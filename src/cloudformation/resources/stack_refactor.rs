...
impl<'a> Stack_refactor<'a> {
    ...
    pub async fn create(&self, stack_definitions: Vec<String>, enable_stack_creation: Option<bool>, resource_mappings: Option<Vec<String>>, description: Option<String>) -> Result<String> {
