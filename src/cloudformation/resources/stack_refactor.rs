...
impl<'a> Stack_refactor<'a> {
    ...
    pub async fn create(&self, resource_mappings: Option<Vec<String>>, description: Option<String>, stack_definitions: Vec<String>, enable_stack_creation: Option<bool>) -> Result<String> {
