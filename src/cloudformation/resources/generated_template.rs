...
impl<'a> Generated_template<'a> {
    ...
    pub async fn create(&self, template_configuration: Option<String>, generated_template_name: String, stack_name: Option<String>, resources: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, template_configuration: Option<String>, generated_template_name: Option<String>, stack_name: Option<String>, resources: Option<Vec<String>>) -> Result<()> {
