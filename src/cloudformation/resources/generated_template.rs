...
impl<'a> Generated_template<'a> {
    ...
    pub async fn create(&self, resources: Option<Vec<String>>, generated_template_name: String, stack_name: Option<String>, template_configuration: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, resources: Option<Vec<String>>, generated_template_name: Option<String>, stack_name: Option<String>, template_configuration: Option<String>) -> Result<()> {
