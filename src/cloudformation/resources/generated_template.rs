...
impl<'a> Generated_template<'a> {
    ...
    pub async fn create(&self, stack_name: Option<String>, template_configuration: Option<String>, resources: Option<Vec<String>>, generated_template_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, stack_name: Option<String>, template_configuration: Option<String>, resources: Option<Vec<String>>, generated_template_name: Option<String>) -> Result<()> {
