...
impl<'a> Environment_ec2<'a> {
    ...
    pub async fn create(&self, instance_type: String, automatic_stop_time_minutes: Option<i64>, tags: Option<Vec<String>>, owner_arn: Option<String>, subnet_id: Option<String>, connection_type: Option<String>, dry_run: Option<bool>, client_request_token: Option<String>, image_id: String, description: Option<String>, name: String) -> Result<String> {
