...
impl<'a> Environment_membership<'a> {
    ...
    pub async fn create(&self, user_arn: String, environment_id: String, permissions: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, user_arn: Option<String>, environment_id: Option<String>, permissions: Option<String>) -> Result<()> {
