...
impl<'a> Domain_name_access_association<'a> {
    ...
    pub async fn create(&self, access_association_source_type: String, tags: Option<String>, access_association_source: String, domain_name_arn: String) -> Result<String> {
