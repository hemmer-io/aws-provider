...
impl<'a> Document_version<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, version_status: Option<String>, authentication_token: Option<String>, document_id: Option<String>, version_id: Option<String>) -> Result<()> {
