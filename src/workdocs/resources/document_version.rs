...
impl<'a> Document_version<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, authentication_token: Option<String>, document_id: Option<String>, version_status: Option<String>, version_id: Option<String>) -> Result<()> {
