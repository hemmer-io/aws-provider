...
impl<'a> Custom_metadata<'a> {
    ...
    pub async fn create(&self, resource_id: String, custom_metadata: HashMap<String, String>, authentication_token: Option<String>, version_id: Option<String>) -> Result<String> {
