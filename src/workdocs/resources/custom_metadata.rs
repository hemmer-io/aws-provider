...
impl<'a> Custom_metadata<'a> {
    ...
    pub async fn create(&self, resource_id: String, version_id: Option<String>, custom_metadata: HashMap<String, String>, authentication_token: Option<String>) -> Result<String> {
