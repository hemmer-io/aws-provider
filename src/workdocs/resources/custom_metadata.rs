...
impl<'a> Custom_metadata<'a> {
    ...
    pub async fn create(&self, version_id: Option<String>, resource_id: String, custom_metadata: HashMap<String, String>, authentication_token: Option<String>) -> Result<String> {
