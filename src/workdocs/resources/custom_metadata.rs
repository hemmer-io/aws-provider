...
impl<'a> Custom_metadata<'a> {
    ...
    pub async fn create(&self, custom_metadata: HashMap<String, String>, version_id: Option<String>, resource_id: String, authentication_token: Option<String>) -> Result<String> {
