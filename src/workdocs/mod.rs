...
impl<'a> WorkdocsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "custom_metadata" => {
                self.plan_custom_metadata(current_state, desired_input)
                    .await
            }
            "notification_subscription" => {
                self.plan_notification_subscription(current_state, desired_input)
                    .await
            }
            ...
            "document_version" => {
                self.plan_document_version(current_state, desired_input)
                    .await
            }
            "root_folders" => self.plan_root_folders(current_state, desired_input).await,
            "users" => self.plan_users(current_state, desired_input).await,
            "current_user" => self.plan_current_user(current_state, desired_input).await,
            "resources" => self.plan_resources(current_state, desired_input).await,
            "notification_subscriptions" => {
                self.plan_notification_subscriptions(current_state, desired_input)
                    .await
            }
            "activities" => self.plan_activities(current_state, desired_input).await,
            "folder_path" => self.plan_folder_path(current_state, desired_input).await,
            "resource_permissions" => {
                self.plan_resource_permissions(current_state, desired_input)
                    .await
            }
            "folder_contents" => {
                self.plan_folder_contents(current_state, desired_input)
                    .await
            }
            "comments" => self.plan_comments(current_state, desired_input).await,
            "document" => self.plan_document(current_state, desired_input).await,
            "document_versions" => {
                self.plan_document_versions(current_state, desired_input)
                    .await
            }
            "document_path" => self.plan_document_path(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workdocs", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "custom_metadata" => self.create_custom_metadata(input).await,
            "notification_subscription" => self.create_notification_subscription(input).await,
            ...
            "document_version" => self.create_document_version(input).await,
            "root_folders" => self.create_root_folders(input).await,
            "users" => self.create_users(input).await,
            "current_user" => self.create_current_user(input).await,
            "resources" => self.create_resources(input).await,
            "notification_subscriptions" => self.create_notification_subscriptions(input).await,
            "activities" => self.create_activities(input).await,
            "folder_path" => self.create_folder_path(input).await,
            "resource_permissions" => self.create_resource_permissions(input).await,
            "folder_contents" => self.create_folder_contents(input).await,
            "comments" => self.create_comments(input).await,
            "document" => self.create_document(input).await,
            "document_versions" => self.create_document_versions(input).await,
            "document_path" => self.create_document_path(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workdocs", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "custom_metadata" => self.read_custom_metadata(id).await,
            "notification_subscription" => self.read_notification_subscription(id).await,
            ...
            "document_version" => self.read_document_version(id).await,
            "root_folders" => self.read_root_folders(id).await,
            "users" => self.read_users(id).await,
            "current_user" => self.read_current_user(id).await,
            "resources" => self.read_resources(id).await,
            "notification_subscriptions" => self.read_notification_subscriptions(id).await,
            "activities" => self.read_activities(id).await,
            "folder_path" => self.read_folder_path(id).await,
            "resource_permissions" => self.read_resource_permissions(id).await,
            "folder_contents" => self.read_folder_contents(id).await,
            "comments" => self.read_comments(id).await,
            "document" => self.read_document(id).await,
            "document_versions" => self.read_document_versions(id).await,
            "document_path" => self.read_document_path(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workdocs", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "custom_metadata" => self.update_custom_metadata(id, input).await,
            "notification_subscription" => self.update_notification_subscription(id, input).await,
            ...
            "document_version" => self.update_document_version(id, input).await,
            "root_folders" => self.update_root_folders(id, input).await,
            "users" => self.update_users(id, input).await,
            "current_user" => self.update_current_user(id, input).await,
            "resources" => self.update_resources(id, input).await,
            "notification_subscriptions" => self.update_notification_subscriptions(id, input).await,
            "activities" => self.update_activities(id, input).await,
            "folder_path" => self.update_folder_path(id, input).await,
            "resource_permissions" => self.update_resource_permissions(id, input).await,
            "folder_contents" => self.update_folder_contents(id, input).await,
            "comments" => self.update_comments(id, input).await,
            "document" => self.update_document(id, input).await,
            "document_versions" => self.update_document_versions(id, input).await,
            "document_path" => self.update_document_path(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workdocs", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "custom_metadata" => self.delete_custom_metadata(id).await,
            "notification_subscription" => self.delete_notification_subscription(id).await,
            ...
            "document_version" => self.delete_document_version(id).await,
            "root_folders" => self.delete_root_folders(id).await,
            "users" => self.delete_users(id).await,
            "current_user" => self.delete_current_user(id).await,
            "resources" => self.delete_resources(id).await,
            "notification_subscriptions" => self.delete_notification_subscriptions(id).await,
            "activities" => self.delete_activities(id).await,
            "folder_path" => self.delete_folder_path(id).await,
            "resource_permissions" => self.delete_resource_permissions(id).await,
            "folder_contents" => self.delete_folder_contents(id).await,
            "comments" => self.delete_comments(id).await,
            "document" => self.delete_document(id).await,
            "document_versions" => self.delete_document_versions(id).await,
            "document_path" => self.delete_document_path(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workdocs", resource_name
            ))),
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    authentication_token.unwrap_or_default(),
                )
    ...
    async fn create_custom_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_custom_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn delete_custom_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
    ...
    async fn read_notification_subscription(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn delete_notification_subscription(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    notify_collaborators.unwrap_or_default(),
                )
                .with_field("version_id", version_id.unwrap_or_default())
    ...
    async fn create_document_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let authentication_token = input.get_optional_string("authentication_token")?;
    ...
    async fn read_document_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn delete_document_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
    ...
    async fn create_root_folders(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_root_folders(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn update_root_folders(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_root_folders(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
    ...
    async fn create_current_user(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_current_user(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn update_current_user(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_current_user(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
    ...
    async fn read_notification_subscriptions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn delete_notification_subscriptions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
    ...
    async fn create_activities(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_activities(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn update_activities(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_activities(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
    ...
    async fn create_folder_path(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_folder_path(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn update_folder_path(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_folder_path(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
    ...
    async fn create_resource_permissions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_resource_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn delete_resource_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
    ...
    async fn create_folder_contents(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_folder_contents(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn delete_folder_contents(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
    ...
    async fn create_comments(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_comments(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn update_comments(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_comments(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
    ...
    async fn create_document_versions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_document_versions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn delete_document_versions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
    ...
    async fn create_document_path(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_document_path(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workdocs_client
    ...
    async fn update_document_path(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_document_path(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workdocs_client
