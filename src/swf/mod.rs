...
impl<'a> SwfService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "activity_type" => {
                self.plan_activity_type(current_state, desired_input).await
            }
            "workflow_execution_history" => {
                self.plan_workflow_execution_history(current_state, desired_input).await
            }
            "workflow_execution" => {
                self.plan_workflow_execution(current_state, desired_input).await
            }
            "workflow_type" => {
                self.plan_workflow_type(current_state, desired_input).await
            }
            "domain" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "activity_type" => {
                self.create_activity_type(input).await
            }
            "workflow_execution_history" => {
                self.create_workflow_execution_history(input).await
            }
            "workflow_execution" => {
                self.create_workflow_execution(input).await
            }
            "workflow_type" => {
                self.create_workflow_type(input).await
            }
            "domain" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "activity_type" => {
                self.read_activity_type(id).await
            }
            "workflow_execution_history" => {
                self.read_workflow_execution_history(id).await
            }
            "workflow_execution" => {
                self.read_workflow_execution(id).await
            }
            "workflow_type" => {
                self.read_workflow_type(id).await
            }
            "domain" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "activity_type" => {
                self.update_activity_type(id, input).await
            }
            "workflow_execution_history" => {
                self.update_workflow_execution_history(id, input).await
            }
            "workflow_execution" => {
                self.update_workflow_execution(id, input).await
            }
            "workflow_type" => {
                self.update_workflow_type(id, input).await
            }
            "domain" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "activity_type" => {
                self.delete_activity_type(id).await
            }
            "workflow_execution_history" => {
                self.delete_workflow_execution_history(id).await
            }
            "workflow_execution" => {
                self.delete_workflow_execution(id).await
            }
            "workflow_type" => {
                self.delete_workflow_type(id).await
            }
            "domain" => {
    ...
    async fn read_workflow_execution_history(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_workflow_execution(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
