...
impl<'a> OamService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "sink_policy" => self.plan_sink_policy(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "sink_policy" => self.create_sink_policy(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "sink_policy" => self.read_sink_policy(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "sink_policy" => self.update_sink_policy(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "sink_policy" => self.delete_sink_policy(id).await,
    ...
    async fn create_sink_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_sink_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_sink_policy(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let policy = input.get_string("policy")?;
            let sink_identifier = input.get_string("sink_identifier")?;
    ...
    async fn delete_sink_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
