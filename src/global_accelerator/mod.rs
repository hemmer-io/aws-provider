...
impl<'a> Global_acceleratorService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "accelerator_attributes" => {
                self.plan_accelerator_attributes(current_state, desired_input).await
            }
            "listener" => {
                self.plan_listener(current_state, desired_input).await
            }
            "accelerator" => {
                self.plan_accelerator(current_state, desired_input).await
            }
            "custom_routing_accelerator_attributes" => {
                self.plan_custom_routing_accelerator_attributes(current_state, desired_input).await
            }
            "custom_routing_endpoint_group" => {
                self.plan_custom_routing_endpoint_group(current_state, desired_input).await
            }
            "custom_routing_accelerator" => {
                self.plan_custom_routing_accelerator(current_state, desired_input).await
            }
            "endpoint_group" => {
                self.plan_endpoint_group(current_state, desired_input).await
            }
            "cross_account_attachment" => {
                self.plan_cross_account_attachment(current_state, desired_input).await
            }
            "custom_routing_listener" => {
                self.plan_custom_routing_listener(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "accelerator_attributes" => {
                self.create_accelerator_attributes(input).await
            }
            "listener" => {
                self.create_listener(input).await
            }
            "accelerator" => {
                self.create_accelerator(input).await
            }
            "custom_routing_accelerator_attributes" => {
                self.create_custom_routing_accelerator_attributes(input).await
            }
            "custom_routing_endpoint_group" => {
                self.create_custom_routing_endpoint_group(input).await
            }
            "custom_routing_accelerator" => {
                self.create_custom_routing_accelerator(input).await
            }
            "endpoint_group" => {
                self.create_endpoint_group(input).await
            }
            "cross_account_attachment" => {
                self.create_cross_account_attachment(input).await
            }
            "custom_routing_listener" => {
                self.create_custom_routing_listener(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "global_accelerator",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "accelerator_attributes" => {
                self.read_accelerator_attributes(id).await
            }
            "listener" => {
                self.read_listener(id).await
            }
            "accelerator" => {
                self.read_accelerator(id).await
            }
            "custom_routing_accelerator_attributes" => {
                self.read_custom_routing_accelerator_attributes(id).await
            }
            "custom_routing_endpoint_group" => {
                self.read_custom_routing_endpoint_group(id).await
            }
            "custom_routing_accelerator" => {
                self.read_custom_routing_accelerator(id).await
            }
            "endpoint_group" => {
                self.read_endpoint_group(id).await
            }
            "cross_account_attachment" => {
                self.read_cross_account_attachment(id).await
            }
            "custom_routing_listener" => {
                self.read_custom_routing_listener(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "global_accelerator",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "accelerator_attributes" => {
                self.update_accelerator_attributes(id, input).await
            }
            "listener" => {
                self.update_listener(id, input).await
            }
            "accelerator" => {
                self.update_accelerator(id, input).await
            }
            "custom_routing_accelerator_attributes" => {
                self.update_custom_routing_accelerator_attributes(id, input).await
            }
            "custom_routing_endpoint_group" => {
                self.update_custom_routing_endpoint_group(id, input).await
            }
            "custom_routing_accelerator" => {
                self.update_custom_routing_accelerator(id, input).await
            }
            "endpoint_group" => {
                self.update_endpoint_group(id, input).await
            }
            "cross_account_attachment" => {
                self.update_cross_account_attachment(id, input).await
            }
            "custom_routing_listener" => {
                self.update_custom_routing_listener(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "global_accelerator",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "accelerator_attributes" => {
                self.delete_accelerator_attributes(id).await
            }
            "listener" => {
                self.delete_listener(id).await
            }
            "accelerator" => {
                self.delete_accelerator(id).await
            }
            "custom_routing_accelerator_attributes" => {
                self.delete_custom_routing_accelerator_attributes(id).await
            }
            "custom_routing_endpoint_group" => {
                self.delete_custom_routing_endpoint_group(id).await
            }
            "custom_routing_accelerator" => {
                self.delete_custom_routing_accelerator(id).await
            }
            "endpoint_group" => {
                self.delete_endpoint_group(id).await
            }
            "cross_account_attachment" => {
                self.delete_cross_account_attachment(id).await
            }
            "custom_routing_listener" => {
                self.delete_custom_routing_listener(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "global_accelerator",
    ...
    async fn create_accelerator_attributes(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("flow_logs_s3_bucket", flow_logs_s3_bucket.unwrap_or_default())
                .with_field("flow_logs_s3_prefix", flow_logs_s3_prefix.unwrap_or_default())
            )
        })
    }

    /// Read a accelerator_attributes resource
    async fn read_accelerator_attributes(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_accelerator_attributes(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_custom_routing_accelerator_attributes(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_custom_routing_accelerator_attributes(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_custom_routing_endpoint_group(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("endpoint_group_region", endpoint_group_region.unwrap_or_default())
                .with_field("idempotency_token", idempotency_token.unwrap_or_default())
                .with_field("destination_configurations", destination_configurations.unwrap_or_default())
    ...
    async fn read_custom_routing_endpoint_group(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_custom_routing_accelerator(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_endpoint_group(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("traffic_dial_percentage", traffic_dial_percentage.unwrap_or_default())
                .with_field("health_check_port", health_check_port.unwrap_or_default())
                .with_field("endpoint_configurations", endpoint_configurations.unwrap_or_default())
                .with_field("endpoint_group_region", endpoint_group_region.unwrap_or_default())
                .with_field("listener_arn", listener_arn.unwrap_or_default())
    ...
    async fn read_cross_account_attachment(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cross_account_attachment(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_custom_routing_listener(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
