...
impl<'a> Custom_routing_accelerator_attributes<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, flow_logs_s3_bucket: Option<String>, flow_logs_s3_prefix: Option<String>, flow_logs_enabled: Option<bool>, accelerator_arn: Option<String>) -> Result<()> {
