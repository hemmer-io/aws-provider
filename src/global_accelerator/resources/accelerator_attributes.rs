...
impl<'a> Accelerator_attributes<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, flow_logs_s3_bucket: Option<String>, flow_logs_enabled: Option<bool>, accelerator_arn: Option<String>, flow_logs_s3_prefix: Option<String>) -> Result<()> {
