...
impl<'a> Custom_routing_accelerator<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, ip_address_type: Option<String>, ip_addresses: Option<Vec<String>>, enabled: Option<bool>, idempotency_token: String, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, ip_address_type: Option<String>, ip_addresses: Option<Vec<String>>, enabled: Option<bool>, idempotency_token: Option<String>, name: Option<String>) -> Result<()> {
