...
impl<'a> Custom_routing_listener<'a> {
    ...
    pub async fn create(&self, accelerator_arn: String, port_ranges: Vec<String>, idempotency_token: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, accelerator_arn: Option<String>, port_ranges: Option<Vec<String>>, idempotency_token: Option<String>) -> Result<()> {
