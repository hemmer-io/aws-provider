...
impl<'a> Custom_routing_endpoint_group<'a> {
    ...
    pub async fn create(&self, idempotency_token: String, endpoint_group_region: String, destination_configurations: Vec<String>, listener_arn: String) -> Result<String> {
