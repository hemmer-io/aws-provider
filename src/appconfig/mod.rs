...
impl<'a> AppconfigService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "configuration_profile" => {
                self.plan_configuration_profile(current_state, desired_input)
                    .await
            }
            ...
            "hosted_configuration_version" => {
                self.plan_hosted_configuration_version(current_state, desired_input)
                    .await
            }
            ...
            "extension_association" => {
                self.plan_extension_association(current_state, desired_input)
                    .await
            }
            "deployment" => self.plan_deployment(current_state, desired_input).await,
            "deployment_strategy" => {
                self.plan_deployment_strategy(current_state, desired_input)
                    .await
            }
            "account_settings" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "configuration_profile" => self.create_configuration_profile(input).await,
            "environment" => self.create_environment(input).await,
            "configuration" => self.create_configuration(input).await,
            "hosted_configuration_version" => self.create_hosted_configuration_version(input).await,
            "application" => self.create_application(input).await,
            "extension" => self.create_extension(input).await,
            "extension_association" => self.create_extension_association(input).await,
            "deployment" => self.create_deployment(input).await,
            "deployment_strategy" => self.create_deployment_strategy(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "configuration_profile" => self.read_configuration_profile(id).await,
            "environment" => self.read_environment(id).await,
            "configuration" => self.read_configuration(id).await,
            "hosted_configuration_version" => self.read_hosted_configuration_version(id).await,
            "application" => self.read_application(id).await,
            "extension" => self.read_extension(id).await,
            "extension_association" => self.read_extension_association(id).await,
            "deployment" => self.read_deployment(id).await,
            "deployment_strategy" => self.read_deployment_strategy(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "configuration_profile" => self.update_configuration_profile(id, input).await,
            ...
            "extension_association" => self.update_extension_association(id, input).await,
            "deployment" => self.update_deployment(id, input).await,
            "deployment_strategy" => self.update_deployment_strategy(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "configuration_profile" => self.delete_configuration_profile(id).await,
            "environment" => self.delete_environment(id).await,
            "configuration" => self.delete_configuration(id).await,
            "hosted_configuration_version" => self.delete_hosted_configuration_version(id).await,
            "application" => self.delete_application(id).await,
            "extension" => self.delete_extension(id).await,
            "extension_association" => self.delete_extension_association(id).await,
            "deployment" => self.delete_deployment(id).await,
            "deployment_strategy" => self.delete_deployment_strategy(id).await,
    ...
    async fn create_configuration_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_configuration_profile(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_configuration_profile(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    latest_version_number.unwrap_or_default(),
                )
                .with_field(
                    "configuration_profile_id",
                    configuration_profile_id.unwrap_or_default(),
                )
    ...
    async fn read_hosted_configuration_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appconfig_client
    ...
    async fn delete_hosted_configuration_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appconfig_client
    ...
    async fn create_extension_association(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    extension_version_number.unwrap_or_default(),
                )
                .with_field(
                    "extension_identifier",
                    extension_identifier.unwrap_or_default(),
                )
                .with_field(
                    "resource_identifier",
    ...
    async fn read_extension_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appconfig_client
    ...
    async fn delete_extension_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appconfig_client
    ...
    async fn create_deployment_strategy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let final_bake_time_in_minutes =
                input.get_optional_string("final_bake_time_in_minutes")?;
            let replicate_to = input.get_optional_string("replicate_to")?;
            let tags = input.get_optional_string("tags")?;
            let deployment_duration_in_minutes =
                input.get_string("deployment_duration_in_minutes")?;
            let name = input.get_string("name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    final_bake_time_in_minutes.unwrap_or_default(),
                )
                .with_field("replicate_to", replicate_to.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "deployment_duration_in_minutes",
                    deployment_duration_in_minutes.unwrap_or_default(),
                )
                .with_field("name", name.unwrap_or_default())
    ...
    async fn read_deployment_strategy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appconfig_client
    ...
    async fn delete_deployment_strategy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appconfig_client
