...
impl<'a> Hosted_configuration_version<'a> {
    ...
    pub async fn create(&self, latest_version_number: Option<i64>, content: String, content_type: String, version_label: Option<String>, configuration_profile_id: String, description: Option<String>, application_id: String) -> Result<String> {
