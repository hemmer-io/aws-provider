...
impl<'a> Hosted_configuration_version<'a> {
    ...
    pub async fn create(&self, version_label: Option<String>, description: Option<String>, content_type: String, latest_version_number: Option<i64>, configuration_profile_id: String, application_id: String, content: String) -> Result<String> {
