...
impl<'a> Extension_association<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, resource_identifier: String, parameters: Option<HashMap<String, String>>, extension_version_number: Option<i64>, extension_identifier: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, resource_identifier: Option<String>, parameters: Option<HashMap<String, String>>, extension_version_number: Option<i64>, extension_identifier: Option<String>) -> Result<()> {
