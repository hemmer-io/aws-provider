...
impl<'a> Portfolio_preferences<'a> {
    ...
    pub async fn create(&self, prioritize_business_goals: Option<String>, application_mode: Option<String>, application_preferences: Option<String>, database_preferences: Option<String>) -> Result<String> {
