...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, enabled: Option<bool>, source_ids: Option<Vec<String>>, event_categories: Option<Vec<String>>, source_type: Option<String>, tags: Option<Vec<String>>, subscription_name: String, sns_topic_arn: String) -> Result<String> {
