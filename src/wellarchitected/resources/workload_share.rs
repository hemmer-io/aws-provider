...
impl<'a> Workload_share<'a> {
    ...
    pub async fn create(&self, workload_id: String, shared_with: String, permission_type: String, client_request_token: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, workload_id: Option<String>, shared_with: Option<String>, permission_type: Option<String>, client_request_token: Option<String>) -> Result<()> {
