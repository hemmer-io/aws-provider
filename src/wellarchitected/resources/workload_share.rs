...
impl<'a> Workload_share<'a> {
    ...
    pub async fn create(&self, shared_with: String, permission_type: String, client_request_token: String, workload_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, shared_with: Option<String>, permission_type: Option<String>, client_request_token: Option<String>, workload_id: Option<String>) -> Result<()> {
