...
impl<'a> Review_template<'a> {
    ...
    pub async fn create(&self, client_request_token: String, lenses: Vec<String>, notes: Option<String>, description: String, tags: Option<HashMap<String, String>>, template_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_request_token: Option<String>, lenses: Option<Vec<String>>, notes: Option<String>, description: Option<String>, tags: Option<HashMap<String, String>>, template_name: Option<String>) -> Result<()> {
