...
impl<'a> Review_template<'a> {
    ...
    pub async fn create(&self, client_request_token: String, template_name: String, lenses: Vec<String>, tags: Option<HashMap<String, String>>, notes: Option<String>, description: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_request_token: Option<String>, template_name: Option<String>, lenses: Option<Vec<String>>, tags: Option<HashMap<String, String>>, notes: Option<String>, description: Option<String>) -> Result<()> {
