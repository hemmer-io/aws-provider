...
impl<'a> Review_template<'a> {
    ...
    pub async fn create(&self, lenses: Vec<String>, notes: Option<String>, description: String, client_request_token: String, template_name: String, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, lenses: Option<Vec<String>>, notes: Option<String>, description: Option<String>, client_request_token: Option<String>, template_name: Option<String>, tags: Option<HashMap<String, String>>) -> Result<()> {
