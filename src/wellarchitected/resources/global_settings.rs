...
impl<'a> Global_settings<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, organization_sharing_status: Option<String>, jira_configuration: Option<String>, discovery_integration_status: Option<String>) -> Result<()> {
