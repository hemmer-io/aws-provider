...
impl<'a> Lens_review<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, workload_id: Option<String>, lens_alias: Option<String>, lens_notes: Option<String>, pillar_notes: Option<HashMap<String, String>>, jira_configuration: Option<String>) -> Result<()> {
