...
impl<'a> Review_template_lens_review<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, lens_alias: Option<String>, pillar_notes: Option<HashMap<String, String>>, template_arn: Option<String>, lens_notes: Option<String>) -> Result<()> {
