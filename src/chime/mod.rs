...
impl<'a> ChimeService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "user_settings" => self.plan_user_settings(current_state, desired_input).await,
            "phone_number_order" => {
                self.plan_phone_number_order(current_state, desired_input)
                    .await
            }
            "retention_settings" => {
                self.plan_retention_settings(current_state, desired_input)
                    .await
            }
            "meeting_dial_out" => {
                self.plan_meeting_dial_out(current_state, desired_input)
                    .await
            }
            "user" => self.plan_user(current_state, desired_input).await,
            "room_membership" => {
                self.plan_room_membership(current_state, desired_input)
                    .await
            }
            "account_settings" => {
            ...
            "events_configuration" => {
                self.plan_events_configuration(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "user_settings" => self.create_user_settings(input).await,
            "phone_number_order" => self.create_phone_number_order(input).await,
            "retention_settings" => self.create_retention_settings(input).await,
            "meeting_dial_out" => self.create_meeting_dial_out(input).await,
            "user" => self.create_user(input).await,
            "room_membership" => self.create_room_membership(input).await,
            "account_settings" => self.create_account_settings(input).await,
            "events_configuration" => self.create_events_configuration(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "chime", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "user_settings" => self.read_user_settings(id).await,
            "phone_number_order" => self.read_phone_number_order(id).await,
            "retention_settings" => self.read_retention_settings(id).await,
            "meeting_dial_out" => self.read_meeting_dial_out(id).await,
            "user" => self.read_user(id).await,
            "room_membership" => self.read_room_membership(id).await,
            "account_settings" => self.read_account_settings(id).await,
            "events_configuration" => self.read_events_configuration(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "chime", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "user_settings" => self.update_user_settings(id, input).await,
            "phone_number_order" => self.update_phone_number_order(id, input).await,
            "retention_settings" => self.update_retention_settings(id, input).await,
            "meeting_dial_out" => self.update_meeting_dial_out(id, input).await,
            "user" => self.update_user(id, input).await,
            "room_membership" => self.update_room_membership(id, input).await,
            "account_settings" => self.update_account_settings(id, input).await,
            "events_configuration" => self.update_events_configuration(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "chime", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "user_settings" => self.delete_user_settings(id).await,
            "phone_number_order" => self.delete_phone_number_order(id).await,
            "retention_settings" => self.delete_retention_settings(id).await,
            "meeting_dial_out" => self.delete_meeting_dial_out(id).await,
            "user" => self.delete_user(id).await,
            "room_membership" => self.delete_room_membership(id).await,
            "account_settings" => self.delete_account_settings(id).await,
            "events_configuration" => self.delete_events_configuration(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "chime", resource_name
            ))),
    ...
    async fn create_user_settings(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_user_settings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_client
    ...
    async fn update_user_settings(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let user_settings = input.get_string("user_settings")?;
            let user_id = input.get_string("user_id")?;
    ...
    async fn create_retention_settings(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let account_id = input.get_string("account_id")?;
    ...
    async fn read_retention_settings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_client
    ...
    async fn delete_retention_settings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_client
    ...
    async fn create_meeting_dial_out(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_meeting_dial_out(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_client
    ...
    async fn delete_meeting_dial_out(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_client
    ...
    async fn create_room_membership(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_room_membership(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_client
    ...
    async fn delete_room_membership(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_client
    ...
    async fn create_events_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let outbound_events_https_endpoint =
                input.get_optional_string("outbound_events_https_endpoint")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    outbound_events_https_endpoint.unwrap_or_default(),
                ))
        })
    }

    /// Read a events_configuration resource
    async fn read_events_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_client
    ...
    async fn delete_events_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_client
