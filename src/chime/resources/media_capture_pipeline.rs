...
impl<'a> Media_capture_pipeline<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, sse_aws_key_management_params: Option<String>, client_request_token: Option<String>, sink_arn: String, source_type: String, source_arn: String, sink_type: String, sink_iam_role_arn: Option<String>, chime_sdk_meeting_configuration: Option<String>) -> Result<String> {
