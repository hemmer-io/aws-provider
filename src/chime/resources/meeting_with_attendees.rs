...
impl<'a> Meeting_with_attendees<'a> {
    ...
    pub async fn create(&self, primary_meeting_id: Option<String>, media_placement_network_type: Option<String>, meeting_features: Option<String>, meeting_host_id: Option<String>, client_request_token: String, tags: Option<Vec<String>>, external_meeting_id: String, tenant_ids: Option<Vec<String>>, notifications_configuration: Option<String>, attendees: Vec<String>, media_region: String) -> Result<String> {
