...
impl<'a> Media_insights_pipeline_configuration<'a> {
    ...
    pub async fn create(&self, elements: Vec<String>, resource_access_role_arn: String, real_time_alert_configuration: Option<String>, tags: Option<Vec<String>>, client_request_token: Option<String>, media_insights_pipeline_configuration_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, elements: Option<Vec<String>>, resource_access_role_arn: Option<String>, real_time_alert_configuration: Option<String>, tags: Option<Vec<String>>, client_request_token: Option<String>, media_insights_pipeline_configuration_name: Option<String>) -> Result<()> {
