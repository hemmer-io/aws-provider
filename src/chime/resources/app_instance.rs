...
impl<'a> App_instance<'a> {
    ...
    pub async fn create(&self, metadata: Option<String>, client_request_token: String, name: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, metadata: Option<String>, client_request_token: Option<String>, name: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
