...
impl<'a> Room_membership<'a> {
    ...
    pub async fn create(&self, account_id: String, room_id: String, member_id: String, role: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, account_id: Option<String>, room_id: Option<String>, member_id: Option<String>, role: Option<String>) -> Result<()> {
