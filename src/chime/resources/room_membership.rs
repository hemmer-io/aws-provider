...
impl<'a> Room_membership<'a> {
    ...
    pub async fn create(&self, member_id: String, room_id: String, role: Option<String>, account_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, member_id: Option<String>, room_id: Option<String>, role: Option<String>, account_id: Option<String>) -> Result<()> {
