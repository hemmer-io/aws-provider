...
impl<'a> Voice_connector<'a> {
    ...
    pub async fn create(&self, network_type: Option<String>, tags: Option<Vec<String>>, integration_type: Option<String>, name: String, aws_region: Option<String>, require_encryption: bool) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, network_type: Option<String>, tags: Option<Vec<String>>, integration_type: Option<String>, name: Option<String>, aws_region: Option<String>, require_encryption: Option<bool>) -> Result<()> {
