...
impl<'a> Permission_group<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, name: String, description: Option<String>, application_permissions: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, name: Option<String>, description: Option<String>, application_permissions: Option<Vec<String>>) -> Result<()> {
