...
impl<'a> Data_view<'a> {
    ...
    pub async fn create(&self, as_of_timestamp: Option<String>, sort_columns: Option<Vec<String>>, client_token: Option<String>, dataset_id: String, auto_update: Option<bool>, destination_type_params: String, partition_columns: Option<Vec<String>>) -> Result<String> {
