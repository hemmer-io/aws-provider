...
impl<'a> Deployment_config<'a> {
    ...
    pub async fn create(&self, minimum_healthy_hosts: Option<String>, zonal_config: Option<String>, traffic_routing_config: Option<String>, compute_platform: Option<String>, deployment_config_name: String) -> Result<String> {
