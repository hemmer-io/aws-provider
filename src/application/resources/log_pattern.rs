...
impl<'a> Log_pattern<'a> {
    ...
    pub async fn create(&self, pattern: String, rank: i64, resource_group_name: String, pattern_set_name: String, pattern_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, pattern: Option<String>, rank: Option<i64>, resource_group_name: Option<String>, pattern_set_name: Option<String>, pattern_name: Option<String>) -> Result<()> {
