...
impl<'a> Segment_snapshot<'a> {
    ...
    pub async fn create(&self, segment_definition_name: String, data_format: String, domain_name: String, encryption_key: Option<String>, role_arn: Option<String>, destination_uri: Option<String>) -> Result<String> {
