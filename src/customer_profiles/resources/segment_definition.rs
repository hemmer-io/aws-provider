...
impl<'a> Segment_definition<'a> {
    ...
    pub async fn create(&self, display_name: String, description: Option<String>, segment_definition_name: String, tags: Option<HashMap<String, String>>, domain_name: String, segment_groups: String) -> Result<String> {
