...
impl<'a> Profile_object_type<'a> {
    ...
    pub async fn create(&self, encryption_key: Option<String>, allow_profile_creation: Option<bool>, fields: Option<HashMap<String, String>>, keys: Option<HashMap<String, Vec<String>>>, description: String, source_last_updated_timestamp_format: Option<String>, max_profile_object_count: Option<i64>, tags: Option<HashMap<String, String>>, template_id: Option<String>, expiration_days: Option<i64>, domain_name: String, object_type_name: String) -> Result<String> {
