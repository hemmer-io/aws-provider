...
impl<'a> CodepipelineService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "action_revision" => {
                self.plan_action_revision(current_state, desired_input)
                    .await
            }
            "approval_result" => {
                self.plan_approval_result(current_state, desired_input)
                    .await
            }
            "third_party_job_details" => {
                self.plan_third_party_job_details(current_state, desired_input)
                    .await
            }
            "pipeline_execution" => {
            ...
            "pipeline_state" => self.plan_pipeline_state(current_state, desired_input).await,
            "job_details" => self.plan_job_details(current_state, desired_input).await,
            "custom_action_type" => {
                self.plan_custom_action_type(current_state, desired_input)
                    .await
            }
            "job_failure_result" => {
                self.plan_job_failure_result(current_state, desired_input)
                    .await
            }
            "job_success_result" => {
                self.plan_job_success_result(current_state, desired_input)
                    .await
            }
            "third_party_job_success_result" => {
                self.plan_third_party_job_success_result(current_state, desired_input)
                    .await
            }
            "third_party_job_failure_result" => {
                self.plan_third_party_job_failure_result(current_state, desired_input)
                    .await
            }
            "action_type" => self.plan_action_type(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codepipeline", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "action_revision" => self.create_action_revision(input).await,
            "approval_result" => self.create_approval_result(input).await,
            "third_party_job_details" => self.create_third_party_job_details(input).await,
            "pipeline_execution" => self.create_pipeline_execution(input).await,
            "webhook" => self.create_webhook(input).await,
            "pipeline_state" => self.create_pipeline_state(input).await,
            "job_details" => self.create_job_details(input).await,
            "custom_action_type" => self.create_custom_action_type(input).await,
            "job_failure_result" => self.create_job_failure_result(input).await,
            "job_success_result" => self.create_job_success_result(input).await,
            "third_party_job_success_result" => {
            ...
            "action_type" => self.create_action_type(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codepipeline", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "action_revision" => self.read_action_revision(id).await,
            "approval_result" => self.read_approval_result(id).await,
            "third_party_job_details" => self.read_third_party_job_details(id).await,
            "pipeline_execution" => self.read_pipeline_execution(id).await,
            "webhook" => self.read_webhook(id).await,
            "pipeline_state" => self.read_pipeline_state(id).await,
            "job_details" => self.read_job_details(id).await,
            "custom_action_type" => self.read_custom_action_type(id).await,
            "job_failure_result" => self.read_job_failure_result(id).await,
            "job_success_result" => self.read_job_success_result(id).await,
            "third_party_job_success_result" => self.read_third_party_job_success_result(id).await,
            "third_party_job_failure_result" => self.read_third_party_job_failure_result(id).await,
            "action_type" => self.read_action_type(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codepipeline", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "action_revision" => self.update_action_revision(id, input).await,
            "approval_result" => self.update_approval_result(id, input).await,
            "third_party_job_details" => self.update_third_party_job_details(id, input).await,
            "pipeline_execution" => self.update_pipeline_execution(id, input).await,
            "webhook" => self.update_webhook(id, input).await,
            "pipeline_state" => self.update_pipeline_state(id, input).await,
            "job_details" => self.update_job_details(id, input).await,
            "custom_action_type" => self.update_custom_action_type(id, input).await,
            "job_failure_result" => self.update_job_failure_result(id, input).await,
            "job_success_result" => self.update_job_success_result(id, input).await,
            "third_party_job_success_result" => {
            ...
            "action_type" => self.update_action_type(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codepipeline", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "action_revision" => self.delete_action_revision(id).await,
            "approval_result" => self.delete_approval_result(id).await,
            "third_party_job_details" => self.delete_third_party_job_details(id).await,
            "pipeline_execution" => self.delete_pipeline_execution(id).await,
            "webhook" => self.delete_webhook(id).await,
            "pipeline_state" => self.delete_pipeline_state(id).await,
            "job_details" => self.delete_job_details(id).await,
            "custom_action_type" => self.delete_custom_action_type(id).await,
            "job_failure_result" => self.delete_job_failure_result(id).await,
            "job_success_result" => self.delete_job_success_result(id).await,
            "third_party_job_success_result" => {
            ...
            "action_type" => self.delete_action_type(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codepipeline", resource_name
            ))),
    ...
    async fn create_action_revision(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_action_revision(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codepipeline_client
    ...
    async fn delete_action_revision(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codepipeline_client
    ...
    async fn create_approval_result(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let pipeline_name = input.get_string("pipeline_name")?;
    ...
    async fn read_approval_result(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codepipeline_client
    ...
    async fn delete_approval_result(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codepipeline_client
    ...
    async fn create_third_party_job_details(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_third_party_job_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codepipeline_client
    ...
    async fn delete_third_party_job_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codepipeline_client
    ...
    async fn create_pipeline_state(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_pipeline_state(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codepipeline_client
    ...
    async fn delete_pipeline_state(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codepipeline_client
    ...
    async fn create_job_details(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_job_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codepipeline_client
    ...
    async fn update_job_details(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_job_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codepipeline_client
    ...
    async fn create_custom_action_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    configuration_properties.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    input_artifact_details.unwrap_or_default(),
                )
                .with_field(
                    "output_artifact_details",
                    output_artifact_details.unwrap_or_default(),
                )
    ...
    async fn read_custom_action_type(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codepipeline_client
    ...
    async fn delete_custom_action_type(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codepipeline_client
    ...
    async fn create_job_failure_result(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_job_failure_result(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codepipeline_client
    ...
    async fn delete_job_failure_result(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codepipeline_client
    ...
    async fn create_job_success_result(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let job_id = input.get_string("job_id")?;
    ...
    async fn read_job_success_result(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codepipeline_client
    ...
    async fn delete_job_success_result(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codepipeline_client
    ...
    async fn read_third_party_job_success_result(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codepipeline_client
    ...
    async fn delete_third_party_job_success_result(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codepipeline_client
    ...
    async fn read_third_party_job_failure_result(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codepipeline_client
    ...
    async fn delete_third_party_job_failure_result(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codepipeline_client
    ...
    async fn create_action_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_action_type(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codepipeline_client
    ...
    async fn update_action_type(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let action_type = input.get_string("action_type")?;
    ...
    async fn delete_action_type(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codepipeline_client
