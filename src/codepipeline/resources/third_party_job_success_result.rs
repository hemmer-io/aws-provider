...
impl<'a> Third_party_job_success_result<'a> {
    ...
    pub async fn create(&self, continuation_token: Option<String>, execution_details: Option<String>, current_revision: Option<String>, job_id: String, client_token: String) -> Result<String> {
