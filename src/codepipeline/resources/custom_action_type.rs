...
impl<'a> Custom_action_type<'a> {
    ...
    pub async fn create(&self, input_artifact_details: String, output_artifact_details: String, version: String, provider: String, settings: Option<String>, configuration_properties: Option<Vec<String>>, tags: Option<Vec<String>>, category: String) -> Result<String> {
