...
impl<'a> Job_success_result<'a> {
    ...
    pub async fn create(&self, job_id: String, current_revision: Option<String>, execution_details: Option<String>, continuation_token: Option<String>, output_variables: Option<HashMap<String, String>>) -> Result<String> {
