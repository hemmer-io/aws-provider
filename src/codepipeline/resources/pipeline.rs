...
impl<'a> Pipeline<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, pipeline: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, pipeline: Option<String>) -> Result<()> {
