...
impl<'a> Pipeline<'a> {
    ...
    pub async fn create(&self, pipeline: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, pipeline: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
