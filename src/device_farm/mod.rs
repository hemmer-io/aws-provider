...
impl<'a> Device_farmService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "test_grid_url" => self.plan_test_grid_url(current_state, desired_input).await,
            "test_grid_project" => {
                self.plan_test_grid_project(current_state, desired_input)
                    .await
            }
            "test" => self.plan_test(current_state, desired_input).await,
            "instance_profile" => {
                self.plan_instance_profile(current_state, desired_input)
                    .await
            }
            "network_profile" => {
                self.plan_network_profile(current_state, desired_input)
                    .await
            }
            "device_pool" => self.plan_device_pool(current_state, desired_input).await,
            "upload" => self.plan_upload(current_state, desired_input).await,
            "account_settings" => {
            ...
            "vpce_configuration" => {
                self.plan_vpce_configuration(current_state, desired_input)
                    .await
            }
            "run" => self.plan_run(current_state, desired_input).await,
            "device" => self.plan_device(current_state, desired_input).await,
            "suite" => self.plan_suite(current_state, desired_input).await,
            "remote_access_session" => {
                self.plan_remote_access_session(current_state, desired_input)
                    .await
            }
            "job" => self.plan_job(current_state, desired_input).await,
            "test_grid_session" => {
                self.plan_test_grid_session(current_state, desired_input)
                    .await
            }
            "device_instance" => {
                self.plan_device_instance(current_state, desired_input)
                    .await
            }
            "device_pool_compatibility" => {
                self.plan_device_pool_compatibility(current_state, desired_input)
                    .await
            }
            "offering_status" => {
                self.plan_offering_status(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "device_farm", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "test_grid_url" => self.create_test_grid_url(input).await,
            "test_grid_project" => self.create_test_grid_project(input).await,
            "test" => self.create_test(input).await,
            "instance_profile" => self.create_instance_profile(input).await,
            "network_profile" => self.create_network_profile(input).await,
            "device_pool" => self.create_device_pool(input).await,
            "upload" => self.create_upload(input).await,
            "account_settings" => self.create_account_settings(input).await,
            "project" => self.create_project(input).await,
            "vpce_configuration" => self.create_vpce_configuration(input).await,
            "run" => self.create_run(input).await,
            "device" => self.create_device(input).await,
            "suite" => self.create_suite(input).await,
            "remote_access_session" => self.create_remote_access_session(input).await,
            "job" => self.create_job(input).await,
            "test_grid_session" => self.create_test_grid_session(input).await,
            "device_instance" => self.create_device_instance(input).await,
            "device_pool_compatibility" => self.create_device_pool_compatibility(input).await,
            "offering_status" => self.create_offering_status(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "device_farm", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "test_grid_url" => self.read_test_grid_url(id).await,
            "test_grid_project" => self.read_test_grid_project(id).await,
            "test" => self.read_test(id).await,
            "instance_profile" => self.read_instance_profile(id).await,
            "network_profile" => self.read_network_profile(id).await,
            "device_pool" => self.read_device_pool(id).await,
            "upload" => self.read_upload(id).await,
            "account_settings" => self.read_account_settings(id).await,
            "project" => self.read_project(id).await,
            "vpce_configuration" => self.read_vpce_configuration(id).await,
            "run" => self.read_run(id).await,
            "device" => self.read_device(id).await,
            "suite" => self.read_suite(id).await,
            "remote_access_session" => self.read_remote_access_session(id).await,
            "job" => self.read_job(id).await,
            "test_grid_session" => self.read_test_grid_session(id).await,
            "device_instance" => self.read_device_instance(id).await,
            "device_pool_compatibility" => self.read_device_pool_compatibility(id).await,
            "offering_status" => self.read_offering_status(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "device_farm", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "test_grid_url" => self.update_test_grid_url(id, input).await,
            "test_grid_project" => self.update_test_grid_project(id, input).await,
            "test" => self.update_test(id, input).await,
            "instance_profile" => self.update_instance_profile(id, input).await,
            "network_profile" => self.update_network_profile(id, input).await,
            "device_pool" => self.update_device_pool(id, input).await,
            "upload" => self.update_upload(id, input).await,
            "account_settings" => self.update_account_settings(id, input).await,
            "project" => self.update_project(id, input).await,
            "vpce_configuration" => self.update_vpce_configuration(id, input).await,
            "run" => self.update_run(id, input).await,
            "device" => self.update_device(id, input).await,
            "suite" => self.update_suite(id, input).await,
            "remote_access_session" => self.update_remote_access_session(id, input).await,
            "job" => self.update_job(id, input).await,
            "test_grid_session" => self.update_test_grid_session(id, input).await,
            "device_instance" => self.update_device_instance(id, input).await,
            "device_pool_compatibility" => self.update_device_pool_compatibility(id, input).await,
            "offering_status" => self.update_offering_status(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "device_farm", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "test_grid_url" => self.delete_test_grid_url(id).await,
            "test_grid_project" => self.delete_test_grid_project(id).await,
            "test" => self.delete_test(id).await,
            "instance_profile" => self.delete_instance_profile(id).await,
            "network_profile" => self.delete_network_profile(id).await,
            "device_pool" => self.delete_device_pool(id).await,
            "upload" => self.delete_upload(id).await,
            "account_settings" => self.delete_account_settings(id).await,
            "project" => self.delete_project(id).await,
            "vpce_configuration" => self.delete_vpce_configuration(id).await,
            "run" => self.delete_run(id).await,
            "device" => self.delete_device(id).await,
            "suite" => self.delete_suite(id).await,
            "remote_access_session" => self.delete_remote_access_session(id).await,
            "job" => self.delete_job(id).await,
            "test_grid_session" => self.delete_test_grid_session(id).await,
            "device_instance" => self.delete_device_instance(id).await,
            "device_pool_compatibility" => self.delete_device_pool_compatibility(id).await,
            "offering_status" => self.delete_offering_status(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "device_farm", resource_name
            ))),
    ...
    async fn create_test_grid_url(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_test_grid_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_test_grid_url(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let expires_in_seconds = input.get_string("expires_in_seconds")?;
            let project_arn = input.get_string("project_arn")?;
    ...
    async fn delete_test_grid_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_test_grid_project(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_test_grid_project(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.device_farm_client
    ...
    async fn delete_test_grid_project(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.device_farm_client
    ...
    async fn create_test(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_test(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.device_farm_client
    ...
    async fn update_test(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn create_instance_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let description = input.get_optional_string("description")?;
            let exclude_app_packages_from_cleanup =
                input.get_optional_string("exclude_app_packages_from_cleanup")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    exclude_app_packages_from_cleanup.unwrap_or_default(),
                )
    ...
    async fn create_network_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    downlink_loss_percent.unwrap_or_default(),
                )
                .with_field("project_arn", project_arn.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field(
                    ...
                    uplink_bandwidth_bits.unwrap_or_default(),
                )
                .with_field(
                    "downlink_bandwidth_bits",
                    downlink_bandwidth_bits.unwrap_or_default(),
                )
                .with_field("downlink_delay_ms", downlink_delay_ms.unwrap_or_default())
                .with_field(
                    "uplink_loss_percent",
                    uplink_loss_percent.unwrap_or_default(),
                )
    ...
    async fn read_network_profile(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.device_farm_client
    ...
    async fn delete_network_profile(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.device_farm_client
    ...
    async fn create_device_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_device_pool(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.device_farm_client
    ...
    async fn update_device_pool(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let max_devices = input.get_optional_string("max_devices")?;
            let project_arn = input.get_string("project_arn")?;
    ...
    async fn delete_device_pool(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.device_farm_client
    ...
    async fn create_upload(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let project_arn = input.get_string("project_arn")?;
    ...
    async fn read_upload(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.device_farm_client
    ...
    async fn update_upload(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let project_arn = input.get_string("project_arn")?;
            let content_type = input.get_optional_string("content_type")?;
    ...
    async fn create_project(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
            let default_job_timeout_minutes =
                input.get_optional_string("default_job_timeout_minutes")?;
            let vpc_config = input.get_optional_string("vpc_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    default_job_timeout_minutes.unwrap_or_default(),
                )
                .with_field("vpc_config", vpc_config.unwrap_or_default()))
        })
    }
    ...
    async fn create_vpce_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let vpce_service_name = input.get_string("vpce_service_name")?;
            let vpce_configuration_description =
                input.get_optional_string("vpce_configuration_description")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    vpce_configuration_description.unwrap_or_default(),
                )
                .with_field("service_dns_name", service_dns_name.unwrap_or_default())
                .with_field(
                    "vpce_configuration_name",
                    vpce_configuration_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a vpce_configuration resource
    async fn read_vpce_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.device_farm_client
    ...
    async fn delete_vpce_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.device_farm_client
    ...
    async fn create_suite(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_suite(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.device_farm_client
    ...
    async fn update_suite(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_suite(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.device_farm_client
    ...
    async fn create_remote_access_session(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    remote_debug_enabled.unwrap_or_default(),
                )
                .with_field("instance_arn", instance_arn.unwrap_or_default())
                .with_field(
                    "remote_record_enabled",
                    remote_record_enabled.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    remote_record_app_arn.unwrap_or_default(),
                )
                .with_field("project_arn", project_arn.unwrap_or_default())
    ...
    async fn read_remote_access_session(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.device_farm_client
    ...
    async fn delete_remote_access_session(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.device_farm_client
    ...
    async fn create_test_grid_session(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_test_grid_session(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.device_farm_client
    ...
    async fn delete_test_grid_session(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.device_farm_client
    ...
    async fn create_device_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_device_instance(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.device_farm_client
    ...
    async fn delete_device_instance(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.device_farm_client
    ...
    async fn read_device_pool_compatibility(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.device_farm_client
    ...
    async fn delete_device_pool_compatibility(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.device_farm_client
    ...
    async fn create_offering_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_offering_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.device_farm_client
    ...
    async fn delete_offering_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.device_farm_client
