...
impl<'a> Test_grid_project<'a> {
    ...
    pub async fn create(&self, name: String, description: Option<String>, vpc_config: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, description: Option<String>, vpc_config: Option<String>) -> Result<()> {
