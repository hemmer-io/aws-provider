...
impl<'a> Test_grid_project<'a> {
    ...
    pub async fn create(&self, vpc_config: Option<String>, description: Option<String>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, vpc_config: Option<String>, description: Option<String>, name: Option<String>) -> Result<()> {
