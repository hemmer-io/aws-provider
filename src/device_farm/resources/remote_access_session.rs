...
impl<'a> Remote_access_session<'a> {
    ...
    pub async fn create(&self, device_arn: String, remote_debug_enabled: Option<bool>, instance_arn: Option<String>, remote_record_enabled: Option<bool>, client_id: Option<String>, configuration: Option<String>, interaction_mode: Option<String>, skip_app_resign: Option<bool>, name: Option<String>, ssh_public_key: Option<String>, remote_record_app_arn: Option<String>, project_arn: String, app_arn: Option<String>) -> Result<String> {
