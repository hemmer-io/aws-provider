//! Apigatewaymanagementapi service for Aws provider
//!
//! This module handles all apigatewaymanagementapi resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Apigatewaymanagementapi service handler
...
impl<'a> ApigatewaymanagementapiService<'a> {
    ...
    async fn create_connection(
        ...
        self.provider.runtime().block_on(async {
            ...
            // Example:
            // let result = self.provider.apigatewaymanagementapi_client
            //     .create_connection()
            //     .set_name(name)
            //     .send()
            //     .await
    ...
    async fn delete_connection(
        ...
        self.provider.runtime().block_on(async {
            ...
            // Example:
            // self.provider.apigatewaymanagementapi_client
            //     .delete_connection()
            //     .set_id(id.to_string())
            //     .send()
            //     .await
