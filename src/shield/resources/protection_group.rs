...
impl<'a> Protection_group<'a> {
    ...
    pub async fn create(&self, aggregation: String, resource_type: Option<String>, pattern: String, members: Option<Vec<String>>, tags: Option<Vec<String>>, protection_group_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, aggregation: Option<String>, resource_type: Option<String>, pattern: Option<String>, members: Option<Vec<String>>, tags: Option<Vec<String>>, protection_group_id: Option<String>) -> Result<()> {
