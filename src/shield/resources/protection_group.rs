...
impl<'a> Protection_group<'a> {
    ...
    pub async fn create(&self, resource_type: Option<String>, pattern: String, protection_group_id: String, tags: Option<Vec<String>>, members: Option<Vec<String>>, aggregation: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, resource_type: Option<String>, pattern: Option<String>, protection_group_id: Option<String>, tags: Option<Vec<String>>, members: Option<Vec<String>>, aggregation: Option<String>) -> Result<()> {
