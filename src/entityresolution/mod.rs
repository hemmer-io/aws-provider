...
impl<'a> EntityresolutionService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "provider_service" => {
                self.plan_provider_service(current_state, desired_input)
                    .await
            }
            "matching_workflow" => {
                self.plan_matching_workflow(current_state, desired_input)
                    .await
            }
            "id_mapping_job" => self.plan_id_mapping_job(current_state, desired_input).await,
            "id_namespace" => self.plan_id_namespace(current_state, desired_input).await,
            "match_id" => self.plan_match_id(current_state, desired_input).await,
            "policy_statement" => {
                self.plan_policy_statement(current_state, desired_input)
                    .await
            }
            "matching_job" => self.plan_matching_job(current_state, desired_input).await,
            "schema_mapping" => self.plan_schema_mapping(current_state, desired_input).await,
            "id_mapping_workflow" => {
                self.plan_id_mapping_workflow(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "entityresolution", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "provider_service" => self.create_provider_service(input).await,
            "matching_workflow" => self.create_matching_workflow(input).await,
            "id_mapping_job" => self.create_id_mapping_job(input).await,
            "id_namespace" => self.create_id_namespace(input).await,
            "match_id" => self.create_match_id(input).await,
            "policy_statement" => self.create_policy_statement(input).await,
            "matching_job" => self.create_matching_job(input).await,
            "schema_mapping" => self.create_schema_mapping(input).await,
            "id_mapping_workflow" => self.create_id_mapping_workflow(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "entityresolution", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "provider_service" => self.read_provider_service(id).await,
            "matching_workflow" => self.read_matching_workflow(id).await,
            "id_mapping_job" => self.read_id_mapping_job(id).await,
            "id_namespace" => self.read_id_namespace(id).await,
            "match_id" => self.read_match_id(id).await,
            "policy_statement" => self.read_policy_statement(id).await,
            "matching_job" => self.read_matching_job(id).await,
            "schema_mapping" => self.read_schema_mapping(id).await,
            "id_mapping_workflow" => self.read_id_mapping_workflow(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "entityresolution", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "provider_service" => self.update_provider_service(id, input).await,
            "matching_workflow" => self.update_matching_workflow(id, input).await,
            "id_mapping_job" => self.update_id_mapping_job(id, input).await,
            "id_namespace" => self.update_id_namespace(id, input).await,
            "match_id" => self.update_match_id(id, input).await,
            "policy_statement" => self.update_policy_statement(id, input).await,
            "matching_job" => self.update_matching_job(id, input).await,
            "schema_mapping" => self.update_schema_mapping(id, input).await,
            "id_mapping_workflow" => self.update_id_mapping_workflow(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "entityresolution", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "provider_service" => self.delete_provider_service(id).await,
            "matching_workflow" => self.delete_matching_workflow(id).await,
            "id_mapping_job" => self.delete_id_mapping_job(id).await,
            "id_namespace" => self.delete_id_namespace(id).await,
            "match_id" => self.delete_match_id(id).await,
            "policy_statement" => self.delete_policy_statement(id).await,
            "matching_job" => self.delete_matching_job(id).await,
            "schema_mapping" => self.delete_schema_mapping(id).await,
            "id_mapping_workflow" => self.delete_id_mapping_workflow(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "entityresolution", resource_name
            ))),
    ...
    async fn create_provider_service(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_provider_service(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.entityresolution_client
    ...
    async fn delete_provider_service(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.entityresolution_client
    ...
    async fn create_matching_workflow(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    incremental_run_config.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "output_source_config",
                    output_source_config.unwrap_or_default(),
                )
                .with_field("workflow_name", workflow_name.unwrap_or_default())
                .with_field(
                    "input_source_config",
                    input_source_config.unwrap_or_default(),
                )
                .with_field(
                    "resolution_techniques",
                    resolution_techniques.unwrap_or_default(),
                ))
        })
    }

    /// Read a matching_workflow resource
    async fn read_matching_workflow(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.entityresolution_client
    ...
    async fn delete_matching_workflow(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.entityresolution_client
    ...
    async fn create_id_mapping_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_id_mapping_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.entityresolution_client
    ...
    async fn delete_id_mapping_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.entityresolution_client
    ...
    async fn create_id_namespace(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let input_source_config = input.get_optional_string("input_source_config")?;
            let id_mapping_workflow_properties =
                input.get_optional_string("id_mapping_workflow_properties")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    id_mapping_workflow_properties.unwrap_or_default(),
                )
    ...
    async fn read_id_namespace(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.entityresolution_client
    ...
    async fn update_id_namespace(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let input_source_config = input.get_optional_string("input_source_config")?;
            let id_mapping_workflow_properties =
    ...
    async fn delete_id_namespace(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.entityresolution_client
    ...
    async fn create_match_id(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_match_id(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.entityresolution_client
    ...
    async fn update_match_id(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_match_id(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.entityresolution_client
    ...
    async fn create_policy_statement(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_policy_statement(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.entityresolution_client
    ...
    async fn delete_policy_statement(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.entityresolution_client
    ...
    async fn create_matching_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_matching_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.entityresolution_client
    ...
    async fn update_matching_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_matching_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.entityresolution_client
    ...
    async fn create_schema_mapping(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "mapped_input_fields",
                    mapped_input_fields.unwrap_or_default(),
                )
    ...
    async fn read_schema_mapping(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.entityresolution_client
    ...
    async fn delete_schema_mapping(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.entityresolution_client
    ...
    async fn create_id_mapping_workflow(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let description = input.get_optional_string("description")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    id_mapping_techniques.unwrap_or_default(),
                )
                .with_field(
                    "output_source_config",
                    output_source_config.unwrap_or_default(),
    ...
    async fn read_id_mapping_workflow(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.entityresolution_client
    ...
    async fn delete_id_mapping_workflow(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.entityresolution_client
