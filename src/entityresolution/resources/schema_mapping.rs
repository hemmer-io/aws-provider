...
impl<'a> Schema_mapping<'a> {
    ...
    pub async fn create(&self, description: Option<String>, tags: Option<HashMap<String, String>>, mapped_input_fields: Vec<String>, schema_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, tags: Option<HashMap<String, String>>, mapped_input_fields: Option<Vec<String>>, schema_name: Option<String>) -> Result<()> {
