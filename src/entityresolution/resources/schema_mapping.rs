...
impl<'a> Schema_mapping<'a> {
    ...
    pub async fn create(&self, schema_name: String, description: Option<String>, tags: Option<HashMap<String, String>>, mapped_input_fields: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, schema_name: Option<String>, description: Option<String>, tags: Option<HashMap<String, String>>, mapped_input_fields: Option<Vec<String>>) -> Result<()> {
