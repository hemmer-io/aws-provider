...
impl<'a> Schema_mapping<'a> {
    ...
    pub async fn create(&self, description: Option<String>, schema_name: String, mapped_input_fields: Vec<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, schema_name: Option<String>, mapped_input_fields: Option<Vec<String>>, tags: Option<HashMap<String, String>>) -> Result<()> {
