...
impl<'a> Schema_mapping<'a> {
    ...
    pub async fn create(&self, mapped_input_fields: Vec<String>, schema_name: String, tags: Option<HashMap<String, String>>, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, mapped_input_fields: Option<Vec<String>>, schema_name: Option<String>, tags: Option<HashMap<String, String>>, description: Option<String>) -> Result<()> {
