...
impl<'a> Attribute_group<'a> {
    ...
    pub async fn create(&self, attributes: String, description: Option<String>, name: String, tags: Option<HashMap<String, String>>, client_token: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, attributes: Option<String>, description: Option<String>, name: Option<String>, tags: Option<HashMap<String, String>>, client_token: Option<String>) -> Result<()> {
