...
impl<'a> Provisioned_product_properties<'a> {
    ...
    pub async fn update(&self, id: &str, accept_language: Option<String>, provisioned_product_properties: Option<HashMap<String, String>>, idempotency_token: Option<String>, provisioned_product_id: Option<String>) -> Result<()> {
