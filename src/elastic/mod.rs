//! Elastic Service
//!
//! Auto-generated service module for elastic

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for elastic
pub struct ElasticService<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> ElasticService<'a> {
    ...
    /// Get lbcookie_stickiness_policy resource handler
    pub fn lbcookie_stickiness_policy(&self) -> resources::Lbcookie_stickiness_policy<'_> {
        resources::Lbcookie_stickiness_policy::new(self.provider)
    }
