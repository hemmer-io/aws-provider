...
impl<'a> Resource_server<'a> {
    ...
    pub async fn create(&self, scopes: Option<Vec<String>>, name: String, identifier: String, user_pool_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, scopes: Option<Vec<String>>, name: Option<String>, identifier: Option<String>, user_pool_id: Option<String>) -> Result<()> {
