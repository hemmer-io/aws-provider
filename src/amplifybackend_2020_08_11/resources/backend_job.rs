...
impl<'a> Backend_job<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, status: Option<String>, job_id: Option<String>, operation: Option<String>, app_id: Option<String>, backend_environment_name: Option<String>) -> Result<()> {
