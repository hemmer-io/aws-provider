...
impl<'a> Cognito_identity_providerService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "user_pool_client" => {
                self.plan_user_pool_client(current_state, desired_input)
                    .await
            }
            "resource_server" => {
                self.plan_resource_server(current_state, desired_input)
                    .await
            }
            "signing_certificate" => {
            ...
            "user_pool_mfa_config" => {
                self.plan_user_pool_mfa_config(current_state, desired_input)
                    .await
            }
            "user_attribute_verification_code" => {
                self.plan_user_attribute_verification_code(current_state, desired_input)
                    .await
            }
            "managed_login_branding" => {
                self.plan_managed_login_branding(current_state, desired_input)
                    .await
            }
            "tokens_from_refresh_token" => {
                self.plan_tokens_from_refresh_token(current_state, desired_input)
                    .await
            }
            "user_auth_factors" => {
                self.plan_user_auth_factors(current_state, desired_input)
                    .await
            }
            "risk_configuration" => {
                self.plan_risk_configuration(current_state, desired_input)
                    .await
            }
            "terms" => self.plan_terms(current_state, desired_input).await,
            "user_attributes" => {
                self.plan_user_attributes(current_state, desired_input)
                    .await
            }
            "device" => self.plan_device(current_state, desired_input).await,
            "managed_login_branding_by_client" => {
                self.plan_managed_login_branding_by_client(current_state, desired_input)
                    .await
            }
            "user_import_job" => {
                self.plan_user_import_job(current_state, desired_input)
                    .await
            }
            "group" => self.plan_group(current_state, desired_input).await,
            "user" => self.plan_user(current_state, desired_input).await,
            "log_delivery_configuration" => {
                self.plan_log_delivery_configuration(current_state, desired_input)
                    .await
            }
            "ui_customization" => {
                self.plan_ui_customization(current_state, desired_input)
                    .await
            }
            "identity_provider_by_identifier" => {
                self.plan_identity_provider_by_identifier(current_state, desired_input)
                    .await
            }
            "user_pool_domain" => {
                self.plan_user_pool_domain(current_state, desired_input)
                    .await
            }
            "csv_header" => self.plan_csv_header(current_state, desired_input).await,
            "web_authn_credential" => {
                self.plan_web_authn_credential(current_state, desired_input)
                    .await
            }
            "auth_event_feedback" => {
                self.plan_auth_event_feedback(current_state, desired_input)
                    .await
            }
            "user_pool" => self.plan_user_pool(current_state, desired_input).await,
            "identity_provider" => {
                self.plan_identity_provider(current_state, desired_input)
                    .await
            }
            "device_status" => self.plan_device_status(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cognito_identity_provider", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "user_pool_client" => self.create_user_pool_client(input).await,
            "resource_server" => self.create_resource_server(input).await,
            "signing_certificate" => self.create_signing_certificate(input).await,
            "user_pool_mfa_config" => self.create_user_pool_mfa_config(input).await,
            "user_attribute_verification_code" => {
                self.create_user_attribute_verification_code(input).await
            }
            "managed_login_branding" => self.create_managed_login_branding(input).await,
            "tokens_from_refresh_token" => self.create_tokens_from_refresh_token(input).await,
            "user_auth_factors" => self.create_user_auth_factors(input).await,
            "risk_configuration" => self.create_risk_configuration(input).await,
            "terms" => self.create_terms(input).await,
            "user_attributes" => self.create_user_attributes(input).await,
            "device" => self.create_device(input).await,
            "managed_login_branding_by_client" => {
                self.create_managed_login_branding_by_client(input).await
            }
            "user_import_job" => self.create_user_import_job(input).await,
            "group" => self.create_group(input).await,
            "user" => self.create_user(input).await,
            "log_delivery_configuration" => self.create_log_delivery_configuration(input).await,
            "ui_customization" => self.create_ui_customization(input).await,
            "identity_provider_by_identifier" => {
                self.create_identity_provider_by_identifier(input).await
            }
            "user_pool_domain" => self.create_user_pool_domain(input).await,
            "csv_header" => self.create_csv_header(input).await,
            "web_authn_credential" => self.create_web_authn_credential(input).await,
            "auth_event_feedback" => self.create_auth_event_feedback(input).await,
            "user_pool" => self.create_user_pool(input).await,
            "identity_provider" => self.create_identity_provider(input).await,
            "device_status" => self.create_device_status(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cognito_identity_provider", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "user_pool_client" => self.read_user_pool_client(id).await,
            "resource_server" => self.read_resource_server(id).await,
            "signing_certificate" => self.read_signing_certificate(id).await,
            "user_pool_mfa_config" => self.read_user_pool_mfa_config(id).await,
            "user_attribute_verification_code" => {
                self.read_user_attribute_verification_code(id).await
            }
            "managed_login_branding" => self.read_managed_login_branding(id).await,
            "tokens_from_refresh_token" => self.read_tokens_from_refresh_token(id).await,
            "user_auth_factors" => self.read_user_auth_factors(id).await,
            "risk_configuration" => self.read_risk_configuration(id).await,
            "terms" => self.read_terms(id).await,
            "user_attributes" => self.read_user_attributes(id).await,
            "device" => self.read_device(id).await,
            "managed_login_branding_by_client" => {
                self.read_managed_login_branding_by_client(id).await
            }
            "user_import_job" => self.read_user_import_job(id).await,
            "group" => self.read_group(id).await,
            "user" => self.read_user(id).await,
            "log_delivery_configuration" => self.read_log_delivery_configuration(id).await,
            "ui_customization" => self.read_ui_customization(id).await,
            "identity_provider_by_identifier" => {
                self.read_identity_provider_by_identifier(id).await
            }
            "user_pool_domain" => self.read_user_pool_domain(id).await,
            "csv_header" => self.read_csv_header(id).await,
            "web_authn_credential" => self.read_web_authn_credential(id).await,
            "auth_event_feedback" => self.read_auth_event_feedback(id).await,
            "user_pool" => self.read_user_pool(id).await,
            "identity_provider" => self.read_identity_provider(id).await,
            "device_status" => self.read_device_status(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cognito_identity_provider", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "user_pool_client" => self.update_user_pool_client(id, input).await,
            "resource_server" => self.update_resource_server(id, input).await,
            "signing_certificate" => self.update_signing_certificate(id, input).await,
            "user_pool_mfa_config" => self.update_user_pool_mfa_config(id, input).await,
            "user_attribute_verification_code" => {
                self.update_user_attribute_verification_code(id, input)
                    .await
            }
            "managed_login_branding" => self.update_managed_login_branding(id, input).await,
            "tokens_from_refresh_token" => self.update_tokens_from_refresh_token(id, input).await,
            "user_auth_factors" => self.update_user_auth_factors(id, input).await,
            "risk_configuration" => self.update_risk_configuration(id, input).await,
            "terms" => self.update_terms(id, input).await,
            "user_attributes" => self.update_user_attributes(id, input).await,
            "device" => self.update_device(id, input).await,
            "managed_login_branding_by_client" => {
                self.update_managed_login_branding_by_client(id, input)
                    .await
            }
            "user_import_job" => self.update_user_import_job(id, input).await,
            "group" => self.update_group(id, input).await,
            "user" => self.update_user(id, input).await,
            "log_delivery_configuration" => self.update_log_delivery_configuration(id, input).await,
            "ui_customization" => self.update_ui_customization(id, input).await,
            "identity_provider_by_identifier" => {
                self.update_identity_provider_by_identifier(id, input).await
            }
            "user_pool_domain" => self.update_user_pool_domain(id, input).await,
            "csv_header" => self.update_csv_header(id, input).await,
            "web_authn_credential" => self.update_web_authn_credential(id, input).await,
            "auth_event_feedback" => self.update_auth_event_feedback(id, input).await,
            "user_pool" => self.update_user_pool(id, input).await,
            "identity_provider" => self.update_identity_provider(id, input).await,
            "device_status" => self.update_device_status(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cognito_identity_provider", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "user_pool_client" => self.delete_user_pool_client(id).await,
            "resource_server" => self.delete_resource_server(id).await,
            "signing_certificate" => self.delete_signing_certificate(id).await,
            "user_pool_mfa_config" => self.delete_user_pool_mfa_config(id).await,
            "user_attribute_verification_code" => {
                self.delete_user_attribute_verification_code(id).await
            }
            "managed_login_branding" => self.delete_managed_login_branding(id).await,
            "tokens_from_refresh_token" => self.delete_tokens_from_refresh_token(id).await,
            "user_auth_factors" => self.delete_user_auth_factors(id).await,
            "risk_configuration" => self.delete_risk_configuration(id).await,
            "terms" => self.delete_terms(id).await,
            "user_attributes" => self.delete_user_attributes(id).await,
            "device" => self.delete_device(id).await,
            "managed_login_branding_by_client" => {
                self.delete_managed_login_branding_by_client(id).await
            }
            "user_import_job" => self.delete_user_import_job(id).await,
            "group" => self.delete_group(id).await,
            "user" => self.delete_user(id).await,
            "log_delivery_configuration" => self.delete_log_delivery_configuration(id).await,
            "ui_customization" => self.delete_ui_customization(id).await,
            "identity_provider_by_identifier" => {
                self.delete_identity_provider_by_identifier(id).await
            }
            "user_pool_domain" => self.delete_user_pool_domain(id).await,
            "csv_header" => self.delete_csv_header(id).await,
            "web_authn_credential" => self.delete_web_authn_credential(id).await,
            "auth_event_feedback" => self.delete_auth_event_feedback(id).await,
            "user_pool" => self.delete_user_pool(id).await,
            "identity_provider" => self.delete_identity_provider(id).await,
            "device_status" => self.delete_device_status(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cognito_identity_provider", resource_name
            ))),
    ...
    async fn create_user_pool_client(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let supported_identity_providers =
                input.get_optional_string("supported_identity_providers")?;
            ...
            let prevent_user_existence_errors =
                input.get_optional_string("prevent_user_existence_errors")?;
            let enable_token_revocation = input.get_optional_string("enable_token_revocation")?;
            let enable_propagate_additional_user_context_data =
                input.get_optional_string("enable_propagate_additional_user_context_data")?;
            ...
            let allowed_o_auth_flows_user_pool_client =
                input.get_optional_string("allowed_o_auth_flows_user_pool_client")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    supported_identity_providers.unwrap_or_default(),
                )
                .with_field(
                    "access_token_validity",
                    access_token_validity.unwrap_or_default(),
                )
                .with_field(
                    "allowed_o_auth_scopes",
                    allowed_o_auth_scopes.unwrap_or_default(),
                )
                .with_field(
                    "prevent_user_existence_errors",
                    prevent_user_existence_errors.unwrap_or_default(),
                )
                .with_field(
                    "enable_token_revocation",
                    enable_token_revocation.unwrap_or_default(),
                )
                .with_field(
                    "enable_propagate_additional_user_context_data",
                    enable_propagate_additional_user_context_data.unwrap_or_default(),
                )
                .with_field("id_token_validity", id_token_validity.unwrap_or_default())
                .with_field(
                    "explicit_auth_flows",
                    explicit_auth_flows.unwrap_or_default(),
                )
                .with_field(
                ...
                .with_field(
                    ...
                    default_redirect_uri.unwrap_or_default(),
                )
                .with_field(
                    "refresh_token_rotation",
                    refresh_token_rotation.unwrap_or_default(),
                )
                .with_field(
                    "auth_session_validity",
                    auth_session_validity.unwrap_or_default(),
                )
                .with_field("user_pool_id", user_pool_id.unwrap_or_default())
                .with_field(
                    "token_validity_units",
                    token_validity_units.unwrap_or_default(),
                )
                .with_field(
                    "allowed_o_auth_flows",
                    allowed_o_auth_flows.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    allowed_o_auth_flows_user_pool_client.unwrap_or_default(),
                )
                .with_field(
                    "refresh_token_validity",
                    refresh_token_validity.unwrap_or_default(),
                )
    ...
    async fn read_user_pool_client(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_user_pool_client(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_resource_server(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_resource_server(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_resource_server(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_user_pool_mfa_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_user_pool_mfa_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_user_pool_mfa_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn read_user_attribute_verification_code(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_user_attribute_verification_code(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_managed_login_branding(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let use_cognito_provided_values =
                input.get_optional_string("use_cognito_provided_values")?;
            let user_pool_id = input.get_string("user_pool_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    use_cognito_provided_values.unwrap_or_default(),
                )
                .with_field("user_pool_id", user_pool_id.unwrap_or_default()))
        })
    }
    ...
    async fn read_managed_login_branding(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_managed_login_branding(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn read_tokens_from_refresh_token(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_tokens_from_refresh_token(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_user_auth_factors(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_user_auth_factors(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_user_auth_factors(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_risk_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_risk_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_risk_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_terms(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_terms(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn update_terms(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let enforcement = input.get_string("enforcement")?;
            let links = input.get_optional_string("links")?;
    ...
    async fn delete_terms(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_user_attributes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_user_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_user_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn read_managed_login_branding_by_client(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_managed_login_branding_by_client(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_user_import_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let user_pool_id = input.get_string("user_pool_id")?;
    ...
    async fn read_user_import_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_user_import_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn read_log_delivery_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_log_delivery_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_ui_customization(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_ui_customization(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_ui_customization(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn read_identity_provider_by_identifier(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_identity_provider_by_identifier(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_user_pool_domain(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    managed_login_version.unwrap_or_default(),
                )
                .with_field("user_pool_id", user_pool_id.unwrap_or_default())
                .with_field("domain", domain.unwrap_or_default())
                .with_field(
                    "custom_domain_config",
                    custom_domain_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a user_pool_domain resource
    async fn read_user_pool_domain(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_user_pool_domain(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_csv_header(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_csv_header(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn update_csv_header(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_csv_header(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_web_authn_credential(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_web_authn_credential(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_web_authn_credential(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_auth_event_feedback(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_auth_event_feedback(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_auth_event_feedback(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_user_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let user_attribute_update_settings =
                input.get_optional_string("user_attribute_update_settings")?;
            ...
            let verification_message_template =
                input.get_optional_string("verification_message_template")?;
            let email_verification_subject =
                input.get_optional_string("email_verification_subject")?;
            ...
            let email_verification_message =
                input.get_optional_string("email_verification_message")?;
            ...
            let sms_authentication_message =
                input.get_optional_string("sms_authentication_message")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    user_attribute_update_settings.unwrap_or_default(),
                )
                .with_field("user_pool_tags", user_pool_tags.unwrap_or_default())
                .with_field("user_pool_tier", user_pool_tier.unwrap_or_default())
                .with_field(
                    "account_recovery_setting",
                    account_recovery_setting.unwrap_or_default(),
                )
                .with_field(
                    "verification_message_template",
                    verification_message_template.unwrap_or_default(),
                )
                .with_field(
                    "email_verification_subject",
                    email_verification_subject.unwrap_or_default(),
                )
                .with_field(
                    "device_configuration",
                    device_configuration.unwrap_or_default(),
                )
                .with_field("sms_configuration", sms_configuration.unwrap_or_default())
                .with_field("policies", policies.unwrap_or_default())
                .with_field(
                    "username_configuration",
                    username_configuration.unwrap_or_default(),
                )
                .with_field(
                    "username_attributes",
                    username_attributes.unwrap_or_default(),
                )
                .with_field(
                    "sms_verification_message",
                    sms_verification_message.unwrap_or_default(),
                )
                .with_field(
                    "email_configuration",
                    email_configuration.unwrap_or_default(),
                )
                .with_field(
                    "email_verification_message",
                    email_verification_message.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    admin_create_user_config.unwrap_or_default(),
                )
                .with_field(
                    "auto_verified_attributes",
                    auto_verified_attributes.unwrap_or_default(),
                )
                .with_field(
                    "sms_authentication_message",
                    sms_authentication_message.unwrap_or_default(),
                )
    ...
    async fn read_user_pool(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn update_user_pool(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let deletion_protection = input.get_optional_string("deletion_protection")?;
            let lambda_config = input.get_optional_string("lambda_config")?;
    ...
    async fn delete_user_pool(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_identity_provider(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let user_pool_id = input.get_string("user_pool_id")?;
    ...
    async fn read_identity_provider(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn delete_identity_provider(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
    ...
    async fn create_device_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    device_remembered_status.unwrap_or_default(),
                ))
        })
    }

    /// Read a device_status resource
    async fn read_device_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_identity_provider_client
    ...
    async fn update_device_status(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let device_key = input.get_string("device_key")?;
            let access_token = input.get_string("access_token")?;
    ...
    async fn delete_device_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_identity_provider_client
