...
impl<'a> Managed_login_branding<'a> {
    ...
    pub async fn create(&self, settings: Option<String>, user_pool_id: String, assets: Option<Vec<String>>, use_cognito_provided_values: Option<bool>, client_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, settings: Option<String>, user_pool_id: Option<String>, assets: Option<Vec<String>>, use_cognito_provided_values: Option<bool>, client_id: Option<String>) -> Result<()> {
