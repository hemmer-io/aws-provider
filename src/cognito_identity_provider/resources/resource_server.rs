...
impl<'a> Resource_server<'a> {
    ...
    pub async fn create(&self, identifier: String, user_pool_id: String, scopes: Option<Vec<String>>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, identifier: Option<String>, user_pool_id: Option<String>, scopes: Option<Vec<String>>, name: Option<String>) -> Result<()> {
