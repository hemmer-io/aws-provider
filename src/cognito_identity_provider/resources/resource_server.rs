...
impl<'a> Resource_server<'a> {
    ...
    pub async fn create(&self, scopes: Option<Vec<String>>, name: String, user_pool_id: String, identifier: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, scopes: Option<Vec<String>>, name: Option<String>, user_pool_id: Option<String>, identifier: Option<String>) -> Result<()> {
