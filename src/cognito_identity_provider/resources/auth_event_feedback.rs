...
impl<'a> Auth_event_feedback<'a> {
    ...
    pub async fn update(&self, id: &str, feedback_token: Option<String>, user_pool_id: Option<String>, username: Option<String>, event_id: Option<String>, feedback_value: Option<String>) -> Result<()> {
