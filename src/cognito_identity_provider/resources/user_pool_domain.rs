...
impl<'a> User_pool_domain<'a> {
    ...
    pub async fn create(&self, custom_domain_config: Option<String>, user_pool_id: String, domain: String, managed_login_version: Option<i64>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, custom_domain_config: Option<String>, user_pool_id: Option<String>, domain: Option<String>, managed_login_version: Option<i64>) -> Result<()> {
