...
impl<'a> User_pool_domain<'a> {
    ...
    pub async fn create(&self, managed_login_version: Option<i64>, user_pool_id: String, domain: String, custom_domain_config: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, managed_login_version: Option<i64>, user_pool_id: Option<String>, domain: Option<String>, custom_domain_config: Option<String>) -> Result<()> {
