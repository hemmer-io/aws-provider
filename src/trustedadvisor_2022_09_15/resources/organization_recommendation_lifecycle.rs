...
impl<'a> Organization_recommendation_lifecycle<'a> {
    ...
    pub async fn update(&self, id: &str, organization_recommendation_identifier: Option<String>, update_reason: Option<String>, update_reason_code: Option<String>, lifecycle_stage: Option<String>) -> Result<()> {
