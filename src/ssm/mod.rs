...
impl<'a> SsmService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "ops_items" => self.plan_ops_items(current_state, desired_input).await,
            "association_status" => {
                self.plan_association_status(current_state, desired_input)
                    .await
            }
            "patch_groups" => self.plan_patch_groups(current_state, desired_input).await,
            "managed_instance_role" => {
                self.plan_managed_instance_role(current_state, desired_input)
                    .await
            }
            "maintenance_window_execution_tasks" => {
                self.plan_maintenance_window_execution_tasks(current_state, desired_input)
                    .await
            }
            "effective_instance_associations" => {
                self.plan_effective_instance_associations(current_state, desired_input)
                    .await
            }
            "effective_patches_for_patch_baseline" => {
                self.plan_effective_patches_for_patch_baseline(current_state, desired_input)
                    .await
            }
            ...
            "parameters_by_path" => {
                self.plan_parameters_by_path(current_state, desired_input)
                    .await
            }
            "access_token" => self.plan_access_token(current_state, desired_input).await,
            "maintenance_window" => {
                self.plan_maintenance_window(current_state, desired_input)
                    .await
            }
            "document_permission" => {
                self.plan_document_permission(current_state, desired_input)
                    .await
            }
            "automation_executions" => {
                self.plan_automation_executions(current_state, desired_input)
                    .await
            }
            "instance_patches" => {
                self.plan_instance_patches(current_state, desired_input)
                    .await
            }
            "maintenance_window_execution_task_invocations" => {
                self.plan_maintenance_window_execution_task_invocations(
                    current_state,
                    desired_input,
                )
                .await
            ...
            "instance_patch_states_for_patch_group" => {
                self.plan_instance_patch_states_for_patch_group(current_state, desired_input)
                    .await
            }
            "instance_information" => {
                self.plan_instance_information(current_state, desired_input)
                    .await
            }
            "document_default_version" => {
                self.plan_document_default_version(current_state, desired_input)
                    .await
            }
            "service_setting" => {
                self.plan_service_setting(current_state, desired_input)
                    .await
            }
            "inventory_deletions" => {
                self.plan_inventory_deletions(current_state, desired_input)
                    .await
            }
            "instance_properties" => {
                self.plan_instance_properties(current_state, desired_input)
                    .await
            }
            "maintenance_windows_for_target" => {
                self.plan_maintenance_windows_for_target(current_state, desired_input)
                    .await
            }
            "default_patch_baseline" => {
                self.plan_default_patch_baseline(current_state, desired_input)
                    .await
            }
            "deployable_patch_snapshot_for_instance" => {
                self.plan_deployable_patch_snapshot_for_instance(current_state, desired_input)
                    .await
            }
            "execution_preview" => {
                self.plan_execution_preview(current_state, desired_input)
                    .await
            }
            "maintenance_window_targets" => {
                self.plan_maintenance_window_targets(current_state, desired_input)
                    .await
            }
            "inventory" => self.plan_inventory(current_state, desired_input).await,
            "automation_step_executions" => {
                self.plan_automation_step_executions(current_state, desired_input)
                    .await
            }
            "patch_baseline_for_patch_group" => {
                self.plan_patch_baseline_for_patch_group(current_state, desired_input)
                    .await
            }
            "inventory_schema" => {
                self.plan_inventory_schema(current_state, desired_input)
                    .await
            }
            "maintenance_window_target" => {
                self.plan_maintenance_window_target(current_state, desired_input)
                    .await
            }
            "calendar_state" => self.plan_calendar_state(current_state, desired_input).await,
            "instance_associations_status" => {
                self.plan_instance_associations_status(current_state, desired_input)
                    .await
            }
            "activations" => self.plan_activations(current_state, desired_input).await,
            "command_invocation" => {
                self.plan_command_invocation(current_state, desired_input)
                    .await
            }
            "resource_policy" => {
            ...
            "maintenance_window_execution_task_invocation" => {
                self.plan_maintenance_window_execution_task_invocation(current_state, desired_input)
                    .await
            }
            "association_execution_targets" => {
                self.plan_association_execution_targets(current_state, desired_input)
                    .await
            }
            "patch_baselines" => {
                self.plan_patch_baselines(current_state, desired_input)
                    .await
            }
            "maintenance_window_schedule" => {
                self.plan_maintenance_window_schedule(current_state, desired_input)
                    .await
            }
            "patch_baseline" => self.plan_patch_baseline(current_state, desired_input).await,
            "maintenance_window_tasks" => {
                self.plan_maintenance_window_tasks(current_state, desired_input)
                    .await
            }
            "parameter_history" => {
                self.plan_parameter_history(current_state, desired_input)
                    .await
            }
            "maintenance_windows" => {
                self.plan_maintenance_windows(current_state, desired_input)
                    .await
            }
            "association_executions" => {
                self.plan_association_executions(current_state, desired_input)
                    .await
            }
            "connection_status" => {
                self.plan_connection_status(current_state, desired_input)
                    .await
            }
            "available_patches" => {
                self.plan_available_patches(current_state, desired_input)
                    .await
            }
            "parameter" => self.plan_parameter(current_state, desired_input).await,
            "instance_patch_states" => {
                self.plan_instance_patch_states(current_state, desired_input)
                    .await
            }
            "association_batch" => {
                self.plan_association_batch(current_state, desired_input)
                    .await
            }
            "parameters" => self.plan_parameters(current_state, desired_input).await,
            "ops_item" => self.plan_ops_item(current_state, desired_input).await,
            "ops_metadata" => self.plan_ops_metadata(current_state, desired_input).await,
            "patch_properties" => {
                self.plan_patch_properties(current_state, desired_input)
                    .await
            }
            "resource_policies" => {
            ...
            "ops_summary" => self.plan_ops_summary(current_state, desired_input).await,
            "compliance_items" => {
                self.plan_compliance_items(current_state, desired_input)
                    .await
            }
            "maintenance_window_execution" => {
                self.plan_maintenance_window_execution(current_state, desired_input)
                    .await
            }
            "association" => self.plan_association(current_state, desired_input).await,
            "activation" => self.plan_activation(current_state, desired_input).await,
            "maintenance_window_task" => {
                self.plan_maintenance_window_task(current_state, desired_input)
                    .await
            }
            "patch_group_state" => {
                self.plan_patch_group_state(current_state, desired_input)
                    .await
            }
            "maintenance_window_executions" => {
                self.plan_maintenance_window_executions(current_state, desired_input)
                    .await
            }
            "document_metadata" => {
                self.plan_document_metadata(current_state, desired_input)
                    .await
            }
            "maintenance_window_execution_task" => {
                self.plan_maintenance_window_execution_task(current_state, desired_input)
                    .await
            }
            "automation_execution" => {
                self.plan_automation_execution(current_state, desired_input)
                    .await
            }
            "resource_data_sync" => {
                self.plan_resource_data_sync(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "ops_items" => self.create_ops_items(input).await,
            "association_status" => self.create_association_status(input).await,
            "patch_groups" => self.create_patch_groups(input).await,
            "managed_instance_role" => self.create_managed_instance_role(input).await,
            "maintenance_window_execution_tasks" => {
            ...
            "effective_patches_for_patch_baseline" => {
                self.create_effective_patches_for_patch_baseline(input)
                    .await
            }
            "document" => self.create_document(input).await,
            "sessions" => self.create_sessions(input).await,
            "parameters_by_path" => self.create_parameters_by_path(input).await,
            "access_token" => self.create_access_token(input).await,
            "maintenance_window" => self.create_maintenance_window(input).await,
            "document_permission" => self.create_document_permission(input).await,
            "automation_executions" => self.create_automation_executions(input).await,
            "instance_patches" => self.create_instance_patches(input).await,
            "maintenance_window_execution_task_invocations" => {
                self.create_maintenance_window_execution_task_invocations(input)
                    .await
            }
            "instance_patch_states_for_patch_group" => {
                self.create_instance_patch_states_for_patch_group(input)
                    .await
            }
            "instance_information" => self.create_instance_information(input).await,
            "document_default_version" => self.create_document_default_version(input).await,
            "service_setting" => self.create_service_setting(input).await,
            "inventory_deletions" => self.create_inventory_deletions(input).await,
            "instance_properties" => self.create_instance_properties(input).await,
            "maintenance_windows_for_target" => {
                self.create_maintenance_windows_for_target(input).await
            }
            "default_patch_baseline" => self.create_default_patch_baseline(input).await,
            "deployable_patch_snapshot_for_instance" => {
                self.create_deployable_patch_snapshot_for_instance(input)
                    .await
            }
            "execution_preview" => self.create_execution_preview(input).await,
            "maintenance_window_targets" => self.create_maintenance_window_targets(input).await,
            "inventory" => self.create_inventory(input).await,
            "automation_step_executions" => self.create_automation_step_executions(input).await,
            "patch_baseline_for_patch_group" => {
                self.create_patch_baseline_for_patch_group(input).await
            }
            "inventory_schema" => self.create_inventory_schema(input).await,
            "maintenance_window_target" => self.create_maintenance_window_target(input).await,
            "calendar_state" => self.create_calendar_state(input).await,
            "instance_associations_status" => self.create_instance_associations_status(input).await,
            "activations" => self.create_activations(input).await,
            "command_invocation" => self.create_command_invocation(input).await,
            "resource_policy" => self.create_resource_policy(input).await,
            "maintenance_window_execution_task_invocation" => {
                self.create_maintenance_window_execution_task_invocation(input)
                    .await
            }
            "association_execution_targets" => {
                self.create_association_execution_targets(input).await
            }
            "patch_baselines" => self.create_patch_baselines(input).await,
            "maintenance_window_schedule" => self.create_maintenance_window_schedule(input).await,
            "patch_baseline" => self.create_patch_baseline(input).await,
            "maintenance_window_tasks" => self.create_maintenance_window_tasks(input).await,
            "parameter_history" => self.create_parameter_history(input).await,
            "maintenance_windows" => self.create_maintenance_windows(input).await,
            "association_executions" => self.create_association_executions(input).await,
            "connection_status" => self.create_connection_status(input).await,
            "available_patches" => self.create_available_patches(input).await,
            "parameter" => self.create_parameter(input).await,
            "instance_patch_states" => self.create_instance_patch_states(input).await,
            "association_batch" => self.create_association_batch(input).await,
            "parameters" => self.create_parameters(input).await,
            "ops_item" => self.create_ops_item(input).await,
            "ops_metadata" => self.create_ops_metadata(input).await,
            "patch_properties" => self.create_patch_properties(input).await,
            "resource_policies" => self.create_resource_policies(input).await,
            "ops_summary" => self.create_ops_summary(input).await,
            "compliance_items" => self.create_compliance_items(input).await,
            "maintenance_window_execution" => self.create_maintenance_window_execution(input).await,
            "association" => self.create_association(input).await,
            "activation" => self.create_activation(input).await,
            "maintenance_window_task" => self.create_maintenance_window_task(input).await,
            "patch_group_state" => self.create_patch_group_state(input).await,
            "maintenance_window_executions" => {
                self.create_maintenance_window_executions(input).await
            }
            "document_metadata" => self.create_document_metadata(input).await,
            "maintenance_window_execution_task" => {
                self.create_maintenance_window_execution_task(input).await
            }
            "automation_execution" => self.create_automation_execution(input).await,
            "resource_data_sync" => self.create_resource_data_sync(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ssm", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "ops_items" => self.read_ops_items(id).await,
            "association_status" => self.read_association_status(id).await,
            "patch_groups" => self.read_patch_groups(id).await,
            "managed_instance_role" => self.read_managed_instance_role(id).await,
            "maintenance_window_execution_tasks" => {
            ...
            "parameters_by_path" => self.read_parameters_by_path(id).await,
            "access_token" => self.read_access_token(id).await,
            "maintenance_window" => self.read_maintenance_window(id).await,
            "document_permission" => self.read_document_permission(id).await,
            "automation_executions" => self.read_automation_executions(id).await,
            "instance_patches" => self.read_instance_patches(id).await,
            "maintenance_window_execution_task_invocations" => {
                self.read_maintenance_window_execution_task_invocations(id)
                    .await
            }
            "instance_patch_states_for_patch_group" => {
                self.read_instance_patch_states_for_patch_group(id).await
            }
            "instance_information" => self.read_instance_information(id).await,
            "document_default_version" => self.read_document_default_version(id).await,
            "service_setting" => self.read_service_setting(id).await,
            "inventory_deletions" => self.read_inventory_deletions(id).await,
            "instance_properties" => self.read_instance_properties(id).await,
            "maintenance_windows_for_target" => self.read_maintenance_windows_for_target(id).await,
            "default_patch_baseline" => self.read_default_patch_baseline(id).await,
            "deployable_patch_snapshot_for_instance" => {
                self.read_deployable_patch_snapshot_for_instance(id).await
            }
            "execution_preview" => self.read_execution_preview(id).await,
            "maintenance_window_targets" => self.read_maintenance_window_targets(id).await,
            "inventory" => self.read_inventory(id).await,
            "automation_step_executions" => self.read_automation_step_executions(id).await,
            "patch_baseline_for_patch_group" => self.read_patch_baseline_for_patch_group(id).await,
            "inventory_schema" => self.read_inventory_schema(id).await,
            "maintenance_window_target" => self.read_maintenance_window_target(id).await,
            "calendar_state" => self.read_calendar_state(id).await,
            "instance_associations_status" => self.read_instance_associations_status(id).await,
            "activations" => self.read_activations(id).await,
            "command_invocation" => self.read_command_invocation(id).await,
            "resource_policy" => self.read_resource_policy(id).await,
            "maintenance_window_execution_task_invocation" => {
                self.read_maintenance_window_execution_task_invocation(id)
                    .await
            }
            "association_execution_targets" => self.read_association_execution_targets(id).await,
            "patch_baselines" => self.read_patch_baselines(id).await,
            "maintenance_window_schedule" => self.read_maintenance_window_schedule(id).await,
            "patch_baseline" => self.read_patch_baseline(id).await,
            "maintenance_window_tasks" => self.read_maintenance_window_tasks(id).await,
            "parameter_history" => self.read_parameter_history(id).await,
            "maintenance_windows" => self.read_maintenance_windows(id).await,
            "association_executions" => self.read_association_executions(id).await,
            "connection_status" => self.read_connection_status(id).await,
            "available_patches" => self.read_available_patches(id).await,
            "parameter" => self.read_parameter(id).await,
            "instance_patch_states" => self.read_instance_patch_states(id).await,
            "association_batch" => self.read_association_batch(id).await,
            "parameters" => self.read_parameters(id).await,
            "ops_item" => self.read_ops_item(id).await,
            "ops_metadata" => self.read_ops_metadata(id).await,
            "patch_properties" => self.read_patch_properties(id).await,
            "resource_policies" => self.read_resource_policies(id).await,
            "ops_summary" => self.read_ops_summary(id).await,
            "compliance_items" => self.read_compliance_items(id).await,
            "maintenance_window_execution" => self.read_maintenance_window_execution(id).await,
            "association" => self.read_association(id).await,
            "activation" => self.read_activation(id).await,
            "maintenance_window_task" => self.read_maintenance_window_task(id).await,
            "patch_group_state" => self.read_patch_group_state(id).await,
            "maintenance_window_executions" => self.read_maintenance_window_executions(id).await,
            "document_metadata" => self.read_document_metadata(id).await,
            "maintenance_window_execution_task" => {
                self.read_maintenance_window_execution_task(id).await
            }
            "automation_execution" => self.read_automation_execution(id).await,
            "resource_data_sync" => self.read_resource_data_sync(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ssm", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "ops_items" => self.update_ops_items(id, input).await,
            "association_status" => self.update_association_status(id, input).await,
            "patch_groups" => self.update_patch_groups(id, input).await,
            "managed_instance_role" => self.update_managed_instance_role(id, input).await,
            "maintenance_window_execution_tasks" => {
                self.update_maintenance_window_execution_tasks(id, input)
                    .await
            }
            "effective_instance_associations" => {
            ...
            "effective_patches_for_patch_baseline" => {
                self.update_effective_patches_for_patch_baseline(id, input)
                    .await
            }
            "document" => self.update_document(id, input).await,
            "sessions" => self.update_sessions(id, input).await,
            "parameters_by_path" => self.update_parameters_by_path(id, input).await,
            "access_token" => self.update_access_token(id, input).await,
            "maintenance_window" => self.update_maintenance_window(id, input).await,
            "document_permission" => self.update_document_permission(id, input).await,
            "automation_executions" => self.update_automation_executions(id, input).await,
            "instance_patches" => self.update_instance_patches(id, input).await,
            "maintenance_window_execution_task_invocations" => {
                self.update_maintenance_window_execution_task_invocations(id, input)
                    .await
            }
            "instance_patch_states_for_patch_group" => {
                self.update_instance_patch_states_for_patch_group(id, input)
                    .await
            }
            "instance_information" => self.update_instance_information(id, input).await,
            "document_default_version" => self.update_document_default_version(id, input).await,
            "service_setting" => self.update_service_setting(id, input).await,
            "inventory_deletions" => self.update_inventory_deletions(id, input).await,
            "instance_properties" => self.update_instance_properties(id, input).await,
            "maintenance_windows_for_target" => {
                self.update_maintenance_windows_for_target(id, input).await
            }
            "default_patch_baseline" => self.update_default_patch_baseline(id, input).await,
            "deployable_patch_snapshot_for_instance" => {
                self.update_deployable_patch_snapshot_for_instance(id, input)
                    .await
            }
            "execution_preview" => self.update_execution_preview(id, input).await,
            "maintenance_window_targets" => self.update_maintenance_window_targets(id, input).await,
            "inventory" => self.update_inventory(id, input).await,
            "automation_step_executions" => self.update_automation_step_executions(id, input).await,
            "patch_baseline_for_patch_group" => {
                self.update_patch_baseline_for_patch_group(id, input).await
            }
            "inventory_schema" => self.update_inventory_schema(id, input).await,
            "maintenance_window_target" => self.update_maintenance_window_target(id, input).await,
            "calendar_state" => self.update_calendar_state(id, input).await,
            "instance_associations_status" => {
                self.update_instance_associations_status(id, input).await
            }
            "activations" => self.update_activations(id, input).await,
            "command_invocation" => self.update_command_invocation(id, input).await,
            "resource_policy" => self.update_resource_policy(id, input).await,
            "maintenance_window_execution_task_invocation" => {
                self.update_maintenance_window_execution_task_invocation(id, input)
                    .await
            }
            "association_execution_targets" => {
                self.update_association_execution_targets(id, input).await
            }
            "patch_baselines" => self.update_patch_baselines(id, input).await,
            "maintenance_window_schedule" => {
                self.update_maintenance_window_schedule(id, input).await
            }
            "patch_baseline" => self.update_patch_baseline(id, input).await,
            "maintenance_window_tasks" => self.update_maintenance_window_tasks(id, input).await,
            "parameter_history" => self.update_parameter_history(id, input).await,
            "maintenance_windows" => self.update_maintenance_windows(id, input).await,
            "association_executions" => self.update_association_executions(id, input).await,
            "connection_status" => self.update_connection_status(id, input).await,
            "available_patches" => self.update_available_patches(id, input).await,
            "parameter" => self.update_parameter(id, input).await,
            "instance_patch_states" => self.update_instance_patch_states(id, input).await,
            "association_batch" => self.update_association_batch(id, input).await,
            "parameters" => self.update_parameters(id, input).await,
            "ops_item" => self.update_ops_item(id, input).await,
            "ops_metadata" => self.update_ops_metadata(id, input).await,
            "patch_properties" => self.update_patch_properties(id, input).await,
            "resource_policies" => self.update_resource_policies(id, input).await,
            "ops_summary" => self.update_ops_summary(id, input).await,
            "compliance_items" => self.update_compliance_items(id, input).await,
            "maintenance_window_execution" => {
                self.update_maintenance_window_execution(id, input).await
            }
            "association" => self.update_association(id, input).await,
            "activation" => self.update_activation(id, input).await,
            "maintenance_window_task" => self.update_maintenance_window_task(id, input).await,
            "patch_group_state" => self.update_patch_group_state(id, input).await,
            "maintenance_window_executions" => {
                self.update_maintenance_window_executions(id, input).await
            }
            "document_metadata" => self.update_document_metadata(id, input).await,
            "maintenance_window_execution_task" => {
                self.update_maintenance_window_execution_task(id, input)
                    .await
            }
            "automation_execution" => self.update_automation_execution(id, input).await,
            "resource_data_sync" => self.update_resource_data_sync(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ssm", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "ops_items" => self.delete_ops_items(id).await,
            "association_status" => self.delete_association_status(id).await,
            "patch_groups" => self.delete_patch_groups(id).await,
            "managed_instance_role" => self.delete_managed_instance_role(id).await,
            "maintenance_window_execution_tasks" => {
            ...
            "parameters_by_path" => self.delete_parameters_by_path(id).await,
            "access_token" => self.delete_access_token(id).await,
            "maintenance_window" => self.delete_maintenance_window(id).await,
            "document_permission" => self.delete_document_permission(id).await,
            "automation_executions" => self.delete_automation_executions(id).await,
            "instance_patches" => self.delete_instance_patches(id).await,
            "maintenance_window_execution_task_invocations" => {
                self.delete_maintenance_window_execution_task_invocations(id)
                    .await
            }
            "instance_patch_states_for_patch_group" => {
                self.delete_instance_patch_states_for_patch_group(id).await
            }
            "instance_information" => self.delete_instance_information(id).await,
            "document_default_version" => self.delete_document_default_version(id).await,
            "service_setting" => self.delete_service_setting(id).await,
            "inventory_deletions" => self.delete_inventory_deletions(id).await,
            "instance_properties" => self.delete_instance_properties(id).await,
            "maintenance_windows_for_target" => {
                self.delete_maintenance_windows_for_target(id).await
            }
            "default_patch_baseline" => self.delete_default_patch_baseline(id).await,
            "deployable_patch_snapshot_for_instance" => {
                self.delete_deployable_patch_snapshot_for_instance(id).await
            }
            "execution_preview" => self.delete_execution_preview(id).await,
            "maintenance_window_targets" => self.delete_maintenance_window_targets(id).await,
            "inventory" => self.delete_inventory(id).await,
            "automation_step_executions" => self.delete_automation_step_executions(id).await,
            "patch_baseline_for_patch_group" => {
                self.delete_patch_baseline_for_patch_group(id).await
            }
            "inventory_schema" => self.delete_inventory_schema(id).await,
            "maintenance_window_target" => self.delete_maintenance_window_target(id).await,
            "calendar_state" => self.delete_calendar_state(id).await,
            "instance_associations_status" => self.delete_instance_associations_status(id).await,
            "activations" => self.delete_activations(id).await,
            "command_invocation" => self.delete_command_invocation(id).await,
            "resource_policy" => self.delete_resource_policy(id).await,
            "maintenance_window_execution_task_invocation" => {
                self.delete_maintenance_window_execution_task_invocation(id)
                    .await
            }
            "association_execution_targets" => self.delete_association_execution_targets(id).await,
            "patch_baselines" => self.delete_patch_baselines(id).await,
            "maintenance_window_schedule" => self.delete_maintenance_window_schedule(id).await,
            "patch_baseline" => self.delete_patch_baseline(id).await,
            "maintenance_window_tasks" => self.delete_maintenance_window_tasks(id).await,
            "parameter_history" => self.delete_parameter_history(id).await,
            "maintenance_windows" => self.delete_maintenance_windows(id).await,
            "association_executions" => self.delete_association_executions(id).await,
            "connection_status" => self.delete_connection_status(id).await,
            "available_patches" => self.delete_available_patches(id).await,
            "parameter" => self.delete_parameter(id).await,
            "instance_patch_states" => self.delete_instance_patch_states(id).await,
            "association_batch" => self.delete_association_batch(id).await,
            "parameters" => self.delete_parameters(id).await,
            "ops_item" => self.delete_ops_item(id).await,
            "ops_metadata" => self.delete_ops_metadata(id).await,
            "patch_properties" => self.delete_patch_properties(id).await,
            "resource_policies" => self.delete_resource_policies(id).await,
            "ops_summary" => self.delete_ops_summary(id).await,
            "compliance_items" => self.delete_compliance_items(id).await,
            "maintenance_window_execution" => self.delete_maintenance_window_execution(id).await,
            "association" => self.delete_association(id).await,
            "activation" => self.delete_activation(id).await,
            "maintenance_window_task" => self.delete_maintenance_window_task(id).await,
            "patch_group_state" => self.delete_patch_group_state(id).await,
            "maintenance_window_executions" => self.delete_maintenance_window_executions(id).await,
            "document_metadata" => self.delete_document_metadata(id).await,
            "maintenance_window_execution_task" => {
                self.delete_maintenance_window_execution_task(id).await
            }
            "automation_execution" => self.delete_automation_execution(id).await,
            "resource_data_sync" => self.delete_resource_data_sync(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ssm", resource_name
            ))),
    ...
    async fn create_ops_items(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_ops_items(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_ops_items(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_ops_items(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_association_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_association_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_association_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_patch_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_patch_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn update_patch_groups(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_patch_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_managed_instance_role(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_managed_instance_role(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_managed_instance_role(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_maintenance_window_execution_tasks(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_maintenance_window_execution_tasks(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_effective_instance_associations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_effective_instance_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_effective_patches_for_patch_baseline(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_effective_patches_for_patch_baseline(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_parameters_by_path(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_parameters_by_path(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_parameters_by_path(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_access_token(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_access_token(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn update_access_token(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_access_token(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_maintenance_window(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    allow_unassociated_targets.unwrap_or_default(),
                )
    ...
    async fn read_maintenance_window(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_maintenance_window(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_document_permission(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_document_permission(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_document_permission(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_automation_executions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_automation_executions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_automation_executions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_instance_patches(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_patches(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_instance_patches(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn delete_maintenance_window_execution_task_invocations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_instance_patch_states_for_patch_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_instance_patch_states_for_patch_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_instance_information(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_information(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_instance_information(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_document_default_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_document_default_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_service_setting(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_service_setting(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_service_setting(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_inventory_deletions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_inventory_deletions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_inventory_deletions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_instance_properties(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_properties(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_instance_properties(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_maintenance_windows_for_target(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_maintenance_windows_for_target(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_default_patch_baseline(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_default_patch_baseline(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_default_patch_baseline(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn delete_deployable_patch_snapshot_for_instance(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_execution_preview(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_execution_preview(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_execution_preview(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_maintenance_window_targets(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_maintenance_window_targets(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_inventory(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_inventory(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn update_inventory(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let items = input.get_string("items")?;
            let instance_id = input.get_string("instance_id")?;
    ...
    async fn delete_inventory(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_automation_step_executions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_automation_step_executions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_patch_baseline_for_patch_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_patch_baseline_for_patch_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_inventory_schema(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_inventory_schema(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_inventory_schema(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_maintenance_window_target(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_maintenance_window_target(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_calendar_state(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_calendar_state(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_calendar_state(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_instance_associations_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_instance_associations_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_activations(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_activations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn update_activations(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_activations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_command_invocation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_command_invocation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_command_invocation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn delete_maintenance_window_execution_task_invocation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_association_execution_targets(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_association_execution_targets(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_patch_baselines(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_patch_baselines(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_patch_baselines(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_maintenance_window_schedule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_maintenance_window_schedule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_patch_baseline(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let description = input.get_optional_string("description")?;
            ...
            let tags = input.get_optional_string("tags")?;
            let name = input.get_string("name")?;
            let available_security_updates_compliance_status =
                input.get_optional_string("available_security_updates_compliance_status")?;
            let approval_rules = input.get_optional_string("approval_rules")?;
            let approved_patches_compliance_level =
                input.get_optional_string("approved_patches_compliance_level")?;
            ...
            let approved_patches_enable_non_security =
                input.get_optional_string("approved_patches_enable_non_security")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    available_security_updates_compliance_status.unwrap_or_default(),
                )
                .with_field("approval_rules", approval_rules.unwrap_or_default())
                .with_field(
                    "approved_patches_compliance_level",
                    approved_patches_compliance_level.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    approved_patches_enable_non_security.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    rejected_patches_action.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default()))
        })
    }
    ...
    async fn read_patch_baseline(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_patch_baseline(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_maintenance_window_tasks(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_maintenance_window_tasks(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_parameter_history(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_parameter_history(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_parameter_history(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_maintenance_windows(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_maintenance_windows(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_maintenance_windows(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_association_executions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_association_executions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_association_executions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_connection_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_connection_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_connection_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_available_patches(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_available_patches(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_available_patches(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_parameter(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_parameter(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn update_parameter(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let value = input.get_string("value")?;
            let allowed_pattern = input.get_optional_string("allowed_pattern")?;
    ...
    async fn delete_parameter(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_instance_patch_states(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_patch_states(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_instance_patch_states(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_association_batch(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_association_batch(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_association_batch(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_parameters(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_parameters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn update_parameters(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_parameters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_ops_item(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_ops_item(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn update_ops_item(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let notifications = input.get_optional_string("notifications")?;
    ...
    async fn delete_ops_item(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_ops_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_ops_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn update_ops_metadata(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let metadata = input.get_optional_string("metadata")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_ops_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_patch_properties(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_patch_properties(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_patch_properties(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_ops_summary(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_ops_summary(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn update_ops_summary(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_ops_summary(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_compliance_items(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_compliance_items(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_compliance_items(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_maintenance_window_execution(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_maintenance_window_execution(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_association(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let apply_only_at_cron_interval =
                input.get_optional_string("apply_only_at_cron_interval")?;
            ...
            let automation_target_parameter_name =
                input.get_optional_string("automation_target_parameter_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    automation_target_parameter_name.unwrap_or_default(),
                )
                .with_field("parameters", parameters.unwrap_or_default())
                .with_field(
                    "schedule_expression",
                    schedule_expression.unwrap_or_default(),
                )
                .with_field("instance_id", instance_id.unwrap_or_default())
                ...
                .with_field(
                    "alarm_configuration",
                    alarm_configuration.unwrap_or_default(),
                )
    ...
    async fn create_activation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    registration_metadata.unwrap_or_default(),
                )
                .with_field(
                    "default_instance_name",
                    default_instance_name.unwrap_or_default(),
                )
                .with_field("iam_role", iam_role.unwrap_or_default())
    ...
    async fn read_activation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn update_activation(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let expiration_date = input.get_optional_string("expiration_date")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_activation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_maintenance_window_task(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let description = input.get_optional_string("description")?;
            let replace = input.get_optional_string("replace")?;
            let task_invocation_parameters =
                input.get_optional_string("task_invocation_parameters")?;
            let max_concurrency = input.get_optional_string("max_concurrency")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    task_invocation_parameters.unwrap_or_default(),
                )
                .with_field("max_concurrency", max_concurrency.unwrap_or_default())
    ...
    async fn read_maintenance_window_task(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_maintenance_window_task(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_patch_group_state(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_patch_group_state(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_patch_group_state(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_maintenance_window_executions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_maintenance_window_executions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_document_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
    ...
    async fn read_document_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_document_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn read_maintenance_window_execution_task(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_maintenance_window_execution_task(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_automation_execution(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_automation_execution(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_automation_execution(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
    ...
    async fn create_resource_data_sync(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_resource_data_sync(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_client
    ...
    async fn delete_resource_data_sync(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_client
