...
impl<'a> Compliance_items<'a> {
    ...
    pub async fn create(&self, items: Vec<String>, execution_summary: String, upload_type: Option<String>, compliance_type: String, item_content_hash: Option<String>, resource_id: String, resource_type: String) -> Result<String> {
