...
impl<'a> Compliance_items<'a> {
    ...
    pub async fn create(&self, upload_type: Option<String>, resource_id: String, resource_type: String, items: Vec<String>, compliance_type: String, execution_summary: String, item_content_hash: Option<String>) -> Result<String> {
