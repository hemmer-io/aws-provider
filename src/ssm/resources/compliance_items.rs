...
impl<'a> Compliance_items<'a> {
    ...
    pub async fn create(&self, compliance_type: String, items: Vec<String>, upload_type: Option<String>, resource_type: String, resource_id: String, execution_summary: String, item_content_hash: Option<String>) -> Result<String> {
