...
impl<'a> Ops_metadata<'a> {
    ...
    pub async fn create(&self, metadata: Option<HashMap<String, String>>, tags: Option<Vec<String>>, resource_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, metadata: Option<HashMap<String, String>>, tags: Option<Vec<String>>, resource_id: Option<String>) -> Result<()> {
