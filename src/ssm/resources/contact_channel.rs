...
impl<'a> Contact_channel<'a> {
    ...
    pub async fn create(&self, delivery_address: String, defer_activation: Option<bool>, type: String, contact_id: String, idempotency_token: Option<String>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, delivery_address: Option<String>, defer_activation: Option<bool>, type: Option<String>, contact_id: Option<String>, idempotency_token: Option<String>, name: Option<String>) -> Result<()> {
