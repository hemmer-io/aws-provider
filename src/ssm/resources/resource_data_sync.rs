...
impl<'a> Resource_data_sync<'a> {
    ...
    pub async fn create(&self, s3_destination: Option<String>, sync_name: String, sync_type: Option<String>, sync_source: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, s3_destination: Option<String>, sync_name: Option<String>, sync_type: Option<String>, sync_source: Option<String>) -> Result<()> {
