...
impl<'a> Configuration_manager<'a> {
    ...
    pub async fn create(&self, configuration_definitions: Vec<String>, description: Option<String>, tags: Option<HashMap<String, String>>, name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, configuration_definitions: Option<Vec<String>>, description: Option<String>, tags: Option<HashMap<String, String>>, name: Option<String>) -> Result<()> {
