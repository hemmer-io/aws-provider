...
impl<'a> Application_settings<'a> {
    ...
    pub async fn update(&self, id: &str, credentials_to_remove: Option<Vec<String>>, backint: Option<String>, credentials_to_add_or_update: Option<Vec<String>>, database_arn: Option<String>, application_id: Option<String>) -> Result<()> {
