...
impl<'a> Permission<'a> {
    ...
    pub async fn create(&self, action: Option<String>, principal: Option<String>, event_bus_name: Option<String>, statement_id: Option<String>, condition: Option<String>, policy: Option<String>) -> Result<String> {
