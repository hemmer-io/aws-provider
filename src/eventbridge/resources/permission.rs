...
impl<'a> Permission<'a> {
    ...
    pub async fn create(&self, statement_id: Option<String>, action: Option<String>, condition: Option<String>, event_bus_name: Option<String>, policy: Option<String>, principal: Option<String>) -> Result<String> {
