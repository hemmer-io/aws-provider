...
impl<'a> EventbridgeService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "partner_events" => self.plan_partner_events(current_state, desired_input).await,
            "event_source" => self.plan_event_source(current_state, desired_input).await,
            "rule" => self.plan_rule(current_state, desired_input).await,
            "api_destination" => {
                self.plan_api_destination(current_state, desired_input)
                    .await
            }
            "event_bus" => self.plan_event_bus(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "eventbridge", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "partner_event_source" => self.create_partner_event_source(input).await,
            "archive" => self.create_archive(input).await,
            "endpoint" => self.create_endpoint(input).await,
            "targets" => self.create_targets(input).await,
            "events" => self.create_events(input).await,
            "replay" => self.create_replay(input).await,
            "connection" => self.create_connection(input).await,
            "permission" => self.create_permission(input).await,
            "partner_events" => self.create_partner_events(input).await,
            "event_source" => self.create_event_source(input).await,
            "rule" => self.create_rule(input).await,
            "api_destination" => self.create_api_destination(input).await,
            "event_bus" => self.create_event_bus(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "eventbridge", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "partner_event_source" => self.read_partner_event_source(id).await,
            "archive" => self.read_archive(id).await,
            "endpoint" => self.read_endpoint(id).await,
            "targets" => self.read_targets(id).await,
            "events" => self.read_events(id).await,
            "replay" => self.read_replay(id).await,
            "connection" => self.read_connection(id).await,
            "permission" => self.read_permission(id).await,
            "partner_events" => self.read_partner_events(id).await,
            "event_source" => self.read_event_source(id).await,
            "rule" => self.read_rule(id).await,
            "api_destination" => self.read_api_destination(id).await,
            "event_bus" => self.read_event_bus(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "eventbridge", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "partner_event_source" => self.update_partner_event_source(id, input).await,
            "archive" => self.update_archive(id, input).await,
            "endpoint" => self.update_endpoint(id, input).await,
            "targets" => self.update_targets(id, input).await,
            "events" => self.update_events(id, input).await,
            "replay" => self.update_replay(id, input).await,
            "connection" => self.update_connection(id, input).await,
            "permission" => self.update_permission(id, input).await,
            "partner_events" => self.update_partner_events(id, input).await,
            "event_source" => self.update_event_source(id, input).await,
            "rule" => self.update_rule(id, input).await,
            "api_destination" => self.update_api_destination(id, input).await,
            "event_bus" => self.update_event_bus(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "eventbridge", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "partner_event_source" => self.delete_partner_event_source(id).await,
            "archive" => self.delete_archive(id).await,
            "endpoint" => self.delete_endpoint(id).await,
            "targets" => self.delete_targets(id).await,
            "events" => self.delete_events(id).await,
            "replay" => self.delete_replay(id).await,
            "connection" => self.delete_connection(id).await,
            "permission" => self.delete_permission(id).await,
            "partner_events" => self.delete_partner_events(id).await,
            "event_source" => self.delete_event_source(id).await,
            "rule" => self.delete_rule(id).await,
            "api_destination" => self.delete_api_destination(id).await,
            "event_bus" => self.delete_event_bus(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "eventbridge", resource_name
            ))),
    ...
    async fn create_partner_event_source(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_partner_event_source(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_partner_event_source(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_targets(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_targets(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.eventbridge_client
    ...
    async fn update_targets(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let event_bus_name = input.get_optional_string("event_bus_name")?;
            let targets = input.get_string("targets")?;
    ...
    async fn delete_targets(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.eventbridge_client
    ...
    async fn create_replay(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_replay(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.eventbridge_client
    ...
    async fn update_replay(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_replay(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.eventbridge_client
    ...
    async fn create_connection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let name = input.get_string("name")?;
            let kms_key_identifier = input.get_optional_string("kms_key_identifier")?;
            let invocation_connectivity_parameters =
                input.get_optional_string("invocation_connectivity_parameters")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    invocation_connectivity_parameters.unwrap_or_default(),
                )
    ...
    async fn create_partner_events(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let entries = input.get_string("entries")?;
    ...
    async fn read_partner_events(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.eventbridge_client
    ...
    async fn delete_partner_events(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.eventbridge_client
    ...
    async fn create_event_source(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_event_source(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.eventbridge_client
    ...
    async fn update_event_source(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_event_source(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.eventbridge_client
    ...
    async fn create_api_destination(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let description = input.get_optional_string("description")?;
            let name = input.get_string("name")?;
            let invocation_rate_limit_per_second =
                input.get_optional_string("invocation_rate_limit_per_second")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    invocation_rate_limit_per_second.unwrap_or_default(),
                )
                .with_field(
                    "invocation_endpoint",
                    invocation_endpoint.unwrap_or_default(),
                )
    ...
    async fn read_api_destination(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.eventbridge_client
    ...
    async fn delete_api_destination(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.eventbridge_client
    ...
    async fn create_event_bus(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
    ...
    async fn read_event_bus(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.eventbridge_client
    ...
    async fn update_event_bus(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
            let description = input.get_optional_string("description")?;
    ...
    async fn delete_event_bus(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.eventbridge_client
