...
impl<'a> Action_target<'a> {
    ...
    pub async fn create(&self, id: String, name: String, description: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, id: Option<String>, name: Option<String>, description: Option<String>) -> Result<()> {
