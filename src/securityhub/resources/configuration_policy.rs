...
impl<'a> Configuration_policy<'a> {
    ...
    pub async fn create(&self, configuration_policy: String, description: Option<String>, tags: Option<HashMap<String, String>>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, configuration_policy: Option<String>, description: Option<String>, tags: Option<HashMap<String, String>>, name: Option<String>) -> Result<()> {
