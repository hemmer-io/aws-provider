...
impl<'a> Aggregator_v2<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, client_token: Option<String>, region_linking_mode: String, linked_regions: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, client_token: Option<String>, region_linking_mode: Option<String>, linked_regions: Option<String>) -> Result<()> {
