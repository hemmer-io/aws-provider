...
impl<'a> Aggregator_v2<'a> {
    ...
    pub async fn create(&self, region_linking_mode: String, linked_regions: Option<String>, tags: Option<HashMap<String, String>>, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, region_linking_mode: Option<String>, linked_regions: Option<String>, tags: Option<HashMap<String, String>>, client_token: Option<String>) -> Result<()> {
