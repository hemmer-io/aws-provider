...
impl<'a> SecurityhubService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "action_target" => {
                self.plan_action_target(current_state, desired_input).await
            }
            "master_account" => {
            ...
            "automation_rule_v2" => {
                self.plan_automation_rule_v2(current_state, desired_input).await
            }
            "insight" => {
            ...
            "security_control" => {
                self.plan_security_control(current_state, desired_input).await
            }
            "findings" => {
            ...
            "connector_v2" => {
                self.plan_connector_v2(current_state, desired_input).await
            }
            "organization_configuration" => {
                self.plan_organization_configuration(current_state, desired_input).await
            }
            "insight_results" => {
                self.plan_insight_results(current_state, desired_input).await
            }
            "finding_history" => {
                self.plan_finding_history(current_state, desired_input).await
            }
            "security_control_definition" => {
                self.plan_security_control_definition(current_state, desired_input).await
            }
            "standards" => {
                self.plan_standards(current_state, desired_input).await
            }
            "insights" => {
                self.plan_insights(current_state, desired_input).await
            }
            "resources_v2" => {
                self.plan_resources_v2(current_state, desired_input).await
            }
            "standards_control" => {
                self.plan_standards_control(current_state, desired_input).await
            }
            "standards_controls" => {
                self.plan_standards_controls(current_state, desired_input).await
            }
            "administrator_account" => {
                self.plan_administrator_account(current_state, desired_input).await
            }
            "resources_statistics_v2" => {
                self.plan_resources_statistics_v2(current_state, desired_input).await
            }
            "ticket_v2" => {
                self.plan_ticket_v2(current_state, desired_input).await
            }
            "action_targets" => {
                self.plan_action_targets(current_state, desired_input).await
            }
            "enabled_standards" => {
                self.plan_enabled_standards(current_state, desired_input).await
            }
            "finding_statistics_v2" => {
                self.plan_finding_statistics_v2(current_state, desired_input).await
            }
            "aggregator_v2" => {
                self.plan_aggregator_v2(current_state, desired_input).await
            }
            "findings_v2" => {
                self.plan_findings_v2(current_state, desired_input).await
            }
            "invitations" => {
                self.plan_invitations(current_state, desired_input).await
            }
            "products_v2" => {
                self.plan_products_v2(current_state, desired_input).await
            }
            "configuration_policy" => {
                self.plan_configuration_policy(current_state, desired_input).await
            }
            "security_hub_configuration" => {
                self.plan_security_hub_configuration(current_state, desired_input).await
            }
            "finding_aggregator" => {
                self.plan_finding_aggregator(current_state, desired_input).await
            }
            "automation_rule" => {
                self.plan_automation_rule(current_state, desired_input).await
            }
            "members" => {
                self.plan_members(current_state, desired_input).await
            }
            "security_hub_v2" => {
                self.plan_security_hub_v2(current_state, desired_input).await
            }
            "configuration_policy_association" => {
                self.plan_configuration_policy_association(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "action_target" => {
                self.create_action_target(input).await
            }
            "master_account" => {
            ...
            "automation_rule_v2" => {
                self.create_automation_rule_v2(input).await
            }
            "insight" => {
            ...
            "security_control" => {
                self.create_security_control(input).await
            }
            "findings" => {
            ...
            "connector_v2" => {
                self.create_connector_v2(input).await
            }
            "organization_configuration" => {
                self.create_organization_configuration(input).await
            }
            "insight_results" => {
                self.create_insight_results(input).await
            }
            "finding_history" => {
                self.create_finding_history(input).await
            }
            "security_control_definition" => {
                self.create_security_control_definition(input).await
            }
            "standards" => {
                self.create_standards(input).await
            }
            "insights" => {
                self.create_insights(input).await
            }
            "resources_v2" => {
                self.create_resources_v2(input).await
            }
            "standards_control" => {
                self.create_standards_control(input).await
            }
            "standards_controls" => {
                self.create_standards_controls(input).await
            }
            "administrator_account" => {
                self.create_administrator_account(input).await
            }
            "resources_statistics_v2" => {
                self.create_resources_statistics_v2(input).await
            }
            "ticket_v2" => {
                self.create_ticket_v2(input).await
            }
            "action_targets" => {
                self.create_action_targets(input).await
            }
            "enabled_standards" => {
                self.create_enabled_standards(input).await
            }
            "finding_statistics_v2" => {
                self.create_finding_statistics_v2(input).await
            }
            "aggregator_v2" => {
                self.create_aggregator_v2(input).await
            }
            "findings_v2" => {
                self.create_findings_v2(input).await
            }
            "invitations" => {
                self.create_invitations(input).await
            }
            "products_v2" => {
                self.create_products_v2(input).await
            }
            "configuration_policy" => {
                self.create_configuration_policy(input).await
            }
            "security_hub_configuration" => {
                self.create_security_hub_configuration(input).await
            }
            "finding_aggregator" => {
                self.create_finding_aggregator(input).await
            }
            "automation_rule" => {
                self.create_automation_rule(input).await
            }
            "members" => {
                self.create_members(input).await
            }
            "security_hub_v2" => {
                self.create_security_hub_v2(input).await
            }
            "configuration_policy_association" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "action_target" => {
                self.read_action_target(id).await
            }
            "master_account" => {
            ...
            "automation_rule_v2" => {
                self.read_automation_rule_v2(id).await
            }
            "insight" => {
            ...
            "security_control" => {
                self.read_security_control(id).await
            }
            "findings" => {
            ...
            "connector_v2" => {
                self.read_connector_v2(id).await
            }
            "organization_configuration" => {
                self.read_organization_configuration(id).await
            }
            "insight_results" => {
                self.read_insight_results(id).await
            }
            "finding_history" => {
                self.read_finding_history(id).await
            }
            "security_control_definition" => {
                self.read_security_control_definition(id).await
            }
            "standards" => {
                self.read_standards(id).await
            }
            "insights" => {
                self.read_insights(id).await
            }
            "resources_v2" => {
                self.read_resources_v2(id).await
            }
            "standards_control" => {
                self.read_standards_control(id).await
            }
            "standards_controls" => {
                self.read_standards_controls(id).await
            }
            "administrator_account" => {
                self.read_administrator_account(id).await
            }
            "resources_statistics_v2" => {
                self.read_resources_statistics_v2(id).await
            }
            "ticket_v2" => {
                self.read_ticket_v2(id).await
            }
            "action_targets" => {
                self.read_action_targets(id).await
            }
            "enabled_standards" => {
                self.read_enabled_standards(id).await
            }
            "finding_statistics_v2" => {
                self.read_finding_statistics_v2(id).await
            }
            "aggregator_v2" => {
                self.read_aggregator_v2(id).await
            }
            "findings_v2" => {
                self.read_findings_v2(id).await
            }
            "invitations" => {
                self.read_invitations(id).await
            }
            "products_v2" => {
                self.read_products_v2(id).await
            }
            "configuration_policy" => {
                self.read_configuration_policy(id).await
            }
            "security_hub_configuration" => {
                self.read_security_hub_configuration(id).await
            }
            "finding_aggregator" => {
                self.read_finding_aggregator(id).await
            }
            "automation_rule" => {
                self.read_automation_rule(id).await
            }
            "members" => {
                self.read_members(id).await
            }
            "security_hub_v2" => {
                self.read_security_hub_v2(id).await
            }
            "configuration_policy_association" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "action_target" => {
                self.update_action_target(id, input).await
            }
            "master_account" => {
            ...
            "automation_rule_v2" => {
                self.update_automation_rule_v2(id, input).await
            }
            "insight" => {
            ...
            "security_control" => {
                self.update_security_control(id, input).await
            }
            "findings" => {
            ...
            "connector_v2" => {
                self.update_connector_v2(id, input).await
            }
            "organization_configuration" => {
                self.update_organization_configuration(id, input).await
            }
            "insight_results" => {
                self.update_insight_results(id, input).await
            }
            "finding_history" => {
                self.update_finding_history(id, input).await
            }
            "security_control_definition" => {
                self.update_security_control_definition(id, input).await
            }
            "standards" => {
                self.update_standards(id, input).await
            }
            "insights" => {
                self.update_insights(id, input).await
            }
            "resources_v2" => {
                self.update_resources_v2(id, input).await
            }
            "standards_control" => {
                self.update_standards_control(id, input).await
            }
            "standards_controls" => {
                self.update_standards_controls(id, input).await
            }
            "administrator_account" => {
                self.update_administrator_account(id, input).await
            }
            "resources_statistics_v2" => {
                self.update_resources_statistics_v2(id, input).await
            }
            "ticket_v2" => {
                self.update_ticket_v2(id, input).await
            }
            "action_targets" => {
                self.update_action_targets(id, input).await
            }
            "enabled_standards" => {
                self.update_enabled_standards(id, input).await
            }
            "finding_statistics_v2" => {
                self.update_finding_statistics_v2(id, input).await
            }
            "aggregator_v2" => {
                self.update_aggregator_v2(id, input).await
            }
            "findings_v2" => {
                self.update_findings_v2(id, input).await
            }
            "invitations" => {
                self.update_invitations(id, input).await
            }
            "products_v2" => {
                self.update_products_v2(id, input).await
            }
            "configuration_policy" => {
                self.update_configuration_policy(id, input).await
            }
            "security_hub_configuration" => {
                self.update_security_hub_configuration(id, input).await
            }
            "finding_aggregator" => {
                self.update_finding_aggregator(id, input).await
            }
            "automation_rule" => {
                self.update_automation_rule(id, input).await
            }
            "members" => {
                self.update_members(id, input).await
            }
            "security_hub_v2" => {
                self.update_security_hub_v2(id, input).await
            }
            "configuration_policy_association" => {
                self.update_configuration_policy_association(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "securityhub",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "action_target" => {
                self.delete_action_target(id).await
            }
            "master_account" => {
            ...
            "automation_rule_v2" => {
                self.delete_automation_rule_v2(id).await
            }
            "insight" => {
            ...
            "security_control" => {
                self.delete_security_control(id).await
            }
            "findings" => {
            ...
            "connector_v2" => {
                self.delete_connector_v2(id).await
            }
            "organization_configuration" => {
                self.delete_organization_configuration(id).await
            }
            "insight_results" => {
                self.delete_insight_results(id).await
            }
            "finding_history" => {
                self.delete_finding_history(id).await
            }
            "security_control_definition" => {
                self.delete_security_control_definition(id).await
            }
            "standards" => {
                self.delete_standards(id).await
            }
            "insights" => {
                self.delete_insights(id).await
            }
            "resources_v2" => {
                self.delete_resources_v2(id).await
            }
            "standards_control" => {
                self.delete_standards_control(id).await
            }
            "standards_controls" => {
                self.delete_standards_controls(id).await
            }
            "administrator_account" => {
                self.delete_administrator_account(id).await
            }
            "resources_statistics_v2" => {
                self.delete_resources_statistics_v2(id).await
            }
            "ticket_v2" => {
                self.delete_ticket_v2(id).await
            }
            "action_targets" => {
                self.delete_action_targets(id).await
            }
            "enabled_standards" => {
                self.delete_enabled_standards(id).await
            }
            "finding_statistics_v2" => {
                self.delete_finding_statistics_v2(id).await
            }
            "aggregator_v2" => {
                self.delete_aggregator_v2(id).await
            }
            "findings_v2" => {
                self.delete_findings_v2(id).await
            }
            "invitations" => {
                self.delete_invitations(id).await
            }
            "products_v2" => {
                self.delete_products_v2(id).await
            }
            "configuration_policy" => {
                self.delete_configuration_policy(id).await
            }
            "security_hub_configuration" => {
                self.delete_security_hub_configuration(id).await
            }
            "finding_aggregator" => {
                self.delete_finding_aggregator(id).await
            }
            "automation_rule" => {
                self.delete_automation_rule(id).await
            }
            "members" => {
                self.delete_members(id).await
            }
            "security_hub_v2" => {
                self.delete_security_hub_v2(id).await
            }
            "configuration_policy_association" => {
    ...
    async fn create_automation_rule_v2(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_automation_rule_v2(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_automation_rule_v2(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_security_control(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("security_control_id", security_control_id.unwrap_or_default())
    ...
    async fn read_security_control(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_security_control(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_organization_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("auto_enable_standards", auto_enable_standards.unwrap_or_default())
            )
        })
    }
    ...
    async fn create_insight_results(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_insight_results(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_finding_history(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_finding_history(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_security_control_definition(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_security_control_definition(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_standards_control(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("standards_control_arn", standards_control_arn.unwrap_or_default())
    ...
    async fn read_standards_control(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_standards_control(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_standards_controls(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_standards_controls(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_standards_controls(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_resources_statistics_v2(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_resources_statistics_v2(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resources_statistics_v2(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_ticket_v2(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field("finding_metadata_uid", finding_metadata_uid.unwrap_or_default())
    ...
    async fn create_action_targets(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_action_targets(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_enabled_standards(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_enabled_standards(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_enabled_standards(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_finding_statistics_v2(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_finding_statistics_v2(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_finding_statistics_v2(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_aggregator_v2(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("region_linking_mode", region_linking_mode.unwrap_or_default())
                .with_field("client_token", client_token.unwrap_or_default())
    ...
    async fn create_configuration_policy(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("configuration_policy", configuration_policy.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
            )
    ...
    async fn read_configuration_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_configuration_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_security_hub_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            let control_finding_generator = input.get_optional_string("control_finding_generator")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("auto_enable_controls", auto_enable_controls.unwrap_or_default())
                .with_field("control_finding_generator", control_finding_generator.unwrap_or_default())
            )
        })
    }

    /// Read a security_hub_configuration resource
    async fn read_security_hub_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_security_hub_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_finding_aggregator(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_finding_aggregator(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_finding_aggregator(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_security_hub_v2(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_security_hub_v2(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_configuration_policy_association(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_configuration_policy_association(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
