...
impl<'a> Long_term_pricing<'a> {
    ...
    pub async fn create(&self, long_term_pricing_type: i64, snowball_type: String, is_long_term_pricing_auto_renew: Option<bool>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, long_term_pricing_type: Option<i64>, snowball_type: Option<String>, is_long_term_pricing_auto_renew: Option<bool>) -> Result<()> {
