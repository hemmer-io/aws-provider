...
impl<'a> Long_term_pricing<'a> {
    ...
    pub async fn create(&self, snowball_type: String, long_term_pricing_type: i64, is_long_term_pricing_auto_renew: Option<bool>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, snowball_type: Option<String>, long_term_pricing_type: Option<i64>, is_long_term_pricing_auto_renew: Option<bool>) -> Result<()> {
