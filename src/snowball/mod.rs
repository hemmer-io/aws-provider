...
impl<'a> SnowballService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "job_shipment_state" => {
                self.plan_job_shipment_state(current_state, desired_input)
                    .await
            }
            "job_manifest" => self.plan_job_manifest(current_state, desired_input).await,
            "software_updates" => {
                self.plan_software_updates(current_state, desired_input)
                    .await
            }
            "addresses" => self.plan_addresses(current_state, desired_input).await,
            "long_term_pricing" => {
                self.plan_long_term_pricing(current_state, desired_input)
                    .await
            }
            "return_shipping_label" => {
                self.plan_return_shipping_label(current_state, desired_input)
                    .await
            }
            "job" => self.plan_job(current_state, desired_input).await,
            "job_unlock_code" => {
                self.plan_job_unlock_code(current_state, desired_input)
                    .await
            }
            "snowball_usage" => self.plan_snowball_usage(current_state, desired_input).await,
            "address" => self.plan_address(current_state, desired_input).await,
            "cluster" => self.plan_cluster(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "snowball", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "job_shipment_state" => self.create_job_shipment_state(input).await,
            "job_manifest" => self.create_job_manifest(input).await,
            "software_updates" => self.create_software_updates(input).await,
            "addresses" => self.create_addresses(input).await,
            "long_term_pricing" => self.create_long_term_pricing(input).await,
            "return_shipping_label" => self.create_return_shipping_label(input).await,
            "job" => self.create_job(input).await,
            "job_unlock_code" => self.create_job_unlock_code(input).await,
            "snowball_usage" => self.create_snowball_usage(input).await,
            "address" => self.create_address(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "job_shipment_state" => self.read_job_shipment_state(id).await,
            "job_manifest" => self.read_job_manifest(id).await,
            "software_updates" => self.read_software_updates(id).await,
            "addresses" => self.read_addresses(id).await,
            "long_term_pricing" => self.read_long_term_pricing(id).await,
            "return_shipping_label" => self.read_return_shipping_label(id).await,
            "job" => self.read_job(id).await,
            "job_unlock_code" => self.read_job_unlock_code(id).await,
            "snowball_usage" => self.read_snowball_usage(id).await,
            "address" => self.read_address(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "job_shipment_state" => self.update_job_shipment_state(id, input).await,
            "job_manifest" => self.update_job_manifest(id, input).await,
            "software_updates" => self.update_software_updates(id, input).await,
            "addresses" => self.update_addresses(id, input).await,
            "long_term_pricing" => self.update_long_term_pricing(id, input).await,
            "return_shipping_label" => self.update_return_shipping_label(id, input).await,
            "job" => self.update_job(id, input).await,
            "job_unlock_code" => self.update_job_unlock_code(id, input).await,
            "snowball_usage" => self.update_snowball_usage(id, input).await,
            "address" => self.update_address(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "job_shipment_state" => self.delete_job_shipment_state(id).await,
            "job_manifest" => self.delete_job_manifest(id).await,
            "software_updates" => self.delete_software_updates(id).await,
            "addresses" => self.delete_addresses(id).await,
            "long_term_pricing" => self.delete_long_term_pricing(id).await,
            "return_shipping_label" => self.delete_return_shipping_label(id).await,
            "job" => self.delete_job(id).await,
            "job_unlock_code" => self.delete_job_unlock_code(id).await,
            "snowball_usage" => self.delete_snowball_usage(id).await,
            "address" => self.delete_address(id).await,
    ...
    async fn create_job_shipment_state(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_job_shipment_state(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_job_shipment_state(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_job_manifest(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_job_manifest(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.snowball_client
    ...
    async fn update_job_manifest(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_job_manifest(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.snowball_client
    ...
    async fn create_software_updates(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_software_updates(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.snowball_client
    ...
    async fn delete_software_updates(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.snowball_client
    ...
    async fn create_addresses(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_addresses(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.snowball_client
    ...
    async fn update_addresses(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_addresses(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.snowball_client
    ...
    async fn create_long_term_pricing(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let long_term_pricing_type = input.get_string("long_term_pricing_type")?;
            let snowball_type = input.get_string("snowball_type")?;
            let is_long_term_pricing_auto_renew =
                input.get_optional_string("is_long_term_pricing_auto_renew")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    long_term_pricing_type.unwrap_or_default(),
                )
                .with_field("snowball_type", snowball_type.unwrap_or_default())
                .with_field(
                    "is_long_term_pricing_auto_renew",
                    is_long_term_pricing_auto_renew.unwrap_or_default(),
                ))
        })
    }

    /// Read a long_term_pricing resource
    async fn read_long_term_pricing(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.snowball_client
    ...
    async fn delete_long_term_pricing(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.snowball_client
    ...
    async fn create_return_shipping_label(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let job_id = input.get_string("job_id")?;
    ...
    async fn read_return_shipping_label(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.snowball_client
    ...
    async fn delete_return_shipping_label(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.snowball_client
    ...
    async fn create_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let snowball_capacity_preference =
                input.get_optional_string("snowball_capacity_preference")?;
            ...
            let on_device_service_configuration =
                input.get_optional_string("on_device_service_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    long_term_pricing_id.unwrap_or_default(),
                )
                .with_field("kms_key_arn", kms_key_arn.unwrap_or_default())
                .with_field("snowball_type", snowball_type.unwrap_or_default())
                .with_field(
                    "snowball_capacity_preference",
                    snowball_capacity_preference.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    forwarding_address_id.unwrap_or_default(),
                )
                .with_field(
                    "on_device_service_configuration",
                    on_device_service_configuration.unwrap_or_default(),
                )
                .with_field(
    ...
    async fn create_job_unlock_code(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_job_unlock_code(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.snowball_client
    ...
    async fn delete_job_unlock_code(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.snowball_client
    ...
    async fn create_snowball_usage(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_snowball_usage(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.snowball_client
    ...
    async fn delete_snowball_usage(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.snowball_client
    ...
    async fn create_address(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_address(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.snowball_client
    ...
    async fn update_address(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let address = input.get_string("address")?;
    ...
    async fn delete_address(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.snowball_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    initial_cluster_size.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    long_term_pricing_ids.unwrap_or_default(),
                )
                .with_field("address_id", address_id.unwrap_or_default())
                .with_field(
                    "on_device_service_configuration",
