...
impl<'a> Asset_model_interface_relationship<'a> {
    ...
    pub async fn create(&self, interface_asset_model_id: String, asset_model_id: String, property_mapping_configuration: String, client_token: Option<String>) -> Result<String> {
