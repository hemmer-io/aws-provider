...
impl<'a> Bulk_import_job<'a> {
    ...
    pub async fn create(&self, job_role_arn: String, files: Vec<String>, error_report_location: String, delete_files_after_import: Option<bool>, job_configuration: String, adaptive_ingestion: Option<bool>, job_name: String) -> Result<String> {
