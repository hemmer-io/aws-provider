...
impl<'a> Storage_configuration<'a> {
    ...
    pub async fn create(&self, warm_tier_retention_period: Option<String>, multi_layer_storage: Option<String>, disallow_ingest_null_na_n: Option<bool>, disassociated_data_storage: Option<String>, warm_tier: Option<String>, storage_type: String, retention_period: Option<String>) -> Result<String> {
