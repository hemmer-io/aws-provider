...
impl<'a> IotsitewiseService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "asset_property_value" => {
                self.plan_asset_property_value(current_state, desired_input)
                    .await
            }
            "default_encryption_configuration" => {
                self.plan_default_encryption_configuration(current_state, desired_input)
                    .await
            }
            "asset_model_composite_model" => {
                self.plan_asset_model_composite_model(current_state, desired_input)
                    .await
            }
            ...
            "asset_property_value_history" => {
                self.plan_asset_property_value_history(current_state, desired_input)
                    .await
            }
            "time_series" => self.plan_time_series(current_state, desired_input).await,
            "logging_options" => {
                self.plan_logging_options(current_state, desired_input)
                    .await
            }
            "interpolated_asset_property_values" => {
                self.plan_interpolated_asset_property_values(current_state, desired_input)
                    .await
            }
            "computation_model" => {
                self.plan_computation_model(current_state, desired_input)
                    .await
            }
            ...
            "asset_property" => self.plan_asset_property(current_state, desired_input).await,
            "asset" => self.plan_asset(current_state, desired_input).await,
            "project" => self.plan_project(current_state, desired_input).await,
            "portal" => self.plan_portal(current_state, desired_input).await,
            "asset_property_aggregates" => {
                self.plan_asset_property_aggregates(current_state, desired_input)
                    .await
            }
            "asset_model_interface_relationship" => {
                self.plan_asset_model_interface_relationship(current_state, desired_input)
                    .await
            }
            "asset_model" => self.plan_asset_model(current_state, desired_input).await,
            "asset_composite_model" => {
                self.plan_asset_composite_model(current_state, desired_input)
                    .await
            }
            "access_policy" => self.plan_access_policy(current_state, desired_input).await,
            "computation_model_execution_summary" => {
                self.plan_computation_model_execution_summary(current_state, desired_input)
                    .await
            }
            "gateway_capability_configuration" => {
                self.plan_gateway_capability_configuration(current_state, desired_input)
                    .await
            }
            "execution" => self.plan_execution(current_state, desired_input).await,
            "bulk_import_job" => {
                self.plan_bulk_import_job(current_state, desired_input)
                    .await
            }
            "dataset" => self.plan_dataset(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iotsitewise", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "asset_property_value" => self.create_asset_property_value(input).await,
            "default_encryption_configuration" => {
                self.create_default_encryption_configuration(input).await
            }
            "asset_model_composite_model" => self.create_asset_model_composite_model(input).await,
            "storage_configuration" => self.create_storage_configuration(input).await,
            "asset_property_value_history" => self.create_asset_property_value_history(input).await,
            "time_series" => self.create_time_series(input).await,
            "logging_options" => self.create_logging_options(input).await,
            "interpolated_asset_property_values" => {
                self.create_interpolated_asset_property_values(input).await
            }
            "computation_model" => self.create_computation_model(input).await,
            "dashboard" => self.create_dashboard(input).await,
            "gateway" => self.create_gateway(input).await,
            "action" => self.create_action(input).await,
            "asset_property" => self.create_asset_property(input).await,
            "asset" => self.create_asset(input).await,
            "project" => self.create_project(input).await,
            "portal" => self.create_portal(input).await,
            "asset_property_aggregates" => self.create_asset_property_aggregates(input).await,
            "asset_model_interface_relationship" => {
                self.create_asset_model_interface_relationship(input).await
            }
            "asset_model" => self.create_asset_model(input).await,
            "asset_composite_model" => self.create_asset_composite_model(input).await,
            "access_policy" => self.create_access_policy(input).await,
            "computation_model_execution_summary" => {
            ...
            "bulk_import_job" => self.create_bulk_import_job(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "asset_property_value" => self.read_asset_property_value(id).await,
            "default_encryption_configuration" => {
                self.read_default_encryption_configuration(id).await
            }
            "asset_model_composite_model" => self.read_asset_model_composite_model(id).await,
            "storage_configuration" => self.read_storage_configuration(id).await,
            "asset_property_value_history" => self.read_asset_property_value_history(id).await,
            "time_series" => self.read_time_series(id).await,
            "logging_options" => self.read_logging_options(id).await,
            "interpolated_asset_property_values" => {
                self.read_interpolated_asset_property_values(id).await
            }
            "computation_model" => self.read_computation_model(id).await,
            "dashboard" => self.read_dashboard(id).await,
            "gateway" => self.read_gateway(id).await,
            "action" => self.read_action(id).await,
            "asset_property" => self.read_asset_property(id).await,
            "asset" => self.read_asset(id).await,
            "project" => self.read_project(id).await,
            "portal" => self.read_portal(id).await,
            "asset_property_aggregates" => self.read_asset_property_aggregates(id).await,
            "asset_model_interface_relationship" => {
                self.read_asset_model_interface_relationship(id).await
            }
            "asset_model" => self.read_asset_model(id).await,
            "asset_composite_model" => self.read_asset_composite_model(id).await,
            "access_policy" => self.read_access_policy(id).await,
            "computation_model_execution_summary" => {
            ...
            "bulk_import_job" => self.read_bulk_import_job(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "asset_property_value" => self.update_asset_property_value(id, input).await,
            "default_encryption_configuration" => {
                self.update_default_encryption_configuration(id, input)
                    .await
            }
            "asset_model_composite_model" => {
            ...
            "time_series" => self.update_time_series(id, input).await,
            "logging_options" => self.update_logging_options(id, input).await,
            "interpolated_asset_property_values" => {
                self.update_interpolated_asset_property_values(id, input)
                    .await
            }
            "computation_model" => self.update_computation_model(id, input).await,
            ...
            "asset_property" => self.update_asset_property(id, input).await,
            "asset" => self.update_asset(id, input).await,
            "project" => self.update_project(id, input).await,
            "portal" => self.update_portal(id, input).await,
            "asset_property_aggregates" => self.update_asset_property_aggregates(id, input).await,
            "asset_model_interface_relationship" => {
                self.update_asset_model_interface_relationship(id, input)
                    .await
            }
            "asset_model" => self.update_asset_model(id, input).await,
            "asset_composite_model" => self.update_asset_composite_model(id, input).await,
            "access_policy" => self.update_access_policy(id, input).await,
            "computation_model_execution_summary" => {
                self.update_computation_model_execution_summary(id, input)
                    .await
            }
            "gateway_capability_configuration" => {
                self.update_gateway_capability_configuration(id, input)
                    .await
            }
            "execution" => self.update_execution(id, input).await,
            "bulk_import_job" => self.update_bulk_import_job(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "asset_property_value" => self.delete_asset_property_value(id).await,
            "default_encryption_configuration" => {
                self.delete_default_encryption_configuration(id).await
            }
            "asset_model_composite_model" => self.delete_asset_model_composite_model(id).await,
            "storage_configuration" => self.delete_storage_configuration(id).await,
            "asset_property_value_history" => self.delete_asset_property_value_history(id).await,
            "time_series" => self.delete_time_series(id).await,
            "logging_options" => self.delete_logging_options(id).await,
            "interpolated_asset_property_values" => {
                self.delete_interpolated_asset_property_values(id).await
            }
            "computation_model" => self.delete_computation_model(id).await,
            "dashboard" => self.delete_dashboard(id).await,
            "gateway" => self.delete_gateway(id).await,
            "action" => self.delete_action(id).await,
            "asset_property" => self.delete_asset_property(id).await,
            "asset" => self.delete_asset(id).await,
            "project" => self.delete_project(id).await,
            "portal" => self.delete_portal(id).await,
            "asset_property_aggregates" => self.delete_asset_property_aggregates(id).await,
            "asset_model_interface_relationship" => {
                self.delete_asset_model_interface_relationship(id).await
            }
            "asset_model" => self.delete_asset_model(id).await,
            "asset_composite_model" => self.delete_asset_composite_model(id).await,
            "access_policy" => self.delete_access_policy(id).await,
            "computation_model_execution_summary" => {
            ...
            "bulk_import_job" => self.delete_bulk_import_job(id).await,
    ...
    async fn create_asset_property_value(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_asset_property_value(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_asset_property_value(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_default_encryption_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn delete_default_encryption_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn create_asset_model_composite_model(
        ...
        self.provider.runtime().block_on(async {
            ...
            let asset_model_composite_model_id =
                input.get_optional_string("asset_model_composite_model_id")?;
            let asset_model_composite_model_external_id =
                input.get_optional_string("asset_model_composite_model_external_id")?;
            let asset_model_composite_model_type =
                input.get_string("asset_model_composite_model_type")?;
            let asset_model_composite_model_name =
                input.get_string("asset_model_composite_model_name")?;
            let parent_asset_model_composite_model_id =
                input.get_optional_string("parent_asset_model_composite_model_id")?;
            ...
            let asset_model_composite_model_properties =
                input.get_optional_string("asset_model_composite_model_properties")?;
            ...
            let asset_model_composite_model_description =
                input.get_optional_string("asset_model_composite_model_description")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    asset_model_composite_model_id.unwrap_or_default(),
                )
                .with_field(
                    "asset_model_composite_model_external_id",
                    asset_model_composite_model_external_id.unwrap_or_default(),
                )
                .with_field(
                    "asset_model_composite_model_type",
                    asset_model_composite_model_type.unwrap_or_default(),
                )
                .with_field(
                    "asset_model_composite_model_name",
                    asset_model_composite_model_name.unwrap_or_default(),
                )
                .with_field(
                    "parent_asset_model_composite_model_id",
                    parent_asset_model_composite_model_id.unwrap_or_default(),
                )
                .with_field("asset_model_id", asset_model_id.unwrap_or_default())
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field(
                    "composed_asset_model_id",
                    composed_asset_model_id.unwrap_or_default(),
                )
                .with_field(
                    "asset_model_composite_model_properties",
                    asset_model_composite_model_properties.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    match_for_version_type.unwrap_or_default(),
                )
                .with_field(
                    "asset_model_composite_model_description",
                    asset_model_composite_model_description.unwrap_or_default(),
                ))
        })
    }

    /// Read a asset_model_composite_model resource
    async fn read_asset_model_composite_model(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn delete_asset_model_composite_model(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn create_storage_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let disallow_ingest_null_na_n =
                input.get_optional_string("disallow_ingest_null_na_n")?;
            let storage_type = input.get_string("storage_type")?;
            let multi_layer_storage = input.get_optional_string("multi_layer_storage")?;
            let disassociated_data_storage =
                input.get_optional_string("disassociated_data_storage")?;
            let warm_tier = input.get_optional_string("warm_tier")?;
            let retention_period = input.get_optional_string("retention_period")?;
            let warm_tier_retention_period =
                input.get_optional_string("warm_tier_retention_period")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    disallow_ingest_null_na_n.unwrap_or_default(),
                )
                .with_field("storage_type", storage_type.unwrap_or_default())
                .with_field(
                    "multi_layer_storage",
                    multi_layer_storage.unwrap_or_default(),
                )
                .with_field(
                    "disassociated_data_storage",
                    disassociated_data_storage.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    warm_tier_retention_period.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn read_asset_property_value_history(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn delete_asset_property_value_history(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn create_time_series(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_time_series(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn update_time_series(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_time_series(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn read_interpolated_asset_property_values(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn delete_interpolated_asset_property_values(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn create_computation_model(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let computation_model_data_binding =
                input.get_string("computation_model_data_binding")?;
            let client_token = input.get_optional_string("client_token")?;
            let computation_model_configuration =
                input.get_string("computation_model_configuration")?;
            let computation_model_description =
                input.get_optional_string("computation_model_description")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    computation_model_data_binding.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field(
                    "computation_model_configuration",
                    computation_model_configuration.unwrap_or_default(),
                )
                .with_field(
                    "computation_model_description",
                    computation_model_description.unwrap_or_default(),
                )
                .with_field(
                    "computation_model_name",
                    computation_model_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a computation_model resource
    async fn read_computation_model(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn delete_computation_model(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    dashboard_definition.unwrap_or_default(),
                )
                .with_field("dashboard_name", dashboard_name.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "dashboard_description",
                    dashboard_description.unwrap_or_default(),
                )
    ...
    async fn create_asset_property(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let property_notification_state =
                input.get_optional_string("property_notification_state")?;
            let client_token = input.get_optional_string("client_token")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    property_notification_state.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default())
    ...
    async fn read_asset_property(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn delete_asset_property(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn create_portal(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let client_token = input.get_optional_string("client_token")?;
            let notification_sender_email =
                input.get_optional_string("notification_sender_email")?;
            let portal_type_configuration =
                input.get_optional_string("portal_type_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    notification_sender_email.unwrap_or_default(),
                )
                .with_field(
                    "portal_type_configuration",
                    portal_type_configuration.unwrap_or_default(),
                )
                .with_field("role_arn", role_arn.unwrap_or_default())
                .with_field(
                    "portal_contact_email",
                    portal_contact_email.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    portal_logo_image_file.unwrap_or_default(),
                )
    ...
    async fn read_portal(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn update_portal(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let client_token = input.get_optional_string("client_token")?;
            let notification_sender_email =
    ...
    async fn delete_portal(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn read_asset_property_aggregates(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn delete_asset_property_aggregates(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn create_asset_model_interface_relationship(
        ...
        self.provider.runtime().block_on(async {
            ...
            let asset_model_id = input.get_string("asset_model_id")?;
            let property_mapping_configuration =
                input.get_string("property_mapping_configuration")?;
            let client_token = input.get_optional_string("client_token")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    interface_asset_model_id.unwrap_or_default(),
                )
                .with_field("asset_model_id", asset_model_id.unwrap_or_default())
                .with_field(
                    "property_mapping_configuration",
                    property_mapping_configuration.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default()))
        })
    }
    ...
    async fn read_asset_model_interface_relationship(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn delete_asset_model_interface_relationship(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn create_asset_model(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let asset_model_composite_models =
                input.get_optional_string("asset_model_composite_models")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    asset_model_description.unwrap_or_default(),
                )
                .with_field("asset_model_type", asset_model_type.unwrap_or_default())
                .with_field(
                    "asset_model_hierarchies",
                    asset_model_hierarchies.unwrap_or_default(),
                )
                .with_field(
                    "asset_model_composite_models",
                    asset_model_composite_models.unwrap_or_default(),
                )
                .with_field(
                    "asset_model_external_id",
                    asset_model_external_id.unwrap_or_default(),
                )
                .with_field("asset_model_id", asset_model_id.unwrap_or_default())
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    ...
                    asset_model_properties.unwrap_or_default(),
                ))
        })
    }

    /// Read a asset_model resource
    async fn read_asset_model(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn update_asset_model(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let asset_model_name = input.get_string("asset_model_name")?;
            let asset_model_description = input.get_optional_string("asset_model_description")?;
    ...
    async fn delete_asset_model(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn create_asset_composite_model(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_asset_composite_model(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn delete_asset_composite_model(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn create_access_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    access_policy_permission.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field(
                    "access_policy_identity",
                    access_policy_identity.unwrap_or_default(),
                )
                .with_field(
                    "access_policy_resource",
                    access_policy_resource.unwrap_or_default(),
                ))
        })
    }

    /// Read a access_policy resource
    async fn read_access_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn update_access_policy(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let access_policy_permission = input.get_string("access_policy_permission")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_access_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn read_computation_model_execution_summary(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn delete_computation_model_execution_summary(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    capability_namespace.unwrap_or_default(),
                )
                .with_field(
                    "capability_configuration",
                    capability_configuration.unwrap_or_default(),
                ))
        })
    }

    /// Read a gateway_capability_configuration resource
    async fn read_gateway_capability_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn delete_gateway_capability_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn create_bulk_import_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let delete_files_after_import =
                input.get_optional_string("delete_files_after_import")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    error_report_location.unwrap_or_default(),
                )
                .with_field(
                    "delete_files_after_import",
                    delete_files_after_import.unwrap_or_default(),
                )
    ...
    async fn read_bulk_import_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotsitewise_client
    ...
    async fn delete_bulk_import_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotsitewise_client
    ...
    async fn create_dataset(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "dataset_description",
                    dataset_description.unwrap_or_default(),
                )
