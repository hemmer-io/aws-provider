...
impl<'a> Emr_containersService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "managed_endpoint" => {
                self.plan_managed_endpoint(current_state, desired_input).await
            }
            "virtual_cluster" => {
                self.plan_virtual_cluster(current_state, desired_input).await
            }
            "managed_endpoint_session_credentials" => {
                self.plan_managed_endpoint_session_credentials(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "managed_endpoint" => {
                self.create_managed_endpoint(input).await
            }
            "virtual_cluster" => {
                self.create_virtual_cluster(input).await
            }
            "managed_endpoint_session_credentials" => {
                self.create_managed_endpoint_session_credentials(input).await
            }
            "security_configuration" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "managed_endpoint" => {
                self.read_managed_endpoint(id).await
            }
            "virtual_cluster" => {
                self.read_virtual_cluster(id).await
            }
            "managed_endpoint_session_credentials" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "managed_endpoint" => {
                self.update_managed_endpoint(id, input).await
            }
            "virtual_cluster" => {
                self.update_virtual_cluster(id, input).await
            }
            "managed_endpoint_session_credentials" => {
                self.update_managed_endpoint_session_credentials(id, input).await
            }
            "security_configuration" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "managed_endpoint" => {
                self.delete_managed_endpoint(id).await
            }
            "virtual_cluster" => {
                self.delete_virtual_cluster(id).await
            }
            "managed_endpoint_session_credentials" => {
    ...
    async fn create_managed_endpoint(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("configuration_overrides", configuration_overrides.unwrap_or_default())
    ...
    async fn read_managed_endpoint(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_virtual_cluster(
        ...
        self.provider.runtime().block_on(async {
            ...
            let security_configuration_id = input.get_optional_string("security_configuration_id")?;
            let tags = input.get_optional_string("tags")?;
            let client_token = input.get_string("client_token")?;
            let name = input.get_string("name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("security_configuration_id", security_configuration_id.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
            )
    ...
    async fn read_managed_endpoint_session_credentials(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_managed_endpoint_session_credentials(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_security_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("security_configuration_data", security_configuration_data.unwrap_or_default())
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("container_provider", container_provider.unwrap_or_default())
