...
impl<'a> Security_configuration<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, client_token: String, name: String, container_provider: Option<String>, security_configuration_data: String) -> Result<String> {
