...
impl<'a> Managed_endpoint<'a> {
    ...
    pub async fn create(&self, type: String, configuration_overrides: Option<String>, client_token: String, release_label: String, virtual_cluster_id: String, execution_role_arn: String, tags: Option<HashMap<String, String>>, certificate_arn: Option<String>, name: String) -> Result<String> {
