...
impl<'a> Managed_endpoint<'a> {
    ...
    pub async fn create(&self, type: String, name: String, execution_role_arn: String, certificate_arn: Option<String>, client_token: String, release_label: String, virtual_cluster_id: String, configuration_overrides: Option<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
