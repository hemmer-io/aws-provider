...
impl<'a> Virtual_cluster<'a> {
    ...
    pub async fn create(&self, client_token: String, security_configuration_id: Option<String>, name: String, container_provider: String, tags: Option<HashMap<String, String>>) -> Result<String> {
