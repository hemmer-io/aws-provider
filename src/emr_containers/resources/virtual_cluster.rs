...
impl<'a> Virtual_cluster<'a> {
    ...
    pub async fn create(&self, security_configuration_id: Option<String>, container_provider: String, name: String, tags: Option<HashMap<String, String>>, client_token: String) -> Result<String> {
