...
impl<'a> Virtual_cluster<'a> {
    ...
    pub async fn create(&self, container_provider: String, security_configuration_id: Option<String>, tags: Option<HashMap<String, String>>, client_token: String, name: String) -> Result<String> {
