...
impl<'a> Job_template<'a> {
    ...
    pub async fn create(&self, client_token: String, kms_key_arn: Option<String>, name: String, tags: Option<HashMap<String, String>>, job_template_data: String) -> Result<String> {
