...
impl<'a> Retraining_scheduler<'a> {
    ...
    pub async fn create(&self, retraining_frequency: String, model_name: String, retraining_start_date: Option<String>, lookback_window: String, client_token: String, promote_mode: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, retraining_frequency: Option<String>, model_name: Option<String>, retraining_start_date: Option<String>, lookback_window: Option<String>, client_token: Option<String>, promote_mode: Option<String>) -> Result<()> {
