...
impl<'a> Retraining_scheduler<'a> {
    ...
    pub async fn create(&self, model_name: String, promote_mode: Option<String>, retraining_start_date: Option<String>, client_token: String, retraining_frequency: String, lookback_window: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, model_name: Option<String>, promote_mode: Option<String>, retraining_start_date: Option<String>, client_token: Option<String>, retraining_frequency: Option<String>, lookback_window: Option<String>) -> Result<()> {
