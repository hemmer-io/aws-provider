...
impl<'a> Label_group<'a> {
    ...
    pub async fn create(&self, client_token: String, label_group_name: String, tags: Option<Vec<String>>, fault_codes: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, label_group_name: Option<String>, tags: Option<Vec<String>>, fault_codes: Option<Vec<String>>) -> Result<()> {
