...
impl<'a> Label_group<'a> {
    ...
    pub async fn create(&self, label_group_name: String, fault_codes: Option<Vec<String>>, tags: Option<Vec<String>>, client_token: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, label_group_name: Option<String>, fault_codes: Option<Vec<String>>, tags: Option<Vec<String>>, client_token: Option<String>) -> Result<()> {
