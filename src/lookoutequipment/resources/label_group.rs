...
impl<'a> Label_group<'a> {
    ...
    pub async fn create(&self, fault_codes: Option<Vec<String>>, client_token: String, label_group_name: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, fault_codes: Option<Vec<String>>, client_token: Option<String>, label_group_name: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
