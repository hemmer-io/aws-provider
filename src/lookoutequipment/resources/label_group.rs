...
impl<'a> Label_group<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, client_token: String, label_group_name: String, fault_codes: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, client_token: Option<String>, label_group_name: Option<String>, fault_codes: Option<Vec<String>>) -> Result<()> {
