...
impl<'a> Connection_group<'a> {
    ...
    pub async fn create(&self, ipv6_enabled: Option<bool>, anycast_ip_list_id: Option<String>, name: String, tags: Option<String>, enabled: Option<bool>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, ipv6_enabled: Option<bool>, anycast_ip_list_id: Option<String>, name: Option<String>, tags: Option<String>, enabled: Option<bool>) -> Result<()> {
