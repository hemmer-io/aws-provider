...
impl<'a> Realtime_log_config<'a> {
    ...
    pub async fn create(&self, name: String, sampling_rate: i64, fields: Vec<String>, end_points: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, sampling_rate: Option<i64>, fields: Option<Vec<String>>, end_points: Option<Vec<String>>) -> Result<()> {
