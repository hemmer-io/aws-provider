...
impl<'a> Workspaces_thin_clientService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "software_set" => self.plan_software_set(current_state, desired_input).await,
            "environment" => self.plan_environment(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workspaces_thin_client", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "software_set" => self.create_software_set(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "software_set" => self.read_software_set(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "software_set" => self.update_software_set(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "software_set" => self.delete_software_set(id).await,
    ...
    async fn create_device(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let software_set_update_schedule =
                input.get_optional_string("software_set_update_schedule")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    desired_software_set_id.unwrap_or_default(),
                )
                .with_field(
                    "software_set_update_schedule",
                    software_set_update_schedule.unwrap_or_default(),
                )
    ...
    async fn create_software_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_software_set(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_thin_client_client
    ...
    async fn update_software_set(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let validation_status = input.get_string("validation_status")?;
            let id = input.get_string("id")?;
    ...
    async fn delete_software_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_thin_client_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    software_set_update_mode.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    device_creation_tags.unwrap_or_default(),
                )
