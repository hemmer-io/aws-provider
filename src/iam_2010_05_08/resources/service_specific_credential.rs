...
impl<'a> Service_specific_credential<'a> {
    ...
    pub async fn create(&self, service_name: String, credential_age_days: Option<i64>, user_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, service_name: Option<String>, credential_age_days: Option<i64>, user_name: Option<String>) -> Result<()> {
