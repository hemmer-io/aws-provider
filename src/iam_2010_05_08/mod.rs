//! Iam_2010_05_08 Service
//!
//! Auto-generated service module for iam_2010_05_08

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for iam_2010_05_08
pub struct Iam_2010_05_08Service<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Iam_2010_05_08Service<'a> {
    ...
    /// Get mfa_device resource handler
    pub fn mfa_device(&self) -> resources::Mfa_device<'_> {
        resources::Mfa_device::new(self.provider)
    }
    ...
    /// Get open_id_connect_provider_thumbprint resource handler
    pub fn open_id_connect_provider_thumbprint(&self) -> resources::Open_id_connect_provider_thumbprint<'_> {
        resources::Open_id_connect_provider_thumbprint::new(self.provider)
    }
    ...
    /// Get saml_provider resource handler
    pub fn saml_provider(&self) -> resources::Saml_provider<'_> {
        resources::Saml_provider::new(self.provider)
    }
    /// Get virtual_mfa_device resource handler
    pub fn virtual_mfa_device(&self) -> resources::Virtual_mfa_device<'_> {
        resources::Virtual_mfa_device::new(self.provider)
    }
    ...
    /// Get open_id_connect_provider resource handler
    pub fn open_id_connect_provider(&self) -> resources::Open_id_connect_provider<'_> {
        resources::Open_id_connect_provider::new(self.provider)
    }
