...
impl<'a> PersonalizeService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "solution_version" => {
                self.plan_solution_version(current_state, desired_input)
                    .await
            }
            "recipe" => self.plan_recipe(current_state, desired_input).await,
            "batch_segment_job" => {
                self.plan_batch_segment_job(current_state, desired_input)
                    .await
            }
            "dataset_export_job" => {
                self.plan_dataset_export_job(current_state, desired_input)
                    .await
            }
            "batch_inference_job" => {
                self.plan_batch_inference_job(current_state, desired_input)
                    .await
            }
            "event_tracker" => self.plan_event_tracker(current_state, desired_input).await,
            "data_deletion_job" => {
                self.plan_data_deletion_job(current_state, desired_input)
                    .await
            }
            "dataset_import_job" => {
            ...
            "feature_transformation" => {
                self.plan_feature_transformation(current_state, desired_input)
                    .await
            }
            ...
            "recommender" => self.plan_recommender(current_state, desired_input).await,
            "campaign" => self.plan_campaign(current_state, desired_input).await,
            "dataset" => self.plan_dataset(current_state, desired_input).await,
            "metric_attribution" => {
                self.plan_metric_attribution(current_state, desired_input)
                    .await
            }
            "solution" => self.plan_solution(current_state, desired_input).await,
            "solution_metrics" => {
                self.plan_solution_metrics(current_state, desired_input)
                    .await
            }
            "algorithm" => self.plan_algorithm(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "personalize", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "solution_version" => self.create_solution_version(input).await,
            "recipe" => self.create_recipe(input).await,
            "batch_segment_job" => self.create_batch_segment_job(input).await,
            "dataset_export_job" => self.create_dataset_export_job(input).await,
            "batch_inference_job" => self.create_batch_inference_job(input).await,
            "event_tracker" => self.create_event_tracker(input).await,
            "data_deletion_job" => self.create_data_deletion_job(input).await,
            "dataset_import_job" => self.create_dataset_import_job(input).await,
            "feature_transformation" => self.create_feature_transformation(input).await,
            "dataset_group" => self.create_dataset_group(input).await,
            "filter" => self.create_filter(input).await,
            "recommender" => self.create_recommender(input).await,
            "campaign" => self.create_campaign(input).await,
            "dataset" => self.create_dataset(input).await,
            "metric_attribution" => self.create_metric_attribution(input).await,
            "solution" => self.create_solution(input).await,
            "solution_metrics" => self.create_solution_metrics(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "solution_version" => self.read_solution_version(id).await,
            "recipe" => self.read_recipe(id).await,
            "batch_segment_job" => self.read_batch_segment_job(id).await,
            "dataset_export_job" => self.read_dataset_export_job(id).await,
            "batch_inference_job" => self.read_batch_inference_job(id).await,
            "event_tracker" => self.read_event_tracker(id).await,
            "data_deletion_job" => self.read_data_deletion_job(id).await,
            "dataset_import_job" => self.read_dataset_import_job(id).await,
            "feature_transformation" => self.read_feature_transformation(id).await,
            "dataset_group" => self.read_dataset_group(id).await,
            "filter" => self.read_filter(id).await,
            "recommender" => self.read_recommender(id).await,
            "campaign" => self.read_campaign(id).await,
            "dataset" => self.read_dataset(id).await,
            "metric_attribution" => self.read_metric_attribution(id).await,
            "solution" => self.read_solution(id).await,
            "solution_metrics" => self.read_solution_metrics(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "solution_version" => self.update_solution_version(id, input).await,
            "recipe" => self.update_recipe(id, input).await,
            "batch_segment_job" => self.update_batch_segment_job(id, input).await,
            "dataset_export_job" => self.update_dataset_export_job(id, input).await,
            "batch_inference_job" => self.update_batch_inference_job(id, input).await,
            "event_tracker" => self.update_event_tracker(id, input).await,
            "data_deletion_job" => self.update_data_deletion_job(id, input).await,
            "dataset_import_job" => self.update_dataset_import_job(id, input).await,
            "feature_transformation" => self.update_feature_transformation(id, input).await,
            "dataset_group" => self.update_dataset_group(id, input).await,
            "filter" => self.update_filter(id, input).await,
            "recommender" => self.update_recommender(id, input).await,
            "campaign" => self.update_campaign(id, input).await,
            "dataset" => self.update_dataset(id, input).await,
            "metric_attribution" => self.update_metric_attribution(id, input).await,
            "solution" => self.update_solution(id, input).await,
            "solution_metrics" => self.update_solution_metrics(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "solution_version" => self.delete_solution_version(id).await,
            "recipe" => self.delete_recipe(id).await,
            "batch_segment_job" => self.delete_batch_segment_job(id).await,
            "dataset_export_job" => self.delete_dataset_export_job(id).await,
            "batch_inference_job" => self.delete_batch_inference_job(id).await,
            "event_tracker" => self.delete_event_tracker(id).await,
            "data_deletion_job" => self.delete_data_deletion_job(id).await,
            "dataset_import_job" => self.delete_dataset_import_job(id).await,
            "feature_transformation" => self.delete_feature_transformation(id).await,
            "dataset_group" => self.delete_dataset_group(id).await,
            "filter" => self.delete_filter(id).await,
            "recommender" => self.delete_recommender(id).await,
            "campaign" => self.delete_campaign(id).await,
            "dataset" => self.delete_dataset(id).await,
            "metric_attribution" => self.delete_metric_attribution(id).await,
            "solution" => self.delete_solution(id).await,
            "solution_metrics" => self.delete_solution_metrics(id).await,
    ...
    async fn create_solution_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_solution_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.personalize_client
    ...
    async fn delete_solution_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.personalize_client
    ...
    async fn create_recipe(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_recipe(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.personalize_client
    ...
    async fn update_recipe(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn create_batch_segment_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    solution_version_arn.unwrap_or_default(),
                )
    ...
    async fn read_batch_segment_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.personalize_client
    ...
    async fn delete_batch_segment_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.personalize_client
    ...
    async fn create_dataset_export_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let job_name = input.get_string("job_name")?;
    ...
    async fn read_dataset_export_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.personalize_client
    ...
    async fn delete_dataset_export_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.personalize_client
    ...
    async fn create_batch_inference_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let job_name = input.get_string("job_name")?;
            ...
            let num_results = input.get_optional_string("num_results")?;
            let solution_version_arn = input.get_string("solution_version_arn")?;
            let batch_inference_job_config =
                input.get_optional_string("batch_inference_job_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    batch_inference_job_mode.unwrap_or_default(),
                )
                .with_field("filter_arn", filter_arn.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("num_results", num_results.unwrap_or_default())
                ...
                .with_field(
                    ...
                    batch_inference_job_config.unwrap_or_default(),
                )
                .with_field(
                    "theme_generation_config",
                    theme_generation_config.unwrap_or_default(),
                )
                .with_field("job_input", job_input.unwrap_or_default()))
        })
    }
    ...
    async fn read_batch_inference_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.personalize_client
    ...
    async fn delete_batch_inference_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.personalize_client
    ...
    async fn create_event_tracker(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_event_tracker(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.personalize_client
    ...
    async fn update_event_tracker(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let name = input.get_string("name")?;
    ...
    async fn delete_event_tracker(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.personalize_client
    ...
    async fn create_data_deletion_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_data_deletion_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.personalize_client
    ...
    async fn delete_data_deletion_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.personalize_client
    ...
    async fn create_dataset_import_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let role_arn = input.get_string("role_arn")?;
            let dataset_arn = input.get_string("dataset_arn")?;
            let publish_attribution_metrics_to_s3 =
                input.get_optional_string("publish_attribution_metrics_to_s3")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    publish_attribution_metrics_to_s3.unwrap_or_default(),
                )
    ...
    async fn create_feature_transformation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_feature_transformation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.personalize_client
    ...
    async fn delete_feature_transformation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.personalize_client
    ...
    async fn create_recommender(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
    ...
    async fn read_recommender(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.personalize_client
    ...
    async fn update_recommender(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_recommender(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.personalize_client
    ...
    async fn create_campaign(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "min_provisioned_tps",
                    min_provisioned_tps.unwrap_or_default(),
                )
                .with_field("name", name.unwrap_or_default())
                .with_field(
                    "solution_version_arn",
    ...
    async fn create_metric_attribution(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    metrics_output_config.unwrap_or_default(),
                )
    ...
    async fn read_metric_attribution(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.personalize_client
    ...
    async fn delete_metric_attribution(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.personalize_client
    ...
    async fn create_solution(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    perform_auto_training.unwrap_or_default(),
                )
    ...
    async fn read_solution(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.personalize_client
    ...
    async fn update_solution(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let event_type = input.get_optional_string("event_type")?;
            let dataset_group_arn = input.get_string("dataset_group_arn")?;
    ...
    async fn delete_solution(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.personalize_client
    ...
    async fn create_solution_metrics(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_solution_metrics(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.personalize_client
    ...
    async fn delete_solution_metrics(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.personalize_client
