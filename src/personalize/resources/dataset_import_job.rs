...
impl<'a> Dataset_import_job<'a> {
    ...
    pub async fn create(&self, data_source: String, publish_attribution_metrics_to_s3: Option<bool>, job_name: String, role_arn: String, import_mode: Option<String>, tags: Option<Vec<String>>, dataset_arn: String) -> Result<String> {
