...
impl<'a> Recommender<'a> {
    ...
    pub async fn create(&self, name: String, tags: Option<Vec<String>>, dataset_group_arn: String, recommender_config: Option<String>, recipe_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, tags: Option<Vec<String>>, dataset_group_arn: Option<String>, recommender_config: Option<String>, recipe_arn: Option<String>) -> Result<()> {
