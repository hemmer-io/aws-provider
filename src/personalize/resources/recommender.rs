...
impl<'a> Recommender<'a> {
    ...
    pub async fn create(&self, name: String, dataset_group_arn: String, recipe_arn: String, tags: Option<Vec<String>>, recommender_config: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, dataset_group_arn: Option<String>, recipe_arn: Option<String>, tags: Option<Vec<String>>, recommender_config: Option<String>) -> Result<()> {
