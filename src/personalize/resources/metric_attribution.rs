...
impl<'a> Metric_attribution<'a> {
    ...
    pub async fn create(&self, metrics_output_config: String, metrics: Vec<String>, name: String, dataset_group_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, metrics_output_config: Option<String>, metrics: Option<Vec<String>>, name: Option<String>, dataset_group_arn: Option<String>) -> Result<()> {
