...
impl<'a> Metric_attribution<'a> {
    ...
    pub async fn create(&self, dataset_group_arn: String, metrics: Vec<String>, metrics_output_config: String, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, dataset_group_arn: Option<String>, metrics: Option<Vec<String>>, metrics_output_config: Option<String>, name: Option<String>) -> Result<()> {
