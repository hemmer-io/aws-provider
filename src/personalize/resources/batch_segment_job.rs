...
impl<'a> Batch_segment_job<'a> {
    ...
    pub async fn create(&self, job_output: String, role_arn: String, job_input: String, job_name: String, tags: Option<Vec<String>>, solution_version_arn: String, filter_arn: Option<String>, num_results: Option<i64>) -> Result<String> {
