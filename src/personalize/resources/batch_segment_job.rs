...
impl<'a> Batch_segment_job<'a> {
    ...
    pub async fn create(&self, num_results: Option<i64>, job_input: String, job_name: String, solution_version_arn: String, tags: Option<Vec<String>>, job_output: String, role_arn: String, filter_arn: Option<String>) -> Result<String> {
