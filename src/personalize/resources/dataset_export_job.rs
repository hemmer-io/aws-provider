...
impl<'a> Dataset_export_job<'a> {
    ...
    pub async fn create(&self, job_name: String, ingestion_mode: Option<String>, tags: Option<Vec<String>>, job_output: String, dataset_arn: String, role_arn: String) -> Result<String> {
