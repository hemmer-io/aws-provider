...
impl<'a> Thing_groups_for_thing<'a> {
    ...
    pub async fn update(&self, id: &str, thing_name: Option<String>, thing_groups_to_add: Option<Vec<String>>, override_dynamic_groups: Option<bool>, thing_groups_to_remove: Option<Vec<String>>) -> Result<()> {
