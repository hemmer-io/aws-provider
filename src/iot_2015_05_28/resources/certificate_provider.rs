...
impl<'a> Certificate_provider<'a> {
    ...
    pub async fn create(&self, lambda_function_arn: String, account_default_for_operations: Vec<String>, certificate_provider_name: String, client_token: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, lambda_function_arn: Option<String>, account_default_for_operations: Option<Vec<String>>, certificate_provider_name: Option<String>, client_token: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
