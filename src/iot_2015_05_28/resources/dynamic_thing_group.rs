...
impl<'a> Dynamic_thing_group<'a> {
    ...
    pub async fn create(&self, index_name: Option<String>, thing_group_name: String, thing_group_properties: Option<String>, query_string: String, query_version: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, index_name: Option<String>, thing_group_name: Option<String>, thing_group_properties: Option<String>, query_string: Option<String>, query_version: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
