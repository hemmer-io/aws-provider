//! Freetier service for Aws provider
//!
//! This module handles all freetier resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Freetier service handler
...
impl<'a> FreetierService<'a> {
    ...
    /// Plan changes to a free_tier_usage resource
    async fn plan_free_tier_usage(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Update a free_tier_usage resource
    async fn update_free_tier_usage(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    /// Plan changes to a account_activity resource
    async fn plan_account_activity(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Update a account_activity resource
    async fn update_account_activity(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    /// Plan changes to a account_plan_state resource
    async fn plan_account_plan_state(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Update a account_plan_state resource
    async fn update_account_plan_state(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
