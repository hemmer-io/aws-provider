...
impl<'a> Organization<'a> {
    ...
    pub async fn create(&self, alias: String, client_token: Option<String>, kms_key_arn: Option<String>, enable_interoperability: Option<bool>, directory_id: Option<String>, domains: Option<Vec<String>>) -> Result<String> {
