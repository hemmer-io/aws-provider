...
impl<'a> Identity_provider_configuration<'a> {
    ...
    pub async fn create(&self, authentication_mode: String, identity_center_configuration: String, organization_id: String, personal_access_token_configuration: String) -> Result<String> {
