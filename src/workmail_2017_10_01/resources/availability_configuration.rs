...
impl<'a> Availability_configuration<'a> {
    ...
    pub async fn create(&self, domain_name: String, client_token: Option<String>, organization_id: String, lambda_provider: Option<String>, ews_provider: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, domain_name: Option<String>, client_token: Option<String>, organization_id: Option<String>, lambda_provider: Option<String>, ews_provider: Option<String>) -> Result<()> {
