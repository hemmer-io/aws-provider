...
impl<'a> Resource_config<'a> {
    ...
    pub async fn create(&self, resource_id: String, configuration: String, tags: Option<HashMap<String, String>>, resource_type: String, schema_version_id: String, resource_name: Option<String>) -> Result<String> {
