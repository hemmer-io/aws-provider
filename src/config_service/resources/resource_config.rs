...
impl<'a> Resource_config<'a> {
    ...
    pub async fn create(&self, configuration: String, resource_type: String, resource_id: String, tags: Option<HashMap<String, String>>, schema_version_id: String, resource_name: Option<String>) -> Result<String> {
