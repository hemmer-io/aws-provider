...
impl<'a> Function_definition_version<'a> {
    ...
    pub async fn create(&self, function_definition_id: String, functions: Option<Vec<String>>, default_config: Option<String>, amzn_client_token: Option<String>) -> Result<String> {
