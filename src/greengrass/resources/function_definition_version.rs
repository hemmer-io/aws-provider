...
impl<'a> Function_definition_version<'a> {
    ...
    pub async fn create(&self, amzn_client_token: Option<String>, function_definition_id: String, default_config: Option<String>, functions: Option<Vec<String>>) -> Result<String> {
