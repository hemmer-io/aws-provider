...
impl<'a> Function_definition_version<'a> {
    ...
    pub async fn create(&self, functions: Option<Vec<String>>, default_config: Option<String>, amzn_client_token: Option<String>, function_definition_id: String) -> Result<String> {
