...
impl<'a> Function_definition_version<'a> {
    ...
    pub async fn create(&self, amzn_client_token: Option<String>, default_config: Option<String>, functions: Option<Vec<String>>, function_definition_id: String) -> Result<String> {
