...
impl<'a> Software_update_job<'a> {
    ...
    pub async fn create(&self, update_targets: Vec<String>, update_targets_architecture: String, amzn_client_token: Option<String>, s3_url_signer_role: String, update_agent_log_level: Option<String>, update_targets_operating_system: String, software_to_update: String) -> Result<String> {
