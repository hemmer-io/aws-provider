...
impl<'a> Device_definition<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, name: Option<String>, amzn_client_token: Option<String>, initial_version: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, name: Option<String>, amzn_client_token: Option<String>, initial_version: Option<String>) -> Result<()> {
