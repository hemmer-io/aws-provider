...
impl<'a> Logger_definition<'a> {
    ...
    pub async fn create(&self, initial_version: Option<String>, tags: Option<HashMap<String, String>>, amzn_client_token: Option<String>, name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, initial_version: Option<String>, tags: Option<HashMap<String, String>>, amzn_client_token: Option<String>, name: Option<String>) -> Result<()> {
