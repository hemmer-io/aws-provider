...
impl<'a> WorkspacesService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "workspaces_pools" => {
                self.plan_workspaces_pools(current_state, desired_input)
                    .await
            }
            "workspace_snapshots" => {
                self.plan_workspace_snapshots(current_state, desired_input)
                    .await
            }
            "applications" => self.plan_applications(current_state, desired_input).await,
            "workspace_image_permissions" => {
                self.plan_workspace_image_permissions(current_state, desired_input)
                    .await
            }
            "workspace_image" => {
                self.plan_workspace_image(current_state, desired_input)
                    .await
            }
            "ip_group" => self.plan_ip_group(current_state, desired_input).await,
            "client_branding" => {
                self.plan_client_branding(current_state, desired_input)
                    .await
            }
            "connection_alias_permissions" => {
                self.plan_connection_alias_permissions(current_state, desired_input)
                    .await
            }
            "connection_alias_permission" => {
                self.plan_connection_alias_permission(current_state, desired_input)
                    .await
            }
            "standby_workspaces" => {
                self.plan_standby_workspaces(current_state, desired_input)
                    .await
            }
            "connection_aliases" => {
                self.plan_connection_aliases(current_state, desired_input)
                    .await
            }
            "tags" => self.plan_tags(current_state, desired_input).await,
            "bundle_associations" => {
                self.plan_bundle_associations(current_state, desired_input)
                    .await
            }
            "workspace_directories" => {
                self.plan_workspace_directories(current_state, desired_input)
                    .await
            }
            "account_link_invitation" => {
                self.plan_account_link_invitation(current_state, desired_input)
                    .await
            }
            "client_properties" => {
                self.plan_client_properties(current_state, desired_input)
                    .await
            }
            "connection_alias" => {
                self.plan_connection_alias(current_state, desired_input)
                    .await
            }
            "image_associations" => {
                self.plan_image_associations(current_state, desired_input)
                    .await
            }
            "application_associations" => {
                self.plan_application_associations(current_state, desired_input)
                    .await
            }
            "workspace_bundle" => {
                self.plan_workspace_bundle(current_state, desired_input)
                    .await
            }
            "connect_client_add_ins" => {
                self.plan_connect_client_add_ins(current_state, desired_input)
                    .await
            }
            "workspace_bundles" => {
                self.plan_workspace_bundles(current_state, desired_input)
                    .await
            }
            "workspace_associations" => {
                self.plan_workspace_associations(current_state, desired_input)
                    .await
            }
            "rules_of_ip_group" => {
                self.plan_rules_of_ip_group(current_state, desired_input)
                    .await
            }
            "custom_workspace_image_import" => {
                self.plan_custom_workspace_image_import(current_state, desired_input)
                    .await
            }
            "updated_workspace_image" => {
                self.plan_updated_workspace_image(current_state, desired_input)
                    .await
            }
            "workspaces_pool" => {
                self.plan_workspaces_pool(current_state, desired_input)
                    .await
            }
            "workspace_image_permission" => {
                self.plan_workspace_image_permission(current_state, desired_input)
                    .await
            }
            "account" => self.plan_account(current_state, desired_input).await,
            "workspaces" => self.plan_workspaces(current_state, desired_input).await,
            "workspace_images" => {
                self.plan_workspace_images(current_state, desired_input)
                    .await
            }
            "workspaces_pool_sessions" => {
                self.plan_workspaces_pool_sessions(current_state, desired_input)
                    .await
            }
            "account_link" => self.plan_account_link(current_state, desired_input).await,
            "account_modifications" => {
                self.plan_account_modifications(current_state, desired_input)
                    .await
            }
            "workspaces_connection_status" => {
                self.plan_workspaces_connection_status(current_state, desired_input)
                    .await
            }
            "ip_groups" => self.plan_ip_groups(current_state, desired_input).await,
            "connect_client_add_in" => {
                self.plan_connect_client_add_in(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workspaces", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "workspaces_pools" => self.create_workspaces_pools(input).await,
            "workspace_snapshots" => self.create_workspace_snapshots(input).await,
            "applications" => self.create_applications(input).await,
            "workspace_image_permissions" => self.create_workspace_image_permissions(input).await,
            "workspace_image" => self.create_workspace_image(input).await,
            "ip_group" => self.create_ip_group(input).await,
            "client_branding" => self.create_client_branding(input).await,
            "connection_alias_permissions" => self.create_connection_alias_permissions(input).await,
            "connection_alias_permission" => self.create_connection_alias_permission(input).await,
            "standby_workspaces" => self.create_standby_workspaces(input).await,
            "connection_aliases" => self.create_connection_aliases(input).await,
            "tags" => self.create_tags(input).await,
            "bundle_associations" => self.create_bundle_associations(input).await,
            "workspace_directories" => self.create_workspace_directories(input).await,
            "account_link_invitation" => self.create_account_link_invitation(input).await,
            "client_properties" => self.create_client_properties(input).await,
            "connection_alias" => self.create_connection_alias(input).await,
            "image_associations" => self.create_image_associations(input).await,
            "application_associations" => self.create_application_associations(input).await,
            "workspace_bundle" => self.create_workspace_bundle(input).await,
            "connect_client_add_ins" => self.create_connect_client_add_ins(input).await,
            "workspace_bundles" => self.create_workspace_bundles(input).await,
            "workspace_associations" => self.create_workspace_associations(input).await,
            "rules_of_ip_group" => self.create_rules_of_ip_group(input).await,
            "custom_workspace_image_import" => {
                self.create_custom_workspace_image_import(input).await
            }
            "updated_workspace_image" => self.create_updated_workspace_image(input).await,
            "workspaces_pool" => self.create_workspaces_pool(input).await,
            "workspace_image_permission" => self.create_workspace_image_permission(input).await,
            "account" => self.create_account(input).await,
            "workspaces" => self.create_workspaces(input).await,
            "workspace_images" => self.create_workspace_images(input).await,
            "workspaces_pool_sessions" => self.create_workspaces_pool_sessions(input).await,
            "account_link" => self.create_account_link(input).await,
            "account_modifications" => self.create_account_modifications(input).await,
            "workspaces_connection_status" => self.create_workspaces_connection_status(input).await,
            "ip_groups" => self.create_ip_groups(input).await,
            "connect_client_add_in" => self.create_connect_client_add_in(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workspaces", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "workspaces_pools" => self.read_workspaces_pools(id).await,
            "workspace_snapshots" => self.read_workspace_snapshots(id).await,
            "applications" => self.read_applications(id).await,
            "workspace_image_permissions" => self.read_workspace_image_permissions(id).await,
            "workspace_image" => self.read_workspace_image(id).await,
            "ip_group" => self.read_ip_group(id).await,
            "client_branding" => self.read_client_branding(id).await,
            "connection_alias_permissions" => self.read_connection_alias_permissions(id).await,
            "connection_alias_permission" => self.read_connection_alias_permission(id).await,
            "standby_workspaces" => self.read_standby_workspaces(id).await,
            "connection_aliases" => self.read_connection_aliases(id).await,
            "tags" => self.read_tags(id).await,
            "bundle_associations" => self.read_bundle_associations(id).await,
            "workspace_directories" => self.read_workspace_directories(id).await,
            "account_link_invitation" => self.read_account_link_invitation(id).await,
            "client_properties" => self.read_client_properties(id).await,
            "connection_alias" => self.read_connection_alias(id).await,
            "image_associations" => self.read_image_associations(id).await,
            "application_associations" => self.read_application_associations(id).await,
            "workspace_bundle" => self.read_workspace_bundle(id).await,
            "connect_client_add_ins" => self.read_connect_client_add_ins(id).await,
            "workspace_bundles" => self.read_workspace_bundles(id).await,
            "workspace_associations" => self.read_workspace_associations(id).await,
            "rules_of_ip_group" => self.read_rules_of_ip_group(id).await,
            "custom_workspace_image_import" => self.read_custom_workspace_image_import(id).await,
            "updated_workspace_image" => self.read_updated_workspace_image(id).await,
            "workspaces_pool" => self.read_workspaces_pool(id).await,
            "workspace_image_permission" => self.read_workspace_image_permission(id).await,
            "account" => self.read_account(id).await,
            "workspaces" => self.read_workspaces(id).await,
            "workspace_images" => self.read_workspace_images(id).await,
            "workspaces_pool_sessions" => self.read_workspaces_pool_sessions(id).await,
            "account_link" => self.read_account_link(id).await,
            "account_modifications" => self.read_account_modifications(id).await,
            "workspaces_connection_status" => self.read_workspaces_connection_status(id).await,
            "ip_groups" => self.read_ip_groups(id).await,
            "connect_client_add_in" => self.read_connect_client_add_in(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workspaces", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "workspaces_pools" => self.update_workspaces_pools(id, input).await,
            "workspace_snapshots" => self.update_workspace_snapshots(id, input).await,
            "applications" => self.update_applications(id, input).await,
            "workspace_image_permissions" => {
                self.update_workspace_image_permissions(id, input).await
            }
            "workspace_image" => self.update_workspace_image(id, input).await,
            "ip_group" => self.update_ip_group(id, input).await,
            "client_branding" => self.update_client_branding(id, input).await,
            "connection_alias_permissions" => {
            ...
            "standby_workspaces" => self.update_standby_workspaces(id, input).await,
            "connection_aliases" => self.update_connection_aliases(id, input).await,
            "tags" => self.update_tags(id, input).await,
            "bundle_associations" => self.update_bundle_associations(id, input).await,
            "workspace_directories" => self.update_workspace_directories(id, input).await,
            "account_link_invitation" => self.update_account_link_invitation(id, input).await,
            "client_properties" => self.update_client_properties(id, input).await,
            "connection_alias" => self.update_connection_alias(id, input).await,
            "image_associations" => self.update_image_associations(id, input).await,
            "application_associations" => self.update_application_associations(id, input).await,
            "workspace_bundle" => self.update_workspace_bundle(id, input).await,
            "connect_client_add_ins" => self.update_connect_client_add_ins(id, input).await,
            "workspace_bundles" => self.update_workspace_bundles(id, input).await,
            "workspace_associations" => self.update_workspace_associations(id, input).await,
            "rules_of_ip_group" => self.update_rules_of_ip_group(id, input).await,
            "custom_workspace_image_import" => {
                self.update_custom_workspace_image_import(id, input).await
            }
            "updated_workspace_image" => self.update_updated_workspace_image(id, input).await,
            "workspaces_pool" => self.update_workspaces_pool(id, input).await,
            "workspace_image_permission" => self.update_workspace_image_permission(id, input).await,
            "account" => self.update_account(id, input).await,
            "workspaces" => self.update_workspaces(id, input).await,
            "workspace_images" => self.update_workspace_images(id, input).await,
            "workspaces_pool_sessions" => self.update_workspaces_pool_sessions(id, input).await,
            "account_link" => self.update_account_link(id, input).await,
            "account_modifications" => self.update_account_modifications(id, input).await,
            "workspaces_connection_status" => {
                self.update_workspaces_connection_status(id, input).await
            }
            "ip_groups" => self.update_ip_groups(id, input).await,
            "connect_client_add_in" => self.update_connect_client_add_in(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workspaces", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "workspaces_pools" => self.delete_workspaces_pools(id).await,
            "workspace_snapshots" => self.delete_workspace_snapshots(id).await,
            "applications" => self.delete_applications(id).await,
            "workspace_image_permissions" => self.delete_workspace_image_permissions(id).await,
            "workspace_image" => self.delete_workspace_image(id).await,
            "ip_group" => self.delete_ip_group(id).await,
            "client_branding" => self.delete_client_branding(id).await,
            "connection_alias_permissions" => self.delete_connection_alias_permissions(id).await,
            "connection_alias_permission" => self.delete_connection_alias_permission(id).await,
            "standby_workspaces" => self.delete_standby_workspaces(id).await,
            "connection_aliases" => self.delete_connection_aliases(id).await,
            "tags" => self.delete_tags(id).await,
            "bundle_associations" => self.delete_bundle_associations(id).await,
            "workspace_directories" => self.delete_workspace_directories(id).await,
            "account_link_invitation" => self.delete_account_link_invitation(id).await,
            "client_properties" => self.delete_client_properties(id).await,
            "connection_alias" => self.delete_connection_alias(id).await,
            "image_associations" => self.delete_image_associations(id).await,
            "application_associations" => self.delete_application_associations(id).await,
            "workspace_bundle" => self.delete_workspace_bundle(id).await,
            "connect_client_add_ins" => self.delete_connect_client_add_ins(id).await,
            "workspace_bundles" => self.delete_workspace_bundles(id).await,
            "workspace_associations" => self.delete_workspace_associations(id).await,
            "rules_of_ip_group" => self.delete_rules_of_ip_group(id).await,
            "custom_workspace_image_import" => self.delete_custom_workspace_image_import(id).await,
            "updated_workspace_image" => self.delete_updated_workspace_image(id).await,
            "workspaces_pool" => self.delete_workspaces_pool(id).await,
            "workspace_image_permission" => self.delete_workspace_image_permission(id).await,
            "account" => self.delete_account(id).await,
            "workspaces" => self.delete_workspaces(id).await,
            "workspace_images" => self.delete_workspace_images(id).await,
            "workspaces_pool_sessions" => self.delete_workspaces_pool_sessions(id).await,
            "account_link" => self.delete_account_link(id).await,
            "account_modifications" => self.delete_account_modifications(id).await,
            "workspaces_connection_status" => self.delete_workspaces_connection_status(id).await,
            "ip_groups" => self.delete_ip_groups(id).await,
            "connect_client_add_in" => self.delete_connect_client_add_in(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workspaces", resource_name
            ))),
    ...
    async fn create_workspaces_pools(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_workspaces_pools(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_workspaces_pools(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_workspace_snapshots(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_workspace_snapshots(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_workspace_snapshots(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn read_workspace_image_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_workspace_image_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_workspace_image(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_workspace_image(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_workspace_image(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_ip_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_ip_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn update_ip_group(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let user_rules = input.get_optional_string("user_rules")?;
            let group_desc = input.get_optional_string("group_desc")?;
    ...
    async fn delete_ip_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_client_branding(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_client_branding(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_client_branding(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn read_connection_alias_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_connection_alias_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_connection_alias_permission(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "connection_alias_permission",
                    connection_alias_permission.unwrap_or_default(),
                )
    ...
    async fn read_connection_alias_permission(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_connection_alias_permission(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_standby_workspaces(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_standby_workspaces(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_standby_workspaces(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_connection_aliases(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_connection_aliases(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_connection_aliases(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_bundle_associations(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_bundle_associations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_bundle_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_workspace_directories(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_workspace_directories(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_workspace_directories(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_account_link_invitation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_account_link_invitation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_account_link_invitation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_client_properties(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_client_properties(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_client_properties(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_connection_alias(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_connection_alias(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_connection_alias(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_image_associations(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_image_associations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_image_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn read_application_associations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_application_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_workspace_bundle(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_workspace_bundle(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_workspace_bundle(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_connect_client_add_ins(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_connect_client_add_ins(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_connect_client_add_ins(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_workspace_bundles(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_workspace_bundles(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_workspace_bundles(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_workspace_associations(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_workspace_associations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_workspace_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_rules_of_ip_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_rules_of_ip_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_rules_of_ip_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn read_custom_workspace_image_import(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_custom_workspace_image_import(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_updated_workspace_image(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
    ...
    async fn read_updated_workspace_image(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_updated_workspace_image(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_workspaces_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_workspaces_pool(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_workspaces_pool(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn read_workspace_image_permission(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_workspace_image_permission(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_workspaces(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_workspaces(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn update_workspaces(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let workspaces = input.get_string("workspaces")?;
    ...
    async fn delete_workspaces(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_workspace_images(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_workspace_images(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_workspace_images(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn read_workspaces_pool_sessions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_workspaces_pool_sessions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_account_link(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_account_link(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn update_account_link(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_account_link(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_account_modifications(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_account_modifications(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_account_modifications(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn read_workspaces_connection_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_workspaces_connection_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_ip_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_ip_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn update_ip_groups(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_ip_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
    ...
    async fn create_connect_client_add_in(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let resource_id = input.get_string("resource_id")?;
    ...
    async fn read_connect_client_add_in(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.workspaces_client
    ...
    async fn delete_connect_client_add_in(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.workspaces_client
