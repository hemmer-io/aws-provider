...
impl<'a> Sesv2Service<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "email_identity_configuration_set_attributes" => {
                self.plan_email_identity_configuration_set_attributes(current_state, desired_input)
                    .await
            }
            "reputation_entity_customer_managed_status" => {
                self.plan_reputation_entity_customer_managed_status(current_state, desired_input)
                    .await
            }
            "email_identity_mail_from_attributes" => {
                self.plan_email_identity_mail_from_attributes(current_state, desired_input)
                    .await
            }
            "reputation_entity_policy" => {
                self.plan_reputation_entity_policy(current_state, desired_input)
                    .await
            }
            "tenant" => self.plan_tenant(current_state, desired_input).await,
            "deliverability_dashboard_option" => {
                self.plan_deliverability_dashboard_option(current_state, desired_input)
                    .await
            }
            "message_insights" => {
                self.plan_message_insights(current_state, desired_input)
                    .await
            }
            "account_details" => {
                self.plan_account_details(current_state, desired_input)
                    .await
            }
            "email_identity_dkim_signing_attributes" => {
                self.plan_email_identity_dkim_signing_attributes(current_state, desired_input)
                    .await
            }
            "configuration_set_delivery_options" => {
                self.plan_configuration_set_delivery_options(current_state, desired_input)
                    .await
            }
            "email_identity_policies" => {
                self.plan_email_identity_policies(current_state, desired_input)
                    .await
            }
            "dedicated_ip_pool" => {
                self.plan_dedicated_ip_pool(current_state, desired_input)
                    .await
            }
            "configuration_set_archiving_options" => {
                self.plan_configuration_set_archiving_options(current_state, desired_input)
                    .await
            }
            "email_template" => self.plan_email_template(current_state, desired_input).await,
            "multi_region_endpoint" => {
                self.plan_multi_region_endpoint(current_state, desired_input)
                    .await
            }
            "account" => self.plan_account(current_state, desired_input).await,
            "dedicated_ip" => self.plan_dedicated_ip(current_state, desired_input).await,
            "dedicated_ips" => self.plan_dedicated_ips(current_state, desired_input).await,
            "blacklist_reports" => {
                self.plan_blacklist_reports(current_state, desired_input)
                    .await
            }
            "tenant_resource_association" => {
                self.plan_tenant_resource_association(current_state, desired_input)
                    .await
            }
            "account_dedicated_ip_warmup_attributes" => {
                self.plan_account_dedicated_ip_warmup_attributes(current_state, desired_input)
                    .await
            }
            ...
            "configuration_set_reputation_options" => {
                self.plan_configuration_set_reputation_options(current_state, desired_input)
                    .await
            }
            ...
            "reputation_entity" => {
                self.plan_reputation_entity(current_state, desired_input)
                    .await
            }
            "account_suppression_attributes" => {
                self.plan_account_suppression_attributes(current_state, desired_input)
                    .await
            }
            "configuration_set_tracking_options" => {
                self.plan_configuration_set_tracking_options(current_state, desired_input)
                    .await
            }
            "domain_statistics_report" => {
                self.plan_domain_statistics_report(current_state, desired_input)
                    .await
            }
            "deliverability_test_report" => {
                self.plan_deliverability_test_report(current_state, desired_input)
                    .await
            }
            "configuration_set_suppression_options" => {
                self.plan_configuration_set_suppression_options(current_state, desired_input)
                    .await
            }
            "dedicated_ip_warmup_attributes" => {
                self.plan_dedicated_ip_warmup_attributes(current_state, desired_input)
                    .await
            }
            "custom_verification_email_template" => {
                self.plan_custom_verification_email_template(current_state, desired_input)
                    .await
            }
            ...
            "account_vdm_attributes" => {
                self.plan_account_vdm_attributes(current_state, desired_input)
                    .await
            }
            "configuration_set_sending_options" => {
                self.plan_configuration_set_sending_options(current_state, desired_input)
                    .await
            }
            "import_job" => self.plan_import_job(current_state, desired_input).await,
            "domain_deliverability_campaign" => {
                self.plan_domain_deliverability_campaign(current_state, desired_input)
                    .await
            }
            "email_identity_policy" => {
                self.plan_email_identity_policy(current_state, desired_input)
                    .await
            }
            "email_identity" => self.plan_email_identity(current_state, desired_input).await,
            "account_sending_attributes" => {
                self.plan_account_sending_attributes(current_state, desired_input)
                    .await
            }
            "suppressed_destination" => {
                self.plan_suppressed_destination(current_state, desired_input)
                    .await
            }
            "deliverability_dashboard_options" => {
                self.plan_deliverability_dashboard_options(current_state, desired_input)
                    .await
            }
            "configuration_set_vdm_options" => {
                self.plan_configuration_set_vdm_options(current_state, desired_input)
                    .await
            }
            "dedicated_ip_in_pool" => {
                self.plan_dedicated_ip_in_pool(current_state, desired_input)
                    .await
            }
            "email_identity_dkim_attributes" => {
                self.plan_email_identity_dkim_attributes(current_state, desired_input)
                    .await
            }
            "dedicated_ip_pool_scaling_attributes" => {
                self.plan_dedicated_ip_pool_scaling_attributes(current_state, desired_input)
                    .await
            }
            "contact_list" => self.plan_contact_list(current_state, desired_input).await,
            "email_identity_feedback_attributes" => {
                self.plan_email_identity_feedback_attributes(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "email_identity_configuration_set_attributes" => {
                self.create_email_identity_configuration_set_attributes(input)
                    .await
            }
            "reputation_entity_customer_managed_status" => {
                self.create_reputation_entity_customer_managed_status(input)
                    .await
            }
            "email_identity_mail_from_attributes" => {
                self.create_email_identity_mail_from_attributes(input).await
            }
            "reputation_entity_policy" => self.create_reputation_entity_policy(input).await,
            "tenant" => self.create_tenant(input).await,
            "deliverability_dashboard_option" => {
                self.create_deliverability_dashboard_option(input).await
            }
            "message_insights" => self.create_message_insights(input).await,
            "account_details" => self.create_account_details(input).await,
            "email_identity_dkim_signing_attributes" => {
                self.create_email_identity_dkim_signing_attributes(input)
                    .await
            }
            "configuration_set_delivery_options" => {
                self.create_configuration_set_delivery_options(input).await
            }
            "email_identity_policies" => self.create_email_identity_policies(input).await,
            "dedicated_ip_pool" => self.create_dedicated_ip_pool(input).await,
            "configuration_set_archiving_options" => {
                self.create_configuration_set_archiving_options(input).await
            }
            "email_template" => self.create_email_template(input).await,
            "multi_region_endpoint" => self.create_multi_region_endpoint(input).await,
            "account" => self.create_account(input).await,
            "dedicated_ip" => self.create_dedicated_ip(input).await,
            "dedicated_ips" => self.create_dedicated_ips(input).await,
            "blacklist_reports" => self.create_blacklist_reports(input).await,
            "tenant_resource_association" => self.create_tenant_resource_association(input).await,
            "account_dedicated_ip_warmup_attributes" => {
                self.create_account_dedicated_ip_warmup_attributes(input)
                    .await
            }
            "configuration_set_event_destination" => {
            ...
            "configuration_set_reputation_options" => {
                self.create_configuration_set_reputation_options(input)
                    .await
            }
            "contact" => self.create_contact(input).await,
            "export_job" => self.create_export_job(input).await,
            "reputation_entity" => self.create_reputation_entity(input).await,
            "account_suppression_attributes" => {
            ...
            "domain_statistics_report" => self.create_domain_statistics_report(input).await,
            "deliverability_test_report" => self.create_deliverability_test_report(input).await,
            "configuration_set_suppression_options" => {
                self.create_configuration_set_suppression_options(input)
                    .await
            }
            "dedicated_ip_warmup_attributes" => {
            ...
            "account_vdm_attributes" => self.create_account_vdm_attributes(input).await,
            "configuration_set_sending_options" => {
            ...
            "email_identity_policy" => self.create_email_identity_policy(input).await,
            "email_identity" => self.create_email_identity(input).await,
            "account_sending_attributes" => self.create_account_sending_attributes(input).await,
            "suppressed_destination" => self.create_suppressed_destination(input).await,
            "deliverability_dashboard_options" => {
            ...
            "dedicated_ip_in_pool" => self.create_dedicated_ip_in_pool(input).await,
            "email_identity_dkim_attributes" => {
                self.create_email_identity_dkim_attributes(input).await
            }
            "dedicated_ip_pool_scaling_attributes" => {
                self.create_dedicated_ip_pool_scaling_attributes(input)
                    .await
            }
            "contact_list" => self.create_contact_list(input).await,
            "email_identity_feedback_attributes" => {
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "email_identity_configuration_set_attributes" => {
                self.read_email_identity_configuration_set_attributes(id)
                    .await
            }
            "reputation_entity_customer_managed_status" => {
                self.read_reputation_entity_customer_managed_status(id)
                    .await
            }
            "email_identity_mail_from_attributes" => {
                self.read_email_identity_mail_from_attributes(id).await
            }
            "reputation_entity_policy" => self.read_reputation_entity_policy(id).await,
            "tenant" => self.read_tenant(id).await,
            "deliverability_dashboard_option" => {
                self.read_deliverability_dashboard_option(id).await
            }
            "message_insights" => self.read_message_insights(id).await,
            "account_details" => self.read_account_details(id).await,
            "email_identity_dkim_signing_attributes" => {
            ...
            "email_identity_policies" => self.read_email_identity_policies(id).await,
            "dedicated_ip_pool" => self.read_dedicated_ip_pool(id).await,
            "configuration_set_archiving_options" => {
                self.read_configuration_set_archiving_options(id).await
            }
            "email_template" => self.read_email_template(id).await,
            "multi_region_endpoint" => self.read_multi_region_endpoint(id).await,
            "account" => self.read_account(id).await,
            "dedicated_ip" => self.read_dedicated_ip(id).await,
            "dedicated_ips" => self.read_dedicated_ips(id).await,
            "blacklist_reports" => self.read_blacklist_reports(id).await,
            "tenant_resource_association" => self.read_tenant_resource_association(id).await,
            "account_dedicated_ip_warmup_attributes" => {
            ...
            "reputation_entity" => self.read_reputation_entity(id).await,
            "account_suppression_attributes" => self.read_account_suppression_attributes(id).await,
            "configuration_set_tracking_options" => {
                self.read_configuration_set_tracking_options(id).await
            }
            "domain_statistics_report" => self.read_domain_statistics_report(id).await,
            "deliverability_test_report" => self.read_deliverability_test_report(id).await,
            "configuration_set_suppression_options" => {
                self.read_configuration_set_suppression_options(id).await
            }
            "dedicated_ip_warmup_attributes" => self.read_dedicated_ip_warmup_attributes(id).await,
            "custom_verification_email_template" => {
            ...
            "account_vdm_attributes" => self.read_account_vdm_attributes(id).await,
            "configuration_set_sending_options" => {
                self.read_configuration_set_sending_options(id).await
            }
            "import_job" => self.read_import_job(id).await,
            "domain_deliverability_campaign" => self.read_domain_deliverability_campaign(id).await,
            "email_identity_policy" => self.read_email_identity_policy(id).await,
            "email_identity" => self.read_email_identity(id).await,
            "account_sending_attributes" => self.read_account_sending_attributes(id).await,
            "suppressed_destination" => self.read_suppressed_destination(id).await,
            "deliverability_dashboard_options" => {
                self.read_deliverability_dashboard_options(id).await
            }
            "configuration_set_vdm_options" => self.read_configuration_set_vdm_options(id).await,
            "dedicated_ip_in_pool" => self.read_dedicated_ip_in_pool(id).await,
            "email_identity_dkim_attributes" => self.read_email_identity_dkim_attributes(id).await,
            "dedicated_ip_pool_scaling_attributes" => {
                self.read_dedicated_ip_pool_scaling_attributes(id).await
            }
            "contact_list" => self.read_contact_list(id).await,
            "email_identity_feedback_attributes" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "email_identity_configuration_set_attributes" => {
                self.update_email_identity_configuration_set_attributes(id, input)
                    .await
            }
            "reputation_entity_customer_managed_status" => {
                self.update_reputation_entity_customer_managed_status(id, input)
                    .await
            }
            "email_identity_mail_from_attributes" => {
                self.update_email_identity_mail_from_attributes(id, input)
                    .await
            }
            "reputation_entity_policy" => self.update_reputation_entity_policy(id, input).await,
            "tenant" => self.update_tenant(id, input).await,
            "deliverability_dashboard_option" => {
                self.update_deliverability_dashboard_option(id, input).await
            }
            "message_insights" => self.update_message_insights(id, input).await,
            "account_details" => self.update_account_details(id, input).await,
            "email_identity_dkim_signing_attributes" => {
                self.update_email_identity_dkim_signing_attributes(id, input)
                    .await
            }
            "configuration_set_delivery_options" => {
                self.update_configuration_set_delivery_options(id, input)
                    .await
            }
            "email_identity_policies" => self.update_email_identity_policies(id, input).await,
            "dedicated_ip_pool" => self.update_dedicated_ip_pool(id, input).await,
            "configuration_set_archiving_options" => {
                self.update_configuration_set_archiving_options(id, input)
                    .await
            }
            "email_template" => self.update_email_template(id, input).await,
            "multi_region_endpoint" => self.update_multi_region_endpoint(id, input).await,
            "account" => self.update_account(id, input).await,
            "dedicated_ip" => self.update_dedicated_ip(id, input).await,
            "dedicated_ips" => self.update_dedicated_ips(id, input).await,
            "blacklist_reports" => self.update_blacklist_reports(id, input).await,
            "tenant_resource_association" => {
                self.update_tenant_resource_association(id, input).await
            }
            "account_dedicated_ip_warmup_attributes" => {
                self.update_account_dedicated_ip_warmup_attributes(id, input)
                    .await
            }
            "configuration_set_event_destination" => {
            ...
            "configuration_set_reputation_options" => {
                self.update_configuration_set_reputation_options(id, input)
                    .await
            }
            "contact" => self.update_contact(id, input).await,
            "export_job" => self.update_export_job(id, input).await,
            "reputation_entity" => self.update_reputation_entity(id, input).await,
            "account_suppression_attributes" => {
                self.update_account_suppression_attributes(id, input).await
            }
            "configuration_set_tracking_options" => {
                self.update_configuration_set_tracking_options(id, input)
                    .await
            }
            "domain_statistics_report" => self.update_domain_statistics_report(id, input).await,
            "deliverability_test_report" => self.update_deliverability_test_report(id, input).await,
            "configuration_set_suppression_options" => {
                self.update_configuration_set_suppression_options(id, input)
                    .await
            }
            "dedicated_ip_warmup_attributes" => {
            ...
            "custom_verification_email_template" => {
                self.update_custom_verification_email_template(id, input)
                    .await
            }
            "configuration_set_event_destinations" => {
            ...
            "account_vdm_attributes" => self.update_account_vdm_attributes(id, input).await,
            "configuration_set_sending_options" => {
                self.update_configuration_set_sending_options(id, input)
                    .await
            }
            ...
            "email_identity_policy" => self.update_email_identity_policy(id, input).await,
            "email_identity" => self.update_email_identity(id, input).await,
            "account_sending_attributes" => self.update_account_sending_attributes(id, input).await,
            "suppressed_destination" => self.update_suppressed_destination(id, input).await,
            "deliverability_dashboard_options" => {
                self.update_deliverability_dashboard_options(id, input)
                    .await
            }
            "configuration_set_vdm_options" => {
                self.update_configuration_set_vdm_options(id, input).await
            }
            "dedicated_ip_in_pool" => self.update_dedicated_ip_in_pool(id, input).await,
            "email_identity_dkim_attributes" => {
                self.update_email_identity_dkim_attributes(id, input).await
            }
            "dedicated_ip_pool_scaling_attributes" => {
                self.update_dedicated_ip_pool_scaling_attributes(id, input)
                    .await
            }
            "contact_list" => self.update_contact_list(id, input).await,
            "email_identity_feedback_attributes" => {
                self.update_email_identity_feedback_attributes(id, input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "email_identity_configuration_set_attributes" => {
                self.delete_email_identity_configuration_set_attributes(id)
                    .await
            }
            "reputation_entity_customer_managed_status" => {
                self.delete_reputation_entity_customer_managed_status(id)
                    .await
            }
            "email_identity_mail_from_attributes" => {
                self.delete_email_identity_mail_from_attributes(id).await
            }
            "reputation_entity_policy" => self.delete_reputation_entity_policy(id).await,
            "tenant" => self.delete_tenant(id).await,
            "deliverability_dashboard_option" => {
                self.delete_deliverability_dashboard_option(id).await
            }
            "message_insights" => self.delete_message_insights(id).await,
            "account_details" => self.delete_account_details(id).await,
            "email_identity_dkim_signing_attributes" => {
            ...
            "email_identity_policies" => self.delete_email_identity_policies(id).await,
            "dedicated_ip_pool" => self.delete_dedicated_ip_pool(id).await,
            "configuration_set_archiving_options" => {
                self.delete_configuration_set_archiving_options(id).await
            }
            "email_template" => self.delete_email_template(id).await,
            "multi_region_endpoint" => self.delete_multi_region_endpoint(id).await,
            "account" => self.delete_account(id).await,
            "dedicated_ip" => self.delete_dedicated_ip(id).await,
            "dedicated_ips" => self.delete_dedicated_ips(id).await,
            "blacklist_reports" => self.delete_blacklist_reports(id).await,
            "tenant_resource_association" => self.delete_tenant_resource_association(id).await,
            "account_dedicated_ip_warmup_attributes" => {
            ...
            "reputation_entity" => self.delete_reputation_entity(id).await,
            "account_suppression_attributes" => {
            ...
            "domain_statistics_report" => self.delete_domain_statistics_report(id).await,
            "deliverability_test_report" => self.delete_deliverability_test_report(id).await,
            "configuration_set_suppression_options" => {
            ...
            "account_vdm_attributes" => self.delete_account_vdm_attributes(id).await,
            "configuration_set_sending_options" => {
            ...
            "email_identity_policy" => self.delete_email_identity_policy(id).await,
            "email_identity" => self.delete_email_identity(id).await,
            "account_sending_attributes" => self.delete_account_sending_attributes(id).await,
            "suppressed_destination" => self.delete_suppressed_destination(id).await,
            "deliverability_dashboard_options" => {
                self.delete_deliverability_dashboard_options(id).await
            }
            "configuration_set_vdm_options" => self.delete_configuration_set_vdm_options(id).await,
            "dedicated_ip_in_pool" => self.delete_dedicated_ip_in_pool(id).await,
            "email_identity_dkim_attributes" => {
            ...
            "contact_list" => self.delete_contact_list(id).await,
            "email_identity_feedback_attributes" => {
    ...
    async fn delete_email_identity_configuration_set_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    reputation_entity_type.unwrap_or_default(),
                )
                .with_field(
                    "reputation_entity_reference",
                    reputation_entity_reference.unwrap_or_default(),
                )
    ...
    async fn delete_reputation_entity_customer_managed_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    behavior_on_mx_failure.unwrap_or_default(),
                )
    ...
    async fn read_email_identity_mail_from_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_email_identity_mail_from_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_reputation_entity_policy(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "reputation_entity_policy",
                    reputation_entity_policy.unwrap_or_default(),
                )
                .with_field(
                    "reputation_entity_type",
                    reputation_entity_type.unwrap_or_default(),
    ...
    async fn read_reputation_entity_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_reputation_entity_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_deliverability_dashboard_option(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_deliverability_dashboard_option(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_message_insights(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_message_insights(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_message_insights(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_account_details(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let production_access_enabled =
                input.get_optional_string("production_access_enabled")?;
            ...
            let additional_contact_email_addresses =
                input.get_optional_string("additional_contact_email_addresses")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    production_access_enabled.unwrap_or_default(),
                )
                .with_field(
                    "use_case_description",
                    use_case_description.unwrap_or_default(),
                )
                .with_field("contact_language", contact_language.unwrap_or_default())
                .with_field(
                    "additional_contact_email_addresses",
                    additional_contact_email_addresses.unwrap_or_default(),
                )
    ...
    async fn read_account_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_account_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    signing_attributes_origin.unwrap_or_default(),
                )
                .with_field("email_identity", email_identity.unwrap_or_default())
    ...
    async fn delete_email_identity_dkim_signing_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    max_delivery_seconds.unwrap_or_default(),
                ))
        })
    }

    /// Read a configuration_set_delivery_options resource
    async fn read_configuration_set_delivery_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_configuration_set_delivery_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_email_identity_policies(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_email_identity_policies(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_email_identity_policies(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_dedicated_ip_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_dedicated_ip_pool(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_dedicated_ip_pool(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_configuration_set_archiving_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_configuration_set_archiving_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_multi_region_endpoint(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_multi_region_endpoint(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_multi_region_endpoint(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_dedicated_ip(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_dedicated_ip(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn update_dedicated_ip(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_dedicated_ip(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_dedicated_ips(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_dedicated_ips(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn update_dedicated_ips(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_dedicated_ips(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_blacklist_reports(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_blacklist_reports(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_blacklist_reports(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_tenant_resource_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_tenant_resource_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_account_dedicated_ip_warmup_attributes(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "auto_warmup_enabled",
                auto_warmup_enabled.unwrap_or_default(),
            ))
        })
    }
    ...
    async fn delete_account_dedicated_ip_warmup_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_configuration_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "suppression_options",
                    suppression_options.unwrap_or_default(),
                )
    ...
    async fn create_configuration_set_reputation_options(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let configuration_set_name = input.get_string("configuration_set_name")?;
            let reputation_metrics_enabled =
                input.get_optional_string("reputation_metrics_enabled")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    reputation_metrics_enabled.unwrap_or_default(),
                ))
        })
    }

    /// Read a configuration_set_reputation_options resource
    async fn read_configuration_set_reputation_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_configuration_set_reputation_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_reputation_entity(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_reputation_entity(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_reputation_entity(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_account_suppression_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_account_suppression_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    custom_redirect_domain.unwrap_or_default(),
                ))
        })
    }

    /// Read a configuration_set_tracking_options resource
    async fn read_configuration_set_tracking_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_configuration_set_tracking_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_domain_statistics_report(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_domain_statistics_report(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_deliverability_test_report(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_deliverability_test_report(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_configuration_set_suppression_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_configuration_set_suppression_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_dedicated_ip_warmup_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_dedicated_ip_warmup_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    success_redirection_url.unwrap_or_default(),
                )
                .with_field("template_content", template_content.unwrap_or_default())
                .with_field(
                    "failure_redirection_url",
                    failure_redirection_url.unwrap_or_default(),
                ))
        })
    }

    /// Read a custom_verification_email_template resource
    async fn read_custom_verification_email_template(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_custom_verification_email_template(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_account_vdm_attributes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_account_vdm_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_account_vdm_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_configuration_set_sending_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_configuration_set_sending_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_domain_deliverability_campaign(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_domain_deliverability_campaign(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_email_identity_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_email_identity_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_email_identity_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_email_identity(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    dkim_signing_attributes.unwrap_or_default(),
                ))
        })
    }

    /// Read a email_identity resource
    async fn read_email_identity(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_email_identity(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_account_sending_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_account_sending_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_suppressed_destination(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_suppressed_destination(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_suppressed_destination(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_deliverability_dashboard_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_deliverability_dashboard_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_configuration_set_vdm_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_configuration_set_vdm_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_dedicated_ip_in_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    destination_pool_name.unwrap_or_default(),
                )
                .with_field("ip", ip.unwrap_or_default()))
        })
    }
    ...
    async fn read_dedicated_ip_in_pool(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_dedicated_ip_in_pool(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_email_identity_dkim_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_email_identity_dkim_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn read_dedicated_ip_pool_scaling_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_dedicated_ip_pool_scaling_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
    ...
    async fn create_contact_list(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_contact_list(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn update_contact_list(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let topics = input.get_optional_string("topics")?;
            let contact_list_name = input.get_string("contact_list_name")?;
    ...
    async fn delete_contact_list(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    email_forwarding_enabled.unwrap_or_default(),
                ))
        })
    }

    /// Read a email_identity_feedback_attributes resource
    async fn read_email_identity_feedback_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sesv2_client
    ...
    async fn delete_email_identity_feedback_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sesv2_client
