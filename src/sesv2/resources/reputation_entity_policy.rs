...
impl<'a> Reputation_entity_policy<'a> {
    ...
    pub async fn update(&self, id: &str, reputation_entity_reference: Option<String>, reputation_entity_type: Option<String>, reputation_entity_policy: Option<String>) -> Result<()> {
