...
impl<'a> Account_details<'a> {
    ...
    pub async fn create(&self, mail_type: String, use_case_description: Option<String>, website_url: String, contact_language: Option<String>, production_access_enabled: Option<bool>, additional_contact_email_addresses: Option<Vec<String>>) -> Result<String> {
