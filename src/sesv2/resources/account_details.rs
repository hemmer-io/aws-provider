...
impl<'a> Account_details<'a> {
    ...
    pub async fn create(&self, production_access_enabled: Option<bool>, use_case_description: Option<String>, contact_language: Option<String>, additional_contact_email_addresses: Option<Vec<String>>, mail_type: String, website_url: String) -> Result<String> {
