...
impl<'a> Email_identity_policy<'a> {
    ...
    pub async fn create(&self, email_identity: String, policy_name: String, policy: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, email_identity: Option<String>, policy_name: Option<String>, policy: Option<String>) -> Result<()> {
