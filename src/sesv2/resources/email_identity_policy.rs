...
impl<'a> Email_identity_policy<'a> {
    ...
    pub async fn create(&self, policy_name: String, email_identity: String, policy: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, policy_name: Option<String>, email_identity: Option<String>, policy: Option<String>) -> Result<()> {
