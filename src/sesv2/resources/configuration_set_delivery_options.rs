...
impl<'a> Configuration_set_delivery_options<'a> {
    ...
    pub async fn create(&self, configuration_set_name: String, tls_policy: Option<String>, max_delivery_seconds: Option<i64>, sending_pool_name: Option<String>) -> Result<String> {
