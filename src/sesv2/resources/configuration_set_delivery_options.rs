...
impl<'a> Configuration_set_delivery_options<'a> {
    ...
    pub async fn create(&self, tls_policy: Option<String>, sending_pool_name: Option<String>, configuration_set_name: String, max_delivery_seconds: Option<i64>) -> Result<String> {
