...
impl<'a> Configuration_set_delivery_options<'a> {
    ...
    pub async fn create(&self, tls_policy: Option<String>, sending_pool_name: Option<String>, max_delivery_seconds: Option<i64>, configuration_set_name: String) -> Result<String> {
