...
impl<'a> Custom_verification_email_template<'a> {
    ...
    pub async fn create(&self, template_subject: String, from_email_address: String, failure_redirection_url: String, template_name: String, template_content: String, success_redirection_url: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, template_subject: Option<String>, from_email_address: Option<String>, failure_redirection_url: Option<String>, template_name: Option<String>, template_content: Option<String>, success_redirection_url: Option<String>) -> Result<()> {
