...
impl<'a> Custom_verification_email_template<'a> {
    ...
    pub async fn create(&self, template_name: String, failure_redirection_url: String, from_email_address: String, template_content: String, success_redirection_url: String, template_subject: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, template_name: Option<String>, failure_redirection_url: Option<String>, from_email_address: Option<String>, template_content: Option<String>, success_redirection_url: Option<String>, template_subject: Option<String>) -> Result<()> {
