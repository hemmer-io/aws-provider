...
impl<'a> Contact_list<'a> {
    ...
    pub async fn create(&self, topics: Option<Vec<String>>, contact_list_name: String, description: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, topics: Option<Vec<String>>, contact_list_name: Option<String>, description: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
