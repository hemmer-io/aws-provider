...
impl<'a> Contact_list<'a> {
    ...
    pub async fn create(&self, contact_list_name: String, description: Option<String>, tags: Option<Vec<String>>, topics: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, contact_list_name: Option<String>, description: Option<String>, tags: Option<Vec<String>>, topics: Option<Vec<String>>) -> Result<()> {
