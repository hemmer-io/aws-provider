...
impl<'a> Contact_list<'a> {
    ...
    pub async fn create(&self, description: Option<String>, tags: Option<Vec<String>>, contact_list_name: String, topics: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, tags: Option<Vec<String>>, contact_list_name: Option<String>, topics: Option<Vec<String>>) -> Result<()> {
