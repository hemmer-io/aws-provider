...
impl<'a> Packaging_group<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, authorization: Option<String>, id: String, egress_access_logs: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, authorization: Option<String>, id: Option<String>, egress_access_logs: Option<String>) -> Result<()> {
