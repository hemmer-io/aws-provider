...
impl<'a> Packaging_group<'a> {
    ...
    pub async fn create(&self, id: String, tags: Option<HashMap<String, String>>, authorization: Option<String>, egress_access_logs: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, id: Option<String>, tags: Option<HashMap<String, String>>, authorization: Option<String>, egress_access_logs: Option<String>) -> Result<()> {
