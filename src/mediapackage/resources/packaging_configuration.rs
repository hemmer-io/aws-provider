...
impl<'a> Packaging_configuration<'a> {
    ...
    pub async fn create(&self, packaging_group_id: String, dash_package: Option<String>, cmaf_package: Option<String>, hls_package: Option<String>, mss_package: Option<String>, tags: Option<HashMap<String, String>>, id: String) -> Result<String> {
