...
impl<'a> Packaging_configuration<'a> {
    ...
    pub async fn create(&self, cmaf_package: Option<String>, hls_package: Option<String>, tags: Option<HashMap<String, String>>, dash_package: Option<String>, packaging_group_id: String, id: String, mss_package: Option<String>) -> Result<String> {
