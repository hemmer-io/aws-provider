...
impl<'a> Packaging_configuration<'a> {
    ...
    pub async fn create(&self, id: String, hls_package: Option<String>, mss_package: Option<String>, tags: Option<HashMap<String, String>>, packaging_group_id: String, cmaf_package: Option<String>, dash_package: Option<String>) -> Result<String> {
