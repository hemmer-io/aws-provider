...
impl<'a> MediapackageService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "packaging_configuration" => {
                self.plan_packaging_configuration(current_state, desired_input).await
            }
            "packaging_group" => {
                self.plan_packaging_group(current_state, desired_input).await
            }
            "asset" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "packaging_configuration" => {
                self.create_packaging_configuration(input).await
            }
            "packaging_group" => {
                self.create_packaging_group(input).await
            }
            "asset" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "packaging_configuration" => {
                self.read_packaging_configuration(id).await
            }
            "packaging_group" => {
                self.read_packaging_group(id).await
            }
            "asset" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "packaging_configuration" => {
                self.update_packaging_configuration(id, input).await
            }
            "packaging_group" => {
                self.update_packaging_group(id, input).await
            }
            "asset" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "packaging_configuration" => {
                self.delete_packaging_configuration(id).await
            }
            "packaging_group" => {
                self.delete_packaging_group(id).await
            }
            "asset" => {
    ...
    async fn read_packaging_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
