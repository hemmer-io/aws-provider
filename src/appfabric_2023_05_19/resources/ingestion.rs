...
impl<'a> Ingestion<'a> {
    ...
    pub async fn create(&self, app_bundle_identifier: String, app: String, ingestion_type: String, tags: Option<Vec<String>>, client_token: Option<String>, tenant_id: String) -> Result<String> {
