...
impl<'a> Distribution_configuration<'a> {
    ...
    pub async fn create(&self, distributions: Vec<String>, tags: Option<HashMap<String, String>>, client_token: String, name: String, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, distributions: Option<Vec<String>>, tags: Option<HashMap<String, String>>, client_token: Option<String>, name: Option<String>, description: Option<String>) -> Result<()> {
