...
impl<'a> Distribution_configuration<'a> {
    ...
    pub async fn create(&self, name: String, client_token: String, description: Option<String>, tags: Option<HashMap<String, String>>, distributions: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, client_token: Option<String>, description: Option<String>, tags: Option<HashMap<String, String>>, distributions: Option<Vec<String>>) -> Result<()> {
