...
impl<'a> Distribution_configuration<'a> {
    ...
    pub async fn create(&self, name: String, tags: Option<HashMap<String, String>>, description: Option<String>, distributions: Vec<String>, client_token: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, tags: Option<HashMap<String, String>>, description: Option<String>, distributions: Option<Vec<String>>, client_token: Option<String>) -> Result<()> {
