...
impl<'a> License_managerService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "license_conversion_task_for_resource" => {
                self.plan_license_conversion_task_for_resource(current_state, desired_input)
                    .await
            }
            "license_usage" => self.plan_license_usage(current_state, desired_input).await,
            ...
            "license" => self.plan_license(current_state, desired_input).await,
            "grant_version" => self.plan_grant_version(current_state, desired_input).await,
            "license_specifications_for_resource" => {
                self.plan_license_specifications_for_resource(current_state, desired_input)
                    .await
            }
            "license_version" => {
                self.plan_license_version(current_state, desired_input)
                    .await
            }
            "service_settings" => {
            ...
            "license_conversion_task" => {
                self.plan_license_conversion_task(current_state, desired_input)
                    .await
            }
            "license_manager_report_generator" => {
                self.plan_license_manager_report_generator(current_state, desired_input)
                    .await
            }
            "license_configuration" => {
                self.plan_license_configuration(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "license_manager", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "license_conversion_task_for_resource" => {
                self.create_license_conversion_task_for_resource(input)
                    .await
            }
            "license_usage" => self.create_license_usage(input).await,
            "token" => self.create_token(input).await,
            "access_token" => self.create_access_token(input).await,
            "license" => self.create_license(input).await,
            "grant_version" => self.create_grant_version(input).await,
            "license_specifications_for_resource" => {
                self.create_license_specifications_for_resource(input).await
            }
            "license_version" => self.create_license_version(input).await,
            "service_settings" => self.create_service_settings(input).await,
            "license_conversion_task" => self.create_license_conversion_task(input).await,
            "license_manager_report_generator" => {
                self.create_license_manager_report_generator(input).await
            }
            "license_configuration" => self.create_license_configuration(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "license_manager", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "license_usage" => self.read_license_usage(id).await,
            "token" => self.read_token(id).await,
            "access_token" => self.read_access_token(id).await,
            "license" => self.read_license(id).await,
            "grant_version" => self.read_grant_version(id).await,
            "license_specifications_for_resource" => {
                self.read_license_specifications_for_resource(id).await
            }
            "license_version" => self.read_license_version(id).await,
            "service_settings" => self.read_service_settings(id).await,
            "license_conversion_task" => self.read_license_conversion_task(id).await,
            "license_manager_report_generator" => {
                self.read_license_manager_report_generator(id).await
            }
            "license_configuration" => self.read_license_configuration(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "license_manager", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "license_conversion_task_for_resource" => {
                self.update_license_conversion_task_for_resource(id, input)
                    .await
            }
            "license_usage" => self.update_license_usage(id, input).await,
            "token" => self.update_token(id, input).await,
            "access_token" => self.update_access_token(id, input).await,
            "license" => self.update_license(id, input).await,
            "grant_version" => self.update_grant_version(id, input).await,
            "license_specifications_for_resource" => {
                self.update_license_specifications_for_resource(id, input)
                    .await
            }
            "license_version" => self.update_license_version(id, input).await,
            "service_settings" => self.update_service_settings(id, input).await,
            "license_conversion_task" => self.update_license_conversion_task(id, input).await,
            "license_manager_report_generator" => {
                self.update_license_manager_report_generator(id, input)
                    .await
            }
            "license_configuration" => self.update_license_configuration(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "license_manager", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "license_usage" => self.delete_license_usage(id).await,
            "token" => self.delete_token(id).await,
            "access_token" => self.delete_access_token(id).await,
            "license" => self.delete_license(id).await,
            "grant_version" => self.delete_grant_version(id).await,
            "license_specifications_for_resource" => {
                self.delete_license_specifications_for_resource(id).await
            }
            "license_version" => self.delete_license_version(id).await,
            "service_settings" => self.delete_service_settings(id).await,
            "license_conversion_task" => self.delete_license_conversion_task(id).await,
            "license_manager_report_generator" => {
                self.delete_license_manager_report_generator(id).await
            }
            "license_configuration" => self.delete_license_configuration(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "license_manager", resource_name
            ))),
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    source_license_context.unwrap_or_default(),
                )
                .with_field(
                    "destination_license_context",
                    destination_license_context.unwrap_or_default(),
                ))
        })
    }

    /// Read a license_conversion_task_for_resource resource
    async fn read_license_conversion_task_for_resource(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.license_manager_client
    ...
    async fn delete_license_conversion_task_for_resource(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.license_manager_client
    ...
    async fn create_license_usage(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_license_usage(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.license_manager_client
    ...
    async fn update_license_usage(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_license_usage(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.license_manager_client
    ...
    async fn create_license(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    consumption_configuration.unwrap_or_default(),
                )
    ...
    async fn read_license(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.license_manager_client
    ...
    async fn update_license(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let product_name = input.get_string("product_name")?;
    ...
    async fn delete_license(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.license_manager_client
    ...
    async fn create_grant_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_grant_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.license_manager_client
    ...
    async fn update_grant_version(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let grant_arn = input.get_string("grant_arn")?;
            let allowed_operations = input.get_optional_string("allowed_operations")?;
    ...
    async fn delete_grant_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.license_manager_client
    ...
    async fn create_license_specifications_for_resource(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let resource_arn = input.get_string("resource_arn")?;
            let remove_license_specifications =
                input.get_optional_string("remove_license_specifications")?;
            let add_license_specifications =
                input.get_optional_string("add_license_specifications")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    remove_license_specifications.unwrap_or_default(),
                )
                .with_field(
                    "add_license_specifications",
                    add_license_specifications.unwrap_or_default(),
                ))
        })
    }

    /// Read a license_specifications_for_resource resource
    async fn read_license_specifications_for_resource(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.license_manager_client
    ...
    async fn delete_license_specifications_for_resource(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.license_manager_client
    ...
    async fn create_license_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let client_token = input.get_string("client_token")?;
    ...
    async fn read_license_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.license_manager_client
    ...
    async fn delete_license_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.license_manager_client
    ...
    async fn create_service_settings(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let enable_cross_accounts_discovery =
                input.get_optional_string("enable_cross_accounts_discovery")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    enable_cross_accounts_discovery.unwrap_or_default(),
                )
    ...
    async fn create_license_conversion_task(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_license_conversion_task(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.license_manager_client
    ...
    async fn delete_license_conversion_task(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.license_manager_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    report_generator_name.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default()))
        })
    }
    ...
    async fn read_license_manager_report_generator(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.license_manager_client
    ...
    async fn delete_license_manager_report_generator(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.license_manager_client
    ...
    async fn create_license_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let disassociate_when_not_found =
                input.get_optional_string("disassociate_when_not_found")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    disassociate_when_not_found.unwrap_or_default(),
                )
                .with_field(
                    "product_information_list",
                    product_information_list.unwrap_or_default(),
                )
                .with_field("license_rules", license_rules.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field(
                    "license_count_hard_limit",
                    license_count_hard_limit.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                .with_field(
                    "license_counting_type",
                    license_counting_type.unwrap_or_default(),
                )
    ...
    async fn read_license_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.license_manager_client
    ...
    async fn delete_license_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.license_manager_client
