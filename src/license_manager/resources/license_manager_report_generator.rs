...
impl<'a> License_manager_report_generator<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, report_frequency: String, description: Option<String>, type: Vec<String>, client_token: String, report_generator_name: String, report_context: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, report_frequency: Option<String>, description: Option<String>, type: Option<Vec<String>>, client_token: Option<String>, report_generator_name: Option<String>, report_context: Option<String>) -> Result<()> {
