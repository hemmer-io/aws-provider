...
impl<'a> License_manager_report_generator<'a> {
    ...
    pub async fn create(&self, report_context: String, report_frequency: String, description: Option<String>, type: Vec<String>, client_token: String, tags: Option<Vec<String>>, report_generator_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, report_context: Option<String>, report_frequency: Option<String>, description: Option<String>, type: Option<Vec<String>>, client_token: Option<String>, tags: Option<Vec<String>>, report_generator_name: Option<String>) -> Result<()> {
