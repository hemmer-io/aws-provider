...
impl<'a> License_manager_report_generator<'a> {
    ...
    pub async fn create(&self, type: Vec<String>, report_context: String, description: Option<String>, tags: Option<Vec<String>>, report_frequency: String, report_generator_name: String, client_token: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, type: Option<Vec<String>>, report_context: Option<String>, description: Option<String>, tags: Option<Vec<String>>, report_frequency: Option<String>, report_generator_name: Option<String>, client_token: Option<String>) -> Result<()> {
