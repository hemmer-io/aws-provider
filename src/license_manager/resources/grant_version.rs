...
impl<'a> Grant_version<'a> {
    ...
    pub async fn create(&self, grant_arn: String, allowed_operations: Option<Vec<String>>, options: Option<String>, client_token: String, grant_name: Option<String>, status_reason: Option<String>, source_version: Option<String>, status: Option<String>) -> Result<String> {
