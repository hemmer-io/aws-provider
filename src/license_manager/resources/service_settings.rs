...
impl<'a> Service_settings<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, organization_configuration: Option<String>, enable_cross_accounts_discovery: Option<bool>, s3_bucket_arn: Option<String>, sns_topic_arn: Option<String>) -> Result<()> {
