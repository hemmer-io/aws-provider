...
impl<'a> License_version<'a> {
    ...
    pub async fn create(&self, client_token: String, license_metadata: Option<Vec<String>>, validity: String, entitlements: Vec<String>, issuer: String, product_name: String, license_name: String, source_version: Option<String>, license_arn: String, home_region: String, status: String, consumption_configuration: String) -> Result<String> {
