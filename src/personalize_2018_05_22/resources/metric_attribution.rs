...
impl<'a> Metric_attribution<'a> {
    ...
    pub async fn create(&self, name: String, metrics: Vec<String>, metrics_output_config: String, dataset_group_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, metrics: Option<Vec<String>>, metrics_output_config: Option<String>, dataset_group_arn: Option<String>) -> Result<()> {
