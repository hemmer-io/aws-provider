...
impl<'a> Dataset_export_job<'a> {
    ...
    pub async fn create(&self, job_output: String, dataset_arn: String, job_name: String, role_arn: String, ingestion_mode: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
