...
impl<'a> Rule_group<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, change_token: String, metric_name: String, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, change_token: Option<String>, metric_name: Option<String>, name: Option<String>) -> Result<()> {
