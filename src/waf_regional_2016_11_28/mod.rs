//! Waf_regional_2016_11_28 Service
//!
//! Auto-generated service module for waf_regional_2016_11_28

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for waf_regional_2016_11_28
pub struct Waf_regional_2016_11_28Service<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Waf_regional_2016_11_28Service<'a> {
    ...
    /// Get web_acl_migration_stack resource handler
    pub fn web_acl_migration_stack(&self) -> resources::Web_acl_migration_stack<'_> {
        resources::Web_acl_migration_stack::new(self.provider)
    }
