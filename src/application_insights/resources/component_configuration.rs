...
impl<'a> Component_configuration<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, auto_config_enabled: Option<bool>, resource_group_name: Option<String>, component_name: Option<String>, monitor: Option<bool>, tier: Option<String>, component_configuration: Option<String>) -> Result<()> {
