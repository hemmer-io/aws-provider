...
impl<'a> Fleet_port_settings<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, fleet_id: Option<String>, inbound_permission_revocations: Option<Vec<String>>, inbound_permission_authorizations: Option<Vec<String>>) -> Result<()> {
