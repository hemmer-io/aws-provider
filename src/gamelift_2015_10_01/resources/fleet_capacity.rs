...
impl<'a> Fleet_capacity<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, desired_instances: Option<i64>, max_size: Option<i64>, min_size: Option<i64>, location: Option<String>, fleet_id: Option<String>) -> Result<()> {
