...
impl<'a> Game_server<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, utilization_status: Option<String>, health_check: Option<String>, game_server_group_name: Option<String>, game_server_id: Option<String>, game_server_data: Option<String>) -> Result<()> {
