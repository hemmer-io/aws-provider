...
impl<'a> Scaling_policy<'a> {
    ...
    pub async fn create(&self, name: String, comparison_operator: Option<String>, fleet_id: String, scaling_adjustment_type: Option<String>, scaling_adjustment: Option<i64>, evaluation_periods: Option<i64>, metric_name: String, threshold: Option<f64>, target_configuration: Option<String>, policy_type: Option<String>) -> Result<String> {
