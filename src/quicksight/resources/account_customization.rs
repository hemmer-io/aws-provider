...
impl<'a> Account_customization<'a> {
    ...
    pub async fn create(&self, aws_account_id: String, account_customization: String, tags: Option<Vec<String>>, namespace: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, aws_account_id: Option<String>, account_customization: Option<String>, tags: Option<Vec<String>>, namespace: Option<String>) -> Result<()> {
