...
impl<'a> Account_customization<'a> {
    ...
    pub async fn create(&self, namespace: Option<String>, aws_account_id: String, account_customization: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, namespace: Option<String>, aws_account_id: Option<String>, account_customization: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
