...
impl<'a> Account_customization<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, namespace: Option<String>, account_customization: String, aws_account_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, namespace: Option<String>, account_customization: Option<String>, aws_account_id: Option<String>) -> Result<()> {
