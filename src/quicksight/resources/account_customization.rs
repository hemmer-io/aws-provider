...
impl<'a> Account_customization<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, aws_account_id: String, namespace: Option<String>, account_customization: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, aws_account_id: Option<String>, namespace: Option<String>, account_customization: Option<String>) -> Result<()> {
