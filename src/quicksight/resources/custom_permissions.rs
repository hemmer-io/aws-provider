...
impl<'a> Custom_permissions<'a> {
    ...
    pub async fn create(&self, capabilities: Option<String>, tags: Option<Vec<String>>, custom_permissions_name: String, aws_account_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, capabilities: Option<String>, tags: Option<Vec<String>>, custom_permissions_name: Option<String>, aws_account_id: Option<String>) -> Result<()> {
