...
impl<'a> Custom_permissions<'a> {
    ...
    pub async fn create(&self, aws_account_id: String, tags: Option<Vec<String>>, capabilities: Option<String>, custom_permissions_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, aws_account_id: Option<String>, tags: Option<Vec<String>>, capabilities: Option<String>, custom_permissions_name: Option<String>) -> Result<()> {
