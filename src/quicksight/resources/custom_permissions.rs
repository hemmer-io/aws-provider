...
impl<'a> Custom_permissions<'a> {
    ...
    pub async fn create(&self, custom_permissions_name: String, capabilities: Option<String>, aws_account_id: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, custom_permissions_name: Option<String>, capabilities: Option<String>, aws_account_id: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
