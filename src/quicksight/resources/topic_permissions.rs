...
impl<'a> Topic_permissions<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, grant_permissions: Option<Vec<String>>, topic_id: Option<String>, aws_account_id: Option<String>, revoke_permissions: Option<Vec<String>>) -> Result<()> {
