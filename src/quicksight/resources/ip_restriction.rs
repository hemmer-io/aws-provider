...
impl<'a> Ip_restriction<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, aws_account_id: Option<String>, ip_restriction_rule_map: Option<HashMap<String, String>>, enabled: Option<bool>, vpc_endpoint_id_restriction_rule_map: Option<HashMap<String, String>>, vpc_id_restriction_rule_map: Option<HashMap<String, String>>) -> Result<()> {
