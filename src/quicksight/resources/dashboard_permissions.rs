...
impl<'a> Dashboard_permissions<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, grant_link_permissions: Option<Vec<String>>, aws_account_id: Option<String>, dashboard_id: Option<String>, grant_permissions: Option<Vec<String>>, revoke_permissions: Option<Vec<String>>, revoke_link_permissions: Option<Vec<String>>) -> Result<()> {
