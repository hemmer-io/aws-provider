...
impl<'a> Iam_policy_assignment<'a> {
    ...
    pub async fn create(&self, identities: Option<HashMap<String, Vec<String>>>, namespace: String, aws_account_id: String, policy_arn: Option<String>, assignment_name: String, assignment_status: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, identities: Option<HashMap<String, Vec<String>>>, namespace: Option<String>, aws_account_id: Option<String>, policy_arn: Option<String>, assignment_name: Option<String>, assignment_status: Option<String>) -> Result<()> {
