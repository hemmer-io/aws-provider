...
impl<'a> Data_source_permissions<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, grant_permissions: Option<Vec<String>>, revoke_permissions: Option<Vec<String>>, aws_account_id: Option<String>, data_source_id: Option<String>) -> Result<()> {
