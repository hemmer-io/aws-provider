...
impl<'a> Data_source_permissions<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, revoke_permissions: Option<Vec<String>>, aws_account_id: Option<String>, data_source_id: Option<String>, grant_permissions: Option<Vec<String>>) -> Result<()> {
