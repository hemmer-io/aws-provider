...
impl<'a> Refresh_schedule<'a> {
    ...
    pub async fn create(&self, schedule: String, data_set_id: String, aws_account_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, schedule: Option<String>, data_set_id: Option<String>, aws_account_id: Option<String>) -> Result<()> {
