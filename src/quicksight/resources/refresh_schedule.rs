...
impl<'a> Refresh_schedule<'a> {
    ...
    pub async fn create(&self, aws_account_id: String, data_set_id: String, schedule: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, aws_account_id: Option<String>, data_set_id: Option<String>, schedule: Option<String>) -> Result<()> {
