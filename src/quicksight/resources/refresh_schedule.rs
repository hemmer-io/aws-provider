...
impl<'a> Refresh_schedule<'a> {
    ...
    pub async fn create(&self, data_set_id: String, schedule: String, aws_account_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, data_set_id: Option<String>, schedule: Option<String>, aws_account_id: Option<String>) -> Result<()> {
