...
impl<'a> Account_settings<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, notification_email: Option<String>, aws_account_id: Option<String>, termination_protection_enabled: Option<bool>, default_namespace: Option<String>) -> Result<()> {
