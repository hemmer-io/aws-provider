...
impl<'a> Folder_permissions<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, revoke_permissions: Option<Vec<String>>, folder_id: Option<String>, grant_permissions: Option<Vec<String>>, aws_account_id: Option<String>) -> Result<()> {
