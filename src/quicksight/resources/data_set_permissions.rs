...
impl<'a> Data_set_permissions<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, data_set_id: Option<String>, grant_permissions: Option<Vec<String>>, revoke_permissions: Option<Vec<String>>, aws_account_id: Option<String>) -> Result<()> {
