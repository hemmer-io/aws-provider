...
impl<'a> Template_alias<'a> {
    ...
    pub async fn create(&self, template_id: String, template_version_number: i64, aws_account_id: String, alias_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, template_id: Option<String>, template_version_number: Option<i64>, aws_account_id: Option<String>, alias_name: Option<String>) -> Result<()> {
