...
impl<'a> Topic_refresh_schedule<'a> {
    ...
    pub async fn create(&self, aws_account_id: String, refresh_schedule: String, topic_id: String, dataset_arn: String, dataset_name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, aws_account_id: Option<String>, refresh_schedule: Option<String>, topic_id: Option<String>, dataset_arn: Option<String>, dataset_name: Option<String>) -> Result<()> {
