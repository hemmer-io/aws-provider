...
impl<'a> Topic_refresh_schedule<'a> {
    ...
    pub async fn create(&self, dataset_arn: String, topic_id: String, aws_account_id: String, refresh_schedule: String, dataset_name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, dataset_arn: Option<String>, topic_id: Option<String>, aws_account_id: Option<String>, refresh_schedule: Option<String>, dataset_name: Option<String>) -> Result<()> {
