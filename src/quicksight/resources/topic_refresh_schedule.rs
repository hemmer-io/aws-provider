...
impl<'a> Topic_refresh_schedule<'a> {
    ...
    pub async fn create(&self, dataset_name: Option<String>, refresh_schedule: String, dataset_arn: String, aws_account_id: String, topic_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, dataset_name: Option<String>, refresh_schedule: Option<String>, dataset_arn: Option<String>, aws_account_id: Option<String>, topic_id: Option<String>) -> Result<()> {
