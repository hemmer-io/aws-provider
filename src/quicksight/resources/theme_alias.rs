...
impl<'a> Theme_alias<'a> {
    ...
    pub async fn create(&self, aws_account_id: String, alias_name: String, theme_version_number: i64, theme_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, aws_account_id: Option<String>, alias_name: Option<String>, theme_version_number: Option<i64>, theme_id: Option<String>) -> Result<()> {
