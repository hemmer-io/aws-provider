...
impl<'a> QuicksightService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "action_connector" => {
                self.plan_action_connector(current_state, desired_input)
                    .await
            }
            "role_custom_permission" => {
                self.plan_role_custom_permission(current_state, desired_input)
                    .await
            }
            "dashboard_snapshot_job" => {
                self.plan_dashboard_snapshot_job(current_state, desired_input)
                    .await
            }
            "application_with_token_exchange_grant" => {
                self.plan_application_with_token_exchange_grant(current_state, desired_input)
                    .await
            }
            "folder_membership" => {
                self.plan_folder_membership(current_state, desired_input)
                    .await
            }
            "topic_refresh" => self.plan_topic_refresh(current_state, desired_input).await,
            "account_customization" => {
                self.plan_account_customization(current_state, desired_input)
                    .await
            }
            "vpc_connection" => self.plan_vpc_connection(current_state, desired_input).await,
            "data_source_permissions" => {
                self.plan_data_source_permissions(current_state, desired_input)
                    .await
            }
            "analysis_permissions" => {
                self.plan_analysis_permissions(current_state, desired_input)
                    .await
            }
            "brand_assignment" => {
                self.plan_brand_assignment(current_state, desired_input)
                    .await
            }
            "dashboard" => self.plan_dashboard(current_state, desired_input).await,
            "dashboard_definition" => {
                self.plan_dashboard_definition(current_state, desired_input)
                    .await
            }
            ...
            "action_connector_permissions" => {
                self.plan_action_connector_permissions(current_state, desired_input)
                    .await
            }
            "ip_restriction" => self.plan_ip_restriction(current_state, desired_input).await,
            "asset_bundle_import_job" => {
                self.plan_asset_bundle_import_job(current_state, desired_input)
                    .await
            }
            "template_permissions" => {
                self.plan_template_permissions(current_state, desired_input)
                    .await
            }
            "account_custom_permission" => {
                self.plan_account_custom_permission(current_state, desired_input)
                    .await
            }
            "spice_capacity_configuration" => {
                self.plan_spice_capacity_configuration(current_state, desired_input)
                    .await
            }
            "user_by_principal_id" => {
                self.plan_user_by_principal_id(current_state, desired_input)
                    .await
            }
            "analysis" => self.plan_analysis(current_state, desired_input).await,
            "dashboard_embed_url" => {
                self.plan_dashboard_embed_url(current_state, desired_input)
                    .await
            }
            "topic_refresh_schedule" => {
                self.plan_topic_refresh_schedule(current_state, desired_input)
                    .await
            }
            "folder_resolved_permissions" => {
                self.plan_folder_resolved_permissions(current_state, desired_input)
                    .await
            }
            "session_embed_url" => {
                self.plan_session_embed_url(current_state, desired_input)
                    .await
            }
            "brand" => self.plan_brand(current_state, desired_input).await,
            "group_membership" => {
                self.plan_group_membership(current_state, desired_input)
                    .await
            }
            "namespace" => self.plan_namespace(current_state, desired_input).await,
            "q_personalization_configuration" => {
                self.plan_q_personalization_configuration(current_state, desired_input)
                    .await
            }
            "dashboards_qa_configuration" => {
                self.plan_dashboards_qa_configuration(current_state, desired_input)
                    .await
            }
            "template_alias" => self.plan_template_alias(current_state, desired_input).await,
            "data_set_permissions" => {
                self.plan_data_set_permissions(current_state, desired_input)
                    .await
            }
            "template" => self.plan_template(current_state, desired_input).await,
            "dashboard_snapshot_job_result" => {
                self.plan_dashboard_snapshot_job_result(current_state, desired_input)
                    .await
            }
            "theme_permissions" => {
                self.plan_theme_permissions(current_state, desired_input)
                    .await
            }
            "template_definition" => {
                self.plan_template_definition(current_state, desired_input)
                    .await
            }
            "flow_metadata" => self.plan_flow_metadata(current_state, desired_input).await,
            "account_settings" => {
            ...
            "refresh_schedule" => {
                self.plan_refresh_schedule(current_state, desired_input)
                    .await
            }
            "default_q_business_application" => {
                self.plan_default_q_business_application(current_state, desired_input)
                    .await
            }
            "data_set_refresh_properties" => {
                self.plan_data_set_refresh_properties(current_state, desired_input)
                    .await
            }
            "brand_published_version" => {
                self.plan_brand_published_version(current_state, desired_input)
                    .await
            }
            "public_sharing_settings" => {
                self.plan_public_sharing_settings(current_state, desired_input)
                    .await
            }
            "custom_permissions" => {
                self.plan_custom_permissions(current_state, desired_input)
                    .await
            }
            "dashboard_permissions" => {
                self.plan_dashboard_permissions(current_state, desired_input)
                    .await
            }
            "identity_propagation_config" => {
                self.plan_identity_propagation_config(current_state, desired_input)
                    .await
            }
            "flow_permissions" => {
                self.plan_flow_permissions(current_state, desired_input)
                    .await
            }
            "iam_policy_assignment" => {
                self.plan_iam_policy_assignment(current_state, desired_input)
                    .await
            }
            "user" => self.plan_user(current_state, desired_input).await,
            "dashboard_links" => {
                self.plan_dashboard_links(current_state, desired_input)
                    .await
            }
            "dashboard_published_version" => {
                self.plan_dashboard_published_version(current_state, desired_input)
                    .await
            }
            "quick_sight_q_search_configuration" => {
                self.plan_quick_sight_q_search_configuration(current_state, desired_input)
                    .await
            }
            "folder" => self.plan_folder(current_state, desired_input).await,
            "asset_bundle_export_job" => {
                self.plan_asset_bundle_export_job(current_state, desired_input)
                    .await
            }
            "role_membership" => {
                self.plan_role_membership(current_state, desired_input)
                    .await
            }
            "account_subscription" => {
                self.plan_account_subscription(current_state, desired_input)
                    .await
            }
            "data_source" => self.plan_data_source(current_state, desired_input).await,
            "analysis_definition" => {
                self.plan_analysis_definition(current_state, desired_input)
                    .await
            }
            "folder_permissions" => {
                self.plan_folder_permissions(current_state, desired_input)
                    .await
            }
            "key_registration" => {
                self.plan_key_registration(current_state, desired_input)
                    .await
            }
            "topic_permissions" => {
                self.plan_topic_permissions(current_state, desired_input)
                    .await
            }
            "theme_alias" => self.plan_theme_alias(current_state, desired_input).await,
            "user_custom_permission" => {
                self.plan_user_custom_permission(current_state, desired_input)
                    .await
            }
            "theme" => self.plan_theme(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "quicksight", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "action_connector" => self.create_action_connector(input).await,
            "role_custom_permission" => self.create_role_custom_permission(input).await,
            "dashboard_snapshot_job" => self.create_dashboard_snapshot_job(input).await,
            "application_with_token_exchange_grant" => {
                self.create_application_with_token_exchange_grant(input)
                    .await
            }
            "folder_membership" => self.create_folder_membership(input).await,
            "topic_refresh" => self.create_topic_refresh(input).await,
            "account_customization" => self.create_account_customization(input).await,
            "vpc_connection" => self.create_vpc_connection(input).await,
            "data_source_permissions" => self.create_data_source_permissions(input).await,
            "analysis_permissions" => self.create_analysis_permissions(input).await,
            "brand_assignment" => self.create_brand_assignment(input).await,
            "dashboard" => self.create_dashboard(input).await,
            "dashboard_definition" => self.create_dashboard_definition(input).await,
            "group" => self.create_group(input).await,
            "topic" => self.create_topic(input).await,
            "action_connector_permissions" => self.create_action_connector_permissions(input).await,
            "ip_restriction" => self.create_ip_restriction(input).await,
            "asset_bundle_import_job" => self.create_asset_bundle_import_job(input).await,
            "template_permissions" => self.create_template_permissions(input).await,
            "account_custom_permission" => self.create_account_custom_permission(input).await,
            "spice_capacity_configuration" => self.create_spice_capacity_configuration(input).await,
            "user_by_principal_id" => self.create_user_by_principal_id(input).await,
            "analysis" => self.create_analysis(input).await,
            "dashboard_embed_url" => self.create_dashboard_embed_url(input).await,
            "topic_refresh_schedule" => self.create_topic_refresh_schedule(input).await,
            "folder_resolved_permissions" => self.create_folder_resolved_permissions(input).await,
            "session_embed_url" => self.create_session_embed_url(input).await,
            "brand" => self.create_brand(input).await,
            "group_membership" => self.create_group_membership(input).await,
            "namespace" => self.create_namespace(input).await,
            "q_personalization_configuration" => {
                self.create_q_personalization_configuration(input).await
            }
            "dashboards_qa_configuration" => self.create_dashboards_qa_configuration(input).await,
            "template_alias" => self.create_template_alias(input).await,
            "data_set_permissions" => self.create_data_set_permissions(input).await,
            "template" => self.create_template(input).await,
            "dashboard_snapshot_job_result" => {
                self.create_dashboard_snapshot_job_result(input).await
            }
            "theme_permissions" => self.create_theme_permissions(input).await,
            "template_definition" => self.create_template_definition(input).await,
            "flow_metadata" => self.create_flow_metadata(input).await,
            ...
            "refresh_schedule" => self.create_refresh_schedule(input).await,
            "default_q_business_application" => {
                self.create_default_q_business_application(input).await
            }
            "data_set_refresh_properties" => self.create_data_set_refresh_properties(input).await,
            "brand_published_version" => self.create_brand_published_version(input).await,
            "public_sharing_settings" => self.create_public_sharing_settings(input).await,
            "custom_permissions" => self.create_custom_permissions(input).await,
            "dashboard_permissions" => self.create_dashboard_permissions(input).await,
            "identity_propagation_config" => self.create_identity_propagation_config(input).await,
            "flow_permissions" => self.create_flow_permissions(input).await,
            "iam_policy_assignment" => self.create_iam_policy_assignment(input).await,
            "user" => self.create_user(input).await,
            "dashboard_links" => self.create_dashboard_links(input).await,
            "dashboard_published_version" => self.create_dashboard_published_version(input).await,
            "quick_sight_q_search_configuration" => {
                self.create_quick_sight_q_search_configuration(input).await
            }
            "folder" => self.create_folder(input).await,
            "asset_bundle_export_job" => self.create_asset_bundle_export_job(input).await,
            "role_membership" => self.create_role_membership(input).await,
            "account_subscription" => self.create_account_subscription(input).await,
            "data_source" => self.create_data_source(input).await,
            "analysis_definition" => self.create_analysis_definition(input).await,
            "folder_permissions" => self.create_folder_permissions(input).await,
            "key_registration" => self.create_key_registration(input).await,
            "topic_permissions" => self.create_topic_permissions(input).await,
            "theme_alias" => self.create_theme_alias(input).await,
            "user_custom_permission" => self.create_user_custom_permission(input).await,
            "theme" => self.create_theme(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "quicksight", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "action_connector" => self.read_action_connector(id).await,
            "role_custom_permission" => self.read_role_custom_permission(id).await,
            "dashboard_snapshot_job" => self.read_dashboard_snapshot_job(id).await,
            "application_with_token_exchange_grant" => {
                self.read_application_with_token_exchange_grant(id).await
            }
            "folder_membership" => self.read_folder_membership(id).await,
            "topic_refresh" => self.read_topic_refresh(id).await,
            "account_customization" => self.read_account_customization(id).await,
            "vpc_connection" => self.read_vpc_connection(id).await,
            "data_source_permissions" => self.read_data_source_permissions(id).await,
            "analysis_permissions" => self.read_analysis_permissions(id).await,
            "brand_assignment" => self.read_brand_assignment(id).await,
            "dashboard" => self.read_dashboard(id).await,
            "dashboard_definition" => self.read_dashboard_definition(id).await,
            "group" => self.read_group(id).await,
            "topic" => self.read_topic(id).await,
            "action_connector_permissions" => self.read_action_connector_permissions(id).await,
            "ip_restriction" => self.read_ip_restriction(id).await,
            "asset_bundle_import_job" => self.read_asset_bundle_import_job(id).await,
            "template_permissions" => self.read_template_permissions(id).await,
            "account_custom_permission" => self.read_account_custom_permission(id).await,
            "spice_capacity_configuration" => self.read_spice_capacity_configuration(id).await,
            "user_by_principal_id" => self.read_user_by_principal_id(id).await,
            "analysis" => self.read_analysis(id).await,
            "dashboard_embed_url" => self.read_dashboard_embed_url(id).await,
            "topic_refresh_schedule" => self.read_topic_refresh_schedule(id).await,
            "folder_resolved_permissions" => self.read_folder_resolved_permissions(id).await,
            "session_embed_url" => self.read_session_embed_url(id).await,
            "brand" => self.read_brand(id).await,
            "group_membership" => self.read_group_membership(id).await,
            "namespace" => self.read_namespace(id).await,
            "q_personalization_configuration" => {
                self.read_q_personalization_configuration(id).await
            }
            "dashboards_qa_configuration" => self.read_dashboards_qa_configuration(id).await,
            "template_alias" => self.read_template_alias(id).await,
            "data_set_permissions" => self.read_data_set_permissions(id).await,
            "template" => self.read_template(id).await,
            "dashboard_snapshot_job_result" => self.read_dashboard_snapshot_job_result(id).await,
            "theme_permissions" => self.read_theme_permissions(id).await,
            "template_definition" => self.read_template_definition(id).await,
            "flow_metadata" => self.read_flow_metadata(id).await,
            ...
            "refresh_schedule" => self.read_refresh_schedule(id).await,
            "default_q_business_application" => self.read_default_q_business_application(id).await,
            "data_set_refresh_properties" => self.read_data_set_refresh_properties(id).await,
            "brand_published_version" => self.read_brand_published_version(id).await,
            "public_sharing_settings" => self.read_public_sharing_settings(id).await,
            "custom_permissions" => self.read_custom_permissions(id).await,
            "dashboard_permissions" => self.read_dashboard_permissions(id).await,
            "identity_propagation_config" => self.read_identity_propagation_config(id).await,
            "flow_permissions" => self.read_flow_permissions(id).await,
            "iam_policy_assignment" => self.read_iam_policy_assignment(id).await,
            "user" => self.read_user(id).await,
            "dashboard_links" => self.read_dashboard_links(id).await,
            "dashboard_published_version" => self.read_dashboard_published_version(id).await,
            "quick_sight_q_search_configuration" => {
                self.read_quick_sight_q_search_configuration(id).await
            }
            "folder" => self.read_folder(id).await,
            "asset_bundle_export_job" => self.read_asset_bundle_export_job(id).await,
            "role_membership" => self.read_role_membership(id).await,
            "account_subscription" => self.read_account_subscription(id).await,
            "data_source" => self.read_data_source(id).await,
            "analysis_definition" => self.read_analysis_definition(id).await,
            "folder_permissions" => self.read_folder_permissions(id).await,
            "key_registration" => self.read_key_registration(id).await,
            "topic_permissions" => self.read_topic_permissions(id).await,
            "theme_alias" => self.read_theme_alias(id).await,
            "user_custom_permission" => self.read_user_custom_permission(id).await,
            "theme" => self.read_theme(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "quicksight", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "action_connector" => self.update_action_connector(id, input).await,
            "role_custom_permission" => self.update_role_custom_permission(id, input).await,
            "dashboard_snapshot_job" => self.update_dashboard_snapshot_job(id, input).await,
            "application_with_token_exchange_grant" => {
                self.update_application_with_token_exchange_grant(id, input)
                    .await
            }
            "folder_membership" => self.update_folder_membership(id, input).await,
            "topic_refresh" => self.update_topic_refresh(id, input).await,
            "account_customization" => self.update_account_customization(id, input).await,
            "vpc_connection" => self.update_vpc_connection(id, input).await,
            "data_source_permissions" => self.update_data_source_permissions(id, input).await,
            "analysis_permissions" => self.update_analysis_permissions(id, input).await,
            "brand_assignment" => self.update_brand_assignment(id, input).await,
            "dashboard" => self.update_dashboard(id, input).await,
            "dashboard_definition" => self.update_dashboard_definition(id, input).await,
            ...
            "ip_restriction" => self.update_ip_restriction(id, input).await,
            "asset_bundle_import_job" => self.update_asset_bundle_import_job(id, input).await,
            "template_permissions" => self.update_template_permissions(id, input).await,
            "account_custom_permission" => self.update_account_custom_permission(id, input).await,
            "spice_capacity_configuration" => {
                self.update_spice_capacity_configuration(id, input).await
            }
            "user_by_principal_id" => self.update_user_by_principal_id(id, input).await,
            "analysis" => self.update_analysis(id, input).await,
            "dashboard_embed_url" => self.update_dashboard_embed_url(id, input).await,
            "topic_refresh_schedule" => self.update_topic_refresh_schedule(id, input).await,
            "folder_resolved_permissions" => {
                self.update_folder_resolved_permissions(id, input).await
            }
            "session_embed_url" => self.update_session_embed_url(id, input).await,
            "brand" => self.update_brand(id, input).await,
            "group_membership" => self.update_group_membership(id, input).await,
            ...
            "template_alias" => self.update_template_alias(id, input).await,
            "data_set_permissions" => self.update_data_set_permissions(id, input).await,
            "template" => self.update_template(id, input).await,
            "dashboard_snapshot_job_result" => {
                self.update_dashboard_snapshot_job_result(id, input).await
            }
            "theme_permissions" => self.update_theme_permissions(id, input).await,
            "template_definition" => self.update_template_definition(id, input).await,
            "flow_metadata" => self.update_flow_metadata(id, input).await,
            ...
            "refresh_schedule" => self.update_refresh_schedule(id, input).await,
            "default_q_business_application" => {
            ...
            "brand_published_version" => self.update_brand_published_version(id, input).await,
            "public_sharing_settings" => self.update_public_sharing_settings(id, input).await,
            "custom_permissions" => self.update_custom_permissions(id, input).await,
            "dashboard_permissions" => self.update_dashboard_permissions(id, input).await,
            "identity_propagation_config" => {
                self.update_identity_propagation_config(id, input).await
            }
            "flow_permissions" => self.update_flow_permissions(id, input).await,
            "iam_policy_assignment" => self.update_iam_policy_assignment(id, input).await,
            "user" => self.update_user(id, input).await,
            "dashboard_links" => self.update_dashboard_links(id, input).await,
            "dashboard_published_version" => {
                self.update_dashboard_published_version(id, input).await
            }
            "quick_sight_q_search_configuration" => {
                self.update_quick_sight_q_search_configuration(id, input)
                    .await
            }
            "folder" => self.update_folder(id, input).await,
            "asset_bundle_export_job" => self.update_asset_bundle_export_job(id, input).await,
            "role_membership" => self.update_role_membership(id, input).await,
            "account_subscription" => self.update_account_subscription(id, input).await,
            "data_source" => self.update_data_source(id, input).await,
            "analysis_definition" => self.update_analysis_definition(id, input).await,
            "folder_permissions" => self.update_folder_permissions(id, input).await,
            "key_registration" => self.update_key_registration(id, input).await,
            "topic_permissions" => self.update_topic_permissions(id, input).await,
            "theme_alias" => self.update_theme_alias(id, input).await,
            "user_custom_permission" => self.update_user_custom_permission(id, input).await,
            "theme" => self.update_theme(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "quicksight", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "action_connector" => self.delete_action_connector(id).await,
            "role_custom_permission" => self.delete_role_custom_permission(id).await,
            "dashboard_snapshot_job" => self.delete_dashboard_snapshot_job(id).await,
            "application_with_token_exchange_grant" => {
                self.delete_application_with_token_exchange_grant(id).await
            }
            "folder_membership" => self.delete_folder_membership(id).await,
            "topic_refresh" => self.delete_topic_refresh(id).await,
            "account_customization" => self.delete_account_customization(id).await,
            "vpc_connection" => self.delete_vpc_connection(id).await,
            "data_source_permissions" => self.delete_data_source_permissions(id).await,
            "analysis_permissions" => self.delete_analysis_permissions(id).await,
            "brand_assignment" => self.delete_brand_assignment(id).await,
            "dashboard" => self.delete_dashboard(id).await,
            "dashboard_definition" => self.delete_dashboard_definition(id).await,
            "group" => self.delete_group(id).await,
            "topic" => self.delete_topic(id).await,
            "action_connector_permissions" => self.delete_action_connector_permissions(id).await,
            "ip_restriction" => self.delete_ip_restriction(id).await,
            "asset_bundle_import_job" => self.delete_asset_bundle_import_job(id).await,
            "template_permissions" => self.delete_template_permissions(id).await,
            "account_custom_permission" => self.delete_account_custom_permission(id).await,
            "spice_capacity_configuration" => self.delete_spice_capacity_configuration(id).await,
            "user_by_principal_id" => self.delete_user_by_principal_id(id).await,
            "analysis" => self.delete_analysis(id).await,
            "dashboard_embed_url" => self.delete_dashboard_embed_url(id).await,
            "topic_refresh_schedule" => self.delete_topic_refresh_schedule(id).await,
            "folder_resolved_permissions" => self.delete_folder_resolved_permissions(id).await,
            "session_embed_url" => self.delete_session_embed_url(id).await,
            "brand" => self.delete_brand(id).await,
            "group_membership" => self.delete_group_membership(id).await,
            "namespace" => self.delete_namespace(id).await,
            "q_personalization_configuration" => {
                self.delete_q_personalization_configuration(id).await
            }
            "dashboards_qa_configuration" => self.delete_dashboards_qa_configuration(id).await,
            "template_alias" => self.delete_template_alias(id).await,
            "data_set_permissions" => self.delete_data_set_permissions(id).await,
            "template" => self.delete_template(id).await,
            "dashboard_snapshot_job_result" => self.delete_dashboard_snapshot_job_result(id).await,
            "theme_permissions" => self.delete_theme_permissions(id).await,
            "template_definition" => self.delete_template_definition(id).await,
            "flow_metadata" => self.delete_flow_metadata(id).await,
            ...
            "refresh_schedule" => self.delete_refresh_schedule(id).await,
            "default_q_business_application" => {
                self.delete_default_q_business_application(id).await
            }
            "data_set_refresh_properties" => self.delete_data_set_refresh_properties(id).await,
            "brand_published_version" => self.delete_brand_published_version(id).await,
            "public_sharing_settings" => self.delete_public_sharing_settings(id).await,
            "custom_permissions" => self.delete_custom_permissions(id).await,
            "dashboard_permissions" => self.delete_dashboard_permissions(id).await,
            "identity_propagation_config" => self.delete_identity_propagation_config(id).await,
            "flow_permissions" => self.delete_flow_permissions(id).await,
            "iam_policy_assignment" => self.delete_iam_policy_assignment(id).await,
            "user" => self.delete_user(id).await,
            "dashboard_links" => self.delete_dashboard_links(id).await,
            "dashboard_published_version" => self.delete_dashboard_published_version(id).await,
            "quick_sight_q_search_configuration" => {
                self.delete_quick_sight_q_search_configuration(id).await
            }
            "folder" => self.delete_folder(id).await,
            "asset_bundle_export_job" => self.delete_asset_bundle_export_job(id).await,
            "role_membership" => self.delete_role_membership(id).await,
            "account_subscription" => self.delete_account_subscription(id).await,
            "data_source" => self.delete_data_source(id).await,
            "analysis_definition" => self.delete_analysis_definition(id).await,
            "folder_permissions" => self.delete_folder_permissions(id).await,
            "key_registration" => self.delete_key_registration(id).await,
            "topic_permissions" => self.delete_topic_permissions(id).await,
            "theme_alias" => self.delete_theme_alias(id).await,
            "user_custom_permission" => self.delete_user_custom_permission(id).await,
            "theme" => self.delete_theme(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "quicksight", resource_name
            ))),
    ...
    async fn create_action_connector(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "action_connector_id",
                    action_connector_id.unwrap_or_default(),
                )
                .with_field("name", name.unwrap_or_default())
                .with_field(
                    "authentication_config",
                    authentication_config.unwrap_or_default(),
                )
    ...
    async fn read_action_connector(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_action_connector(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_role_custom_permission(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    custom_permissions_name.unwrap_or_default(),
                )
    ...
    async fn read_role_custom_permission(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_role_custom_permission(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_dashboard_snapshot_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_dashboard_snapshot_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_dashboard_snapshot_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn read_application_with_token_exchange_grant(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_application_with_token_exchange_grant(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_folder_membership(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_folder_membership(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_folder_membership(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_topic_refresh(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_topic_refresh(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn update_topic_refresh(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_topic_refresh(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_account_customization(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "account_customization",
                    account_customization.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default()))
        })
    }
    ...
    async fn read_account_customization(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_account_customization(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_data_source_permissions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_data_source_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_data_source_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_analysis_permissions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let aws_account_id = input.get_string("aws_account_id")?;
    ...
    async fn read_analysis_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_analysis_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_brand_assignment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let aws_account_id = input.get_string("aws_account_id")?;
    ...
    async fn read_brand_assignment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_brand_assignment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_dashboard(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let link_sharing_configuration =
                input.get_optional_string("link_sharing_configuration")?;
            ...
            let dashboard_publish_options =
                input.get_optional_string("dashboard_publish_options")?;
            let aws_account_id = input.get_string("aws_account_id")?;
            let name = input.get_string("name")?;
            let permissions = input.get_optional_string("permissions")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    link_sharing_configuration.unwrap_or_default(),
                )
                .with_field(
                    "version_description",
                ...
                .with_field(
                    "validation_strategy",
                    validation_strategy.unwrap_or_default(),
                )
                .with_field(
                    "dashboard_publish_options",
                    dashboard_publish_options.unwrap_or_default(),
                )
                .with_field("aws_account_id", aws_account_id.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                .with_field("permissions", permissions.unwrap_or_default())
    ...
    async fn create_dashboard_definition(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_dashboard_definition(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_dashboard_definition(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn read_action_connector_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_action_connector_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_ip_restriction(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let aws_account_id = input.get_string("aws_account_id")?;
            ...
            let vpc_endpoint_id_restriction_rule_map =
                input.get_optional_string("vpc_endpoint_id_restriction_rule_map")?;
            let vpc_id_restriction_rule_map =
                input.get_optional_string("vpc_id_restriction_rule_map")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    ip_restriction_rule_map.unwrap_or_default(),
                )
                .with_field("enabled", enabled.unwrap_or_default())
                .with_field(
                    "vpc_endpoint_id_restriction_rule_map",
                    vpc_endpoint_id_restriction_rule_map.unwrap_or_default(),
                )
                .with_field(
                    "vpc_id_restriction_rule_map",
                    vpc_id_restriction_rule_map.unwrap_or_default(),
                ))
        })
    }

    /// Read a ip_restriction resource
    async fn read_ip_restriction(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_ip_restriction(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_asset_bundle_import_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_asset_bundle_import_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_asset_bundle_import_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_template_permissions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_template_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_template_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn read_account_custom_permission(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_account_custom_permission(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn read_spice_capacity_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_spice_capacity_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_user_by_principal_id(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_user_by_principal_id(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_user_by_principal_id(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_analysis(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let theme_arn = input.get_optional_string("theme_arn")?;
    ...
    async fn read_analysis(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn update_analysis(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let theme_arn = input.get_optional_string("theme_arn")?;
            let analysis_id = input.get_string("analysis_id")?;
    ...
    async fn create_dashboard_embed_url(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_dashboard_embed_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_dashboard_embed_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_topic_refresh_schedule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_topic_refresh_schedule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_topic_refresh_schedule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn read_folder_resolved_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_folder_resolved_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_session_embed_url(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_session_embed_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_session_embed_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_group_membership(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let aws_account_id = input.get_string("aws_account_id")?;
    ...
    async fn read_group_membership(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_group_membership(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    personalization_mode.unwrap_or_default(),
                )
                .with_field("aws_account_id", aws_account_id.unwrap_or_default()))
        })
    }
    ...
    async fn read_q_personalization_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_q_personalization_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    dashboards_qa_status.unwrap_or_default(),
                ))
        })
    }

    /// Read a dashboards_qa_configuration resource
    async fn read_dashboards_qa_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_dashboards_qa_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_template_alias(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    template_version_number.unwrap_or_default(),
                )
                .with_field("template_id", template_id.unwrap_or_default()))
        })
    }
    ...
    async fn read_template_alias(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_template_alias(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_data_set_permissions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let grant_permissions = input.get_optional_string("grant_permissions")?;
    ...
    async fn read_data_set_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_data_set_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn read_dashboard_snapshot_job_result(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_dashboard_snapshot_job_result(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_theme_permissions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let grant_permissions = input.get_optional_string("grant_permissions")?;
    ...
    async fn read_theme_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_theme_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_template_definition(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_template_definition(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_template_definition(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_flow_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_flow_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn update_flow_metadata(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_flow_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_data_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let row_level_permission_data_set =
                input.get_optional_string("row_level_permission_data_set")?;
            ...
            let column_level_permission_rules =
                input.get_optional_string("column_level_permission_rules")?;
            let row_level_permission_tag_configuration =
                input.get_optional_string("row_level_permission_tag_configuration")?;
            let aws_account_id = input.get_string("aws_account_id")?;
            let column_groups = input.get_optional_string("column_groups")?;
            let use_as = input.get_optional_string("use_as")?;
            let performance_configuration =
                input.get_optional_string("performance_configuration")?;
            let tags = input.get_optional_string("tags")?;
            let dataset_parameters = input.get_optional_string("dataset_parameters")?;
            let data_set_usage_configuration =
                input.get_optional_string("data_set_usage_configuration")?;
            let permissions = input.get_optional_string("permissions")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    row_level_permission_data_set.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    column_level_permission_rules.unwrap_or_default(),
                )
                .with_field(
                    "row_level_permission_tag_configuration",
                    row_level_permission_tag_configuration.unwrap_or_default(),
                )
                .with_field("aws_account_id", aws_account_id.unwrap_or_default())
                ...
                .with_field(
                    ...
                    performance_configuration.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("dataset_parameters", dataset_parameters.unwrap_or_default())
                .with_field(
                    "data_set_usage_configuration",
                    data_set_usage_configuration.unwrap_or_default(),
                )
                .with_field("permissions", permissions.unwrap_or_default())
    ...
    async fn create_refresh_schedule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_refresh_schedule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_refresh_schedule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn read_default_q_business_application(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_default_q_business_application(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_data_set_refresh_properties(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "data_set_refresh_properties",
                    data_set_refresh_properties.unwrap_or_default(),
                ))
        })
    }

    /// Read a data_set_refresh_properties resource
    async fn read_data_set_refresh_properties(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_data_set_refresh_properties(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_brand_published_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let aws_account_id = input.get_string("aws_account_id")?;
    ...
    async fn read_brand_published_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_brand_published_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_public_sharing_settings(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    public_sharing_enabled.unwrap_or_default(),
                )
                .with_field("aws_account_id", aws_account_id.unwrap_or_default()))
        })
    }
    ...
    async fn read_public_sharing_settings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_public_sharing_settings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_custom_permissions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_custom_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_custom_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_dashboard_permissions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let aws_account_id = input.get_string("aws_account_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    revoke_link_permissions.unwrap_or_default(),
                )
                .with_field("revoke_permissions", revoke_permissions.unwrap_or_default())
                .with_field(
                    "grant_link_permissions",
                    grant_link_permissions.unwrap_or_default(),
                ))
        })
    }

    /// Read a dashboard_permissions resource
    async fn read_dashboard_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_dashboard_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn read_identity_propagation_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_identity_propagation_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_flow_permissions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let aws_account_id = input.get_string("aws_account_id")?;
    ...
    async fn read_flow_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_flow_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_iam_policy_assignment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_iam_policy_assignment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_iam_policy_assignment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_user(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let namespace = input.get_string("namespace")?;
            let unapply_custom_permissions =
                input.get_optional_string("unapply_custom_permissions")?;
            let email = input.get_string("email")?;
            let custom_federation_provider_url =
                input.get_optional_string("custom_federation_provider_url")?;
            ...
            let role = input.get_string("role")?;
            let external_login_federation_provider_type =
                input.get_optional_string("external_login_federation_provider_type")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    unapply_custom_permissions.unwrap_or_default(),
                )
                .with_field("email", email.unwrap_or_default())
                .with_field(
                    "custom_federation_provider_url",
                    custom_federation_provider_url.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    external_login_federation_provider_type.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_dashboard_links(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_dashboard_links(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_dashboard_links(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn read_dashboard_published_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_dashboard_published_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn read_quick_sight_q_search_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_quick_sight_q_search_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_asset_bundle_export_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_asset_bundle_export_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_asset_bundle_export_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_role_membership(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let member_name = input.get_string("member_name")?;
    ...
    async fn read_role_membership(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_role_membership(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_account_subscription(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let iam_identity_center_instance_arn =
                input.get_optional_string("iam_identity_center_instance_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    iam_identity_center_instance_arn.unwrap_or_default(),
                )
    ...
    async fn read_account_subscription(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_account_subscription(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_data_source(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let tags = input.get_optional_string("tags")?;
            let data_source_id = input.get_string("data_source_id")?;
            let vpc_connection_properties =
                input.get_optional_string("vpc_connection_properties")?;
            let folder_arns = input.get_optional_string("folder_arns")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    data_source_parameters.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("data_source_id", data_source_id.unwrap_or_default())
                .with_field(
                    "vpc_connection_properties",
                    vpc_connection_properties.unwrap_or_default(),
                )
                .with_field("folder_arns", folder_arns.unwrap_or_default())
    ...
    async fn create_analysis_definition(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_analysis_definition(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_analysis_definition(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_folder_permissions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let folder_id = input.get_string("folder_id")?;
    ...
    async fn read_folder_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_folder_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_key_registration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let aws_account_id = input.get_string("aws_account_id")?;
    ...
    async fn read_key_registration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_key_registration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_topic_permissions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let grant_permissions = input.get_optional_string("grant_permissions")?;
    ...
    async fn read_topic_permissions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_topic_permissions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_theme_alias(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let aws_account_id = input.get_string("aws_account_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    theme_version_number.unwrap_or_default(),
                )
                .with_field("theme_id", theme_id.unwrap_or_default()))
        })
    }
    ...
    async fn read_theme_alias(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn update_theme_alias(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let aws_account_id = input.get_string("aws_account_id")?;
            let alias_name = input.get_string("alias_name")?;
    ...
    async fn delete_theme_alias(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_user_custom_permission(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let user_name = input.get_string("user_name")?;
    ...
    async fn read_user_custom_permission(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn delete_user_custom_permission(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
    ...
    async fn create_theme(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
    ...
    async fn read_theme(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.quicksight_client
    ...
    async fn update_theme(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_theme(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.quicksight_client
