...
impl<'a> Cross_account_attachment<'a> {
    ...
    pub async fn create(&self, resources: Option<Vec<String>>, idempotency_token: String, tags: Option<Vec<String>>, name: String, principals: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, resources: Option<Vec<String>>, idempotency_token: Option<String>, tags: Option<Vec<String>>, name: Option<String>, principals: Option<Vec<String>>) -> Result<()> {
