...
impl<'a> Custom_routing_listener<'a> {
    ...
    pub async fn create(&self, idempotency_token: String, port_ranges: Vec<String>, accelerator_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, idempotency_token: Option<String>, port_ranges: Option<Vec<String>>, accelerator_arn: Option<String>) -> Result<()> {
