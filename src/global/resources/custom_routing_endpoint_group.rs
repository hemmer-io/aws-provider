...
impl<'a> Custom_routing_endpoint_group<'a> {
    ...
    pub async fn create(&self, listener_arn: String, endpoint_group_region: String, idempotency_token: String, destination_configurations: Vec<String>) -> Result<String> {
