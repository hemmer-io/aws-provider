...
impl<'a> Account_assignment<'a> {
    ...
    pub async fn create(&self, permission_set_arn: String, target_type: String, principal_id: String, principal_type: String, target_id: String, instance_arn: String) -> Result<String> {
