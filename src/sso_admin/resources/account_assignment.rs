...
impl<'a> Account_assignment<'a> {
    ...
    pub async fn create(&self, target_type: String, permission_set_arn: String, instance_arn: String, principal_id: String, target_id: String, principal_type: String) -> Result<String> {
