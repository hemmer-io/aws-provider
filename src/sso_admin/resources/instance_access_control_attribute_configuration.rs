...
impl<'a> Instance_access_control_attribute_configuration<'a> {
    ...
    pub async fn create(&self, instance_access_control_attribute_configuration: String, instance_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, instance_access_control_attribute_configuration: Option<String>, instance_arn: Option<String>) -> Result<()> {
