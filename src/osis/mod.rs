...
impl<'a> OsisService<'a> {
    ...
    async fn read_pipeline_change_progress(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_pipeline_change_progress(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_pipeline_blueprint(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_pipeline_blueprint(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_pipeline_blueprint(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
