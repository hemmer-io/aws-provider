...
impl<'a> Cognito_syncService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "identity_pool_configuration" => {
                self.plan_identity_pool_configuration(current_state, desired_input)
                    .await
            }
            "bulk_publish_details" => {
                self.plan_bulk_publish_details(current_state, desired_input)
                    .await
            }
            "identity_pool_usage" => {
                self.plan_identity_pool_usage(current_state, desired_input)
                    .await
            }
            "dataset" => self.plan_dataset(current_state, desired_input).await,
            "cognito_events" => self.plan_cognito_events(current_state, desired_input).await,
            "identity_usage" => self.plan_identity_usage(current_state, desired_input).await,
            "records" => self.plan_records(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cognito_sync", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "identity_pool_configuration" => self.create_identity_pool_configuration(input).await,
            "bulk_publish_details" => self.create_bulk_publish_details(input).await,
            "identity_pool_usage" => self.create_identity_pool_usage(input).await,
            "dataset" => self.create_dataset(input).await,
            "cognito_events" => self.create_cognito_events(input).await,
            "identity_usage" => self.create_identity_usage(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "identity_pool_configuration" => self.read_identity_pool_configuration(id).await,
            "bulk_publish_details" => self.read_bulk_publish_details(id).await,
            "identity_pool_usage" => self.read_identity_pool_usage(id).await,
            "dataset" => self.read_dataset(id).await,
            "cognito_events" => self.read_cognito_events(id).await,
            "identity_usage" => self.read_identity_usage(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "bulk_publish_details" => self.update_bulk_publish_details(id, input).await,
            "identity_pool_usage" => self.update_identity_pool_usage(id, input).await,
            "dataset" => self.update_dataset(id, input).await,
            "cognito_events" => self.update_cognito_events(id, input).await,
            "identity_usage" => self.update_identity_usage(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "identity_pool_configuration" => self.delete_identity_pool_configuration(id).await,
            "bulk_publish_details" => self.delete_bulk_publish_details(id).await,
            "identity_pool_usage" => self.delete_identity_pool_usage(id).await,
            "dataset" => self.delete_dataset(id).await,
            "cognito_events" => self.delete_cognito_events(id).await,
            "identity_usage" => self.delete_identity_usage(id).await,
    ...
    async fn read_identity_pool_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_identity_pool_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_bulk_publish_details(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_bulk_publish_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_sync_client
    ...
    async fn delete_bulk_publish_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_sync_client
    ...
    async fn create_identity_pool_usage(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_identity_pool_usage(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_sync_client
    ...
    async fn delete_identity_pool_usage(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_sync_client
    ...
    async fn create_cognito_events(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cognito_events(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_sync_client
    ...
    async fn delete_cognito_events(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_sync_client
    ...
    async fn create_identity_usage(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_identity_usage(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cognito_sync_client
    ...
    async fn delete_identity_usage(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cognito_sync_client
