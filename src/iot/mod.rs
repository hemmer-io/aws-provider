...
impl<'a> IotService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "effective_policies" => {
                self.plan_effective_policies(current_state, desired_input)
                    .await
            }
            "thing" => self.plan_thing(current_state, desired_input).await,
            ...
            "registration_code" => {
                self.plan_registration_code(current_state, desired_input)
                    .await
            }
            "detect_mitigation_actions_task" => {
                self.plan_detect_mitigation_actions_task(current_state, desired_input)
                    .await
            }
            "provisioning_claim" => {
                self.plan_provisioning_claim(current_state, desired_input)
                    .await
            }
            "managed_job_template" => {
                self.plan_managed_job_template(current_state, desired_input)
                    .await
            }
            "dynamic_thing_group" => {
                self.plan_dynamic_thing_group(current_state, desired_input)
                    .await
            }
            ...
            "domain_configuration" => {
                self.plan_domain_configuration(current_state, desired_input)
                    .await
            }
            "certificate_from_csr" => {
                self.plan_certificate_from_csr(current_state, desired_input)
                    .await
            }
            "package" => self.plan_package(current_state, desired_input).await,
            "thing_group" => self.plan_thing_group(current_state, desired_input).await,
            "indexing_configuration" => {
                self.plan_indexing_configuration(current_state, desired_input)
                    .await
            }
            "verification_state_on_violation" => {
                self.plan_verification_state_on_violation(current_state, desired_input)
                    .await
            }
            "fleet_metric" => self.plan_fleet_metric(current_state, desired_input).await,
            "provisioning_template_version" => {
                self.plan_provisioning_template_version(current_state, desired_input)
                    .await
            }
            "v2_logging_options" => {
                self.plan_v2_logging_options(current_state, desired_input)
                    .await
            }
            "scheduled_audit" => {
                self.plan_scheduled_audit(current_state, desired_input)
                    .await
            }
            "endpoint" => self.plan_endpoint(current_state, desired_input).await,
            "package_configuration" => {
                self.plan_package_configuration(current_state, desired_input)
                    .await
            }
            "provisioning_template" => {
                self.plan_provisioning_template(current_state, desired_input)
                    .await
            }
            "keys_and_certificate" => {
                self.plan_keys_and_certificate(current_state, desired_input)
                    .await
            }
            "authorizer" => self.plan_authorizer(current_state, desired_input).await,
            "role_alias" => self.plan_role_alias(current_state, desired_input).await,
            "stream" => self.plan_stream(current_state, desired_input).await,
            "certificate_provider" => {
                self.plan_certificate_provider(current_state, desired_input)
                    .await
            }
            "ca_certificate" => self.plan_ca_certificate(current_state, desired_input).await,
            "security_profile" => {
                self.plan_security_profile(current_state, desired_input)
                    .await
            }
            "command_execution" => {
                self.plan_command_execution(current_state, desired_input)
                    .await
            }
            "buckets_aggregation" => {
                self.plan_buckets_aggregation(current_state, desired_input)
                    .await
            }
            "dimension" => self.plan_dimension(current_state, desired_input).await,
            "billing_group" => self.plan_billing_group(current_state, desired_input).await,
            "v2_logging_level" => {
                self.plan_v2_logging_level(current_state, desired_input)
                    .await
            }
            "statistics" => self.plan_statistics(current_state, desired_input).await,
            "thing_type" => self.plan_thing_type(current_state, desired_input).await,
            "account_audit_configuration" => {
                self.plan_account_audit_configuration(current_state, desired_input)
                    .await
            }
            "logging_options" => {
            ...
            "default_authorizer" => {
                self.plan_default_authorizer(current_state, desired_input)
                    .await
            }
            "topic_rule_destination" => {
                self.plan_topic_rule_destination(current_state, desired_input)
                    .await
            }
            "ota_update" => self.plan_ota_update(current_state, desired_input).await,
            "cardinality" => self.plan_cardinality(current_state, desired_input).await,
            "audit_suppression" => {
                self.plan_audit_suppression(current_state, desired_input)
                    .await
            }
            ...
            "thing_groups_for_thing" => {
                self.plan_thing_groups_for_thing(current_state, desired_input)
                    .await
            }
            "percentiles" => self.plan_percentiles(current_state, desired_input).await,
            "thing_registration_task" => {
                self.plan_thing_registration_task(current_state, desired_input)
                    .await
            }
            "index" => self.plan_index(current_state, desired_input).await,
            "topic_rule" => self.plan_topic_rule(current_state, desired_input).await,
            "command" => self.plan_command(current_state, desired_input).await,
            "audit_finding" => self.plan_audit_finding(current_state, desired_input).await,
            "audit_mitigation_actions_task" => {
                self.plan_audit_mitigation_actions_task(current_state, desired_input)
                    .await
            }
            "encryption_configuration" => {
                self.plan_encryption_configuration(current_state, desired_input)
                    .await
            }
            "package_version" => {
            ...
            "job_document" => self.plan_job_document(current_state, desired_input).await,
            "event_configurations" => {
                self.plan_event_configurations(current_state, desired_input)
                    .await
            }
            "thing_connectivity_data" => {
                self.plan_thing_connectivity_data(current_state, desired_input)
                    .await
            }
            "audit_task" => self.plan_audit_task(current_state, desired_input).await,
            "behavior_model_training_summaries" => {
                self.plan_behavior_model_training_summaries(current_state, desired_input)
                    .await
            }
            "mitigation_action" => {
                self.plan_mitigation_action(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "effective_policies" => self.create_effective_policies(input).await,
            "thing" => self.create_thing(input).await,
            "custom_metric" => self.create_custom_metric(input).await,
            "job" => self.create_job(input).await,
            "registration_code" => self.create_registration_code(input).await,
            "detect_mitigation_actions_task" => {
                self.create_detect_mitigation_actions_task(input).await
            }
            "provisioning_claim" => self.create_provisioning_claim(input).await,
            "managed_job_template" => self.create_managed_job_template(input).await,
            "dynamic_thing_group" => self.create_dynamic_thing_group(input).await,
            "policy" => self.create_policy(input).await,
            "policy_version" => self.create_policy_version(input).await,
            "domain_configuration" => self.create_domain_configuration(input).await,
            "certificate_from_csr" => self.create_certificate_from_csr(input).await,
            "package" => self.create_package(input).await,
            "thing_group" => self.create_thing_group(input).await,
            "indexing_configuration" => self.create_indexing_configuration(input).await,
            "verification_state_on_violation" => {
                self.create_verification_state_on_violation(input).await
            }
            "fleet_metric" => self.create_fleet_metric(input).await,
            "provisioning_template_version" => {
                self.create_provisioning_template_version(input).await
            }
            "v2_logging_options" => self.create_v2_logging_options(input).await,
            "scheduled_audit" => self.create_scheduled_audit(input).await,
            "endpoint" => self.create_endpoint(input).await,
            "package_configuration" => self.create_package_configuration(input).await,
            "provisioning_template" => self.create_provisioning_template(input).await,
            "keys_and_certificate" => self.create_keys_and_certificate(input).await,
            "authorizer" => self.create_authorizer(input).await,
            "role_alias" => self.create_role_alias(input).await,
            "stream" => self.create_stream(input).await,
            "certificate_provider" => self.create_certificate_provider(input).await,
            "ca_certificate" => self.create_ca_certificate(input).await,
            "security_profile" => self.create_security_profile(input).await,
            "command_execution" => self.create_command_execution(input).await,
            "buckets_aggregation" => self.create_buckets_aggregation(input).await,
            "dimension" => self.create_dimension(input).await,
            "billing_group" => self.create_billing_group(input).await,
            "v2_logging_level" => self.create_v2_logging_level(input).await,
            "statistics" => self.create_statistics(input).await,
            "thing_type" => self.create_thing_type(input).await,
            "account_audit_configuration" => self.create_account_audit_configuration(input).await,
            "logging_options" => self.create_logging_options(input).await,
            "default_authorizer" => self.create_default_authorizer(input).await,
            "topic_rule_destination" => self.create_topic_rule_destination(input).await,
            "ota_update" => self.create_ota_update(input).await,
            "cardinality" => self.create_cardinality(input).await,
            "audit_suppression" => self.create_audit_suppression(input).await,
            "job_template" => self.create_job_template(input).await,
            "job_execution" => self.create_job_execution(input).await,
            "thing_groups_for_thing" => self.create_thing_groups_for_thing(input).await,
            "percentiles" => self.create_percentiles(input).await,
            "thing_registration_task" => self.create_thing_registration_task(input).await,
            "index" => self.create_index(input).await,
            "topic_rule" => self.create_topic_rule(input).await,
            "command" => self.create_command(input).await,
            "audit_finding" => self.create_audit_finding(input).await,
            "audit_mitigation_actions_task" => {
                self.create_audit_mitigation_actions_task(input).await
            }
            "encryption_configuration" => self.create_encryption_configuration(input).await,
            "package_version" => self.create_package_version(input).await,
            "job_document" => self.create_job_document(input).await,
            "event_configurations" => self.create_event_configurations(input).await,
            "thing_connectivity_data" => self.create_thing_connectivity_data(input).await,
            "audit_task" => self.create_audit_task(input).await,
            "behavior_model_training_summaries" => {
                self.create_behavior_model_training_summaries(input).await
            }
            "mitigation_action" => self.create_mitigation_action(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "effective_policies" => self.read_effective_policies(id).await,
            "thing" => self.read_thing(id).await,
            "custom_metric" => self.read_custom_metric(id).await,
            "job" => self.read_job(id).await,
            "registration_code" => self.read_registration_code(id).await,
            "detect_mitigation_actions_task" => self.read_detect_mitigation_actions_task(id).await,
            "provisioning_claim" => self.read_provisioning_claim(id).await,
            "managed_job_template" => self.read_managed_job_template(id).await,
            "dynamic_thing_group" => self.read_dynamic_thing_group(id).await,
            "policy" => self.read_policy(id).await,
            "policy_version" => self.read_policy_version(id).await,
            "domain_configuration" => self.read_domain_configuration(id).await,
            "certificate_from_csr" => self.read_certificate_from_csr(id).await,
            "package" => self.read_package(id).await,
            "thing_group" => self.read_thing_group(id).await,
            "indexing_configuration" => self.read_indexing_configuration(id).await,
            "verification_state_on_violation" => {
                self.read_verification_state_on_violation(id).await
            }
            "fleet_metric" => self.read_fleet_metric(id).await,
            "provisioning_template_version" => self.read_provisioning_template_version(id).await,
            "v2_logging_options" => self.read_v2_logging_options(id).await,
            "scheduled_audit" => self.read_scheduled_audit(id).await,
            "endpoint" => self.read_endpoint(id).await,
            "package_configuration" => self.read_package_configuration(id).await,
            "provisioning_template" => self.read_provisioning_template(id).await,
            "keys_and_certificate" => self.read_keys_and_certificate(id).await,
            "authorizer" => self.read_authorizer(id).await,
            "role_alias" => self.read_role_alias(id).await,
            "stream" => self.read_stream(id).await,
            "certificate_provider" => self.read_certificate_provider(id).await,
            "ca_certificate" => self.read_ca_certificate(id).await,
            "security_profile" => self.read_security_profile(id).await,
            "command_execution" => self.read_command_execution(id).await,
            "buckets_aggregation" => self.read_buckets_aggregation(id).await,
            "dimension" => self.read_dimension(id).await,
            "billing_group" => self.read_billing_group(id).await,
            "v2_logging_level" => self.read_v2_logging_level(id).await,
            "statistics" => self.read_statistics(id).await,
            "thing_type" => self.read_thing_type(id).await,
            "account_audit_configuration" => self.read_account_audit_configuration(id).await,
            "logging_options" => self.read_logging_options(id).await,
            "default_authorizer" => self.read_default_authorizer(id).await,
            "topic_rule_destination" => self.read_topic_rule_destination(id).await,
            "ota_update" => self.read_ota_update(id).await,
            "cardinality" => self.read_cardinality(id).await,
            "audit_suppression" => self.read_audit_suppression(id).await,
            "job_template" => self.read_job_template(id).await,
            "job_execution" => self.read_job_execution(id).await,
            "thing_groups_for_thing" => self.read_thing_groups_for_thing(id).await,
            "percentiles" => self.read_percentiles(id).await,
            "thing_registration_task" => self.read_thing_registration_task(id).await,
            "index" => self.read_index(id).await,
            "topic_rule" => self.read_topic_rule(id).await,
            "command" => self.read_command(id).await,
            "audit_finding" => self.read_audit_finding(id).await,
            "audit_mitigation_actions_task" => self.read_audit_mitigation_actions_task(id).await,
            "encryption_configuration" => self.read_encryption_configuration(id).await,
            "package_version" => self.read_package_version(id).await,
            "job_document" => self.read_job_document(id).await,
            "event_configurations" => self.read_event_configurations(id).await,
            "thing_connectivity_data" => self.read_thing_connectivity_data(id).await,
            "audit_task" => self.read_audit_task(id).await,
            "behavior_model_training_summaries" => {
                self.read_behavior_model_training_summaries(id).await
            }
            "mitigation_action" => self.read_mitigation_action(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "effective_policies" => self.update_effective_policies(id, input).await,
            "thing" => self.update_thing(id, input).await,
            "custom_metric" => self.update_custom_metric(id, input).await,
            "job" => self.update_job(id, input).await,
            "registration_code" => self.update_registration_code(id, input).await,
            "detect_mitigation_actions_task" => {
                self.update_detect_mitigation_actions_task(id, input).await
            }
            "provisioning_claim" => self.update_provisioning_claim(id, input).await,
            "managed_job_template" => self.update_managed_job_template(id, input).await,
            "dynamic_thing_group" => self.update_dynamic_thing_group(id, input).await,
            "policy" => self.update_policy(id, input).await,
            "policy_version" => self.update_policy_version(id, input).await,
            "domain_configuration" => self.update_domain_configuration(id, input).await,
            "certificate_from_csr" => self.update_certificate_from_csr(id, input).await,
            "package" => self.update_package(id, input).await,
            "thing_group" => self.update_thing_group(id, input).await,
            "indexing_configuration" => self.update_indexing_configuration(id, input).await,
            "verification_state_on_violation" => {
                self.update_verification_state_on_violation(id, input).await
            }
            "fleet_metric" => self.update_fleet_metric(id, input).await,
            "provisioning_template_version" => {
                self.update_provisioning_template_version(id, input).await
            }
            "v2_logging_options" => self.update_v2_logging_options(id, input).await,
            "scheduled_audit" => self.update_scheduled_audit(id, input).await,
            "endpoint" => self.update_endpoint(id, input).await,
            "package_configuration" => self.update_package_configuration(id, input).await,
            "provisioning_template" => self.update_provisioning_template(id, input).await,
            "keys_and_certificate" => self.update_keys_and_certificate(id, input).await,
            "authorizer" => self.update_authorizer(id, input).await,
            "role_alias" => self.update_role_alias(id, input).await,
            "stream" => self.update_stream(id, input).await,
            "certificate_provider" => self.update_certificate_provider(id, input).await,
            "ca_certificate" => self.update_ca_certificate(id, input).await,
            "security_profile" => self.update_security_profile(id, input).await,
            "command_execution" => self.update_command_execution(id, input).await,
            "buckets_aggregation" => self.update_buckets_aggregation(id, input).await,
            "dimension" => self.update_dimension(id, input).await,
            "billing_group" => self.update_billing_group(id, input).await,
            "v2_logging_level" => self.update_v2_logging_level(id, input).await,
            "statistics" => self.update_statistics(id, input).await,
            "thing_type" => self.update_thing_type(id, input).await,
            "account_audit_configuration" => {
                self.update_account_audit_configuration(id, input).await
            }
            "logging_options" => self.update_logging_options(id, input).await,
            "default_authorizer" => self.update_default_authorizer(id, input).await,
            "topic_rule_destination" => self.update_topic_rule_destination(id, input).await,
            "ota_update" => self.update_ota_update(id, input).await,
            "cardinality" => self.update_cardinality(id, input).await,
            "audit_suppression" => self.update_audit_suppression(id, input).await,
            "job_template" => self.update_job_template(id, input).await,
            "job_execution" => self.update_job_execution(id, input).await,
            "thing_groups_for_thing" => self.update_thing_groups_for_thing(id, input).await,
            "percentiles" => self.update_percentiles(id, input).await,
            "thing_registration_task" => self.update_thing_registration_task(id, input).await,
            "index" => self.update_index(id, input).await,
            "topic_rule" => self.update_topic_rule(id, input).await,
            "command" => self.update_command(id, input).await,
            "audit_finding" => self.update_audit_finding(id, input).await,
            "audit_mitigation_actions_task" => {
                self.update_audit_mitigation_actions_task(id, input).await
            }
            "encryption_configuration" => self.update_encryption_configuration(id, input).await,
            "package_version" => self.update_package_version(id, input).await,
            "job_document" => self.update_job_document(id, input).await,
            "event_configurations" => self.update_event_configurations(id, input).await,
            "thing_connectivity_data" => self.update_thing_connectivity_data(id, input).await,
            "audit_task" => self.update_audit_task(id, input).await,
            "behavior_model_training_summaries" => {
                self.update_behavior_model_training_summaries(id, input)
                    .await
            }
            "mitigation_action" => self.update_mitigation_action(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "effective_policies" => self.delete_effective_policies(id).await,
            "thing" => self.delete_thing(id).await,
            "custom_metric" => self.delete_custom_metric(id).await,
            "job" => self.delete_job(id).await,
            "registration_code" => self.delete_registration_code(id).await,
            "detect_mitigation_actions_task" => {
                self.delete_detect_mitigation_actions_task(id).await
            }
            "provisioning_claim" => self.delete_provisioning_claim(id).await,
            "managed_job_template" => self.delete_managed_job_template(id).await,
            "dynamic_thing_group" => self.delete_dynamic_thing_group(id).await,
            "policy" => self.delete_policy(id).await,
            "policy_version" => self.delete_policy_version(id).await,
            "domain_configuration" => self.delete_domain_configuration(id).await,
            "certificate_from_csr" => self.delete_certificate_from_csr(id).await,
            "package" => self.delete_package(id).await,
            "thing_group" => self.delete_thing_group(id).await,
            "indexing_configuration" => self.delete_indexing_configuration(id).await,
            "verification_state_on_violation" => {
                self.delete_verification_state_on_violation(id).await
            }
            "fleet_metric" => self.delete_fleet_metric(id).await,
            "provisioning_template_version" => self.delete_provisioning_template_version(id).await,
            "v2_logging_options" => self.delete_v2_logging_options(id).await,
            "scheduled_audit" => self.delete_scheduled_audit(id).await,
            "endpoint" => self.delete_endpoint(id).await,
            "package_configuration" => self.delete_package_configuration(id).await,
            "provisioning_template" => self.delete_provisioning_template(id).await,
            "keys_and_certificate" => self.delete_keys_and_certificate(id).await,
            "authorizer" => self.delete_authorizer(id).await,
            "role_alias" => self.delete_role_alias(id).await,
            "stream" => self.delete_stream(id).await,
            "certificate_provider" => self.delete_certificate_provider(id).await,
            "ca_certificate" => self.delete_ca_certificate(id).await,
            "security_profile" => self.delete_security_profile(id).await,
            "command_execution" => self.delete_command_execution(id).await,
            "buckets_aggregation" => self.delete_buckets_aggregation(id).await,
            "dimension" => self.delete_dimension(id).await,
            "billing_group" => self.delete_billing_group(id).await,
            "v2_logging_level" => self.delete_v2_logging_level(id).await,
            "statistics" => self.delete_statistics(id).await,
            "thing_type" => self.delete_thing_type(id).await,
            "account_audit_configuration" => self.delete_account_audit_configuration(id).await,
            "logging_options" => self.delete_logging_options(id).await,
            "default_authorizer" => self.delete_default_authorizer(id).await,
            "topic_rule_destination" => self.delete_topic_rule_destination(id).await,
            "ota_update" => self.delete_ota_update(id).await,
            "cardinality" => self.delete_cardinality(id).await,
            "audit_suppression" => self.delete_audit_suppression(id).await,
            "job_template" => self.delete_job_template(id).await,
            "job_execution" => self.delete_job_execution(id).await,
            "thing_groups_for_thing" => self.delete_thing_groups_for_thing(id).await,
            "percentiles" => self.delete_percentiles(id).await,
            "thing_registration_task" => self.delete_thing_registration_task(id).await,
            "index" => self.delete_index(id).await,
            "topic_rule" => self.delete_topic_rule(id).await,
            "command" => self.delete_command(id).await,
            "audit_finding" => self.delete_audit_finding(id).await,
            "audit_mitigation_actions_task" => self.delete_audit_mitigation_actions_task(id).await,
            "encryption_configuration" => self.delete_encryption_configuration(id).await,
            "package_version" => self.delete_package_version(id).await,
            "job_document" => self.delete_job_document(id).await,
            "event_configurations" => self.delete_event_configurations(id).await,
            "thing_connectivity_data" => self.delete_thing_connectivity_data(id).await,
            "audit_task" => self.delete_audit_task(id).await,
            "behavior_model_training_summaries" => {
                self.delete_behavior_model_training_summaries(id).await
            }
            "mitigation_action" => self.delete_mitigation_action(id).await,
    ...
    async fn create_effective_policies(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_effective_policies(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_effective_policies(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_thing(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_thing(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_thing(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let billing_group_name = input.get_optional_string("billing_group_name")?;
            let thing_name = input.get_string("thing_name")?;
    ...
    async fn delete_thing(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let job_executions_rollout_config =
                input.get_optional_string("job_executions_rollout_config")?;
            ...
            let destination_package_versions =
                input.get_optional_string("destination_package_versions")?;
            ...
            let tags = input.get_optional_string("tags")?;
            let job_executions_retry_config =
                input.get_optional_string("job_executions_retry_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    job_executions_rollout_config.unwrap_or_default(),
                )
                .with_field(
                    "presigned_url_config",
                    presigned_url_config.unwrap_or_default(),
                )
                .with_field("abort_config", abort_config.unwrap_or_default())
                .with_field(
                    "destination_package_versions",
                    destination_package_versions.unwrap_or_default(),
                )
                ...
                .with_field(
                    "document_parameters",
                    document_parameters.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    job_executions_retry_config.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_registration_code(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_registration_code(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_registration_code(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn read_detect_mitigation_actions_task(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_detect_mitigation_actions_task(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_provisioning_claim(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_provisioning_claim(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_provisioning_claim(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_managed_job_template(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_managed_job_template(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_managed_job_template(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_dynamic_thing_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    thing_group_properties.unwrap_or_default(),
                ))
        })
    }

    /// Read a dynamic_thing_group resource
    async fn read_dynamic_thing_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_dynamic_thing_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_domain_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let client_certificate_config =
                input.get_optional_string("client_certificate_config")?;
            let server_certificate_config =
                input.get_optional_string("server_certificate_config")?;
            let validation_certificate_arn =
                input.get_optional_string("validation_certificate_arn")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    application_protocol.unwrap_or_default(),
                )
                .with_field(
                    "server_certificate_arns",
                    server_certificate_arns.unwrap_or_default(),
                )
                .with_field(
                    "client_certificate_config",
                    client_certificate_config.unwrap_or_default(),
                )
                .with_field(
                    "server_certificate_config",
                    server_certificate_config.unwrap_or_default(),
                )
                .with_field(
                    "validation_certificate_arn",
                    validation_certificate_arn.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("authorizer_config", authorizer_config.unwrap_or_default())
                .with_field(
                    "domain_configuration_name",
                    domain_configuration_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a domain_configuration resource
    async fn read_domain_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_domain_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_certificate_from_csr(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    certificate_signing_request.unwrap_or_default(),
                )
    ...
    async fn read_certificate_from_csr(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_certificate_from_csr(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_thing_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let thing_group_name = input.get_string("thing_group_name")?;
    ...
    async fn read_thing_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_thing_group(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let thing_group_name = input.get_string("thing_group_name")?;
            let parent_group_name = input.get_optional_string("parent_group_name")?;
    ...
    async fn delete_thing_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_indexing_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let thing_indexing_configuration =
                input.get_optional_string("thing_indexing_configuration")?;
            let thing_group_indexing_configuration =
                input.get_optional_string("thing_group_indexing_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    thing_indexing_configuration.unwrap_or_default(),
                )
                .with_field(
                    "thing_group_indexing_configuration",
                    thing_group_indexing_configuration.unwrap_or_default(),
                ))
        })
    }

    /// Read a indexing_configuration resource
    async fn read_indexing_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_indexing_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_verification_state_on_violation(
        ...
        self.provider.runtime().block_on(async {
            ...
            let verification_state_description =
                input.get_optional_string("verification_state_description")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    verification_state_description.unwrap_or_default(),
                )
    ...
    async fn read_verification_state_on_violation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_verification_state_on_violation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_fleet_metric(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_fleet_metric(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_fleet_metric(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let aggregation_type = input.get_string("aggregation_type")?;
            let query_version = input.get_optional_string("query_version")?;
    ...
    async fn delete_fleet_metric(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn read_provisioning_template_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_provisioning_template_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_v2_logging_options(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_v2_logging_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_v2_logging_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_scheduled_audit(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    scheduled_audit_name.unwrap_or_default(),
                )
    ...
    async fn read_scheduled_audit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_scheduled_audit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_package_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let client_token = input.get_optional_string("client_token")?;
            let version_update_by_jobs_config =
                input.get_optional_string("version_update_by_jobs_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    version_update_by_jobs_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a package_configuration resource
    async fn read_package_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_package_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_provisioning_template(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    pre_provisioning_hook.unwrap_or_default(),
                )
                .with_field("description", description.unwrap_or_default())
                ...
                .with_field(
                    ...
                    provisioning_role_arn.unwrap_or_default(),
                ))
        })
    }

    /// Read a provisioning_template resource
    async fn read_provisioning_template(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_provisioning_template(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_keys_and_certificate(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let set_as_active = input.get_optional_string("set_as_active")?;
    ...
    async fn read_keys_and_certificate(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_keys_and_certificate(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_authorizer(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let token_signing_public_keys =
                input.get_optional_string("token_signing_public_keys")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    authorizer_function_arn.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    token_signing_public_keys.unwrap_or_default(),
                )
                .with_field(
                    "enable_caching_for_http",
                    enable_caching_for_http.unwrap_or_default(),
                )
    ...
    async fn create_role_alias(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let tags = input.get_optional_string("tags")?;
            let credential_duration_seconds =
                input.get_optional_string("credential_duration_seconds")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    credential_duration_seconds.unwrap_or_default(),
                ))
        })
    }

    /// Read a role_alias resource
    async fn read_role_alias(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_role_alias(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let role_arn = input.get_string("role_arn")?;
            let role_alias = input.get_string("role_alias")?;
    ...
    async fn delete_role_alias(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_stream(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let description = input.get_optional_string("description")?;
    ...
    async fn read_stream(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_stream(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let description = input.get_optional_string("description")?;
            let stream_id = input.get_string("stream_id")?;
    ...
    async fn create_certificate_provider(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let account_default_for_operations =
                input.get_string("account_default_for_operations")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    account_default_for_operations.unwrap_or_default(),
                )
                .with_field(
                    "certificate_provider_name",
                    certificate_provider_name.unwrap_or_default(),
                )
                .with_field(
                    "lambda_function_arn",
                    lambda_function_arn.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default()))
        })
    }
    ...
    async fn read_certificate_provider(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_certificate_provider(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_ca_certificate(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let new_auto_registration_status =
                input.get_optional_string("new_auto_registration_status")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    remove_auto_registration.unwrap_or_default(),
                )
                .with_field("new_status", new_status.unwrap_or_default())
                .with_field(
                    "new_auto_registration_status",
                    new_auto_registration_status.unwrap_or_default(),
                )
                .with_field(
                    "registration_config",
                    registration_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a ca_certificate resource
    async fn read_ca_certificate(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_ca_certificate(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_security_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let additional_metrics_to_retain_v2 =
                input.get_optional_string("additional_metrics_to_retain_v2")?;
            ...
            let tags = input.get_optional_string("tags")?;
            let security_profile_description =
                input.get_optional_string("security_profile_description")?;
            let behaviors = input.get_optional_string("behaviors")?;
            let additional_metrics_to_retain =
                input.get_optional_string("additional_metrics_to_retain")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    additional_metrics_to_retain_v2.unwrap_or_default(),
                )
                .with_field(
                ...
                .with_field(
                    ...
                    security_profile_description.unwrap_or_default(),
                )
                .with_field("behaviors", behaviors.unwrap_or_default())
                .with_field(
                    "additional_metrics_to_retain",
                    additional_metrics_to_retain.unwrap_or_default(),
                )
                .with_field(
                    "metrics_export_config",
                    metrics_export_config.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_command_execution(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_command_execution(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_command_execution(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_buckets_aggregation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_buckets_aggregation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_buckets_aggregation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_dimension(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_dimension(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_dimension(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let client_request_token = input.get_string("client_request_token")?;
    ...
    async fn delete_dimension(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_billing_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    billing_group_properties.unwrap_or_default(),
                ))
        })
    }

    /// Read a billing_group resource
    async fn read_billing_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_billing_group(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let billing_group_name = input.get_string("billing_group_name")?;
    ...
    async fn delete_billing_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_v2_logging_level(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_v2_logging_level(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_v2_logging_level(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_statistics(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_statistics(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_statistics(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_statistics(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_thing_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    thing_type_properties.unwrap_or_default(),
                )
                .with_field("thing_type_name", thing_type_name.unwrap_or_default()))
        })
    }
    ...
    async fn read_thing_type(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_thing_type(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let thing_type_properties = input.get_optional_string("thing_type_properties")?;
    ...
    async fn delete_thing_type(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_account_audit_configuration(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let audit_notification_target_configurations =
                input.get_optional_string("audit_notification_target_configurations")?;
            let role_arn = input.get_optional_string("role_arn")?;
            let audit_check_configurations =
                input.get_optional_string("audit_check_configurations")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    audit_notification_target_configurations.unwrap_or_default(),
                )
                .with_field("role_arn", role_arn.unwrap_or_default())
                .with_field(
                    "audit_check_configurations",
                    audit_check_configurations.unwrap_or_default(),
                ))
        })
    }

    /// Read a account_audit_configuration resource
    async fn read_account_audit_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_account_audit_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_default_authorizer(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_default_authorizer(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_default_authorizer(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_topic_rule_destination(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_topic_rule_destination(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_topic_rule_destination(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_ota_update(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let files = input.get_string("files")?;
            let aws_job_executions_rollout_config =
                input.get_optional_string("aws_job_executions_rollout_config")?;
            let aws_job_presigned_url_config =
                input.get_optional_string("aws_job_presigned_url_config")?;
            let role_arn = input.get_string("role_arn")?;
            let targets = input.get_string("targets")?;
            let target_selection = input.get_optional_string("target_selection")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    aws_job_timeout_config.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                ...
                .with_field(
                    ...
                    aws_job_abort_config.unwrap_or_default(),
                )
                .with_field("protocols", protocols.unwrap_or_default())
                .with_field("files", files.unwrap_or_default())
                .with_field(
                    "aws_job_executions_rollout_config",
                    aws_job_executions_rollout_config.unwrap_or_default(),
                )
                .with_field(
                    "aws_job_presigned_url_config",
                    aws_job_presigned_url_config.unwrap_or_default(),
                )
                .with_field("role_arn", role_arn.unwrap_or_default())
                .with_field("targets", targets.unwrap_or_default())
                .with_field("target_selection", target_selection.unwrap_or_default())
                .with_field(
                    ...
                    additional_parameters.unwrap_or_default(),
                ))
        })
    }

    /// Read a ota_update resource
    async fn read_ota_update(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_ota_update(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let aws_job_timeout_config = input.get_optional_string("aws_job_timeout_config")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_ota_update(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_cardinality(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cardinality(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_cardinality(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_cardinality(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_audit_suppression(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    suppress_indefinitely.unwrap_or_default(),
                )
                .with_field("description", description.unwrap_or_default())
                .with_field(
                    "client_request_token",
    ...
    async fn read_audit_suppression(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_audit_suppression(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_job_template(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "maintenance_windows",
                    maintenance_windows.unwrap_or_default(),
                )
    ...
    async fn create_thing_groups_for_thing(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    thing_groups_to_remove.unwrap_or_default(),
                )
                .with_field(
                    "thing_groups_to_add",
                    thing_groups_to_add.unwrap_or_default(),
                )
                .with_field(
                    "override_dynamic_groups",
                    override_dynamic_groups.unwrap_or_default(),
                )
                .with_field("thing_name", thing_name.unwrap_or_default()))
        })
    }
    ...
    async fn read_thing_groups_for_thing(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_thing_groups_for_thing(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_percentiles(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_percentiles(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_percentiles(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_percentiles(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_thing_registration_task(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_thing_registration_task(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_thing_registration_task(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_topic_rule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_topic_rule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_topic_rule(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let rule_name = input.get_string("rule_name")?;
    ...
    async fn delete_topic_rule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    mandatory_parameters.unwrap_or_default(),
                )
                .with_field("role_arn", role_arn.unwrap_or_default()))
        })
    }
    ...
    async fn create_audit_finding(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_audit_finding(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_audit_finding(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_audit_finding(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn read_audit_mitigation_actions_task(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_audit_mitigation_actions_task(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_encryption_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "kms_access_role_arn",
                    kms_access_role_arn.unwrap_or_default(),
                )
    ...
    async fn read_encryption_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_encryption_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_job_document(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_job_document(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_job_document(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_job_document(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_event_configurations(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "event_configurations",
                event_configurations.unwrap_or_default(),
            ))
        })
    }

    /// Read a event_configurations resource
    async fn read_event_configurations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_event_configurations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_thing_connectivity_data(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_thing_connectivity_data(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_thing_connectivity_data(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_audit_task(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_audit_task(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn update_audit_task(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_audit_task(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn read_behavior_model_training_summaries(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_behavior_model_training_summaries(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
    ...
    async fn create_mitigation_action(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_mitigation_action(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_client
    ...
    async fn delete_mitigation_action(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_client
