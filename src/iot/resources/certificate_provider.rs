...
impl<'a> Certificate_provider<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, certificate_provider_name: String, account_default_for_operations: Vec<String>, client_token: Option<String>, lambda_function_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, certificate_provider_name: Option<String>, account_default_for_operations: Option<Vec<String>>, client_token: Option<String>, lambda_function_arn: Option<String>) -> Result<()> {
