...
impl<'a> Certificate_provider<'a> {
    ...
    pub async fn create(&self, certificate_provider_name: String, lambda_function_arn: String, account_default_for_operations: Vec<String>, client_token: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, certificate_provider_name: Option<String>, lambda_function_arn: Option<String>, account_default_for_operations: Option<Vec<String>>, client_token: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
