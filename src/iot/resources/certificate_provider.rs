...
impl<'a> Certificate_provider<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, account_default_for_operations: Vec<String>, certificate_provider_name: String, lambda_function_arn: String, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, account_default_for_operations: Option<Vec<String>>, certificate_provider_name: Option<String>, lambda_function_arn: Option<String>, client_token: Option<String>) -> Result<()> {
