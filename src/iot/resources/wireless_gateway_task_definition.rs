...
impl<'a> Wireless_gateway_task_definition<'a> {
    ...
    pub async fn create(&self, client_request_token: Option<String>, auto_create_tasks: bool, update: Option<String>, tags: Option<Vec<String>>, name: Option<String>) -> Result<String> {
