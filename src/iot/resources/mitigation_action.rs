...
impl<'a> Mitigation_action<'a> {
    ...
    pub async fn create(&self, action_params: String, tags: Option<Vec<String>>, role_arn: String, action_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, action_params: Option<String>, tags: Option<Vec<String>>, role_arn: Option<String>, action_name: Option<String>) -> Result<()> {
