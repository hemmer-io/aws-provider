...
impl<'a> Mitigation_action<'a> {
    ...
    pub async fn create(&self, action_name: String, role_arn: String, action_params: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, action_name: Option<String>, role_arn: Option<String>, action_params: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
