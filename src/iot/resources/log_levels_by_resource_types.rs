...
impl<'a> Log_levels_by_resource_types<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, wireless_device_log_options: Option<Vec<String>>, default_log_level: Option<String>, wireless_gateway_log_options: Option<Vec<String>>, fuota_task_log_options: Option<Vec<String>>) -> Result<()> {
