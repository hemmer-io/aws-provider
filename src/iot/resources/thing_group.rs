...
impl<'a> Thing_group<'a> {
    ...
    pub async fn create(&self, parent_group_name: Option<String>, thing_group_name: String, thing_group_properties: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, parent_group_name: Option<String>, thing_group_name: Option<String>, thing_group_properties: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
