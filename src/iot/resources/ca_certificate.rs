...
impl<'a> Ca_certificate<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, new_auto_registration_status: Option<String>, remove_auto_registration: Option<bool>, new_status: Option<String>, registration_config: Option<String>, certificate_id: Option<String>) -> Result<()> {
