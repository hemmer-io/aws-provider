...
impl<'a> Device_profile<'a> {
    ...
    pub async fn create(&self, name: Option<String>, lo_ra_wan: Option<String>, tags: Option<Vec<String>>, sidewalk: Option<String>, client_request_token: Option<String>) -> Result<String> {
