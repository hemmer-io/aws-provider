...
impl<'a> Network_analyzer_configuration<'a> {
    ...
    pub async fn create(&self, wireless_gateways: Option<Vec<String>>, trace_content: Option<String>, client_request_token: Option<String>, multicast_groups: Option<Vec<String>>, description: Option<String>, wireless_devices: Option<Vec<String>>, tags: Option<Vec<String>>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, wireless_gateways: Option<Vec<String>>, trace_content: Option<String>, client_request_token: Option<String>, multicast_groups: Option<Vec<String>>, description: Option<String>, wireless_devices: Option<Vec<String>>, tags: Option<Vec<String>>, name: Option<String>) -> Result<()> {
