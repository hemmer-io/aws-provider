...
impl<'a> Custom_metric<'a> {
    ...
    pub async fn create(&self, display_name: Option<String>, tags: Option<Vec<String>>, metric_type: String, metric_name: String, client_request_token: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, display_name: Option<String>, tags: Option<Vec<String>>, metric_type: Option<String>, metric_name: Option<String>, client_request_token: Option<String>) -> Result<()> {
