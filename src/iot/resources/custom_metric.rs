...
impl<'a> Custom_metric<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, display_name: Option<String>, metric_type: String, metric_name: String, client_request_token: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, display_name: Option<String>, metric_type: Option<String>, metric_name: Option<String>, client_request_token: Option<String>) -> Result<()> {
