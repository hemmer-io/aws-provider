...
impl<'a> Custom_metric<'a> {
    ...
    pub async fn create(&self, client_request_token: String, display_name: Option<String>, tags: Option<Vec<String>>, metric_type: String, metric_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_request_token: Option<String>, display_name: Option<String>, tags: Option<Vec<String>>, metric_type: Option<String>, metric_name: Option<String>) -> Result<()> {
