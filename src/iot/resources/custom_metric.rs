...
impl<'a> Custom_metric<'a> {
    ...
    pub async fn create(&self, metric_name: String, tags: Option<Vec<String>>, display_name: Option<String>, client_request_token: String, metric_type: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, metric_name: Option<String>, tags: Option<Vec<String>>, display_name: Option<String>, client_request_token: Option<String>, metric_type: Option<String>) -> Result<()> {
