...
impl<'a> Route53profilesService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "profile_resource_association" => {
                self.plan_profile_resource_association(current_state, desired_input)
                    .await
            }
            "profile_association" => {
                self.plan_profile_association(current_state, desired_input)
                    .await
            }
            "profile" => self.plan_profile(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route53profiles", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "profile_resource_association" => self.create_profile_resource_association(input).await,
            "profile_association" => self.create_profile_association(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "profile_resource_association" => self.read_profile_resource_association(id).await,
            "profile_association" => self.read_profile_association(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "profile_association" => self.update_profile_association(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "profile_resource_association" => self.delete_profile_resource_association(id).await,
            "profile_association" => self.delete_profile_association(id).await,
    ...
    async fn create_profile_resource_association(
        ...
        self.provider.runtime().block_on(async {
            ...
            let profile_resource_association_id =
                input.get_string("profile_resource_association_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "resource_properties",
                    resource_properties.unwrap_or_default(),
                )
                .with_field("name", name.unwrap_or_default())
                .with_field(
                    "profile_resource_association_id",
                    profile_resource_association_id.unwrap_or_default(),
                ))
        })
    }

    /// Read a profile_resource_association resource
    async fn read_profile_resource_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_profile_resource_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_profile_association(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_profile_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route53profiles_client
    ...
    async fn delete_profile_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route53profiles_client
