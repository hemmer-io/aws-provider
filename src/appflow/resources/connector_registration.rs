...
impl<'a> Connector_registration<'a> {
    ...
    pub async fn update(&self, id: &str, client_token: Option<String>, description: Option<String>, connector_provisioning_config: Option<String>, connector_label: Option<String>) -> Result<()> {
