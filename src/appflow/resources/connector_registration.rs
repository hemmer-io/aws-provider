...
impl<'a> Connector_registration<'a> {
    ...
    pub async fn update(&self, id: &str, description: Option<String>, client_token: Option<String>, connector_label: Option<String>, connector_provisioning_config: Option<String>) -> Result<()> {
