...
impl<'a> AppflowService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "flow_execution_records" => {
                self.plan_flow_execution_records(current_state, desired_input)
                    .await
            }
            "connector" => self.plan_connector(current_state, desired_input).await,
            "connectors" => self.plan_connectors(current_state, desired_input).await,
            "flow" => self.plan_flow(current_state, desired_input).await,
            "connector_profile" => {
                self.plan_connector_profile(current_state, desired_input)
                    .await
            }
            "connector_entity" => {
                self.plan_connector_entity(current_state, desired_input)
                    .await
            }
            "connector_profiles" => {
                self.plan_connector_profiles(current_state, desired_input)
                    .await
            }
            "connector_registration" => {
                self.plan_connector_registration(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "appflow", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "flow_execution_records" => self.create_flow_execution_records(input).await,
            "connector" => self.create_connector(input).await,
            "connectors" => self.create_connectors(input).await,
            "flow" => self.create_flow(input).await,
            "connector_profile" => self.create_connector_profile(input).await,
            "connector_entity" => self.create_connector_entity(input).await,
            "connector_profiles" => self.create_connector_profiles(input).await,
            "connector_registration" => self.create_connector_registration(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "appflow", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "flow_execution_records" => self.read_flow_execution_records(id).await,
            "connector" => self.read_connector(id).await,
            "connectors" => self.read_connectors(id).await,
            "flow" => self.read_flow(id).await,
            "connector_profile" => self.read_connector_profile(id).await,
            "connector_entity" => self.read_connector_entity(id).await,
            "connector_profiles" => self.read_connector_profiles(id).await,
            "connector_registration" => self.read_connector_registration(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "appflow", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "flow_execution_records" => self.update_flow_execution_records(id, input).await,
            "connector" => self.update_connector(id, input).await,
            "connectors" => self.update_connectors(id, input).await,
            "flow" => self.update_flow(id, input).await,
            "connector_profile" => self.update_connector_profile(id, input).await,
            "connector_entity" => self.update_connector_entity(id, input).await,
            "connector_profiles" => self.update_connector_profiles(id, input).await,
            "connector_registration" => self.update_connector_registration(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "appflow", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "flow_execution_records" => self.delete_flow_execution_records(id).await,
            "connector" => self.delete_connector(id).await,
            "connectors" => self.delete_connectors(id).await,
            "flow" => self.delete_flow(id).await,
            "connector_profile" => self.delete_connector_profile(id).await,
            "connector_entity" => self.delete_connector_entity(id).await,
            "connector_profiles" => self.delete_connector_profiles(id).await,
            "connector_registration" => self.delete_connector_registration(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "appflow", resource_name
            ))),
    ...
    async fn create_flow_execution_records(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_flow_execution_records(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_flow_execution_records(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_connectors(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_connectors(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appflow_client
    ...
    async fn update_connectors(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_connectors(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appflow_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    destination_flow_config_list.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field("source_flow_config", source_flow_config.unwrap_or_default())
                .with_field(
                    "metadata_catalog_config",
                    metadata_catalog_config.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_connector_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let kms_arn = input.get_optional_string("kms_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    connector_profile_name.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    connector_profile_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a connector_profile resource
    async fn read_connector_profile(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appflow_client
    ...
    async fn delete_connector_profile(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appflow_client
    ...
    async fn create_connector_entity(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_connector_entity(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appflow_client
    ...
    async fn delete_connector_entity(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appflow_client
    ...
    async fn create_connector_profiles(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_connector_profiles(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appflow_client
    ...
    async fn delete_connector_profiles(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appflow_client
    ...
    async fn create_connector_registration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let description = input.get_optional_string("description")?;
            ...
            let client_token = input.get_optional_string("client_token")?;
            let connector_provisioning_config =
                input.get_optional_string("connector_provisioning_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    connector_provisioning_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a connector_registration resource
    async fn read_connector_registration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appflow_client
    ...
    async fn delete_connector_registration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appflow_client
