...
impl<'a> Logging_configuration<'a> {
    ...
    pub async fn create(&self, name: Option<String>, destination_configuration: String, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, destination_configuration: Option<String>, tags: Option<HashMap<String, String>>) -> Result<()> {
