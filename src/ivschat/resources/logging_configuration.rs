...
impl<'a> Logging_configuration<'a> {
    ...
    pub async fn create(&self, destination_configuration: String, name: Option<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, destination_configuration: Option<String>, name: Option<String>, tags: Option<HashMap<String, String>>) -> Result<()> {
