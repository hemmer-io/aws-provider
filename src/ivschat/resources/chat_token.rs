...
impl<'a> Chat_token<'a> {
    ...
    pub async fn create(&self, capabilities: Option<Vec<String>>, attributes: Option<HashMap<String, String>>, user_id: String, session_duration_in_minutes: Option<i64>, room_identifier: String) -> Result<String> {
