...
impl<'a> IvschatService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "chat_token" => self.plan_chat_token(current_state, desired_input).await,
            "room" => self.plan_room(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ivschat", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "chat_token" => self.create_chat_token(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "chat_token" => self.read_chat_token(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "chat_token" => self.update_chat_token(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "chat_token" => self.delete_chat_token(id).await,
    ...
    async fn create_chat_token(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_chat_token(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ivschat_client
    ...
    async fn update_chat_token(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let capabilities = input.get_optional_string("capabilities")?;
            let attributes = input.get_optional_string("attributes")?;
    ...
    async fn delete_chat_token(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ivschat_client
    ...
    async fn create_room(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let logging_configuration_identifiers =
                input.get_optional_string("logging_configuration_identifiers")?;
            let maximum_message_rate_per_second =
                input.get_optional_string("maximum_message_rate_per_second")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    message_review_handler.unwrap_or_default(),
                )
                .with_field(
                    "logging_configuration_identifiers",
                    logging_configuration_identifiers.unwrap_or_default(),
                )
                .with_field(
                    "maximum_message_rate_per_second",
                    maximum_message_rate_per_second.unwrap_or_default(),
                )
                .with_field(
                    "maximum_message_length",
                    maximum_message_length.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("name", name.unwrap_or_default()))
        })
