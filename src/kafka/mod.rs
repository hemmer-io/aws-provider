...
impl<'a> KafkaService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "cluster_v2" => {
                self.plan_cluster_v2(current_state, desired_input).await
            }
            "connectivity" => {
                self.plan_connectivity(current_state, desired_input).await
            }
            ...
            "bootstrap_brokers" => {
                self.plan_bootstrap_brokers(current_state, desired_input).await
            }
            "broker_storage" => {
                self.plan_broker_storage(current_state, desired_input).await
            }
            "security" => {
                self.plan_security(current_state, desired_input).await
            }
            "monitoring" => {
                self.plan_monitoring(current_state, desired_input).await
            }
            "cluster_operation_v2" => {
                self.plan_cluster_operation_v2(current_state, desired_input).await
            }
            "cluster_kafka_version" => {
                self.plan_cluster_kafka_version(current_state, desired_input).await
            }
            "broker_count" => {
                self.plan_broker_count(current_state, desired_input).await
            }
            "compatible_kafka_versions" => {
                self.plan_compatible_kafka_versions(current_state, desired_input).await
            }
            "cluster_policy" => {
                self.plan_cluster_policy(current_state, desired_input).await
            }
            "replicator" => {
                self.plan_replicator(current_state, desired_input).await
            }
            "cluster_operation" => {
                self.plan_cluster_operation(current_state, desired_input).await
            }
            "configuration" => {
            ...
            "broker_type" => {
                self.plan_broker_type(current_state, desired_input).await
            }
            "cluster_configuration" => {
                self.plan_cluster_configuration(current_state, desired_input).await
            }
            "replication_info" => {
                self.plan_replication_info(current_state, desired_input).await
            }
            "storage" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "cluster_v2" => {
                self.create_cluster_v2(input).await
            }
            "connectivity" => {
                self.create_connectivity(input).await
            }
            "configuration_revision" => {
            ...
            "bootstrap_brokers" => {
                self.create_bootstrap_brokers(input).await
            }
            "broker_storage" => {
                self.create_broker_storage(input).await
            }
            "security" => {
                self.create_security(input).await
            }
            "monitoring" => {
                self.create_monitoring(input).await
            }
            "cluster_operation_v2" => {
                self.create_cluster_operation_v2(input).await
            }
            "cluster_kafka_version" => {
                self.create_cluster_kafka_version(input).await
            }
            "broker_count" => {
                self.create_broker_count(input).await
            }
            "compatible_kafka_versions" => {
                self.create_compatible_kafka_versions(input).await
            }
            "cluster_policy" => {
                self.create_cluster_policy(input).await
            }
            "replicator" => {
                self.create_replicator(input).await
            }
            "cluster_operation" => {
                self.create_cluster_operation(input).await
            }
            "configuration" => {
            ...
            "broker_type" => {
                self.create_broker_type(input).await
            }
            "cluster_configuration" => {
                self.create_cluster_configuration(input).await
            }
            "replication_info" => {
                self.create_replication_info(input).await
            }
            "storage" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "cluster_v2" => {
                self.read_cluster_v2(id).await
            }
            "connectivity" => {
                self.read_connectivity(id).await
            }
            "configuration_revision" => {
            ...
            "bootstrap_brokers" => {
                self.read_bootstrap_brokers(id).await
            }
            "broker_storage" => {
                self.read_broker_storage(id).await
            }
            "security" => {
                self.read_security(id).await
            }
            "monitoring" => {
                self.read_monitoring(id).await
            }
            "cluster_operation_v2" => {
                self.read_cluster_operation_v2(id).await
            }
            "cluster_kafka_version" => {
                self.read_cluster_kafka_version(id).await
            }
            "broker_count" => {
                self.read_broker_count(id).await
            }
            "compatible_kafka_versions" => {
                self.read_compatible_kafka_versions(id).await
            }
            "cluster_policy" => {
                self.read_cluster_policy(id).await
            }
            "replicator" => {
                self.read_replicator(id).await
            }
            "cluster_operation" => {
                self.read_cluster_operation(id).await
            }
            "configuration" => {
            ...
            "broker_type" => {
                self.read_broker_type(id).await
            }
            "cluster_configuration" => {
                self.read_cluster_configuration(id).await
            }
            "replication_info" => {
                self.read_replication_info(id).await
            }
            "storage" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "cluster_v2" => {
                self.update_cluster_v2(id, input).await
            }
            "connectivity" => {
                self.update_connectivity(id, input).await
            }
            "configuration_revision" => {
            ...
            "bootstrap_brokers" => {
                self.update_bootstrap_brokers(id, input).await
            }
            "broker_storage" => {
                self.update_broker_storage(id, input).await
            }
            "security" => {
                self.update_security(id, input).await
            }
            "monitoring" => {
                self.update_monitoring(id, input).await
            }
            "cluster_operation_v2" => {
                self.update_cluster_operation_v2(id, input).await
            }
            "cluster_kafka_version" => {
                self.update_cluster_kafka_version(id, input).await
            }
            "broker_count" => {
                self.update_broker_count(id, input).await
            }
            "compatible_kafka_versions" => {
                self.update_compatible_kafka_versions(id, input).await
            }
            "cluster_policy" => {
                self.update_cluster_policy(id, input).await
            }
            "replicator" => {
                self.update_replicator(id, input).await
            }
            "cluster_operation" => {
                self.update_cluster_operation(id, input).await
            }
            "configuration" => {
            ...
            "broker_type" => {
                self.update_broker_type(id, input).await
            }
            "cluster_configuration" => {
                self.update_cluster_configuration(id, input).await
            }
            "replication_info" => {
                self.update_replication_info(id, input).await
            }
            "storage" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "cluster_v2" => {
                self.delete_cluster_v2(id).await
            }
            "connectivity" => {
                self.delete_connectivity(id).await
            }
            "configuration_revision" => {
            ...
            "bootstrap_brokers" => {
                self.delete_bootstrap_brokers(id).await
            }
            "broker_storage" => {
                self.delete_broker_storage(id).await
            }
            "security" => {
                self.delete_security(id).await
            }
            "monitoring" => {
                self.delete_monitoring(id).await
            }
            "cluster_operation_v2" => {
                self.delete_cluster_operation_v2(id).await
            }
            "cluster_kafka_version" => {
                self.delete_cluster_kafka_version(id).await
            }
            "broker_count" => {
                self.delete_broker_count(id).await
            }
            "compatible_kafka_versions" => {
                self.delete_compatible_kafka_versions(id).await
            }
            "cluster_policy" => {
                self.delete_cluster_policy(id).await
            }
            "replicator" => {
                self.delete_replicator(id).await
            }
            "cluster_operation" => {
                self.delete_cluster_operation(id).await
            }
            "configuration" => {
            ...
            "broker_type" => {
                self.delete_broker_type(id).await
            }
            "cluster_configuration" => {
                self.delete_cluster_configuration(id).await
            }
            "replication_info" => {
                self.delete_replication_info(id).await
            }
            "storage" => {
    ...
    async fn create_cluster(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("number_of_broker_nodes", number_of_broker_nodes.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("storage_mode", storage_mode.unwrap_or_default())
                .with_field("configuration_info", configuration_info.unwrap_or_default())
                .with_field("broker_node_group_info", broker_node_group_info.unwrap_or_default())
                .with_field("enhanced_monitoring", enhanced_monitoring.unwrap_or_default())
                .with_field("client_authentication", client_authentication.unwrap_or_default())
                .with_field("cluster_name", cluster_name.unwrap_or_default())
    ...
    async fn create_bootstrap_brokers(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_bootstrap_brokers(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_bootstrap_brokers(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_broker_storage(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            let current_version = input.get_string("current_version")?;
            let cluster_arn = input.get_string("cluster_arn")?;
            let target_broker_ebs_volume_info = input.get_string("target_broker_ebs_volume_info")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("current_version", current_version.unwrap_or_default())
                .with_field("cluster_arn", cluster_arn.unwrap_or_default())
                .with_field("target_broker_ebs_volume_info", target_broker_ebs_volume_info.unwrap_or_default())
            )
        })
    }

    /// Read a broker_storage resource
    async fn read_broker_storage(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_broker_storage(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster_operation_v2(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_cluster_operation_v2(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_operation_v2(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster_kafka_version(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("configuration_info", configuration_info.unwrap_or_default())
                .with_field("current_version", current_version.unwrap_or_default())
                .with_field("target_kafka_version", target_kafka_version.unwrap_or_default())
                .with_field("cluster_arn", cluster_arn.unwrap_or_default())
            )
        })
    }
    ...
    async fn read_cluster_kafka_version(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_kafka_version(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_broker_count(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let current_version = input.get_string("current_version")?;
            let target_number_of_broker_nodes = input.get_string("target_number_of_broker_nodes")?;
            let cluster_arn = input.get_string("cluster_arn")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("current_version", current_version.unwrap_or_default())
                .with_field("target_number_of_broker_nodes", target_number_of_broker_nodes.unwrap_or_default())
                .with_field("cluster_arn", cluster_arn.unwrap_or_default())
            )
        })
    }
    ...
    async fn read_compatible_kafka_versions(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_compatible_kafka_versions(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster_policy(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_cluster_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_replicator(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("tags", tags.unwrap_or_default())
                .with_field("replication_info_list", replication_info_list.unwrap_or_default())
    ...
    async fn create_cluster_operation(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_cluster_operation(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_operation(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_broker_type(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("current_version", current_version.unwrap_or_default())
                .with_field("cluster_arn", cluster_arn.unwrap_or_default())
                .with_field("target_instance_type", target_instance_type.unwrap_or_default())
            )
        })
    }

    /// Read a broker_type resource
    async fn read_broker_type(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster_configuration(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_cluster_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_replication_info(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            let consumer_group_replication = input.get_optional_string("consumer_group_replication")?;
            let current_version = input.get_string("current_version")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("source_kafka_cluster_arn", source_kafka_cluster_arn.unwrap_or_default())
                .with_field("target_kafka_cluster_arn", target_kafka_cluster_arn.unwrap_or_default())
                ...
                .with_field("consumer_group_replication", consumer_group_replication.unwrap_or_default())
                .with_field("current_version", current_version.unwrap_or_default())
            )
        })
    }
    ...
    async fn read_replication_info(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_replication_info(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
