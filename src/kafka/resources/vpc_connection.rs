...
impl<'a> Vpc_connection<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, authentication: String, target_cluster_arn: String, vpc_id: String, client_subnets: Vec<String>, security_groups: Vec<String>) -> Result<String> {
