...
impl<'a> Vpc_connection<'a> {
    ...
    pub async fn create(&self, authentication: String, target_cluster_arn: String, client_subnets: Vec<String>, vpc_id: String, security_groups: Vec<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
