...
impl<'a> Cluster_kafka_version<'a> {
    ...
    pub async fn update(&self, id: &str, current_version: Option<String>, configuration_info: Option<String>, target_kafka_version: Option<String>, cluster_arn: Option<String>) -> Result<()> {
