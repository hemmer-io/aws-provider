...
impl<'a> Replicator<'a> {
    ...
    pub async fn create(&self, replication_info_list: Vec<String>, service_execution_role_arn: String, description: Option<String>, kafka_clusters: Vec<String>, replicator_name: String, tags: Option<HashMap<String, String>>) -> Result<String> {
