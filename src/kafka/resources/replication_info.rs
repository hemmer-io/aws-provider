...
impl<'a> Replication_info<'a> {
    ...
    pub async fn update(&self, id: &str, source_kafka_cluster_arn: Option<String>, topic_replication: Option<String>, current_version: Option<String>, target_kafka_cluster_arn: Option<String>, replicator_arn: Option<String>, consumer_group_replication: Option<String>) -> Result<()> {
