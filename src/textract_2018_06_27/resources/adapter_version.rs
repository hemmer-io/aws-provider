...
impl<'a> Adapter_version<'a> {
    ...
    pub async fn create(&self, dataset_config: String, kms_key_id: Option<String>, tags: Option<HashMap<String, String>>, client_request_token: Option<String>, output_config: String, adapter_id: String) -> Result<String> {
