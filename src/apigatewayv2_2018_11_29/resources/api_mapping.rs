...
impl<'a> Api_mapping<'a> {
    ...
    pub async fn create(&self, domain_name: String, stage: String, api_id: String, api_mapping_key: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, domain_name: Option<String>, stage: Option<String>, api_id: Option<String>, api_mapping_key: Option<String>) -> Result<()> {
