...
impl<'a> Routing_rule<'a> {
    ...
    pub async fn create(&self, conditions: Vec<String>, domain_name: String, domain_name_id: Option<String>, priority: i64, routing_rule_id: String, actions: Vec<String>) -> Result<String> {
