...
impl<'a> Conformance_pack<'a> {
    ...
    pub async fn create(&self, delivery_s3_key_prefix: Option<String>, delivery_s3_bucket: Option<String>, conformance_pack_name: String, template_body: Option<String>, conformance_pack_input_parameters: Option<Vec<String>>, template_ssmdocument_details: Option<String>, template_s3_uri: Option<String>) -> Result<String> {
