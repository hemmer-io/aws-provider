...
impl<'a> Configuration_aggregator<'a> {
    ...
    pub async fn create(&self, aggregator_filters: Option<String>, tags: Option<Vec<String>>, configuration_aggregator_name: String, organization_aggregation_source: Option<String>, account_aggregation_sources: Option<Vec<String>>) -> Result<String> {
