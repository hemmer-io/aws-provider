...
impl<'a> Access_point<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, client_token: String, file_system_id: String, posix_user: Option<String>, root_directory: Option<String>) -> Result<String> {
