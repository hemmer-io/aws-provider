...
impl<'a> Cost_optimization_hubService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "preferences" => self.plan_preferences(current_state, desired_input).await,
            "enrollment_status" => {
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "cost_optimization_hub", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "preferences" => self.create_preferences(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "preferences" => self.read_preferences(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "preferences" => self.update_preferences(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "preferences" => self.delete_preferences(id).await,
    ...
    async fn create_preferences(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let member_account_discount_visibility =
                input.get_optional_string("member_account_discount_visibility")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    preferred_commitment.unwrap_or_default(),
                )
                .with_field(
                ...
                .with_field(
                    ...
                    member_account_discount_visibility.unwrap_or_default(),
                ))
        })
    }

    /// Read a preferences resource
    async fn read_preferences(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_preferences(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let preferred_commitment = input.get_optional_string("preferred_commitment")?;
            let savings_estimation_mode = input.get_optional_string("savings_estimation_mode")?;
    ...
    async fn delete_preferences(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
