...
impl<'a> Sip_media_application<'a> {
    ...
    pub async fn create(&self, endpoints: Vec<String>, tags: Option<Vec<String>>, name: String, aws_region: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, endpoints: Option<Vec<String>>, tags: Option<Vec<String>>, name: Option<String>, aws_region: Option<String>) -> Result<()> {
