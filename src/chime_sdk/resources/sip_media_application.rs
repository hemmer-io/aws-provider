...
impl<'a> Sip_media_application<'a> {
    ...
    pub async fn create(&self, name: String, endpoints: Vec<String>, tags: Option<Vec<String>>, aws_region: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, endpoints: Option<Vec<String>>, tags: Option<Vec<String>>, aws_region: Option<String>) -> Result<()> {
