...
impl<'a> Sip_media_application<'a> {
    ...
    pub async fn create(&self, aws_region: String, name: String, endpoints: Vec<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, aws_region: Option<String>, name: Option<String>, endpoints: Option<Vec<String>>, tags: Option<Vec<String>>) -> Result<()> {
