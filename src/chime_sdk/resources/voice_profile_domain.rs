...
impl<'a> Voice_profile_domain<'a> {
    ...
    pub async fn create(&self, server_side_encryption_configuration: String, name: String, client_request_token: Option<String>, tags: Option<Vec<String>>, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, server_side_encryption_configuration: Option<String>, name: Option<String>, client_request_token: Option<String>, tags: Option<Vec<String>>, description: Option<String>) -> Result<()> {
