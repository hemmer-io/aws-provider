...
impl<'a> Voice_profile_domain<'a> {
    ...
    pub async fn create(&self, name: String, description: Option<String>, client_request_token: Option<String>, server_side_encryption_configuration: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, description: Option<String>, client_request_token: Option<String>, server_side_encryption_configuration: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
