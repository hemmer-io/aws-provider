...
impl<'a> Voice_connector<'a> {
    ...
    pub async fn create(&self, name: String, integration_type: Option<String>, aws_region: Option<String>, network_type: Option<String>, require_encryption: bool, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, integration_type: Option<String>, aws_region: Option<String>, network_type: Option<String>, require_encryption: Option<bool>, tags: Option<Vec<String>>) -> Result<()> {
