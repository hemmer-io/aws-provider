...
impl<'a> Sip_media_application_call<'a> {
    ...
    pub async fn create(&self, from_phone_number: String, sip_media_application_id: String, sip_headers: Option<HashMap<String, String>>, to_phone_number: String, arguments_map: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, from_phone_number: Option<String>, sip_media_application_id: Option<String>, sip_headers: Option<HashMap<String, String>>, to_phone_number: Option<String>, arguments_map: Option<HashMap<String, String>>) -> Result<()> {
