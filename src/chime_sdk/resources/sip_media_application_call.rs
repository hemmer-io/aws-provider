...
impl<'a> Sip_media_application_call<'a> {
    ...
    pub async fn create(&self, arguments_map: Option<HashMap<String, String>>, sip_media_application_id: String, from_phone_number: String, sip_headers: Option<HashMap<String, String>>, to_phone_number: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, arguments_map: Option<HashMap<String, String>>, sip_media_application_id: Option<String>, from_phone_number: Option<String>, sip_headers: Option<HashMap<String, String>>, to_phone_number: Option<String>) -> Result<()> {
