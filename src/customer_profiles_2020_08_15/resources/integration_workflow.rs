...
impl<'a> Integration_workflow<'a> {
    ...
    pub async fn create(&self, workflow_type: String, object_type_name: String, domain_name: String, tags: Option<HashMap<String, String>>, role_arn: String, integration_config: String) -> Result<String> {
