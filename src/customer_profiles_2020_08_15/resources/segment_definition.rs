...
impl<'a> Segment_definition<'a> {
    ...
    pub async fn create(&self, display_name: String, tags: Option<HashMap<String, String>>, segment_definition_name: String, segment_groups: String, domain_name: String, description: Option<String>) -> Result<String> {
