...
impl<'a> Segment_snapshot<'a> {
    ...
    pub async fn create(&self, domain_name: String, segment_definition_name: String, encryption_key: Option<String>, role_arn: Option<String>, destination_uri: Option<String>, data_format: String) -> Result<String> {
