...
impl<'a> Storage_configuration<'a> {
    ...
    pub async fn create(&self, retention_period: Option<String>, warm_tier_retention_period: Option<String>, disallow_ingest_null_na_n: Option<bool>, disassociated_data_storage: Option<String>, warm_tier: Option<String>, storage_type: String, multi_layer_storage: Option<String>) -> Result<String> {
