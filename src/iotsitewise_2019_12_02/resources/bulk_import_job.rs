...
impl<'a> Bulk_import_job<'a> {
    ...
    pub async fn create(&self, delete_files_after_import: Option<bool>, job_configuration: String, job_name: String, files: Vec<String>, error_report_location: String, adaptive_ingestion: Option<bool>, job_role_arn: String) -> Result<String> {
