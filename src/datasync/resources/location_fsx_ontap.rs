...
impl<'a> Location_fsx_ontap<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, protocol: String, security_group_arns: Vec<String>, subdirectory: Option<String>, storage_virtual_machine_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, protocol: Option<String>, security_group_arns: Option<Vec<String>>, subdirectory: Option<String>, storage_virtual_machine_arn: Option<String>) -> Result<()> {
