...
impl<'a> Location_fsx_ontap<'a> {
    ...
    pub async fn create(&self, storage_virtual_machine_arn: String, protocol: String, subdirectory: Option<String>, tags: Option<Vec<String>>, security_group_arns: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, storage_virtual_machine_arn: Option<String>, protocol: Option<String>, subdirectory: Option<String>, tags: Option<Vec<String>>, security_group_arns: Option<Vec<String>>) -> Result<()> {
