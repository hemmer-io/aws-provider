...
impl<'a> Location_fsx_ontap<'a> {
    ...
    pub async fn create(&self, subdirectory: Option<String>, security_group_arns: Vec<String>, protocol: String, tags: Option<Vec<String>>, storage_virtual_machine_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, subdirectory: Option<String>, security_group_arns: Option<Vec<String>>, protocol: Option<String>, tags: Option<Vec<String>>, storage_virtual_machine_arn: Option<String>) -> Result<()> {
