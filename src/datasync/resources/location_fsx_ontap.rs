...
impl<'a> Location_fsx_ontap<'a> {
    ...
    pub async fn create(&self, protocol: String, storage_virtual_machine_arn: String, tags: Option<Vec<String>>, security_group_arns: Vec<String>, subdirectory: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, protocol: Option<String>, storage_virtual_machine_arn: Option<String>, tags: Option<Vec<String>>, security_group_arns: Option<Vec<String>>, subdirectory: Option<String>) -> Result<()> {
