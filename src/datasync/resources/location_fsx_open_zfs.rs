...
impl<'a> Location_fsx_open_zfs<'a> {
    ...
    pub async fn create(&self, security_group_arns: Vec<String>, protocol: String, subdirectory: Option<String>, tags: Option<Vec<String>>, fsx_filesystem_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, security_group_arns: Option<Vec<String>>, protocol: Option<String>, subdirectory: Option<String>, tags: Option<Vec<String>>, fsx_filesystem_arn: Option<String>) -> Result<()> {
