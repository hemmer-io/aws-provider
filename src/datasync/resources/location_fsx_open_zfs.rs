...
impl<'a> Location_fsx_open_zfs<'a> {
    ...
    pub async fn create(&self, security_group_arns: Vec<String>, tags: Option<Vec<String>>, subdirectory: Option<String>, fsx_filesystem_arn: String, protocol: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, security_group_arns: Option<Vec<String>>, tags: Option<Vec<String>>, subdirectory: Option<String>, fsx_filesystem_arn: Option<String>, protocol: Option<String>) -> Result<()> {
