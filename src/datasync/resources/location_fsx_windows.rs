...
impl<'a> Location_fsx_windows<'a> {
    ...
    pub async fn create(&self, password: String, security_group_arns: Vec<String>, fsx_filesystem_arn: String, subdirectory: Option<String>, user: String, domain: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, password: Option<String>, security_group_arns: Option<Vec<String>>, fsx_filesystem_arn: Option<String>, subdirectory: Option<String>, user: Option<String>, domain: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
