...
impl<'a> Location_fsx_lustre<'a> {
    ...
    pub async fn create(&self, fsx_filesystem_arn: String, subdirectory: Option<String>, security_group_arns: Vec<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, fsx_filesystem_arn: Option<String>, subdirectory: Option<String>, security_group_arns: Option<Vec<String>>, tags: Option<Vec<String>>) -> Result<()> {
