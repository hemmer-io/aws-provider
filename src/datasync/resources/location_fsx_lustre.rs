...
impl<'a> Location_fsx_lustre<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, fsx_filesystem_arn: String, subdirectory: Option<String>, security_group_arns: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, fsx_filesystem_arn: Option<String>, subdirectory: Option<String>, security_group_arns: Option<Vec<String>>) -> Result<()> {
