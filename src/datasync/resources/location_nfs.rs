...
impl<'a> Location_nfs<'a> {
    ...
    pub async fn create(&self, server_hostname: String, subdirectory: String, on_prem_config: String, mount_options: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, server_hostname: Option<String>, subdirectory: Option<String>, on_prem_config: Option<String>, mount_options: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
