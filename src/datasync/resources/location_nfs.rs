...
impl<'a> Location_nfs<'a> {
    ...
    pub async fn create(&self, on_prem_config: String, tags: Option<Vec<String>>, server_hostname: String, mount_options: Option<String>, subdirectory: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, on_prem_config: Option<String>, tags: Option<Vec<String>>, server_hostname: Option<String>, mount_options: Option<String>, subdirectory: Option<String>) -> Result<()> {
