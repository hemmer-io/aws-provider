...
impl<'a> Location_nfs<'a> {
    ...
    pub async fn create(&self, subdirectory: String, server_hostname: String, on_prem_config: String, tags: Option<Vec<String>>, mount_options: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, subdirectory: Option<String>, server_hostname: Option<String>, on_prem_config: Option<String>, tags: Option<Vec<String>>, mount_options: Option<String>) -> Result<()> {
