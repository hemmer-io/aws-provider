...
impl<'a> DatasyncService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "location_fsx_ontap" => {
                self.plan_location_fsx_ontap(current_state, desired_input)
                    .await
            }
            "location_fsx_open_zfs" => {
                self.plan_location_fsx_open_zfs(current_state, desired_input)
                    .await
            }
            "task" => self.plan_task(current_state, desired_input).await,
            "location_efs" => self.plan_location_efs(current_state, desired_input).await,
            "location_azure_blob" => {
                self.plan_location_azure_blob(current_state, desired_input)
                    .await
            }
            "location_nfs" => self.plan_location_nfs(current_state, desired_input).await,
            "location_s3" => self.plan_location_s3(current_state, desired_input).await,
            "location_smb" => self.plan_location_smb(current_state, desired_input).await,
            "location" => self.plan_location(current_state, desired_input).await,
            "location_object_storage" => {
                self.plan_location_object_storage(current_state, desired_input)
                    .await
            }
            "location_fsx_windows" => {
                self.plan_location_fsx_windows(current_state, desired_input)
                    .await
            }
            "location_hdfs" => self.plan_location_hdfs(current_state, desired_input).await,
            "task_execution" => self.plan_task_execution(current_state, desired_input).await,
            "location_fsx_lustre" => {
                self.plan_location_fsx_lustre(current_state, desired_input)
                    .await
            }
            "agent" => self.plan_agent(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "datasync", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "location_fsx_ontap" => self.create_location_fsx_ontap(input).await,
            "location_fsx_open_zfs" => self.create_location_fsx_open_zfs(input).await,
            "task" => self.create_task(input).await,
            "location_efs" => self.create_location_efs(input).await,
            "location_azure_blob" => self.create_location_azure_blob(input).await,
            "location_nfs" => self.create_location_nfs(input).await,
            "location_s3" => self.create_location_s3(input).await,
            "location_smb" => self.create_location_smb(input).await,
            "location" => self.create_location(input).await,
            "location_object_storage" => self.create_location_object_storage(input).await,
            "location_fsx_windows" => self.create_location_fsx_windows(input).await,
            "location_hdfs" => self.create_location_hdfs(input).await,
            "task_execution" => self.create_task_execution(input).await,
            "location_fsx_lustre" => self.create_location_fsx_lustre(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "location_fsx_ontap" => self.read_location_fsx_ontap(id).await,
            "location_fsx_open_zfs" => self.read_location_fsx_open_zfs(id).await,
            "task" => self.read_task(id).await,
            "location_efs" => self.read_location_efs(id).await,
            "location_azure_blob" => self.read_location_azure_blob(id).await,
            "location_nfs" => self.read_location_nfs(id).await,
            "location_s3" => self.read_location_s3(id).await,
            "location_smb" => self.read_location_smb(id).await,
            "location" => self.read_location(id).await,
            "location_object_storage" => self.read_location_object_storage(id).await,
            "location_fsx_windows" => self.read_location_fsx_windows(id).await,
            "location_hdfs" => self.read_location_hdfs(id).await,
            "task_execution" => self.read_task_execution(id).await,
            "location_fsx_lustre" => self.read_location_fsx_lustre(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "location_fsx_ontap" => self.update_location_fsx_ontap(id, input).await,
            "location_fsx_open_zfs" => self.update_location_fsx_open_zfs(id, input).await,
            "task" => self.update_task(id, input).await,
            "location_efs" => self.update_location_efs(id, input).await,
            "location_azure_blob" => self.update_location_azure_blob(id, input).await,
            "location_nfs" => self.update_location_nfs(id, input).await,
            "location_s3" => self.update_location_s3(id, input).await,
            "location_smb" => self.update_location_smb(id, input).await,
            "location" => self.update_location(id, input).await,
            "location_object_storage" => self.update_location_object_storage(id, input).await,
            "location_fsx_windows" => self.update_location_fsx_windows(id, input).await,
            "location_hdfs" => self.update_location_hdfs(id, input).await,
            "task_execution" => self.update_task_execution(id, input).await,
            "location_fsx_lustre" => self.update_location_fsx_lustre(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "location_fsx_ontap" => self.delete_location_fsx_ontap(id).await,
            "location_fsx_open_zfs" => self.delete_location_fsx_open_zfs(id).await,
            "task" => self.delete_task(id).await,
            "location_efs" => self.delete_location_efs(id).await,
            "location_azure_blob" => self.delete_location_azure_blob(id).await,
            "location_nfs" => self.delete_location_nfs(id).await,
            "location_s3" => self.delete_location_s3(id).await,
            "location_smb" => self.delete_location_smb(id).await,
            "location" => self.delete_location(id).await,
            "location_object_storage" => self.delete_location_object_storage(id).await,
            "location_fsx_windows" => self.delete_location_fsx_windows(id).await,
            "location_hdfs" => self.delete_location_hdfs(id).await,
            "task_execution" => self.delete_task_execution(id).await,
            "location_fsx_lustre" => self.delete_location_fsx_lustre(id).await,
    ...
    async fn create_location_fsx_ontap(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    storage_virtual_machine_arn.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "security_group_arns",
                    security_group_arns.unwrap_or_default(),
                )
    ...
    async fn read_location_fsx_ontap(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_location_fsx_ontap(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_location_fsx_open_zfs(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_location_fsx_open_zfs(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.datasync_client
    ...
    async fn delete_location_fsx_open_zfs(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.datasync_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    destination_location_arn.unwrap_or_default(),
                )
                .with_field(
                    "source_location_arn",
                    source_location_arn.unwrap_or_default(),
                )
    ...
    async fn create_location_efs(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let file_system_access_role_arn =
                input.get_optional_string("file_system_access_role_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    file_system_access_role_arn.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    in_transit_encryption.unwrap_or_default(),
                )
                .with_field("subdirectory", subdirectory.unwrap_or_default())
    ...
    async fn read_location_efs(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.datasync_client
    ...
    async fn update_location_efs(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let file_system_access_role_arn =
                input.get_optional_string("file_system_access_role_arn")?;
    ...
    async fn delete_location_efs(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.datasync_client
    ...
    async fn create_location_azure_blob(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    custom_secret_config.unwrap_or_default(),
                )
                .with_field("subdirectory", subdirectory.unwrap_or_default())
                .with_field(
                    "authentication_type",
    ...
    async fn read_location_azure_blob(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.datasync_client
    ...
    async fn delete_location_azure_blob(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.datasync_client
    ...
    async fn create_location_nfs(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_location_nfs(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.datasync_client
    ...
    async fn update_location_nfs(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let subdirectory = input.get_string("subdirectory")?;
            let server_hostname = input.get_string("server_hostname")?;
    ...
    async fn delete_location_nfs(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.datasync_client
    ...
    async fn create_location_s3(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_location_s3(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.datasync_client
    ...
    async fn update_location_s3(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let s3_bucket_arn = input.get_string("s3_bucket_arn")?;
    ...
    async fn delete_location_s3(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.datasync_client
    ...
    async fn create_location_smb(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_location_smb(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.datasync_client
    ...
    async fn update_location_smb(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let kerberos_principal = input.get_optional_string("kerberos_principal")?;
            let kerberos_keytab = input.get_optional_string("kerberos_keytab")?;
    ...
    async fn delete_location_smb(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.datasync_client
    ...
    async fn create_location_object_storage(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let subdirectory = input.get_optional_string("subdirectory")?;
    ...
    async fn read_location_object_storage(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.datasync_client
    ...
    async fn delete_location_object_storage(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.datasync_client
    ...
    async fn create_location_fsx_windows(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let domain = input.get_optional_string("domain")?;
    ...
    async fn read_location_fsx_windows(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.datasync_client
    ...
    async fn delete_location_fsx_windows(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.datasync_client
    ...
    async fn create_location_hdfs(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let authentication_type = input.get_string("authentication_type")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    kms_key_provider_uri.unwrap_or_default(),
                )
    ...
    async fn read_location_hdfs(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.datasync_client
    ...
    async fn update_location_hdfs(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let authentication_type = input.get_string("authentication_type")?;
            let subdirectory = input.get_optional_string("subdirectory")?;
    ...
    async fn delete_location_hdfs(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.datasync_client
    ...
    async fn create_task_execution(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_task_execution(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.datasync_client
    ...
    async fn delete_task_execution(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.datasync_client
    ...
    async fn create_location_fsx_lustre(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let fsx_filesystem_arn = input.get_string("fsx_filesystem_arn")?;
    ...
    async fn read_location_fsx_lustre(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.datasync_client
    ...
    async fn delete_location_fsx_lustre(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.datasync_client
