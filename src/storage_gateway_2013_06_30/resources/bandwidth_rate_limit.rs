...
impl<'a> Bandwidth_rate_limit<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, gateway_arn: Option<String>, average_download_rate_limit_in_bits_per_sec: Option<i64>, average_upload_rate_limit_in_bits_per_sec: Option<i64>) -> Result<()> {
