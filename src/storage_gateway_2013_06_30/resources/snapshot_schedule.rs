...
impl<'a> Snapshot_schedule<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, volume_arn: Option<String>, recurrence_in_hours: Option<i64>, description: Option<String>, start_at: Option<i64>, tags: Option<Vec<String>>) -> Result<()> {
