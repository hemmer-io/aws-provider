...
impl<'a> Tape_pool<'a> {
    ...
    pub async fn create(&self, retention_lock_type: Option<String>, tags: Option<Vec<String>>, retention_lock_time_in_days: Option<i64>, pool_name: String, storage_class: String) -> Result<String> {
