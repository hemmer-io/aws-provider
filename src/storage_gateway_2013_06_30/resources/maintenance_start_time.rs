...
impl<'a> Maintenance_start_time<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, gateway_arn: Option<String>, hour_of_day: Option<i64>, day_of_week: Option<i64>, day_of_month: Option<i64>, software_update_preferences: Option<String>, minute_of_hour: Option<i64>) -> Result<()> {
