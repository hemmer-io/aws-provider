...
impl<'a> Gateway_information<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, cloud_watch_log_group_arn: Option<String>, gateway_capacity: Option<String>, gateway_name: Option<String>, gateway_timezone: Option<String>, gateway_arn: Option<String>) -> Result<()> {
