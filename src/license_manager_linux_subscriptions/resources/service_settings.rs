...
impl<'a> Service_settings<'a> {
    ...
    pub async fn read(&self, id: &str) -> Result<()> {
        ...
        let _client = &self.provider.license_manager_linux_subscriptions_client;
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, allow_update: Option<bool>, linux_subscriptions_discovery_settings: Option<String>, linux_subscriptions_discovery: Option<String>) -> Result<()> {
