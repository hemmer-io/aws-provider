...
impl<'a> License_manager_linux_subscriptionsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "registered_subscription_provider" => {
                self.plan_registered_subscription_provider(current_state, desired_input)
                    .await
            }
            "service_settings" => {
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "license_manager_linux_subscriptions", resource_name
            ))),
        }
    }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "registered_subscription_provider" => {
                self.update_registered_subscription_provider(id, input)
                    .await
            }
    ...
    async fn read_registered_subscription_provider(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_registered_subscription_provider(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_service_settings(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let linux_subscriptions_discovery_settings =
                input.get_string("linux_subscriptions_discovery_settings")?;
            let linux_subscriptions_discovery =
                input.get_string("linux_subscriptions_discovery")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    linux_subscriptions_discovery_settings.unwrap_or_default(),
                )
                .with_field(
                    "linux_subscriptions_discovery",
                    linux_subscriptions_discovery.unwrap_or_default(),
                ))
        })
    }
