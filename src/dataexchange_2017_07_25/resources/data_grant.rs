...
impl<'a> Data_grant<'a> {
    ...
    pub async fn create(&self, name: String, receiver_principal: String, description: Option<String>, grant_distribution_scope: String, ends_at: Option<String>, source_data_set_id: String, tags: Option<HashMap<String, String>>) -> Result<String> {
