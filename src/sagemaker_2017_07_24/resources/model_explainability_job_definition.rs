...
impl<'a> Model_explainability_job_definition<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, model_explainability_baseline_config: Option<String>, model_explainability_app_specification: String, network_config: Option<String>, model_explainability_job_output_config: String, job_resources: String, stopping_condition: Option<String>, job_definition_name: String, model_explainability_job_input: String, role_arn: String) -> Result<String> {
