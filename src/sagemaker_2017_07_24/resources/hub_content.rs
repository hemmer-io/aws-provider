...
impl<'a> Hub_content<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, hub_content_markdown: Option<String>, hub_content_version: Option<String>, hub_name: Option<String>, hub_content_description: Option<String>, hub_content_name: Option<String>, hub_content_type: Option<String>, hub_content_display_name: Option<String>, hub_content_search_keywords: Option<Vec<String>>, support_status: Option<String>) -> Result<()> {
