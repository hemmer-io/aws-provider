...
impl<'a> Hub_content_presigned_urls<'a> {
    ...
    pub async fn create(&self, hub_content_type: String, access_config: Option<String>, hub_name: String, hub_content_version: Option<String>, hub_content_name: String, max_results: Option<i64>, next_token: Option<String>) -> Result<String> {
