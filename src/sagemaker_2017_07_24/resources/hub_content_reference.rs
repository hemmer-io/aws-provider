...
impl<'a> Hub_content_reference<'a> {
    ...
    pub async fn create(&self, min_version: Option<String>, sage_maker_public_hub_content_arn: String, hub_content_name: Option<String>, tags: Option<Vec<String>>, hub_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, min_version: Option<String>, sage_maker_public_hub_content_arn: Option<String>, hub_content_name: Option<String>, tags: Option<Vec<String>>, hub_name: Option<String>) -> Result<()> {
