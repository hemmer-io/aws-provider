...
impl<'a> Inference_recommendations_job<'a> {
    ...
    pub async fn create(&self, job_name: String, role_arn: String, output_config: Option<String>, tags: Option<Vec<String>>, job_description: Option<String>, stopping_conditions: Option<String>, job_type: String, input_config: String) -> Result<String> {
