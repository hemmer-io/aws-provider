...
impl<'a> Model_quality_job_definition<'a> {
    ...
    pub async fn create(&self, model_quality_baseline_config: Option<String>, model_quality_app_specification: String, model_quality_job_output_config: String, role_arn: String, network_config: Option<String>, tags: Option<Vec<String>>, job_resources: String, job_definition_name: String, model_quality_job_input: String, stopping_condition: Option<String>) -> Result<String> {
