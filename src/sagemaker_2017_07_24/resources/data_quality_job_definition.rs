...
impl<'a> Data_quality_job_definition<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, job_resources: String, data_quality_baseline_config: Option<String>, job_definition_name: String, role_arn: String, data_quality_job_output_config: String, stopping_condition: Option<String>, network_config: Option<String>, data_quality_app_specification: String, data_quality_job_input: String) -> Result<String> {
