...
impl<'a> Cluster_software<'a> {
    ...
    pub async fn update(&self, id: &str, deployment_config: Option<String>, image_id: Option<String>, cluster_name: Option<String>, instance_groups: Option<Vec<String>>) -> Result<()> {
