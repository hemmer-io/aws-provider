...
impl<'a> Compilation_job<'a> {
    ...
    pub async fn create(&self, compilation_job_name: String, stopping_condition: String, tags: Option<Vec<String>>, role_arn: String, vpc_config: Option<String>, input_config: Option<String>, model_package_version_arn: Option<String>, output_config: String) -> Result<String> {
