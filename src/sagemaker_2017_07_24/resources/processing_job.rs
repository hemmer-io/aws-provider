...
impl<'a> Processing_job<'a> {
    ...
    pub async fn create(&self, app_specification: String, processing_inputs: Option<Vec<String>>, experiment_config: Option<String>, network_config: Option<String>, processing_resources: String, stopping_condition: Option<String>, role_arn: String, processing_output_config: Option<String>, environment: Option<HashMap<String, String>>, tags: Option<Vec<String>>, processing_job_name: String) -> Result<String> {
