...
impl<'a> Edge_deployment_plan<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, stages: Option<Vec<String>>, edge_deployment_plan_name: String, model_configs: Vec<String>, device_fleet_name: String) -> Result<String> {
