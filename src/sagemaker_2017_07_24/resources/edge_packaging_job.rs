...
impl<'a> Edge_packaging_job<'a> {
    ...
    pub async fn create(&self, model_version: String, output_config: String, resource_key: Option<String>, compilation_job_name: String, tags: Option<Vec<String>>, role_arn: String, edge_packaging_job_name: String, model_name: String) -> Result<String> {
