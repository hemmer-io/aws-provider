...
impl<'a> Distribution_configuration<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, client_token: String, description: Option<String>, distributions: Vec<String>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, client_token: Option<String>, description: Option<String>, distributions: Option<Vec<String>>, name: Option<String>) -> Result<()> {
