...
impl<'a> Job_success_result<'a> {
    ...
    pub async fn create(&self, continuation_token: Option<String>, execution_details: Option<String>, output_variables: Option<HashMap<String, String>>, job_id: String, current_revision: Option<String>) -> Result<String> {
