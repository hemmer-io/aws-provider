...
impl<'a> Repository_link<'a> {
    ...
    pub async fn create(&self, repository_name: String, encryption_key_arn: Option<String>, tags: Option<Vec<String>>, owner_id: String, connection_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, repository_name: Option<String>, encryption_key_arn: Option<String>, tags: Option<Vec<String>>, owner_id: Option<String>, connection_arn: Option<String>) -> Result<()> {
