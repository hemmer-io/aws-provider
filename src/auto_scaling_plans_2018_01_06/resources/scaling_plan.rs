...
impl<'a> Scaling_plan<'a> {
    ...
    pub async fn create(&self, application_source: String, scaling_plan_name: String, scaling_instructions: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, application_source: Option<String>, scaling_plan_name: Option<String>, scaling_instructions: Option<Vec<String>>) -> Result<()> {
