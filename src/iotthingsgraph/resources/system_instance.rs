...
impl<'a> System_instance<'a> {
    ...
    pub async fn create(&self, flow_actions_role_arn: Option<String>, tags: Option<Vec<String>>, s3_bucket_name: Option<String>, definition: String, target: String, greengrass_group_name: Option<String>, metrics_configuration: Option<String>) -> Result<String> {
