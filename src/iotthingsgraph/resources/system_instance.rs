...
impl<'a> System_instance<'a> {
    ...
    pub async fn create(&self, greengrass_group_name: Option<String>, flow_actions_role_arn: Option<String>, tags: Option<Vec<String>>, target: String, metrics_configuration: Option<String>, definition: String, s3_bucket_name: Option<String>) -> Result<String> {
