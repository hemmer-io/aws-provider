...
impl<'a> Gov_cloud_account<'a> {
    ...
    pub async fn create(&self, email: String, account_name: String, iam_user_access_to_billing: Option<String>, role_name: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
