...
impl<'a> Organizational_unit<'a> {
    ...
    pub async fn create(&self, parent_id: String, name: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, parent_id: Option<String>, name: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
