...
impl<'a> Db_cluster_endpoint<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, endpoint_type: String, db_cluster_identifier: String, excluded_members: Option<String>, static_members: Option<String>, db_cluster_endpoint_identifier: String) -> Result<String> {
