...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, enabled: Option<bool>, subscription_name: String, tags: Option<Vec<String>>, sns_topic_arn: String, source_type: Option<String>, event_categories: Option<Vec<String>>, source_ids: Option<Vec<String>>) -> Result<String> {
