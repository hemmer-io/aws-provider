...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, enabled: Option<bool>, subscription_name: String, sns_topic_arn: String, event_categories: Option<Vec<String>>, source_type: Option<String>, source_ids: Option<Vec<String>>, tags: Option<Vec<String>>) -> Result<String> {
