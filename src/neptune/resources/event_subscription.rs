...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, sns_topic_arn: String, source_type: Option<String>, source_ids: Option<Vec<String>>, event_categories: Option<Vec<String>>, subscription_name: String, enabled: Option<bool>, tags: Option<Vec<String>>) -> Result<String> {
