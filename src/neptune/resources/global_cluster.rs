...
impl<'a> Global_cluster<'a> {
    ...
    pub async fn create(&self, engine_version: Option<String>, storage_encrypted: Option<bool>, engine: Option<String>, deletion_protection: Option<bool>, global_cluster_identifier: String, source_db_cluster_identifier: Option<String>) -> Result<String> {
