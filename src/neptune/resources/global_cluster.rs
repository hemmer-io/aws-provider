...
impl<'a> Global_cluster<'a> {
    ...
    pub async fn create(&self, global_cluster_identifier: String, engine_version: Option<String>, engine: Option<String>, deletion_protection: Option<bool>, storage_encrypted: Option<bool>, source_dbcluster_identifier: Option<String>) -> Result<String> {
