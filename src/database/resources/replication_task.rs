...
impl<'a> Replication_task<'a> {
    ...
    pub async fn create(&self, task_data: Option<String>, resource_identifier: Option<String>, migration_type: String, source_endpoint_arn: String, replication_instance_arn: String, cdc_start_time: Option<String>, target_endpoint_arn: String, replication_task_settings: Option<String>, replication_task_identifier: String, table_mappings: String, cdc_start_position: Option<String>, cdc_stop_position: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
