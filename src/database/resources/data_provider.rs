...
impl<'a> Data_provider<'a> {
    ...
    pub async fn create(&self, engine: String, data_provider_name: Option<String>, settings: String, tags: Option<Vec<String>>, description: Option<String>, virtual: Option<bool>) -> Result<String> {
