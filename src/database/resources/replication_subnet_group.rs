...
impl<'a> Replication_subnet_group<'a> {
    ...
    pub async fn create(&self, replication_subnet_group_identifier: String, tags: Option<Vec<String>>, replication_subnet_group_description: String, subnet_ids: Vec<String>) -> Result<String> {
