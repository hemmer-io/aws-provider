...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, enabled: Option<bool>, source_type: Option<String>, event_categories: Option<Vec<String>>, source_ids: Option<Vec<String>>, sns_topic_arn: String, tags: Option<Vec<String>>, subscription_name: String) -> Result<String> {
