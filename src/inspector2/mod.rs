...
impl<'a> Inspector2Service<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "findings_report" => {
                self.plan_findings_report(current_state, desired_input).await
            }
            "cis_scan_report" => {
                self.plan_cis_scan_report(current_state, desired_input).await
            }
            "delegated_admin_account" => {
                self.plan_delegated_admin_account(current_state, desired_input).await
            }
            "code_security_scan" => {
                self.plan_code_security_scan(current_state, desired_input).await
            }
            "findings_report_status" => {
                self.plan_findings_report_status(current_state, desired_input).await
            }
            "org_ec2_deep_inspection_configuration" => {
                self.plan_org_ec2_deep_inspection_configuration(current_state, desired_input).await
            }
            "cis_scan_configuration" => {
                self.plan_cis_scan_configuration(current_state, desired_input).await
            }
            "sbom_export" => {
                self.plan_sbom_export(current_state, desired_input).await
            }
            "encryption_key" => {
                self.plan_encryption_key(current_state, desired_input).await
            }
            "code_security_integration" => {
                self.plan_code_security_integration(current_state, desired_input).await
            }
            "organization_configuration" => {
                self.plan_organization_configuration(current_state, desired_input).await
            }
            "cis_scan_result_details" => {
                self.plan_cis_scan_result_details(current_state, desired_input).await
            }
            "clusters_for_image" => {
                self.plan_clusters_for_image(current_state, desired_input).await
            }
            "configuration" => {
                self.plan_configuration(current_state, desired_input).await
            }
            "ec2_deep_inspection_configuration" => {
                self.plan_ec2_deep_inspection_configuration(current_state, desired_input).await
            }
            "code_security_scan_configuration" => {
                self.plan_code_security_scan_configuration(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "findings_report" => {
                self.create_findings_report(input).await
            }
            "cis_scan_report" => {
                self.create_cis_scan_report(input).await
            }
            "delegated_admin_account" => {
                self.create_delegated_admin_account(input).await
            }
            "code_security_scan" => {
                self.create_code_security_scan(input).await
            }
            "findings_report_status" => {
                self.create_findings_report_status(input).await
            }
            "org_ec2_deep_inspection_configuration" => {
                self.create_org_ec2_deep_inspection_configuration(input).await
            }
            "cis_scan_configuration" => {
                self.create_cis_scan_configuration(input).await
            }
            "sbom_export" => {
                self.create_sbom_export(input).await
            }
            "encryption_key" => {
                self.create_encryption_key(input).await
            }
            "code_security_integration" => {
                self.create_code_security_integration(input).await
            }
            "organization_configuration" => {
                self.create_organization_configuration(input).await
            }
            "cis_scan_result_details" => {
                self.create_cis_scan_result_details(input).await
            }
            "clusters_for_image" => {
                self.create_clusters_for_image(input).await
            }
            "configuration" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "findings_report" => {
                self.read_findings_report(id).await
            }
            "cis_scan_report" => {
                self.read_cis_scan_report(id).await
            }
            "delegated_admin_account" => {
                self.read_delegated_admin_account(id).await
            }
            "code_security_scan" => {
                self.read_code_security_scan(id).await
            }
            "findings_report_status" => {
                self.read_findings_report_status(id).await
            }
            "org_ec2_deep_inspection_configuration" => {
                self.read_org_ec2_deep_inspection_configuration(id).await
            }
            "cis_scan_configuration" => {
                self.read_cis_scan_configuration(id).await
            }
            "sbom_export" => {
                self.read_sbom_export(id).await
            }
            "encryption_key" => {
                self.read_encryption_key(id).await
            }
            "code_security_integration" => {
                self.read_code_security_integration(id).await
            }
            "organization_configuration" => {
                self.read_organization_configuration(id).await
            }
            "cis_scan_result_details" => {
                self.read_cis_scan_result_details(id).await
            }
            "clusters_for_image" => {
                self.read_clusters_for_image(id).await
            }
            "configuration" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "findings_report" => {
                self.update_findings_report(id, input).await
            }
            "cis_scan_report" => {
                self.update_cis_scan_report(id, input).await
            }
            "delegated_admin_account" => {
                self.update_delegated_admin_account(id, input).await
            }
            "code_security_scan" => {
                self.update_code_security_scan(id, input).await
            }
            "findings_report_status" => {
                self.update_findings_report_status(id, input).await
            }
            "org_ec2_deep_inspection_configuration" => {
                self.update_org_ec2_deep_inspection_configuration(id, input).await
            }
            "cis_scan_configuration" => {
                self.update_cis_scan_configuration(id, input).await
            }
            "sbom_export" => {
                self.update_sbom_export(id, input).await
            }
            "encryption_key" => {
                self.update_encryption_key(id, input).await
            }
            "code_security_integration" => {
                self.update_code_security_integration(id, input).await
            }
            "organization_configuration" => {
                self.update_organization_configuration(id, input).await
            }
            "cis_scan_result_details" => {
                self.update_cis_scan_result_details(id, input).await
            }
            "clusters_for_image" => {
                self.update_clusters_for_image(id, input).await
            }
            "configuration" => {
                self.update_configuration(id, input).await
            }
            "ec2_deep_inspection_configuration" => {
                self.update_ec2_deep_inspection_configuration(id, input).await
            }
            "code_security_scan_configuration" => {
                self.update_code_security_scan_configuration(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "inspector2",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "findings_report" => {
                self.delete_findings_report(id).await
            }
            "cis_scan_report" => {
                self.delete_cis_scan_report(id).await
            }
            "delegated_admin_account" => {
                self.delete_delegated_admin_account(id).await
            }
            "code_security_scan" => {
                self.delete_code_security_scan(id).await
            }
            "findings_report_status" => {
                self.delete_findings_report_status(id).await
            }
            "org_ec2_deep_inspection_configuration" => {
                self.delete_org_ec2_deep_inspection_configuration(id).await
            }
            "cis_scan_configuration" => {
                self.delete_cis_scan_configuration(id).await
            }
            "sbom_export" => {
                self.delete_sbom_export(id).await
            }
            "encryption_key" => {
                self.delete_encryption_key(id).await
            }
            "code_security_integration" => {
                self.delete_code_security_integration(id).await
            }
            "organization_configuration" => {
                self.delete_organization_configuration(id).await
            }
            "cis_scan_result_details" => {
                self.delete_cis_scan_result_details(id).await
            }
            "clusters_for_image" => {
                self.delete_clusters_for_image(id).await
            }
            "configuration" => {
    ...
    async fn create_findings_report(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_findings_report(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cis_scan_report(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_cis_scan_report(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_delegated_admin_account(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_delegated_admin_account(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_delegated_admin_account(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_code_security_scan(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_code_security_scan(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_code_security_scan(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_findings_report_status(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_findings_report_status(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_findings_report_status(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_org_ec2_deep_inspection_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_org_ec2_deep_inspection_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cis_scan_configuration(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_cis_scan_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cis_scan_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_sbom_export(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("s3_destination", s3_destination.unwrap_or_default())
                .with_field("report_format", report_format.unwrap_or_default())
                .with_field("resource_filter_criteria", resource_filter_criteria.unwrap_or_default())
            )
        })
    }

    /// Read a sbom_export resource
    async fn read_sbom_export(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_code_security_integration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_code_security_integration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cis_scan_result_details(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_cis_scan_result_details(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cis_scan_result_details(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_clusters_for_image(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_clusters_for_image(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_clusters_for_image(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_ec2_deep_inspection_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("activate_deep_inspection", activate_deep_inspection.unwrap_or_default())
    ...
    async fn read_ec2_deep_inspection_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_ec2_deep_inspection_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_code_security_scan_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_code_security_scan_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
