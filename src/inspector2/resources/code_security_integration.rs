...
impl<'a> Code_security_integration<'a> {
    ...
    pub async fn create(&self, name: String, tags: Option<HashMap<String, String>>, type: String, details: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, tags: Option<HashMap<String, String>>, type: Option<String>, details: Option<String>) -> Result<()> {
