...
impl<'a> Code_security_integration<'a> {
    ...
    pub async fn create(&self, type: String, tags: Option<HashMap<String, String>>, name: String, details: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, type: Option<String>, tags: Option<HashMap<String, String>>, name: Option<String>, details: Option<String>) -> Result<()> {
