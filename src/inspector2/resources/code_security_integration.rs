...
impl<'a> Code_security_integration<'a> {
    ...
    pub async fn create(&self, details: Option<String>, name: String, type: String, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, details: Option<String>, name: Option<String>, type: Option<String>, tags: Option<HashMap<String, String>>) -> Result<()> {
