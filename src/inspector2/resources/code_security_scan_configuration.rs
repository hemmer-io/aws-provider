...
impl<'a> Code_security_scan_configuration<'a> {
    ...
    pub async fn create(&self, name: String, level: String, scope_settings: Option<String>, tags: Option<HashMap<String, String>>, configuration: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, level: Option<String>, scope_settings: Option<String>, tags: Option<HashMap<String, String>>, configuration: Option<String>) -> Result<()> {
