...
impl<'a> Code_security_scan_configuration<'a> {
    ...
    pub async fn create(&self, configuration: String, level: String, tags: Option<HashMap<String, String>>, name: String, scope_settings: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, configuration: Option<String>, level: Option<String>, tags: Option<HashMap<String, String>>, name: Option<String>, scope_settings: Option<String>) -> Result<()> {
