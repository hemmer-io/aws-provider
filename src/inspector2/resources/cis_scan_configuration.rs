...
impl<'a> Cis_scan_configuration<'a> {
    ...
    pub async fn create(&self, scan_name: String, security_level: String, schedule: String, targets: String, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, scan_name: Option<String>, security_level: Option<String>, schedule: Option<String>, targets: Option<String>, tags: Option<HashMap<String, String>>) -> Result<()> {
