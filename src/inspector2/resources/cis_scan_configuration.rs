...
impl<'a> Cis_scan_configuration<'a> {
    ...
    pub async fn create(&self, targets: String, security_level: String, schedule: String, tags: Option<HashMap<String, String>>, scan_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, targets: Option<String>, security_level: Option<String>, schedule: Option<String>, tags: Option<HashMap<String, String>>, scan_name: Option<String>) -> Result<()> {
