...
impl<'a> Cis_scan_configuration<'a> {
    ...
    pub async fn create(&self, schedule: String, tags: Option<HashMap<String, String>>, security_level: String, scan_name: String, targets: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, schedule: Option<String>, tags: Option<HashMap<String, String>>, security_level: Option<String>, scan_name: Option<String>, targets: Option<String>) -> Result<()> {
