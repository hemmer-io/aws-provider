...
impl<'a> Cis_scan_configuration<'a> {
    ...
    pub async fn create(&self, security_level: String, targets: String, tags: Option<HashMap<String, String>>, scan_name: String, schedule: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, security_level: Option<String>, targets: Option<String>, tags: Option<HashMap<String, String>>, scan_name: Option<String>, schedule: Option<String>) -> Result<()> {
