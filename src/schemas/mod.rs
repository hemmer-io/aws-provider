...
impl<'a> SchemasService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "discovered_schema" => {
                self.plan_discovered_schema(current_state, desired_input)
                    .await
            }
            "code_binding_source" => {
                self.plan_code_binding_source(current_state, desired_input)
                    .await
            }
            "discoverer" => self.plan_discoverer(current_state, desired_input).await,
            "schema_version" => self.plan_schema_version(current_state, desired_input).await,
            "code_binding" => self.plan_code_binding(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "discovered_schema" => self.create_discovered_schema(input).await,
            "code_binding_source" => self.create_code_binding_source(input).await,
            "discoverer" => self.create_discoverer(input).await,
            "schema_version" => self.create_schema_version(input).await,
            "code_binding" => self.create_code_binding(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "discovered_schema" => self.read_discovered_schema(id).await,
            "code_binding_source" => self.read_code_binding_source(id).await,
            "discoverer" => self.read_discoverer(id).await,
            "schema_version" => self.read_schema_version(id).await,
            "code_binding" => self.read_code_binding(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "discovered_schema" => self.update_discovered_schema(id, input).await,
            "code_binding_source" => self.update_code_binding_source(id, input).await,
            "discoverer" => self.update_discoverer(id, input).await,
            "schema_version" => self.update_schema_version(id, input).await,
            "code_binding" => self.update_code_binding(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "discovered_schema" => self.delete_discovered_schema(id).await,
            "code_binding_source" => self.delete_code_binding_source(id).await,
            "discoverer" => self.delete_discoverer(id).await,
            "schema_version" => self.delete_schema_version(id).await,
            "code_binding" => self.delete_code_binding(id).await,
    ...
    async fn create_discovered_schema(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_discovered_schema(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.schemas_client
    ...
    async fn delete_discovered_schema(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.schemas_client
    ...
    async fn create_code_binding_source(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_code_binding_source(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.schemas_client
    ...
    async fn delete_code_binding_source(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.schemas_client
    ...
    async fn create_discoverer(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_discoverer(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.schemas_client
    ...
    async fn update_discoverer(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let cross_account = input.get_optional_string("cross_account")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_discoverer(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.schemas_client
    ...
    async fn create_code_binding(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_code_binding(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.schemas_client
    ...
    async fn update_code_binding(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let language = input.get_string("language")?;
            let registry_name = input.get_string("registry_name")?;
    ...
    async fn delete_code_binding(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.schemas_client
