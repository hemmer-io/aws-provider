...
impl<'a> Legal_hold<'a> {
    ...
    pub async fn create(&self, recovery_point_selection: Option<String>, title: String, description: String, idempotency_token: Option<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
