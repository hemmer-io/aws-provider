...
impl<'a> Backup_plan<'a> {
    ...
    pub async fn create(&self, creator_request_id: Option<String>, backup_plan_tags: Option<HashMap<String, String>>, backup_plan: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, creator_request_id: Option<String>, backup_plan_tags: Option<HashMap<String, String>>, backup_plan: Option<String>) -> Result<()> {
