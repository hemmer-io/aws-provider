...
impl<'a> Restore_testing_selection<'a> {
    ...
    pub async fn create(&self, restore_testing_plan_name: String, restore_testing_selection: String, creator_request_id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, restore_testing_plan_name: Option<String>, restore_testing_selection: Option<String>, creator_request_id: Option<String>) -> Result<()> {
