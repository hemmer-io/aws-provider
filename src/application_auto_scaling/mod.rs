...
impl<'a> Application_auto_scalingService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "scalable_targets" => {
                self.plan_scalable_targets(current_state, desired_input)
                    .await
            }
            "scaling_policies" => {
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "application_auto_scaling", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "scalable_targets" => self.create_scalable_targets(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "scalable_targets" => self.read_scalable_targets(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "scalable_targets" => self.update_scalable_targets(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "scalable_targets" => self.delete_scalable_targets(id).await,
    ...
    async fn create_scaling_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let step_scaling_policy_configuration =
                input.get_optional_string("step_scaling_policy_configuration")?;
            let policy_type = input.get_optional_string("policy_type")?;
            let service_namespace = input.get_string("service_namespace")?;
            let target_tracking_scaling_policy_configuration =
                input.get_optional_string("target_tracking_scaling_policy_configuration")?;
            let scalable_dimension = input.get_string("scalable_dimension")?;
            let predictive_scaling_policy_configuration =
                input.get_optional_string("predictive_scaling_policy_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    step_scaling_policy_configuration.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    target_tracking_scaling_policy_configuration.unwrap_or_default(),
                )
                .with_field("scalable_dimension", scalable_dimension.unwrap_or_default())
                .with_field(
                    "predictive_scaling_policy_configuration",
                    predictive_scaling_policy_configuration.unwrap_or_default(),
                ))
        })
    }
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    scalable_target_action.unwrap_or_default(),
                )
    ...
    async fn create_scalable_targets(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_scalable_targets(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.application_auto_scaling_client
    ...
    async fn delete_scalable_targets(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.application_auto_scaling_client
