...
impl<'a> ServerlessapplicationrepositoryService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "cloud_formation_template" => {
                self.plan_cloud_formation_template(current_state, desired_input).await
            }
            "application_policy" => {
                self.plan_application_policy(current_state, desired_input).await
            }
            "cloud_formation_change_set" => {
                self.plan_cloud_formation_change_set(current_state, desired_input).await
            }
            "application" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "cloud_formation_template" => {
                self.create_cloud_formation_template(input).await
            }
            "application_policy" => {
                self.create_application_policy(input).await
            }
            "cloud_formation_change_set" => {
                self.create_cloud_formation_change_set(input).await
            }
            "application" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "cloud_formation_template" => {
                self.read_cloud_formation_template(id).await
            }
            "application_policy" => {
                self.read_application_policy(id).await
            }
            "cloud_formation_change_set" => {
                self.read_cloud_formation_change_set(id).await
            }
            "application" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "cloud_formation_template" => {
                self.update_cloud_formation_template(id, input).await
            }
            "application_policy" => {
                self.update_application_policy(id, input).await
            }
            "cloud_formation_change_set" => {
                self.update_cloud_formation_change_set(id, input).await
            }
            "application" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "cloud_formation_template" => {
                self.delete_cloud_formation_template(id).await
            }
            "application_policy" => {
                self.delete_application_policy(id).await
            }
            "cloud_formation_change_set" => {
                self.delete_cloud_formation_change_set(id).await
            }
            "application" => {
    ...
    async fn create_application_version(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("source_code_archive_url", source_code_archive_url.unwrap_or_default())
    ...
    async fn read_cloud_formation_template(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cloud_formation_template(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_application_policy(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_application_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_application_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_cloud_formation_change_set(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cloud_formation_change_set(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
