...
impl<'a> Direct_connect_gateway_association<'a> {
    ...
    pub async fn create(&self, virtual_gateway_id: Option<String>, direct_connect_gateway_id: String, add_allowed_prefixes_to_direct_connect_gateway: Option<Vec<String>>, gateway_id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, virtual_gateway_id: Option<String>, direct_connect_gateway_id: Option<String>, add_allowed_prefixes_to_direct_connect_gateway: Option<Vec<String>>, gateway_id: Option<String>) -> Result<()> {
