...
impl<'a> Virtual_interface_attributes<'a> {
    ...
    pub async fn update(&self, id: &str, enable_site_link: Option<bool>, virtual_interface_name: Option<String>, virtual_interface_id: Option<String>, mtu: Option<i64>) -> Result<()> {
