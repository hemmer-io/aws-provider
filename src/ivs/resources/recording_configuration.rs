...
impl<'a> Recording_configuration<'a> {
    ...
    pub async fn create(&self, thumbnail_configuration: Option<String>, recording_reconnect_window_seconds: Option<i64>, destination_configuration: String, name: Option<String>, rendition_configuration: Option<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
