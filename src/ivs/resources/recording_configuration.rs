...
impl<'a> Recording_configuration<'a> {
    ...
    pub async fn create(&self, name: Option<String>, thumbnail_configuration: Option<String>, recording_reconnect_window_seconds: Option<i64>, rendition_configuration: Option<String>, destination_configuration: String, tags: Option<HashMap<String, String>>) -> Result<String> {
