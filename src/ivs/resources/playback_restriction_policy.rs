...
impl<'a> Playback_restriction_policy<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, allowed_origins: Option<Vec<String>>, enable_strict_origin_enforcement: Option<bool>, name: Option<String>, allowed_countries: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, allowed_origins: Option<Vec<String>>, enable_strict_origin_enforcement: Option<bool>, name: Option<String>, allowed_countries: Option<Vec<String>>) -> Result<()> {
