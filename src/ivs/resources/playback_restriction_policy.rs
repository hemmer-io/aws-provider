...
impl<'a> Playback_restriction_policy<'a> {
    ...
    pub async fn create(&self, allowed_origins: Option<Vec<String>>, tags: Option<HashMap<String, String>>, allowed_countries: Option<Vec<String>>, enable_strict_origin_enforcement: Option<bool>, name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, allowed_origins: Option<Vec<String>>, tags: Option<HashMap<String, String>>, allowed_countries: Option<Vec<String>>, enable_strict_origin_enforcement: Option<bool>, name: Option<String>) -> Result<()> {
