...
impl<'a> Eks_anywhere_subscription<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, name: String, license_type: Option<String>, auto_renew: Option<bool>, client_request_token: Option<String>, license_quantity: Option<i64>, term: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, name: Option<String>, license_type: Option<String>, auto_renew: Option<bool>, client_request_token: Option<String>, license_quantity: Option<i64>, term: Option<String>) -> Result<()> {
