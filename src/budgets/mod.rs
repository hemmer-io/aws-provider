...
impl<'a> BudgetsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "budget_action" => self.plan_budget_action(current_state, desired_input).await,
            "budget_actions_for_budget" => {
                self.plan_budget_actions_for_budget(current_state, desired_input)
                    .await
            }
            "budget_actions_for_account" => {
                self.plan_budget_actions_for_account(current_state, desired_input)
                    .await
            }
            "budget_performance_history" => {
                self.plan_budget_performance_history(current_state, desired_input)
                    .await
            }
            "budget_action_histories" => {
                self.plan_budget_action_histories(current_state, desired_input)
                    .await
            }
            "budget_notifications_for_account" => {
                self.plan_budget_notifications_for_account(current_state, desired_input)
                    .await
            }
            "budgets" => self.plan_budgets(current_state, desired_input).await,
            "subscriber" => self.plan_subscriber(current_state, desired_input).await,
            "subscribers_for_notification" => {
                self.plan_subscribers_for_notification(current_state, desired_input)
                    .await
            }
            "notifications_for_budget" => {
                self.plan_notifications_for_budget(current_state, desired_input)
                    .await
            }
            "notification" => self.plan_notification(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "budgets", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "budget_action" => self.create_budget_action(input).await,
            "budget_actions_for_budget" => self.create_budget_actions_for_budget(input).await,
            "budget_actions_for_account" => self.create_budget_actions_for_account(input).await,
            "budget_performance_history" => self.create_budget_performance_history(input).await,
            "budget_action_histories" => self.create_budget_action_histories(input).await,
            "budget_notifications_for_account" => {
                self.create_budget_notifications_for_account(input).await
            }
            "budgets" => self.create_budgets(input).await,
            "subscriber" => self.create_subscriber(input).await,
            "subscribers_for_notification" => self.create_subscribers_for_notification(input).await,
            "notifications_for_budget" => self.create_notifications_for_budget(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "budget_action" => self.read_budget_action(id).await,
            "budget_actions_for_budget" => self.read_budget_actions_for_budget(id).await,
            "budget_actions_for_account" => self.read_budget_actions_for_account(id).await,
            "budget_performance_history" => self.read_budget_performance_history(id).await,
            "budget_action_histories" => self.read_budget_action_histories(id).await,
            "budget_notifications_for_account" => {
                self.read_budget_notifications_for_account(id).await
            }
            "budgets" => self.read_budgets(id).await,
            "subscriber" => self.read_subscriber(id).await,
            "subscribers_for_notification" => self.read_subscribers_for_notification(id).await,
            "notifications_for_budget" => self.read_notifications_for_budget(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "budget_action" => self.update_budget_action(id, input).await,
            "budget_actions_for_budget" => self.update_budget_actions_for_budget(id, input).await,
            "budget_actions_for_account" => self.update_budget_actions_for_account(id, input).await,
            "budget_performance_history" => self.update_budget_performance_history(id, input).await,
            "budget_action_histories" => self.update_budget_action_histories(id, input).await,
            "budget_notifications_for_account" => {
                self.update_budget_notifications_for_account(id, input)
                    .await
            }
            "budgets" => self.update_budgets(id, input).await,
            "subscriber" => self.update_subscriber(id, input).await,
            "subscribers_for_notification" => {
                self.update_subscribers_for_notification(id, input).await
            }
            "notifications_for_budget" => self.update_notifications_for_budget(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "budget_action" => self.delete_budget_action(id).await,
            "budget_actions_for_budget" => self.delete_budget_actions_for_budget(id).await,
            "budget_actions_for_account" => self.delete_budget_actions_for_account(id).await,
            "budget_performance_history" => self.delete_budget_performance_history(id).await,
            "budget_action_histories" => self.delete_budget_action_histories(id).await,
            "budget_notifications_for_account" => {
                self.delete_budget_notifications_for_account(id).await
            }
            "budgets" => self.delete_budgets(id).await,
            "subscriber" => self.delete_subscriber(id).await,
            "subscribers_for_notification" => self.delete_subscribers_for_notification(id).await,
            "notifications_for_budget" => self.delete_notifications_for_budget(id).await,
    ...
    async fn create_budget(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let notifications_with_subscribers =
                input.get_optional_string("notifications_with_subscribers")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    notifications_with_subscribers.unwrap_or_default(),
                )
    ...
    async fn create_budget_action(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_budget_action(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.budgets_client
    ...
    async fn update_budget_action(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let action_type = input.get_string("action_type")?;
            let subscribers = input.get_string("subscribers")?;
    ...
    async fn delete_budget_action(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.budgets_client
    ...
    async fn read_budget_actions_for_budget(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.budgets_client
    ...
    async fn delete_budget_actions_for_budget(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.budgets_client
    ...
    async fn read_budget_actions_for_account(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.budgets_client
    ...
    async fn delete_budget_actions_for_account(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.budgets_client
    ...
    async fn read_budget_performance_history(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.budgets_client
    ...
    async fn delete_budget_performance_history(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.budgets_client
    ...
    async fn create_budget_action_histories(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_budget_action_histories(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.budgets_client
    ...
    async fn delete_budget_action_histories(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.budgets_client
    ...
    async fn read_budget_notifications_for_account(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.budgets_client
    ...
    async fn delete_budget_notifications_for_account(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.budgets_client
    ...
    async fn create_budgets(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_budgets(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.budgets_client
    ...
    async fn update_budgets(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_budgets(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.budgets_client
    ...
    async fn create_subscriber(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_subscriber(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.budgets_client
    ...
    async fn update_subscriber(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let notification = input.get_string("notification")?;
            let subscriber = input.get_string("subscriber")?;
    ...
    async fn read_subscribers_for_notification(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.budgets_client
    ...
    async fn delete_subscribers_for_notification(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.budgets_client
    ...
    async fn read_notifications_for_budget(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.budgets_client
    ...
    async fn delete_notifications_for_budget(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.budgets_client
