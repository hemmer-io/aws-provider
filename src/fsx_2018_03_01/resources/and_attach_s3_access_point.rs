...
impl<'a> And_attach_s3_access_point<'a> {
    ...
    pub async fn create(&self, type: String, name: String, s3_access_point: Option<String>, open_zfs_configuration: Option<String>, client_request_token: Option<String>) -> Result<String> {
