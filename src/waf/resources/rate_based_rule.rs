...
impl<'a> Rate_based_rule<'a> {
    ...
    pub async fn create(&self, name: String, rate_key: String, change_token: String, rate_limit: i64, tags: Option<Vec<String>>, metric_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, rate_key: Option<String>, change_token: Option<String>, rate_limit: Option<i64>, tags: Option<Vec<String>>, metric_name: Option<String>) -> Result<()> {
