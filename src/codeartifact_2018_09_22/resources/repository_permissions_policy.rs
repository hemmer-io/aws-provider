...
impl<'a> Repository_permissions_policy<'a> {
    ...
    pub async fn create(&self, policy_revision: Option<String>, domain_owner: Option<String>, repository: String, policy_document: String, domain: String) -> Result<String> {
