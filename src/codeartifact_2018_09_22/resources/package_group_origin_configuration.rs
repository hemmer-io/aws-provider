...
impl<'a> Package_group_origin_configuration<'a> {
    ...
    pub async fn update(&self, id: &str, domain_owner: Option<String>, package_group: Option<String>, domain: Option<String>, restrictions: Option<HashMap<String, String>>, add_allowed_repositories: Option<Vec<String>>, remove_allowed_repositories: Option<Vec<String>>) -> Result<()> {
