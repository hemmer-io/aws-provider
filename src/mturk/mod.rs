...
impl<'a> MturkService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "hit_type_of_hit" => {
                self.plan_hit_type_of_hit(current_state, desired_input)
                    .await
            }
            "file_upload_url" => {
                self.plan_file_upload_url(current_state, desired_input)
                    .await
            }
            "hit_review_status" => {
                self.plan_hit_review_status(current_state, desired_input)
                    .await
            }
            "assignment" => self.plan_assignment(current_state, desired_input).await,
            "worker_block" => self.plan_worker_block(current_state, desired_input).await,
            "account_balance" => {
                self.plan_account_balance(current_state, desired_input)
                    .await
            }
            "additional_assignments_for_hit" => {
                self.plan_additional_assignments_for_hit(current_state, desired_input)
                    .await
            }
            "qualification_score" => {
                self.plan_qualification_score(current_state, desired_input)
                    .await
            }
            ...
            "hit" => self.plan_hit(current_state, desired_input).await,
            "hit_type" => self.plan_hit_type(current_state, desired_input).await,
            "hit_with_hit_type" => {
                self.plan_hit_with_hit_type(current_state, desired_input)
                    .await
            }
            "qualification_type" => {
                self.plan_qualification_type(current_state, desired_input)
                    .await
            }
            "expiration_for_hit" => {
                self.plan_expiration_for_hit(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "hit_type_of_hit" => self.create_hit_type_of_hit(input).await,
            "file_upload_url" => self.create_file_upload_url(input).await,
            "hit_review_status" => self.create_hit_review_status(input).await,
            "assignment" => self.create_assignment(input).await,
            "worker_block" => self.create_worker_block(input).await,
            "account_balance" => self.create_account_balance(input).await,
            "additional_assignments_for_hit" => {
                self.create_additional_assignments_for_hit(input).await
            }
            "qualification_score" => self.create_qualification_score(input).await,
            "notification_settings" => self.create_notification_settings(input).await,
            "hit" => self.create_hit(input).await,
            "hit_type" => self.create_hit_type(input).await,
            "hit_with_hit_type" => self.create_hit_with_hit_type(input).await,
            "qualification_type" => self.create_qualification_type(input).await,
            "expiration_for_hit" => self.create_expiration_for_hit(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "mturk", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "hit_type_of_hit" => self.read_hit_type_of_hit(id).await,
            "file_upload_url" => self.read_file_upload_url(id).await,
            "hit_review_status" => self.read_hit_review_status(id).await,
            "assignment" => self.read_assignment(id).await,
            "worker_block" => self.read_worker_block(id).await,
            "account_balance" => self.read_account_balance(id).await,
            "additional_assignments_for_hit" => self.read_additional_assignments_for_hit(id).await,
            "qualification_score" => self.read_qualification_score(id).await,
            "notification_settings" => self.read_notification_settings(id).await,
            "hit" => self.read_hit(id).await,
            "hit_type" => self.read_hit_type(id).await,
            "hit_with_hit_type" => self.read_hit_with_hit_type(id).await,
            "qualification_type" => self.read_qualification_type(id).await,
            "expiration_for_hit" => self.read_expiration_for_hit(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "mturk", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "hit_type_of_hit" => self.update_hit_type_of_hit(id, input).await,
            "file_upload_url" => self.update_file_upload_url(id, input).await,
            "hit_review_status" => self.update_hit_review_status(id, input).await,
            "assignment" => self.update_assignment(id, input).await,
            "worker_block" => self.update_worker_block(id, input).await,
            "account_balance" => self.update_account_balance(id, input).await,
            "additional_assignments_for_hit" => {
                self.update_additional_assignments_for_hit(id, input).await
            }
            "qualification_score" => self.update_qualification_score(id, input).await,
            "notification_settings" => self.update_notification_settings(id, input).await,
            "hit" => self.update_hit(id, input).await,
            "hit_type" => self.update_hit_type(id, input).await,
            "hit_with_hit_type" => self.update_hit_with_hit_type(id, input).await,
            "qualification_type" => self.update_qualification_type(id, input).await,
            "expiration_for_hit" => self.update_expiration_for_hit(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "mturk", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "hit_type_of_hit" => self.delete_hit_type_of_hit(id).await,
            "file_upload_url" => self.delete_file_upload_url(id).await,
            "hit_review_status" => self.delete_hit_review_status(id).await,
            "assignment" => self.delete_assignment(id).await,
            "worker_block" => self.delete_worker_block(id).await,
            "account_balance" => self.delete_account_balance(id).await,
            "additional_assignments_for_hit" => {
                self.delete_additional_assignments_for_hit(id).await
            }
            "qualification_score" => self.delete_qualification_score(id).await,
            "notification_settings" => self.delete_notification_settings(id).await,
            "hit" => self.delete_hit(id).await,
            "hit_type" => self.delete_hit_type(id).await,
            "hit_with_hit_type" => self.delete_hit_with_hit_type(id).await,
            "qualification_type" => self.delete_qualification_type(id).await,
            "expiration_for_hit" => self.delete_expiration_for_hit(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "mturk", resource_name
            ))),
    ...
    async fn create_hit_type_of_hit(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_hit_type_of_hit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_hit_type_of_hit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_file_upload_url(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_file_upload_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mturk_client
    ...
    async fn delete_file_upload_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mturk_client
    ...
    async fn create_hit_review_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_hit_review_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mturk_client
    ...
    async fn delete_hit_review_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mturk_client
    ...
    async fn create_assignment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_assignment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mturk_client
    ...
    async fn update_assignment(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_assignment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mturk_client
    ...
    async fn create_worker_block(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_worker_block(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mturk_client
    ...
    async fn update_worker_block(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let reason = input.get_string("reason")?;
            let worker_id = input.get_string("worker_id")?;
    ...
    async fn delete_worker_block(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mturk_client
    ...
    async fn create_account_balance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_account_balance(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mturk_client
    ...
    async fn delete_account_balance(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mturk_client
    ...
    async fn create_additional_assignments_for_hit(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let number_of_additional_assignments =
                input.get_string("number_of_additional_assignments")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    number_of_additional_assignments.unwrap_or_default(),
                )
                .with_field(
                    "unique_request_token",
                    unique_request_token.unwrap_or_default(),
                )
                .with_field("hit_id", hit_id.unwrap_or_default()))
        })
    }
    ...
    async fn read_additional_assignments_for_hit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mturk_client
    ...
    async fn delete_additional_assignments_for_hit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mturk_client
    ...
    async fn create_qualification_score(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_qualification_score(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mturk_client
    ...
    async fn delete_qualification_score(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mturk_client
    ...
    async fn create_hit(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let auto_approval_delay_in_seconds =
                input.get_optional_string("auto_approval_delay_in_seconds")?;
            let unique_request_token = input.get_optional_string("unique_request_token")?;
            ...
            let assignment_duration_in_seconds =
                input.get_string("assignment_duration_in_seconds")?;
            ...
            let qualification_requirements =
                input.get_optional_string("qualification_requirements")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    auto_approval_delay_in_seconds.unwrap_or_default(),
                )
                .with_field(
                    "unique_request_token",
                    unique_request_token.unwrap_or_default(),
                ...
                .with_field(
                    "lifetime_in_seconds",
                    lifetime_in_seconds.unwrap_or_default(),
                )
                .with_field("title", title.unwrap_or_default())
                .with_field("question", question.unwrap_or_default())
                .with_field(
                    "assignment_duration_in_seconds",
                    assignment_duration_in_seconds.unwrap_or_default(),
                )
                .with_field(
                    "requester_annotation",
                    requester_annotation.unwrap_or_default(),
                )
                .with_field(
                    "hit_layout_parameters",
                    hit_layout_parameters.unwrap_or_default(),
                )
    ...
    /// Read a hit resource
    async fn read_hit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mturk_client
    ...
    async fn update_hit(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let auto_approval_delay_in_seconds =
                input.get_optional_string("auto_approval_delay_in_seconds")?;
    ...
    async fn delete_hit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mturk_client
    ...
    async fn create_hit_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let qualification_requirements =
    ...
    async fn read_hit_type(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mturk_client
    ...
    async fn update_hit_type(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let qualification_requirements =
                input.get_optional_string("qualification_requirements")?;
    ...
    async fn delete_hit_type(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mturk_client
    ...
    async fn create_hit_with_hit_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let hit_type_id = input.get_string("hit_type_id")?;
    ...
    async fn read_hit_with_hit_type(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mturk_client
    ...
    async fn delete_hit_with_hit_type(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mturk_client
    ...
    async fn create_qualification_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    qualification_type_status.unwrap_or_default(),
                )
                .with_field("description", description.unwrap_or_default())
                .with_field(
                    "test_duration_in_seconds",
                    test_duration_in_seconds.unwrap_or_default(),
                )
                .with_field(
                    "retry_delay_in_seconds",
                    retry_delay_in_seconds.unwrap_or_default(),
                )
    ...
    async fn read_qualification_type(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mturk_client
    ...
    async fn delete_qualification_type(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mturk_client
    ...
    async fn create_expiration_for_hit(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let hit_id = input.get_string("hit_id")?;
    ...
    async fn read_expiration_for_hit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mturk_client
    ...
    async fn delete_expiration_for_hit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mturk_client
