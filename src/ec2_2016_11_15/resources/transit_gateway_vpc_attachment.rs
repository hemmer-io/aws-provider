...
impl<'a> Transit_gateway_vpc_attachment<'a> {
    ...
    pub async fn create(&self, subnet_ids: Vec<String>, options: Option<String>, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, transit_gateway_id: String, vpc_id: String) -> Result<String> {
