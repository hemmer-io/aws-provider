...
impl<'a> Vpn_gateway<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, amazon_side_asn: Option<i64>, type: String, availability_zone: Option<String>, tag_specifications: Option<Vec<String>>) -> Result<String> {
