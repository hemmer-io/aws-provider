...
impl<'a> Network_acl_entry<'a> {
    ...
    pub async fn create(&self, port_range: Option<String>, rule_number: i64, egress: bool, cidr_block: Option<String>, dry_run: Option<bool>, network_acl_id: String, protocol: String, rule_action: String, ipv6_cidr_block: Option<String>, icmp_type_code: Option<String>) -> Result<String> {
