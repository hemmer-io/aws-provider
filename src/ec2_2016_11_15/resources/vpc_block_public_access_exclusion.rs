...
impl<'a> Vpc_block_public_access_exclusion<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, internet_gateway_exclusion_mode: String, subnet_id: Option<String>, vpc_id: Option<String>) -> Result<String> {
