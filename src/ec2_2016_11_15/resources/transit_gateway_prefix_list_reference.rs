...
impl<'a> Transit_gateway_prefix_list_reference<'a> {
    ...
    pub async fn create(&self, transit_gateway_route_table_id: String, dry_run: Option<bool>, prefix_list_id: String, transit_gateway_attachment_id: Option<String>, blackhole: Option<bool>) -> Result<String> {
