...
impl<'a> Instance_connect_endpoint<'a> {
    ...
    pub async fn create(&self, subnet_id: String, ip_address_type: Option<String>, preserve_client_ip: Option<bool>, dry_run: Option<bool>, client_token: Option<String>, security_group_ids: Option<Vec<String>>, tag_specifications: Option<Vec<String>>) -> Result<String> {
