...
impl<'a> Transit_gateway_peering_attachment<'a> {
    ...
    pub async fn create(&self, peer_transit_gateway_id: String, transit_gateway_id: String, peer_region: String, options: Option<String>, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, peer_account_id: String) -> Result<String> {
