...
impl<'a> Vpc_endpoint_service_configuration<'a> {
    ...
    pub async fn create(&self, network_load_balancer_arns: Option<Vec<String>>, dry_run: Option<bool>, gateway_load_balancer_arns: Option<Vec<String>>, supported_regions: Option<Vec<String>>, tag_specifications: Option<Vec<String>>, client_token: Option<String>, supported_ip_address_types: Option<Vec<String>>, acceptance_required: Option<bool>, private_dns_name: Option<String>) -> Result<String> {
