...
impl<'a> Transit_gateway_route<'a> {
    ...
    pub async fn create(&self, destination_cidr_block: String, transit_gateway_route_table_id: String, transit_gateway_attachment_id: Option<String>, blackhole: Option<bool>, dry_run: Option<bool>) -> Result<String> {
