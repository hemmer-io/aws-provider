...
impl<'a> Transit_gateway_connect_peer<'a> {
    ...
    pub async fn create(&self, bgp_options: Option<String>, inside_cidr_blocks: Vec<String>, transit_gateway_attachment_id: String, transit_gateway_address: Option<String>, peer_address: String, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>) -> Result<String> {
