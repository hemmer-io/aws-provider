...
impl<'a> Launch_template_version<'a> {
    ...
    pub async fn create(&self, version_description: Option<String>, launch_template_id: Option<String>, launch_template_name: Option<String>, source_version: Option<String>, client_token: Option<String>, dry_run: Option<bool>, launch_template_data: String, resolve_alias: Option<bool>) -> Result<String> {
