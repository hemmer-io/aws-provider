...
impl<'a> Vpc_peering_connection<'a> {
    ...
    pub async fn create(&self, vpc_id: String, dry_run: Option<bool>, peer_region: Option<String>, tag_specifications: Option<Vec<String>>, peer_vpc_id: Option<String>, peer_owner_id: Option<String>) -> Result<String> {
