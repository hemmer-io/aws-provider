...
impl<'a> Local_gateway_virtual_interface<'a> {
    ...
    pub async fn create(&self, local_gateway_virtual_interface_group_id: String, vlan: i64, tag_specifications: Option<Vec<String>>, local_address: String, peer_address: String, dry_run: Option<bool>, peer_bgp_asn_extended: Option<i64>, outpost_lag_id: String, peer_bgp_asn: Option<i64>) -> Result<String> {
