...
impl<'a> Event_data_store<'a> {
    ...
    pub async fn create(&self, name: String, organization_enabled: Option<bool>, retention_period: Option<i64>, tags_list: Option<Vec<String>>, kms_key_id: Option<String>, billing_mode: Option<String>, termination_protection_enabled: Option<bool>, advanced_event_selectors: Option<Vec<String>>, start_ingestion: Option<bool>, multi_region_enabled: Option<bool>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, organization_enabled: Option<bool>, retention_period: Option<i64>, tags_list: Option<Vec<String>>, kms_key_id: Option<String>, billing_mode: Option<String>, termination_protection_enabled: Option<bool>, advanced_event_selectors: Option<Vec<String>>, start_ingestion: Option<bool>, multi_region_enabled: Option<bool>) -> Result<()> {
