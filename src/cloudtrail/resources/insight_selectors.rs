...
impl<'a> Insight_selectors<'a> {
    ...
    pub async fn create(&self, event_data_store: Option<String>, trail_name: Option<String>, insight_selectors: Vec<String>, insights_destination: Option<String>) -> Result<String> {
