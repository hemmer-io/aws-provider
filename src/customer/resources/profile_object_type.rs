...
impl<'a> Profile_object_type<'a> {
    ...
    pub async fn create(&self, domain_name: String, template_id: Option<String>, encryption_key: Option<String>, expiration_days: Option<i64>, allow_profile_creation: Option<bool>, source_last_updated_timestamp_format: Option<String>, max_profile_object_count: Option<i64>, fields: Option<HashMap<String, String>>, keys: Option<HashMap<String, Vec<String>>>, tags: Option<HashMap<String, String>>, object_type_name: String, description: String) -> Result<String> {
