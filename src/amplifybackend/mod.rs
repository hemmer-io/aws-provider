...
impl<'a> AmplifybackendService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "backend_config" => self.plan_backend_config(current_state, desired_input).await,
            "backend_job" => self.plan_backend_job(current_state, desired_input).await,
            "backend_api" => self.plan_backend_api(current_state, desired_input).await,
            "backend_api_models" => {
                self.plan_backend_api_models(current_state, desired_input)
                    .await
            }
            "backend_auth" => self.plan_backend_auth(current_state, desired_input).await,
            "backend_storage" => {
                self.plan_backend_storage(current_state, desired_input)
                    .await
            }
            "token" => self.plan_token(current_state, desired_input).await,
            "backend" => self.plan_backend(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "amplifybackend", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "backend_config" => self.create_backend_config(input).await,
            "backend_job" => self.create_backend_job(input).await,
            "backend_api" => self.create_backend_api(input).await,
            "backend_api_models" => self.create_backend_api_models(input).await,
            "backend_auth" => self.create_backend_auth(input).await,
            "backend_storage" => self.create_backend_storage(input).await,
            "token" => self.create_token(input).await,
            "backend" => self.create_backend(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "amplifybackend", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "backend_config" => self.read_backend_config(id).await,
            "backend_job" => self.read_backend_job(id).await,
            "backend_api" => self.read_backend_api(id).await,
            "backend_api_models" => self.read_backend_api_models(id).await,
            "backend_auth" => self.read_backend_auth(id).await,
            "backend_storage" => self.read_backend_storage(id).await,
            "token" => self.read_token(id).await,
            "backend" => self.read_backend(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "amplifybackend", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "backend_config" => self.update_backend_config(id, input).await,
            "backend_job" => self.update_backend_job(id, input).await,
            "backend_api" => self.update_backend_api(id, input).await,
            "backend_api_models" => self.update_backend_api_models(id, input).await,
            "backend_auth" => self.update_backend_auth(id, input).await,
            "backend_storage" => self.update_backend_storage(id, input).await,
            "token" => self.update_token(id, input).await,
            "backend" => self.update_backend(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "amplifybackend", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "backend_config" => self.delete_backend_config(id).await,
            "backend_job" => self.delete_backend_job(id).await,
            "backend_api" => self.delete_backend_api(id).await,
            "backend_api_models" => self.delete_backend_api_models(id).await,
            "backend_auth" => self.delete_backend_auth(id).await,
            "backend_storage" => self.delete_backend_storage(id).await,
            "token" => self.delete_token(id).await,
            "backend" => self.delete_backend(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "amplifybackend", resource_name
            ))),
    ...
    async fn create_backend_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    backend_manager_app_id.unwrap_or_default(),
                ))
        })
    }

    /// Read a backend_config resource
    async fn read_backend_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_backend_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_backend_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    backend_environment_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a backend_job resource
    async fn read_backend_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.amplifybackend_client
    ...
    async fn update_backend_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let job_id = input.get_string("job_id")?;
            let operation = input.get_optional_string("operation")?;
    ...
    async fn delete_backend_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.amplifybackend_client
    ...
    async fn create_backend_api(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_backend_api(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.amplifybackend_client
    ...
    async fn update_backend_api(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let resource_name = input.get_string("resource_name")?;
            let app_id = input.get_string("app_id")?;
    ...
    async fn delete_backend_api(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.amplifybackend_client
    ...
    async fn create_backend_api_models(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_backend_api_models(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.amplifybackend_client
    ...
    async fn delete_backend_api_models(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.amplifybackend_client
    ...
    async fn create_backend_auth(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let resource_name = input.get_string("resource_name")?;
    ...
    async fn read_backend_auth(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.amplifybackend_client
    ...
    async fn update_backend_auth(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let resource_name = input.get_string("resource_name")?;
            let backend_environment_name = input.get_string("backend_environment_name")?;
    ...
    async fn delete_backend_auth(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.amplifybackend_client
    ...
    async fn create_backend_storage(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let app_id = input.get_string("app_id")?;
    ...
    async fn read_backend_storage(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.amplifybackend_client
    ...
    async fn delete_backend_storage(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.amplifybackend_client
    ...
    async fn create_backend(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let backend_environment_name = input.get_string("backend_environment_name")?;
    ...
    async fn read_backend(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.amplifybackend_client
    ...
    async fn update_backend(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let backend_environment_name = input.get_string("backend_environment_name")?;
            let app_id = input.get_string("app_id")?;
    ...
    async fn delete_backend(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.amplifybackend_client
