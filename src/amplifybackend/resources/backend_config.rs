...
impl<'a> Backend_config<'a> {
    ...
    pub async fn create(&self, app_id: String, backend_manager_app_id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, app_id: Option<String>, backend_manager_app_id: Option<String>) -> Result<()> {
