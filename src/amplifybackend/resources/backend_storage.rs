...
impl<'a> Backend_storage<'a> {
    ...
    pub async fn create(&self, app_id: String, resource_config: String, backend_environment_name: String, resource_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, app_id: Option<String>, resource_config: Option<String>, backend_environment_name: Option<String>, resource_name: Option<String>) -> Result<()> {
