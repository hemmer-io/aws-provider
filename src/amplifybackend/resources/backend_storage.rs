...
impl<'a> Backend_storage<'a> {
    ...
    pub async fn create(&self, app_id: String, backend_environment_name: String, resource_name: String, resource_config: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, app_id: Option<String>, backend_environment_name: Option<String>, resource_name: Option<String>, resource_config: Option<String>) -> Result<()> {
