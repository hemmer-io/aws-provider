...
impl<'a> Backend_auth<'a> {
    ...
    pub async fn create(&self, resource_name: String, backend_environment_name: String, app_id: String, resource_config: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, resource_name: Option<String>, backend_environment_name: Option<String>, app_id: Option<String>, resource_config: Option<String>) -> Result<()> {
