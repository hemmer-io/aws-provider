...
impl<'a> Backend_job<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, job_id: Option<String>, operation: Option<String>, status: Option<String>, app_id: Option<String>, backend_environment_name: Option<String>) -> Result<()> {
