...
impl<'a> License_specifications_for_resource<'a> {
    ...
    pub async fn update(&self, id: &str, add_license_specifications: Option<Vec<String>>, remove_license_specifications: Option<Vec<String>>, resource_arn: Option<String>) -> Result<()> {
