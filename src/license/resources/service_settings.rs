...
impl<'a> Service_settings<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, linux_subscriptions_discovery: Option<String>, allow_update: Option<bool>, linux_subscriptions_discovery_settings: Option<String>) -> Result<()> {
