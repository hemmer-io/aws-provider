...
impl<'a> License_manager_report_generator<'a> {
    ...
    pub async fn create(&self, report_context: String, type: Vec<String>, description: Option<String>, report_generator_name: String, tags: Option<Vec<String>>, client_token: String, report_frequency: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, report_context: Option<String>, type: Option<Vec<String>>, description: Option<String>, report_generator_name: Option<String>, tags: Option<Vec<String>>, client_token: Option<String>, report_frequency: Option<String>) -> Result<()> {
