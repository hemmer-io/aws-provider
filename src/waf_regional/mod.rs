//! Waf_regional service for Aws provider
//!
//! This module handles all waf_regional resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Waf_regional service handler
pub struct Waf_regionalService<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Waf_regionalService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "byte_match_set" => self.plan_byte_match_set(current_state, desired_input).await,
            ...
            "xss_match_set" => self.plan_xss_match_set(current_state, desired_input).await,
            "web_acl_for_resource" => {
                self.plan_web_acl_for_resource(current_state, desired_input)
                    .await
            }
            "rate_based_rule" => {
                self.plan_rate_based_rule(current_state, desired_input)
                    .await
            }
            "size_constraint_set" => {
                self.plan_size_constraint_set(current_state, desired_input)
                    .await
            }
            ...
            "change_token_status" => {
                self.plan_change_token_status(current_state, desired_input)
                    .await
            }
            "rate_based_rule_managed_keys" => {
                self.plan_rate_based_rule_managed_keys(current_state, desired_input)
                    .await
            }
            ...
            "geo_match_set" => self.plan_geo_match_set(current_state, desired_input).await,
            "sql_injection_match_set" => {
                self.plan_sql_injection_match_set(current_state, desired_input)
                    .await
            }
            "regex_match_set" => {
                self.plan_regex_match_set(current_state, desired_input)
                    .await
            }
            "permission_policy" => {
            ...
            "web_acl_migration_stack" => {
                self.plan_web_acl_migration_stack(current_state, desired_input)
                    .await
            }
            "change_token" => self.plan_change_token(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "waf_regional", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "byte_match_set" => self.create_byte_match_set(input).await,
            ...
            "xss_match_set" => self.create_xss_match_set(input).await,
            "web_acl_for_resource" => self.create_web_acl_for_resource(input).await,
            "rate_based_rule" => self.create_rate_based_rule(input).await,
            "size_constraint_set" => self.create_size_constraint_set(input).await,
            ...
            "change_token_status" => self.create_change_token_status(input).await,
            "rate_based_rule_managed_keys" => self.create_rate_based_rule_managed_keys(input).await,
            "logging_configuration" => self.create_logging_configuration(input).await,
            "geo_match_set" => self.create_geo_match_set(input).await,
            "sql_injection_match_set" => self.create_sql_injection_match_set(input).await,
            "regex_match_set" => self.create_regex_match_set(input).await,
            "permission_policy" => self.create_permission_policy(input).await,
            "web_acl_migration_stack" => self.create_web_acl_migration_stack(input).await,
            "change_token" => self.create_change_token(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "waf_regional", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "byte_match_set" => self.read_byte_match_set(id).await,
            ...
            "xss_match_set" => self.read_xss_match_set(id).await,
            "web_acl_for_resource" => self.read_web_acl_for_resource(id).await,
            "rate_based_rule" => self.read_rate_based_rule(id).await,
            "size_constraint_set" => self.read_size_constraint_set(id).await,
            "web_acl" => self.read_web_acl(id).await,
            "ip_set" => self.read_ip_set(id).await,
            "rule_group" => self.read_rule_group(id).await,
            "change_token_status" => self.read_change_token_status(id).await,
            "rate_based_rule_managed_keys" => self.read_rate_based_rule_managed_keys(id).await,
            "logging_configuration" => self.read_logging_configuration(id).await,
            "geo_match_set" => self.read_geo_match_set(id).await,
            "sql_injection_match_set" => self.read_sql_injection_match_set(id).await,
            "regex_match_set" => self.read_regex_match_set(id).await,
            "permission_policy" => self.read_permission_policy(id).await,
            "web_acl_migration_stack" => self.read_web_acl_migration_stack(id).await,
            "change_token" => self.read_change_token(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "waf_regional", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "byte_match_set" => self.update_byte_match_set(id, input).await,
            ...
            "xss_match_set" => self.update_xss_match_set(id, input).await,
            "web_acl_for_resource" => self.update_web_acl_for_resource(id, input).await,
            "rate_based_rule" => self.update_rate_based_rule(id, input).await,
            "size_constraint_set" => self.update_size_constraint_set(id, input).await,
            ...
            "change_token_status" => self.update_change_token_status(id, input).await,
            "rate_based_rule_managed_keys" => {
            ...
            "geo_match_set" => self.update_geo_match_set(id, input).await,
            "sql_injection_match_set" => self.update_sql_injection_match_set(id, input).await,
            "regex_match_set" => self.update_regex_match_set(id, input).await,
            "permission_policy" => self.update_permission_policy(id, input).await,
            "web_acl_migration_stack" => self.update_web_acl_migration_stack(id, input).await,
            "change_token" => self.update_change_token(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "waf_regional", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "byte_match_set" => self.delete_byte_match_set(id).await,
            ...
            "xss_match_set" => self.delete_xss_match_set(id).await,
            "web_acl_for_resource" => self.delete_web_acl_for_resource(id).await,
            "rate_based_rule" => self.delete_rate_based_rule(id).await,
            "size_constraint_set" => self.delete_size_constraint_set(id).await,
            "web_acl" => self.delete_web_acl(id).await,
            "ip_set" => self.delete_ip_set(id).await,
            "rule_group" => self.delete_rule_group(id).await,
            "change_token_status" => self.delete_change_token_status(id).await,
            "rate_based_rule_managed_keys" => self.delete_rate_based_rule_managed_keys(id).await,
            "logging_configuration" => self.delete_logging_configuration(id).await,
            "geo_match_set" => self.delete_geo_match_set(id).await,
            "sql_injection_match_set" => self.delete_sql_injection_match_set(id).await,
            "regex_match_set" => self.delete_regex_match_set(id).await,
            "permission_policy" => self.delete_permission_policy(id).await,
            "web_acl_migration_stack" => self.delete_web_acl_migration_stack(id).await,
            "change_token" => self.delete_change_token(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "waf_regional", resource_name
            ))),
    ...
    async fn create_byte_match_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_byte_match_set(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_byte_match_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_xss_match_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let change_token = input.get_string("change_token")?;
    ...
    async fn read_xss_match_set(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.waf_regional_client
    ...
    async fn update_xss_match_set(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let change_token = input.get_string("change_token")?;
            let name = input.get_string("name")?;
    ...
    async fn delete_xss_match_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.waf_regional_client
    ...
    async fn create_rate_based_rule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_rate_based_rule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.waf_regional_client
    ...
    async fn delete_rate_based_rule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.waf_regional_client
    ...
    async fn create_size_constraint_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
    ...
    async fn read_size_constraint_set(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.waf_regional_client
    ...
    async fn delete_size_constraint_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.waf_regional_client
    ...
    async fn create_change_token_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_change_token_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.waf_regional_client
    ...
    async fn delete_change_token_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.waf_regional_client
    ...
    async fn read_rate_based_rule_managed_keys(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.waf_regional_client
    ...
    async fn delete_rate_based_rule_managed_keys(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.waf_regional_client
    ...
    async fn create_geo_match_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let change_token = input.get_string("change_token")?;
    ...
    async fn read_geo_match_set(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.waf_regional_client
    ...
    async fn update_geo_match_set(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let change_token = input.get_string("change_token")?;
            let name = input.get_string("name")?;
    ...
    async fn delete_geo_match_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.waf_regional_client
    ...
    async fn create_sql_injection_match_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let change_token = input.get_string("change_token")?;
    ...
    async fn read_sql_injection_match_set(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.waf_regional_client
    ...
    async fn delete_sql_injection_match_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.waf_regional_client
    ...
    async fn create_regex_match_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
    ...
    async fn read_regex_match_set(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.waf_regional_client
    ...
    async fn delete_regex_match_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.waf_regional_client
    ...
    async fn create_web_acl_migration_stack(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    ignore_unsupported_type.unwrap_or_default(),
                )
    ...
    async fn read_web_acl_migration_stack(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.waf_regional_client
    ...
    async fn delete_web_acl_migration_stack(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.waf_regional_client
    ...
    async fn create_change_token(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_change_token(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.waf_regional_client
    ...
    async fn update_change_token(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_change_token(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.waf_regional_client
