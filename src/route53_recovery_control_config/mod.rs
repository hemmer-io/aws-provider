...
impl<'a> Route53_recovery_control_configService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "control_panel" => self.plan_control_panel(current_state, desired_input).await,
            "safety_rule" => self.plan_safety_rule(current_state, desired_input).await,
            "resource_policy" => {
                self.plan_resource_policy(current_state, desired_input)
                    .await
            }
            "routing_control" => {
                self.plan_routing_control(current_state, desired_input)
                    .await
            }
            "cluster" => self.plan_cluster(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route53_recovery_control_config", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "control_panel" => self.create_control_panel(input).await,
            "safety_rule" => self.create_safety_rule(input).await,
            "resource_policy" => self.create_resource_policy(input).await,
            "routing_control" => self.create_routing_control(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "control_panel" => self.read_control_panel(id).await,
            "safety_rule" => self.read_safety_rule(id).await,
            "resource_policy" => self.read_resource_policy(id).await,
            "routing_control" => self.read_routing_control(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "control_panel" => self.update_control_panel(id, input).await,
            "safety_rule" => self.update_safety_rule(id, input).await,
            "resource_policy" => self.update_resource_policy(id, input).await,
            "routing_control" => self.update_routing_control(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "control_panel" => self.delete_control_panel(id).await,
            "safety_rule" => self.delete_safety_rule(id).await,
            "resource_policy" => self.delete_resource_policy(id).await,
            "routing_control" => self.delete_routing_control(id).await,
    ...
    async fn create_control_panel(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_control_panel(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_control_panel(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let cluster_arn = input.get_string("cluster_arn")?;
            let client_token = input.get_optional_string("client_token")?;
    ...
    async fn delete_control_panel(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_safety_rule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_safety_rule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route53_recovery_control_config_client
    ...
    async fn update_safety_rule(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let gating_rule = input.get_optional_string("gating_rule")?;
    ...
    async fn delete_safety_rule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route53_recovery_control_config_client
    ...
    async fn create_routing_control(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    routing_control_name.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default()))
        })
    }
    ...
    async fn read_routing_control(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route53_recovery_control_config_client
    ...
    async fn delete_routing_control(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route53_recovery_control_config_client
