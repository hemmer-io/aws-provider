...
impl<'a> Integration_association<'a> {
    ...
    pub async fn create(&self, integration_arn: String, source_application_name: Option<String>, tags: Option<HashMap<String, String>>, source_application_url: Option<String>, integration_type: String, source_type: Option<String>, instance_id: String) -> Result<String> {
