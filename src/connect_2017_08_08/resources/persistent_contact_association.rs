...
impl<'a> Persistent_contact_association<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, initial_contact_id: String, source_contact_id: String, instance_id: String, rehydration_type: String) -> Result<String> {
