...
impl<'a> Instance_storage_config<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, instance_id: Option<String>, association_id: Option<String>, resource_type: Option<String>, storage_config: Option<String>, client_token: Option<String>) -> Result<()> {
