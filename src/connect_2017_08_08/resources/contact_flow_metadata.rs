...
impl<'a> Contact_flow_metadata<'a> {
    ...
    pub async fn update(&self, id: &str, name: Option<String>, contact_flow_state: Option<String>, contact_flow_id: Option<String>, description: Option<String>, instance_id: Option<String>) -> Result<()> {
