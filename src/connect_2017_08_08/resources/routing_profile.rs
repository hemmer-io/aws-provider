...
impl<'a> Routing_profile<'a> {
    ...
    pub async fn create(&self, queue_configs: Option<Vec<String>>, instance_id: String, manual_assignment_queue_configs: Option<Vec<String>>, name: String, tags: Option<HashMap<String, String>>, description: String, media_concurrencies: Vec<String>, agent_availability_timer: Option<String>, default_outbound_queue_id: String) -> Result<String> {
