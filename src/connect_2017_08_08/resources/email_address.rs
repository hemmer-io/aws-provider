...
impl<'a> Email_address<'a> {
    ...
    pub async fn create(&self, display_name: Option<String>, client_token: Option<String>, description: Option<String>, instance_id: String, email_address: String, tags: Option<HashMap<String, String>>) -> Result<String> {
