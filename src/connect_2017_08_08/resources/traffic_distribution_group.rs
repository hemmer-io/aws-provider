...
impl<'a> Traffic_distribution_group<'a> {
    ...
    pub async fn create(&self, description: Option<String>, instance_id: String, client_token: Option<String>, name: String, tags: Option<HashMap<String, String>>) -> Result<String> {
