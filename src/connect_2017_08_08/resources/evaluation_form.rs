...
impl<'a> Evaluation_form<'a> {
    ...
    pub async fn create(&self, title: String, description: Option<String>, scoring_strategy: Option<String>, items: Vec<String>, client_token: Option<String>, instance_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, title: Option<String>, description: Option<String>, scoring_strategy: Option<String>, items: Option<Vec<String>>, client_token: Option<String>, instance_id: Option<String>) -> Result<()> {
