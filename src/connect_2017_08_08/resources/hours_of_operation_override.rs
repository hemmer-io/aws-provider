...
impl<'a> Hours_of_operation_override<'a> {
    ...
    pub async fn create(&self, description: Option<String>, effective_till: String, hours_of_operation_id: String, name: String, config: Vec<String>, effective_from: String, instance_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, effective_till: Option<String>, hours_of_operation_id: Option<String>, name: Option<String>, config: Option<Vec<String>>, effective_from: Option<String>, instance_id: Option<String>) -> Result<()> {
