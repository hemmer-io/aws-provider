...
impl<'a> Repository_link<'a> {
    ...
    pub async fn create(&self, repository_name: String, owner_id: String, tags: Option<Vec<String>>, connection_arn: String, encryption_key_arn: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, repository_name: Option<String>, owner_id: Option<String>, tags: Option<Vec<String>>, connection_arn: Option<String>, encryption_key_arn: Option<String>) -> Result<()> {
