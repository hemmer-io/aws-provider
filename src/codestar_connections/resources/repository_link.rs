...
impl<'a> Repository_link<'a> {
    ...
    pub async fn create(&self, owner_id: String, connection_arn: String, repository_name: String, tags: Option<Vec<String>>, encryption_key_arn: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, owner_id: Option<String>, connection_arn: Option<String>, repository_name: Option<String>, tags: Option<Vec<String>>, encryption_key_arn: Option<String>) -> Result<()> {
