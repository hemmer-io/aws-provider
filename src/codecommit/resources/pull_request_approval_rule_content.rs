...
impl<'a> Pull_request_approval_rule_content<'a> {
    ...
    pub async fn update(&self, id: &str, approval_rule_name: Option<String>, pull_request_id: Option<String>, existing_rule_content_sha256: Option<String>, new_rule_content: Option<String>) -> Result<()> {
