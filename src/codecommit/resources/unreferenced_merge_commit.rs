...
impl<'a> Unreferenced_merge_commit<'a> {
    ...
    pub async fn create(&self, commit_message: Option<String>, conflict_resolution: Option<String>, merge_option: String, conflict_resolution_strategy: Option<String>, destination_commit_specifier: String, source_commit_specifier: String, conflict_detail_level: Option<String>, keep_empty_folders: Option<bool>, email: Option<String>, repository_name: String, author_name: Option<String>) -> Result<String> {
