...
impl<'a> Approval_rule_template_content<'a> {
    ...
    pub async fn update(&self, id: &str, existing_rule_content_sha256: Option<String>, approval_rule_template_name: Option<String>, new_rule_content: Option<String>) -> Result<()> {
