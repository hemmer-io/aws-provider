...
impl<'a> Approval_rule_template<'a> {
    ...
    pub async fn create(&self, approval_rule_template_name: String, approval_rule_template_content: String, approval_rule_template_description: Option<String>) -> Result<String> {
