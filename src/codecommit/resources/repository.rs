...
impl<'a> Repository<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, repository_description: Option<String>, repository_name: String, kms_key_id: Option<String>) -> Result<String> {
