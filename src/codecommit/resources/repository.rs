...
impl<'a> Repository<'a> {
    ...
    pub async fn create(&self, repository_description: Option<String>, repository_name: String, tags: Option<HashMap<String, String>>, kms_key_id: Option<String>) -> Result<String> {
