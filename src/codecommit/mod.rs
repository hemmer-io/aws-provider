...
impl<'a> CodecommitService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "pull_request_approval_rule" => {
                self.plan_pull_request_approval_rule(current_state, desired_input)
                    .await
            }
            "pull_request_approval_states" => {
                self.plan_pull_request_approval_states(current_state, desired_input)
                    .await
            }
            "comments_for_compared_commit" => {
                self.plan_comments_for_compared_commit(current_state, desired_input)
                    .await
            }
            "repository_name" => {
                self.plan_repository_name(current_state, desired_input)
                    .await
            }
            ...
            "comments_for_pull_request" => {
                self.plan_comments_for_pull_request(current_state, desired_input)
                    .await
            }
            "merge_conflicts" => {
                self.plan_merge_conflicts(current_state, desired_input)
                    .await
            }
            "merge_options" => self.plan_merge_options(current_state, desired_input).await,
            "approval_rule_template_name" => {
                self.plan_approval_rule_template_name(current_state, desired_input)
                    .await
            }
            "blob" => self.plan_blob(current_state, desired_input).await,
            "repository_encryption_key" => {
                self.plan_repository_encryption_key(current_state, desired_input)
                    .await
            }
            "pull_request" => self.plan_pull_request(current_state, desired_input).await,
            "approval_rule_template_description" => {
                self.plan_approval_rule_template_description(current_state, desired_input)
                    .await
            }
            "pull_request_title" => {
                self.plan_pull_request_title(current_state, desired_input)
                    .await
            }
            "comment" => self.plan_comment(current_state, desired_input).await,
            "comment_reactions" => {
                self.plan_comment_reactions(current_state, desired_input)
                    .await
            }
            "approval_rule_template" => {
                self.plan_approval_rule_template(current_state, desired_input)
                    .await
            }
            "merge_commit" => self.plan_merge_commit(current_state, desired_input).await,
            "pull_request_description" => {
                self.plan_pull_request_description(current_state, desired_input)
                    .await
            }
            "pull_request_approval_state" => {
                self.plan_pull_request_approval_state(current_state, desired_input)
                    .await
            }
            "pull_request_override_state" => {
                self.plan_pull_request_override_state(current_state, desired_input)
                    .await
            }
            "pull_request_events" => {
                self.plan_pull_request_events(current_state, desired_input)
                    .await
            }
            "repository" => self.plan_repository(current_state, desired_input).await,
            "repository_triggers" => {
                self.plan_repository_triggers(current_state, desired_input)
                    .await
            }
            "comment_content" => {
                self.plan_comment_content(current_state, desired_input)
                    .await
            }
            "repository_description" => {
                self.plan_repository_description(current_state, desired_input)
                    .await
            }
            "pull_request_approval_rule_content" => {
                self.plan_pull_request_approval_rule_content(current_state, desired_input)
                    .await
            }
            "approval_rule_template_content" => {
                self.plan_approval_rule_template_content(current_state, desired_input)
                    .await
            }
            "comment_reaction" => {
                self.plan_comment_reaction(current_state, desired_input)
                    .await
            }
            "folder" => self.plan_folder(current_state, desired_input).await,
            "unreferenced_merge_commit" => {
                self.plan_unreferenced_merge_commit(current_state, desired_input)
                    .await
            }
            "pull_request_status" => {
                self.plan_pull_request_status(current_state, desired_input)
                    .await
            }
            "default_branch" => self.plan_default_branch(current_state, desired_input).await,
            "commit" => self.plan_commit(current_state, desired_input).await,
            "differences" => self.plan_differences(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codecommit", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "pull_request_approval_rule" => self.create_pull_request_approval_rule(input).await,
            "pull_request_approval_states" => self.create_pull_request_approval_states(input).await,
            "comments_for_compared_commit" => self.create_comments_for_compared_commit(input).await,
            "repository_name" => self.create_repository_name(input).await,
            "file" => self.create_file(input).await,
            "branch" => self.create_branch(input).await,
            "comments_for_pull_request" => self.create_comments_for_pull_request(input).await,
            "merge_conflicts" => self.create_merge_conflicts(input).await,
            "merge_options" => self.create_merge_options(input).await,
            "approval_rule_template_name" => self.create_approval_rule_template_name(input).await,
            "blob" => self.create_blob(input).await,
            "repository_encryption_key" => self.create_repository_encryption_key(input).await,
            "pull_request" => self.create_pull_request(input).await,
            "approval_rule_template_description" => {
                self.create_approval_rule_template_description(input).await
            }
            "pull_request_title" => self.create_pull_request_title(input).await,
            "comment" => self.create_comment(input).await,
            "comment_reactions" => self.create_comment_reactions(input).await,
            "approval_rule_template" => self.create_approval_rule_template(input).await,
            "merge_commit" => self.create_merge_commit(input).await,
            "pull_request_description" => self.create_pull_request_description(input).await,
            "pull_request_approval_state" => self.create_pull_request_approval_state(input).await,
            "pull_request_override_state" => self.create_pull_request_override_state(input).await,
            "pull_request_events" => self.create_pull_request_events(input).await,
            "repository" => self.create_repository(input).await,
            "repository_triggers" => self.create_repository_triggers(input).await,
            "comment_content" => self.create_comment_content(input).await,
            "repository_description" => self.create_repository_description(input).await,
            "pull_request_approval_rule_content" => {
            ...
            "comment_reaction" => self.create_comment_reaction(input).await,
            "folder" => self.create_folder(input).await,
            "unreferenced_merge_commit" => self.create_unreferenced_merge_commit(input).await,
            "pull_request_status" => self.create_pull_request_status(input).await,
            "default_branch" => self.create_default_branch(input).await,
            "commit" => self.create_commit(input).await,
            "differences" => self.create_differences(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codecommit", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "pull_request_approval_rule" => self.read_pull_request_approval_rule(id).await,
            "pull_request_approval_states" => self.read_pull_request_approval_states(id).await,
            "comments_for_compared_commit" => self.read_comments_for_compared_commit(id).await,
            "repository_name" => self.read_repository_name(id).await,
            "file" => self.read_file(id).await,
            "branch" => self.read_branch(id).await,
            "comments_for_pull_request" => self.read_comments_for_pull_request(id).await,
            "merge_conflicts" => self.read_merge_conflicts(id).await,
            "merge_options" => self.read_merge_options(id).await,
            "approval_rule_template_name" => self.read_approval_rule_template_name(id).await,
            "blob" => self.read_blob(id).await,
            "repository_encryption_key" => self.read_repository_encryption_key(id).await,
            "pull_request" => self.read_pull_request(id).await,
            "approval_rule_template_description" => {
                self.read_approval_rule_template_description(id).await
            }
            "pull_request_title" => self.read_pull_request_title(id).await,
            "comment" => self.read_comment(id).await,
            "comment_reactions" => self.read_comment_reactions(id).await,
            "approval_rule_template" => self.read_approval_rule_template(id).await,
            "merge_commit" => self.read_merge_commit(id).await,
            "pull_request_description" => self.read_pull_request_description(id).await,
            "pull_request_approval_state" => self.read_pull_request_approval_state(id).await,
            "pull_request_override_state" => self.read_pull_request_override_state(id).await,
            "pull_request_events" => self.read_pull_request_events(id).await,
            "repository" => self.read_repository(id).await,
            "repository_triggers" => self.read_repository_triggers(id).await,
            "comment_content" => self.read_comment_content(id).await,
            "repository_description" => self.read_repository_description(id).await,
            "pull_request_approval_rule_content" => {
                self.read_pull_request_approval_rule_content(id).await
            }
            "approval_rule_template_content" => self.read_approval_rule_template_content(id).await,
            "comment_reaction" => self.read_comment_reaction(id).await,
            "folder" => self.read_folder(id).await,
            "unreferenced_merge_commit" => self.read_unreferenced_merge_commit(id).await,
            "pull_request_status" => self.read_pull_request_status(id).await,
            "default_branch" => self.read_default_branch(id).await,
            "commit" => self.read_commit(id).await,
            "differences" => self.read_differences(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codecommit", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "pull_request_approval_rule" => self.update_pull_request_approval_rule(id, input).await,
            "pull_request_approval_states" => {
            ...
            "repository_name" => self.update_repository_name(id, input).await,
            "file" => self.update_file(id, input).await,
            "branch" => self.update_branch(id, input).await,
            "comments_for_pull_request" => self.update_comments_for_pull_request(id, input).await,
            "merge_conflicts" => self.update_merge_conflicts(id, input).await,
            "merge_options" => self.update_merge_options(id, input).await,
            "approval_rule_template_name" => {
                self.update_approval_rule_template_name(id, input).await
            }
            "blob" => self.update_blob(id, input).await,
            "repository_encryption_key" => self.update_repository_encryption_key(id, input).await,
            "pull_request" => self.update_pull_request(id, input).await,
            "approval_rule_template_description" => {
                self.update_approval_rule_template_description(id, input)
                    .await
            }
            "pull_request_title" => self.update_pull_request_title(id, input).await,
            "comment" => self.update_comment(id, input).await,
            "comment_reactions" => self.update_comment_reactions(id, input).await,
            "approval_rule_template" => self.update_approval_rule_template(id, input).await,
            "merge_commit" => self.update_merge_commit(id, input).await,
            "pull_request_description" => self.update_pull_request_description(id, input).await,
            "pull_request_approval_state" => {
            ...
            "pull_request_events" => self.update_pull_request_events(id, input).await,
            "repository" => self.update_repository(id, input).await,
            "repository_triggers" => self.update_repository_triggers(id, input).await,
            "comment_content" => self.update_comment_content(id, input).await,
            "repository_description" => self.update_repository_description(id, input).await,
            "pull_request_approval_rule_content" => {
                self.update_pull_request_approval_rule_content(id, input)
                    .await
            }
            "approval_rule_template_content" => {
                self.update_approval_rule_template_content(id, input).await
            }
            "comment_reaction" => self.update_comment_reaction(id, input).await,
            "folder" => self.update_folder(id, input).await,
            "unreferenced_merge_commit" => self.update_unreferenced_merge_commit(id, input).await,
            "pull_request_status" => self.update_pull_request_status(id, input).await,
            "default_branch" => self.update_default_branch(id, input).await,
            "commit" => self.update_commit(id, input).await,
            "differences" => self.update_differences(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codecommit", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "pull_request_approval_rule" => self.delete_pull_request_approval_rule(id).await,
            "pull_request_approval_states" => self.delete_pull_request_approval_states(id).await,
            "comments_for_compared_commit" => self.delete_comments_for_compared_commit(id).await,
            "repository_name" => self.delete_repository_name(id).await,
            "file" => self.delete_file(id).await,
            "branch" => self.delete_branch(id).await,
            "comments_for_pull_request" => self.delete_comments_for_pull_request(id).await,
            "merge_conflicts" => self.delete_merge_conflicts(id).await,
            "merge_options" => self.delete_merge_options(id).await,
            "approval_rule_template_name" => self.delete_approval_rule_template_name(id).await,
            "blob" => self.delete_blob(id).await,
            "repository_encryption_key" => self.delete_repository_encryption_key(id).await,
            "pull_request" => self.delete_pull_request(id).await,
            "approval_rule_template_description" => {
                self.delete_approval_rule_template_description(id).await
            }
            "pull_request_title" => self.delete_pull_request_title(id).await,
            "comment" => self.delete_comment(id).await,
            "comment_reactions" => self.delete_comment_reactions(id).await,
            "approval_rule_template" => self.delete_approval_rule_template(id).await,
            "merge_commit" => self.delete_merge_commit(id).await,
            "pull_request_description" => self.delete_pull_request_description(id).await,
            "pull_request_approval_state" => self.delete_pull_request_approval_state(id).await,
            "pull_request_override_state" => self.delete_pull_request_override_state(id).await,
            "pull_request_events" => self.delete_pull_request_events(id).await,
            "repository" => self.delete_repository(id).await,
            "repository_triggers" => self.delete_repository_triggers(id).await,
            "comment_content" => self.delete_comment_content(id).await,
            "repository_description" => self.delete_repository_description(id).await,
            "pull_request_approval_rule_content" => {
            ...
            "comment_reaction" => self.delete_comment_reaction(id).await,
            "folder" => self.delete_folder(id).await,
            "unreferenced_merge_commit" => self.delete_unreferenced_merge_commit(id).await,
            "pull_request_status" => self.delete_pull_request_status(id).await,
            "default_branch" => self.delete_default_branch(id).await,
            "commit" => self.delete_commit(id).await,
            "differences" => self.delete_differences(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codecommit", resource_name
            ))),
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    approval_rule_content.unwrap_or_default(),
                )
    ...
    async fn read_pull_request_approval_rule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_pull_request_approval_rule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_pull_request_approval_states(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_pull_request_approval_states(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn read_comments_for_compared_commit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_comments_for_compared_commit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_repository_name(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_repository_name(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_repository_name(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn read_comments_for_pull_request(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_comments_for_pull_request(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_merge_conflicts(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_merge_conflicts(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_merge_conflicts(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_merge_options(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_merge_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn update_merge_options(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_merge_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_approval_rule_template_name(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let new_approval_rule_template_name =
                input.get_string("new_approval_rule_template_name")?;
            let old_approval_rule_template_name =
                input.get_string("old_approval_rule_template_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    new_approval_rule_template_name.unwrap_or_default(),
                )
                .with_field(
                    "old_approval_rule_template_name",
                    old_approval_rule_template_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a approval_rule_template_name resource
    async fn read_approval_rule_template_name(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_approval_rule_template_name(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_blob(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_blob(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn update_blob(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_repository_encryption_key(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_repository_encryption_key(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_approval_rule_template_description(
        ...
        self.provider.runtime().block_on(async {
            ...
            let approval_rule_template_description =
                input.get_string("approval_rule_template_description")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "approval_rule_template_name",
                    approval_rule_template_name.unwrap_or_default(),
                )
                .with_field(
                    "approval_rule_template_description",
                    approval_rule_template_description.unwrap_or_default(),
                ))
        })
    }

    /// Read a approval_rule_template_description resource
    async fn read_approval_rule_template_description(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_approval_rule_template_description(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_pull_request_title(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let pull_request_id = input.get_string("pull_request_id")?;
    ...
    async fn read_pull_request_title(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_pull_request_title(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_comment_reactions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_comment_reactions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_comment_reactions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_approval_rule_template(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let approval_rule_template_name = input.get_string("approval_rule_template_name")?;
            let approval_rule_template_description =
                input.get_optional_string("approval_rule_template_description")?;
            let approval_rule_template_content =
                input.get_string("approval_rule_template_content")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "approval_rule_template_content",
                    approval_rule_template_content.unwrap_or_default(),
                ))
        })
    }

    /// Read a approval_rule_template resource
    async fn read_approval_rule_template(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_approval_rule_template(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_merge_commit(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_merge_commit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn update_merge_commit(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_merge_commit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn read_pull_request_description(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_pull_request_description(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn read_pull_request_approval_state(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_pull_request_approval_state(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn read_pull_request_override_state(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_pull_request_override_state(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_pull_request_events(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_pull_request_events(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_pull_request_events(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_repository(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "repository_description",
                    repository_description.unwrap_or_default(),
                )
                .with_field("kms_key_id", kms_key_id.unwrap_or_default()))
        })
    }
    ...
    async fn create_repository_triggers(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_repository_triggers(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_repository_triggers(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_comment_content(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_comment_content(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_comment_content(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_repository_description(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let repository_description = input.get_optional_string("repository_description")?;
    ...
    async fn read_repository_description(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_repository_description(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_pull_request_approval_rule_content(
        ...
        self.provider.runtime().block_on(async {
            ...
            let existing_rule_content_sha256 =
                input.get_optional_string("existing_rule_content_sha256")?;
            let approval_rule_name = input.get_string("approval_rule_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    existing_rule_content_sha256.unwrap_or_default(),
                )
                .with_field("approval_rule_name", approval_rule_name.unwrap_or_default()))
        })
    }
    ...
    async fn read_pull_request_approval_rule_content(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_pull_request_approval_rule_content(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn read_approval_rule_template_content(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_approval_rule_template_content(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_comment_reaction(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_comment_reaction(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_comment_reaction(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_unreferenced_merge_commit(
        ...
        self.provider.runtime().block_on(async {
            ...
            let conflict_resolution_strategy =
                input.get_optional_string("conflict_resolution_strategy")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    source_commit_specifier.unwrap_or_default(),
                )
                .with_field(
                    "conflict_detail_level",
                    conflict_detail_level.unwrap_or_default(),
                )
                .with_field("email", email.unwrap_or_default())
                ...
                .with_field(
                    "conflict_resolution",
                    conflict_resolution.unwrap_or_default(),
                )
                .with_field("repository_name", repository_name.unwrap_or_default())
                .with_field(
                    "destination_commit_specifier",
                    destination_commit_specifier.unwrap_or_default(),
                )
                .with_field("merge_option", merge_option.unwrap_or_default())
                .with_field(
                    "conflict_resolution_strategy",
                    conflict_resolution_strategy.unwrap_or_default(),
                ))
        })
    }

    /// Read a unreferenced_merge_commit resource
    async fn read_unreferenced_merge_commit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_unreferenced_merge_commit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_pull_request_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let pull_request_id = input.get_string("pull_request_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "pull_request_status",
                    pull_request_status.unwrap_or_default(),
                ))
        })
    }

    /// Read a pull_request_status resource
    async fn read_pull_request_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_pull_request_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_default_branch(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let repository_name = input.get_string("repository_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "default_branch_name",
                    default_branch_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a default_branch resource
    async fn read_default_branch(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn delete_default_branch(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_commit(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let commit_message = input.get_optional_string("commit_message")?;
    ...
    async fn read_commit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn update_commit(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let commit_message = input.get_optional_string("commit_message")?;
            let set_file_modes = input.get_optional_string("set_file_modes")?;
    ...
    async fn delete_commit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
    ...
    async fn create_differences(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_differences(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codecommit_client
    ...
    async fn update_differences(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_differences(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codecommit_client
