...
impl<'a> Application_instance<'a> {
    ...
    pub async fn create(&self, description: Option<String>, default_runtime_context_device: String, name: Option<String>, manifest_overrides_payload: Option<String>, application_instance_id_to_replace: Option<String>, tags: Option<HashMap<String, String>>, runtime_role_arn: Option<String>, manifest_payload: String) -> Result<String> {
