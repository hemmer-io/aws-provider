...
impl<'a> Node_from_template_job<'a> {
    ...
    pub async fn create(&self, output_package_name: String, node_description: Option<String>, job_tags: Option<Vec<String>>, node_name: String, output_package_version: String, template_type: String, template_parameters: HashMap<String, String>) -> Result<String> {
