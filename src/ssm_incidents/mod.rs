...
impl<'a> Ssm_incidentsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "incident_record" => {
                self.plan_incident_record(current_state, desired_input).await
            }
            "resource_policies" => {
            ...
            "related_items" => {
                self.plan_related_items(current_state, desired_input).await
            }
            "deletion_protection" => {
                self.plan_deletion_protection(current_state, desired_input).await
            }
            "response_plan" => {
                self.plan_response_plan(current_state, desired_input).await
            }
            "replication_set" => {
                self.plan_replication_set(current_state, desired_input).await
            }
            "timeline_event" => {
                self.plan_timeline_event(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "incident_record" => {
                self.create_incident_record(input).await
            }
            "resource_policies" => {
            ...
            "related_items" => {
                self.create_related_items(input).await
            }
            "deletion_protection" => {
                self.create_deletion_protection(input).await
            }
            "response_plan" => {
                self.create_response_plan(input).await
            }
            "replication_set" => {
                self.create_replication_set(input).await
            }
            "timeline_event" => {
                self.create_timeline_event(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ssm_incidents",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "incident_record" => {
                self.read_incident_record(id).await
            }
            "resource_policies" => {
            ...
            "related_items" => {
                self.read_related_items(id).await
            }
            "deletion_protection" => {
                self.read_deletion_protection(id).await
            }
            "response_plan" => {
                self.read_response_plan(id).await
            }
            "replication_set" => {
                self.read_replication_set(id).await
            }
            "timeline_event" => {
                self.read_timeline_event(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ssm_incidents",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "incident_record" => {
                self.update_incident_record(id, input).await
            }
            "resource_policies" => {
            ...
            "related_items" => {
                self.update_related_items(id, input).await
            }
            "deletion_protection" => {
                self.update_deletion_protection(id, input).await
            }
            "response_plan" => {
                self.update_response_plan(id, input).await
            }
            "replication_set" => {
                self.update_replication_set(id, input).await
            }
            "timeline_event" => {
                self.update_timeline_event(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ssm_incidents",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "incident_record" => {
                self.delete_incident_record(id).await
            }
            "resource_policies" => {
            ...
            "related_items" => {
                self.delete_related_items(id).await
            }
            "deletion_protection" => {
                self.delete_deletion_protection(id).await
            }
            "response_plan" => {
                self.delete_response_plan(id).await
            }
            "replication_set" => {
                self.delete_replication_set(id).await
            }
            "timeline_event" => {
                self.delete_timeline_event(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ssm_incidents",
    ...
    async fn create_incident_record(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("notification_targets", notification_targets.unwrap_or_default())
    ...
    async fn delete_incident_record(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_related_items(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("incident_record_arn", incident_record_arn.unwrap_or_default())
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field("related_items_update", related_items_update.unwrap_or_default())
            )
        })
    }

    /// Read a related_items resource
    async fn read_related_items(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_deletion_protection(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_deletion_protection(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_deletion_protection(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_replication_set(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_replication_set(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_timeline_event(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
