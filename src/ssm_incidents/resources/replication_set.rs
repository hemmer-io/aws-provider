...
impl<'a> Replication_set<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, client_token: Option<String>, regions: HashMap<String, String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, client_token: Option<String>, regions: Option<HashMap<String, String>>) -> Result<()> {
