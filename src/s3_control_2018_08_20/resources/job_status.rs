...
impl<'a> Job_status<'a> {
    ...
    pub async fn update(&self, id: &str, job_id: Option<String>, status_update_reason: Option<String>, account_id: Option<String>, requested_job_status: Option<String>) -> Result<()> {
