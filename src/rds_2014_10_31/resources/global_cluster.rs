...
impl<'a> Global_cluster<'a> {
    ...
    pub async fn create(&self, engine_version: Option<String>, storage_encrypted: Option<bool>, source_db_cluster_identifier: Option<String>, engine: Option<String>, deletion_protection: Option<bool>, engine_lifecycle_support: Option<String>, global_cluster_identifier: String, database_name: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
