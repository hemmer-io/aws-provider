...
impl<'a> Option_group<'a> {
    ...
    pub async fn create(&self, option_group_description: String, major_engine_version: String, tags: Option<Vec<String>>, engine_name: String, option_group_name: String) -> Result<String> {
