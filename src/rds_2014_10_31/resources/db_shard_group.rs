...
impl<'a> Db_shard_group<'a> {
    ...
    pub async fn create(&self, publicly_accessible: Option<bool>, db_cluster_identifier: String, compute_redundancy: Option<i64>, min_acu: Option<f64>, tags: Option<Vec<String>>, db_shard_group_identifier: String, max_acu: f64) -> Result<String> {
