...
impl<'a> Auto_scalingService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "load_balancer_target_groups" => {
                self.plan_load_balancer_target_groups(current_state, desired_input).await
            }
            "auto_scaling_instances" => {
                self.plan_auto_scaling_instances(current_state, desired_input).await
            }
            "adjustment_types" => {
                self.plan_adjustment_types(current_state, desired_input).await
            }
            "warm_pool" => {
                self.plan_warm_pool(current_state, desired_input).await
            }
            "scheduled_action" => {
            ...
            "launch_configurations" => {
                self.plan_launch_configurations(current_state, desired_input).await
            }
            "scaling_policy" => {
                self.plan_scaling_policy(current_state, desired_input).await
            }
            "scaling_process_types" => {
                self.plan_scaling_process_types(current_state, desired_input).await
            }
            "load_balancers" => {
                self.plan_load_balancers(current_state, desired_input).await
            }
            "traffic_sources" => {
                self.plan_traffic_sources(current_state, desired_input).await
            }
            "auto_scaling_group" => {
                self.plan_auto_scaling_group(current_state, desired_input).await
            }
            "termination_policy_types" => {
                self.plan_termination_policy_types(current_state, desired_input).await
            }
            "scheduled_actions" => {
                self.plan_scheduled_actions(current_state, desired_input).await
            }
            "lifecycle_hook" => {
                self.plan_lifecycle_hook(current_state, desired_input).await
            }
            "notification_configuration" => {
                self.plan_notification_configuration(current_state, desired_input).await
            }
            "instance_refreshes" => {
                self.plan_instance_refreshes(current_state, desired_input).await
            }
            "auto_scaling_notification_types" => {
                self.plan_auto_scaling_notification_types(current_state, desired_input).await
            }
            "policy" => {
                self.plan_policy(current_state, desired_input).await
            }
            "scheduled_update_group_action" => {
                self.plan_scheduled_update_group_action(current_state, desired_input).await
            }
            "launch_configuration" => {
                self.plan_launch_configuration(current_state, desired_input).await
            }
            "lifecycle_hook_types" => {
                self.plan_lifecycle_hook_types(current_state, desired_input).await
            }
            "notification_configurations" => {
                self.plan_notification_configurations(current_state, desired_input).await
            }
            "lifecycle_hooks" => {
                self.plan_lifecycle_hooks(current_state, desired_input).await
            }
            "account_limits" => {
                self.plan_account_limits(current_state, desired_input).await
            }
            "auto_scaling_groups" => {
                self.plan_auto_scaling_groups(current_state, desired_input).await
            }
            "metric_collection_types" => {
                self.plan_metric_collection_types(current_state, desired_input).await
            }
            "policies" => {
                self.plan_policies(current_state, desired_input).await
            }
            "scaling_activities" => {
            ...
            "or_update_tags" => {
                self.plan_or_update_tags(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "load_balancer_target_groups" => {
                self.create_load_balancer_target_groups(input).await
            }
            "auto_scaling_instances" => {
                self.create_auto_scaling_instances(input).await
            }
            "adjustment_types" => {
                self.create_adjustment_types(input).await
            }
            "warm_pool" => {
                self.create_warm_pool(input).await
            }
            "scheduled_action" => {
            ...
            "launch_configurations" => {
                self.create_launch_configurations(input).await
            }
            "scaling_policy" => {
                self.create_scaling_policy(input).await
            }
            "scaling_process_types" => {
                self.create_scaling_process_types(input).await
            }
            "load_balancers" => {
                self.create_load_balancers(input).await
            }
            "traffic_sources" => {
                self.create_traffic_sources(input).await
            }
            "auto_scaling_group" => {
                self.create_auto_scaling_group(input).await
            }
            "termination_policy_types" => {
                self.create_termination_policy_types(input).await
            }
            "scheduled_actions" => {
                self.create_scheduled_actions(input).await
            }
            "lifecycle_hook" => {
                self.create_lifecycle_hook(input).await
            }
            "notification_configuration" => {
                self.create_notification_configuration(input).await
            }
            "instance_refreshes" => {
                self.create_instance_refreshes(input).await
            }
            "auto_scaling_notification_types" => {
            ...
            "launch_configuration" => {
                self.create_launch_configuration(input).await
            }
            "lifecycle_hook_types" => {
                self.create_lifecycle_hook_types(input).await
            }
            "notification_configurations" => {
                self.create_notification_configurations(input).await
            }
            "lifecycle_hooks" => {
                self.create_lifecycle_hooks(input).await
            }
            "account_limits" => {
                self.create_account_limits(input).await
            }
            "auto_scaling_groups" => {
                self.create_auto_scaling_groups(input).await
            }
            "metric_collection_types" => {
                self.create_metric_collection_types(input).await
            }
            "policies" => {
                self.create_policies(input).await
            }
            "scaling_activities" => {
            ...
            "or_update_tags" => {
                self.create_or_update_tags(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "auto_scaling",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "load_balancer_target_groups" => {
                self.read_load_balancer_target_groups(id).await
            }
            "auto_scaling_instances" => {
                self.read_auto_scaling_instances(id).await
            }
            "adjustment_types" => {
                self.read_adjustment_types(id).await
            }
            "warm_pool" => {
                self.read_warm_pool(id).await
            }
            "scheduled_action" => {
            ...
            "launch_configurations" => {
                self.read_launch_configurations(id).await
            }
            "scaling_policy" => {
                self.read_scaling_policy(id).await
            }
            "scaling_process_types" => {
                self.read_scaling_process_types(id).await
            }
            "load_balancers" => {
                self.read_load_balancers(id).await
            }
            "traffic_sources" => {
                self.read_traffic_sources(id).await
            }
            "auto_scaling_group" => {
                self.read_auto_scaling_group(id).await
            }
            "termination_policy_types" => {
                self.read_termination_policy_types(id).await
            }
            "scheduled_actions" => {
                self.read_scheduled_actions(id).await
            }
            "lifecycle_hook" => {
                self.read_lifecycle_hook(id).await
            }
            "notification_configuration" => {
                self.read_notification_configuration(id).await
            }
            "instance_refreshes" => {
                self.read_instance_refreshes(id).await
            }
            "auto_scaling_notification_types" => {
            ...
            "scheduled_update_group_action" => {
                self.read_scheduled_update_group_action(id).await
            }
            "launch_configuration" => {
                self.read_launch_configuration(id).await
            }
            "lifecycle_hook_types" => {
                self.read_lifecycle_hook_types(id).await
            }
            "notification_configurations" => {
                self.read_notification_configurations(id).await
            }
            "lifecycle_hooks" => {
                self.read_lifecycle_hooks(id).await
            }
            "account_limits" => {
                self.read_account_limits(id).await
            }
            "auto_scaling_groups" => {
                self.read_auto_scaling_groups(id).await
            }
            "metric_collection_types" => {
                self.read_metric_collection_types(id).await
            }
            "policies" => {
                self.read_policies(id).await
            }
            "scaling_activities" => {
            ...
            "or_update_tags" => {
                self.read_or_update_tags(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "auto_scaling",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "auto_scaling_instances" => {
                self.update_auto_scaling_instances(id, input).await
            }
            "adjustment_types" => {
                self.update_adjustment_types(id, input).await
            }
            "warm_pool" => {
                self.update_warm_pool(id, input).await
            }
            "scheduled_action" => {
            ...
            "launch_configurations" => {
                self.update_launch_configurations(id, input).await
            }
            "scaling_policy" => {
                self.update_scaling_policy(id, input).await
            }
            "scaling_process_types" => {
                self.update_scaling_process_types(id, input).await
            }
            "load_balancers" => {
                self.update_load_balancers(id, input).await
            }
            "traffic_sources" => {
                self.update_traffic_sources(id, input).await
            }
            "auto_scaling_group" => {
                self.update_auto_scaling_group(id, input).await
            }
            "termination_policy_types" => {
                self.update_termination_policy_types(id, input).await
            }
            "scheduled_actions" => {
                self.update_scheduled_actions(id, input).await
            }
            "lifecycle_hook" => {
                self.update_lifecycle_hook(id, input).await
            }
            "notification_configuration" => {
                self.update_notification_configuration(id, input).await
            }
            "instance_refreshes" => {
                self.update_instance_refreshes(id, input).await
            }
            "auto_scaling_notification_types" => {
            ...
            "launch_configuration" => {
                self.update_launch_configuration(id, input).await
            }
            "lifecycle_hook_types" => {
                self.update_lifecycle_hook_types(id, input).await
            }
            "notification_configurations" => {
                self.update_notification_configurations(id, input).await
            }
            "lifecycle_hooks" => {
                self.update_lifecycle_hooks(id, input).await
            }
            "account_limits" => {
                self.update_account_limits(id, input).await
            }
            "auto_scaling_groups" => {
                self.update_auto_scaling_groups(id, input).await
            }
            "metric_collection_types" => {
                self.update_metric_collection_types(id, input).await
            }
            "policies" => {
                self.update_policies(id, input).await
            }
            "scaling_activities" => {
            ...
            "or_update_tags" => {
                self.update_or_update_tags(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "auto_scaling",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "load_balancer_target_groups" => {
                self.delete_load_balancer_target_groups(id).await
            }
            "auto_scaling_instances" => {
                self.delete_auto_scaling_instances(id).await
            }
            "adjustment_types" => {
                self.delete_adjustment_types(id).await
            }
            "warm_pool" => {
                self.delete_warm_pool(id).await
            }
            "scheduled_action" => {
            ...
            "launch_configurations" => {
                self.delete_launch_configurations(id).await
            }
            "scaling_policy" => {
                self.delete_scaling_policy(id).await
            }
            "scaling_process_types" => {
                self.delete_scaling_process_types(id).await
            }
            "load_balancers" => {
                self.delete_load_balancers(id).await
            }
            "traffic_sources" => {
                self.delete_traffic_sources(id).await
            }
            "auto_scaling_group" => {
                self.delete_auto_scaling_group(id).await
            }
            "termination_policy_types" => {
                self.delete_termination_policy_types(id).await
            }
            "scheduled_actions" => {
            ...
            "instance_refreshes" => {
                self.delete_instance_refreshes(id).await
            }
            "auto_scaling_notification_types" => {
            ...
            "scheduled_update_group_action" => {
                self.delete_scheduled_update_group_action(id).await
            }
            "launch_configuration" => {
                self.delete_launch_configuration(id).await
            }
            "lifecycle_hook_types" => {
                self.delete_lifecycle_hook_types(id).await
            }
            "notification_configurations" => {
                self.delete_notification_configurations(id).await
            }
            "lifecycle_hooks" => {
                self.delete_lifecycle_hooks(id).await
            }
            "account_limits" => {
                self.delete_account_limits(id).await
            }
            "auto_scaling_groups" => {
                self.delete_auto_scaling_groups(id).await
            }
            "metric_collection_types" => {
                self.delete_metric_collection_types(id).await
            }
            "policies" => {
                self.delete_policies(id).await
            }
            "scaling_activities" => {
            ...
            "or_update_tags" => {
                self.delete_or_update_tags(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "auto_scaling",
    ...
    async fn read_load_balancer_target_groups(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_load_balancer_target_groups(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_auto_scaling_instances(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_auto_scaling_instances(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_auto_scaling_instances(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_adjustment_types(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_adjustment_types(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_adjustment_types(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_warm_pool(
        ...
        self.provider.runtime().block_on(async {
            ...
            let max_group_prepared_capacity = input.get_optional_string("max_group_prepared_capacity")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("instance_reuse_policy", instance_reuse_policy.unwrap_or_default())
                .with_field("min_size", min_size.unwrap_or_default())
                .with_field("pool_state", pool_state.unwrap_or_default())
                .with_field("auto_scaling_group_name", auto_scaling_group_name.unwrap_or_default())
                .with_field("max_group_prepared_capacity", max_group_prepared_capacity.unwrap_or_default())
            )
        })
    }

    /// Read a warm_pool resource
    async fn read_warm_pool(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_launch_configurations(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_launch_configurations(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_launch_configurations(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_scaling_policy(
        ...
        self.provider.runtime().block_on(async {
            ...
            let target_tracking_configuration = input.get_optional_string("target_tracking_configuration")?;
            let estimated_instance_warmup = input.get_optional_string("estimated_instance_warmup")?;
            let predictive_scaling_configuration = input.get_optional_string("predictive_scaling_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("min_adjustment_magnitude", min_adjustment_magnitude.unwrap_or_default())
                .with_field("metric_aggregation_type", metric_aggregation_type.unwrap_or_default())
                ...
                .with_field("target_tracking_configuration", target_tracking_configuration.unwrap_or_default())
                .with_field("estimated_instance_warmup", estimated_instance_warmup.unwrap_or_default())
                .with_field("predictive_scaling_configuration", predictive_scaling_configuration.unwrap_or_default())
                .with_field("min_adjustment_step", min_adjustment_step.unwrap_or_default())
            )
        })
    }
    ...
    async fn create_scaling_process_types(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_scaling_process_types(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_scaling_process_types(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_traffic_sources(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_traffic_sources(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_auto_scaling_group(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let availability_zone_impairment_policy = input.get_optional_string("availability_zone_impairment_policy")?;
            ...
            let health_check_grace_period = input.get_optional_string("health_check_grace_period")?;
            let launch_configuration_name = input.get_optional_string("launch_configuration_name")?;
            ...
            let capacity_reservation_specification = input.get_optional_string("capacity_reservation_specification")?;
            ...
            let new_instances_protected_from_scale_in = input.get_optional_string("new_instances_protected_from_scale_in")?;
            ...
            let availability_zone_distribution = input.get_optional_string("availability_zone_distribution")?;
            ...
            let lifecycle_hook_specification_list = input.get_optional_string("lifecycle_hook_specification_list")?;
            let auto_scaling_group_name = input.get_string("auto_scaling_group_name")?;
            let tags = input.get_optional_string("tags")?;
            let traffic_sources = input.get_optional_string("traffic_sources")?;
            let instance_maintenance_policy = input.get_optional_string("instance_maintenance_policy")?;
            let skip_zonal_shift_validation = input.get_optional_string("skip_zonal_shift_validation")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("availability_zone_impairment_policy", availability_zone_impairment_policy.unwrap_or_default())
                .with_field("desired_capacity_type", desired_capacity_type.unwrap_or_default())
                .with_field("context", context.unwrap_or_default())
                .with_field("capacity_rebalance", capacity_rebalance.unwrap_or_default())
                .with_field("service_linked_role_arn", service_linked_role_arn.unwrap_or_default())
                .with_field("health_check_grace_period", health_check_grace_period.unwrap_or_default())
                .with_field("launch_configuration_name", launch_configuration_name.unwrap_or_default())
                .with_field("termination_policies", termination_policies.unwrap_or_default())
                .with_field("target_group_ar_ns", target_group_ar_ns.unwrap_or_default())
                .with_field("capacity_reservation_specification", capacity_reservation_specification.unwrap_or_default())
                .with_field("default_instance_warmup", default_instance_warmup.unwrap_or_default())
                ...
                .with_field("new_instances_protected_from_scale_in", new_instances_protected_from_scale_in.unwrap_or_default())
                .with_field("instance_id", instance_id.unwrap_or_default())
                .with_field("max_instance_lifetime", max_instance_lifetime.unwrap_or_default())
                .with_field("max_size", max_size.unwrap_or_default())
                .with_field("health_check_type", health_check_type.unwrap_or_default())
                .with_field("vpc_zone_identifier", vpc_zone_identifier.unwrap_or_default())
                .with_field("availability_zone_distribution", availability_zone_distribution.unwrap_or_default())
                .with_field("mixed_instances_policy", mixed_instances_policy.unwrap_or_default())
                .with_field("load_balancer_names", load_balancer_names.unwrap_or_default())
                .with_field("lifecycle_hook_specification_list", lifecycle_hook_specification_list.unwrap_or_default())
                .with_field("auto_scaling_group_name", auto_scaling_group_name.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("traffic_sources", traffic_sources.unwrap_or_default())
                .with_field("instance_maintenance_policy", instance_maintenance_policy.unwrap_or_default())
                .with_field("skip_zonal_shift_validation", skip_zonal_shift_validation.unwrap_or_default())
    ...
    async fn read_auto_scaling_group(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_termination_policy_types(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_termination_policy_types(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_lifecycle_hook(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("auto_scaling_group_name", auto_scaling_group_name.unwrap_or_default())
                .with_field("lifecycle_hook_name", lifecycle_hook_name.unwrap_or_default())
                .with_field("notification_metadata", notification_metadata.unwrap_or_default())
                .with_field("lifecycle_transition", lifecycle_transition.unwrap_or_default())
                .with_field("default_result", default_result.unwrap_or_default())
                .with_field("role_arn", role_arn.unwrap_or_default())
                .with_field("notification_target_arn", notification_target_arn.unwrap_or_default())
            )
        })
    }

    /// Read a lifecycle_hook resource
    async fn read_lifecycle_hook(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_instance_refreshes(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_instance_refreshes(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_instance_refreshes(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_auto_scaling_notification_types(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_auto_scaling_notification_types(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_scheduled_update_group_action(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_scheduled_update_group_action(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_launch_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            let associate_public_ip_address = input.get_optional_string("associate_public_ip_address")?;
            ...
            let classic_link_vpc_security_groups = input.get_optional_string("classic_link_vpc_security_groups")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("launch_configuration_name", launch_configuration_name.unwrap_or_default())
                .with_field("associate_public_ip_address", associate_public_ip_address.unwrap_or_default())
                .with_field("key_name", key_name.unwrap_or_default())
                .with_field("security_groups", security_groups.unwrap_or_default())
                .with_field("instance_monitoring", instance_monitoring.unwrap_or_default())
                ...
                .with_field("iam_instance_profile", iam_instance_profile.unwrap_or_default())
                .with_field("user_data", user_data.unwrap_or_default())
                .with_field("instance_type", instance_type.unwrap_or_default())
                .with_field("classic_link_vpc_id", classic_link_vpc_id.unwrap_or_default())
                .with_field("classic_link_vpc_security_groups", classic_link_vpc_security_groups.unwrap_or_default())
    ...
    async fn read_launch_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_lifecycle_hook_types(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_lifecycle_hook_types(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_lifecycle_hook_types(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_notification_configurations(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_notification_configurations(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_lifecycle_hooks(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_lifecycle_hooks(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_auto_scaling_groups(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_auto_scaling_groups(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_auto_scaling_groups(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_metric_collection_types(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_metric_collection_types(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_metric_collection_types(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_or_update_tags(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
