...
impl<'a> Scheduled_update_group_action<'a> {
    ...
    pub async fn create(&self, scheduled_action_name: String, time: Option<String>, start_time: Option<String>, recurrence: Option<String>, auto_scaling_group_name: String, min_size: Option<i64>, end_time: Option<String>, max_size: Option<i64>, time_zone: Option<String>, desired_capacity: Option<i64>) -> Result<String> {
