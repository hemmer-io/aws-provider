...
impl<'a> Warm_pool<'a> {
    ...
    pub async fn create(&self, max_group_prepared_capacity: Option<i64>, pool_state: Option<String>, instance_reuse_policy: Option<String>, auto_scaling_group_name: String, min_size: Option<i64>) -> Result<String> {
