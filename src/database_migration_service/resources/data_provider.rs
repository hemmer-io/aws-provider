...
impl<'a> Data_provider<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, virtual: Option<bool>, description: Option<String>, engine: String, data_provider_name: Option<String>, settings: String) -> Result<String> {
