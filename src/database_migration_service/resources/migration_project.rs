...
impl<'a> Migration_project<'a> {
    ...
    pub async fn create(&self, transformation_rules: Option<String>, migration_project_name: Option<String>, source_data_provider_descriptors: Vec<String>, schema_conversion_application_attributes: Option<String>, tags: Option<Vec<String>>, target_data_provider_descriptors: Vec<String>, description: Option<String>, instance_profile_identifier: String) -> Result<String> {
