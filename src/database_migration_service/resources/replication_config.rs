...
impl<'a> Replication_config<'a> {
    ...
    pub async fn create(&self, compute_config: String, table_mappings: String, replication_settings: Option<String>, supplemental_settings: Option<String>, resource_identifier: Option<String>, tags: Option<Vec<String>>, replication_type: String, target_endpoint_arn: String, replication_config_identifier: String, source_endpoint_arn: String) -> Result<String> {
