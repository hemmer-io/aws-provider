...
impl<'a> Replication_subnet_group<'a> {
    ...
    pub async fn create(&self, subnet_ids: Vec<String>, replication_subnet_group_identifier: String, replication_subnet_group_description: String, tags: Option<Vec<String>>) -> Result<String> {
