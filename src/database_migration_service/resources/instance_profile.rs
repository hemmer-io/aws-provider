...
impl<'a> Instance_profile<'a> {
    ...
    pub async fn create(&self, description: Option<String>, availability_zone: Option<String>, network_type: Option<String>, kms_key_arn: Option<String>, instance_profile_name: Option<String>, vpc_security_groups: Option<String>, tags: Option<Vec<String>>, publicly_accessible: Option<bool>, subnet_group_identifier: Option<String>) -> Result<String> {
