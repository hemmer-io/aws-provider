...
impl<'a> Database_migration_serviceService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "replication_task_assessment_results" => {
                self.plan_replication_task_assessment_results(current_state, desired_input)
                    .await
            }
            "applicable_individual_assessments" => {
                self.plan_applicable_individual_assessments(current_state, desired_input)
                    .await
            }
            "recommendation_limitations" => {
                self.plan_recommendation_limitations(current_state, desired_input)
                    .await
            }
            "data_providers" => self.plan_data_providers(current_state, desired_input).await,
            "recommendations" => {
            ...
            "schemas" => self.plan_schemas(current_state, desired_input).await,
            "events" => self.plan_events(current_state, desired_input).await,
            "replication_subnet_groups" => {
                self.plan_replication_subnet_groups(current_state, desired_input)
                    .await
            }
            "replication_instance" => {
                self.plan_replication_instance(current_state, desired_input)
                    .await
            }
            "migration_project" => {
                self.plan_migration_project(current_state, desired_input)
                    .await
            }
            "data_migrations" => {
                self.plan_data_migrations(current_state, desired_input)
                    .await
            }
            "subscriptions_to_event_bridge" => {
                self.plan_subscriptions_to_event_bridge(current_state, desired_input)
                    .await
            }
            "replication_table_statistics" => {
                self.plan_replication_table_statistics(current_state, desired_input)
                    .await
            }
            "orderable_replication_instances" => {
                self.plan_orderable_replication_instances(current_state, desired_input)
                    .await
            }
            "replication_config" => {
                self.plan_replication_config(current_state, desired_input)
                    .await
            }
            "conversion_configuration" => {
                self.plan_conversion_configuration(current_state, desired_input)
                    .await
            }
            ...
            "table_statistics" => {
                self.plan_table_statistics(current_state, desired_input)
                    .await
            }
            "replication_instances" => {
                self.plan_replication_instances(current_state, desired_input)
                    .await
            }
            "metadata_model_exports_as_script" => {
                self.plan_metadata_model_exports_as_script(current_state, desired_input)
                    .await
            }
            "fleet_advisor_schemas" => {
                self.plan_fleet_advisor_schemas(current_state, desired_input)
                    .await
            }
            "migration_projects" => {
                self.plan_migration_projects(current_state, desired_input)
                    .await
            }
            "connection" => self.plan_connection(current_state, desired_input).await,
            "instance_profiles" => {
                self.plan_instance_profiles(current_state, desired_input)
                    .await
            }
            "extension_pack_associations" => {
                self.plan_extension_pack_associations(current_state, desired_input)
                    .await
            }
            "metadata_model_imports" => {
                self.plan_metadata_model_imports(current_state, desired_input)
                    .await
            }
            "certificate" => self.plan_certificate(current_state, desired_input).await,
            "data_migration" => self.plan_data_migration(current_state, desired_input).await,
            "metadata_model_conversions" => {
                self.plan_metadata_model_conversions(current_state, desired_input)
                    .await
            }
            "fleet_advisor_collectors" => {
                self.plan_fleet_advisor_collectors(current_state, desired_input)
                    .await
            }
            "fleet_advisor_lsa_analysis" => {
                self.plan_fleet_advisor_lsa_analysis(current_state, desired_input)
                    .await
            }
            "replication_task_individual_assessments" => {
                self.plan_replication_task_individual_assessments(current_state, desired_input)
                    .await
            }
            "event_categories" => {
            ...
            "replication_instance_task_logs" => {
                self.plan_replication_instance_task_logs(current_state, desired_input)
                    .await
            }
            "replication_subnet_group" => {
                self.plan_replication_subnet_group(current_state, desired_input)
                    .await
            }
            "event_subscriptions" => {
            ...
            "replication_configs" => {
                self.plan_replication_configs(current_state, desired_input)
                    .await
            }
            "fleet_advisor_collector" => {
                self.plan_fleet_advisor_collector(current_state, desired_input)
                    .await
            }
            "fleet_advisor_schema_object_summary" => {
                self.plan_fleet_advisor_schema_object_summary(current_state, desired_input)
                    .await
            }
            "replication_tasks" => {
                self.plan_replication_tasks(current_state, desired_input)
                    .await
            }
            "endpoint_types" => self.plan_endpoint_types(current_state, desired_input).await,
            "endpoint_settings" => {
                self.plan_endpoint_settings(current_state, desired_input)
                    .await
            }
            "replications" => self.plan_replications(current_state, desired_input).await,
            "refresh_schemas_status" => {
                self.plan_refresh_schemas_status(current_state, desired_input)
                    .await
            }
            "fleet_advisor_databases" => {
                self.plan_fleet_advisor_databases(current_state, desired_input)
                    .await
            }
            "metadata_model_assessments" => {
                self.plan_metadata_model_assessments(current_state, desired_input)
                    .await
            }
            "metadata_model_exports_to_target" => {
                self.plan_metadata_model_exports_to_target(current_state, desired_input)
                    .await
            }
            "instance_profile" => {
            ...
            "replication_task_assessment_runs" => {
                self.plan_replication_task_assessment_runs(current_state, desired_input)
                    .await
            }
            "data_provider" => self.plan_data_provider(current_state, desired_input).await,
            "certificates" => self.plan_certificates(current_state, desired_input).await,
            "engine_versions" => {
                self.plan_engine_versions(current_state, desired_input)
                    .await
            }
            "replication_task" => {
                self.plan_replication_task(current_state, desired_input)
                    .await
            }
            "replication_task_assessment_run" => {
                self.plan_replication_task_assessment_run(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "database_migration_service", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "recommendation_limitations" => self.create_recommendation_limitations(input).await,
            "data_providers" => self.create_data_providers(input).await,
            "recommendations" => self.create_recommendations(input).await,
            "event_subscription" => self.create_event_subscription(input).await,
            "schemas" => self.create_schemas(input).await,
            "events" => self.create_events(input).await,
            "replication_subnet_groups" => self.create_replication_subnet_groups(input).await,
            "replication_instance" => self.create_replication_instance(input).await,
            "migration_project" => self.create_migration_project(input).await,
            "data_migrations" => self.create_data_migrations(input).await,
            "subscriptions_to_event_bridge" => {
                self.create_subscriptions_to_event_bridge(input).await
            }
            "replication_table_statistics" => self.create_replication_table_statistics(input).await,
            "orderable_replication_instances" => {
                self.create_orderable_replication_instances(input).await
            }
            "replication_config" => self.create_replication_config(input).await,
            "conversion_configuration" => self.create_conversion_configuration(input).await,
            ...
            "table_statistics" => self.create_table_statistics(input).await,
            "replication_instances" => self.create_replication_instances(input).await,
            "metadata_model_exports_as_script" => {
                self.create_metadata_model_exports_as_script(input).await
            }
            "fleet_advisor_schemas" => self.create_fleet_advisor_schemas(input).await,
            "migration_projects" => self.create_migration_projects(input).await,
            "connection" => self.create_connection(input).await,
            "instance_profiles" => self.create_instance_profiles(input).await,
            "extension_pack_associations" => self.create_extension_pack_associations(input).await,
            "metadata_model_imports" => self.create_metadata_model_imports(input).await,
            "certificate" => self.create_certificate(input).await,
            "data_migration" => self.create_data_migration(input).await,
            "metadata_model_conversions" => self.create_metadata_model_conversions(input).await,
            "fleet_advisor_collectors" => self.create_fleet_advisor_collectors(input).await,
            "fleet_advisor_lsa_analysis" => self.create_fleet_advisor_lsa_analysis(input).await,
            "replication_task_individual_assessments" => {
                self.create_replication_task_individual_assessments(input)
                    .await
            }
            ...
            "replication_subnet_group" => self.create_replication_subnet_group(input).await,
            "event_subscriptions" => self.create_event_subscriptions(input).await,
            "connections" => self.create_connections(input).await,
            "replication_configs" => self.create_replication_configs(input).await,
            "fleet_advisor_collector" => self.create_fleet_advisor_collector(input).await,
            "fleet_advisor_schema_object_summary" => {
                self.create_fleet_advisor_schema_object_summary(input).await
            }
            "replication_tasks" => self.create_replication_tasks(input).await,
            "endpoint_types" => self.create_endpoint_types(input).await,
            "endpoint_settings" => self.create_endpoint_settings(input).await,
            "replications" => self.create_replications(input).await,
            "refresh_schemas_status" => self.create_refresh_schemas_status(input).await,
            "fleet_advisor_databases" => self.create_fleet_advisor_databases(input).await,
            "metadata_model_assessments" => self.create_metadata_model_assessments(input).await,
            "metadata_model_exports_to_target" => {
            ...
            "data_provider" => self.create_data_provider(input).await,
            "certificates" => self.create_certificates(input).await,
            "engine_versions" => self.create_engine_versions(input).await,
            "replication_task" => self.create_replication_task(input).await,
            "replication_task_assessment_run" => {
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "recommendation_limitations" => self.read_recommendation_limitations(id).await,
            "data_providers" => self.read_data_providers(id).await,
            "recommendations" => self.read_recommendations(id).await,
            "event_subscription" => self.read_event_subscription(id).await,
            "schemas" => self.read_schemas(id).await,
            "events" => self.read_events(id).await,
            "replication_subnet_groups" => self.read_replication_subnet_groups(id).await,
            "replication_instance" => self.read_replication_instance(id).await,
            "migration_project" => self.read_migration_project(id).await,
            "data_migrations" => self.read_data_migrations(id).await,
            "subscriptions_to_event_bridge" => self.read_subscriptions_to_event_bridge(id).await,
            "replication_table_statistics" => self.read_replication_table_statistics(id).await,
            "orderable_replication_instances" => {
                self.read_orderable_replication_instances(id).await
            }
            "replication_config" => self.read_replication_config(id).await,
            "conversion_configuration" => self.read_conversion_configuration(id).await,
            ...
            "table_statistics" => self.read_table_statistics(id).await,
            "replication_instances" => self.read_replication_instances(id).await,
            "metadata_model_exports_as_script" => {
                self.read_metadata_model_exports_as_script(id).await
            }
            "fleet_advisor_schemas" => self.read_fleet_advisor_schemas(id).await,
            "migration_projects" => self.read_migration_projects(id).await,
            "connection" => self.read_connection(id).await,
            "instance_profiles" => self.read_instance_profiles(id).await,
            "extension_pack_associations" => self.read_extension_pack_associations(id).await,
            "metadata_model_imports" => self.read_metadata_model_imports(id).await,
            "certificate" => self.read_certificate(id).await,
            "data_migration" => self.read_data_migration(id).await,
            "metadata_model_conversions" => self.read_metadata_model_conversions(id).await,
            "fleet_advisor_collectors" => self.read_fleet_advisor_collectors(id).await,
            "fleet_advisor_lsa_analysis" => self.read_fleet_advisor_lsa_analysis(id).await,
            "replication_task_individual_assessments" => {
                self.read_replication_task_individual_assessments(id).await
            }
            "event_categories" => self.read_event_categories(id).await,
            "replication_instance_task_logs" => self.read_replication_instance_task_logs(id).await,
            "replication_subnet_group" => self.read_replication_subnet_group(id).await,
            "event_subscriptions" => self.read_event_subscriptions(id).await,
            "connections" => self.read_connections(id).await,
            "replication_configs" => self.read_replication_configs(id).await,
            "fleet_advisor_collector" => self.read_fleet_advisor_collector(id).await,
            "fleet_advisor_schema_object_summary" => {
                self.read_fleet_advisor_schema_object_summary(id).await
            }
            "replication_tasks" => self.read_replication_tasks(id).await,
            "endpoint_types" => self.read_endpoint_types(id).await,
            "endpoint_settings" => self.read_endpoint_settings(id).await,
            "replications" => self.read_replications(id).await,
            "refresh_schemas_status" => self.read_refresh_schemas_status(id).await,
            "fleet_advisor_databases" => self.read_fleet_advisor_databases(id).await,
            "metadata_model_assessments" => self.read_metadata_model_assessments(id).await,
            "metadata_model_exports_to_target" => {
            ...
            "data_provider" => self.read_data_provider(id).await,
            "certificates" => self.read_certificates(id).await,
            "engine_versions" => self.read_engine_versions(id).await,
            "replication_task" => self.read_replication_task(id).await,
            "replication_task_assessment_run" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "replication_task_assessment_results" => {
                self.update_replication_task_assessment_results(id, input)
                    .await
            }
            "applicable_individual_assessments" => {
                self.update_applicable_individual_assessments(id, input)
                    .await
            }
            "recommendation_limitations" => self.update_recommendation_limitations(id, input).await,
            "data_providers" => self.update_data_providers(id, input).await,
            ...
            "schemas" => self.update_schemas(id, input).await,
            "events" => self.update_events(id, input).await,
            "replication_subnet_groups" => self.update_replication_subnet_groups(id, input).await,
            "replication_instance" => self.update_replication_instance(id, input).await,
            "migration_project" => self.update_migration_project(id, input).await,
            "data_migrations" => self.update_data_migrations(id, input).await,
            "subscriptions_to_event_bridge" => {
            ...
            "replication_config" => self.update_replication_config(id, input).await,
            "conversion_configuration" => self.update_conversion_configuration(id, input).await,
            ...
            "table_statistics" => self.update_table_statistics(id, input).await,
            "replication_instances" => self.update_replication_instances(id, input).await,
            "metadata_model_exports_as_script" => {
                self.update_metadata_model_exports_as_script(id, input)
                    .await
            }
            "fleet_advisor_schemas" => self.update_fleet_advisor_schemas(id, input).await,
            "migration_projects" => self.update_migration_projects(id, input).await,
            "connection" => self.update_connection(id, input).await,
            "instance_profiles" => self.update_instance_profiles(id, input).await,
            "extension_pack_associations" => {
                self.update_extension_pack_associations(id, input).await
            }
            "metadata_model_imports" => self.update_metadata_model_imports(id, input).await,
            "certificate" => self.update_certificate(id, input).await,
            "data_migration" => self.update_data_migration(id, input).await,
            "metadata_model_conversions" => self.update_metadata_model_conversions(id, input).await,
            "fleet_advisor_collectors" => self.update_fleet_advisor_collectors(id, input).await,
            "fleet_advisor_lsa_analysis" => self.update_fleet_advisor_lsa_analysis(id, input).await,
            "replication_task_individual_assessments" => {
                self.update_replication_task_individual_assessments(id, input)
                    .await
            }
            ...
            "replication_subnet_group" => self.update_replication_subnet_group(id, input).await,
            "event_subscriptions" => self.update_event_subscriptions(id, input).await,
            "connections" => self.update_connections(id, input).await,
            "replication_configs" => self.update_replication_configs(id, input).await,
            "fleet_advisor_collector" => self.update_fleet_advisor_collector(id, input).await,
            "fleet_advisor_schema_object_summary" => {
                self.update_fleet_advisor_schema_object_summary(id, input)
                    .await
            }
            "replication_tasks" => self.update_replication_tasks(id, input).await,
            "endpoint_types" => self.update_endpoint_types(id, input).await,
            "endpoint_settings" => self.update_endpoint_settings(id, input).await,
            "replications" => self.update_replications(id, input).await,
            "refresh_schemas_status" => self.update_refresh_schemas_status(id, input).await,
            "fleet_advisor_databases" => self.update_fleet_advisor_databases(id, input).await,
            "metadata_model_assessments" => self.update_metadata_model_assessments(id, input).await,
            "metadata_model_exports_to_target" => {
                self.update_metadata_model_exports_to_target(id, input)
                    .await
            }
            ...
            "replication_task_assessment_runs" => {
                self.update_replication_task_assessment_runs(id, input)
                    .await
            }
            "data_provider" => self.update_data_provider(id, input).await,
            "certificates" => self.update_certificates(id, input).await,
            "engine_versions" => self.update_engine_versions(id, input).await,
            "replication_task" => self.update_replication_task(id, input).await,
            "replication_task_assessment_run" => {
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "recommendation_limitations" => self.delete_recommendation_limitations(id).await,
            "data_providers" => self.delete_data_providers(id).await,
            "recommendations" => self.delete_recommendations(id).await,
            "event_subscription" => self.delete_event_subscription(id).await,
            "schemas" => self.delete_schemas(id).await,
            "events" => self.delete_events(id).await,
            "replication_subnet_groups" => self.delete_replication_subnet_groups(id).await,
            "replication_instance" => self.delete_replication_instance(id).await,
            "migration_project" => self.delete_migration_project(id).await,
            "data_migrations" => self.delete_data_migrations(id).await,
            "subscriptions_to_event_bridge" => self.delete_subscriptions_to_event_bridge(id).await,
            "replication_table_statistics" => self.delete_replication_table_statistics(id).await,
            "orderable_replication_instances" => {
                self.delete_orderable_replication_instances(id).await
            }
            "replication_config" => self.delete_replication_config(id).await,
            "conversion_configuration" => self.delete_conversion_configuration(id).await,
            ...
            "table_statistics" => self.delete_table_statistics(id).await,
            "replication_instances" => self.delete_replication_instances(id).await,
            "metadata_model_exports_as_script" => {
                self.delete_metadata_model_exports_as_script(id).await
            }
            "fleet_advisor_schemas" => self.delete_fleet_advisor_schemas(id).await,
            "migration_projects" => self.delete_migration_projects(id).await,
            "connection" => self.delete_connection(id).await,
            "instance_profiles" => self.delete_instance_profiles(id).await,
            "extension_pack_associations" => self.delete_extension_pack_associations(id).await,
            "metadata_model_imports" => self.delete_metadata_model_imports(id).await,
            "certificate" => self.delete_certificate(id).await,
            "data_migration" => self.delete_data_migration(id).await,
            "metadata_model_conversions" => self.delete_metadata_model_conversions(id).await,
            "fleet_advisor_collectors" => self.delete_fleet_advisor_collectors(id).await,
            "fleet_advisor_lsa_analysis" => self.delete_fleet_advisor_lsa_analysis(id).await,
            "replication_task_individual_assessments" => {
                self.delete_replication_task_individual_assessments(id)
                    .await
            }
            ...
            "replication_subnet_group" => self.delete_replication_subnet_group(id).await,
            "event_subscriptions" => self.delete_event_subscriptions(id).await,
            "connections" => self.delete_connections(id).await,
            "replication_configs" => self.delete_replication_configs(id).await,
            "fleet_advisor_collector" => self.delete_fleet_advisor_collector(id).await,
            "fleet_advisor_schema_object_summary" => {
                self.delete_fleet_advisor_schema_object_summary(id).await
            }
            "replication_tasks" => self.delete_replication_tasks(id).await,
            "endpoint_types" => self.delete_endpoint_types(id).await,
            "endpoint_settings" => self.delete_endpoint_settings(id).await,
            "replications" => self.delete_replications(id).await,
            "refresh_schemas_status" => self.delete_refresh_schemas_status(id).await,
            "fleet_advisor_databases" => self.delete_fleet_advisor_databases(id).await,
            "metadata_model_assessments" => self.delete_metadata_model_assessments(id).await,
            "metadata_model_exports_to_target" => {
            ...
            "data_provider" => self.delete_data_provider(id).await,
            "certificates" => self.delete_certificates(id).await,
            "engine_versions" => self.delete_engine_versions(id).await,
            "replication_task" => self.delete_replication_task(id).await,
            "replication_task_assessment_run" => {
    ...
    async fn read_replication_task_assessment_results(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_replication_task_assessment_results(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_applicable_individual_assessments(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_applicable_individual_assessments(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_recommendation_limitations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_recommendation_limitations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_data_providers(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_data_providers(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_data_providers(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_schemas(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_schemas(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn update_schemas(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_schemas(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_replication_subnet_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_replication_subnet_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_replication_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let kerberos_authentication_settings =
                input.get_optional_string("kerberos_authentication_settings")?;
            let replication_instance_identifier =
                input.get_string("replication_instance_identifier")?;
            ...
            let replication_subnet_group_identifier =
                input.get_optional_string("replication_subnet_group_identifier")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    replication_instance_class.unwrap_or_default(),
                )
                .with_field(
                    "kerberos_authentication_settings",
                    kerberos_authentication_settings.unwrap_or_default(),
                )
                .with_field(
                    "replication_instance_identifier",
                    replication_instance_identifier.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    replication_subnet_group_identifier.unwrap_or_default(),
                ))
        })
    }

    /// Read a replication_instance resource
    async fn read_replication_instance(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_replication_instance(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_migration_project(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let source_data_provider_descriptors =
                input.get_string("source_data_provider_descriptors")?;
            let schema_conversion_application_attributes =
                input.get_optional_string("schema_conversion_application_attributes")?;
            let tags = input.get_optional_string("tags")?;
            let target_data_provider_descriptors =
                input.get_string("target_data_provider_descriptors")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    transformation_rules.unwrap_or_default(),
                )
                .with_field(
                    "migration_project_name",
                    migration_project_name.unwrap_or_default(),
                )
                .with_field(
                    "source_data_provider_descriptors",
                    source_data_provider_descriptors.unwrap_or_default(),
                )
                .with_field(
                    "schema_conversion_application_attributes",
                    schema_conversion_application_attributes.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "target_data_provider_descriptors",
                    target_data_provider_descriptors.unwrap_or_default(),
                )
                .with_field("description", description.unwrap_or_default())
                .with_field(
                    "instance_profile_identifier",
                    instance_profile_identifier.unwrap_or_default(),
                ))
        })
    }

    /// Read a migration_project resource
    async fn read_migration_project(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_migration_project(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_data_migrations(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_data_migrations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_data_migrations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_subscriptions_to_event_bridge(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_subscriptions_to_event_bridge(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_replication_table_statistics(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_replication_table_statistics(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_orderable_replication_instances(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_orderable_replication_instances(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_replication_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let compute_config = input.get_string("compute_config")?;
            let replication_config_identifier =
                input.get_string("replication_config_identifier")?;
            let resource_identifier = input.get_optional_string("resource_identifier")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    replication_config_identifier.unwrap_or_default(),
                )
                .with_field(
                    "resource_identifier",
                    resource_identifier.unwrap_or_default(),
                ...
                .with_field(
                    "source_endpoint_arn",
                    source_endpoint_arn.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    replication_settings.unwrap_or_default(),
                )
                .with_field(
                    "target_endpoint_arn",
                    target_endpoint_arn.unwrap_or_default(),
                )
                .with_field(
                    "supplemental_settings",
                    supplemental_settings.unwrap_or_default(),
                ))
        })
    }

    /// Read a replication_config resource
    async fn read_replication_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_replication_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_conversion_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_conversion_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_endpoint(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let external_table_definition =
                input.get_optional_string("external_table_definition")?;
            ...
            let microsoft_sql_server_settings =
                input.get_optional_string("microsoft_sql_server_settings")?;
            let ibm_db2_settings = input.get_optional_string("ibm_db2_settings")?;
            let extra_connection_attributes =
                input.get_optional_string("extra_connection_attributes")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    elasticsearch_settings.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    external_table_definition.unwrap_or_default(),
                )
                .with_field("doc_db_settings", doc_db_settings.unwrap_or_default())
                .with_field(
                    "gcp_my_sql_settings",
                    gcp_my_sql_settings.unwrap_or_default(),
                )
                .with_field(
                    "timestream_settings",
                    timestream_settings.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    dms_transfer_settings.unwrap_or_default(),
                )
                .with_field(
                    "postgre_sql_settings",
                    postgre_sql_settings.unwrap_or_default(),
                )
                .with_field("engine_name", engine_name.unwrap_or_default())
                .with_field(
                    "endpoint_identifier",
                    endpoint_identifier.unwrap_or_default(),
                )
    ...
    async fn create_table_statistics(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_table_statistics(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_table_statistics(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_replication_instances(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_replication_instances(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_replication_instances(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_metadata_model_exports_as_script(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_metadata_model_exports_as_script(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_fleet_advisor_schemas(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_fleet_advisor_schemas(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_fleet_advisor_schemas(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_migration_projects(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_migration_projects(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_migration_projects(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_instance_profiles(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_profiles(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_instance_profiles(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_extension_pack_associations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_extension_pack_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_metadata_model_imports(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_metadata_model_imports(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_metadata_model_imports(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_data_migration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    target_data_settings.unwrap_or_default(),
                )
                .with_field(
                    "data_migration_type",
                    data_migration_type.unwrap_or_default(),
                )
                .with_field(
                    "data_migration_name",
                    data_migration_name.unwrap_or_default(),
                )
                .with_field(
                    "enable_cloudwatch_logs",
                    enable_cloudwatch_logs.unwrap_or_default(),
                )
                .with_field(
                    "source_data_settings",
                    source_data_settings.unwrap_or_default(),
                )
                .with_field("number_of_jobs", number_of_jobs.unwrap_or_default())
                .with_field(
                    "migration_project_identifier",
                    migration_project_identifier.unwrap_or_default(),
                ))
        })
    }

    /// Read a data_migration resource
    async fn read_data_migration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_data_migration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_metadata_model_conversions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_metadata_model_conversions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_fleet_advisor_collectors(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_fleet_advisor_collectors(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_fleet_advisor_lsa_analysis(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_fleet_advisor_lsa_analysis(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn delete_replication_task_individual_assessments(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_replication_instance_task_logs(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_replication_instance_task_logs(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_replication_subnet_group(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let replication_subnet_group_description =
                input.get_string("replication_subnet_group_description")?;
            let subnet_ids = input.get_string("subnet_ids")?;
            let replication_subnet_group_identifier =
                input.get_string("replication_subnet_group_identifier")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    replication_subnet_group_description.unwrap_or_default(),
                )
    ...
    async fn read_replication_subnet_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_replication_subnet_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_replication_configs(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_replication_configs(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_replication_configs(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_fleet_advisor_collector(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_fleet_advisor_collector(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_fleet_advisor_collector(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_fleet_advisor_schema_object_summary(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_fleet_advisor_schema_object_summary(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_replication_tasks(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_replication_tasks(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_replication_tasks(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_endpoint_types(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_endpoint_types(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_endpoint_types(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_endpoint_settings(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_endpoint_settings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_endpoint_settings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_replications(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_replications(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn update_replications(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_replications(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_refresh_schemas_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_refresh_schemas_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_refresh_schemas_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_fleet_advisor_databases(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_fleet_advisor_databases(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_fleet_advisor_databases(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_metadata_model_assessments(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_metadata_model_assessments(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_metadata_model_exports_to_target(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_metadata_model_exports_to_target(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_instance_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "vpc_security_groups",
                    vpc_security_groups.unwrap_or_default(),
                )
                .with_field("network_type", network_type.unwrap_or_default())
                .with_field(
                    "subnet_group_identifier",
                    subnet_group_identifier.unwrap_or_default(),
                )
    ...
    async fn read_replication_task_assessment_runs(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_replication_task_assessment_runs(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_data_provider(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_data_provider(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn update_data_provider(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let settings = input.get_string("settings")?;
            let description = input.get_optional_string("description")?;
    ...
    async fn delete_data_provider(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_engine_versions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_engine_versions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_engine_versions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn create_replication_task(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let replication_task_settings =
                input.get_optional_string("replication_task_settings")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    replication_task_identifier.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    replication_instance_arn.unwrap_or_default(),
                )
                .with_field("cdc_start_position", cdc_start_position.unwrap_or_default())
                .with_field(
                    "replication_task_settings",
                    replication_task_settings.unwrap_or_default(),
                ))
        })
    }

    /// Read a replication_task resource
    async fn read_replication_task(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_replication_task(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
    ...
    async fn read_replication_task_assessment_run(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.database_migration_service_client
    ...
    async fn delete_replication_task_assessment_run(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.database_migration_service_client
