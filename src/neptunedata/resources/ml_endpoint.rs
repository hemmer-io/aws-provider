...
impl<'a> Ml_endpoint<'a> {
    ...
    pub async fn create(&self, instance_type: Option<String>, update: Option<bool>, neptune_iam_role_arn: Option<String>, volume_encryption_kms_key: Option<String>, ml_model_transform_job_id: Option<String>, instance_count: Option<i64>, id: Option<String>, model_name: Option<String>, ml_model_training_job_id: Option<String>) -> Result<String> {
