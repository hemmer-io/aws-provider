...
impl<'a> Ivs_realtimeService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "participant_token" => {
                self.plan_participant_token(current_state, desired_input).await
            }
            "composition" => {
                self.plan_composition(current_state, desired_input).await
            }
            ...
            "stage_session" => {
                self.plan_stage_session(current_state, desired_input).await
            }
            "ingest_configuration" => {
                self.plan_ingest_configuration(current_state, desired_input).await
            }
            "stage" => {
                self.plan_stage(current_state, desired_input).await
            }
            "encoder_configuration" => {
                self.plan_encoder_configuration(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "participant_token" => {
                self.create_participant_token(input).await
            }
            "composition" => {
                self.create_composition(input).await
            }
            "storage_configuration" => {
            ...
            "stage_session" => {
                self.create_stage_session(input).await
            }
            "ingest_configuration" => {
                self.create_ingest_configuration(input).await
            }
            "stage" => {
                self.create_stage(input).await
            }
            "encoder_configuration" => {
                self.create_encoder_configuration(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ivs_realtime",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "participant_token" => {
                self.read_participant_token(id).await
            }
            "composition" => {
                self.read_composition(id).await
            }
            "storage_configuration" => {
            ...
            "stage_session" => {
                self.read_stage_session(id).await
            }
            "ingest_configuration" => {
                self.read_ingest_configuration(id).await
            }
            "stage" => {
                self.read_stage(id).await
            }
            "encoder_configuration" => {
                self.read_encoder_configuration(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ivs_realtime",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "participant_token" => {
                self.update_participant_token(id, input).await
            }
            "composition" => {
                self.update_composition(id, input).await
            }
            "storage_configuration" => {
            ...
            "stage_session" => {
                self.update_stage_session(id, input).await
            }
            "ingest_configuration" => {
                self.update_ingest_configuration(id, input).await
            }
            "stage" => {
                self.update_stage(id, input).await
            }
            "encoder_configuration" => {
                self.update_encoder_configuration(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ivs_realtime",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "participant_token" => {
                self.delete_participant_token(id).await
            }
            "composition" => {
                self.delete_composition(id).await
            }
            "storage_configuration" => {
            ...
            "stage_session" => {
                self.delete_stage_session(id).await
            }
            "ingest_configuration" => {
                self.delete_ingest_configuration(id).await
            }
            "stage" => {
                self.delete_stage(id).await
            }
            "encoder_configuration" => {
                self.delete_encoder_configuration(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ivs_realtime",
    ...
    async fn read_participant_token(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_participant_token(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_ingest_configuration(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_ingest_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_ingest_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_stage(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let participant_token_configurations = input.get_optional_string("participant_token_configurations")?;
            let auto_participant_recording_configuration = input.get_optional_string("auto_participant_recording_configuration")?;
            let name = input.get_optional_string("name")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("tags", tags.unwrap_or_default())
                .with_field("participant_token_configurations", participant_token_configurations.unwrap_or_default())
                .with_field("auto_participant_recording_configuration", auto_participant_recording_configuration.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
            )
        })
    }
    ...
    async fn create_encoder_configuration(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_encoder_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_encoder_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
