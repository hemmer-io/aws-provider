...
impl<'a> Participant_token<'a> {
    ...
    pub async fn create(&self, attributes: Option<HashMap<String, String>>, capabilities: Option<Vec<String>>, stage_arn: String, duration: Option<i64>, user_id: Option<String>) -> Result<String> {
