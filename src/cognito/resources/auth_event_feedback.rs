...
impl<'a> Auth_event_feedback<'a> {
    ...
    pub async fn update(&self, id: &str, feedback_value: Option<String>, feedback_token: Option<String>, event_id: Option<String>, user_pool_id: Option<String>, username: Option<String>) -> Result<()> {
