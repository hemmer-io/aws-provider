...
impl<'a> Managed_login_branding<'a> {
    ...
    pub async fn create(&self, client_id: String, use_cognito_provided_values: Option<bool>, user_pool_id: String, settings: Option<String>, assets: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_id: Option<String>, use_cognito_provided_values: Option<bool>, user_pool_id: Option<String>, settings: Option<String>, assets: Option<Vec<String>>) -> Result<()> {
