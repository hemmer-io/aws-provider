...
impl<'a> Direct_connectService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "transit_virtual_interface" => {
                self.plan_transit_virtual_interface(current_state, desired_input)
                    .await
            }
            "lags" => self.plan_lags(current_state, desired_input).await,
            "locations" => self.plan_locations(current_state, desired_input).await,
            "hosted_connections" => {
                self.plan_hosted_connections(current_state, desired_input)
                    .await
            }
            "connections_on_interconnect" => {
                self.plan_connections_on_interconnect(current_state, desired_input)
                    .await
            }
            "virtual_interface" => {
                self.plan_virtual_interface(current_state, desired_input)
                    .await
            }
            "public_virtual_interface" => {
                self.plan_public_virtual_interface(current_state, desired_input)
                    .await
            }
            "virtual_gateways" => {
                self.plan_virtual_gateways(current_state, desired_input)
                    .await
            }
            "direct_connect_gateway" => {
                self.plan_direct_connect_gateway(current_state, desired_input)
                    .await
            }
            "customer_metadata" => {
                self.plan_customer_metadata(current_state, desired_input)
                    .await
            }
            "loa" => self.plan_loa(current_state, desired_input).await,
            "direct_connect_gateways" => {
                self.plan_direct_connect_gateways(current_state, desired_input)
                    .await
            }
            "direct_connect_gateway_associations" => {
                self.plan_direct_connect_gateway_associations(current_state, desired_input)
                    .await
            }
            "connection" => self.plan_connection(current_state, desired_input).await,
            "interconnects" => self.plan_interconnects(current_state, desired_input).await,
            "private_virtual_interface" => {
                self.plan_private_virtual_interface(current_state, desired_input)
                    .await
            }
            "virtual_interfaces" => {
                self.plan_virtual_interfaces(current_state, desired_input)
                    .await
            }
            "connection_loa" => self.plan_connection_loa(current_state, desired_input).await,
            "bgp_peer" => self.plan_bgp_peer(current_state, desired_input).await,
            "direct_connect_gateway_attachments" => {
                self.plan_direct_connect_gateway_attachments(current_state, desired_input)
                    .await
            }
            "direct_connect_gateway_association_proposal" => {
                self.plan_direct_connect_gateway_association_proposal(current_state, desired_input)
                    .await
            }
            "interconnect" => self.plan_interconnect(current_state, desired_input).await,
            "lag" => self.plan_lag(current_state, desired_input).await,
            "connections" => self.plan_connections(current_state, desired_input).await,
            "direct_connect_gateway_association_proposals" => {
                self.plan_direct_connect_gateway_association_proposals(current_state, desired_input)
                    .await
            }
            "router_configuration" => {
                self.plan_router_configuration(current_state, desired_input)
                    .await
            }
            "direct_connect_gateway_association" => {
                self.plan_direct_connect_gateway_association(current_state, desired_input)
                    .await
            }
            "interconnect_loa" => {
                self.plan_interconnect_loa(current_state, desired_input)
                    .await
            }
            "virtual_interface_attributes" => {
                self.plan_virtual_interface_attributes(current_state, desired_input)
                    .await
            }
            "tags" => self.plan_tags(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "direct_connect", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "transit_virtual_interface" => self.create_transit_virtual_interface(input).await,
            "lags" => self.create_lags(input).await,
            "locations" => self.create_locations(input).await,
            "hosted_connections" => self.create_hosted_connections(input).await,
            "connections_on_interconnect" => self.create_connections_on_interconnect(input).await,
            "virtual_interface" => self.create_virtual_interface(input).await,
            "public_virtual_interface" => self.create_public_virtual_interface(input).await,
            "virtual_gateways" => self.create_virtual_gateways(input).await,
            "direct_connect_gateway" => self.create_direct_connect_gateway(input).await,
            "customer_metadata" => self.create_customer_metadata(input).await,
            "loa" => self.create_loa(input).await,
            "direct_connect_gateways" => self.create_direct_connect_gateways(input).await,
            "direct_connect_gateway_associations" => {
                self.create_direct_connect_gateway_associations(input).await
            }
            "connection" => self.create_connection(input).await,
            "interconnects" => self.create_interconnects(input).await,
            "private_virtual_interface" => self.create_private_virtual_interface(input).await,
            "virtual_interfaces" => self.create_virtual_interfaces(input).await,
            "connection_loa" => self.create_connection_loa(input).await,
            "bgp_peer" => self.create_bgp_peer(input).await,
            "direct_connect_gateway_attachments" => {
                self.create_direct_connect_gateway_attachments(input).await
            }
            "direct_connect_gateway_association_proposal" => {
                self.create_direct_connect_gateway_association_proposal(input)
                    .await
            }
            "interconnect" => self.create_interconnect(input).await,
            "lag" => self.create_lag(input).await,
            "connections" => self.create_connections(input).await,
            "direct_connect_gateway_association_proposals" => {
                self.create_direct_connect_gateway_association_proposals(input)
                    .await
            }
            "router_configuration" => self.create_router_configuration(input).await,
            "direct_connect_gateway_association" => {
                self.create_direct_connect_gateway_association(input).await
            }
            "interconnect_loa" => self.create_interconnect_loa(input).await,
            "virtual_interface_attributes" => self.create_virtual_interface_attributes(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "transit_virtual_interface" => self.read_transit_virtual_interface(id).await,
            "lags" => self.read_lags(id).await,
            "locations" => self.read_locations(id).await,
            "hosted_connections" => self.read_hosted_connections(id).await,
            "connections_on_interconnect" => self.read_connections_on_interconnect(id).await,
            "virtual_interface" => self.read_virtual_interface(id).await,
            "public_virtual_interface" => self.read_public_virtual_interface(id).await,
            "virtual_gateways" => self.read_virtual_gateways(id).await,
            "direct_connect_gateway" => self.read_direct_connect_gateway(id).await,
            "customer_metadata" => self.read_customer_metadata(id).await,
            "loa" => self.read_loa(id).await,
            "direct_connect_gateways" => self.read_direct_connect_gateways(id).await,
            "direct_connect_gateway_associations" => {
                self.read_direct_connect_gateway_associations(id).await
            }
            "connection" => self.read_connection(id).await,
            "interconnects" => self.read_interconnects(id).await,
            "private_virtual_interface" => self.read_private_virtual_interface(id).await,
            "virtual_interfaces" => self.read_virtual_interfaces(id).await,
            "connection_loa" => self.read_connection_loa(id).await,
            "bgp_peer" => self.read_bgp_peer(id).await,
            "direct_connect_gateway_attachments" => {
                self.read_direct_connect_gateway_attachments(id).await
            }
            "direct_connect_gateway_association_proposal" => {
                self.read_direct_connect_gateway_association_proposal(id)
                    .await
            }
            "interconnect" => self.read_interconnect(id).await,
            "lag" => self.read_lag(id).await,
            "connections" => self.read_connections(id).await,
            "direct_connect_gateway_association_proposals" => {
                self.read_direct_connect_gateway_association_proposals(id)
                    .await
            }
            "router_configuration" => self.read_router_configuration(id).await,
            "direct_connect_gateway_association" => {
                self.read_direct_connect_gateway_association(id).await
            }
            "interconnect_loa" => self.read_interconnect_loa(id).await,
            "virtual_interface_attributes" => self.read_virtual_interface_attributes(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "transit_virtual_interface" => self.update_transit_virtual_interface(id, input).await,
            "lags" => self.update_lags(id, input).await,
            "locations" => self.update_locations(id, input).await,
            "hosted_connections" => self.update_hosted_connections(id, input).await,
            "connections_on_interconnect" => {
                self.update_connections_on_interconnect(id, input).await
            }
            "virtual_interface" => self.update_virtual_interface(id, input).await,
            "public_virtual_interface" => self.update_public_virtual_interface(id, input).await,
            "virtual_gateways" => self.update_virtual_gateways(id, input).await,
            "direct_connect_gateway" => self.update_direct_connect_gateway(id, input).await,
            "customer_metadata" => self.update_customer_metadata(id, input).await,
            "loa" => self.update_loa(id, input).await,
            "direct_connect_gateways" => self.update_direct_connect_gateways(id, input).await,
            "direct_connect_gateway_associations" => {
                self.update_direct_connect_gateway_associations(id, input)
                    .await
            }
            "connection" => self.update_connection(id, input).await,
            "interconnects" => self.update_interconnects(id, input).await,
            "private_virtual_interface" => self.update_private_virtual_interface(id, input).await,
            "virtual_interfaces" => self.update_virtual_interfaces(id, input).await,
            "connection_loa" => self.update_connection_loa(id, input).await,
            "bgp_peer" => self.update_bgp_peer(id, input).await,
            "direct_connect_gateway_attachments" => {
                self.update_direct_connect_gateway_attachments(id, input)
                    .await
            }
            "direct_connect_gateway_association_proposal" => {
                self.update_direct_connect_gateway_association_proposal(id, input)
                    .await
            }
            "interconnect" => self.update_interconnect(id, input).await,
            "lag" => self.update_lag(id, input).await,
            "connections" => self.update_connections(id, input).await,
            "direct_connect_gateway_association_proposals" => {
                self.update_direct_connect_gateway_association_proposals(id, input)
                    .await
            }
            "router_configuration" => self.update_router_configuration(id, input).await,
            "direct_connect_gateway_association" => {
                self.update_direct_connect_gateway_association(id, input)
                    .await
            }
            "interconnect_loa" => self.update_interconnect_loa(id, input).await,
            "virtual_interface_attributes" => {
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "transit_virtual_interface" => self.delete_transit_virtual_interface(id).await,
            "lags" => self.delete_lags(id).await,
            "locations" => self.delete_locations(id).await,
            "hosted_connections" => self.delete_hosted_connections(id).await,
            "connections_on_interconnect" => self.delete_connections_on_interconnect(id).await,
            "virtual_interface" => self.delete_virtual_interface(id).await,
            "public_virtual_interface" => self.delete_public_virtual_interface(id).await,
            "virtual_gateways" => self.delete_virtual_gateways(id).await,
            "direct_connect_gateway" => self.delete_direct_connect_gateway(id).await,
            "customer_metadata" => self.delete_customer_metadata(id).await,
            "loa" => self.delete_loa(id).await,
            "direct_connect_gateways" => self.delete_direct_connect_gateways(id).await,
            "direct_connect_gateway_associations" => {
                self.delete_direct_connect_gateway_associations(id).await
            }
            "connection" => self.delete_connection(id).await,
            "interconnects" => self.delete_interconnects(id).await,
            "private_virtual_interface" => self.delete_private_virtual_interface(id).await,
            "virtual_interfaces" => self.delete_virtual_interfaces(id).await,
            "connection_loa" => self.delete_connection_loa(id).await,
            "bgp_peer" => self.delete_bgp_peer(id).await,
            "direct_connect_gateway_attachments" => {
                self.delete_direct_connect_gateway_attachments(id).await
            }
            "direct_connect_gateway_association_proposal" => {
                self.delete_direct_connect_gateway_association_proposal(id)
                    .await
            }
            "interconnect" => self.delete_interconnect(id).await,
            "lag" => self.delete_lag(id).await,
            "connections" => self.delete_connections(id).await,
            "direct_connect_gateway_association_proposals" => {
                self.delete_direct_connect_gateway_association_proposals(id)
                    .await
            }
            "router_configuration" => self.delete_router_configuration(id).await,
            "direct_connect_gateway_association" => {
                self.delete_direct_connect_gateway_association(id).await
            }
            "interconnect_loa" => self.delete_interconnect_loa(id).await,
            "virtual_interface_attributes" => self.delete_virtual_interface_attributes(id).await,
    ...
    async fn create_transit_virtual_interface(
        ...
        self.provider.runtime().block_on(async {
            ...
            let new_transit_virtual_interface =
                input.get_string("new_transit_virtual_interface")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    new_transit_virtual_interface.unwrap_or_default(),
                ))
        })
    }

    /// Read a transit_virtual_interface resource
    async fn read_transit_virtual_interface(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_transit_virtual_interface(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_lags(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_lags(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn update_lags(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_lags(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_locations(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_locations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn update_locations(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_locations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_hosted_connections(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_hosted_connections(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_hosted_connections(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn read_connections_on_interconnect(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_connections_on_interconnect(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_virtual_interface(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_virtual_interface(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_virtual_interface(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    new_public_virtual_interface.unwrap_or_default(),
                ))
        })
    }

    /// Read a public_virtual_interface resource
    async fn read_public_virtual_interface(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_public_virtual_interface(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_virtual_gateways(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_virtual_gateways(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_virtual_gateways(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_direct_connect_gateway(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    direct_connect_gateway_name.unwrap_or_default(),
                )
    ...
    async fn read_direct_connect_gateway(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_direct_connect_gateway(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_customer_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_customer_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_customer_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_loa(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    /// Read a loa resource
    async fn read_loa(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn update_loa(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_loa(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_direct_connect_gateways(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_direct_connect_gateways(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_direct_connect_gateways(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn read_direct_connect_gateway_associations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_direct_connect_gateway_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_interconnects(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_interconnects(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn update_interconnects(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_interconnects(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_private_virtual_interface(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let connection_id = input.get_string("connection_id")?;
            let new_private_virtual_interface =
                input.get_string("new_private_virtual_interface")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    new_private_virtual_interface.unwrap_or_default(),
                ))
        })
    }

    /// Read a private_virtual_interface resource
    async fn read_private_virtual_interface(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_private_virtual_interface(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_virtual_interfaces(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_virtual_interfaces(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_virtual_interfaces(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_connection_loa(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_connection_loa(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_connection_loa(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_bgp_peer(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    virtual_interface_id.unwrap_or_default(),
                ))
        })
    }

    /// Read a bgp_peer resource
    async fn read_bgp_peer(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn update_bgp_peer(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let new_bgp_peer = input.get_optional_string("new_bgp_peer")?;
            let virtual_interface_id = input.get_optional_string("virtual_interface_id")?;
    ...
    async fn delete_bgp_peer(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn read_direct_connect_gateway_attachments(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_direct_connect_gateway_attachments(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_direct_connect_gateway_association_proposal(
        ...
        self.provider.runtime().block_on(async {
            ...
            let remove_allowed_prefixes_to_direct_connect_gateway =
                input.get_optional_string("remove_allowed_prefixes_to_direct_connect_gateway")?;
            let direct_connect_gateway_owner_account =
                input.get_string("direct_connect_gateway_owner_account")?;
            let add_allowed_prefixes_to_direct_connect_gateway =
                input.get_optional_string("add_allowed_prefixes_to_direct_connect_gateway")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    remove_allowed_prefixes_to_direct_connect_gateway.unwrap_or_default(),
                )
                .with_field(
                    "direct_connect_gateway_owner_account",
                    direct_connect_gateway_owner_account.unwrap_or_default(),
                )
                .with_field(
                    "add_allowed_prefixes_to_direct_connect_gateway",
                    add_allowed_prefixes_to_direct_connect_gateway.unwrap_or_default(),
                )
                .with_field(
                    "direct_connect_gateway_id",
                    direct_connect_gateway_id.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn delete_direct_connect_gateway_association_proposal(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_interconnect(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_interconnect(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn update_interconnect(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let location = input.get_string("location")?;
    ...
    async fn delete_interconnect(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_lag(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let request_mac_sec = input.get_optional_string("request_mac_sec")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    child_connection_tags.unwrap_or_default(),
                )
                .with_field("provider_name", provider_name.unwrap_or_default())
                .with_field(
                    "number_of_connections",
                    number_of_connections.unwrap_or_default(),
                )
                .with_field("location", location.unwrap_or_default())
                .with_field("connection_id", connection_id.unwrap_or_default())
                .with_field(
                    "connections_bandwidth",
                    connections_bandwidth.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default()))
        })
    }
    ...
    /// Read a lag resource
    async fn read_lag(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn update_lag(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let request_mac_sec = input.get_optional_string("request_mac_sec")?;
            let lag_name = input.get_string("lag_name")?;
    ...
    async fn delete_lag(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn delete_direct_connect_gateway_association_proposals(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_router_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_router_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_router_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn read_direct_connect_gateway_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_direct_connect_gateway_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
    ...
    async fn create_interconnect_loa(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_interconnect_loa(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_interconnect_loa(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    virtual_interface_name.unwrap_or_default(),
                )
    ...
    async fn read_virtual_interface_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.direct_connect_client
    ...
    async fn delete_virtual_interface_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.direct_connect_client
