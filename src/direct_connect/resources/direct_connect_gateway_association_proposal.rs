...
impl<'a> Direct_connect_gateway_association_proposal<'a> {
    ...
    pub async fn create(&self, add_allowed_prefixes_to_direct_connect_gateway: Option<Vec<String>>, gateway_id: String, direct_connect_gateway_owner_account: String, direct_connect_gateway_id: String, remove_allowed_prefixes_to_direct_connect_gateway: Option<Vec<String>>) -> Result<String> {
