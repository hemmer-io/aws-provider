...
impl<'a> Direct_connect_gateway<'a> {
    ...
    pub async fn create(&self, direct_connect_gateway_name: String, tags: Option<Vec<String>>, amazon_side_asn: Option<i64>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, direct_connect_gateway_name: Option<String>, tags: Option<Vec<String>>, amazon_side_asn: Option<i64>) -> Result<()> {
