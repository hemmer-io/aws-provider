...
impl<'a> Direct_connect_gateway<'a> {
    ...
    pub async fn create(&self, amazon_side_asn: Option<i64>, direct_connect_gateway_name: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, amazon_side_asn: Option<i64>, direct_connect_gateway_name: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
