...
impl<'a> Virtual_interface_attributes<'a> {
    ...
    pub async fn update(&self, id: &str, virtual_interface_id: Option<String>, enable_site_link: Option<bool>, virtual_interface_name: Option<String>, mtu: Option<i64>) -> Result<()> {
