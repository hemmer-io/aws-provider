...
impl<'a> Custom_data_identifier<'a> {
    ...
    pub async fn create(&self, keywords: Option<Vec<String>>, maximum_match_distance: Option<i64>, client_token: Option<String>, description: Option<String>, name: String, regex: String, ignore_words: Option<Vec<String>>, severity_levels: Option<Vec<String>>, tags: Option<HashMap<String, String>>) -> Result<String> {
