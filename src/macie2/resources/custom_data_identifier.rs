...
impl<'a> Custom_data_identifier<'a> {
    ...
    pub async fn create(&self, ignore_words: Option<Vec<String>>, name: String, client_token: Option<String>, keywords: Option<Vec<String>>, description: Option<String>, severity_levels: Option<Vec<String>>, regex: String, maximum_match_distance: Option<i64>, tags: Option<HashMap<String, String>>) -> Result<String> {
