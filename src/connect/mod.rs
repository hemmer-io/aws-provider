...
impl<'a> ConnectService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "contact_evaluation" => {
                self.plan_contact_evaluation(current_state, desired_input)
                    .await
            }
            "contact_flow_content" => {
                self.plan_contact_flow_content(current_state, desired_input)
                    .await
            }
            "contact_routing_data" => {
                self.plan_contact_routing_data(current_state, desired_input)
                    .await
            }
            "agent_status" => self.plan_agent_status(current_state, desired_input).await,
            "queue_outbound_email_config" => {
                self.plan_queue_outbound_email_config(current_state, desired_input)
                    .await
            }
            "contact_metrics" => {
                self.plan_contact_metrics(current_state, desired_input)
                    .await
            }
            "participant" => self.plan_participant(current_state, desired_input).await,
            "queue" => self.plan_queue(current_state, desired_input).await,
            "user_proficiencies" => {
                self.plan_user_proficiencies(current_state, desired_input)
                    .await
            }
            "quick_connect" => self.plan_quick_connect(current_state, desired_input).await,
            "contact_flow_name" => {
                self.plan_contact_flow_name(current_state, desired_input)
                    .await
            }
            "queue_hours_of_operation" => {
                self.plan_queue_hours_of_operation(current_state, desired_input)
                    .await
            }
            "queue_max_contacts" => {
                self.plan_queue_max_contacts(current_state, desired_input)
                    .await
            }
            "user" => self.plan_user(current_state, desired_input).await,
            "metric_data" => self.plan_metric_data(current_state, desired_input).await,
            ...
            "participant_role_config" => {
                self.plan_participant_role_config(current_state, desired_input)
                    .await
            }
            "prompt_file" => self.plan_prompt_file(current_state, desired_input).await,
            "queue_status" => self.plan_queue_status(current_state, desired_input).await,
            "contact_flow_module" => {
                self.plan_contact_flow_module(current_state, desired_input)
                    .await
            }
            "push_notification_registration" => {
                self.plan_push_notification_registration(current_state, desired_input)
                    .await
            }
            "participant_authentication" => {
                self.plan_participant_authentication(current_state, desired_input)
                    .await
            }
            "evaluation_form" => {
                self.plan_evaluation_form(current_state, desired_input)
                    .await
            }
            "traffic_distribution_group" => {
                self.plan_traffic_distribution_group(current_state, desired_input)
                    .await
            }
            "use_case" => self.plan_use_case(current_state, desired_input).await,
            "contact_attributes" => {
                self.plan_contact_attributes(current_state, desired_input)
                    .await
            }
            "user_phone_config" => {
                self.plan_user_phone_config(current_state, desired_input)
                    .await
            }
            "contact_flow_module_metadata" => {
                self.plan_contact_flow_module_metadata(current_state, desired_input)
                    .await
            }
            "routing_profile_default_outbound_queue" => {
                self.plan_routing_profile_default_outbound_queue(current_state, desired_input)
                    .await
            }
            "predefined_attribute" => {
                self.plan_predefined_attribute(current_state, desired_input)
                    .await
            }
            "instance" => self.plan_instance(current_state, desired_input).await,
            "user_hierarchy_group" => {
                self.plan_user_hierarchy_group(current_state, desired_input)
                    .await
            }
            "phone_number" => self.plan_phone_number(current_state, desired_input).await,
            "view_version" => self.plan_view_version(current_state, desired_input).await,
            "instance_attribute" => {
                self.plan_instance_attribute(current_state, desired_input)
                    .await
            }
            "task_template" => self.plan_task_template(current_state, desired_input).await,
            "persistent_contact_association" => {
                self.plan_persistent_contact_association(current_state, desired_input)
                    .await
            }
            "contact_flow_version" => {
                self.plan_contact_flow_version(current_state, desired_input)
                    .await
            }
            "view" => self.plan_view(current_state, desired_input).await,
            "queue_name" => self.plan_queue_name(current_state, desired_input).await,
            "integration_association" => {
                self.plan_integration_association(current_state, desired_input)
                    .await
            }
            "quick_connect_config" => {
                self.plan_quick_connect_config(current_state, desired_input)
                    .await
            }
            "quick_connect_name" => {
                self.plan_quick_connect_name(current_state, desired_input)
                    .await
            }
            "prompt" => self.plan_prompt(current_state, desired_input).await,
            "routing_profile_agent_availability_timer" => {
                self.plan_routing_profile_agent_availability_timer(current_state, desired_input)
                    .await
            }
            "routing_profile_name" => {
                self.plan_routing_profile_name(current_state, desired_input)
                    .await
            }
            "user_hierarchy_structure" => {
                self.plan_user_hierarchy_structure(current_state, desired_input)
                    .await
            }
            "attached_file" => self.plan_attached_file(current_state, desired_input).await,
            "routing_profile_queues" => {
                self.plan_routing_profile_queues(current_state, desired_input)
                    .await
            }
            "user_security_profiles" => {
                self.plan_user_security_profiles(current_state, desired_input)
                    .await
            }
            "current_user_data" => {
                self.plan_current_user_data(current_state, desired_input)
                    .await
            }
            "user_status" => self.plan_user_status(current_state, desired_input).await,
            "metric_data_v2" => self.plan_metric_data_v2(current_state, desired_input).await,
            "email_address_metadata" => {
                self.plan_email_address_metadata(current_state, desired_input)
                    .await
            }
            "traffic_distribution" => {
                self.plan_traffic_distribution(current_state, desired_input)
                    .await
            }
            "phone_number_metadata" => {
                self.plan_phone_number_metadata(current_state, desired_input)
                    .await
            }
            "queue_outbound_caller_config" => {
                self.plan_queue_outbound_caller_config(current_state, desired_input)
                    .await
            }
            "routing_profile" => {
                self.plan_routing_profile(current_state, desired_input)
                    .await
            }
            "view_content" => self.plan_view_content(current_state, desired_input).await,
            "effective_hours_of_operations" => {
                self.plan_effective_hours_of_operations(current_state, desired_input)
                    .await
            }
            "security_profile" => {
            ...
            "hours_of_operation_override" => {
                self.plan_hours_of_operation_override(current_state, desired_input)
                    .await
            }
            "rule" => self.plan_rule(current_state, desired_input).await,
            "contact_flow_metadata" => {
                self.plan_contact_flow_metadata(current_state, desired_input)
                    .await
            }
            "current_metric_data" => {
                self.plan_current_metric_data(current_state, desired_input)
                    .await
            }
            "contact_schedule" => {
                self.plan_contact_schedule(current_state, desired_input)
                    .await
            }
            "instance_storage_config" => {
                self.plan_instance_storage_config(current_state, desired_input)
                    .await
            }
            "flow_association" => {
                self.plan_flow_association(current_state, desired_input)
                    .await
            }
            "user_hierarchy" => self.plan_user_hierarchy(current_state, desired_input).await,
            "contact_flow" => self.plan_contact_flow(current_state, desired_input).await,
            "user_identity_info" => {
                self.plan_user_identity_info(current_state, desired_input)
                    .await
            }
            "routing_profile_concurrency" => {
                self.plan_routing_profile_concurrency(current_state, desired_input)
                    .await
            }
            "contact_flow_module_content" => {
                self.plan_contact_flow_module_content(current_state, desired_input)
                    .await
            }
            "user_hierarchy_group_name" => {
                self.plan_user_hierarchy_group_name(current_state, desired_input)
                    .await
            }
            "federation_token" => {
                self.plan_federation_token(current_state, desired_input)
                    .await
            }
            "hours_of_operation" => {
                self.plan_hours_of_operation(current_state, desired_input)
                    .await
            }
            "email_address" => self.plan_email_address(current_state, desired_input).await,
            "authentication_profile" => {
                self.plan_authentication_profile(current_state, desired_input)
                    .await
            }
            "user_routing_profile" => {
                self.plan_user_routing_profile(current_state, desired_input)
                    .await
            }
            "view_metadata" => self.plan_view_metadata(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "contact_evaluation" => self.create_contact_evaluation(input).await,
            "contact_flow_content" => self.create_contact_flow_content(input).await,
            "contact_routing_data" => self.create_contact_routing_data(input).await,
            "agent_status" => self.create_agent_status(input).await,
            "queue_outbound_email_config" => self.create_queue_outbound_email_config(input).await,
            "contact_metrics" => self.create_contact_metrics(input).await,
            "participant" => self.create_participant(input).await,
            "queue" => self.create_queue(input).await,
            "user_proficiencies" => self.create_user_proficiencies(input).await,
            "quick_connect" => self.create_quick_connect(input).await,
            "contact_flow_name" => self.create_contact_flow_name(input).await,
            "queue_hours_of_operation" => self.create_queue_hours_of_operation(input).await,
            "queue_max_contacts" => self.create_queue_max_contacts(input).await,
            "user" => self.create_user(input).await,
            "metric_data" => self.create_metric_data(input).await,
            "vocabulary" => self.create_vocabulary(input).await,
            "contact" => self.create_contact(input).await,
            "participant_role_config" => self.create_participant_role_config(input).await,
            "prompt_file" => self.create_prompt_file(input).await,
            "queue_status" => self.create_queue_status(input).await,
            "contact_flow_module" => self.create_contact_flow_module(input).await,
            "push_notification_registration" => {
                self.create_push_notification_registration(input).await
            }
            "participant_authentication" => self.create_participant_authentication(input).await,
            "evaluation_form" => self.create_evaluation_form(input).await,
            "traffic_distribution_group" => self.create_traffic_distribution_group(input).await,
            "use_case" => self.create_use_case(input).await,
            "contact_attributes" => self.create_contact_attributes(input).await,
            "user_phone_config" => self.create_user_phone_config(input).await,
            "contact_flow_module_metadata" => self.create_contact_flow_module_metadata(input).await,
            "routing_profile_default_outbound_queue" => {
                self.create_routing_profile_default_outbound_queue(input)
                    .await
            }
            "predefined_attribute" => self.create_predefined_attribute(input).await,
            "instance" => self.create_instance(input).await,
            "user_hierarchy_group" => self.create_user_hierarchy_group(input).await,
            "phone_number" => self.create_phone_number(input).await,
            "view_version" => self.create_view_version(input).await,
            "instance_attribute" => self.create_instance_attribute(input).await,
            "task_template" => self.create_task_template(input).await,
            "persistent_contact_association" => {
                self.create_persistent_contact_association(input).await
            }
            "contact_flow_version" => self.create_contact_flow_version(input).await,
            "view" => self.create_view(input).await,
            "queue_name" => self.create_queue_name(input).await,
            "integration_association" => self.create_integration_association(input).await,
            "quick_connect_config" => self.create_quick_connect_config(input).await,
            "quick_connect_name" => self.create_quick_connect_name(input).await,
            "prompt" => self.create_prompt(input).await,
            "routing_profile_agent_availability_timer" => {
                self.create_routing_profile_agent_availability_timer(input)
                    .await
            }
            "routing_profile_name" => self.create_routing_profile_name(input).await,
            "user_hierarchy_structure" => self.create_user_hierarchy_structure(input).await,
            "attached_file" => self.create_attached_file(input).await,
            "routing_profile_queues" => self.create_routing_profile_queues(input).await,
            "user_security_profiles" => self.create_user_security_profiles(input).await,
            "current_user_data" => self.create_current_user_data(input).await,
            "user_status" => self.create_user_status(input).await,
            "metric_data_v2" => self.create_metric_data_v2(input).await,
            "email_address_metadata" => self.create_email_address_metadata(input).await,
            "traffic_distribution" => self.create_traffic_distribution(input).await,
            "phone_number_metadata" => self.create_phone_number_metadata(input).await,
            "queue_outbound_caller_config" => self.create_queue_outbound_caller_config(input).await,
            "routing_profile" => self.create_routing_profile(input).await,
            "view_content" => self.create_view_content(input).await,
            "effective_hours_of_operations" => {
                self.create_effective_hours_of_operations(input).await
            }
            "security_profile" => self.create_security_profile(input).await,
            "hours_of_operation_override" => self.create_hours_of_operation_override(input).await,
            "rule" => self.create_rule(input).await,
            "contact_flow_metadata" => self.create_contact_flow_metadata(input).await,
            "current_metric_data" => self.create_current_metric_data(input).await,
            "contact_schedule" => self.create_contact_schedule(input).await,
            "instance_storage_config" => self.create_instance_storage_config(input).await,
            "flow_association" => self.create_flow_association(input).await,
            "user_hierarchy" => self.create_user_hierarchy(input).await,
            "contact_flow" => self.create_contact_flow(input).await,
            "user_identity_info" => self.create_user_identity_info(input).await,
            "routing_profile_concurrency" => self.create_routing_profile_concurrency(input).await,
            "contact_flow_module_content" => self.create_contact_flow_module_content(input).await,
            "user_hierarchy_group_name" => self.create_user_hierarchy_group_name(input).await,
            "federation_token" => self.create_federation_token(input).await,
            "hours_of_operation" => self.create_hours_of_operation(input).await,
            "email_address" => self.create_email_address(input).await,
            "authentication_profile" => self.create_authentication_profile(input).await,
            "user_routing_profile" => self.create_user_routing_profile(input).await,
            "view_metadata" => self.create_view_metadata(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "connect", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "contact_evaluation" => self.read_contact_evaluation(id).await,
            "contact_flow_content" => self.read_contact_flow_content(id).await,
            "contact_routing_data" => self.read_contact_routing_data(id).await,
            "agent_status" => self.read_agent_status(id).await,
            "queue_outbound_email_config" => self.read_queue_outbound_email_config(id).await,
            "contact_metrics" => self.read_contact_metrics(id).await,
            "participant" => self.read_participant(id).await,
            "queue" => self.read_queue(id).await,
            "user_proficiencies" => self.read_user_proficiencies(id).await,
            "quick_connect" => self.read_quick_connect(id).await,
            "contact_flow_name" => self.read_contact_flow_name(id).await,
            "queue_hours_of_operation" => self.read_queue_hours_of_operation(id).await,
            "queue_max_contacts" => self.read_queue_max_contacts(id).await,
            "user" => self.read_user(id).await,
            "metric_data" => self.read_metric_data(id).await,
            "vocabulary" => self.read_vocabulary(id).await,
            "contact" => self.read_contact(id).await,
            "participant_role_config" => self.read_participant_role_config(id).await,
            "prompt_file" => self.read_prompt_file(id).await,
            "queue_status" => self.read_queue_status(id).await,
            "contact_flow_module" => self.read_contact_flow_module(id).await,
            "push_notification_registration" => self.read_push_notification_registration(id).await,
            "participant_authentication" => self.read_participant_authentication(id).await,
            "evaluation_form" => self.read_evaluation_form(id).await,
            "traffic_distribution_group" => self.read_traffic_distribution_group(id).await,
            "use_case" => self.read_use_case(id).await,
            "contact_attributes" => self.read_contact_attributes(id).await,
            "user_phone_config" => self.read_user_phone_config(id).await,
            "contact_flow_module_metadata" => self.read_contact_flow_module_metadata(id).await,
            "routing_profile_default_outbound_queue" => {
                self.read_routing_profile_default_outbound_queue(id).await
            }
            "predefined_attribute" => self.read_predefined_attribute(id).await,
            "instance" => self.read_instance(id).await,
            "user_hierarchy_group" => self.read_user_hierarchy_group(id).await,
            "phone_number" => self.read_phone_number(id).await,
            "view_version" => self.read_view_version(id).await,
            "instance_attribute" => self.read_instance_attribute(id).await,
            "task_template" => self.read_task_template(id).await,
            "persistent_contact_association" => self.read_persistent_contact_association(id).await,
            "contact_flow_version" => self.read_contact_flow_version(id).await,
            "view" => self.read_view(id).await,
            "queue_name" => self.read_queue_name(id).await,
            "integration_association" => self.read_integration_association(id).await,
            "quick_connect_config" => self.read_quick_connect_config(id).await,
            "quick_connect_name" => self.read_quick_connect_name(id).await,
            "prompt" => self.read_prompt(id).await,
            "routing_profile_agent_availability_timer" => {
                self.read_routing_profile_agent_availability_timer(id).await
            }
            "routing_profile_name" => self.read_routing_profile_name(id).await,
            "user_hierarchy_structure" => self.read_user_hierarchy_structure(id).await,
            "attached_file" => self.read_attached_file(id).await,
            "routing_profile_queues" => self.read_routing_profile_queues(id).await,
            "user_security_profiles" => self.read_user_security_profiles(id).await,
            "current_user_data" => self.read_current_user_data(id).await,
            "user_status" => self.read_user_status(id).await,
            "metric_data_v2" => self.read_metric_data_v2(id).await,
            "email_address_metadata" => self.read_email_address_metadata(id).await,
            "traffic_distribution" => self.read_traffic_distribution(id).await,
            "phone_number_metadata" => self.read_phone_number_metadata(id).await,
            "queue_outbound_caller_config" => self.read_queue_outbound_caller_config(id).await,
            "routing_profile" => self.read_routing_profile(id).await,
            "view_content" => self.read_view_content(id).await,
            "effective_hours_of_operations" => self.read_effective_hours_of_operations(id).await,
            "security_profile" => self.read_security_profile(id).await,
            "hours_of_operation_override" => self.read_hours_of_operation_override(id).await,
            "rule" => self.read_rule(id).await,
            "contact_flow_metadata" => self.read_contact_flow_metadata(id).await,
            "current_metric_data" => self.read_current_metric_data(id).await,
            "contact_schedule" => self.read_contact_schedule(id).await,
            "instance_storage_config" => self.read_instance_storage_config(id).await,
            "flow_association" => self.read_flow_association(id).await,
            "user_hierarchy" => self.read_user_hierarchy(id).await,
            "contact_flow" => self.read_contact_flow(id).await,
            "user_identity_info" => self.read_user_identity_info(id).await,
            "routing_profile_concurrency" => self.read_routing_profile_concurrency(id).await,
            "contact_flow_module_content" => self.read_contact_flow_module_content(id).await,
            "user_hierarchy_group_name" => self.read_user_hierarchy_group_name(id).await,
            "federation_token" => self.read_federation_token(id).await,
            "hours_of_operation" => self.read_hours_of_operation(id).await,
            "email_address" => self.read_email_address(id).await,
            "authentication_profile" => self.read_authentication_profile(id).await,
            "user_routing_profile" => self.read_user_routing_profile(id).await,
            "view_metadata" => self.read_view_metadata(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "connect", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "contact_evaluation" => self.update_contact_evaluation(id, input).await,
            "contact_flow_content" => self.update_contact_flow_content(id, input).await,
            "contact_routing_data" => self.update_contact_routing_data(id, input).await,
            "agent_status" => self.update_agent_status(id, input).await,
            "queue_outbound_email_config" => {
                self.update_queue_outbound_email_config(id, input).await
            }
            "contact_metrics" => self.update_contact_metrics(id, input).await,
            "participant" => self.update_participant(id, input).await,
            "queue" => self.update_queue(id, input).await,
            "user_proficiencies" => self.update_user_proficiencies(id, input).await,
            "quick_connect" => self.update_quick_connect(id, input).await,
            "contact_flow_name" => self.update_contact_flow_name(id, input).await,
            "queue_hours_of_operation" => self.update_queue_hours_of_operation(id, input).await,
            "queue_max_contacts" => self.update_queue_max_contacts(id, input).await,
            "user" => self.update_user(id, input).await,
            "metric_data" => self.update_metric_data(id, input).await,
            "vocabulary" => self.update_vocabulary(id, input).await,
            "contact" => self.update_contact(id, input).await,
            "participant_role_config" => self.update_participant_role_config(id, input).await,
            "prompt_file" => self.update_prompt_file(id, input).await,
            "queue_status" => self.update_queue_status(id, input).await,
            "contact_flow_module" => self.update_contact_flow_module(id, input).await,
            "push_notification_registration" => {
                self.update_push_notification_registration(id, input).await
            }
            "participant_authentication" => self.update_participant_authentication(id, input).await,
            "evaluation_form" => self.update_evaluation_form(id, input).await,
            "traffic_distribution_group" => self.update_traffic_distribution_group(id, input).await,
            "use_case" => self.update_use_case(id, input).await,
            "contact_attributes" => self.update_contact_attributes(id, input).await,
            "user_phone_config" => self.update_user_phone_config(id, input).await,
            "contact_flow_module_metadata" => {
                self.update_contact_flow_module_metadata(id, input).await
            }
            "routing_profile_default_outbound_queue" => {
                self.update_routing_profile_default_outbound_queue(id, input)
                    .await
            }
            "predefined_attribute" => self.update_predefined_attribute(id, input).await,
            "instance" => self.update_instance(id, input).await,
            "user_hierarchy_group" => self.update_user_hierarchy_group(id, input).await,
            "phone_number" => self.update_phone_number(id, input).await,
            "view_version" => self.update_view_version(id, input).await,
            "instance_attribute" => self.update_instance_attribute(id, input).await,
            "task_template" => self.update_task_template(id, input).await,
            "persistent_contact_association" => {
                self.update_persistent_contact_association(id, input).await
            }
            "contact_flow_version" => self.update_contact_flow_version(id, input).await,
            "view" => self.update_view(id, input).await,
            "queue_name" => self.update_queue_name(id, input).await,
            "integration_association" => self.update_integration_association(id, input).await,
            "quick_connect_config" => self.update_quick_connect_config(id, input).await,
            "quick_connect_name" => self.update_quick_connect_name(id, input).await,
            "prompt" => self.update_prompt(id, input).await,
            "routing_profile_agent_availability_timer" => {
                self.update_routing_profile_agent_availability_timer(id, input)
                    .await
            }
            "routing_profile_name" => self.update_routing_profile_name(id, input).await,
            "user_hierarchy_structure" => self.update_user_hierarchy_structure(id, input).await,
            "attached_file" => self.update_attached_file(id, input).await,
            "routing_profile_queues" => self.update_routing_profile_queues(id, input).await,
            "user_security_profiles" => self.update_user_security_profiles(id, input).await,
            "current_user_data" => self.update_current_user_data(id, input).await,
            "user_status" => self.update_user_status(id, input).await,
            "metric_data_v2" => self.update_metric_data_v2(id, input).await,
            "email_address_metadata" => self.update_email_address_metadata(id, input).await,
            "traffic_distribution" => self.update_traffic_distribution(id, input).await,
            "phone_number_metadata" => self.update_phone_number_metadata(id, input).await,
            "queue_outbound_caller_config" => {
                self.update_queue_outbound_caller_config(id, input).await
            }
            "routing_profile" => self.update_routing_profile(id, input).await,
            "view_content" => self.update_view_content(id, input).await,
            "effective_hours_of_operations" => {
            ...
            "contact_flow_metadata" => self.update_contact_flow_metadata(id, input).await,
            "current_metric_data" => self.update_current_metric_data(id, input).await,
            "contact_schedule" => self.update_contact_schedule(id, input).await,
            "instance_storage_config" => self.update_instance_storage_config(id, input).await,
            "flow_association" => self.update_flow_association(id, input).await,
            "user_hierarchy" => self.update_user_hierarchy(id, input).await,
            "contact_flow" => self.update_contact_flow(id, input).await,
            "user_identity_info" => self.update_user_identity_info(id, input).await,
            "routing_profile_concurrency" => {
            ...
            "user_hierarchy_group_name" => self.update_user_hierarchy_group_name(id, input).await,
            "federation_token" => self.update_federation_token(id, input).await,
            "hours_of_operation" => self.update_hours_of_operation(id, input).await,
            "email_address" => self.update_email_address(id, input).await,
            "authentication_profile" => self.update_authentication_profile(id, input).await,
            "user_routing_profile" => self.update_user_routing_profile(id, input).await,
            "view_metadata" => self.update_view_metadata(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "connect", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "contact_evaluation" => self.delete_contact_evaluation(id).await,
            "contact_flow_content" => self.delete_contact_flow_content(id).await,
            "contact_routing_data" => self.delete_contact_routing_data(id).await,
            "agent_status" => self.delete_agent_status(id).await,
            "queue_outbound_email_config" => self.delete_queue_outbound_email_config(id).await,
            "contact_metrics" => self.delete_contact_metrics(id).await,
            "participant" => self.delete_participant(id).await,
            "queue" => self.delete_queue(id).await,
            "user_proficiencies" => self.delete_user_proficiencies(id).await,
            "quick_connect" => self.delete_quick_connect(id).await,
            "contact_flow_name" => self.delete_contact_flow_name(id).await,
            "queue_hours_of_operation" => self.delete_queue_hours_of_operation(id).await,
            "queue_max_contacts" => self.delete_queue_max_contacts(id).await,
            "user" => self.delete_user(id).await,
            "metric_data" => self.delete_metric_data(id).await,
            "vocabulary" => self.delete_vocabulary(id).await,
            "contact" => self.delete_contact(id).await,
            "participant_role_config" => self.delete_participant_role_config(id).await,
            "prompt_file" => self.delete_prompt_file(id).await,
            "queue_status" => self.delete_queue_status(id).await,
            "contact_flow_module" => self.delete_contact_flow_module(id).await,
            "push_notification_registration" => {
                self.delete_push_notification_registration(id).await
            }
            "participant_authentication" => self.delete_participant_authentication(id).await,
            "evaluation_form" => self.delete_evaluation_form(id).await,
            "traffic_distribution_group" => self.delete_traffic_distribution_group(id).await,
            "use_case" => self.delete_use_case(id).await,
            "contact_attributes" => self.delete_contact_attributes(id).await,
            "user_phone_config" => self.delete_user_phone_config(id).await,
            "contact_flow_module_metadata" => self.delete_contact_flow_module_metadata(id).await,
            "routing_profile_default_outbound_queue" => {
                self.delete_routing_profile_default_outbound_queue(id).await
            }
            "predefined_attribute" => self.delete_predefined_attribute(id).await,
            "instance" => self.delete_instance(id).await,
            "user_hierarchy_group" => self.delete_user_hierarchy_group(id).await,
            "phone_number" => self.delete_phone_number(id).await,
            "view_version" => self.delete_view_version(id).await,
            "instance_attribute" => self.delete_instance_attribute(id).await,
            "task_template" => self.delete_task_template(id).await,
            "persistent_contact_association" => {
                self.delete_persistent_contact_association(id).await
            }
            "contact_flow_version" => self.delete_contact_flow_version(id).await,
            "view" => self.delete_view(id).await,
            "queue_name" => self.delete_queue_name(id).await,
            "integration_association" => self.delete_integration_association(id).await,
            "quick_connect_config" => self.delete_quick_connect_config(id).await,
            "quick_connect_name" => self.delete_quick_connect_name(id).await,
            "prompt" => self.delete_prompt(id).await,
            "routing_profile_agent_availability_timer" => {
                self.delete_routing_profile_agent_availability_timer(id)
                    .await
            }
            "routing_profile_name" => self.delete_routing_profile_name(id).await,
            "user_hierarchy_structure" => self.delete_user_hierarchy_structure(id).await,
            "attached_file" => self.delete_attached_file(id).await,
            "routing_profile_queues" => self.delete_routing_profile_queues(id).await,
            "user_security_profiles" => self.delete_user_security_profiles(id).await,
            "current_user_data" => self.delete_current_user_data(id).await,
            "user_status" => self.delete_user_status(id).await,
            "metric_data_v2" => self.delete_metric_data_v2(id).await,
            "email_address_metadata" => self.delete_email_address_metadata(id).await,
            "traffic_distribution" => self.delete_traffic_distribution(id).await,
            "phone_number_metadata" => self.delete_phone_number_metadata(id).await,
            "queue_outbound_caller_config" => self.delete_queue_outbound_caller_config(id).await,
            "routing_profile" => self.delete_routing_profile(id).await,
            "view_content" => self.delete_view_content(id).await,
            "effective_hours_of_operations" => self.delete_effective_hours_of_operations(id).await,
            "security_profile" => self.delete_security_profile(id).await,
            "hours_of_operation_override" => self.delete_hours_of_operation_override(id).await,
            "rule" => self.delete_rule(id).await,
            "contact_flow_metadata" => self.delete_contact_flow_metadata(id).await,
            "current_metric_data" => self.delete_current_metric_data(id).await,
            "contact_schedule" => self.delete_contact_schedule(id).await,
            "instance_storage_config" => self.delete_instance_storage_config(id).await,
            "flow_association" => self.delete_flow_association(id).await,
            "user_hierarchy" => self.delete_user_hierarchy(id).await,
            "contact_flow" => self.delete_contact_flow(id).await,
            "user_identity_info" => self.delete_user_identity_info(id).await,
            "routing_profile_concurrency" => self.delete_routing_profile_concurrency(id).await,
            "contact_flow_module_content" => self.delete_contact_flow_module_content(id).await,
            "user_hierarchy_group_name" => self.delete_user_hierarchy_group_name(id).await,
            "federation_token" => self.delete_federation_token(id).await,
            "hours_of_operation" => self.delete_hours_of_operation(id).await,
            "email_address" => self.delete_email_address(id).await,
            "authentication_profile" => self.delete_authentication_profile(id).await,
            "user_routing_profile" => self.delete_user_routing_profile(id).await,
            "view_metadata" => self.delete_view_metadata(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "connect", resource_name
            ))),
    ...
    async fn create_contact_evaluation(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_contact_evaluation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_contact_evaluation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_contact_flow_content(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_contact_flow_content(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_contact_flow_content(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_contact_routing_data(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let contact_id = input.get_string("contact_id")?;
            let instance_id = input.get_string("instance_id")?;
            let queue_time_adjustment_seconds =
                input.get_optional_string("queue_time_adjustment_seconds")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    queue_time_adjustment_seconds.unwrap_or_default(),
                )
    ...
    async fn read_contact_routing_data(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_contact_routing_data(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_agent_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_agent_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_agent_status(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let description = input.get_optional_string("description")?;
            let instance_id = input.get_string("instance_id")?;
    ...
    async fn delete_agent_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    outbound_email_config.unwrap_or_default(),
                )
                .with_field("instance_id", instance_id.unwrap_or_default())
    ...
    async fn read_queue_outbound_email_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_queue_outbound_email_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_contact_metrics(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_contact_metrics(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_contact_metrics(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_participant(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "participant_details",
                    participant_details.unwrap_or_default(),
                )
                .with_field("contact_id", contact_id.unwrap_or_default()))
        })
    }
    ...
    async fn create_queue(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    hours_of_operation_id.unwrap_or_default(),
                )
                .with_field("instance_id", instance_id.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                ...
                .with_field(
                    ...
                    outbound_caller_config.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default()))
        })
    }
    ...
    async fn read_queue(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_queue(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let outbound_email_config = input.get_optional_string("outbound_email_config")?;
            let name = input.get_string("name")?;
    ...
    async fn create_user_proficiencies(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_user_proficiencies(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_user_proficiencies(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_quick_connect(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let instance_id = input.get_string("instance_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "quick_connect_config",
                    quick_connect_config.unwrap_or_default(),
                )
                .with_field("description", description.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default()))
        })
    ...
    async fn read_quick_connect(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_quick_connect(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let instance_id = input.get_string("instance_id")?;
            let name = input.get_string("name")?;
    ...
    async fn delete_quick_connect(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_contact_flow_name(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let instance_id = input.get_string("instance_id")?;
    ...
    async fn read_contact_flow_name(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_contact_flow_name(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn read_queue_hours_of_operation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_queue_hours_of_operation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_queue_max_contacts(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let max_contacts = input.get_optional_string("max_contacts")?;
    ...
    async fn read_queue_max_contacts(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_queue_max_contacts(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    security_profile_ids.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_metric_data(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_metric_data(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_metric_data(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_metric_data(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_contact(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let expiry_duration_in_minutes =
                input.get_optional_string("expiry_duration_in_minutes")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "previous_contact_id",
                    previous_contact_id.unwrap_or_default(),
                )
                .with_field(
                    "expiry_duration_in_minutes",
                    expiry_duration_in_minutes.unwrap_or_default(),
                )
    ...
    async fn create_participant_role_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    channel_configuration.unwrap_or_default(),
                )
                .with_field("instance_id", instance_id.unwrap_or_default())
                .with_field("contact_id", contact_id.unwrap_or_default()))
        })
    ...
    async fn read_participant_role_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_participant_role_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_prompt_file(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_prompt_file(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_prompt_file(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_prompt_file(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_queue_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let instance_id = input.get_string("instance_id")?;
    ...
    async fn read_queue_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_queue_status(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let instance_id = input.get_string("instance_id")?;
            let queue_id = input.get_string("queue_id")?;
    ...
    async fn delete_queue_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_contact_flow_module(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let content = input.get_string("content")?;
    ...
    async fn read_contact_flow_module(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_contact_flow_module(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    contact_configuration.unwrap_or_default(),
                )
                .with_field("instance_id", instance_id.unwrap_or_default())
    ...
    async fn read_push_notification_registration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_push_notification_registration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn read_participant_authentication(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_participant_authentication(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_evaluation_form(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_evaluation_form(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_evaluation_form(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn read_traffic_distribution_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_traffic_distribution_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_use_case(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    integration_association_id.unwrap_or_default(),
                ))
        })
    }

    /// Read a use_case resource
    async fn read_use_case(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_use_case(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let use_case_type = input.get_string("use_case_type")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_use_case(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_contact_attributes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_contact_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_contact_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_user_phone_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let phone_config = input.get_string("phone_config")?;
    ...
    async fn read_user_phone_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_user_phone_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    contact_flow_module_id.unwrap_or_default(),
                )
                .with_field("state", state.unwrap_or_default())
                .with_field("name", name.unwrap_or_default()))
        })
    ...
    async fn read_contact_flow_module_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_contact_flow_module_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    default_outbound_queue_id.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn delete_routing_profile_default_outbound_queue(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_predefined_attribute(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    attribute_configuration.unwrap_or_default(),
                )
                .with_field("instance_id", instance_id.unwrap_or_default()))
        })
    }
    ...
    async fn read_predefined_attribute(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_predefined_attribute(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    inbound_calls_enabled.unwrap_or_default(),
                )
                .with_field(
                    "outbound_calls_enabled",
                    outbound_calls_enabled.unwrap_or_default(),
                )
                .with_field("instance_alias", instance_alias.unwrap_or_default())
                .with_field(
                    "identity_management_type",
                    identity_management_type.unwrap_or_default(),
                )
    ...
    async fn create_user_hierarchy_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
    ...
    async fn read_user_hierarchy_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_user_hierarchy_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_view_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "view_content_sha256",
                    view_content_sha256.unwrap_or_default(),
                ))
        })
    }

    /// Read a view_version resource
    async fn read_view_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_view_version(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let view_id = input.get_string("view_id")?;
            let version_description = input.get_optional_string("version_description")?;
    ...
    async fn delete_view_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_instance_attribute(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_attribute(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_instance_attribute(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_task_template(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "self_assign_flow_id",
                    self_assign_flow_id.unwrap_or_default(),
                )
                .with_field("instance_id", instance_id.unwrap_or_default()))
        })
    }
    ...
    async fn read_task_template(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_task_template(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let status = input.get_optional_string("status")?;
            let constraints = input.get_optional_string("constraints")?;
    ...
    async fn delete_task_template(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn read_persistent_contact_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_persistent_contact_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_contact_flow_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    last_modified_region.unwrap_or_default(),
                )
                .with_field("instance_id", instance_id.unwrap_or_default())
                .with_field(
                    "flow_content_sha256",
                    flow_content_sha256.unwrap_or_default(),
                )
                .with_field("contact_flow_id", contact_flow_id.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field(
                    "contact_flow_version",
                    contact_flow_version.unwrap_or_default(),
                )
    ...
    async fn read_contact_flow_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_contact_flow_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_queue_name(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_optional_string("name")?;
    ...
    async fn read_queue_name(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_queue_name(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_optional_string("name")?;
            let description = input.get_optional_string("description")?;
    ...
    async fn delete_queue_name(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_integration_association(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    source_application_url.unwrap_or_default(),
                )
                .with_field(
                    "source_application_name",
                    source_application_name.unwrap_or_default(),
                )
    ...
    async fn read_integration_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_integration_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_quick_connect_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_quick_connect_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_quick_connect_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_quick_connect_name(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let instance_id = input.get_string("instance_id")?;
    ...
    async fn read_quick_connect_name(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_quick_connect_name(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_prompt(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
    ...
    async fn read_prompt(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_prompt(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
            let instance_id = input.get_string("instance_id")?;
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    agent_availability_timer.unwrap_or_default(),
                )
                .with_field("instance_id", instance_id.unwrap_or_default())
                .with_field("routing_profile_id", routing_profile_id.unwrap_or_default()))
        })
    ...
    async fn delete_routing_profile_agent_availability_timer(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_routing_profile_name(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_optional_string("name")?;
    ...
    async fn read_routing_profile_name(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_routing_profile_name(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_user_hierarchy_structure(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "hierarchy_structure",
                    hierarchy_structure.unwrap_or_default(),
                ))
        })
    }

    /// Read a user_hierarchy_structure resource
    async fn read_user_hierarchy_structure(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_user_hierarchy_structure(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_attached_file(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_attached_file(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_attached_file(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_attached_file(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_routing_profile_queues(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_routing_profile_queues(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_routing_profile_queues(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_user_security_profiles(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let user_id = input.get_string("user_id")?;
    ...
    async fn read_user_security_profiles(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_user_security_profiles(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_current_user_data(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_current_user_data(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_current_user_data(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_user_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_user_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_user_status(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let agent_status_id = input.get_string("agent_status_id")?;
            let instance_id = input.get_string("instance_id")?;
    ...
    async fn delete_user_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_metric_data_v2(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_metric_data_v2(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_metric_data_v2(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_email_address_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_email_address_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_email_address_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_traffic_distribution(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_traffic_distribution(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_traffic_distribution(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_phone_number_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let client_token = input.get_optional_string("client_token")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    phone_number_description.unwrap_or_default(),
                ))
        })
    }

    /// Read a phone_number_metadata resource
    async fn read_phone_number_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_phone_number_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn read_queue_outbound_caller_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_queue_outbound_caller_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_routing_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
            ...
            let instance_id = input.get_string("instance_id")?;
            let default_outbound_queue_id = input.get_string("default_outbound_queue_id")?;
            let manual_assignment_queue_configs =
                input.get_optional_string("manual_assignment_queue_configs")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    manual_assignment_queue_configs.unwrap_or_default(),
                )
                .with_field(
                    "media_concurrencies",
                    media_concurrencies.unwrap_or_default(),
                ))
        })
    }

    /// Read a routing_profile resource
    async fn read_routing_profile(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_routing_profile(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_view_content(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let status = input.get_string("status")?;
    ...
    async fn read_view_content(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_view_content(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let status = input.get_string("status")?;
            let view_id = input.get_string("view_id")?;
    ...
    async fn delete_view_content(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn read_effective_hours_of_operations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_effective_hours_of_operations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_security_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let hierarchy_restricted_resources =
                input.get_optional_string("hierarchy_restricted_resources")?;
            let description = input.get_optional_string("description")?;
            let permissions = input.get_optional_string("permissions")?;
            let instance_id = input.get_string("instance_id")?;
            let allowed_access_control_hierarchy_group_id =
                input.get_optional_string("allowed_access_control_hierarchy_group_id")?;
            let tags = input.get_optional_string("tags")?;
            let applications = input.get_optional_string("applications")?;
            let security_profile_name = input.get_string("security_profile_name")?;
            let allowed_access_control_tags =
                input.get_optional_string("allowed_access_control_tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    hierarchy_restricted_resources.unwrap_or_default(),
                )
                .with_field("description", description.unwrap_or_default())
                ...
                .with_field(
                    ...
                    allowed_access_control_hierarchy_group_id.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("applications", applications.unwrap_or_default())
                .with_field(
                    "security_profile_name",
                    security_profile_name.unwrap_or_default(),
                )
                .with_field(
                    "allowed_access_control_tags",
                    allowed_access_control_tags.unwrap_or_default(),
                )
                .with_field(
                    "tag_restricted_resources",
                    tag_restricted_resources.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn read_hours_of_operation_override(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_hours_of_operation_override(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    trigger_event_source.unwrap_or_default(),
                )
                .with_field("instance_id", instance_id.unwrap_or_default())
                .with_field("name", name.unwrap_or_default()))
        })
    ...
    async fn create_contact_flow_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_optional_string("name")?;
    ...
    async fn read_contact_flow_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_contact_flow_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_current_metric_data(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_current_metric_data(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_current_metric_data(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_contact_schedule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let contact_id = input.get_string("contact_id")?;
    ...
    async fn read_contact_schedule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_contact_schedule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_instance_storage_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_storage_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_instance_storage_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_flow_association(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_flow_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_flow_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_user_hierarchy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let instance_id = input.get_string("instance_id")?;
    ...
    async fn read_user_hierarchy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_user_hierarchy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_contact_flow(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_contact_flow(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_contact_flow(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let r#type = input.get_string("type")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_contact_flow(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_user_identity_info(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let instance_id = input.get_string("instance_id")?;
    ...
    async fn read_user_identity_info(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_user_identity_info(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn read_routing_profile_concurrency(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_routing_profile_concurrency(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn read_contact_flow_module_content(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_contact_flow_module_content(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn read_user_hierarchy_group_name(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_user_hierarchy_group_name(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_federation_token(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_federation_token(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_federation_token(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_hours_of_operation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let config = input.get_string("config")?;
    ...
    async fn read_hours_of_operation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_hours_of_operation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_email_address(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_email_address(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_email_address(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let email_address = input.get_string("email_address")?;
            let display_name = input.get_optional_string("display_name")?;
    ...
    async fn delete_email_address(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_authentication_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let periodic_session_duration =
                input.get_optional_string("periodic_session_duration")?;
            let instance_id = input.get_string("instance_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    authentication_profile_id.unwrap_or_default(),
                )
                .with_field("name", name.unwrap_or_default())
                ...
                .with_field(
                    ...
                    periodic_session_duration.unwrap_or_default(),
                )
                .with_field("instance_id", instance_id.unwrap_or_default()))
        })
    }
    ...
    async fn create_user_routing_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let instance_id = input.get_string("instance_id")?;
    ...
    async fn read_user_routing_profile(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn delete_user_routing_profile(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
    ...
    async fn create_view_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_optional_string("name")?;
    ...
    async fn read_view_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connect_client
    ...
    async fn update_view_metadata(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_optional_string("name")?;
            let view_id = input.get_string("view_id")?;
    ...
    async fn delete_view_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connect_client
