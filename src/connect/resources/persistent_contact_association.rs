...
impl<'a> Persistent_contact_association<'a> {
    ...
    pub async fn create(&self, rehydration_type: String, initial_contact_id: String, instance_id: String, client_token: Option<String>, source_contact_id: String) -> Result<String> {
