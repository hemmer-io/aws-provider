...
impl<'a> Persistent_contact_association<'a> {
    ...
    pub async fn create(&self, initial_contact_id: String, rehydration_type: String, client_token: Option<String>, source_contact_id: String, instance_id: String) -> Result<String> {
