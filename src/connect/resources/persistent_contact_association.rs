...
impl<'a> Persistent_contact_association<'a> {
    ...
    pub async fn create(&self, source_contact_id: String, client_token: Option<String>, instance_id: String, initial_contact_id: String, rehydration_type: String) -> Result<String> {
