...
impl<'a> Predefined_attribute<'a> {
    ...
    pub async fn create(&self, values: Option<String>, instance_id: String, name: String, attribute_configuration: Option<String>, purposes: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, values: Option<String>, instance_id: Option<String>, name: Option<String>, attribute_configuration: Option<String>, purposes: Option<Vec<String>>) -> Result<()> {
