...
impl<'a> Predefined_attribute<'a> {
    ...
    pub async fn create(&self, name: String, values: Option<String>, purposes: Option<Vec<String>>, attribute_configuration: Option<String>, instance_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, values: Option<String>, purposes: Option<Vec<String>>, attribute_configuration: Option<String>, instance_id: Option<String>) -> Result<()> {
