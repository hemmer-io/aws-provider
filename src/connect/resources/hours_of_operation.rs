...
impl<'a> Hours_of_operation<'a> {
    ...
    pub async fn create(&self, config: Vec<String>, description: Option<String>, tags: Option<HashMap<String, String>>, instance_id: String, name: String, time_zone: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, config: Option<Vec<String>>, description: Option<String>, tags: Option<HashMap<String, String>>, instance_id: Option<String>, name: Option<String>, time_zone: Option<String>) -> Result<()> {
