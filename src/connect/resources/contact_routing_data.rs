...
impl<'a> Contact_routing_data<'a> {
    ...
    pub async fn update(&self, id: &str, contact_id: Option<String>, instance_id: Option<String>, queue_time_adjustment_seconds: Option<i64>, routing_criteria: Option<String>, queue_priority: Option<i64>) -> Result<()> {
