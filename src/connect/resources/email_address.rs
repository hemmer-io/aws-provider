...
impl<'a> Email_address<'a> {
    ...
    pub async fn create(&self, email_address: String, display_name: Option<String>, tags: Option<HashMap<String, String>>, client_token: Option<String>, description: Option<String>, instance_id: String) -> Result<String> {
