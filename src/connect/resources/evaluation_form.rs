...
impl<'a> Evaluation_form<'a> {
    ...
    pub async fn create(&self, title: String, items: Vec<String>, description: Option<String>, client_token: Option<String>, scoring_strategy: Option<String>, instance_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, title: Option<String>, items: Option<Vec<String>>, description: Option<String>, client_token: Option<String>, scoring_strategy: Option<String>, instance_id: Option<String>) -> Result<()> {
