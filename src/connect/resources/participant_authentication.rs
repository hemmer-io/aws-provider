...
impl<'a> Participant_authentication<'a> {
    ...
    pub async fn update(&self, id: &str, error: Option<String>, error_description: Option<String>, state: Option<String>, code: Option<String>, instance_id: Option<String>) -> Result<()> {
