...
impl<'a> Participant_authentication<'a> {
    ...
    pub async fn update(&self, id: &str, state: Option<String>, code: Option<String>, instance_id: Option<String>, error_description: Option<String>, error: Option<String>) -> Result<()> {
