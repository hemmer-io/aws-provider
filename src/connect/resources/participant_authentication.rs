...
impl<'a> Participant_authentication<'a> {
    ...
    pub async fn update(&self, id: &str, code: Option<String>, error: Option<String>, error_description: Option<String>, instance_id: Option<String>, state: Option<String>) -> Result<()> {
