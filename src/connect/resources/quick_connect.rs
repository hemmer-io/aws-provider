...
impl<'a> Quick_connect<'a> {
    ...
    pub async fn create(&self, instance_id: String, name: String, quick_connect_config: String, description: Option<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
