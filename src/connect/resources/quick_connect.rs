...
impl<'a> Quick_connect<'a> {
    ...
    pub async fn create(&self, instance_id: String, tags: Option<HashMap<String, String>>, name: String, description: Option<String>, quick_connect_config: String) -> Result<String> {
