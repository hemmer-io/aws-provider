...
impl<'a> Quick_connect<'a> {
    ...
    pub async fn create(&self, description: Option<String>, instance_id: String, name: String, tags: Option<HashMap<String, String>>, quick_connect_config: String) -> Result<String> {
