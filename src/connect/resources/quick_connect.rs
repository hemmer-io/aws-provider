...
impl<'a> Quick_connect<'a> {
    ...
    pub async fn create(&self, name: String, tags: Option<HashMap<String, String>>, quick_connect_config: String, description: Option<String>, instance_id: String) -> Result<String> {
