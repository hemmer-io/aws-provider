...
impl<'a> Traffic_distribution_group<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, instance_id: String, client_token: Option<String>, description: Option<String>, name: String) -> Result<String> {
