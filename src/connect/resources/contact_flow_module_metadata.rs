...
impl<'a> Contact_flow_module_metadata<'a> {
    ...
    pub async fn update(&self, id: &str, name: Option<String>, description: Option<String>, instance_id: Option<String>, state: Option<String>, contact_flow_module_id: Option<String>) -> Result<()> {
