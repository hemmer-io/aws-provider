...
impl<'a> Email_address_metadata<'a> {
    ...
    pub async fn update(&self, id: &str, description: Option<String>, display_name: Option<String>, client_token: Option<String>, email_address_id: Option<String>, instance_id: Option<String>) -> Result<()> {
