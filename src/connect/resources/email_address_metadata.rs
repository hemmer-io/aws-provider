...
impl<'a> Email_address_metadata<'a> {
    ...
    pub async fn update(&self, id: &str, email_address_id: Option<String>, instance_id: Option<String>, display_name: Option<String>, client_token: Option<String>, description: Option<String>) -> Result<()> {
