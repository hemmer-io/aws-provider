...
impl<'a> Email_address_metadata<'a> {
    ...
    pub async fn update(&self, id: &str, display_name: Option<String>, client_token: Option<String>, instance_id: Option<String>, description: Option<String>, email_address_id: Option<String>) -> Result<()> {
