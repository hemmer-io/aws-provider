...
impl<'a> Contact_flow_version<'a> {
    ...
    pub async fn create(&self, flow_content_sha256: Option<String>, description: Option<String>, contact_flow_id: String, last_modified_time: Option<String>, contact_flow_version: Option<i64>, instance_id: String, last_modified_region: Option<String>) -> Result<String> {
