...
impl<'a> Contact_flow_version<'a> {
    ...
    pub async fn create(&self, last_modified_region: Option<String>, instance_id: String, flow_content_sha256: Option<String>, contact_flow_id: String, description: Option<String>, contact_flow_version: Option<i64>, last_modified_time: Option<String>) -> Result<String> {
