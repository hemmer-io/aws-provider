...
impl<'a> Contact_flow_version<'a> {
    ...
    pub async fn create(&self, contact_flow_id: String, contact_flow_version: Option<i64>, last_modified_time: Option<String>, last_modified_region: Option<String>, flow_content_sha256: Option<String>, description: Option<String>, instance_id: String) -> Result<String> {
