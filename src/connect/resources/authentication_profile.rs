...
impl<'a> Authentication_profile<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, allowed_ips: Option<Vec<String>>, periodic_session_duration: Option<i64>, authentication_profile_id: Option<String>, instance_id: Option<String>, name: Option<String>, blocked_ips: Option<Vec<String>>) -> Result<()> {
