...
impl<'a> Vocabulary<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, instance_id: String, vocabulary_name: String, language_code: String, content: String, tags: Option<HashMap<String, String>>) -> Result<String> {
