...
impl<'a> Hours_of_operation_override<'a> {
    ...
    pub async fn create(&self, hours_of_operation_id: String, description: Option<String>, name: String, effective_till: String, instance_id: String, config: Vec<String>, effective_from: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, hours_of_operation_id: Option<String>, description: Option<String>, name: Option<String>, effective_till: Option<String>, instance_id: Option<String>, config: Option<Vec<String>>, effective_from: Option<String>) -> Result<()> {
