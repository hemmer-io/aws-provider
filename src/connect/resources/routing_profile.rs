...
impl<'a> Routing_profile<'a> {
    ...
    pub async fn create(&self, description: String, agent_availability_timer: Option<String>, name: String, queue_configs: Option<Vec<String>>, default_outbound_queue_id: String, media_concurrencies: Vec<String>, manual_assignment_queue_configs: Option<Vec<String>>, tags: Option<HashMap<String, String>>, instance_id: String) -> Result<String> {
