...
impl<'a> Routing_profile<'a> {
    ...
    pub async fn create(&self, default_outbound_queue_id: String, agent_availability_timer: Option<String>, name: String, manual_assignment_queue_configs: Option<Vec<String>>, queue_configs: Option<Vec<String>>, description: String, tags: Option<HashMap<String, String>>, media_concurrencies: Vec<String>, instance_id: String) -> Result<String> {
