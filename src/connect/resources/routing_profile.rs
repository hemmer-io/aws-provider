...
impl<'a> Routing_profile<'a> {
    ...
    pub async fn create(&self, name: String, queue_configs: Option<Vec<String>>, agent_availability_timer: Option<String>, description: String, tags: Option<HashMap<String, String>>, instance_id: String, default_outbound_queue_id: String, manual_assignment_queue_configs: Option<Vec<String>>, media_concurrencies: Vec<String>) -> Result<String> {
