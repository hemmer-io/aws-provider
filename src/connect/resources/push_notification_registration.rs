...
impl<'a> Push_notification_registration<'a> {
    ...
    pub async fn create(&self, device_token: String, client_token: Option<String>, instance_id: String, contact_configuration: String, device_type: String, pinpoint_app_arn: String) -> Result<String> {
