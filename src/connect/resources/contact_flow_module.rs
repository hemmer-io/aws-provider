...
impl<'a> Contact_flow_module<'a> {
    ...
    pub async fn create(&self, content: String, instance_id: String, name: String, description: Option<String>, tags: Option<HashMap<String, String>>, client_token: Option<String>) -> Result<String> {
