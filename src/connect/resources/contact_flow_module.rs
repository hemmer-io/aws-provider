...
impl<'a> Contact_flow_module<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, instance_id: String, name: String, client_token: Option<String>, description: Option<String>, content: String) -> Result<String> {
