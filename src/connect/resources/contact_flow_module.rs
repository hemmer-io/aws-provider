...
impl<'a> Contact_flow_module<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, content: String, client_token: Option<String>, name: String, instance_id: String, description: Option<String>) -> Result<String> {
