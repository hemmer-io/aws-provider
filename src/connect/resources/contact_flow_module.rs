...
impl<'a> Contact_flow_module<'a> {
    ...
    pub async fn create(&self, instance_id: String, tags: Option<HashMap<String, String>>, description: Option<String>, content: String, name: String, client_token: Option<String>) -> Result<String> {
