...
impl<'a> Contact_evaluation<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, instance_id: Option<String>, evaluation_id: Option<String>, answers: Option<HashMap<String, String>>, notes: Option<HashMap<String, String>>) -> Result<()> {
