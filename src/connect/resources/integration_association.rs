...
impl<'a> Integration_association<'a> {
    ...
    pub async fn create(&self, integration_arn: String, integration_type: String, source_application_url: Option<String>, source_application_name: Option<String>, source_type: Option<String>, instance_id: String, tags: Option<HashMap<String, String>>) -> Result<String> {
