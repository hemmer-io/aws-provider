...
impl<'a> Contact_flow<'a> {
    ...
    pub async fn create(&self, type: String, description: Option<String>, content: String, instance_id: String, status: Option<String>, name: String, tags: Option<HashMap<String, String>>) -> Result<String> {
