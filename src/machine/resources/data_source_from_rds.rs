...
impl<'a> Data_source_from_rds<'a> {
    ...
    pub async fn create(&self, role_arn: String, data_source_id: String, rdsdata: String, data_source_name: Option<String>, compute_statistics: Option<bool>) -> Result<String> {
