...
impl<'a> Batch_prediction<'a> {
    ...
    pub async fn create(&self, batch_prediction_data_source_id: String, mlmodel_id: String, output_uri: String, batch_prediction_id: String, batch_prediction_name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, batch_prediction_data_source_id: Option<String>, mlmodel_id: Option<String>, output_uri: Option<String>, batch_prediction_id: Option<String>, batch_prediction_name: Option<String>) -> Result<()> {
