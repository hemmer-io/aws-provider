...
impl<'a> TaxsettingsService<'a> {
    ...
    async fn create_tax_registration(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn read_tax_registration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_tax_registration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_tax_registration_document(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_tax_registration_document(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
