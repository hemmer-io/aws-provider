...
impl<'a> Health_check<'a> {
    ...
    pub async fn create(&self, health_check_config: String, caller_reference: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, health_check_config: Option<String>, caller_reference: Option<String>) -> Result<()> {
