...
impl<'a> Route_53Service<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "vpc_association_authorization" => {
                self.plan_vpc_association_authorization(current_state, desired_input)
                    .await
            }
            "geo_location" => self.plan_geo_location(current_state, desired_input).await,
            "traffic_policy" => self.plan_traffic_policy(current_state, desired_input).await,
            "traffic_policy_comment" => {
                self.plan_traffic_policy_comment(current_state, desired_input)
                    .await
            }
            "hosted_zone_count" => {
                self.plan_hosted_zone_count(current_state, desired_input)
                    .await
            }
            "change" => self.plan_change(current_state, desired_input).await,
            "checker_ip_ranges" => {
                self.plan_checker_ip_ranges(current_state, desired_input)
                    .await
            }
            "reusable_delegation_set_limit" => {
                self.plan_reusable_delegation_set_limit(current_state, desired_input)
                    .await
            }
            "dnssec" => self.plan_dnssec(current_state, desired_input).await,
            "hosted_zone" => self.plan_hosted_zone(current_state, desired_input).await,
            "reusable_delegation_set" => {
                self.plan_reusable_delegation_set(current_state, desired_input)
                    .await
            }
            "health_check_last_failure_reason" => {
                self.plan_health_check_last_failure_reason(current_state, desired_input)
                    .await
            }
            "traffic_policy_instance_count" => {
                self.plan_traffic_policy_instance_count(current_state, desired_input)
                    .await
            }
            "query_logging_config" => {
                self.plan_query_logging_config(current_state, desired_input)
                    .await
            }
            "hosted_zone_comment" => {
                self.plan_hosted_zone_comment(current_state, desired_input)
                    .await
            }
            "health_check" => self.plan_health_check(current_state, desired_input).await,
            "traffic_policy_version" => {
                self.plan_traffic_policy_version(current_state, desired_input)
                    .await
            }
            "health_check_status" => {
                self.plan_health_check_status(current_state, desired_input)
                    .await
            }
            "traffic_policy_instance" => {
                self.plan_traffic_policy_instance(current_state, desired_input)
                    .await
            }
            "account_limit" => self.plan_account_limit(current_state, desired_input).await,
            "key_signing_key" => {
                self.plan_key_signing_key(current_state, desired_input)
                    .await
            }
            "hosted_zone_limit" => {
                self.plan_hosted_zone_limit(current_state, desired_input)
                    .await
            }
            "cidr_collection" => {
                self.plan_cidr_collection(current_state, desired_input)
                    .await
            }
            "health_check_count" => {
                self.plan_health_check_count(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route_53", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "geo_location" => self.create_geo_location(input).await,
            "traffic_policy" => self.create_traffic_policy(input).await,
            "traffic_policy_comment" => self.create_traffic_policy_comment(input).await,
            "hosted_zone_count" => self.create_hosted_zone_count(input).await,
            "change" => self.create_change(input).await,
            "checker_ip_ranges" => self.create_checker_ip_ranges(input).await,
            "reusable_delegation_set_limit" => {
                self.create_reusable_delegation_set_limit(input).await
            }
            "dnssec" => self.create_dnssec(input).await,
            "hosted_zone" => self.create_hosted_zone(input).await,
            "reusable_delegation_set" => self.create_reusable_delegation_set(input).await,
            "health_check_last_failure_reason" => {
            ...
            "query_logging_config" => self.create_query_logging_config(input).await,
            "hosted_zone_comment" => self.create_hosted_zone_comment(input).await,
            "health_check" => self.create_health_check(input).await,
            "traffic_policy_version" => self.create_traffic_policy_version(input).await,
            "health_check_status" => self.create_health_check_status(input).await,
            "traffic_policy_instance" => self.create_traffic_policy_instance(input).await,
            "account_limit" => self.create_account_limit(input).await,
            "key_signing_key" => self.create_key_signing_key(input).await,
            "hosted_zone_limit" => self.create_hosted_zone_limit(input).await,
            "cidr_collection" => self.create_cidr_collection(input).await,
            "health_check_count" => self.create_health_check_count(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route_53", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "vpc_association_authorization" => self.read_vpc_association_authorization(id).await,
            "geo_location" => self.read_geo_location(id).await,
            "traffic_policy" => self.read_traffic_policy(id).await,
            "traffic_policy_comment" => self.read_traffic_policy_comment(id).await,
            "hosted_zone_count" => self.read_hosted_zone_count(id).await,
            "change" => self.read_change(id).await,
            "checker_ip_ranges" => self.read_checker_ip_ranges(id).await,
            "reusable_delegation_set_limit" => self.read_reusable_delegation_set_limit(id).await,
            "dnssec" => self.read_dnssec(id).await,
            "hosted_zone" => self.read_hosted_zone(id).await,
            "reusable_delegation_set" => self.read_reusable_delegation_set(id).await,
            "health_check_last_failure_reason" => {
                self.read_health_check_last_failure_reason(id).await
            }
            "traffic_policy_instance_count" => self.read_traffic_policy_instance_count(id).await,
            "query_logging_config" => self.read_query_logging_config(id).await,
            "hosted_zone_comment" => self.read_hosted_zone_comment(id).await,
            "health_check" => self.read_health_check(id).await,
            "traffic_policy_version" => self.read_traffic_policy_version(id).await,
            "health_check_status" => self.read_health_check_status(id).await,
            "traffic_policy_instance" => self.read_traffic_policy_instance(id).await,
            "account_limit" => self.read_account_limit(id).await,
            "key_signing_key" => self.read_key_signing_key(id).await,
            "hosted_zone_limit" => self.read_hosted_zone_limit(id).await,
            "cidr_collection" => self.read_cidr_collection(id).await,
            "health_check_count" => self.read_health_check_count(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route_53", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "geo_location" => self.update_geo_location(id, input).await,
            "traffic_policy" => self.update_traffic_policy(id, input).await,
            "traffic_policy_comment" => self.update_traffic_policy_comment(id, input).await,
            "hosted_zone_count" => self.update_hosted_zone_count(id, input).await,
            "change" => self.update_change(id, input).await,
            "checker_ip_ranges" => self.update_checker_ip_ranges(id, input).await,
            "reusable_delegation_set_limit" => {
                self.update_reusable_delegation_set_limit(id, input).await
            }
            "dnssec" => self.update_dnssec(id, input).await,
            "hosted_zone" => self.update_hosted_zone(id, input).await,
            "reusable_delegation_set" => self.update_reusable_delegation_set(id, input).await,
            "health_check_last_failure_reason" => {
                self.update_health_check_last_failure_reason(id, input)
                    .await
            }
            "traffic_policy_instance_count" => {
                self.update_traffic_policy_instance_count(id, input).await
            }
            "query_logging_config" => self.update_query_logging_config(id, input).await,
            "hosted_zone_comment" => self.update_hosted_zone_comment(id, input).await,
            "health_check" => self.update_health_check(id, input).await,
            "traffic_policy_version" => self.update_traffic_policy_version(id, input).await,
            "health_check_status" => self.update_health_check_status(id, input).await,
            "traffic_policy_instance" => self.update_traffic_policy_instance(id, input).await,
            "account_limit" => self.update_account_limit(id, input).await,
            "key_signing_key" => self.update_key_signing_key(id, input).await,
            "hosted_zone_limit" => self.update_hosted_zone_limit(id, input).await,
            "cidr_collection" => self.update_cidr_collection(id, input).await,
            "health_check_count" => self.update_health_check_count(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route_53", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "vpc_association_authorization" => self.delete_vpc_association_authorization(id).await,
            "geo_location" => self.delete_geo_location(id).await,
            "traffic_policy" => self.delete_traffic_policy(id).await,
            "traffic_policy_comment" => self.delete_traffic_policy_comment(id).await,
            "hosted_zone_count" => self.delete_hosted_zone_count(id).await,
            "change" => self.delete_change(id).await,
            "checker_ip_ranges" => self.delete_checker_ip_ranges(id).await,
            "reusable_delegation_set_limit" => self.delete_reusable_delegation_set_limit(id).await,
            "dnssec" => self.delete_dnssec(id).await,
            "hosted_zone" => self.delete_hosted_zone(id).await,
            "reusable_delegation_set" => self.delete_reusable_delegation_set(id).await,
            "health_check_last_failure_reason" => {
                self.delete_health_check_last_failure_reason(id).await
            }
            "traffic_policy_instance_count" => self.delete_traffic_policy_instance_count(id).await,
            "query_logging_config" => self.delete_query_logging_config(id).await,
            "hosted_zone_comment" => self.delete_hosted_zone_comment(id).await,
            "health_check" => self.delete_health_check(id).await,
            "traffic_policy_version" => self.delete_traffic_policy_version(id).await,
            "health_check_status" => self.delete_health_check_status(id).await,
            "traffic_policy_instance" => self.delete_traffic_policy_instance(id).await,
            "account_limit" => self.delete_account_limit(id).await,
            "key_signing_key" => self.delete_key_signing_key(id).await,
            "hosted_zone_limit" => self.delete_hosted_zone_limit(id).await,
            "cidr_collection" => self.delete_cidr_collection(id).await,
            "health_check_count" => self.delete_health_check_count(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route_53", resource_name
            ))),
    ...
    async fn read_vpc_association_authorization(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_vpc_association_authorization(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_geo_location(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_geo_location(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn update_geo_location(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_geo_location(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_traffic_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_traffic_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_traffic_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_traffic_policy_comment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_traffic_policy_comment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_traffic_policy_comment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_hosted_zone_count(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_hosted_zone_count(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_hosted_zone_count(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_checker_ip_ranges(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_checker_ip_ranges(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_checker_ip_ranges(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn read_reusable_delegation_set_limit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_reusable_delegation_set_limit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_dnssec(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_dnssec(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn update_dnssec(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_dnssec(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_hosted_zone(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_hosted_zone(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn update_hosted_zone(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let hosted_zone_config = input.get_optional_string("hosted_zone_config")?;
            let delegation_set_id = input.get_optional_string("delegation_set_id")?;
    ...
    async fn delete_hosted_zone(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_reusable_delegation_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let caller_reference = input.get_string("caller_reference")?;
    ...
    async fn read_reusable_delegation_set(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_reusable_delegation_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn read_health_check_last_failure_reason(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_health_check_last_failure_reason(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn read_traffic_policy_instance_count(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_traffic_policy_instance_count(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_query_logging_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let cloud_watch_logs_log_group_arn =
                input.get_string("cloud_watch_logs_log_group_arn")?;
            let hosted_zone_id = input.get_string("hosted_zone_id")?;
    ...
    async fn read_query_logging_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_query_logging_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_hosted_zone_comment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let id = input.get_string("id")?;
    ...
    async fn read_hosted_zone_comment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_hosted_zone_comment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_health_check(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "health_check_config",
                    health_check_config.unwrap_or_default(),
                )
                .with_field("caller_reference", caller_reference.unwrap_or_default()))
        })
    }
    ...
    async fn read_health_check(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn update_health_check(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let health_check_config = input.get_string("health_check_config")?;
            let caller_reference = input.get_string("caller_reference")?;
    ...
    async fn delete_health_check(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_traffic_policy_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let comment = input.get_optional_string("comment")?;
    ...
    async fn read_traffic_policy_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_traffic_policy_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_health_check_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_health_check_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_health_check_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_traffic_policy_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "traffic_policy_version",
                    traffic_policy_version.unwrap_or_default(),
                )
    ...
    async fn read_traffic_policy_instance(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_traffic_policy_instance(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_account_limit(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_account_limit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn update_account_limit(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_account_limit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_key_signing_key(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    key_management_service_arn.unwrap_or_default(),
                )
                .with_field("name", name.unwrap_or_default()))
        })
    }
    ...
    async fn read_key_signing_key(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_key_signing_key(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_hosted_zone_limit(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_hosted_zone_limit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_hosted_zone_limit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_cidr_collection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
    ...
    async fn read_cidr_collection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_cidr_collection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
    ...
    async fn create_health_check_count(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_health_check_count(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_client
    ...
    async fn delete_health_check_count(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_client
