...
impl<'a> Report_group<'a> {
    ...
    pub async fn create(&self, name: String, type: String, export_config: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, type: Option<String>, export_config: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
