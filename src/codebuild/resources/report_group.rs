...
impl<'a> Report_group<'a> {
    ...
    pub async fn create(&self, name: String, tags: Option<Vec<String>>, export_config: String, type: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, tags: Option<Vec<String>>, export_config: Option<String>, type: Option<String>) -> Result<()> {
