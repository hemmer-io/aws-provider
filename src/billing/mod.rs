...
impl<'a> BillingService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "billing_view" => self.plan_billing_view(current_state, desired_input).await,
            "resource_policy" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "billing_view" => self.create_billing_view(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "billing_view" => self.read_billing_view(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "billing_view" => self.update_billing_view(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "billing_view" => self.delete_billing_view(id).await,
    ...
    async fn create_billing_view(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    data_filter_expression.unwrap_or_default(),
                )
    ...
    async fn read_billing_view(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_billing_view(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let description = input.get_optional_string("description")?;
            let source_views = input.get_string("source_views")?;
    ...
    async fn delete_billing_view(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
