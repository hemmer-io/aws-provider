...
impl<'a> ProtonService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "resources_summary" => {
                self.plan_resources_summary(current_state, desired_input)
                    .await
            }
            "template_sync_status" => {
                self.plan_template_sync_status(current_state, desired_input)
                    .await
            }
            "service_instance_sync_status" => {
                self.plan_service_instance_sync_status(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "resources_summary" => self.create_resources_summary(input).await,
            "template_sync_status" => self.create_template_sync_status(input).await,
            "service_instance_sync_status" => self.create_service_instance_sync_status(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "resources_summary" => self.read_resources_summary(id).await,
            "template_sync_status" => self.read_template_sync_status(id).await,
            "service_instance_sync_status" => self.read_service_instance_sync_status(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "resources_summary" => self.update_resources_summary(id, input).await,
            "template_sync_status" => self.update_template_sync_status(id, input).await,
            "service_instance_sync_status" => {
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "resources_summary" => self.delete_resources_summary(id).await,
            "template_sync_status" => self.delete_template_sync_status(id).await,
            "service_instance_sync_status" => self.delete_service_instance_sync_status(id).await,
    ...
    async fn create_resources_summary(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_resources_summary(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resources_summary(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_template_sync_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_template_sync_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.proton_client
    ...
    async fn delete_template_sync_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.proton_client
    ...
    async fn read_service_instance_sync_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.proton_client
    ...
    async fn delete_service_instance_sync_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.proton_client
