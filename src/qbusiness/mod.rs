...
impl<'a> QbusinessService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "chat_response_configuration" => {
                self.plan_chat_response_configuration(current_state, desired_input).await
            }
            "anonymous_web_experience_url" => {
                self.plan_anonymous_web_experience_url(current_state, desired_input).await
            }
            "user" => {
            ...
            "document_content" => {
                self.plan_document_content(current_state, desired_input).await
            }
            "policy" => {
                self.plan_policy(current_state, desired_input).await
            }
            "chat_controls_configuration" => {
                self.plan_chat_controls_configuration(current_state, desired_input).await
            }
            "feedback" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "chat_response_configuration" => {
                self.create_chat_response_configuration(input).await
            }
            "anonymous_web_experience_url" => {
                self.create_anonymous_web_experience_url(input).await
            }
            "user" => {
            ...
            "document_content" => {
                self.create_document_content(input).await
            }
            "policy" => {
                self.create_policy(input).await
            }
            "chat_controls_configuration" => {
                self.create_chat_controls_configuration(input).await
            }
            "feedback" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "chat_response_configuration" => {
                self.read_chat_response_configuration(id).await
            }
            "anonymous_web_experience_url" => {
                self.read_anonymous_web_experience_url(id).await
            }
            "user" => {
            ...
            "document_content" => {
                self.read_document_content(id).await
            }
            "policy" => {
                self.read_policy(id).await
            }
            "chat_controls_configuration" => {
                self.read_chat_controls_configuration(id).await
            }
            "feedback" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "document_content" => {
                self.update_document_content(id, input).await
            }
            "policy" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "chat_response_configuration" => {
                self.delete_chat_response_configuration(id).await
            }
            "anonymous_web_experience_url" => {
                self.delete_anonymous_web_experience_url(id).await
            }
            "user" => {
            ...
            "document_content" => {
                self.delete_document_content(id).await
            }
            "policy" => {
                self.delete_policy(id).await
            }
            "chat_controls_configuration" => {
                self.delete_chat_controls_configuration(id).await
            }
            "feedback" => {
    ...
    async fn create_chat_response_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("response_configurations", response_configurations.unwrap_or_default())
    ...
    async fn read_chat_response_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_chat_response_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_anonymous_web_experience_url(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_anonymous_web_experience_url(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_document_content(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_document_content(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_chat_controls_configuration(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let topic_configurations_to_delete = input.get_optional_string("topic_configurations_to_delete")?;
            let application_id = input.get_string("application_id")?;
            let blocked_phrases_configuration_update = input.get_optional_string("blocked_phrases_configuration_update")?;
            let hallucination_reduction_configuration = input.get_optional_string("hallucination_reduction_configuration")?;
            let creator_mode_configuration = input.get_optional_string("creator_mode_configuration")?;
            let topic_configurations_to_create_or_update = input.get_optional_string("topic_configurations_to_create_or_update")?;
            let client_token = input.get_optional_string("client_token")?;
            let orchestration_configuration = input.get_optional_string("orchestration_configuration")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("topic_configurations_to_delete", topic_configurations_to_delete.unwrap_or_default())
                .with_field("application_id", application_id.unwrap_or_default())
                .with_field("blocked_phrases_configuration_update", blocked_phrases_configuration_update.unwrap_or_default())
                .with_field("hallucination_reduction_configuration", hallucination_reduction_configuration.unwrap_or_default())
                .with_field("creator_mode_configuration", creator_mode_configuration.unwrap_or_default())
                .with_field("topic_configurations_to_create_or_update", topic_configurations_to_create_or_update.unwrap_or_default())
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field("orchestration_configuration", orchestration_configuration.unwrap_or_default())
    ...
    async fn read_chat_controls_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_chat_controls_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
