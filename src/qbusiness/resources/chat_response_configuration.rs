...
impl<'a> Chat_response_configuration<'a> {
    ...
    pub async fn create(&self, display_name: String, response_configurations: HashMap<String, String>, application_id: String, client_token: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, display_name: Option<String>, response_configurations: Option<HashMap<String, String>>, application_id: Option<String>, client_token: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
