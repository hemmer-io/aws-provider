...
impl<'a> Chat_response_configuration<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, response_configurations: HashMap<String, String>, application_id: String, display_name: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, response_configurations: Option<HashMap<String, String>>, application_id: Option<String>, display_name: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
