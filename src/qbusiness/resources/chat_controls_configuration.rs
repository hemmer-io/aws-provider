...
impl<'a> Chat_controls_configuration<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, hallucination_reduction_configuration: Option<String>, topic_configurations_to_delete: Option<Vec<String>>, orchestration_configuration: Option<String>, application_id: Option<String>, client_token: Option<String>, blocked_phrases_configuration_update: Option<String>, creator_mode_configuration: Option<String>, topic_configurations_to_create_or_update: Option<Vec<String>>, response_scope: Option<String>) -> Result<()> {
