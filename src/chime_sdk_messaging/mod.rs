...
impl<'a> Chime_sdk_messagingService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "channel_moderated_by_app_instance_user" => {
                self.plan_channel_moderated_by_app_instance_user(current_state, desired_input)
                    .await
            }
            "channel_read_marker" => {
                self.plan_channel_read_marker(current_state, desired_input)
                    .await
            }
            "channel_message" => {
                self.plan_channel_message(current_state, desired_input)
                    .await
            }
            "messaging_streaming_configurations" => {
                self.plan_messaging_streaming_configurations(current_state, desired_input)
                    .await
            }
            "channel_expiration_settings" => {
                self.plan_channel_expiration_settings(current_state, desired_input)
                    .await
            }
            "channel_message_status" => {
                self.plan_channel_message_status(current_state, desired_input)
                    .await
            }
            "channel_membership_preferences" => {
                self.plan_channel_membership_preferences(current_state, desired_input)
                    .await
            }
            "channel_flow" => self.plan_channel_flow(current_state, desired_input).await,
            "channel_membership_for_app_instance_user" => {
                self.plan_channel_membership_for_app_instance_user(current_state, desired_input)
                    .await
            }
            "channel_ban" => self.plan_channel_ban(current_state, desired_input).await,
            "channel_moderator" => {
                self.plan_channel_moderator(current_state, desired_input)
                    .await
            }
            "messaging_session_endpoint" => {
                self.plan_messaging_session_endpoint(current_state, desired_input)
                    .await
            }
            "channel_membership" => {
                self.plan_channel_membership(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "chime_sdk_messaging", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "channel_moderated_by_app_instance_user" => {
                self.create_channel_moderated_by_app_instance_user(input)
                    .await
            }
            "channel_read_marker" => self.create_channel_read_marker(input).await,
            "channel_message" => self.create_channel_message(input).await,
            "messaging_streaming_configurations" => {
                self.create_messaging_streaming_configurations(input).await
            }
            "channel_expiration_settings" => self.create_channel_expiration_settings(input).await,
            "channel_message_status" => self.create_channel_message_status(input).await,
            "channel_membership_preferences" => {
                self.create_channel_membership_preferences(input).await
            }
            "channel_flow" => self.create_channel_flow(input).await,
            "channel_membership_for_app_instance_user" => {
                self.create_channel_membership_for_app_instance_user(input)
                    .await
            }
            "channel_ban" => self.create_channel_ban(input).await,
            "channel_moderator" => self.create_channel_moderator(input).await,
            "messaging_session_endpoint" => self.create_messaging_session_endpoint(input).await,
            "channel_membership" => self.create_channel_membership(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "chime_sdk_messaging", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "channel_read_marker" => self.read_channel_read_marker(id).await,
            "channel_message" => self.read_channel_message(id).await,
            "messaging_streaming_configurations" => {
                self.read_messaging_streaming_configurations(id).await
            }
            "channel_expiration_settings" => self.read_channel_expiration_settings(id).await,
            "channel_message_status" => self.read_channel_message_status(id).await,
            "channel_membership_preferences" => self.read_channel_membership_preferences(id).await,
            "channel_flow" => self.read_channel_flow(id).await,
            "channel_membership_for_app_instance_user" => {
                self.read_channel_membership_for_app_instance_user(id).await
            }
            "channel_ban" => self.read_channel_ban(id).await,
            "channel_moderator" => self.read_channel_moderator(id).await,
            "messaging_session_endpoint" => self.read_messaging_session_endpoint(id).await,
            "channel_membership" => self.read_channel_membership(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "chime_sdk_messaging", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "channel_moderated_by_app_instance_user" => {
                self.update_channel_moderated_by_app_instance_user(id, input)
                    .await
            }
            "channel_read_marker" => self.update_channel_read_marker(id, input).await,
            "channel_message" => self.update_channel_message(id, input).await,
            "messaging_streaming_configurations" => {
                self.update_messaging_streaming_configurations(id, input)
                    .await
            }
            "channel_expiration_settings" => {
                self.update_channel_expiration_settings(id, input).await
            }
            "channel_message_status" => self.update_channel_message_status(id, input).await,
            "channel_membership_preferences" => {
                self.update_channel_membership_preferences(id, input).await
            }
            "channel_flow" => self.update_channel_flow(id, input).await,
            "channel_membership_for_app_instance_user" => {
                self.update_channel_membership_for_app_instance_user(id, input)
                    .await
            }
            "channel_ban" => self.update_channel_ban(id, input).await,
            "channel_moderator" => self.update_channel_moderator(id, input).await,
            "messaging_session_endpoint" => self.update_messaging_session_endpoint(id, input).await,
            "channel_membership" => self.update_channel_membership(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "chime_sdk_messaging", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "channel_read_marker" => self.delete_channel_read_marker(id).await,
            "channel_message" => self.delete_channel_message(id).await,
            "messaging_streaming_configurations" => {
                self.delete_messaging_streaming_configurations(id).await
            }
            "channel_expiration_settings" => self.delete_channel_expiration_settings(id).await,
            "channel_message_status" => self.delete_channel_message_status(id).await,
            "channel_membership_preferences" => {
                self.delete_channel_membership_preferences(id).await
            }
            "channel_flow" => self.delete_channel_flow(id).await,
            "channel_membership_for_app_instance_user" => {
                self.delete_channel_membership_for_app_instance_user(id)
                    .await
            }
            "channel_ban" => self.delete_channel_ban(id).await,
            "channel_moderator" => self.delete_channel_moderator(id).await,
            "messaging_session_endpoint" => self.delete_messaging_session_endpoint(id).await,
            "channel_membership" => self.delete_channel_membership(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "chime_sdk_messaging", resource_name
            ))),
    ...
    async fn create_channel(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let elastic_channel_configuration =
                input.get_optional_string("elastic_channel_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    elastic_channel_configuration.unwrap_or_default(),
                )
                .with_field(
                    "expiration_settings",
    ...
    async fn delete_channel_moderated_by_app_instance_user(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
    ...
    async fn create_channel_read_marker(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let chime_bearer = input.get_string("chime_bearer")?;
    ...
    async fn read_channel_read_marker(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_sdk_messaging_client
    ...
    async fn delete_channel_read_marker(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
    ...
    async fn create_channel_message(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_channel_message(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_sdk_messaging_client
    ...
    async fn delete_channel_message(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    streaming_configurations.unwrap_or_default(),
                ))
        })
    }

    /// Read a messaging_streaming_configurations resource
    async fn read_messaging_streaming_configurations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_sdk_messaging_client
    ...
    async fn delete_messaging_streaming_configurations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
    ...
    async fn read_channel_expiration_settings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_sdk_messaging_client
    ...
    async fn delete_channel_expiration_settings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
    ...
    async fn create_channel_message_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_channel_message_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_sdk_messaging_client
    ...
    async fn delete_channel_message_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
    ...
    async fn read_channel_membership_preferences(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_sdk_messaging_client
    ...
    async fn delete_channel_membership_preferences(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
    ...
    async fn create_channel_flow(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_channel_flow(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_sdk_messaging_client
    ...
    async fn update_channel_flow(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let processors = input.get_string("processors")?;
            let app_instance_arn = input.get_string("app_instance_arn")?;
    ...
    async fn delete_channel_flow(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
    ...
    async fn delete_channel_membership_for_app_instance_user(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
    ...
    async fn create_channel_ban(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let chime_bearer = input.get_string("chime_bearer")?;
    ...
    async fn read_channel_ban(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_sdk_messaging_client
    ...
    async fn update_channel_ban(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let chime_bearer = input.get_string("chime_bearer")?;
            let channel_arn = input.get_string("channel_arn")?;
    ...
    async fn delete_channel_ban(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
    ...
    async fn create_channel_moderator(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let chime_bearer = input.get_string("chime_bearer")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    channel_moderator_arn.unwrap_or_default(),
                )
                .with_field("channel_arn", channel_arn.unwrap_or_default()))
        })
    }
    ...
    async fn read_channel_moderator(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_sdk_messaging_client
    ...
    async fn delete_channel_moderator(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
    ...
    async fn read_messaging_session_endpoint(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_sdk_messaging_client
    ...
    async fn delete_messaging_session_endpoint(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
    ...
    async fn create_channel_membership(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let chime_bearer = input.get_string("chime_bearer")?;
    ...
    async fn read_channel_membership(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.chime_sdk_messaging_client
    ...
    async fn delete_channel_membership(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.chime_sdk_messaging_client
