...
impl<'a> Channel_message<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, message_id: Option<String>, sub_channel_id: Option<String>, content_type: Option<String>, metadata: Option<String>, chime_bearer: Option<String>, content: Option<String>, channel_arn: Option<String>) -> Result<()> {
