...
impl<'a> Recommendation_preferences<'a> {
    ...
    pub async fn create(&self, utilization_preferences: Option<Vec<String>>, external_metrics_preference: Option<String>, preferred_resources: Option<Vec<String>>, scope: Option<String>, savings_estimation_mode: Option<String>, inferred_workload_types: Option<String>, enhanced_infrastructure_metrics: Option<String>, look_back_period: Option<String>, resource_type: String) -> Result<String> {
