...
impl<'a> Event_integration<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, name: String, description: Option<String>, event_filter: String, event_bridge_bus: String, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, name: Option<String>, description: Option<String>, event_filter: Option<String>, event_bridge_bus: Option<String>, client_token: Option<String>) -> Result<()> {
