//! Memorydb_2021_01_01 Service
//!
//! Auto-generated service module for memorydb_2021_01_01

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for memorydb_2021_01_01
pub struct Memorydb_2021_01_01Service<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Memorydb_2021_01_01Service<'a> {
    ...
    /// Get ac_ls resource handler
    pub fn ac_ls(&self) -> resources::Ac_ls<'_> {
        resources::Ac_ls::new(self.provider)
    }
