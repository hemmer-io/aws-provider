...
impl<'a> Parameter_group<'a> {
    ...
    pub async fn create(&self, family: String, tags: Option<Vec<String>>, description: Option<String>, parameter_group_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, family: Option<String>, tags: Option<Vec<String>>, description: Option<String>, parameter_group_name: Option<String>) -> Result<()> {
