...
impl<'a> BackupService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "framework" => self.plan_framework(current_state, desired_input).await,
            "backup_plan_from_json" => {
                self.plan_backup_plan_from_json(current_state, desired_input)
                    .await
            }
            "logically_air_gapped_backup_vault" => {
                self.plan_logically_air_gapped_backup_vault(current_state, desired_input)
                    .await
            }
            "protected_resource" => {
            ...
            "recovery_point" => self.plan_recovery_point(current_state, desired_input).await,
            "backup_vault_notifications" => {
                self.plan_backup_vault_notifications(current_state, desired_input)
                    .await
            }
            "restore_testing_inferred_metadata" => {
                self.plan_restore_testing_inferred_metadata(current_state, desired_input)
                    .await
            }
            "restore_testing_selection" => {
                self.plan_restore_testing_selection(current_state, desired_input)
                    .await
            }
            "backup_vault_access_policy" => {
                self.plan_backup_vault_access_policy(current_state, desired_input)
                    .await
            }
            "region_settings" => {
                self.plan_region_settings(current_state, desired_input)
                    .await
            }
            "recovery_point_index_settings" => {
                self.plan_recovery_point_index_settings(current_state, desired_input)
                    .await
            }
            "restore_access_backup_vault" => {
                self.plan_restore_access_backup_vault(current_state, desired_input)
                    .await
            }
            "backup_vault" => self.plan_backup_vault(current_state, desired_input).await,
            "supported_resource_types" => {
                self.plan_supported_resource_types(current_state, desired_input)
                    .await
            }
            "backup_vault_lock_configuration" => {
                self.plan_backup_vault_lock_configuration(current_state, desired_input)
                    .await
            }
            "legal_hold" => self.plan_legal_hold(current_state, desired_input).await,
            "recovery_point_index_details" => {
                self.plan_recovery_point_index_details(current_state, desired_input)
                    .await
            }
            "recovery_point_restore_metadata" => {
                self.plan_recovery_point_restore_metadata(current_state, desired_input)
                    .await
            }
            "restore_testing_plan" => {
                self.plan_restore_testing_plan(current_state, desired_input)
                    .await
            }
            "recovery_point_lifecycle" => {
                self.plan_recovery_point_lifecycle(current_state, desired_input)
                    .await
            }
            "backup_selection" => {
                self.plan_backup_selection(current_state, desired_input)
                    .await
            }
            "restore_validation_result" => {
                self.plan_restore_validation_result(current_state, desired_input)
                    .await
            }
            "restore_job" => self.plan_restore_job(current_state, desired_input).await,
            "report_job" => self.plan_report_job(current_state, desired_input).await,
            "report_plan" => self.plan_report_plan(current_state, desired_input).await,
            "backup_job" => self.plan_backup_job(current_state, desired_input).await,
            "copy_job" => self.plan_copy_job(current_state, desired_input).await,
            "restore_job_metadata" => {
                self.plan_restore_job_metadata(current_state, desired_input)
                    .await
            }
            "backup_plan" => self.plan_backup_plan(current_state, desired_input).await,
            "backup_plan_from_template" => {
                self.plan_backup_plan_from_template(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "framework" => self.create_framework(input).await,
            "backup_plan_from_json" => self.create_backup_plan_from_json(input).await,
            "logically_air_gapped_backup_vault" => {
            ...
            "recovery_point" => self.create_recovery_point(input).await,
            "backup_vault_notifications" => self.create_backup_vault_notifications(input).await,
            "restore_testing_inferred_metadata" => {
                self.create_restore_testing_inferred_metadata(input).await
            }
            "restore_testing_selection" => self.create_restore_testing_selection(input).await,
            "backup_vault_access_policy" => self.create_backup_vault_access_policy(input).await,
            "region_settings" => self.create_region_settings(input).await,
            "recovery_point_index_settings" => {
                self.create_recovery_point_index_settings(input).await
            }
            "restore_access_backup_vault" => self.create_restore_access_backup_vault(input).await,
            "backup_vault" => self.create_backup_vault(input).await,
            "supported_resource_types" => self.create_supported_resource_types(input).await,
            "backup_vault_lock_configuration" => {
                self.create_backup_vault_lock_configuration(input).await
            }
            "legal_hold" => self.create_legal_hold(input).await,
            "recovery_point_index_details" => self.create_recovery_point_index_details(input).await,
            "recovery_point_restore_metadata" => {
                self.create_recovery_point_restore_metadata(input).await
            }
            "restore_testing_plan" => self.create_restore_testing_plan(input).await,
            "recovery_point_lifecycle" => self.create_recovery_point_lifecycle(input).await,
            "backup_selection" => self.create_backup_selection(input).await,
            "restore_validation_result" => self.create_restore_validation_result(input).await,
            "restore_job" => self.create_restore_job(input).await,
            "report_job" => self.create_report_job(input).await,
            "report_plan" => self.create_report_plan(input).await,
            "backup_job" => self.create_backup_job(input).await,
            "copy_job" => self.create_copy_job(input).await,
            "restore_job_metadata" => self.create_restore_job_metadata(input).await,
            "backup_plan" => self.create_backup_plan(input).await,
            "backup_plan_from_template" => self.create_backup_plan_from_template(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "backup", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "framework" => self.read_framework(id).await,
            "backup_plan_from_json" => self.read_backup_plan_from_json(id).await,
            "logically_air_gapped_backup_vault" => {
            ...
            "recovery_point" => self.read_recovery_point(id).await,
            "backup_vault_notifications" => self.read_backup_vault_notifications(id).await,
            "restore_testing_inferred_metadata" => {
                self.read_restore_testing_inferred_metadata(id).await
            }
            "restore_testing_selection" => self.read_restore_testing_selection(id).await,
            "backup_vault_access_policy" => self.read_backup_vault_access_policy(id).await,
            "region_settings" => self.read_region_settings(id).await,
            "recovery_point_index_settings" => self.read_recovery_point_index_settings(id).await,
            "restore_access_backup_vault" => self.read_restore_access_backup_vault(id).await,
            "backup_vault" => self.read_backup_vault(id).await,
            "supported_resource_types" => self.read_supported_resource_types(id).await,
            "backup_vault_lock_configuration" => {
                self.read_backup_vault_lock_configuration(id).await
            }
            "legal_hold" => self.read_legal_hold(id).await,
            "recovery_point_index_details" => self.read_recovery_point_index_details(id).await,
            "recovery_point_restore_metadata" => {
                self.read_recovery_point_restore_metadata(id).await
            }
            "restore_testing_plan" => self.read_restore_testing_plan(id).await,
            "recovery_point_lifecycle" => self.read_recovery_point_lifecycle(id).await,
            "backup_selection" => self.read_backup_selection(id).await,
            "restore_validation_result" => self.read_restore_validation_result(id).await,
            "restore_job" => self.read_restore_job(id).await,
            "report_job" => self.read_report_job(id).await,
            "report_plan" => self.read_report_plan(id).await,
            "backup_job" => self.read_backup_job(id).await,
            "copy_job" => self.read_copy_job(id).await,
            "restore_job_metadata" => self.read_restore_job_metadata(id).await,
            "backup_plan" => self.read_backup_plan(id).await,
            "backup_plan_from_template" => self.read_backup_plan_from_template(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "backup", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "framework" => self.update_framework(id, input).await,
            "backup_plan_from_json" => self.update_backup_plan_from_json(id, input).await,
            "logically_air_gapped_backup_vault" => {
                self.update_logically_air_gapped_backup_vault(id, input)
                    .await
            }
            ...
            "recovery_point" => self.update_recovery_point(id, input).await,
            "backup_vault_notifications" => self.update_backup_vault_notifications(id, input).await,
            "restore_testing_inferred_metadata" => {
                self.update_restore_testing_inferred_metadata(id, input)
                    .await
            }
            "restore_testing_selection" => self.update_restore_testing_selection(id, input).await,
            "backup_vault_access_policy" => self.update_backup_vault_access_policy(id, input).await,
            "region_settings" => self.update_region_settings(id, input).await,
            "recovery_point_index_settings" => {
            ...
            "supported_resource_types" => self.update_supported_resource_types(id, input).await,
            "backup_vault_lock_configuration" => {
                self.update_backup_vault_lock_configuration(id, input).await
            }
            "legal_hold" => self.update_legal_hold(id, input).await,
            "recovery_point_index_details" => {
            ...
            "restore_testing_plan" => self.update_restore_testing_plan(id, input).await,
            "recovery_point_lifecycle" => self.update_recovery_point_lifecycle(id, input).await,
            "backup_selection" => self.update_backup_selection(id, input).await,
            "restore_validation_result" => self.update_restore_validation_result(id, input).await,
            "restore_job" => self.update_restore_job(id, input).await,
            "report_job" => self.update_report_job(id, input).await,
            "report_plan" => self.update_report_plan(id, input).await,
            "backup_job" => self.update_backup_job(id, input).await,
            "copy_job" => self.update_copy_job(id, input).await,
            "restore_job_metadata" => self.update_restore_job_metadata(id, input).await,
            "backup_plan" => self.update_backup_plan(id, input).await,
            "backup_plan_from_template" => self.update_backup_plan_from_template(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "backup", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "framework" => self.delete_framework(id).await,
            "backup_plan_from_json" => self.delete_backup_plan_from_json(id).await,
            "logically_air_gapped_backup_vault" => {
            ...
            "recovery_point" => self.delete_recovery_point(id).await,
            "backup_vault_notifications" => self.delete_backup_vault_notifications(id).await,
            "restore_testing_inferred_metadata" => {
                self.delete_restore_testing_inferred_metadata(id).await
            }
            "restore_testing_selection" => self.delete_restore_testing_selection(id).await,
            "backup_vault_access_policy" => self.delete_backup_vault_access_policy(id).await,
            "region_settings" => self.delete_region_settings(id).await,
            "recovery_point_index_settings" => self.delete_recovery_point_index_settings(id).await,
            "restore_access_backup_vault" => self.delete_restore_access_backup_vault(id).await,
            "backup_vault" => self.delete_backup_vault(id).await,
            "supported_resource_types" => self.delete_supported_resource_types(id).await,
            "backup_vault_lock_configuration" => {
                self.delete_backup_vault_lock_configuration(id).await
            }
            "legal_hold" => self.delete_legal_hold(id).await,
            "recovery_point_index_details" => self.delete_recovery_point_index_details(id).await,
            "recovery_point_restore_metadata" => {
                self.delete_recovery_point_restore_metadata(id).await
            }
            "restore_testing_plan" => self.delete_restore_testing_plan(id).await,
            "recovery_point_lifecycle" => self.delete_recovery_point_lifecycle(id).await,
            "backup_selection" => self.delete_backup_selection(id).await,
            "restore_validation_result" => self.delete_restore_validation_result(id).await,
            "restore_job" => self.delete_restore_job(id).await,
            "report_job" => self.delete_report_job(id).await,
            "report_plan" => self.delete_report_plan(id).await,
            "backup_job" => self.delete_backup_job(id).await,
            "copy_job" => self.delete_copy_job(id).await,
            "restore_job_metadata" => self.delete_restore_job_metadata(id).await,
            "backup_plan" => self.delete_backup_plan(id).await,
            "backup_plan_from_template" => self.delete_backup_plan_from_template(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "backup", resource_name
            ))),
    ...
    async fn create_framework(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    framework_description.unwrap_or_default(),
                ))
        })
    }

    /// Read a framework resource
    async fn read_framework(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_framework(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let idempotency_token = input.get_optional_string("idempotency_token")?;
            let framework_name = input.get_string("framework_name")?;
    ...
    async fn delete_framework(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_backup_plan_from_json(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_backup_plan_from_json(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_backup_plan_from_json(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn read_logically_air_gapped_backup_vault(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_logically_air_gapped_backup_vault(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_recovery_point(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_recovery_point(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_recovery_point(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_backup_vault_notifications(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "backup_vault_events",
                    backup_vault_events.unwrap_or_default(),
                )
    ...
    async fn read_backup_vault_notifications(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_backup_vault_notifications(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn read_restore_testing_inferred_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_restore_testing_inferred_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_restore_testing_selection(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "restore_testing_selection",
                    restore_testing_selection.unwrap_or_default(),
                )
                .with_field(
                    "restore_testing_plan_name",
                    restore_testing_plan_name.unwrap_or_default(),
                )
                .with_field("creator_request_id", creator_request_id.unwrap_or_default()))
        })
    }
    ...
    async fn read_restore_testing_selection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_restore_testing_selection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn read_backup_vault_access_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_backup_vault_access_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_region_settings(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let resource_type_opt_in_preference =
                input.get_optional_string("resource_type_opt_in_preference")?;
            let resource_type_management_preference =
                input.get_optional_string("resource_type_management_preference")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    resource_type_opt_in_preference.unwrap_or_default(),
                )
                .with_field(
                    "resource_type_management_preference",
                    resource_type_management_preference.unwrap_or_default(),
                ))
        })
    }

    /// Read a region_settings resource
    async fn read_region_settings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_region_settings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn read_recovery_point_index_settings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_recovery_point_index_settings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    source_backup_vault_arn.unwrap_or_default(),
                )
                .with_field("backup_vault_tags", backup_vault_tags.unwrap_or_default()))
        })
    }
    ...
    async fn read_restore_access_backup_vault(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_restore_access_backup_vault(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn read_supported_resource_types(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_supported_resource_types(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_backup_vault_lock_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "changeable_for_days",
                    changeable_for_days.unwrap_or_default(),
                )
                .with_field("max_retention_days", max_retention_days.unwrap_or_default())
                .with_field("min_retention_days", min_retention_days.unwrap_or_default()))
        })
    ...
    async fn read_backup_vault_lock_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_backup_vault_lock_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_legal_hold(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let idempotency_token = input.get_optional_string("idempotency_token")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    recovery_point_selection.unwrap_or_default(),
                )
    ...
    async fn read_legal_hold(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn update_legal_hold(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let idempotency_token = input.get_optional_string("idempotency_token")?;
            let recovery_point_selection = input.get_optional_string("recovery_point_selection")?;
    ...
    async fn delete_legal_hold(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn read_recovery_point_index_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_recovery_point_index_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn read_recovery_point_restore_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_recovery_point_restore_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_restore_testing_plan(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "restore_testing_plan",
                    restore_testing_plan.unwrap_or_default(),
                )
                .with_field("creator_request_id", creator_request_id.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default()))
        })
    ...
    async fn read_restore_testing_plan(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_restore_testing_plan(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn read_recovery_point_lifecycle(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_recovery_point_lifecycle(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_backup_selection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_backup_selection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_backup_selection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_restore_validation_result(
        ...
        self.provider.runtime().block_on(async {
            ...
            let validation_status_message =
                input.get_optional_string("validation_status_message")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    validation_status_message.unwrap_or_default(),
                )
    ...
    async fn read_restore_validation_result(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_restore_validation_result(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_restore_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_restore_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn update_restore_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_restore_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_report_plan(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_report_plan(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn update_report_plan(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let report_plan_tags = input.get_optional_string("report_plan_tags")?;
            let idempotency_token = input.get_optional_string("idempotency_token")?;
    ...
    async fn delete_report_plan(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_backup_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_backup_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn update_backup_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn create_copy_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_copy_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn update_copy_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_copy_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn create_restore_job_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_restore_job_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_restore_job_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
    ...
    async fn read_backup_plan_from_template(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.backup_client
    ...
    async fn delete_backup_plan_from_template(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.backup_client
