...
impl<'a> Backup_vault_lock_configuration<'a> {
    ...
    pub async fn create(&self, backup_vault_name: String, max_retention_days: Option<i64>, min_retention_days: Option<i64>, changeable_for_days: Option<i64>) -> Result<String> {
