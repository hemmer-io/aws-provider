...
impl<'a> Legal_hold<'a> {
    ...
    pub async fn create(&self, title: String, description: String, idempotency_token: Option<String>, tags: Option<HashMap<String, String>>, recovery_point_selection: Option<String>) -> Result<String> {
