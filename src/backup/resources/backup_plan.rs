...
impl<'a> Backup_plan<'a> {
    ...
    pub async fn create(&self, backup_plan_tags: Option<HashMap<String, String>>, creator_request_id: Option<String>, backup_plan: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, backup_plan_tags: Option<HashMap<String, String>>, creator_request_id: Option<String>, backup_plan: Option<String>) -> Result<()> {
