...
impl<'a> Logically_air_gapped_backup_vault<'a> {
    ...
    pub async fn create(&self, creator_request_id: Option<String>, max_retention_days: i64, min_retention_days: i64, backup_vault_name: String, backup_vault_tags: Option<HashMap<String, String>>) -> Result<String> {
