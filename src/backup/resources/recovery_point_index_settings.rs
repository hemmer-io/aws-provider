...
impl<'a> Recovery_point_index_settings<'a> {
    ...
    pub async fn update(&self, id: &str, recovery_point_arn: Option<String>, backup_vault_name: Option<String>, iam_role_arn: Option<String>, index: Option<String>) -> Result<()> {
