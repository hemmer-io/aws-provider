...
impl<'a> Backup_vault<'a> {
    ...
    pub async fn create(&self, creator_request_id: Option<String>, backup_vault_name: String, encryption_key_arn: Option<String>, backup_vault_tags: Option<HashMap<String, String>>) -> Result<String> {
