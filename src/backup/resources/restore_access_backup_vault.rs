...
impl<'a> Restore_access_backup_vault<'a> {
    ...
    pub async fn create(&self, source_backup_vault_arn: String, backup_vault_name: Option<String>, backup_vault_tags: Option<HashMap<String, String>>, creator_request_id: Option<String>, requester_comment: Option<String>) -> Result<String> {
