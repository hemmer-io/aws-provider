...
impl<'a> Restore_access_backup_vault<'a> {
    ...
    pub async fn create(&self, requester_comment: Option<String>, backup_vault_tags: Option<HashMap<String, String>>, backup_vault_name: Option<String>, source_backup_vault_arn: String, creator_request_id: Option<String>) -> Result<String> {
