...
impl<'a> Preferences<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, savings_estimation_mode: Option<String>, member_account_discount_visibility: Option<String>, preferred_commitment: Option<String>) -> Result<()> {
