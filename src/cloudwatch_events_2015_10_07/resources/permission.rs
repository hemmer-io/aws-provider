...
impl<'a> Permission<'a> {
    ...
    pub async fn create(&self, action: Option<String>, condition: Option<String>, policy: Option<String>, event_bus_name: Option<String>, principal: Option<String>, statement_id: Option<String>) -> Result<String> {
