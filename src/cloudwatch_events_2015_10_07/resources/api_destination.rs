...
impl<'a> Api_destination<'a> {
    ...
    pub async fn create(&self, name: String, connection_arn: String, http_method: String, invocation_endpoint: String, invocation_rate_limit_per_second: Option<i64>, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, connection_arn: Option<String>, http_method: Option<String>, invocation_endpoint: Option<String>, invocation_rate_limit_per_second: Option<i64>, description: Option<String>) -> Result<()> {
