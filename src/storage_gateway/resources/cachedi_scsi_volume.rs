...
impl<'a> Cachedi_scsi_volume<'a> {
    ...
    pub async fn create(&self, network_interface_id: String, kms_key: Option<String>, tags: Option<Vec<String>>, client_token: String, volume_size_in_bytes: i64, kms_encrypted: Option<bool>, source_volume_arn: Option<String>, gateway_arn: String, snapshot_id: Option<String>, target_name: String) -> Result<String> {
