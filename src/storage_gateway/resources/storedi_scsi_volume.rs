...
impl<'a> Storedi_scsi_volume<'a> {
    ...
    pub async fn create(&self, network_interface_id: String, snapshot_id: Option<String>, preserve_existing_data: bool, target_name: String, disk_id: String, kms_key: Option<String>, gateway_arn: String, kms_encrypted: Option<bool>, tags: Option<Vec<String>>) -> Result<String> {
