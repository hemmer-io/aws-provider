...
impl<'a> Maintenance_start_time<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, minute_of_hour: Option<i64>, software_update_preferences: Option<String>, day_of_week: Option<i64>, gateway_arn: Option<String>, day_of_month: Option<i64>, hour_of_day: Option<i64>) -> Result<()> {
