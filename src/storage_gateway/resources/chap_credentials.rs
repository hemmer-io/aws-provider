...
impl<'a> Chap_credentials<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, secret_to_authenticate_initiator: Option<String>, initiator_name: Option<String>, secret_to_authenticate_target: Option<String>, target_arn: Option<String>) -> Result<()> {
