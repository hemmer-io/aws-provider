...
impl<'a> File_system_association<'a> {
    ...
    pub async fn update(&self, id: &str, file_system_association_arn: Option<String>, user_name: Option<String>, cache_attributes: Option<String>, password: Option<String>, audit_destination_arn: Option<String>) -> Result<()> {
