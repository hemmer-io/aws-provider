...
impl<'a> File_system_association<'a> {
    ...
    pub async fn update(&self, id: &str, password: Option<String>, audit_destination_arn: Option<String>, user_name: Option<String>, file_system_association_arn: Option<String>, cache_attributes: Option<String>) -> Result<()> {
