...
impl<'a> Tape_with_barcode<'a> {
    ...
    pub async fn create(&self, gateway_arn: String, tape_barcode: String, pool_id: Option<String>, tags: Option<Vec<String>>, tape_size_in_bytes: i64, kms_key: Option<String>, kms_encrypted: Option<bool>, worm: Option<bool>) -> Result<String> {
