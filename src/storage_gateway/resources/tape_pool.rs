...
impl<'a> Tape_pool<'a> {
    ...
    pub async fn create(&self, pool_name: String, storage_class: String, retention_lock_time_in_days: Option<i64>, tags: Option<Vec<String>>, retention_lock_type: Option<String>) -> Result<String> {
