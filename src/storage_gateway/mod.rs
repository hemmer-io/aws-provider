...
impl<'a> Storage_gatewayService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "bandwidth_rate_limit_schedule" => {
                self.plan_bandwidth_rate_limit_schedule(current_state, desired_input)
                    .await
            }
            ...
            "smb_security_strategy" => {
                self.plan_smb_security_strategy(current_state, desired_input)
                    .await
            }
            "gateway_information" => {
                self.plan_gateway_information(current_state, desired_input)
                    .await
            }
            "smb_file_share" => self.plan_smb_file_share(current_state, desired_input).await,
            "cachedi_scsi_volume" => {
                self.plan_cachedi_scsi_volume(current_state, desired_input)
                    .await
            }
            "availability_monitor_test" => {
                self.plan_availability_monitor_test(current_state, desired_input)
                    .await
            }
            "file_system_association" => {
                self.plan_file_system_association(current_state, desired_input)
                    .await
            }
            "gateway_software_now" => {
                self.plan_gateway_software_now(current_state, desired_input)
                    .await
            }
            "tape_recovery_points" => {
                self.plan_tape_recovery_points(current_state, desired_input)
                    .await
            }
            "tapes" => self.plan_tapes(current_state, desired_input).await,
            "tape_pool" => self.plan_tape_pool(current_state, desired_input).await,
            "gateway" => self.plan_gateway(current_state, desired_input).await,
            "nfs_file_shares" => {
                self.plan_nfs_file_shares(current_state, desired_input)
                    .await
            }
            "nfs_file_share" => self.plan_nfs_file_share(current_state, desired_input).await,
            "tape_with_barcode" => {
                self.plan_tape_with_barcode(current_state, desired_input)
                    .await
            }
            "working_storage" => {
                self.plan_working_storage(current_state, desired_input)
                    .await
            }
            "snapshot" => self.plan_snapshot(current_state, desired_input).await,
            "chap_credentials" => {
                self.plan_chap_credentials(current_state, desired_input)
                    .await
            }
            "smb_settings" => self.plan_smb_settings(current_state, desired_input).await,
            "tape_archives" => self.plan_tape_archives(current_state, desired_input).await,
            "cache" => self.plan_cache(current_state, desired_input).await,
            "smb_file_shares" => {
                self.plan_smb_file_shares(current_state, desired_input)
                    .await
            }
            "file_share" => self.plan_file_share(current_state, desired_input).await,
            "vtl_devices" => self.plan_vtl_devices(current_state, desired_input).await,
            "automatic_tape_creation_policy" => {
                self.plan_automatic_tape_creation_policy(current_state, desired_input)
                    .await
            }
            "tape_archive" => self.plan_tape_archive(current_state, desired_input).await,
            "file_system_associations" => {
                self.plan_file_system_associations(current_state, desired_input)
                    .await
            }
            "maintenance_start_time" => {
                self.plan_maintenance_start_time(current_state, desired_input)
                    .await
            }
            "cache_report" => self.plan_cache_report(current_state, desired_input).await,
            "vtl_device_type" => {
                self.plan_vtl_device_type(current_state, desired_input)
                    .await
            }
            "cachedi_scsi_volumes" => {
                self.plan_cachedi_scsi_volumes(current_state, desired_input)
                    .await
            }
            "upload_buffer" => self.plan_upload_buffer(current_state, desired_input).await,
            "smb_local_groups" => {
                self.plan_smb_local_groups(current_state, desired_input)
                    .await
            }
            "tape" => self.plan_tape(current_state, desired_input).await,
            "bandwidth_rate_limit" => {
                self.plan_bandwidth_rate_limit(current_state, desired_input)
                    .await
            }
            "snapshot_from_volume_recovery_point" => {
                self.plan_snapshot_from_volume_recovery_point(current_state, desired_input)
                    .await
            }
            "storedi_scsi_volume" => {
                self.plan_storedi_scsi_volume(current_state, desired_input)
                    .await
            }
            "storedi_scsi_volumes" => {
                self.plan_storedi_scsi_volumes(current_state, desired_input)
                    .await
            }
            "smb_file_share_visibility" => {
                self.plan_smb_file_share_visibility(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "storage_gateway", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "smb_security_strategy" => self.create_smb_security_strategy(input).await,
            "gateway_information" => self.create_gateway_information(input).await,
            "smb_file_share" => self.create_smb_file_share(input).await,
            "cachedi_scsi_volume" => self.create_cachedi_scsi_volume(input).await,
            "availability_monitor_test" => self.create_availability_monitor_test(input).await,
            "file_system_association" => self.create_file_system_association(input).await,
            "gateway_software_now" => self.create_gateway_software_now(input).await,
            "tape_recovery_points" => self.create_tape_recovery_points(input).await,
            "tapes" => self.create_tapes(input).await,
            "tape_pool" => self.create_tape_pool(input).await,
            "gateway" => self.create_gateway(input).await,
            "nfs_file_shares" => self.create_nfs_file_shares(input).await,
            "nfs_file_share" => self.create_nfs_file_share(input).await,
            "tape_with_barcode" => self.create_tape_with_barcode(input).await,
            "working_storage" => self.create_working_storage(input).await,
            "snapshot" => self.create_snapshot(input).await,
            "chap_credentials" => self.create_chap_credentials(input).await,
            "smb_settings" => self.create_smb_settings(input).await,
            "tape_archives" => self.create_tape_archives(input).await,
            "cache" => self.create_cache(input).await,
            "smb_file_shares" => self.create_smb_file_shares(input).await,
            "file_share" => self.create_file_share(input).await,
            "vtl_devices" => self.create_vtl_devices(input).await,
            "automatic_tape_creation_policy" => {
                self.create_automatic_tape_creation_policy(input).await
            }
            "tape_archive" => self.create_tape_archive(input).await,
            "file_system_associations" => self.create_file_system_associations(input).await,
            "maintenance_start_time" => self.create_maintenance_start_time(input).await,
            "cache_report" => self.create_cache_report(input).await,
            "vtl_device_type" => self.create_vtl_device_type(input).await,
            "cachedi_scsi_volumes" => self.create_cachedi_scsi_volumes(input).await,
            "upload_buffer" => self.create_upload_buffer(input).await,
            "smb_local_groups" => self.create_smb_local_groups(input).await,
            "tape" => self.create_tape(input).await,
            "bandwidth_rate_limit" => self.create_bandwidth_rate_limit(input).await,
            "snapshot_from_volume_recovery_point" => {
                self.create_snapshot_from_volume_recovery_point(input).await
            }
            "storedi_scsi_volume" => self.create_storedi_scsi_volume(input).await,
            "storedi_scsi_volumes" => self.create_storedi_scsi_volumes(input).await,
            "smb_file_share_visibility" => self.create_smb_file_share_visibility(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "storage_gateway", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "bandwidth_rate_limit_schedule" => self.read_bandwidth_rate_limit_schedule(id).await,
            "volume" => self.read_volume(id).await,
            "snapshot_schedule" => self.read_snapshot_schedule(id).await,
            "smb_security_strategy" => self.read_smb_security_strategy(id).await,
            "gateway_information" => self.read_gateway_information(id).await,
            "smb_file_share" => self.read_smb_file_share(id).await,
            "cachedi_scsi_volume" => self.read_cachedi_scsi_volume(id).await,
            "availability_monitor_test" => self.read_availability_monitor_test(id).await,
            "file_system_association" => self.read_file_system_association(id).await,
            "gateway_software_now" => self.read_gateway_software_now(id).await,
            "tape_recovery_points" => self.read_tape_recovery_points(id).await,
            "tapes" => self.read_tapes(id).await,
            "tape_pool" => self.read_tape_pool(id).await,
            "gateway" => self.read_gateway(id).await,
            "nfs_file_shares" => self.read_nfs_file_shares(id).await,
            "nfs_file_share" => self.read_nfs_file_share(id).await,
            "tape_with_barcode" => self.read_tape_with_barcode(id).await,
            "working_storage" => self.read_working_storage(id).await,
            "snapshot" => self.read_snapshot(id).await,
            "chap_credentials" => self.read_chap_credentials(id).await,
            "smb_settings" => self.read_smb_settings(id).await,
            "tape_archives" => self.read_tape_archives(id).await,
            "cache" => self.read_cache(id).await,
            "smb_file_shares" => self.read_smb_file_shares(id).await,
            "file_share" => self.read_file_share(id).await,
            "vtl_devices" => self.read_vtl_devices(id).await,
            "automatic_tape_creation_policy" => self.read_automatic_tape_creation_policy(id).await,
            "tape_archive" => self.read_tape_archive(id).await,
            "file_system_associations" => self.read_file_system_associations(id).await,
            "maintenance_start_time" => self.read_maintenance_start_time(id).await,
            "cache_report" => self.read_cache_report(id).await,
            "vtl_device_type" => self.read_vtl_device_type(id).await,
            "cachedi_scsi_volumes" => self.read_cachedi_scsi_volumes(id).await,
            "upload_buffer" => self.read_upload_buffer(id).await,
            "smb_local_groups" => self.read_smb_local_groups(id).await,
            "tape" => self.read_tape(id).await,
            "bandwidth_rate_limit" => self.read_bandwidth_rate_limit(id).await,
            "snapshot_from_volume_recovery_point" => {
                self.read_snapshot_from_volume_recovery_point(id).await
            }
            "storedi_scsi_volume" => self.read_storedi_scsi_volume(id).await,
            "storedi_scsi_volumes" => self.read_storedi_scsi_volumes(id).await,
            "smb_file_share_visibility" => self.read_smb_file_share_visibility(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "storage_gateway", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "smb_security_strategy" => self.update_smb_security_strategy(id, input).await,
            "gateway_information" => self.update_gateway_information(id, input).await,
            "smb_file_share" => self.update_smb_file_share(id, input).await,
            "cachedi_scsi_volume" => self.update_cachedi_scsi_volume(id, input).await,
            "availability_monitor_test" => self.update_availability_monitor_test(id, input).await,
            "file_system_association" => self.update_file_system_association(id, input).await,
            "gateway_software_now" => self.update_gateway_software_now(id, input).await,
            "tape_recovery_points" => self.update_tape_recovery_points(id, input).await,
            "tapes" => self.update_tapes(id, input).await,
            "tape_pool" => self.update_tape_pool(id, input).await,
            "gateway" => self.update_gateway(id, input).await,
            "nfs_file_shares" => self.update_nfs_file_shares(id, input).await,
            "nfs_file_share" => self.update_nfs_file_share(id, input).await,
            "tape_with_barcode" => self.update_tape_with_barcode(id, input).await,
            "working_storage" => self.update_working_storage(id, input).await,
            "snapshot" => self.update_snapshot(id, input).await,
            "chap_credentials" => self.update_chap_credentials(id, input).await,
            "smb_settings" => self.update_smb_settings(id, input).await,
            "tape_archives" => self.update_tape_archives(id, input).await,
            "cache" => self.update_cache(id, input).await,
            "smb_file_shares" => self.update_smb_file_shares(id, input).await,
            "file_share" => self.update_file_share(id, input).await,
            "vtl_devices" => self.update_vtl_devices(id, input).await,
            "automatic_tape_creation_policy" => {
                self.update_automatic_tape_creation_policy(id, input).await
            }
            "tape_archive" => self.update_tape_archive(id, input).await,
            "file_system_associations" => self.update_file_system_associations(id, input).await,
            "maintenance_start_time" => self.update_maintenance_start_time(id, input).await,
            "cache_report" => self.update_cache_report(id, input).await,
            "vtl_device_type" => self.update_vtl_device_type(id, input).await,
            "cachedi_scsi_volumes" => self.update_cachedi_scsi_volumes(id, input).await,
            "upload_buffer" => self.update_upload_buffer(id, input).await,
            "smb_local_groups" => self.update_smb_local_groups(id, input).await,
            "tape" => self.update_tape(id, input).await,
            "bandwidth_rate_limit" => self.update_bandwidth_rate_limit(id, input).await,
            "snapshot_from_volume_recovery_point" => {
                self.update_snapshot_from_volume_recovery_point(id, input)
                    .await
            }
            "storedi_scsi_volume" => self.update_storedi_scsi_volume(id, input).await,
            "storedi_scsi_volumes" => self.update_storedi_scsi_volumes(id, input).await,
            "smb_file_share_visibility" => self.update_smb_file_share_visibility(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "storage_gateway", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "bandwidth_rate_limit_schedule" => self.delete_bandwidth_rate_limit_schedule(id).await,
            "volume" => self.delete_volume(id).await,
            "snapshot_schedule" => self.delete_snapshot_schedule(id).await,
            "smb_security_strategy" => self.delete_smb_security_strategy(id).await,
            "gateway_information" => self.delete_gateway_information(id).await,
            "smb_file_share" => self.delete_smb_file_share(id).await,
            "cachedi_scsi_volume" => self.delete_cachedi_scsi_volume(id).await,
            "availability_monitor_test" => self.delete_availability_monitor_test(id).await,
            "file_system_association" => self.delete_file_system_association(id).await,
            "gateway_software_now" => self.delete_gateway_software_now(id).await,
            "tape_recovery_points" => self.delete_tape_recovery_points(id).await,
            "tapes" => self.delete_tapes(id).await,
            "tape_pool" => self.delete_tape_pool(id).await,
            "gateway" => self.delete_gateway(id).await,
            "nfs_file_shares" => self.delete_nfs_file_shares(id).await,
            "nfs_file_share" => self.delete_nfs_file_share(id).await,
            "tape_with_barcode" => self.delete_tape_with_barcode(id).await,
            "working_storage" => self.delete_working_storage(id).await,
            "snapshot" => self.delete_snapshot(id).await,
            "chap_credentials" => self.delete_chap_credentials(id).await,
            "smb_settings" => self.delete_smb_settings(id).await,
            "tape_archives" => self.delete_tape_archives(id).await,
            "cache" => self.delete_cache(id).await,
            "smb_file_shares" => self.delete_smb_file_shares(id).await,
            "file_share" => self.delete_file_share(id).await,
            "vtl_devices" => self.delete_vtl_devices(id).await,
            "automatic_tape_creation_policy" => {
                self.delete_automatic_tape_creation_policy(id).await
            }
            "tape_archive" => self.delete_tape_archive(id).await,
            "file_system_associations" => self.delete_file_system_associations(id).await,
            "maintenance_start_time" => self.delete_maintenance_start_time(id).await,
            "cache_report" => self.delete_cache_report(id).await,
            "vtl_device_type" => self.delete_vtl_device_type(id).await,
            "cachedi_scsi_volumes" => self.delete_cachedi_scsi_volumes(id).await,
            "upload_buffer" => self.delete_upload_buffer(id).await,
            "smb_local_groups" => self.delete_smb_local_groups(id).await,
            "tape" => self.delete_tape(id).await,
            "bandwidth_rate_limit" => self.delete_bandwidth_rate_limit(id).await,
            "snapshot_from_volume_recovery_point" => {
                self.delete_snapshot_from_volume_recovery_point(id).await
            }
            "storedi_scsi_volume" => self.delete_storedi_scsi_volume(id).await,
            "storedi_scsi_volumes" => self.delete_storedi_scsi_volumes(id).await,
            "smb_file_share_visibility" => self.delete_smb_file_share_visibility(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "storage_gateway", resource_name
            ))),
    ...
    async fn create_bandwidth_rate_limit_schedule(
        ...
        self.provider.runtime().block_on(async {
            ...
            let bandwidth_rate_limit_intervals =
                input.get_string("bandwidth_rate_limit_intervals")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    bandwidth_rate_limit_intervals.unwrap_or_default(),
                )
    ...
    async fn read_bandwidth_rate_limit_schedule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_bandwidth_rate_limit_schedule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_snapshot_schedule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "recurrence_in_hours",
                    recurrence_in_hours.unwrap_or_default(),
                )
    ...
    async fn create_smb_security_strategy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let gateway_arn = input.get_string("gateway_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "smb_security_strategy",
                    smb_security_strategy.unwrap_or_default(),
                ))
        })
    }

    /// Read a smb_security_strategy resource
    async fn read_smb_security_strategy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_smb_security_strategy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_gateway_information(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let cloud_watch_log_group_arn =
                input.get_optional_string("cloud_watch_log_group_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    cloud_watch_log_group_arn.unwrap_or_default(),
                ))
        })
    }

    /// Read a gateway_information resource
    async fn read_gateway_information(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_gateway_information(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_smb_file_share(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    vpc_endpoint_dns_name.unwrap_or_default(),
                )
                .with_field(
                    "guess_mime_type_enabled",
                    guess_mime_type_enabled.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field(
                    "audit_destination_arn",
                    audit_destination_arn.unwrap_or_default(),
                )
                .with_field("encryption_type", encryption_type.unwrap_or_default())
                .with_field(
                    "default_storage_class",
                    default_storage_class.unwrap_or_default(),
                )
                .with_field(
                    "notification_policy",
                    notification_policy.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    access_based_enumeration.unwrap_or_default(),
                )
    ...
    async fn read_smb_file_share(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_smb_file_share(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_cachedi_scsi_volume(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    network_interface_id.unwrap_or_default(),
                )
                .with_field("kms_key", kms_key.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field(
                    ...
                    volume_size_in_bytes.unwrap_or_default(),
                )
                .with_field("kms_encrypted", kms_encrypted.unwrap_or_default())
    ...
    async fn read_cachedi_scsi_volume(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_cachedi_scsi_volume(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn read_availability_monitor_test(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_availability_monitor_test(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_file_system_association(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let cache_attributes = input.get_optional_string("cache_attributes")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    file_system_association_arn.unwrap_or_default(),
                )
    ...
    async fn read_file_system_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_file_system_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_gateway_software_now(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let gateway_arn = input.get_string("gateway_arn")?;
    ...
    async fn read_gateway_software_now(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_gateway_software_now(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_tape_recovery_points(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_tape_recovery_points(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_tape_recovery_points(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_tapes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let kms_encrypted = input.get_optional_string("kms_encrypted")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "tape_barcode_prefix",
                    tape_barcode_prefix.unwrap_or_default(),
                )
                ...
                .with_field(
                    "num_tapes_to_create",
                    num_tapes_to_create.unwrap_or_default(),
                ))
        })
    }

    /// Read a tapes resource
    async fn read_tapes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn update_tapes(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let kms_encrypted = input.get_optional_string("kms_encrypted")?;
            let client_token = input.get_string("client_token")?;
    ...
    async fn delete_tapes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_tape_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let pool_name = input.get_string("pool_name")?;
            let storage_class = input.get_string("storage_class")?;
            let retention_lock_time_in_days =
                input.get_optional_string("retention_lock_time_in_days")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    retention_lock_time_in_days.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "retention_lock_type",
                    retention_lock_type.unwrap_or_default(),
                ))
        })
    }

    /// Read a tape_pool resource
    async fn read_tape_pool(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn update_tape_pool(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let pool_name = input.get_string("pool_name")?;
            let storage_class = input.get_string("storage_class")?;
    ...
    async fn delete_tape_pool(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_gateway(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_gateway(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn update_gateway(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn create_nfs_file_shares(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_nfs_file_shares(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_nfs_file_shares(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_nfs_file_share(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let file_share_name = input.get_optional_string("file_share_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    nfs_file_share_defaults.unwrap_or_default(),
                )
                .with_field(
                    "vpc_endpoint_dns_name",
                    vpc_endpoint_dns_name.unwrap_or_default(),
    ...
    async fn read_nfs_file_share(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_nfs_file_share(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_tape_with_barcode(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let gateway_arn = input.get_string("gateway_arn")?;
    ...
    async fn read_tape_with_barcode(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_tape_with_barcode(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_working_storage(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_working_storage(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_working_storage(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    snapshot_description.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_chap_credentials(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let secret_to_authenticate_initiator =
                input.get_string("secret_to_authenticate_initiator")?;
            let initiator_name = input.get_string("initiator_name")?;
            let secret_to_authenticate_target =
                input.get_optional_string("secret_to_authenticate_target")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    secret_to_authenticate_initiator.unwrap_or_default(),
                )
                .with_field("initiator_name", initiator_name.unwrap_or_default())
                .with_field(
                    "secret_to_authenticate_target",
                    secret_to_authenticate_target.unwrap_or_default(),
                )
    ...
    async fn read_chap_credentials(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_chap_credentials(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_smb_settings(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_smb_settings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn update_smb_settings(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_smb_settings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_tape_archives(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_tape_archives(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn update_tape_archives(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_tape_archives(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_smb_file_shares(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_smb_file_shares(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_smb_file_shares(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_file_share(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_file_share(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn update_file_share(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_file_share(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_vtl_devices(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_vtl_devices(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn update_vtl_devices(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_vtl_devices(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_automatic_tape_creation_policy(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let automatic_tape_creation_rules =
                input.get_string("automatic_tape_creation_rules")?;
            let gateway_arn = input.get_string("gateway_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    automatic_tape_creation_rules.unwrap_or_default(),
                )
                .with_field("gateway_arn", gateway_arn.unwrap_or_default()))
        })
    }
    ...
    async fn read_automatic_tape_creation_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_automatic_tape_creation_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_tape_archive(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_tape_archive(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn update_tape_archive(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_tape_archive(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn read_file_system_associations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_file_system_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_maintenance_start_time(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let hour_of_day = input.get_optional_string("hour_of_day")?;
            let software_update_preferences =
                input.get_optional_string("software_update_preferences")?;
            let gateway_arn = input.get_string("gateway_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    software_update_preferences.unwrap_or_default(),
                )
                .with_field("gateway_arn", gateway_arn.unwrap_or_default())
    ...
    async fn read_maintenance_start_time(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_maintenance_start_time(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_cache_report(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cache_report(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn update_cache_report(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_cache_report(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_vtl_device_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_vtl_device_type(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_vtl_device_type(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_cachedi_scsi_volumes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cachedi_scsi_volumes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_cachedi_scsi_volumes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_upload_buffer(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_upload_buffer(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn update_upload_buffer(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_upload_buffer(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_smb_local_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_smb_local_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_smb_local_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_tape(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_tape(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn update_tape(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_tape(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_bandwidth_rate_limit(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let average_upload_rate_limit_in_bits_per_sec =
                input.get_optional_string("average_upload_rate_limit_in_bits_per_sec")?;
            let gateway_arn = input.get_string("gateway_arn")?;
            let average_download_rate_limit_in_bits_per_sec =
                input.get_optional_string("average_download_rate_limit_in_bits_per_sec")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    average_upload_rate_limit_in_bits_per_sec.unwrap_or_default(),
                )
                .with_field("gateway_arn", gateway_arn.unwrap_or_default())
                .with_field(
                    "average_download_rate_limit_in_bits_per_sec",
                    average_download_rate_limit_in_bits_per_sec.unwrap_or_default(),
                ))
        })
    }

    /// Read a bandwidth_rate_limit resource
    async fn read_bandwidth_rate_limit(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_bandwidth_rate_limit(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn read_snapshot_from_volume_recovery_point(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_snapshot_from_volume_recovery_point(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_storedi_scsi_volume(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let network_interface_id = input.get_string("network_interface_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    preserve_existing_data.unwrap_or_default(),
                ))
        })
    }

    /// Read a storedi_scsi_volume resource
    async fn read_storedi_scsi_volume(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_storedi_scsi_volume(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_storedi_scsi_volumes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_storedi_scsi_volumes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_storedi_scsi_volumes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
    ...
    async fn create_smb_file_share_visibility(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "file_shares_visible",
                    file_shares_visible.unwrap_or_default(),
                ))
        })
    }

    /// Read a smb_file_share_visibility resource
    async fn read_smb_file_share_visibility(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.storage_gateway_client
    ...
    async fn delete_smb_file_share_visibility(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.storage_gateway_client
