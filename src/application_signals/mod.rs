...
impl<'a> Application_signalsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "grouping_configuration" => {
                self.plan_grouping_configuration(current_state, desired_input).await
            }
            "service" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "grouping_configuration" => {
                self.create_grouping_configuration(input).await
            }
            "service" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "grouping_configuration" => {
                self.read_grouping_configuration(id).await
            }
            "service" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "grouping_configuration" => {
                self.update_grouping_configuration(id, input).await
            }
            "service" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "grouping_configuration" => {
                self.delete_grouping_configuration(id).await
            }
            "service" => {
    ...
    async fn create_grouping_configuration(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let grouping_attribute_definitions = input.get_string("grouping_attribute_definitions")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("grouping_attribute_definitions", grouping_attribute_definitions.unwrap_or_default())
            )
        })
    }

    /// Read a grouping_configuration resource
    async fn read_grouping_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_grouping_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
