...
impl<'a> Trusted_token_issuer<'a> {
    ...
    pub async fn create(&self, instance_arn: String, name: String, trusted_token_issuer_type: String, trusted_token_issuer_configuration: String, client_token: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, instance_arn: Option<String>, name: Option<String>, trusted_token_issuer_type: Option<String>, trusted_token_issuer_configuration: Option<String>, client_token: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
