...
impl<'a> Permission_set<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, instance_arn: String, session_duration: Option<String>, name: String, description: Option<String>, relay_state: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, instance_arn: Option<String>, session_duration: Option<String>, name: Option<String>, description: Option<String>, relay_state: Option<String>) -> Result<()> {
