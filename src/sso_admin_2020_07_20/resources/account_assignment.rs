...
impl<'a> Account_assignment<'a> {
    ...
    pub async fn create(&self, permission_set_arn: String, principal_type: String, principal_id: String, target_id: String, instance_arn: String, target_type: String) -> Result<String> {
