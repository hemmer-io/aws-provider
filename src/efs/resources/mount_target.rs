...
impl<'a> Mount_target<'a> {
    ...
    pub async fn create(&self, ipv6_address: Option<String>, ip_address: Option<String>, security_groups: Option<Vec<String>>, file_system_id: String, ip_address_type: Option<String>, subnet_id: String) -> Result<String> {
