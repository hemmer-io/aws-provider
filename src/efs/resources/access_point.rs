...
impl<'a> Access_point<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, root_directory: Option<String>, file_system_id: String, client_token: String, posix_user: Option<String>) -> Result<String> {
