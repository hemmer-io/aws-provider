...
impl<'a> EfsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "mount_target" => self.plan_mount_target(current_state, desired_input).await,
            "access_points" => self.plan_access_points(current_state, desired_input).await,
            "tags" => self.plan_tags(current_state, desired_input).await,
            "backup_policy" => self.plan_backup_policy(current_state, desired_input).await,
            "replication_configurations" => {
                self.plan_replication_configurations(current_state, desired_input)
                    .await
            }
            "file_system_policy" => {
                self.plan_file_system_policy(current_state, desired_input)
                    .await
            }
            "mount_target_security_groups" => {
                self.plan_mount_target_security_groups(current_state, desired_input)
                    .await
            }
            ...
            "file_system_protection" => {
                self.plan_file_system_protection(current_state, desired_input)
                    .await
            }
            "lifecycle_configuration" => {
                self.plan_lifecycle_configuration(current_state, desired_input)
                    .await
            }
            "access_point" => self.plan_access_point(current_state, desired_input).await,
            "mount_targets" => self.plan_mount_targets(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "mount_target" => self.create_mount_target(input).await,
            "access_points" => self.create_access_points(input).await,
            "tags" => self.create_tags(input).await,
            "backup_policy" => self.create_backup_policy(input).await,
            "replication_configurations" => self.create_replication_configurations(input).await,
            "file_system_policy" => self.create_file_system_policy(input).await,
            "mount_target_security_groups" => self.create_mount_target_security_groups(input).await,
            "file_system" => self.create_file_system(input).await,
            "account_preferences" => self.create_account_preferences(input).await,
            "file_system_protection" => self.create_file_system_protection(input).await,
            "lifecycle_configuration" => self.create_lifecycle_configuration(input).await,
            "access_point" => self.create_access_point(input).await,
            "mount_targets" => self.create_mount_targets(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "mount_target" => self.read_mount_target(id).await,
            "access_points" => self.read_access_points(id).await,
            "tags" => self.read_tags(id).await,
            "backup_policy" => self.read_backup_policy(id).await,
            "replication_configurations" => self.read_replication_configurations(id).await,
            "file_system_policy" => self.read_file_system_policy(id).await,
            "mount_target_security_groups" => self.read_mount_target_security_groups(id).await,
            "file_system" => self.read_file_system(id).await,
            "account_preferences" => self.read_account_preferences(id).await,
            "file_system_protection" => self.read_file_system_protection(id).await,
            "lifecycle_configuration" => self.read_lifecycle_configuration(id).await,
            "access_point" => self.read_access_point(id).await,
            "mount_targets" => self.read_mount_targets(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "mount_target" => self.update_mount_target(id, input).await,
            "access_points" => self.update_access_points(id, input).await,
            "tags" => self.update_tags(id, input).await,
            "backup_policy" => self.update_backup_policy(id, input).await,
            "replication_configurations" => self.update_replication_configurations(id, input).await,
            "file_system_policy" => self.update_file_system_policy(id, input).await,
            "mount_target_security_groups" => {
            ...
            "file_system_protection" => self.update_file_system_protection(id, input).await,
            "lifecycle_configuration" => self.update_lifecycle_configuration(id, input).await,
            "access_point" => self.update_access_point(id, input).await,
            "mount_targets" => self.update_mount_targets(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "mount_target" => self.delete_mount_target(id).await,
            "access_points" => self.delete_access_points(id).await,
            "tags" => self.delete_tags(id).await,
            "backup_policy" => self.delete_backup_policy(id).await,
            "replication_configurations" => self.delete_replication_configurations(id).await,
            "file_system_policy" => self.delete_file_system_policy(id).await,
            "mount_target_security_groups" => self.delete_mount_target_security_groups(id).await,
            "file_system" => self.delete_file_system(id).await,
            "account_preferences" => self.delete_account_preferences(id).await,
            "file_system_protection" => self.delete_file_system_protection(id).await,
            "lifecycle_configuration" => self.delete_lifecycle_configuration(id).await,
            "access_point" => self.delete_access_point(id).await,
            "mount_targets" => self.delete_mount_targets(id).await,
    ...
    async fn create_mount_target(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_mount_target(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_mount_target(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let ipv6_address = input.get_optional_string("ipv6_address")?;
            let subnet_id = input.get_string("subnet_id")?;
    ...
    async fn delete_mount_target(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_access_points(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_access_points(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.efs_client
    ...
    async fn update_access_points(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_access_points(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.efs_client
    ...
    async fn create_backup_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let file_system_id = input.get_string("file_system_id")?;
    ...
    async fn read_backup_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.efs_client
    ...
    async fn update_backup_policy(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let file_system_id = input.get_string("file_system_id")?;
            let backup_policy = input.get_string("backup_policy")?;
    ...
    async fn delete_backup_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.efs_client
    ...
    async fn read_replication_configurations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.efs_client
    ...
    async fn delete_replication_configurations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.efs_client
    ...
    async fn create_file_system_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let policy = input.get_string("policy")?;
            let file_system_id = input.get_string("file_system_id")?;
            let bypass_policy_lockout_safety_check =
                input.get_optional_string("bypass_policy_lockout_safety_check")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    bypass_policy_lockout_safety_check.unwrap_or_default(),
                ))
        })
    }

    /// Read a file_system_policy resource
    async fn read_file_system_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.efs_client
    ...
    async fn delete_file_system_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.efs_client
    ...
    async fn read_mount_target_security_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.efs_client
    ...
    async fn delete_mount_target_security_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.efs_client
    ...
    async fn create_file_system(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let provisioned_throughput_in_mibps =
                input.get_optional_string("provisioned_throughput_in_mibps")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    availability_zone_name.unwrap_or_default(),
                )
                .with_field("encrypted", encrypted.unwrap_or_default())
                .with_field(
                    "provisioned_throughput_in_mibps",
                    provisioned_throughput_in_mibps.unwrap_or_default(),
                )
    ...
    async fn create_file_system_protection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let file_system_id = input.get_string("file_system_id")?;
            let replication_overwrite_protection =
                input.get_optional_string("replication_overwrite_protection")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    replication_overwrite_protection.unwrap_or_default(),
                ))
        })
    }

    /// Read a file_system_protection resource
    async fn read_file_system_protection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.efs_client
    ...
    async fn delete_file_system_protection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.efs_client
    ...
    async fn create_lifecycle_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let file_system_id = input.get_string("file_system_id")?;
    ...
    async fn read_lifecycle_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.efs_client
    ...
    async fn delete_lifecycle_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.efs_client
    ...
    async fn create_mount_targets(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_mount_targets(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.efs_client
    ...
    async fn update_mount_targets(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_mount_targets(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.efs_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    source_file_system_id.unwrap_or_default(),
                )
