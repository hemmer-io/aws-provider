...
impl<'a> Signing_profile<'a> {
    ...
    pub async fn create(&self, signature_validity_period: Option<String>, overrides: Option<String>, platform_id: String, signing_parameters: Option<HashMap<String, String>>, tags: Option<HashMap<String, String>>, profile_name: String, signing_material: Option<String>) -> Result<String> {
