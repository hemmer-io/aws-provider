...
impl<'a> SignerService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "signing_job" => self.plan_signing_job(current_state, desired_input).await,
            "revocation_status" => {
                self.plan_revocation_status(current_state, desired_input)
                    .await
            }
            "signing_platform" => {
                self.plan_signing_platform(current_state, desired_input)
                    .await
            }
            "signing_profile" => {
                self.plan_signing_profile(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "signing_job" => self.create_signing_job(input).await,
            "revocation_status" => self.create_revocation_status(input).await,
            "signing_platform" => self.create_signing_platform(input).await,
            "signing_profile" => self.create_signing_profile(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "signer", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "signing_job" => self.read_signing_job(id).await,
            "revocation_status" => self.read_revocation_status(id).await,
            "signing_platform" => self.read_signing_platform(id).await,
            "signing_profile" => self.read_signing_profile(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "signer", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "signing_job" => self.update_signing_job(id, input).await,
            "revocation_status" => self.update_revocation_status(id, input).await,
            "signing_platform" => self.update_signing_platform(id, input).await,
            "signing_profile" => self.update_signing_profile(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "signer", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "signing_job" => self.delete_signing_job(id).await,
            "revocation_status" => self.delete_revocation_status(id).await,
            "signing_platform" => self.delete_signing_platform(id).await,
            "signing_profile" => self.delete_signing_profile(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "signer", resource_name
            ))),
    ...
    async fn create_signing_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_signing_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_signing_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_signing_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_revocation_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_revocation_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.signer_client
    ...
    async fn delete_revocation_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.signer_client
    ...
    async fn create_signing_platform(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_signing_platform(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.signer_client
    ...
    async fn delete_signing_platform(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.signer_client
    ...
    async fn create_signing_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let signature_validity_period =
                input.get_optional_string("signature_validity_period")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    signature_validity_period.unwrap_or_default(),
                )
    ...
    async fn read_signing_profile(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.signer_client
    ...
    async fn delete_signing_profile(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.signer_client
