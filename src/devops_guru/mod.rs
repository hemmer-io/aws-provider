...
impl<'a> Devops_guruService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "organization_health" => {
                self.plan_organization_health(current_state, desired_input)
                    .await
            }
            "insight" => self.plan_insight(current_state, desired_input).await,
            "event_sources_config" => {
                self.plan_event_sources_config(current_state, desired_input)
                    .await
            }
            "account_health" => self.plan_account_health(current_state, desired_input).await,
            "organization_resource_collection_health" => {
                self.plan_organization_resource_collection_health(current_state, desired_input)
                    .await
            }
            "service_integration" => {
                self.plan_service_integration(current_state, desired_input)
                    .await
            }
            "account_overview" => {
                self.plan_account_overview(current_state, desired_input)
                    .await
            }
            "feedback" => self.plan_feedback(current_state, desired_input).await,
            "resource_collection_health" => {
                self.plan_resource_collection_health(current_state, desired_input)
                    .await
            }
            "organization_overview" => {
                self.plan_organization_overview(current_state, desired_input)
                    .await
            }
            "anomaly" => self.plan_anomaly(current_state, desired_input).await,
            "resource_collection" => {
                self.plan_resource_collection(current_state, desired_input)
                    .await
            }
            "cost_estimation" => {
                self.plan_cost_estimation(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "devops_guru", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "organization_health" => self.create_organization_health(input).await,
            "insight" => self.create_insight(input).await,
            "event_sources_config" => self.create_event_sources_config(input).await,
            "account_health" => self.create_account_health(input).await,
            "organization_resource_collection_health" => {
                self.create_organization_resource_collection_health(input)
                    .await
            }
            "service_integration" => self.create_service_integration(input).await,
            "account_overview" => self.create_account_overview(input).await,
            "feedback" => self.create_feedback(input).await,
            "resource_collection_health" => self.create_resource_collection_health(input).await,
            "organization_overview" => self.create_organization_overview(input).await,
            "anomaly" => self.create_anomaly(input).await,
            "resource_collection" => self.create_resource_collection(input).await,
            "cost_estimation" => self.create_cost_estimation(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "devops_guru", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "organization_health" => self.read_organization_health(id).await,
            "insight" => self.read_insight(id).await,
            "event_sources_config" => self.read_event_sources_config(id).await,
            "account_health" => self.read_account_health(id).await,
            "organization_resource_collection_health" => {
                self.read_organization_resource_collection_health(id).await
            }
            "service_integration" => self.read_service_integration(id).await,
            "account_overview" => self.read_account_overview(id).await,
            "feedback" => self.read_feedback(id).await,
            "resource_collection_health" => self.read_resource_collection_health(id).await,
            "organization_overview" => self.read_organization_overview(id).await,
            "anomaly" => self.read_anomaly(id).await,
            "resource_collection" => self.read_resource_collection(id).await,
            "cost_estimation" => self.read_cost_estimation(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "devops_guru", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "organization_health" => self.update_organization_health(id, input).await,
            "insight" => self.update_insight(id, input).await,
            "event_sources_config" => self.update_event_sources_config(id, input).await,
            "account_health" => self.update_account_health(id, input).await,
            "organization_resource_collection_health" => {
                self.update_organization_resource_collection_health(id, input)
                    .await
            }
            "service_integration" => self.update_service_integration(id, input).await,
            "account_overview" => self.update_account_overview(id, input).await,
            "feedback" => self.update_feedback(id, input).await,
            "resource_collection_health" => self.update_resource_collection_health(id, input).await,
            "organization_overview" => self.update_organization_overview(id, input).await,
            "anomaly" => self.update_anomaly(id, input).await,
            "resource_collection" => self.update_resource_collection(id, input).await,
            "cost_estimation" => self.update_cost_estimation(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "devops_guru", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "organization_health" => self.delete_organization_health(id).await,
            "insight" => self.delete_insight(id).await,
            "event_sources_config" => self.delete_event_sources_config(id).await,
            "account_health" => self.delete_account_health(id).await,
            "organization_resource_collection_health" => {
                self.delete_organization_resource_collection_health(id)
                    .await
            }
            "service_integration" => self.delete_service_integration(id).await,
            "account_overview" => self.delete_account_overview(id).await,
            "feedback" => self.delete_feedback(id).await,
            "resource_collection_health" => self.delete_resource_collection_health(id).await,
            "organization_overview" => self.delete_organization_overview(id).await,
            "anomaly" => self.delete_anomaly(id).await,
            "resource_collection" => self.delete_resource_collection(id).await,
            "cost_estimation" => self.delete_cost_estimation(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "devops_guru", resource_name
            ))),
    ...
    async fn create_organization_health(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_organization_health(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_organization_health(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_event_sources_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_event_sources_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.devops_guru_client
    ...
    async fn delete_event_sources_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.devops_guru_client
    ...
    async fn create_account_health(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_account_health(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.devops_guru_client
    ...
    async fn delete_account_health(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.devops_guru_client
    ...
    async fn delete_organization_resource_collection_health(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.devops_guru_client
    ...
    async fn create_service_integration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "service_integration",
                service_integration.unwrap_or_default(),
            ))
        })
    }

    /// Read a service_integration resource
    async fn read_service_integration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.devops_guru_client
    ...
    async fn delete_service_integration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.devops_guru_client
    ...
    async fn create_account_overview(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_account_overview(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.devops_guru_client
    ...
    async fn delete_account_overview(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.devops_guru_client
    ...
    async fn read_resource_collection_health(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.devops_guru_client
    ...
    async fn delete_resource_collection_health(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.devops_guru_client
    ...
    async fn create_organization_overview(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_organization_overview(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.devops_guru_client
    ...
    async fn delete_organization_overview(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.devops_guru_client
    ...
    async fn create_resource_collection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "resource_collection",
                    resource_collection.unwrap_or_default(),
                )
    ...
    async fn read_resource_collection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.devops_guru_client
    ...
    async fn delete_resource_collection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.devops_guru_client
    ...
    async fn create_cost_estimation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cost_estimation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.devops_guru_client
    ...
    async fn delete_cost_estimation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.devops_guru_client
