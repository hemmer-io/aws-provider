...
impl<'a> Auto_scaling_configuration<'a> {
    ...
    pub async fn create(&self, auto_scaling_configuration_name: String, min_size: Option<i64>, max_size: Option<i64>, max_concurrency: Option<i64>, tags: Option<Vec<String>>) -> Result<String> {
