...
impl<'a> Virtual_cluster<'a> {
    ...
    pub async fn create(&self, security_configuration_id: Option<String>, container_provider: String, tags: Option<HashMap<String, String>>, client_token: String, name: String) -> Result<String> {
