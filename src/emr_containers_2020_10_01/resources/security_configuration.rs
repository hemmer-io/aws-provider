...
impl<'a> Security_configuration<'a> {
    ...
    pub async fn create(&self, security_configuration_data: String, name: String, container_provider: Option<String>, tags: Option<HashMap<String, String>>, client_token: String) -> Result<String> {
