...
impl<'a> Job_template<'a> {
    ...
    pub async fn create(&self, job_template_data: String, kms_key_arn: Option<String>, tags: Option<HashMap<String, String>>, name: String, client_token: String) -> Result<String> {
