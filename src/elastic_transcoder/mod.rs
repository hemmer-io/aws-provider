...
impl<'a> Elastic_transcoderService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "pipeline_notifications" => {
                self.plan_pipeline_notifications(current_state, desired_input)
                    .await
            }
            "pipeline_status" => {
                self.plan_pipeline_status(current_state, desired_input)
                    .await
            }
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "elastic_transcoder", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "pipeline_notifications" => self.create_pipeline_notifications(input).await,
            "pipeline_status" => self.create_pipeline_status(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "pipeline_notifications" => self.read_pipeline_notifications(id).await,
            "pipeline_status" => self.read_pipeline_status(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "pipeline_notifications" => self.update_pipeline_notifications(id, input).await,
            "pipeline_status" => self.update_pipeline_status(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "pipeline_notifications" => self.delete_pipeline_notifications(id).await,
            "pipeline_status" => self.delete_pipeline_status(id).await,
    ...
    async fn create_pipeline_notifications(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_pipeline_notifications(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elastic_transcoder_client
    ...
    async fn delete_pipeline_notifications(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elastic_transcoder_client
    ...
    async fn create_pipeline_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_pipeline_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elastic_transcoder_client
    ...
    async fn delete_pipeline_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elastic_transcoder_client
