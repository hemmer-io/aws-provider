...
impl<'a> Protect_configuration_country_rule_set<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, number_capability: Option<String>, protect_configuration_id: Option<String>, country_rule_set_updates: Option<HashMap<String, String>>) -> Result<()> {
