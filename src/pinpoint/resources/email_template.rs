...
impl<'a> Email_template<'a> {
    ...
    pub async fn create(&self, template_name: String, email_template_request: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, template_name: Option<String>, email_template_request: Option<String>) -> Result<()> {
