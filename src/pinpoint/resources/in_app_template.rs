...
impl<'a> In_app_template<'a> {
    ...
    pub async fn create(&self, in_app_template_request: String, template_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, in_app_template_request: Option<String>, template_name: Option<String>) -> Result<()> {
