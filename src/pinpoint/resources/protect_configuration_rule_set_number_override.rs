...
impl<'a> Protect_configuration_rule_set_number_override<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, destination_phone_number: String, action: String, protect_configuration_id: String, expiration_timestamp: Option<String>) -> Result<String> {
