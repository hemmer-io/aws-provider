...
impl<'a> Sms_template<'a> {
    ...
    pub async fn create(&self, template_name: String, sms_template_request: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, template_name: Option<String>, sms_template_request: Option<String>) -> Result<()> {
