...
impl<'a> Domain_name<'a> {
    ...
    pub async fn create(&self, certificate_arn: String, tags: Option<HashMap<String, String>>, domain_name: String, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, certificate_arn: Option<String>, tags: Option<HashMap<String, String>>, domain_name: Option<String>, description: Option<String>) -> Result<()> {
