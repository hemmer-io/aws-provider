...
impl<'a> Domain_name<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, certificate_arn: String, description: Option<String>, domain_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, certificate_arn: Option<String>, description: Option<String>, domain_name: Option<String>) -> Result<()> {
