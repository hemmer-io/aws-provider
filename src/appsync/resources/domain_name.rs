...
impl<'a> Domain_name<'a> {
    ...
    pub async fn create(&self, description: Option<String>, domain_name: String, certificate_arn: String, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, domain_name: Option<String>, certificate_arn: Option<String>, tags: Option<HashMap<String, String>>) -> Result<()> {
