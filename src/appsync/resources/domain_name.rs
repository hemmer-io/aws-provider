...
impl<'a> Domain_name<'a> {
    ...
    pub async fn create(&self, domain_name: String, certificate_arn: String, tags: Option<HashMap<String, String>>, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, domain_name: Option<String>, certificate_arn: Option<String>, tags: Option<HashMap<String, String>>, description: Option<String>) -> Result<()> {
