...
impl<'a> Source_api_association<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, association_id: Option<String>, merged_api_identifier: Option<String>, source_api_association_config: Option<String>) -> Result<()> {
