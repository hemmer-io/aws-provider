...
impl<'a> AppsyncService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "resolver" => self.plan_resolver(current_state, desired_input).await,
            "api_key" => self.plan_api_key(current_state, desired_input).await,
            "schema_creation_status" => {
                self.plan_schema_creation_status(current_state, desired_input)
                    .await
            }
            "channel_namespace" => {
                self.plan_channel_namespace(current_state, desired_input)
                    .await
            }
            ...
            "graphql_api_environment_variables" => {
                self.plan_graphql_api_environment_variables(current_state, desired_input)
                    .await
            }
            "introspection_schema" => {
                self.plan_introspection_schema(current_state, desired_input)
                    .await
            }
            "source_api_association" => {
                self.plan_source_api_association(current_state, desired_input)
                    .await
            }
            "graphql_api" => self.plan_graphql_api(current_state, desired_input).await,
            "data_source_introspection" => {
                self.plan_data_source_introspection(current_state, desired_input)
                    .await
            }
            "api_cache" => self.plan_api_cache(current_state, desired_input).await,
            "api_association" => {
                self.plan_api_association(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "resolver" => self.create_resolver(input).await,
            "api_key" => self.create_api_key(input).await,
            "schema_creation_status" => self.create_schema_creation_status(input).await,
            "channel_namespace" => self.create_channel_namespace(input).await,
            ...
            "introspection_schema" => self.create_introspection_schema(input).await,
            "source_api_association" => self.create_source_api_association(input).await,
            "graphql_api" => self.create_graphql_api(input).await,
            "data_source_introspection" => self.create_data_source_introspection(input).await,
            "api_cache" => self.create_api_cache(input).await,
            "api_association" => self.create_api_association(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "resolver" => self.read_resolver(id).await,
            "api_key" => self.read_api_key(id).await,
            "schema_creation_status" => self.read_schema_creation_status(id).await,
            "channel_namespace" => self.read_channel_namespace(id).await,
            ...
            "introspection_schema" => self.read_introspection_schema(id).await,
            "source_api_association" => self.read_source_api_association(id).await,
            "graphql_api" => self.read_graphql_api(id).await,
            "data_source_introspection" => self.read_data_source_introspection(id).await,
            "api_cache" => self.read_api_cache(id).await,
            "api_association" => self.read_api_association(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "resolver" => self.update_resolver(id, input).await,
            "api_key" => self.update_api_key(id, input).await,
            "schema_creation_status" => self.update_schema_creation_status(id, input).await,
            "channel_namespace" => self.update_channel_namespace(id, input).await,
            "data_source" => self.update_data_source(id, input).await,
            "function" => self.update_function(id, input).await,
            "graphql_api_environment_variables" => {
                self.update_graphql_api_environment_variables(id, input)
                    .await
            }
            "introspection_schema" => self.update_introspection_schema(id, input).await,
            "source_api_association" => self.update_source_api_association(id, input).await,
            "graphql_api" => self.update_graphql_api(id, input).await,
            "data_source_introspection" => self.update_data_source_introspection(id, input).await,
            "api_cache" => self.update_api_cache(id, input).await,
            "api_association" => self.update_api_association(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "resolver" => self.delete_resolver(id).await,
            "api_key" => self.delete_api_key(id).await,
            "schema_creation_status" => self.delete_schema_creation_status(id).await,
            "channel_namespace" => self.delete_channel_namespace(id).await,
            ...
            "introspection_schema" => self.delete_introspection_schema(id).await,
            "source_api_association" => self.delete_source_api_association(id).await,
            "graphql_api" => self.delete_graphql_api(id).await,
            "data_source_introspection" => self.delete_data_source_introspection(id).await,
            "api_cache" => self.delete_api_cache(id).await,
            "api_association" => self.delete_api_association(id).await,
    ...
    async fn create_resolver(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let response_mapping_template =
                input.get_optional_string("response_mapping_template")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    request_mapping_template.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    response_mapping_template.unwrap_or_default(),
                )
    ...
    async fn read_resolver(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appsync_client
    ...
    async fn update_resolver(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let field_name = input.get_string("field_name")?;
            let request_mapping_template = input.get_optional_string("request_mapping_template")?;
    ...
    async fn delete_resolver(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appsync_client
    ...
    async fn create_schema_creation_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_schema_creation_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appsync_client
    ...
    async fn delete_schema_creation_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appsync_client
    ...
    async fn create_channel_namespace(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    subscribe_auth_modes.unwrap_or_default(),
                )
    ...
    async fn read_channel_namespace(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appsync_client
    ...
    async fn delete_channel_namespace(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appsync_client
    ...
    async fn create_data_source(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let open_search_service_config =
                input.get_optional_string("open_search_service_config")?;
            let relational_database_config =
                input.get_optional_string("relational_database_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "event_bridge_config",
                    event_bridge_config.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    elasticsearch_config.unwrap_or_default(),
                )
                .with_field("type", r#type.unwrap_or_default())
                .with_field(
                    "open_search_service_config",
                    open_search_service_config.unwrap_or_default(),
                )
                .with_field(
                    "relational_database_config",
                    relational_database_config.unwrap_or_default(),
                )
    ...
    async fn read_graphql_api_environment_variables(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appsync_client
    ...
    async fn delete_graphql_api_environment_variables(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appsync_client
    ...
    async fn create_introspection_schema(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_introspection_schema(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appsync_client
    ...
    async fn delete_introspection_schema(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appsync_client
    ...
    async fn create_source_api_association(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let association_id = input.get_string("association_id")?;
            let description = input.get_optional_string("description")?;
            let source_api_association_config =
                input.get_optional_string("source_api_association_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    source_api_association_config.unwrap_or_default(),
                )
                .with_field(
                    "merged_api_identifier",
                    merged_api_identifier.unwrap_or_default(),
                ))
        })
    }

    /// Read a source_api_association resource
    async fn read_source_api_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appsync_client
    ...
    async fn delete_source_api_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appsync_client
    ...
    async fn create_graphql_api(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let merged_api_execution_role_arn =
                input.get_optional_string("merged_api_execution_role_arn")?;
            ...
            let additional_authentication_providers =
                input.get_optional_string("additional_authentication_providers")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    merged_api_execution_role_arn.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    enhanced_metrics_config.unwrap_or_default(),
                )
                .with_field("owner_contact", owner_contact.unwrap_or_default())
                .with_field(
                    "lambda_authorizer_config",
                    lambda_authorizer_config.unwrap_or_default(),
                )
                .with_field(
                    "additional_authentication_providers",
                    additional_authentication_providers.unwrap_or_default(),
                )
                .with_field(
                    "authentication_type",
    ...
    async fn read_graphql_api(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appsync_client
    ...
    async fn update_graphql_api(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let merged_api_execution_role_arn =
                input.get_optional_string("merged_api_execution_role_arn")?;
    ...
    async fn delete_graphql_api(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appsync_client
    ...
    async fn read_data_source_introspection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appsync_client
    ...
    async fn delete_data_source_introspection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appsync_client
    ...
    async fn create_api_cache(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    api_caching_behavior.unwrap_or_default(),
                )
                .with_field("api_id", api_id.unwrap_or_default())
                .with_field("type", r#type.unwrap_or_default())
                ...
                .with_field(
                    ...
                    health_metrics_config.unwrap_or_default(),
                )
                .with_field(
    ...
    async fn read_api_cache(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appsync_client
    ...
    async fn update_api_cache(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let api_caching_behavior = input.get_string("api_caching_behavior")?;
            let api_id = input.get_string("api_id")?;
    ...
    async fn delete_api_cache(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appsync_client
    ...
    async fn create_api_association(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_api_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.appsync_client
    ...
    async fn delete_api_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.appsync_client
