...
impl<'a> AmplifyService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "artifact_url" => {
                self.plan_artifact_url(current_state, desired_input).await
            }
            "app" => {
            ...
            "backend_environment" => {
                self.plan_backend_environment(current_state, desired_input).await
            }
            "branch" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "artifact_url" => {
                self.create_artifact_url(input).await
            }
            "app" => {
            ...
            "backend_environment" => {
                self.create_backend_environment(input).await
            }
            "branch" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "artifact_url" => {
                self.read_artifact_url(id).await
            }
            "app" => {
            ...
            "backend_environment" => {
                self.read_backend_environment(id).await
            }
            "branch" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "artifact_url" => {
                self.update_artifact_url(id, input).await
            }
            "app" => {
            ...
            "backend_environment" => {
                self.update_backend_environment(id, input).await
            }
            "branch" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "artifact_url" => {
                self.delete_artifact_url(id).await
            }
            "app" => {
            ...
            "backend_environment" => {
                self.delete_backend_environment(id).await
            }
            "branch" => {
    ...
    async fn create_app(
        ...
        self.provider.runtime().block_on(async {
            ...
            let auto_branch_creation_config = input.get_optional_string("auto_branch_creation_config")?;
            let auto_branch_creation_patterns = input.get_optional_string("auto_branch_creation_patterns")?;
            let custom_headers = input.get_optional_string("custom_headers")?;
            let enable_auto_branch_creation = input.get_optional_string("enable_auto_branch_creation")?;
            ...
            let enable_branch_auto_deletion = input.get_optional_string("enable_branch_auto_deletion")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("basic_auth_credentials", basic_auth_credentials.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field("enable_branch_auto_build", enable_branch_auto_build.unwrap_or_default())
                .with_field("custom_rules", custom_rules.unwrap_or_default())
                .with_field("build_spec", build_spec.unwrap_or_default())
                .with_field("auto_branch_creation_config", auto_branch_creation_config.unwrap_or_default())
                .with_field("auto_branch_creation_patterns", auto_branch_creation_patterns.unwrap_or_default())
                .with_field("custom_headers", custom_headers.unwrap_or_default())
                .with_field("enable_auto_branch_creation", enable_auto_branch_creation.unwrap_or_default())
                ...
                .with_field("enable_branch_auto_deletion", enable_branch_auto_deletion.unwrap_or_default())
                .with_field("cache_config", cache_config.unwrap_or_default())
                .with_field("job_config", job_config.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                .with_field("iam_service_role_arn", iam_service_role_arn.unwrap_or_default())
    ...
    async fn create_domain_association(
        ...
        self.provider.runtime().block_on(async {
            ...
            let auto_sub_domain_creation_patterns = input.get_optional_string("auto_sub_domain_creation_patterns")?;
            let app_id = input.get_string("app_id")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("sub_domain_settings", sub_domain_settings.unwrap_or_default())
                .with_field("auto_sub_domain_iam_role", auto_sub_domain_iam_role.unwrap_or_default())
                .with_field("auto_sub_domain_creation_patterns", auto_sub_domain_creation_patterns.unwrap_or_default())
                .with_field("app_id", app_id.unwrap_or_default())
                .with_field("domain_name", domain_name.unwrap_or_default())
                .with_field("certificate_settings", certificate_settings.unwrap_or_default())
                .with_field("enable_auto_sub_domain", enable_auto_sub_domain.unwrap_or_default())
            )
        })
    }
    ...
    async fn create_backend_environment(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("deployment_artifacts", deployment_artifacts.unwrap_or_default())
    ...
    async fn read_backend_environment(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_branch(
        ...
        self.provider.runtime().block_on(async {
            ...
            let enable_basic_auth = input.get_optional_string("enable_basic_auth")?;
            let tags = input.get_optional_string("tags")?;
            let enable_pull_request_preview = input.get_optional_string("enable_pull_request_preview")?;
            let description = input.get_optional_string("description")?;
            let environment_variables = input.get_optional_string("environment_variables")?;
            let pull_request_environment_name = input.get_optional_string("pull_request_environment_name")?;
            let app_id = input.get_string("app_id")?;
            let build_spec = input.get_optional_string("build_spec")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("branch_name", branch_name.unwrap_or_default())
                .with_field("basic_auth_credentials", basic_auth_credentials.unwrap_or_default())
                .with_field("backend_environment_arn", backend_environment_arn.unwrap_or_default())
                .with_field("compute_role_arn", compute_role_arn.unwrap_or_default())
                .with_field("enable_auto_build", enable_auto_build.unwrap_or_default())
                .with_field("backend", backend.unwrap_or_default())
                .with_field("enable_basic_auth", enable_basic_auth.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("enable_pull_request_preview", enable_pull_request_preview.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field("environment_variables", environment_variables.unwrap_or_default())
                .with_field("pull_request_environment_name", pull_request_environment_name.unwrap_or_default())
                .with_field("app_id", app_id.unwrap_or_default())
                .with_field("build_spec", build_spec.unwrap_or_default())
                .with_field("enable_skew_protection", enable_skew_protection.unwrap_or_default())
                ...
                .with_field("enable_performance_mode", enable_performance_mode.unwrap_or_default())
                .with_field("stage", stage.unwrap_or_default())
                .with_field("enable_notification", enable_notification.unwrap_or_default())
            )
        })
    }
