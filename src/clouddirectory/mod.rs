...
impl<'a> ClouddirectoryService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "object_information" => {
                self.plan_object_information(current_state, desired_input)
                    .await
            }
            "object" => self.plan_object(current_state, desired_input).await,
            "link_attributes" => {
                self.plan_link_attributes(current_state, desired_input)
                    .await
            }
            "facet" => self.plan_facet(current_state, desired_input).await,
            "applied_schema_version" => {
                self.plan_applied_schema_version(current_state, desired_input)
                    .await
            }
            "object_attributes" => {
            ...
            "schema_from_json" => {
                self.plan_schema_from_json(current_state, desired_input)
                    .await
            }
            "schema_as_json" => self.plan_schema_as_json(current_state, desired_input).await,
            "directory" => self.plan_directory(current_state, desired_input).await,
            "typed_link_facet_information" => {
                self.plan_typed_link_facet_information(current_state, desired_input)
                    .await
            }
            "typed_link_facet" => {
                self.plan_typed_link_facet(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "clouddirectory", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "object_information" => self.create_object_information(input).await,
            "object" => self.create_object(input).await,
            "link_attributes" => self.create_link_attributes(input).await,
            "facet" => self.create_facet(input).await,
            "applied_schema_version" => self.create_applied_schema_version(input).await,
            "object_attributes" => self.create_object_attributes(input).await,
            "schema_from_json" => self.create_schema_from_json(input).await,
            "schema_as_json" => self.create_schema_as_json(input).await,
            "directory" => self.create_directory(input).await,
            "typed_link_facet_information" => self.create_typed_link_facet_information(input).await,
            "typed_link_facet" => self.create_typed_link_facet(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "clouddirectory", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "object_information" => self.read_object_information(id).await,
            "object" => self.read_object(id).await,
            "link_attributes" => self.read_link_attributes(id).await,
            "facet" => self.read_facet(id).await,
            "applied_schema_version" => self.read_applied_schema_version(id).await,
            "object_attributes" => self.read_object_attributes(id).await,
            "schema_from_json" => self.read_schema_from_json(id).await,
            "schema_as_json" => self.read_schema_as_json(id).await,
            "directory" => self.read_directory(id).await,
            "typed_link_facet_information" => self.read_typed_link_facet_information(id).await,
            "typed_link_facet" => self.read_typed_link_facet(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "clouddirectory", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "object_information" => self.update_object_information(id, input).await,
            "object" => self.update_object(id, input).await,
            "link_attributes" => self.update_link_attributes(id, input).await,
            "facet" => self.update_facet(id, input).await,
            "applied_schema_version" => self.update_applied_schema_version(id, input).await,
            "object_attributes" => self.update_object_attributes(id, input).await,
            "schema_from_json" => self.update_schema_from_json(id, input).await,
            "schema_as_json" => self.update_schema_as_json(id, input).await,
            "directory" => self.update_directory(id, input).await,
            "typed_link_facet_information" => {
                self.update_typed_link_facet_information(id, input).await
            }
            "typed_link_facet" => self.update_typed_link_facet(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "clouddirectory", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "object_information" => self.delete_object_information(id).await,
            "object" => self.delete_object(id).await,
            "link_attributes" => self.delete_link_attributes(id).await,
            "facet" => self.delete_facet(id).await,
            "applied_schema_version" => self.delete_applied_schema_version(id).await,
            "object_attributes" => self.delete_object_attributes(id).await,
            "schema_from_json" => self.delete_schema_from_json(id).await,
            "schema_as_json" => self.delete_schema_as_json(id).await,
            "directory" => self.delete_directory(id).await,
            "typed_link_facet_information" => self.delete_typed_link_facet_information(id).await,
            "typed_link_facet" => self.delete_typed_link_facet(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "clouddirectory", resource_name
            ))),
    ...
    async fn create_index(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let ordered_indexed_attribute_list =
                input.get_string("ordered_indexed_attribute_list")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    ordered_indexed_attribute_list.unwrap_or_default(),
                )
    ...
    async fn create_object_information(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_object_information(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.clouddirectory_client
    ...
    async fn delete_object_information(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.clouddirectory_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    object_attribute_list.unwrap_or_default(),
                )
                .with_field("parent_reference", parent_reference.unwrap_or_default())
    ...
    async fn create_link_attributes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    typed_link_specifier.unwrap_or_default(),
                ))
        })
    }

    /// Read a link_attributes resource
    async fn read_link_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.clouddirectory_client
    ...
    async fn delete_link_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.clouddirectory_client
    ...
    async fn create_facet(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_facet(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.clouddirectory_client
    ...
    async fn update_facet(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let object_type = input.get_optional_string("object_type")?;
            let attributes = input.get_optional_string("attributes")?;
    ...
    async fn delete_facet(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.clouddirectory_client
    ...
    async fn create_applied_schema_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_applied_schema_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.clouddirectory_client
    ...
    async fn delete_applied_schema_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.clouddirectory_client
    ...
    async fn create_schema_from_json(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let schema_arn = input.get_string("schema_arn")?;
    ...
    async fn read_schema_from_json(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.clouddirectory_client
    ...
    async fn delete_schema_from_json(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.clouddirectory_client
    ...
    async fn create_schema_as_json(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_schema_as_json(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.clouddirectory_client
    ...
    async fn delete_schema_as_json(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.clouddirectory_client
    ...
    async fn read_typed_link_facet_information(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.clouddirectory_client
    ...
    async fn delete_typed_link_facet_information(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.clouddirectory_client
    ...
    async fn create_typed_link_facet(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let schema_arn = input.get_string("schema_arn")?;
    ...
    async fn read_typed_link_facet(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.clouddirectory_client
    ...
    async fn delete_typed_link_facet(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.clouddirectory_client
