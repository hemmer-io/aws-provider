//! Device_farm_2015_06_23 Service
//!
//! Auto-generated service module for device_farm_2015_06_23

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for device_farm_2015_06_23
pub struct Device_farm_2015_06_23Service<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Device_farm_2015_06_23Service<'a> {
    ...
    /// Get vpce_configuration resource handler
    pub fn vpce_configuration(&self) -> resources::Vpce_configuration<'_> {
        resources::Vpce_configuration::new(self.provider)
    }
