...
impl<'a> Device_pool<'a> {
    ...
    pub async fn create(&self, rules: Vec<String>, description: Option<String>, max_devices: Option<i64>, project_arn: String, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, rules: Option<Vec<String>>, description: Option<String>, max_devices: Option<i64>, project_arn: Option<String>, name: Option<String>) -> Result<()> {
