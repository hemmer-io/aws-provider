...
impl<'a> Registration_field_value<'a> {
    ...
    pub async fn create(&self, registration_attachment_id: Option<String>, registration_id: String, field_path: String, text_value: Option<String>, select_choices: Option<Vec<String>>) -> Result<String> {
