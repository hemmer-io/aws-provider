...
impl<'a> Registration_field_value<'a> {
    ...
    pub async fn create(&self, select_choices: Option<Vec<String>>, registration_id: String, text_value: Option<String>, registration_attachment_id: Option<String>, field_path: String) -> Result<String> {
