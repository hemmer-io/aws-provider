...
impl<'a> Protect_configuration<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, deletion_protection_enabled: Option<bool>, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, deletion_protection_enabled: Option<bool>, client_token: Option<String>) -> Result<()> {
