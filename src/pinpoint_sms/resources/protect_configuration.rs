...
impl<'a> Protect_configuration<'a> {
    ...
    pub async fn create(&self, deletion_protection_enabled: Option<bool>, client_token: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, deletion_protection_enabled: Option<bool>, client_token: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
