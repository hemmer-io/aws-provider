...
impl<'a> Configuration_set_event_destination<'a> {
    ...
    pub async fn create(&self, configuration_set_name: String, event_destination: Option<String>, event_destination_name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, configuration_set_name: Option<String>, event_destination: Option<String>, event_destination_name: Option<String>) -> Result<()> {
