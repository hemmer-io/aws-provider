...
impl<'a> Configuration_set_event_destination<'a> {
    ...
    pub async fn create(&self, event_destination_name: Option<String>, configuration_set_name: String, event_destination: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, event_destination_name: Option<String>, configuration_set_name: Option<String>, event_destination: Option<String>) -> Result<()> {
