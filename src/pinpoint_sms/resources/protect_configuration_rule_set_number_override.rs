...
impl<'a> Protect_configuration_rule_set_number_override<'a> {
    ...
    pub async fn create(&self, destination_phone_number: String, expiration_timestamp: Option<String>, protect_configuration_id: String, action: String, client_token: Option<String>) -> Result<String> {
