...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, subscription_name: String, sns_topic_arn: String, source_type: Option<String>, source_ids: Option<Vec<String>>, tags: Option<Vec<String>>, event_categories: Option<Vec<String>>, enabled: Option<bool>) -> Result<String> {
