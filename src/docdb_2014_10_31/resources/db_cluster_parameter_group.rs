...
impl<'a> Db_cluster_parameter_group<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, db_parameter_group_family: String, description: String, db_cluster_parameter_group_name: String) -> Result<String> {
