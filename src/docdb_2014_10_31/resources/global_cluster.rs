...
impl<'a> Global_cluster<'a> {
    ...
    pub async fn create(&self, global_cluster_identifier: String, engine_version: Option<String>, deletion_protection: Option<bool>, engine: Option<String>, storage_encrypted: Option<bool>, source_db_cluster_identifier: Option<String>, database_name: Option<String>) -> Result<String> {
