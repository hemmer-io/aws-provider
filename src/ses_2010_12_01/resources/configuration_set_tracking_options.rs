...
impl<'a> Configuration_set_tracking_options<'a> {
    ...
    pub async fn create(&self, tracking_options: String, configuration_set_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tracking_options: Option<String>, configuration_set_name: Option<String>) -> Result<()> {
