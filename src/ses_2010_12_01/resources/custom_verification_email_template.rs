...
impl<'a> Custom_verification_email_template<'a> {
    ...
    pub async fn create(&self, failure_redirection_url: String, from_email_address: String, template_subject: String, success_redirection_url: String, template_content: String, template_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, failure_redirection_url: Option<String>, from_email_address: Option<String>, template_subject: Option<String>, success_redirection_url: Option<String>, template_content: Option<String>, template_name: Option<String>) -> Result<()> {
