...
impl<'a> Configuration_set_event_destination<'a> {
    ...
    pub async fn create(&self, event_destination: String, configuration_set_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, event_destination: Option<String>, configuration_set_name: Option<String>) -> Result<()> {
