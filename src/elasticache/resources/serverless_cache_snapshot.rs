...
impl<'a> Serverless_cache_snapshot<'a> {
    ...
    pub async fn create(&self, serverless_cache_snapshot_name: String, serverless_cache_name: String, tags: Option<Vec<String>>, kms_key_id: Option<String>) -> Result<String> {
