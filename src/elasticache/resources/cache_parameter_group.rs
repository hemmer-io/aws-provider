...
impl<'a> Cache_parameter_group<'a> {
    ...
    pub async fn create(&self, cache_parameter_group_name: String, description: String, cache_parameter_group_family: String, tags: Option<Vec<String>>) -> Result<String> {
