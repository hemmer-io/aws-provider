...
impl<'a> ElasticacheService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "cache_parameter_group" => {
                self.plan_cache_parameter_group(current_state, desired_input)
                    .await
            }
            "serverless_caches" => {
                self.plan_serverless_caches(current_state, desired_input)
                    .await
            }
            "snapshots" => self.plan_snapshots(current_state, desired_input).await,
            "update_actions" => self.plan_update_actions(current_state, desired_input).await,
            "cache_subnet_groups" => {
                self.plan_cache_subnet_groups(current_state, desired_input)
                    .await
            }
            "snapshot" => self.plan_snapshot(current_state, desired_input).await,
            "cache_security_groups" => {
                self.plan_cache_security_groups(current_state, desired_input)
                    .await
            }
            "service_updates" => {
                self.plan_service_updates(current_state, desired_input)
                    .await
            }
            "cache_parameters" => {
                self.plan_cache_parameters(current_state, desired_input)
                    .await
            }
            "serverless_cache" => {
                self.plan_serverless_cache(current_state, desired_input)
                    .await
            }
            "reserved_cache_nodes" => {
                self.plan_reserved_cache_nodes(current_state, desired_input)
                    .await
            }
            "cache_subnet_group" => {
                self.plan_cache_subnet_group(current_state, desired_input)
                    .await
            }
            "cache_engine_versions" => {
                self.plan_cache_engine_versions(current_state, desired_input)
                    .await
            }
            "replication_groups" => {
                self.plan_replication_groups(current_state, desired_input)
                    .await
            }
            "serverless_cache_snapshots" => {
                self.plan_serverless_cache_snapshots(current_state, desired_input)
                    .await
            }
            "global_replication_group" => {
                self.plan_global_replication_group(current_state, desired_input)
                    .await
            }
            "cache_parameter_groups" => {
                self.plan_cache_parameter_groups(current_state, desired_input)
                    .await
            }
            "cache_clusters" => self.plan_cache_clusters(current_state, desired_input).await,
            "user_groups" => self.plan_user_groups(current_state, desired_input).await,
            "user_group" => self.plan_user_group(current_state, desired_input).await,
            "replication_group" => {
                self.plan_replication_group(current_state, desired_input)
                    .await
            }
            "users" => self.plan_users(current_state, desired_input).await,
            "serverless_cache_snapshot" => {
                self.plan_serverless_cache_snapshot(current_state, desired_input)
                    .await
            }
            "global_replication_groups" => {
                self.plan_global_replication_groups(current_state, desired_input)
                    .await
            }
            "user" => self.plan_user(current_state, desired_input).await,
            "events" => self.plan_events(current_state, desired_input).await,
            "cache_cluster" => self.plan_cache_cluster(current_state, desired_input).await,
            "reserved_cache_nodes_offerings" => {
                self.plan_reserved_cache_nodes_offerings(current_state, desired_input)
                    .await
            }
            "cache_security_group" => {
                self.plan_cache_security_group(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "elasticache", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "cache_parameter_group" => self.create_cache_parameter_group(input).await,
            "serverless_caches" => self.create_serverless_caches(input).await,
            "snapshots" => self.create_snapshots(input).await,
            "update_actions" => self.create_update_actions(input).await,
            "cache_subnet_groups" => self.create_cache_subnet_groups(input).await,
            "snapshot" => self.create_snapshot(input).await,
            "cache_security_groups" => self.create_cache_security_groups(input).await,
            "service_updates" => self.create_service_updates(input).await,
            "cache_parameters" => self.create_cache_parameters(input).await,
            "serverless_cache" => self.create_serverless_cache(input).await,
            "reserved_cache_nodes" => self.create_reserved_cache_nodes(input).await,
            "cache_subnet_group" => self.create_cache_subnet_group(input).await,
            "cache_engine_versions" => self.create_cache_engine_versions(input).await,
            "replication_groups" => self.create_replication_groups(input).await,
            "serverless_cache_snapshots" => self.create_serverless_cache_snapshots(input).await,
            "global_replication_group" => self.create_global_replication_group(input).await,
            "cache_parameter_groups" => self.create_cache_parameter_groups(input).await,
            "cache_clusters" => self.create_cache_clusters(input).await,
            "user_groups" => self.create_user_groups(input).await,
            "user_group" => self.create_user_group(input).await,
            "replication_group" => self.create_replication_group(input).await,
            "users" => self.create_users(input).await,
            "serverless_cache_snapshot" => self.create_serverless_cache_snapshot(input).await,
            "global_replication_groups" => self.create_global_replication_groups(input).await,
            "user" => self.create_user(input).await,
            "events" => self.create_events(input).await,
            "cache_cluster" => self.create_cache_cluster(input).await,
            "reserved_cache_nodes_offerings" => {
                self.create_reserved_cache_nodes_offerings(input).await
            }
            "cache_security_group" => self.create_cache_security_group(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "elasticache", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "cache_parameter_group" => self.read_cache_parameter_group(id).await,
            "serverless_caches" => self.read_serverless_caches(id).await,
            "snapshots" => self.read_snapshots(id).await,
            "update_actions" => self.read_update_actions(id).await,
            "cache_subnet_groups" => self.read_cache_subnet_groups(id).await,
            "snapshot" => self.read_snapshot(id).await,
            "cache_security_groups" => self.read_cache_security_groups(id).await,
            "service_updates" => self.read_service_updates(id).await,
            "cache_parameters" => self.read_cache_parameters(id).await,
            "serverless_cache" => self.read_serverless_cache(id).await,
            "reserved_cache_nodes" => self.read_reserved_cache_nodes(id).await,
            "cache_subnet_group" => self.read_cache_subnet_group(id).await,
            "cache_engine_versions" => self.read_cache_engine_versions(id).await,
            "replication_groups" => self.read_replication_groups(id).await,
            "serverless_cache_snapshots" => self.read_serverless_cache_snapshots(id).await,
            "global_replication_group" => self.read_global_replication_group(id).await,
            "cache_parameter_groups" => self.read_cache_parameter_groups(id).await,
            "cache_clusters" => self.read_cache_clusters(id).await,
            "user_groups" => self.read_user_groups(id).await,
            "user_group" => self.read_user_group(id).await,
            "replication_group" => self.read_replication_group(id).await,
            "users" => self.read_users(id).await,
            "serverless_cache_snapshot" => self.read_serverless_cache_snapshot(id).await,
            "global_replication_groups" => self.read_global_replication_groups(id).await,
            "user" => self.read_user(id).await,
            "events" => self.read_events(id).await,
            "cache_cluster" => self.read_cache_cluster(id).await,
            "reserved_cache_nodes_offerings" => self.read_reserved_cache_nodes_offerings(id).await,
            "cache_security_group" => self.read_cache_security_group(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "elasticache", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "cache_parameter_group" => self.update_cache_parameter_group(id, input).await,
            "serverless_caches" => self.update_serverless_caches(id, input).await,
            "snapshots" => self.update_snapshots(id, input).await,
            "update_actions" => self.update_update_actions(id, input).await,
            "cache_subnet_groups" => self.update_cache_subnet_groups(id, input).await,
            "snapshot" => self.update_snapshot(id, input).await,
            "cache_security_groups" => self.update_cache_security_groups(id, input).await,
            "service_updates" => self.update_service_updates(id, input).await,
            "cache_parameters" => self.update_cache_parameters(id, input).await,
            "serverless_cache" => self.update_serverless_cache(id, input).await,
            "reserved_cache_nodes" => self.update_reserved_cache_nodes(id, input).await,
            "cache_subnet_group" => self.update_cache_subnet_group(id, input).await,
            "cache_engine_versions" => self.update_cache_engine_versions(id, input).await,
            "replication_groups" => self.update_replication_groups(id, input).await,
            "serverless_cache_snapshots" => self.update_serverless_cache_snapshots(id, input).await,
            "global_replication_group" => self.update_global_replication_group(id, input).await,
            "cache_parameter_groups" => self.update_cache_parameter_groups(id, input).await,
            "cache_clusters" => self.update_cache_clusters(id, input).await,
            "user_groups" => self.update_user_groups(id, input).await,
            "user_group" => self.update_user_group(id, input).await,
            "replication_group" => self.update_replication_group(id, input).await,
            "users" => self.update_users(id, input).await,
            "serverless_cache_snapshot" => self.update_serverless_cache_snapshot(id, input).await,
            "global_replication_groups" => self.update_global_replication_groups(id, input).await,
            "user" => self.update_user(id, input).await,
            "events" => self.update_events(id, input).await,
            "cache_cluster" => self.update_cache_cluster(id, input).await,
            "reserved_cache_nodes_offerings" => {
                self.update_reserved_cache_nodes_offerings(id, input).await
            }
            "cache_security_group" => self.update_cache_security_group(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "elasticache", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "cache_parameter_group" => self.delete_cache_parameter_group(id).await,
            "serverless_caches" => self.delete_serverless_caches(id).await,
            "snapshots" => self.delete_snapshots(id).await,
            "update_actions" => self.delete_update_actions(id).await,
            "cache_subnet_groups" => self.delete_cache_subnet_groups(id).await,
            "snapshot" => self.delete_snapshot(id).await,
            "cache_security_groups" => self.delete_cache_security_groups(id).await,
            "service_updates" => self.delete_service_updates(id).await,
            "cache_parameters" => self.delete_cache_parameters(id).await,
            "serverless_cache" => self.delete_serverless_cache(id).await,
            "reserved_cache_nodes" => self.delete_reserved_cache_nodes(id).await,
            "cache_subnet_group" => self.delete_cache_subnet_group(id).await,
            "cache_engine_versions" => self.delete_cache_engine_versions(id).await,
            "replication_groups" => self.delete_replication_groups(id).await,
            "serverless_cache_snapshots" => self.delete_serverless_cache_snapshots(id).await,
            "global_replication_group" => self.delete_global_replication_group(id).await,
            "cache_parameter_groups" => self.delete_cache_parameter_groups(id).await,
            "cache_clusters" => self.delete_cache_clusters(id).await,
            "user_groups" => self.delete_user_groups(id).await,
            "user_group" => self.delete_user_group(id).await,
            "replication_group" => self.delete_replication_group(id).await,
            "users" => self.delete_users(id).await,
            "serverless_cache_snapshot" => self.delete_serverless_cache_snapshot(id).await,
            "global_replication_groups" => self.delete_global_replication_groups(id).await,
            "user" => self.delete_user(id).await,
            "events" => self.delete_events(id).await,
            "cache_cluster" => self.delete_cache_cluster(id).await,
            "reserved_cache_nodes_offerings" => {
                self.delete_reserved_cache_nodes_offerings(id).await
            }
            "cache_security_group" => self.delete_cache_security_group(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "elasticache", resource_name
            ))),
    ...
    async fn create_cache_parameter_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    cache_parameter_group_name.unwrap_or_default(),
                )
                .with_field(
                    "cache_parameter_group_family",
                    cache_parameter_group_family.unwrap_or_default(),
                )
    ...
    async fn read_cache_parameter_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_cache_parameter_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_serverless_caches(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_serverless_caches(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_serverless_caches(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_update_actions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_update_actions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_update_actions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_cache_subnet_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cache_subnet_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_cache_subnet_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    replication_group_id.unwrap_or_default(),
                )
    ...
    async fn create_cache_security_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cache_security_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_cache_security_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_service_updates(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_service_updates(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_service_updates(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_cache_parameters(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cache_parameters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_cache_parameters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_serverless_cache(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    serverless_cache_name.unwrap_or_default(),
                )
                .with_field("cache_usage_limits", cache_usage_limits.unwrap_or_default())
                .with_field("kms_key_id", kms_key_id.unwrap_or_default())
                .with_field(
                    "snapshot_arns_to_restore",
                    snapshot_arns_to_restore.unwrap_or_default(),
                )
                .with_field("security_group_ids", security_group_ids.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field(
                    "snapshot_retention_limit",
                    snapshot_retention_limit.unwrap_or_default(),
                )
                .with_field(
                    "daily_snapshot_time",
                    daily_snapshot_time.unwrap_or_default(),
                )
    ...
    async fn read_serverless_cache(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_serverless_cache(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_reserved_cache_nodes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_reserved_cache_nodes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_reserved_cache_nodes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_cache_subnet_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let cache_subnet_group_description =
                input.get_string("cache_subnet_group_description")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    cache_subnet_group_name.unwrap_or_default(),
                )
                .with_field(
                    "cache_subnet_group_description",
                    cache_subnet_group_description.unwrap_or_default(),
                ))
        })
    }

    /// Read a cache_subnet_group resource
    async fn read_cache_subnet_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_cache_subnet_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_cache_engine_versions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cache_engine_versions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_cache_engine_versions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_replication_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_replication_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_replication_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn read_serverless_cache_snapshots(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_serverless_cache_snapshots(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_global_replication_group(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let global_replication_group_description =
                input.get_optional_string("global_replication_group_description")?;
            let global_replication_group_id_suffix =
                input.get_string("global_replication_group_id_suffix")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    global_replication_group_description.unwrap_or_default(),
                )
                .with_field(
                    "global_replication_group_id_suffix",
                    global_replication_group_id_suffix.unwrap_or_default(),
                )
                .with_field(
                    "primary_replication_group_id",
                    primary_replication_group_id.unwrap_or_default(),
                ))
        })
    }

    /// Read a global_replication_group resource
    async fn read_global_replication_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_global_replication_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_cache_parameter_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cache_parameter_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_cache_parameter_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_cache_clusters(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cache_clusters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_cache_clusters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_user_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_user_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn update_user_groups(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_user_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_user_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_user_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn update_user_group(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let user_ids = input.get_optional_string("user_ids")?;
    ...
    async fn delete_user_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_replication_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let replication_group_description =
                input.get_string("replication_group_description")?;
            ...
            let transit_encryption_enabled =
                input.get_optional_string("transit_encryption_enabled")?;
            let snapshot_arns = input.get_optional_string("snapshot_arns")?;
            let log_delivery_configurations =
                input.get_optional_string("log_delivery_configurations")?;
            let num_cache_clusters = input.get_optional_string("num_cache_clusters")?;
            let global_replication_group_id =
                input.get_optional_string("global_replication_group_id")?;
            let num_node_groups = input.get_optional_string("num_node_groups")?;
            let cache_parameter_group_name =
                input.get_optional_string("cache_parameter_group_name")?;
            let security_group_ids = input.get_optional_string("security_group_ids")?;
            let tags = input.get_optional_string("tags")?;
            ...
            let at_rest_encryption_enabled =
                input.get_optional_string("at_rest_encryption_enabled")?;
            let snapshot_retention_limit = input.get_optional_string("snapshot_retention_limit")?;
            let cache_node_type = input.get_optional_string("cache_node_type")?;
            let cache_security_group_names =
                input.get_optional_string("cache_security_group_names")?;
            let serverless_cache_snapshot_name =
                input.get_optional_string("serverless_cache_snapshot_name")?;
            ...
            let automatic_failover_enabled =
                input.get_optional_string("automatic_failover_enabled")?;
            ...
            let preferred_cache_cluster_a_zs =
                input.get_optional_string("preferred_cache_cluster_a_zs")?;
            let kms_key_id = input.get_optional_string("kms_key_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    transit_encryption_mode.unwrap_or_default(),
                )
                .with_field(
                    "replication_group_description",
                    replication_group_description.unwrap_or_default(),
                )
                .with_field(
                    "node_group_configuration",
                    node_group_configuration.unwrap_or_default(),
                )
                .with_field(
                    "data_tiering_enabled",
                    data_tiering_enabled.unwrap_or_default(),
                )
                .with_field(
                    "transit_encryption_enabled",
                    transit_encryption_enabled.unwrap_or_default(),
                )
                .with_field("snapshot_arns", snapshot_arns.unwrap_or_default())
                .with_field(
                    "log_delivery_configurations",
                    log_delivery_configurations.unwrap_or_default(),
                )
                .with_field("num_cache_clusters", num_cache_clusters.unwrap_or_default())
                .with_field(
                    "global_replication_group_id",
                    global_replication_group_id.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    replicas_per_node_group.unwrap_or_default(),
                )
                .with_field(
                    "at_rest_encryption_enabled",
                    at_rest_encryption_enabled.unwrap_or_default(),
                )
                .with_field(
                    "snapshot_retention_limit",
                    snapshot_retention_limit.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    cache_security_group_names.unwrap_or_default(),
                )
                .with_field(
                    "serverless_cache_snapshot_name",
                    serverless_cache_snapshot_name.unwrap_or_default(),
                )
                .with_field(
                ...
                .with_field(
                    ...
                    notification_topic_arn.unwrap_or_default(),
                )
                .with_field("engine_version", engine_version.unwrap_or_default())
                .with_field(
                    "automatic_failover_enabled",
                    automatic_failover_enabled.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    preferred_cache_cluster_a_zs.unwrap_or_default(),
                )
                .with_field("kms_key_id", kms_key_id.unwrap_or_default())
    ...
    async fn read_replication_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_replication_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_serverless_cache_snapshot(
        ...
        self.provider.runtime().block_on(async {
            ...
            let kms_key_id = input.get_optional_string("kms_key_id")?;
            let serverless_cache_snapshot_name =
                input.get_string("serverless_cache_snapshot_name")?;
    ...
    async fn read_serverless_cache_snapshot(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_serverless_cache_snapshot(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn read_global_replication_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_global_replication_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    no_password_required.unwrap_or_default(),
                )
                .with_field("engine", engine.unwrap_or_default())
    ...
    async fn create_cache_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let snapshot_window = input.get_optional_string("snapshot_window")?;
            ...
            let preferred_availability_zones =
                input.get_optional_string("preferred_availability_zones")?;
            let snapshot_arns = input.get_optional_string("snapshot_arns")?;
            let engine = input.get_optional_string("engine")?;
            ...
            let preferred_availability_zone =
                input.get_optional_string("preferred_availability_zone")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    preferred_availability_zones.unwrap_or_default(),
                )
                .with_field("snapshot_arns", snapshot_arns.unwrap_or_default())
                .with_field("engine", engine.unwrap_or_default())
                .with_field(
                    "preferred_outpost_arns",
                    preferred_outpost_arns.unwrap_or_default(),
                )
                .with_field(
                    "transit_encryption_enabled",
                    transit_encryption_enabled.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    preferred_availability_zone.unwrap_or_default(),
                )
                .with_field("cache_cluster_id", cache_cluster_id.unwrap_or_default())
                .with_field(
                    "snapshot_retention_limit",
                ...
                .with_field(
                    ...
                    preferred_outpost_arn.unwrap_or_default(),
                )
                .with_field(
                    "preferred_maintenance_window",
                    preferred_maintenance_window.unwrap_or_default(),
    ...
    async fn read_cache_cluster(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn update_cache_cluster(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let snapshot_window = input.get_optional_string("snapshot_window")?;
            let network_type = input.get_optional_string("network_type")?;
    ...
    async fn delete_cache_cluster(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn read_reserved_cache_nodes_offerings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_reserved_cache_nodes_offerings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
    ...
    async fn create_cache_security_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    cache_security_group_name.unwrap_or_default(),
                )
                .with_field("description", description.unwrap_or_default()))
        })
    }
    ...
    async fn read_cache_security_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticache_client
    ...
    async fn delete_cache_security_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticache_client
