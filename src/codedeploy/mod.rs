...
impl<'a> CodedeployService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "git_hub_account_token" => {
                self.plan_git_hub_account_token(current_state, desired_input)
                    .await
            }
            "deployment_config" => {
                self.plan_deployment_config(current_state, desired_input)
                    .await
            }
            "resources_by_external_id" => {
                self.plan_resources_by_external_id(current_state, desired_input)
                    .await
            }
            "application_revision" => {
                self.plan_application_revision(current_state, desired_input)
                    .await
            }
            "deployment_group" => {
                self.plan_deployment_group(current_state, desired_input)
                    .await
            }
            "deployment_target" => {
                self.plan_deployment_target(current_state, desired_input)
                    .await
            }
            "deployment_instance" => {
                self.plan_deployment_instance(current_state, desired_input)
                    .await
            }
            "application" => self.plan_application(current_state, desired_input).await,
            "on_premises_instance" => {
                self.plan_on_premises_instance(current_state, desired_input)
                    .await
            }
            "lifecycle_event_hook_execution_status" => {
                self.plan_lifecycle_event_hook_execution_status(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codedeploy", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "git_hub_account_token" => self.create_git_hub_account_token(input).await,
            "deployment_config" => self.create_deployment_config(input).await,
            "resources_by_external_id" => self.create_resources_by_external_id(input).await,
            "application_revision" => self.create_application_revision(input).await,
            "deployment_group" => self.create_deployment_group(input).await,
            "deployment_target" => self.create_deployment_target(input).await,
            "deployment_instance" => self.create_deployment_instance(input).await,
            "application" => self.create_application(input).await,
            "on_premises_instance" => self.create_on_premises_instance(input).await,
            "lifecycle_event_hook_execution_status" => {
                self.create_lifecycle_event_hook_execution_status(input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "git_hub_account_token" => self.read_git_hub_account_token(id).await,
            "deployment_config" => self.read_deployment_config(id).await,
            "resources_by_external_id" => self.read_resources_by_external_id(id).await,
            "application_revision" => self.read_application_revision(id).await,
            "deployment_group" => self.read_deployment_group(id).await,
            "deployment_target" => self.read_deployment_target(id).await,
            "deployment_instance" => self.read_deployment_instance(id).await,
            "application" => self.read_application(id).await,
            "on_premises_instance" => self.read_on_premises_instance(id).await,
            "lifecycle_event_hook_execution_status" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "git_hub_account_token" => self.update_git_hub_account_token(id, input).await,
            "deployment_config" => self.update_deployment_config(id, input).await,
            "resources_by_external_id" => self.update_resources_by_external_id(id, input).await,
            "application_revision" => self.update_application_revision(id, input).await,
            "deployment_group" => self.update_deployment_group(id, input).await,
            "deployment_target" => self.update_deployment_target(id, input).await,
            "deployment_instance" => self.update_deployment_instance(id, input).await,
            "application" => self.update_application(id, input).await,
            "on_premises_instance" => self.update_on_premises_instance(id, input).await,
            "lifecycle_event_hook_execution_status" => {
                self.update_lifecycle_event_hook_execution_status(id, input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "git_hub_account_token" => self.delete_git_hub_account_token(id).await,
            "deployment_config" => self.delete_deployment_config(id).await,
            "resources_by_external_id" => self.delete_resources_by_external_id(id).await,
            "application_revision" => self.delete_application_revision(id).await,
            "deployment_group" => self.delete_deployment_group(id).await,
            "deployment_target" => self.delete_deployment_target(id).await,
            "deployment_instance" => self.delete_deployment_instance(id).await,
            "application" => self.delete_application(id).await,
            "on_premises_instance" => self.delete_on_premises_instance(id).await,
            "lifecycle_event_hook_execution_status" => {
    ...
    async fn create_deployment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let override_alarm_configuration =
                input.get_optional_string("override_alarm_configuration")?;
            let ignore_application_stop_failures =
                input.get_optional_string("ignore_application_stop_failures")?;
            ...
            let update_outdated_instances_only =
                input.get_optional_string("update_outdated_instances_only")?;
            ...
            let auto_rollback_configuration =
                input.get_optional_string("auto_rollback_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    override_alarm_configuration.unwrap_or_default(),
                )
                .with_field(
                    "ignore_application_stop_failures",
                    ignore_application_stop_failures.unwrap_or_default(),
                )
                .with_field(
                    "deployment_group_name",
                    deployment_group_name.unwrap_or_default(),
                )
                .with_field("description", description.unwrap_or_default())
                .with_field(
                    "deployment_config_name",
                    deployment_config_name.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    update_outdated_instances_only.unwrap_or_default(),
                )
                .with_field("target_instances", target_instances.unwrap_or_default())
                .with_field(
                    "file_exists_behavior",
                    file_exists_behavior.unwrap_or_default(),
                )
                .with_field(
                    "auto_rollback_configuration",
                    auto_rollback_configuration.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_git_hub_account_token(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_git_hub_account_token(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codedeploy_client
    ...
    async fn delete_git_hub_account_token(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codedeploy_client
    ...
    async fn create_deployment_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    traffic_routing_config.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    minimum_healthy_hosts.unwrap_or_default(),
                ))
        })
    }

    /// Read a deployment_config resource
    async fn read_deployment_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codedeploy_client
    ...
    async fn delete_deployment_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codedeploy_client
    ...
    async fn read_resources_by_external_id(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codedeploy_client
    ...
    async fn delete_resources_by_external_id(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codedeploy_client
    ...
    async fn create_application_revision(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_application_revision(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codedeploy_client
    ...
    async fn delete_application_revision(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codedeploy_client
    ...
    async fn create_deployment_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let on_premises_instance_tag_filters =
                input.get_optional_string("on_premises_instance_tag_filters")?;
            ...
            let deployment_config_name = input.get_optional_string("deployment_config_name")?;
            let outdated_instances_strategy =
                input.get_optional_string("outdated_instances_strategy")?;
            ...
            let blue_green_deployment_configuration =
                input.get_optional_string("blue_green_deployment_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "on_premises_tag_set",
                    on_premises_tag_set.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    on_premises_instance_tag_filters.unwrap_or_default(),
                )
                .with_field(
                    "termination_hook_enabled",
                    termination_hook_enabled.unwrap_or_default(),
                )
                .with_field(
                    "trigger_configurations",
                    trigger_configurations.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    outdated_instances_strategy.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    blue_green_deployment_configuration.unwrap_or_default(),
                )
                .with_field(
                    "auto_scaling_groups",
                    auto_scaling_groups.unwrap_or_default(),
                )
                .with_field("application_name", application_name.unwrap_or_default()))
        })
    }
    ...
    async fn read_deployment_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codedeploy_client
    ...
    async fn delete_deployment_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codedeploy_client
    ...
    async fn create_deployment_target(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_deployment_target(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codedeploy_client
    ...
    async fn delete_deployment_target(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codedeploy_client
    ...
    async fn create_deployment_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_deployment_instance(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codedeploy_client
    ...
    async fn delete_deployment_instance(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codedeploy_client
    ...
    async fn create_on_premises_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_on_premises_instance(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codedeploy_client
    ...
    async fn delete_on_premises_instance(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codedeploy_client
    ...
    async fn create_lifecycle_event_hook_execution_status(
        ...
        self.provider.runtime().block_on(async {
            ...
            let lifecycle_event_hook_execution_id =
                input.get_optional_string("lifecycle_event_hook_execution_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    lifecycle_event_hook_execution_id.unwrap_or_default(),
                )
    ...
    async fn read_lifecycle_event_hook_execution_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codedeploy_client
    ...
    async fn delete_lifecycle_event_hook_execution_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codedeploy_client
