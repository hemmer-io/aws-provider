...
impl<'a> Deployment_config<'a> {
    ...
    pub async fn create(&self, traffic_routing_config: Option<String>, minimum_healthy_hosts: Option<String>, compute_platform: Option<String>, zonal_config: Option<String>, deployment_config_name: String) -> Result<String> {
