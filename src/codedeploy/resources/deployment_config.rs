...
impl<'a> Deployment_config<'a> {
    ...
    pub async fn create(&self, compute_platform: Option<String>, zonal_config: Option<String>, deployment_config_name: String, minimum_healthy_hosts: Option<String>, traffic_routing_config: Option<String>) -> Result<String> {
