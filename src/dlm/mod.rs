...
impl<'a> DlmService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "lifecycle_policies" => {
                self.plan_lifecycle_policies(current_state, desired_input)
                    .await
            }
            "lifecycle_policy" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "lifecycle_policies" => self.create_lifecycle_policies(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "lifecycle_policies" => self.read_lifecycle_policies(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "lifecycle_policies" => self.update_lifecycle_policies(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "lifecycle_policies" => self.delete_lifecycle_policies(id).await,
    ...
    async fn create_lifecycle_policies(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_lifecycle_policies(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_lifecycle_policies(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_lifecycle_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let cross_region_copy_targets =
                input.get_optional_string("cross_region_copy_targets")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    cross_region_copy_targets.unwrap_or_default(),
                ))
        })
    }
