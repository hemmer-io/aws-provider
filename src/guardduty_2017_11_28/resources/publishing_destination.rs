...
impl<'a> Publishing_destination<'a> {
    ...
    pub async fn create(&self, destination_type: String, detector_id: String, destination_properties: String, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, destination_type: Option<String>, detector_id: Option<String>, destination_properties: Option<String>, client_token: Option<String>) -> Result<()> {
