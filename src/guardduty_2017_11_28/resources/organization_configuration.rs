...
impl<'a> Organization_configuration<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, auto_enable_organization_members: Option<String>, detector_id: Option<String>, data_sources: Option<String>, auto_enable: Option<bool>, features: Option<Vec<String>>) -> Result<()> {
