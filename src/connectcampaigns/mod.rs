...
impl<'a> ConnectcampaignsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "campaign_dialer_config" => {
                self.plan_campaign_dialer_config(current_state, desired_input)
                    .await
            }
            "campaign_name" => self.plan_campaign_name(current_state, desired_input).await,
            "campaign_outbound_call_config" => {
                self.plan_campaign_outbound_call_config(current_state, desired_input)
                    .await
            }
            ...
            "dial_request_batch" => {
                self.plan_dial_request_batch(current_state, desired_input)
                    .await
            }
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "connectcampaigns", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "campaign_dialer_config" => self.create_campaign_dialer_config(input).await,
            ...
            "dial_request_batch" => self.create_dial_request_batch(input).await,
            "instance_onboarding_job_status" => {
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "campaign_dialer_config" => self.read_campaign_dialer_config(id).await,
            "campaign_name" => self.read_campaign_name(id).await,
            "campaign_outbound_call_config" => self.read_campaign_outbound_call_config(id).await,
            ...
            "dial_request_batch" => self.read_dial_request_batch(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "campaign_dialer_config" => self.update_campaign_dialer_config(id, input).await,
            ...
            "dial_request_batch" => self.update_dial_request_batch(id, input).await,
            "instance_onboarding_job_status" => {
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "campaign_dialer_config" => self.delete_campaign_dialer_config(id).await,
            "campaign_name" => self.delete_campaign_name(id).await,
            "campaign_outbound_call_config" => self.delete_campaign_outbound_call_config(id).await,
            ...
            "dial_request_batch" => self.delete_dial_request_batch(id).await,
            "instance_onboarding_job_status" => {
    ...
    async fn create_campaign_dialer_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_campaign_dialer_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_campaign_dialer_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_campaign_outbound_call_config(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let id = input.get_string("id")?;
            let connect_source_phone_number =
                input.get_optional_string("connect_source_phone_number")?;
            let connect_contact_flow_id = input.get_optional_string("connect_contact_flow_id")?;
            let answer_machine_detection_config =
                input.get_optional_string("answer_machine_detection_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    connect_source_phone_number.unwrap_or_default(),
                )
                .with_field(
                    "connect_contact_flow_id",
                    connect_contact_flow_id.unwrap_or_default(),
                )
                .with_field(
                    "answer_machine_detection_config",
                    answer_machine_detection_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a campaign_outbound_call_config resource
    async fn read_campaign_outbound_call_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connectcampaigns_client
    ...
    async fn delete_campaign_outbound_call_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connectcampaigns_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    outbound_call_config.unwrap_or_default(),
                )
                .with_field("name", name.unwrap_or_default())
    ...
    async fn create_dial_request_batch(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let id = input.get_string("id")?;
    ...
    async fn read_dial_request_batch(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connectcampaigns_client
    ...
    async fn delete_dial_request_batch(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connectcampaigns_client
