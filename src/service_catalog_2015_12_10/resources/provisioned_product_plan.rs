...
impl<'a> Provisioned_product_plan<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, plan_name: String, provisioning_artifact_id: String, provisioning_parameters: Option<Vec<String>>, notification_arns: Option<Vec<String>>, idempotency_token: String, accept_language: Option<String>, plan_type: String, provisioned_product_name: String, product_id: String, path_id: Option<String>) -> Result<String> {
