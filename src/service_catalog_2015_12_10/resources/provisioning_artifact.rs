...
impl<'a> Provisioning_artifact<'a> {
    ...
    pub async fn create(&self, product_id: String, idempotency_token: String, parameters: String, accept_language: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, product_id: Option<String>, idempotency_token: Option<String>, parameters: Option<String>, accept_language: Option<String>) -> Result<()> {
