...
impl<'a> Logging_configuration<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, logging_configuration: Option<String>, firewall_arn: Option<String>, enable_monitoring_dashboard: Option<bool>, firewall_name: Option<String>) -> Result<()> {
