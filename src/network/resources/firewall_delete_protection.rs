...
impl<'a> Firewall_delete_protection<'a> {
    ...
    pub async fn update(&self, id: &str, update_token: Option<String>, firewall_name: Option<String>, delete_protection: Option<bool>, firewall_arn: Option<String>) -> Result<()> {
