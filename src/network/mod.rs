//! Network Service
//!
//! Auto-generated service module for network

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for network
...
impl<'a> NetworkService<'a> {
    ...
    /// Get tlsinspection_configuration resource handler
    pub fn tlsinspection_configuration(&self) -> resources::Tlsinspection_configuration<'_> {
        resources::Tlsinspection_configuration::new(self.provider)
    }
