...
impl<'a> Image_set_metadata<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, image_set_id: Option<String>, datastore_id: Option<String>, latest_version_id: Option<String>, force: Option<bool>, update_image_set_metadata_updates: Option<String>) -> Result<()> {
