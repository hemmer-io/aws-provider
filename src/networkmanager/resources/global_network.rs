...
impl<'a> Global_network<'a> {
    ...
    pub async fn create(&self, description: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
