...
impl<'a> Connect_attachment<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, transport_attachment_id: String, edge_location: String, options: String, core_network_id: String, client_token: Option<String>) -> Result<String> {
