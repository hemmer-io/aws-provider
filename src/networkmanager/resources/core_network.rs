...
impl<'a> Core_network<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, tags: Option<Vec<String>>, policy_document: Option<String>, global_network_id: String, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, tags: Option<Vec<String>>, policy_document: Option<String>, global_network_id: Option<String>, description: Option<String>) -> Result<()> {
