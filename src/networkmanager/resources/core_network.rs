...
impl<'a> Core_network<'a> {
    ...
    pub async fn create(&self, description: Option<String>, global_network_id: String, tags: Option<Vec<String>>, client_token: Option<String>, policy_document: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, global_network_id: Option<String>, tags: Option<Vec<String>>, client_token: Option<String>, policy_document: Option<String>) -> Result<()> {
