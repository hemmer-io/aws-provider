...
impl<'a> Connect_peer<'a> {
    ...
    pub async fn create(&self, bgp_options: Option<String>, connect_attachment_id: String, inside_cidr_blocks: Option<Vec<String>>, core_network_address: Option<String>, client_token: Option<String>, subnet_arn: Option<String>, peer_address: String, tags: Option<Vec<String>>) -> Result<String> {
