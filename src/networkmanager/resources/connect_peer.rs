...
impl<'a> Connect_peer<'a> {
    ...
    pub async fn create(&self, core_network_address: Option<String>, client_token: Option<String>, tags: Option<Vec<String>>, connect_attachment_id: String, subnet_arn: Option<String>, inside_cidr_blocks: Option<Vec<String>>, peer_address: String, bgp_options: Option<String>) -> Result<String> {
