...
impl<'a> Core_network_policy<'a> {
    ...
    pub async fn create(&self, policy_document: String, latest_version_id: Option<i64>, core_network_id: String, description: Option<String>, client_token: Option<String>) -> Result<String> {
