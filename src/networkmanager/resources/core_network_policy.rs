...
impl<'a> Core_network_policy<'a> {
    ...
    pub async fn create(&self, latest_version_id: Option<i64>, core_network_id: String, policy_document: String, description: Option<String>, client_token: Option<String>) -> Result<String> {
