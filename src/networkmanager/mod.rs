...
impl<'a> NetworkmanagerService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "network_telemetry" => {
                self.plan_network_telemetry(current_state, desired_input)
                    .await
            }
            "network_resources" => {
                self.plan_network_resources(current_state, desired_input)
                    .await
            }
            "link" => self.plan_link(current_state, desired_input).await,
            "core_network_change_events" => {
                self.plan_core_network_change_events(current_state, desired_input)
                    .await
            }
            "transit_gateway_peering" => {
                self.plan_transit_gateway_peering(current_state, desired_input)
                    .await
            }
            "vpc_attachment" => self.plan_vpc_attachment(current_state, desired_input).await,
            "link_associations" => {
                self.plan_link_associations(current_state, desired_input)
                    .await
            }
            "global_networks" => {
                self.plan_global_networks(current_state, desired_input)
                    .await
            }
            "sites" => self.plan_sites(current_state, desired_input).await,
            "resource_policy" => {
                self.plan_resource_policy(current_state, desired_input)
                    .await
            }
            "connect_attachment" => {
                self.plan_connect_attachment(current_state, desired_input)
                    .await
            }
            "site" => self.plan_site(current_state, desired_input).await,
            "connect_peer_associations" => {
                self.plan_connect_peer_associations(current_state, desired_input)
                    .await
            }
            "network_routes" => self.plan_network_routes(current_state, desired_input).await,
            "attachment" => self.plan_attachment(current_state, desired_input).await,
            "transit_gateway_route_table_attachment" => {
                self.plan_transit_gateway_route_table_attachment(current_state, desired_input)
                    .await
            }
            "core_network_policy" => {
                self.plan_core_network_policy(current_state, desired_input)
                    .await
            }
            "core_network_change_set" => {
                self.plan_core_network_change_set(current_state, desired_input)
                    .await
            }
            "network_resource_counts" => {
                self.plan_network_resource_counts(current_state, desired_input)
                    .await
            }
            ...
            "connect_peer" => self.plan_connect_peer(current_state, desired_input).await,
            "links" => self.plan_links(current_state, desired_input).await,
            "customer_gateway_associations" => {
                self.plan_customer_gateway_associations(current_state, desired_input)
                    .await
            }
            "network_resource_metadata" => {
                self.plan_network_resource_metadata(current_state, desired_input)
                    .await
            }
            "direct_connect_gateway_attachment" => {
                self.plan_direct_connect_gateway_attachment(current_state, desired_input)
                    .await
            }
            "route_analysis" => self.plan_route_analysis(current_state, desired_input).await,
            "transit_gateway_connect_peer_associations" => {
                self.plan_transit_gateway_connect_peer_associations(current_state, desired_input)
                    .await
            }
            "network_resource_relationships" => {
                self.plan_network_resource_relationships(current_state, desired_input)
                    .await
            }
            ...
            "transit_gateway_registrations" => {
                self.plan_transit_gateway_registrations(current_state, desired_input)
                    .await
            }
            "global_network" => self.plan_global_network(current_state, desired_input).await,
            "site_to_site_vpn_attachment" => {
                self.plan_site_to_site_vpn_attachment(current_state, desired_input)
                    .await
            }
            "core_network_policy_version" => {
                self.plan_core_network_policy_version(current_state, desired_input)
                    .await
            }
            "core_network" => self.plan_core_network(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "networkmanager", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "network_telemetry" => self.create_network_telemetry(input).await,
            "network_resources" => self.create_network_resources(input).await,
            "link" => self.create_link(input).await,
            "core_network_change_events" => self.create_core_network_change_events(input).await,
            "transit_gateway_peering" => self.create_transit_gateway_peering(input).await,
            "vpc_attachment" => self.create_vpc_attachment(input).await,
            "link_associations" => self.create_link_associations(input).await,
            "global_networks" => self.create_global_networks(input).await,
            "sites" => self.create_sites(input).await,
            "resource_policy" => self.create_resource_policy(input).await,
            "connect_attachment" => self.create_connect_attachment(input).await,
            "site" => self.create_site(input).await,
            "connect_peer_associations" => self.create_connect_peer_associations(input).await,
            "network_routes" => self.create_network_routes(input).await,
            "attachment" => self.create_attachment(input).await,
            "transit_gateway_route_table_attachment" => {
                self.create_transit_gateway_route_table_attachment(input)
                    .await
            }
            "core_network_policy" => self.create_core_network_policy(input).await,
            "core_network_change_set" => self.create_core_network_change_set(input).await,
            "network_resource_counts" => self.create_network_resource_counts(input).await,
            ...
            "connect_peer" => self.create_connect_peer(input).await,
            "links" => self.create_links(input).await,
            "customer_gateway_associations" => {
                self.create_customer_gateway_associations(input).await
            }
            "network_resource_metadata" => self.create_network_resource_metadata(input).await,
            "direct_connect_gateway_attachment" => {
                self.create_direct_connect_gateway_attachment(input).await
            }
            "route_analysis" => self.create_route_analysis(input).await,
            "transit_gateway_connect_peer_associations" => {
                self.create_transit_gateway_connect_peer_associations(input)
                    .await
            }
            "network_resource_relationships" => {
            ...
            "global_network" => self.create_global_network(input).await,
            "site_to_site_vpn_attachment" => self.create_site_to_site_vpn_attachment(input).await,
            "core_network_policy_version" => self.create_core_network_policy_version(input).await,
            "core_network" => self.create_core_network(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "networkmanager", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "network_telemetry" => self.read_network_telemetry(id).await,
            "network_resources" => self.read_network_resources(id).await,
            "link" => self.read_link(id).await,
            "core_network_change_events" => self.read_core_network_change_events(id).await,
            "transit_gateway_peering" => self.read_transit_gateway_peering(id).await,
            "vpc_attachment" => self.read_vpc_attachment(id).await,
            "link_associations" => self.read_link_associations(id).await,
            "global_networks" => self.read_global_networks(id).await,
            "sites" => self.read_sites(id).await,
            "resource_policy" => self.read_resource_policy(id).await,
            "connect_attachment" => self.read_connect_attachment(id).await,
            "site" => self.read_site(id).await,
            "connect_peer_associations" => self.read_connect_peer_associations(id).await,
            "network_routes" => self.read_network_routes(id).await,
            "attachment" => self.read_attachment(id).await,
            "transit_gateway_route_table_attachment" => {
                self.read_transit_gateway_route_table_attachment(id).await
            }
            "core_network_policy" => self.read_core_network_policy(id).await,
            "core_network_change_set" => self.read_core_network_change_set(id).await,
            "network_resource_counts" => self.read_network_resource_counts(id).await,
            "connection" => self.read_connection(id).await,
            "devices" => self.read_devices(id).await,
            "connections" => self.read_connections(id).await,
            "connect_peer" => self.read_connect_peer(id).await,
            "links" => self.read_links(id).await,
            "customer_gateway_associations" => self.read_customer_gateway_associations(id).await,
            "network_resource_metadata" => self.read_network_resource_metadata(id).await,
            "direct_connect_gateway_attachment" => {
                self.read_direct_connect_gateway_attachment(id).await
            }
            "route_analysis" => self.read_route_analysis(id).await,
            "transit_gateway_connect_peer_associations" => {
                self.read_transit_gateway_connect_peer_associations(id)
                    .await
            }
            "network_resource_relationships" => self.read_network_resource_relationships(id).await,
            "device" => self.read_device(id).await,
            "peering" => self.read_peering(id).await,
            "transit_gateway_registrations" => self.read_transit_gateway_registrations(id).await,
            "global_network" => self.read_global_network(id).await,
            "site_to_site_vpn_attachment" => self.read_site_to_site_vpn_attachment(id).await,
            "core_network_policy_version" => self.read_core_network_policy_version(id).await,
            "core_network" => self.read_core_network(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "networkmanager", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "network_telemetry" => self.update_network_telemetry(id, input).await,
            "network_resources" => self.update_network_resources(id, input).await,
            "link" => self.update_link(id, input).await,
            "core_network_change_events" => self.update_core_network_change_events(id, input).await,
            "transit_gateway_peering" => self.update_transit_gateway_peering(id, input).await,
            "vpc_attachment" => self.update_vpc_attachment(id, input).await,
            "link_associations" => self.update_link_associations(id, input).await,
            "global_networks" => self.update_global_networks(id, input).await,
            "sites" => self.update_sites(id, input).await,
            "resource_policy" => self.update_resource_policy(id, input).await,
            "connect_attachment" => self.update_connect_attachment(id, input).await,
            "site" => self.update_site(id, input).await,
            "connect_peer_associations" => self.update_connect_peer_associations(id, input).await,
            "network_routes" => self.update_network_routes(id, input).await,
            "attachment" => self.update_attachment(id, input).await,
            "transit_gateway_route_table_attachment" => {
                self.update_transit_gateway_route_table_attachment(id, input)
                    .await
            }
            "core_network_policy" => self.update_core_network_policy(id, input).await,
            "core_network_change_set" => self.update_core_network_change_set(id, input).await,
            "network_resource_counts" => self.update_network_resource_counts(id, input).await,
            ...
            "connect_peer" => self.update_connect_peer(id, input).await,
            "links" => self.update_links(id, input).await,
            "customer_gateway_associations" => {
                self.update_customer_gateway_associations(id, input).await
            }
            "network_resource_metadata" => self.update_network_resource_metadata(id, input).await,
            "direct_connect_gateway_attachment" => {
                self.update_direct_connect_gateway_attachment(id, input)
                    .await
            }
            "route_analysis" => self.update_route_analysis(id, input).await,
            "transit_gateway_connect_peer_associations" => {
                self.update_transit_gateway_connect_peer_associations(id, input)
                    .await
            }
            "network_resource_relationships" => {
            ...
            "global_network" => self.update_global_network(id, input).await,
            "site_to_site_vpn_attachment" => {
            ...
            "core_network" => self.update_core_network(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "networkmanager", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "network_telemetry" => self.delete_network_telemetry(id).await,
            "network_resources" => self.delete_network_resources(id).await,
            "link" => self.delete_link(id).await,
            "core_network_change_events" => self.delete_core_network_change_events(id).await,
            "transit_gateway_peering" => self.delete_transit_gateway_peering(id).await,
            "vpc_attachment" => self.delete_vpc_attachment(id).await,
            "link_associations" => self.delete_link_associations(id).await,
            "global_networks" => self.delete_global_networks(id).await,
            "sites" => self.delete_sites(id).await,
            "resource_policy" => self.delete_resource_policy(id).await,
            "connect_attachment" => self.delete_connect_attachment(id).await,
            "site" => self.delete_site(id).await,
            "connect_peer_associations" => self.delete_connect_peer_associations(id).await,
            "network_routes" => self.delete_network_routes(id).await,
            "attachment" => self.delete_attachment(id).await,
            "transit_gateway_route_table_attachment" => {
                self.delete_transit_gateway_route_table_attachment(id).await
            }
            "core_network_policy" => self.delete_core_network_policy(id).await,
            "core_network_change_set" => self.delete_core_network_change_set(id).await,
            "network_resource_counts" => self.delete_network_resource_counts(id).await,
            ...
            "connect_peer" => self.delete_connect_peer(id).await,
            "links" => self.delete_links(id).await,
            "customer_gateway_associations" => self.delete_customer_gateway_associations(id).await,
            "network_resource_metadata" => self.delete_network_resource_metadata(id).await,
            "direct_connect_gateway_attachment" => {
                self.delete_direct_connect_gateway_attachment(id).await
            }
            "route_analysis" => self.delete_route_analysis(id).await,
            "transit_gateway_connect_peer_associations" => {
                self.delete_transit_gateway_connect_peer_associations(id)
                    .await
            }
            "network_resource_relationships" => {
            ...
            "transit_gateway_registrations" => self.delete_transit_gateway_registrations(id).await,
            "global_network" => self.delete_global_network(id).await,
            "site_to_site_vpn_attachment" => self.delete_site_to_site_vpn_attachment(id).await,
            "core_network_policy_version" => self.delete_core_network_policy_version(id).await,
            "core_network" => self.delete_core_network(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "networkmanager", resource_name
            ))),
    ...
    async fn create_network_telemetry(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_network_telemetry(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_network_telemetry(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_network_resources(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_network_resources(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_network_resources(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn read_core_network_change_events(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_core_network_change_events(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_transit_gateway_peering(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "transit_gateway_arn",
                    transit_gateway_arn.unwrap_or_default(),
                )
    ...
    async fn read_transit_gateway_peering(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_transit_gateway_peering(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_vpc_attachment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_vpc_attachment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_vpc_attachment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_link_associations(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_link_associations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_link_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_global_networks(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_global_networks(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_global_networks(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_sites(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_sites(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn update_sites(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_sites(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_connect_attachment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    transport_attachment_id.unwrap_or_default(),
                )
                .with_field("core_network_id", core_network_id.unwrap_or_default())
                .with_field("options", options.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
    ...
    async fn read_connect_attachment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_connect_attachment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn read_connect_peer_associations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_connect_peer_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_network_routes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_network_routes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_network_routes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_transit_gateway_route_table_attachment(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let client_token = input.get_optional_string("client_token")?;
            let transit_gateway_route_table_arn =
                input.get_string("transit_gateway_route_table_arn")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    transit_gateway_route_table_arn.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
    ...
    async fn delete_transit_gateway_route_table_attachment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_core_network_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let policy_document = input.get_string("policy_document")?;
    ...
    async fn read_core_network_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_core_network_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_core_network_change_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_core_network_change_set(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_core_network_change_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_network_resource_counts(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_network_resource_counts(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_network_resource_counts(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_connection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "connected_device_id",
                    connected_device_id.unwrap_or_default(),
                )
    ...
    async fn create_connect_peer(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    connect_attachment_id.unwrap_or_default(),
                )
                .with_field("inside_cidr_blocks", inside_cidr_blocks.unwrap_or_default())
                .with_field(
                    "core_network_address",
                    core_network_address.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default())
    ...
    async fn read_connect_peer(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn update_connect_peer(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let bgp_options = input.get_optional_string("bgp_options")?;
            let connect_attachment_id = input.get_string("connect_attachment_id")?;
    ...
    async fn delete_connect_peer(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_links(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_links(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn update_links(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_links(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn read_customer_gateway_associations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_customer_gateway_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn read_network_resource_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_network_resource_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    direct_connect_gateway_arn.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default()))
        })
    ...
    async fn read_direct_connect_gateway_attachment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_direct_connect_gateway_attachment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_route_analysis(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_route_analysis(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_route_analysis(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn delete_transit_gateway_connect_peer_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn read_network_resource_relationships(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_network_resource_relationships(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn read_transit_gateway_registrations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_transit_gateway_registrations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_global_network(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let description = input.get_optional_string("description")?;
    ...
    async fn read_global_network(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_global_network(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn read_site_to_site_vpn_attachment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_site_to_site_vpn_attachment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn read_core_network_policy_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn delete_core_network_policy_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
    ...
    async fn create_core_network(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let description = input.get_optional_string("description")?;
    ...
    async fn read_core_network(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.networkmanager_client
    ...
    async fn update_core_network(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let description = input.get_optional_string("description")?;
            let policy_document = input.get_optional_string("policy_document")?;
    ...
    async fn delete_core_network(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.networkmanager_client
