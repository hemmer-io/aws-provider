...
impl<'a> Snapshot_block<'a> {
    ...
    pub async fn create(&self, checksum_algorithm: String, block_data: String, block_index: i64, progress: Option<i64>, snapshot_id: String, data_length: i64, checksum: String) -> Result<String> {
