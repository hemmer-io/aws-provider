...
impl<'a> Vpc_endpoint<'a> {
    ...
    pub async fn update(&self, id: &str, add_subnet_ids: Option<Vec<String>>, remove_subnet_ids: Option<Vec<String>>, id: Option<String>, client_token: Option<String>, add_security_group_ids: Option<Vec<String>>, remove_security_group_ids: Option<Vec<String>>) -> Result<()> {
