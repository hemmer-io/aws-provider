...
impl<'a> Vpc_endpoint<'a> {
    ...
    pub async fn update(&self, id: &str, remove_security_group_ids: Option<Vec<String>>, id: Option<String>, add_subnet_ids: Option<Vec<String>>, remove_subnet_ids: Option<Vec<String>>, add_security_group_ids: Option<Vec<String>>, client_token: Option<String>) -> Result<()> {
