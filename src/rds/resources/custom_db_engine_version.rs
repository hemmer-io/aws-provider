...
impl<'a> Custom_db_engine_version<'a> {
    ...
    pub async fn create(&self, description: Option<String>, manifest: Option<String>, tags: Option<Vec<String>>, database_installation_files_s3_prefix: Option<String>, engine_version: String, engine: String, image_id: Option<String>, kms_key_id: Option<String>, source_custom_db_engine_version_identifier: Option<String>, use_aws_provided_latest_image: Option<bool>, database_installation_files_s3_bucket_name: Option<String>) -> Result<String> {
