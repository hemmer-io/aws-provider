...
impl<'a> Dbcluster_endpoint<'a> {
    ...
    pub async fn create(&self, dbcluster_endpoint_identifier: String, static_members: Option<String>, tags: Option<Vec<String>>, endpoint_type: String, dbcluster_identifier: String, excluded_members: Option<String>) -> Result<String> {
