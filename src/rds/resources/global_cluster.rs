...
impl<'a> Global_cluster<'a> {
    ...
    pub async fn create(&self, engine: Option<String>, deletion_protection: Option<bool>, engine_lifecycle_support: Option<String>, source_dbcluster_identifier: Option<String>, engine_version: Option<String>, database_name: Option<String>, global_cluster_identifier: String, storage_encrypted: Option<bool>, tags: Option<Vec<String>>) -> Result<String> {
