...
impl<'a> Global_cluster<'a> {
    ...
    pub async fn create(&self, storage_encrypted: Option<bool>, global_cluster_identifier: String, engine: Option<String>, deletion_protection: Option<bool>, engine_version: Option<String>, source_db_cluster_identifier: Option<String>, engine_lifecycle_support: Option<String>, database_name: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
