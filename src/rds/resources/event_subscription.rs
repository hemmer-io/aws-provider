...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, source_type: Option<String>, sns_topic_arn: String, event_categories: Option<Vec<String>>, subscription_name: String, enabled: Option<bool>, source_ids: Option<Vec<String>>) -> Result<String> {
