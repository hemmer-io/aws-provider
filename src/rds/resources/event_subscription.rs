...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, source_ids: Option<Vec<String>>, subscription_name: String, sns_topic_arn: String, enabled: Option<bool>, tags: Option<Vec<String>>, source_type: Option<String>, event_categories: Option<Vec<String>>) -> Result<String> {
