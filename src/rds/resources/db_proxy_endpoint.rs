...
impl<'a> Db_proxy_endpoint<'a> {
    ...
    pub async fn create(&self, vpc_subnet_ids: String, vpc_security_group_ids: Option<String>, endpoint_network_type: Option<String>, db_proxy_name: String, tags: Option<Vec<String>>, target_role: Option<String>, db_proxy_endpoint_name: String) -> Result<String> {
