...
impl<'a> Tenant_database<'a> {
    ...
    pub async fn create(&self, nchar_character_set_name: Option<String>, tags: Option<Vec<String>>, master_username: String, character_set_name: Option<String>, db_instance_identifier: String, tenant_db_name: String, master_user_secret_kms_key_id: Option<String>, master_user_password: Option<String>, manage_master_user_password: Option<bool>) -> Result<String> {
