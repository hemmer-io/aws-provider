...
impl<'a> Db_shard_group<'a> {
    ...
    pub async fn create(&self, db_cluster_identifier: String, publicly_accessible: Option<bool>, min_acu: Option<f64>, max_acu: f64, compute_redundancy: Option<i64>, db_shard_group_identifier: String, tags: Option<Vec<String>>) -> Result<String> {
