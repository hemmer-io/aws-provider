...
impl<'a> RdsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "db_cluster" => self.plan_db_cluster(current_state, desired_input).await,
            "event_subscription" => {
                self.plan_event_subscription(current_state, desired_input)
                    .await
            }
            "db_cluster_parameter_groups" => {
                self.plan_db_cluster_parameter_groups(current_state, desired_input)
                    .await
            }
            "source_regions" => self.plan_source_regions(current_state, desired_input).await,
            "reserved_db_instances_offerings" => {
                self.plan_reserved_db_instances_offerings(current_state, desired_input)
                    .await
            }
            "db_parameter_group" => {
                self.plan_db_parameter_group(current_state, desired_input)
                    .await
            }
            "db_snapshot_attributes" => {
                self.plan_db_snapshot_attributes(current_state, desired_input)
                    .await
            }
            "global_clusters" => {
                self.plan_global_clusters(current_state, desired_input)
                    .await
            }
            "db_cluster_automated_backups" => {
                self.plan_db_cluster_automated_backups(current_state, desired_input)
                    .await
            }
            "blue_green_deployment" => {
                self.plan_blue_green_deployment(current_state, desired_input)
                    .await
            }
            "db_proxy_endpoints" => {
                self.plan_db_proxy_endpoints(current_state, desired_input)
                    .await
            }
            "db_clusters" => self.plan_db_clusters(current_state, desired_input).await,
            "db_instances" => self.plan_db_instances(current_state, desired_input).await,
            "option_group_options" => {
                self.plan_option_group_options(current_state, desired_input)
                    .await
            }
            "db_proxy_target_groups" => {
                self.plan_db_proxy_target_groups(current_state, desired_input)
                    .await
            }
            "db_snapshot" => self.plan_db_snapshot(current_state, desired_input).await,
            "db_cluster_parameters" => {
                self.plan_db_cluster_parameters(current_state, desired_input)
                    .await
            }
            "db_recommendations" => {
                self.plan_db_recommendations(current_state, desired_input)
                    .await
            }
            "db_parameter_groups" => {
                self.plan_db_parameter_groups(current_state, desired_input)
                    .await
            }
            "event_categories" => {
            ...
            "db_security_groups" => {
                self.plan_db_security_groups(current_state, desired_input)
                    .await
            }
            "db_cluster_snapshot_attributes" => {
                self.plan_db_cluster_snapshot_attributes(current_state, desired_input)
                    .await
            }
            "tenant_databases" => {
                self.plan_tenant_databases(current_state, desired_input)
                    .await
            }
            "custom_db_engine_version" => {
                self.plan_custom_db_engine_version(current_state, desired_input)
                    .await
            }
            "valid_db_instance_modifications" => {
                self.plan_valid_db_instance_modifications(current_state, desired_input)
                    .await
            }
            "db_major_engine_versions" => {
                self.plan_db_major_engine_versions(current_state, desired_input)
                    .await
            }
            "db_cluster_snapshot" => {
                self.plan_db_cluster_snapshot(current_state, desired_input)
                    .await
            }
            "db_proxies" => self.plan_db_proxies(current_state, desired_input).await,
            "db_instance" => self.plan_db_instance(current_state, desired_input).await,
            "db_security_group" => {
                self.plan_db_security_group(current_state, desired_input)
                    .await
            }
            "db_cluster_backtracks" => {
                self.plan_db_cluster_backtracks(current_state, desired_input)
                    .await
            }
            "db_engine_versions" => {
                self.plan_db_engine_versions(current_state, desired_input)
                    .await
            }
            "events" => self.plan_events(current_state, desired_input).await,
            "blue_green_deployments" => {
                self.plan_blue_green_deployments(current_state, desired_input)
                    .await
            }
            "db_instance_automated_backup" => {
                self.plan_db_instance_automated_backup(current_state, desired_input)
                    .await
            }
            "integrations" => self.plan_integrations(current_state, desired_input).await,
            "db_snapshot_tenant_databases" => {
                self.plan_db_snapshot_tenant_databases(current_state, desired_input)
                    .await
            }
            "db_instance_read_replica" => {
                self.plan_db_instance_read_replica(current_state, desired_input)
                    .await
            }
            "db_cluster_snapshots" => {
                self.plan_db_cluster_snapshots(current_state, desired_input)
                    .await
            }
            "db_instance_automated_backups" => {
                self.plan_db_instance_automated_backups(current_state, desired_input)
                    .await
            }
            "pending_maintenance_actions" => {
                self.plan_pending_maintenance_actions(current_state, desired_input)
                    .await
            }
            "db_shard_group" => self.plan_db_shard_group(current_state, desired_input).await,
            "db_log_files" => self.plan_db_log_files(current_state, desired_input).await,
            "engine_default_parameters" => {
                self.plan_engine_default_parameters(current_state, desired_input)
                    .await
            }
            "db_proxy_endpoint" => {
                self.plan_db_proxy_endpoint(current_state, desired_input)
                    .await
            }
            "integration" => self.plan_integration(current_state, desired_input).await,
            "db_subnet_group" => {
                self.plan_db_subnet_group(current_state, desired_input)
                    .await
            }
            "option_groups" => self.plan_option_groups(current_state, desired_input).await,
            "db_proxy" => self.plan_db_proxy(current_state, desired_input).await,
            "db_subnet_groups" => {
                self.plan_db_subnet_groups(current_state, desired_input)
                    .await
            }
            "tenant_database" => {
                self.plan_tenant_database(current_state, desired_input)
                    .await
            }
            "db_parameters" => self.plan_db_parameters(current_state, desired_input).await,
            "db_snapshots" => self.plan_db_snapshots(current_state, desired_input).await,
            "global_cluster" => self.plan_global_cluster(current_state, desired_input).await,
            "db_proxy_targets" => {
                self.plan_db_proxy_targets(current_state, desired_input)
                    .await
            }
            "db_cluster_parameter_group" => {
                self.plan_db_cluster_parameter_group(current_state, desired_input)
                    .await
            }
            "option_group" => self.plan_option_group(current_state, desired_input).await,
            "db_cluster_endpoint" => {
                self.plan_db_cluster_endpoint(current_state, desired_input)
                    .await
            }
            "db_cluster_endpoints" => {
                self.plan_db_cluster_endpoints(current_state, desired_input)
                    .await
            }
            "event_subscriptions" => {
            ...
            "db_cluster_automated_backup" => {
                self.plan_db_cluster_automated_backup(current_state, desired_input)
                    .await
            }
            "orderable_db_instance_options" => {
                self.plan_orderable_db_instance_options(current_state, desired_input)
                    .await
            }
            "engine_default_cluster_parameters" => {
                self.plan_engine_default_cluster_parameters(current_state, desired_input)
                    .await
            }
            ...
            "db_shard_groups" => {
                self.plan_db_shard_groups(current_state, desired_input)
                    .await
            }
            "reserved_db_instances" => {
                self.plan_reserved_db_instances(current_state, desired_input)
                    .await
            }
            "account_attributes" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "db_cluster" => self.create_db_cluster(input).await,
            "event_subscription" => self.create_event_subscription(input).await,
            "db_cluster_parameter_groups" => self.create_db_cluster_parameter_groups(input).await,
            "source_regions" => self.create_source_regions(input).await,
            "reserved_db_instances_offerings" => {
                self.create_reserved_db_instances_offerings(input).await
            }
            "db_parameter_group" => self.create_db_parameter_group(input).await,
            "db_snapshot_attributes" => self.create_db_snapshot_attributes(input).await,
            "global_clusters" => self.create_global_clusters(input).await,
            "db_cluster_automated_backups" => self.create_db_cluster_automated_backups(input).await,
            "blue_green_deployment" => self.create_blue_green_deployment(input).await,
            "db_proxy_endpoints" => self.create_db_proxy_endpoints(input).await,
            "db_clusters" => self.create_db_clusters(input).await,
            "db_instances" => self.create_db_instances(input).await,
            "option_group_options" => self.create_option_group_options(input).await,
            "db_proxy_target_groups" => self.create_db_proxy_target_groups(input).await,
            "db_snapshot" => self.create_db_snapshot(input).await,
            "db_cluster_parameters" => self.create_db_cluster_parameters(input).await,
            "db_recommendations" => self.create_db_recommendations(input).await,
            "db_parameter_groups" => self.create_db_parameter_groups(input).await,
            "event_categories" => self.create_event_categories(input).await,
            "db_security_groups" => self.create_db_security_groups(input).await,
            "db_cluster_snapshot_attributes" => {
                self.create_db_cluster_snapshot_attributes(input).await
            }
            "tenant_databases" => self.create_tenant_databases(input).await,
            "custom_db_engine_version" => self.create_custom_db_engine_version(input).await,
            "valid_db_instance_modifications" => {
                self.create_valid_db_instance_modifications(input).await
            }
            "db_major_engine_versions" => self.create_db_major_engine_versions(input).await,
            "db_cluster_snapshot" => self.create_db_cluster_snapshot(input).await,
            "db_proxies" => self.create_db_proxies(input).await,
            "db_instance" => self.create_db_instance(input).await,
            "db_security_group" => self.create_db_security_group(input).await,
            "db_cluster_backtracks" => self.create_db_cluster_backtracks(input).await,
            "db_engine_versions" => self.create_db_engine_versions(input).await,
            "events" => self.create_events(input).await,
            "blue_green_deployments" => self.create_blue_green_deployments(input).await,
            "db_instance_automated_backup" => self.create_db_instance_automated_backup(input).await,
            "integrations" => self.create_integrations(input).await,
            "db_snapshot_tenant_databases" => self.create_db_snapshot_tenant_databases(input).await,
            "db_instance_read_replica" => self.create_db_instance_read_replica(input).await,
            "db_cluster_snapshots" => self.create_db_cluster_snapshots(input).await,
            "db_instance_automated_backups" => {
                self.create_db_instance_automated_backups(input).await
            }
            "pending_maintenance_actions" => self.create_pending_maintenance_actions(input).await,
            "db_shard_group" => self.create_db_shard_group(input).await,
            "db_log_files" => self.create_db_log_files(input).await,
            "engine_default_parameters" => self.create_engine_default_parameters(input).await,
            "db_proxy_endpoint" => self.create_db_proxy_endpoint(input).await,
            "integration" => self.create_integration(input).await,
            "db_subnet_group" => self.create_db_subnet_group(input).await,
            "option_groups" => self.create_option_groups(input).await,
            "db_proxy" => self.create_db_proxy(input).await,
            "db_subnet_groups" => self.create_db_subnet_groups(input).await,
            "tenant_database" => self.create_tenant_database(input).await,
            "db_parameters" => self.create_db_parameters(input).await,
            "db_snapshots" => self.create_db_snapshots(input).await,
            "global_cluster" => self.create_global_cluster(input).await,
            "db_proxy_targets" => self.create_db_proxy_targets(input).await,
            "db_cluster_parameter_group" => self.create_db_cluster_parameter_group(input).await,
            "option_group" => self.create_option_group(input).await,
            "db_cluster_endpoint" => self.create_db_cluster_endpoint(input).await,
            "db_cluster_endpoints" => self.create_db_cluster_endpoints(input).await,
            "event_subscriptions" => self.create_event_subscriptions(input).await,
            "db_cluster_automated_backup" => self.create_db_cluster_automated_backup(input).await,
            "orderable_db_instance_options" => {
            ...
            "db_shard_groups" => self.create_db_shard_groups(input).await,
            "reserved_db_instances" => self.create_reserved_db_instances(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "db_cluster" => self.read_db_cluster(id).await,
            "event_subscription" => self.read_event_subscription(id).await,
            "db_cluster_parameter_groups" => self.read_db_cluster_parameter_groups(id).await,
            "source_regions" => self.read_source_regions(id).await,
            "reserved_db_instances_offerings" => {
                self.read_reserved_db_instances_offerings(id).await
            }
            "db_parameter_group" => self.read_db_parameter_group(id).await,
            "db_snapshot_attributes" => self.read_db_snapshot_attributes(id).await,
            "global_clusters" => self.read_global_clusters(id).await,
            "db_cluster_automated_backups" => self.read_db_cluster_automated_backups(id).await,
            "blue_green_deployment" => self.read_blue_green_deployment(id).await,
            "db_proxy_endpoints" => self.read_db_proxy_endpoints(id).await,
            "db_clusters" => self.read_db_clusters(id).await,
            "db_instances" => self.read_db_instances(id).await,
            "option_group_options" => self.read_option_group_options(id).await,
            "db_proxy_target_groups" => self.read_db_proxy_target_groups(id).await,
            "db_snapshot" => self.read_db_snapshot(id).await,
            "db_cluster_parameters" => self.read_db_cluster_parameters(id).await,
            "db_recommendations" => self.read_db_recommendations(id).await,
            "db_parameter_groups" => self.read_db_parameter_groups(id).await,
            "event_categories" => self.read_event_categories(id).await,
            "db_security_groups" => self.read_db_security_groups(id).await,
            "db_cluster_snapshot_attributes" => self.read_db_cluster_snapshot_attributes(id).await,
            "tenant_databases" => self.read_tenant_databases(id).await,
            "custom_db_engine_version" => self.read_custom_db_engine_version(id).await,
            "valid_db_instance_modifications" => {
                self.read_valid_db_instance_modifications(id).await
            }
            "db_major_engine_versions" => self.read_db_major_engine_versions(id).await,
            "db_cluster_snapshot" => self.read_db_cluster_snapshot(id).await,
            "db_proxies" => self.read_db_proxies(id).await,
            "db_instance" => self.read_db_instance(id).await,
            "db_security_group" => self.read_db_security_group(id).await,
            "db_cluster_backtracks" => self.read_db_cluster_backtracks(id).await,
            "db_engine_versions" => self.read_db_engine_versions(id).await,
            "events" => self.read_events(id).await,
            "blue_green_deployments" => self.read_blue_green_deployments(id).await,
            "db_instance_automated_backup" => self.read_db_instance_automated_backup(id).await,
            "integrations" => self.read_integrations(id).await,
            "db_snapshot_tenant_databases" => self.read_db_snapshot_tenant_databases(id).await,
            "db_instance_read_replica" => self.read_db_instance_read_replica(id).await,
            "db_cluster_snapshots" => self.read_db_cluster_snapshots(id).await,
            "db_instance_automated_backups" => self.read_db_instance_automated_backups(id).await,
            "pending_maintenance_actions" => self.read_pending_maintenance_actions(id).await,
            "db_shard_group" => self.read_db_shard_group(id).await,
            "db_log_files" => self.read_db_log_files(id).await,
            "engine_default_parameters" => self.read_engine_default_parameters(id).await,
            "db_proxy_endpoint" => self.read_db_proxy_endpoint(id).await,
            "integration" => self.read_integration(id).await,
            "db_subnet_group" => self.read_db_subnet_group(id).await,
            "option_groups" => self.read_option_groups(id).await,
            "db_proxy" => self.read_db_proxy(id).await,
            "db_subnet_groups" => self.read_db_subnet_groups(id).await,
            "tenant_database" => self.read_tenant_database(id).await,
            "db_parameters" => self.read_db_parameters(id).await,
            "db_snapshots" => self.read_db_snapshots(id).await,
            "global_cluster" => self.read_global_cluster(id).await,
            "db_proxy_targets" => self.read_db_proxy_targets(id).await,
            "db_cluster_parameter_group" => self.read_db_cluster_parameter_group(id).await,
            "option_group" => self.read_option_group(id).await,
            "db_cluster_endpoint" => self.read_db_cluster_endpoint(id).await,
            "db_cluster_endpoints" => self.read_db_cluster_endpoints(id).await,
            "event_subscriptions" => self.read_event_subscriptions(id).await,
            "db_cluster_automated_backup" => self.read_db_cluster_automated_backup(id).await,
            "orderable_db_instance_options" => self.read_orderable_db_instance_options(id).await,
            "engine_default_cluster_parameters" => {
            ...
            "db_shard_groups" => self.read_db_shard_groups(id).await,
            "reserved_db_instances" => self.read_reserved_db_instances(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "db_cluster" => self.update_db_cluster(id, input).await,
            "event_subscription" => self.update_event_subscription(id, input).await,
            "db_cluster_parameter_groups" => {
                self.update_db_cluster_parameter_groups(id, input).await
            }
            "source_regions" => self.update_source_regions(id, input).await,
            "reserved_db_instances_offerings" => {
                self.update_reserved_db_instances_offerings(id, input).await
            }
            "db_parameter_group" => self.update_db_parameter_group(id, input).await,
            "db_snapshot_attributes" => self.update_db_snapshot_attributes(id, input).await,
            "global_clusters" => self.update_global_clusters(id, input).await,
            "db_cluster_automated_backups" => {
                self.update_db_cluster_automated_backups(id, input).await
            }
            "blue_green_deployment" => self.update_blue_green_deployment(id, input).await,
            "db_proxy_endpoints" => self.update_db_proxy_endpoints(id, input).await,
            "db_clusters" => self.update_db_clusters(id, input).await,
            "db_instances" => self.update_db_instances(id, input).await,
            "option_group_options" => self.update_option_group_options(id, input).await,
            "db_proxy_target_groups" => self.update_db_proxy_target_groups(id, input).await,
            "db_snapshot" => self.update_db_snapshot(id, input).await,
            "db_cluster_parameters" => self.update_db_cluster_parameters(id, input).await,
            "db_recommendations" => self.update_db_recommendations(id, input).await,
            "db_parameter_groups" => self.update_db_parameter_groups(id, input).await,
            "event_categories" => self.update_event_categories(id, input).await,
            "db_security_groups" => self.update_db_security_groups(id, input).await,
            "db_cluster_snapshot_attributes" => {
                self.update_db_cluster_snapshot_attributes(id, input).await
            }
            "tenant_databases" => self.update_tenant_databases(id, input).await,
            "custom_db_engine_version" => self.update_custom_db_engine_version(id, input).await,
            "valid_db_instance_modifications" => {
                self.update_valid_db_instance_modifications(id, input).await
            }
            "db_major_engine_versions" => self.update_db_major_engine_versions(id, input).await,
            "db_cluster_snapshot" => self.update_db_cluster_snapshot(id, input).await,
            "db_proxies" => self.update_db_proxies(id, input).await,
            "db_instance" => self.update_db_instance(id, input).await,
            "db_security_group" => self.update_db_security_group(id, input).await,
            "db_cluster_backtracks" => self.update_db_cluster_backtracks(id, input).await,
            "db_engine_versions" => self.update_db_engine_versions(id, input).await,
            "events" => self.update_events(id, input).await,
            "blue_green_deployments" => self.update_blue_green_deployments(id, input).await,
            "db_instance_automated_backup" => {
            ...
            "db_instance_read_replica" => self.update_db_instance_read_replica(id, input).await,
            "db_cluster_snapshots" => self.update_db_cluster_snapshots(id, input).await,
            "db_instance_automated_backups" => {
            ...
            "db_shard_group" => self.update_db_shard_group(id, input).await,
            "db_log_files" => self.update_db_log_files(id, input).await,
            "engine_default_parameters" => self.update_engine_default_parameters(id, input).await,
            "db_proxy_endpoint" => self.update_db_proxy_endpoint(id, input).await,
            "integration" => self.update_integration(id, input).await,
            "db_subnet_group" => self.update_db_subnet_group(id, input).await,
            "option_groups" => self.update_option_groups(id, input).await,
            "db_proxy" => self.update_db_proxy(id, input).await,
            "db_subnet_groups" => self.update_db_subnet_groups(id, input).await,
            "tenant_database" => self.update_tenant_database(id, input).await,
            "db_parameters" => self.update_db_parameters(id, input).await,
            "db_snapshots" => self.update_db_snapshots(id, input).await,
            "global_cluster" => self.update_global_cluster(id, input).await,
            "db_proxy_targets" => self.update_db_proxy_targets(id, input).await,
            "db_cluster_parameter_group" => self.update_db_cluster_parameter_group(id, input).await,
            "option_group" => self.update_option_group(id, input).await,
            "db_cluster_endpoint" => self.update_db_cluster_endpoint(id, input).await,
            "db_cluster_endpoints" => self.update_db_cluster_endpoints(id, input).await,
            ...
            "engine_default_cluster_parameters" => {
                self.update_engine_default_cluster_parameters(id, input)
                    .await
            }
            "export_tasks" => self.update_export_tasks(id, input).await,
            "certificates" => self.update_certificates(id, input).await,
            "db_shard_groups" => self.update_db_shard_groups(id, input).await,
            "reserved_db_instances" => self.update_reserved_db_instances(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "db_cluster" => self.delete_db_cluster(id).await,
            "event_subscription" => self.delete_event_subscription(id).await,
            "db_cluster_parameter_groups" => self.delete_db_cluster_parameter_groups(id).await,
            "source_regions" => self.delete_source_regions(id).await,
            "reserved_db_instances_offerings" => {
                self.delete_reserved_db_instances_offerings(id).await
            }
            "db_parameter_group" => self.delete_db_parameter_group(id).await,
            "db_snapshot_attributes" => self.delete_db_snapshot_attributes(id).await,
            "global_clusters" => self.delete_global_clusters(id).await,
            "db_cluster_automated_backups" => self.delete_db_cluster_automated_backups(id).await,
            "blue_green_deployment" => self.delete_blue_green_deployment(id).await,
            "db_proxy_endpoints" => self.delete_db_proxy_endpoints(id).await,
            "db_clusters" => self.delete_db_clusters(id).await,
            "db_instances" => self.delete_db_instances(id).await,
            "option_group_options" => self.delete_option_group_options(id).await,
            "db_proxy_target_groups" => self.delete_db_proxy_target_groups(id).await,
            "db_snapshot" => self.delete_db_snapshot(id).await,
            "db_cluster_parameters" => self.delete_db_cluster_parameters(id).await,
            "db_recommendations" => self.delete_db_recommendations(id).await,
            "db_parameter_groups" => self.delete_db_parameter_groups(id).await,
            "event_categories" => self.delete_event_categories(id).await,
            "db_security_groups" => self.delete_db_security_groups(id).await,
            "db_cluster_snapshot_attributes" => {
                self.delete_db_cluster_snapshot_attributes(id).await
            }
            "tenant_databases" => self.delete_tenant_databases(id).await,
            "custom_db_engine_version" => self.delete_custom_db_engine_version(id).await,
            "valid_db_instance_modifications" => {
                self.delete_valid_db_instance_modifications(id).await
            }
            "db_major_engine_versions" => self.delete_db_major_engine_versions(id).await,
            "db_cluster_snapshot" => self.delete_db_cluster_snapshot(id).await,
            "db_proxies" => self.delete_db_proxies(id).await,
            "db_instance" => self.delete_db_instance(id).await,
            "db_security_group" => self.delete_db_security_group(id).await,
            "db_cluster_backtracks" => self.delete_db_cluster_backtracks(id).await,
            "db_engine_versions" => self.delete_db_engine_versions(id).await,
            "events" => self.delete_events(id).await,
            "blue_green_deployments" => self.delete_blue_green_deployments(id).await,
            "db_instance_automated_backup" => self.delete_db_instance_automated_backup(id).await,
            "integrations" => self.delete_integrations(id).await,
            "db_snapshot_tenant_databases" => self.delete_db_snapshot_tenant_databases(id).await,
            "db_instance_read_replica" => self.delete_db_instance_read_replica(id).await,
            "db_cluster_snapshots" => self.delete_db_cluster_snapshots(id).await,
            "db_instance_automated_backups" => self.delete_db_instance_automated_backups(id).await,
            "pending_maintenance_actions" => self.delete_pending_maintenance_actions(id).await,
            "db_shard_group" => self.delete_db_shard_group(id).await,
            "db_log_files" => self.delete_db_log_files(id).await,
            "engine_default_parameters" => self.delete_engine_default_parameters(id).await,
            "db_proxy_endpoint" => self.delete_db_proxy_endpoint(id).await,
            "integration" => self.delete_integration(id).await,
            "db_subnet_group" => self.delete_db_subnet_group(id).await,
            "option_groups" => self.delete_option_groups(id).await,
            "db_proxy" => self.delete_db_proxy(id).await,
            "db_subnet_groups" => self.delete_db_subnet_groups(id).await,
            "tenant_database" => self.delete_tenant_database(id).await,
            "db_parameters" => self.delete_db_parameters(id).await,
            "db_snapshots" => self.delete_db_snapshots(id).await,
            "global_cluster" => self.delete_global_cluster(id).await,
            "db_proxy_targets" => self.delete_db_proxy_targets(id).await,
            "db_cluster_parameter_group" => self.delete_db_cluster_parameter_group(id).await,
            "option_group" => self.delete_option_group(id).await,
            "db_cluster_endpoint" => self.delete_db_cluster_endpoint(id).await,
            "db_cluster_endpoints" => self.delete_db_cluster_endpoints(id).await,
            "event_subscriptions" => self.delete_event_subscriptions(id).await,
            "db_cluster_automated_backup" => self.delete_db_cluster_automated_backup(id).await,
            "orderable_db_instance_options" => self.delete_orderable_db_instance_options(id).await,
            "engine_default_cluster_parameters" => {
            ...
            "db_shard_groups" => self.delete_db_shard_groups(id).await,
            "reserved_db_instances" => self.delete_reserved_db_instances(id).await,
    ...
    async fn create_db_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let db_cluster_instance_class =
                input.get_optional_string("db_cluster_instance_class")?;
            ...
            let replication_source_identifier =
                input.get_optional_string("replication_source_identifier")?;
            ...
            let performance_insights_kms_key_id =
                input.get_optional_string("performance_insights_kms_key_id")?;
            ...
            let performance_insights_retention_period =
                input.get_optional_string("performance_insights_retention_period")?;
            let character_set_name = input.get_optional_string("character_set_name")?;
            let db_cluster_parameter_group_name =
                input.get_optional_string("db_cluster_parameter_group_name")?;
            let rds_custom_cluster_configuration =
                input.get_optional_string("rds_custom_cluster_configuration")?;
            let monitoring_interval = input.get_optional_string("monitoring_interval")?;
            let domain = input.get_optional_string("domain")?;
            let master_user_authentication_type =
                input.get_optional_string("master_user_authentication_type")?;
            let network_type = input.get_optional_string("network_type")?;
            let enable_global_write_forwarding =
                input.get_optional_string("enable_global_write_forwarding")?;
            ...
            let auto_minor_version_upgrade =
                input.get_optional_string("auto_minor_version_upgrade")?;
            let master_user_secret_kms_key_id =
                input.get_optional_string("master_user_secret_kms_key_id")?;
            let enable_performance_insights =
                input.get_optional_string("enable_performance_insights")?;
            ...
            let manage_master_user_password =
                input.get_optional_string("manage_master_user_password")?;
            let db_system_id = input.get_optional_string("db_system_id")?;
            let global_cluster_identifier =
                input.get_optional_string("global_cluster_identifier")?;
            let domain_iam_role_name = input.get_optional_string("domain_iam_role_name")?;
            let ca_certificate_identifier =
                input.get_optional_string("ca_certificate_identifier")?;
            let storage_type = input.get_optional_string("storage_type")?;
            let enable_local_write_forwarding =
                input.get_optional_string("enable_local_write_forwarding")?;
            ...
            let serverless_v2_scaling_configuration =
                input.get_optional_string("serverless_v2_scaling_configuration")?;
            let preferred_backup_window = input.get_optional_string("preferred_backup_window")?;
            let enable_cloudwatch_logs_exports =
                input.get_optional_string("enable_cloudwatch_logs_exports")?;
            let enable_limitless_database =
                input.get_optional_string("enable_limitless_database")?;
            let enable_iam_database_authentication =
                input.get_optional_string("enable_iam_database_authentication")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    database_insights_mode.unwrap_or_default(),
                )
                .with_field("master_username", master_username.unwrap_or_default())
                .with_field(
                    "db_cluster_instance_class",
                    db_cluster_instance_class.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    engine_lifecycle_support.unwrap_or_default(),
                )
                .with_field("kms_key_id", kms_key_id.unwrap_or_default())
                .with_field("allocated_storage", allocated_storage.unwrap_or_default())
                .with_field(
                    "db_cluster_identifier",
                    db_cluster_identifier.unwrap_or_default(),
                )
                .with_field(
                    "replication_source_identifier",
                    replication_source_identifier.unwrap_or_default(),
                )
                .with_field("iops", iops.unwrap_or_default())
                .with_field(
                    "db_subnet_group_name",
                    db_subnet_group_name.unwrap_or_default(),
                )
                .with_field(
                    "copy_tags_to_snapshot",
                    copy_tags_to_snapshot.unwrap_or_default(),
                )
                ...
                .with_field(
                    "deletion_protection",
                    deletion_protection.unwrap_or_default(),
                )
                .with_field(
                    "performance_insights_kms_key_id",
                    performance_insights_kms_key_id.unwrap_or_default(),
                )
                .with_field(
                ...
                .with_field(
                    ...
                    scaling_configuration.unwrap_or_default(),
                )
                .with_field(
                    "publicly_accessible",
                ...
                .with_field(
                    ...
                    performance_insights_retention_period.unwrap_or_default(),
                )
                .with_field("character_set_name", character_set_name.unwrap_or_default())
                .with_field(
                    "db_cluster_parameter_group_name",
                    db_cluster_parameter_group_name.unwrap_or_default(),
                )
                .with_field(
                    "rds_custom_cluster_configuration",
                    rds_custom_cluster_configuration.unwrap_or_default(),
                )
                .with_field(
                    "monitoring_interval",
                    monitoring_interval.unwrap_or_default(),
                )
                .with_field("domain", domain.unwrap_or_default())
                .with_field(
                    "master_user_authentication_type",
                    master_user_authentication_type.unwrap_or_default(),
                )
                .with_field("network_type", network_type.unwrap_or_default())
                .with_field(
                    "enable_global_write_forwarding",
                    enable_global_write_forwarding.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    cluster_scalability_type.unwrap_or_default(),
                )
                .with_field(
                ...
                .with_field(
                    ...
                    auto_minor_version_upgrade.unwrap_or_default(),
                )
                .with_field(
                    "master_user_secret_kms_key_id",
                    master_user_secret_kms_key_id.unwrap_or_default(),
                )
                .with_field(
                    "enable_performance_insights",
                    enable_performance_insights.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    enable_http_endpoint.unwrap_or_default(),
                )
                .with_field("storage_encrypted", storage_encrypted.unwrap_or_default())
                .with_field("engine", engine.unwrap_or_default())
                .with_field(
                    "manage_master_user_password",
                    manage_master_user_password.unwrap_or_default(),
                )
                .with_field("db_system_id", db_system_id.unwrap_or_default())
                .with_field(
                    "global_cluster_identifier",
                    global_cluster_identifier.unwrap_or_default(),
                )
                .with_field(
                    "domain_iam_role_name",
                    domain_iam_role_name.unwrap_or_default(),
                )
                .with_field(
                    "ca_certificate_identifier",
                    ca_certificate_identifier.unwrap_or_default(),
                )
                .with_field("storage_type", storage_type.unwrap_or_default())
                .with_field(
                    "enable_local_write_forwarding",
                    enable_local_write_forwarding.unwrap_or_default(),
                )
                .with_field(
                    "monitoring_role_arn",
                    monitoring_role_arn.unwrap_or_default(),
                )
                .with_field(
                    "backup_retention_period",
                    backup_retention_period.unwrap_or_default(),
                )
                .with_field(
                    "serverless_v2_scaling_configuration",
                    serverless_v2_scaling_configuration.unwrap_or_default(),
                )
                .with_field(
                ...
                .with_field(
                    ...
                    enable_cloudwatch_logs_exports.unwrap_or_default(),
                )
                .with_field(
                    "enable_limitless_database",
                    enable_limitless_database.unwrap_or_default(),
                )
                .with_field(
                    "enable_iam_database_authentication",
                    enable_iam_database_authentication.unwrap_or_default(),
                ))
        })
    }

    /// Read a db_cluster resource
    async fn read_db_cluster(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_db_cluster(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let database_insights_mode = input.get_optional_string("database_insights_mode")?;
            let master_username = input.get_optional_string("master_username")?;
    ...
    async fn delete_db_cluster(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_db_cluster_parameter_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_cluster_parameter_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_source_regions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_source_regions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_source_regions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_reserved_db_instances_offerings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_reserved_db_instances_offerings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_parameter_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    db_parameter_group_name.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "db_parameter_group_family",
                    db_parameter_group_family.unwrap_or_default(),
                )
    ...
    async fn read_db_parameter_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_parameter_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_snapshot_attributes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_snapshot_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_snapshot_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_global_clusters(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_global_clusters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_global_clusters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_db_cluster_automated_backups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_cluster_automated_backups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_blue_green_deployment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let upgrade_target_storage_config =
                input.get_optional_string("upgrade_target_storage_config")?;
            ...
            let target_storage_throughput =
                input.get_optional_string("target_storage_throughput")?;
            let source = input.get_string("source")?;
            let target_engine_version = input.get_optional_string("target_engine_version")?;
            let target_db_cluster_parameter_group_name =
                input.get_optional_string("target_db_cluster_parameter_group_name")?;
            let target_db_parameter_group_name =
                input.get_optional_string("target_db_parameter_group_name")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    blue_green_deployment_name.unwrap_or_default(),
                )
                .with_field(
                    "target_db_instance_class",
                    target_db_instance_class.unwrap_or_default(),
                )
                .with_field(
                    "upgrade_target_storage_config",
                    upgrade_target_storage_config.unwrap_or_default(),
                )
                .with_field("target_iops", target_iops.unwrap_or_default())
                .with_field(
                    "target_storage_type",
                    target_storage_type.unwrap_or_default(),
                )
                .with_field(
                    "target_storage_throughput",
                    target_storage_throughput.unwrap_or_default(),
                )
                .with_field("source", source.unwrap_or_default())
                .with_field(
                    "target_engine_version",
                    target_engine_version.unwrap_or_default(),
                )
                .with_field(
                    "target_db_cluster_parameter_group_name",
                    target_db_cluster_parameter_group_name.unwrap_or_default(),
                )
                .with_field(
                    "target_db_parameter_group_name",
                    target_db_parameter_group_name.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "target_allocated_storage",
                    target_allocated_storage.unwrap_or_default(),
                ))
        })
    }

    /// Read a blue_green_deployment resource
    async fn read_blue_green_deployment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_blue_green_deployment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_proxy_endpoints(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_proxy_endpoints(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_proxy_endpoints(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_clusters(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_clusters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn update_db_clusters(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_db_clusters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_instances(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_instances(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn update_db_instances(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_db_instances(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_option_group_options(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_option_group_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_option_group_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_proxy_target_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_proxy_target_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_proxy_target_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_snapshot(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    db_instance_identifier.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "db_snapshot_identifier",
                    db_snapshot_identifier.unwrap_or_default(),
                ))
        })
    }

    /// Read a db_snapshot resource
    async fn read_db_snapshot(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn update_db_snapshot(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let db_instance_identifier = input.get_string("db_instance_identifier")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_db_snapshot(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_cluster_parameters(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_cluster_parameters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_cluster_parameters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_recommendations(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_recommendations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_recommendations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_parameter_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_parameter_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_parameter_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_security_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_security_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_security_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_db_cluster_snapshot_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_cluster_snapshot_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_tenant_databases(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_tenant_databases(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_tenant_databases(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_custom_db_engine_version(
        ...
        self.provider.runtime().block_on(async {
            ...
            let database_installation_files_s3_prefix =
                input.get_optional_string("database_installation_files_s3_prefix")?;
            let use_aws_provided_latest_image =
                input.get_optional_string("use_aws_provided_latest_image")?;
            let engine_version = input.get_string("engine_version")?;
            let engine = input.get_string("engine")?;
            let source_custom_db_engine_version_identifier =
                input.get_optional_string("source_custom_db_engine_version_identifier")?;
            let manifest = input.get_optional_string("manifest")?;
            let database_installation_files_s3_bucket_name =
                input.get_optional_string("database_installation_files_s3_bucket_name")?;
            let kms_key_id = input.get_optional_string("kms_key_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    database_installation_files_s3_prefix.unwrap_or_default(),
                )
                .with_field(
                    "use_aws_provided_latest_image",
                    use_aws_provided_latest_image.unwrap_or_default(),
                )
                .with_field("engine_version", engine_version.unwrap_or_default())
                .with_field("engine", engine.unwrap_or_default())
                .with_field(
                    "source_custom_db_engine_version_identifier",
                    source_custom_db_engine_version_identifier.unwrap_or_default(),
                )
                .with_field("manifest", manifest.unwrap_or_default())
                .with_field(
                    "database_installation_files_s3_bucket_name",
                    database_installation_files_s3_bucket_name.unwrap_or_default(),
                )
                .with_field("kms_key_id", kms_key_id.unwrap_or_default()))
        })
    }
    ...
    async fn read_custom_db_engine_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_custom_db_engine_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_valid_db_instance_modifications(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_valid_db_instance_modifications(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_db_major_engine_versions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_major_engine_versions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_cluster_snapshot(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let db_cluster_snapshot_identifier =
                input.get_string("db_cluster_snapshot_identifier")?;
            let db_cluster_identifier = input.get_string("db_cluster_identifier")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    db_cluster_snapshot_identifier.unwrap_or_default(),
                )
                .with_field(
                    "db_cluster_identifier",
                    db_cluster_identifier.unwrap_or_default(),
    ...
    async fn read_db_cluster_snapshot(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_cluster_snapshot(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_proxies(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_proxies(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn update_db_proxies(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_db_proxies(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let vpc_security_group_ids = input.get_optional_string("vpc_security_group_ids")?;
            ...
            let iops = input.get_optional_string("iops")?;
            let custom_iam_instance_profile =
                input.get_optional_string("custom_iam_instance_profile")?;
            let publicly_accessible = input.get_optional_string("publicly_accessible")?;
            let performance_insights_retention_period =
                input.get_optional_string("performance_insights_retention_period")?;
            let performance_insights_kms_key_id =
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    max_allocated_storage.unwrap_or_default(),
                )
                .with_field(
                    "deletion_protection",
                    deletion_protection.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    nchar_character_set_name.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    tde_credential_password.unwrap_or_default(),
                )
                .with_field("character_set_name", character_set_name.unwrap_or_default())
                .with_field(
                    "backup_retention_period",
                ...
                .with_field(
                    ...
                    enable_customer_owned_ip.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    custom_iam_instance_profile.unwrap_or_default(),
                )
                .with_field(
                    "publicly_accessible",
                    publicly_accessible.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    dedicated_log_volume.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    domain_auth_secret_arn.unwrap_or_default(),
                )
                .with_field("master_username", master_username.unwrap_or_default())
                .with_field(
                    "enable_performance_insights",
    ...
    async fn read_db_instance(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn update_db_instance(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let vpc_security_group_ids = input.get_optional_string("vpc_security_group_ids")?;
            let master_user_authentication_type =
    ...
    async fn delete_db_instance(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_security_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let db_security_group_description =
                input.get_string("db_security_group_description")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    db_security_group_description.unwrap_or_default(),
                )
                .with_field(
                    "db_security_group_name",
                    db_security_group_name.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default()))
        })
    }
    ...
    async fn read_db_security_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_security_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_cluster_backtracks(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_cluster_backtracks(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_cluster_backtracks(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_engine_versions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_engine_versions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_engine_versions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_blue_green_deployments(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_blue_green_deployments(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_blue_green_deployments(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_db_instance_automated_backup(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_instance_automated_backup(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_db_snapshot_tenant_databases(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_snapshot_tenant_databases(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_instance_read_replica(
        ...
        self.provider.runtime().block_on(async {
            ...
            let source_db_instance_identifier =
                input.get_optional_string("source_db_instance_identifier")?;
            let availability_zone = input.get_optional_string("availability_zone")?;
            let backup_target = input.get_optional_string("backup_target")?;
            ...
            let source_db_cluster_identifier =
                input.get_optional_string("source_db_cluster_identifier")?;
            let domain_iam_role_name = input.get_optional_string("domain_iam_role_name")?;
            let enable_customer_owned_ip = input.get_optional_string("enable_customer_owned_ip")?;
            let publicly_accessible = input.get_optional_string("publicly_accessible")?;
            let multi_az = input.get_optional_string("multi_az")?;
            ...
            let network_type = input.get_optional_string("network_type")?;
            let max_allocated_storage = input.get_optional_string("max_allocated_storage")?;
            let use_default_processor_features =
                input.get_optional_string("use_default_processor_features")?;
            let processor_features = input.get_optional_string("processor_features")?;
            let domain_fqdn = input.get_optional_string("domain_fqdn")?;
            let dedicated_log_volume = input.get_optional_string("dedicated_log_volume")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    source_db_instance_identifier.unwrap_or_default(),
                )
                .with_field("availability_zone", availability_zone.unwrap_or_default())
                .with_field("backup_target", backup_target.unwrap_or_default())
                .with_field(
                    "upgrade_storage_config",
                    upgrade_storage_config.unwrap_or_default(),
                )
                .with_field(
                    "db_subnet_group_name",
                    db_subnet_group_name.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    source_db_cluster_identifier.unwrap_or_default(),
                )
                .with_field(
                    "domain_iam_role_name",
                    domain_iam_role_name.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    use_default_processor_features.unwrap_or_default(),
                )
                .with_field("processor_features", processor_features.unwrap_or_default())
                .with_field("domain_fqdn", domain_fqdn.unwrap_or_default())
                .with_field(
    ...
    async fn read_db_instance_read_replica(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_instance_read_replica(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_cluster_snapshots(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_cluster_snapshots(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_cluster_snapshots(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_db_instance_automated_backups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_instance_automated_backups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_pending_maintenance_actions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_pending_maintenance_actions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_shard_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let db_cluster_identifier = input.get_string("db_cluster_identifier")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    db_shard_group_identifier.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
    ...
    async fn read_db_shard_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_shard_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_log_files(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_log_files(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn update_db_log_files(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_db_log_files(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_engine_default_parameters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_engine_default_parameters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_proxy_endpoint(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    db_proxy_endpoint_name.unwrap_or_default(),
                )
                .with_field(
                    "vpc_security_group_ids",
                    vpc_security_group_ids.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    endpoint_network_type.unwrap_or_default(),
                ))
        })
    }

    /// Read a db_proxy_endpoint resource
    async fn read_db_proxy_endpoint(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_proxy_endpoint(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_subnet_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    db_subnet_group_description.unwrap_or_default(),
                )
                .with_field(
                    "db_subnet_group_name",
                    db_subnet_group_name.unwrap_or_default(),
    ...
    async fn read_db_subnet_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_subnet_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_option_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_option_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn update_option_groups(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_option_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_proxy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let endpoint_network_type = input.get_optional_string("endpoint_network_type")?;
            let target_connection_network_type =
                input.get_optional_string("target_connection_network_type")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    target_connection_network_type.unwrap_or_default(),
                )
                .with_field(
                    "idle_client_timeout",
                    idle_client_timeout.unwrap_or_default(),
                )
                .with_field("auth", auth.unwrap_or_default())
                .with_field(
                    "default_auth_scheme",
                    default_auth_scheme.unwrap_or_default(),
                )
    ...
    async fn read_db_proxy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn update_db_proxy(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let endpoint_network_type = input.get_optional_string("endpoint_network_type")?;
    ...
    async fn delete_db_proxy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_subnet_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_subnet_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_subnet_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_tenant_database(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_tenant_database(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_tenant_database(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_parameters(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_parameters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn update_db_parameters(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_db_parameters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_snapshots(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_snapshots(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn update_db_snapshots(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_db_snapshots(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_global_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let storage_encrypted = input.get_optional_string("storage_encrypted")?;
    ...
    async fn read_global_cluster(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_global_cluster(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_proxy_targets(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_proxy_targets(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_proxy_targets(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_cluster_parameter_group(
        ...
        self.provider.runtime().block_on(async {
            ...
            let tags = input.get_optional_string("tags")?;
            let db_cluster_parameter_group_name =
                input.get_string("db_cluster_parameter_group_name")?;
            let db_parameter_group_family = input.get_string("db_parameter_group_family")?;
    ...
    async fn read_db_cluster_parameter_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_cluster_parameter_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_option_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    major_engine_version.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "option_group_description",
                    option_group_description.unwrap_or_default(),
                )
                .with_field("option_group_name", option_group_name.unwrap_or_default()))
        })
    }
    ...
    async fn read_option_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn update_option_group(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let engine_name = input.get_string("engine_name")?;
            let major_engine_version = input.get_string("major_engine_version")?;
    ...
    async fn delete_option_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_cluster_endpoint(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let db_cluster_endpoint_identifier =
                input.get_string("db_cluster_endpoint_identifier")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    db_cluster_endpoint_identifier.unwrap_or_default(),
                ))
        })
    }

    /// Read a db_cluster_endpoint resource
    async fn read_db_cluster_endpoint(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_cluster_endpoint(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_cluster_endpoints(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_cluster_endpoints(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_cluster_endpoints(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_db_cluster_automated_backup(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_cluster_automated_backup(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_orderable_db_instance_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_orderable_db_instance_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn read_engine_default_cluster_parameters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_engine_default_cluster_parameters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_db_shard_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_db_shard_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_db_shard_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
    ...
    async fn create_reserved_db_instances(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_reserved_db_instances(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.rds_client
    ...
    async fn delete_reserved_db_instances(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.rds_client
