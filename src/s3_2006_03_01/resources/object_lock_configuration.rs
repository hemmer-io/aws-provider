...
impl<'a> Object_lock_configuration<'a> {
    ...
    pub async fn create(&self, token: Option<String>, content_md5: Option<String>, checksum_algorithm: Option<String>, request_payer: Option<String>, expected_bucket_owner: Option<String>, bucket: String, object_lock_configuration: Option<String>) -> Result<String> {
