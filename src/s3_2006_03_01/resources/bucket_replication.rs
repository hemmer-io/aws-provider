...
impl<'a> Bucket_replication<'a> {
    ...
    pub async fn create(&self, bucket: String, content_md5: Option<String>, checksum_algorithm: Option<String>, expected_bucket_owner: Option<String>, replication_configuration: String, token: Option<String>) -> Result<String> {
