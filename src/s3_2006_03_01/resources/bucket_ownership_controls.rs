...
impl<'a> Bucket_ownership_controls<'a> {
    ...
    pub async fn create(&self, bucket: String, content_md5: Option<String>, expected_bucket_owner: Option<String>, checksum_algorithm: Option<String>, ownership_controls: String) -> Result<String> {
