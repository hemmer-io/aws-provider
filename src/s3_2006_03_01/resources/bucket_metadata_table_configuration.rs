...
impl<'a> Bucket_metadata_table_configuration<'a> {
    ...
    pub async fn create(&self, content_md5: Option<String>, expected_bucket_owner: Option<String>, checksum_algorithm: Option<String>, metadata_table_configuration: String, bucket: String) -> Result<String> {
