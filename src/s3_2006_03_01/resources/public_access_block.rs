...
impl<'a> Public_access_block<'a> {
    ...
    pub async fn create(&self, content_md5: Option<String>, expected_bucket_owner: Option<String>, checksum_algorithm: Option<String>, public_access_block_configuration: String, bucket: String) -> Result<String> {
