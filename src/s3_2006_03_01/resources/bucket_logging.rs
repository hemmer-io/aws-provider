...
impl<'a> Bucket_logging<'a> {
    ...
    pub async fn create(&self, checksum_algorithm: Option<String>, content_md5: Option<String>, bucket_logging_status: String, expected_bucket_owner: Option<String>, bucket: String) -> Result<String> {
