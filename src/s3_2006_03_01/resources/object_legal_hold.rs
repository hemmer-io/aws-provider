...
impl<'a> Object_legal_hold<'a> {
    ...
    pub async fn create(&self, legal_hold: Option<String>, checksum_algorithm: Option<String>, content_md5: Option<String>, version_id: Option<String>, request_payer: Option<String>, expected_bucket_owner: Option<String>, bucket: String, key: String) -> Result<String> {
