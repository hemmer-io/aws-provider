...
impl<'a> Bucket_encryption<'a> {
    ...
    pub async fn create(&self, expected_bucket_owner: Option<String>, bucket: String, server_side_encryption_configuration: String, checksum_algorithm: Option<String>, content_md5: Option<String>) -> Result<String> {
