...
impl<'a> Managed_rule_set_versions<'a> {
    ...
    pub async fn create(&self, name: String, id: String, scope: String, lock_token: String, versions_to_publish: Option<HashMap<String, String>>, recommended_version: Option<String>) -> Result<String> {
