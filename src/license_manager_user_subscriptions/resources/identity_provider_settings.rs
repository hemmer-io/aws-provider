...
impl<'a> Identity_provider_settings<'a> {
    ...
    pub async fn update(&self, id: &str, update_settings: Option<String>, identity_provider: Option<String>, identity_provider_arn: Option<String>, product: Option<String>) -> Result<()> {
