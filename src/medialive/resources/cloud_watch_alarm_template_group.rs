...
impl<'a> Cloud_watch_alarm_template_group<'a> {
    ...
    pub async fn create(&self, name: String, description: Option<String>, tags: Option<HashMap<String, String>>, request_id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, description: Option<String>, tags: Option<HashMap<String, String>>, request_id: Option<String>) -> Result<()> {
