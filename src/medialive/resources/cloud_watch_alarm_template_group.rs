...
impl<'a> Cloud_watch_alarm_template_group<'a> {
    ...
    pub async fn create(&self, request_id: Option<String>, name: String, description: Option<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, request_id: Option<String>, name: Option<String>, description: Option<String>, tags: Option<HashMap<String, String>>) -> Result<()> {
