...
impl<'a> Channel_placement_group<'a> {
    ...
    pub async fn create(&self, cluster_id: String, nodes: Option<Vec<String>>, tags: Option<HashMap<String, String>>, request_id: Option<String>, name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, cluster_id: Option<String>, nodes: Option<Vec<String>>, tags: Option<HashMap<String, String>>, request_id: Option<String>, name: Option<String>) -> Result<()> {
