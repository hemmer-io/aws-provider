...
impl<'a> Channel_placement_group<'a> {
    ...
    pub async fn create(&self, nodes: Option<Vec<String>>, tags: Option<HashMap<String, String>>, cluster_id: String, request_id: Option<String>, name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, nodes: Option<Vec<String>>, tags: Option<HashMap<String, String>>, cluster_id: Option<String>, request_id: Option<String>, name: Option<String>) -> Result<()> {
