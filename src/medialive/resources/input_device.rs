...
impl<'a> Input_device<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, uhd_device_settings: Option<String>, input_device_id: Option<String>, name: Option<String>, hd_device_settings: Option<String>, availability_zone: Option<String>) -> Result<()> {
