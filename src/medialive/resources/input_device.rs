...
impl<'a> Input_device<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, availability_zone: Option<String>, input_device_id: Option<String>, name: Option<String>, uhd_device_settings: Option<String>, hd_device_settings: Option<String>) -> Result<()> {
