...
impl<'a> Input_security_group<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, whitelist_rules: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, whitelist_rules: Option<Vec<String>>) -> Result<()> {
