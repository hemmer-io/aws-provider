...
impl<'a> Multiplex_program<'a> {
    ...
    pub async fn create(&self, request_id: String, multiplex_program_settings: String, multiplex_id: String, program_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, request_id: Option<String>, multiplex_program_settings: Option<String>, multiplex_id: Option<String>, program_name: Option<String>) -> Result<()> {
