...
impl<'a> Event_bridge_rule_template_group<'a> {
    ...
    pub async fn create(&self, description: Option<String>, request_id: Option<String>, name: String, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, request_id: Option<String>, name: Option<String>, tags: Option<HashMap<String, String>>) -> Result<()> {
