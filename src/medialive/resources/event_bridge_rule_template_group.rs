...
impl<'a> Event_bridge_rule_template_group<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, description: Option<String>, name: String, request_id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, description: Option<String>, name: Option<String>, request_id: Option<String>) -> Result<()> {
