...
impl<'a> Event_bridge_rule_template<'a> {
    ...
    pub async fn create(&self, description: Option<String>, event_type: String, group_identifier: String, name: String, event_targets: Option<Vec<String>>, tags: Option<HashMap<String, String>>, request_id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, event_type: Option<String>, group_identifier: Option<String>, name: Option<String>, event_targets: Option<Vec<String>>, tags: Option<HashMap<String, String>>, request_id: Option<String>) -> Result<()> {
