...
impl<'a> Event_bridge_rule_template<'a> {
    ...
    pub async fn create(&self, description: Option<String>, event_type: String, group_identifier: String, request_id: Option<String>, tags: Option<HashMap<String, String>>, name: String, event_targets: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, event_type: Option<String>, group_identifier: Option<String>, request_id: Option<String>, tags: Option<HashMap<String, String>>, name: Option<String>, event_targets: Option<Vec<String>>) -> Result<()> {
