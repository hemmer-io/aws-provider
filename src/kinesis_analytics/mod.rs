...
impl<'a> Kinesis_analyticsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "application_snapshot" => {
                self.plan_application_snapshot(current_state, desired_input)
                    .await
            }
            "application_vpc_configuration" => {
                self.plan_application_vpc_configuration(current_state, desired_input)
                    .await
            }
            "application_version" => {
            ...
            "application_maintenance_configuration" => {
                self.plan_application_maintenance_configuration(current_state, desired_input)
                    .await
            }
            "application_cloud_watch_logging_option" => {
                self.plan_application_cloud_watch_logging_option(current_state, desired_input)
                    .await
            }
            "application_presigned_url" => {
                self.plan_application_presigned_url(current_state, desired_input)
                    .await
            }
            "application" => self.plan_application(current_state, desired_input).await,
            "application_operation" => {
                self.plan_application_operation(current_state, desired_input)
                    .await
            }
            "application_reference_data_source" => {
                self.plan_application_reference_data_source(current_state, desired_input)
                    .await
            }
            "application_input_processing_configuration" => {
                self.plan_application_input_processing_configuration(current_state, desired_input)
                    .await
            }
            "application_output" => {
                self.plan_application_output(current_state, desired_input)
                    .await
            }
            "application_output" => {
                self.plan_application_output(current_state, desired_input)
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "kinesis_analytics", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "application_snapshot" => self.create_application_snapshot(input).await,
            "application_vpc_configuration" => {
                self.create_application_vpc_configuration(input).await
            }
            "application_version" => self.create_application_version(input).await,
            "application_maintenance_configuration" => {
                self.create_application_maintenance_configuration(input)
                    .await
            }
            "application_cloud_watch_logging_option" => {
                self.create_application_cloud_watch_logging_option(input)
                    .await
            }
            "application_presigned_url" => self.create_application_presigned_url(input).await,
            "application" => self.create_application(input).await,
            "application_operation" => self.create_application_operation(input).await,
            "application_reference_data_source" => {
                self.create_application_reference_data_source(input).await
            }
            "application_input_processing_configuration" => {
                self.create_application_input_processing_configuration(input)
                    .await
            }
            "application_output" => self.create_application_output(input).await,
            "application_output" => self.create_application_output(input).await,
            "application" => self.create_application(input).await,
            "application_cloud_watch_logging_option" => {
                self.create_application_cloud_watch_logging_option(input)
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "application_snapshot" => self.read_application_snapshot(id).await,
            "application_vpc_configuration" => self.read_application_vpc_configuration(id).await,
            ...
            "application_presigned_url" => self.read_application_presigned_url(id).await,
            "application" => self.read_application(id).await,
            "application_operation" => self.read_application_operation(id).await,
            "application_reference_data_source" => {
                self.read_application_reference_data_source(id).await
            }
            "application_input_processing_configuration" => {
                self.read_application_input_processing_configuration(id)
                    .await
            }
            "application_output" => self.read_application_output(id).await,
            "application_output" => self.read_application_output(id).await,
            "application" => self.read_application(id).await,
            "application_cloud_watch_logging_option" => {
                self.read_application_cloud_watch_logging_option(id).await
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "application_snapshot" => self.update_application_snapshot(id, input).await,
            "application_vpc_configuration" => {
            ...
            "application_maintenance_configuration" => {
                self.update_application_maintenance_configuration(id, input)
                    .await
            }
            "application_cloud_watch_logging_option" => {
                self.update_application_cloud_watch_logging_option(id, input)
                    .await
            }
            "application_presigned_url" => self.update_application_presigned_url(id, input).await,
            "application" => self.update_application(id, input).await,
            "application_operation" => self.update_application_operation(id, input).await,
            "application_reference_data_source" => {
                self.update_application_reference_data_source(id, input)
                    .await
            }
            "application_input_processing_configuration" => {
                self.update_application_input_processing_configuration(id, input)
                    .await
            }
            "application_output" => self.update_application_output(id, input).await,
            "application_output" => self.update_application_output(id, input).await,
            "application" => self.update_application(id, input).await,
            "application_cloud_watch_logging_option" => {
                self.update_application_cloud_watch_logging_option(id, input)
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "application_snapshot" => self.delete_application_snapshot(id).await,
            "application_vpc_configuration" => self.delete_application_vpc_configuration(id).await,
            ...
            "application_presigned_url" => self.delete_application_presigned_url(id).await,
            "application" => self.delete_application(id).await,
            "application_operation" => self.delete_application_operation(id).await,
            "application_reference_data_source" => {
                self.delete_application_reference_data_source(id).await
            }
            "application_input_processing_configuration" => {
                self.delete_application_input_processing_configuration(id)
                    .await
            }
            "application_output" => self.delete_application_output(id).await,
            "application_output" => self.delete_application_output(id).await,
            "application" => self.delete_application(id).await,
            "application_cloud_watch_logging_option" => {
                self.delete_application_cloud_watch_logging_option(id).await
    ...
    async fn create_application_snapshot(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_application_snapshot(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_application_snapshot(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_application_vpc_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_analytics_client
    ...
    async fn delete_application_vpc_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_analytics_client
    ...
    async fn create_application_maintenance_configuration(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let application_maintenance_configuration_update =
                input.get_string("application_maintenance_configuration_update")?;
            let application_name = input.get_string("application_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    application_maintenance_configuration_update.unwrap_or_default(),
                )
                .with_field("application_name", application_name.unwrap_or_default()))
        })
    }
    ...
    async fn read_application_maintenance_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_analytics_client
    ...
    async fn delete_application_maintenance_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_analytics_client
    ...
    async fn delete_application_cloud_watch_logging_option(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_analytics_client
    ...
    async fn read_application_presigned_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_analytics_client
    ...
    async fn delete_application_presigned_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_analytics_client
    ...
    async fn create_application(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let cloud_watch_logging_options =
                input.get_optional_string("cloud_watch_logging_options")?;
            let application_name = input.get_string("application_name")?;
            ...
            let application_configuration =
                input.get_optional_string("application_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    cloud_watch_logging_options.unwrap_or_default(),
                )
                .with_field("application_name", application_name.unwrap_or_default())
                .with_field(
                    "application_description",
                    application_description.unwrap_or_default(),
                )
                .with_field(
                    "service_execution_role",
                    service_execution_role.unwrap_or_default(),
                )
                .with_field("application_mode", application_mode.unwrap_or_default())
                .with_field(
                    "runtime_environment",
                    runtime_environment.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "application_configuration",
                    application_configuration.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_application_operation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_application_operation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_analytics_client
    ...
    async fn delete_application_operation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_analytics_client
    ...
    async fn read_application_reference_data_source(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_analytics_client
    ...
    async fn delete_application_reference_data_source(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_analytics_client
    ...
    async fn delete_application_input_processing_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_analytics_client
    ...
    async fn create_application_output(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_application_output(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_analytics_client
    ...
    async fn delete_application_output(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_analytics_client
