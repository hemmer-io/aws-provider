...
impl<'a> EcsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "cluster_settings" => {
                self.plan_cluster_settings(current_state, desired_input).await
            }
            "tasks" => {
                self.plan_tasks(current_state, desired_input).await
            }
            "task_set" => {
                self.plan_task_set(current_state, desired_input).await
            }
            "capacity_providers" => {
                self.plan_capacity_providers(current_state, desired_input).await
            }
            "service_deployments" => {
                self.plan_service_deployments(current_state, desired_input).await
            }
            "clusters" => {
            ...
            "task_protection" => {
                self.plan_task_protection(current_state, desired_input).await
            }
            "task_definition" => {
                self.plan_task_definition(current_state, desired_input).await
            }
            "task_sets" => {
                self.plan_task_sets(current_state, desired_input).await
            }
            "capacity_provider" => {
                self.plan_capacity_provider(current_state, desired_input).await
            }
            "task_definitions" => {
                self.plan_task_definitions(current_state, desired_input).await
            }
            "account_setting" => {
                self.plan_account_setting(current_state, desired_input).await
            }
            "service_revisions" => {
                self.plan_service_revisions(current_state, desired_input).await
            }
            "service_primary_task_set" => {
                self.plan_service_primary_task_set(current_state, desired_input).await
            }
            "container_agent" => {
                self.plan_container_agent(current_state, desired_input).await
            }
            "attributes" => {
                self.plan_attributes(current_state, desired_input).await
            }
            "account_setting_default" => {
                self.plan_account_setting_default(current_state, desired_input).await
            }
            "service" => {
                self.plan_service(current_state, desired_input).await
            }
            "container_instances_state" => {
                self.plan_container_instances_state(current_state, desired_input).await
            }
            "container_instances" => {
                self.plan_container_instances(current_state, desired_input).await
            }
            "cluster_capacity_providers" => {
                self.plan_cluster_capacity_providers(current_state, desired_input).await
            }
            "services" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "cluster_settings" => {
                self.create_cluster_settings(input).await
            }
            "tasks" => {
                self.create_tasks(input).await
            }
            "task_set" => {
                self.create_task_set(input).await
            }
            "capacity_providers" => {
                self.create_capacity_providers(input).await
            }
            "service_deployments" => {
                self.create_service_deployments(input).await
            }
            "clusters" => {
            ...
            "task_protection" => {
                self.create_task_protection(input).await
            }
            "task_definition" => {
                self.create_task_definition(input).await
            }
            "task_sets" => {
                self.create_task_sets(input).await
            }
            "capacity_provider" => {
                self.create_capacity_provider(input).await
            }
            "task_definitions" => {
                self.create_task_definitions(input).await
            }
            "account_setting" => {
                self.create_account_setting(input).await
            }
            "service_revisions" => {
                self.create_service_revisions(input).await
            }
            "service_primary_task_set" => {
                self.create_service_primary_task_set(input).await
            }
            "container_agent" => {
                self.create_container_agent(input).await
            }
            "attributes" => {
                self.create_attributes(input).await
            }
            "account_setting_default" => {
                self.create_account_setting_default(input).await
            }
            "service" => {
                self.create_service(input).await
            }
            "container_instances_state" => {
                self.create_container_instances_state(input).await
            }
            "container_instances" => {
                self.create_container_instances(input).await
            }
            "cluster_capacity_providers" => {
                self.create_cluster_capacity_providers(input).await
            }
            "services" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "cluster_settings" => {
                self.read_cluster_settings(id).await
            }
            "tasks" => {
                self.read_tasks(id).await
            }
            "task_set" => {
                self.read_task_set(id).await
            }
            "capacity_providers" => {
                self.read_capacity_providers(id).await
            }
            "service_deployments" => {
                self.read_service_deployments(id).await
            }
            "clusters" => {
            ...
            "task_protection" => {
                self.read_task_protection(id).await
            }
            "task_definition" => {
                self.read_task_definition(id).await
            }
            "task_sets" => {
                self.read_task_sets(id).await
            }
            "capacity_provider" => {
                self.read_capacity_provider(id).await
            }
            "task_definitions" => {
                self.read_task_definitions(id).await
            }
            "account_setting" => {
                self.read_account_setting(id).await
            }
            "service_revisions" => {
                self.read_service_revisions(id).await
            }
            "service_primary_task_set" => {
                self.read_service_primary_task_set(id).await
            }
            "container_agent" => {
                self.read_container_agent(id).await
            }
            "attributes" => {
                self.read_attributes(id).await
            }
            "account_setting_default" => {
                self.read_account_setting_default(id).await
            }
            "service" => {
                self.read_service(id).await
            }
            "container_instances_state" => {
                self.read_container_instances_state(id).await
            }
            "container_instances" => {
                self.read_container_instances(id).await
            }
            "cluster_capacity_providers" => {
                self.read_cluster_capacity_providers(id).await
            }
            "services" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "cluster_settings" => {
                self.update_cluster_settings(id, input).await
            }
            "tasks" => {
                self.update_tasks(id, input).await
            }
            "task_set" => {
                self.update_task_set(id, input).await
            }
            "capacity_providers" => {
                self.update_capacity_providers(id, input).await
            }
            "service_deployments" => {
                self.update_service_deployments(id, input).await
            }
            "clusters" => {
            ...
            "task_protection" => {
                self.update_task_protection(id, input).await
            }
            "task_definition" => {
                self.update_task_definition(id, input).await
            }
            "task_sets" => {
                self.update_task_sets(id, input).await
            }
            "capacity_provider" => {
                self.update_capacity_provider(id, input).await
            }
            "task_definitions" => {
                self.update_task_definitions(id, input).await
            }
            "account_setting" => {
                self.update_account_setting(id, input).await
            }
            "service_revisions" => {
                self.update_service_revisions(id, input).await
            }
            "service_primary_task_set" => {
                self.update_service_primary_task_set(id, input).await
            }
            "container_agent" => {
                self.update_container_agent(id, input).await
            }
            "attributes" => {
                self.update_attributes(id, input).await
            }
            "account_setting_default" => {
                self.update_account_setting_default(id, input).await
            }
            "service" => {
                self.update_service(id, input).await
            }
            "container_instances_state" => {
                self.update_container_instances_state(id, input).await
            }
            "container_instances" => {
                self.update_container_instances(id, input).await
            }
            "cluster_capacity_providers" => {
                self.update_cluster_capacity_providers(id, input).await
            }
            "services" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "cluster_settings" => {
                self.delete_cluster_settings(id).await
            }
            "tasks" => {
                self.delete_tasks(id).await
            }
            "task_set" => {
                self.delete_task_set(id).await
            }
            "capacity_providers" => {
                self.delete_capacity_providers(id).await
            }
            "service_deployments" => {
                self.delete_service_deployments(id).await
            }
            "clusters" => {
            ...
            "task_protection" => {
                self.delete_task_protection(id).await
            }
            "task_definition" => {
                self.delete_task_definition(id).await
            }
            "task_sets" => {
                self.delete_task_sets(id).await
            }
            "capacity_provider" => {
                self.delete_capacity_provider(id).await
            }
            "task_definitions" => {
                self.delete_task_definitions(id).await
            }
            "account_setting" => {
                self.delete_account_setting(id).await
            }
            "service_revisions" => {
                self.delete_service_revisions(id).await
            }
            "service_primary_task_set" => {
                self.delete_service_primary_task_set(id).await
            }
            "container_agent" => {
                self.delete_container_agent(id).await
            }
            "attributes" => {
                self.delete_attributes(id).await
            }
            "account_setting_default" => {
                self.delete_account_setting_default(id).await
            }
            "service" => {
                self.delete_service(id).await
            }
            "container_instances_state" => {
                self.delete_container_instances_state(id).await
            }
            "container_instances" => {
                self.delete_container_instances(id).await
            }
            "cluster_capacity_providers" => {
                self.delete_cluster_capacity_providers(id).await
            }
            "services" => {
    ...
    async fn create_cluster_settings(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn read_cluster_settings(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_settings(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_task_set(
        ...
        self.provider.runtime().block_on(async {
            ...
            let cluster = input.get_string("cluster")?;
            let capacity_provider_strategy = input.get_optional_string("capacity_provider_strategy")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("cluster", cluster.unwrap_or_default())
                .with_field("capacity_provider_strategy", capacity_provider_strategy.unwrap_or_default())
    ...
    async fn create_capacity_providers(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_capacity_providers(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_capacity_providers(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_service_deployments(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_service_deployments(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_service_deployments(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster(
        ...
        self.provider.runtime().block_on(async {
            ...
            let default_capacity_provider_strategy = input.get_optional_string("default_capacity_provider_strategy")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("default_capacity_provider_strategy", default_capacity_provider_strategy.unwrap_or_default())
                .with_field("service_connect_defaults", service_connect_defaults.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
    ...
    async fn create_task_protection(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_task_protection(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_capacity_provider(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let auto_scaling_group_provider = input.get_optional_string("auto_scaling_group_provider")?;
            let name = input.get_string("name")?;
            let tags = input.get_optional_string("tags")?;
            let managed_instances_provider = input.get_optional_string("managed_instances_provider")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("auto_scaling_group_provider", auto_scaling_group_provider.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("managed_instances_provider", managed_instances_provider.unwrap_or_default())
                .with_field("cluster", cluster.unwrap_or_default())
            )
        })
    }
    ...
    async fn read_capacity_provider(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_task_definitions(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_task_definitions(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_task_definitions(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_service_revisions(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_service_revisions(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_service_revisions(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_service_primary_task_set(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_service_primary_task_set(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_container_agent(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_container_agent(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_account_setting_default(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_account_setting_default(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_account_setting_default(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_service(
        ...
        self.provider.runtime().block_on(async {
            ...
            let service_connect_configuration = input.get_optional_string("service_connect_configuration")?;
            let volume_configurations = input.get_optional_string("volume_configurations")?;
            let role = input.get_optional_string("role")?;
            let vpc_lattice_configurations = input.get_optional_string("vpc_lattice_configurations")?;
            ...
            let client_token = input.get_optional_string("client_token")?;
            let health_check_grace_period_seconds = input.get_optional_string("health_check_grace_period_seconds")?;
            ...
            let availability_zone_rebalancing = input.get_optional_string("availability_zone_rebalancing")?;
            let service_registries = input.get_optional_string("service_registries")?;
            let tags = input.get_optional_string("tags")?;
            let network_configuration = input.get_optional_string("network_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("cluster", cluster.unwrap_or_default())
                .with_field("load_balancers", load_balancers.unwrap_or_default())
                .with_field("enable_ecs_managed_tags", enable_ecs_managed_tags.unwrap_or_default())
                .with_field("propagate_tags", propagate_tags.unwrap_or_default())
                .with_field("service_connect_configuration", service_connect_configuration.unwrap_or_default())
                .with_field("volume_configurations", volume_configurations.unwrap_or_default())
                .with_field("role", role.unwrap_or_default())
                .with_field("vpc_lattice_configurations", vpc_lattice_configurations.unwrap_or_default())
                .with_field("service_name", service_name.unwrap_or_default())
                .with_field("deployment_controller", deployment_controller.unwrap_or_default())
                .with_field("task_definition", task_definition.unwrap_or_default())
                .with_field("launch_type", launch_type.unwrap_or_default())
                .with_field("placement_constraints", placement_constraints.unwrap_or_default())
                .with_field("platform_version", platform_version.unwrap_or_default())
                .with_field("deployment_configuration", deployment_configuration.unwrap_or_default())
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field("health_check_grace_period_seconds", health_check_grace_period_seconds.unwrap_or_default())
                .with_field("scheduling_strategy", scheduling_strategy.unwrap_or_default())
                .with_field("enable_execute_command", enable_execute_command.unwrap_or_default())
                ...
                .with_field("availability_zone_rebalancing", availability_zone_rebalancing.unwrap_or_default())
                .with_field("service_registries", service_registries.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("network_configuration", network_configuration.unwrap_or_default())
            )
    ...
    async fn create_container_instances_state(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("container_instances", container_instances.unwrap_or_default())
    ...
    async fn read_container_instances_state(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_container_instances_state(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_container_instances(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_container_instances(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_container_instances(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster_capacity_providers(
        ...
        self.provider.runtime().block_on(async {
            ...
            let default_capacity_provider_strategy = input.get_string("default_capacity_provider_strategy")?;
    ...
    async fn read_cluster_capacity_providers(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_capacity_providers(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
