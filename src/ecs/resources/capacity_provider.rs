...
impl<'a> Capacity_provider<'a> {
    ...
    pub async fn create(&self, auto_scaling_group_provider: Option<String>, managed_instances_provider: Option<String>, name: String, tags: Option<Vec<String>>, cluster: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, auto_scaling_group_provider: Option<String>, managed_instances_provider: Option<String>, name: Option<String>, tags: Option<Vec<String>>, cluster: Option<String>) -> Result<()> {
