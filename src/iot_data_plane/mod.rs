...
impl<'a> Iot_data_planeService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "retained_message" => {
                self.plan_retained_message(current_state, desired_input)
                    .await
            }
            "connection" => self.plan_connection(current_state, desired_input).await,
            "thing_shadow" => self.plan_thing_shadow(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iot_data_plane", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "retained_message" => self.create_retained_message(input).await,
            "connection" => self.create_connection(input).await,
            "thing_shadow" => self.create_thing_shadow(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iot_data_plane", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "retained_message" => self.read_retained_message(id).await,
            "connection" => self.read_connection(id).await,
            "thing_shadow" => self.read_thing_shadow(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iot_data_plane", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "retained_message" => self.update_retained_message(id, input).await,
            "connection" => self.update_connection(id, input).await,
            "thing_shadow" => self.update_thing_shadow(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iot_data_plane", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "retained_message" => self.delete_retained_message(id).await,
            "connection" => self.delete_connection(id).await,
            "thing_shadow" => self.delete_thing_shadow(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iot_data_plane", resource_name
            ))),
    ...
    async fn create_retained_message(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_retained_message(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_retained_message(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_thing_shadow(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_thing_shadow(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iot_data_plane_client
    ...
    async fn update_thing_shadow(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let payload = input.get_string("payload")?;
            let thing_name = input.get_string("thing_name")?;
    ...
    async fn delete_thing_shadow(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iot_data_plane_client
