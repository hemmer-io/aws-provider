...
impl<'a> PricingService<'a> {
    ...
    async fn create_price_list_file_url(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_price_list_file_url(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_price_list_file_url(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_attribute_values(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_attribute_values(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_attribute_values(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
