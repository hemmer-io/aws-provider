...
impl<'a> Data_repository_task<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, type: String, release_configuration: Option<String>, client_request_token: Option<String>, report: String, capacity_to_release: Option<i64>, file_system_id: String, paths: Option<Vec<String>>) -> Result<String> {
