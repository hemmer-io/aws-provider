...
impl<'a> And_attach_s3_access_point<'a> {
    ...
    pub async fn create(&self, open_zfs_configuration: Option<String>, name: String, client_request_token: Option<String>, s3_access_point: Option<String>, type: String) -> Result<String> {
