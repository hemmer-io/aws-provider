...
impl<'a> RedshiftService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "reserved_node_offerings" => {
                self.plan_reserved_node_offerings(current_state, desired_input).await
            }
            "inbound_integrations" => {
                self.plan_inbound_integrations(current_state, desired_input).await
            }
            "cluster_parameter_group" => {
                self.plan_cluster_parameter_group(current_state, desired_input).await
            }
            "tags" => {
            ...
            "cluster_security_group" => {
                self.plan_cluster_security_group(current_state, desired_input).await
            }
            "account_attributes" => {
            ...
            "snapshot_schedules" => {
                self.plan_snapshot_schedules(current_state, desired_input).await
            }
            "cluster_credentials_with_iam" => {
                self.plan_cluster_credentials_with_iam(current_state, desired_input).await
            }
            "data_shares_for_producer" => {
                self.plan_data_shares_for_producer(current_state, desired_input).await
            }
            "cluster_db_revisions" => {
                self.plan_cluster_db_revisions(current_state, desired_input).await
            }
            "endpoint_authorization" => {
                self.plan_endpoint_authorization(current_state, desired_input).await
            }
            "scheduled_actions" => {
                self.plan_scheduled_actions(current_state, desired_input).await
            }
            "node_configuration_options" => {
                self.plan_node_configuration_options(current_state, desired_input).await
            }
            "snapshot_copy_grant" => {
                self.plan_snapshot_copy_grant(current_state, desired_input).await
            }
            "hsm_client_certificates" => {
                self.plan_hsm_client_certificates(current_state, desired_input).await
            }
            "clusters" => {
            ...
            "redshift_idc_application" => {
                self.plan_redshift_idc_application(current_state, desired_input).await
            }
            "event_categories" => {
                self.plan_event_categories(current_state, desired_input).await
            }
            "hsm_configuration" => {
                self.plan_hsm_configuration(current_state, desired_input).await
            }
            "resize" => {
                self.plan_resize(current_state, desired_input).await
            }
            "cluster_subnet_group" => {
                self.plan_cluster_subnet_group(current_state, desired_input).await
            }
            "orderable_cluster_options" => {
                self.plan_orderable_cluster_options(current_state, desired_input).await
            }
            "usage_limit" => {
                self.plan_usage_limit(current_state, desired_input).await
            }
            "event_subscription" => {
            ...
            "cluster_security_groups" => {
                self.plan_cluster_security_groups(current_state, desired_input).await
            }
            "authentication_profiles" => {
                self.plan_authentication_profiles(current_state, desired_input).await
            }
            "reserved_node_exchange_offerings" => {
                self.plan_reserved_node_exchange_offerings(current_state, desired_input).await
            }
            "snapshot_schedule" => {
                self.plan_snapshot_schedule(current_state, desired_input).await
            }
            "cluster_snapshots" => {
                self.plan_cluster_snapshots(current_state, desired_input).await
            }
            "cluster_tracks" => {
                self.plan_cluster_tracks(current_state, desired_input).await
            }
            "scheduled_action" => {
                self.plan_scheduled_action(current_state, desired_input).await
            }
            "hsm_client_certificate" => {
                self.plan_hsm_client_certificate(current_state, desired_input).await
            }
            "partner" => {
                self.plan_partner(current_state, desired_input).await
            }
            "cluster_parameter_groups" => {
                self.plan_cluster_parameter_groups(current_state, desired_input).await
            }
            "event_subscriptions" => {
                self.plan_event_subscriptions(current_state, desired_input).await
            }
            "cluster_parameters" => {
                self.plan_cluster_parameters(current_state, desired_input).await
            }
            "hsm_configurations" => {
                self.plan_hsm_configurations(current_state, desired_input).await
            }
            "reserved_node_exchange_status" => {
                self.plan_reserved_node_exchange_status(current_state, desired_input).await
            }
            "integration" => {
                self.plan_integration(current_state, desired_input).await
            }
            "table_restore_status" => {
                self.plan_table_restore_status(current_state, desired_input).await
            }
            "endpoint_access" => {
                self.plan_endpoint_access(current_state, desired_input).await
            }
            "logging_status" => {
                self.plan_logging_status(current_state, desired_input).await
            }
            "cluster_versions" => {
                self.plan_cluster_versions(current_state, desired_input).await
            }
            "default_cluster_parameters" => {
                self.plan_default_cluster_parameters(current_state, desired_input).await
            }
            "partner_status" => {
                self.plan_partner_status(current_state, desired_input).await
            }
            "storage" => {
                self.plan_storage(current_state, desired_input).await
            }
            "cluster_subnet_groups" => {
                self.plan_cluster_subnet_groups(current_state, desired_input).await
            }
            "reserved_nodes" => {
                self.plan_reserved_nodes(current_state, desired_input).await
            }
            "data_shares" => {
                self.plan_data_shares(current_state, desired_input).await
            }
            "snapshot_copy_grants" => {
                self.plan_snapshot_copy_grants(current_state, desired_input).await
            }
            "cluster_credentials" => {
                self.plan_cluster_credentials(current_state, desired_input).await
            }
            "redshift_idc_applications" => {
                self.plan_redshift_idc_applications(current_state, desired_input).await
            }
            "reserved_node_exchange_configuration_options" => {
                self.plan_reserved_node_exchange_configuration_options(current_state, desired_input).await
            }
            "usage_limits" => {
                self.plan_usage_limits(current_state, desired_input).await
            }
            "partners" => {
                self.plan_partners(current_state, desired_input).await
            }
            "custom_domain_associations" => {
                self.plan_custom_domain_associations(current_state, desired_input).await
            }
            "custom_domain_association" => {
                self.plan_custom_domain_association(current_state, desired_input).await
            }
            "data_shares_for_consumer" => {
                self.plan_data_shares_for_consumer(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "reserved_node_offerings" => {
                self.create_reserved_node_offerings(input).await
            }
            "inbound_integrations" => {
                self.create_inbound_integrations(input).await
            }
            "cluster_parameter_group" => {
                self.create_cluster_parameter_group(input).await
            }
            "tags" => {
            ...
            "cluster_security_group" => {
                self.create_cluster_security_group(input).await
            }
            "account_attributes" => {
            ...
            "snapshot_schedules" => {
                self.create_snapshot_schedules(input).await
            }
            "cluster_credentials_with_iam" => {
                self.create_cluster_credentials_with_iam(input).await
            }
            "data_shares_for_producer" => {
                self.create_data_shares_for_producer(input).await
            }
            "cluster_db_revisions" => {
                self.create_cluster_db_revisions(input).await
            }
            "endpoint_authorization" => {
                self.create_endpoint_authorization(input).await
            }
            "scheduled_actions" => {
                self.create_scheduled_actions(input).await
            }
            "node_configuration_options" => {
                self.create_node_configuration_options(input).await
            }
            "snapshot_copy_grant" => {
                self.create_snapshot_copy_grant(input).await
            }
            "hsm_client_certificates" => {
                self.create_hsm_client_certificates(input).await
            }
            "clusters" => {
            ...
            "redshift_idc_application" => {
                self.create_redshift_idc_application(input).await
            }
            "event_categories" => {
                self.create_event_categories(input).await
            }
            "hsm_configuration" => {
                self.create_hsm_configuration(input).await
            }
            "resize" => {
                self.create_resize(input).await
            }
            "cluster_subnet_group" => {
                self.create_cluster_subnet_group(input).await
            }
            "orderable_cluster_options" => {
                self.create_orderable_cluster_options(input).await
            }
            "usage_limit" => {
                self.create_usage_limit(input).await
            }
            "event_subscription" => {
            ...
            "cluster_security_groups" => {
                self.create_cluster_security_groups(input).await
            }
            "authentication_profiles" => {
                self.create_authentication_profiles(input).await
            }
            "reserved_node_exchange_offerings" => {
            ...
            "cluster_snapshots" => {
                self.create_cluster_snapshots(input).await
            }
            "cluster_tracks" => {
                self.create_cluster_tracks(input).await
            }
            "scheduled_action" => {
                self.create_scheduled_action(input).await
            }
            "hsm_client_certificate" => {
                self.create_hsm_client_certificate(input).await
            }
            "partner" => {
                self.create_partner(input).await
            }
            "cluster_parameter_groups" => {
                self.create_cluster_parameter_groups(input).await
            }
            "event_subscriptions" => {
                self.create_event_subscriptions(input).await
            }
            "cluster_parameters" => {
                self.create_cluster_parameters(input).await
            }
            "hsm_configurations" => {
                self.create_hsm_configurations(input).await
            }
            "reserved_node_exchange_status" => {
            ...
            "table_restore_status" => {
                self.create_table_restore_status(input).await
            }
            "endpoint_access" => {
                self.create_endpoint_access(input).await
            }
            "logging_status" => {
                self.create_logging_status(input).await
            }
            "cluster_versions" => {
                self.create_cluster_versions(input).await
            }
            "default_cluster_parameters" => {
                self.create_default_cluster_parameters(input).await
            }
            "partner_status" => {
                self.create_partner_status(input).await
            }
            "storage" => {
                self.create_storage(input).await
            }
            "cluster_subnet_groups" => {
                self.create_cluster_subnet_groups(input).await
            }
            "reserved_nodes" => {
                self.create_reserved_nodes(input).await
            }
            "data_shares" => {
                self.create_data_shares(input).await
            }
            "snapshot_copy_grants" => {
                self.create_snapshot_copy_grants(input).await
            }
            "cluster_credentials" => {
                self.create_cluster_credentials(input).await
            }
            "redshift_idc_applications" => {
                self.create_redshift_idc_applications(input).await
            }
            "reserved_node_exchange_configuration_options" => {
                self.create_reserved_node_exchange_configuration_options(input).await
            }
            "usage_limits" => {
                self.create_usage_limits(input).await
            }
            "partners" => {
                self.create_partners(input).await
            }
            "custom_domain_associations" => {
                self.create_custom_domain_associations(input).await
            }
            "custom_domain_association" => {
                self.create_custom_domain_association(input).await
            }
            "data_shares_for_consumer" => {
                self.create_data_shares_for_consumer(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "redshift",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "reserved_node_offerings" => {
                self.read_reserved_node_offerings(id).await
            }
            "inbound_integrations" => {
                self.read_inbound_integrations(id).await
            }
            "cluster_parameter_group" => {
                self.read_cluster_parameter_group(id).await
            }
            "tags" => {
            ...
            "cluster_security_group" => {
                self.read_cluster_security_group(id).await
            }
            "account_attributes" => {
            ...
            "snapshot_schedules" => {
                self.read_snapshot_schedules(id).await
            }
            "cluster_credentials_with_iam" => {
                self.read_cluster_credentials_with_iam(id).await
            }
            "data_shares_for_producer" => {
                self.read_data_shares_for_producer(id).await
            }
            "cluster_db_revisions" => {
                self.read_cluster_db_revisions(id).await
            }
            "endpoint_authorization" => {
                self.read_endpoint_authorization(id).await
            }
            "scheduled_actions" => {
                self.read_scheduled_actions(id).await
            }
            "node_configuration_options" => {
                self.read_node_configuration_options(id).await
            }
            "snapshot_copy_grant" => {
                self.read_snapshot_copy_grant(id).await
            }
            "hsm_client_certificates" => {
                self.read_hsm_client_certificates(id).await
            }
            "clusters" => {
            ...
            "redshift_idc_application" => {
                self.read_redshift_idc_application(id).await
            }
            "event_categories" => {
                self.read_event_categories(id).await
            }
            "hsm_configuration" => {
                self.read_hsm_configuration(id).await
            }
            "resize" => {
                self.read_resize(id).await
            }
            "cluster_subnet_group" => {
                self.read_cluster_subnet_group(id).await
            }
            "orderable_cluster_options" => {
                self.read_orderable_cluster_options(id).await
            }
            "usage_limit" => {
                self.read_usage_limit(id).await
            }
            "event_subscription" => {
            ...
            "cluster_security_groups" => {
                self.read_cluster_security_groups(id).await
            }
            "authentication_profiles" => {
                self.read_authentication_profiles(id).await
            }
            "reserved_node_exchange_offerings" => {
            ...
            "cluster_snapshots" => {
                self.read_cluster_snapshots(id).await
            }
            "cluster_tracks" => {
                self.read_cluster_tracks(id).await
            }
            "scheduled_action" => {
                self.read_scheduled_action(id).await
            }
            "hsm_client_certificate" => {
                self.read_hsm_client_certificate(id).await
            }
            "partner" => {
                self.read_partner(id).await
            }
            "cluster_parameter_groups" => {
                self.read_cluster_parameter_groups(id).await
            }
            "event_subscriptions" => {
                self.read_event_subscriptions(id).await
            }
            "cluster_parameters" => {
                self.read_cluster_parameters(id).await
            }
            "hsm_configurations" => {
                self.read_hsm_configurations(id).await
            }
            "reserved_node_exchange_status" => {
                self.read_reserved_node_exchange_status(id).await
            }
            "integration" => {
                self.read_integration(id).await
            }
            "table_restore_status" => {
                self.read_table_restore_status(id).await
            }
            "endpoint_access" => {
                self.read_endpoint_access(id).await
            }
            "logging_status" => {
                self.read_logging_status(id).await
            }
            "cluster_versions" => {
                self.read_cluster_versions(id).await
            }
            "default_cluster_parameters" => {
                self.read_default_cluster_parameters(id).await
            }
            "partner_status" => {
                self.read_partner_status(id).await
            }
            "storage" => {
                self.read_storage(id).await
            }
            "cluster_subnet_groups" => {
                self.read_cluster_subnet_groups(id).await
            }
            "reserved_nodes" => {
                self.read_reserved_nodes(id).await
            }
            "data_shares" => {
                self.read_data_shares(id).await
            }
            "snapshot_copy_grants" => {
                self.read_snapshot_copy_grants(id).await
            }
            "cluster_credentials" => {
                self.read_cluster_credentials(id).await
            }
            "redshift_idc_applications" => {
                self.read_redshift_idc_applications(id).await
            }
            "reserved_node_exchange_configuration_options" => {
                self.read_reserved_node_exchange_configuration_options(id).await
            }
            "usage_limits" => {
                self.read_usage_limits(id).await
            }
            "partners" => {
                self.read_partners(id).await
            }
            "custom_domain_associations" => {
                self.read_custom_domain_associations(id).await
            }
            "custom_domain_association" => {
                self.read_custom_domain_association(id).await
            }
            "data_shares_for_consumer" => {
                self.read_data_shares_for_consumer(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "redshift",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "reserved_node_offerings" => {
                self.update_reserved_node_offerings(id, input).await
            }
            "inbound_integrations" => {
                self.update_inbound_integrations(id, input).await
            }
            "cluster_parameter_group" => {
                self.update_cluster_parameter_group(id, input).await
            }
            "tags" => {
            ...
            "cluster_security_group" => {
                self.update_cluster_security_group(id, input).await
            }
            "account_attributes" => {
            ...
            "snapshot_schedules" => {
                self.update_snapshot_schedules(id, input).await
            }
            "cluster_credentials_with_iam" => {
                self.update_cluster_credentials_with_iam(id, input).await
            }
            "data_shares_for_producer" => {
                self.update_data_shares_for_producer(id, input).await
            }
            "cluster_db_revisions" => {
                self.update_cluster_db_revisions(id, input).await
            }
            "endpoint_authorization" => {
                self.update_endpoint_authorization(id, input).await
            }
            "scheduled_actions" => {
                self.update_scheduled_actions(id, input).await
            }
            "node_configuration_options" => {
                self.update_node_configuration_options(id, input).await
            }
            "snapshot_copy_grant" => {
                self.update_snapshot_copy_grant(id, input).await
            }
            "hsm_client_certificates" => {
                self.update_hsm_client_certificates(id, input).await
            }
            "clusters" => {
            ...
            "redshift_idc_application" => {
                self.update_redshift_idc_application(id, input).await
            }
            "event_categories" => {
                self.update_event_categories(id, input).await
            }
            "hsm_configuration" => {
                self.update_hsm_configuration(id, input).await
            }
            "resize" => {
                self.update_resize(id, input).await
            }
            "cluster_subnet_group" => {
                self.update_cluster_subnet_group(id, input).await
            }
            "orderable_cluster_options" => {
                self.update_orderable_cluster_options(id, input).await
            }
            "usage_limit" => {
                self.update_usage_limit(id, input).await
            }
            "event_subscription" => {
            ...
            "cluster_security_groups" => {
                self.update_cluster_security_groups(id, input).await
            }
            "authentication_profiles" => {
                self.update_authentication_profiles(id, input).await
            }
            "reserved_node_exchange_offerings" => {
                self.update_reserved_node_exchange_offerings(id, input).await
            }
            "snapshot_schedule" => {
                self.update_snapshot_schedule(id, input).await
            }
            "cluster_snapshots" => {
                self.update_cluster_snapshots(id, input).await
            }
            "cluster_tracks" => {
                self.update_cluster_tracks(id, input).await
            }
            "scheduled_action" => {
                self.update_scheduled_action(id, input).await
            }
            "hsm_client_certificate" => {
                self.update_hsm_client_certificate(id, input).await
            }
            "partner" => {
                self.update_partner(id, input).await
            }
            "cluster_parameter_groups" => {
                self.update_cluster_parameter_groups(id, input).await
            }
            "event_subscriptions" => {
                self.update_event_subscriptions(id, input).await
            }
            "cluster_parameters" => {
                self.update_cluster_parameters(id, input).await
            }
            "hsm_configurations" => {
                self.update_hsm_configurations(id, input).await
            }
            "reserved_node_exchange_status" => {
            ...
            "table_restore_status" => {
                self.update_table_restore_status(id, input).await
            }
            "endpoint_access" => {
                self.update_endpoint_access(id, input).await
            }
            "logging_status" => {
                self.update_logging_status(id, input).await
            }
            "cluster_versions" => {
                self.update_cluster_versions(id, input).await
            }
            "default_cluster_parameters" => {
                self.update_default_cluster_parameters(id, input).await
            }
            "partner_status" => {
                self.update_partner_status(id, input).await
            }
            "storage" => {
                self.update_storage(id, input).await
            }
            "cluster_subnet_groups" => {
                self.update_cluster_subnet_groups(id, input).await
            }
            "reserved_nodes" => {
                self.update_reserved_nodes(id, input).await
            }
            "data_shares" => {
                self.update_data_shares(id, input).await
            }
            "snapshot_copy_grants" => {
                self.update_snapshot_copy_grants(id, input).await
            }
            "cluster_credentials" => {
                self.update_cluster_credentials(id, input).await
            }
            "redshift_idc_applications" => {
                self.update_redshift_idc_applications(id, input).await
            }
            "reserved_node_exchange_configuration_options" => {
                self.update_reserved_node_exchange_configuration_options(id, input).await
            }
            "usage_limits" => {
                self.update_usage_limits(id, input).await
            }
            "partners" => {
                self.update_partners(id, input).await
            }
            "custom_domain_associations" => {
                self.update_custom_domain_associations(id, input).await
            }
            "custom_domain_association" => {
                self.update_custom_domain_association(id, input).await
            }
            "data_shares_for_consumer" => {
                self.update_data_shares_for_consumer(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "redshift",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "reserved_node_offerings" => {
                self.delete_reserved_node_offerings(id).await
            }
            "inbound_integrations" => {
                self.delete_inbound_integrations(id).await
            }
            "cluster_parameter_group" => {
                self.delete_cluster_parameter_group(id).await
            }
            "tags" => {
            ...
            "cluster_security_group" => {
                self.delete_cluster_security_group(id).await
            }
            "account_attributes" => {
            ...
            "snapshot_schedules" => {
                self.delete_snapshot_schedules(id).await
            }
            "cluster_credentials_with_iam" => {
                self.delete_cluster_credentials_with_iam(id).await
            }
            "data_shares_for_producer" => {
                self.delete_data_shares_for_producer(id).await
            }
            "cluster_db_revisions" => {
                self.delete_cluster_db_revisions(id).await
            }
            "endpoint_authorization" => {
                self.delete_endpoint_authorization(id).await
            }
            "scheduled_actions" => {
                self.delete_scheduled_actions(id).await
            }
            "node_configuration_options" => {
                self.delete_node_configuration_options(id).await
            }
            "snapshot_copy_grant" => {
                self.delete_snapshot_copy_grant(id).await
            }
            "hsm_client_certificates" => {
                self.delete_hsm_client_certificates(id).await
            }
            "clusters" => {
            ...
            "redshift_idc_application" => {
                self.delete_redshift_idc_application(id).await
            }
            "event_categories" => {
                self.delete_event_categories(id).await
            }
            "hsm_configuration" => {
                self.delete_hsm_configuration(id).await
            }
            "resize" => {
                self.delete_resize(id).await
            }
            "cluster_subnet_group" => {
                self.delete_cluster_subnet_group(id).await
            }
            "orderable_cluster_options" => {
                self.delete_orderable_cluster_options(id).await
            }
            "usage_limit" => {
                self.delete_usage_limit(id).await
            }
            "event_subscription" => {
            ...
            "cluster_security_groups" => {
                self.delete_cluster_security_groups(id).await
            }
            "authentication_profiles" => {
                self.delete_authentication_profiles(id).await
            }
            "reserved_node_exchange_offerings" => {
            ...
            "cluster_snapshots" => {
                self.delete_cluster_snapshots(id).await
            }
            "cluster_tracks" => {
                self.delete_cluster_tracks(id).await
            }
            "scheduled_action" => {
                self.delete_scheduled_action(id).await
            }
            "hsm_client_certificate" => {
                self.delete_hsm_client_certificate(id).await
            }
            "partner" => {
                self.delete_partner(id).await
            }
            "cluster_parameter_groups" => {
                self.delete_cluster_parameter_groups(id).await
            }
            "event_subscriptions" => {
                self.delete_event_subscriptions(id).await
            }
            "cluster_parameters" => {
                self.delete_cluster_parameters(id).await
            }
            "hsm_configurations" => {
                self.delete_hsm_configurations(id).await
            }
            "reserved_node_exchange_status" => {
                self.delete_reserved_node_exchange_status(id).await
            }
            "integration" => {
                self.delete_integration(id).await
            }
            "table_restore_status" => {
                self.delete_table_restore_status(id).await
            }
            "endpoint_access" => {
                self.delete_endpoint_access(id).await
            }
            "logging_status" => {
                self.delete_logging_status(id).await
            }
            "cluster_versions" => {
                self.delete_cluster_versions(id).await
            }
            "default_cluster_parameters" => {
                self.delete_default_cluster_parameters(id).await
            }
            "partner_status" => {
                self.delete_partner_status(id).await
            }
            "storage" => {
                self.delete_storage(id).await
            }
            "cluster_subnet_groups" => {
                self.delete_cluster_subnet_groups(id).await
            }
            "reserved_nodes" => {
                self.delete_reserved_nodes(id).await
            }
            "data_shares" => {
                self.delete_data_shares(id).await
            }
            "snapshot_copy_grants" => {
                self.delete_snapshot_copy_grants(id).await
            }
            "cluster_credentials" => {
                self.delete_cluster_credentials(id).await
            }
            "redshift_idc_applications" => {
                self.delete_redshift_idc_applications(id).await
            }
            "reserved_node_exchange_configuration_options" => {
                self.delete_reserved_node_exchange_configuration_options(id).await
            }
            "usage_limits" => {
                self.delete_usage_limits(id).await
            }
            "partners" => {
                self.delete_partners(id).await
            }
            "custom_domain_associations" => {
                self.delete_custom_domain_associations(id).await
            }
            "custom_domain_association" => {
                self.delete_custom_domain_association(id).await
            }
            "data_shares_for_consumer" => {
                self.delete_data_shares_for_consumer(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "redshift",
    ...
    async fn create_reserved_node_offerings(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn read_reserved_node_offerings(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_reserved_node_offerings(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster_parameter_group(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("parameter_group_family", parameter_group_family.unwrap_or_default())
    ...
    async fn read_cluster_parameter_group(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster(
        ...
        self.provider.runtime().block_on(async {
            ...
            let cluster_subnet_group_name = input.get_optional_string("cluster_subnet_group_name")?;
            let cluster_parameter_group_name = input.get_optional_string("cluster_parameter_group_name")?;
            let manual_snapshot_retention_period = input.get_optional_string("manual_snapshot_retention_period")?;
            ...
            let snapshot_schedule_identifier = input.get_optional_string("snapshot_schedule_identifier")?;
            ...
            let availability_zone_relocation = input.get_optional_string("availability_zone_relocation")?;
            ...
            let automated_snapshot_retention_period = input.get_optional_string("automated_snapshot_retention_period")?;
            ...
            let hsm_client_certificate_identifier = input.get_optional_string("hsm_client_certificate_identifier")?;
            ...
            let aqua_configuration_status = input.get_optional_string("aqua_configuration_status")?;
            let master_password_secret_kms_key_id = input.get_optional_string("master_password_secret_kms_key_id")?;
            let port = input.get_optional_string("port")?;
            let allow_version_upgrade = input.get_optional_string("allow_version_upgrade")?;
            let redshift_idc_application_arn = input.get_optional_string("redshift_idc_application_arn")?;
            let availability_zone = input.get_optional_string("availability_zone")?;
            let hsm_configuration_identifier = input.get_optional_string("hsm_configuration_identifier")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("cluster_subnet_group_name", cluster_subnet_group_name.unwrap_or_default())
                .with_field("cluster_parameter_group_name", cluster_parameter_group_name.unwrap_or_default())
                .with_field("manual_snapshot_retention_period", manual_snapshot_retention_period.unwrap_or_default())
                .with_field("iam_roles", iam_roles.unwrap_or_default())
                .with_field("enhanced_vpc_routing", enhanced_vpc_routing.unwrap_or_default())
                .with_field("maintenance_track_name", maintenance_track_name.unwrap_or_default())
                .with_field("snapshot_schedule_identifier", snapshot_schedule_identifier.unwrap_or_default())
                ...
                .with_field("availability_zone_relocation", availability_zone_relocation.unwrap_or_default())
                ...
                .with_field("automated_snapshot_retention_period", automated_snapshot_retention_period.unwrap_or_default())
                ...
                .with_field("cluster_security_groups", cluster_security_groups.unwrap_or_default())
                ...
                .with_field("manage_master_password", manage_master_password.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                ...
                .with_field("hsm_client_certificate_identifier", hsm_client_certificate_identifier.unwrap_or_default())
                .with_field("cluster_identifier", cluster_identifier.unwrap_or_default())
                .with_field("elastic_ip", elastic_ip.unwrap_or_default())
                .with_field("default_iam_role_arn", default_iam_role_arn.unwrap_or_default())
                .with_field("aqua_configuration_status", aqua_configuration_status.unwrap_or_default())
                .with_field("master_password_secret_kms_key_id", master_password_secret_kms_key_id.unwrap_or_default())
                .with_field("port", port.unwrap_or_default())
                .with_field("allow_version_upgrade", allow_version_upgrade.unwrap_or_default())
                .with_field("redshift_idc_application_arn", redshift_idc_application_arn.unwrap_or_default())
                .with_field("availability_zone", availability_zone.unwrap_or_default())
                .with_field("hsm_configuration_identifier", hsm_configuration_identifier.unwrap_or_default())
    ...
    async fn create_cluster_snapshot(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("manual_snapshot_retention_period", manual_snapshot_retention_period.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("snapshot_identifier", snapshot_identifier.unwrap_or_default())
            )
        })
    }
    ...
    async fn create_cluster_security_group(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("tags", tags.unwrap_or_default())
                .with_field("cluster_security_group_name", cluster_security_group_name.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
            )
        })
    }
    ...
    async fn read_cluster_security_group(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_snapshot_schedules(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_snapshot_schedules(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_snapshot_schedules(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_cluster_credentials_with_iam(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_credentials_with_iam(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_data_shares_for_producer(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_data_shares_for_producer(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster_db_revisions(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_cluster_db_revisions(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_db_revisions(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_endpoint_authorization(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_endpoint_authorization(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_endpoint_authorization(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_node_configuration_options(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_node_configuration_options(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_snapshot_copy_grant(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("kms_key_id", kms_key_id.unwrap_or_default())
                .with_field("snapshot_copy_grant_name", snapshot_copy_grant_name.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
            )
        })
    }
    ...
    async fn read_snapshot_copy_grant(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_hsm_client_certificates(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_hsm_client_certificates(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_hsm_client_certificates(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_authentication_profile(
        ...
        self.provider.runtime().block_on(async {
            ...
            let authentication_profile_content = input.get_string("authentication_profile_content")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("authentication_profile_name", authentication_profile_name.unwrap_or_default())
                .with_field("authentication_profile_content", authentication_profile_content.unwrap_or_default())
            )
        })
    }
    ...
    async fn create_redshift_idc_application(
        ...
        self.provider.runtime().block_on(async {
            ...
            let authorized_token_issuer_list = input.get_optional_string("authorized_token_issuer_list")?;
            let identity_namespace = input.get_optional_string("identity_namespace")?;
            let redshift_idc_application_name = input.get_string("redshift_idc_application_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("service_integrations", service_integrations.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("sso_tag_keys", sso_tag_keys.unwrap_or_default())
                .with_field("authorized_token_issuer_list", authorized_token_issuer_list.unwrap_or_default())
                .with_field("identity_namespace", identity_namespace.unwrap_or_default())
                .with_field("redshift_idc_application_name", redshift_idc_application_name.unwrap_or_default())
    ...
    async fn read_redshift_idc_application(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_redshift_idc_application(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_hsm_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            let hsm_server_public_certificate = input.get_string("hsm_server_public_certificate")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("hsm_partition_password", hsm_partition_password.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field("hsm_partition_name", hsm_partition_name.unwrap_or_default())
                .with_field("hsm_server_public_certificate", hsm_server_public_certificate.unwrap_or_default())
            )
        })
    }

    /// Read a hsm_configuration resource
    async fn read_hsm_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_cluster_subnet_group(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_orderable_cluster_options(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_orderable_cluster_options(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster_security_groups(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_cluster_security_groups(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_security_groups(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_authentication_profiles(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_authentication_profiles(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_authentication_profiles(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_reserved_node_exchange_offerings(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_reserved_node_exchange_offerings(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_snapshot_schedule(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("schedule_definitions", schedule_definitions.unwrap_or_default())
                .with_field("schedule_description", schedule_description.unwrap_or_default())
                .with_field("dry_run", dry_run.unwrap_or_default())
                .with_field("schedule_identifier", schedule_identifier.unwrap_or_default())
    ...
    async fn create_cluster_snapshots(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_cluster_snapshots(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_snapshots(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster_tracks(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_cluster_tracks(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_scheduled_action(
        ...
        self.provider.runtime().block_on(async {
            ...
            let scheduled_action_description = input.get_optional_string("scheduled_action_description")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("scheduled_action_description", scheduled_action_description.unwrap_or_default())
    ...
    async fn create_hsm_client_certificate(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let hsm_client_certificate_identifier = input.get_string("hsm_client_certificate_identifier")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_hsm_client_certificate(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_cluster_parameter_groups(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_parameter_groups(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster_parameters(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_cluster_parameters(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_parameters(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_hsm_configurations(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_hsm_configurations(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_hsm_configurations(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_reserved_node_exchange_status(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_reserved_node_exchange_status(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_table_restore_status(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_table_restore_status(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_table_restore_status(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_logging_status(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_logging_status(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_default_cluster_parameters(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_default_cluster_parameters(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_partner_status(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_partner_status(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster_subnet_groups(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_cluster_subnet_groups(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_subnet_groups(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_snapshot_copy_grants(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_snapshot_copy_grants(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_snapshot_copy_grants(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cluster_credentials(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_cluster_credentials(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_cluster_credentials(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_redshift_idc_applications(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_redshift_idc_applications(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_reserved_node_exchange_configuration_options(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_custom_domain_associations(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_custom_domain_associations(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_data_shares_for_consumer(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_data_shares_for_consumer(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
