...
impl<'a> Usage_limit<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, cluster_identifier: String, limit_type: String, feature_type: String, amount: i64, period: Option<String>, breach_action: Option<String>) -> Result<String> {
