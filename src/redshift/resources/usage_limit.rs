...
impl<'a> Usage_limit<'a> {
    ...
    pub async fn create(&self, feature_type: String, cluster_identifier: String, period: Option<String>, amount: i64, breach_action: Option<String>, tags: Option<Vec<String>>, limit_type: String) -> Result<String> {
