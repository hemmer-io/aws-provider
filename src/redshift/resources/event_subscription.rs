...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, severity: Option<String>, sns_topic_arn: String, tags: Option<Vec<String>>, event_categories: Option<Vec<String>>, enabled: Option<bool>, subscription_name: String, source_type: Option<String>, source_ids: Option<Vec<String>>) -> Result<String> {
