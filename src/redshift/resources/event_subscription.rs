...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, event_categories: Option<Vec<String>>, subscription_name: String, source_ids: Option<Vec<String>>, sns_topic_arn: String, enabled: Option<bool>, source_type: Option<String>, severity: Option<String>) -> Result<String> {
