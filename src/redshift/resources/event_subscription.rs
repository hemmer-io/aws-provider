...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, enabled: Option<bool>, sns_topic_arn: String, event_categories: Option<Vec<String>>, tags: Option<Vec<String>>, severity: Option<String>, source_ids: Option<Vec<String>>, subscription_name: String, source_type: Option<String>) -> Result<String> {
