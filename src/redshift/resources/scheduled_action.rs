...
impl<'a> Scheduled_action<'a> {
    ...
    pub async fn create(&self, target_action: String, schedule: String, start_time: Option<String>, scheduled_action_description: Option<String>, iam_role: String, enable: Option<bool>, scheduled_action_name: String, end_time: Option<String>) -> Result<String> {
