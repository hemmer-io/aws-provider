...
impl<'a> Scheduled_action<'a> {
    ...
    pub async fn create(&self, target_action: String, iam_role: String, end_time: Option<String>, schedule: String, enable: Option<bool>, scheduled_action_description: Option<String>, scheduled_action_name: String, start_time: Option<String>) -> Result<String> {
