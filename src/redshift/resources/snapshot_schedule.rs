...
impl<'a> Snapshot_schedule<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, schedule_definitions: Option<Vec<String>>, schedule_description: Option<String>, dry_run: Option<bool>, schedule_identifier: Option<String>, next_invocations: Option<i64>) -> Result<String> {
