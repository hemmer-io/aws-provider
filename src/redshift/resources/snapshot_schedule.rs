...
impl<'a> Snapshot_schedule<'a> {
    ...
    pub async fn create(&self, schedule_definitions: Option<Vec<String>>, schedule_identifier: Option<String>, dry_run: Option<bool>, next_invocations: Option<i64>, schedule_description: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
