...
impl<'a> Redshift_idc_application<'a> {
    ...
    pub async fn create(&self, authorized_token_issuer_list: Option<Vec<String>>, service_integrations: Option<Vec<String>>, tags: Option<Vec<String>>, idc_instance_arn: String, sso_tag_keys: Option<Vec<String>>, redshift_idc_application_name: String, identity_namespace: Option<String>, idc_display_name: String, iam_role_arn: String) -> Result<String> {
