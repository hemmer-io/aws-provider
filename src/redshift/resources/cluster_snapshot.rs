...
impl<'a> Cluster_snapshot<'a> {
    ...
    pub async fn create(&self, manual_snapshot_retention_period: Option<i64>, snapshot_identifier: String, cluster_identifier: String, tags: Option<Vec<String>>) -> Result<String> {
