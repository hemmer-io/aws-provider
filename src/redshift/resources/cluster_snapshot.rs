...
impl<'a> Cluster_snapshot<'a> {
    ...
    pub async fn create(&self, manual_snapshot_retention_period: Option<i64>, cluster_identifier: String, snapshot_identifier: String, tags: Option<Vec<String>>) -> Result<String> {
