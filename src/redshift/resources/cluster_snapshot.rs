...
impl<'a> Cluster_snapshot<'a> {
    ...
    pub async fn create(&self, cluster_identifier: String, manual_snapshot_retention_period: Option<i64>, tags: Option<Vec<String>>, snapshot_identifier: String) -> Result<String> {
