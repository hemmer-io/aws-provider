...
impl<'a> Endpoint_access<'a> {
    ...
    pub async fn create(&self, resource_owner: Option<String>, cluster_identifier: Option<String>, endpoint_name: String, vpc_security_group_ids: Option<Vec<String>>, subnet_group_name: String) -> Result<String> {
