...
impl<'a> Partner_status<'a> {
    ...
    pub async fn update(&self, id: &str, cluster_identifier: Option<String>, partner_name: Option<String>, status: Option<String>, database_name: Option<String>, status_message: Option<String>, account_id: Option<String>) -> Result<()> {
