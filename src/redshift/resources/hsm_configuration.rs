...
impl<'a> Hsm_configuration<'a> {
    ...
    pub async fn create(&self, hsm_ip_address: String, hsm_partition_name: String, hsm_partition_password: String, hsm_server_public_certificate: String, tags: Option<Vec<String>>, description: String, hsm_configuration_identifier: String) -> Result<String> {
