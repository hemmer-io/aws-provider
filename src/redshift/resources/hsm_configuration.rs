...
impl<'a> Hsm_configuration<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, hsm_configuration_identifier: String, hsm_ip_address: String, description: String, hsm_partition_name: String, hsm_partition_password: String, hsm_server_public_certificate: String) -> Result<String> {
