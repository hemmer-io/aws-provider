...
impl<'a> FisService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "experiment_target_account_configuration" => {
                self.plan_experiment_target_account_configuration(current_state, desired_input)
                    .await
            }
            "experiment" => self.plan_experiment(current_state, desired_input).await,
            "target_account_configuration" => {
                self.plan_target_account_configuration(current_state, desired_input)
                    .await
            }
            "safety_lever" => self.plan_safety_lever(current_state, desired_input).await,
            "target_resource_type" => {
                self.plan_target_resource_type(current_state, desired_input)
                    .await
            }
            "safety_lever_state" => {
                self.plan_safety_lever_state(current_state, desired_input)
                    .await
            }
            "experiment_template" => {
                self.plan_experiment_template(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "experiment_target_account_configuration" => {
                self.create_experiment_target_account_configuration(input)
                    .await
            }
            "experiment" => self.create_experiment(input).await,
            "target_account_configuration" => self.create_target_account_configuration(input).await,
            "safety_lever" => self.create_safety_lever(input).await,
            "target_resource_type" => self.create_target_resource_type(input).await,
            "safety_lever_state" => self.create_safety_lever_state(input).await,
            "experiment_template" => self.create_experiment_template(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "fis", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "target_account_configuration" => self.read_target_account_configuration(id).await,
            "safety_lever" => self.read_safety_lever(id).await,
            "target_resource_type" => self.read_target_resource_type(id).await,
            "safety_lever_state" => self.read_safety_lever_state(id).await,
            "experiment_template" => self.read_experiment_template(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "fis", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "experiment_target_account_configuration" => {
                self.update_experiment_target_account_configuration(id, input)
                    .await
            }
            ...
            "safety_lever" => self.update_safety_lever(id, input).await,
            "target_resource_type" => self.update_target_resource_type(id, input).await,
            "safety_lever_state" => self.update_safety_lever_state(id, input).await,
            "experiment_template" => self.update_experiment_template(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "fis", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "experiment_target_account_configuration" => {
                self.delete_experiment_target_account_configuration(id)
                    .await
            }
            "experiment" => self.delete_experiment(id).await,
            "target_account_configuration" => self.delete_target_account_configuration(id).await,
            "safety_lever" => self.delete_safety_lever(id).await,
            "target_resource_type" => self.delete_target_resource_type(id).await,
            "safety_lever_state" => self.delete_safety_lever_state(id).await,
            "experiment_template" => self.delete_experiment_template(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "fis", resource_name
            ))),
    ...
    async fn delete_experiment_target_account_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.fis_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    experiment_template_id.unwrap_or_default(),
                )
    ...
    async fn read_target_account_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.fis_client
    ...
    async fn delete_target_account_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.fis_client
    ...
    async fn create_safety_lever(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_safety_lever(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.fis_client
    ...
    async fn update_safety_lever(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_safety_lever(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.fis_client
    ...
    async fn create_target_resource_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_target_resource_type(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.fis_client
    ...
    async fn delete_target_resource_type(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.fis_client
    ...
    async fn create_safety_lever_state(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_safety_lever_state(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.fis_client
    ...
    async fn delete_safety_lever_state(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.fis_client
    ...
    async fn create_experiment_template(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let experiment_report_configuration =
                input.get_optional_string("experiment_report_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    experiment_report_configuration.unwrap_or_default(),
                )
    ...
    async fn read_experiment_template(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.fis_client
    ...
    async fn delete_experiment_template(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.fis_client
