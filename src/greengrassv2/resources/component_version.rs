...
impl<'a> Component_version<'a> {
    ...
    pub async fn create(&self, lambda_function: Option<String>, inline_recipe: Option<String>, tags: Option<HashMap<String, String>>, client_token: Option<String>) -> Result<String> {
