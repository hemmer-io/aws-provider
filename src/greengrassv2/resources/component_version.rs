...
impl<'a> Component_version<'a> {
    ...
    pub async fn create(&self, inline_recipe: Option<String>, client_token: Option<String>, lambda_function: Option<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
