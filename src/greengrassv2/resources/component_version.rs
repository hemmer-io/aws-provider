...
impl<'a> Component_version<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, inline_recipe: Option<String>, tags: Option<HashMap<String, String>>, lambda_function: Option<String>) -> Result<String> {
