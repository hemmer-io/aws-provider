...
impl<'a> Global_cluster<'a> {
    ...
    pub async fn create(&self, storage_encrypted: Option<bool>, database_name: Option<String>, engine: Option<String>, global_cluster_identifier: String, source_db_cluster_identifier: Option<String>, engine_version: Option<String>, deletion_protection: Option<bool>) -> Result<String> {
