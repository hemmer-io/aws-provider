...
impl<'a> Global_cluster<'a> {
    ...
    pub async fn create(&self, storage_encrypted: Option<bool>, source_dbcluster_identifier: Option<String>, global_cluster_identifier: String, deletion_protection: Option<bool>, engine_version: Option<String>, engine: Option<String>, database_name: Option<String>) -> Result<String> {
