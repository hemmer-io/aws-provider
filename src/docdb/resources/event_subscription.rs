...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, source_type: Option<String>, subscription_name: String, enabled: Option<bool>, sns_topic_arn: String, event_categories: Option<Vec<String>>, tags: Option<Vec<String>>, source_ids: Option<Vec<String>>) -> Result<String> {
