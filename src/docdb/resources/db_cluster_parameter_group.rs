...
impl<'a> Db_cluster_parameter_group<'a> {
    ...
    pub async fn create(&self, db_cluster_parameter_group_name: String, db_parameter_group_family: String, description: String, tags: Option<Vec<String>>) -> Result<String> {
