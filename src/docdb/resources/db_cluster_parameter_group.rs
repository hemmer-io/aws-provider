...
impl<'a> Db_cluster_parameter_group<'a> {
    ...
    pub async fn create(&self, description: String, db_cluster_parameter_group_name: String, db_parameter_group_family: String, tags: Option<Vec<String>>) -> Result<String> {
