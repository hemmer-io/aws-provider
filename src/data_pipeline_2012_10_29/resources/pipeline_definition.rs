...
impl<'a> Pipeline_definition<'a> {
    ...
    pub async fn create(&self, pipeline_id: String, parameter_values: Option<Vec<String>>, pipeline_objects: Vec<String>, parameter_objects: Option<Vec<String>>) -> Result<String> {
