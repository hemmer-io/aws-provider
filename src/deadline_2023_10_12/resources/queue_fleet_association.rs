...
impl<'a> Queue_fleet_association<'a> {
    ...
    pub async fn create(&self, queue_id: String, farm_id: String, fleet_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, queue_id: Option<String>, farm_id: Option<String>, fleet_id: Option<String>) -> Result<()> {
