...
impl<'a> Global_table_settings<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, global_table_name: Option<String>, global_table_global_secondary_index_settings_update: Option<Vec<String>>, global_table_billing_mode: Option<String>, global_table_provisioned_write_capacity_auto_scaling_settings_update: Option<String>, replica_settings_update: Option<Vec<String>>, global_table_provisioned_write_capacity_units: Option<i64>) -> Result<()> {
