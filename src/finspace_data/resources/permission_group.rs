...
impl<'a> Permission_group<'a> {
    ...
    pub async fn create(&self, description: Option<String>, application_permissions: Vec<String>, name: String, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, application_permissions: Option<Vec<String>>, name: Option<String>, client_token: Option<String>) -> Result<()> {
