...
impl<'a> Permission_group<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, application_permissions: Vec<String>, description: Option<String>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, application_permissions: Option<Vec<String>>, description: Option<String>, name: Option<String>) -> Result<()> {
