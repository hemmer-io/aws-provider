...
impl<'a> Permission_group<'a> {
    ...
    pub async fn create(&self, name: String, client_token: Option<String>, description: Option<String>, application_permissions: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, client_token: Option<String>, description: Option<String>, application_permissions: Option<Vec<String>>) -> Result<()> {
