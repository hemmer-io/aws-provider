...
impl<'a> Library_item<'a> {
    ...
    pub async fn create(&self, app_id: String, categories: Vec<String>, instance_id: String, app_version: i64) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, app_id: Option<String>, categories: Option<Vec<String>>, instance_id: Option<String>, app_version: Option<i64>) -> Result<()> {
