...
impl<'a> Q_app_session_metadata<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, instance_id: Option<String>, session_id: Option<String>, session_name: Option<String>, sharing_configuration: Option<String>) -> Result<()> {
