...
impl<'a> User_profile<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, user_identifier: String, user_type: Option<String>, domain_identifier: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, user_identifier: Option<String>, user_type: Option<String>, domain_identifier: Option<String>) -> Result<()> {
