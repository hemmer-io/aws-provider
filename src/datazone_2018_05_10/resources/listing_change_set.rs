...
impl<'a> Listing_change_set<'a> {
    ...
    pub async fn create(&self, entity_identifier: String, entity_type: String, entity_revision: Option<String>, action: String, domain_identifier: String, client_token: Option<String>) -> Result<String> {
