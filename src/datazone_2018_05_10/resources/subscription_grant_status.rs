...
impl<'a> Subscription_grant_status<'a> {
    ...
    pub async fn update(&self, id: &str, failure_cause: Option<String>, target_name: Option<String>, domain_identifier: Option<String>, identifier: Option<String>, status: Option<String>, asset_identifier: Option<String>) -> Result<()> {
