...
impl<'a> Environment_blueprint<'a> {
    ...
    pub async fn create(&self, domain_identifier: String, user_parameters: Option<Vec<String>>, description: Option<String>, name: String, provisioning_properties: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, domain_identifier: Option<String>, user_parameters: Option<Vec<String>>, description: Option<String>, name: Option<String>, provisioning_properties: Option<String>) -> Result<()> {
