...
impl<'a> Package_versions_status<'a> {
    ...
    pub async fn update(&self, id: &str, namespace: Option<String>, package: Option<String>, version_revisions: Option<HashMap<String, String>>, target_status: Option<String>, repository: Option<String>, domain: Option<String>, format: Option<String>, expected_status: Option<String>, domain_owner: Option<String>, versions: Option<Vec<String>>) -> Result<()> {
