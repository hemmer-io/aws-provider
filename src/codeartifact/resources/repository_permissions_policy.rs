...
impl<'a> Repository_permissions_policy<'a> {
    ...
    pub async fn create(&self, domain: String, repository: String, policy_document: String, policy_revision: Option<String>, domain_owner: Option<String>) -> Result<String> {
