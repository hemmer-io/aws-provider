...
impl<'a> Package_group<'a> {
    ...
    pub async fn create(&self, domain: String, domain_owner: Option<String>, package_group: String, contact_info: Option<String>, description: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, domain: Option<String>, domain_owner: Option<String>, package_group: Option<String>, contact_info: Option<String>, description: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
