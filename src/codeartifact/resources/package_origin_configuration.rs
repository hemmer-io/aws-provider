...
impl<'a> Package_origin_configuration<'a> {
    ...
    pub async fn create(&self, repository: String, namespace: Option<String>, restrictions: String, domain: String, domain_owner: Option<String>, package: String, format: String) -> Result<String> {
