...
impl<'a> Package_group_origin_configuration<'a> {
    ...
    pub async fn update(&self, id: &str, domain: Option<String>, add_allowed_repositories: Option<Vec<String>>, remove_allowed_repositories: Option<Vec<String>>, package_group: Option<String>, domain_owner: Option<String>, restrictions: Option<HashMap<String, String>>) -> Result<()> {
