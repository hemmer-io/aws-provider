...
impl<'a> Cloudtrail_dataService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "audit_events" => self.plan_audit_events(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudtrail_data", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "audit_events" => self.create_audit_events(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudtrail_data", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "audit_events" => self.read_audit_events(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudtrail_data", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "audit_events" => self.update_audit_events(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudtrail_data", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "audit_events" => self.delete_audit_events(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudtrail_data", resource_name
            ))),
    ...
    async fn create_audit_events(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_audit_events(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_audit_events(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let channel_arn = input.get_string("channel_arn")?;
            let external_id = input.get_optional_string("external_id")?;
    ...
    async fn delete_audit_events(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
