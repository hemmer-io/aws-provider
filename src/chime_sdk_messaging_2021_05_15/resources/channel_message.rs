...
impl<'a> Channel_message<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, message_id: Option<String>, chime_bearer: Option<String>, content_type: Option<String>, content: Option<String>, channel_arn: Option<String>, sub_channel_id: Option<String>, metadata: Option<String>) -> Result<()> {
