//! Resource_groups_tagging_api service for Aws provider
//!
//! This module handles all resource_groups_tagging_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Resource_groups_tagging_api service handler
pub struct Resource_groups_tagging_apiService<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Resource_groups_tagging_apiService<'a> {
    ...
    // ------------------------------------------------------------------------
    // Tag_keys resource operations
    // ------------------------------------------------------------------------

    /// Plan changes to a tag_keys resource
    async fn plan_tag_keys(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Create a new tag_keys resource
    async fn create_tag_keys(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    /// Read a tag_keys resource
    async fn read_tag_keys(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    /// Update a tag_keys resource
    async fn update_tag_keys(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    /// Delete a tag_keys resource
    async fn delete_tag_keys(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    // ------------------------------------------------------------------------
    // Compliance_summary resource operations
    // ------------------------------------------------------------------------

    /// Plan changes to a compliance_summary resource
    async fn plan_compliance_summary(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Create a new compliance_summary resource
    async fn create_compliance_summary(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    /// Read a compliance_summary resource
    async fn read_compliance_summary(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    /// Update a compliance_summary resource
    async fn update_compliance_summary(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    /// Delete a compliance_summary resource
    async fn delete_compliance_summary(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    /// Plan changes to a tag_values resource
    async fn plan_tag_values(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Create a new tag_values resource
    async fn create_tag_values(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    /// Update a tag_values resource
    async fn update_tag_values(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    /// Delete a tag_values resource
    async fn delete_tag_values(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
