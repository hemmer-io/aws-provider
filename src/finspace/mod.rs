...
impl<'a> FinspaceService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "kx_database" => self.plan_kx_database(current_state, desired_input).await,
            "kx_changeset" => self.plan_kx_changeset(current_state, desired_input).await,
            "kx_connection_string" => {
                self.plan_kx_connection_string(current_state, desired_input)
                    .await
            }
            "kx_cluster_code_configuration" => {
                self.plan_kx_cluster_code_configuration(current_state, desired_input)
                    .await
            }
            "kx_dataview" => self.plan_kx_dataview(current_state, desired_input).await,
            "kx_environment" => self.plan_kx_environment(current_state, desired_input).await,
            "kx_scaling_group" => {
                self.plan_kx_scaling_group(current_state, desired_input)
                    .await
            }
            "environment" => self.plan_environment(current_state, desired_input).await,
            "kx_cluster_databases" => {
                self.plan_kx_cluster_databases(current_state, desired_input)
                    .await
            }
            "kx_cluster" => self.plan_kx_cluster(current_state, desired_input).await,
            "kx_volume" => self.plan_kx_volume(current_state, desired_input).await,
            "kx_environment_network" => {
                self.plan_kx_environment_network(current_state, desired_input)
                    .await
            }
            "kx_user" => self.plan_kx_user(current_state, desired_input).await,
            "kx_cluster_node" => {
                self.plan_kx_cluster_node(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "finspace", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "kx_database" => self.create_kx_database(input).await,
            "kx_changeset" => self.create_kx_changeset(input).await,
            "kx_connection_string" => self.create_kx_connection_string(input).await,
            "kx_cluster_code_configuration" => {
                self.create_kx_cluster_code_configuration(input).await
            }
            "kx_dataview" => self.create_kx_dataview(input).await,
            "kx_environment" => self.create_kx_environment(input).await,
            "kx_scaling_group" => self.create_kx_scaling_group(input).await,
            "environment" => self.create_environment(input).await,
            "kx_cluster_databases" => self.create_kx_cluster_databases(input).await,
            "kx_cluster" => self.create_kx_cluster(input).await,
            "kx_volume" => self.create_kx_volume(input).await,
            "kx_environment_network" => self.create_kx_environment_network(input).await,
            "kx_user" => self.create_kx_user(input).await,
            "kx_cluster_node" => self.create_kx_cluster_node(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "finspace", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "kx_database" => self.read_kx_database(id).await,
            "kx_changeset" => self.read_kx_changeset(id).await,
            "kx_connection_string" => self.read_kx_connection_string(id).await,
            "kx_cluster_code_configuration" => self.read_kx_cluster_code_configuration(id).await,
            "kx_dataview" => self.read_kx_dataview(id).await,
            "kx_environment" => self.read_kx_environment(id).await,
            "kx_scaling_group" => self.read_kx_scaling_group(id).await,
            "environment" => self.read_environment(id).await,
            "kx_cluster_databases" => self.read_kx_cluster_databases(id).await,
            "kx_cluster" => self.read_kx_cluster(id).await,
            "kx_volume" => self.read_kx_volume(id).await,
            "kx_environment_network" => self.read_kx_environment_network(id).await,
            "kx_user" => self.read_kx_user(id).await,
            "kx_cluster_node" => self.read_kx_cluster_node(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "finspace", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "kx_database" => self.update_kx_database(id, input).await,
            "kx_changeset" => self.update_kx_changeset(id, input).await,
            "kx_connection_string" => self.update_kx_connection_string(id, input).await,
            "kx_cluster_code_configuration" => {
                self.update_kx_cluster_code_configuration(id, input).await
            }
            "kx_dataview" => self.update_kx_dataview(id, input).await,
            "kx_environment" => self.update_kx_environment(id, input).await,
            "kx_scaling_group" => self.update_kx_scaling_group(id, input).await,
            "environment" => self.update_environment(id, input).await,
            "kx_cluster_databases" => self.update_kx_cluster_databases(id, input).await,
            "kx_cluster" => self.update_kx_cluster(id, input).await,
            "kx_volume" => self.update_kx_volume(id, input).await,
            "kx_environment_network" => self.update_kx_environment_network(id, input).await,
            "kx_user" => self.update_kx_user(id, input).await,
            "kx_cluster_node" => self.update_kx_cluster_node(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "finspace", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "kx_database" => self.delete_kx_database(id).await,
            "kx_changeset" => self.delete_kx_changeset(id).await,
            "kx_connection_string" => self.delete_kx_connection_string(id).await,
            "kx_cluster_code_configuration" => self.delete_kx_cluster_code_configuration(id).await,
            "kx_dataview" => self.delete_kx_dataview(id).await,
            "kx_environment" => self.delete_kx_environment(id).await,
            "kx_scaling_group" => self.delete_kx_scaling_group(id).await,
            "environment" => self.delete_environment(id).await,
            "kx_cluster_databases" => self.delete_kx_cluster_databases(id).await,
            "kx_cluster" => self.delete_kx_cluster(id).await,
            "kx_volume" => self.delete_kx_volume(id).await,
            "kx_environment_network" => self.delete_kx_environment_network(id).await,
            "kx_user" => self.delete_kx_user(id).await,
            "kx_cluster_node" => self.delete_kx_cluster_node(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "finspace", resource_name
            ))),
    ...
    async fn create_kx_database(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_kx_database(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_kx_database(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let environment_id = input.get_string("environment_id")?;
            let database_name = input.get_string("database_name")?;
    ...
    async fn delete_kx_database(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_kx_changeset(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let database_name = input.get_string("database_name")?;
    ...
    async fn read_kx_changeset(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.finspace_client
    ...
    async fn update_kx_changeset(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let database_name = input.get_string("database_name")?;
            let change_requests = input.get_string("change_requests")?;
    ...
    async fn delete_kx_changeset(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.finspace_client
    ...
    async fn create_kx_connection_string(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_kx_connection_string(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.finspace_client
    ...
    async fn delete_kx_connection_string(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.finspace_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    command_line_arguments.unwrap_or_default(),
                )
                .with_field(
                ...
                .with_field(
                    ...
                    initialization_script.unwrap_or_default(),
                )
    ...
    async fn read_kx_cluster_code_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.finspace_client
    ...
    async fn delete_kx_cluster_code_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.finspace_client
    ...
    async fn create_kx_dataview(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    availability_zone_id.unwrap_or_default(),
                )
                .with_field(
                    "segment_configurations",
                    segment_configurations.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default())
    ...
    async fn read_kx_dataview(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.finspace_client
    ...
    async fn update_kx_dataview(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let az_mode = input.get_string("az_mode")?;
            let read_write = input.get_optional_string("read_write")?;
    ...
    async fn delete_kx_dataview(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.finspace_client
    ...
    async fn create_kx_environment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_kx_environment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.finspace_client
    ...
    async fn delete_kx_environment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.finspace_client
    ...
    async fn create_kx_scaling_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let environment_id = input.get_string("environment_id")?;
    ...
    async fn read_kx_scaling_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.finspace_client
    ...
    async fn delete_kx_scaling_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.finspace_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    federation_parameters.unwrap_or_default(),
                )
                .with_field(
                    "superuser_parameters",
                    superuser_parameters.unwrap_or_default(),
                )
                .with_field("name", name.unwrap_or_default())
    ...
    async fn create_kx_cluster_databases(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_kx_cluster_databases(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.finspace_client
    ...
    async fn delete_kx_cluster_databases(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.finspace_client
    ...
    async fn create_kx_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let environment_id = input.get_string("environment_id")?;
            let tickerplant_log_configuration =
                input.get_optional_string("tickerplant_log_configuration")?;
            let scaling_group_configuration =
                input.get_optional_string("scaling_group_configuration")?;
            ...
            let cluster_name = input.get_string("cluster_name")?;
            let tags = input.get_optional_string("tags")?;
            let cache_storage_configurations =
                input.get_optional_string("cache_storage_configurations")?;
            ...
            let savedown_storage_configuration =
                input.get_optional_string("savedown_storage_configuration")?;
            let execution_role = input.get_optional_string("execution_role")?;
            let auto_scaling_configuration =
                input.get_optional_string("auto_scaling_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    tickerplant_log_configuration.unwrap_or_default(),
                )
                .with_field(
                    "scaling_group_configuration",
                    scaling_group_configuration.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    cache_storage_configurations.unwrap_or_default(),
                )
                .with_field("code", code.unwrap_or_default())
                .with_field(
                    "capacity_configuration",
                    capacity_configuration.unwrap_or_default(),
                )
                .with_field("vpc_configuration", vpc_configuration.unwrap_or_default())
                .with_field(
                    "savedown_storage_configuration",
                    savedown_storage_configuration.unwrap_or_default(),
                )
                .with_field("execution_role", execution_role.unwrap_or_default())
                .with_field(
                    "auto_scaling_configuration",
                    auto_scaling_configuration.unwrap_or_default(),
                )
                .with_field("databases", databases.unwrap_or_default())
                .with_field(
                    "cluster_description",
                    cluster_description.unwrap_or_default(),
                )
                .with_field("az_mode", az_mode.unwrap_or_default()))
        })
    }
    ...
    async fn read_kx_cluster(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.finspace_client
    ...
    async fn update_kx_cluster(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let environment_id = input.get_string("environment_id")?;
            let tickerplant_log_configuration =
    ...
    async fn delete_kx_cluster(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.finspace_client
    ...
    async fn create_kx_volume(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    availability_zone_ids.unwrap_or_default(),
                )
                .with_field("az_mode", az_mode.unwrap_or_default())
    ...
    async fn read_kx_volume(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.finspace_client
    ...
    async fn update_kx_volume(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let volume_name = input.get_string("volume_name")?;
            let availability_zone_ids = input.get_string("availability_zone_ids")?;
    ...
    async fn delete_kx_volume(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.finspace_client
    ...
    async fn create_kx_environment_network(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let transit_gateway_configuration =
                input.get_optional_string("transit_gateway_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    transit_gateway_configuration.unwrap_or_default(),
                )
                .with_field(
                    "custom_dns_configuration",
                    custom_dns_configuration.unwrap_or_default(),
                )
                .with_field("environment_id", environment_id.unwrap_or_default())
                .with_field("client_token", client_token.unwrap_or_default()))
        })
    ...
    async fn read_kx_environment_network(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.finspace_client
    ...
    async fn delete_kx_environment_network(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.finspace_client
    ...
    async fn create_kx_user(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_kx_user(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.finspace_client
    ...
    async fn update_kx_user(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let environment_id = input.get_string("environment_id")?;
    ...
    async fn delete_kx_user(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.finspace_client
    ...
    async fn create_kx_cluster_node(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_kx_cluster_node(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.finspace_client
    ...
    async fn delete_kx_cluster_node(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.finspace_client
