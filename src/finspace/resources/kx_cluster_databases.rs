...
impl<'a> Kx_cluster_databases<'a> {
    ...
    pub async fn update(&self, id: &str, deployment_configuration: Option<String>, environment_id: Option<String>, databases: Option<Vec<String>>, cluster_name: Option<String>, client_token: Option<String>) -> Result<()> {
