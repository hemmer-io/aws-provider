...
impl<'a> Kx_environment<'a> {
    ...
    pub async fn create(&self, description: Option<String>, tags: Option<HashMap<String, String>>, name: String, kms_key_id: String, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, tags: Option<HashMap<String, String>>, name: Option<String>, kms_key_id: Option<String>, client_token: Option<String>) -> Result<()> {
