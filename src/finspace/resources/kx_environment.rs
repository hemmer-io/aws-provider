...
impl<'a> Kx_environment<'a> {
    ...
    pub async fn create(&self, name: String, tags: Option<HashMap<String, String>>, client_token: Option<String>, description: Option<String>, kms_key_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, tags: Option<HashMap<String, String>>, client_token: Option<String>, description: Option<String>, kms_key_id: Option<String>) -> Result<()> {
