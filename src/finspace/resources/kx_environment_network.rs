...
impl<'a> Kx_environment_network<'a> {
    ...
    pub async fn update(&self, id: &str, transit_gateway_configuration: Option<String>, environment_id: Option<String>, custom_dnsconfiguration: Option<Vec<String>>, client_token: Option<String>) -> Result<()> {
