...
impl<'a> Kx_environment_network<'a> {
    ...
    pub async fn update(&self, id: &str, transit_gateway_configuration: Option<String>, custom_dns_configuration: Option<Vec<String>>, environment_id: Option<String>, client_token: Option<String>) -> Result<()> {
