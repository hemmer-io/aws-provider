...
impl<'a> Kx_scaling_group<'a> {
    ...
    pub async fn create(&self, environment_id: String, scaling_group_name: String, host_type: String, client_token: String, availability_zone_id: String, tags: Option<HashMap<String, String>>) -> Result<String> {
