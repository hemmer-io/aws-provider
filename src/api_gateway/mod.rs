...
impl<'a> Api_gatewayService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "method_response" => {
                self.plan_method_response(current_state, desired_input).await
            }
            "gateway_responses" => {
                self.plan_gateway_responses(current_state, desired_input).await
            }
            "domain_name" => {
            ...
            "request_validator" => {
                self.plan_request_validator(current_state, desired_input).await
            }
            "rest_apis" => {
                self.plan_rest_apis(current_state, desired_input).await
            }
            "sdk_type" => {
                self.plan_sdk_type(current_state, desired_input).await
            }
            "usage_plan_key" => {
                self.plan_usage_plan_key(current_state, desired_input).await
            }
            "sdk_types" => {
                self.plan_sdk_types(current_state, desired_input).await
            }
            "domain_name_access_association" => {
                self.plan_domain_name_access_association(current_state, desired_input).await
            }
            "stages" => {
                self.plan_stages(current_state, desired_input).await
            }
            "usage_plans" => {
                self.plan_usage_plans(current_state, desired_input).await
            }
            "request_validators" => {
                self.plan_request_validators(current_state, desired_input).await
            }
            "authorizers" => {
                self.plan_authorizers(current_state, desired_input).await
            }
            "documentation_parts" => {
                self.plan_documentation_parts(current_state, desired_input).await
            }
            "domain_names" => {
            ...
            "api_keys" => {
                self.plan_api_keys(current_state, desired_input).await
            }
            "gateway_response" => {
                self.plan_gateway_response(current_state, desired_input).await
            }
            "client_certificate" => {
                self.plan_client_certificate(current_state, desired_input).await
            }
            "documentation_part" => {
                self.plan_documentation_part(current_state, desired_input).await
            }
            "usage_plan" => {
                self.plan_usage_plan(current_state, desired_input).await
            }
            "integration" => {
                self.plan_integration(current_state, desired_input).await
            }
            "method" => {
                self.plan_method(current_state, desired_input).await
            }
            "base_path_mappings" => {
                self.plan_base_path_mappings(current_state, desired_input).await
            }
            "rest_api" => {
                self.plan_rest_api(current_state, desired_input).await
            }
            "vpc_link" => {
            ...
            "base_path_mapping" => {
                self.plan_base_path_mapping(current_state, desired_input).await
            }
            "domain_name_access_associations" => {
                self.plan_domain_name_access_associations(current_state, desired_input).await
            }
            "documentation_version" => {
                self.plan_documentation_version(current_state, desired_input).await
            }
            "usage_plan_keys" => {
                self.plan_usage_plan_keys(current_state, desired_input).await
            }
            "resource" => {
                self.plan_resource(current_state, desired_input).await
            }
            "usage" => {
                self.plan_usage(current_state, desired_input).await
            }
            "documentation_versions" => {
                self.plan_documentation_versions(current_state, desired_input).await
            }
            "client_certificates" => {
                self.plan_client_certificates(current_state, desired_input).await
            }
            "sdk" => {
                self.plan_sdk(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "method_response" => {
                self.create_method_response(input).await
            }
            "gateway_responses" => {
                self.create_gateway_responses(input).await
            }
            "domain_name" => {
            ...
            "request_validator" => {
                self.create_request_validator(input).await
            }
            "rest_apis" => {
                self.create_rest_apis(input).await
            }
            "sdk_type" => {
                self.create_sdk_type(input).await
            }
            "usage_plan_key" => {
                self.create_usage_plan_key(input).await
            }
            "sdk_types" => {
                self.create_sdk_types(input).await
            }
            "domain_name_access_association" => {
            ...
            "usage_plans" => {
                self.create_usage_plans(input).await
            }
            "request_validators" => {
                self.create_request_validators(input).await
            }
            "authorizers" => {
                self.create_authorizers(input).await
            }
            "documentation_parts" => {
                self.create_documentation_parts(input).await
            }
            "domain_names" => {
            ...
            "api_keys" => {
                self.create_api_keys(input).await
            }
            "gateway_response" => {
                self.create_gateway_response(input).await
            }
            "client_certificate" => {
                self.create_client_certificate(input).await
            }
            "documentation_part" => {
                self.create_documentation_part(input).await
            }
            "usage_plan" => {
                self.create_usage_plan(input).await
            }
            "integration" => {
                self.create_integration(input).await
            }
            "method" => {
                self.create_method(input).await
            }
            "base_path_mappings" => {
                self.create_base_path_mappings(input).await
            }
            "rest_api" => {
                self.create_rest_api(input).await
            }
            "vpc_link" => {
            ...
            "base_path_mapping" => {
                self.create_base_path_mapping(input).await
            }
            "domain_name_access_associations" => {
                self.create_domain_name_access_associations(input).await
            }
            "documentation_version" => {
                self.create_documentation_version(input).await
            }
            "usage_plan_keys" => {
                self.create_usage_plan_keys(input).await
            }
            "resource" => {
                self.create_resource(input).await
            }
            "usage" => {
                self.create_usage(input).await
            }
            "documentation_versions" => {
                self.create_documentation_versions(input).await
            }
            "client_certificates" => {
                self.create_client_certificates(input).await
            }
            "sdk" => {
                self.create_sdk(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "api_gateway",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "method_response" => {
                self.read_method_response(id).await
            }
            "gateway_responses" => {
                self.read_gateway_responses(id).await
            }
            "domain_name" => {
            ...
            "request_validator" => {
                self.read_request_validator(id).await
            }
            "rest_apis" => {
                self.read_rest_apis(id).await
            }
            "sdk_type" => {
                self.read_sdk_type(id).await
            }
            "usage_plan_key" => {
                self.read_usage_plan_key(id).await
            }
            "sdk_types" => {
                self.read_sdk_types(id).await
            }
            "domain_name_access_association" => {
                self.read_domain_name_access_association(id).await
            }
            "stages" => {
                self.read_stages(id).await
            }
            "usage_plans" => {
                self.read_usage_plans(id).await
            }
            "request_validators" => {
                self.read_request_validators(id).await
            }
            "authorizers" => {
                self.read_authorizers(id).await
            }
            "documentation_parts" => {
                self.read_documentation_parts(id).await
            }
            "domain_names" => {
            ...
            "api_keys" => {
                self.read_api_keys(id).await
            }
            "gateway_response" => {
                self.read_gateway_response(id).await
            }
            "client_certificate" => {
                self.read_client_certificate(id).await
            }
            "documentation_part" => {
                self.read_documentation_part(id).await
            }
            "usage_plan" => {
                self.read_usage_plan(id).await
            }
            "integration" => {
                self.read_integration(id).await
            }
            "method" => {
                self.read_method(id).await
            }
            "base_path_mappings" => {
                self.read_base_path_mappings(id).await
            }
            "rest_api" => {
                self.read_rest_api(id).await
            }
            "vpc_link" => {
            ...
            "base_path_mapping" => {
                self.read_base_path_mapping(id).await
            }
            "domain_name_access_associations" => {
                self.read_domain_name_access_associations(id).await
            }
            "documentation_version" => {
                self.read_documentation_version(id).await
            }
            "usage_plan_keys" => {
                self.read_usage_plan_keys(id).await
            }
            "resource" => {
                self.read_resource(id).await
            }
            "usage" => {
                self.read_usage(id).await
            }
            "documentation_versions" => {
                self.read_documentation_versions(id).await
            }
            "client_certificates" => {
                self.read_client_certificates(id).await
            }
            "sdk" => {
                self.read_sdk(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "api_gateway",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "method_response" => {
                self.update_method_response(id, input).await
            }
            "gateway_responses" => {
                self.update_gateway_responses(id, input).await
            }
            "domain_name" => {
            ...
            "request_validator" => {
                self.update_request_validator(id, input).await
            }
            "rest_apis" => {
                self.update_rest_apis(id, input).await
            }
            "sdk_type" => {
                self.update_sdk_type(id, input).await
            }
            "usage_plan_key" => {
                self.update_usage_plan_key(id, input).await
            }
            "sdk_types" => {
                self.update_sdk_types(id, input).await
            }
            "domain_name_access_association" => {
            ...
            "usage_plans" => {
                self.update_usage_plans(id, input).await
            }
            "request_validators" => {
                self.update_request_validators(id, input).await
            }
            "authorizers" => {
                self.update_authorizers(id, input).await
            }
            "documentation_parts" => {
                self.update_documentation_parts(id, input).await
            }
            "domain_names" => {
            ...
            "api_keys" => {
                self.update_api_keys(id, input).await
            }
            "gateway_response" => {
                self.update_gateway_response(id, input).await
            }
            "client_certificate" => {
                self.update_client_certificate(id, input).await
            }
            "documentation_part" => {
                self.update_documentation_part(id, input).await
            }
            "usage_plan" => {
                self.update_usage_plan(id, input).await
            }
            "integration" => {
                self.update_integration(id, input).await
            }
            "method" => {
                self.update_method(id, input).await
            }
            "base_path_mappings" => {
                self.update_base_path_mappings(id, input).await
            }
            "rest_api" => {
                self.update_rest_api(id, input).await
            }
            "vpc_link" => {
            ...
            "base_path_mapping" => {
                self.update_base_path_mapping(id, input).await
            }
            "domain_name_access_associations" => {
                self.update_domain_name_access_associations(id, input).await
            }
            "documentation_version" => {
                self.update_documentation_version(id, input).await
            }
            "usage_plan_keys" => {
                self.update_usage_plan_keys(id, input).await
            }
            "resource" => {
                self.update_resource(id, input).await
            }
            "usage" => {
                self.update_usage(id, input).await
            }
            "documentation_versions" => {
                self.update_documentation_versions(id, input).await
            }
            "client_certificates" => {
                self.update_client_certificates(id, input).await
            }
            "sdk" => {
                self.update_sdk(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "api_gateway",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "method_response" => {
                self.delete_method_response(id).await
            }
            "gateway_responses" => {
                self.delete_gateway_responses(id).await
            }
            "domain_name" => {
            ...
            "request_validator" => {
                self.delete_request_validator(id).await
            }
            "rest_apis" => {
                self.delete_rest_apis(id).await
            }
            "sdk_type" => {
                self.delete_sdk_type(id).await
            }
            "usage_plan_key" => {
                self.delete_usage_plan_key(id).await
            }
            "sdk_types" => {
                self.delete_sdk_types(id).await
            }
            "domain_name_access_association" => {
            ...
            "usage_plans" => {
                self.delete_usage_plans(id).await
            }
            "request_validators" => {
                self.delete_request_validators(id).await
            }
            "authorizers" => {
                self.delete_authorizers(id).await
            }
            "documentation_parts" => {
                self.delete_documentation_parts(id).await
            }
            "domain_names" => {
            ...
            "api_keys" => {
                self.delete_api_keys(id).await
            }
            "gateway_response" => {
                self.delete_gateway_response(id).await
            }
            "client_certificate" => {
                self.delete_client_certificate(id).await
            }
            "documentation_part" => {
                self.delete_documentation_part(id).await
            }
            "usage_plan" => {
                self.delete_usage_plan(id).await
            }
            "integration" => {
                self.delete_integration(id).await
            }
            "method" => {
                self.delete_method(id).await
            }
            "base_path_mappings" => {
                self.delete_base_path_mappings(id).await
            }
            "rest_api" => {
                self.delete_rest_api(id).await
            }
            "vpc_link" => {
            ...
            "base_path_mapping" => {
                self.delete_base_path_mapping(id).await
            }
            "domain_name_access_associations" => {
                self.delete_domain_name_access_associations(id).await
            }
            "documentation_version" => {
                self.delete_documentation_version(id).await
            }
            "usage_plan_keys" => {
                self.delete_usage_plan_keys(id).await
            }
            "resource" => {
                self.delete_resource(id).await
            }
            "usage" => {
                self.delete_usage(id).await
            }
            "documentation_versions" => {
                self.delete_documentation_versions(id).await
            }
            "client_certificates" => {
                self.delete_client_certificates(id).await
            }
            "sdk" => {
                self.delete_sdk(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "api_gateway",
    ...
    async fn create_method_response(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn create_gateway_responses(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_gateway_responses(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_gateway_responses(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_domain_name(
        ...
        self.provider.runtime().block_on(async {
            ...
            let ownership_verification_certificate_arn = input.get_optional_string("ownership_verification_certificate_arn")?;
            ...
            let regional_certificate_name = input.get_optional_string("regional_certificate_name")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("endpoint_configuration", endpoint_configuration.unwrap_or_default())
                .with_field("certificate_private_key", certificate_private_key.unwrap_or_default())
                ...
                .with_field("ownership_verification_certificate_arn", ownership_verification_certificate_arn.unwrap_or_default())
                ...
                .with_field("regional_certificate_arn", regional_certificate_arn.unwrap_or_default())
                ...
                .with_field("regional_certificate_name", regional_certificate_name.unwrap_or_default())
    ...
    async fn create_request_validator(
        ...
        self.provider.runtime().block_on(async {
            ...
            let validate_request_parameters = input.get_optional_string("validate_request_parameters")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("name", name.unwrap_or_default())
                .with_field("validate_request_parameters", validate_request_parameters.unwrap_or_default())
                .with_field("validate_request_body", validate_request_body.unwrap_or_default())
                .with_field("rest_api_id", rest_api_id.unwrap_or_default())
            )
        })
    }
    ...
    async fn read_request_validator(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_domain_name_access_association(
        ...
        self.provider.runtime().block_on(async {
            ...
            let access_association_source_type = input.get_string("access_association_source_type")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("access_association_source_type", access_association_source_type.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("access_association_source", access_association_source.unwrap_or_default())
            )
        })
    }

    /// Read a domain_name_access_association resource
    async fn read_domain_name_access_association(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_domain_name_access_association(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_request_validators(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_request_validators(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_request_validators(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_documentation_parts(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_documentation_parts(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_documentation_parts(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_deployment(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("cache_cluster_enabled", cache_cluster_enabled.unwrap_or_default())
    ...
    async fn create_authorizer(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("authorizer_credentials", authorizer_credentials.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
    ...
    async fn create_gateway_response(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn create_client_certificate(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_client_certificate(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_documentation_part(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_integration(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("integration_http_method", integration_http_method.unwrap_or_default())
                .with_field("http_method", http_method.unwrap_or_default())
                .with_field("uri", uri.unwrap_or_default())
                .with_field("connection_type", connection_type.unwrap_or_default())
                .with_field("cache_key_parameters", cache_key_parameters.unwrap_or_default())
    ...
    async fn create_method(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("request_validator_id", request_validator_id.unwrap_or_default())
                .with_field("resource_id", resource_id.unwrap_or_default())
    ...
    async fn create_base_path_mappings(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_base_path_mappings(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_base_path_mappings(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_model_template(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_api_key(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("generate_distinct_id", generate_distinct_id.unwrap_or_default())
    ...
    async fn create_stage(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("stage_name", stage_name.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field("documentation_version", documentation_version.unwrap_or_default())
                .with_field("canary_settings", canary_settings.unwrap_or_default())
                .with_field("tracing_enabled", tracing_enabled.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("cache_cluster_enabled", cache_cluster_enabled.unwrap_or_default())
    ...
    async fn read_base_path_mapping(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_domain_name_access_associations(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_domain_name_access_associations(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_documentation_version(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_usage_plan_keys(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_usage_plan_keys(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_documentation_versions(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_documentation_versions(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_documentation_versions(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_client_certificates(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_client_certificates(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_client_certificates(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
