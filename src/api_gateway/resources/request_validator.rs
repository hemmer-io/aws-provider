...
impl<'a> Request_validator<'a> {
    ...
    pub async fn create(&self, validate_request_body: Option<bool>, rest_api_id: String, validate_request_parameters: Option<bool>, name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, validate_request_body: Option<bool>, rest_api_id: Option<String>, validate_request_parameters: Option<bool>, name: Option<String>) -> Result<()> {
