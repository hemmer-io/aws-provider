...
impl<'a> Documentation_version<'a> {
    ...
    pub async fn create(&self, documentation_version: String, stage_name: Option<String>, rest_api_id: String, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, documentation_version: Option<String>, stage_name: Option<String>, rest_api_id: Option<String>, description: Option<String>) -> Result<()> {
