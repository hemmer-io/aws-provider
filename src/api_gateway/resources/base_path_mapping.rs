...
impl<'a> Base_path_mapping<'a> {
    ...
    pub async fn create(&self, base_path: Option<String>, rest_api_id: String, domain_name_id: Option<String>, domain_name: String, stage: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, base_path: Option<String>, rest_api_id: Option<String>, domain_name_id: Option<String>, domain_name: Option<String>, stage: Option<String>) -> Result<()> {
