...
impl<'a> Base_path_mapping<'a> {
    ...
    pub async fn create(&self, stage: Option<String>, base_path: Option<String>, rest_api_id: String, domain_name: String, domain_name_id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, stage: Option<String>, base_path: Option<String>, rest_api_id: Option<String>, domain_name: Option<String>, domain_name_id: Option<String>) -> Result<()> {
