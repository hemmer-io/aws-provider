...
impl<'a> Gateway_response<'a> {
    ...
    pub async fn create(&self, response_type: String, rest_api_id: String, status_code: Option<String>, response_parameters: Option<String>, response_templates: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, response_type: Option<String>, rest_api_id: Option<String>, status_code: Option<String>, response_parameters: Option<String>, response_templates: Option<String>) -> Result<()> {
