...
impl<'a> Gateway_response<'a> {
    ...
    pub async fn create(&self, rest_api_id: String, response_type: String, status_code: Option<String>, response_templates: Option<String>, response_parameters: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, rest_api_id: Option<String>, response_type: Option<String>, status_code: Option<String>, response_templates: Option<String>, response_parameters: Option<String>) -> Result<()> {
