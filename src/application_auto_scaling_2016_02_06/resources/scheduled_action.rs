...
impl<'a> Scheduled_action<'a> {
    ...
    pub async fn create(&self, scalable_dimension: String, service_namespace: String, schedule: Option<String>, start_time: Option<String>, scheduled_action_name: String, end_time: Option<String>, resource_id: String, timezone: Option<String>, scalable_target_action: Option<String>) -> Result<String> {
