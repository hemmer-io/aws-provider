...
impl<'a> Scaling_policy<'a> {
    ...
    pub async fn create(&self, resource_id: String, scalable_dimension: String, step_scaling_policy_configuration: Option<String>, target_tracking_scaling_policy_configuration: Option<String>, policy_name: String, predictive_scaling_policy_configuration: Option<String>, service_namespace: String, policy_type: Option<String>) -> Result<String> {
