...
impl<'a> Column_statistics_for_table<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, table_name: Option<String>, column_statistics_list: Option<Vec<String>>, database_name: Option<String>, catalog_id: Option<String>) -> Result<()> {
