...
impl<'a> Glue_identity_center_configuration<'a> {
    ...
    pub async fn create(&self, instance_arn: String, user_background_sessions_enabled: Option<bool>, scopes: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, instance_arn: Option<String>, user_background_sessions_enabled: Option<bool>, scopes: Option<Vec<String>>) -> Result<()> {
