...
impl<'a> Glue_identity_center_configuration<'a> {
    ...
    pub async fn create(&self, instance_arn: String, scopes: Option<Vec<String>>, user_background_sessions_enabled: Option<bool>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, instance_arn: Option<String>, scopes: Option<Vec<String>>, user_background_sessions_enabled: Option<bool>) -> Result<()> {
