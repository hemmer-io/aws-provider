...
impl<'a> Job_from_source_control<'a> {
    ...
    pub async fn update(&self, id: &str, repository_name: Option<String>, auth_token: Option<String>, job_name: Option<String>, provider: Option<String>, auth_strategy: Option<String>, repository_owner: Option<String>, commit_id: Option<String>, branch_name: Option<String>, folder: Option<String>) -> Result<()> {
