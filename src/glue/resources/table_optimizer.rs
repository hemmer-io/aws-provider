...
impl<'a> Table_optimizer<'a> {
    ...
    pub async fn create(&self, catalog_id: String, table_name: String, database_name: String, type: String, table_optimizer_configuration: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, catalog_id: Option<String>, table_name: Option<String>, database_name: Option<String>, type: Option<String>, table_optimizer_configuration: Option<String>) -> Result<()> {
