...
impl<'a> Resource_policy<'a> {
    ...
    pub async fn create(&self, policy_hash_condition: Option<String>, policy_exists_condition: Option<String>, policy_in_json: String, enable_hybrid: Option<String>, resource_arn: Option<String>) -> Result<String> {
