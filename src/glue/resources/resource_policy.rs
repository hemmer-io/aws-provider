...
impl<'a> Resource_policy<'a> {
    ...
    pub async fn create(&self, policy_hash_condition: Option<String>, resource_arn: Option<String>, enable_hybrid: Option<String>, policy_in_json: String, policy_exists_condition: Option<String>) -> Result<String> {
