...
impl<'a> Integration_resource_property<'a> {
    ...
    pub async fn create(&self, target_processing_properties: Option<String>, resource_arn: String, source_processing_properties: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, target_processing_properties: Option<String>, resource_arn: Option<String>, source_processing_properties: Option<String>) -> Result<()> {
