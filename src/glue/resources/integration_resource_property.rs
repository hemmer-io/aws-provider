...
impl<'a> Integration_resource_property<'a> {
    ...
    pub async fn create(&self, resource_arn: String, target_processing_properties: Option<String>, source_processing_properties: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, resource_arn: Option<String>, target_processing_properties: Option<String>, source_processing_properties: Option<String>) -> Result<()> {
