...
impl<'a> Schema_version_metadata<'a> {
    ...
    pub async fn create(&self, schema_version_id: Option<String>, schema_version_number: Option<String>, metadata_key_value: String, schema_id: Option<String>) -> Result<String> {
