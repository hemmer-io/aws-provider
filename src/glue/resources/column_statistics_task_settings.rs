...
impl<'a> Column_statistics_task_settings<'a> {
    ...
    pub async fn create(&self, schedule: Option<String>, database_name: String, table_name: String, role: String, column_name_list: Option<Vec<String>>, sample_size: Option<f64>, catalog_id: Option<String>, security_configuration: Option<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, schedule: Option<String>, database_name: Option<String>, table_name: Option<String>, role: Option<String>, column_name_list: Option<Vec<String>>, sample_size: Option<f64>, catalog_id: Option<String>, security_configuration: Option<String>, tags: Option<HashMap<String, String>>) -> Result<()> {
