...
impl<'a> User_defined_function<'a> {
    ...
    pub async fn create(&self, database_name: String, catalog_id: Option<String>, function_input: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, database_name: Option<String>, catalog_id: Option<String>, function_input: Option<String>) -> Result<()> {
