...
impl<'a> User_defined_function<'a> {
    ...
    pub async fn create(&self, database_name: String, function_input: String, catalog_id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, database_name: Option<String>, function_input: Option<String>, catalog_id: Option<String>) -> Result<()> {
