...
impl<'a> Usage_profile<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, description: Option<String>, configuration: String, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, description: Option<String>, configuration: Option<String>, name: Option<String>) -> Result<()> {
