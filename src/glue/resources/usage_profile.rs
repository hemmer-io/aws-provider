...
impl<'a> Usage_profile<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, configuration: String, name: String, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, configuration: Option<String>, name: Option<String>, description: Option<String>) -> Result<()> {
