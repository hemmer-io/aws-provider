...
impl<'a> Usage_profile<'a> {
    ...
    pub async fn create(&self, description: Option<String>, name: String, tags: Option<HashMap<String, String>>, configuration: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, name: Option<String>, tags: Option<HashMap<String, String>>, configuration: Option<String>) -> Result<()> {
