//! Glue Service
//!
//! Auto-generated service module for glue

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for glue
...
impl<'a> GlueService<'a> {
    ...
    /// Get mltransforms resource handler
    pub fn mltransforms(&self) -> resources::Mltransforms<'_> {
        resources::Mltransforms::new(self.provider)
    }
    ...
    /// Get mltask_runs resource handler
    pub fn mltask_runs(&self) -> resources::Mltask_runs<'_> {
        resources::Mltask_runs::new(self.provider)
    }
    ...
    /// Get mltransform resource handler
    pub fn mltransform(&self) -> resources::Mltransform<'_> {
        resources::Mltransform::new(self.provider)
    }
    ...
    /// Get mltask_run resource handler
    pub fn mltask_run(&self) -> resources::Mltask_run<'_> {
        resources::Mltask_run::new(self.provider)
    }
