...
impl<'a> IotfleetwiseService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "register_account_status" => {
                self.plan_register_account_status(current_state, desired_input)
                    .await
            }
            "vehicle_status" => self.plan_vehicle_status(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iotfleetwise", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "register_account_status" => self.create_register_account_status(input).await,
            "vehicle_status" => self.create_vehicle_status(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iotfleetwise", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "register_account_status" => self.read_register_account_status(id).await,
            "vehicle_status" => self.read_vehicle_status(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iotfleetwise", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "register_account_status" => self.update_register_account_status(id, input).await,
            "vehicle_status" => self.update_vehicle_status(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iotfleetwise", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "register_account_status" => self.delete_register_account_status(id).await,
            "vehicle_status" => self.delete_vehicle_status(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iotfleetwise", resource_name
            ))),
    ...
    async fn create_logging_options(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                ...
                cloud_watch_log_delivery.unwrap_or_default(),
            ))
        })
    }
    ...
    async fn create_register_account_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_register_account_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotfleetwise_client
    ...
    async fn delete_register_account_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotfleetwise_client
    ...
    async fn create_vehicle_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_vehicle_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotfleetwise_client
    ...
    async fn delete_vehicle_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotfleetwise_client
