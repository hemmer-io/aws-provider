...
impl<'a> Subnet_group<'a> {
    ...
    pub async fn create(&self, description: Option<String>, subnet_group_name: String, subnet_ids: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, subnet_group_name: Option<String>, subnet_ids: Option<Vec<String>>) -> Result<()> {
