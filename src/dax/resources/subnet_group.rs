...
impl<'a> Subnet_group<'a> {
    ...
    pub async fn create(&self, subnet_ids: Vec<String>, description: Option<String>, subnet_group_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, subnet_ids: Option<Vec<String>>, description: Option<String>, subnet_group_name: Option<String>) -> Result<()> {
