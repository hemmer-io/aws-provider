...
impl<'a> DaxService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "default_parameters" => {
                self.plan_default_parameters(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "default_parameters" => self.create_default_parameters(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "default_parameters" => self.read_default_parameters(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "default_parameters" => self.update_default_parameters(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "default_parameters" => self.delete_default_parameters(id).await,
    ...
    async fn create_default_parameters(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_default_parameters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.dax_client
    ...
    async fn delete_default_parameters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.dax_client
    ...
    async fn create_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let cluster_endpoint_encryption_type =
                input.get_optional_string("cluster_endpoint_encryption_type")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    cluster_endpoint_encryption_type.unwrap_or_default(),
                )
                .with_field("subnet_group_name", subnet_group_name.unwrap_or_default()))
        })
    }
