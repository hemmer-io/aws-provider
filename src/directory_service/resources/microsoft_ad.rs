...
impl<'a> Microsoft_ad<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, edition: Option<String>, description: Option<String>, name: String, short_name: Option<String>, vpc_settings: String, network_type: Option<String>, password: String) -> Result<String> {
