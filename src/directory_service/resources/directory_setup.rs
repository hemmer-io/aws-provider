...
impl<'a> Directory_setup<'a> {
    ...
    pub async fn update(&self, id: &str, update_type: Option<String>, directory_size_update_settings: Option<String>, directory_id: Option<String>, network_update_settings: Option<String>, os_update_settings: Option<String>, create_snapshot_before_update: Option<bool>) -> Result<()> {
