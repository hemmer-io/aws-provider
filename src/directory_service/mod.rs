...
impl<'a> Directory_serviceService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "directory_setup" => {
                self.plan_directory_setup(current_state, desired_input).await
            }
            "hybrid_ad_update" => {
                self.plan_hybrid_ad_update(current_state, desired_input).await
            }
            "microsoft_ad" => {
                self.plan_microsoft_ad(current_state, desired_input).await
            }
            "alias" => {
                self.plan_alias(current_state, desired_input).await
            }
            "trusts" => {
                self.plan_trusts(current_state, desired_input).await
            }
            "ad_assessment" => {
                self.plan_ad_assessment(current_state, desired_input).await
            }
            "client_authentication_settings" => {
                self.plan_client_authentication_settings(current_state, desired_input).await
            }
            "domain_controllers" => {
                self.plan_domain_controllers(current_state, desired_input).await
            }
            "ca_enrollment_policy" => {
                self.plan_ca_enrollment_policy(current_state, desired_input).await
            }
            "hybrid_ad" => {
                self.plan_hybrid_ad(current_state, desired_input).await
            }
            "computer" => {
                self.plan_computer(current_state, desired_input).await
            }
            "snapshot" => {
                self.plan_snapshot(current_state, desired_input).await
            }
            "event_topics" => {
                self.plan_event_topics(current_state, desired_input).await
            }
            "directories" => {
                self.plan_directories(current_state, desired_input).await
            }
            "update_directory" => {
                self.plan_update_directory(current_state, desired_input).await
            }
            "radius" => {
                self.plan_radius(current_state, desired_input).await
            }
            "log_subscription" => {
                self.plan_log_subscription(current_state, desired_input).await
            }
            "number_of_domain_controllers" => {
                self.plan_number_of_domain_controllers(current_state, desired_input).await
            }
            "directory_data_access" => {
                self.plan_directory_data_access(current_state, desired_input).await
            }
            "trust" => {
                self.plan_trust(current_state, desired_input).await
            }
            "conditional_forwarders" => {
                self.plan_conditional_forwarders(current_state, desired_input).await
            }
            "ldaps_settings" => {
                self.plan_ldaps_settings(current_state, desired_input).await
            }
            "regions" => {
                self.plan_regions(current_state, desired_input).await
            }
            "snapshot_limits" => {
                self.plan_snapshot_limits(current_state, desired_input).await
            }
            "directory_limits" => {
                self.plan_directory_limits(current_state, desired_input).await
            }
            "shared_directories" => {
                self.plan_shared_directories(current_state, desired_input).await
            }
            "snapshots" => {
                self.plan_snapshots(current_state, desired_input).await
            }
            "conditional_forwarder" => {
                self.plan_conditional_forwarder(current_state, desired_input).await
            }
            "certificate" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "directory_setup" => {
                self.create_directory_setup(input).await
            }
            "hybrid_ad_update" => {
                self.create_hybrid_ad_update(input).await
            }
            "microsoft_ad" => {
                self.create_microsoft_ad(input).await
            }
            "alias" => {
                self.create_alias(input).await
            }
            "trusts" => {
                self.create_trusts(input).await
            }
            "ad_assessment" => {
                self.create_ad_assessment(input).await
            }
            "client_authentication_settings" => {
                self.create_client_authentication_settings(input).await
            }
            "domain_controllers" => {
                self.create_domain_controllers(input).await
            }
            "ca_enrollment_policy" => {
                self.create_ca_enrollment_policy(input).await
            }
            "hybrid_ad" => {
                self.create_hybrid_ad(input).await
            }
            "computer" => {
                self.create_computer(input).await
            }
            "snapshot" => {
                self.create_snapshot(input).await
            }
            "event_topics" => {
                self.create_event_topics(input).await
            }
            "directories" => {
                self.create_directories(input).await
            }
            "update_directory" => {
                self.create_update_directory(input).await
            }
            "radius" => {
                self.create_radius(input).await
            }
            "log_subscription" => {
                self.create_log_subscription(input).await
            }
            "number_of_domain_controllers" => {
                self.create_number_of_domain_controllers(input).await
            }
            "directory_data_access" => {
                self.create_directory_data_access(input).await
            }
            "trust" => {
                self.create_trust(input).await
            }
            "conditional_forwarders" => {
                self.create_conditional_forwarders(input).await
            }
            "ldaps_settings" => {
                self.create_ldaps_settings(input).await
            }
            "regions" => {
                self.create_regions(input).await
            }
            "snapshot_limits" => {
                self.create_snapshot_limits(input).await
            }
            "directory_limits" => {
                self.create_directory_limits(input).await
            }
            "shared_directories" => {
                self.create_shared_directories(input).await
            }
            "snapshots" => {
                self.create_snapshots(input).await
            }
            "conditional_forwarder" => {
                self.create_conditional_forwarder(input).await
            }
            "certificate" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "directory_setup" => {
                self.read_directory_setup(id).await
            }
            "hybrid_ad_update" => {
                self.read_hybrid_ad_update(id).await
            }
            "microsoft_ad" => {
                self.read_microsoft_ad(id).await
            }
            "alias" => {
                self.read_alias(id).await
            }
            "trusts" => {
                self.read_trusts(id).await
            }
            "ad_assessment" => {
                self.read_ad_assessment(id).await
            }
            "client_authentication_settings" => {
                self.read_client_authentication_settings(id).await
            }
            "domain_controllers" => {
                self.read_domain_controllers(id).await
            }
            "ca_enrollment_policy" => {
                self.read_ca_enrollment_policy(id).await
            }
            "hybrid_ad" => {
                self.read_hybrid_ad(id).await
            }
            "computer" => {
                self.read_computer(id).await
            }
            "snapshot" => {
                self.read_snapshot(id).await
            }
            "event_topics" => {
                self.read_event_topics(id).await
            }
            "directories" => {
                self.read_directories(id).await
            }
            "update_directory" => {
                self.read_update_directory(id).await
            }
            "radius" => {
                self.read_radius(id).await
            }
            "log_subscription" => {
                self.read_log_subscription(id).await
            }
            "number_of_domain_controllers" => {
                self.read_number_of_domain_controllers(id).await
            }
            "directory_data_access" => {
                self.read_directory_data_access(id).await
            }
            "trust" => {
                self.read_trust(id).await
            }
            "conditional_forwarders" => {
                self.read_conditional_forwarders(id).await
            }
            "ldaps_settings" => {
                self.read_ldaps_settings(id).await
            }
            "regions" => {
                self.read_regions(id).await
            }
            "snapshot_limits" => {
                self.read_snapshot_limits(id).await
            }
            "directory_limits" => {
                self.read_directory_limits(id).await
            }
            "shared_directories" => {
                self.read_shared_directories(id).await
            }
            "snapshots" => {
                self.read_snapshots(id).await
            }
            "conditional_forwarder" => {
                self.read_conditional_forwarder(id).await
            }
            "certificate" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "directory_setup" => {
                self.update_directory_setup(id, input).await
            }
            "hybrid_ad_update" => {
                self.update_hybrid_ad_update(id, input).await
            }
            "microsoft_ad" => {
                self.update_microsoft_ad(id, input).await
            }
            "alias" => {
                self.update_alias(id, input).await
            }
            "trusts" => {
                self.update_trusts(id, input).await
            }
            "ad_assessment" => {
                self.update_ad_assessment(id, input).await
            }
            "client_authentication_settings" => {
                self.update_client_authentication_settings(id, input).await
            }
            "domain_controllers" => {
                self.update_domain_controllers(id, input).await
            }
            "ca_enrollment_policy" => {
                self.update_ca_enrollment_policy(id, input).await
            }
            "hybrid_ad" => {
                self.update_hybrid_ad(id, input).await
            }
            "computer" => {
                self.update_computer(id, input).await
            }
            "snapshot" => {
                self.update_snapshot(id, input).await
            }
            "event_topics" => {
                self.update_event_topics(id, input).await
            }
            "directories" => {
                self.update_directories(id, input).await
            }
            "update_directory" => {
                self.update_update_directory(id, input).await
            }
            "radius" => {
                self.update_radius(id, input).await
            }
            "log_subscription" => {
                self.update_log_subscription(id, input).await
            }
            "number_of_domain_controllers" => {
                self.update_number_of_domain_controllers(id, input).await
            }
            "directory_data_access" => {
                self.update_directory_data_access(id, input).await
            }
            "trust" => {
                self.update_trust(id, input).await
            }
            "conditional_forwarders" => {
                self.update_conditional_forwarders(id, input).await
            }
            "ldaps_settings" => {
                self.update_ldaps_settings(id, input).await
            }
            "regions" => {
                self.update_regions(id, input).await
            }
            "snapshot_limits" => {
                self.update_snapshot_limits(id, input).await
            }
            "directory_limits" => {
                self.update_directory_limits(id, input).await
            }
            "shared_directories" => {
                self.update_shared_directories(id, input).await
            }
            "snapshots" => {
                self.update_snapshots(id, input).await
            }
            "conditional_forwarder" => {
                self.update_conditional_forwarder(id, input).await
            }
            "certificate" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "directory_setup" => {
                self.delete_directory_setup(id).await
            }
            "hybrid_ad_update" => {
                self.delete_hybrid_ad_update(id).await
            }
            "microsoft_ad" => {
                self.delete_microsoft_ad(id).await
            }
            "alias" => {
                self.delete_alias(id).await
            }
            "trusts" => {
                self.delete_trusts(id).await
            }
            "ad_assessment" => {
                self.delete_ad_assessment(id).await
            }
            "client_authentication_settings" => {
                self.delete_client_authentication_settings(id).await
            }
            "domain_controllers" => {
                self.delete_domain_controllers(id).await
            }
            "ca_enrollment_policy" => {
                self.delete_ca_enrollment_policy(id).await
            }
            "hybrid_ad" => {
                self.delete_hybrid_ad(id).await
            }
            "computer" => {
                self.delete_computer(id).await
            }
            "snapshot" => {
                self.delete_snapshot(id).await
            }
            "event_topics" => {
                self.delete_event_topics(id).await
            }
            "directories" => {
                self.delete_directories(id).await
            }
            "update_directory" => {
                self.delete_update_directory(id).await
            }
            "radius" => {
                self.delete_radius(id).await
            }
            "log_subscription" => {
                self.delete_log_subscription(id).await
            }
            "number_of_domain_controllers" => {
                self.delete_number_of_domain_controllers(id).await
            }
            "directory_data_access" => {
                self.delete_directory_data_access(id).await
            }
            "trust" => {
                self.delete_trust(id).await
            }
            "conditional_forwarders" => {
                self.delete_conditional_forwarders(id).await
            }
            "ldaps_settings" => {
                self.delete_ldaps_settings(id).await
            }
            "regions" => {
                self.delete_regions(id).await
            }
            "snapshot_limits" => {
                self.delete_snapshot_limits(id).await
            }
            "directory_limits" => {
                self.delete_directory_limits(id).await
            }
            "shared_directories" => {
                self.delete_shared_directories(id).await
            }
            "snapshots" => {
                self.delete_snapshots(id).await
            }
            "conditional_forwarder" => {
                self.delete_conditional_forwarder(id).await
            }
            "certificate" => {
    ...
    async fn create_directory_setup(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            let create_snapshot_before_update = input.get_optional_string("create_snapshot_before_update")?;
            let update_type = input.get_string("update_type")?;
            let os_update_settings = input.get_optional_string("os_update_settings")?;
            let directory_size_update_settings = input.get_optional_string("directory_size_update_settings")?;
            let directory_id = input.get_string("directory_id")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("network_update_settings", network_update_settings.unwrap_or_default())
                .with_field("create_snapshot_before_update", create_snapshot_before_update.unwrap_or_default())
                .with_field("update_type", update_type.unwrap_or_default())
                .with_field("os_update_settings", os_update_settings.unwrap_or_default())
                .with_field("directory_size_update_settings", directory_size_update_settings.unwrap_or_default())
                .with_field("directory_id", directory_id.unwrap_or_default())
            )
        })
    }
    ...
    async fn delete_directory_setup(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_hybrid_ad_update(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_hybrid_ad_update(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_hybrid_ad_update(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_client_authentication_settings(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_client_authentication_settings(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_domain_controllers(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_domain_controllers(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_domain_controllers(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_ca_enrollment_policy(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_ca_enrollment_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_ca_enrollment_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_computer(
        ...
        self.provider.runtime().block_on(async {
            ...
            let password = input.get_string("password")?;
            let organizational_unit_distinguished_name = input.get_optional_string("organizational_unit_distinguished_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("password", password.unwrap_or_default())
                .with_field("organizational_unit_distinguished_name", organizational_unit_distinguished_name.unwrap_or_default())
                .with_field("computer_attributes", computer_attributes.unwrap_or_default())
            )
        })
    }

    /// Read a computer resource
    async fn read_computer(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_update_directory(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_update_directory(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_update_directory(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_log_subscription(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_number_of_domain_controllers(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_number_of_domain_controllers(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_directory_data_access(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_directory_data_access(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_directory_data_access(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_trust(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let conditional_forwarder_ip_addrs = input.get_optional_string("conditional_forwarder_ip_addrs")?;
            ...
            let conditional_forwarder_ipv6_addrs = input.get_optional_string("conditional_forwarder_ipv6_addrs")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("conditional_forwarder_ip_addrs", conditional_forwarder_ip_addrs.unwrap_or_default())
                ...
                .with_field("conditional_forwarder_ipv6_addrs", conditional_forwarder_ipv6_addrs.unwrap_or_default())
    ...
    async fn create_conditional_forwarders(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_conditional_forwarders(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_conditional_forwarders(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_ldaps_settings(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_ldaps_settings(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_snapshot_limits(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_snapshot_limits(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_directory_limits(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_directory_limits(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_directory_limits(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_shared_directories(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_shared_directories(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_conditional_forwarder(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
