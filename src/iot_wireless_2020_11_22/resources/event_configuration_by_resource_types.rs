...
impl<'a> Event_configuration_by_resource_types<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, device_registration_state: Option<String>, message_delivery_status: Option<String>, connection_status: Option<String>, proximity: Option<String>, join: Option<String>) -> Result<()> {
