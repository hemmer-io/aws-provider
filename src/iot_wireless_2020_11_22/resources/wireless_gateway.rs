...
impl<'a> Wireless_gateway<'a> {
    ...
    pub async fn create(&self, client_request_token: Option<String>, description: Option<String>, name: Option<String>, tags: Option<Vec<String>>, lo_ra_wan: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_request_token: Option<String>, description: Option<String>, name: Option<String>, tags: Option<Vec<String>>, lo_ra_wan: Option<String>) -> Result<()> {
