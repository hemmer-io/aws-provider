...
impl<'a> Multicast_group<'a> {
    ...
    pub async fn create(&self, lo_ra_wan: String, client_request_token: Option<String>, name: Option<String>, description: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, lo_ra_wan: Option<String>, client_request_token: Option<String>, name: Option<String>, description: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
