...
impl<'a> CloudwatchService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "anomaly_detector" => {
                self.plan_anomaly_detector(current_state, desired_input)
                    .await
            }
            "dashboard" => self.plan_dashboard(current_state, desired_input).await,
            "dashboards" => self.plan_dashboards(current_state, desired_input).await,
            "insight_rule_report" => {
                self.plan_insight_rule_report(current_state, desired_input)
                    .await
            }
            "metric_stream" => self.plan_metric_stream(current_state, desired_input).await,
            "metric_statistics" => {
                self.plan_metric_statistics(current_state, desired_input)
                    .await
            }
            "insight_rules" => self.plan_insight_rules(current_state, desired_input).await,
            "anomaly_detectors" => {
                self.plan_anomaly_detectors(current_state, desired_input)
                    .await
            }
            "metric_alarm" => self.plan_metric_alarm(current_state, desired_input).await,
            "alarm_history" => self.plan_alarm_history(current_state, desired_input).await,
            "alarms_for_metric" => {
                self.plan_alarms_for_metric(current_state, desired_input)
                    .await
            }
            "composite_alarm" => {
                self.plan_composite_alarm(current_state, desired_input)
                    .await
            }
            "alarm_contributors" => {
                self.plan_alarm_contributors(current_state, desired_input)
                    .await
            }
            "metric_widget_image" => {
                self.plan_metric_widget_image(current_state, desired_input)
                    .await
            }
            ...
            "managed_insight_rules" => {
                self.plan_managed_insight_rules(current_state, desired_input)
                    .await
            }
            "insight_rule" => self.plan_insight_rule(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudwatch", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "anomaly_detector" => self.create_anomaly_detector(input).await,
            "dashboard" => self.create_dashboard(input).await,
            "dashboards" => self.create_dashboards(input).await,
            "insight_rule_report" => self.create_insight_rule_report(input).await,
            "metric_stream" => self.create_metric_stream(input).await,
            "metric_statistics" => self.create_metric_statistics(input).await,
            "insight_rules" => self.create_insight_rules(input).await,
            "anomaly_detectors" => self.create_anomaly_detectors(input).await,
            "metric_alarm" => self.create_metric_alarm(input).await,
            "alarm_history" => self.create_alarm_history(input).await,
            "alarms_for_metric" => self.create_alarms_for_metric(input).await,
            "composite_alarm" => self.create_composite_alarm(input).await,
            "alarm_contributors" => self.create_alarm_contributors(input).await,
            "metric_widget_image" => self.create_metric_widget_image(input).await,
            "metric_data" => self.create_metric_data(input).await,
            "alarms" => self.create_alarms(input).await,
            "managed_insight_rules" => self.create_managed_insight_rules(input).await,
            "insight_rule" => self.create_insight_rule(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudwatch", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "anomaly_detector" => self.read_anomaly_detector(id).await,
            "dashboard" => self.read_dashboard(id).await,
            "dashboards" => self.read_dashboards(id).await,
            "insight_rule_report" => self.read_insight_rule_report(id).await,
            "metric_stream" => self.read_metric_stream(id).await,
            "metric_statistics" => self.read_metric_statistics(id).await,
            "insight_rules" => self.read_insight_rules(id).await,
            "anomaly_detectors" => self.read_anomaly_detectors(id).await,
            "metric_alarm" => self.read_metric_alarm(id).await,
            "alarm_history" => self.read_alarm_history(id).await,
            "alarms_for_metric" => self.read_alarms_for_metric(id).await,
            "composite_alarm" => self.read_composite_alarm(id).await,
            "alarm_contributors" => self.read_alarm_contributors(id).await,
            "metric_widget_image" => self.read_metric_widget_image(id).await,
            "metric_data" => self.read_metric_data(id).await,
            "alarms" => self.read_alarms(id).await,
            "managed_insight_rules" => self.read_managed_insight_rules(id).await,
            "insight_rule" => self.read_insight_rule(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudwatch", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "anomaly_detector" => self.update_anomaly_detector(id, input).await,
            "dashboard" => self.update_dashboard(id, input).await,
            "dashboards" => self.update_dashboards(id, input).await,
            "insight_rule_report" => self.update_insight_rule_report(id, input).await,
            "metric_stream" => self.update_metric_stream(id, input).await,
            "metric_statistics" => self.update_metric_statistics(id, input).await,
            "insight_rules" => self.update_insight_rules(id, input).await,
            "anomaly_detectors" => self.update_anomaly_detectors(id, input).await,
            "metric_alarm" => self.update_metric_alarm(id, input).await,
            "alarm_history" => self.update_alarm_history(id, input).await,
            "alarms_for_metric" => self.update_alarms_for_metric(id, input).await,
            "composite_alarm" => self.update_composite_alarm(id, input).await,
            "alarm_contributors" => self.update_alarm_contributors(id, input).await,
            "metric_widget_image" => self.update_metric_widget_image(id, input).await,
            "metric_data" => self.update_metric_data(id, input).await,
            "alarms" => self.update_alarms(id, input).await,
            "managed_insight_rules" => self.update_managed_insight_rules(id, input).await,
            "insight_rule" => self.update_insight_rule(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudwatch", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "anomaly_detector" => self.delete_anomaly_detector(id).await,
            "dashboard" => self.delete_dashboard(id).await,
            "dashboards" => self.delete_dashboards(id).await,
            "insight_rule_report" => self.delete_insight_rule_report(id).await,
            "metric_stream" => self.delete_metric_stream(id).await,
            "metric_statistics" => self.delete_metric_statistics(id).await,
            "insight_rules" => self.delete_insight_rules(id).await,
            "anomaly_detectors" => self.delete_anomaly_detectors(id).await,
            "metric_alarm" => self.delete_metric_alarm(id).await,
            "alarm_history" => self.delete_alarm_history(id).await,
            "alarms_for_metric" => self.delete_alarms_for_metric(id).await,
            "composite_alarm" => self.delete_composite_alarm(id).await,
            "alarm_contributors" => self.delete_alarm_contributors(id).await,
            "metric_widget_image" => self.delete_metric_widget_image(id).await,
            "metric_data" => self.delete_metric_data(id).await,
            "alarms" => self.delete_alarms(id).await,
            "managed_insight_rules" => self.delete_managed_insight_rules(id).await,
            "insight_rule" => self.delete_insight_rule(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudwatch", resource_name
            ))),
    ...
    async fn create_anomaly_detector(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let single_metric_anomaly_detector =
                input.get_optional_string("single_metric_anomaly_detector")?;
            ...
            let metric_math_anomaly_detector =
                input.get_optional_string("metric_math_anomaly_detector")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    single_metric_anomaly_detector.unwrap_or_default(),
                )
                .with_field("dimensions", dimensions.unwrap_or_default())
                .with_field(
                    "metric_characteristics",
                    metric_characteristics.unwrap_or_default(),
                )
                .with_field(
                    "metric_math_anomaly_detector",
                    metric_math_anomaly_detector.unwrap_or_default(),
                )
    ...
    async fn read_anomaly_detector(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_anomaly_detector(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_dashboards(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_dashboards(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn update_dashboards(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_dashboards(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
    ...
    async fn create_insight_rule_report(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_insight_rule_report(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn delete_insight_rule_report(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
    ...
    async fn create_metric_stream(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let statistics_configurations =
                input.get_optional_string("statistics_configurations")?;
            ...
            let include_linked_accounts_metrics =
                input.get_optional_string("include_linked_accounts_metrics")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    statistics_configurations.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    include_linked_accounts_metrics.unwrap_or_default(),
                )
    ...
    async fn read_metric_stream(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn update_metric_stream(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let statistics_configurations =
                input.get_optional_string("statistics_configurations")?;
    ...
    async fn delete_metric_stream(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
    ...
    async fn create_metric_statistics(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_metric_statistics(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn delete_metric_statistics(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
    ...
    async fn create_insight_rules(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_insight_rules(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn update_insight_rules(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_insight_rules(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
    ...
    async fn create_anomaly_detectors(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_anomaly_detectors(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn delete_anomaly_detectors(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
    ...
    async fn create_metric_alarm(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let alarm_name = input.get_string("alarm_name")?;
            let ok_actions = input.get_optional_string("ok_actions")?;
            let insufficient_data_actions =
                input.get_optional_string("insufficient_data_actions")?;
            ...
            let evaluate_low_sample_count_percentile =
                input.get_optional_string("evaluate_low_sample_count_percentile")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    insufficient_data_actions.unwrap_or_default(),
                )
                ...
                .with_field(
                    "threshold_metric_id",
                    threshold_metric_id.unwrap_or_default(),
                )
                .with_field("period", period.unwrap_or_default())
                .with_field(
                    "evaluate_low_sample_count_percentile",
                    evaluate_low_sample_count_percentile.unwrap_or_default(),
                ))
        })
    }

    /// Read a metric_alarm resource
    async fn read_metric_alarm(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn update_metric_alarm(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let alarm_name = input.get_string("alarm_name")?;
            let ok_actions = input.get_optional_string("ok_actions")?;
    ...
    async fn delete_metric_alarm(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
    ...
    async fn create_alarm_history(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_alarm_history(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn update_alarm_history(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_alarm_history(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
    ...
    async fn create_alarms_for_metric(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_alarms_for_metric(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn delete_alarms_for_metric(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
    ...
    async fn create_composite_alarm(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let actions_suppressor_extension_period =
                input.get_optional_string("actions_suppressor_extension_period")?;
            let actions_enabled = input.get_optional_string("actions_enabled")?;
            ...
            let actions_suppressor_wait_period =
                input.get_optional_string("actions_suppressor_wait_period")?;
            let alarm_name = input.get_string("alarm_name")?;
            let ok_actions = input.get_optional_string("ok_actions")?;
            let alarm_actions = input.get_optional_string("alarm_actions")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    actions_suppressor_extension_period.unwrap_or_default(),
                )
                .with_field("actions_enabled", actions_enabled.unwrap_or_default())
                ...
                .with_field(
                    ...
                    actions_suppressor_wait_period.unwrap_or_default(),
                )
                .with_field("alarm_name", alarm_name.unwrap_or_default())
                .with_field("ok_actions", ok_actions.unwrap_or_default())
                .with_field("alarm_actions", alarm_actions.unwrap_or_default())
    ...
    async fn read_composite_alarm(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn delete_composite_alarm(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
    ...
    async fn create_alarm_contributors(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_alarm_contributors(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn delete_alarm_contributors(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
    ...
    async fn create_metric_widget_image(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_metric_widget_image(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn delete_metric_widget_image(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    strict_entity_validation.unwrap_or_default(),
                )
                .with_field("namespace", namespace.unwrap_or_default())
    ...
    async fn create_managed_insight_rules(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_managed_insight_rules(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn delete_managed_insight_rules(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
    ...
    async fn create_insight_rule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_insight_rule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudwatch_client
    ...
    async fn update_insight_rule(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let rule_definition = input.get_string("rule_definition")?;
            let rule_name = input.get_string("rule_name")?;
    ...
    async fn delete_insight_rule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudwatch_client
