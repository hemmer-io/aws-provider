...
impl<'a> Anomaly_detector<'a> {
    ...
    pub async fn create(&self, dimensions: Option<Vec<String>>, single_metric_anomaly_detector: Option<String>, stat: Option<String>, metric_name: Option<String>, configuration: Option<String>, metric_characteristics: Option<String>, metric_math_anomaly_detector: Option<String>, namespace: Option<String>) -> Result<String> {
