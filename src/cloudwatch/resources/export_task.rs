...
impl<'a> Export_task<'a> {
    ...
    pub async fn create(&self, task_name: Option<String>, log_group_name: String, log_stream_name_prefix: Option<String>, from: String, to: String, destination: String, destination_prefix: Option<String>) -> Result<String> {
