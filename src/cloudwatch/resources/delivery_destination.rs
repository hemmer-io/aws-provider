...
impl<'a> Delivery_destination<'a> {
    ...
    pub async fn create(&self, name: String, delivery_destination_configuration: Option<String>, delivery_destination_type: Option<String>, tags: Option<HashMap<String, String>>, output_format: Option<String>) -> Result<String> {
