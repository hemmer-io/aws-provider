...
impl<'a> Account_policy<'a> {
    ...
    pub async fn create(&self, policy_name: String, scope: Option<String>, policy_type: String, policy_document: String, selection_criteria: Option<String>) -> Result<String> {
