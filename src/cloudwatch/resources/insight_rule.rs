...
impl<'a> Insight_rule<'a> {
    ...
    pub async fn create(&self, apply_on_transformed_logs: Option<bool>, rule_state: Option<String>, rule_name: String, tags: Option<Vec<String>>, rule_definition: String) -> Result<String> {
