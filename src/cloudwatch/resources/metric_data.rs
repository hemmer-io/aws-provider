...
impl<'a> Metric_data<'a> {
    ...
    pub async fn create(&self, namespace: String, metric_data: Option<Vec<String>>, entity_metric_data: Option<Vec<String>>, strict_entity_validation: Option<bool>) -> Result<String> {
