...
impl<'a> Metric_data<'a> {
    ...
    pub async fn create(&self, entity_metric_data: Option<Vec<String>>, strict_entity_validation: Option<bool>, namespace: String, metric_data: Option<Vec<String>>) -> Result<String> {
