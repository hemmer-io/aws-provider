...
impl<'a> Site_rack_physical_properties<'a> {
    ...
    pub async fn update(&self, id: &str, uplink_count: Option<String>, uplink_gbps: Option<String>, maximum_supported_weight_lbs: Option<String>, power_draw_kva: Option<String>, site_id: Option<String>, power_connector: Option<String>, fiber_optic_cable_type: Option<String>, optical_standard: Option<String>, power_phase: Option<String>, power_feed_drop: Option<String>) -> Result<()> {
