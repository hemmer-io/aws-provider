...
impl<'a> OutpostsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "outpost_instance_types" => {
                self.plan_outpost_instance_types(current_state, desired_input)
                    .await
            }
            "capacity_task" => self.plan_capacity_task(current_state, desired_input).await,
            "site_rack_physical_properties" => {
                self.plan_site_rack_physical_properties(current_state, desired_input)
                    .await
            }
            "outpost_supported_instance_types" => {
                self.plan_outpost_supported_instance_types(current_state, desired_input)
                    .await
            }
            "connection" => self.plan_connection(current_state, desired_input).await,
            "outpost_billing_information" => {
                self.plan_outpost_billing_information(current_state, desired_input)
                    .await
            }
            ...
            "site_address" => self.plan_site_address(current_state, desired_input).await,
            "outpost" => self.plan_outpost(current_state, desired_input).await,
            "site" => self.plan_site(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "outposts", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "outpost_instance_types" => self.create_outpost_instance_types(input).await,
            "capacity_task" => self.create_capacity_task(input).await,
            "site_rack_physical_properties" => {
            ...
            "outpost_billing_information" => self.create_outpost_billing_information(input).await,
            "order" => self.create_order(input).await,
            "catalog_item" => self.create_catalog_item(input).await,
            "site_address" => self.create_site_address(input).await,
            "outpost" => self.create_outpost(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "outpost_instance_types" => self.read_outpost_instance_types(id).await,
            "capacity_task" => self.read_capacity_task(id).await,
            "site_rack_physical_properties" => self.read_site_rack_physical_properties(id).await,
            "outpost_supported_instance_types" => {
                self.read_outpost_supported_instance_types(id).await
            }
            "connection" => self.read_connection(id).await,
            "outpost_billing_information" => self.read_outpost_billing_information(id).await,
            "order" => self.read_order(id).await,
            "catalog_item" => self.read_catalog_item(id).await,
            "site_address" => self.read_site_address(id).await,
            "outpost" => self.read_outpost(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "outpost_instance_types" => self.update_outpost_instance_types(id, input).await,
            "capacity_task" => self.update_capacity_task(id, input).await,
            "site_rack_physical_properties" => {
                self.update_site_rack_physical_properties(id, input).await
            }
            "outpost_supported_instance_types" => {
                self.update_outpost_supported_instance_types(id, input)
                    .await
            }
            ...
            "site_address" => self.update_site_address(id, input).await,
            "outpost" => self.update_outpost(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "outpost_instance_types" => self.delete_outpost_instance_types(id).await,
            "capacity_task" => self.delete_capacity_task(id).await,
            "site_rack_physical_properties" => self.delete_site_rack_physical_properties(id).await,
            "outpost_supported_instance_types" => {
                self.delete_outpost_supported_instance_types(id).await
            }
            "connection" => self.delete_connection(id).await,
            "outpost_billing_information" => self.delete_outpost_billing_information(id).await,
            "order" => self.delete_order(id).await,
            "catalog_item" => self.delete_catalog_item(id).await,
            "site_address" => self.delete_site_address(id).await,
            "outpost" => self.delete_outpost(id).await,
    ...
    async fn create_outpost_instance_types(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_outpost_instance_types(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_outpost_instance_types(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_capacity_task(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_capacity_task(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.outposts_client
    ...
    async fn update_capacity_task(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_capacity_task(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.outposts_client
    ...
    async fn create_site_rack_physical_properties(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let maximum_supported_weight_lbs =
                input.get_optional_string("maximum_supported_weight_lbs")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    maximum_supported_weight_lbs.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    fiber_optic_cable_type.unwrap_or_default(),
                )
    ...
    async fn read_site_rack_physical_properties(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.outposts_client
    ...
    async fn delete_site_rack_physical_properties(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.outposts_client
    ...
    async fn read_outpost_supported_instance_types(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.outposts_client
    ...
    async fn delete_outpost_supported_instance_types(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.outposts_client
    ...
    async fn read_outpost_billing_information(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.outposts_client
    ...
    async fn delete_outpost_billing_information(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.outposts_client
    ...
    async fn create_site_address(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_site_address(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.outposts_client
    ...
    async fn update_site_address(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let address = input.get_string("address")?;
            let site_id = input.get_string("site_id")?;
    ...
    async fn delete_site_address(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.outposts_client
    ...
    async fn create_outpost(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    supported_hardware_type.unwrap_or_default(),
                )
    ...
    async fn read_outpost(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.outposts_client
    ...
    async fn update_outpost(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let availability_zone_id = input.get_optional_string("availability_zone_id")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_outpost(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.outposts_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    rack_physical_properties.unwrap_or_default(),
                ))
        })
    }
