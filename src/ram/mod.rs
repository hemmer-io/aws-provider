...
impl<'a> RamService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "resource_share_invitations" => {
                self.plan_resource_share_invitations(current_state, desired_input)
                    .await
            }
            "resource_share_associations" => {
                self.plan_resource_share_associations(current_state, desired_input)
                    .await
            }
            "permission_version" => {
                self.plan_permission_version(current_state, desired_input)
                    .await
            }
            "resource_share" => self.plan_resource_share(current_state, desired_input).await,
            "resource_shares" => {
                self.plan_resource_shares(current_state, desired_input)
                    .await
            }
            "resource_policies" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "resource_share_invitations" => self.create_resource_share_invitations(input).await,
            "resource_share_associations" => self.create_resource_share_associations(input).await,
            "permission_version" => self.create_permission_version(input).await,
            "resource_share" => self.create_resource_share(input).await,
            "resource_shares" => self.create_resource_shares(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "resource_share_invitations" => self.read_resource_share_invitations(id).await,
            "resource_share_associations" => self.read_resource_share_associations(id).await,
            "permission_version" => self.read_permission_version(id).await,
            "resource_share" => self.read_resource_share(id).await,
            "resource_shares" => self.read_resource_shares(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "resource_share_invitations" => self.update_resource_share_invitations(id, input).await,
            "resource_share_associations" => {
                self.update_resource_share_associations(id, input).await
            }
            "permission_version" => self.update_permission_version(id, input).await,
            "resource_share" => self.update_resource_share(id, input).await,
            "resource_shares" => self.update_resource_shares(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "resource_share_invitations" => self.delete_resource_share_invitations(id).await,
            "resource_share_associations" => self.delete_resource_share_associations(id).await,
            "permission_version" => self.delete_permission_version(id).await,
            "resource_share" => self.delete_resource_share(id).await,
            "resource_shares" => self.delete_resource_shares(id).await,
    ...
    async fn read_resource_share_invitations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resource_share_invitations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_resource_share_associations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ram_client
    ...
    async fn delete_resource_share_associations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ram_client
    ...
    async fn create_permission_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_permission_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ram_client
    ...
    async fn delete_permission_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ram_client
    ...
    async fn create_resource_share(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let allow_external_principals =
                input.get_optional_string("allow_external_principals")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    allow_external_principals.unwrap_or_default(),
                )
    ...
    async fn read_resource_share(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ram_client
    ...
    async fn delete_resource_share(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ram_client
    ...
    async fn create_resource_shares(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_resource_shares(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ram_client
    ...
    async fn delete_resource_shares(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ram_client
