...
impl<'a> Safety_rule<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, tags: Option<HashMap<String, String>>, assertion_rule: Option<String>, gating_rule: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, tags: Option<HashMap<String, String>>, assertion_rule: Option<String>, gating_rule: Option<String>) -> Result<()> {
