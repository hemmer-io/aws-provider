...
impl<'a> Routing_control<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, control_panel_arn: Option<String>, routing_control_name: String, cluster_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, control_panel_arn: Option<String>, routing_control_name: Option<String>, cluster_arn: Option<String>) -> Result<()> {
