...
impl<'a> Account_password_policy<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, minimum_password_length: Option<i64>, allow_users_to_change_password: Option<bool>, password_reuse_prevention: Option<i64>, max_password_age: Option<i64>, require_uppercase_characters: Option<bool>, require_numbers: Option<bool>, require_symbols: Option<bool>, require_lowercase_characters: Option<bool>, hard_expiry: Option<bool>) -> Result<()> {
