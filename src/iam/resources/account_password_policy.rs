...
impl<'a> Account_password_policy<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, max_password_age: Option<i64>, require_uppercase_characters: Option<bool>, allow_users_to_change_password: Option<bool>, require_symbols: Option<bool>, password_reuse_prevention: Option<i64>, hard_expiry: Option<bool>, minimum_password_length: Option<i64>, require_numbers: Option<bool>, require_lowercase_characters: Option<bool>) -> Result<()> {
