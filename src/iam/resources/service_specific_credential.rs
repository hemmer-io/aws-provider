...
impl<'a> Service_specific_credential<'a> {
    ...
    pub async fn create(&self, service_name: String, user_name: String, credential_age_days: Option<i64>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, service_name: Option<String>, user_name: Option<String>, credential_age_days: Option<i64>) -> Result<()> {
