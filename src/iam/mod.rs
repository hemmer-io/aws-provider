...
impl<'a> IamService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "role_permissions_boundary" => {
                self.plan_role_permissions_boundary(current_state, desired_input).await
            }
            "service_specific_credential" => {
                self.plan_service_specific_credential(current_state, desired_input).await
            }
            "server_certificate" => {
                self.plan_server_certificate(current_state, desired_input).await
            }
            "role_description" => {
                self.plan_role_description(current_state, desired_input).await
            }
            "policy" => {
            ...
            "account_summary" => {
                self.plan_account_summary(current_state, desired_input).await
            }
            "mfa_device" => {
                self.plan_mfa_device(current_state, desired_input).await
            }
            "open_id_connect_provider" => {
                self.plan_open_id_connect_provider(current_state, desired_input).await
            }
            "account_alias" => {
            ...
            "organizations_access_report" => {
                self.plan_organizations_access_report(current_state, desired_input).await
            }
            "user_permissions_boundary" => {
                self.plan_user_permissions_boundary(current_state, desired_input).await
            }
            "login_profile" => {
                self.plan_login_profile(current_state, desired_input).await
            }
            "group_policy" => {
                self.plan_group_policy(current_state, desired_input).await
            }
            "context_keys_for_custom_policy" => {
                self.plan_context_keys_for_custom_policy(current_state, desired_input).await
            }
            "open_id_connect_provider_thumbprint" => {
                self.plan_open_id_connect_provider_thumbprint(current_state, desired_input).await
            }
            "user_policy" => {
                self.plan_user_policy(current_state, desired_input).await
            }
            "account_password_policy" => {
                self.plan_account_password_policy(current_state, desired_input).await
            }
            "credential_report" => {
                self.plan_credential_report(current_state, desired_input).await
            }
            "service_last_accessed_details_with_entities" => {
                self.plan_service_last_accessed_details_with_entities(current_state, desired_input).await
            }
            "service_linked_role_deletion_status" => {
                self.plan_service_linked_role_deletion_status(current_state, desired_input).await
            }
            "policy_version" => {
                self.plan_policy_version(current_state, desired_input).await
            }
            "virtual_mfa_device" => {
                self.plan_virtual_mfa_device(current_state, desired_input).await
            }
            "assume_role_policy" => {
                self.plan_assume_role_policy(current_state, desired_input).await
            }
            "saml_provider" => {
                self.plan_saml_provider(current_state, desired_input).await
            }
            "context_keys_for_principal_policy" => {
                self.plan_context_keys_for_principal_policy(current_state, desired_input).await
            }
            "service_last_accessed_details" => {
                self.plan_service_last_accessed_details(current_state, desired_input).await
            }
            "role_policy" => {
                self.plan_role_policy(current_state, desired_input).await
            }
            "ssh_public_key" => {
                self.plan_ssh_public_key(current_state, desired_input).await
            }
            "account_authorization_details" => {
                self.plan_account_authorization_details(current_state, desired_input).await
            }
            "service_linked_role" => {
                self.plan_service_linked_role(current_state, desired_input).await
            }
            "group" => {
                self.plan_group(current_state, desired_input).await
            }
            "access_key" => {
                self.plan_access_key(current_state, desired_input).await
            }
            "access_key_last_used" => {
                self.plan_access_key_last_used(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "role_permissions_boundary" => {
                self.create_role_permissions_boundary(input).await
            }
            "service_specific_credential" => {
                self.create_service_specific_credential(input).await
            }
            "server_certificate" => {
                self.create_server_certificate(input).await
            }
            "role_description" => {
                self.create_role_description(input).await
            }
            "policy" => {
            ...
            "account_summary" => {
                self.create_account_summary(input).await
            }
            "mfa_device" => {
                self.create_mfa_device(input).await
            }
            "open_id_connect_provider" => {
                self.create_open_id_connect_provider(input).await
            }
            "account_alias" => {
            ...
            "organizations_access_report" => {
                self.create_organizations_access_report(input).await
            }
            "user_permissions_boundary" => {
                self.create_user_permissions_boundary(input).await
            }
            "login_profile" => {
                self.create_login_profile(input).await
            }
            "group_policy" => {
                self.create_group_policy(input).await
            }
            "context_keys_for_custom_policy" => {
            ...
            "user_policy" => {
                self.create_user_policy(input).await
            }
            "account_password_policy" => {
                self.create_account_password_policy(input).await
            }
            "credential_report" => {
                self.create_credential_report(input).await
            }
            "service_last_accessed_details_with_entities" => {
                self.create_service_last_accessed_details_with_entities(input).await
            }
            "service_linked_role_deletion_status" => {
            ...
            "virtual_mfa_device" => {
                self.create_virtual_mfa_device(input).await
            }
            "assume_role_policy" => {
                self.create_assume_role_policy(input).await
            }
            "saml_provider" => {
                self.create_saml_provider(input).await
            }
            "context_keys_for_principal_policy" => {
            ...
            "role_policy" => {
                self.create_role_policy(input).await
            }
            "ssh_public_key" => {
            ...
            "service_linked_role" => {
                self.create_service_linked_role(input).await
            }
            "group" => {
                self.create_group(input).await
            }
            "access_key" => {
                self.create_access_key(input).await
            }
            "access_key_last_used" => {
                self.create_access_key_last_used(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iam",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "role_permissions_boundary" => {
                self.read_role_permissions_boundary(id).await
            }
            "service_specific_credential" => {
                self.read_service_specific_credential(id).await
            }
            "server_certificate" => {
                self.read_server_certificate(id).await
            }
            "role_description" => {
                self.read_role_description(id).await
            }
            "policy" => {
            ...
            "account_summary" => {
                self.read_account_summary(id).await
            }
            "mfa_device" => {
                self.read_mfa_device(id).await
            }
            "open_id_connect_provider" => {
                self.read_open_id_connect_provider(id).await
            }
            "account_alias" => {
            ...
            "organizations_access_report" => {
                self.read_organizations_access_report(id).await
            }
            "user_permissions_boundary" => {
                self.read_user_permissions_boundary(id).await
            }
            "login_profile" => {
                self.read_login_profile(id).await
            }
            "group_policy" => {
                self.read_group_policy(id).await
            }
            "context_keys_for_custom_policy" => {
                self.read_context_keys_for_custom_policy(id).await
            }
            "open_id_connect_provider_thumbprint" => {
                self.read_open_id_connect_provider_thumbprint(id).await
            }
            "user_policy" => {
                self.read_user_policy(id).await
            }
            "account_password_policy" => {
                self.read_account_password_policy(id).await
            }
            "credential_report" => {
                self.read_credential_report(id).await
            }
            "service_last_accessed_details_with_entities" => {
                self.read_service_last_accessed_details_with_entities(id).await
            }
            "service_linked_role_deletion_status" => {
            ...
            "virtual_mfa_device" => {
                self.read_virtual_mfa_device(id).await
            }
            "assume_role_policy" => {
                self.read_assume_role_policy(id).await
            }
            "saml_provider" => {
                self.read_saml_provider(id).await
            }
            "context_keys_for_principal_policy" => {
                self.read_context_keys_for_principal_policy(id).await
            }
            "service_last_accessed_details" => {
                self.read_service_last_accessed_details(id).await
            }
            "role_policy" => {
                self.read_role_policy(id).await
            }
            "ssh_public_key" => {
                self.read_ssh_public_key(id).await
            }
            "account_authorization_details" => {
                self.read_account_authorization_details(id).await
            }
            "service_linked_role" => {
                self.read_service_linked_role(id).await
            }
            "group" => {
                self.read_group(id).await
            }
            "access_key" => {
                self.read_access_key(id).await
            }
            "access_key_last_used" => {
                self.read_access_key_last_used(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iam",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "role_permissions_boundary" => {
                self.update_role_permissions_boundary(id, input).await
            }
            "service_specific_credential" => {
                self.update_service_specific_credential(id, input).await
            }
            "server_certificate" => {
                self.update_server_certificate(id, input).await
            }
            "role_description" => {
                self.update_role_description(id, input).await
            }
            "policy" => {
            ...
            "account_summary" => {
                self.update_account_summary(id, input).await
            }
            "mfa_device" => {
                self.update_mfa_device(id, input).await
            }
            "open_id_connect_provider" => {
                self.update_open_id_connect_provider(id, input).await
            }
            "account_alias" => {
            ...
            "user_permissions_boundary" => {
                self.update_user_permissions_boundary(id, input).await
            }
            "login_profile" => {
                self.update_login_profile(id, input).await
            }
            "group_policy" => {
                self.update_group_policy(id, input).await
            }
            "context_keys_for_custom_policy" => {
                self.update_context_keys_for_custom_policy(id, input).await
            }
            "open_id_connect_provider_thumbprint" => {
                self.update_open_id_connect_provider_thumbprint(id, input).await
            }
            "user_policy" => {
                self.update_user_policy(id, input).await
            }
            "account_password_policy" => {
                self.update_account_password_policy(id, input).await
            }
            "credential_report" => {
                self.update_credential_report(id, input).await
            }
            "service_last_accessed_details_with_entities" => {
                self.update_service_last_accessed_details_with_entities(id, input).await
            }
            "service_linked_role_deletion_status" => {
                self.update_service_linked_role_deletion_status(id, input).await
            }
            "policy_version" => {
                self.update_policy_version(id, input).await
            }
            "virtual_mfa_device" => {
                self.update_virtual_mfa_device(id, input).await
            }
            "assume_role_policy" => {
                self.update_assume_role_policy(id, input).await
            }
            "saml_provider" => {
                self.update_saml_provider(id, input).await
            }
            "context_keys_for_principal_policy" => {
                self.update_context_keys_for_principal_policy(id, input).await
            }
            "service_last_accessed_details" => {
                self.update_service_last_accessed_details(id, input).await
            }
            "role_policy" => {
                self.update_role_policy(id, input).await
            }
            "ssh_public_key" => {
            ...
            "service_linked_role" => {
                self.update_service_linked_role(id, input).await
            }
            "group" => {
                self.update_group(id, input).await
            }
            "access_key" => {
                self.update_access_key(id, input).await
            }
            "access_key_last_used" => {
                self.update_access_key_last_used(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iam",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "role_permissions_boundary" => {
                self.delete_role_permissions_boundary(id).await
            }
            "service_specific_credential" => {
                self.delete_service_specific_credential(id).await
            }
            "server_certificate" => {
                self.delete_server_certificate(id).await
            }
            "role_description" => {
                self.delete_role_description(id).await
            }
            "policy" => {
            ...
            "account_summary" => {
                self.delete_account_summary(id).await
            }
            "mfa_device" => {
                self.delete_mfa_device(id).await
            }
            "open_id_connect_provider" => {
                self.delete_open_id_connect_provider(id).await
            }
            "account_alias" => {
            ...
            "organizations_access_report" => {
                self.delete_organizations_access_report(id).await
            }
            "user_permissions_boundary" => {
                self.delete_user_permissions_boundary(id).await
            }
            "login_profile" => {
                self.delete_login_profile(id).await
            }
            "group_policy" => {
                self.delete_group_policy(id).await
            }
            "context_keys_for_custom_policy" => {
            ...
            "user_policy" => {
                self.delete_user_policy(id).await
            }
            "account_password_policy" => {
                self.delete_account_password_policy(id).await
            }
            "credential_report" => {
                self.delete_credential_report(id).await
            }
            "service_last_accessed_details_with_entities" => {
                self.delete_service_last_accessed_details_with_entities(id).await
            }
            "service_linked_role_deletion_status" => {
            ...
            "virtual_mfa_device" => {
                self.delete_virtual_mfa_device(id).await
            }
            "assume_role_policy" => {
                self.delete_assume_role_policy(id).await
            }
            "saml_provider" => {
                self.delete_saml_provider(id).await
            }
            "context_keys_for_principal_policy" => {
                self.delete_context_keys_for_principal_policy(id).await
            }
            "service_last_accessed_details" => {
                self.delete_service_last_accessed_details(id).await
            }
            "role_policy" => {
                self.delete_role_policy(id).await
            }
            "ssh_public_key" => {
                self.delete_ssh_public_key(id).await
            }
            "account_authorization_details" => {
                self.delete_account_authorization_details(id).await
            }
            "service_linked_role" => {
                self.delete_service_linked_role(id).await
            }
            "group" => {
                self.delete_group(id).await
            }
            "access_key" => {
                self.delete_access_key(id).await
            }
            "access_key_last_used" => {
                self.delete_access_key_last_used(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iam",
    ...
    async fn read_role_permissions_boundary(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_service_specific_credential(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("credential_age_days", credential_age_days.unwrap_or_default())
            )
        })
    }

    /// Read a service_specific_credential resource
    async fn read_service_specific_credential(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_server_certificate(
        ...
        self.provider.runtime().block_on(async {
            ...
            let new_server_certificate_name = input.get_optional_string("new_server_certificate_name")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("server_certificate_name", server_certificate_name.unwrap_or_default())
                .with_field("new_path", new_path.unwrap_or_default())
                .with_field("new_server_certificate_name", new_server_certificate_name.unwrap_or_default())
            )
        })
    }

    /// Read a server_certificate resource
    async fn read_server_certificate(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_role_description(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_role_description(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_role_description(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_account_summary(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_account_summary(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_open_id_connect_provider(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_role(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("role_name", role_name.unwrap_or_default())
                .with_field("assume_role_policy_document", assume_role_policy_document.unwrap_or_default())
                .with_field("max_session_duration", max_session_duration.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("path", path.unwrap_or_default())
                .with_field("permissions_boundary", permissions_boundary.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
    ...
    async fn read_organizations_access_report(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_organizations_access_report(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_user_permissions_boundary(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_login_profile(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("user_name", user_name.unwrap_or_default())
                .with_field("password_reset_required", password_reset_required.unwrap_or_default())
            )
        })
    }

    /// Read a login_profile resource
    async fn read_login_profile(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_context_keys_for_custom_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_context_keys_for_custom_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_open_id_connect_provider_thumbprint(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("thumbprint_list", thumbprint_list.unwrap_or_default())
                .with_field("open_id_connect_provider_arn", open_id_connect_provider_arn.unwrap_or_default())
            )
        })
    }

    /// Read a open_id_connect_provider_thumbprint resource
    async fn read_open_id_connect_provider_thumbprint(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_open_id_connect_provider_thumbprint(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_account_password_policy(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let require_uppercase_characters = input.get_optional_string("require_uppercase_characters")?;
            let require_numbers = input.get_optional_string("require_numbers")?;
            let require_lowercase_characters = input.get_optional_string("require_lowercase_characters")?;
            let max_password_age = input.get_optional_string("max_password_age")?;
            let password_reuse_prevention = input.get_optional_string("password_reuse_prevention")?;
            ...
            let allow_users_to_change_password = input.get_optional_string("allow_users_to_change_password")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("require_uppercase_characters", require_uppercase_characters.unwrap_or_default())
                .with_field("require_numbers", require_numbers.unwrap_or_default())
                .with_field("require_lowercase_characters", require_lowercase_characters.unwrap_or_default())
                .with_field("max_password_age", max_password_age.unwrap_or_default())
                .with_field("password_reuse_prevention", password_reuse_prevention.unwrap_or_default())
                .with_field("hard_expiry", hard_expiry.unwrap_or_default())
                .with_field("minimum_password_length", minimum_password_length.unwrap_or_default())
                .with_field("allow_users_to_change_password", allow_users_to_change_password.unwrap_or_default())
    ...
    async fn read_account_password_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_credential_report(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_credential_report(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_credential_report(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_service_last_accessed_details_with_entities(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_service_linked_role_deletion_status(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_service_linked_role_deletion_status(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_virtual_mfa_device(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("tags", tags.unwrap_or_default())
                .with_field("path", path.unwrap_or_default())
                .with_field("virtual_mfa_device_name", virtual_mfa_device_name.unwrap_or_default())
            )
        })
    }

    /// Read a virtual_mfa_device resource
    async fn read_virtual_mfa_device(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_assume_role_policy(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_assume_role_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_assume_role_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_saml_provider(
        ...
        self.provider.runtime().block_on(async {
            ...
            let assertion_encryption_mode = input.get_optional_string("assertion_encryption_mode")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("assertion_encryption_mode", assertion_encryption_mode.unwrap_or_default())
                .with_field("saml_metadata_document", saml_metadata_document.unwrap_or_default())
            )
        })
    }

    /// Read a saml_provider resource
    async fn read_saml_provider(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_context_keys_for_principal_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_context_keys_for_principal_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_service_last_accessed_details(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_service_last_accessed_details(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_account_authorization_details(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_account_authorization_details(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_service_linked_role(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_access_key_last_used(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_access_key_last_used(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_access_key_last_used(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
