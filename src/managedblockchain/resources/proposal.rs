...
impl<'a> Proposal<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, member_id: String, network_id: String, client_request_token: String, actions: String, description: Option<String>) -> Result<String> {
