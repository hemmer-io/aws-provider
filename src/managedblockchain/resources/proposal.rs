...
impl<'a> Proposal<'a> {
    ...
    pub async fn create(&self, member_id: String, network_id: String, actions: String, client_request_token: String, description: Option<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
