...
impl<'a> Resource_policy<'a> {
    ...
    pub async fn create(&self, confirm_remove_self_resource_access: Option<bool>, policy: String, expected_revision_id: Option<String>, resource_arn: String) -> Result<String> {
