...
impl<'a> Resource_policy<'a> {
    ...
    pub async fn create(&self, resource_arn: String, policy: String, confirm_remove_self_resource_access: Option<bool>, expected_revision_id: Option<String>) -> Result<String> {
