...
impl<'a> Table_replica_auto_scaling<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, provisioned_write_capacity_auto_scaling_update: Option<String>, global_secondary_index_updates: Option<Vec<String>>, table_name: Option<String>, replica_updates: Option<Vec<String>>) -> Result<()> {
