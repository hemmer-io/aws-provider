...
impl<'a> Contributor_insights<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, contributor_insights_action: Option<String>, index_name: Option<String>, contributor_insights_mode: Option<String>, table_name: Option<String>) -> Result<()> {
