...
impl<'a> Contributor_insights<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, table_name: Option<String>, index_name: Option<String>, contributor_insights_action: Option<String>, contributor_insights_mode: Option<String>) -> Result<()> {
