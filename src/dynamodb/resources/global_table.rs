...
impl<'a> Global_table<'a> {
    ...
    pub async fn create(&self, replication_group: Vec<String>, global_table_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, replication_group: Option<Vec<String>>, global_table_name: Option<String>) -> Result<()> {
