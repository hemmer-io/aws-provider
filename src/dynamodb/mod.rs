...
impl<'a> DynamodbService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "contributor_insights" => {
                self.plan_contributor_insights(current_state, desired_input)
                    .await
            }
            "continuous_backups" => {
                self.plan_continuous_backups(current_state, desired_input)
                    .await
            }
            ...
            "global_table_settings" => {
                self.plan_global_table_settings(current_state, desired_input)
                    .await
            }
            "global_table" => self.plan_global_table(current_state, desired_input).await,
            "table_replica_auto_scaling" => {
                self.plan_table_replica_auto_scaling(current_state, desired_input)
                    .await
            }
            "export" => self.plan_export(current_state, desired_input).await,
            "time_to_live" => self.plan_time_to_live(current_state, desired_input).await,
            "kinesis_streaming_destination" => {
                self.plan_kinesis_streaming_destination(current_state, desired_input)
                    .await
            }
            "resource_policy" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "contributor_insights" => self.create_contributor_insights(input).await,
            "continuous_backups" => self.create_continuous_backups(input).await,
            "backup" => self.create_backup(input).await,
            "limits" => self.create_limits(input).await,
            "item" => self.create_item(input).await,
            "global_table_settings" => self.create_global_table_settings(input).await,
            "global_table" => self.create_global_table(input).await,
            "table_replica_auto_scaling" => self.create_table_replica_auto_scaling(input).await,
            "export" => self.create_export(input).await,
            "time_to_live" => self.create_time_to_live(input).await,
            "kinesis_streaming_destination" => {
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "contributor_insights" => self.read_contributor_insights(id).await,
            "continuous_backups" => self.read_continuous_backups(id).await,
            "backup" => self.read_backup(id).await,
            "limits" => self.read_limits(id).await,
            "item" => self.read_item(id).await,
            "global_table_settings" => self.read_global_table_settings(id).await,
            "global_table" => self.read_global_table(id).await,
            "table_replica_auto_scaling" => self.read_table_replica_auto_scaling(id).await,
            "export" => self.read_export(id).await,
            "time_to_live" => self.read_time_to_live(id).await,
            "kinesis_streaming_destination" => self.read_kinesis_streaming_destination(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "contributor_insights" => self.update_contributor_insights(id, input).await,
            "continuous_backups" => self.update_continuous_backups(id, input).await,
            "backup" => self.update_backup(id, input).await,
            "limits" => self.update_limits(id, input).await,
            "item" => self.update_item(id, input).await,
            "global_table_settings" => self.update_global_table_settings(id, input).await,
            "global_table" => self.update_global_table(id, input).await,
            "table_replica_auto_scaling" => self.update_table_replica_auto_scaling(id, input).await,
            "export" => self.update_export(id, input).await,
            "time_to_live" => self.update_time_to_live(id, input).await,
            "kinesis_streaming_destination" => {
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "contributor_insights" => self.delete_contributor_insights(id).await,
            "continuous_backups" => self.delete_continuous_backups(id).await,
            "backup" => self.delete_backup(id).await,
            "limits" => self.delete_limits(id).await,
            "item" => self.delete_item(id).await,
            "global_table_settings" => self.delete_global_table_settings(id).await,
            "global_table" => self.delete_global_table(id).await,
            "table_replica_auto_scaling" => self.delete_table_replica_auto_scaling(id).await,
            "export" => self.delete_export(id).await,
            "time_to_live" => self.delete_time_to_live(id).await,
            "kinesis_streaming_destination" => self.delete_kinesis_streaming_destination(id).await,
    ...
    async fn create_contributor_insights(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let contributor_insights_mode =
                input.get_optional_string("contributor_insights_mode")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    contributor_insights_action.unwrap_or_default(),
                )
                .with_field("index_name", index_name.unwrap_or_default())
                .with_field(
                    "contributor_insights_mode",
                    contributor_insights_mode.unwrap_or_default(),
                )
    ...
    async fn read_contributor_insights(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_contributor_insights(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_continuous_backups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let point_in_time_recovery_specification =
                input.get_string("point_in_time_recovery_specification")?;
            let table_name = input.get_string("table_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    point_in_time_recovery_specification.unwrap_or_default(),
                )
                .with_field("table_name", table_name.unwrap_or_default()))
        })
    }
    ...
    async fn read_continuous_backups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.dynamodb_client
    ...
    async fn delete_continuous_backups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.dynamodb_client
    ...
    async fn create_item(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let return_values_on_condition_check_failure =
                input.get_optional_string("return_values_on_condition_check_failure")?;
            ...
            let table_name = input.get_string("table_name")?;
            let return_item_collection_metrics =
                input.get_optional_string("return_item_collection_metrics")?;
            let condition_expression = input.get_optional_string("condition_expression")?;
            let expression_attribute_names =
                input.get_optional_string("expression_attribute_names")?;
            let item = input.get_string("item")?;
            let expression_attribute_values =
                input.get_optional_string("expression_attribute_values")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    return_consumed_capacity.unwrap_or_default(),
                )
                .with_field(
                    "return_values_on_condition_check_failure",
                    return_values_on_condition_check_failure.unwrap_or_default(),
                )
                .with_field(
                    "conditional_operator",
                    conditional_operator.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    return_item_collection_metrics.unwrap_or_default(),
                )
                .with_field(
                    "condition_expression",
                    condition_expression.unwrap_or_default(),
                )
                .with_field(
                    "expression_attribute_names",
                    expression_attribute_names.unwrap_or_default(),
                )
                .with_field("item", item.unwrap_or_default())
                .with_field(
                    "expression_attribute_values",
                    expression_attribute_values.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_global_table_settings(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let global_table_provisioned_write_capacity_units =
                input.get_optional_string("global_table_provisioned_write_capacity_units")?;
            let global_table_provisioned_write_capacity_auto_scaling_settings_update = input
                .get_optional_string(
                    "global_table_provisioned_write_capacity_auto_scaling_settings_update",
                )?;
            let global_table_global_secondary_index_settings_update =
                input.get_optional_string("global_table_global_secondary_index_settings_update")?;
            ...
            let global_table_billing_mode =
                input.get_optional_string("global_table_billing_mode")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    global_table_provisioned_write_capacity_units.unwrap_or_default(),
                )
                .with_field(
                    "global_table_provisioned_write_capacity_auto_scaling_settings_update",
                    global_table_provisioned_write_capacity_auto_scaling_settings_update
                ...
                .with_field(
                    ...
                    global_table_global_secondary_index_settings_update.unwrap_or_default(),
                )
                .with_field("global_table_name", global_table_name.unwrap_or_default())
                .with_field(
                    "replica_settings_update",
                    replica_settings_update.unwrap_or_default(),
                )
                .with_field(
                    "global_table_billing_mode",
                    global_table_billing_mode.unwrap_or_default(),
                ))
        })
    }

    /// Read a global_table_settings resource
    async fn read_global_table_settings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.dynamodb_client
    ...
    async fn delete_global_table_settings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.dynamodb_client
    ...
    async fn create_global_table(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let global_table_name = input.get_string("global_table_name")?;
    ...
    async fn read_global_table(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.dynamodb_client
    ...
    async fn update_global_table(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let global_table_name = input.get_string("global_table_name")?;
            let replication_group = input.get_string("replication_group")?;
    ...
    async fn delete_global_table(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.dynamodb_client
    ...
    async fn create_table_replica_auto_scaling(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let provisioned_write_capacity_auto_scaling_update =
                input.get_optional_string("provisioned_write_capacity_auto_scaling_update")?;
            let replica_updates = input.get_optional_string("replica_updates")?;
            let table_name = input.get_string("table_name")?;
            let global_secondary_index_updates =
                input.get_optional_string("global_secondary_index_updates")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    provisioned_write_capacity_auto_scaling_update.unwrap_or_default(),
                )
                .with_field("replica_updates", replica_updates.unwrap_or_default())
                .with_field("table_name", table_name.unwrap_or_default())
                .with_field(
                    "global_secondary_index_updates",
                    global_secondary_index_updates.unwrap_or_default(),
                ))
        })
    }

    /// Read a table_replica_auto_scaling resource
    async fn read_table_replica_auto_scaling(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.dynamodb_client
    ...
    async fn delete_table_replica_auto_scaling(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.dynamodb_client
    ...
    async fn create_time_to_live(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let table_name = input.get_string("table_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    time_to_live_specification.unwrap_or_default(),
                ))
        })
    }

    /// Read a time_to_live resource
    async fn read_time_to_live(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.dynamodb_client
    ...
    async fn update_time_to_live(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let table_name = input.get_string("table_name")?;
            let time_to_live_specification = input.get_string("time_to_live_specification")?;
    ...
    async fn delete_time_to_live(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.dynamodb_client
    ...
    async fn create_kinesis_streaming_destination(
        ...
        self.provider.runtime().block_on(async {
            ...
            let update_kinesis_streaming_configuration =
                input.get_optional_string("update_kinesis_streaming_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    update_kinesis_streaming_configuration.unwrap_or_default(),
                ))
        })
    }

    /// Read a kinesis_streaming_destination resource
    async fn read_kinesis_streaming_destination(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.dynamodb_client
    ...
    async fn delete_kinesis_streaming_destination(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.dynamodb_client
    ...
    async fn create_resource_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let confirm_remove_self_resource_access =
                input.get_optional_string("confirm_remove_self_resource_access")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    confirm_remove_self_resource_access.unwrap_or_default(),
                )
                .with_field(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    stream_specification.unwrap_or_default(),
                )
                .with_field(
                ...
                .with_field(
                    ...
                    on_demand_throughput.unwrap_or_default(),
                )
                .with_field("billing_mode", billing_mode.unwrap_or_default())
                .with_field(
                    "attribute_definitions",
                    attribute_definitions.unwrap_or_default(),
                )
                .with_field("table_name", table_name.unwrap_or_default())
                .with_field(
                    "local_secondary_indexes",
                    local_secondary_indexes.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    global_secondary_indexes.unwrap_or_default(),
                ))
        })
    }
