...
impl<'a> Scheduled_action<'a> {
    ...
    pub async fn create(&self, iam_role: String, scheduled_action_description: Option<String>, target_action: String, start_time: Option<String>, scheduled_action_name: String, enable: Option<bool>, end_time: Option<String>, schedule: String) -> Result<String> {
