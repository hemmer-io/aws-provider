...
impl<'a> Endpoint_access<'a> {
    ...
    pub async fn create(&self, endpoint_name: String, subnet_group_name: String, vpc_security_group_ids: Option<Vec<String>>, resource_owner: Option<String>, cluster_identifier: Option<String>) -> Result<String> {
