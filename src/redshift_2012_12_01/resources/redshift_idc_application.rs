...
impl<'a> Redshift_idc_application<'a> {
    ...
    pub async fn create(&self, redshift_idc_application_name: String, authorized_token_issuer_list: Option<Vec<String>>, idc_display_name: String, tags: Option<Vec<String>>, service_integrations: Option<Vec<String>>, identity_namespace: Option<String>, sso_tag_keys: Option<Vec<String>>, iam_role_arn: String, idc_instance_arn: String) -> Result<String> {
