...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, event_categories: Option<Vec<String>>, severity: Option<String>, subscription_name: String, tags: Option<Vec<String>>, enabled: Option<bool>, sns_topic_arn: String, source_type: Option<String>, source_ids: Option<Vec<String>>) -> Result<String> {
