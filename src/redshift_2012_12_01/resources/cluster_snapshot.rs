...
impl<'a> Cluster_snapshot<'a> {
    ...
    pub async fn create(&self, snapshot_identifier: String, tags: Option<Vec<String>>, manual_snapshot_retention_period: Option<i64>, cluster_identifier: String) -> Result<String> {
