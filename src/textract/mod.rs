...
impl<'a> TextractService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "document_analysis" => {
                self.plan_document_analysis(current_state, desired_input)
                    .await
            }
            "adapter_version" => {
                self.plan_adapter_version(current_state, desired_input)
                    .await
            }
            "adapter" => self.plan_adapter(current_state, desired_input).await,
            "document_text_detection" => {
                self.plan_document_text_detection(current_state, desired_input)
                    .await
            }
            "lending_analysis" => {
                self.plan_lending_analysis(current_state, desired_input)
                    .await
            }
            "lending_analysis_summary" => {
                self.plan_lending_analysis_summary(current_state, desired_input)
                    .await
            }
            "expense_analysis" => {
                self.plan_expense_analysis(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "textract", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "document_analysis" => self.create_document_analysis(input).await,
            "adapter_version" => self.create_adapter_version(input).await,
            "adapter" => self.create_adapter(input).await,
            "document_text_detection" => self.create_document_text_detection(input).await,
            "lending_analysis" => self.create_lending_analysis(input).await,
            "lending_analysis_summary" => self.create_lending_analysis_summary(input).await,
            "expense_analysis" => self.create_expense_analysis(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "textract", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "document_analysis" => self.read_document_analysis(id).await,
            "adapter_version" => self.read_adapter_version(id).await,
            "adapter" => self.read_adapter(id).await,
            "document_text_detection" => self.read_document_text_detection(id).await,
            "lending_analysis" => self.read_lending_analysis(id).await,
            "lending_analysis_summary" => self.read_lending_analysis_summary(id).await,
            "expense_analysis" => self.read_expense_analysis(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "textract", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "document_analysis" => self.update_document_analysis(id, input).await,
            "adapter_version" => self.update_adapter_version(id, input).await,
            "adapter" => self.update_adapter(id, input).await,
            "document_text_detection" => self.update_document_text_detection(id, input).await,
            "lending_analysis" => self.update_lending_analysis(id, input).await,
            "lending_analysis_summary" => self.update_lending_analysis_summary(id, input).await,
            "expense_analysis" => self.update_expense_analysis(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "textract", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "document_analysis" => self.delete_document_analysis(id).await,
            "adapter_version" => self.delete_adapter_version(id).await,
            "adapter" => self.delete_adapter(id).await,
            "document_text_detection" => self.delete_document_text_detection(id).await,
            "lending_analysis" => self.delete_lending_analysis(id).await,
            "lending_analysis_summary" => self.delete_lending_analysis_summary(id).await,
            "expense_analysis" => self.delete_expense_analysis(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "textract", resource_name
            ))),
    ...
    async fn create_document_analysis(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_document_analysis(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_document_analysis(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_adapter_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_adapter_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.textract_client
    ...
    async fn delete_adapter_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.textract_client
    ...
    async fn create_document_text_detection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_document_text_detection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.textract_client
    ...
    async fn delete_document_text_detection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.textract_client
    ...
    async fn create_lending_analysis(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_lending_analysis(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.textract_client
    ...
    async fn delete_lending_analysis(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.textract_client
    ...
    async fn read_lending_analysis_summary(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.textract_client
    ...
    async fn delete_lending_analysis_summary(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.textract_client
    ...
    async fn create_expense_analysis(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_expense_analysis(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.textract_client
    ...
    async fn delete_expense_analysis(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.textract_client
