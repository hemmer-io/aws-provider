...
impl<'a> Adapter_version<'a> {
    ...
    pub async fn create(&self, kms_key_id: Option<String>, tags: Option<HashMap<String, String>>, adapter_id: String, client_request_token: Option<String>, output_config: String, dataset_config: String) -> Result<String> {
