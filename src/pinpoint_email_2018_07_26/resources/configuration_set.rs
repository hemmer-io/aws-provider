...
impl<'a> Configuration_set<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, reputation_options: Option<String>, tracking_options: Option<String>, configuration_set_name: String, sending_options: Option<String>, delivery_options: Option<String>) -> Result<String> {
