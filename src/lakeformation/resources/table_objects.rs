...
impl<'a> Table_objects<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, write_operations: Option<Vec<String>>, transaction_id: Option<String>, database_name: Option<String>, catalog_id: Option<String>, table_name: Option<String>) -> Result<()> {
