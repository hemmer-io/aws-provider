...
impl<'a> Table_storage_optimizer<'a> {
    ...
    pub async fn update(&self, id: &str, storage_optimizer_config: Option<HashMap<String, HashMap<String, String>>>, catalog_id: Option<String>, database_name: Option<String>, table_name: Option<String>) -> Result<()> {
