...
impl<'a> Lf_tag_expression<'a> {
    ...
    pub async fn create(&self, expression: Vec<String>, name: String, catalog_id: Option<String>, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, expression: Option<Vec<String>>, name: Option<String>, catalog_id: Option<String>, description: Option<String>) -> Result<()> {
