...
impl<'a> Lf_tag_expression<'a> {
    ...
    pub async fn create(&self, name: String, expression: Vec<String>, description: Option<String>, catalog_id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, expression: Option<Vec<String>>, description: Option<String>, catalog_id: Option<String>) -> Result<()> {
