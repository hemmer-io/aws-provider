...
impl<'a> Subnet_group<'a> {
    ...
    pub async fn create(&self, subnet_group_name: String, subnet_ids: Vec<String>, tags: Option<Vec<String>>, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, subnet_group_name: Option<String>, subnet_ids: Option<Vec<String>>, tags: Option<Vec<String>>, description: Option<String>) -> Result<()> {
