...
impl<'a> Parameter_group<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, family: String, parameter_group_name: String, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, family: Option<String>, parameter_group_name: Option<String>, description: Option<String>) -> Result<()> {
