...
impl<'a> Parameter_group<'a> {
    ...
    pub async fn create(&self, parameter_group_name: String, tags: Option<Vec<String>>, family: String, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, parameter_group_name: Option<String>, tags: Option<Vec<String>>, family: Option<String>, description: Option<String>) -> Result<()> {
