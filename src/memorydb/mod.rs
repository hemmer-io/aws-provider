...
impl<'a> MemorydbService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "multi_region_parameters" => {
                self.plan_multi_region_parameters(current_state, desired_input)
                    .await
            }
            "multi_region_cluster" => {
                self.plan_multi_region_cluster(current_state, desired_input)
                    .await
            }
            "reserved_nodes" => self.plan_reserved_nodes(current_state, desired_input).await,
            "ac_ls" => self.plan_ac_ls(current_state, desired_input).await,
            "parameter_group" => {
                self.plan_parameter_group(current_state, desired_input)
                    .await
            }
            "acl" => self.plan_acl(current_state, desired_input).await,
            "parameters" => self.plan_parameters(current_state, desired_input).await,
            "subnet_groups" => self.plan_subnet_groups(current_state, desired_input).await,
            ...
            "reserved_nodes_offerings" => {
                self.plan_reserved_nodes_offerings(current_state, desired_input)
                    .await
            }
            "multi_region_parameter_groups" => {
                self.plan_multi_region_parameter_groups(current_state, desired_input)
                    .await
            }
            ...
            "subnet_group" => self.plan_subnet_group(current_state, desired_input).await,
            "parameter_groups" => {
                self.plan_parameter_groups(current_state, desired_input)
                    .await
            }
            "multi_region_clusters" => {
                self.plan_multi_region_clusters(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "multi_region_parameters" => self.create_multi_region_parameters(input).await,
            "multi_region_cluster" => self.create_multi_region_cluster(input).await,
            "reserved_nodes" => self.create_reserved_nodes(input).await,
            "ac_ls" => self.create_ac_ls(input).await,
            "parameter_group" => self.create_parameter_group(input).await,
            "acl" => self.create_acl(input).await,
            "parameters" => self.create_parameters(input).await,
            "subnet_groups" => self.create_subnet_groups(input).await,
            ...
            "reserved_nodes_offerings" => self.create_reserved_nodes_offerings(input).await,
            "multi_region_parameter_groups" => {
            ...
            "subnet_group" => self.create_subnet_group(input).await,
            "parameter_groups" => self.create_parameter_groups(input).await,
            "multi_region_clusters" => self.create_multi_region_clusters(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "multi_region_parameters" => self.read_multi_region_parameters(id).await,
            "multi_region_cluster" => self.read_multi_region_cluster(id).await,
            "reserved_nodes" => self.read_reserved_nodes(id).await,
            "ac_ls" => self.read_ac_ls(id).await,
            "parameter_group" => self.read_parameter_group(id).await,
            "acl" => self.read_acl(id).await,
            "parameters" => self.read_parameters(id).await,
            "subnet_groups" => self.read_subnet_groups(id).await,
            ...
            "reserved_nodes_offerings" => self.read_reserved_nodes_offerings(id).await,
            "multi_region_parameter_groups" => self.read_multi_region_parameter_groups(id).await,
            "user" => self.read_user(id).await,
            "service_updates" => self.read_service_updates(id).await,
            "subnet_group" => self.read_subnet_group(id).await,
            "parameter_groups" => self.read_parameter_groups(id).await,
            "multi_region_clusters" => self.read_multi_region_clusters(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "multi_region_parameters" => self.update_multi_region_parameters(id, input).await,
            "multi_region_cluster" => self.update_multi_region_cluster(id, input).await,
            "reserved_nodes" => self.update_reserved_nodes(id, input).await,
            "ac_ls" => self.update_ac_ls(id, input).await,
            "parameter_group" => self.update_parameter_group(id, input).await,
            "acl" => self.update_acl(id, input).await,
            "parameters" => self.update_parameters(id, input).await,
            "subnet_groups" => self.update_subnet_groups(id, input).await,
            ...
            "reserved_nodes_offerings" => self.update_reserved_nodes_offerings(id, input).await,
            "multi_region_parameter_groups" => {
            ...
            "subnet_group" => self.update_subnet_group(id, input).await,
            "parameter_groups" => self.update_parameter_groups(id, input).await,
            "multi_region_clusters" => self.update_multi_region_clusters(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "multi_region_parameters" => self.delete_multi_region_parameters(id).await,
            "multi_region_cluster" => self.delete_multi_region_cluster(id).await,
            "reserved_nodes" => self.delete_reserved_nodes(id).await,
            "ac_ls" => self.delete_ac_ls(id).await,
            "parameter_group" => self.delete_parameter_group(id).await,
            "acl" => self.delete_acl(id).await,
            "parameters" => self.delete_parameters(id).await,
            "subnet_groups" => self.delete_subnet_groups(id).await,
            ...
            "reserved_nodes_offerings" => self.delete_reserved_nodes_offerings(id).await,
            "multi_region_parameter_groups" => self.delete_multi_region_parameter_groups(id).await,
            "user" => self.delete_user(id).await,
            "service_updates" => self.delete_service_updates(id).await,
            "subnet_group" => self.delete_subnet_group(id).await,
            "parameter_groups" => self.delete_parameter_groups(id).await,
            "multi_region_clusters" => self.delete_multi_region_clusters(id).await,
    ...
    async fn create_multi_region_parameters(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_multi_region_parameters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_multi_region_parameters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_multi_region_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let multi_region_cluster_name_suffix =
                input.get_string("multi_region_cluster_name_suffix")?;
            ...
            let multi_region_parameter_group_name =
                input.get_optional_string("multi_region_parameter_group_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    multi_region_cluster_name_suffix.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    multi_region_parameter_group_name.unwrap_or_default(),
                )
    ...
    async fn read_multi_region_cluster(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.memorydb_client
    ...
    async fn delete_multi_region_cluster(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.memorydb_client
    ...
    async fn create_ac_ls(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_ac_ls(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.memorydb_client
    ...
    async fn update_ac_ls(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_ac_ls(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.memorydb_client
    ...
    async fn create_parameter_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_parameter_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.memorydb_client
    ...
    async fn delete_parameter_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.memorydb_client
    ...
    async fn create_subnet_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_subnet_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.memorydb_client
    ...
    async fn update_subnet_groups(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_subnet_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.memorydb_client
    ...
    async fn read_reserved_nodes_offerings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.memorydb_client
    ...
    async fn delete_reserved_nodes_offerings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.memorydb_client
    ...
    async fn read_multi_region_parameter_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.memorydb_client
    ...
    async fn delete_multi_region_parameter_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.memorydb_client
    ...
    async fn create_subnet_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_subnet_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.memorydb_client
    ...
    async fn update_subnet_group(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let subnet_group_name = input.get_string("subnet_group_name")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_subnet_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.memorydb_client
    ...
    async fn create_parameter_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_parameter_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.memorydb_client
    ...
    async fn delete_parameter_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.memorydb_client
    ...
    async fn create_multi_region_clusters(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_multi_region_clusters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.memorydb_client
    ...
    async fn delete_multi_region_clusters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.memorydb_client
    ...
    async fn create_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let engine_version = input.get_optional_string("engine_version")?;
            let multi_region_cluster_name =
                input.get_optional_string("multi_region_cluster_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    multi_region_cluster_name.unwrap_or_default(),
                )
                .with_field(
                    "parameter_group_name",
                    parameter_group_name.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    num_replicas_per_shard.unwrap_or_default(),
                )
                .with_field("num_shards", num_shards.unwrap_or_default())
                .with_field("snapshot_name", snapshot_name.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
