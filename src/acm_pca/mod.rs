...
impl<'a> Acm_pcaService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "certificate_authority_audit_report" => {
                self.plan_certificate_authority_audit_report(current_state, desired_input)
                    .await
            }
            "certificate_authority" => {
                self.plan_certificate_authority(current_state, desired_input)
                    .await
            }
            "policy" => self.plan_policy(current_state, desired_input).await,
            "certificate_authority_certificate" => {
                self.plan_certificate_authority_certificate(current_state, desired_input)
                    .await
            }
            "certificate_authority_csr" => {
                self.plan_certificate_authority_csr(current_state, desired_input)
                    .await
            }
            "certificate" => self.plan_certificate(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "acm_pca", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "certificate_authority" => self.create_certificate_authority(input).await,
            "policy" => self.create_policy(input).await,
            "certificate_authority_certificate" => {
                self.create_certificate_authority_certificate(input).await
            }
            "certificate_authority_csr" => self.create_certificate_authority_csr(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "certificate_authority" => self.read_certificate_authority(id).await,
            "policy" => self.read_policy(id).await,
            "certificate_authority_certificate" => {
                self.read_certificate_authority_certificate(id).await
            }
            "certificate_authority_csr" => self.read_certificate_authority_csr(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "certificate_authority_audit_report" => {
                self.update_certificate_authority_audit_report(id, input)
                    .await
            }
            "certificate_authority" => self.update_certificate_authority(id, input).await,
            "policy" => self.update_policy(id, input).await,
            "certificate_authority_certificate" => {
                self.update_certificate_authority_certificate(id, input)
                    .await
            }
            "certificate_authority_csr" => self.update_certificate_authority_csr(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "certificate_authority" => self.delete_certificate_authority(id).await,
            "policy" => self.delete_policy(id).await,
            "certificate_authority_certificate" => {
                self.delete_certificate_authority_certificate(id).await
            }
            "certificate_authority_csr" => self.delete_certificate_authority_csr(id).await,
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    certificate_authority_arn.unwrap_or_default(),
                )
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    audit_report_response_format.unwrap_or_default(),
                )
                .with_field(
                    "certificate_authority_arn",
                    certificate_authority_arn.unwrap_or_default(),
    ...
    async fn read_certificate_authority_audit_report(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.acm_pca_client
    ...
    async fn delete_certificate_authority_audit_report(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.acm_pca_client
    ...
    async fn create_certificate_authority(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let certificate_authority_configuration =
                input.get_string("certificate_authority_configuration")?;
            let key_storage_security_standard =
                input.get_optional_string("key_storage_security_standard")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    certificate_authority_configuration.unwrap_or_default(),
                )
                .with_field(
                    "key_storage_security_standard",
                    key_storage_security_standard.unwrap_or_default(),
                )
                .with_field(
                    "revocation_configuration",
                    revocation_configuration.unwrap_or_default(),
                )
                .with_field(
                    "certificate_authority_type",
                    certificate_authority_type.unwrap_or_default(),
                )
    ...
    async fn read_certificate_authority(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.acm_pca_client
    ...
    async fn delete_certificate_authority(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.acm_pca_client
    ...
    async fn read_certificate_authority_certificate(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.acm_pca_client
    ...
    async fn delete_certificate_authority_certificate(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.acm_pca_client
    ...
    async fn read_certificate_authority_csr(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.acm_pca_client
    ...
    async fn delete_certificate_authority_csr(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.acm_pca_client
