...
impl<'a> Provisioned_product<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, path_name: Option<String>, provisioned_product_name: Option<String>, path_id: Option<String>, provisioning_artifact_id: Option<String>, provisioned_product_id: Option<String>, product_id: Option<String>, provisioning_artifact_name: Option<String>, provisioning_parameters: Option<Vec<String>>, update_token: Option<String>, accept_language: Option<String>, product_name: Option<String>, provisioning_preferences: Option<String>) -> Result<()> {
