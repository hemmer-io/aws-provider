...
impl<'a> Provisioning_artifact<'a> {
    ...
    pub async fn create(&self, idempotency_token: String, accept_language: Option<String>, product_id: String, parameters: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, idempotency_token: Option<String>, accept_language: Option<String>, product_id: Option<String>, parameters: Option<String>) -> Result<()> {
