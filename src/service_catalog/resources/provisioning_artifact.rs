...
impl<'a> Provisioning_artifact<'a> {
    ...
    pub async fn create(&self, parameters: String, idempotency_token: String, accept_language: Option<String>, product_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, parameters: Option<String>, idempotency_token: Option<String>, accept_language: Option<String>, product_id: Option<String>) -> Result<()> {
