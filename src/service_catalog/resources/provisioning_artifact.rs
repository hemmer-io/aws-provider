...
impl<'a> Provisioning_artifact<'a> {
    ...
    pub async fn create(&self, product_id: String, parameters: String, accept_language: Option<String>, idempotency_token: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, product_id: Option<String>, parameters: Option<String>, accept_language: Option<String>, idempotency_token: Option<String>) -> Result<()> {
