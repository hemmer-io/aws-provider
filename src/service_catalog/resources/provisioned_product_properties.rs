...
impl<'a> Provisioned_product_properties<'a> {
    ...
    pub async fn update(&self, id: &str, provisioned_product_properties: Option<HashMap<String, String>>, accept_language: Option<String>, provisioned_product_id: Option<String>, idempotency_token: Option<String>) -> Result<()> {
