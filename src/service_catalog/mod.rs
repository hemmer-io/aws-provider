...
impl<'a> Service_catalogService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "product_as_admin" => {
                self.plan_product_as_admin(current_state, desired_input)
                    .await
            }
            "record" => self.plan_record(current_state, desired_input).await,
            "provisioning_parameters" => {
                self.plan_provisioning_parameters(current_state, desired_input)
                    .await
            }
            "aws_organizations_access_status" => {
                self.plan_aws_organizations_access_status(current_state, desired_input)
                    .await
            }
            "constraint" => self.plan_constraint(current_state, desired_input).await,
            "provisioning_artifact" => {
                self.plan_provisioning_artifact(current_state, desired_input)
                    .await
            }
            "service_action_execution_parameters" => {
                self.plan_service_action_execution_parameters(current_state, desired_input)
                    .await
            }
            "provisioned_product_outputs" => {
                self.plan_provisioned_product_outputs(current_state, desired_input)
                    .await
            }
            "product" => self.plan_product(current_state, desired_input).await,
            "service_action" => self.plan_service_action(current_state, desired_input).await,
            "portfolio_shares" => {
                self.plan_portfolio_shares(current_state, desired_input)
                    .await
            }
            "portfolio" => self.plan_portfolio(current_state, desired_input).await,
            "portfolio_share_status" => {
                self.plan_portfolio_share_status(current_state, desired_input)
                    .await
            }
            "provisioned_product_plan" => {
                self.plan_provisioned_product_plan(current_state, desired_input)
                    .await
            }
            "tag_option" => self.plan_tag_option(current_state, desired_input).await,
            "provisioned_product" => {
                self.plan_provisioned_product(current_state, desired_input)
                    .await
            }
            "portfolio_share" => {
                self.plan_portfolio_share(current_state, desired_input)
                    .await
            }
            "product_view" => self.plan_product_view(current_state, desired_input).await,
            "copy_product_status" => {
                self.plan_copy_product_status(current_state, desired_input)
                    .await
            }
            "provisioned_product_properties" => {
                self.plan_provisioned_product_properties(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "service_catalog", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "product_as_admin" => self.create_product_as_admin(input).await,
            "record" => self.create_record(input).await,
            "provisioning_parameters" => self.create_provisioning_parameters(input).await,
            "aws_organizations_access_status" => {
                self.create_aws_organizations_access_status(input).await
            }
            "constraint" => self.create_constraint(input).await,
            "provisioning_artifact" => self.create_provisioning_artifact(input).await,
            "service_action_execution_parameters" => {
                self.create_service_action_execution_parameters(input).await
            }
            "provisioned_product_outputs" => self.create_provisioned_product_outputs(input).await,
            "product" => self.create_product(input).await,
            "service_action" => self.create_service_action(input).await,
            "portfolio_shares" => self.create_portfolio_shares(input).await,
            "portfolio" => self.create_portfolio(input).await,
            "portfolio_share_status" => self.create_portfolio_share_status(input).await,
            "provisioned_product_plan" => self.create_provisioned_product_plan(input).await,
            "tag_option" => self.create_tag_option(input).await,
            "provisioned_product" => self.create_provisioned_product(input).await,
            "portfolio_share" => self.create_portfolio_share(input).await,
            "product_view" => self.create_product_view(input).await,
            "copy_product_status" => self.create_copy_product_status(input).await,
            "provisioned_product_properties" => {
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "product_as_admin" => self.read_product_as_admin(id).await,
            "record" => self.read_record(id).await,
            "provisioning_parameters" => self.read_provisioning_parameters(id).await,
            "aws_organizations_access_status" => {
                self.read_aws_organizations_access_status(id).await
            }
            "constraint" => self.read_constraint(id).await,
            "provisioning_artifact" => self.read_provisioning_artifact(id).await,
            "service_action_execution_parameters" => {
                self.read_service_action_execution_parameters(id).await
            }
            "provisioned_product_outputs" => self.read_provisioned_product_outputs(id).await,
            "product" => self.read_product(id).await,
            "service_action" => self.read_service_action(id).await,
            "portfolio_shares" => self.read_portfolio_shares(id).await,
            "portfolio" => self.read_portfolio(id).await,
            "portfolio_share_status" => self.read_portfolio_share_status(id).await,
            "provisioned_product_plan" => self.read_provisioned_product_plan(id).await,
            "tag_option" => self.read_tag_option(id).await,
            "provisioned_product" => self.read_provisioned_product(id).await,
            "portfolio_share" => self.read_portfolio_share(id).await,
            "product_view" => self.read_product_view(id).await,
            "copy_product_status" => self.read_copy_product_status(id).await,
            "provisioned_product_properties" => self.read_provisioned_product_properties(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "service_catalog", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "product_as_admin" => self.update_product_as_admin(id, input).await,
            "record" => self.update_record(id, input).await,
            "provisioning_parameters" => self.update_provisioning_parameters(id, input).await,
            "aws_organizations_access_status" => {
                self.update_aws_organizations_access_status(id, input).await
            }
            "constraint" => self.update_constraint(id, input).await,
            "provisioning_artifact" => self.update_provisioning_artifact(id, input).await,
            "service_action_execution_parameters" => {
                self.update_service_action_execution_parameters(id, input)
                    .await
            }
            "provisioned_product_outputs" => {
            ...
            "service_action" => self.update_service_action(id, input).await,
            "portfolio_shares" => self.update_portfolio_shares(id, input).await,
            "portfolio" => self.update_portfolio(id, input).await,
            "portfolio_share_status" => self.update_portfolio_share_status(id, input).await,
            "provisioned_product_plan" => self.update_provisioned_product_plan(id, input).await,
            "tag_option" => self.update_tag_option(id, input).await,
            "provisioned_product" => self.update_provisioned_product(id, input).await,
            "portfolio_share" => self.update_portfolio_share(id, input).await,
            "product_view" => self.update_product_view(id, input).await,
            "copy_product_status" => self.update_copy_product_status(id, input).await,
            "provisioned_product_properties" => {
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "product_as_admin" => self.delete_product_as_admin(id).await,
            "record" => self.delete_record(id).await,
            "provisioning_parameters" => self.delete_provisioning_parameters(id).await,
            "aws_organizations_access_status" => {
                self.delete_aws_organizations_access_status(id).await
            }
            "constraint" => self.delete_constraint(id).await,
            "provisioning_artifact" => self.delete_provisioning_artifact(id).await,
            "service_action_execution_parameters" => {
                self.delete_service_action_execution_parameters(id).await
            }
            "provisioned_product_outputs" => self.delete_provisioned_product_outputs(id).await,
            "product" => self.delete_product(id).await,
            "service_action" => self.delete_service_action(id).await,
            "portfolio_shares" => self.delete_portfolio_shares(id).await,
            "portfolio" => self.delete_portfolio(id).await,
            "portfolio_share_status" => self.delete_portfolio_share_status(id).await,
            "provisioned_product_plan" => self.delete_provisioned_product_plan(id).await,
            "tag_option" => self.delete_tag_option(id).await,
            "provisioned_product" => self.delete_provisioned_product(id).await,
            "portfolio_share" => self.delete_portfolio_share(id).await,
            "product_view" => self.delete_product_view(id).await,
            "copy_product_status" => self.delete_copy_product_status(id).await,
            "provisioned_product_properties" => {
    ...
    async fn create_product_as_admin(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_product_as_admin(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_product_as_admin(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_provisioning_parameters(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_provisioning_parameters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_provisioning_parameters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn read_aws_organizations_access_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_aws_organizations_access_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn create_provisioning_artifact(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let idempotency_token = input.get_string("idempotency_token")?;
    ...
    async fn read_provisioning_artifact(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_provisioning_artifact(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn read_service_action_execution_parameters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_service_action_execution_parameters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn read_provisioned_product_outputs(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_provisioned_product_outputs(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn create_product(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let idempotency_token = input.get_string("idempotency_token")?;
            let provisioning_artifact_parameters =
                input.get_optional_string("provisioning_artifact_parameters")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "support_description",
                    support_description.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    provisioning_artifact_parameters.unwrap_or_default(),
                )
    ...
    async fn create_service_action(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let name = input.get_string("name")?;
    ...
    async fn read_service_action(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_service_action(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn create_portfolio_shares(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_portfolio_shares(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_portfolio_shares(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn create_portfolio(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let description = input.get_optional_string("description")?;
    ...
    async fn read_portfolio(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn update_portfolio(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let description = input.get_optional_string("description")?;
            let display_name = input.get_string("display_name")?;
    ...
    async fn create_portfolio_share_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_portfolio_share_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_portfolio_share_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    provisioned_product_name.unwrap_or_default(),
                )
                .with_field(
                    "provisioning_artifact_id",
                    provisioning_artifact_id.unwrap_or_default(),
                )
                .with_field("idempotency_token", idempotency_token.unwrap_or_default())
                .with_field(
                    "provisioning_parameters",
                    provisioning_parameters.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
    ...
    async fn read_provisioned_product_plan(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_provisioned_product_plan(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn create_tag_option(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_tag_option(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn update_tag_option(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let key = input.get_string("key")?;
            let value = input.get_string("value")?;
    ...
    async fn delete_tag_option(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn create_provisioned_product(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            let provisioning_artifact_name =
                input.get_optional_string("provisioning_artifact_name")?;
            let provisioning_parameters = input.get_optional_string("provisioning_parameters")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    provisioned_product_id.unwrap_or_default(),
                )
                .with_field("product_id", product_id.unwrap_or_default())
                .with_field(
                    "provisioning_artifact_name",
                    provisioning_artifact_name.unwrap_or_default(),
                )
                .with_field(
                    "provisioning_parameters",
                    provisioning_parameters.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    provisioning_preferences.unwrap_or_default(),
                ))
        })
    }

    /// Read a provisioned_product resource
    async fn read_provisioned_product(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_provisioned_product(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn create_portfolio_share(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let accept_language = input.get_optional_string("accept_language")?;
    ...
    async fn read_portfolio_share(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_portfolio_share(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn create_product_view(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_product_view(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn update_product_view(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_product_view(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn create_copy_product_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_copy_product_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_copy_product_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
    ...
    async fn create_provisioned_product_properties(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let provisioned_product_properties =
                input.get_string("provisioned_product_properties")?;
            let accept_language = input.get_optional_string("accept_language")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "provisioned_product_properties",
                    provisioned_product_properties.unwrap_or_default(),
                )
                .with_field("accept_language", accept_language.unwrap_or_default())
                .with_field(
                    "provisioned_product_id",
    ...
    async fn read_provisioned_product_properties(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_catalog_client
    ...
    async fn delete_provisioned_product_properties(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_catalog_client
