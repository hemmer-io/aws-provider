//! Direct Service
//!
//! Auto-generated service module for direct

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for direct
pub struct DirectService<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> DirectService<'a> {
    ...
    /// Get bgppeer resource handler
    pub fn bgppeer(&self) -> resources::Bgppeer<'_> {
        resources::Bgppeer::new(self.provider)
    }
