...
impl<'a> Queue_limit_association<'a> {
    ...
    pub async fn create(&self, farm_id: String, queue_id: String, limit_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, farm_id: Option<String>, queue_id: Option<String>, limit_id: Option<String>) -> Result<()> {
