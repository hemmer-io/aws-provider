...
impl<'a> Queue_fleet_association<'a> {
    ...
    pub async fn create(&self, farm_id: String, fleet_id: String, queue_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, farm_id: Option<String>, fleet_id: Option<String>, queue_id: Option<String>) -> Result<()> {
