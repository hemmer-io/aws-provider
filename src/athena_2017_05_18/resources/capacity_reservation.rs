...
impl<'a> Capacity_reservation<'a> {
    ...
    pub async fn create(&self, target_dpus: i64, name: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, target_dpus: Option<i64>, name: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
