...
impl<'a> Permission<'a> {
    ...
    pub async fn create(&self, policy: Option<String>, event_bus_name: Option<String>, statement_id: Option<String>, condition: Option<String>, action: Option<String>, principal: Option<String>) -> Result<String> {
