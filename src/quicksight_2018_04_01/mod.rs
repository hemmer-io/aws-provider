//! Quicksight_2018_04_01 Service
//!
//! Auto-generated service module for quicksight_2018_04_01

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for quicksight_2018_04_01
pub struct Quicksight_2018_04_01Service<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Quicksight_2018_04_01Service<'a> {
    ...
    /// Get q_personalization_configuration resource handler
    pub fn q_personalization_configuration(&self) -> resources::Q_personalization_configuration<'_> {
        resources::Q_personalization_configuration::new(self.provider)
    }
    ...
    /// Get spice_capacity_configuration resource handler
    pub fn spice_capacity_configuration(&self) -> resources::Spice_capacity_configuration<'_> {
        resources::Spice_capacity_configuration::new(self.provider)
    }
    ...
    /// Get quick_sight_q_search_configuration resource handler
    pub fn quick_sight_q_search_configuration(&self) -> resources::Quick_sight_q_search_configuration<'_> {
        resources::Quick_sight_q_search_configuration::new(self.provider)
    }
    ...
    /// Get dashboards_qa_configuration resource handler
    pub fn dashboards_qa_configuration(&self) -> resources::Dashboards_qa_configuration<'_> {
        resources::Dashboards_qa_configuration::new(self.provider)
    }
    ...
    /// Get iam_policy_assignment resource handler
    pub fn iam_policy_assignment(&self) -> resources::Iam_policy_assignment<'_> {
        resources::Iam_policy_assignment::new(self.provider)
    }
    ...
    /// Get default_q_business_application resource handler
    pub fn default_q_business_application(&self) -> resources::Default_q_business_application<'_> {
        resources::Default_q_business_application::new(self.provider)
    }
