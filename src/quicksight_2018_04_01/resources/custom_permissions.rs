...
impl<'a> Custom_permissions<'a> {
    ...
    pub async fn create(&self, custom_permissions_name: String, tags: Option<Vec<String>>, aws_account_id: String, capabilities: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, custom_permissions_name: Option<String>, tags: Option<Vec<String>>, aws_account_id: Option<String>, capabilities: Option<String>) -> Result<()> {
