...
impl<'a> Action_connector_permissions<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, action_connector_id: Option<String>, aws_account_id: Option<String>, grant_permissions: Option<Vec<String>>, revoke_permissions: Option<Vec<String>>) -> Result<()> {
