...
impl<'a> User_custom_permission<'a> {
    ...
    pub async fn update(&self, id: &str, custom_permissions_name: Option<String>, user_name: Option<String>, namespace: Option<String>, aws_account_id: Option<String>) -> Result<()> {
