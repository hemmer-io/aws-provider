...
impl<'a> Account_settings<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, aws_account_id: Option<String>, default_namespace: Option<String>, notification_email: Option<String>, termination_protection_enabled: Option<bool>) -> Result<()> {
