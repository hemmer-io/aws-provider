...
impl<'a> Template_alias<'a> {
    ...
    pub async fn create(&self, aws_account_id: String, template_version_number: i64, alias_name: String, template_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, aws_account_id: Option<String>, template_version_number: Option<i64>, alias_name: Option<String>, template_id: Option<String>) -> Result<()> {
