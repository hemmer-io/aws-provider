...
impl<'a> Codeguru_reviewerService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "repository_association" => {
                self.plan_repository_association(current_state, desired_input)
                    .await
            }
            "recommendation_feedback" => {
                self.plan_recommendation_feedback(current_state, desired_input)
                    .await
            }
            "code_review" => self.plan_code_review(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codeguru_reviewer", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "repository_association" => self.create_repository_association(input).await,
            "recommendation_feedback" => self.create_recommendation_feedback(input).await,
            "code_review" => self.create_code_review(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codeguru_reviewer", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "repository_association" => self.read_repository_association(id).await,
            "recommendation_feedback" => self.read_recommendation_feedback(id).await,
            "code_review" => self.read_code_review(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codeguru_reviewer", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "repository_association" => self.update_repository_association(id, input).await,
            "recommendation_feedback" => self.update_recommendation_feedback(id, input).await,
            "code_review" => self.update_code_review(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codeguru_reviewer", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "repository_association" => self.delete_repository_association(id).await,
            "recommendation_feedback" => self.delete_recommendation_feedback(id).await,
            "code_review" => self.delete_code_review(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "codeguru_reviewer", resource_name
            ))),
    ...
    async fn create_repository_association(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_repository_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_repository_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_recommendation_feedback(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_recommendation_feedback(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codeguru_reviewer_client
    ...
    async fn delete_recommendation_feedback(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codeguru_reviewer_client
    ...
    async fn create_code_review(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    repository_association_arn.unwrap_or_default(),
                ))
        })
    }

    /// Read a code_review resource
    async fn read_code_review(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.codeguru_reviewer_client
    ...
    async fn update_code_review(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let client_request_token = input.get_optional_string("client_request_token")?;
            let r#type = input.get_string("type")?;
    ...
    async fn delete_code_review(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.codeguru_reviewer_client
