...
impl<'a> Voice_template<'a> {
    ...
    pub async fn create(&self, voice_template_request: String, template_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, voice_template_request: Option<String>, template_name: Option<String>) -> Result<()> {
