...
impl<'a> Sms_template<'a> {
    ...
    pub async fn create(&self, sms_template_request: String, template_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, sms_template_request: Option<String>, template_name: Option<String>) -> Result<()> {
