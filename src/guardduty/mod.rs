...
impl<'a> GuarddutyService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "findings_feedback" => {
                self.plan_findings_feedback(current_state, desired_input).await
            }
            "invitations" => {
                self.plan_invitations(current_state, desired_input).await
            }
            "publishing_destination" => {
                self.plan_publishing_destination(current_state, desired_input).await
            }
            "filter" => {
            ...
            "trusted_entity_set" => {
                self.plan_trusted_entity_set(current_state, desired_input).await
            }
            "malware_scans" => {
                self.plan_malware_scans(current_state, desired_input).await
            }
            "invitations_count" => {
            ...
            "organization_statistics" => {
                self.plan_organization_statistics(current_state, desired_input).await
            }
            "threat_intel_set" => {
                self.plan_threat_intel_set(current_state, desired_input).await
            }
            "coverage_statistics" => {
                self.plan_coverage_statistics(current_state, desired_input).await
            }
            "malware_scan_settings" => {
                self.plan_malware_scan_settings(current_state, desired_input).await
            }
            "threat_entity_set" => {
                self.plan_threat_entity_set(current_state, desired_input).await
            }
            "administrator_account" => {
                self.plan_administrator_account(current_state, desired_input).await
            }
            "remaining_free_trial_days" => {
                self.plan_remaining_free_trial_days(current_state, desired_input).await
            }
            "member_detectors" => {
                self.plan_member_detectors(current_state, desired_input).await
            }
            "findings" => {
                self.plan_findings(current_state, desired_input).await
            }
            "malware_protection_plan" => {
                self.plan_malware_protection_plan(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "findings_feedback" => {
                self.create_findings_feedback(input).await
            }
            "invitations" => {
                self.create_invitations(input).await
            }
            "publishing_destination" => {
                self.create_publishing_destination(input).await
            }
            "filter" => {
            ...
            "trusted_entity_set" => {
                self.create_trusted_entity_set(input).await
            }
            "malware_scans" => {
                self.create_malware_scans(input).await
            }
            "invitations_count" => {
            ...
            "organization_statistics" => {
                self.create_organization_statistics(input).await
            }
            "threat_intel_set" => {
                self.create_threat_intel_set(input).await
            }
            "coverage_statistics" => {
                self.create_coverage_statistics(input).await
            }
            "malware_scan_settings" => {
                self.create_malware_scan_settings(input).await
            }
            "threat_entity_set" => {
                self.create_threat_entity_set(input).await
            }
            "administrator_account" => {
                self.create_administrator_account(input).await
            }
            "remaining_free_trial_days" => {
                self.create_remaining_free_trial_days(input).await
            }
            "member_detectors" => {
                self.create_member_detectors(input).await
            }
            "findings" => {
                self.create_findings(input).await
            }
            "malware_protection_plan" => {
                self.create_malware_protection_plan(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "guardduty",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "findings_feedback" => {
                self.read_findings_feedback(id).await
            }
            "invitations" => {
                self.read_invitations(id).await
            }
            "publishing_destination" => {
                self.read_publishing_destination(id).await
            }
            "filter" => {
            ...
            "trusted_entity_set" => {
                self.read_trusted_entity_set(id).await
            }
            "malware_scans" => {
                self.read_malware_scans(id).await
            }
            "invitations_count" => {
            ...
            "organization_statistics" => {
                self.read_organization_statistics(id).await
            }
            "threat_intel_set" => {
                self.read_threat_intel_set(id).await
            }
            "coverage_statistics" => {
                self.read_coverage_statistics(id).await
            }
            "malware_scan_settings" => {
                self.read_malware_scan_settings(id).await
            }
            "threat_entity_set" => {
                self.read_threat_entity_set(id).await
            }
            "administrator_account" => {
                self.read_administrator_account(id).await
            }
            "remaining_free_trial_days" => {
                self.read_remaining_free_trial_days(id).await
            }
            "member_detectors" => {
                self.read_member_detectors(id).await
            }
            "findings" => {
                self.read_findings(id).await
            }
            "malware_protection_plan" => {
                self.read_malware_protection_plan(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "guardduty",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "findings_feedback" => {
                self.update_findings_feedback(id, input).await
            }
            "invitations" => {
                self.update_invitations(id, input).await
            }
            "publishing_destination" => {
                self.update_publishing_destination(id, input).await
            }
            "filter" => {
            ...
            "trusted_entity_set" => {
                self.update_trusted_entity_set(id, input).await
            }
            "malware_scans" => {
                self.update_malware_scans(id, input).await
            }
            "invitations_count" => {
            ...
            "organization_statistics" => {
                self.update_organization_statistics(id, input).await
            }
            "threat_intel_set" => {
                self.update_threat_intel_set(id, input).await
            }
            "coverage_statistics" => {
                self.update_coverage_statistics(id, input).await
            }
            "malware_scan_settings" => {
                self.update_malware_scan_settings(id, input).await
            }
            "threat_entity_set" => {
                self.update_threat_entity_set(id, input).await
            }
            "administrator_account" => {
                self.update_administrator_account(id, input).await
            }
            "remaining_free_trial_days" => {
                self.update_remaining_free_trial_days(id, input).await
            }
            "member_detectors" => {
                self.update_member_detectors(id, input).await
            }
            "findings" => {
                self.update_findings(id, input).await
            }
            "malware_protection_plan" => {
                self.update_malware_protection_plan(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "guardduty",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "findings_feedback" => {
                self.delete_findings_feedback(id).await
            }
            "invitations" => {
                self.delete_invitations(id).await
            }
            "publishing_destination" => {
                self.delete_publishing_destination(id).await
            }
            "filter" => {
            ...
            "trusted_entity_set" => {
                self.delete_trusted_entity_set(id).await
            }
            "malware_scans" => {
                self.delete_malware_scans(id).await
            }
            "invitations_count" => {
            ...
            "organization_statistics" => {
                self.delete_organization_statistics(id).await
            }
            "threat_intel_set" => {
                self.delete_threat_intel_set(id).await
            }
            "coverage_statistics" => {
                self.delete_coverage_statistics(id).await
            }
            "malware_scan_settings" => {
                self.delete_malware_scan_settings(id).await
            }
            "threat_entity_set" => {
                self.delete_threat_entity_set(id).await
            }
            "administrator_account" => {
                self.delete_administrator_account(id).await
            }
            "remaining_free_trial_days" => {
                self.delete_remaining_free_trial_days(id).await
            }
            "member_detectors" => {
                self.delete_member_detectors(id).await
            }
            "findings" => {
                self.delete_findings(id).await
            }
            "malware_protection_plan" => {
                self.delete_malware_protection_plan(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "guardduty",
    ...
    async fn create_findings_feedback(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_findings_feedback(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_findings_feedback(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_publishing_destination(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("destination_properties", destination_properties.unwrap_or_default())
    ...
    async fn read_publishing_destination(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_trusted_entity_set(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_trusted_entity_set(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_trusted_entity_set(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_organization_statistics(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_organization_statistics(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_organization_statistics(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_threat_intel_set(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_coverage_statistics(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_coverage_statistics(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_coverage_statistics(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_malware_scan_settings(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let ebs_snapshot_preservation = input.get_optional_string("ebs_snapshot_preservation")?;
            let detector_id = input.get_string("detector_id")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("ebs_snapshot_preservation", ebs_snapshot_preservation.unwrap_or_default())
                .with_field("detector_id", detector_id.unwrap_or_default())
                .with_field("scan_resource_criteria", scan_resource_criteria.unwrap_or_default())
            )
        })
    }

    /// Read a malware_scan_settings resource
    async fn read_malware_scan_settings(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_malware_scan_settings(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_threat_entity_set(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_threat_entity_set(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_threat_entity_set(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_remaining_free_trial_days(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_remaining_free_trial_days(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_member_detectors(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_member_detectors(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_member_detectors(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_malware_protection_plan(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_malware_protection_plan(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_malware_protection_plan(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
