...
impl<'a> Publishing_destination<'a> {
    ...
    pub async fn create(&self, destination_properties: String, detector_id: String, destination_type: String, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, destination_properties: Option<String>, detector_id: Option<String>, destination_type: Option<String>, client_token: Option<String>) -> Result<()> {
