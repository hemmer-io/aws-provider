...
impl<'a> Publishing_destination<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, destination_type: String, destination_properties: String, detector_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, destination_type: Option<String>, destination_properties: Option<String>, detector_id: Option<String>) -> Result<()> {
