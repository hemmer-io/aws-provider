...
impl<'a> Organization_configuration<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, detector_id: Option<String>, auto_enable: Option<bool>, data_sources: Option<String>, auto_enable_organization_members: Option<String>, features: Option<Vec<String>>) -> Result<()> {
