...
impl<'a> Resource_groupsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "group_configuration" => {
                self.plan_group_configuration(current_state, desired_input)
                    .await
            }
            "tag_sync_task" => self.plan_tag_sync_task(current_state, desired_input).await,
            "group_query" => self.plan_group_query(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "group_configuration" => self.create_group_configuration(input).await,
            "tag_sync_task" => self.create_tag_sync_task(input).await,
            "group_query" => self.create_group_query(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "group_configuration" => self.read_group_configuration(id).await,
            "tag_sync_task" => self.read_tag_sync_task(id).await,
            "group_query" => self.read_group_query(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "group_configuration" => self.update_group_configuration(id, input).await,
            "tag_sync_task" => self.update_tag_sync_task(id, input).await,
            "group_query" => self.update_group_query(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "group_configuration" => self.delete_group_configuration(id).await,
            "tag_sync_task" => self.delete_tag_sync_task(id).await,
            "group_query" => self.delete_group_query(id).await,
    ...
    async fn create_group_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_group_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_group_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_tag_sync_task(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_tag_sync_task(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.resource_groups_client
    ...
    async fn update_tag_sync_task(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_tag_sync_task(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.resource_groups_client
    ...
    async fn create_group_query(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_group_query(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.resource_groups_client
    ...
    async fn update_group_query(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let group_name = input.get_optional_string("group_name")?;
            let group = input.get_optional_string("group")?;
    ...
    async fn delete_group_query(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.resource_groups_client
    ...
    async fn create_account_settings(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let group_lifecycle_events_desired_status =
                input.get_optional_string("group_lifecycle_events_desired_status")?;
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                ...
                group_lifecycle_events_desired_status.unwrap_or_default(),
            ))
        })
    }
