...
impl<'a> Medical_vocabulary<'a> {
    ...
    pub async fn create(&self, vocabulary_file_uri: String, tags: Option<Vec<String>>, vocabulary_name: String, language_code: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, vocabulary_file_uri: Option<String>, tags: Option<Vec<String>>, vocabulary_name: Option<String>, language_code: Option<String>) -> Result<()> {
