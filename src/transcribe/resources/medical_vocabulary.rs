...
impl<'a> Medical_vocabulary<'a> {
    ...
    pub async fn create(&self, language_code: String, vocabulary_file_uri: String, vocabulary_name: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, language_code: Option<String>, vocabulary_file_uri: Option<String>, vocabulary_name: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
