...
impl<'a> Call_analytics_category<'a> {
    ...
    pub async fn create(&self, input_type: Option<String>, rules: Vec<String>, tags: Option<Vec<String>>, category_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, input_type: Option<String>, rules: Option<Vec<String>>, tags: Option<Vec<String>>, category_name: Option<String>) -> Result<()> {
