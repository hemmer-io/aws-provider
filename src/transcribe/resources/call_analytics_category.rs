...
impl<'a> Call_analytics_category<'a> {
    ...
    pub async fn create(&self, rules: Vec<String>, tags: Option<Vec<String>>, category_name: String, input_type: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, rules: Option<Vec<String>>, tags: Option<Vec<String>>, category_name: Option<String>, input_type: Option<String>) -> Result<()> {
