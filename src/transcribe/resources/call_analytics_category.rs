...
impl<'a> Call_analytics_category<'a> {
    ...
    pub async fn create(&self, category_name: String, tags: Option<Vec<String>>, rules: Vec<String>, input_type: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, category_name: Option<String>, tags: Option<Vec<String>>, rules: Option<Vec<String>>, input_type: Option<String>) -> Result<()> {
