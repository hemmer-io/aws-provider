...
impl<'a> KinesisService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "media_for_fragment_list" => {
                self.plan_media_for_fragment_list(current_state, desired_input)
                    .await
            }
            "dash_streaming_session_url" => {
                self.plan_dash_streaming_session_url(current_state, desired_input)
                    .await
            }
            "clip" => self.plan_clip(current_state, desired_input).await,
            "hls_streaming_session_url" => {
                self.plan_hls_streaming_session_url(current_state, desired_input)
                    .await
            }
            ...
            "mapped_resource_configuration" => {
                self.plan_mapped_resource_configuration(current_state, desired_input)
                    .await
            }
            "signaling_channel" => {
                self.plan_signaling_channel(current_state, desired_input)
                    .await
            }
            ...
            "image_generation_configuration" => {
                self.plan_image_generation_configuration(current_state, desired_input)
                    .await
            }
            "data_endpoint" => self.plan_data_endpoint(current_state, desired_input).await,
            "edge_configuration" => {
                self.plan_edge_configuration(current_state, desired_input)
                    .await
            }
            "media_storage_configuration" => {
                self.plan_media_storage_configuration(current_state, desired_input)
                    .await
            }
            "data_retention" => self.plan_data_retention(current_state, desired_input).await,
            "stream" => self.plan_stream(current_state, desired_input).await,
            "signaling_channel_endpoint" => {
                self.plan_signaling_channel_endpoint(current_state, desired_input)
                    .await
            }
            "max_record_size" => {
                self.plan_max_record_size(current_state, desired_input)
                    .await
            }
            "stream_summary" => self.plan_stream_summary(current_state, desired_input).await,
            "limits" => self.plan_limits(current_state, desired_input).await,
            "shard_iterator" => self.plan_shard_iterator(current_state, desired_input).await,
            "records" => self.plan_records(current_state, desired_input).await,
            "shard_count" => self.plan_shard_count(current_state, desired_input).await,
            "stream_mode" => self.plan_stream_mode(current_state, desired_input).await,
            "record" => self.plan_record(current_state, desired_input).await,
            "stream_consumer" => {
                self.plan_stream_consumer(current_state, desired_input)
                    .await
            }
            "resource_policy" => {
            ...
            "stream" => self.plan_stream(current_state, desired_input).await,
            "ice_server_config" => {
                self.plan_ice_server_config(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "kinesis", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "media_for_fragment_list" => self.create_media_for_fragment_list(input).await,
            "dash_streaming_session_url" => self.create_dash_streaming_session_url(input).await,
            "clip" => self.create_clip(input).await,
            "hls_streaming_session_url" => self.create_hls_streaming_session_url(input).await,
            ...
            "signaling_channel" => self.create_signaling_channel(input).await,
            ...
            "data_endpoint" => self.create_data_endpoint(input).await,
            "edge_configuration" => self.create_edge_configuration(input).await,
            "media_storage_configuration" => self.create_media_storage_configuration(input).await,
            "data_retention" => self.create_data_retention(input).await,
            "stream" => self.create_stream(input).await,
            "signaling_channel_endpoint" => self.create_signaling_channel_endpoint(input).await,
            "max_record_size" => self.create_max_record_size(input).await,
            "stream_summary" => self.create_stream_summary(input).await,
            "limits" => self.create_limits(input).await,
            "shard_iterator" => self.create_shard_iterator(input).await,
            "records" => self.create_records(input).await,
            "shard_count" => self.create_shard_count(input).await,
            "stream_mode" => self.create_stream_mode(input).await,
            "record" => self.create_record(input).await,
            "stream_consumer" => self.create_stream_consumer(input).await,
            "resource_policy" => self.create_resource_policy(input).await,
            "stream" => self.create_stream(input).await,
            "ice_server_config" => self.create_ice_server_config(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "kinesis", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "media_for_fragment_list" => self.read_media_for_fragment_list(id).await,
            "dash_streaming_session_url" => self.read_dash_streaming_session_url(id).await,
            "clip" => self.read_clip(id).await,
            "hls_streaming_session_url" => self.read_hls_streaming_session_url(id).await,
            "images" => self.read_images(id).await,
            "media" => self.read_media(id).await,
            "mapped_resource_configuration" => self.read_mapped_resource_configuration(id).await,
            "signaling_channel" => self.read_signaling_channel(id).await,
            "notification_configuration" => self.read_notification_configuration(id).await,
            "image_generation_configuration" => self.read_image_generation_configuration(id).await,
            "data_endpoint" => self.read_data_endpoint(id).await,
            "edge_configuration" => self.read_edge_configuration(id).await,
            "media_storage_configuration" => self.read_media_storage_configuration(id).await,
            "data_retention" => self.read_data_retention(id).await,
            "stream" => self.read_stream(id).await,
            "signaling_channel_endpoint" => self.read_signaling_channel_endpoint(id).await,
            "max_record_size" => self.read_max_record_size(id).await,
            "stream_summary" => self.read_stream_summary(id).await,
            "limits" => self.read_limits(id).await,
            "shard_iterator" => self.read_shard_iterator(id).await,
            "records" => self.read_records(id).await,
            "shard_count" => self.read_shard_count(id).await,
            "stream_mode" => self.read_stream_mode(id).await,
            "record" => self.read_record(id).await,
            "stream_consumer" => self.read_stream_consumer(id).await,
            "resource_policy" => self.read_resource_policy(id).await,
            "stream" => self.read_stream(id).await,
            "ice_server_config" => self.read_ice_server_config(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "kinesis", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "media_for_fragment_list" => self.update_media_for_fragment_list(id, input).await,
            "dash_streaming_session_url" => self.update_dash_streaming_session_url(id, input).await,
            "clip" => self.update_clip(id, input).await,
            "hls_streaming_session_url" => self.update_hls_streaming_session_url(id, input).await,
            ...
            "signaling_channel" => self.update_signaling_channel(id, input).await,
            ...
            "data_endpoint" => self.update_data_endpoint(id, input).await,
            "edge_configuration" => self.update_edge_configuration(id, input).await,
            "media_storage_configuration" => {
                self.update_media_storage_configuration(id, input).await
            }
            "data_retention" => self.update_data_retention(id, input).await,
            "stream" => self.update_stream(id, input).await,
            "signaling_channel_endpoint" => self.update_signaling_channel_endpoint(id, input).await,
            "max_record_size" => self.update_max_record_size(id, input).await,
            "stream_summary" => self.update_stream_summary(id, input).await,
            "limits" => self.update_limits(id, input).await,
            "shard_iterator" => self.update_shard_iterator(id, input).await,
            "records" => self.update_records(id, input).await,
            "shard_count" => self.update_shard_count(id, input).await,
            "stream_mode" => self.update_stream_mode(id, input).await,
            "record" => self.update_record(id, input).await,
            "stream_consumer" => self.update_stream_consumer(id, input).await,
            "resource_policy" => self.update_resource_policy(id, input).await,
            "stream" => self.update_stream(id, input).await,
            "ice_server_config" => self.update_ice_server_config(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "kinesis", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "media_for_fragment_list" => self.delete_media_for_fragment_list(id).await,
            "dash_streaming_session_url" => self.delete_dash_streaming_session_url(id).await,
            "clip" => self.delete_clip(id).await,
            "hls_streaming_session_url" => self.delete_hls_streaming_session_url(id).await,
            "images" => self.delete_images(id).await,
            "media" => self.delete_media(id).await,
            "mapped_resource_configuration" => self.delete_mapped_resource_configuration(id).await,
            "signaling_channel" => self.delete_signaling_channel(id).await,
            ...
            "data_endpoint" => self.delete_data_endpoint(id).await,
            "edge_configuration" => self.delete_edge_configuration(id).await,
            "media_storage_configuration" => self.delete_media_storage_configuration(id).await,
            "data_retention" => self.delete_data_retention(id).await,
            "stream" => self.delete_stream(id).await,
            "signaling_channel_endpoint" => self.delete_signaling_channel_endpoint(id).await,
            "max_record_size" => self.delete_max_record_size(id).await,
            "stream_summary" => self.delete_stream_summary(id).await,
            "limits" => self.delete_limits(id).await,
            "shard_iterator" => self.delete_shard_iterator(id).await,
            "records" => self.delete_records(id).await,
            "shard_count" => self.delete_shard_count(id).await,
            "stream_mode" => self.delete_stream_mode(id).await,
            "record" => self.delete_record(id).await,
            "stream_consumer" => self.delete_stream_consumer(id).await,
            "resource_policy" => self.delete_resource_policy(id).await,
            "stream" => self.delete_stream(id).await,
            "ice_server_config" => self.delete_ice_server_config(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "kinesis", resource_name
            ))),
    ...
    async fn create_media_for_fragment_list(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_media_for_fragment_list(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_media_for_fragment_list(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_dash_streaming_session_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_dash_streaming_session_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_clip(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_clip(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn update_clip(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_hls_streaming_session_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_hls_streaming_session_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn read_mapped_resource_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_mapped_resource_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_signaling_channel(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let single_master_configuration =
                input.get_optional_string("single_master_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    single_master_configuration.unwrap_or_default(),
                ))
        })
    }

    /// Read a signaling_channel resource
    async fn read_signaling_channel(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_signaling_channel(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_image_generation_configuration(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let stream_name = input.get_optional_string("stream_name")?;
            let image_generation_configuration =
                input.get_optional_string("image_generation_configuration")?;
            let stream_arn = input.get_optional_string("stream_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "image_generation_configuration",
                    image_generation_configuration.unwrap_or_default(),
                )
                .with_field("stream_arn", stream_arn.unwrap_or_default()))
        })
    }
    ...
    async fn read_image_generation_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_image_generation_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_data_endpoint(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_data_endpoint(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn update_data_endpoint(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_data_endpoint(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_edge_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_edge_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_edge_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_media_storage_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "media_storage_configuration",
                    media_storage_configuration.unwrap_or_default(),
                )
    ...
    async fn read_media_storage_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_media_storage_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_data_retention(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let current_version = input.get_string("current_version")?;
            let operation = input.get_string("operation")?;
            let data_retention_change_in_hours =
                input.get_string("data_retention_change_in_hours")?;
            let stream_name = input.get_optional_string("stream_name")?;
            let stream_arn = input.get_optional_string("stream_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    data_retention_change_in_hours.unwrap_or_default(),
                )
                .with_field("stream_name", stream_name.unwrap_or_default())
                .with_field("stream_arn", stream_arn.unwrap_or_default()))
        })
    ...
    async fn read_data_retention(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_data_retention(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    data_retention_in_hours.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default()))
        })
    }
    ...
    async fn read_signaling_channel_endpoint(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_signaling_channel_endpoint(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_max_record_size(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let stream_arn = input.get_optional_string("stream_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    max_record_size_in_ki_b.unwrap_or_default(),
                ))
        })
    }

    /// Read a max_record_size resource
    async fn read_max_record_size(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_max_record_size(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_stream_summary(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_stream_summary(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_stream_summary(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_limits(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_limits(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn update_limits(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_limits(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_shard_iterator(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_shard_iterator(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_shard_iterator(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_records(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let stream_name = input.get_optional_string("stream_name")?;
    ...
    async fn read_records(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn update_records(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let stream_name = input.get_optional_string("stream_name")?;
            let stream_arn = input.get_optional_string("stream_arn")?;
    ...
    async fn delete_records(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_shard_count(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let stream_arn = input.get_optional_string("stream_arn")?;
    ...
    async fn read_shard_count(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn update_shard_count(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let stream_arn = input.get_optional_string("stream_arn")?;
            let target_shard_count = input.get_string("target_shard_count")?;
    ...
    async fn delete_shard_count(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_stream_mode(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "stream_mode_details",
                    stream_mode_details.unwrap_or_default(),
                ))
        })
    }

    /// Read a stream_mode resource
    async fn read_stream_mode(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn update_stream_mode(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let stream_arn = input.get_string("stream_arn")?;
            let stream_mode_details = input.get_string("stream_mode_details")?;
    ...
    async fn delete_stream_mode(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_record(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let sequence_number_for_ordering =
                input.get_optional_string("sequence_number_for_ordering")?;
            let stream_arn = input.get_optional_string("stream_arn")?;
            let stream_name = input.get_optional_string("stream_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    sequence_number_for_ordering.unwrap_or_default(),
                )
                .with_field("stream_arn", stream_arn.unwrap_or_default())
                .with_field("stream_name", stream_name.unwrap_or_default())
    ...
    async fn create_stream_consumer(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_stream_consumer(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_stream_consumer(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
    ...
    async fn create_ice_server_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_ice_server_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.kinesis_client
    ...
    async fn delete_ice_server_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.kinesis_client
