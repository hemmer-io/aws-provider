...
impl<'a> Data_retention<'a> {
    ...
    pub async fn update(&self, id: &str, current_version: Option<String>, operation: Option<String>, data_retention_change_in_hours: Option<i64>, stream_name: Option<String>, stream_arn: Option<String>) -> Result<()> {
