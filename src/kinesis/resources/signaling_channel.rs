...
impl<'a> Signaling_channel<'a> {
    ...
    pub async fn create(&self, single_master_configuration: Option<String>, channel_name: String, tags: Option<Vec<String>>, channel_type: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, single_master_configuration: Option<String>, channel_name: Option<String>, tags: Option<Vec<String>>, channel_type: Option<String>) -> Result<()> {
