...
impl<'a> Signaling_channel<'a> {
    ...
    pub async fn create(&self, channel_type: Option<String>, channel_name: String, single_master_configuration: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, channel_type: Option<String>, channel_name: Option<String>, single_master_configuration: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
