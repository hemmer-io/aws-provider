...
impl<'a> Signaling_channel<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, channel_type: Option<String>, channel_name: String, single_master_configuration: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, channel_type: Option<String>, channel_name: Option<String>, single_master_configuration: Option<String>) -> Result<()> {
