...
impl<'a> Signaling_channel<'a> {
    ...
    pub async fn create(&self, channel_name: String, channel_type: Option<String>, tags: Option<Vec<String>>, single_master_configuration: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, channel_name: Option<String>, channel_type: Option<String>, tags: Option<Vec<String>>, single_master_configuration: Option<String>) -> Result<()> {
