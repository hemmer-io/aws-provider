...
impl<'a> Assessment_target<'a> {
    ...
    pub async fn create(&self, resource_group_arn: Option<String>, assessment_target_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, resource_group_arn: Option<String>, assessment_target_name: Option<String>) -> Result<()> {
