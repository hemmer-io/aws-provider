...
impl<'a> Assessment_template<'a> {
    ...
    pub async fn create(&self, rules_package_arns: Vec<String>, user_attributes_for_findings: Option<Vec<String>>, assessment_template_name: String, duration_in_seconds: i64, assessment_target_arn: String) -> Result<String> {
