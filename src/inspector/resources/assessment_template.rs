...
impl<'a> Assessment_template<'a> {
    ...
    pub async fn create(&self, assessment_target_arn: String, rules_package_arns: Vec<String>, assessment_template_name: String, duration_in_seconds: i64, user_attributes_for_findings: Option<Vec<String>>) -> Result<String> {
