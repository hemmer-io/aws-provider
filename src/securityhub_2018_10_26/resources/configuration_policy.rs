...
impl<'a> Configuration_policy<'a> {
    ...
    pub async fn create(&self, description: Option<String>, configuration_policy: String, tags: Option<HashMap<String, String>>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, configuration_policy: Option<String>, tags: Option<HashMap<String, String>>, name: Option<String>) -> Result<()> {
