...
impl<'a> Campaign_outbound_call_config<'a> {
    ...
    pub async fn update(&self, id: &str, id: Option<String>, connect_contact_flow_id: Option<String>, connect_source_phone_number: Option<String>, answer_machine_detection_config: Option<String>) -> Result<()> {
