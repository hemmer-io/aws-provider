...
impl<'a> Campaign<'a> {
    ...
    pub async fn create(&self, connect_instance_id: String, outbound_call_config: String, name: String, dialer_config: String, tags: Option<HashMap<String, String>>) -> Result<String> {
