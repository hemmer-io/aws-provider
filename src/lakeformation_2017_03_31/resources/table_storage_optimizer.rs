...
impl<'a> Table_storage_optimizer<'a> {
    ...
    pub async fn update(&self, id: &str, catalog_id: Option<String>, table_name: Option<String>, database_name: Option<String>, storage_optimizer_config: Option<HashMap<String, HashMap<String, String>>>) -> Result<()> {
