...
impl<'a> Table_objects<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, database_name: Option<String>, table_name: Option<String>, catalog_id: Option<String>, transaction_id: Option<String>, write_operations: Option<Vec<String>>) -> Result<()> {
