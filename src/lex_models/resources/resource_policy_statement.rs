...
impl<'a> Resource_policy_statement<'a> {
    ...
    pub async fn create(&self, action: Vec<String>, effect: String, principal: Vec<String>, resource_arn: String, condition: Option<HashMap<String, HashMap<String, String>>>, expected_revision_id: Option<String>, statement_id: String) -> Result<String> {
