...
impl<'a> Resource_policy_statement<'a> {
    ...
    pub async fn create(&self, resource_arn: String, principal: Vec<String>, statement_id: String, effect: String, action: Vec<String>, expected_revision_id: Option<String>, condition: Option<HashMap<String, HashMap<String, String>>>) -> Result<String> {
