...
impl<'a> Bot_recommendation<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, bot_version: Option<String>, locale_id: Option<String>, bot_id: Option<String>, bot_recommendation_id: Option<String>, encryption_setting: Option<String>) -> Result<()> {
