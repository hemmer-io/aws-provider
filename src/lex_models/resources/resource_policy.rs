...
impl<'a> Resource_policy<'a> {
    ...
    pub async fn create(&self, policy: String, resource_arn: String) -> Result<String> {
    ...
    /// Update a resource_policy
    ///
    /// TODO: Map `id` and update fields to appropriate SDK parameters
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, policy: Option<String>, resource_arn: Option<String>) -> Result<()> {
