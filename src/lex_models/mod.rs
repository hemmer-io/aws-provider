...
impl<'a> Lex_modelsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "bot_recommendation" => {
                self.plan_bot_recommendation(current_state, desired_input).await
            }
            "bot_replica" => {
                self.plan_bot_replica(current_state, desired_input).await
            }
            "resource_policy" => {
                self.plan_resource_policy(current_state, desired_input).await
            }
            "utterances" => {
                self.plan_utterances(current_state, desired_input).await
            }
            "test_set" => {
                self.plan_test_set(current_state, desired_input).await
            }
            "test_set_discrepancy_report" => {
                self.plan_test_set_discrepancy_report(current_state, desired_input).await
            }
            "import" => {
                self.plan_import(current_state, desired_input).await
            }
            "custom_vocabulary_metadata" => {
                self.plan_custom_vocabulary_metadata(current_state, desired_input).await
            }
            "resource_policy_statement" => {
                self.plan_resource_policy_statement(current_state, desired_input).await
            }
            "test_set_generation" => {
                self.plan_test_set_generation(current_state, desired_input).await
            }
            "bot_version" => {
                self.plan_bot_version(current_state, desired_input).await
            }
            "test_execution_artifacts_url" => {
                self.plan_test_execution_artifacts_url(current_state, desired_input).await
            }
            "upload_url" => {
                self.plan_upload_url(current_state, desired_input).await
            }
            "bot_alias" => {
                self.plan_bot_alias(current_state, desired_input).await
            }
            "test_execution" => {
                self.plan_test_execution(current_state, desired_input).await
            }
            "intent" => {
                self.plan_intent(current_state, desired_input).await
            }
            "bot_locale" => {
                self.plan_bot_locale(current_state, desired_input).await
            }
            "export" => {
                self.plan_export(current_state, desired_input).await
            }
            "bot_resource_generation" => {
                self.plan_bot_resource_generation(current_state, desired_input).await
            }
            "slot_type" => {
                self.plan_slot_type(current_state, desired_input).await
            }
            "custom_vocabulary" => {
                self.plan_custom_vocabulary(current_state, desired_input).await
            }
            "slot" => {
                self.plan_slot(current_state, desired_input).await
            }
            "bot" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "bot_recommendation" => {
                self.create_bot_recommendation(input).await
            }
            "bot_replica" => {
                self.create_bot_replica(input).await
            }
            "resource_policy" => {
                self.create_resource_policy(input).await
            }
            "utterances" => {
                self.create_utterances(input).await
            }
            "test_set" => {
                self.create_test_set(input).await
            }
            "test_set_discrepancy_report" => {
                self.create_test_set_discrepancy_report(input).await
            }
            "import" => {
                self.create_import(input).await
            }
            "custom_vocabulary_metadata" => {
                self.create_custom_vocabulary_metadata(input).await
            }
            "resource_policy_statement" => {
                self.create_resource_policy_statement(input).await
            }
            "test_set_generation" => {
                self.create_test_set_generation(input).await
            }
            "bot_version" => {
                self.create_bot_version(input).await
            }
            "test_execution_artifacts_url" => {
                self.create_test_execution_artifacts_url(input).await
            }
            "upload_url" => {
                self.create_upload_url(input).await
            }
            "bot_alias" => {
                self.create_bot_alias(input).await
            }
            "test_execution" => {
                self.create_test_execution(input).await
            }
            "intent" => {
                self.create_intent(input).await
            }
            "bot_locale" => {
                self.create_bot_locale(input).await
            }
            "export" => {
                self.create_export(input).await
            }
            "bot_resource_generation" => {
                self.create_bot_resource_generation(input).await
            }
            "slot_type" => {
                self.create_slot_type(input).await
            }
            "custom_vocabulary" => {
                self.create_custom_vocabulary(input).await
            }
            "slot" => {
                self.create_slot(input).await
            }
            "bot" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "bot_recommendation" => {
                self.read_bot_recommendation(id).await
            }
            "bot_replica" => {
                self.read_bot_replica(id).await
            }
            "resource_policy" => {
                self.read_resource_policy(id).await
            }
            "utterances" => {
                self.read_utterances(id).await
            }
            "test_set" => {
                self.read_test_set(id).await
            }
            "test_set_discrepancy_report" => {
                self.read_test_set_discrepancy_report(id).await
            }
            "import" => {
                self.read_import(id).await
            }
            "custom_vocabulary_metadata" => {
                self.read_custom_vocabulary_metadata(id).await
            }
            "resource_policy_statement" => {
                self.read_resource_policy_statement(id).await
            }
            "test_set_generation" => {
                self.read_test_set_generation(id).await
            }
            "bot_version" => {
                self.read_bot_version(id).await
            }
            "test_execution_artifacts_url" => {
                self.read_test_execution_artifacts_url(id).await
            }
            "upload_url" => {
                self.read_upload_url(id).await
            }
            "bot_alias" => {
                self.read_bot_alias(id).await
            }
            "test_execution" => {
                self.read_test_execution(id).await
            }
            "intent" => {
                self.read_intent(id).await
            }
            "bot_locale" => {
                self.read_bot_locale(id).await
            }
            "export" => {
                self.read_export(id).await
            }
            "bot_resource_generation" => {
                self.read_bot_resource_generation(id).await
            }
            "slot_type" => {
                self.read_slot_type(id).await
            }
            "custom_vocabulary" => {
                self.read_custom_vocabulary(id).await
            }
            "slot" => {
                self.read_slot(id).await
            }
            "bot" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "bot_recommendation" => {
                self.update_bot_recommendation(id, input).await
            }
            "bot_replica" => {
                self.update_bot_replica(id, input).await
            }
            "resource_policy" => {
                self.update_resource_policy(id, input).await
            }
            "utterances" => {
                self.update_utterances(id, input).await
            }
            "test_set" => {
                self.update_test_set(id, input).await
            }
            "test_set_discrepancy_report" => {
            ...
            "custom_vocabulary_metadata" => {
                self.update_custom_vocabulary_metadata(id, input).await
            }
            "resource_policy_statement" => {
                self.update_resource_policy_statement(id, input).await
            }
            "test_set_generation" => {
                self.update_test_set_generation(id, input).await
            }
            "bot_version" => {
                self.update_bot_version(id, input).await
            }
            "test_execution_artifacts_url" => {
            ...
            "bot_alias" => {
                self.update_bot_alias(id, input).await
            }
            "test_execution" => {
                self.update_test_execution(id, input).await
            }
            "intent" => {
                self.update_intent(id, input).await
            }
            "bot_locale" => {
                self.update_bot_locale(id, input).await
            }
            "export" => {
                self.update_export(id, input).await
            }
            "bot_resource_generation" => {
                self.update_bot_resource_generation(id, input).await
            }
            "slot_type" => {
                self.update_slot_type(id, input).await
            }
            "custom_vocabulary" => {
                self.update_custom_vocabulary(id, input).await
            }
            "slot" => {
                self.update_slot(id, input).await
            }
            "bot" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "bot_recommendation" => {
                self.delete_bot_recommendation(id).await
            }
            "bot_replica" => {
                self.delete_bot_replica(id).await
            }
            "resource_policy" => {
                self.delete_resource_policy(id).await
            }
            "utterances" => {
                self.delete_utterances(id).await
            }
            "test_set" => {
                self.delete_test_set(id).await
            }
            "test_set_discrepancy_report" => {
                self.delete_test_set_discrepancy_report(id).await
            }
            "import" => {
                self.delete_import(id).await
            }
            "custom_vocabulary_metadata" => {
                self.delete_custom_vocabulary_metadata(id).await
            }
            "resource_policy_statement" => {
                self.delete_resource_policy_statement(id).await
            }
            "test_set_generation" => {
                self.delete_test_set_generation(id).await
            }
            "bot_version" => {
                self.delete_bot_version(id).await
            }
            "test_execution_artifacts_url" => {
                self.delete_test_execution_artifacts_url(id).await
            }
            "upload_url" => {
                self.delete_upload_url(id).await
            }
            "bot_alias" => {
                self.delete_bot_alias(id).await
            }
            "test_execution" => {
                self.delete_test_execution(id).await
            }
            "intent" => {
                self.delete_intent(id).await
            }
            "bot_locale" => {
                self.delete_bot_locale(id).await
            }
            "export" => {
                self.delete_export(id).await
            }
            "bot_resource_generation" => {
                self.delete_bot_resource_generation(id).await
            }
            "slot_type" => {
                self.delete_slot_type(id).await
            }
            "custom_vocabulary" => {
                self.delete_custom_vocabulary(id).await
            }
            "slot" => {
                self.delete_slot(id).await
            }
            "bot" => {
    ...
    async fn create_bot_recommendation(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("bot_recommendation_id", bot_recommendation_id.unwrap_or_default())
    ...
    async fn read_bot_recommendation(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_bot_recommendation(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_test_set_discrepancy_report(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_test_set_discrepancy_report(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_custom_vocabulary_metadata(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_custom_vocabulary_metadata(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_resource_policy_statement(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resource_policy_statement(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_test_set_generation(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_test_set_generation(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_test_set_generation(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_bot_version(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let bot_id = input.get_string("bot_id")?;
            let bot_version_locale_specification = input.get_string("bot_version_locale_specification")?;
            let description = input.get_optional_string("description")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("bot_id", bot_id.unwrap_or_default())
                .with_field("bot_version_locale_specification", bot_version_locale_specification.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
            )
        })
    }
    ...
    async fn read_test_execution_artifacts_url(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_test_execution_artifacts_url(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_bot_alias(
        ...
        self.provider.runtime().block_on(async {
            ...
            let bot_id = input.get_string("bot_id")?;
            let bot_alias_locale_settings = input.get_optional_string("bot_alias_locale_settings")?;
            let bot_alias_name = input.get_string("bot_alias_name")?;
            let conversation_log_settings = input.get_optional_string("conversation_log_settings")?;
            let sentiment_analysis_settings = input.get_optional_string("sentiment_analysis_settings")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("bot_version", bot_version.unwrap_or_default())
                .with_field("bot_id", bot_id.unwrap_or_default())
                .with_field("bot_alias_locale_settings", bot_alias_locale_settings.unwrap_or_default())
                .with_field("bot_alias_name", bot_alias_name.unwrap_or_default())
                .with_field("conversation_log_settings", conversation_log_settings.unwrap_or_default())
                .with_field("sentiment_analysis_settings", sentiment_analysis_settings.unwrap_or_default())
    ...
    async fn create_intent(
        ...
        self.provider.runtime().block_on(async {
            ...
            let q_in_connect_intent_configuration = input.get_optional_string("q_in_connect_intent_configuration")?;
            ...
            let qn_a_intent_configuration = input.get_optional_string("qn_a_intent_configuration")?;
            let description = input.get_optional_string("description")?;
            let output_contexts = input.get_optional_string("output_contexts")?;
            let bot_id = input.get_string("bot_id")?;
            let intent_confirmation_setting = input.get_optional_string("intent_confirmation_setting")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("fulfillment_code_hook", fulfillment_code_hook.unwrap_or_default())
                .with_field("intent_closing_setting", intent_closing_setting.unwrap_or_default())
                .with_field("q_in_connect_intent_configuration", q_in_connect_intent_configuration.unwrap_or_default())
                ...
                .with_field("parent_intent_signature", parent_intent_signature.unwrap_or_default())
                .with_field("qn_a_intent_configuration", qn_a_intent_configuration.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field("output_contexts", output_contexts.unwrap_or_default())
                .with_field("bot_id", bot_id.unwrap_or_default())
                .with_field("intent_confirmation_setting", intent_confirmation_setting.unwrap_or_default())
                .with_field("kendra_configuration", kendra_configuration.unwrap_or_default())
                .with_field("initial_response_setting", initial_response_setting.unwrap_or_default())
            )
        })
    }
    ...
    async fn create_bot_locale(
        ...
        self.provider.runtime().block_on(async {
            ...
            let nlu_intent_confidence_threshold = input.get_string("nlu_intent_confidence_threshold")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("bot_id", bot_id.unwrap_or_default())
                .with_field("locale_id", locale_id.unwrap_or_default())
                .with_field("generative_ai_settings", generative_ai_settings.unwrap_or_default())
                .with_field("voice_settings", voice_settings.unwrap_or_default())
                .with_field("nlu_intent_confidence_threshold", nlu_intent_confidence_threshold.unwrap_or_default())
            )
        })
    }

    /// Read a bot_locale resource
    async fn read_bot_locale(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_export(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("resource_specification", resource_specification.unwrap_or_default())
    ...
    async fn create_bot_resource_generation(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_bot_resource_generation(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_bot_resource_generation(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_slot_type(
        ...
        self.provider.runtime().block_on(async {
            ...
            let parent_slot_type_signature = input.get_optional_string("parent_slot_type_signature")?;
            let composite_slot_type_setting = input.get_optional_string("composite_slot_type_setting")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("bot_id", bot_id.unwrap_or_default())
                .with_field("external_source_setting", external_source_setting.unwrap_or_default())
                .with_field("slot_type_name", slot_type_name.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field("slot_type_values", slot_type_values.unwrap_or_default())
                .with_field("locale_id", locale_id.unwrap_or_default())
                .with_field("bot_version", bot_version.unwrap_or_default())
                .with_field("value_selection_setting", value_selection_setting.unwrap_or_default())
                .with_field("parent_slot_type_signature", parent_slot_type_signature.unwrap_or_default())
                .with_field("composite_slot_type_setting", composite_slot_type_setting.unwrap_or_default())
            )
        })
    }

    /// Read a slot_type resource
    async fn read_slot_type(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_custom_vocabulary(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_custom_vocabulary(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_custom_vocabulary(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_slot(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("description", description.unwrap_or_default())
                .with_field("bot_id", bot_id.unwrap_or_default())
                .with_field("multiple_values_setting", multiple_values_setting.unwrap_or_default())
                .with_field("sub_slot_setting", sub_slot_setting.unwrap_or_default())
                .with_field("intent_id", intent_id.unwrap_or_default())
                .with_field("locale_id", locale_id.unwrap_or_default())
                .with_field("value_elicitation_setting", value_elicitation_setting.unwrap_or_default())
                .with_field("obfuscation_setting", obfuscation_setting.unwrap_or_default())
                .with_field("bot_version", bot_version.unwrap_or_default())
    ...
    async fn create_bot(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("test_bot_alias_tags", test_bot_alias_tags.unwrap_or_default())
                ...
                .with_field("idle_session_ttl_in_seconds", idle_session_ttl_in_seconds.unwrap_or_default())
            )
        })
    }
