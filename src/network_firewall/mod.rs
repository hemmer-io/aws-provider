...
impl<'a> Network_firewallService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "firewall" => self.plan_firewall(current_state, desired_input).await,
            "vpc_endpoint_association" => {
                self.plan_vpc_endpoint_association(current_state, desired_input)
                    .await
            }
            "rule_group_metadata" => {
                self.plan_rule_group_metadata(current_state, desired_input)
                    .await
            }
            "firewall_metadata" => {
                self.plan_firewall_metadata(current_state, desired_input)
                    .await
            }
            "rule_group_summary" => {
                self.plan_rule_group_summary(current_state, desired_input)
                    .await
            }
            "subnet_change_protection" => {
                self.plan_subnet_change_protection(current_state, desired_input)
                    .await
            }
            "tls_inspection_configuration" => {
                self.plan_tls_inspection_configuration(current_state, desired_input)
                    .await
            }
            "flow_operation" => self.plan_flow_operation(current_state, desired_input).await,
            "firewall_policy_change_protection" => {
                self.plan_firewall_policy_change_protection(current_state, desired_input)
                    .await
            }
            "resource_policy" => {
            ...
            "firewall_analysis_settings" => {
                self.plan_firewall_analysis_settings(current_state, desired_input)
                    .await
            }
            "firewall_description" => {
                self.plan_firewall_description(current_state, desired_input)
                    .await
            }
            "firewall_encryption_configuration" => {
                self.plan_firewall_encryption_configuration(current_state, desired_input)
                    .await
            }
            "analysis_report_results" => {
                self.plan_analysis_report_results(current_state, desired_input)
                    .await
            }
            "availability_zone_change_protection" => {
                self.plan_availability_zone_change_protection(current_state, desired_input)
                    .await
            }
            "rule_group" => self.plan_rule_group(current_state, desired_input).await,
            "firewall_delete_protection" => {
                self.plan_firewall_delete_protection(current_state, desired_input)
                    .await
            }
            "network_firewall_transit_gateway_attachment" => {
                self.plan_network_firewall_transit_gateway_attachment(current_state, desired_input)
                    .await
            }
            "firewall_policy" => {
                self.plan_firewall_policy(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "network_firewall", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "firewall" => self.create_firewall(input).await,
            "vpc_endpoint_association" => self.create_vpc_endpoint_association(input).await,
            "rule_group_metadata" => self.create_rule_group_metadata(input).await,
            "firewall_metadata" => self.create_firewall_metadata(input).await,
            "rule_group_summary" => self.create_rule_group_summary(input).await,
            "subnet_change_protection" => self.create_subnet_change_protection(input).await,
            "tls_inspection_configuration" => self.create_tls_inspection_configuration(input).await,
            "flow_operation" => self.create_flow_operation(input).await,
            "firewall_policy_change_protection" => {
                self.create_firewall_policy_change_protection(input).await
            }
            "resource_policy" => self.create_resource_policy(input).await,
            "firewall_analysis_settings" => self.create_firewall_analysis_settings(input).await,
            "firewall_description" => self.create_firewall_description(input).await,
            "firewall_encryption_configuration" => {
                self.create_firewall_encryption_configuration(input).await
            }
            "analysis_report_results" => self.create_analysis_report_results(input).await,
            "availability_zone_change_protection" => {
                self.create_availability_zone_change_protection(input).await
            }
            "rule_group" => self.create_rule_group(input).await,
            "firewall_delete_protection" => self.create_firewall_delete_protection(input).await,
            "network_firewall_transit_gateway_attachment" => {
                self.create_network_firewall_transit_gateway_attachment(input)
                    .await
            }
            "firewall_policy" => self.create_firewall_policy(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "network_firewall", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "firewall" => self.read_firewall(id).await,
            "vpc_endpoint_association" => self.read_vpc_endpoint_association(id).await,
            "rule_group_metadata" => self.read_rule_group_metadata(id).await,
            "firewall_metadata" => self.read_firewall_metadata(id).await,
            "rule_group_summary" => self.read_rule_group_summary(id).await,
            "subnet_change_protection" => self.read_subnet_change_protection(id).await,
            "tls_inspection_configuration" => self.read_tls_inspection_configuration(id).await,
            "flow_operation" => self.read_flow_operation(id).await,
            "firewall_policy_change_protection" => {
                self.read_firewall_policy_change_protection(id).await
            }
            "resource_policy" => self.read_resource_policy(id).await,
            "firewall_analysis_settings" => self.read_firewall_analysis_settings(id).await,
            "firewall_description" => self.read_firewall_description(id).await,
            "firewall_encryption_configuration" => {
                self.read_firewall_encryption_configuration(id).await
            }
            "analysis_report_results" => self.read_analysis_report_results(id).await,
            "availability_zone_change_protection" => {
                self.read_availability_zone_change_protection(id).await
            }
            "rule_group" => self.read_rule_group(id).await,
            "firewall_delete_protection" => self.read_firewall_delete_protection(id).await,
            "network_firewall_transit_gateway_attachment" => {
                self.read_network_firewall_transit_gateway_attachment(id)
                    .await
            }
            "firewall_policy" => self.read_firewall_policy(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "network_firewall", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "firewall" => self.update_firewall(id, input).await,
            "vpc_endpoint_association" => self.update_vpc_endpoint_association(id, input).await,
            "rule_group_metadata" => self.update_rule_group_metadata(id, input).await,
            "firewall_metadata" => self.update_firewall_metadata(id, input).await,
            "rule_group_summary" => self.update_rule_group_summary(id, input).await,
            "subnet_change_protection" => self.update_subnet_change_protection(id, input).await,
            "tls_inspection_configuration" => {
                self.update_tls_inspection_configuration(id, input).await
            }
            "flow_operation" => self.update_flow_operation(id, input).await,
            "firewall_policy_change_protection" => {
                self.update_firewall_policy_change_protection(id, input)
                    .await
            }
            "resource_policy" => self.update_resource_policy(id, input).await,
            "firewall_analysis_settings" => self.update_firewall_analysis_settings(id, input).await,
            "firewall_description" => self.update_firewall_description(id, input).await,
            "firewall_encryption_configuration" => {
                self.update_firewall_encryption_configuration(id, input)
                    .await
            }
            "analysis_report_results" => self.update_analysis_report_results(id, input).await,
            "availability_zone_change_protection" => {
                self.update_availability_zone_change_protection(id, input)
                    .await
            }
            "rule_group" => self.update_rule_group(id, input).await,
            "firewall_delete_protection" => self.update_firewall_delete_protection(id, input).await,
            "network_firewall_transit_gateway_attachment" => {
                self.update_network_firewall_transit_gateway_attachment(id, input)
                    .await
            }
            "firewall_policy" => self.update_firewall_policy(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "network_firewall", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "firewall" => self.delete_firewall(id).await,
            "vpc_endpoint_association" => self.delete_vpc_endpoint_association(id).await,
            "rule_group_metadata" => self.delete_rule_group_metadata(id).await,
            "firewall_metadata" => self.delete_firewall_metadata(id).await,
            "rule_group_summary" => self.delete_rule_group_summary(id).await,
            "subnet_change_protection" => self.delete_subnet_change_protection(id).await,
            "tls_inspection_configuration" => self.delete_tls_inspection_configuration(id).await,
            "flow_operation" => self.delete_flow_operation(id).await,
            "firewall_policy_change_protection" => {
                self.delete_firewall_policy_change_protection(id).await
            }
            "resource_policy" => self.delete_resource_policy(id).await,
            "firewall_analysis_settings" => self.delete_firewall_analysis_settings(id).await,
            "firewall_description" => self.delete_firewall_description(id).await,
            "firewall_encryption_configuration" => {
                self.delete_firewall_encryption_configuration(id).await
            }
            "analysis_report_results" => self.delete_analysis_report_results(id).await,
            "availability_zone_change_protection" => {
                self.delete_availability_zone_change_protection(id).await
            }
            "rule_group" => self.delete_rule_group(id).await,
            "firewall_delete_protection" => self.delete_firewall_delete_protection(id).await,
            "network_firewall_transit_gateway_attachment" => {
                self.delete_network_firewall_transit_gateway_attachment(id)
                    .await
            }
            "firewall_policy" => self.delete_firewall_policy(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "network_firewall", resource_name
            ))),
    ...
    async fn create_logging_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let enable_monitoring_dashboard =
                input.get_optional_string("enable_monitoring_dashboard")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    enable_monitoring_dashboard.unwrap_or_default(),
                )
                .with_field(
                    "logging_configuration",
    ...
    async fn create_firewall(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let availability_zone_change_protection =
                input.get_optional_string("availability_zone_change_protection")?;
            let subnet_change_protection = input.get_optional_string("subnet_change_protection")?;
            let firewall_policy_change_protection =
                input.get_optional_string("firewall_policy_change_protection")?;
            let availability_zone_mappings =
                input.get_optional_string("availability_zone_mappings")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    enabled_analysis_types.unwrap_or_default(),
                )
                ...
                .with_field(
                    "availability_zone_change_protection",
                    availability_zone_change_protection.unwrap_or_default(),
                )
                .with_field(
                    "subnet_change_protection",
                    subnet_change_protection.unwrap_or_default(),
                )
                .with_field(
                    "firewall_policy_change_protection",
                    firewall_policy_change_protection.unwrap_or_default(),
                )
                .with_field(
                    "availability_zone_mappings",
                    availability_zone_mappings.unwrap_or_default(),
                )
                ...
                .with_field(
                    "firewall_policy_arn",
                    firewall_policy_arn.unwrap_or_default(),
                )
                .with_field("firewall_name", firewall_name.unwrap_or_default())
                .with_field(
    ...
    async fn read_firewall(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn update_firewall(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let enabled_analysis_types = input.get_optional_string("enabled_analysis_types")?;
            let vpc_id = input.get_optional_string("vpc_id")?;
    ...
    async fn read_vpc_endpoint_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_vpc_endpoint_association(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn create_rule_group_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_rule_group_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_rule_group_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn create_firewall_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_firewall_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_firewall_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn create_rule_group_summary(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_rule_group_summary(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_rule_group_summary(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn read_subnet_change_protection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_subnet_change_protection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn create_tls_inspection_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            let tags = input.get_optional_string("tags")?;
            let encryption_configuration = input.get_optional_string("encryption_configuration")?;
            let tls_inspection_configuration_name =
                input.get_string("tls_inspection_configuration_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "tls_inspection_configuration",
                    tls_inspection_configuration.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "encryption_configuration",
                ...
                .with_field(
                    ...
                    tls_inspection_configuration_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a tls_inspection_configuration resource
    async fn read_tls_inspection_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_tls_inspection_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn create_flow_operation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_flow_operation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_flow_operation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn create_firewall_policy_change_protection(
        ...
        self.provider.runtime().block_on(async {
            ...
            let update_token = input.get_optional_string("update_token")?;
            let firewall_policy_change_protection =
                input.get_string("firewall_policy_change_protection")?;
    ...
    async fn read_firewall_policy_change_protection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_firewall_policy_change_protection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn read_firewall_analysis_settings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_firewall_analysis_settings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn create_firewall_description(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let update_token = input.get_optional_string("update_token")?;
    ...
    async fn read_firewall_description(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_firewall_description(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn read_firewall_encryption_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_firewall_encryption_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn create_analysis_report_results(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_analysis_report_results(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_analysis_report_results(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn create_availability_zone_change_protection(
        ...
        self.provider.runtime().block_on(async {
            ...
            let firewall_arn = input.get_optional_string("firewall_arn")?;
            let availability_zone_change_protection =
                input.get_string("availability_zone_change_protection")?;
    ...
    async fn read_availability_zone_change_protection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_availability_zone_change_protection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    summary_configuration.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
    ...
    async fn read_firewall_delete_protection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_firewall_delete_protection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn delete_network_firewall_transit_gateway_attachment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
    ...
    async fn create_firewall_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let encryption_configuration = input.get_optional_string("encryption_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    firewall_policy_name.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("dry_run", dry_run.unwrap_or_default())
    ...
    async fn read_firewall_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.network_firewall_client
    ...
    async fn delete_firewall_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.network_firewall_client
