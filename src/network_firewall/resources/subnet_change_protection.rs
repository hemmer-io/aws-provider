...
impl<'a> Subnet_change_protection<'a> {
    ...
    pub async fn update(&self, id: &str, firewall_name: Option<String>, subnet_change_protection: Option<bool>, update_token: Option<String>, firewall_arn: Option<String>) -> Result<()> {
