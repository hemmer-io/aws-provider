...
impl<'a> Availability_zone_change_protection<'a> {
    ...
    pub async fn update(&self, id: &str, availability_zone_change_protection: Option<bool>, update_token: Option<String>, firewall_arn: Option<String>, firewall_name: Option<String>) -> Result<()> {
