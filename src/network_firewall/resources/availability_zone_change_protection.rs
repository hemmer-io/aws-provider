...
impl<'a> Availability_zone_change_protection<'a> {
    ...
    pub async fn update(&self, id: &str, update_token: Option<String>, firewall_name: Option<String>, firewall_arn: Option<String>, availability_zone_change_protection: Option<bool>) -> Result<()> {
