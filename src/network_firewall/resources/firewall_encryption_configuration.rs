...
impl<'a> Firewall_encryption_configuration<'a> {
    ...
    pub async fn update(&self, id: &str, update_token: Option<String>, firewall_name: Option<String>, encryption_configuration: Option<String>, firewall_arn: Option<String>) -> Result<()> {
