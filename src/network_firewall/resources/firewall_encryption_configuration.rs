...
impl<'a> Firewall_encryption_configuration<'a> {
    ...
    pub async fn update(&self, id: &str, firewall_name: Option<String>, update_token: Option<String>, firewall_arn: Option<String>, encryption_configuration: Option<String>) -> Result<()> {
