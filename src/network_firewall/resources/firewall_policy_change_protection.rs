...
impl<'a> Firewall_policy_change_protection<'a> {
    ...
    pub async fn update(&self, id: &str, update_token: Option<String>, firewall_arn: Option<String>, firewall_name: Option<String>, firewall_policy_change_protection: Option<bool>) -> Result<()> {
