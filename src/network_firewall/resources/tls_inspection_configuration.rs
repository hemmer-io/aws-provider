...
impl<'a> Tls_inspection_configuration<'a> {
    ...
    pub async fn create(&self, description: Option<String>, encryption_configuration: Option<String>, tls_inspection_configuration: String, tls_inspection_configuration_name: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, encryption_configuration: Option<String>, tls_inspection_configuration: Option<String>, tls_inspection_configuration_name: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
