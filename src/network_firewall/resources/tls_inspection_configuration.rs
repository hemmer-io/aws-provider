...
impl<'a> Tls_inspection_configuration<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, encryption_configuration: Option<String>, tls_inspection_configuration: String, description: Option<String>, tls_inspection_configuration_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, encryption_configuration: Option<String>, tls_inspection_configuration: Option<String>, description: Option<String>, tls_inspection_configuration_name: Option<String>) -> Result<()> {
