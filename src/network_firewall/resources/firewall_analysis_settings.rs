...
impl<'a> Firewall_analysis_settings<'a> {
    ...
    pub async fn update(&self, id: &str, enabled_analysis_types: Option<Vec<String>>, firewall_name: Option<String>, update_token: Option<String>, firewall_arn: Option<String>) -> Result<()> {
