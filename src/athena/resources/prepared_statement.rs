...
impl<'a> Prepared_statement<'a> {
    ...
    pub async fn create(&self, work_group: String, description: Option<String>, query_statement: String, statement_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, work_group: Option<String>, description: Option<String>, query_statement: Option<String>, statement_name: Option<String>) -> Result<()> {
