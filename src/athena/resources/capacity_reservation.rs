...
impl<'a> Capacity_reservation<'a> {
    ...
    pub async fn create(&self, name: String, tags: Option<Vec<String>>, target_dpus: i64) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, tags: Option<Vec<String>>, target_dpus: Option<i64>) -> Result<()> {
