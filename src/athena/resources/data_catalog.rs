...
impl<'a> Data_catalog<'a> {
    ...
    pub async fn create(&self, name: String, tags: Option<Vec<String>>, parameters: Option<HashMap<String, String>>, type: String, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, tags: Option<Vec<String>>, parameters: Option<HashMap<String, String>>, type: Option<String>, description: Option<String>) -> Result<()> {
