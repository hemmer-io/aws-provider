...
impl<'a> Data_catalog<'a> {
    ...
    pub async fn create(&self, parameters: Option<HashMap<String, String>>, description: Option<String>, tags: Option<Vec<String>>, type: String, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, parameters: Option<HashMap<String, String>>, description: Option<String>, tags: Option<Vec<String>>, type: Option<String>, name: Option<String>) -> Result<()> {
