...
impl<'a> Data_catalog<'a> {
    ...
    pub async fn create(&self, type: String, parameters: Option<HashMap<String, String>>, name: String, description: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, type: Option<String>, parameters: Option<HashMap<String, String>>, name: Option<String>, description: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
