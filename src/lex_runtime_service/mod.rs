...
impl<'a> Lex_runtime_serviceService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "lex_runtime_service", resource_name
            ))),
        }
    }
    ...
    async fn create_session(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let recent_intent_summary_view =
                input.get_optional_string("recent_intent_summary_view")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    recent_intent_summary_view.unwrap_or_default(),
                )
