...
impl<'a> Predictor_backtest_export_job<'a> {
    ...
    pub async fn create(&self, predictor_backtest_export_job_name: String, format: Option<String>, predictor_arn: String, destination: String, tags: Option<Vec<String>>) -> Result<String> {
