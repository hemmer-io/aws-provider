...
impl<'a> Explainability_export<'a> {
    ...
    pub async fn create(&self, destination: String, tags: Option<Vec<String>>, explainability_export_name: String, explainability_arn: String, format: Option<String>) -> Result<String> {
