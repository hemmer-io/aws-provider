...
impl<'a> Token_with_iam<'a> {
    ...
    pub async fn create(&self, client_id: String, code_verifier: Option<String>, assertion: Option<String>, redirect_uri: Option<String>, subject_token: Option<String>, requested_token_type: Option<String>, refresh_token: Option<String>, code: Option<String>, grant_type: String, scope: Option<Vec<String>>, subject_token_type: Option<String>) -> Result<String> {
