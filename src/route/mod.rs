//! Route Service
//!
//! Auto-generated service module for route

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for route
...
impl<'a> RouteService<'a> {
    ...
    /// Get vpcassociation_authorization resource handler
    pub fn vpcassociation_authorization(&self) -> resources::Vpcassociation_authorization<'_> {
        resources::Vpcassociation_authorization::new(self.provider)
    }
