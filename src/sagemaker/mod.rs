...
impl<'a> SagemakerService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "edge_packaging_job" => {
                self.plan_edge_packaging_job(current_state, desired_input)
                    .await
            }
            "tags" => self.plan_tags(current_state, desired_input).await,
            "presigned_mlflow_tracking_server_url" => {
                self.plan_presigned_mlflow_tracking_server_url(current_state, desired_input)
                    .await
            }
            "subscribed_workteam" => {
                self.plan_subscribed_workteam(current_state, desired_input)
                    .await
            }
            "pipeline_version" => {
                self.plan_pipeline_version(current_state, desired_input)
                    .await
            }
            "model" => self.plan_model(current_state, desired_input).await,
            "trial_component" => {
                self.plan_trial_component(current_state, desired_input)
                    .await
            }
            "notebook_instance_lifecycle_config" => {
                self.plan_notebook_instance_lifecycle_config(current_state, desired_input)
                    .await
            }
            ...
            "flow_definition" => {
                self.plan_flow_definition(current_state, desired_input)
                    .await
            }
            "cluster_software" => {
                self.plan_cluster_software(current_state, desired_input)
                    .await
            }
            "association" => self.plan_association(current_state, desired_input).await,
            "inference_component" => {
                self.plan_inference_component(current_state, desired_input)
                    .await
            }
            "lineage_group" => self.plan_lineage_group(current_state, desired_input).await,
            "human_task_ui" => self.plan_human_task_ui(current_state, desired_input).await,
            "edge_deployment_plan" => {
                self.plan_edge_deployment_plan(current_state, desired_input)
                    .await
            }
            "hub" => self.plan_hub(current_state, desired_input).await,
            "hub_content" => self.plan_hub_content(current_state, desired_input).await,
            "pipeline_definition_for_execution" => {
                self.plan_pipeline_definition_for_execution(current_state, desired_input)
                    .await
            }
            "code_repository" => {
                self.plan_code_repository(current_state, desired_input)
                    .await
            }
            "pipeline" => self.plan_pipeline(current_state, desired_input).await,
            "monitoring_schedule" => {
                self.plan_monitoring_schedule(current_state, desired_input)
                    .await
            }
            "pipeline_execution" => {
                self.plan_pipeline_execution(current_state, desired_input)
                    .await
            }
            "app_image_config" => {
                self.plan_app_image_config(current_state, desired_input)
                    .await
            }
            "presigned_domain_url" => {
                self.plan_presigned_domain_url(current_state, desired_input)
                    .await
            }
            "device" => self.plan_device(current_state, desired_input).await,
            "data_quality_job_definition" => {
                self.plan_data_quality_job_definition(current_state, desired_input)
                    .await
            }
            "labeling_job" => self.plan_labeling_job(current_state, desired_input).await,
            "algorithm" => self.plan_algorithm(current_state, desired_input).await,
            "model_explainability_job_definition" => {
                self.plan_model_explainability_job_definition(current_state, desired_input)
                    .await
            }
            "compute_quota" => self.plan_compute_quota(current_state, desired_input).await,
            "inference_experiment" => {
                self.plan_inference_experiment(current_state, desired_input)
                    .await
            }
            "partner_app" => self.plan_partner_app(current_state, desired_input).await,
            "inference_recommendations_job" => {
                self.plan_inference_recommendations_job(current_state, desired_input)
                    .await
            }
            "training_job" => self.plan_training_job(current_state, desired_input).await,
            "model_bias_job_definition" => {
                self.plan_model_bias_job_definition(current_state, desired_input)
                    .await
            }
            "edge_deployment_stage" => {
                self.plan_edge_deployment_stage(current_state, desired_input)
                    .await
            }
            "presigned_notebook_instance_url" => {
                self.plan_presigned_notebook_instance_url(current_state, desired_input)
                    .await
            }
            "transform_job" => self.plan_transform_job(current_state, desired_input).await,
            "hub_content_reference" => {
                self.plan_hub_content_reference(current_state, desired_input)
                    .await
            }
            "scaling_configuration_recommendation" => {
                self.plan_scaling_configuration_recommendation(current_state, desired_input)
                    .await
            }
            "context" => self.plan_context(current_state, desired_input).await,
            "model_card" => self.plan_model_card(current_state, desired_input).await,
            "studio_lifecycle_config" => {
                self.plan_studio_lifecycle_config(current_state, desired_input)
                    .await
            }
            "user_profile" => self.plan_user_profile(current_state, desired_input).await,
            "endpoint_config" => {
                self.plan_endpoint_config(current_state, desired_input)
                    .await
            }
            "experiment" => self.plan_experiment(current_state, desired_input).await,
            "endpoint_weights_and_capacities" => {
                self.plan_endpoint_weights_and_capacities(current_state, desired_input)
                    .await
            }
            "training_plan" => self.plan_training_plan(current_state, desired_input).await,
            "cluster" => self.plan_cluster(current_state, desired_input).await,
            "devices" => self.plan_devices(current_state, desired_input).await,
            "compilation_job" => {
                self.plan_compilation_job(current_state, desired_input)
                    .await
            }
            "optimization_job" => {
                self.plan_optimization_job(current_state, desired_input)
                    .await
            }
            ...
            "sagemaker_servicecatalog_portfolio_status" => {
                self.plan_sagemaker_servicecatalog_portfolio_status(current_state, desired_input)
                    .await
            }
            "auto_ml_job" => self.plan_auto_ml_job(current_state, desired_input).await,
            "model_package" => self.plan_model_package(current_state, desired_input).await,
            "reserved_capacity" => {
                self.plan_reserved_capacity(current_state, desired_input)
                    .await
            }
            "search_suggestions" => {
                self.plan_search_suggestions(current_state, desired_input)
                    .await
            }
            "image" => self.plan_image(current_state, desired_input).await,
            "mlflow_tracking_server" => {
                self.plan_mlflow_tracking_server(current_state, desired_input)
                    .await
            }
            "device_fleet" => self.plan_device_fleet(current_state, desired_input).await,
            "notebook_instance" => {
                self.plan_notebook_instance(current_state, desired_input)
                    .await
            }
            "device_fleet_report" => {
                self.plan_device_fleet_report(current_state, desired_input)
                    .await
            }
            "inference_component_runtime_config" => {
                self.plan_inference_component_runtime_config(current_state, desired_input)
                    .await
            }
            "feature_group" => self.plan_feature_group(current_state, desired_input).await,
            "auto_ml_job_v2" => self.plan_auto_ml_job_v2(current_state, desired_input).await,
            "lineage_group_policy" => {
                self.plan_lineage_group_policy(current_state, desired_input)
                    .await
            }
            "image_version" => self.plan_image_version(current_state, desired_input).await,
            "hyper_parameter_tuning_job" => {
                self.plan_hyper_parameter_tuning_job(current_state, desired_input)
                    .await
            }
            "processing_job" => self.plan_processing_job(current_state, desired_input).await,
            "model_package_group_policy" => {
                self.plan_model_package_group_policy(current_state, desired_input)
                    .await
            }
            "cluster_event" => self.plan_cluster_event(current_state, desired_input).await,
            "feature_metadata" => {
                self.plan_feature_metadata(current_state, desired_input)
                    .await
            }
            "cluster_node" => self.plan_cluster_node(current_state, desired_input).await,
            ...
            "cluster_scheduler_config" => {
                self.plan_cluster_scheduler_config(current_state, desired_input)
                    .await
            }
            "workteam" => self.plan_workteam(current_state, desired_input).await,
            "monitoring_alert" => {
                self.plan_monitoring_alert(current_state, desired_input)
                    .await
            }
            "model_quality_job_definition" => {
                self.plan_model_quality_job_definition(current_state, desired_input)
                    .await
            }
            "hub_content_presigned_urls" => {
                self.plan_hub_content_presigned_urls(current_state, desired_input)
                    .await
            }
            "model_package_group" => {
                self.plan_model_package_group(current_state, desired_input)
                    .await
            }
            "action" => self.plan_action(current_state, desired_input).await,
            "space" => self.plan_space(current_state, desired_input).await,
            "workforce" => self.plan_workforce(current_state, desired_input).await,
            "model_card_export_job" => {
                self.plan_model_card_export_job(current_state, desired_input)
                    .await
            }
            "partner_app_presigned_url" => {
                self.plan_partner_app_presigned_url(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "sagemaker", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "edge_packaging_job" => self.create_edge_packaging_job(input).await,
            "tags" => self.create_tags(input).await,
            "presigned_mlflow_tracking_server_url" => {
                self.create_presigned_mlflow_tracking_server_url(input)
                    .await
            }
            "subscribed_workteam" => self.create_subscribed_workteam(input).await,
            "pipeline_version" => self.create_pipeline_version(input).await,
            "model" => self.create_model(input).await,
            "trial_component" => self.create_trial_component(input).await,
            "notebook_instance_lifecycle_config" => {
            ...
            "flow_definition" => self.create_flow_definition(input).await,
            "cluster_software" => self.create_cluster_software(input).await,
            "association" => self.create_association(input).await,
            "inference_component" => self.create_inference_component(input).await,
            "lineage_group" => self.create_lineage_group(input).await,
            "human_task_ui" => self.create_human_task_ui(input).await,
            "edge_deployment_plan" => self.create_edge_deployment_plan(input).await,
            "hub" => self.create_hub(input).await,
            "hub_content" => self.create_hub_content(input).await,
            "pipeline_definition_for_execution" => {
                self.create_pipeline_definition_for_execution(input).await
            }
            "code_repository" => self.create_code_repository(input).await,
            "pipeline" => self.create_pipeline(input).await,
            "monitoring_schedule" => self.create_monitoring_schedule(input).await,
            "pipeline_execution" => self.create_pipeline_execution(input).await,
            "app_image_config" => self.create_app_image_config(input).await,
            "presigned_domain_url" => self.create_presigned_domain_url(input).await,
            "device" => self.create_device(input).await,
            "data_quality_job_definition" => self.create_data_quality_job_definition(input).await,
            "labeling_job" => self.create_labeling_job(input).await,
            "algorithm" => self.create_algorithm(input).await,
            "model_explainability_job_definition" => {
                self.create_model_explainability_job_definition(input).await
            }
            "compute_quota" => self.create_compute_quota(input).await,
            "inference_experiment" => self.create_inference_experiment(input).await,
            "partner_app" => self.create_partner_app(input).await,
            "inference_recommendations_job" => {
                self.create_inference_recommendations_job(input).await
            }
            "training_job" => self.create_training_job(input).await,
            "model_bias_job_definition" => self.create_model_bias_job_definition(input).await,
            "edge_deployment_stage" => self.create_edge_deployment_stage(input).await,
            "presigned_notebook_instance_url" => {
                self.create_presigned_notebook_instance_url(input).await
            }
            "transform_job" => self.create_transform_job(input).await,
            "hub_content_reference" => self.create_hub_content_reference(input).await,
            "scaling_configuration_recommendation" => {
                self.create_scaling_configuration_recommendation(input)
                    .await
            }
            "context" => self.create_context(input).await,
            "model_card" => self.create_model_card(input).await,
            "studio_lifecycle_config" => self.create_studio_lifecycle_config(input).await,
            "user_profile" => self.create_user_profile(input).await,
            "endpoint_config" => self.create_endpoint_config(input).await,
            "experiment" => self.create_experiment(input).await,
            "endpoint_weights_and_capacities" => {
                self.create_endpoint_weights_and_capacities(input).await
            }
            "training_plan" => self.create_training_plan(input).await,
            "cluster" => self.create_cluster(input).await,
            "devices" => self.create_devices(input).await,
            "compilation_job" => self.create_compilation_job(input).await,
            "optimization_job" => self.create_optimization_job(input).await,
            "project" => self.create_project(input).await,
            "trial" => self.create_trial(input).await,
            "sagemaker_servicecatalog_portfolio_status" => {
                self.create_sagemaker_servicecatalog_portfolio_status(input)
                    .await
            }
            "auto_ml_job" => self.create_auto_ml_job(input).await,
            "model_package" => self.create_model_package(input).await,
            "reserved_capacity" => self.create_reserved_capacity(input).await,
            "search_suggestions" => self.create_search_suggestions(input).await,
            "image" => self.create_image(input).await,
            "mlflow_tracking_server" => self.create_mlflow_tracking_server(input).await,
            "device_fleet" => self.create_device_fleet(input).await,
            "notebook_instance" => self.create_notebook_instance(input).await,
            "device_fleet_report" => self.create_device_fleet_report(input).await,
            "inference_component_runtime_config" => {
                self.create_inference_component_runtime_config(input).await
            }
            "feature_group" => self.create_feature_group(input).await,
            "auto_ml_job_v2" => self.create_auto_ml_job_v2(input).await,
            "lineage_group_policy" => self.create_lineage_group_policy(input).await,
            "image_version" => self.create_image_version(input).await,
            "hyper_parameter_tuning_job" => self.create_hyper_parameter_tuning_job(input).await,
            "processing_job" => self.create_processing_job(input).await,
            "model_package_group_policy" => self.create_model_package_group_policy(input).await,
            "cluster_event" => self.create_cluster_event(input).await,
            "feature_metadata" => self.create_feature_metadata(input).await,
            "cluster_node" => self.create_cluster_node(input).await,
            "app" => self.create_app(input).await,
            "domain" => self.create_domain(input).await,
            "cluster_scheduler_config" => self.create_cluster_scheduler_config(input).await,
            "workteam" => self.create_workteam(input).await,
            "monitoring_alert" => self.create_monitoring_alert(input).await,
            "model_quality_job_definition" => self.create_model_quality_job_definition(input).await,
            "hub_content_presigned_urls" => self.create_hub_content_presigned_urls(input).await,
            "model_package_group" => self.create_model_package_group(input).await,
            "action" => self.create_action(input).await,
            "space" => self.create_space(input).await,
            "workforce" => self.create_workforce(input).await,
            "model_card_export_job" => self.create_model_card_export_job(input).await,
            "partner_app_presigned_url" => self.create_partner_app_presigned_url(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "sagemaker", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "edge_packaging_job" => self.read_edge_packaging_job(id).await,
            "tags" => self.read_tags(id).await,
            "presigned_mlflow_tracking_server_url" => {
                self.read_presigned_mlflow_tracking_server_url(id).await
            }
            "subscribed_workteam" => self.read_subscribed_workteam(id).await,
            "pipeline_version" => self.read_pipeline_version(id).await,
            "model" => self.read_model(id).await,
            "trial_component" => self.read_trial_component(id).await,
            "notebook_instance_lifecycle_config" => {
            ...
            "flow_definition" => self.read_flow_definition(id).await,
            "cluster_software" => self.read_cluster_software(id).await,
            "association" => self.read_association(id).await,
            "inference_component" => self.read_inference_component(id).await,
            "lineage_group" => self.read_lineage_group(id).await,
            "human_task_ui" => self.read_human_task_ui(id).await,
            "edge_deployment_plan" => self.read_edge_deployment_plan(id).await,
            "hub" => self.read_hub(id).await,
            "hub_content" => self.read_hub_content(id).await,
            "pipeline_definition_for_execution" => {
                self.read_pipeline_definition_for_execution(id).await
            }
            "code_repository" => self.read_code_repository(id).await,
            "pipeline" => self.read_pipeline(id).await,
            "monitoring_schedule" => self.read_monitoring_schedule(id).await,
            "pipeline_execution" => self.read_pipeline_execution(id).await,
            "app_image_config" => self.read_app_image_config(id).await,
            "presigned_domain_url" => self.read_presigned_domain_url(id).await,
            "device" => self.read_device(id).await,
            "data_quality_job_definition" => self.read_data_quality_job_definition(id).await,
            "labeling_job" => self.read_labeling_job(id).await,
            "algorithm" => self.read_algorithm(id).await,
            "model_explainability_job_definition" => {
                self.read_model_explainability_job_definition(id).await
            }
            "compute_quota" => self.read_compute_quota(id).await,
            "inference_experiment" => self.read_inference_experiment(id).await,
            "partner_app" => self.read_partner_app(id).await,
            "inference_recommendations_job" => self.read_inference_recommendations_job(id).await,
            "training_job" => self.read_training_job(id).await,
            "model_bias_job_definition" => self.read_model_bias_job_definition(id).await,
            "edge_deployment_stage" => self.read_edge_deployment_stage(id).await,
            "presigned_notebook_instance_url" => {
                self.read_presigned_notebook_instance_url(id).await
            }
            "transform_job" => self.read_transform_job(id).await,
            "hub_content_reference" => self.read_hub_content_reference(id).await,
            "scaling_configuration_recommendation" => {
                self.read_scaling_configuration_recommendation(id).await
            }
            "context" => self.read_context(id).await,
            "model_card" => self.read_model_card(id).await,
            "studio_lifecycle_config" => self.read_studio_lifecycle_config(id).await,
            "user_profile" => self.read_user_profile(id).await,
            "endpoint_config" => self.read_endpoint_config(id).await,
            "experiment" => self.read_experiment(id).await,
            "endpoint_weights_and_capacities" => {
                self.read_endpoint_weights_and_capacities(id).await
            }
            "training_plan" => self.read_training_plan(id).await,
            "cluster" => self.read_cluster(id).await,
            "devices" => self.read_devices(id).await,
            "compilation_job" => self.read_compilation_job(id).await,
            "optimization_job" => self.read_optimization_job(id).await,
            "project" => self.read_project(id).await,
            "trial" => self.read_trial(id).await,
            "sagemaker_servicecatalog_portfolio_status" => {
                self.read_sagemaker_servicecatalog_portfolio_status(id)
                    .await
            }
            "auto_ml_job" => self.read_auto_ml_job(id).await,
            "model_package" => self.read_model_package(id).await,
            "reserved_capacity" => self.read_reserved_capacity(id).await,
            "search_suggestions" => self.read_search_suggestions(id).await,
            "image" => self.read_image(id).await,
            "mlflow_tracking_server" => self.read_mlflow_tracking_server(id).await,
            "device_fleet" => self.read_device_fleet(id).await,
            "notebook_instance" => self.read_notebook_instance(id).await,
            "device_fleet_report" => self.read_device_fleet_report(id).await,
            "inference_component_runtime_config" => {
                self.read_inference_component_runtime_config(id).await
            }
            "feature_group" => self.read_feature_group(id).await,
            "auto_ml_job_v2" => self.read_auto_ml_job_v2(id).await,
            "lineage_group_policy" => self.read_lineage_group_policy(id).await,
            "image_version" => self.read_image_version(id).await,
            "hyper_parameter_tuning_job" => self.read_hyper_parameter_tuning_job(id).await,
            "processing_job" => self.read_processing_job(id).await,
            "model_package_group_policy" => self.read_model_package_group_policy(id).await,
            "cluster_event" => self.read_cluster_event(id).await,
            "feature_metadata" => self.read_feature_metadata(id).await,
            "cluster_node" => self.read_cluster_node(id).await,
            "app" => self.read_app(id).await,
            "domain" => self.read_domain(id).await,
            "cluster_scheduler_config" => self.read_cluster_scheduler_config(id).await,
            "workteam" => self.read_workteam(id).await,
            "monitoring_alert" => self.read_monitoring_alert(id).await,
            "model_quality_job_definition" => self.read_model_quality_job_definition(id).await,
            "hub_content_presigned_urls" => self.read_hub_content_presigned_urls(id).await,
            "model_package_group" => self.read_model_package_group(id).await,
            "action" => self.read_action(id).await,
            "space" => self.read_space(id).await,
            "workforce" => self.read_workforce(id).await,
            "model_card_export_job" => self.read_model_card_export_job(id).await,
            "partner_app_presigned_url" => self.read_partner_app_presigned_url(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "sagemaker", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "edge_packaging_job" => self.update_edge_packaging_job(id, input).await,
            "tags" => self.update_tags(id, input).await,
            "presigned_mlflow_tracking_server_url" => {
                self.update_presigned_mlflow_tracking_server_url(id, input)
                    .await
            }
            "subscribed_workteam" => self.update_subscribed_workteam(id, input).await,
            "pipeline_version" => self.update_pipeline_version(id, input).await,
            "model" => self.update_model(id, input).await,
            "trial_component" => self.update_trial_component(id, input).await,
            "notebook_instance_lifecycle_config" => {
                self.update_notebook_instance_lifecycle_config(id, input)
                    .await
            }
            "artifact" => self.update_artifact(id, input).await,
            "endpoint" => self.update_endpoint(id, input).await,
            "flow_definition" => self.update_flow_definition(id, input).await,
            "cluster_software" => self.update_cluster_software(id, input).await,
            "association" => self.update_association(id, input).await,
            "inference_component" => self.update_inference_component(id, input).await,
            "lineage_group" => self.update_lineage_group(id, input).await,
            "human_task_ui" => self.update_human_task_ui(id, input).await,
            "edge_deployment_plan" => self.update_edge_deployment_plan(id, input).await,
            "hub" => self.update_hub(id, input).await,
            "hub_content" => self.update_hub_content(id, input).await,
            "pipeline_definition_for_execution" => {
                self.update_pipeline_definition_for_execution(id, input)
                    .await
            }
            "code_repository" => self.update_code_repository(id, input).await,
            "pipeline" => self.update_pipeline(id, input).await,
            "monitoring_schedule" => self.update_monitoring_schedule(id, input).await,
            "pipeline_execution" => self.update_pipeline_execution(id, input).await,
            "app_image_config" => self.update_app_image_config(id, input).await,
            "presigned_domain_url" => self.update_presigned_domain_url(id, input).await,
            "device" => self.update_device(id, input).await,
            "data_quality_job_definition" => {
                self.update_data_quality_job_definition(id, input).await
            }
            "labeling_job" => self.update_labeling_job(id, input).await,
            "algorithm" => self.update_algorithm(id, input).await,
            "model_explainability_job_definition" => {
                self.update_model_explainability_job_definition(id, input)
                    .await
            }
            "compute_quota" => self.update_compute_quota(id, input).await,
            "inference_experiment" => self.update_inference_experiment(id, input).await,
            "partner_app" => self.update_partner_app(id, input).await,
            "inference_recommendations_job" => {
                self.update_inference_recommendations_job(id, input).await
            }
            "training_job" => self.update_training_job(id, input).await,
            "model_bias_job_definition" => self.update_model_bias_job_definition(id, input).await,
            "edge_deployment_stage" => self.update_edge_deployment_stage(id, input).await,
            "presigned_notebook_instance_url" => {
                self.update_presigned_notebook_instance_url(id, input).await
            }
            "transform_job" => self.update_transform_job(id, input).await,
            "hub_content_reference" => self.update_hub_content_reference(id, input).await,
            "scaling_configuration_recommendation" => {
                self.update_scaling_configuration_recommendation(id, input)
                    .await
            }
            "context" => self.update_context(id, input).await,
            "model_card" => self.update_model_card(id, input).await,
            "studio_lifecycle_config" => self.update_studio_lifecycle_config(id, input).await,
            "user_profile" => self.update_user_profile(id, input).await,
            "endpoint_config" => self.update_endpoint_config(id, input).await,
            "experiment" => self.update_experiment(id, input).await,
            "endpoint_weights_and_capacities" => {
                self.update_endpoint_weights_and_capacities(id, input).await
            }
            "training_plan" => self.update_training_plan(id, input).await,
            "cluster" => self.update_cluster(id, input).await,
            "devices" => self.update_devices(id, input).await,
            "compilation_job" => self.update_compilation_job(id, input).await,
            "optimization_job" => self.update_optimization_job(id, input).await,
            "project" => self.update_project(id, input).await,
            "trial" => self.update_trial(id, input).await,
            "sagemaker_servicecatalog_portfolio_status" => {
                self.update_sagemaker_servicecatalog_portfolio_status(id, input)
                    .await
            }
            "auto_ml_job" => self.update_auto_ml_job(id, input).await,
            "model_package" => self.update_model_package(id, input).await,
            "reserved_capacity" => self.update_reserved_capacity(id, input).await,
            "search_suggestions" => self.update_search_suggestions(id, input).await,
            "image" => self.update_image(id, input).await,
            "mlflow_tracking_server" => self.update_mlflow_tracking_server(id, input).await,
            "device_fleet" => self.update_device_fleet(id, input).await,
            "notebook_instance" => self.update_notebook_instance(id, input).await,
            "device_fleet_report" => self.update_device_fleet_report(id, input).await,
            "inference_component_runtime_config" => {
                self.update_inference_component_runtime_config(id, input)
                    .await
            }
            "feature_group" => self.update_feature_group(id, input).await,
            "auto_ml_job_v2" => self.update_auto_ml_job_v2(id, input).await,
            "lineage_group_policy" => self.update_lineage_group_policy(id, input).await,
            "image_version" => self.update_image_version(id, input).await,
            "hyper_parameter_tuning_job" => self.update_hyper_parameter_tuning_job(id, input).await,
            "processing_job" => self.update_processing_job(id, input).await,
            "model_package_group_policy" => self.update_model_package_group_policy(id, input).await,
            "cluster_event" => self.update_cluster_event(id, input).await,
            "feature_metadata" => self.update_feature_metadata(id, input).await,
            "cluster_node" => self.update_cluster_node(id, input).await,
            "app" => self.update_app(id, input).await,
            "domain" => self.update_domain(id, input).await,
            "cluster_scheduler_config" => self.update_cluster_scheduler_config(id, input).await,
            "workteam" => self.update_workteam(id, input).await,
            "monitoring_alert" => self.update_monitoring_alert(id, input).await,
            "model_quality_job_definition" => {
                self.update_model_quality_job_definition(id, input).await
            }
            "hub_content_presigned_urls" => self.update_hub_content_presigned_urls(id, input).await,
            "model_package_group" => self.update_model_package_group(id, input).await,
            "action" => self.update_action(id, input).await,
            "space" => self.update_space(id, input).await,
            "workforce" => self.update_workforce(id, input).await,
            "model_card_export_job" => self.update_model_card_export_job(id, input).await,
            "partner_app_presigned_url" => self.update_partner_app_presigned_url(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "sagemaker", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "edge_packaging_job" => self.delete_edge_packaging_job(id).await,
            "tags" => self.delete_tags(id).await,
            "presigned_mlflow_tracking_server_url" => {
                self.delete_presigned_mlflow_tracking_server_url(id).await
            }
            "subscribed_workteam" => self.delete_subscribed_workteam(id).await,
            "pipeline_version" => self.delete_pipeline_version(id).await,
            "model" => self.delete_model(id).await,
            "trial_component" => self.delete_trial_component(id).await,
            "notebook_instance_lifecycle_config" => {
            ...
            "flow_definition" => self.delete_flow_definition(id).await,
            "cluster_software" => self.delete_cluster_software(id).await,
            "association" => self.delete_association(id).await,
            "inference_component" => self.delete_inference_component(id).await,
            "lineage_group" => self.delete_lineage_group(id).await,
            "human_task_ui" => self.delete_human_task_ui(id).await,
            "edge_deployment_plan" => self.delete_edge_deployment_plan(id).await,
            "hub" => self.delete_hub(id).await,
            "hub_content" => self.delete_hub_content(id).await,
            "pipeline_definition_for_execution" => {
                self.delete_pipeline_definition_for_execution(id).await
            }
            "code_repository" => self.delete_code_repository(id).await,
            "pipeline" => self.delete_pipeline(id).await,
            "monitoring_schedule" => self.delete_monitoring_schedule(id).await,
            "pipeline_execution" => self.delete_pipeline_execution(id).await,
            "app_image_config" => self.delete_app_image_config(id).await,
            "presigned_domain_url" => self.delete_presigned_domain_url(id).await,
            "device" => self.delete_device(id).await,
            "data_quality_job_definition" => self.delete_data_quality_job_definition(id).await,
            "labeling_job" => self.delete_labeling_job(id).await,
            "algorithm" => self.delete_algorithm(id).await,
            "model_explainability_job_definition" => {
                self.delete_model_explainability_job_definition(id).await
            }
            "compute_quota" => self.delete_compute_quota(id).await,
            "inference_experiment" => self.delete_inference_experiment(id).await,
            "partner_app" => self.delete_partner_app(id).await,
            "inference_recommendations_job" => self.delete_inference_recommendations_job(id).await,
            "training_job" => self.delete_training_job(id).await,
            "model_bias_job_definition" => self.delete_model_bias_job_definition(id).await,
            "edge_deployment_stage" => self.delete_edge_deployment_stage(id).await,
            "presigned_notebook_instance_url" => {
                self.delete_presigned_notebook_instance_url(id).await
            }
            "transform_job" => self.delete_transform_job(id).await,
            "hub_content_reference" => self.delete_hub_content_reference(id).await,
            "scaling_configuration_recommendation" => {
                self.delete_scaling_configuration_recommendation(id).await
            }
            "context" => self.delete_context(id).await,
            "model_card" => self.delete_model_card(id).await,
            "studio_lifecycle_config" => self.delete_studio_lifecycle_config(id).await,
            "user_profile" => self.delete_user_profile(id).await,
            "endpoint_config" => self.delete_endpoint_config(id).await,
            "experiment" => self.delete_experiment(id).await,
            "endpoint_weights_and_capacities" => {
                self.delete_endpoint_weights_and_capacities(id).await
            }
            "training_plan" => self.delete_training_plan(id).await,
            "cluster" => self.delete_cluster(id).await,
            "devices" => self.delete_devices(id).await,
            "compilation_job" => self.delete_compilation_job(id).await,
            "optimization_job" => self.delete_optimization_job(id).await,
            "project" => self.delete_project(id).await,
            "trial" => self.delete_trial(id).await,
            "sagemaker_servicecatalog_portfolio_status" => {
                self.delete_sagemaker_servicecatalog_portfolio_status(id)
                    .await
            }
            "auto_ml_job" => self.delete_auto_ml_job(id).await,
            "model_package" => self.delete_model_package(id).await,
            "reserved_capacity" => self.delete_reserved_capacity(id).await,
            "search_suggestions" => self.delete_search_suggestions(id).await,
            "image" => self.delete_image(id).await,
            "mlflow_tracking_server" => self.delete_mlflow_tracking_server(id).await,
            "device_fleet" => self.delete_device_fleet(id).await,
            "notebook_instance" => self.delete_notebook_instance(id).await,
            "device_fleet_report" => self.delete_device_fleet_report(id).await,
            "inference_component_runtime_config" => {
                self.delete_inference_component_runtime_config(id).await
            }
            "feature_group" => self.delete_feature_group(id).await,
            "auto_ml_job_v2" => self.delete_auto_ml_job_v2(id).await,
            "lineage_group_policy" => self.delete_lineage_group_policy(id).await,
            "image_version" => self.delete_image_version(id).await,
            "hyper_parameter_tuning_job" => self.delete_hyper_parameter_tuning_job(id).await,
            "processing_job" => self.delete_processing_job(id).await,
            "model_package_group_policy" => self.delete_model_package_group_policy(id).await,
            "cluster_event" => self.delete_cluster_event(id).await,
            "feature_metadata" => self.delete_feature_metadata(id).await,
            "cluster_node" => self.delete_cluster_node(id).await,
            "app" => self.delete_app(id).await,
            "domain" => self.delete_domain(id).await,
            "cluster_scheduler_config" => self.delete_cluster_scheduler_config(id).await,
            "workteam" => self.delete_workteam(id).await,
            "monitoring_alert" => self.delete_monitoring_alert(id).await,
            "model_quality_job_definition" => self.delete_model_quality_job_definition(id).await,
            "hub_content_presigned_urls" => self.delete_hub_content_presigned_urls(id).await,
            "model_package_group" => self.delete_model_package_group(id).await,
            "action" => self.delete_action(id).await,
            "space" => self.delete_space(id).await,
            "workforce" => self.delete_workforce(id).await,
            "model_card_export_job" => self.delete_model_card_export_job(id).await,
            "partner_app_presigned_url" => self.delete_partner_app_presigned_url(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "sagemaker", resource_name
            ))),
    ...
    async fn create_edge_packaging_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    compilation_job_name.unwrap_or_default(),
                )
                .with_field(
                    "edge_packaging_job_name",
                    edge_packaging_job_name.unwrap_or_default(),
                )
    ...
    async fn read_edge_packaging_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_edge_packaging_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_presigned_mlflow_tracking_server_url(
        ...
        self.provider.runtime().block_on(async {
            ...
            let session_expiration_duration_in_seconds =
                input.get_optional_string("session_expiration_duration_in_seconds")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    tracking_server_name.unwrap_or_default(),
                )
                .with_field("expires_in_seconds", expires_in_seconds.unwrap_or_default())
                .with_field(
                    "session_expiration_duration_in_seconds",
                    session_expiration_duration_in_seconds.unwrap_or_default(),
                ))
        })
    }

    /// Read a presigned_mlflow_tracking_server_url resource
    async fn read_presigned_mlflow_tracking_server_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_presigned_mlflow_tracking_server_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_subscribed_workteam(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_subscribed_workteam(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_subscribed_workteam(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_pipeline_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let pipeline_arn = input.get_string("pipeline_arn")?;
            let pipeline_version_id = input.get_string("pipeline_version_id")?;
            let pipeline_version_display_name =
                input.get_optional_string("pipeline_version_display_name")?;
            let pipeline_version_description =
                input.get_optional_string("pipeline_version_description")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "pipeline_version_id",
                    pipeline_version_id.unwrap_or_default(),
                )
                .with_field(
                    "pipeline_version_display_name",
                    pipeline_version_display_name.unwrap_or_default(),
                )
                .with_field(
                    "pipeline_version_description",
                    pipeline_version_description.unwrap_or_default(),
                ))
        })
    }

    /// Read a pipeline_version resource
    async fn read_pipeline_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_pipeline_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_model(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let inference_execution_config =
                input.get_optional_string("inference_execution_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    inference_execution_config.unwrap_or_default(),
                )
                .with_field("execution_role_arn", execution_role_arn.unwrap_or_default())
                .with_field(
                    "enable_network_isolation",
                    enable_network_isolation.unwrap_or_default(),
                )
    ...
    async fn create_trial_component(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    trial_component_name.unwrap_or_default(),
                )
                ...
                .with_field(
                    "metadata_properties",
                    metadata_properties.unwrap_or_default(),
                )
    ...
    async fn read_trial_component(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_trial_component(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_notebook_instance_lifecycle_config(
        ...
        self.provider.runtime().block_on(async {
            ...
            let tags = input.get_optional_string("tags")?;
            let notebook_instance_lifecycle_config_name =
                input.get_string("notebook_instance_lifecycle_config_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    notebook_instance_lifecycle_config_name.unwrap_or_default(),
                )
    ...
    async fn read_notebook_instance_lifecycle_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_notebook_instance_lifecycle_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    endpoint_config_name.unwrap_or_default(),
                )
    ...
    async fn create_flow_definition(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let human_loop_request_source =
                input.get_optional_string("human_loop_request_source")?;
            let tags = input.get_optional_string("tags")?;
            let output_config = input.get_string("output_config")?;
            let role_arn = input.get_string("role_arn")?;
            let human_loop_activation_config =
                input.get_optional_string("human_loop_activation_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    flow_definition_name.unwrap_or_default(),
                )
                .with_field("human_loop_config", human_loop_config.unwrap_or_default())
                .with_field(
                    "human_loop_request_source",
                    human_loop_request_source.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("output_config", output_config.unwrap_or_default())
                .with_field("role_arn", role_arn.unwrap_or_default())
                .with_field(
                    ...
                    human_loop_activation_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a flow_definition resource
    async fn read_flow_definition(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_flow_definition(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_cluster_software(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cluster_software(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_cluster_software(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_association(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_association(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_association(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn create_inference_component(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    inference_component_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a inference_component resource
    async fn read_inference_component(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_inference_component(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_lineage_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_lineage_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_lineage_group(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_lineage_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_human_task_ui(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_human_task_ui(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_human_task_ui(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let human_task_ui_name = input.get_string("human_task_ui_name")?;
    ...
    async fn delete_human_task_ui(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_edge_deployment_plan(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    edge_deployment_plan_name.unwrap_or_default(),
                )
    ...
    async fn read_edge_deployment_plan(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_edge_deployment_plan(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_hub(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "hub_search_keywords",
                    hub_search_keywords.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_hub_content(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let hub_content_description = input.get_optional_string("hub_content_description")?;
            let hub_content_search_keywords =
                input.get_optional_string("hub_content_search_keywords")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    hub_content_description.unwrap_or_default(),
                )
                .with_field(
                    "hub_content_search_keywords",
                    hub_content_search_keywords.unwrap_or_default(),
                )
                .with_field("support_status", support_status.unwrap_or_default())
                .with_field(
                    "hub_content_version",
                    hub_content_version.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    hub_content_markdown.unwrap_or_default(),
                )
                .with_field(
                    "hub_content_display_name",
                    hub_content_display_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a hub_content resource
    async fn read_hub_content(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_hub_content(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let hub_content_description = input.get_optional_string("hub_content_description")?;
            let hub_content_search_keywords =
    ...
    async fn delete_hub_content(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn read_pipeline_definition_for_execution(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_pipeline_definition_for_execution(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_code_repository(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    code_repository_name.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
    ...
    async fn read_code_repository(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_code_repository(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_pipeline(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let tags = input.get_optional_string("tags")?;
            let parallelism_configuration =
                input.get_optional_string("parallelism_configuration")?;
            ...
            let pipeline_definition_s3_location =
                input.get_optional_string("pipeline_definition_s3_location")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    pipeline_display_name.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "parallelism_configuration",
                    parallelism_configuration.unwrap_or_default(),
                )
                .with_field(
                ...
                .with_field(
                    "pipeline_definition",
                    pipeline_definition.unwrap_or_default(),
                )
                .with_field(
                    "pipeline_definition_s3_location",
                    pipeline_definition_s3_location.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_monitoring_schedule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    monitoring_schedule_config.unwrap_or_default(),
                )
                .with_field(
                    "monitoring_schedule_name",
                    monitoring_schedule_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a monitoring_schedule resource
    async fn read_monitoring_schedule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_monitoring_schedule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_pipeline_execution(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let parallelism_configuration =
            ...
            let pipeline_execution_description =
                input.get_optional_string("pipeline_execution_description")?;
            let pipeline_execution_display_name =
                input.get_optional_string("pipeline_execution_display_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    pipeline_execution_arn.unwrap_or_default(),
                )
                .with_field(
                    "pipeline_execution_description",
                    pipeline_execution_description.unwrap_or_default(),
                )
                .with_field(
                    "pipeline_execution_display_name",
                    pipeline_execution_display_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a pipeline_execution resource
    async fn read_pipeline_execution(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_pipeline_execution(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_app_image_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let kernel_gateway_image_config =
                input.get_optional_string("kernel_gateway_image_config")?;
            let code_editor_app_image_config =
                input.get_optional_string("code_editor_app_image_config")?;
            let tags = input.get_optional_string("tags")?;
            let app_image_config_name = input.get_string("app_image_config_name")?;
            let jupyter_lab_app_image_config =
                input.get_optional_string("jupyter_lab_app_image_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    kernel_gateway_image_config.unwrap_or_default(),
                )
                .with_field(
                    "code_editor_app_image_config",
                    code_editor_app_image_config.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "app_image_config_name",
                    app_image_config_name.unwrap_or_default(),
                )
                .with_field(
                    "jupyter_lab_app_image_config",
                    jupyter_lab_app_image_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a app_image_config resource
    async fn read_app_image_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_app_image_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_presigned_domain_url(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_presigned_domain_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_presigned_domain_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_data_quality_job_definition(
        ...
        self.provider.runtime().block_on(async {
            ...
            let data_quality_job_output_config =
                input.get_string("data_quality_job_output_config")?;
            let tags = input.get_optional_string("tags")?;
            let network_config = input.get_optional_string("network_config")?;
            let data_quality_app_specification =
                input.get_string("data_quality_app_specification")?;
            let data_quality_baseline_config =
                input.get_optional_string("data_quality_baseline_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "job_definition_name",
                    job_definition_name.unwrap_or_default(),
                )
                .with_field("job_resources", job_resources.unwrap_or_default())
                .with_field(
                    "data_quality_job_input",
                    data_quality_job_input.unwrap_or_default(),
                )
                .with_field(
                    "data_quality_job_output_config",
                    data_quality_job_output_config.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("network_config", network_config.unwrap_or_default())
                .with_field(
                    "data_quality_app_specification",
                    data_quality_app_specification.unwrap_or_default(),
                )
                .with_field(
                    "data_quality_baseline_config",
                    data_quality_baseline_config.unwrap_or_default(),
                )
    ...
    async fn read_data_quality_job_definition(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_data_quality_job_definition(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_labeling_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            let role_arn = input.get_string("role_arn")?;
            let label_category_config_s3_uri =
                input.get_optional_string("label_category_config_s3_uri")?;
            let human_task_config = input.get_string("human_task_config")?;
            let input_config = input.get_string("input_config")?;
            let output_config = input.get_string("output_config")?;
            let labeling_job_algorithms_config =
                input.get_optional_string("labeling_job_algorithms_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    label_attribute_name.unwrap_or_default(),
                )
                .with_field("role_arn", role_arn.unwrap_or_default())
                .with_field(
                    "label_category_config_s3_uri",
                    label_category_config_s3_uri.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    labeling_job_algorithms_config.unwrap_or_default(),
                )
                .with_field(
                    "stopping_conditions",
                    stopping_conditions.unwrap_or_default(),
                ))
        })
    }

    /// Read a labeling_job resource
    async fn read_labeling_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_labeling_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let labeling_job_name = input.get_string("labeling_job_name")?;
    ...
    async fn delete_labeling_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_algorithm(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    algorithm_description.unwrap_or_default(),
                )
                .with_field(
                    "training_specification",
                    training_specification.unwrap_or_default(),
                )
                .with_field(
                    "inference_specification",
                    inference_specification.unwrap_or_default(),
                )
                .with_field(
                    "validation_specification",
                    validation_specification.unwrap_or_default(),
                )
                .with_field(
                    "certify_for_marketplace",
                    certify_for_marketplace.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default()))
        })
    }
    ...
    async fn read_algorithm(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_algorithm(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let algorithm_name = input.get_string("algorithm_name")?;
            let algorithm_description = input.get_optional_string("algorithm_description")?;
    ...
    async fn create_model_explainability_job_definition(
        ...
        self.provider.runtime().block_on(async {
            ...
            let stopping_condition = input.get_optional_string("stopping_condition")?;
            let job_resources = input.get_string("job_resources")?;
            let model_explainability_app_specification =
                input.get_string("model_explainability_app_specification")?;
            let job_definition_name = input.get_string("job_definition_name")?;
            let model_explainability_job_input =
                input.get_string("model_explainability_job_input")?;
            let model_explainability_baseline_config =
                input.get_optional_string("model_explainability_baseline_config")?;
            let tags = input.get_optional_string("tags")?;
            let network_config = input.get_optional_string("network_config")?;
            let model_explainability_job_output_config =
                input.get_string("model_explainability_job_output_config")?;
            let role_arn = input.get_string("role_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    model_explainability_app_specification.unwrap_or_default(),
                )
                .with_field(
                    "job_definition_name",
                    job_definition_name.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    model_explainability_job_input.unwrap_or_default(),
                )
                .with_field(
                    "model_explainability_baseline_config",
                    model_explainability_baseline_config.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("network_config", network_config.unwrap_or_default())
                .with_field(
                    "model_explainability_job_output_config",
                    model_explainability_job_output_config.unwrap_or_default(),
                )
                .with_field("role_arn", role_arn.unwrap_or_default()))
        })
    }
    ...
    async fn read_model_explainability_job_definition(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_model_explainability_job_definition(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_compute_quota(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_compute_quota(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_compute_quota(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let compute_quota_config = input.get_string("compute_quota_config")?;
            let activation_state = input.get_optional_string("activation_state")?;
    ...
    async fn delete_compute_quota(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_inference_experiment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "data_storage_config",
                    data_storage_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a inference_experiment resource
    async fn read_inference_experiment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_inference_experiment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_partner_app(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let enable_iam_session_based_identity =
                input.get_optional_string("enable_iam_session_based_identity")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    enable_iam_session_based_identity.unwrap_or_default(),
                )
    ...
    async fn read_partner_app(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_partner_app(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let kms_key_id = input.get_optional_string("kms_key_id")?;
            let maintenance_config = input.get_optional_string("maintenance_config")?;
    ...
    async fn delete_partner_app(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn read_inference_recommendations_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_inference_recommendations_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_training_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let enable_inter_container_traffic_encryption =
                input.get_optional_string("enable_inter_container_traffic_encryption")?;
            let profiler_rule_configurations =
                input.get_optional_string("profiler_rule_configurations")?;
            ...
            let tags = input.get_optional_string("tags")?;
            let debug_rule_configurations =
                input.get_optional_string("debug_rule_configurations")?;
            ...
            let enable_managed_spot_training =
                input.get_optional_string("enable_managed_spot_training")?;
            let tensor_board_output_config =
                input.get_optional_string("tensor_board_output_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    enable_inter_container_traffic_encryption.unwrap_or_default(),
                )
                .with_field(
                    "profiler_rule_configurations",
                    profiler_rule_configurations.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    debug_rule_configurations.unwrap_or_default(),
                )
                .with_field("hyper_parameters", hyper_parameters.unwrap_or_default())
                .with_field(
                    "algorithm_specification",
                    algorithm_specification.unwrap_or_default(),
                )
                .with_field(
                    "enable_managed_spot_training",
                    enable_managed_spot_training.unwrap_or_default(),
                )
                .with_field(
                    "tensor_board_output_config",
                    tensor_board_output_config.unwrap_or_default(),
                )
                .with_field(
                    "remote_debug_config",
                    remote_debug_config.unwrap_or_default(),
                )
                .with_field("infra_check_config", infra_check_config.unwrap_or_default())
                .with_field(
                    "session_chaining_config",
                    session_chaining_config.unwrap_or_default(),
                )
                .with_field("role_arn", role_arn.unwrap_or_default()))
        })
    }
    ...
    async fn read_training_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_training_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let output_data_config = input.get_string("output_data_config")?;
            let enable_network_isolation = input.get_optional_string("enable_network_isolation")?;
    ...
    async fn delete_training_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_model_bias_job_definition(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let job_definition_name = input.get_string("job_definition_name")?;
            let model_bias_baseline_config =
                input.get_optional_string("model_bias_baseline_config")?;
            let network_config = input.get_optional_string("network_config")?;
            let job_resources = input.get_string("job_resources")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    model_bias_baseline_config.unwrap_or_default(),
                )
                .with_field("network_config", network_config.unwrap_or_default())
                .with_field("job_resources", job_resources.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    ...
                    model_bias_app_specification.unwrap_or_default(),
                )
                .with_field("stopping_condition", stopping_condition.unwrap_or_default())
                .with_field(
                    "model_bias_job_input",
                    model_bias_job_input.unwrap_or_default(),
                )
                .with_field("role_arn", role_arn.unwrap_or_default())
                .with_field(
                    "model_bias_job_output_config",
                    model_bias_job_output_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a model_bias_job_definition resource
    async fn read_model_bias_job_definition(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_model_bias_job_definition(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_edge_deployment_stage(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let edge_deployment_plan_name = input.get_string("edge_deployment_plan_name")?;
    ...
    async fn read_edge_deployment_stage(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_edge_deployment_stage(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    notebook_instance_name.unwrap_or_default(),
                )
                .with_field(
                    "session_expiration_duration_in_seconds",
                    session_expiration_duration_in_seconds.unwrap_or_default(),
    ...
    async fn read_presigned_notebook_instance_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_presigned_notebook_instance_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_transform_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            let max_concurrent_transforms =
                input.get_optional_string("max_concurrent_transforms")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "data_capture_config",
                    data_capture_config.unwrap_or_default(),
                )
                .with_field(
                    "transform_resources",
                    transform_resources.unwrap_or_default(),
                )
                .with_field("max_payload_in_mb", max_payload_in_mb.unwrap_or_default())
                .with_field(
                    "max_concurrent_transforms",
                    max_concurrent_transforms.unwrap_or_default(),
                )
                .with_field(
                    "model_client_config",
                    model_client_config.unwrap_or_default(),
                )
    ...
    async fn read_transform_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_transform_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let experiment_config = input.get_optional_string("experiment_config")?;
    ...
    async fn delete_transform_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_hub_content_reference(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let hub_name = input.get_string("hub_name")?;
            let sage_maker_public_hub_content_arn =
                input.get_string("sage_maker_public_hub_content_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    sage_maker_public_hub_content_arn.unwrap_or_default(),
                )
                .with_field("hub_content_name", hub_content_name.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
    ...
    async fn read_hub_content_reference(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_hub_content_reference(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn read_scaling_configuration_recommendation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_scaling_configuration_recommendation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_model_card(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_model_card(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_model_card(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let content = input.get_string("content")?;
            let model_card_name = input.get_string("model_card_name")?;
    ...
    async fn delete_model_card(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_studio_lifecycle_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let studio_lifecycle_config_name = input.get_string("studio_lifecycle_config_name")?;
            let studio_lifecycle_config_app_type =
                input.get_string("studio_lifecycle_config_app_type")?;
            let tags = input.get_optional_string("tags")?;
            let studio_lifecycle_config_content =
                input.get_string("studio_lifecycle_config_content")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    studio_lifecycle_config_name.unwrap_or_default(),
                )
                .with_field(
                    "studio_lifecycle_config_app_type",
                    studio_lifecycle_config_app_type.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "studio_lifecycle_config_content",
                    studio_lifecycle_config_content.unwrap_or_default(),
                ))
        })
    }

    /// Read a studio_lifecycle_config resource
    async fn read_studio_lifecycle_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_studio_lifecycle_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_user_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let single_sign_on_user_identifier =
                input.get_optional_string("single_sign_on_user_identifier")?;
            let domain_id = input.get_string("domain_id")?;
            let single_sign_on_user_value =
                input.get_optional_string("single_sign_on_user_value")?;
            let user_profile_name = input.get_string("user_profile_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    single_sign_on_user_identifier.unwrap_or_default(),
                )
                .with_field("domain_id", domain_id.unwrap_or_default())
                .with_field(
                    "single_sign_on_user_value",
                    single_sign_on_user_value.unwrap_or_default(),
                )
                .with_field("user_profile_name", user_profile_name.unwrap_or_default()))
        })
    }
    ...
    async fn create_endpoint_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            let data_capture_config = input.get_optional_string("data_capture_config")?;
            let kms_key_id = input.get_optional_string("kms_key_id")?;
            let shadow_production_variants =
                input.get_optional_string("shadow_production_variants")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    async_inference_config.unwrap_or_default(),
                )
                .with_field(
                    "data_capture_config",
                    data_capture_config.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    shadow_production_variants.unwrap_or_default(),
                )
                .with_field(
                    "production_variants",
                    production_variants.unwrap_or_default(),
                )
    ...
    async fn read_endpoint_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_endpoint_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_endpoint_weights_and_capacities(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let endpoint_name = input.get_string("endpoint_name")?;
            let desired_weights_and_capacities =
                input.get_string("desired_weights_and_capacities")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    desired_weights_and_capacities.unwrap_or_default(),
                ))
        })
    }

    /// Read a endpoint_weights_and_capacities resource
    async fn read_endpoint_weights_and_capacities(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_endpoint_weights_and_capacities(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_training_plan(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let spare_instance_count_per_ultra_server =
                input.get_optional_string("spare_instance_count_per_ultra_server")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    training_plan_offering_id.unwrap_or_default(),
                )
                .with_field(
                    "spare_instance_count_per_ultra_server",
                    spare_instance_count_per_ultra_server.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default()))
        })
    }
    ...
    async fn read_training_plan(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_training_plan(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let training_plan_name = input.get_string("training_plan_name")?;
            let training_plan_offering_id = input.get_string("training_plan_offering_id")?;
    ...
    async fn delete_training_plan(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let restricted_instance_groups =
                input.get_optional_string("restricted_instance_groups")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    tiered_storage_config.unwrap_or_default(),
                )
                .with_field("vpc_config", vpc_config.unwrap_or_default())
                ...
                .with_field(
                    ...
                    node_provisioning_mode.unwrap_or_default(),
                )
                .with_field(
                    "restricted_instance_groups",
                    restricted_instance_groups.unwrap_or_default(),
                )
    ...
    async fn create_devices(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_devices(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_devices(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let devices = input.get_string("devices")?;
            let device_fleet_name = input.get_string("device_fleet_name")?;
    ...
    async fn delete_devices(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_compilation_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let stopping_condition = input.get_string("stopping_condition")?;
            ...
            let output_config = input.get_string("output_config")?;
            let compilation_job_name = input.get_string("compilation_job_name")?;
            let model_package_version_arn =
                input.get_optional_string("model_package_version_arn")?;
            let role_arn = input.get_string("role_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    model_package_version_arn.unwrap_or_default(),
                )
                .with_field("role_arn", role_arn.unwrap_or_default()))
        })
    }
    ...
    async fn read_compilation_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_compilation_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_optimization_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    optimization_environment.unwrap_or_default(),
                )
                .with_field(
                    "optimization_configs",
                    optimization_configs.unwrap_or_default(),
                )
                .with_field(
                    "optimization_job_name",
                    optimization_job_name.unwrap_or_default(),
                )
                .with_field(
                    "deployment_instance_type",
                    deployment_instance_type.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("stopping_condition", stopping_condition.unwrap_or_default())
                .with_field("vpc_config", vpc_config.unwrap_or_default())
    ...
    async fn read_optimization_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_optimization_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_project(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let service_catalog_provisioning_details =
                input.get_optional_string("service_catalog_provisioning_details")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "project_description",
                    project_description.unwrap_or_default(),
                )
                .with_field("project_name", project_name.unwrap_or_default())
                .with_field(
                    "service_catalog_provisioning_details",
                    service_catalog_provisioning_details.unwrap_or_default(),
                )
    ...
    async fn delete_sagemaker_servicecatalog_portfolio_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_auto_ml_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let generate_candidate_definitions_only =
                input.get_optional_string("generate_candidate_definitions_only")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "model_deploy_config",
                    model_deploy_config.unwrap_or_default(),
                )
                .with_field(
                    "auto_ml_job_objective",
                    auto_ml_job_objective.unwrap_or_default(),
                )
                .with_field("input_data_config", input_data_config.unwrap_or_default())
                ...
                .with_field(
                    ...
                    generate_candidate_definitions_only.unwrap_or_default(),
                )
    ...
    async fn read_auto_ml_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_auto_ml_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let model_deploy_config = input.get_optional_string("model_deploy_config")?;
            let auto_ml_job_objective = input.get_optional_string("auto_ml_job_objective")?;
    ...
    async fn delete_auto_ml_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_model_package(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let tags = input.get_optional_string("tags")?;
            let model_package_description =
                input.get_optional_string("model_package_description")?;
            let validation_specification = input.get_optional_string("validation_specification")?;
            let source_algorithm_specification =
                input.get_optional_string("source_algorithm_specification")?;
            let model_metrics = input.get_optional_string("model_metrics")?;
            let additional_inference_specifications =
                input.get_optional_string("additional_inference_specifications")?;
            let source_uri = input.get_optional_string("source_uri")?;
            let inference_specification = input.get_optional_string("inference_specification")?;
            let task = input.get_optional_string("task")?;
            let customer_metadata_properties =
                input.get_optional_string("customer_metadata_properties")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    model_package_group_name.unwrap_or_default(),
                )
                .with_field("security_config", security_config.unwrap_or_default())
                ...
                .with_field(
                    ...
                    drift_check_baselines.unwrap_or_default(),
                )
                .with_field(
                    "certify_for_marketplace",
                    certify_for_marketplace.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    model_approval_status.unwrap_or_default(),
                )
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field("sample_payload_url", sample_payload_url.unwrap_or_default())
                .with_field(
                    "skip_model_validation",
                    skip_model_validation.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "model_package_description",
                    model_package_description.unwrap_or_default(),
                )
                .with_field(
                    "validation_specification",
                    validation_specification.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    source_algorithm_specification.unwrap_or_default(),
                )
                .with_field("model_metrics", model_metrics.unwrap_or_default())
                .with_field(
                    "additional_inference_specifications",
                    additional_inference_specifications.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    customer_metadata_properties.unwrap_or_default(),
                ))
        })
    }

    /// Read a model_package resource
    async fn read_model_package(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_model_package(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let model_package_group_name = input.get_optional_string("model_package_group_name")?;
            let security_config = input.get_optional_string("security_config")?;
    ...
    async fn delete_model_package(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_reserved_capacity(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_reserved_capacity(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_reserved_capacity(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_search_suggestions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_search_suggestions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_search_suggestions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_mlflow_tracking_server(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tracking_server_name = input.get_string("tracking_server_name")?;
            let artifact_store_uri = input.get_string("artifact_store_uri")?;
            let automatic_model_registration =
                input.get_optional_string("automatic_model_registration")?;
            let role_arn = input.get_string("role_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    automatic_model_registration.unwrap_or_default(),
                )
                .with_field("role_arn", role_arn.unwrap_or_default())
                .with_field(
                ...
                .with_field(
                    ...
                    tracking_server_size.unwrap_or_default(),
                )
    ...
    async fn read_mlflow_tracking_server(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_mlflow_tracking_server(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_device_fleet(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    enable_iot_role_alias.unwrap_or_default(),
                )
                .with_field("device_fleet_name", device_fleet_name.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field("output_config", output_config.unwrap_or_default())
    ...
    async fn read_device_fleet(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_device_fleet(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let enable_iot_role_alias = input.get_optional_string("enable_iot_role_alias")?;
            let device_fleet_name = input.get_string("device_fleet_name")?;
    ...
    async fn delete_device_fleet(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_notebook_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let instance_metadata_service_configuration =
                input.get_optional_string("instance_metadata_service_configuration")?;
            let additional_code_repositories =
                input.get_optional_string("additional_code_repositories")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "platform_identifier",
                    platform_identifier.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    instance_metadata_service_configuration.unwrap_or_default(),
                )
                .with_field(
                    "additional_code_repositories",
                    additional_code_repositories.unwrap_or_default(),
                )
                .with_field(
                    "direct_internet_access",
                    direct_internet_access.unwrap_or_default(),
                )
                .with_field("volume_size_in_gb", volume_size_in_gb.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "lifecycle_config_name",
                    lifecycle_config_name.unwrap_or_default(),
                )
                .with_field("subnet_id", subnet_id.unwrap_or_default())
                .with_field("kms_key_id", kms_key_id.unwrap_or_default())
                .with_field(
                    "default_code_repository",
                    default_code_repository.unwrap_or_default(),
                ))
        })
    }

    /// Read a notebook_instance resource
    async fn read_notebook_instance(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_notebook_instance(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_device_fleet_report(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_device_fleet_report(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_device_fleet_report(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    desired_runtime_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a inference_component_runtime_config resource
    async fn read_inference_component_runtime_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_inference_component_runtime_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_feature_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let record_identifier_feature_name =
                input.get_string("record_identifier_feature_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    offline_store_config.unwrap_or_default(),
                )
                .with_field("description", description.unwrap_or_default())
                .with_field("role_arn", role_arn.unwrap_or_default())
                .with_field(
                    "online_store_config",
                    online_store_config.unwrap_or_default(),
                )
                .with_field("feature_group_name", feature_group_name.unwrap_or_default())
                .with_field(
                    "event_time_feature_name",
                    event_time_feature_name.unwrap_or_default(),
                )
                .with_field(
                    "feature_definitions",
                    feature_definitions.unwrap_or_default(),
                )
                .with_field(
                    "record_identifier_feature_name",
                    record_identifier_feature_name.unwrap_or_default(),
                )
    ...
    async fn create_auto_ml_job_v2(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let security_config = input.get_optional_string("security_config")?;
            ...
            let auto_ml_job_input_data_config =
                input.get_string("auto_ml_job_input_data_config")?;
            let output_data_config = input.get_string("output_data_config")?;
            let role_arn = input.get_string("role_arn")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    auto_ml_compute_config.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "model_deploy_config",
                ...
                .with_field(
                    ...
                    auto_ml_problem_type_config.unwrap_or_default(),
                )
                .with_field(
                    "auto_ml_job_input_data_config",
                    auto_ml_job_input_data_config.unwrap_or_default(),
                )
                .with_field("output_data_config", output_data_config.unwrap_or_default())
                .with_field("role_arn", role_arn.unwrap_or_default()))
        })
    ...
    async fn read_auto_ml_job_v2(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_auto_ml_job_v2(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_lineage_group_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_lineage_group_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_lineage_group_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_image_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_image_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_image_version(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let release_notes = input.get_optional_string("release_notes")?;
            let client_token = input.get_string("client_token")?;
    ...
    async fn delete_image_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_hyper_parameter_tuning_job(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let hyper_parameter_tuning_job_name =
                input.get_string("hyper_parameter_tuning_job_name")?;
            let hyper_parameter_tuning_job_config =
                input.get_string("hyper_parameter_tuning_job_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    hyper_parameter_tuning_job_name.unwrap_or_default(),
                )
                .with_field(
                    "hyper_parameter_tuning_job_config",
                    hyper_parameter_tuning_job_config.unwrap_or_default(),
                )
                .with_field(
                    "training_job_definition",
                    training_job_definition.unwrap_or_default(),
                )
                .with_field(
                    "training_job_definitions",
                    training_job_definitions.unwrap_or_default(),
                )
    ...
    async fn read_hyper_parameter_tuning_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_hyper_parameter_tuning_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_processing_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    processing_resources.unwrap_or_default(),
                )
                .with_field("network_config", network_config.unwrap_or_default())
                .with_field("processing_inputs", processing_inputs.unwrap_or_default())
                .with_field(
                    "processing_output_config",
                    processing_output_config.unwrap_or_default(),
                )
                .with_field("environment", environment.unwrap_or_default())
                .with_field("experiment_config", experiment_config.unwrap_or_default())
                .with_field(
                    "processing_job_name",
                    processing_job_name.unwrap_or_default(),
                )
                .with_field("stopping_condition", stopping_condition.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
    ...
    async fn read_processing_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_processing_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn read_model_package_group_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_model_package_group_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_cluster_event(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cluster_event(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_cluster_event(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_cluster_event(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_feature_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let feature_group_name = input.get_string("feature_group_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "parameter_additions",
                    parameter_additions.unwrap_or_default(),
                ))
        })
    }

    /// Read a feature_metadata resource
    async fn read_feature_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_feature_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_cluster_node(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cluster_node(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_cluster_node(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_cluster_node(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_domain(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let app_security_group_management =
                input.get_optional_string("app_security_group_management")?;
            ...
            let home_efs_file_system_kms_key_id =
                input.get_optional_string("home_efs_file_system_kms_key_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    default_user_settings.unwrap_or_default(),
                )
                .with_field(
                    "app_security_group_management",
                    app_security_group_management.unwrap_or_default(),
                )
                .with_field(
                    "default_space_settings",
                    default_space_settings.unwrap_or_default(),
                )
    ...
    async fn read_cluster_scheduler_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_cluster_scheduler_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_workteam(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let workforce_name = input.get_optional_string("workforce_name")?;
            let notification_configuration =
                input.get_optional_string("notification_configuration")?;
            let worker_access_configuration =
                input.get_optional_string("worker_access_configuration")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    worker_access_configuration.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
    ...
    async fn read_workteam(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_workteam(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let workforce_name = input.get_optional_string("workforce_name")?;
            let notification_configuration =
    ...
    async fn delete_workteam(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_monitoring_alert(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let monitoring_schedule_name = input.get_string("monitoring_schedule_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    monitoring_alert_name.unwrap_or_default(),
                )
                .with_field(
                    "datapoints_to_alert",
                    datapoints_to_alert.unwrap_or_default(),
                )
    ...
    async fn read_monitoring_alert(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_monitoring_alert(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_model_quality_job_definition(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let model_quality_app_specification =
                input.get_string("model_quality_app_specification")?;
            let model_quality_job_output_config =
                input.get_string("model_quality_job_output_config")?;
            let model_quality_baseline_config =
                input.get_optional_string("model_quality_baseline_config")?;
            let stopping_condition = input.get_optional_string("stopping_condition")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    model_quality_app_specification.unwrap_or_default(),
                )
                .with_field(
                    "model_quality_job_output_config",
                    model_quality_job_output_config.unwrap_or_default(),
                )
                .with_field(
                    "model_quality_baseline_config",
                    model_quality_baseline_config.unwrap_or_default(),
                )
                .with_field("stopping_condition", stopping_condition.unwrap_or_default())
                .with_field(
                    "model_quality_job_input",
                    model_quality_job_input.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("network_config", network_config.unwrap_or_default())
                .with_field("role_arn", role_arn.unwrap_or_default())
    ...
    async fn read_model_quality_job_definition(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_model_quality_job_definition(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn read_hub_content_presigned_urls(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_hub_content_presigned_urls(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_model_package_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let model_package_group_description =
                input.get_optional_string("model_package_group_description")?;
            let tags = input.get_optional_string("tags")?;
            let model_package_group_name = input.get_string("model_package_group_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    model_package_group_description.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "model_package_group_name",
    ...
    async fn read_model_package_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_model_package_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_action(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_action(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_action(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let action_name = input.get_string("action_name")?;
            let properties = input.get_optional_string("properties")?;
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    space_sharing_settings.unwrap_or_default(),
                )
                .with_field("space_name", space_name.unwrap_or_default()))
        })
    }
    ...
    async fn create_workforce(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    workforce_vpc_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a workforce resource
    async fn read_workforce(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn update_workforce(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let workforce_name = input.get_string("workforce_name")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_workforce(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn create_model_card_export_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    model_card_export_job_name.unwrap_or_default(),
                )
                .with_field("output_config", output_config.unwrap_or_default())
                .with_field("model_card_name", model_card_name.unwrap_or_default()))
        })
    ...
    async fn read_model_card_export_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_model_card_export_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
    ...
    async fn read_partner_app_presigned_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.sagemaker_client
    ...
    async fn delete_partner_app_presigned_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.sagemaker_client
