//! Sagemaker Service
//!
//! Auto-generated service module for sagemaker

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for sagemaker
...
impl<'a> SagemakerService<'a> {
    ...
    /// Get auto_mljob resource handler
    pub fn auto_mljob(&self) -> resources::Auto_mljob<'_> {
        resources::Auto_mljob::new(self.provider)
    }
    ...
    /// Get auto_mljob_v2 resource handler
    pub fn auto_mljob_v2(&self) -> resources::Auto_mljob_v2<'_> {
        resources::Auto_mljob_v2::new(self.provider)
    }
