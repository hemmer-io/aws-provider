...
impl<'a> Data_quality_job_definition<'a> {
    ...
    pub async fn create(&self, data_quality_baseline_config: Option<String>, data_quality_job_output_config: String, network_config: Option<String>, tags: Option<Vec<String>>, job_definition_name: String, job_resources: String, role_arn: String, data_quality_job_input: String, stopping_condition: Option<String>, data_quality_app_specification: String) -> Result<String> {
