...
impl<'a> Data_quality_job_definition<'a> {
    ...
    pub async fn create(&self, job_resources: String, stopping_condition: Option<String>, data_quality_job_output_config: String, data_quality_baseline_config: Option<String>, role_arn: String, data_quality_job_input: String, job_definition_name: String, network_config: Option<String>, tags: Option<Vec<String>>, data_quality_app_specification: String) -> Result<String> {
