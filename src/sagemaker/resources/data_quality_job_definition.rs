...
impl<'a> Data_quality_job_definition<'a> {
    ...
    pub async fn create(&self, role_arn: String, job_definition_name: String, job_resources: String, data_quality_job_input: String, data_quality_job_output_config: String, tags: Option<Vec<String>>, network_config: Option<String>, data_quality_app_specification: String, data_quality_baseline_config: Option<String>, stopping_condition: Option<String>) -> Result<String> {
