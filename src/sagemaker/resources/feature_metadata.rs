...
impl<'a> Feature_metadata<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, parameter_additions: Option<Vec<String>>, parameter_removals: Option<Vec<String>>, feature_name: Option<String>, description: Option<String>, feature_group_name: Option<String>) -> Result<()> {
