...
impl<'a> Feature_metadata<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, feature_name: Option<String>, feature_group_name: Option<String>, parameter_additions: Option<Vec<String>>, description: Option<String>, parameter_removals: Option<Vec<String>>) -> Result<()> {
