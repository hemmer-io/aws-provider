...
impl<'a> Compilation_job<'a> {
    ...
    pub async fn create(&self, stopping_condition: String, input_config: Option<String>, vpc_config: Option<String>, tags: Option<Vec<String>>, output_config: String, compilation_job_name: String, model_package_version_arn: Option<String>, role_arn: String) -> Result<String> {
