...
impl<'a> Inference_component<'a> {
    ...
    pub async fn create(&self, inference_component_name: String, variant_name: Option<String>, tags: Option<Vec<String>>, endpoint_name: String, specification: String, runtime_config: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, inference_component_name: Option<String>, variant_name: Option<String>, tags: Option<Vec<String>>, endpoint_name: Option<String>, specification: Option<String>, runtime_config: Option<String>) -> Result<()> {
