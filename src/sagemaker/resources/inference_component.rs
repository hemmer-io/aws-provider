...
impl<'a> Inference_component<'a> {
    ...
    pub async fn create(&self, runtime_config: Option<String>, endpoint_name: String, tags: Option<Vec<String>>, specification: String, variant_name: Option<String>, inference_component_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, runtime_config: Option<String>, endpoint_name: Option<String>, tags: Option<Vec<String>>, specification: Option<String>, variant_name: Option<String>, inference_component_name: Option<String>) -> Result<()> {
