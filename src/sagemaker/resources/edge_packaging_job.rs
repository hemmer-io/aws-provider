...
impl<'a> Edge_packaging_job<'a> {
    ...
    pub async fn create(&self, compilation_job_name: String, edge_packaging_job_name: String, model_version: String, role_arn: String, output_config: String, resource_key: Option<String>, model_name: String, tags: Option<Vec<String>>) -> Result<String> {
