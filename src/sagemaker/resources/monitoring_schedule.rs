...
impl<'a> Monitoring_schedule<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, monitoring_schedule_name: String, monitoring_schedule_config: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, monitoring_schedule_name: Option<String>, monitoring_schedule_config: Option<String>) -> Result<()> {
