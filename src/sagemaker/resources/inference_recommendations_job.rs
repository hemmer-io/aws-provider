...
impl<'a> Inference_recommendations_job<'a> {
    ...
    pub async fn create(&self, job_name: String, input_config: String, stopping_conditions: Option<String>, tags: Option<Vec<String>>, job_type: String, job_description: Option<String>, role_arn: String, output_config: Option<String>) -> Result<String> {
