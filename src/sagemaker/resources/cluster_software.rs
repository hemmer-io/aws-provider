...
impl<'a> Cluster_software<'a> {
    ...
    pub async fn update(&self, id: &str, cluster_name: Option<String>, image_id: Option<String>, deployment_config: Option<String>, instance_groups: Option<Vec<String>>) -> Result<()> {
