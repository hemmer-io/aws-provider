...
impl<'a> Flow_definition<'a> {
    ...
    pub async fn create(&self, flow_definition_name: String, human_loop_config: Option<String>, human_loop_request_source: Option<String>, tags: Option<Vec<String>>, output_config: String, role_arn: String, human_loop_activation_config: Option<String>) -> Result<String> {
