...
impl<'a> Presigned_domain_url<'a> {
    ...
    pub async fn create(&self, domain_id: String, expires_in_seconds: Option<i64>, space_name: Option<String>, landing_uri: Option<String>, user_profile_name: String, session_expiration_duration_in_seconds: Option<i64>) -> Result<String> {
