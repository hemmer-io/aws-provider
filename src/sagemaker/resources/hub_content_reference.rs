...
impl<'a> Hub_content_reference<'a> {
    ...
    pub async fn create(&self, hub_content_name: Option<String>, tags: Option<Vec<String>>, min_version: Option<String>, hub_name: String, sage_maker_public_hub_content_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, hub_content_name: Option<String>, tags: Option<Vec<String>>, min_version: Option<String>, hub_name: Option<String>, sage_maker_public_hub_content_arn: Option<String>) -> Result<()> {
