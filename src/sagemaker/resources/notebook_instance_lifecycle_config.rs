...
impl<'a> Notebook_instance_lifecycle_config<'a> {
    ...
    pub async fn create(&self, notebook_instance_lifecycle_config_name: String, on_create: Option<Vec<String>>, tags: Option<Vec<String>>, on_start: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, notebook_instance_lifecycle_config_name: Option<String>, on_create: Option<Vec<String>>, tags: Option<Vec<String>>, on_start: Option<Vec<String>>) -> Result<()> {
