...
impl<'a> Notebook_instance_lifecycle_config<'a> {
    ...
    pub async fn create(&self, on_start: Option<Vec<String>>, tags: Option<Vec<String>>, notebook_instance_lifecycle_config_name: String, on_create: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, on_start: Option<Vec<String>>, tags: Option<Vec<String>>, notebook_instance_lifecycle_config_name: Option<String>, on_create: Option<Vec<String>>) -> Result<()> {
