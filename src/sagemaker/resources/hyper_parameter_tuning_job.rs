...
impl<'a> Hyper_parameter_tuning_job<'a> {
    ...
    pub async fn create(&self, hyper_parameter_tuning_job_name: String, training_job_definition: Option<String>, hyper_parameter_tuning_job_config: String, warm_start_config: Option<String>, tags: Option<Vec<String>>, training_job_definitions: Option<Vec<String>>, autotune: Option<String>) -> Result<String> {
