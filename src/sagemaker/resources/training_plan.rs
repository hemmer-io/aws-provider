...
impl<'a> Training_plan<'a> {
    ...
    pub async fn create(&self, training_plan_name: String, training_plan_offering_id: String, spare_instance_count_per_ultra_server: Option<i64>, tags: Option<Vec<String>>) -> Result<String> {
