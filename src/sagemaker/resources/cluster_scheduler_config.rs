...
impl<'a> Cluster_scheduler_config<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, cluster_arn: String, description: Option<String>, name: String, scheduler_config: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, cluster_arn: Option<String>, description: Option<String>, name: Option<String>, scheduler_config: Option<String>) -> Result<()> {
