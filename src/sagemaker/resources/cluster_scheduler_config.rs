...
impl<'a> Cluster_scheduler_config<'a> {
    ...
    pub async fn create(&self, cluster_arn: String, scheduler_config: String, tags: Option<Vec<String>>, name: String, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, cluster_arn: Option<String>, scheduler_config: Option<String>, tags: Option<Vec<String>>, name: Option<String>, description: Option<String>) -> Result<()> {
