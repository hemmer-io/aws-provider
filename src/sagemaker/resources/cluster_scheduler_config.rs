...
impl<'a> Cluster_scheduler_config<'a> {
    ...
    pub async fn create(&self, scheduler_config: String, tags: Option<Vec<String>>, cluster_arn: String, description: Option<String>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, scheduler_config: Option<String>, tags: Option<Vec<String>>, cluster_arn: Option<String>, description: Option<String>, name: Option<String>) -> Result<()> {
