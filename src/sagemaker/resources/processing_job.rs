...
impl<'a> Processing_job<'a> {
    ...
    pub async fn create(&self, processing_resources: String, network_config: Option<String>, processing_inputs: Option<Vec<String>>, processing_output_config: Option<String>, environment: Option<HashMap<String, String>>, experiment_config: Option<String>, processing_job_name: String, stopping_condition: Option<String>, tags: Option<Vec<String>>, app_specification: String, role_arn: String) -> Result<String> {
