...
impl<'a> Model_quality_job_definition<'a> {
    ...
    pub async fn create(&self, model_quality_baseline_config: Option<String>, job_resources: String, tags: Option<Vec<String>>, model_quality_job_input: String, job_definition_name: String, network_config: Option<String>, stopping_condition: Option<String>, model_quality_app_specification: String, model_quality_job_output_config: String, role_arn: String) -> Result<String> {
