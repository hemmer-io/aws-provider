...
impl<'a> Model_quality_job_definition<'a> {
    ...
    pub async fn create(&self, job_resources: String, tags: Option<Vec<String>>, model_quality_job_input: String, model_quality_job_output_config: String, job_definition_name: String, model_quality_baseline_config: Option<String>, role_arn: String, model_quality_app_specification: String, stopping_condition: Option<String>, network_config: Option<String>) -> Result<String> {
