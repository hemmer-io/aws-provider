...
impl<'a> Model_quality_job_definition<'a> {
    ...
    pub async fn create(&self, model_quality_app_specification: String, model_quality_job_output_config: String, model_quality_baseline_config: Option<String>, stopping_condition: Option<String>, model_quality_job_input: String, tags: Option<Vec<String>>, network_config: Option<String>, role_arn: String, job_definition_name: String, job_resources: String) -> Result<String> {
