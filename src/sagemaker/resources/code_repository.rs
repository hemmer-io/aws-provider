...
impl<'a> Code_repository<'a> {
    ...
    pub async fn create(&self, code_repository_name: String, tags: Option<Vec<String>>, git_config: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, code_repository_name: Option<String>, tags: Option<Vec<String>>, git_config: Option<String>) -> Result<()> {
