...
impl<'a> Code_repository<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, code_repository_name: String, git_config: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, code_repository_name: Option<String>, git_config: Option<String>) -> Result<()> {
