...
impl<'a> Code_repository<'a> {
    ...
    pub async fn create(&self, code_repository_name: String, git_config: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, code_repository_name: Option<String>, git_config: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
