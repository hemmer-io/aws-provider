...
impl<'a> Edge_deployment_plan<'a> {
    ...
    pub async fn create(&self, edge_deployment_plan_name: String, device_fleet_name: String, model_configs: Vec<String>, stages: Option<Vec<String>>, tags: Option<Vec<String>>) -> Result<String> {
