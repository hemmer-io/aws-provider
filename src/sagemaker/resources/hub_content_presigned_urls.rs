...
impl<'a> Hub_content_presigned_urls<'a> {
    ...
    pub async fn create(&self, access_config: Option<String>, hub_content_name: String, hub_content_version: Option<String>, max_results: Option<i64>, hub_name: String, next_token: Option<String>, hub_content_type: String) -> Result<String> {
