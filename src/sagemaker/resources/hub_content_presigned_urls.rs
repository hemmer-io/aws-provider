...
impl<'a> Hub_content_presigned_urls<'a> {
    ...
    pub async fn create(&self, hub_content_name: String, access_config: Option<String>, max_results: Option<i64>, hub_content_version: Option<String>, next_token: Option<String>, hub_content_type: String, hub_name: String) -> Result<String> {
