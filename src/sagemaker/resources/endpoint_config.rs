...
impl<'a> Endpoint_config<'a> {
    ...
    pub async fn create(&self, kms_key_id: Option<String>, async_inference_config: Option<String>, tags: Option<Vec<String>>, shadow_production_variants: Option<Vec<String>>, execution_role_arn: Option<String>, production_variants: Vec<String>, endpoint_config_name: String, data_capture_config: Option<String>, vpc_config: Option<String>, explainer_config: Option<String>, enable_network_isolation: Option<bool>) -> Result<String> {
