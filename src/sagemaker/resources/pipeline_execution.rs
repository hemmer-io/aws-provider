...
impl<'a> Pipeline_execution<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, pipeline_execution_description: Option<String>, pipeline_execution_display_name: Option<String>, parallelism_configuration: Option<String>, pipeline_execution_arn: Option<String>) -> Result<()> {
