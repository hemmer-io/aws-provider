...
impl<'a> Model_bias_job_definition<'a> {
    ...
    pub async fn create(&self, job_definition_name: String, model_bias_baseline_config: Option<String>, network_config: Option<String>, job_resources: String, tags: Option<Vec<String>>, model_bias_app_specification: String, stopping_condition: Option<String>, model_bias_job_input: String, role_arn: String, model_bias_job_output_config: String) -> Result<String> {
