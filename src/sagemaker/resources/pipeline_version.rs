...
impl<'a> Pipeline_version<'a> {
    ...
    pub async fn update(&self, id: &str, pipeline_version_display_name: Option<String>, pipeline_version_description: Option<String>, pipeline_version_id: Option<i64>, pipeline_arn: Option<String>) -> Result<()> {
