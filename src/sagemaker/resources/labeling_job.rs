...
impl<'a> Labeling_job<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, labeling_job_name: String, label_attribute_name: String, role_arn: String, label_category_config_s3_uri: Option<String>, human_task_config: String, input_config: String, output_config: String, labeling_job_algorithms_config: Option<String>, stopping_conditions: Option<String>) -> Result<String> {
