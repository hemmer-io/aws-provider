...
impl<'a> Configuration_set<'a> {
    ...
    pub async fn create(&self, delivery_options: Option<String>, reputation_options: Option<String>, configuration_set_name: String, tracking_options: Option<String>, sending_options: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
