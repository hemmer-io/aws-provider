...
impl<'a> ComprehendmedicalService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "icd10_cm_inference_job" => {
                self.plan_icd10_cm_inference_job(current_state, desired_input)
                    .await
            }
            "rx_norm_inference_job" => {
                self.plan_rx_norm_inference_job(current_state, desired_input)
                    .await
            }
            "phi_detection_job" => {
                self.plan_phi_detection_job(current_state, desired_input)
                    .await
            }
            "snomedct_inference_job" => {
                self.plan_snomedct_inference_job(current_state, desired_input)
                    .await
            }
            "entities_detection_v2_job" => {
                self.plan_entities_detection_v2_job(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "comprehendmedical", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "icd10_cm_inference_job" => self.create_icd10_cm_inference_job(input).await,
            "rx_norm_inference_job" => self.create_rx_norm_inference_job(input).await,
            "phi_detection_job" => self.create_phi_detection_job(input).await,
            "snomedct_inference_job" => self.create_snomedct_inference_job(input).await,
            "entities_detection_v2_job" => self.create_entities_detection_v2_job(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "comprehendmedical", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "icd10_cm_inference_job" => self.read_icd10_cm_inference_job(id).await,
            "rx_norm_inference_job" => self.read_rx_norm_inference_job(id).await,
            "phi_detection_job" => self.read_phi_detection_job(id).await,
            "snomedct_inference_job" => self.read_snomedct_inference_job(id).await,
            "entities_detection_v2_job" => self.read_entities_detection_v2_job(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "comprehendmedical", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "icd10_cm_inference_job" => self.update_icd10_cm_inference_job(id, input).await,
            "rx_norm_inference_job" => self.update_rx_norm_inference_job(id, input).await,
            "phi_detection_job" => self.update_phi_detection_job(id, input).await,
            "snomedct_inference_job" => self.update_snomedct_inference_job(id, input).await,
            "entities_detection_v2_job" => self.update_entities_detection_v2_job(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "comprehendmedical", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "icd10_cm_inference_job" => self.delete_icd10_cm_inference_job(id).await,
            "rx_norm_inference_job" => self.delete_rx_norm_inference_job(id).await,
            "phi_detection_job" => self.delete_phi_detection_job(id).await,
            "snomedct_inference_job" => self.delete_snomedct_inference_job(id).await,
            "entities_detection_v2_job" => self.delete_entities_detection_v2_job(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "comprehendmedical", resource_name
            ))),
    ...
    async fn create_icd10_cm_inference_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_icd10_cm_inference_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_icd10_cm_inference_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_rx_norm_inference_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_rx_norm_inference_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehendmedical_client
    ...
    async fn delete_rx_norm_inference_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehendmedical_client
    ...
    async fn create_phi_detection_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_phi_detection_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehendmedical_client
    ...
    async fn delete_phi_detection_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehendmedical_client
    ...
    async fn create_snomedct_inference_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_snomedct_inference_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehendmedical_client
    ...
    async fn delete_snomedct_inference_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehendmedical_client
    ...
    async fn read_entities_detection_v2_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehendmedical_client
    ...
    async fn delete_entities_detection_v2_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehendmedical_client
