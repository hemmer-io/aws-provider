...
impl<'a> Resource_set<'a> {
    ...
    pub async fn create(&self, resource_set_type: String, resource_set_name: String, resources: Vec<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, resource_set_type: Option<String>, resource_set_name: Option<String>, resources: Option<Vec<String>>, tags: Option<HashMap<String, String>>) -> Result<()> {
