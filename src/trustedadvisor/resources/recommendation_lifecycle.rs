...
impl<'a> Recommendation_lifecycle<'a> {
    ...
    pub async fn update(&self, id: &str, update_reason_code: Option<String>, recommendation_identifier: Option<String>, lifecycle_stage: Option<String>, update_reason: Option<String>) -> Result<()> {
