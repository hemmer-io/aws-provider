//! Neptune_graph service for Aws provider
//!
//! This module handles all neptune_graph resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Neptune_graph service handler
pub struct Neptune_graphService<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Neptune_graphService<'a> {
    ...
    async fn create_query(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            // Example:
            // let result = self.provider.neptune_graph_client
            //     .create_query()
            //     .set_name(name)
            //     .send()
            //     .await
    ...
    async fn delete_query(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            ...
            // Example:
            // self.provider.neptune_graph_client
            //     .delete_query()
            //     .set_id(id.to_string())
            //     .send()
            //     .await
    ...
    /// Plan changes to a graph_summary resource
    async fn plan_graph_summary(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
