...
impl<'a> Vpc_endpoint<'a> {
    ...
    pub async fn create(&self, domain_arn: String, vpc_options: String, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, domain_arn: Option<String>, vpc_options: Option<String>, client_token: Option<String>) -> Result<()> {
