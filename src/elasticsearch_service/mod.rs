...
impl<'a> Elasticsearch_serviceService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "compatible_elasticsearch_versions" => {
                self.plan_compatible_elasticsearch_versions(current_state, desired_input)
                    .await
            }
            "inbound_cross_cluster_search_connections" => {
                self.plan_inbound_cross_cluster_search_connections(current_state, desired_input)
                    .await
            }
            "upgrade_history" => {
            ...
            "elasticsearch_domains" => {
                self.plan_elasticsearch_domains(current_state, desired_input)
                    .await
            }
            "elasticsearch_service_role" => {
                self.plan_elasticsearch_service_role(current_state, desired_input)
                    .await
            }
            "domain_auto_tunes" => {
            ...
            "elasticsearch_instance_type_limits" => {
                self.plan_elasticsearch_instance_type_limits(current_state, desired_input)
                    .await
            }
            ...
            "outbound_cross_cluster_search_connections" => {
                self.plan_outbound_cross_cluster_search_connections(current_state, desired_input)
                    .await
            }
            "package" => self.plan_package(current_state, desired_input).await,
            "reserved_elasticsearch_instance_offerings" => {
                self.plan_reserved_elasticsearch_instance_offerings(current_state, desired_input)
                    .await
            }
            "inbound_cross_cluster_search_connection" => {
                self.plan_inbound_cross_cluster_search_connection(current_state, desired_input)
                    .await
            }
            "vpc_endpoints" => self.plan_vpc_endpoints(current_state, desired_input).await,
            "elasticsearch_domain" => {
                self.plan_elasticsearch_domain(current_state, desired_input)
                    .await
            }
            ...
            "reserved_elasticsearch_instances" => {
                self.plan_reserved_elasticsearch_instances(current_state, desired_input)
                    .await
            }
            "outbound_cross_cluster_search_connection" => {
                self.plan_outbound_cross_cluster_search_connection(current_state, desired_input)
                    .await
            }
            "elasticsearch_domain_config" => {
                self.plan_elasticsearch_domain_config(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "elasticsearch_service", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "inbound_cross_cluster_search_connections" => {
                self.create_inbound_cross_cluster_search_connections(input)
                    .await
            }
            "upgrade_history" => self.create_upgrade_history(input).await,
            "vpc_endpoint" => self.create_vpc_endpoint(input).await,
            "elasticsearch_domains" => self.create_elasticsearch_domains(input).await,
            "elasticsearch_service_role" => self.create_elasticsearch_service_role(input).await,
            ...
            "outbound_cross_cluster_search_connections" => {
                self.create_outbound_cross_cluster_search_connections(input)
                    .await
            }
            "package" => self.create_package(input).await,
            "reserved_elasticsearch_instance_offerings" => {
                self.create_reserved_elasticsearch_instance_offerings(input)
                    .await
            }
            "inbound_cross_cluster_search_connection" => {
                self.create_inbound_cross_cluster_search_connection(input)
                    .await
            }
            "vpc_endpoints" => self.create_vpc_endpoints(input).await,
            "elasticsearch_domain" => self.create_elasticsearch_domain(input).await,
            ...
            "outbound_cross_cluster_search_connection" => {
                self.create_outbound_cross_cluster_search_connection(input)
                    .await
            }
            "elasticsearch_domain_config" => self.create_elasticsearch_domain_config(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "elasticsearch_service", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "elasticsearch_domains" => self.read_elasticsearch_domains(id).await,
            "elasticsearch_service_role" => self.read_elasticsearch_service_role(id).await,
            ...
            "outbound_cross_cluster_search_connections" => {
                self.read_outbound_cross_cluster_search_connections(id)
                    .await
            }
            "package" => self.read_package(id).await,
            "reserved_elasticsearch_instance_offerings" => {
                self.read_reserved_elasticsearch_instance_offerings(id)
                    .await
            }
            "inbound_cross_cluster_search_connection" => {
            ...
            "elasticsearch_domain" => self.read_elasticsearch_domain(id).await,
            ...
            "elasticsearch_domain_config" => self.read_elasticsearch_domain_config(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "elasticsearch_service", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "compatible_elasticsearch_versions" => {
                self.update_compatible_elasticsearch_versions(id, input)
                    .await
            }
            "inbound_cross_cluster_search_connections" => {
                self.update_inbound_cross_cluster_search_connections(id, input)
                    .await
            }
            "upgrade_history" => self.update_upgrade_history(id, input).await,
            "vpc_endpoint" => self.update_vpc_endpoint(id, input).await,
            "elasticsearch_domains" => self.update_elasticsearch_domains(id, input).await,
            "elasticsearch_service_role" => self.update_elasticsearch_service_role(id, input).await,
            "domain_auto_tunes" => self.update_domain_auto_tunes(id, input).await,
            "elasticsearch_instance_type_limits" => {
                self.update_elasticsearch_instance_type_limits(id, input)
                    .await
            }
            "package_version_history" => self.update_package_version_history(id, input).await,
            "outbound_cross_cluster_search_connections" => {
                self.update_outbound_cross_cluster_search_connections(id, input)
                    .await
            }
            "package" => self.update_package(id, input).await,
            "reserved_elasticsearch_instance_offerings" => {
                self.update_reserved_elasticsearch_instance_offerings(id, input)
                    .await
            }
            "inbound_cross_cluster_search_connection" => {
                self.update_inbound_cross_cluster_search_connection(id, input)
                    .await
            }
            "vpc_endpoints" => self.update_vpc_endpoints(id, input).await,
            "elasticsearch_domain" => self.update_elasticsearch_domain(id, input).await,
            ...
            "reserved_elasticsearch_instances" => {
                self.update_reserved_elasticsearch_instances(id, input)
                    .await
            }
            "outbound_cross_cluster_search_connection" => {
                self.update_outbound_cross_cluster_search_connection(id, input)
                    .await
            }
            "elasticsearch_domain_config" => {
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "inbound_cross_cluster_search_connections" => {
                self.delete_inbound_cross_cluster_search_connections(id)
                    .await
            }
            "upgrade_history" => self.delete_upgrade_history(id).await,
            "vpc_endpoint" => self.delete_vpc_endpoint(id).await,
            "elasticsearch_domains" => self.delete_elasticsearch_domains(id).await,
            "elasticsearch_service_role" => self.delete_elasticsearch_service_role(id).await,
            ...
            "outbound_cross_cluster_search_connections" => {
                self.delete_outbound_cross_cluster_search_connections(id)
                    .await
            }
            "package" => self.delete_package(id).await,
            "reserved_elasticsearch_instance_offerings" => {
                self.delete_reserved_elasticsearch_instance_offerings(id)
                    .await
            }
            "inbound_cross_cluster_search_connection" => {
                self.delete_inbound_cross_cluster_search_connection(id)
                    .await
            }
            "vpc_endpoints" => self.delete_vpc_endpoints(id).await,
            "elasticsearch_domain" => self.delete_elasticsearch_domain(id).await,
            ...
            "outbound_cross_cluster_search_connection" => {
                self.delete_outbound_cross_cluster_search_connection(id)
                    .await
            }
            "elasticsearch_domain_config" => self.delete_elasticsearch_domain_config(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "elasticsearch_service", resource_name
            ))),
    ...
    async fn read_compatible_elasticsearch_versions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_compatible_elasticsearch_versions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_inbound_cross_cluster_search_connections(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticsearch_service_client
    ...
    async fn create_elasticsearch_domains(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_elasticsearch_domains(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticsearch_service_client
    ...
    async fn delete_elasticsearch_domains(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticsearch_service_client
    ...
    async fn read_elasticsearch_service_role(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticsearch_service_client
    ...
    async fn delete_elasticsearch_service_role(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticsearch_service_client
    ...
    async fn read_elasticsearch_instance_type_limits(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticsearch_service_client
    ...
    async fn delete_elasticsearch_instance_type_limits(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticsearch_service_client
    ...
    async fn delete_outbound_cross_cluster_search_connections(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticsearch_service_client
    ...
    async fn delete_reserved_elasticsearch_instance_offerings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticsearch_service_client
    ...
    async fn delete_inbound_cross_cluster_search_connection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticsearch_service_client
    ...
    async fn create_elasticsearch_domain(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let elasticsearch_cluster_config =
                input.get_optional_string("elasticsearch_cluster_config")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    elasticsearch_version.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    elasticsearch_cluster_config.unwrap_or_default(),
                )
                .with_field(
    ...
    async fn read_elasticsearch_domain(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticsearch_service_client
    ...
    async fn delete_elasticsearch_domain(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticsearch_service_client
    ...
    async fn read_reserved_elasticsearch_instances(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticsearch_service_client
    ...
    async fn delete_reserved_elasticsearch_instances(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticsearch_service_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    destination_domain_info.unwrap_or_default(),
                )
    ...
    async fn delete_outbound_cross_cluster_search_connection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticsearch_service_client
    ...
    async fn read_elasticsearch_domain_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.elasticsearch_service_client
    ...
    async fn delete_elasticsearch_domain_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.elasticsearch_service_client
