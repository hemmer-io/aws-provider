...
impl<'a> Consumable_resource<'a> {
    ...
    pub async fn create(&self, resource_type: Option<String>, tags: Option<HashMap<String, String>>, total_quantity: Option<i64>, consumable_resource_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, resource_type: Option<String>, tags: Option<HashMap<String, String>>, total_quantity: Option<i64>, consumable_resource_name: Option<String>) -> Result<()> {
