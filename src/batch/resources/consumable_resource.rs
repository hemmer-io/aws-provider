...
impl<'a> Consumable_resource<'a> {
    ...
    pub async fn create(&self, consumable_resource_name: String, resource_type: Option<String>, tags: Option<HashMap<String, String>>, total_quantity: Option<i64>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, consumable_resource_name: Option<String>, resource_type: Option<String>, tags: Option<HashMap<String, String>>, total_quantity: Option<i64>) -> Result<()> {
