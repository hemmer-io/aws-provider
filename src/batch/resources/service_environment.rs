...
impl<'a> Service_environment<'a> {
    ...
    pub async fn create(&self, state: Option<String>, service_environment_type: String, tags: Option<HashMap<String, String>>, capacity_limits: Vec<String>, service_environment_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, state: Option<String>, service_environment_type: Option<String>, tags: Option<HashMap<String, String>>, capacity_limits: Option<Vec<String>>, service_environment_name: Option<String>) -> Result<()> {
