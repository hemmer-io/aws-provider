...
impl<'a> Service_environment<'a> {
    ...
    pub async fn create(&self, service_environment_name: String, tags: Option<HashMap<String, String>>, state: Option<String>, service_environment_type: String, capacity_limits: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, service_environment_name: Option<String>, tags: Option<HashMap<String, String>>, state: Option<String>, service_environment_type: Option<String>, capacity_limits: Option<Vec<String>>) -> Result<()> {
