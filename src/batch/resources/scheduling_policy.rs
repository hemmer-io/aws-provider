...
impl<'a> Scheduling_policy<'a> {
    ...
    pub async fn create(&self, fairshare_policy: Option<String>, tags: Option<HashMap<String, String>>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, fairshare_policy: Option<String>, tags: Option<HashMap<String, String>>, name: Option<String>) -> Result<()> {
