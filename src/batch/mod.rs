...
impl<'a> BatchService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "compute_environments" => {
                self.plan_compute_environments(current_state, desired_input)
                    .await
            }
            "jobs" => self.plan_jobs(current_state, desired_input).await,
            "service_environment" => {
                self.plan_service_environment(current_state, desired_input)
                    .await
            }
            "consumable_resource" => {
                self.plan_consumable_resource(current_state, desired_input)
                    .await
            }
            "scheduling_policy" => {
                self.plan_scheduling_policy(current_state, desired_input)
                    .await
            }
            "scheduling_policies" => {
                self.plan_scheduling_policies(current_state, desired_input)
                    .await
            }
            "compute_environment" => {
                self.plan_compute_environment(current_state, desired_input)
                    .await
            }
            "job_queue_snapshot" => {
                self.plan_job_queue_snapshot(current_state, desired_input)
                    .await
            }
            "job_queue" => self.plan_job_queue(current_state, desired_input).await,
            "service_job" => self.plan_service_job(current_state, desired_input).await,
            "job_definitions" => {
                self.plan_job_definitions(current_state, desired_input)
                    .await
            }
            "service_environments" => {
                self.plan_service_environments(current_state, desired_input)
                    .await
            }
            "job_queues" => self.plan_job_queues(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "compute_environments" => self.create_compute_environments(input).await,
            "jobs" => self.create_jobs(input).await,
            "service_environment" => self.create_service_environment(input).await,
            "consumable_resource" => self.create_consumable_resource(input).await,
            "scheduling_policy" => self.create_scheduling_policy(input).await,
            "scheduling_policies" => self.create_scheduling_policies(input).await,
            "compute_environment" => self.create_compute_environment(input).await,
            "job_queue_snapshot" => self.create_job_queue_snapshot(input).await,
            "job_queue" => self.create_job_queue(input).await,
            "service_job" => self.create_service_job(input).await,
            "job_definitions" => self.create_job_definitions(input).await,
            "service_environments" => self.create_service_environments(input).await,
            "job_queues" => self.create_job_queues(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "batch", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "compute_environments" => self.read_compute_environments(id).await,
            "jobs" => self.read_jobs(id).await,
            "service_environment" => self.read_service_environment(id).await,
            "consumable_resource" => self.read_consumable_resource(id).await,
            "scheduling_policy" => self.read_scheduling_policy(id).await,
            "scheduling_policies" => self.read_scheduling_policies(id).await,
            "compute_environment" => self.read_compute_environment(id).await,
            "job_queue_snapshot" => self.read_job_queue_snapshot(id).await,
            "job_queue" => self.read_job_queue(id).await,
            "service_job" => self.read_service_job(id).await,
            "job_definitions" => self.read_job_definitions(id).await,
            "service_environments" => self.read_service_environments(id).await,
            "job_queues" => self.read_job_queues(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "batch", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "compute_environments" => self.update_compute_environments(id, input).await,
            "jobs" => self.update_jobs(id, input).await,
            "service_environment" => self.update_service_environment(id, input).await,
            "consumable_resource" => self.update_consumable_resource(id, input).await,
            "scheduling_policy" => self.update_scheduling_policy(id, input).await,
            "scheduling_policies" => self.update_scheduling_policies(id, input).await,
            "compute_environment" => self.update_compute_environment(id, input).await,
            "job_queue_snapshot" => self.update_job_queue_snapshot(id, input).await,
            "job_queue" => self.update_job_queue(id, input).await,
            "service_job" => self.update_service_job(id, input).await,
            "job_definitions" => self.update_job_definitions(id, input).await,
            "service_environments" => self.update_service_environments(id, input).await,
            "job_queues" => self.update_job_queues(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "batch", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "compute_environments" => self.delete_compute_environments(id).await,
            "jobs" => self.delete_jobs(id).await,
            "service_environment" => self.delete_service_environment(id).await,
            "consumable_resource" => self.delete_consumable_resource(id).await,
            "scheduling_policy" => self.delete_scheduling_policy(id).await,
            "scheduling_policies" => self.delete_scheduling_policies(id).await,
            "compute_environment" => self.delete_compute_environment(id).await,
            "job_queue_snapshot" => self.delete_job_queue_snapshot(id).await,
            "job_queue" => self.delete_job_queue(id).await,
            "service_job" => self.delete_service_job(id).await,
            "job_definitions" => self.delete_job_definitions(id).await,
            "service_environments" => self.delete_service_environments(id).await,
            "job_queues" => self.delete_job_queues(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "batch", resource_name
            ))),
    ...
    async fn create_compute_environments(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_compute_environments(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_compute_environments(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_service_environment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    service_environment_type.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("capacity_limits", capacity_limits.unwrap_or_default())
                .with_field(
                    "service_environment_name",
                    service_environment_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a service_environment resource
    async fn read_service_environment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.batch_client
    ...
    async fn delete_service_environment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.batch_client
    ...
    async fn create_consumable_resource(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    consumable_resource_name.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default()))
        })
    }
    ...
    async fn read_consumable_resource(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.batch_client
    ...
    async fn delete_consumable_resource(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.batch_client
    ...
    async fn create_scheduling_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_scheduling_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.batch_client
    ...
    async fn delete_scheduling_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.batch_client
    ...
    async fn create_scheduling_policies(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_scheduling_policies(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.batch_client
    ...
    async fn delete_scheduling_policies(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.batch_client
    ...
    async fn create_compute_environment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    compute_environment_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a compute_environment resource
    async fn read_compute_environment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.batch_client
    ...
    async fn delete_compute_environment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.batch_client
    ...
    async fn create_job_queue_snapshot(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_job_queue_snapshot(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.batch_client
    ...
    async fn delete_job_queue_snapshot(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.batch_client
    ...
    async fn create_job_queue(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let state = input.get_optional_string("state")?;
            let priority = input.get_string("priority")?;
            let service_environment_order =
                input.get_optional_string("service_environment_order")?;
            let job_state_time_limit_actions =
                input.get_optional_string("job_state_time_limit_actions")?;
            let tags = input.get_optional_string("tags")?;
            ...
            let compute_environment_order =
                input.get_optional_string("compute_environment_order")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    service_environment_order.unwrap_or_default(),
                )
                .with_field(
                    "job_state_time_limit_actions",
                    job_state_time_limit_actions.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                ...
                .with_field(
                    ...
                    scheduling_policy_arn.unwrap_or_default(),
                )
                .with_field(
                    "compute_environment_order",
                    compute_environment_order.unwrap_or_default(),
                ))
        })
    }

    /// Read a job_queue resource
    async fn read_job_queue(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.batch_client
    ...
    async fn update_job_queue(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let state = input.get_optional_string("state")?;
            let priority = input.get_string("priority")?;
    ...
    async fn delete_job_queue(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.batch_client
    ...
    async fn create_service_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_service_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.batch_client
    ...
    async fn update_service_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_service_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.batch_client
    ...
    async fn create_job_definitions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_job_definitions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.batch_client
    ...
    async fn delete_job_definitions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.batch_client
    ...
    async fn create_service_environments(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_service_environments(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.batch_client
    ...
    async fn delete_service_environments(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.batch_client
    ...
    async fn create_job_queues(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_job_queues(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.batch_client
    ...
    async fn update_job_queues(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_job_queues(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.batch_client
