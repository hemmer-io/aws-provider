...
impl<'a> Routing_rule<'a> {
    ...
    pub async fn create(&self, domain_name_id: Option<String>, routing_rule_id: String, actions: Vec<String>, domain_name: String, priority: i64, conditions: Vec<String>) -> Result<String> {
