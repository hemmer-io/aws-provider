...
impl<'a> Api_mapping<'a> {
    ...
    pub async fn create(&self, api_mapping_key: Option<String>, api_id: String, domain_name: String, stage: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, api_mapping_key: Option<String>, api_id: Option<String>, domain_name: Option<String>, stage: Option<String>) -> Result<()> {
