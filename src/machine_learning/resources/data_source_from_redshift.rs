...
impl<'a> Data_source_from_redshift<'a> {
    ...
    pub async fn create(&self, data_source_id: String, data_source_name: Option<String>, role_arn: String, data_spec: String, compute_statistics: Option<bool>) -> Result<String> {
