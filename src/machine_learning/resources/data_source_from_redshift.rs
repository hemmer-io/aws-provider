...
impl<'a> Data_source_from_redshift<'a> {
    ...
    pub async fn create(&self, data_source_id: String, role_arn: String, data_source_name: Option<String>, compute_statistics: Option<bool>, data_spec: String) -> Result<String> {
