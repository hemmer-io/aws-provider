...
impl<'a> Data_source_from_rds<'a> {
    ...
    pub async fn create(&self, data_source_id: String, data_source_name: Option<String>, compute_statistics: Option<bool>, rds_data: String, role_arn: String) -> Result<String> {
