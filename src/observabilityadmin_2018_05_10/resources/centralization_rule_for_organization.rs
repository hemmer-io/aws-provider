...
impl<'a> Centralization_rule_for_organization<'a> {
    ...
    pub async fn create(&self, rule: String, rule_name: String, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, rule: Option<String>, rule_name: Option<String>, tags: Option<HashMap<String, String>>) -> Result<()> {
