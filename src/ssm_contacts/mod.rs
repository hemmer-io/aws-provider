...
impl<'a> Ssm_contactsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "rotation" => self.plan_rotation(current_state, desired_input).await,
            "engagement" => self.plan_engagement(current_state, desired_input).await,
            "contact_channel" => {
                self.plan_contact_channel(current_state, desired_input)
                    .await
            }
            "contact" => self.plan_contact(current_state, desired_input).await,
            "rotation_override" => {
                self.plan_rotation_override(current_state, desired_input)
                    .await
            }
            "contact_policy" => self.plan_contact_policy(current_state, desired_input).await,
            "page" => self.plan_page(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ssm_contacts", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "rotation" => self.create_rotation(input).await,
            "engagement" => self.create_engagement(input).await,
            "contact_channel" => self.create_contact_channel(input).await,
            "contact" => self.create_contact(input).await,
            "rotation_override" => self.create_rotation_override(input).await,
            "contact_policy" => self.create_contact_policy(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "rotation" => self.read_rotation(id).await,
            "engagement" => self.read_engagement(id).await,
            "contact_channel" => self.read_contact_channel(id).await,
            "contact" => self.read_contact(id).await,
            "rotation_override" => self.read_rotation_override(id).await,
            "contact_policy" => self.read_contact_policy(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "rotation" => self.update_rotation(id, input).await,
            "engagement" => self.update_engagement(id, input).await,
            "contact_channel" => self.update_contact_channel(id, input).await,
            "contact" => self.update_contact(id, input).await,
            "rotation_override" => self.update_rotation_override(id, input).await,
            "contact_policy" => self.update_contact_policy(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "rotation" => self.delete_rotation(id).await,
            "engagement" => self.delete_engagement(id).await,
            "contact_channel" => self.delete_contact_channel(id).await,
            "contact" => self.delete_contact(id).await,
            "rotation_override" => self.delete_rotation_override(id).await,
            "contact_policy" => self.delete_contact_policy(id).await,
    ...
    async fn create_rotation(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_rotation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_rotation(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let idempotency_token = input.get_optional_string("idempotency_token")?;
    ...
    async fn delete_rotation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_engagement(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_engagement(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_contacts_client
    ...
    async fn update_engagement(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_engagement(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_contacts_client
    ...
    async fn create_contact_channel(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let idempotency_token = input.get_optional_string("idempotency_token")?;
    ...
    async fn read_contact_channel(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_contacts_client
    ...
    async fn delete_contact_channel(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_contacts_client
    ...
    async fn create_rotation_override(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_rotation_override(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_contacts_client
    ...
    async fn delete_rotation_override(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_contacts_client
    ...
    async fn create_contact_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_contact_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_contacts_client
    ...
    async fn delete_contact_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_contacts_client
