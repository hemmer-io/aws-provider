...
impl<'a> Rotation_override<'a> {
    ...
    pub async fn create(&self, rotation_id: String, end_time: String, start_time: String, new_contact_ids: Vec<String>, idempotency_token: Option<String>) -> Result<String> {
