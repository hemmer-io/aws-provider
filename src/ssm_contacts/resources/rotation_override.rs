...
impl<'a> Rotation_override<'a> {
    ...
    pub async fn create(&self, end_time: String, start_time: String, new_contact_ids: Vec<String>, idempotency_token: Option<String>, rotation_id: String) -> Result<String> {
