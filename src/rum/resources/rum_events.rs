...
impl<'a> Rum_events<'a> {
    ...
    pub async fn create(&self, rum_events: Vec<String>, user_details: String, app_monitor_details: String, id: String, batch_id: String, alias: Option<String>) -> Result<String> {
