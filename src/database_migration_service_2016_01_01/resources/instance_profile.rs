...
impl<'a> Instance_profile<'a> {
    ...
    pub async fn create(&self, network_type: Option<String>, availability_zone: Option<String>, kms_key_arn: Option<String>, description: Option<String>, vpc_security_groups: Option<String>, instance_profile_name: Option<String>, subnet_group_identifier: Option<String>, publicly_accessible: Option<bool>, tags: Option<Vec<String>>) -> Result<String> {
