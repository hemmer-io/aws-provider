...
impl<'a> Migration_project<'a> {
    ...
    pub async fn create(&self, description: Option<String>, target_data_provider_descriptors: Vec<String>, instance_profile_identifier: String, transformation_rules: Option<String>, migration_project_name: Option<String>, tags: Option<Vec<String>>, source_data_provider_descriptors: Vec<String>, schema_conversion_application_attributes: Option<String>) -> Result<String> {
