...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, source_type: Option<String>, source_ids: Option<Vec<String>>, sns_topic_arn: String, enabled: Option<bool>, event_categories: Option<Vec<String>>, subscription_name: String, tags: Option<Vec<String>>) -> Result<String> {
