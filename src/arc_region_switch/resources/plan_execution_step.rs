...
impl<'a> Plan_execution_step<'a> {
    ...
    pub async fn update(&self, id: &str, plan_arn: Option<String>, execution_id: Option<String>, comment: Option<String>, step_name: Option<String>, action_to_take: Option<String>) -> Result<()> {

        // Note: This is a generated skeleton.
        // TODO: Map resource ID and update fields to SDK parameters
        let _client = &self.provider.arc_region_switch_client;
