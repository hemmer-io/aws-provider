...
impl<'a> Timestream_writeService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "batch_load_task" => {
                self.plan_batch_load_task(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "timestream_write", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "batch_load_task" => self.create_batch_load_task(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "timestream_write", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "batch_load_task" => self.read_batch_load_task(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "timestream_write", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "batch_load_task" => self.update_batch_load_task(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "timestream_write", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "batch_load_task" => self.delete_batch_load_task(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "timestream_write", resource_name
            ))),
    ...
    async fn create_table(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let magnetic_store_write_properties =
                input.get_optional_string("magnetic_store_write_properties")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    retention_properties.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("database_name", database_name.unwrap_or_default())
                .with_field(
                    "magnetic_store_write_properties",
                    magnetic_store_write_properties.unwrap_or_default(),
                )
    ...
    async fn create_batch_load_task(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    report_configuration.unwrap_or_default(),
                )
                .with_field(
                    "target_database_name",
                    target_database_name.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    data_model_configuration.unwrap_or_default(),
                )
                .with_field(
                    "data_source_configuration",
                    data_source_configuration.unwrap_or_default(),
                ))
        })
    }

    /// Read a batch_load_task resource
    async fn read_batch_load_task(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.timestream_write_client
    ...
    async fn delete_batch_load_task(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.timestream_write_client
