...
impl<'a> Batch_load_task<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, target_database_name: String, target_table_name: String, record_version: Option<i64>, data_source_configuration: String, data_model_configuration: Option<String>, report_configuration: String) -> Result<String> {
