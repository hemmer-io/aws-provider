...
impl<'a> Image_tag_mutability<'a> {
    ...
    pub async fn create(&self, registry_id: Option<String>, image_tag_mutability: String, repository_name: String, image_tag_mutability_exclusion_filters: Option<Vec<String>>) -> Result<String> {
