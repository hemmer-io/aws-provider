...
impl<'a> MigrationhubstrategyService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "server_strategies" => {
                self.plan_server_strategies(current_state, desired_input)
                    .await
            }
            "server_details" => self.plan_server_details(current_state, desired_input).await,
            "portfolio_summary" => {
                self.plan_portfolio_summary(current_state, desired_input)
                    .await
            }
            "application_component_details" => {
                self.plan_application_component_details(current_state, desired_input)
                    .await
            }
            "portfolio_preferences" => {
                self.plan_portfolio_preferences(current_state, desired_input)
                    .await
            }
            "assessment" => self.plan_assessment(current_state, desired_input).await,
            "recommendation_report_details" => {
                self.plan_recommendation_report_details(current_state, desired_input)
                    .await
            }
            "application_component_strategies" => {
                self.plan_application_component_strategies(current_state, desired_input)
                    .await
            }
            "application_component_config" => {
                self.plan_application_component_config(current_state, desired_input)
                    .await
            }
            "server_config" => self.plan_server_config(current_state, desired_input).await,
            "import_file_task" => {
                self.plan_import_file_task(current_state, desired_input)
                    .await
            }
            "latest_assessment_id" => {
                self.plan_latest_assessment_id(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "migrationhubstrategy", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "server_strategies" => self.create_server_strategies(input).await,
            "server_details" => self.create_server_details(input).await,
            "portfolio_summary" => self.create_portfolio_summary(input).await,
            "application_component_details" => {
                self.create_application_component_details(input).await
            }
            "portfolio_preferences" => self.create_portfolio_preferences(input).await,
            ...
            "application_component_config" => self.create_application_component_config(input).await,
            "server_config" => self.create_server_config(input).await,
            "import_file_task" => self.create_import_file_task(input).await,
            "latest_assessment_id" => self.create_latest_assessment_id(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "migrationhubstrategy", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "server_strategies" => self.read_server_strategies(id).await,
            "server_details" => self.read_server_details(id).await,
            "portfolio_summary" => self.read_portfolio_summary(id).await,
            "application_component_details" => self.read_application_component_details(id).await,
            "portfolio_preferences" => self.read_portfolio_preferences(id).await,
            "assessment" => self.read_assessment(id).await,
            "recommendation_report_details" => self.read_recommendation_report_details(id).await,
            "application_component_strategies" => {
                self.read_application_component_strategies(id).await
            }
            "application_component_config" => self.read_application_component_config(id).await,
            "server_config" => self.read_server_config(id).await,
            "import_file_task" => self.read_import_file_task(id).await,
            "latest_assessment_id" => self.read_latest_assessment_id(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "migrationhubstrategy", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "server_strategies" => self.update_server_strategies(id, input).await,
            "server_details" => self.update_server_details(id, input).await,
            "portfolio_summary" => self.update_portfolio_summary(id, input).await,
            "application_component_details" => {
                self.update_application_component_details(id, input).await
            }
            "portfolio_preferences" => self.update_portfolio_preferences(id, input).await,
            "assessment" => self.update_assessment(id, input).await,
            "recommendation_report_details" => {
                self.update_recommendation_report_details(id, input).await
            }
            "application_component_strategies" => {
                self.update_application_component_strategies(id, input)
                    .await
            }
            "application_component_config" => {
                self.update_application_component_config(id, input).await
            }
            "server_config" => self.update_server_config(id, input).await,
            "import_file_task" => self.update_import_file_task(id, input).await,
            "latest_assessment_id" => self.update_latest_assessment_id(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "migrationhubstrategy", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "server_strategies" => self.delete_server_strategies(id).await,
            "server_details" => self.delete_server_details(id).await,
            "portfolio_summary" => self.delete_portfolio_summary(id).await,
            "application_component_details" => self.delete_application_component_details(id).await,
            "portfolio_preferences" => self.delete_portfolio_preferences(id).await,
            "assessment" => self.delete_assessment(id).await,
            "recommendation_report_details" => self.delete_recommendation_report_details(id).await,
            "application_component_strategies" => {
                self.delete_application_component_strategies(id).await
            }
            "application_component_config" => self.delete_application_component_config(id).await,
            "server_config" => self.delete_server_config(id).await,
            "import_file_task" => self.delete_import_file_task(id).await,
            "latest_assessment_id" => self.delete_latest_assessment_id(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "migrationhubstrategy", resource_name
            ))),
    ...
    async fn create_server_strategies(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_server_strategies(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_server_strategies(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_server_details(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_server_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.migrationhubstrategy_client
    ...
    async fn delete_server_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.migrationhubstrategy_client
    ...
    async fn create_portfolio_summary(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_portfolio_summary(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.migrationhubstrategy_client
    ...
    async fn delete_portfolio_summary(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.migrationhubstrategy_client
    ...
    async fn read_application_component_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.migrationhubstrategy_client
    ...
    async fn delete_application_component_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.migrationhubstrategy_client
    ...
    async fn create_portfolio_preferences(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let prioritize_business_goals =
                input.get_optional_string("prioritize_business_goals")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    database_preferences.unwrap_or_default(),
                )
                .with_field(
                    "application_preferences",
                    application_preferences.unwrap_or_default(),
                )
                .with_field(
                    "prioritize_business_goals",
                    prioritize_business_goals.unwrap_or_default(),
                ))
        })
    }

    /// Read a portfolio_preferences resource
    async fn read_portfolio_preferences(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.migrationhubstrategy_client
    ...
    async fn delete_portfolio_preferences(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.migrationhubstrategy_client
    ...
    async fn read_recommendation_report_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.migrationhubstrategy_client
    ...
    async fn delete_recommendation_report_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.migrationhubstrategy_client
    ...
    async fn read_application_component_strategies(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.migrationhubstrategy_client
    ...
    async fn delete_application_component_strategies(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.migrationhubstrategy_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    application_component_id.unwrap_or_default(),
                )
                .with_field("inclusion_status", inclusion_status.unwrap_or_default())
                .with_field(
                    "secrets_manager_key",
                    secrets_manager_key.unwrap_or_default(),
                )
    ...
    async fn read_application_component_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.migrationhubstrategy_client
    ...
    async fn delete_application_component_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.migrationhubstrategy_client
    ...
    async fn create_server_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_server_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.migrationhubstrategy_client
    ...
    async fn update_server_config(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let server_id = input.get_string("server_id")?;
            let strategy_option = input.get_optional_string("strategy_option")?;
    ...
    async fn delete_server_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.migrationhubstrategy_client
    ...
    async fn create_import_file_task(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_import_file_task(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.migrationhubstrategy_client
    ...
    async fn delete_import_file_task(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.migrationhubstrategy_client
    ...
    async fn create_latest_assessment_id(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_latest_assessment_id(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.migrationhubstrategy_client
    ...
    async fn delete_latest_assessment_id(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.migrationhubstrategy_client
