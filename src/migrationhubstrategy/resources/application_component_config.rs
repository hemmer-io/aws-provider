...
impl<'a> Application_component_config<'a> {
    ...
    pub async fn update(&self, id: &str, secrets_manager_key: Option<String>, source_code_list: Option<Vec<String>>, application_component_id: Option<String>, strategy_option: Option<String>, configure_only: Option<bool>, app_type: Option<String>, inclusion_status: Option<String>) -> Result<()> {
