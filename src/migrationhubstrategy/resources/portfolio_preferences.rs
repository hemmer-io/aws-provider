...
impl<'a> Portfolio_preferences<'a> {
    ...
    pub async fn create(&self, application_mode: Option<String>, database_preferences: Option<String>, application_preferences: Option<String>, prioritize_business_goals: Option<String>) -> Result<String> {
