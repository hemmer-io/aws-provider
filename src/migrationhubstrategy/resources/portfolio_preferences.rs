...
impl<'a> Portfolio_preferences<'a> {
    ...
    pub async fn create(&self, database_preferences: Option<String>, application_preferences: Option<String>, application_mode: Option<String>, prioritize_business_goals: Option<String>) -> Result<String> {
