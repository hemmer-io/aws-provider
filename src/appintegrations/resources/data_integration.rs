...
impl<'a> Data_integration<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, file_configuration: Option<String>, object_configuration: Option<HashMap<String, HashMap<String, Vec<String>>>>, description: Option<String>, kms_key: String, source_uri: Option<String>, schedule_config: Option<String>, client_token: Option<String>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, file_configuration: Option<String>, object_configuration: Option<HashMap<String, HashMap<String, Vec<String>>>>, description: Option<String>, kms_key: Option<String>, source_uri: Option<String>, schedule_config: Option<String>, client_token: Option<String>, name: Option<String>) -> Result<()> {
