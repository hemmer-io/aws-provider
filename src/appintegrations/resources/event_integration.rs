...
impl<'a> Event_integration<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, name: String, description: Option<String>, tags: Option<HashMap<String, String>>, event_filter: String, event_bridge_bus: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, name: Option<String>, description: Option<String>, tags: Option<HashMap<String, String>>, event_filter: Option<String>, event_bridge_bus: Option<String>) -> Result<()> {
