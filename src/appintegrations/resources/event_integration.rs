...
impl<'a> Event_integration<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, name: String, tags: Option<HashMap<String, String>>, event_bridge_bus: String, description: Option<String>, event_filter: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, name: Option<String>, tags: Option<HashMap<String, String>>, event_bridge_bus: Option<String>, description: Option<String>, event_filter: Option<String>) -> Result<()> {
