...
impl<'a> Event_integration<'a> {
    ...
    pub async fn create(&self, event_filter: String, description: Option<String>, tags: Option<HashMap<String, String>>, client_token: Option<String>, name: String, event_bridge_bus: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, event_filter: Option<String>, description: Option<String>, tags: Option<HashMap<String, String>>, client_token: Option<String>, name: Option<String>, event_bridge_bus: Option<String>) -> Result<()> {
