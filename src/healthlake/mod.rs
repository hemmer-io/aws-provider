...
impl<'a> HealthlakeService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "fhir_import_job" => {
                self.plan_fhir_import_job(current_state, desired_input)
                    .await
            }
            "fhir_export_job" => {
                self.plan_fhir_export_job(current_state, desired_input)
                    .await
            }
            "fhir_datastore" => self.plan_fhir_datastore(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "healthlake", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "fhir_import_job" => self.create_fhir_import_job(input).await,
            "fhir_export_job" => self.create_fhir_export_job(input).await,
            "fhir_datastore" => self.create_fhir_datastore(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "healthlake", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "fhir_import_job" => self.read_fhir_import_job(id).await,
            "fhir_export_job" => self.read_fhir_export_job(id).await,
            "fhir_datastore" => self.read_fhir_datastore(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "healthlake", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "fhir_import_job" => self.update_fhir_import_job(id, input).await,
            "fhir_export_job" => self.update_fhir_export_job(id, input).await,
            "fhir_datastore" => self.update_fhir_datastore(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "healthlake", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "fhir_import_job" => self.delete_fhir_import_job(id).await,
            "fhir_export_job" => self.delete_fhir_export_job(id).await,
            "fhir_datastore" => self.delete_fhir_datastore(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "healthlake", resource_name
            ))),
    ...
    async fn create_fhir_import_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_fhir_import_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_fhir_import_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_fhir_export_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_fhir_export_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.healthlake_client
    ...
    async fn delete_fhir_export_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.healthlake_client
    ...
    async fn create_fhir_datastore(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let identity_provider_configuration =
                input.get_optional_string("identity_provider_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "preload_data_config",
                    preload_data_config.unwrap_or_default(),
                )
                .with_field(
                    "datastore_type_version",
                    datastore_type_version.unwrap_or_default(),
                )
                .with_field(
                    "identity_provider_configuration",
                    identity_provider_configuration.unwrap_or_default(),
                ))
        })
    }

    /// Read a fhir_datastore resource
    async fn read_fhir_datastore(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.healthlake_client
    ...
    async fn delete_fhir_datastore(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.healthlake_client
