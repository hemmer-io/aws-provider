...
impl<'a> Fhir_datastore<'a> {
    ...
    pub async fn create(&self, datastore_name: Option<String>, sse_configuration: Option<String>, client_token: Option<String>, tags: Option<Vec<String>>, preload_data_config: Option<String>, datastore_type_version: String, identity_provider_configuration: Option<String>) -> Result<String> {
