...
impl<'a> App_version_app_component<'a> {
    ...
    pub async fn create(&self, app_arn: String, name: String, additional_info: Option<HashMap<String, Vec<String>>>, type: String, client_token: Option<String>, id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, app_arn: Option<String>, name: Option<String>, additional_info: Option<HashMap<String, Vec<String>>>, type: Option<String>, client_token: Option<String>, id: Option<String>) -> Result<()> {
