...
impl<'a> MediaconvertService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "preset" => self.plan_preset(current_state, desired_input).await,
            "jobs_query_results" => {
                self.plan_jobs_query_results(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "preset" => self.create_preset(input).await,
            "jobs_query_results" => self.create_jobs_query_results(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "preset" => self.read_preset(id).await,
            "jobs_query_results" => self.read_jobs_query_results(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "preset" => self.update_preset(id, input).await,
            "jobs_query_results" => self.update_jobs_query_results(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "preset" => self.delete_preset(id).await,
            "jobs_query_results" => self.delete_jobs_query_results(id).await,
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    simulate_reserved_queue.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "acceleration_settings",
                    acceleration_settings.unwrap_or_default(),
                )
                .with_field("priority", priority.unwrap_or_default())
                .with_field(
                    "billing_tags_source",
                    billing_tags_source.unwrap_or_default(),
                )
                .with_field("settings", settings.unwrap_or_default())
                .with_field(
                    "status_update_interval",
                    status_update_interval.unwrap_or_default(),
                )
    ...
    async fn create_preset(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let category = input.get_optional_string("category")?;
    ...
    async fn read_preset(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mediaconvert_client
    ...
    async fn update_preset(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let category = input.get_optional_string("category")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn create_jobs_query_results(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_jobs_query_results(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.mediaconvert_client
    ...
    async fn delete_jobs_query_results(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.mediaconvert_client
    ...
    async fn create_queue(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let reservation_plan_settings =
                input.get_optional_string("reservation_plan_settings")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    reservation_plan_settings.unwrap_or_default(),
                )
