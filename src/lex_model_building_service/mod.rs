...
impl<'a> Lex_model_building_serviceService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "slot_types" => {
                self.plan_slot_types(current_state, desired_input).await
            }
            "bot_alias" => {
                self.plan_bot_alias(current_state, desired_input).await
            }
            "builtin_intents" => {
                self.plan_builtin_intents(current_state, desired_input).await
            }
            "import" => {
                self.plan_import(current_state, desired_input).await
            }
            "bot_channel_association" => {
                self.plan_bot_channel_association(current_state, desired_input).await
            }
            "intent" => {
            ...
            "builtin_slot_types" => {
                self.plan_builtin_slot_types(current_state, desired_input).await
            }
            "intent_versions" => {
                self.plan_intent_versions(current_state, desired_input).await
            }
            "bot_versions" => {
                self.plan_bot_versions(current_state, desired_input).await
            }
            "migration" => {
                self.plan_migration(current_state, desired_input).await
            }
            "slot_type_version" => {
                self.plan_slot_type_version(current_state, desired_input).await
            }
            "utterances" => {
                self.plan_utterances(current_state, desired_input).await
            }
            "bot_aliases" => {
                self.plan_bot_aliases(current_state, desired_input).await
            }
            "migrations" => {
                self.plan_migrations(current_state, desired_input).await
            }
            "slot_type_versions" => {
                self.plan_slot_type_versions(current_state, desired_input).await
            }
            "utterances_view" => {
                self.plan_utterances_view(current_state, desired_input).await
            }
            "intent_version" => {
                self.plan_intent_version(current_state, desired_input).await
            }
            "slot_type" => {
                self.plan_slot_type(current_state, desired_input).await
            }
            "builtin_intent" => {
                self.plan_builtin_intent(current_state, desired_input).await
            }
            "bot_channel_associations" => {
                self.plan_bot_channel_associations(current_state, desired_input).await
            }
            "bot_version" => {
                self.plan_bot_version(current_state, desired_input).await
            }
            "bots" => {
                self.plan_bots(current_state, desired_input).await
            }
            "export" => {
                self.plan_export(current_state, desired_input).await
            }
            "intents" => {
                self.plan_intents(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "slot_types" => {
                self.create_slot_types(input).await
            }
            "bot_alias" => {
                self.create_bot_alias(input).await
            }
            "builtin_intents" => {
                self.create_builtin_intents(input).await
            }
            "import" => {
                self.create_import(input).await
            }
            "bot_channel_association" => {
                self.create_bot_channel_association(input).await
            }
            "intent" => {
            ...
            "builtin_slot_types" => {
                self.create_builtin_slot_types(input).await
            }
            "intent_versions" => {
                self.create_intent_versions(input).await
            }
            "bot_versions" => {
                self.create_bot_versions(input).await
            }
            "migration" => {
                self.create_migration(input).await
            }
            "slot_type_version" => {
                self.create_slot_type_version(input).await
            }
            "utterances" => {
                self.create_utterances(input).await
            }
            "bot_aliases" => {
                self.create_bot_aliases(input).await
            }
            "migrations" => {
                self.create_migrations(input).await
            }
            "slot_type_versions" => {
                self.create_slot_type_versions(input).await
            }
            "utterances_view" => {
                self.create_utterances_view(input).await
            }
            "intent_version" => {
                self.create_intent_version(input).await
            }
            "slot_type" => {
                self.create_slot_type(input).await
            }
            "builtin_intent" => {
                self.create_builtin_intent(input).await
            }
            "bot_channel_associations" => {
                self.create_bot_channel_associations(input).await
            }
            "bot_version" => {
                self.create_bot_version(input).await
            }
            "bots" => {
                self.create_bots(input).await
            }
            "export" => {
                self.create_export(input).await
            }
            "intents" => {
                self.create_intents(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "lex_model_building_service",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "slot_types" => {
                self.read_slot_types(id).await
            }
            "bot_alias" => {
                self.read_bot_alias(id).await
            }
            "builtin_intents" => {
                self.read_builtin_intents(id).await
            }
            "import" => {
                self.read_import(id).await
            }
            "bot_channel_association" => {
                self.read_bot_channel_association(id).await
            }
            "intent" => {
            ...
            "builtin_slot_types" => {
                self.read_builtin_slot_types(id).await
            }
            "intent_versions" => {
                self.read_intent_versions(id).await
            }
            "bot_versions" => {
                self.read_bot_versions(id).await
            }
            "migration" => {
                self.read_migration(id).await
            }
            "slot_type_version" => {
                self.read_slot_type_version(id).await
            }
            "utterances" => {
                self.read_utterances(id).await
            }
            "bot_aliases" => {
                self.read_bot_aliases(id).await
            }
            "migrations" => {
                self.read_migrations(id).await
            }
            "slot_type_versions" => {
                self.read_slot_type_versions(id).await
            }
            "utterances_view" => {
                self.read_utterances_view(id).await
            }
            "intent_version" => {
                self.read_intent_version(id).await
            }
            "slot_type" => {
                self.read_slot_type(id).await
            }
            "builtin_intent" => {
                self.read_builtin_intent(id).await
            }
            "bot_channel_associations" => {
                self.read_bot_channel_associations(id).await
            }
            "bot_version" => {
                self.read_bot_version(id).await
            }
            "bots" => {
                self.read_bots(id).await
            }
            "export" => {
                self.read_export(id).await
            }
            "intents" => {
                self.read_intents(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "lex_model_building_service",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "slot_types" => {
                self.update_slot_types(id, input).await
            }
            "bot_alias" => {
                self.update_bot_alias(id, input).await
            }
            "builtin_intents" => {
                self.update_builtin_intents(id, input).await
            }
            "import" => {
                self.update_import(id, input).await
            }
            "bot_channel_association" => {
                self.update_bot_channel_association(id, input).await
            }
            "intent" => {
            ...
            "builtin_slot_types" => {
                self.update_builtin_slot_types(id, input).await
            }
            "intent_versions" => {
                self.update_intent_versions(id, input).await
            }
            "bot_versions" => {
                self.update_bot_versions(id, input).await
            }
            "migration" => {
                self.update_migration(id, input).await
            }
            "slot_type_version" => {
                self.update_slot_type_version(id, input).await
            }
            "utterances" => {
                self.update_utterances(id, input).await
            }
            "bot_aliases" => {
                self.update_bot_aliases(id, input).await
            }
            "migrations" => {
                self.update_migrations(id, input).await
            }
            "slot_type_versions" => {
                self.update_slot_type_versions(id, input).await
            }
            "utterances_view" => {
                self.update_utterances_view(id, input).await
            }
            "intent_version" => {
                self.update_intent_version(id, input).await
            }
            "slot_type" => {
                self.update_slot_type(id, input).await
            }
            "builtin_intent" => {
                self.update_builtin_intent(id, input).await
            }
            "bot_channel_associations" => {
                self.update_bot_channel_associations(id, input).await
            }
            "bot_version" => {
                self.update_bot_version(id, input).await
            }
            "bots" => {
                self.update_bots(id, input).await
            }
            "export" => {
                self.update_export(id, input).await
            }
            "intents" => {
                self.update_intents(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "lex_model_building_service",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "slot_types" => {
                self.delete_slot_types(id).await
            }
            "bot_alias" => {
                self.delete_bot_alias(id).await
            }
            "builtin_intents" => {
                self.delete_builtin_intents(id).await
            }
            "import" => {
                self.delete_import(id).await
            }
            "bot_channel_association" => {
                self.delete_bot_channel_association(id).await
            }
            "intent" => {
            ...
            "builtin_slot_types" => {
                self.delete_builtin_slot_types(id).await
            }
            "intent_versions" => {
                self.delete_intent_versions(id).await
            }
            "bot_versions" => {
                self.delete_bot_versions(id).await
            }
            "migration" => {
                self.delete_migration(id).await
            }
            "slot_type_version" => {
                self.delete_slot_type_version(id).await
            }
            "utterances" => {
                self.delete_utterances(id).await
            }
            "bot_aliases" => {
                self.delete_bot_aliases(id).await
            }
            "migrations" => {
                self.delete_migrations(id).await
            }
            "slot_type_versions" => {
                self.delete_slot_type_versions(id).await
            }
            "utterances_view" => {
                self.delete_utterances_view(id).await
            }
            "intent_version" => {
                self.delete_intent_version(id).await
            }
            "slot_type" => {
                self.delete_slot_type(id).await
            }
            "builtin_intent" => {
                self.delete_builtin_intent(id).await
            }
            "bot_channel_associations" => {
                self.delete_bot_channel_associations(id).await
            }
            "bot_version" => {
                self.delete_bot_version(id).await
            }
            "bots" => {
                self.delete_bots(id).await
            }
            "export" => {
                self.delete_export(id).await
            }
            "intents" => {
                self.delete_intents(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "lex_model_building_service",
    ...
    async fn create_builtin_intents(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_builtin_intents(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_bot_channel_association(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_bot_channel_association(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_intent(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("rejection_statement", rejection_statement.unwrap_or_default())
                .with_field("confirmation_prompt", confirmation_prompt.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                ...
                .with_field("fulfillment_activity", fulfillment_activity.unwrap_or_default())
                .with_field("conclusion_statement", conclusion_statement.unwrap_or_default())
    ...
    async fn create_bot(
        ...
        self.provider.runtime().block_on(async {
            ...
            let idle_session_ttl_in_seconds = input.get_optional_string("idle_session_ttl_in_seconds")?;
            let enable_model_improvements = input.get_optional_string("enable_model_improvements")?;
            let abort_statement = input.get_optional_string("abort_statement")?;
            let nlu_intent_confidence_threshold = input.get_optional_string("nlu_intent_confidence_threshold")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("name", name.unwrap_or_default())
                .with_field("clarification_prompt", clarification_prompt.unwrap_or_default())
                ...
                .with_field("enable_model_improvements", enable_model_improvements.unwrap_or_default())
    ...
    async fn create_builtin_slot_types(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_builtin_slot_types(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_builtin_slot_types(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_intent_versions(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_intent_versions(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_slot_type_version(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_slot_type_versions(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_slot_type_versions(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_slot_type_versions(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_utterances_view(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_utterances_view(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_slot_type(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("value_selection_strategy", value_selection_strategy.unwrap_or_default())
                .with_field("checksum", checksum.unwrap_or_default())
                .with_field("slot_type_configurations", slot_type_configurations.unwrap_or_default())
    ...
    async fn create_builtin_intent(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_builtin_intent(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_bot_channel_associations(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_bot_channel_associations(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
