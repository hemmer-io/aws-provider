...
impl<'a> Bot_alias<'a> {
    ...
    pub async fn create(&self, bot_version: String, tags: Option<Vec<String>>, description: Option<String>, checksum: Option<String>, conversation_logs: Option<String>, name: String, bot_name: String) -> Result<String> {
