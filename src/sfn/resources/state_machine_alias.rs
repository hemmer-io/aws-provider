...
impl<'a> State_machine_alias<'a> {
    ...
    pub async fn create(&self, name: String, description: Option<String>, routing_configuration: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, description: Option<String>, routing_configuration: Option<Vec<String>>) -> Result<()> {
