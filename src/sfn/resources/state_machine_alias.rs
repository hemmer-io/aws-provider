...
impl<'a> State_machine_alias<'a> {
    ...
    pub async fn create(&self, routing_configuration: Vec<String>, description: Option<String>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, routing_configuration: Option<Vec<String>>, description: Option<String>, name: Option<String>) -> Result<()> {
