...
impl<'a> Access_control_configuration<'a> {
    ...
    pub async fn create(&self, description: Option<String>, access_control_list: Option<Vec<String>>, hierarchical_access_control_list: Option<Vec<String>>, name: String, index_id: String, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, access_control_list: Option<Vec<String>>, hierarchical_access_control_list: Option<Vec<String>>, name: Option<String>, index_id: Option<String>, client_token: Option<String>) -> Result<()> {
