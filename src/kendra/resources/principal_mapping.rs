...
impl<'a> Principal_mapping<'a> {
    ...
    pub async fn create(&self, group_members: String, ordering_id: Option<i64>, role_arn: Option<String>, data_source_id: Option<String>, group_id: String, index_id: String) -> Result<String> {
