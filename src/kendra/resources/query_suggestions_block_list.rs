...
impl<'a> Query_suggestions_block_list<'a> {
    ...
    pub async fn create(&self, description: Option<String>, name: String, role_arn: String, index_id: String, tags: Option<Vec<String>>, source_s3_path: String, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, name: Option<String>, role_arn: Option<String>, index_id: Option<String>, tags: Option<Vec<String>>, source_s3_path: Option<String>, client_token: Option<String>) -> Result<()> {
