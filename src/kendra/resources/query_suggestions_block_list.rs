...
impl<'a> Query_suggestions_block_list<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, source_s3_path: String, description: Option<String>, index_id: String, name: String, role_arn: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, source_s3_path: Option<String>, description: Option<String>, index_id: Option<String>, name: Option<String>, role_arn: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
