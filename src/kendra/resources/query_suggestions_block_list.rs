...
impl<'a> Query_suggestions_block_list<'a> {
    ...
    pub async fn create(&self, index_id: String, role_arn: String, source_s3_path: String, description: Option<String>, client_token: Option<String>, tags: Option<Vec<String>>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, index_id: Option<String>, role_arn: Option<String>, source_s3_path: Option<String>, description: Option<String>, client_token: Option<String>, tags: Option<Vec<String>>, name: Option<String>) -> Result<()> {
