...
impl<'a> Query_suggestions_config<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, index_id: Option<String>, mode: Option<String>, include_queries_without_user_information: Option<bool>, query_log_look_back_window_in_days: Option<i64>, minimum_query_count: Option<i64>, attribute_suggestions_config: Option<String>, minimum_number_of_querying_users: Option<i64>) -> Result<()> {
