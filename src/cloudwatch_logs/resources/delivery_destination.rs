...
impl<'a> Delivery_destination<'a> {
    ...
    pub async fn create(&self, delivery_destination_type: Option<String>, delivery_destination_configuration: Option<String>, tags: Option<HashMap<String, String>>, name: String, output_format: Option<String>) -> Result<String> {
