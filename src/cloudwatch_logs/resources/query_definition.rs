...
impl<'a> Query_definition<'a> {
    ...
    pub async fn create(&self, name: String, query_definition_id: Option<String>, query_string: String, query_language: Option<String>, client_token: Option<String>, log_group_names: Option<Vec<String>>) -> Result<String> {
