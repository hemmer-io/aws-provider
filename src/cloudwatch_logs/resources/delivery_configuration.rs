...
impl<'a> Delivery_configuration<'a> {
    ...
    pub async fn update(&self, id: &str, s3_delivery_configuration: Option<String>, id: Option<String>, record_fields: Option<Vec<String>>, field_delimiter: Option<String>) -> Result<()> {
