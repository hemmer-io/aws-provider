...
impl<'a> Account_policy<'a> {
    ...
    pub async fn create(&self, policy_document: String, scope: Option<String>, selection_criteria: Option<String>, policy_name: String, policy_type: String) -> Result<String> {
