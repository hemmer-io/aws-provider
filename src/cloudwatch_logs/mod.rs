...
impl<'a> Cloudwatch_logsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "delivery_sources" => {
                self.plan_delivery_sources(current_state, desired_input).await
            }
            "query_definitions" => {
                self.plan_query_definitions(current_state, desired_input).await
            }
            "log_object" => {
                self.plan_log_object(current_state, desired_input).await
            }
            "log_group" => {
                self.plan_log_group(current_state, desired_input).await
            }
            "configuration_templates" => {
                self.plan_configuration_templates(current_state, desired_input).await
            }
            "export_task" => {
                self.plan_export_task(current_state, desired_input).await
            }
            "subscription_filter" => {
                self.plan_subscription_filter(current_state, desired_input).await
            }
            "account_policies" => {
                self.plan_account_policies(current_state, desired_input).await
            }
            "log_anomaly_detector" => {
                self.plan_log_anomaly_detector(current_state, desired_input).await
            }
            "destinations" => {
                self.plan_destinations(current_state, desired_input).await
            }
            "account_policy" => {
                self.plan_account_policy(current_state, desired_input).await
            }
            "transformer" => {
                self.plan_transformer(current_state, desired_input).await
            }
            "log_streams" => {
                self.plan_log_streams(current_state, desired_input).await
            }
            "data_protection_policy" => {
                self.plan_data_protection_policy(current_state, desired_input).await
            }
            "destination_policy" => {
                self.plan_destination_policy(current_state, desired_input).await
            }
            "log_groups" => {
                self.plan_log_groups(current_state, desired_input).await
            }
            "delivery_configuration" => {
                self.plan_delivery_configuration(current_state, desired_input).await
            }
            "delivery_destination" => {
                self.plan_delivery_destination(current_state, desired_input).await
            }
            "subscription_filters" => {
                self.plan_subscription_filters(current_state, desired_input).await
            }
            "delivery_destinations" => {
                self.plan_delivery_destinations(current_state, desired_input).await
            }
            "index_policies" => {
                self.plan_index_policies(current_state, desired_input).await
            }
            "delivery" => {
                self.plan_delivery(current_state, desired_input).await
            }
            "integration" => {
                self.plan_integration(current_state, desired_input).await
            }
            "log_record" => {
                self.plan_log_record(current_state, desired_input).await
            }
            "metric_filter" => {
                self.plan_metric_filter(current_state, desired_input).await
            }
            "index_policy" => {
                self.plan_index_policy(current_state, desired_input).await
            }
            "delivery_source" => {
                self.plan_delivery_source(current_state, desired_input).await
            }
            "retention_policy" => {
                self.plan_retention_policy(current_state, desired_input).await
            }
            "metric_filters" => {
                self.plan_metric_filters(current_state, desired_input).await
            }
            "resource_policy" => {
                self.plan_resource_policy(current_state, desired_input).await
            }
            "log_group_fields" => {
                self.plan_log_group_fields(current_state, desired_input).await
            }
            "deliveries" => {
                self.plan_deliveries(current_state, desired_input).await
            }
            "log_stream" => {
                self.plan_log_stream(current_state, desired_input).await
            }
            "destination" => {
                self.plan_destination(current_state, desired_input).await
            }
            "query_definition" => {
                self.plan_query_definition(current_state, desired_input).await
            }
            "queries" => {
                self.plan_queries(current_state, desired_input).await
            }
            "log_events" => {
                self.plan_log_events(current_state, desired_input).await
            }
            "query_results" => {
            ...
            "delivery_destination_policy" => {
                self.plan_delivery_destination_policy(current_state, desired_input).await
            }
            "export_tasks" => {
            ...
            "field_indexes" => {
                self.plan_field_indexes(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "delivery_sources" => {
                self.create_delivery_sources(input).await
            }
            "query_definitions" => {
                self.create_query_definitions(input).await
            }
            "log_object" => {
                self.create_log_object(input).await
            }
            "log_group" => {
                self.create_log_group(input).await
            }
            "configuration_templates" => {
                self.create_configuration_templates(input).await
            }
            "export_task" => {
                self.create_export_task(input).await
            }
            "subscription_filter" => {
                self.create_subscription_filter(input).await
            }
            "account_policies" => {
                self.create_account_policies(input).await
            }
            "log_anomaly_detector" => {
                self.create_log_anomaly_detector(input).await
            }
            "destinations" => {
                self.create_destinations(input).await
            }
            "account_policy" => {
                self.create_account_policy(input).await
            }
            "transformer" => {
                self.create_transformer(input).await
            }
            "log_streams" => {
                self.create_log_streams(input).await
            }
            "data_protection_policy" => {
                self.create_data_protection_policy(input).await
            }
            "destination_policy" => {
                self.create_destination_policy(input).await
            }
            "log_groups" => {
                self.create_log_groups(input).await
            }
            "delivery_configuration" => {
                self.create_delivery_configuration(input).await
            }
            "delivery_destination" => {
                self.create_delivery_destination(input).await
            }
            "subscription_filters" => {
                self.create_subscription_filters(input).await
            }
            "delivery_destinations" => {
                self.create_delivery_destinations(input).await
            }
            "index_policies" => {
                self.create_index_policies(input).await
            }
            "delivery" => {
                self.create_delivery(input).await
            }
            "integration" => {
                self.create_integration(input).await
            }
            "log_record" => {
                self.create_log_record(input).await
            }
            "metric_filter" => {
                self.create_metric_filter(input).await
            }
            "index_policy" => {
                self.create_index_policy(input).await
            }
            "delivery_source" => {
                self.create_delivery_source(input).await
            }
            "retention_policy" => {
                self.create_retention_policy(input).await
            }
            "metric_filters" => {
                self.create_metric_filters(input).await
            }
            "resource_policy" => {
                self.create_resource_policy(input).await
            }
            "log_group_fields" => {
                self.create_log_group_fields(input).await
            }
            "deliveries" => {
                self.create_deliveries(input).await
            }
            "log_stream" => {
                self.create_log_stream(input).await
            }
            "destination" => {
                self.create_destination(input).await
            }
            "query_definition" => {
                self.create_query_definition(input).await
            }
            "queries" => {
                self.create_queries(input).await
            }
            "log_events" => {
                self.create_log_events(input).await
            }
            "query_results" => {
            ...
            "delivery_destination_policy" => {
                self.create_delivery_destination_policy(input).await
            }
            "export_tasks" => {
            ...
            "field_indexes" => {
                self.create_field_indexes(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudwatch_logs",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "delivery_sources" => {
                self.read_delivery_sources(id).await
            }
            "query_definitions" => {
                self.read_query_definitions(id).await
            }
            "log_object" => {
                self.read_log_object(id).await
            }
            "log_group" => {
                self.read_log_group(id).await
            }
            "configuration_templates" => {
                self.read_configuration_templates(id).await
            }
            "export_task" => {
                self.read_export_task(id).await
            }
            "subscription_filter" => {
                self.read_subscription_filter(id).await
            }
            "account_policies" => {
                self.read_account_policies(id).await
            }
            "log_anomaly_detector" => {
                self.read_log_anomaly_detector(id).await
            }
            "destinations" => {
                self.read_destinations(id).await
            }
            "account_policy" => {
                self.read_account_policy(id).await
            }
            "transformer" => {
                self.read_transformer(id).await
            }
            "log_streams" => {
                self.read_log_streams(id).await
            }
            "data_protection_policy" => {
                self.read_data_protection_policy(id).await
            }
            "destination_policy" => {
                self.read_destination_policy(id).await
            }
            "log_groups" => {
                self.read_log_groups(id).await
            }
            "delivery_configuration" => {
                self.read_delivery_configuration(id).await
            }
            "delivery_destination" => {
                self.read_delivery_destination(id).await
            }
            "subscription_filters" => {
                self.read_subscription_filters(id).await
            }
            "delivery_destinations" => {
                self.read_delivery_destinations(id).await
            }
            "index_policies" => {
                self.read_index_policies(id).await
            }
            "delivery" => {
                self.read_delivery(id).await
            }
            "integration" => {
                self.read_integration(id).await
            }
            "log_record" => {
                self.read_log_record(id).await
            }
            "metric_filter" => {
                self.read_metric_filter(id).await
            }
            "index_policy" => {
                self.read_index_policy(id).await
            }
            "delivery_source" => {
                self.read_delivery_source(id).await
            }
            "retention_policy" => {
                self.read_retention_policy(id).await
            }
            "metric_filters" => {
                self.read_metric_filters(id).await
            }
            "resource_policy" => {
                self.read_resource_policy(id).await
            }
            "log_group_fields" => {
                self.read_log_group_fields(id).await
            }
            "deliveries" => {
                self.read_deliveries(id).await
            }
            "log_stream" => {
                self.read_log_stream(id).await
            }
            "destination" => {
                self.read_destination(id).await
            }
            "query_definition" => {
                self.read_query_definition(id).await
            }
            "queries" => {
                self.read_queries(id).await
            }
            "log_events" => {
                self.read_log_events(id).await
            }
            "query_results" => {
            ...
            "delivery_destination_policy" => {
                self.read_delivery_destination_policy(id).await
            }
            "export_tasks" => {
            ...
            "field_indexes" => {
                self.read_field_indexes(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudwatch_logs",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "delivery_sources" => {
                self.update_delivery_sources(id, input).await
            }
            "query_definitions" => {
                self.update_query_definitions(id, input).await
            }
            "log_object" => {
                self.update_log_object(id, input).await
            }
            "log_group" => {
                self.update_log_group(id, input).await
            }
            "configuration_templates" => {
                self.update_configuration_templates(id, input).await
            }
            "export_task" => {
                self.update_export_task(id, input).await
            }
            "subscription_filter" => {
                self.update_subscription_filter(id, input).await
            }
            "account_policies" => {
                self.update_account_policies(id, input).await
            }
            "log_anomaly_detector" => {
                self.update_log_anomaly_detector(id, input).await
            }
            "destinations" => {
                self.update_destinations(id, input).await
            }
            "account_policy" => {
                self.update_account_policy(id, input).await
            }
            "transformer" => {
                self.update_transformer(id, input).await
            }
            "log_streams" => {
                self.update_log_streams(id, input).await
            }
            "data_protection_policy" => {
                self.update_data_protection_policy(id, input).await
            }
            "destination_policy" => {
                self.update_destination_policy(id, input).await
            }
            "log_groups" => {
                self.update_log_groups(id, input).await
            }
            "delivery_configuration" => {
                self.update_delivery_configuration(id, input).await
            }
            "delivery_destination" => {
                self.update_delivery_destination(id, input).await
            }
            "subscription_filters" => {
                self.update_subscription_filters(id, input).await
            }
            "delivery_destinations" => {
                self.update_delivery_destinations(id, input).await
            }
            "index_policies" => {
                self.update_index_policies(id, input).await
            }
            "delivery" => {
                self.update_delivery(id, input).await
            }
            "integration" => {
                self.update_integration(id, input).await
            }
            "log_record" => {
                self.update_log_record(id, input).await
            }
            "metric_filter" => {
                self.update_metric_filter(id, input).await
            }
            "index_policy" => {
                self.update_index_policy(id, input).await
            }
            "delivery_source" => {
                self.update_delivery_source(id, input).await
            }
            "retention_policy" => {
                self.update_retention_policy(id, input).await
            }
            "metric_filters" => {
                self.update_metric_filters(id, input).await
            }
            "resource_policy" => {
                self.update_resource_policy(id, input).await
            }
            "log_group_fields" => {
                self.update_log_group_fields(id, input).await
            }
            "deliveries" => {
                self.update_deliveries(id, input).await
            }
            "log_stream" => {
                self.update_log_stream(id, input).await
            }
            "destination" => {
                self.update_destination(id, input).await
            }
            "query_definition" => {
                self.update_query_definition(id, input).await
            }
            "queries" => {
                self.update_queries(id, input).await
            }
            "log_events" => {
                self.update_log_events(id, input).await
            }
            "query_results" => {
            ...
            "field_indexes" => {
                self.update_field_indexes(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudwatch_logs",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "delivery_sources" => {
                self.delete_delivery_sources(id).await
            }
            "query_definitions" => {
                self.delete_query_definitions(id).await
            }
            "log_object" => {
                self.delete_log_object(id).await
            }
            "log_group" => {
                self.delete_log_group(id).await
            }
            "configuration_templates" => {
                self.delete_configuration_templates(id).await
            }
            "export_task" => {
                self.delete_export_task(id).await
            }
            "subscription_filter" => {
                self.delete_subscription_filter(id).await
            }
            "account_policies" => {
                self.delete_account_policies(id).await
            }
            "log_anomaly_detector" => {
                self.delete_log_anomaly_detector(id).await
            }
            "destinations" => {
                self.delete_destinations(id).await
            }
            "account_policy" => {
                self.delete_account_policy(id).await
            }
            "transformer" => {
                self.delete_transformer(id).await
            }
            "log_streams" => {
                self.delete_log_streams(id).await
            }
            "data_protection_policy" => {
                self.delete_data_protection_policy(id).await
            }
            "destination_policy" => {
                self.delete_destination_policy(id).await
            }
            "log_groups" => {
                self.delete_log_groups(id).await
            }
            "delivery_configuration" => {
                self.delete_delivery_configuration(id).await
            }
            "delivery_destination" => {
                self.delete_delivery_destination(id).await
            }
            "subscription_filters" => {
                self.delete_subscription_filters(id).await
            }
            "delivery_destinations" => {
                self.delete_delivery_destinations(id).await
            }
            "index_policies" => {
                self.delete_index_policies(id).await
            }
            "delivery" => {
                self.delete_delivery(id).await
            }
            "integration" => {
                self.delete_integration(id).await
            }
            "log_record" => {
                self.delete_log_record(id).await
            }
            "metric_filter" => {
                self.delete_metric_filter(id).await
            }
            "index_policy" => {
                self.delete_index_policy(id).await
            }
            "delivery_source" => {
                self.delete_delivery_source(id).await
            }
            "retention_policy" => {
                self.delete_retention_policy(id).await
            }
            "metric_filters" => {
                self.delete_metric_filters(id).await
            }
            "resource_policy" => {
                self.delete_resource_policy(id).await
            }
            "log_group_fields" => {
                self.delete_log_group_fields(id).await
            }
            "deliveries" => {
                self.delete_deliveries(id).await
            }
            "log_stream" => {
                self.delete_log_stream(id).await
            }
            "destination" => {
                self.delete_destination(id).await
            }
            "query_definition" => {
                self.delete_query_definition(id).await
            }
            "queries" => {
                self.delete_queries(id).await
            }
            "log_events" => {
                self.delete_log_events(id).await
            }
            "query_results" => {
            ...
            "delivery_destination_policy" => {
                self.delete_delivery_destination_policy(id).await
            }
            "export_tasks" => {
            ...
            "field_indexes" => {
                self.delete_field_indexes(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudwatch_logs",
    ...
    async fn create_delivery_sources(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn read_delivery_sources(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_delivery_sources(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_query_definitions(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_query_definitions(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_query_definitions(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_configuration_templates(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_configuration_templates(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_configuration_templates(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_export_task(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("log_group_name", log_group_name.unwrap_or_default())
                .with_field("log_stream_name_prefix", log_stream_name_prefix.unwrap_or_default())
    ...
    async fn create_subscription_filter(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("field_selection_criteria", field_selection_criteria.unwrap_or_default())
    ...
    async fn read_subscription_filter(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_account_policies(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_account_policies(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_account_policies(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_log_anomaly_detector(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("kms_key_id", kms_key_id.unwrap_or_default())
                .with_field("evaluation_frequency", evaluation_frequency.unwrap_or_default())
                .with_field("log_group_arn_list", log_group_arn_list.unwrap_or_default())
                .with_field("filter_pattern", filter_pattern.unwrap_or_default())
                .with_field("anomaly_visibility_time", anomaly_visibility_time.unwrap_or_default())
    ...
    async fn read_log_anomaly_detector(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_log_anomaly_detector(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_account_policy(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_account_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_transformer(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("log_group_identifier", log_group_identifier.unwrap_or_default())
    ...
    async fn create_data_protection_policy(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_data_protection_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_destination_policy(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_destination_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_delivery_configuration(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            let s3_delivery_configuration = input.get_optional_string("s3_delivery_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("s3_delivery_configuration", s3_delivery_configuration.unwrap_or_default())
            )
        })
    }

    /// Read a delivery_configuration resource
    async fn read_delivery_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_delivery_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_delivery_destination(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let delivery_destination_type = input.get_optional_string("delivery_destination_type")?;
            let delivery_destination_configuration = input.get_optional_string("delivery_destination_configuration")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("delivery_destination_type", delivery_destination_type.unwrap_or_default())
                .with_field("delivery_destination_configuration", delivery_destination_configuration.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
    ...
    async fn read_delivery_destination(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_subscription_filters(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_subscription_filters(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_subscription_filters(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_delivery_destinations(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_delivery_destinations(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_delivery_destinations(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_index_policies(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_index_policies(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_delivery(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("s3_delivery_configuration", s3_delivery_configuration.unwrap_or_default())
                .with_field("field_delimiter", field_delimiter.unwrap_or_default())
                .with_field("delivery_source_name", delivery_source_name.unwrap_or_default())
                .with_field("record_fields", record_fields.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("delivery_destination_arn", delivery_destination_arn.unwrap_or_default())
            )
        })
    }
    ...
    async fn create_metric_filter(
        ...
        self.provider.runtime().block_on(async {
            ...
            let emit_system_field_dimensions = input.get_optional_string("emit_system_field_dimensions")?;
            let log_group_name = input.get_string("log_group_name")?;
            let apply_on_transformed_logs = input.get_optional_string("apply_on_transformed_logs")?;
            let filter_pattern = input.get_string("filter_pattern")?;
            let filter_name = input.get_string("filter_name")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("metric_transformations", metric_transformations.unwrap_or_default())
                .with_field("emit_system_field_dimensions", emit_system_field_dimensions.unwrap_or_default())
                .with_field("log_group_name", log_group_name.unwrap_or_default())
                .with_field("apply_on_transformed_logs", apply_on_transformed_logs.unwrap_or_default())
                .with_field("filter_pattern", filter_pattern.unwrap_or_default())
                .with_field("filter_name", filter_name.unwrap_or_default())
    ...
    async fn create_delivery_source(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_delivery_source(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_retention_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_metric_filters(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_metric_filters(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_log_group_fields(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_log_group_fields(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_log_group_fields(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_query_definition(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("query_definition_id", query_definition_id.unwrap_or_default())
    ...
    async fn read_query_definition(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_anomaly(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("anomaly_detector_arn", anomaly_detector_arn.unwrap_or_default())
    ...
    async fn create_delivery_destination_policy(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("delivery_destination_name", delivery_destination_name.unwrap_or_default())
                .with_field("delivery_destination_policy", delivery_destination_policy.unwrap_or_default())
            )
        })
    }

    /// Read a delivery_destination_policy resource
    async fn read_delivery_destination_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_delivery_destination_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
