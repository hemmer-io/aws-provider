...
impl<'a> Event_bridge_rule_template<'a> {
    ...
    pub async fn create(&self, event_type: String, group_identifier: String, event_targets: Option<Vec<String>>, name: String, description: Option<String>, request_id: Option<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, event_type: Option<String>, group_identifier: Option<String>, event_targets: Option<Vec<String>>, name: Option<String>, description: Option<String>, request_id: Option<String>, tags: Option<HashMap<String, String>>) -> Result<()> {
