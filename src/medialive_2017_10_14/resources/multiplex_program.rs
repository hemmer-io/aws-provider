...
impl<'a> Multiplex_program<'a> {
    ...
    pub async fn create(&self, multiplex_id: String, program_name: String, request_id: String, multiplex_program_settings: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, multiplex_id: Option<String>, program_name: Option<String>, request_id: Option<String>, multiplex_program_settings: Option<String>) -> Result<()> {
