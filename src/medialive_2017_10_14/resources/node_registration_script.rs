...
impl<'a> Node_registration_script<'a> {
    ...
    pub async fn create(&self, id: Option<String>, cluster_id: String, node_interface_mappings: Option<Vec<String>>, request_id: Option<String>, name: Option<String>, role: Option<String>) -> Result<String> {
