...
impl<'a> Studio_session_mapping<'a> {
    ...
    pub async fn create(&self, identity_type: String, studio_id: String, identity_id: Option<String>, session_policy_arn: String, identity_name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, identity_type: Option<String>, studio_id: Option<String>, identity_id: Option<String>, session_policy_arn: Option<String>, identity_name: Option<String>) -> Result<()> {
