...
impl<'a> Persistent_app_ui<'a> {
    ...
    pub async fn create(&self, target_resource_arn: String, x_referer: Option<String>, emr_containers_config: Option<String>, profiler_type: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
