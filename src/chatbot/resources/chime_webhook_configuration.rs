...
impl<'a> Chime_webhook_configuration<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, logging_level: Option<String>, webhook_url: String, sns_topic_arns: Vec<String>, webhook_description: String, configuration_name: String, iam_role_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, logging_level: Option<String>, webhook_url: Option<String>, sns_topic_arns: Option<Vec<String>>, webhook_description: Option<String>, configuration_name: Option<String>, iam_role_arn: Option<String>) -> Result<()> {
