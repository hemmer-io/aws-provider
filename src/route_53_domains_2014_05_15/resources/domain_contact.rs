...
impl<'a> Domain_contact<'a> {
    ...
    pub async fn update(&self, id: &str, registrant_contact: Option<String>, consent: Option<String>, billing_contact: Option<String>, domain_name: Option<String>, admin_contact: Option<String>, tech_contact: Option<String>) -> Result<()> {
