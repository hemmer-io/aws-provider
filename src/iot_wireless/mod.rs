...
impl<'a> Iot_wirelessService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "wireless_device_import_task" => {
                self.plan_wireless_device_import_task(current_state, desired_input).await
            }
            "wireless_gateway_task" => {
                self.plan_wireless_gateway_task(current_state, desired_input).await
            }
            "fuota_task" => {
                self.plan_fuota_task(current_state, desired_input).await
            }
            "wireless_gateway_firmware_information" => {
                self.plan_wireless_gateway_firmware_information(current_state, desired_input).await
            }
            "destination" => {
                self.plan_destination(current_state, desired_input).await
            }
            "resource_event_configuration" => {
                self.plan_resource_event_configuration(current_state, desired_input).await
            }
            "position_configuration" => {
                self.plan_position_configuration(current_state, desired_input).await
            }
            "position_estimate" => {
                self.plan_position_estimate(current_state, desired_input).await
            }
            "wireless_device" => {
                self.plan_wireless_device(current_state, desired_input).await
            }
            "position" => {
                self.plan_position(current_state, desired_input).await
            }
            "wireless_gateway_task_definition" => {
                self.plan_wireless_gateway_task_definition(current_state, desired_input).await
            }
            "wireless_device_statistics" => {
                self.plan_wireless_device_statistics(current_state, desired_input).await
            }
            "wireless_gateway_certificate" => {
                self.plan_wireless_gateway_certificate(current_state, desired_input).await
            }
            "service_endpoint" => {
                self.plan_service_endpoint(current_state, desired_input).await
            }
            "partner_account" => {
                self.plan_partner_account(current_state, desired_input).await
            }
            "service_profile" => {
                self.plan_service_profile(current_state, desired_input).await
            }
            "log_levels_by_resource_types" => {
                self.plan_log_levels_by_resource_types(current_state, desired_input).await
            }
            "metric_configuration" => {
                self.plan_metric_configuration(current_state, desired_input).await
            }
            "multicast_group" => {
                self.plan_multicast_group(current_state, desired_input).await
            }
            "wireless_gateway_statistics" => {
                self.plan_wireless_gateway_statistics(current_state, desired_input).await
            }
            "resource_log_level" => {
                self.plan_resource_log_level(current_state, desired_input).await
            }
            "resource_position" => {
                self.plan_resource_position(current_state, desired_input).await
            }
            "device_profile" => {
                self.plan_device_profile(current_state, desired_input).await
            }
            "network_analyzer_configuration" => {
                self.plan_network_analyzer_configuration(current_state, desired_input).await
            }
            "queued_messages" => {
                self.plan_queued_messages(current_state, desired_input).await
            }
            "event_configuration_by_resource_types" => {
                self.plan_event_configuration_by_resource_types(current_state, desired_input).await
            }
            "multicast_group_session" => {
                self.plan_multicast_group_session(current_state, desired_input).await
            }
            "metrics" => {
                self.plan_metrics(current_state, desired_input).await
            }
            "wireless_gateway" => {
                self.plan_wireless_gateway(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "wireless_device_import_task" => {
                self.create_wireless_device_import_task(input).await
            }
            "wireless_gateway_task" => {
                self.create_wireless_gateway_task(input).await
            }
            "fuota_task" => {
                self.create_fuota_task(input).await
            }
            "wireless_gateway_firmware_information" => {
                self.create_wireless_gateway_firmware_information(input).await
            }
            "destination" => {
                self.create_destination(input).await
            }
            "resource_event_configuration" => {
                self.create_resource_event_configuration(input).await
            }
            "position_configuration" => {
                self.create_position_configuration(input).await
            }
            "position_estimate" => {
                self.create_position_estimate(input).await
            }
            "wireless_device" => {
                self.create_wireless_device(input).await
            }
            "position" => {
                self.create_position(input).await
            }
            "wireless_gateway_task_definition" => {
                self.create_wireless_gateway_task_definition(input).await
            }
            "wireless_device_statistics" => {
                self.create_wireless_device_statistics(input).await
            }
            "wireless_gateway_certificate" => {
                self.create_wireless_gateway_certificate(input).await
            }
            "service_endpoint" => {
                self.create_service_endpoint(input).await
            }
            "partner_account" => {
                self.create_partner_account(input).await
            }
            "service_profile" => {
                self.create_service_profile(input).await
            }
            "log_levels_by_resource_types" => {
                self.create_log_levels_by_resource_types(input).await
            }
            "metric_configuration" => {
                self.create_metric_configuration(input).await
            }
            "multicast_group" => {
                self.create_multicast_group(input).await
            }
            "wireless_gateway_statistics" => {
                self.create_wireless_gateway_statistics(input).await
            }
            "resource_log_level" => {
                self.create_resource_log_level(input).await
            }
            "resource_position" => {
                self.create_resource_position(input).await
            }
            "device_profile" => {
                self.create_device_profile(input).await
            }
            "network_analyzer_configuration" => {
                self.create_network_analyzer_configuration(input).await
            }
            "queued_messages" => {
                self.create_queued_messages(input).await
            }
            "event_configuration_by_resource_types" => {
                self.create_event_configuration_by_resource_types(input).await
            }
            "multicast_group_session" => {
                self.create_multicast_group_session(input).await
            }
            "metrics" => {
                self.create_metrics(input).await
            }
            "wireless_gateway" => {
                self.create_wireless_gateway(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iot_wireless",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "wireless_device_import_task" => {
                self.read_wireless_device_import_task(id).await
            }
            "wireless_gateway_task" => {
                self.read_wireless_gateway_task(id).await
            }
            "fuota_task" => {
                self.read_fuota_task(id).await
            }
            "wireless_gateway_firmware_information" => {
            ...
            "resource_event_configuration" => {
                self.read_resource_event_configuration(id).await
            }
            "position_configuration" => {
                self.read_position_configuration(id).await
            }
            "position_estimate" => {
                self.read_position_estimate(id).await
            }
            "wireless_device" => {
                self.read_wireless_device(id).await
            }
            "position" => {
                self.read_position(id).await
            }
            "wireless_gateway_task_definition" => {
                self.read_wireless_gateway_task_definition(id).await
            }
            "wireless_device_statistics" => {
                self.read_wireless_device_statistics(id).await
            }
            "wireless_gateway_certificate" => {
                self.read_wireless_gateway_certificate(id).await
            }
            "service_endpoint" => {
                self.read_service_endpoint(id).await
            }
            "partner_account" => {
                self.read_partner_account(id).await
            }
            "service_profile" => {
                self.read_service_profile(id).await
            }
            "log_levels_by_resource_types" => {
                self.read_log_levels_by_resource_types(id).await
            }
            "metric_configuration" => {
                self.read_metric_configuration(id).await
            }
            "multicast_group" => {
                self.read_multicast_group(id).await
            }
            "wireless_gateway_statistics" => {
                self.read_wireless_gateway_statistics(id).await
            }
            "resource_log_level" => {
                self.read_resource_log_level(id).await
            }
            "resource_position" => {
                self.read_resource_position(id).await
            }
            "device_profile" => {
                self.read_device_profile(id).await
            }
            "network_analyzer_configuration" => {
                self.read_network_analyzer_configuration(id).await
            }
            "queued_messages" => {
                self.read_queued_messages(id).await
            }
            "event_configuration_by_resource_types" => {
                self.read_event_configuration_by_resource_types(id).await
            }
            "multicast_group_session" => {
                self.read_multicast_group_session(id).await
            }
            "metrics" => {
                self.read_metrics(id).await
            }
            "wireless_gateway" => {
                self.read_wireless_gateway(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iot_wireless",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "wireless_gateway_task" => {
                self.update_wireless_gateway_task(id, input).await
            }
            "fuota_task" => {
                self.update_fuota_task(id, input).await
            }
            "wireless_gateway_firmware_information" => {
                self.update_wireless_gateway_firmware_information(id, input).await
            }
            "destination" => {
            ...
            "position_configuration" => {
                self.update_position_configuration(id, input).await
            }
            "position_estimate" => {
                self.update_position_estimate(id, input).await
            }
            "wireless_device" => {
                self.update_wireless_device(id, input).await
            }
            "position" => {
                self.update_position(id, input).await
            }
            "wireless_gateway_task_definition" => {
                self.update_wireless_gateway_task_definition(id, input).await
            }
            "wireless_device_statistics" => {
                self.update_wireless_device_statistics(id, input).await
            }
            "wireless_gateway_certificate" => {
                self.update_wireless_gateway_certificate(id, input).await
            }
            "service_endpoint" => {
                self.update_service_endpoint(id, input).await
            }
            "partner_account" => {
                self.update_partner_account(id, input).await
            }
            "service_profile" => {
                self.update_service_profile(id, input).await
            }
            "log_levels_by_resource_types" => {
                self.update_log_levels_by_resource_types(id, input).await
            }
            "metric_configuration" => {
                self.update_metric_configuration(id, input).await
            }
            "multicast_group" => {
                self.update_multicast_group(id, input).await
            }
            "wireless_gateway_statistics" => {
                self.update_wireless_gateway_statistics(id, input).await
            }
            "resource_log_level" => {
                self.update_resource_log_level(id, input).await
            }
            "resource_position" => {
                self.update_resource_position(id, input).await
            }
            "device_profile" => {
                self.update_device_profile(id, input).await
            }
            "network_analyzer_configuration" => {
                self.update_network_analyzer_configuration(id, input).await
            }
            "queued_messages" => {
                self.update_queued_messages(id, input).await
            }
            "event_configuration_by_resource_types" => {
                self.update_event_configuration_by_resource_types(id, input).await
            }
            "multicast_group_session" => {
                self.update_multicast_group_session(id, input).await
            }
            "metrics" => {
                self.update_metrics(id, input).await
            }
            "wireless_gateway" => {
                self.update_wireless_gateway(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iot_wireless",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "wireless_device_import_task" => {
                self.delete_wireless_device_import_task(id).await
            }
            "wireless_gateway_task" => {
                self.delete_wireless_gateway_task(id).await
            }
            "fuota_task" => {
                self.delete_fuota_task(id).await
            }
            "wireless_gateway_firmware_information" => {
            ...
            "resource_event_configuration" => {
                self.delete_resource_event_configuration(id).await
            }
            "position_configuration" => {
                self.delete_position_configuration(id).await
            }
            "position_estimate" => {
                self.delete_position_estimate(id).await
            }
            "wireless_device" => {
                self.delete_wireless_device(id).await
            }
            "position" => {
                self.delete_position(id).await
            }
            "wireless_gateway_task_definition" => {
                self.delete_wireless_gateway_task_definition(id).await
            }
            "wireless_device_statistics" => {
                self.delete_wireless_device_statistics(id).await
            }
            "wireless_gateway_certificate" => {
                self.delete_wireless_gateway_certificate(id).await
            }
            "service_endpoint" => {
                self.delete_service_endpoint(id).await
            }
            "partner_account" => {
                self.delete_partner_account(id).await
            }
            "service_profile" => {
                self.delete_service_profile(id).await
            }
            "log_levels_by_resource_types" => {
                self.delete_log_levels_by_resource_types(id).await
            }
            "metric_configuration" => {
                self.delete_metric_configuration(id).await
            }
            "multicast_group" => {
                self.delete_multicast_group(id).await
            }
            "wireless_gateway_statistics" => {
                self.delete_wireless_gateway_statistics(id).await
            }
            "resource_log_level" => {
                self.delete_resource_log_level(id).await
            }
            "resource_position" => {
                self.delete_resource_position(id).await
            }
            "device_profile" => {
                self.delete_device_profile(id).await
            }
            "network_analyzer_configuration" => {
                self.delete_network_analyzer_configuration(id).await
            }
            "queued_messages" => {
                self.delete_queued_messages(id).await
            }
            "event_configuration_by_resource_types" => {
                self.delete_event_configuration_by_resource_types(id).await
            }
            "multicast_group_session" => {
                self.delete_multicast_group_session(id).await
            }
            "metrics" => {
                self.delete_metrics(id).await
            }
            "wireless_gateway" => {
                self.delete_wireless_gateway(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iot_wireless",
    ...
    async fn read_wireless_device_import_task(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_wireless_device_import_task(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_wireless_gateway_task(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let id = input.get_string("id")?;
            let wireless_gateway_task_definition_id = input.get_string("wireless_gateway_task_definition_id")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("id", id.unwrap_or_default())
                .with_field("wireless_gateway_task_definition_id", wireless_gateway_task_definition_id.unwrap_or_default())
            )
        })
    }

    /// Read a wireless_gateway_task resource
    async fn read_wireless_gateway_task(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_wireless_gateway_task(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_fuota_task(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("firmware_update_role", firmware_update_role.unwrap_or_default())
                .with_field("firmware_update_image", firmware_update_image.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                .with_field("fragment_size_bytes", fragment_size_bytes.unwrap_or_default())
                .with_field("fragment_interval_ms", fragment_interval_ms.unwrap_or_default())
    ...
    async fn read_wireless_gateway_firmware_information(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_wireless_gateway_firmware_information(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_resource_event_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            let device_registration_state = input.get_optional_string("device_registration_state")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("device_registration_state", device_registration_state.unwrap_or_default())
                .with_field("join", join.unwrap_or_default())
                .with_field("message_delivery_status", message_delivery_status.unwrap_or_default())
    ...
    async fn read_resource_event_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resource_event_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_position_configuration(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_position_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_position_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_position_estimate(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_position_estimate(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_position_estimate(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_wireless_device(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_wireless_device(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_wireless_gateway_task_definition(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_wireless_gateway_task_definition(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_wireless_device_statistics(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_wireless_device_statistics(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_wireless_gateway_certificate(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_wireless_gateway_certificate(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_service_endpoint(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_partner_account(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_partner_account(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_service_profile(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_log_levels_by_resource_types(
        ...
        self.provider.runtime().block_on(async {
            ...
            let wireless_device_log_options = input.get_optional_string("wireless_device_log_options")?;
            let wireless_gateway_log_options = input.get_optional_string("wireless_gateway_log_options")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("fuota_task_log_options", fuota_task_log_options.unwrap_or_default())
                .with_field("wireless_device_log_options", wireless_device_log_options.unwrap_or_default())
                .with_field("wireless_gateway_log_options", wireless_gateway_log_options.unwrap_or_default())
            )
        })
    }

    /// Read a log_levels_by_resource_types resource
    async fn read_log_levels_by_resource_types(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_log_levels_by_resource_types(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_metric_configuration(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_metric_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_metric_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_multicast_group(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_wireless_gateway_statistics(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_wireless_gateway_statistics(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_resource_log_level(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_resource_log_level(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resource_log_level(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_resource_position(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_resource_position(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resource_position(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_network_analyzer_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_network_analyzer_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_queued_messages(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_queued_messages(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_event_configuration_by_resource_types(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_event_configuration_by_resource_types(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_multicast_group_session(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_multicast_group_session(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_multicast_group_session(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_wireless_gateway(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_wireless_gateway(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_wireless_gateway(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
