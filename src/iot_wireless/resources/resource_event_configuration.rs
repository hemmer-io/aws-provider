...
impl<'a> Resource_event_configuration<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, connection_status: Option<String>, device_registration_state: Option<String>, join: Option<String>, message_delivery_status: Option<String>, identifier_type: Option<String>, identifier: Option<String>, proximity: Option<String>, partner_type: Option<String>) -> Result<()> {
