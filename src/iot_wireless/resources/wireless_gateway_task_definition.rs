...
impl<'a> Wireless_gateway_task_definition<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, name: Option<String>, update: Option<String>, client_request_token: Option<String>, auto_create_tasks: bool) -> Result<String> {
