...
impl<'a> Device_profile<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, sidewalk: Option<String>, name: Option<String>, client_request_token: Option<String>, lo_ra_wan: Option<String>) -> Result<String> {
