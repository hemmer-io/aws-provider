...
impl<'a> Device_profile<'a> {
    ...
    pub async fn create(&self, client_request_token: Option<String>, sidewalk: Option<String>, name: Option<String>, lo_ra_wan: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
