...
impl<'a> Device_profile<'a> {
    ...
    pub async fn create(&self, lo_ra_wan: Option<String>, client_request_token: Option<String>, tags: Option<Vec<String>>, sidewalk: Option<String>, name: Option<String>) -> Result<String> {
