...
impl<'a> FmsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "protocols_list" => {
                self.plan_protocols_list(current_state, desired_input).await
            }
            ...
            "admin_scope" => {
                self.plan_admin_scope(current_state, desired_input).await
            }
            "violation_details" => {
                self.plan_violation_details(current_state, desired_input).await
            }
            "apps_list" => {
                self.plan_apps_list(current_state, desired_input).await
            }
            "third_party_firewall_association_status" => {
                self.plan_third_party_firewall_association_status(current_state, desired_input).await
            }
            "protection_status" => {
                self.plan_protection_status(current_state, desired_input).await
            }
            "admin_account" => {
                self.plan_admin_account(current_state, desired_input).await
            }
            "policy" => {
                self.plan_policy(current_state, desired_input).await
            }
            "compliance_detail" => {
                self.plan_compliance_detail(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "protocols_list" => {
                self.create_protocols_list(input).await
            }
            "notification_channel" => {
            ...
            "admin_scope" => {
                self.create_admin_scope(input).await
            }
            "violation_details" => {
                self.create_violation_details(input).await
            }
            "apps_list" => {
                self.create_apps_list(input).await
            }
            "third_party_firewall_association_status" => {
                self.create_third_party_firewall_association_status(input).await
            }
            "protection_status" => {
                self.create_protection_status(input).await
            }
            "admin_account" => {
                self.create_admin_account(input).await
            }
            "policy" => {
                self.create_policy(input).await
            }
            "compliance_detail" => {
                self.create_compliance_detail(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "fms",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "protocols_list" => {
                self.read_protocols_list(id).await
            }
            "notification_channel" => {
            ...
            "admin_scope" => {
                self.read_admin_scope(id).await
            }
            "violation_details" => {
                self.read_violation_details(id).await
            }
            "apps_list" => {
                self.read_apps_list(id).await
            }
            "third_party_firewall_association_status" => {
                self.read_third_party_firewall_association_status(id).await
            }
            "protection_status" => {
                self.read_protection_status(id).await
            }
            "admin_account" => {
                self.read_admin_account(id).await
            }
            "policy" => {
                self.read_policy(id).await
            }
            "compliance_detail" => {
                self.read_compliance_detail(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "fms",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "protocols_list" => {
                self.update_protocols_list(id, input).await
            }
            "notification_channel" => {
            ...
            "admin_scope" => {
                self.update_admin_scope(id, input).await
            }
            "violation_details" => {
                self.update_violation_details(id, input).await
            }
            "apps_list" => {
                self.update_apps_list(id, input).await
            }
            "third_party_firewall_association_status" => {
                self.update_third_party_firewall_association_status(id, input).await
            }
            "protection_status" => {
                self.update_protection_status(id, input).await
            }
            "admin_account" => {
                self.update_admin_account(id, input).await
            }
            "policy" => {
                self.update_policy(id, input).await
            }
            "compliance_detail" => {
                self.update_compliance_detail(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "fms",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "protocols_list" => {
                self.delete_protocols_list(id).await
            }
            "notification_channel" => {
            ...
            "admin_scope" => {
                self.delete_admin_scope(id).await
            }
            "violation_details" => {
                self.delete_violation_details(id).await
            }
            "apps_list" => {
                self.delete_apps_list(id).await
            }
            "third_party_firewall_association_status" => {
                self.delete_third_party_firewall_association_status(id).await
            }
            "protection_status" => {
                self.delete_protection_status(id).await
            }
            "admin_account" => {
                self.delete_admin_account(id).await
            }
            "policy" => {
                self.delete_policy(id).await
            }
            "compliance_detail" => {
                self.delete_compliance_detail(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "fms",
    ...
    async fn create_protocols_list(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn create_violation_details(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_violation_details(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_violation_details(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_third_party_firewall_association_status(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_protection_status(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_protection_status(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_protection_status(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_compliance_detail(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_compliance_detail(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_compliance_detail(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
