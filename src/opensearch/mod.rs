...
impl<'a> OpensearchService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "domain_health" => self.plan_domain_health(current_state, desired_input).await,
            "inbound_connection" => {
                self.plan_inbound_connection(current_state, desired_input)
                    .await
            }
            "application" => self.plan_application(current_state, desired_input).await,
            "reserved_instance_offerings" => {
                self.plan_reserved_instance_offerings(current_state, desired_input)
                    .await
            }
            "vpc_endpoints" => self.plan_vpc_endpoints(current_state, desired_input).await,
            "upgrade_history" => {
                self.plan_upgrade_history(current_state, desired_input)
                    .await
            }
            "domain" => self.plan_domain(current_state, desired_input).await,
            "domain_auto_tunes" => {
                self.plan_domain_auto_tunes(current_state, desired_input)
                    .await
            }
            "domains" => self.plan_domains(current_state, desired_input).await,
            "package_scope" => self.plan_package_scope(current_state, desired_input).await,
            "upgrade_status" => self.plan_upgrade_status(current_state, desired_input).await,
            "dry_run_progress" => {
                self.plan_dry_run_progress(current_state, desired_input)
                    .await
            }
            "package" => self.plan_package(current_state, desired_input).await,
            "domain_change_progress" => {
                self.plan_domain_change_progress(current_state, desired_input)
                    .await
            }
            "inbound_connections" => {
                self.plan_inbound_connections(current_state, desired_input)
                    .await
            }
            "domain_nodes" => self.plan_domain_nodes(current_state, desired_input).await,
            "domain_maintenance_status" => {
                self.plan_domain_maintenance_status(current_state, desired_input)
                    .await
            }
            "package_version_history" => {
                self.plan_package_version_history(current_state, desired_input)
                    .await
            }
            "outbound_connection" => {
                self.plan_outbound_connection(current_state, desired_input)
                    .await
            }
            "direct_query_data_source" => {
                self.plan_direct_query_data_source(current_state, desired_input)
                    .await
            }
            "scheduled_action" => {
            ...
            "instance_type_limits" => {
                self.plan_instance_type_limits(current_state, desired_input)
                    .await
            }
            "outbound_connections" => {
                self.plan_outbound_connections(current_state, desired_input)
                    .await
            }
            "domain_config" => self.plan_domain_config(current_state, desired_input).await,
            "reserved_instances" => {
                self.plan_reserved_instances(current_state, desired_input)
                    .await
            }
            "data_source" => self.plan_data_source(current_state, desired_input).await,
            "vpc_endpoint" => self.plan_vpc_endpoint(current_state, desired_input).await,
            "compatible_versions" => {
                self.plan_compatible_versions(current_state, desired_input)
                    .await
            }
            "packages" => self.plan_packages(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "opensearch", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "domain_health" => self.create_domain_health(input).await,
            "inbound_connection" => self.create_inbound_connection(input).await,
            "application" => self.create_application(input).await,
            "reserved_instance_offerings" => self.create_reserved_instance_offerings(input).await,
            "vpc_endpoints" => self.create_vpc_endpoints(input).await,
            "upgrade_history" => self.create_upgrade_history(input).await,
            "domain" => self.create_domain(input).await,
            "domain_auto_tunes" => self.create_domain_auto_tunes(input).await,
            "domains" => self.create_domains(input).await,
            "package_scope" => self.create_package_scope(input).await,
            "upgrade_status" => self.create_upgrade_status(input).await,
            "dry_run_progress" => self.create_dry_run_progress(input).await,
            "package" => self.create_package(input).await,
            "domain_change_progress" => self.create_domain_change_progress(input).await,
            "inbound_connections" => self.create_inbound_connections(input).await,
            "domain_nodes" => self.create_domain_nodes(input).await,
            "domain_maintenance_status" => self.create_domain_maintenance_status(input).await,
            "package_version_history" => self.create_package_version_history(input).await,
            "outbound_connection" => self.create_outbound_connection(input).await,
            "direct_query_data_source" => self.create_direct_query_data_source(input).await,
            "scheduled_action" => self.create_scheduled_action(input).await,
            "instance_type_limits" => self.create_instance_type_limits(input).await,
            "outbound_connections" => self.create_outbound_connections(input).await,
            "domain_config" => self.create_domain_config(input).await,
            "reserved_instances" => self.create_reserved_instances(input).await,
            "data_source" => self.create_data_source(input).await,
            "vpc_endpoint" => self.create_vpc_endpoint(input).await,
            "compatible_versions" => self.create_compatible_versions(input).await,
            "packages" => self.create_packages(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "opensearch", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "domain_health" => self.read_domain_health(id).await,
            "inbound_connection" => self.read_inbound_connection(id).await,
            "application" => self.read_application(id).await,
            "reserved_instance_offerings" => self.read_reserved_instance_offerings(id).await,
            "vpc_endpoints" => self.read_vpc_endpoints(id).await,
            "upgrade_history" => self.read_upgrade_history(id).await,
            "domain" => self.read_domain(id).await,
            "domain_auto_tunes" => self.read_domain_auto_tunes(id).await,
            "domains" => self.read_domains(id).await,
            "package_scope" => self.read_package_scope(id).await,
            "upgrade_status" => self.read_upgrade_status(id).await,
            "dry_run_progress" => self.read_dry_run_progress(id).await,
            "package" => self.read_package(id).await,
            "domain_change_progress" => self.read_domain_change_progress(id).await,
            "inbound_connections" => self.read_inbound_connections(id).await,
            "domain_nodes" => self.read_domain_nodes(id).await,
            "domain_maintenance_status" => self.read_domain_maintenance_status(id).await,
            "package_version_history" => self.read_package_version_history(id).await,
            "outbound_connection" => self.read_outbound_connection(id).await,
            "direct_query_data_source" => self.read_direct_query_data_source(id).await,
            "scheduled_action" => self.read_scheduled_action(id).await,
            "instance_type_limits" => self.read_instance_type_limits(id).await,
            "outbound_connections" => self.read_outbound_connections(id).await,
            "domain_config" => self.read_domain_config(id).await,
            "reserved_instances" => self.read_reserved_instances(id).await,
            "data_source" => self.read_data_source(id).await,
            "vpc_endpoint" => self.read_vpc_endpoint(id).await,
            "compatible_versions" => self.read_compatible_versions(id).await,
            "packages" => self.read_packages(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "opensearch", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "domain_health" => self.update_domain_health(id, input).await,
            "inbound_connection" => self.update_inbound_connection(id, input).await,
            "application" => self.update_application(id, input).await,
            "reserved_instance_offerings" => {
                self.update_reserved_instance_offerings(id, input).await
            }
            "vpc_endpoints" => self.update_vpc_endpoints(id, input).await,
            "upgrade_history" => self.update_upgrade_history(id, input).await,
            "domain" => self.update_domain(id, input).await,
            "domain_auto_tunes" => self.update_domain_auto_tunes(id, input).await,
            "domains" => self.update_domains(id, input).await,
            "package_scope" => self.update_package_scope(id, input).await,
            "upgrade_status" => self.update_upgrade_status(id, input).await,
            "dry_run_progress" => self.update_dry_run_progress(id, input).await,
            "package" => self.update_package(id, input).await,
            "domain_change_progress" => self.update_domain_change_progress(id, input).await,
            "inbound_connections" => self.update_inbound_connections(id, input).await,
            "domain_nodes" => self.update_domain_nodes(id, input).await,
            "domain_maintenance_status" => self.update_domain_maintenance_status(id, input).await,
            "package_version_history" => self.update_package_version_history(id, input).await,
            "outbound_connection" => self.update_outbound_connection(id, input).await,
            "direct_query_data_source" => self.update_direct_query_data_source(id, input).await,
            "scheduled_action" => self.update_scheduled_action(id, input).await,
            "instance_type_limits" => self.update_instance_type_limits(id, input).await,
            "outbound_connections" => self.update_outbound_connections(id, input).await,
            "domain_config" => self.update_domain_config(id, input).await,
            "reserved_instances" => self.update_reserved_instances(id, input).await,
            "data_source" => self.update_data_source(id, input).await,
            "vpc_endpoint" => self.update_vpc_endpoint(id, input).await,
            "compatible_versions" => self.update_compatible_versions(id, input).await,
            "packages" => self.update_packages(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "opensearch", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "domain_health" => self.delete_domain_health(id).await,
            "inbound_connection" => self.delete_inbound_connection(id).await,
            "application" => self.delete_application(id).await,
            "reserved_instance_offerings" => self.delete_reserved_instance_offerings(id).await,
            "vpc_endpoints" => self.delete_vpc_endpoints(id).await,
            "upgrade_history" => self.delete_upgrade_history(id).await,
            "domain" => self.delete_domain(id).await,
            "domain_auto_tunes" => self.delete_domain_auto_tunes(id).await,
            "domains" => self.delete_domains(id).await,
            "package_scope" => self.delete_package_scope(id).await,
            "upgrade_status" => self.delete_upgrade_status(id).await,
            "dry_run_progress" => self.delete_dry_run_progress(id).await,
            "package" => self.delete_package(id).await,
            "domain_change_progress" => self.delete_domain_change_progress(id).await,
            "inbound_connections" => self.delete_inbound_connections(id).await,
            "domain_nodes" => self.delete_domain_nodes(id).await,
            "domain_maintenance_status" => self.delete_domain_maintenance_status(id).await,
            "package_version_history" => self.delete_package_version_history(id).await,
            "outbound_connection" => self.delete_outbound_connection(id).await,
            "direct_query_data_source" => self.delete_direct_query_data_source(id).await,
            "scheduled_action" => self.delete_scheduled_action(id).await,
            "instance_type_limits" => self.delete_instance_type_limits(id).await,
            "outbound_connections" => self.delete_outbound_connections(id).await,
            "domain_config" => self.delete_domain_config(id).await,
            "reserved_instances" => self.delete_reserved_instances(id).await,
            "data_source" => self.delete_data_source(id).await,
            "vpc_endpoint" => self.delete_vpc_endpoint(id).await,
            "compatible_versions" => self.delete_compatible_versions(id).await,
            "packages" => self.delete_packages(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "opensearch", resource_name
            ))),
    ...
    async fn create_domain_health(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_domain_health(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_domain_health(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_domain_health(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_inbound_connection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_inbound_connection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_inbound_connection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_application(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let iam_identity_center_options =
                input.get_optional_string("iam_identity_center_options")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    iam_identity_center_options.unwrap_or_default(),
                )
    ...
    async fn read_reserved_instance_offerings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_reserved_instance_offerings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_vpc_endpoints(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_vpc_endpoints(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn update_vpc_endpoints(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_vpc_endpoints(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_upgrade_history(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_upgrade_history(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_upgrade_history(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_domain(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let node_to_node_encryption_options =
                input.get_optional_string("node_to_node_encryption_options")?;
            ...
            let advanced_security_options =
                input.get_optional_string("advanced_security_options")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    node_to_node_encryption_options.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    software_update_options.unwrap_or_default(),
                )
                .with_field(
                    "off_peak_window_options",
                    off_peak_window_options.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    identity_center_options.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    advanced_security_options.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_domain_auto_tunes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_domain_auto_tunes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_domain_auto_tunes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_package_scope(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_package_scope(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn update_package_scope(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let package_id = input.get_string("package_id")?;
            let package_user_list = input.get_string("package_user_list")?;
    ...
    async fn delete_package_scope(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_upgrade_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_upgrade_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_upgrade_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_dry_run_progress(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_dry_run_progress(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_dry_run_progress(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_package(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let package_encryption_options =
                input.get_optional_string("package_encryption_options")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "package_description",
                    package_description.unwrap_or_default(),
                )
                .with_field("package_name", package_name.unwrap_or_default())
                .with_field(
                    "package_encryption_options",
                    package_encryption_options.unwrap_or_default(),
                )
                .with_field("package_type", package_type.unwrap_or_default())
                .with_field(
                    "package_vending_options",
                    package_vending_options.unwrap_or_default(),
                )
                .with_field(
                    "package_configuration",
                    package_configuration.unwrap_or_default(),
                )
    ...
    async fn create_domain_change_progress(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_domain_change_progress(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_domain_change_progress(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_inbound_connections(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_inbound_connections(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_inbound_connections(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_domain_nodes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_domain_nodes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn update_domain_nodes(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_domain_nodes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn read_domain_maintenance_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_domain_maintenance_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_package_version_history(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_package_version_history(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_package_version_history(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_outbound_connection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    connection_properties.unwrap_or_default(),
                )
    ...
    async fn read_outbound_connection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_outbound_connection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn read_direct_query_data_source(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_direct_query_data_source(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_instance_type_limits(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_type_limits(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_instance_type_limits(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_outbound_connections(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_outbound_connections(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_outbound_connections(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_domain_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_domain_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn update_domain_config(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let dry_run = input.get_optional_string("dry_run")?;
            let auto_tune_options = input.get_optional_string("auto_tune_options")?;
    ...
    async fn delete_domain_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_reserved_instances(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_reserved_instances(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_reserved_instances(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_vpc_endpoint(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_vpc_endpoint(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn update_vpc_endpoint(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let vpc_options = input.get_string("vpc_options")?;
            let client_token = input.get_optional_string("client_token")?;
    ...
    async fn delete_vpc_endpoint(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_compatible_versions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_compatible_versions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn delete_compatible_versions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
    ...
    async fn create_packages(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_packages(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.opensearch_client
    ...
    async fn update_packages(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_packages(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.opensearch_client
