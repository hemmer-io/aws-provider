...
impl<'a> Scheduled_action<'a> {
    ...
    pub async fn update(&self, id: &str, domain_name: Option<String>, action_id: Option<String>, action_type: Option<String>, schedule_at: Option<String>, desired_start_time: Option<i64>) -> Result<()> {
