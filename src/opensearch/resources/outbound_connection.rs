...
impl<'a> Outbound_connection<'a> {
    ...
    pub async fn create(&self, connection_mode: Option<String>, connection_properties: Option<String>, connection_alias: String, local_domain_info: String, remote_domain_info: String) -> Result<String> {
