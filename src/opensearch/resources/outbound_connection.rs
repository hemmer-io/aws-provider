...
impl<'a> Outbound_connection<'a> {
    ...
    pub async fn create(&self, connection_alias: String, remote_domain_info: String, connection_mode: Option<String>, local_domain_info: String, connection_properties: Option<String>) -> Result<String> {
