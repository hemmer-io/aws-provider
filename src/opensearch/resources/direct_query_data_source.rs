...
impl<'a> Direct_query_data_source<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, open_search_arns: Option<Vec<String>>, description: Option<String>, data_source_name: Option<String>, data_source_type: Option<String>) -> Result<()> {
