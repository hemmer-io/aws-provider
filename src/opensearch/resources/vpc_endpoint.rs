...
impl<'a> Vpc_endpoint<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, vpc_options: String, domain_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, vpc_options: Option<String>, domain_arn: Option<String>) -> Result<()> {
