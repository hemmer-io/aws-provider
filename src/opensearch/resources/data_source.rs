...
impl<'a> Data_source<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, domain_name: Option<String>, data_source_type: Option<String>, description: Option<String>, status: Option<String>) -> Result<()> {
