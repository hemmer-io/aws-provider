...
impl<'a> Instance_metadata_options<'a> {
    ...
    pub async fn update(&self, id: &str, http_put_response_hop_limit: Option<i64>, http_tokens: Option<String>, http_protocol_ipv6: Option<String>, instance_name: Option<String>, http_endpoint: Option<String>) -> Result<()> {
