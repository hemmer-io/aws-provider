//! Lightsail_2016_11_28 Service
//!
//! Auto-generated service module for lightsail_2016_11_28

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for lightsail_2016_11_28
pub struct Lightsail_2016_11_28Service<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Lightsail_2016_11_28Service<'a> {
    ...
    /// Get container_api_metadata resource handler
    pub fn container_api_metadata(&self) -> resources::Container_api_metadata<'_> {
        resources::Container_api_metadata::new(self.provider)
    }
    ...
    /// Get gui_session_access_details resource handler
    pub fn gui_session_access_details(&self) -> resources::Gui_session_access_details<'_> {
        resources::Gui_session_access_details::new(self.provider)
    }
