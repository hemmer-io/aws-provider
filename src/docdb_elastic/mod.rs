...
impl<'a> Docdb_elasticService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "pending_maintenance_action" => {
                self.plan_pending_maintenance_action(current_state, desired_input)
                    .await
            }
            "cluster" => self.plan_cluster(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "docdb_elastic", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "pending_maintenance_action" => self.create_pending_maintenance_action(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "pending_maintenance_action" => self.read_pending_maintenance_action(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "pending_maintenance_action" => self.update_pending_maintenance_action(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "pending_maintenance_action" => self.delete_pending_maintenance_action(id).await,
    ...
    async fn read_pending_maintenance_action(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.docdb_elastic_client
    ...
    async fn delete_pending_maintenance_action(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.docdb_elastic_client
    ...
    async fn create_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "admin_user_password",
                    admin_user_password.unwrap_or_default(),
                )
                .with_field(
                    "shard_instance_count",
                    shard_instance_count.unwrap_or_default(),
                )
