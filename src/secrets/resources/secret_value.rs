...
impl<'a> Secret_value<'a> {
    ...
    pub async fn create(&self, secret_string: Option<String>, secret_id: String, client_request_token: Option<String>, rotation_token: Option<String>, version_stages: Option<Vec<String>>, secret_binary: Option<String>) -> Result<String> {
