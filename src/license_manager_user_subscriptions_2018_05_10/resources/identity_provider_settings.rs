...
impl<'a> Identity_provider_settings<'a> {
    ...
    pub async fn update(&self, id: &str, product: Option<String>, identity_provider_arn: Option<String>, identity_provider: Option<String>, update_settings: Option<String>) -> Result<()> {
