...
impl<'a> Documentation_version<'a> {
    ...
    pub async fn create(&self, documentation_version: String, stage_name: Option<String>, description: Option<String>, rest_api_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, documentation_version: Option<String>, stage_name: Option<String>, description: Option<String>, rest_api_id: Option<String>) -> Result<()> {
