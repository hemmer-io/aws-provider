...
impl<'a> Gateway_response<'a> {
    ...
    pub async fn create(&self, response_templates: Option<String>, status_code: Option<String>, rest_api_id: String, response_type: String, response_parameters: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, response_templates: Option<String>, status_code: Option<String>, rest_api_id: Option<String>, response_type: Option<String>, response_parameters: Option<String>) -> Result<()> {
