...
impl<'a> Ops_metadata<'a> {
    ...
    pub async fn create(&self, resource_id: String, metadata: Option<HashMap<String, String>>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, resource_id: Option<String>, metadata: Option<HashMap<String, String>>, tags: Option<Vec<String>>) -> Result<()> {
