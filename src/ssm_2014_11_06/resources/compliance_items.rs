...
impl<'a> Compliance_items<'a> {
    ...
    pub async fn create(&self, resource_type: String, execution_summary: String, item_content_hash: Option<String>, resource_id: String, compliance_type: String, items: Vec<String>, upload_type: Option<String>) -> Result<String> {
