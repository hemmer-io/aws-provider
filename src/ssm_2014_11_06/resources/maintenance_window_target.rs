...
impl<'a> Maintenance_window_target<'a> {
    ...
    pub async fn update(&self, id: &str, targets: Option<Vec<String>>, window_id: Option<String>, owner_information: Option<String>, name: Option<String>, description: Option<String>, window_target_id: Option<String>, replace: Option<bool>) -> Result<()> {
