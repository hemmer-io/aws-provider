...
impl<'a> Scaling_policy<'a> {
    ...
    pub async fn create(&self, scaling_adjustment_type: Option<String>, metric_name: String, target_configuration: Option<String>, comparison_operator: Option<String>, name: String, scaling_adjustment: Option<i64>, threshold: Option<f64>, fleet_id: String, evaluation_periods: Option<i64>, policy_type: Option<String>) -> Result<String> {
