...
impl<'a> GameliftService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "game_session_queue" => {
                self.plan_game_session_queue(current_state, desired_input)
                    .await
            }
            "build" => self.plan_build(current_state, desired_input).await,
            "fleet_capacity" => self.plan_fleet_capacity(current_state, desired_input).await,
            ...
            "matchmaking" => self.plan_matchmaking(current_state, desired_input).await,
            "matchmaking_configuration" => {
                self.plan_matchmaking_configuration(current_state, desired_input)
                    .await
            }
            "vpc_peering_authorizations" => {
                self.plan_vpc_peering_authorizations(current_state, desired_input)
                    .await
            }
            "compute_auth_token" => {
                self.plan_compute_auth_token(current_state, desired_input)
                    .await
            }
            "ec2_instance_limits" => {
                self.plan_ec2_instance_limits(current_state, desired_input)
                    .await
            }
            "scaling_policies" => {
                self.plan_scaling_policies(current_state, desired_input)
                    .await
            }
            "fleet_events" => self.plan_fleet_events(current_state, desired_input).await,
            "fleet_locations" => {
                self.plan_fleet_locations(current_state, desired_input)
                    .await
            }
            "container_group_definition" => {
                self.plan_container_group_definition(current_state, desired_input)
                    .await
            }
            "matchmaking_rule_set" => {
                self.plan_matchmaking_rule_set(current_state, desired_input)
                    .await
            }
            "player_sessions" => {
                self.plan_player_sessions(current_state, desired_input)
                    .await
            }
            "script" => self.plan_script(current_state, desired_input).await,
            "fleet_deployment" => {
                self.plan_fleet_deployment(current_state, desired_input)
                    .await
            }
            "matchmaking_configurations" => {
                self.plan_matchmaking_configurations(current_state, desired_input)
                    .await
            }
            "matchmaking_rule_sets" => {
                self.plan_matchmaking_rule_sets(current_state, desired_input)
                    .await
            }
            "fleet_location_attributes" => {
                self.plan_fleet_location_attributes(current_state, desired_input)
                    .await
            }
            "game_server_instances" => {
                self.plan_game_server_instances(current_state, desired_input)
                    .await
            }
            "container_fleet" => {
                self.plan_container_fleet(current_state, desired_input)
                    .await
            }
            "runtime_configuration" => {
                self.plan_runtime_configuration(current_state, desired_input)
                    .await
            }
            "vpc_peering_connections" => {
                self.plan_vpc_peering_connections(current_state, desired_input)
                    .await
            }
            "game_session_queues" => {
                self.plan_game_session_queues(current_state, desired_input)
                    .await
            }
            "alias" => self.plan_alias(current_state, desired_input).await,
            "player_session" => self.plan_player_session(current_state, desired_input).await,
            "compute_access" => self.plan_compute_access(current_state, desired_input).await,
            "game_server" => self.plan_game_server(current_state, desired_input).await,
            "game_session_placement" => {
                self.plan_game_session_placement(current_state, desired_input)
                    .await
            }
            "fleet_location_utilization" => {
                self.plan_fleet_location_utilization(current_state, desired_input)
                    .await
            }
            "fleet_attributes" => {
                self.plan_fleet_attributes(current_state, desired_input)
                    .await
            }
            "fleet_utilization" => {
                self.plan_fleet_utilization(current_state, desired_input)
                    .await
            }
            "instances" => self.plan_instances(current_state, desired_input).await,
            "game_session_log_url" => {
                self.plan_game_session_log_url(current_state, desired_input)
                    .await
            }
            "compute" => self.plan_compute(current_state, desired_input).await,
            "fleet_location_capacity" => {
                self.plan_fleet_location_capacity(current_state, desired_input)
                    .await
            }
            "game_session" => self.plan_game_session(current_state, desired_input).await,
            "vpc_peering_authorization" => {
                self.plan_vpc_peering_authorization(current_state, desired_input)
                    .await
            }
            "vpc_peering_connection" => {
                self.plan_vpc_peering_connection(current_state, desired_input)
                    .await
            }
            "fleet_port_settings" => {
                self.plan_fleet_port_settings(current_state, desired_input)
                    .await
            }
            "instance_access" => {
                self.plan_instance_access(current_state, desired_input)
                    .await
            }
            "game_server_group" => {
                self.plan_game_server_group(current_state, desired_input)
                    .await
            }
            "game_session_details" => {
                self.plan_game_session_details(current_state, desired_input)
                    .await
            }
            "game_sessions" => self.plan_game_sessions(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gamelift", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "game_session_queue" => self.create_game_session_queue(input).await,
            "build" => self.create_build(input).await,
            "fleet_capacity" => self.create_fleet_capacity(input).await,
            ...
            "matchmaking" => self.create_matchmaking(input).await,
            "matchmaking_configuration" => self.create_matchmaking_configuration(input).await,
            "vpc_peering_authorizations" => self.create_vpc_peering_authorizations(input).await,
            "compute_auth_token" => self.create_compute_auth_token(input).await,
            "ec2_instance_limits" => self.create_ec2_instance_limits(input).await,
            "scaling_policies" => self.create_scaling_policies(input).await,
            "fleet_events" => self.create_fleet_events(input).await,
            "fleet_locations" => self.create_fleet_locations(input).await,
            "container_group_definition" => self.create_container_group_definition(input).await,
            "matchmaking_rule_set" => self.create_matchmaking_rule_set(input).await,
            "player_sessions" => self.create_player_sessions(input).await,
            "script" => self.create_script(input).await,
            "fleet_deployment" => self.create_fleet_deployment(input).await,
            "matchmaking_configurations" => self.create_matchmaking_configurations(input).await,
            "matchmaking_rule_sets" => self.create_matchmaking_rule_sets(input).await,
            "fleet_location_attributes" => self.create_fleet_location_attributes(input).await,
            "game_server_instances" => self.create_game_server_instances(input).await,
            "container_fleet" => self.create_container_fleet(input).await,
            "runtime_configuration" => self.create_runtime_configuration(input).await,
            "vpc_peering_connections" => self.create_vpc_peering_connections(input).await,
            "game_session_queues" => self.create_game_session_queues(input).await,
            "alias" => self.create_alias(input).await,
            "player_session" => self.create_player_session(input).await,
            "compute_access" => self.create_compute_access(input).await,
            "game_server" => self.create_game_server(input).await,
            "game_session_placement" => self.create_game_session_placement(input).await,
            "fleet_location_utilization" => self.create_fleet_location_utilization(input).await,
            "fleet_attributes" => self.create_fleet_attributes(input).await,
            "fleet_utilization" => self.create_fleet_utilization(input).await,
            "instances" => self.create_instances(input).await,
            "game_session_log_url" => self.create_game_session_log_url(input).await,
            "compute" => self.create_compute(input).await,
            "fleet_location_capacity" => self.create_fleet_location_capacity(input).await,
            "game_session" => self.create_game_session(input).await,
            "vpc_peering_authorization" => self.create_vpc_peering_authorization(input).await,
            "vpc_peering_connection" => self.create_vpc_peering_connection(input).await,
            "fleet_port_settings" => self.create_fleet_port_settings(input).await,
            "instance_access" => self.create_instance_access(input).await,
            "game_server_group" => self.create_game_server_group(input).await,
            "game_session_details" => self.create_game_session_details(input).await,
            "game_sessions" => self.create_game_sessions(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gamelift", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "game_session_queue" => self.read_game_session_queue(id).await,
            "build" => self.read_build(id).await,
            "fleet_capacity" => self.read_fleet_capacity(id).await,
            "fleet" => self.read_fleet(id).await,
            "location" => self.read_location(id).await,
            "scaling_policy" => self.read_scaling_policy(id).await,
            "matchmaking" => self.read_matchmaking(id).await,
            "matchmaking_configuration" => self.read_matchmaking_configuration(id).await,
            "vpc_peering_authorizations" => self.read_vpc_peering_authorizations(id).await,
            "compute_auth_token" => self.read_compute_auth_token(id).await,
            "ec2_instance_limits" => self.read_ec2_instance_limits(id).await,
            "scaling_policies" => self.read_scaling_policies(id).await,
            "fleet_events" => self.read_fleet_events(id).await,
            "fleet_locations" => self.read_fleet_locations(id).await,
            "container_group_definition" => self.read_container_group_definition(id).await,
            "matchmaking_rule_set" => self.read_matchmaking_rule_set(id).await,
            "player_sessions" => self.read_player_sessions(id).await,
            "script" => self.read_script(id).await,
            "fleet_deployment" => self.read_fleet_deployment(id).await,
            "matchmaking_configurations" => self.read_matchmaking_configurations(id).await,
            "matchmaking_rule_sets" => self.read_matchmaking_rule_sets(id).await,
            "fleet_location_attributes" => self.read_fleet_location_attributes(id).await,
            "game_server_instances" => self.read_game_server_instances(id).await,
            "container_fleet" => self.read_container_fleet(id).await,
            "runtime_configuration" => self.read_runtime_configuration(id).await,
            "vpc_peering_connections" => self.read_vpc_peering_connections(id).await,
            "game_session_queues" => self.read_game_session_queues(id).await,
            "alias" => self.read_alias(id).await,
            "player_session" => self.read_player_session(id).await,
            "compute_access" => self.read_compute_access(id).await,
            "game_server" => self.read_game_server(id).await,
            "game_session_placement" => self.read_game_session_placement(id).await,
            "fleet_location_utilization" => self.read_fleet_location_utilization(id).await,
            "fleet_attributes" => self.read_fleet_attributes(id).await,
            "fleet_utilization" => self.read_fleet_utilization(id).await,
            "instances" => self.read_instances(id).await,
            "game_session_log_url" => self.read_game_session_log_url(id).await,
            "compute" => self.read_compute(id).await,
            "fleet_location_capacity" => self.read_fleet_location_capacity(id).await,
            "game_session" => self.read_game_session(id).await,
            "vpc_peering_authorization" => self.read_vpc_peering_authorization(id).await,
            "vpc_peering_connection" => self.read_vpc_peering_connection(id).await,
            "fleet_port_settings" => self.read_fleet_port_settings(id).await,
            "instance_access" => self.read_instance_access(id).await,
            "game_server_group" => self.read_game_server_group(id).await,
            "game_session_details" => self.read_game_session_details(id).await,
            "game_sessions" => self.read_game_sessions(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gamelift", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "game_session_queue" => self.update_game_session_queue(id, input).await,
            "build" => self.update_build(id, input).await,
            "fleet_capacity" => self.update_fleet_capacity(id, input).await,
            ...
            "matchmaking" => self.update_matchmaking(id, input).await,
            "matchmaking_configuration" => self.update_matchmaking_configuration(id, input).await,
            "vpc_peering_authorizations" => self.update_vpc_peering_authorizations(id, input).await,
            "compute_auth_token" => self.update_compute_auth_token(id, input).await,
            "ec2_instance_limits" => self.update_ec2_instance_limits(id, input).await,
            "scaling_policies" => self.update_scaling_policies(id, input).await,
            "fleet_events" => self.update_fleet_events(id, input).await,
            "fleet_locations" => self.update_fleet_locations(id, input).await,
            "container_group_definition" => self.update_container_group_definition(id, input).await,
            "matchmaking_rule_set" => self.update_matchmaking_rule_set(id, input).await,
            "player_sessions" => self.update_player_sessions(id, input).await,
            "script" => self.update_script(id, input).await,
            "fleet_deployment" => self.update_fleet_deployment(id, input).await,
            "matchmaking_configurations" => self.update_matchmaking_configurations(id, input).await,
            "matchmaking_rule_sets" => self.update_matchmaking_rule_sets(id, input).await,
            "fleet_location_attributes" => self.update_fleet_location_attributes(id, input).await,
            "game_server_instances" => self.update_game_server_instances(id, input).await,
            "container_fleet" => self.update_container_fleet(id, input).await,
            "runtime_configuration" => self.update_runtime_configuration(id, input).await,
            "vpc_peering_connections" => self.update_vpc_peering_connections(id, input).await,
            "game_session_queues" => self.update_game_session_queues(id, input).await,
            "alias" => self.update_alias(id, input).await,
            "player_session" => self.update_player_session(id, input).await,
            "compute_access" => self.update_compute_access(id, input).await,
            "game_server" => self.update_game_server(id, input).await,
            "game_session_placement" => self.update_game_session_placement(id, input).await,
            "fleet_location_utilization" => self.update_fleet_location_utilization(id, input).await,
            "fleet_attributes" => self.update_fleet_attributes(id, input).await,
            "fleet_utilization" => self.update_fleet_utilization(id, input).await,
            "instances" => self.update_instances(id, input).await,
            "game_session_log_url" => self.update_game_session_log_url(id, input).await,
            "compute" => self.update_compute(id, input).await,
            "fleet_location_capacity" => self.update_fleet_location_capacity(id, input).await,
            "game_session" => self.update_game_session(id, input).await,
            "vpc_peering_authorization" => self.update_vpc_peering_authorization(id, input).await,
            "vpc_peering_connection" => self.update_vpc_peering_connection(id, input).await,
            "fleet_port_settings" => self.update_fleet_port_settings(id, input).await,
            "instance_access" => self.update_instance_access(id, input).await,
            "game_server_group" => self.update_game_server_group(id, input).await,
            "game_session_details" => self.update_game_session_details(id, input).await,
            "game_sessions" => self.update_game_sessions(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gamelift", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "game_session_queue" => self.delete_game_session_queue(id).await,
            "build" => self.delete_build(id).await,
            "fleet_capacity" => self.delete_fleet_capacity(id).await,
            "fleet" => self.delete_fleet(id).await,
            "location" => self.delete_location(id).await,
            "scaling_policy" => self.delete_scaling_policy(id).await,
            "matchmaking" => self.delete_matchmaking(id).await,
            "matchmaking_configuration" => self.delete_matchmaking_configuration(id).await,
            "vpc_peering_authorizations" => self.delete_vpc_peering_authorizations(id).await,
            "compute_auth_token" => self.delete_compute_auth_token(id).await,
            "ec2_instance_limits" => self.delete_ec2_instance_limits(id).await,
            "scaling_policies" => self.delete_scaling_policies(id).await,
            "fleet_events" => self.delete_fleet_events(id).await,
            "fleet_locations" => self.delete_fleet_locations(id).await,
            "container_group_definition" => self.delete_container_group_definition(id).await,
            "matchmaking_rule_set" => self.delete_matchmaking_rule_set(id).await,
            "player_sessions" => self.delete_player_sessions(id).await,
            "script" => self.delete_script(id).await,
            "fleet_deployment" => self.delete_fleet_deployment(id).await,
            "matchmaking_configurations" => self.delete_matchmaking_configurations(id).await,
            "matchmaking_rule_sets" => self.delete_matchmaking_rule_sets(id).await,
            "fleet_location_attributes" => self.delete_fleet_location_attributes(id).await,
            "game_server_instances" => self.delete_game_server_instances(id).await,
            "container_fleet" => self.delete_container_fleet(id).await,
            "runtime_configuration" => self.delete_runtime_configuration(id).await,
            "vpc_peering_connections" => self.delete_vpc_peering_connections(id).await,
            "game_session_queues" => self.delete_game_session_queues(id).await,
            "alias" => self.delete_alias(id).await,
            "player_session" => self.delete_player_session(id).await,
            "compute_access" => self.delete_compute_access(id).await,
            "game_server" => self.delete_game_server(id).await,
            "game_session_placement" => self.delete_game_session_placement(id).await,
            "fleet_location_utilization" => self.delete_fleet_location_utilization(id).await,
            "fleet_attributes" => self.delete_fleet_attributes(id).await,
            "fleet_utilization" => self.delete_fleet_utilization(id).await,
            "instances" => self.delete_instances(id).await,
            "game_session_log_url" => self.delete_game_session_log_url(id).await,
            "compute" => self.delete_compute(id).await,
            "fleet_location_capacity" => self.delete_fleet_location_capacity(id).await,
            "game_session" => self.delete_game_session(id).await,
            "vpc_peering_authorization" => self.delete_vpc_peering_authorization(id).await,
            "vpc_peering_connection" => self.delete_vpc_peering_connection(id).await,
            "fleet_port_settings" => self.delete_fleet_port_settings(id).await,
            "instance_access" => self.delete_instance_access(id).await,
            "game_server_group" => self.delete_game_server_group(id).await,
            "game_session_details" => self.delete_game_session_details(id).await,
            "game_sessions" => self.delete_game_sessions(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gamelift", resource_name
            ))),
    ...
    async fn create_game_session_queue(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    player_latency_policies.unwrap_or_default(),
                )
                .with_field(
                    "priority_configuration",
                    priority_configuration.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    filter_configuration.unwrap_or_default(),
                )
                .with_field(
                    "notification_target",
                    notification_target.unwrap_or_default(),
                ))
        })
    }

    /// Read a game_session_queue resource
    async fn read_game_session_queue(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_game_session_queue(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_fleet_capacity(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_fleet_capacity(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_fleet_capacity(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_fleet(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let instance_role_credentials_provider =
                input.get_optional_string("instance_role_credentials_provider")?;
            ...
            let certificate_configuration =
                input.get_optional_string("certificate_configuration")?;
            ...
            let new_game_session_protection_policy =
                input.get_optional_string("new_game_session_protection_policy")?;
            let peer_vpc_id = input.get_optional_string("peer_vpc_id")?;
            let resource_creation_limit_policy =
                input.get_optional_string("resource_creation_limit_policy")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    anywhere_configuration.unwrap_or_default(),
                )
                .with_field(
                    "instance_role_credentials_provider",
                    instance_role_credentials_provider.unwrap_or_default(),
                )
                .with_field("metric_groups", metric_groups.unwrap_or_default())
                .with_field(
                    "peer_vpc_aws_account_id",
                    peer_vpc_aws_account_id.unwrap_or_default(),
                )
                .with_field("script_id", script_id.unwrap_or_default())
                .with_field(
                    "certificate_configuration",
                    certificate_configuration.unwrap_or_default(),
                )
                ...
                .with_field(
                    "runtime_configuration",
                    runtime_configuration.unwrap_or_default(),
                ))
        })
    }
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    scaling_adjustment_type.unwrap_or_default(),
                )
    ...
    async fn create_matchmaking(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_matchmaking(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn update_matchmaking(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_matchmaking(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_matchmaking_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            let acceptance_timeout_seconds =
                input.get_optional_string("acceptance_timeout_seconds")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "acceptance_required",
                    acceptance_required.unwrap_or_default(),
                )
                .with_field("custom_event_data", custom_event_data.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                ...
                .with_field(
                    ...
                    game_session_queue_arns.unwrap_or_default(),
                )
                .with_field("name", name.unwrap_or_default())
                .with_field(
                    "request_timeout_seconds",
                    request_timeout_seconds.unwrap_or_default(),
                )
                .with_field(
                    "acceptance_timeout_seconds",
                    acceptance_timeout_seconds.unwrap_or_default(),
                )
                .with_field("rule_set_name", rule_set_name.unwrap_or_default())
                .with_field(
                    "additional_player_count",
                    additional_player_count.unwrap_or_default(),
                )
    ...
    async fn read_matchmaking_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_matchmaking_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn read_vpc_peering_authorizations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_vpc_peering_authorizations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_compute_auth_token(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_compute_auth_token(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_compute_auth_token(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_ec2_instance_limits(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_ec2_instance_limits(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_ec2_instance_limits(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_scaling_policies(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_scaling_policies(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_scaling_policies(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_fleet_events(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_fleet_events(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn update_fleet_events(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_fleet_events(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_fleet_locations(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_fleet_locations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_fleet_locations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_container_group_definition(
        ...
        self.provider.runtime().block_on(async {
            ...
            let game_server_container_definition =
                input.get_optional_string("game_server_container_definition")?;
            let tags = input.get_optional_string("tags")?;
            let name = input.get_string("name")?;
            ...
            let support_container_definitions =
                input.get_optional_string("support_container_definitions")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    container_group_type.unwrap_or_default(),
                )
                .with_field(
                    "game_server_container_definition",
                    game_server_container_definition.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                .with_field("operating_system", operating_system.unwrap_or_default())
                ...
                .with_field(
                    ...
                    total_memory_limit_mebibytes.unwrap_or_default(),
                )
                .with_field(
                    "support_container_definitions",
                    support_container_definitions.unwrap_or_default(),
                ))
        })
    }

    /// Read a container_group_definition resource
    async fn read_container_group_definition(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_container_group_definition(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_matchmaking_rule_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_matchmaking_rule_set(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_matchmaking_rule_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_player_sessions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_player_sessions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_player_sessions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_fleet_deployment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_fleet_deployment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_fleet_deployment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn read_matchmaking_configurations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_matchmaking_configurations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_matchmaking_rule_sets(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_matchmaking_rule_sets(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_matchmaking_rule_sets(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn read_fleet_location_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_fleet_location_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_game_server_instances(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_game_server_instances(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_game_server_instances(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_container_fleet(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let per_instance_container_group_definition_name =
                input.get_optional_string("per_instance_container_group_definition_name")?;
            let instance_inbound_permissions =
                input.get_optional_string("instance_inbound_permissions")?;
            let metric_groups = input.get_optional_string("metric_groups")?;
            let fleet_role_arn = input.get_string("fleet_role_arn")?;
            let game_server_container_group_definition_name =
                input.get_optional_string("game_server_container_group_definition_name")?;
            let game_session_creation_limit_policy =
                input.get_optional_string("game_session_creation_limit_policy")?;
            let new_game_session_protection_policy =
                input.get_optional_string("new_game_session_protection_policy")?;
            let log_configuration = input.get_optional_string("log_configuration")?;
            let locations = input.get_optional_string("locations")?;
            let description = input.get_optional_string("description")?;
            let instance_connection_port_range =
                input.get_optional_string("instance_connection_port_range")?;
            let billing_type = input.get_optional_string("billing_type")?;
            let instance_type = input.get_optional_string("instance_type")?;
            let tags = input.get_optional_string("tags")?;
            let game_server_container_groups_per_instance =
                input.get_optional_string("game_server_container_groups_per_instance")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    per_instance_container_group_definition_name.unwrap_or_default(),
                )
                .with_field(
                    "instance_inbound_permissions",
                    instance_inbound_permissions.unwrap_or_default(),
                )
                .with_field("metric_groups", metric_groups.unwrap_or_default())
                .with_field("fleet_role_arn", fleet_role_arn.unwrap_or_default())
                .with_field(
                    "game_server_container_group_definition_name",
                    game_server_container_group_definition_name.unwrap_or_default(),
                )
                .with_field(
                    "game_session_creation_limit_policy",
                    game_session_creation_limit_policy.unwrap_or_default(),
                )
                .with_field(
                    "new_game_session_protection_policy",
                    new_game_session_protection_policy.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    instance_connection_port_range.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    game_server_container_groups_per_instance.unwrap_or_default(),
                ))
        })
    }

    /// Read a container_fleet resource
    async fn read_container_fleet(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_container_fleet(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_runtime_configuration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let fleet_id = input.get_string("fleet_id")?;
    ...
    async fn read_runtime_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_runtime_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_vpc_peering_connections(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_vpc_peering_connections(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_vpc_peering_connections(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_game_session_queues(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_game_session_queues(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_game_session_queues(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_player_session(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_player_session(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_player_session(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_compute_access(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_compute_access(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_compute_access(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_game_server(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    game_server_group_name.unwrap_or_default(),
                )
    ...
    async fn read_game_server(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn update_game_server(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let utilization_status = input.get_optional_string("utilization_status")?;
            let game_server_group_name = input.get_string("game_server_group_name")?;
    ...
    async fn delete_game_server(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_game_session_placement(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_game_session_placement(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_game_session_placement(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn read_fleet_location_utilization(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_fleet_location_utilization(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_fleet_attributes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let metric_groups = input.get_optional_string("metric_groups")?;
    ...
    async fn read_fleet_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_fleet_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_fleet_utilization(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_fleet_utilization(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_fleet_utilization(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_game_session_log_url(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_game_session_log_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_game_session_log_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_compute(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_compute(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn update_compute(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_compute(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_fleet_location_capacity(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_fleet_location_capacity(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_fleet_location_capacity(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_game_session(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    maximum_player_session_count.unwrap_or_default(),
                )
                .with_field("game_session_data", game_session_data.unwrap_or_default())
    ...
    async fn read_game_session(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn update_game_session(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let game_session_id = input.get_optional_string("game_session_id")?;
            let idempotency_token = input.get_optional_string("idempotency_token")?;
    ...
    async fn delete_game_session(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    game_lift_aws_account_id.unwrap_or_default(),
                )
                .with_field("peer_vpc_id", peer_vpc_id.unwrap_or_default()))
        })
    }
    ...
    async fn read_vpc_peering_authorization(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_vpc_peering_authorization(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_vpc_peering_connection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let fleet_id = input.get_string("fleet_id")?;
    ...
    async fn read_vpc_peering_connection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_vpc_peering_connection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_fleet_port_settings(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let inbound_permission_revocations =
                input.get_optional_string("inbound_permission_revocations")?;
            let fleet_id = input.get_string("fleet_id")?;
            let inbound_permission_authorizations =
                input.get_optional_string("inbound_permission_authorizations")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    inbound_permission_revocations.unwrap_or_default(),
                )
                .with_field("fleet_id", fleet_id.unwrap_or_default())
                .with_field(
                    "inbound_permission_authorizations",
                    inbound_permission_authorizations.unwrap_or_default(),
                ))
        })
    }

    /// Read a fleet_port_settings resource
    async fn read_fleet_port_settings(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_fleet_port_settings(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_instance_access(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_access(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_instance_access(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_game_server_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let tags = input.get_optional_string("tags")?;
            let game_server_protection_policy =
                input.get_optional_string("game_server_protection_policy")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "auto_scaling_policy",
                    auto_scaling_policy.unwrap_or_default(),
                )
                .with_field(
                    "instance_definitions",
                    instance_definitions.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    game_server_protection_policy.unwrap_or_default(),
                )
                .with_field("min_size", min_size.unwrap_or_default())
    ...
    async fn read_game_server_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_game_server_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_game_session_details(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_game_session_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn delete_game_session_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
    ...
    async fn create_game_sessions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_game_sessions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.gamelift_client
    ...
    async fn update_game_sessions(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_game_sessions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.gamelift_client
