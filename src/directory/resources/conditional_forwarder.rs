...
impl<'a> Conditional_forwarder<'a> {
    ...
    pub async fn create(&self, remote_domain_name: String, directory_id: String, dns_ipv6_addrs: Option<Vec<String>>, dns_ip_addrs: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, remote_domain_name: Option<String>, directory_id: Option<String>, dns_ipv6_addrs: Option<Vec<String>>, dns_ip_addrs: Option<Vec<String>>) -> Result<()> {
