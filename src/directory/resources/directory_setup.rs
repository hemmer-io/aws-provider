...
impl<'a> Directory_setup<'a> {
    ...
    pub async fn update(&self, id: &str, osupdate_settings: Option<String>, directory_id: Option<String>, directory_size_update_settings: Option<String>, update_type: Option<String>, network_update_settings: Option<String>, create_snapshot_before_update: Option<bool>) -> Result<()> {
