...
impl<'a> Parameter_group<'a> {
    ...
    pub async fn create(&self, parameter_group_name: String, description: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, parameter_group_name: Option<String>, description: Option<String>) -> Result<()> {
