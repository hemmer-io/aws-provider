...
impl<'a> Fargate_profile<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, fargate_profile_name: String, subnets: Option<String>, pod_execution_role_arn: String, cluster_name: String, selectors: Option<Vec<String>>, client_request_token: Option<String>) -> Result<String> {
