...
impl<'a> Eks_anywhere_subscription<'a> {
    ...
    pub async fn create(&self, license_type: Option<String>, client_request_token: Option<String>, tags: Option<HashMap<String, String>>, term: String, name: String, auto_renew: Option<bool>, license_quantity: Option<i64>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, license_type: Option<String>, client_request_token: Option<String>, tags: Option<HashMap<String, String>>, term: Option<String>, name: Option<String>, auto_renew: Option<bool>, license_quantity: Option<i64>) -> Result<()> {
