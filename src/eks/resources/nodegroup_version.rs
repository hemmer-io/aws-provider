...
impl<'a> Nodegroup_version<'a> {
    ...
    pub async fn update(&self, id: &str, nodegroup_name: Option<String>, launch_template: Option<String>, version: Option<String>, release_version: Option<String>, force: Option<bool>, client_request_token: Option<String>, cluster_name: Option<String>) -> Result<()> {
