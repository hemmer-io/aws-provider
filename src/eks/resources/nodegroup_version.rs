...
impl<'a> Nodegroup_version<'a> {
    ...
    pub async fn update(&self, id: &str, nodegroup_name: Option<String>, release_version: Option<String>, launch_template: Option<String>, cluster_name: Option<String>, version: Option<String>, client_request_token: Option<String>, force: Option<bool>) -> Result<()> {
