...
impl<'a> Nodegroup_config<'a> {
    ...
    pub async fn update(&self, id: &str, scaling_config: Option<String>, node_repair_config: Option<String>, cluster_name: Option<String>, taints: Option<String>, update_config: Option<String>, client_request_token: Option<String>, nodegroup_name: Option<String>, labels: Option<String>) -> Result<()> {
