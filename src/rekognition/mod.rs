...
impl<'a> RekognitionService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "face_liveness_session" => {
                self.plan_face_liveness_session(current_state, desired_input).await
            }
            "stream_processor" => {
                self.plan_stream_processor(current_state, desired_input).await
            }
            "person_tracking" => {
                self.plan_person_tracking(current_state, desired_input).await
            }
            "segment_detection" => {
                self.plan_segment_detection(current_state, desired_input).await
            }
            "dataset" => {
            ...
            "face_search" => {
                self.plan_face_search(current_state, desired_input).await
            }
            "faces" => {
                self.plan_faces(current_state, desired_input).await
            }
            "celebrity_info" => {
                self.plan_celebrity_info(current_state, desired_input).await
            }
            "media_analysis_job" => {
                self.plan_media_analysis_job(current_state, desired_input).await
            }
            "label_detection" => {
                self.plan_label_detection(current_state, desired_input).await
            }
            "face_liveness_session_results" => {
                self.plan_face_liveness_session_results(current_state, desired_input).await
            }
            "face_detection" => {
                self.plan_face_detection(current_state, desired_input).await
            }
            "celebrity_recognition" => {
                self.plan_celebrity_recognition(current_state, desired_input).await
            }
            "content_moderation" => {
                self.plan_content_moderation(current_state, desired_input).await
            }
            "project" => {
                self.plan_project(current_state, desired_input).await
            }
            "projects" => {
                self.plan_projects(current_state, desired_input).await
            }
            "collection" => {
                self.plan_collection(current_state, desired_input).await
            }
            "text_detection" => {
                self.plan_text_detection(current_state, desired_input).await
            }
            "project_policy" => {
                self.plan_project_policy(current_state, desired_input).await
            }
            "project_version" => {
                self.plan_project_version(current_state, desired_input).await
            }
            "project_versions" => {
                self.plan_project_versions(current_state, desired_input).await
            }
            "dataset_entries" => {
                self.plan_dataset_entries(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "face_liveness_session" => {
                self.create_face_liveness_session(input).await
            }
            "stream_processor" => {
                self.create_stream_processor(input).await
            }
            "person_tracking" => {
                self.create_person_tracking(input).await
            }
            "segment_detection" => {
                self.create_segment_detection(input).await
            }
            "dataset" => {
            ...
            "face_search" => {
                self.create_face_search(input).await
            }
            "faces" => {
                self.create_faces(input).await
            }
            "celebrity_info" => {
                self.create_celebrity_info(input).await
            }
            "media_analysis_job" => {
                self.create_media_analysis_job(input).await
            }
            "label_detection" => {
                self.create_label_detection(input).await
            }
            "face_liveness_session_results" => {
                self.create_face_liveness_session_results(input).await
            }
            "face_detection" => {
                self.create_face_detection(input).await
            }
            "celebrity_recognition" => {
                self.create_celebrity_recognition(input).await
            }
            "content_moderation" => {
                self.create_content_moderation(input).await
            }
            "project" => {
                self.create_project(input).await
            }
            "projects" => {
                self.create_projects(input).await
            }
            "collection" => {
                self.create_collection(input).await
            }
            "text_detection" => {
                self.create_text_detection(input).await
            }
            "project_policy" => {
                self.create_project_policy(input).await
            }
            "project_version" => {
                self.create_project_version(input).await
            }
            "project_versions" => {
                self.create_project_versions(input).await
            }
            "dataset_entries" => {
                self.create_dataset_entries(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "rekognition",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "face_liveness_session" => {
                self.read_face_liveness_session(id).await
            }
            "stream_processor" => {
                self.read_stream_processor(id).await
            }
            "person_tracking" => {
                self.read_person_tracking(id).await
            }
            "segment_detection" => {
                self.read_segment_detection(id).await
            }
            "dataset" => {
            ...
            "face_search" => {
                self.read_face_search(id).await
            }
            "faces" => {
                self.read_faces(id).await
            }
            "celebrity_info" => {
                self.read_celebrity_info(id).await
            }
            "media_analysis_job" => {
                self.read_media_analysis_job(id).await
            }
            "label_detection" => {
                self.read_label_detection(id).await
            }
            "face_liveness_session_results" => {
                self.read_face_liveness_session_results(id).await
            }
            "face_detection" => {
                self.read_face_detection(id).await
            }
            "celebrity_recognition" => {
                self.read_celebrity_recognition(id).await
            }
            "content_moderation" => {
                self.read_content_moderation(id).await
            }
            "project" => {
                self.read_project(id).await
            }
            "projects" => {
                self.read_projects(id).await
            }
            "collection" => {
                self.read_collection(id).await
            }
            "text_detection" => {
                self.read_text_detection(id).await
            }
            "project_policy" => {
                self.read_project_policy(id).await
            }
            "project_version" => {
                self.read_project_version(id).await
            }
            "project_versions" => {
                self.read_project_versions(id).await
            }
            "dataset_entries" => {
                self.read_dataset_entries(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "rekognition",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "face_liveness_session" => {
                self.update_face_liveness_session(id, input).await
            }
            "stream_processor" => {
                self.update_stream_processor(id, input).await
            }
            "person_tracking" => {
                self.update_person_tracking(id, input).await
            }
            "segment_detection" => {
                self.update_segment_detection(id, input).await
            }
            "dataset" => {
            ...
            "face_search" => {
                self.update_face_search(id, input).await
            }
            "faces" => {
                self.update_faces(id, input).await
            }
            "celebrity_info" => {
                self.update_celebrity_info(id, input).await
            }
            "media_analysis_job" => {
                self.update_media_analysis_job(id, input).await
            }
            "label_detection" => {
                self.update_label_detection(id, input).await
            }
            "face_liveness_session_results" => {
                self.update_face_liveness_session_results(id, input).await
            }
            "face_detection" => {
                self.update_face_detection(id, input).await
            }
            "celebrity_recognition" => {
                self.update_celebrity_recognition(id, input).await
            }
            "content_moderation" => {
                self.update_content_moderation(id, input).await
            }
            "project" => {
                self.update_project(id, input).await
            }
            "projects" => {
                self.update_projects(id, input).await
            }
            "collection" => {
                self.update_collection(id, input).await
            }
            "text_detection" => {
                self.update_text_detection(id, input).await
            }
            "project_policy" => {
                self.update_project_policy(id, input).await
            }
            "project_version" => {
                self.update_project_version(id, input).await
            }
            "project_versions" => {
                self.update_project_versions(id, input).await
            }
            "dataset_entries" => {
                self.update_dataset_entries(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "rekognition",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "face_liveness_session" => {
                self.delete_face_liveness_session(id).await
            }
            "stream_processor" => {
                self.delete_stream_processor(id).await
            }
            "person_tracking" => {
                self.delete_person_tracking(id).await
            }
            "segment_detection" => {
                self.delete_segment_detection(id).await
            }
            "dataset" => {
            ...
            "face_search" => {
                self.delete_face_search(id).await
            }
            "faces" => {
                self.delete_faces(id).await
            }
            "celebrity_info" => {
                self.delete_celebrity_info(id).await
            }
            "media_analysis_job" => {
                self.delete_media_analysis_job(id).await
            }
            "label_detection" => {
                self.delete_label_detection(id).await
            }
            "face_liveness_session_results" => {
                self.delete_face_liveness_session_results(id).await
            }
            "face_detection" => {
                self.delete_face_detection(id).await
            }
            "celebrity_recognition" => {
                self.delete_celebrity_recognition(id).await
            }
            "content_moderation" => {
                self.delete_content_moderation(id).await
            }
            "project" => {
                self.delete_project(id).await
            }
            "projects" => {
                self.delete_projects(id).await
            }
            "collection" => {
                self.delete_collection(id).await
            }
            "text_detection" => {
                self.delete_text_detection(id).await
            }
            "project_policy" => {
                self.delete_project_policy(id).await
            }
            "project_version" => {
                self.delete_project_version(id).await
            }
            "project_versions" => {
                self.delete_project_versions(id).await
            }
            "dataset_entries" => {
                self.delete_dataset_entries(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "rekognition",
    ...
    async fn create_face_liveness_session(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn read_face_liveness_session(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_face_liveness_session(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_stream_processor(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("notification_channel", notification_channel.unwrap_or_default())
                .with_field("kms_key_id", kms_key_id.unwrap_or_default())
                .with_field("input", input.unwrap_or_default())
                .with_field("output", output.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("data_sharing_preference", data_sharing_preference.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                .with_field("role_arn", role_arn.unwrap_or_default())
                .with_field("settings", settings.unwrap_or_default())
                .with_field("regions_of_interest", regions_of_interest.unwrap_or_default())
            )
        })
    }

    /// Read a stream_processor resource
    async fn read_stream_processor(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_person_tracking(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_person_tracking(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_segment_detection(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_segment_detection(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_segment_detection(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_celebrity_info(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_celebrity_info(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_media_analysis_job(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_media_analysis_job(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_media_analysis_job(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_label_detection(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_label_detection(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_face_liveness_session_results(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_face_liveness_session_results(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_face_detection(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_face_detection(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_celebrity_recognition(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_celebrity_recognition(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_celebrity_recognition(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_content_moderation(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_content_moderation(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_content_moderation(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_text_detection(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_text_detection(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_project_versions(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_project_versions(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_project_versions(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_dataset_entries(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_dataset_entries(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
