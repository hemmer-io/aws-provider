...
impl<'a> Project_version<'a> {
    ...
    pub async fn create(&self, feature_config: Option<String>, project_arn: String, training_data: Option<String>, output_config: String, version_name: String, testing_data: Option<String>, kms_key_id: Option<String>, version_description: Option<String>, tags: Option<HashMap<String, String>>) -> Result<String> {
