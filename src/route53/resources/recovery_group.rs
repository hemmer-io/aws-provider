...
impl<'a> Recovery_group<'a> {
    ...
    pub async fn create(&self, cells: Option<Vec<String>>, recovery_group_name: String, tags: Option<HashMap<String, String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, cells: Option<Vec<String>>, recovery_group_name: Option<String>, tags: Option<HashMap<String, String>>) -> Result<()> {
