...
impl<'a> Routing_control_state<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, routing_control_arn: Option<String>, routing_control_state: Option<String>, safety_rules_to_override: Option<Vec<String>>) -> Result<()> {
