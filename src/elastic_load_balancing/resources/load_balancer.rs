...
impl<'a> Load_balancer<'a> {
    ...
    pub async fn create(&self, subnets: Option<Vec<String>>, scheme: Option<String>, tags: Option<Vec<String>>, load_balancer_name: String, listeners: Vec<String>, security_groups: Option<Vec<String>>, availability_zones: Option<Vec<String>>) -> Result<String> {
