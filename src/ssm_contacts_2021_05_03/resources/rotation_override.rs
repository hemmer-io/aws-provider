...
impl<'a> Rotation_override<'a> {
    ...
    pub async fn create(&self, new_contact_ids: Vec<String>, end_time: String, start_time: String, idempotency_token: Option<String>, rotation_id: String) -> Result<String> {
