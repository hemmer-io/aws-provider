...
impl<'a> Environment_blueprint<'a> {
    ...
    pub async fn create(&self, name: String, provisioning_properties: String, description: Option<String>, domain_identifier: String, user_parameters: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, provisioning_properties: Option<String>, description: Option<String>, domain_identifier: Option<String>, user_parameters: Option<Vec<String>>) -> Result<()> {
