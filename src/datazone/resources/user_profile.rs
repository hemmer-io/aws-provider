...
impl<'a> User_profile<'a> {
    ...
    pub async fn create(&self, user_type: Option<String>, client_token: Option<String>, user_identifier: String, domain_identifier: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, user_type: Option<String>, client_token: Option<String>, user_identifier: Option<String>, domain_identifier: Option<String>) -> Result<()> {
