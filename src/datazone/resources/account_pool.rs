...
impl<'a> Account_pool<'a> {
    ...
    pub async fn create(&self, resolution_strategy: String, name: String, account_source: String, description: Option<String>, domain_identifier: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, resolution_strategy: Option<String>, name: Option<String>, account_source: Option<String>, description: Option<String>, domain_identifier: Option<String>) -> Result<()> {
