...
impl<'a> Account_pool<'a> {
    ...
    pub async fn create(&self, name: String, resolution_strategy: String, domain_identifier: String, description: Option<String>, account_source: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, resolution_strategy: Option<String>, domain_identifier: Option<String>, description: Option<String>, account_source: Option<String>) -> Result<()> {
