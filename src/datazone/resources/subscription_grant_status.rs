...
impl<'a> Subscription_grant_status<'a> {
    ...
    pub async fn update(&self, id: &str, domain_identifier: Option<String>, target_name: Option<String>, status: Option<String>, asset_identifier: Option<String>, failure_cause: Option<String>, identifier: Option<String>) -> Result<()> {
