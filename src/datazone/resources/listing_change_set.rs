...
impl<'a> Listing_change_set<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, entity_revision: Option<String>, domain_identifier: String, entity_identifier: String, entity_type: String, action: String) -> Result<String> {
