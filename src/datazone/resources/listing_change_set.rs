...
impl<'a> Listing_change_set<'a> {
    ...
    pub async fn create(&self, domain_identifier: String, entity_revision: Option<String>, action: String, entity_type: String, entity_identifier: String, client_token: Option<String>) -> Result<String> {
