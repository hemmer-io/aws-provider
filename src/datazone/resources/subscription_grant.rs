...
impl<'a> Subscription_grant<'a> {
    ...
    pub async fn create(&self, domain_identifier: String, environment_identifier: String, granted_entity: String, subscription_target_identifier: Option<String>, asset_target_names: Option<Vec<String>>, client_token: Option<String>) -> Result<String> {
