...
impl<'a> Subscription_grant<'a> {
    ...
    pub async fn create(&self, granted_entity: String, domain_identifier: String, asset_target_names: Option<Vec<String>>, subscription_target_identifier: Option<String>, client_token: Option<String>, environment_identifier: String) -> Result<String> {
