...
impl<'a> Group_profile<'a> {
    ...
    pub async fn create(&self, domain_identifier: String, group_identifier: String, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, domain_identifier: Option<String>, group_identifier: Option<String>, client_token: Option<String>) -> Result<()> {
