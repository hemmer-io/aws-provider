...
impl<'a> Group_profile<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, group_identifier: String, domain_identifier: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_token: Option<String>, group_identifier: Option<String>, domain_identifier: Option<String>) -> Result<()> {
