...
impl<'a> Cost_category_definition<'a> {
    ...
    pub async fn create(&self, resource_tags: Option<Vec<String>>, default_value: Option<String>, effective_start: Option<String>, split_charge_rules: Option<Vec<String>>, name: String, rule_version: String, rules: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, resource_tags: Option<Vec<String>>, default_value: Option<String>, effective_start: Option<String>, split_charge_rules: Option<Vec<String>>, name: Option<String>, rule_version: Option<String>, rules: Option<Vec<String>>) -> Result<()> {
