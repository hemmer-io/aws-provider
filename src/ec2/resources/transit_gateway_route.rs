...
impl<'a> Transit_gateway_route<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, destination_cidr_block: String, transit_gateway_route_table_id: String, blackhole: Option<bool>, transit_gateway_attachment_id: Option<String>) -> Result<String> {
