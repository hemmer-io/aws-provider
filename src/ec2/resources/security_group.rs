...
impl<'a> Security_group<'a> {
    ...
    pub async fn create(&self, group_name: String, dry_run: Option<bool>, description: String, vpc_id: Option<String>, tag_specifications: Option<Vec<String>>) -> Result<String> {
