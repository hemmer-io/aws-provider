...
impl<'a> Security_group<'a> {
    ...
    pub async fn create(&self, description: String, group_name: String, vpc_id: Option<String>, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>) -> Result<String> {
