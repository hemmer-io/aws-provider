...
impl<'a> Security_group<'a> {
    ...
    pub async fn create(&self, vpc_id: Option<String>, description: String, tag_specifications: Option<Vec<String>>, group_name: String, dry_run: Option<bool>) -> Result<String> {
