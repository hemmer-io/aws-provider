...
impl<'a> Local_gateway_virtual_interface<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, outpost_lag_id: String, vlan: i64, peer_address: String, dry_run: Option<bool>, peer_bgp_asn_extended: Option<i64>, peer_bgp_asn: Option<i64>, local_address: String, local_gateway_virtual_interface_group_id: String) -> Result<String> {
