...
impl<'a> Vpc_endpoint_connection_notification<'a> {
    ...
    pub async fn create(&self, vpc_endpoint_id: Option<String>, connection_events: Vec<String>, client_token: Option<String>, connection_notification_arn: String, dry_run: Option<bool>, service_id: Option<String>) -> Result<String> {
