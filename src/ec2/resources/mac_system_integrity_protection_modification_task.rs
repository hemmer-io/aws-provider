...
impl<'a> Mac_system_integrity_protection_modification_task<'a> {
    ...
    pub async fn create(&self, mac_credentials: Option<String>, instance_id: String, mac_system_integrity_protection_configuration: Option<String>, client_token: Option<String>, dry_run: Option<bool>, tag_specifications: Option<Vec<String>>, mac_system_integrity_protection_status: String) -> Result<String> {
