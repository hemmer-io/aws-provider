...
impl<'a> Mac_system_integrity_protection_modification_task<'a> {
    ...
    pub async fn create(&self, instance_id: String, mac_credentials: Option<String>, client_token: Option<String>, dry_run: Option<bool>, mac_system_integrity_protection_status: String, tag_specifications: Option<Vec<String>>, mac_system_integrity_protection_configuration: Option<String>) -> Result<String> {
