...
impl<'a> Delegate_mac_volume_ownership_task<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, tag_specifications: Option<Vec<String>>, instance_id: String, client_token: Option<String>, mac_credentials: String) -> Result<String> {
