...
impl<'a> Delegate_mac_volume_ownership_task<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, dry_run: Option<bool>, mac_credentials: String, instance_id: String, tag_specifications: Option<Vec<String>>) -> Result<String> {
