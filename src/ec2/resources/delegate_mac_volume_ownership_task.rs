...
impl<'a> Delegate_mac_volume_ownership_task<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, client_token: Option<String>, dry_run: Option<bool>, instance_id: String, mac_credentials: String) -> Result<String> {
