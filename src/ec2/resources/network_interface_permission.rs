...
impl<'a> Network_interface_permission<'a> {
    ...
    pub async fn create(&self, aws_account_id: Option<String>, network_interface_id: String, permission: String, dry_run: Option<bool>, aws_service: Option<String>) -> Result<String> {
