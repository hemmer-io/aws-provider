...
impl<'a> Traffic_mirror_target<'a> {
    ...
    pub async fn create(&self, gateway_load_balancer_endpoint_id: Option<String>, network_interface_id: Option<String>, network_load_balancer_arn: Option<String>, description: Option<String>, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, client_token: Option<String>) -> Result<String> {
