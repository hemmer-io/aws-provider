...
impl<'a> Traffic_mirror_target<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, network_interface_id: Option<String>, network_load_balancer_arn: Option<String>, tag_specifications: Option<Vec<String>>, description: Option<String>, client_token: Option<String>, gateway_load_balancer_endpoint_id: Option<String>) -> Result<String> {
