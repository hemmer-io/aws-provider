...
impl<'a> Security_group_rule_descriptions_ingress<'a> {
    ...
    pub async fn update(&self, id: &str, security_group_rule_descriptions: Option<Vec<String>>, dry_run: Option<bool>, group_name: Option<String>, ip_permissions: Option<Vec<String>>, group_id: Option<String>) -> Result<()> {
