...
impl<'a> Security_group_rule_descriptions_ingress<'a> {
    ...
    pub async fn update(&self, id: &str, group_id: Option<String>, ip_permissions: Option<Vec<String>>, dry_run: Option<bool>, security_group_rule_descriptions: Option<Vec<String>>, group_name: Option<String>) -> Result<()> {
