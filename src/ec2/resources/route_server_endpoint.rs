...
impl<'a> Route_server_endpoint<'a> {
    ...
    pub async fn create(&self, route_server_id: String, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, client_token: Option<String>, subnet_id: String) -> Result<String> {
