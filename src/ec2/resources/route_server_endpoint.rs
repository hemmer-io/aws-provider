...
impl<'a> Route_server_endpoint<'a> {
    ...
    pub async fn create(&self, route_server_id: String, client_token: Option<String>, dry_run: Option<bool>, tag_specifications: Option<Vec<String>>, subnet_id: String) -> Result<String> {
