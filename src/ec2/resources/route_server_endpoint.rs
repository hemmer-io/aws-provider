...
impl<'a> Route_server_endpoint<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, route_server_id: String, client_token: Option<String>, subnet_id: String, dry_run: Option<bool>) -> Result<String> {
