...
impl<'a> Route_server_endpoint<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, route_server_id: String, dry_run: Option<bool>, subnet_id: String, client_token: Option<String>) -> Result<String> {
