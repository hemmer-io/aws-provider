...
impl<'a> Transit_gateway_peering_attachment<'a> {
    ...
    pub async fn create(&self, peer_transit_gateway_id: String, transit_gateway_id: String, peer_account_id: String, dry_run: Option<bool>, tag_specifications: Option<Vec<String>>, options: Option<String>, peer_region: String) -> Result<String> {
