...
impl<'a> Instance_export_task<'a> {
    ...
    pub async fn create(&self, description: Option<String>, target_environment: String, tag_specifications: Option<Vec<String>>, export_to_s3_task: String, instance_id: String) -> Result<String> {
