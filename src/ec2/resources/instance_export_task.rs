...
impl<'a> Instance_export_task<'a> {
    ...
    pub async fn create(&self, instance_id: String, description: Option<String>, target_environment: String, tag_specifications: Option<Vec<String>>, export_to_s3_task: String) -> Result<String> {
