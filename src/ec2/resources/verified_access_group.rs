...
impl<'a> Verified_access_group<'a> {
    ...
    pub async fn create(&self, sse_specification: Option<String>, client_token: Option<String>, tag_specifications: Option<Vec<String>>, verified_access_instance_id: String, dry_run: Option<bool>, policy_document: Option<String>, description: Option<String>) -> Result<String> {
