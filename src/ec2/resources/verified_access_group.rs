...
impl<'a> Verified_access_group<'a> {
    ...
    pub async fn create(&self, description: Option<String>, dry_run: Option<bool>, sse_specification: Option<String>, verified_access_instance_id: String, tag_specifications: Option<Vec<String>>, client_token: Option<String>, policy_document: Option<String>) -> Result<String> {
