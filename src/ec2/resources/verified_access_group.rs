...
impl<'a> Verified_access_group<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, sse_specification: Option<String>, verified_access_instance_id: String, client_token: Option<String>, policy_document: Option<String>, description: Option<String>) -> Result<String> {
