...
impl<'a> Verified_access_group<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, sse_specification: Option<String>, verified_access_instance_id: String, policy_document: Option<String>, description: Option<String>, tag_specifications: Option<Vec<String>>, client_token: Option<String>) -> Result<String> {
