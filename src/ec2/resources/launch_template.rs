...
impl<'a> Launch_template<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, client_token: Option<String>, dry_run: Option<bool>, version_description: Option<String>, launch_template_name: String, launch_template_data: String, operator: Option<String>) -> Result<String> {
