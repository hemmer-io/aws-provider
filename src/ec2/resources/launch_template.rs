...
impl<'a> Launch_template<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, version_description: Option<String>, launch_template_data: String, operator: Option<String>, launch_template_name: String, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>) -> Result<String> {
