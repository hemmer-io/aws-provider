...
impl<'a> Transit_gateway_connect<'a> {
    ...
    pub async fn create(&self, transport_transit_gateway_attachment_id: String, tag_specifications: Option<Vec<String>>, options: String, dry_run: Option<bool>) -> Result<String> {
