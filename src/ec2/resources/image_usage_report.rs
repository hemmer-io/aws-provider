...
impl<'a> Image_usage_report<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, account_ids: Option<Vec<String>>, client_token: Option<String>, image_id: String, tag_specifications: Option<Vec<String>>, resource_types: Vec<String>) -> Result<String> {
