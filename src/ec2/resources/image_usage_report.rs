...
impl<'a> Image_usage_report<'a> {
    ...
    pub async fn create(&self, resource_types: Vec<String>, image_id: String, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, account_ids: Option<Vec<String>>, client_token: Option<String>) -> Result<String> {
