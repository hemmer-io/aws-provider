...
impl<'a> Image_usage_report<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, account_ids: Option<Vec<String>>, image_id: String, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, resource_types: Vec<String>) -> Result<String> {
