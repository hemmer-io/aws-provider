...
impl<'a> Image_usage_report<'a> {
    ...
    pub async fn create(&self, image_id: String, resource_types: Vec<String>, client_token: Option<String>, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, account_ids: Option<Vec<String>>) -> Result<String> {
