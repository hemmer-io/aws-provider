...
impl<'a> Ipam_resource_discovery<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, dry_run: Option<bool>, operating_regions: Option<Vec<String>>, tag_specifications: Option<Vec<String>>, description: Option<String>) -> Result<String> {
