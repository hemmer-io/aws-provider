...
impl<'a> Ipam_resource_discovery<'a> {
    ...
    pub async fn create(&self, description: Option<String>, tag_specifications: Option<Vec<String>>, client_token: Option<String>, dry_run: Option<bool>, operating_regions: Option<Vec<String>>) -> Result<String> {
