...
impl<'a> Instance_connect_endpoint<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, client_token: Option<String>, ip_address_type: Option<String>, dry_run: Option<bool>, preserve_client_ip: Option<bool>, subnet_id: String, security_group_ids: Option<Vec<String>>) -> Result<String> {
