...
impl<'a> Subnet_cidr_reservation<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, cidr: String, reservation_type: String, description: Option<String>, dry_run: Option<bool>, subnet_id: String) -> Result<String> {
