...
impl<'a> Subnet_cidr_reservation<'a> {
    ...
    pub async fn create(&self, reservation_type: String, dry_run: Option<bool>, tag_specifications: Option<Vec<String>>, description: Option<String>, subnet_id: String, cidr: String) -> Result<String> {
