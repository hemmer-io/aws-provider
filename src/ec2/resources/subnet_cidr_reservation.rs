...
impl<'a> Subnet_cidr_reservation<'a> {
    ...
    pub async fn create(&self, reservation_type: String, dry_run: Option<bool>, description: Option<String>, tag_specifications: Option<Vec<String>>, cidr: String, subnet_id: String) -> Result<String> {
