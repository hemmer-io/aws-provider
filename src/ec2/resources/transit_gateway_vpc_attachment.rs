...
impl<'a> Transit_gateway_vpc_attachment<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, vpc_id: String, subnet_ids: Vec<String>, options: Option<String>, transit_gateway_id: String) -> Result<String> {
