...
impl<'a> Network_insights_access_scope<'a> {
    ...
    pub async fn create(&self, client_token: String, exclude_paths: Option<Vec<String>>, tag_specifications: Option<Vec<String>>, match_paths: Option<Vec<String>>, dry_run: Option<bool>) -> Result<String> {
