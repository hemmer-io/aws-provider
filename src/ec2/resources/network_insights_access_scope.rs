...
impl<'a> Network_insights_access_scope<'a> {
    ...
    pub async fn create(&self, match_paths: Option<Vec<String>>, client_token: String, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, exclude_paths: Option<Vec<String>>) -> Result<String> {
