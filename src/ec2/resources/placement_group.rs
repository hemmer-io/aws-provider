...
impl<'a> Placement_group<'a> {
    ...
    pub async fn create(&self, strategy: Option<String>, partition_count: Option<i64>, dry_run: Option<bool>, tag_specifications: Option<Vec<String>>, spread_level: Option<String>, group_name: Option<String>) -> Result<String> {
