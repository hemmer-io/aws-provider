...
impl<'a> Placement_group<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, group_name: Option<String>, strategy: Option<String>, spread_level: Option<String>, partition_count: Option<i64>, tag_specifications: Option<Vec<String>>) -> Result<String> {
