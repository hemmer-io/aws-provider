...
impl<'a> Vpc_peering_connection<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, peer_owner_id: Option<String>, peer_region: Option<String>, peer_vpc_id: Option<String>, tag_specifications: Option<Vec<String>>, vpc_id: String) -> Result<String> {
