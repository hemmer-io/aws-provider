...
impl<'a> Vpc_peering_connection<'a> {
    ...
    pub async fn create(&self, vpc_id: String, peer_vpc_id: Option<String>, peer_region: Option<String>, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, peer_owner_id: Option<String>) -> Result<String> {
