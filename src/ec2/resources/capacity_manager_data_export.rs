...
impl<'a> Capacity_manager_data_export<'a> {
    ...
    pub async fn create(&self, schedule: String, s3_bucket_prefix: Option<String>, dry_run: Option<bool>, client_token: Option<String>, tag_specifications: Option<Vec<String>>, output_format: String, s3_bucket_name: String) -> Result<String> {
