...
impl<'a> Capacity_manager_data_export<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, output_format: String, s3_bucket_name: String, dry_run: Option<bool>, s3_bucket_prefix: Option<String>, schedule: String, client_token: Option<String>) -> Result<String> {
