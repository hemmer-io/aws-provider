...
impl<'a> Transit_gateway_route_table_announcement<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, transit_gateway_route_table_id: String, dry_run: Option<bool>, peering_attachment_id: String) -> Result<String> {
