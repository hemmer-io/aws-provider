...
impl<'a> Customer_gateway<'a> {
    ...
    pub async fn create(&self, bgp_asn_extended: Option<i64>, certificate_arn: Option<String>, bgp_asn: Option<i64>, type: String, dry_run: Option<bool>, device_name: Option<String>, tag_specifications: Option<Vec<String>>, ip_address: Option<String>, public_ip: Option<String>) -> Result<String> {
