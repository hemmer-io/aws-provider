...
impl<'a> Network_insights_path<'a> {
    ...
    pub async fn create(&self, filter_at_source: Option<String>, destination_port: Option<i64>, tag_specifications: Option<Vec<String>>, destination_ip: Option<String>, protocol: String, source: String, filter_at_destination: Option<String>, destination: Option<String>, source_ip: Option<String>, dry_run: Option<bool>, client_token: String) -> Result<String> {
