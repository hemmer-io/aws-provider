...
impl<'a> Network_insights_path<'a> {
    ...
    pub async fn create(&self, source_ip: Option<String>, destination_port: Option<i64>, source: String, destination_ip: Option<String>, client_token: String, filter_at_destination: Option<String>, tag_specifications: Option<Vec<String>>, filter_at_source: Option<String>, protocol: String, destination: Option<String>, dry_run: Option<bool>) -> Result<String> {
