...
impl<'a> Replace_root_volume_task<'a> {
    ...
    pub async fn create(&self, snapshot_id: Option<String>, delete_replaced_root_volume: Option<bool>, volume_initialization_rate: Option<i64>, dry_run: Option<bool>, client_token: Option<String>, instance_id: String, tag_specifications: Option<Vec<String>>, image_id: Option<String>) -> Result<String> {
