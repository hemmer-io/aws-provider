...
impl<'a> Replace_root_volume_task<'a> {
    ...
    pub async fn create(&self, image_id: Option<String>, volume_initialization_rate: Option<i64>, delete_replaced_root_volume: Option<bool>, tag_specifications: Option<Vec<String>>, client_token: Option<String>, snapshot_id: Option<String>, dry_run: Option<bool>, instance_id: String) -> Result<String> {
