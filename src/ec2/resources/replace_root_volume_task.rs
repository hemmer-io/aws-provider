...
impl<'a> Replace_root_volume_task<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, delete_replaced_root_volume: Option<bool>, client_token: Option<String>, image_id: Option<String>, volume_initialization_rate: Option<i64>, instance_id: String, snapshot_id: Option<String>) -> Result<String> {
