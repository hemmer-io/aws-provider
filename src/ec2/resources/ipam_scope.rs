...
impl<'a> Ipam_scope<'a> {
    ...
    pub async fn create(&self, ipam_id: String, description: Option<String>, client_token: Option<String>, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>) -> Result<String> {
