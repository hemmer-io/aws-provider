...
impl<'a> Traffic_mirror_session<'a> {
    ...
    pub async fn create(&self, description: Option<String>, dry_run: Option<bool>, traffic_mirror_target_id: String, virtual_network_id: Option<i64>, client_token: Option<String>, packet_length: Option<i64>, tag_specifications: Option<Vec<String>>, traffic_mirror_filter_id: String, network_interface_id: String, session_number: i64) -> Result<String> {
