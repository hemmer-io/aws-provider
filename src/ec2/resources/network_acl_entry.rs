...
impl<'a> Network_acl_entry<'a> {
    ...
    pub async fn create(&self, rule_number: i64, network_acl_id: String, protocol: String, rule_action: String, cidr_block: Option<String>, ipv6_cidr_block: Option<String>, egress: bool, dry_run: Option<bool>, port_range: Option<String>, icmp_type_code: Option<String>) -> Result<String> {
