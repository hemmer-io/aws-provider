...
impl<'a> Client_vpn_route<'a> {
    ...
    pub async fn create(&self, destination_cidr_block: String, target_vpc_subnet_id: String, client_vpn_endpoint_id: String, description: Option<String>, client_token: Option<String>, dry_run: Option<bool>) -> Result<String> {
