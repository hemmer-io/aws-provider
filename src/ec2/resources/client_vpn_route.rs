...
impl<'a> Client_vpn_route<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, client_vpn_endpoint_id: String, target_vpc_subnet_id: String, description: Option<String>, destination_cidr_block: String, client_token: Option<String>) -> Result<String> {
