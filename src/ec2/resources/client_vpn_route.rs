...
impl<'a> Client_vpn_route<'a> {
    ...
    pub async fn create(&self, client_vpn_endpoint_id: String, target_vpc_subnet_id: String, description: Option<String>, dry_run: Option<bool>, destination_cidr_block: String, client_token: Option<String>) -> Result<String> {
