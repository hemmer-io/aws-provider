...
impl<'a> Local_gateway_route<'a> {
    ...
    pub async fn create(&self, local_gateway_route_table_id: String, local_gateway_virtual_interface_group_id: Option<String>, destination_cidr_block: Option<String>, dry_run: Option<bool>, network_interface_id: Option<String>, destination_prefix_list_id: Option<String>) -> Result<String> {
