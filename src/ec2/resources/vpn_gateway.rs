...
impl<'a> Vpn_gateway<'a> {
    ...
    pub async fn create(&self, type: String, amazon_side_asn: Option<i64>, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>, availability_zone: Option<String>) -> Result<String> {
