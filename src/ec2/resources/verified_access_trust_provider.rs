...
impl<'a> Verified_access_trust_provider<'a> {
    ...
    pub async fn create(&self, device_trust_provider_type: Option<String>, tag_specifications: Option<Vec<String>>, description: Option<String>, policy_reference_name: String, sse_specification: Option<String>, trust_provider_type: String, user_trust_provider_type: Option<String>, oidc_options: Option<String>, client_token: Option<String>, native_application_oidc_options: Option<String>, dry_run: Option<bool>, device_options: Option<String>) -> Result<String> {
