...
impl<'a> Vpn_connection<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, vpn_gateway_id: Option<String>, pre_shared_key_storage: Option<String>, customer_gateway_id: String, type: String, transit_gateway_id: Option<String>, tag_specifications: Option<Vec<String>>, options: Option<String>) -> Result<String> {
