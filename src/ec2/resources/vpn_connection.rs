...
impl<'a> Vpn_connection<'a> {
    ...
    pub async fn create(&self, vpn_gateway_id: Option<String>, options: Option<String>, type: String, dry_run: Option<bool>, customer_gateway_id: String, transit_gateway_id: Option<String>, pre_shared_key_storage: Option<String>, tag_specifications: Option<Vec<String>>) -> Result<String> {
