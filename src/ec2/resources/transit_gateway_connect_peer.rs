...
impl<'a> Transit_gateway_connect_peer<'a> {
    ...
    pub async fn create(&self, transit_gateway_address: Option<String>, peer_address: String, transit_gateway_attachment_id: String, bgp_options: Option<String>, inside_cidr_blocks: Vec<String>, dry_run: Option<bool>, tag_specifications: Option<Vec<String>>) -> Result<String> {
