...
impl<'a> Local_gateway_route_table_virtual_interface_group_association<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, local_gateway_virtual_interface_group_id: String, dry_run: Option<bool>, local_gateway_route_table_id: String) -> Result<String> {
