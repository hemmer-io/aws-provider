...
impl<'a> Local_gateway_route_table_virtual_interface_group_association<'a> {
    ...
    pub async fn create(&self, local_gateway_virtual_interface_group_id: String, tag_specifications: Option<Vec<String>>, local_gateway_route_table_id: String, dry_run: Option<bool>) -> Result<String> {
