...
impl<'a> Route_server<'a> {
    ...
    pub async fn create(&self, amazon_side_asn: i64, client_token: Option<String>, dry_run: Option<bool>, persist_routes_duration: Option<i64>, sns_notifications_enabled: Option<bool>, persist_routes: Option<String>, tag_specifications: Option<Vec<String>>) -> Result<String> {
