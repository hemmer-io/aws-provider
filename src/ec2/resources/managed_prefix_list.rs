...
impl<'a> Managed_prefix_list<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, entries: Option<Vec<String>>, address_family: String, client_token: Option<String>, prefix_list_name: String, max_entries: i64, dry_run: Option<bool>) -> Result<String> {
