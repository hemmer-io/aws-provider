...
impl<'a> Ipam_prefix_list_resolver<'a> {
    ...
    pub async fn create(&self, description: Option<String>, dry_run: Option<bool>, address_family: String, rules: Option<Vec<String>>, tag_specifications: Option<Vec<String>>, client_token: Option<String>, ipam_id: String) -> Result<String> {
