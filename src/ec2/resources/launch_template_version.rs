...
impl<'a> Launch_template_version<'a> {
    ...
    pub async fn create(&self, launch_template_id: Option<String>, client_token: Option<String>, dry_run: Option<bool>, version_description: Option<String>, launch_template_name: Option<String>, launch_template_data: String, source_version: Option<String>, resolve_alias: Option<bool>) -> Result<String> {
