...
impl<'a> Instance_event_window<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, time_ranges: Option<Vec<String>>, tag_specifications: Option<Vec<String>>, name: Option<String>, cron_expression: Option<String>) -> Result<String> {
