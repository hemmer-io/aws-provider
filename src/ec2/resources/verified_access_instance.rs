...
impl<'a> Verified_access_instance<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, dry_run: Option<bool>, fipsenabled: Option<bool>, cidr_endpoints_custom_sub_domain: Option<String>, tag_specifications: Option<Vec<String>>, description: Option<String>) -> Result<String> {
