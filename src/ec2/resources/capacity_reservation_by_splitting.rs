...
impl<'a> Capacity_reservation_by_splitting<'a> {
    ...
    pub async fn create(&self, client_token: Option<String>, instance_count: i64, source_capacity_reservation_id: String, tag_specifications: Option<Vec<String>>, dry_run: Option<bool>) -> Result<String> {
