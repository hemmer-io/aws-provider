...
impl<'a> Capacity_reservation_by_splitting<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, client_token: Option<String>, instance_count: i64, tag_specifications: Option<Vec<String>>, source_capacity_reservation_id: String) -> Result<String> {
