...
impl<'a> Route_server_peer<'a> {
    ...
    pub async fn create(&self, bgp_options: String, tag_specifications: Option<Vec<String>>, route_server_endpoint_id: String, dry_run: Option<bool>, peer_address: String) -> Result<String> {
