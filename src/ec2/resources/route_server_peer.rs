...
impl<'a> Route_server_peer<'a> {
    ...
    pub async fn create(&self, tag_specifications: Option<Vec<String>>, bgp_options: String, dry_run: Option<bool>, peer_address: String, route_server_endpoint_id: String) -> Result<String> {
