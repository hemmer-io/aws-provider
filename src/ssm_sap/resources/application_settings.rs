...
impl<'a> Application_settings<'a> {
    ...
    pub async fn update(&self, id: &str, credentials_to_remove: Option<Vec<String>>, database_arn: Option<String>, credentials_to_add_or_update: Option<Vec<String>>, application_id: Option<String>, backint: Option<String>) -> Result<()> {

        // Note: This is a generated skeleton.
        // TODO: Map resource ID and update fields to SDK parameters
        let _client = &self.provider.ssm_sap_client;
