...
impl<'a> Ssm_sapService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "resource_permission" => {
                self.plan_resource_permission(current_state, desired_input)
                    .await
            }
            ...
            "configuration_check_operation" => {
                self.plan_configuration_check_operation(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ssm_sap", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "resource_permission" => self.create_resource_permission(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "resource_permission" => self.read_resource_permission(id).await,
            ...
            "configuration_check_operation" => self.read_configuration_check_operation(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ssm_sap", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "resource_permission" => self.update_resource_permission(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "resource_permission" => self.delete_resource_permission(id).await,
            ...
            "configuration_check_operation" => self.delete_configuration_check_operation(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ssm_sap", resource_name
            ))),
    ...
    async fn create_resource_permission(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "source_resource_arn",
                    source_resource_arn.unwrap_or_default(),
                )
    ...
    async fn read_resource_permission(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resource_permission(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_application_settings(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let credentials_to_add_or_update =
                input.get_optional_string("credentials_to_add_or_update")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    credentials_to_remove.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    credentials_to_add_or_update.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn read_configuration_check_operation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ssm_sap_client
    ...
    async fn delete_configuration_check_operation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ssm_sap_client
