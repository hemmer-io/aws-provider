...
impl AwsProvider {
    ...
    pub fn new() -> Result<Self> {
        ...
        let (config, iottwinmaker_client, payment_cryptography_client, timestream_write_client, workspaces_instances_client, guardduty_client, resiliencehub_client, sts_client, lightsail_client, license_manager_user_subscriptions_client, route53_recovery_readiness_client, chatbot_client, networkmanager_client, pinpoint_client, detective_client, managedblockchain_query_client, fis_client, s3vectors_client, codeguru_reviewer_client, cleanroomsml_client, databrew_client, workdocs_client, pca_connector_scep_client, s3tables_client, route53_recovery_cluster_client, cloudfront_client, kendra_ranking_client, forecastquery_client, rbin_client, memorydb_client, codedeploy_client, ses_client, kafka_client, socialmessaging_client, partnercentral_selling_client, mailmanager_client, personalize_client, iot_managed_integrations_client, securityhub_client, mwaa_client, transcribe_streaming_client, observabilityadmin_client, chime_sdk_meetings_client, marketplace_reporting_client, appflow_client, comprehend_client, launch_wizard_client, s3_control_client, controlcatalog_client, applicationcostprofiler_client, cloudtrail_client, keyspacesstreams_client, personalize_events_client, wellarchitected_client, cloudhsm_client, sesv2_client, iot_wireless_client, amp_client, finspace_data_client, s3outposts_client, pi_client, neptunedata_client, codeconnections_client, keyspaces_client, outposts_client, mediastore_client, iotdeviceadvisor_client, deadline_client, pcs_client, panorama_client, codebuild_client, greengrassv2_client, health_client, polly_client, workmail_client, cloudformation_client, evidently_client, geo_routes_client, appconfig_client, appintegrations_client, gamelift_client, billingconductor_client, waf_regional_client, proton_client, resource_explorer_2_client, schemas_client, aiops_client, elasticsearch_service_client, sso_client, secrets_manager_client, cognito_identity_provider_client, cloudsearch_domain_client, amplifyuibuilder_client, networkmonitor_client, iotanalytics_client, medical_imaging_client, bcm_dashboards_client, drs_client, support_app_client, tnb_client, connectcases_client, route53_recovery_control_config_client, support_client, groundstation_client, pinpoint_email_client, ebs_client, medialive_client, efs_client, mediastore_data_client, repostspace_client, greengrass_client, marketplace_commerce_analytics_client, migrationhubstrategy_client, oam_client, dax_client, managedblockchain_client, waf_client, backup_client, network_firewall_client, rds_client, iotthingsgraph_client, firehose_client, textract_client, macie2_client, comprehendmedical_client, sagemaker_a2i_runtime_client, budgets_client, auto_scaling_plans_client, qbusiness_client, connectcampaignsv2_client, inspector2_client, mq_client, osis_client, bcm_recommended_actions_client, direct_connect_client, opensearchserverless_client, personalize_runtime_client, emr_client, marketplace_agreement_client, chime_sdk_messaging_client, ram_client, batch_client, wafv2_client, notificationscontacts_client, evs_client, elastic_transcoder_client, vpc_lattice_client, marketplace_deployment_client, ivschat_client, xray_client, iot_jobs_data_plane_client, lex_model_building_service_client, customer_profiles_client, amplify_client, service_catalog_appregistry_client, iotsecuretunneling_client, backup_gateway_client, bedrock_runtime_client, machine_learning_client, kendra_client, route_53_client, cloudtrail_data_client, connectparticipant_client, savingsplans_client, codepipeline_client, bedrock_agentcore_control_client, codecommit_client, glacier_client, qconnect_client, taxsettings_client, marketplace_catalog_client, database_migration_service_client, lookoutequipment_client, account_client, neptune_client, qapps_client, scheduler_client, connect_contact_lens_client, eventbridge_client, devops_guru_client, config_service_client, bedrock_data_automation_runtime_client, dsql_client, eks_client, opensearch_client, sqs_client, elastic_load_balancing_client, apigatewaymanagementapi_client, internetmonitor_client, auditmanager_client, athena_client, signer_client, invoicing_client, application_auto_scaling_client, voice_id_client, trustedadvisor_client, iot_events_data_client, docdb_client, sso_admin_client, neptune_graph_client, ssm_sap_client, ssm_contacts_client, pricing_client, forecast_client, compute_optimizer_client, iotfleetwise_client, auto_scaling_client, bcm_pricing_calculator_client, bedrock_agent_runtime_client, s3_client, mediatailor_client, dynamodb_streams_client, iotsitewise_client, emr_containers_client, bcm_data_exports_client, ecr_public_client, pinpoint_sms_client, api_gateway_client, codeartifact_client, redshift_data_client, ec2_client, cloudfront_keyvaluestore_client, elastic_beanstalk_client, bedrock_agent_client, cloudsearch_client, appconfigdata_client, dlm_client, appsync_client, ivs_client, rum_client, dataexchange_client, app_mesh_client, rekognition_client, ssm_quicksetup_client, mturk_client, frauddetector_client, sfn_client, timestream_query_client, dynamodb_client, workspaces_client, artifact_client, ssm_client, pipes_client, migrationhub_config_client, redshift_client, marketplace_metering_client, migration_hub_client, codestar_connections_client, data_pipeline_client, license_manager_client, workmailmessageflow_client, workspaces_web_client, directory_service_client, sagemaker_metrics_client, workspaces_thin_client_client, directory_service_data_client, resource_groups_client, verifiedpermissions_client, sns_client, cognito_sync_client, apigatewayv2_client, arc_zonal_shift_client, appstream_client, migration_hub_refactor_spaces_client, arc_region_switch_client, accessanalyzer_client, bedrock_client, kms_client, cost_explorer_client, kinesis_analytics_client, acm_pca_client, sagemaker_client, cloudwatch_logs_client, swf_client, emr_serverless_client, bedrock_data_automation_client, mediaconvert_client, cost_optimization_hub_client, connectcampaigns_client, datasync_client, chime_sdk_media_pipelines_client, application_signals_client, sagemaker_geospatial_client, securitylake_client, inspector_scan_client, rtbfabric_client, cost_and_usage_report_service_client, gameliftstreams_client, sso_oidc_client, payment_cryptography_data_client, billing_client, iam_client, chime_sdk_client, sagemaker_edge_client, iot_events_client, connect_client, identitystore_client, iot_data_plane_client, pca_connector_ad_client, freetier_client, rds_data_client, lex_runtime_service_client, odb_client, eks_auth_client, organizations_client, networkflowmonitor_client, glue_client, elasticache_client, clouddirectory_client, healthlake_client, codestar_notifications_client, quicksight_client, route53resolver_client, synthetics_client, transcribe_client, chime_client, fms_client, translate_client, amplifybackend_client, inspector_client, migrationhuborchestrator_client, backupsearch_client, ssm_guiconnect_client, serverlessapplicationrepository_client, kinesis_client, geo_places_client, cloudwatch_client, ivs_realtime_client, controltower_client, mediapackage_client, service_quotas_client, service_catalog_client, mgn_client, fsx_client, lex_models_client, ecr_client, cloud9_client, cleanrooms_client, lex_runtime_client, grafana_client, route53profiles_client, resource_groups_tagging_api_client, global_accelerator_client, finspace_client, bedrock_agentcore_client, supplychain_client, cognito_identity_client, entityresolution_client, shield_client, b2bi_client, datazone_client, route_53_domains_client, acm_client, m2_client, appfabric_client, docdb_elastic_client, geo_maps_client, apprunner_client, lakeformation_client, snowball_client, notifications_client, mpa_client, imagebuilder_client, mediaconnect_client, kafkaconnect_client, snow_device_management_client, cloudcontrol_client, license_manager_linux_subscriptions_client, marketplace_entitlement_service_client, chime_sdk_identity_client, location_client, device_farm_client, cloudwatch_events_client, braket_client, codeguru_security_client, codeguruprofiler_client, iot_client, ssm_incidents_client, rolesanywhere_client, transfer_client, redshift_serverless_client, wisdom_client, omics_client, sagemaker_featurestore_runtime_client, codecatalyst_client, ecs_client, storage_gateway_client, mediapackagev2_client, simspaceweaver_client, timestream_influxdb_client, sagemaker_runtime_client, application_insights_client, lambda_client, ec2_instance_connect_client, security_ir_client) = runtime.block_on(async {
            ...
            (config, iottwinmaker_client, payment_cryptography_client, timestream_write_client, workspaces_instances_client, guardduty_client, resiliencehub_client, sts_client, lightsail_client, license_manager_user_subscriptions_client, route53_recovery_readiness_client, chatbot_client, networkmanager_client, pinpoint_client, detective_client, managedblockchain_query_client, fis_client, s3vectors_client, codeguru_reviewer_client, cleanroomsml_client, databrew_client, workdocs_client, pca_connector_scep_client, s3tables_client, route53_recovery_cluster_client, cloudfront_client, kendra_ranking_client, forecastquery_client, rbin_client, memorydb_client, codedeploy_client, ses_client, kafka_client, socialmessaging_client, partnercentral_selling_client, mailmanager_client, personalize_client, iot_managed_integrations_client, securityhub_client, mwaa_client, transcribe_streaming_client, observabilityadmin_client, chime_sdk_meetings_client, marketplace_reporting_client, appflow_client, comprehend_client, launch_wizard_client, s3_control_client, controlcatalog_client, applicationcostprofiler_client, cloudtrail_client, keyspacesstreams_client, personalize_events_client, wellarchitected_client, cloudhsm_client, sesv2_client, iot_wireless_client, amp_client, finspace_data_client, s3outposts_client, pi_client, neptunedata_client, codeconnections_client, keyspaces_client, outposts_client, mediastore_client, iotdeviceadvisor_client, deadline_client, pcs_client, panorama_client, codebuild_client, greengrassv2_client, health_client, polly_client, workmail_client, cloudformation_client, evidently_client, geo_routes_client, appconfig_client, appintegrations_client, gamelift_client, billingconductor_client, waf_regional_client, proton_client, resource_explorer_2_client, schemas_client, aiops_client, elasticsearch_service_client, sso_client, secrets_manager_client, cognito_identity_provider_client, cloudsearch_domain_client, amplifyuibuilder_client, networkmonitor_client, iotanalytics_client, medical_imaging_client, bcm_dashboards_client, drs_client, support_app_client, tnb_client, connectcases_client, route53_recovery_control_config_client, support_client, groundstation_client, pinpoint_email_client, ebs_client, medialive_client, efs_client, mediastore_data_client, repostspace_client, greengrass_client, marketplace_commerce_analytics_client, migrationhubstrategy_client, oam_client, dax_client, managedblockchain_client, waf_client, backup_client, network_firewall_client, rds_client, iotthingsgraph_client, firehose_client, textract_client, macie2_client, comprehendmedical_client, sagemaker_a2i_runtime_client, budgets_client, auto_scaling_plans_client, qbusiness_client, connectcampaignsv2_client, inspector2_client, mq_client, osis_client, bcm_recommended_actions_client, direct_connect_client, opensearchserverless_client, personalize_runtime_client, emr_client, marketplace_agreement_client, chime_sdk_messaging_client, ram_client, batch_client, wafv2_client, notificationscontacts_client, evs_client, elastic_transcoder_client, vpc_lattice_client, marketplace_deployment_client, ivschat_client, xray_client, iot_jobs_data_plane_client, lex_model_building_service_client, customer_profiles_client, amplify_client, service_catalog_appregistry_client, iotsecuretunneling_client, backup_gateway_client, bedrock_runtime_client, machine_learning_client, kendra_client, route_53_client, cloudtrail_data_client, connectparticipant_client, savingsplans_client, codepipeline_client, bedrock_agentcore_control_client, codecommit_client, glacier_client, qconnect_client, taxsettings_client, marketplace_catalog_client, database_migration_service_client, lookoutequipment_client, account_client, neptune_client, qapps_client, scheduler_client, connect_contact_lens_client, eventbridge_client, devops_guru_client, config_service_client, bedrock_data_automation_runtime_client, dsql_client, eks_client, opensearch_client, sqs_client, elastic_load_balancing_client, apigatewaymanagementapi_client, internetmonitor_client, auditmanager_client, athena_client, signer_client, invoicing_client, application_auto_scaling_client, voice_id_client, trustedadvisor_client, iot_events_data_client, docdb_client, sso_admin_client, neptune_graph_client, ssm_sap_client, ssm_contacts_client, pricing_client, forecast_client, compute_optimizer_client, iotfleetwise_client, auto_scaling_client, bcm_pricing_calculator_client, bedrock_agent_runtime_client, s3_client, mediatailor_client, dynamodb_streams_client, iotsitewise_client, emr_containers_client, bcm_data_exports_client, ecr_public_client, pinpoint_sms_client, api_gateway_client, codeartifact_client, redshift_data_client, ec2_client, cloudfront_keyvaluestore_client, elastic_beanstalk_client, bedrock_agent_client, cloudsearch_client, appconfigdata_client, dlm_client, appsync_client, ivs_client, rum_client, dataexchange_client, app_mesh_client, rekognition_client, ssm_quicksetup_client, mturk_client, frauddetector_client, sfn_client, timestream_query_client, dynamodb_client, workspaces_client, artifact_client, ssm_client, pipes_client, migrationhub_config_client, redshift_client, marketplace_metering_client, migration_hub_client, codestar_connections_client, data_pipeline_client, license_manager_client, workmailmessageflow_client, workspaces_web_client, directory_service_client, sagemaker_metrics_client, workspaces_thin_client_client, directory_service_data_client, resource_groups_client, verifiedpermissions_client, sns_client, cognito_sync_client, apigatewayv2_client, arc_zonal_shift_client, appstream_client, migration_hub_refactor_spaces_client, arc_region_switch_client, accessanalyzer_client, bedrock_client, kms_client, cost_explorer_client, kinesis_analytics_client, acm_pca_client, sagemaker_client, cloudwatch_logs_client, swf_client, emr_serverless_client, bedrock_data_automation_client, mediaconvert_client, cost_optimization_hub_client, connectcampaigns_client, datasync_client, chime_sdk_media_pipelines_client, application_signals_client, sagemaker_geospatial_client, securitylake_client, inspector_scan_client, rtbfabric_client, cost_and_usage_report_service_client, gameliftstreams_client, sso_oidc_client, payment_cryptography_data_client, billing_client, iam_client, chime_sdk_client, sagemaker_edge_client, iot_events_client, connect_client, identitystore_client, iot_data_plane_client, pca_connector_ad_client, freetier_client, rds_data_client, lex_runtime_service_client, odb_client, eks_auth_client, organizations_client, networkflowmonitor_client, glue_client, elasticache_client, clouddirectory_client, healthlake_client, codestar_notifications_client, quicksight_client, route53resolver_client, synthetics_client, transcribe_client, chime_client, fms_client, translate_client, amplifybackend_client, inspector_client, migrationhuborchestrator_client, backupsearch_client, ssm_guiconnect_client, serverlessapplicationrepository_client, kinesis_client, geo_places_client, cloudwatch_client, ivs_realtime_client, controltower_client, mediapackage_client, service_quotas_client, service_catalog_client, mgn_client, fsx_client, lex_models_client, ecr_client, cloud9_client, cleanrooms_client, lex_runtime_client, grafana_client, route53profiles_client, resource_groups_tagging_api_client, global_accelerator_client, finspace_client, bedrock_agentcore_client, supplychain_client, cognito_identity_client, entityresolution_client, shield_client, b2bi_client, datazone_client, route_53_domains_client, acm_client, m2_client, appfabric_client, docdb_elastic_client, geo_maps_client, apprunner_client, lakeformation_client, snowball_client, notifications_client, mpa_client, imagebuilder_client, mediaconnect_client, kafkaconnect_client, snow_device_management_client, cloudcontrol_client, license_manager_linux_subscriptions_client, marketplace_entitlement_service_client, chime_sdk_identity_client, location_client, device_farm_client, cloudwatch_events_client, braket_client, codeguru_security_client, codeguruprofiler_client, iot_client, ssm_incidents_client, rolesanywhere_client, transfer_client, redshift_serverless_client, wisdom_client, omics_client, sagemaker_featurestore_runtime_client, codecatalyst_client, ecs_client, storage_gateway_client, mediapackagev2_client, simspaceweaver_client, timestream_influxdb_client, sagemaker_runtime_client, application_insights_client, lambda_client, ec2_instance_connect_client, security_ir_client)
        });
