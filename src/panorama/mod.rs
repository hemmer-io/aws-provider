...
impl<'a> PanoramaService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "job_for_devices" => {
                self.plan_job_for_devices(current_state, desired_input)
                    .await
            }
            "application_instance_details" => {
                self.plan_application_instance_details(current_state, desired_input)
                    .await
            }
            "device_job" => self.plan_device_job(current_state, desired_input).await,
            "application_instance" => {
                self.plan_application_instance(current_state, desired_input)
                    .await
            }
            "node" => self.plan_node(current_state, desired_input).await,
            "device_metadata" => {
                self.plan_device_metadata(current_state, desired_input)
                    .await
            }
            "node_from_template_job" => {
                self.plan_node_from_template_job(current_state, desired_input)
                    .await
            }
            "package_version" => {
            ...
            "package_import_job" => {
                self.plan_package_import_job(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "panorama", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "job_for_devices" => self.create_job_for_devices(input).await,
            "application_instance_details" => self.create_application_instance_details(input).await,
            "device_job" => self.create_device_job(input).await,
            "application_instance" => self.create_application_instance(input).await,
            "node" => self.create_node(input).await,
            "device_metadata" => self.create_device_metadata(input).await,
            "node_from_template_job" => self.create_node_from_template_job(input).await,
            "package_version" => self.create_package_version(input).await,
            "device" => self.create_device(input).await,
            "package_import_job" => self.create_package_import_job(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "panorama", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "job_for_devices" => self.read_job_for_devices(id).await,
            "application_instance_details" => self.read_application_instance_details(id).await,
            "device_job" => self.read_device_job(id).await,
            "application_instance" => self.read_application_instance(id).await,
            "node" => self.read_node(id).await,
            "device_metadata" => self.read_device_metadata(id).await,
            "node_from_template_job" => self.read_node_from_template_job(id).await,
            "package_version" => self.read_package_version(id).await,
            "device" => self.read_device(id).await,
            "package_import_job" => self.read_package_import_job(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "panorama", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "job_for_devices" => self.update_job_for_devices(id, input).await,
            "application_instance_details" => {
                self.update_application_instance_details(id, input).await
            }
            "device_job" => self.update_device_job(id, input).await,
            "application_instance" => self.update_application_instance(id, input).await,
            "node" => self.update_node(id, input).await,
            "device_metadata" => self.update_device_metadata(id, input).await,
            "node_from_template_job" => self.update_node_from_template_job(id, input).await,
            "package_version" => self.update_package_version(id, input).await,
            "device" => self.update_device(id, input).await,
            "package_import_job" => self.update_package_import_job(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "panorama", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "job_for_devices" => self.delete_job_for_devices(id).await,
            "application_instance_details" => self.delete_application_instance_details(id).await,
            "device_job" => self.delete_device_job(id).await,
            "application_instance" => self.delete_application_instance(id).await,
            "node" => self.delete_node(id).await,
            "device_metadata" => self.delete_device_metadata(id).await,
            "node_from_template_job" => self.delete_node_from_template_job(id).await,
            "package_version" => self.delete_package_version(id).await,
            "device" => self.delete_device(id).await,
            "package_import_job" => self.delete_package_import_job(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "panorama", resource_name
            ))),
    ...
    async fn create_job_for_devices(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_job_for_devices(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.panorama_client
    ...
    async fn delete_job_for_devices(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.panorama_client
    ...
    async fn read_application_instance_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.panorama_client
    ...
    async fn delete_application_instance_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.panorama_client
    ...
    async fn create_device_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_device_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.panorama_client
    ...
    async fn update_device_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_device_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.panorama_client
    ...
    async fn create_application_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let default_runtime_context_device =
                input.get_string("default_runtime_context_device")?;
            let description = input.get_optional_string("description")?;
            let application_instance_id_to_replace =
                input.get_optional_string("application_instance_id_to_replace")?;
            let name = input.get_optional_string("name")?;
            let manifest_payload = input.get_string("manifest_payload")?;
            let manifest_overrides_payload =
                input.get_optional_string("manifest_overrides_payload")?;
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    default_runtime_context_device.unwrap_or_default(),
                )
                .with_field("description", description.unwrap_or_default())
                .with_field(
                    "application_instance_id_to_replace",
                    application_instance_id_to_replace.unwrap_or_default(),
                )
                .with_field("name", name.unwrap_or_default())
                .with_field("manifest_payload", manifest_payload.unwrap_or_default())
                .with_field(
                    "manifest_overrides_payload",
                    manifest_overrides_payload.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
    ...
    async fn read_application_instance(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.panorama_client
    ...
    async fn delete_application_instance(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.panorama_client
    ...
    async fn create_device_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_device_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.panorama_client
    ...
    async fn delete_device_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.panorama_client
    ...
    async fn create_node_from_template_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    output_package_version.unwrap_or_default(),
                )
                .with_field(
                    "output_package_name",
                    output_package_name.unwrap_or_default(),
                )
                .with_field("job_tags", job_tags.unwrap_or_default())
                .with_field("node_name", node_name.unwrap_or_default())
                .with_field(
                    "template_parameters",
                    template_parameters.unwrap_or_default(),
                ))
        })
    }

    /// Read a node_from_template_job resource
    async fn read_node_from_template_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.panorama_client
    ...
    async fn delete_node_from_template_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.panorama_client
    ...
    async fn create_package_import_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let job_type = input.get_string("job_type")?;
    ...
    async fn read_package_import_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.panorama_client
    ...
    async fn delete_package_import_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.panorama_client
