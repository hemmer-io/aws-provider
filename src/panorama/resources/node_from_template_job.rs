...
impl<'a> Node_from_template_job<'a> {
    ...
    pub async fn create(&self, node_description: Option<String>, template_type: String, output_package_version: String, output_package_name: String, job_tags: Option<Vec<String>>, node_name: String, template_parameters: HashMap<String, String>) -> Result<String> {
