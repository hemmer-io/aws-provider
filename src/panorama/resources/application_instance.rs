...
impl<'a> Application_instance<'a> {
    ...
    pub async fn create(&self, default_runtime_context_device: String, description: Option<String>, application_instance_id_to_replace: Option<String>, name: Option<String>, manifest_payload: String, manifest_overrides_payload: Option<String>, tags: Option<HashMap<String, String>>, runtime_role_arn: Option<String>) -> Result<String> {
