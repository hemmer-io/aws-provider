...
impl<'a> Repository_link<'a> {
    ...
    pub async fn create(&self, connection_arn: String, owner_id: String, repository_name: String, encryption_key_arn: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, connection_arn: Option<String>, owner_id: Option<String>, repository_name: Option<String>, encryption_key_arn: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
