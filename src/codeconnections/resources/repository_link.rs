...
impl<'a> Repository_link<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, repository_name: String, owner_id: String, encryption_key_arn: Option<String>, connection_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, repository_name: Option<String>, owner_id: Option<String>, encryption_key_arn: Option<String>, connection_arn: Option<String>) -> Result<()> {
