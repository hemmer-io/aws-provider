//! Codeconnections service for Aws provider
//!
//! This module handles all codeconnections resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Codeconnections service handler
...
impl<'a> CodeconnectionsService<'a> {
    ...
    async fn create_repository_link(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_repository_link(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
