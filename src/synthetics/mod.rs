...
impl<'a> SyntheticsService<'a> {
    ...
    async fn create_canaries_last_run(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn read_canaries_last_run(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_canaries_last_run(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
