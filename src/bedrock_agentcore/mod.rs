...
impl<'a> Bedrock_agentcoreService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "resource_oauth2_token" => {
                self.plan_resource_oauth2_token(current_state, desired_input)
                    .await
            }
            "workload_access_token_for_jwt" => {
                self.plan_workload_access_token_for_jwt(current_state, desired_input)
                    .await
            }
            "resource_api_key" => {
                self.plan_resource_api_key(current_state, desired_input)
                    .await
            }
            "workload_access_token_for_user_id" => {
                self.plan_workload_access_token_for_user_id(current_state, desired_input)
                    .await
            }
            "workload_access_token" => {
                self.plan_workload_access_token(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "bedrock_agentcore", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "resource_oauth2_token" => self.create_resource_oauth2_token(input).await,
            "workload_access_token_for_jwt" => {
                self.create_workload_access_token_for_jwt(input).await
            }
            "resource_api_key" => self.create_resource_api_key(input).await,
            "workload_access_token_for_user_id" => {
                self.create_workload_access_token_for_user_id(input).await
            }
            "workload_access_token" => self.create_workload_access_token(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "bedrock_agentcore", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "resource_oauth2_token" => self.read_resource_oauth2_token(id).await,
            "workload_access_token_for_jwt" => self.read_workload_access_token_for_jwt(id).await,
            "resource_api_key" => self.read_resource_api_key(id).await,
            "workload_access_token_for_user_id" => {
                self.read_workload_access_token_for_user_id(id).await
            }
            "workload_access_token" => self.read_workload_access_token(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "bedrock_agentcore", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "resource_oauth2_token" => self.update_resource_oauth2_token(id, input).await,
            "workload_access_token_for_jwt" => {
                self.update_workload_access_token_for_jwt(id, input).await
            }
            "resource_api_key" => self.update_resource_api_key(id, input).await,
            "workload_access_token_for_user_id" => {
                self.update_workload_access_token_for_user_id(id, input)
                    .await
            }
            "workload_access_token" => self.update_workload_access_token(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "bedrock_agentcore", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "resource_oauth2_token" => self.delete_resource_oauth2_token(id).await,
            "workload_access_token_for_jwt" => self.delete_workload_access_token_for_jwt(id).await,
            "resource_api_key" => self.delete_resource_api_key(id).await,
            "workload_access_token_for_user_id" => {
                self.delete_workload_access_token_for_user_id(id).await
            }
            "workload_access_token" => self.delete_workload_access_token(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "bedrock_agentcore", resource_name
            ))),
    ...
    async fn create_resource_oauth2_token(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_resource_oauth2_token(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resource_oauth2_token(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_workload_access_token_for_jwt(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.bedrock_agentcore_client
    ...
    async fn delete_workload_access_token_for_jwt(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.bedrock_agentcore_client
    ...
    async fn create_resource_api_key(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_resource_api_key(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.bedrock_agentcore_client
    ...
    async fn delete_resource_api_key(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.bedrock_agentcore_client
    ...
    async fn read_workload_access_token_for_user_id(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.bedrock_agentcore_client
    ...
    async fn delete_workload_access_token_for_user_id(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.bedrock_agentcore_client
    ...
    async fn create_workload_access_token(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_workload_access_token(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.bedrock_agentcore_client
    ...
    async fn delete_workload_access_token(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.bedrock_agentcore_client
