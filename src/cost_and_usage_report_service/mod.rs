...
impl<'a> Cost_and_usage_report_serviceService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "report_definitions" => {
                self.plan_report_definitions(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "report_definitions" => {
                self.create_report_definitions(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cost_and_usage_report_service",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "report_definitions" => {
                self.read_report_definitions(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cost_and_usage_report_service",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "report_definitions" => {
                self.update_report_definitions(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cost_and_usage_report_service",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "report_definitions" => {
                self.delete_report_definitions(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cost_and_usage_report_service",
    ...
    async fn create_report_definitions(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_report_definitions(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_report_definitions(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
