...
impl<'a> CloudsearchService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "scaling_parameters" => {
                self.plan_scaling_parameters(current_state, desired_input).await
            }
            "service_access_policies" => {
                self.plan_service_access_policies(current_state, desired_input).await
            }
            "analysis_schemes" => {
                self.plan_analysis_schemes(current_state, desired_input).await
            }
            "domain_endpoint_options" => {
                self.plan_domain_endpoint_options(current_state, desired_input).await
            }
            "expressions" => {
                self.plan_expressions(current_state, desired_input).await
            }
            "suggester" => {
                self.plan_suggester(current_state, desired_input).await
            }
            "index_fields" => {
                self.plan_index_fields(current_state, desired_input).await
            }
            "domains" => {
                self.plan_domains(current_state, desired_input).await
            }
            "analysis_scheme" => {
                self.plan_analysis_scheme(current_state, desired_input).await
            }
            "index_field" => {
                self.plan_index_field(current_state, desired_input).await
            }
            "expression" => {
                self.plan_expression(current_state, desired_input).await
            }
            "suggesters" => {
                self.plan_suggesters(current_state, desired_input).await
            }
            "availability_options" => {
                self.plan_availability_options(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "scaling_parameters" => {
                self.create_scaling_parameters(input).await
            }
            "service_access_policies" => {
                self.create_service_access_policies(input).await
            }
            "analysis_schemes" => {
                self.create_analysis_schemes(input).await
            }
            "domain_endpoint_options" => {
                self.create_domain_endpoint_options(input).await
            }
            "expressions" => {
                self.create_expressions(input).await
            }
            "suggester" => {
                self.create_suggester(input).await
            }
            "index_fields" => {
                self.create_index_fields(input).await
            }
            "domains" => {
                self.create_domains(input).await
            }
            "analysis_scheme" => {
                self.create_analysis_scheme(input).await
            }
            "index_field" => {
                self.create_index_field(input).await
            }
            "expression" => {
                self.create_expression(input).await
            }
            "suggesters" => {
                self.create_suggesters(input).await
            }
            "availability_options" => {
                self.create_availability_options(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudsearch",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "scaling_parameters" => {
                self.read_scaling_parameters(id).await
            }
            "service_access_policies" => {
                self.read_service_access_policies(id).await
            }
            "analysis_schemes" => {
                self.read_analysis_schemes(id).await
            }
            "domain_endpoint_options" => {
                self.read_domain_endpoint_options(id).await
            }
            "expressions" => {
                self.read_expressions(id).await
            }
            "suggester" => {
                self.read_suggester(id).await
            }
            "index_fields" => {
                self.read_index_fields(id).await
            }
            "domains" => {
                self.read_domains(id).await
            }
            "analysis_scheme" => {
                self.read_analysis_scheme(id).await
            }
            "index_field" => {
                self.read_index_field(id).await
            }
            "expression" => {
                self.read_expression(id).await
            }
            "suggesters" => {
                self.read_suggesters(id).await
            }
            "availability_options" => {
                self.read_availability_options(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudsearch",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "scaling_parameters" => {
                self.update_scaling_parameters(id, input).await
            }
            "service_access_policies" => {
                self.update_service_access_policies(id, input).await
            }
            "analysis_schemes" => {
                self.update_analysis_schemes(id, input).await
            }
            "domain_endpoint_options" => {
                self.update_domain_endpoint_options(id, input).await
            }
            "expressions" => {
                self.update_expressions(id, input).await
            }
            "suggester" => {
                self.update_suggester(id, input).await
            }
            "index_fields" => {
                self.update_index_fields(id, input).await
            }
            "domains" => {
                self.update_domains(id, input).await
            }
            "analysis_scheme" => {
                self.update_analysis_scheme(id, input).await
            }
            "index_field" => {
                self.update_index_field(id, input).await
            }
            "expression" => {
                self.update_expression(id, input).await
            }
            "suggesters" => {
                self.update_suggesters(id, input).await
            }
            "availability_options" => {
                self.update_availability_options(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudsearch",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "scaling_parameters" => {
                self.delete_scaling_parameters(id).await
            }
            "service_access_policies" => {
                self.delete_service_access_policies(id).await
            }
            "analysis_schemes" => {
                self.delete_analysis_schemes(id).await
            }
            "domain_endpoint_options" => {
                self.delete_domain_endpoint_options(id).await
            }
            "expressions" => {
                self.delete_expressions(id).await
            }
            "suggester" => {
                self.delete_suggester(id).await
            }
            "index_fields" => {
                self.delete_index_fields(id).await
            }
            "domains" => {
                self.delete_domains(id).await
            }
            "analysis_scheme" => {
                self.delete_analysis_scheme(id).await
            }
            "index_field" => {
                self.delete_index_field(id).await
            }
            "expression" => {
                self.delete_expression(id).await
            }
            "suggesters" => {
                self.delete_suggesters(id).await
            }
            "availability_options" => {
                self.delete_availability_options(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudsearch",
    ...
    async fn create_scaling_parameters(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_scaling_parameters(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_scaling_parameters(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_service_access_policies(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_service_access_policies(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_service_access_policies(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_analysis_schemes(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_analysis_schemes(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_analysis_schemes(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_domain_endpoint_options(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_domain_endpoint_options(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_domain_endpoint_options(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_analysis_scheme(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn create_availability_options(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_availability_options(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_availability_options(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
