...
impl<'a> Entity_recognizer<'a> {
    ...
    pub async fn create(&self, model_kms_key_id: Option<String>, model_policy: Option<String>, client_request_token: Option<String>, version_name: Option<String>, vpc_config: Option<String>, recognizer_name: String, tags: Option<Vec<String>>, language_code: String, input_data_config: String, data_access_role_arn: String, volume_kms_key_id: Option<String>) -> Result<String> {
