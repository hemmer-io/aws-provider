...
impl<'a> Batch_import_job<'a> {
    ...
    pub async fn create(&self, iam_role_arn: String, tags: Option<Vec<String>>, job_id: String, output_path: String, event_type_name: String, input_path: String) -> Result<String> {
