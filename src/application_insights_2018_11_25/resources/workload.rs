...
impl<'a> Workload<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, workload_configuration: Option<String>, component_name: Option<String>, workload_id: Option<String>, resource_group_name: Option<String>) -> Result<()> {
