//! Mpa service for Aws provider
//!
//! This module handles all mpa resources and their CRUD operations.
...
impl<'a> MpaService<'a> {
    ...
    async fn create_policy_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            // Example:
            // let result = self.provider.mpa_client
