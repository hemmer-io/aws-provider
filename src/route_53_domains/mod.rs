...
impl<'a> Route_53_domainsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "domain_detail" => self.plan_domain_detail(current_state, desired_input).await,
            "domain_contact_privacy" => {
                self.plan_domain_contact_privacy(current_state, desired_input)
                    .await
            }
            "domain_nameservers" => {
                self.plan_domain_nameservers(current_state, desired_input)
                    .await
            }
            "contact_reachability_status" => {
                self.plan_contact_reachability_status(current_state, desired_input)
                    .await
            }
            "domain_suggestions" => {
                self.plan_domain_suggestions(current_state, desired_input)
                    .await
            }
            "operation_detail" => {
                self.plan_operation_detail(current_state, desired_input)
                    .await
            }
            "tags_for_domain" => {
                self.plan_tags_for_domain(current_state, desired_input)
                    .await
            }
            "domain" => self.plan_domain(current_state, desired_input).await,
            "domain_contact" => self.plan_domain_contact(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route_53_domains", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "domain_detail" => self.create_domain_detail(input).await,
            "domain_contact_privacy" => self.create_domain_contact_privacy(input).await,
            "domain_nameservers" => self.create_domain_nameservers(input).await,
            "contact_reachability_status" => self.create_contact_reachability_status(input).await,
            "domain_suggestions" => self.create_domain_suggestions(input).await,
            "operation_detail" => self.create_operation_detail(input).await,
            "tags_for_domain" => self.create_tags_for_domain(input).await,
            "domain" => self.create_domain(input).await,
            "domain_contact" => self.create_domain_contact(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route_53_domains", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "domain_detail" => self.read_domain_detail(id).await,
            "domain_contact_privacy" => self.read_domain_contact_privacy(id).await,
            "domain_nameservers" => self.read_domain_nameservers(id).await,
            "contact_reachability_status" => self.read_contact_reachability_status(id).await,
            "domain_suggestions" => self.read_domain_suggestions(id).await,
            "operation_detail" => self.read_operation_detail(id).await,
            "tags_for_domain" => self.read_tags_for_domain(id).await,
            "domain" => self.read_domain(id).await,
            "domain_contact" => self.read_domain_contact(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route_53_domains", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "domain_detail" => self.update_domain_detail(id, input).await,
            "domain_contact_privacy" => self.update_domain_contact_privacy(id, input).await,
            "domain_nameservers" => self.update_domain_nameservers(id, input).await,
            "contact_reachability_status" => {
                self.update_contact_reachability_status(id, input).await
            }
            "domain_suggestions" => self.update_domain_suggestions(id, input).await,
            "operation_detail" => self.update_operation_detail(id, input).await,
            "tags_for_domain" => self.update_tags_for_domain(id, input).await,
            "domain" => self.update_domain(id, input).await,
            "domain_contact" => self.update_domain_contact(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route_53_domains", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "domain_detail" => self.delete_domain_detail(id).await,
            "domain_contact_privacy" => self.delete_domain_contact_privacy(id).await,
            "domain_nameservers" => self.delete_domain_nameservers(id).await,
            "contact_reachability_status" => self.delete_contact_reachability_status(id).await,
            "domain_suggestions" => self.delete_domain_suggestions(id).await,
            "operation_detail" => self.delete_operation_detail(id).await,
            "tags_for_domain" => self.delete_tags_for_domain(id).await,
            "domain" => self.delete_domain(id).await,
            "domain_contact" => self.delete_domain_contact(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route_53_domains", resource_name
            ))),
    ...
    async fn create_domain_detail(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_domain_detail(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_domain_detail(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_domain_detail(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_domain_contact_privacy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_domain_contact_privacy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_domains_client
    ...
    async fn delete_domain_contact_privacy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_domains_client
    ...
    async fn create_domain_nameservers(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_domain_nameservers(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_domains_client
    ...
    async fn delete_domain_nameservers(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_domains_client
    ...
    async fn read_contact_reachability_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_domains_client
    ...
    async fn delete_contact_reachability_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_domains_client
    ...
    async fn create_domain_suggestions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_domain_suggestions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_domains_client
    ...
    async fn delete_domain_suggestions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_domains_client
    ...
    async fn create_operation_detail(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_operation_detail(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_domains_client
    ...
    async fn delete_operation_detail(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_domains_client
    ...
    async fn create_tags_for_domain(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_tags_for_domain(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_domains_client
    ...
    async fn delete_tags_for_domain(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_domains_client
    ...
    async fn create_domain_contact(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_domain_contact(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route_53_domains_client
    ...
    async fn delete_domain_contact(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route_53_domains_client
