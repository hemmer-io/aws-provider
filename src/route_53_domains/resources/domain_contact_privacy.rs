...
impl<'a> Domain_contact_privacy<'a> {
    ...
    pub async fn update(&self, id: &str, billing_privacy: Option<bool>, admin_privacy: Option<bool>, registrant_privacy: Option<bool>, domain_name: Option<String>, tech_privacy: Option<bool>) -> Result<()> {
