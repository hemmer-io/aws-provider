...
impl<'a> Predictor_backtest_export_job<'a> {
    ...
    pub async fn create(&self, format: Option<String>, predictor_arn: String, predictor_backtest_export_job_name: String, destination: String, tags: Option<Vec<String>>) -> Result<String> {
