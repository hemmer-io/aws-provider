...
impl<'a> Predictor_backtest_export_job<'a> {
    ...
    pub async fn create(&self, format: Option<String>, predictor_backtest_export_job_name: String, destination: String, predictor_arn: String, tags: Option<Vec<String>>) -> Result<String> {
