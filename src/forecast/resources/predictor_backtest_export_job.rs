...
impl<'a> Predictor_backtest_export_job<'a> {
    ...
    pub async fn create(&self, destination: String, format: Option<String>, predictor_backtest_export_job_name: String, predictor_arn: String, tags: Option<Vec<String>>) -> Result<String> {
