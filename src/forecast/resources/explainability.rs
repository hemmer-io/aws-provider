...
impl<'a> Explainability<'a> {
    ...
    pub async fn create(&self, resource_arn: String, tags: Option<Vec<String>>, schema: Option<String>, start_date_time: Option<String>, end_date_time: Option<String>, enable_visualization: Option<bool>, explainability_name: String, data_source: Option<String>, explainability_config: String) -> Result<String> {
