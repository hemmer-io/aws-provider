...
impl<'a> Explainability<'a> {
    ...
    pub async fn create(&self, end_date_time: Option<String>, data_source: Option<String>, start_date_time: Option<String>, tags: Option<Vec<String>>, schema: Option<String>, explainability_name: String, resource_arn: String, explainability_config: String, enable_visualization: Option<bool>) -> Result<String> {
