...
impl<'a> Forecast_export_job<'a> {
    ...
    pub async fn create(&self, destination: String, format: Option<String>, tags: Option<Vec<String>>, forecast_export_job_name: String, forecast_arn: String) -> Result<String> {
