...
impl<'a> Forecast_export_job<'a> {
    ...
    pub async fn create(&self, forecast_export_job_name: String, destination: String, tags: Option<Vec<String>>, forecast_arn: String, format: Option<String>) -> Result<String> {
