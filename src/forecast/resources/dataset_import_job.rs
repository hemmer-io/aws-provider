...
impl<'a> Dataset_import_job<'a> {
    ...
    pub async fn create(&self, dataset_arn: String, data_source: String, time_zone: Option<String>, dataset_import_job_name: String, timestamp_format: Option<String>, geolocation_format: Option<String>, import_mode: Option<String>, format: Option<String>, use_geolocation_for_time_zone: Option<bool>, tags: Option<Vec<String>>) -> Result<String> {
