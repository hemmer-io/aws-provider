...
impl<'a> What_if_forecast<'a> {
    ...
    pub async fn create(&self, what_if_analysis_arn: String, tags: Option<Vec<String>>, time_series_transformations: Option<Vec<String>>, time_series_replacements_data_source: Option<String>, what_if_forecast_name: String) -> Result<String> {
