...
impl<'a> Dataset_group<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, dataset_arns: Option<Vec<String>>, dataset_group_name: String, domain: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, dataset_arns: Option<Vec<String>>, dataset_group_name: Option<String>, domain: Option<String>) -> Result<()> {
