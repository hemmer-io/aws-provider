...
impl<'a> Dataset_group<'a> {
    ...
    pub async fn create(&self, dataset_group_name: String, domain: String, dataset_arns: Option<Vec<String>>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, dataset_group_name: Option<String>, domain: Option<String>, dataset_arns: Option<Vec<String>>, tags: Option<Vec<String>>) -> Result<()> {
