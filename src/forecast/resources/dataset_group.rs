...
impl<'a> Dataset_group<'a> {
    ...
    pub async fn create(&self, domain: String, dataset_group_name: String, dataset_arns: Option<Vec<String>>, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, domain: Option<String>, dataset_group_name: Option<String>, dataset_arns: Option<Vec<String>>, tags: Option<Vec<String>>) -> Result<()> {
