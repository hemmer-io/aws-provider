...
impl<'a> Explainability_export<'a> {
    ...
    pub async fn create(&self, explainability_export_name: String, explainability_arn: String, destination: String, format: Option<String>, tags: Option<Vec<String>>) -> Result<String> {
