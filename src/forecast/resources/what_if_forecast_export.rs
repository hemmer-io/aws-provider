...
impl<'a> What_if_forecast_export<'a> {
    ...
    pub async fn create(&self, what_if_forecast_arns: Vec<i64>, what_if_forecast_export_name: String, destination: String, tags: Option<Vec<String>>, format: Option<String>) -> Result<String> {
