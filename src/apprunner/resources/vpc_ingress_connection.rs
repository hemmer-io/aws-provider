...
impl<'a> Vpc_ingress_connection<'a> {
    ...
    pub async fn create(&self, ingress_vpc_configuration: String, vpc_ingress_connection_name: String, tags: Option<Vec<String>>, service_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, ingress_vpc_configuration: Option<String>, vpc_ingress_connection_name: Option<String>, tags: Option<Vec<String>>, service_arn: Option<String>) -> Result<()> {
