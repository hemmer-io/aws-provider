...
impl<'a> Vpc_ingress_connection<'a> {
    ...
    pub async fn create(&self, service_arn: String, vpc_ingress_connection_name: String, tags: Option<Vec<String>>, ingress_vpc_configuration: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, service_arn: Option<String>, vpc_ingress_connection_name: Option<String>, tags: Option<Vec<String>>, ingress_vpc_configuration: Option<String>) -> Result<()> {
