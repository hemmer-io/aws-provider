...
impl<'a> Auto_scaling_configuration<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, auto_scaling_configuration_name: String, max_concurrency: Option<i64>, max_size: Option<i64>, min_size: Option<i64>) -> Result<String> {
