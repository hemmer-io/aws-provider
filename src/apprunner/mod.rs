...
impl<'a> ApprunnerService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "default_auto_scaling_configuration" => {
                self.plan_default_auto_scaling_configuration(current_state, desired_input)
                    .await
            }
            "observability_configuration" => {
                self.plan_observability_configuration(current_state, desired_input)
                    .await
            }
            "custom_domains" => self.plan_custom_domains(current_state, desired_input).await,
            "vpc_ingress_connection" => {
                self.plan_vpc_ingress_connection(current_state, desired_input)
                    .await
            }
            "auto_scaling_configuration" => {
                self.plan_auto_scaling_configuration(current_state, desired_input)
                    .await
            }
            "connection" => self.plan_connection(current_state, desired_input).await,
            "vpc_connector" => self.plan_vpc_connector(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apprunner", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "observability_configuration" => self.create_observability_configuration(input).await,
            "custom_domains" => self.create_custom_domains(input).await,
            "vpc_ingress_connection" => self.create_vpc_ingress_connection(input).await,
            "auto_scaling_configuration" => self.create_auto_scaling_configuration(input).await,
            "connection" => self.create_connection(input).await,
            "vpc_connector" => self.create_vpc_connector(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apprunner", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "observability_configuration" => self.read_observability_configuration(id).await,
            "custom_domains" => self.read_custom_domains(id).await,
            "vpc_ingress_connection" => self.read_vpc_ingress_connection(id).await,
            "auto_scaling_configuration" => self.read_auto_scaling_configuration(id).await,
            "connection" => self.read_connection(id).await,
            "vpc_connector" => self.read_vpc_connector(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apprunner", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "default_auto_scaling_configuration" => {
                self.update_default_auto_scaling_configuration(id, input)
                    .await
            }
            "observability_configuration" => {
                self.update_observability_configuration(id, input).await
            }
            "custom_domains" => self.update_custom_domains(id, input).await,
            "vpc_ingress_connection" => self.update_vpc_ingress_connection(id, input).await,
            "auto_scaling_configuration" => self.update_auto_scaling_configuration(id, input).await,
            "connection" => self.update_connection(id, input).await,
            "vpc_connector" => self.update_vpc_connector(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apprunner", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "observability_configuration" => self.delete_observability_configuration(id).await,
            "custom_domains" => self.delete_custom_domains(id).await,
            "vpc_ingress_connection" => self.delete_vpc_ingress_connection(id).await,
            "auto_scaling_configuration" => self.delete_auto_scaling_configuration(id).await,
            "connection" => self.delete_connection(id).await,
            "vpc_connector" => self.delete_vpc_connector(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apprunner", resource_name
            ))),
    ...
    async fn create_service(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let auto_scaling_configuration_arn =
                input.get_optional_string("auto_scaling_configuration_arn")?;
            ...
            let health_check_configuration =
                input.get_optional_string("health_check_configuration")?;
            let instance_configuration = input.get_optional_string("instance_configuration")?;
            let observability_configuration =
                input.get_optional_string("observability_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    auto_scaling_configuration_arn.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    health_check_configuration.unwrap_or_default(),
                )
                .with_field(
                ...
                .with_field(
                    "observability_configuration",
                    observability_configuration.unwrap_or_default(),
                )
                .with_field(
    ...
    async fn create_default_auto_scaling_configuration(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let auto_scaling_configuration_arn =
                input.get_string("auto_scaling_configuration_arn")?;
    ...
    async fn read_default_auto_scaling_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.apprunner_client
    ...
    async fn delete_default_auto_scaling_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.apprunner_client
    ...
    async fn create_observability_configuration(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let observability_configuration_name =
                input.get_string("observability_configuration_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    observability_configuration_name.unwrap_or_default(),
                )
                .with_field(
                    "trace_configuration",
                    trace_configuration.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default()))
        })
    }
    ...
    async fn read_observability_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.apprunner_client
    ...
    async fn delete_observability_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.apprunner_client
    ...
    async fn create_custom_domains(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_custom_domains(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.apprunner_client
    ...
    async fn delete_custom_domains(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.apprunner_client
    ...
    async fn create_vpc_ingress_connection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    ingress_vpc_configuration.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "vpc_ingress_connection_name",
                    vpc_ingress_connection_name.unwrap_or_default(),
                )
    ...
    async fn read_vpc_ingress_connection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.apprunner_client
    ...
    async fn delete_vpc_ingress_connection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.apprunner_client
    ...
    async fn create_auto_scaling_configuration(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let auto_scaling_configuration_name =
                input.get_string("auto_scaling_configuration_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    auto_scaling_configuration_name.unwrap_or_default(),
                )
    ...
    async fn read_auto_scaling_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.apprunner_client
    ...
    async fn delete_auto_scaling_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.apprunner_client
    ...
    async fn create_vpc_connector(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_vpc_connector(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.apprunner_client
    ...
    async fn update_vpc_connector(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let subnets = input.get_string("subnets")?;
    ...
    async fn delete_vpc_connector(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.apprunner_client
