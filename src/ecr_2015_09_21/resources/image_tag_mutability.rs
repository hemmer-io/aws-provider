...
impl<'a> Image_tag_mutability<'a> {
    ...
    pub async fn create(&self, repository_name: String, image_tag_mutability_exclusion_filters: Option<Vec<String>>, image_tag_mutability: String, registry_id: Option<String>) -> Result<String> {
