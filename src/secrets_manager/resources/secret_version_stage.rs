...
impl<'a> Secret_version_stage<'a> {
    ...
    pub async fn update(&self, id: &str, remove_from_version_id: Option<String>, secret_id: Option<String>, version_stage: Option<String>, move_to_version_id: Option<String>) -> Result<()> {
