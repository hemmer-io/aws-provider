...
impl<'a> Secret_value<'a> {
    ...
    pub async fn create(&self, secret_string: Option<String>, version_stages: Option<Vec<String>>, client_request_token: Option<String>, secret_binary: Option<String>, secret_id: String, rotation_token: Option<String>) -> Result<String> {
