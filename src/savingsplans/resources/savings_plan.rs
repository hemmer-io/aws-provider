...
impl<'a> Savings_plan<'a> {
    ...
    pub async fn create(&self, upfront_payment_amount: Option<String>, tags: Option<HashMap<String, String>>, purchase_time: Option<String>, client_token: Option<String>, savings_plan_offering_id: String, commitment: String) -> Result<String> {
