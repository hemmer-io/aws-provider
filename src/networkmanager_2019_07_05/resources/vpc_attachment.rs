...
impl<'a> Vpc_attachment<'a> {
    ...
    pub async fn create(&self, options: Option<String>, tags: Option<Vec<String>>, subnet_arns: Vec<String>, core_network_id: String, vpc_arn: String, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, options: Option<String>, tags: Option<Vec<String>>, subnet_arns: Option<Vec<String>>, core_network_id: Option<String>, vpc_arn: Option<String>, client_token: Option<String>) -> Result<()> {
