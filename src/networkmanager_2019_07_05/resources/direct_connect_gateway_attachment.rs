...
impl<'a> Direct_connect_gateway_attachment<'a> {
    ...
    pub async fn create(&self, edge_locations: Vec<String>, core_network_id: String, tags: Option<Vec<String>>, direct_connect_gateway_arn: String, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, edge_locations: Option<Vec<String>>, core_network_id: Option<String>, tags: Option<Vec<String>>, direct_connect_gateway_arn: Option<String>, client_token: Option<String>) -> Result<()> {
