...
impl<'a> Streaming_url<'a> {
    ...
    pub async fn create(&self, fleet_name: String, validity: Option<i64>, stack_name: String, application_id: Option<String>, user_id: String, session_context: Option<String>) -> Result<String> {
