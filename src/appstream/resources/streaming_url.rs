...
impl<'a> Streaming_url<'a> {
    ...
    pub async fn create(&self, stack_name: String, user_id: String, application_id: Option<String>, fleet_name: String, validity: Option<i64>, session_context: Option<String>) -> Result<String> {
