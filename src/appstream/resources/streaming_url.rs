...
impl<'a> Streaming_url<'a> {
    ...
    pub async fn create(&self, stack_name: String, fleet_name: String, application_id: Option<String>, user_id: String, validity: Option<i64>, session_context: Option<String>) -> Result<String> {
