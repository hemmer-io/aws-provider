...
impl<'a> Updated_image<'a> {
    ...
    pub async fn create(&self, new_image_description: Option<String>, new_image_tags: Option<HashMap<String, String>>, new_image_name: String, new_image_display_name: Option<String>, dry_run: Option<bool>, existing_image_name: String) -> Result<String> {
