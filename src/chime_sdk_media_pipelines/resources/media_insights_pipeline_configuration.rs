...
impl<'a> Media_insights_pipeline_configuration<'a> {
    ...
    pub async fn create(&self, client_request_token: Option<String>, media_insights_pipeline_configuration_name: String, resource_access_role_arn: String, tags: Option<Vec<String>>, real_time_alert_configuration: Option<String>, elements: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_request_token: Option<String>, media_insights_pipeline_configuration_name: Option<String>, resource_access_role_arn: Option<String>, tags: Option<Vec<String>>, real_time_alert_configuration: Option<String>, elements: Option<Vec<String>>) -> Result<()> {
