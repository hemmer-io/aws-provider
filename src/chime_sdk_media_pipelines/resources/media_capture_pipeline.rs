...
impl<'a> Media_capture_pipeline<'a> {
    ...
    pub async fn create(&self, sink_type: String, sse_aws_key_management_params: Option<String>, sink_iam_role_arn: Option<String>, client_request_token: Option<String>, chime_sdk_meeting_configuration: Option<String>, sink_arn: String, tags: Option<Vec<String>>, source_arn: String, source_type: String) -> Result<String> {
