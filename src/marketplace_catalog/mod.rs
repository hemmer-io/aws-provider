//! Marketplace_catalog service for Aws provider
//!
//! This module handles all marketplace_catalog resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Marketplace_catalog service handler
pub struct Marketplace_catalogService<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Marketplace_catalogService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "marketplace_catalog", resource_name
            ))),
        }
    }
    ...
    async fn create_change_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            // Example:
            // let result = self.provider.marketplace_catalog_client
            //     .create_change_set()
            //     .set_name(name)
            //     .send()
            //     .await
    ...
    async fn delete_change_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            ...
            // Example:
            // self.provider.marketplace_catalog_client
            //     .delete_change_set()
            //     .set_id(id.to_string())
            //     .send()
            //     .await
