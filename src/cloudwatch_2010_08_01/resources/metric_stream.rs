...
impl<'a> Metric_stream<'a> {
    ...
    pub async fn create(&self, name: String, firehose_arn: String, role_arn: String, tags: Option<Vec<String>>, statistics_configurations: Option<Vec<String>>, exclude_filters: Option<Vec<String>>, include_filters: Option<Vec<String>>, include_linked_accounts_metrics: Option<bool>, output_format: String) -> Result<String> {
