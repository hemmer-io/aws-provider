...
impl<'a> Insight_rule<'a> {
    ...
    pub async fn create(&self, rule_definition: String, tags: Option<Vec<String>>, apply_on_transformed_logs: Option<bool>, rule_name: String, rule_state: Option<String>) -> Result<String> {
