...
impl<'a> Batch_load_task<'a> {
    ...
    pub async fn create(&self, target_table_name: String, record_version: Option<i64>, report_configuration: String, client_token: Option<String>, data_model_configuration: Option<String>, data_source_configuration: String, target_database_name: String) -> Result<String> {
