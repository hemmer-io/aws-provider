...
impl<'a> Subscription_filter<'a> {
    ...
    pub async fn create(&self, role_arn: Option<String>, log_group_name: String, destination_arn: String, emit_system_fields: Option<Vec<String>>, filter_pattern: String, apply_on_transformed_logs: Option<bool>, filter_name: String, distribution: Option<String>, field_selection_criteria: Option<String>) -> Result<String> {
