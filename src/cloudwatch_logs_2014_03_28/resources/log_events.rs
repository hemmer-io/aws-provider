...
impl<'a> Log_events<'a> {
    ...
    pub async fn create(&self, sequence_token: Option<String>, log_events: Vec<String>, log_group_name: String, entity: Option<String>, log_stream_name: String) -> Result<String> {
