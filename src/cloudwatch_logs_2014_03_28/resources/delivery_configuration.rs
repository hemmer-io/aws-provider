...
impl<'a> Delivery_configuration<'a> {
    ...
    pub async fn update(&self, id: &str, field_delimiter: Option<String>, s3_delivery_configuration: Option<String>, id: Option<String>, record_fields: Option<Vec<String>>) -> Result<()> {
