...
impl<'a> Resource_policy<'a> {
    ...
    pub async fn create(&self, resource_arn: Option<String>, policy_name: Option<String>, policy_document: Option<String>, expected_revision_id: Option<String>) -> Result<String> {
