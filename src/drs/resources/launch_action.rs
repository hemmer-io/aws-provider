...
impl<'a> Launch_action<'a> {
    ...
    pub async fn create(&self, parameters: Option<HashMap<String, String>>, order: i64, description: String, resource_id: String, optional: bool, active: bool, category: String, action_id: String, action_code: String, name: String, action_version: String) -> Result<String> {
