...
impl<'a> Recovery_group<'a> {
    ...
    pub async fn create(&self, recovery_group_name: String, tags: Option<HashMap<String, String>>, cells: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, recovery_group_name: Option<String>, tags: Option<HashMap<String, String>>, cells: Option<Vec<String>>) -> Result<()> {
