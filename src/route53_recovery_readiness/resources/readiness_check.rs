...
impl<'a> Readiness_check<'a> {
    ...
    pub async fn create(&self, resource_set_name: String, tags: Option<HashMap<String, String>>, readiness_check_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, resource_set_name: Option<String>, tags: Option<HashMap<String, String>>, readiness_check_name: Option<String>) -> Result<()> {
