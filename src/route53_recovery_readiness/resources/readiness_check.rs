...
impl<'a> Readiness_check<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, resource_set_name: String, readiness_check_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, resource_set_name: Option<String>, readiness_check_name: Option<String>) -> Result<()> {
