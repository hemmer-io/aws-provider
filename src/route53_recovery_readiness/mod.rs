...
impl<'a> Route53_recovery_readinessService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "readiness_check_resource_status" => {
                self.plan_readiness_check_resource_status(current_state, desired_input)
                    .await
            }
            "cell" => self.plan_cell(current_state, desired_input).await,
            "readiness_check" => {
                self.plan_readiness_check(current_state, desired_input)
                    .await
            }
            "recovery_group" => self.plan_recovery_group(current_state, desired_input).await,
            "readiness_check_status" => {
                self.plan_readiness_check_status(current_state, desired_input)
                    .await
            }
            "recovery_group_readiness_summary" => {
                self.plan_recovery_group_readiness_summary(current_state, desired_input)
                    .await
            }
            "cross_account_authorization" => {
                self.plan_cross_account_authorization(current_state, desired_input)
                    .await
            }
            "cell_readiness_summary" => {
                self.plan_cell_readiness_summary(current_state, desired_input)
                    .await
            }
            "architecture_recommendations" => {
                self.plan_architecture_recommendations(current_state, desired_input)
                    .await
            }
            "resource_set" => self.plan_resource_set(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route53_recovery_readiness", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "cell" => self.create_cell(input).await,
            "readiness_check" => self.create_readiness_check(input).await,
            "recovery_group" => self.create_recovery_group(input).await,
            "readiness_check_status" => self.create_readiness_check_status(input).await,
            "recovery_group_readiness_summary" => {
                self.create_recovery_group_readiness_summary(input).await
            }
            "cross_account_authorization" => self.create_cross_account_authorization(input).await,
            "cell_readiness_summary" => self.create_cell_readiness_summary(input).await,
            "architecture_recommendations" => self.create_architecture_recommendations(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "cell" => self.read_cell(id).await,
            "readiness_check" => self.read_readiness_check(id).await,
            "recovery_group" => self.read_recovery_group(id).await,
            "readiness_check_status" => self.read_readiness_check_status(id).await,
            "recovery_group_readiness_summary" => {
                self.read_recovery_group_readiness_summary(id).await
            }
            "cross_account_authorization" => self.read_cross_account_authorization(id).await,
            "cell_readiness_summary" => self.read_cell_readiness_summary(id).await,
            "architecture_recommendations" => self.read_architecture_recommendations(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "cell" => self.update_cell(id, input).await,
            "readiness_check" => self.update_readiness_check(id, input).await,
            "recovery_group" => self.update_recovery_group(id, input).await,
            "readiness_check_status" => self.update_readiness_check_status(id, input).await,
            "recovery_group_readiness_summary" => {
                self.update_recovery_group_readiness_summary(id, input)
                    .await
            }
            "cross_account_authorization" => {
                self.update_cross_account_authorization(id, input).await
            }
            "cell_readiness_summary" => self.update_cell_readiness_summary(id, input).await,
            "architecture_recommendations" => {
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "cell" => self.delete_cell(id).await,
            "readiness_check" => self.delete_readiness_check(id).await,
            "recovery_group" => self.delete_recovery_group(id).await,
            "readiness_check_status" => self.delete_readiness_check_status(id).await,
            "recovery_group_readiness_summary" => {
                self.delete_recovery_group_readiness_summary(id).await
            }
            "cross_account_authorization" => self.delete_cross_account_authorization(id).await,
            "cell_readiness_summary" => self.delete_cell_readiness_summary(id).await,
            "architecture_recommendations" => self.delete_architecture_recommendations(id).await,
    ...
    async fn read_readiness_check_resource_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_readiness_check_resource_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cell(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cell(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route53_recovery_readiness_client
    ...
    async fn update_cell(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let cells = input.get_optional_string("cells")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_cell(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route53_recovery_readiness_client
    ...
    async fn create_readiness_check(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    readiness_check_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a readiness_check resource
    async fn read_readiness_check(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route53_recovery_readiness_client
    ...
    async fn delete_readiness_check(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route53_recovery_readiness_client
    ...
    async fn create_recovery_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "recovery_group_name",
                    recovery_group_name.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("cells", cells.unwrap_or_default()))
        })
    ...
    async fn read_recovery_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route53_recovery_readiness_client
    ...
    async fn delete_recovery_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route53_recovery_readiness_client
    ...
    async fn create_readiness_check_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_readiness_check_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route53_recovery_readiness_client
    ...
    async fn delete_readiness_check_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route53_recovery_readiness_client
    ...
    async fn read_recovery_group_readiness_summary(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route53_recovery_readiness_client
    ...
    async fn delete_recovery_group_readiness_summary(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route53_recovery_readiness_client
    ...
    async fn create_cross_account_authorization(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "cross_account_authorization",
                cross_account_authorization.unwrap_or_default(),
            ))
        })
    }

    /// Read a cross_account_authorization resource
    async fn read_cross_account_authorization(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route53_recovery_readiness_client
    ...
    async fn delete_cross_account_authorization(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route53_recovery_readiness_client
    ...
    async fn create_cell_readiness_summary(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cell_readiness_summary(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route53_recovery_readiness_client
    ...
    async fn delete_cell_readiness_summary(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route53_recovery_readiness_client
    ...
    async fn read_architecture_recommendations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.route53_recovery_readiness_client
    ...
    async fn delete_architecture_recommendations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.route53_recovery_readiness_client
