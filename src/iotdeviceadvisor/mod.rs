...
impl<'a> IotdeviceadvisorService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "suite_definition" => {
                self.plan_suite_definition(current_state, desired_input)
                    .await
            }
            "suite_run" => self.plan_suite_run(current_state, desired_input).await,
            "suite_run_report" => {
                self.plan_suite_run_report(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iotdeviceadvisor", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "suite_definition" => self.create_suite_definition(input).await,
            "suite_run" => self.create_suite_run(input).await,
            "suite_run_report" => self.create_suite_run_report(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iotdeviceadvisor", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "suite_definition" => self.read_suite_definition(id).await,
            "suite_run" => self.read_suite_run(id).await,
            "suite_run_report" => self.read_suite_run_report(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iotdeviceadvisor", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "suite_definition" => self.update_suite_definition(id, input).await,
            "suite_run" => self.update_suite_run(id, input).await,
            "suite_run_report" => self.update_suite_run_report(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iotdeviceadvisor", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "suite_definition" => self.delete_suite_definition(id).await,
            "suite_run" => self.delete_suite_run(id).await,
            "suite_run_report" => self.delete_suite_run_report(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iotdeviceadvisor", resource_name
            ))),
    ...
    async fn create_suite_definition(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let client_token = input.get_optional_string("client_token")?;
            let tags = input.get_optional_string("tags")?;
            let suite_definition_configuration =
                input.get_string("suite_definition_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    suite_definition_configuration.unwrap_or_default(),
                ))
        })
    }

    /// Read a suite_definition resource
    async fn read_suite_definition(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotdeviceadvisor_client
    ...
    async fn delete_suite_definition(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotdeviceadvisor_client
    ...
    async fn create_suite_run(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_suite_run(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotdeviceadvisor_client
    ...
    async fn update_suite_run(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_suite_run(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotdeviceadvisor_client
    ...
    async fn create_suite_run_report(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_suite_run_report(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotdeviceadvisor_client
    ...
    async fn delete_suite_run_report(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotdeviceadvisor_client
