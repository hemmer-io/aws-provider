...
impl<'a> Suite_definition<'a> {
    ...
    pub async fn create(&self, suite_definition_configuration: String, tags: Option<HashMap<String, String>>, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, suite_definition_configuration: Option<String>, tags: Option<HashMap<String, String>>, client_token: Option<String>) -> Result<()> {
