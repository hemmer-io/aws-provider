...
impl<'a> Logger_definition<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, initial_version: Option<String>, amzn_client_token: Option<String>, name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, initial_version: Option<String>, amzn_client_token: Option<String>, name: Option<String>) -> Result<()> {
