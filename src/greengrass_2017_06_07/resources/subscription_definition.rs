...
impl<'a> Subscription_definition<'a> {
    ...
    pub async fn create(&self, name: Option<String>, tags: Option<HashMap<String, String>>, initial_version: Option<String>, amzn_client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, tags: Option<HashMap<String, String>>, initial_version: Option<String>, amzn_client_token: Option<String>) -> Result<()> {
