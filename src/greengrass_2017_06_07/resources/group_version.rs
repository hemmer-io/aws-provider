...
impl<'a> Group_version<'a> {
    ...
    pub async fn create(&self, core_definition_version_arn: Option<String>, resource_definition_version_arn: Option<String>, device_definition_version_arn: Option<String>, function_definition_version_arn: Option<String>, logger_definition_version_arn: Option<String>, connector_definition_version_arn: Option<String>, subscription_definition_version_arn: Option<String>, amzn_client_token: Option<String>, group_id: String) -> Result<String> {
