...
impl<'a> Deployment<'a> {
    ...
    pub async fn create(&self, deployment_id: Option<String>, group_id: String, deployment_type: String, group_version_id: Option<String>, amzn_client_token: Option<String>) -> Result<String> {
