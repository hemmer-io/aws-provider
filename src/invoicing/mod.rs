...
impl<'a> InvoicingService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "invoice_unit" => {
                self.plan_invoice_unit(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "invoice_unit" => {
                self.create_invoice_unit(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "invoicing",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "invoice_unit" => {
                self.read_invoice_unit(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "invoicing",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "invoice_unit" => {
                self.update_invoice_unit(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "invoicing",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "invoice_unit" => {
                self.delete_invoice_unit(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "invoicing",
