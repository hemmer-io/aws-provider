...
impl<'a> Realtime_log_config<'a> {
    ...
    pub async fn create(&self, fields: Vec<String>, end_points: Vec<String>, name: String, sampling_rate: i64) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, fields: Option<Vec<String>>, end_points: Option<Vec<String>>, name: Option<String>, sampling_rate: Option<i64>) -> Result<()> {
