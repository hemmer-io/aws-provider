...
impl<'a> Realtime_log_config<'a> {
    ...
    pub async fn create(&self, name: String, sampling_rate: i64, end_points: Vec<String>, fields: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, sampling_rate: Option<i64>, end_points: Option<Vec<String>>, fields: Option<Vec<String>>) -> Result<()> {
