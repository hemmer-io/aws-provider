...
impl<'a> Realtime_log_config<'a> {
    ...
    pub async fn create(&self, fields: Vec<String>, sampling_rate: i64, name: String, end_points: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, fields: Option<Vec<String>>, sampling_rate: Option<i64>, name: Option<String>, end_points: Option<Vec<String>>) -> Result<()> {
