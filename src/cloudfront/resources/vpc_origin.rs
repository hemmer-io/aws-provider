...
impl<'a> Vpc_origin<'a> {
    ...
    pub async fn create(&self, tags: Option<String>, vpc_origin_endpoint_config: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<String>, vpc_origin_endpoint_config: Option<String>) -> Result<()> {
