...
impl<'a> Key_value_store<'a> {
    ...
    pub async fn create(&self, import_source: Option<String>, name: String, comment: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, import_source: Option<String>, name: Option<String>, comment: Option<String>) -> Result<()> {
