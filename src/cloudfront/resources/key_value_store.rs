...
impl<'a> Key_value_store<'a> {
    ...
    pub async fn create(&self, comment: Option<String>, import_source: Option<String>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, comment: Option<String>, import_source: Option<String>, name: Option<String>) -> Result<()> {
