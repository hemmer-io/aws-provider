...
impl<'a> Key_value_store<'a> {
    ...
    pub async fn create(&self, name: String, import_source: Option<String>, comment: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, import_source: Option<String>, comment: Option<String>) -> Result<()> {
