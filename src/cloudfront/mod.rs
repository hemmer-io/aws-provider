...
impl<'a> CloudfrontService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "connection_group_by_routing_endpoint" => {
                self.plan_connection_group_by_routing_endpoint(current_state, desired_input)
                    .await
            }
            "cache_policy_config" => {
                self.plan_cache_policy_config(current_state, desired_input)
                    .await
            }
            "response_headers_policy_config" => {
                self.plan_response_headers_policy_config(current_state, desired_input)
                    .await
            }
            "distribution_with_tags" => {
                self.plan_distribution_with_tags(current_state, desired_input)
                    .await
            }
            "field_level_encryption_profile_config" => {
                self.plan_field_level_encryption_profile_config(current_state, desired_input)
                    .await
            }
            "origin_request_policy_config" => {
                self.plan_origin_request_policy_config(current_state, desired_input)
                    .await
            }
            "distribution_with_staging_config" => {
                self.plan_distribution_with_staging_config(current_state, desired_input)
                    .await
            }
            "origin_access_control_config" => {
                self.plan_origin_access_control_config(current_state, desired_input)
                    .await
            }
            "key_group_config" => {
                self.plan_key_group_config(current_state, desired_input)
                    .await
            }
            "field_level_encryption_config" => {
                self.plan_field_level_encryption_config(current_state, desired_input)
                    .await
            }
            "anycast_ip_list" => {
                self.plan_anycast_ip_list(current_state, desired_input)
                    .await
            }
            "invalidation_for_distribution_tenant" => {
                self.plan_invalidation_for_distribution_tenant(current_state, desired_input)
                    .await
            }
            "realtime_log_config" => {
                self.plan_realtime_log_config(current_state, desired_input)
                    .await
            }
            "response_headers_policy" => {
                self.plan_response_headers_policy(current_state, desired_input)
                    .await
            }
            "continuous_deployment_policy_config" => {
                self.plan_continuous_deployment_policy_config(current_state, desired_input)
                    .await
            }
            "continuous_deployment_policy" => {
                self.plan_continuous_deployment_policy(current_state, desired_input)
                    .await
            }
            "cloud_front_origin_access_identity_config" => {
                self.plan_cloud_front_origin_access_identity_config(current_state, desired_input)
                    .await
            }
            "public_key" => self.plan_public_key(current_state, desired_input).await,
            "origin_request_policy" => {
                self.plan_origin_request_policy(current_state, desired_input)
                    .await
            }
            "function" => self.plan_function(current_state, desired_input).await,
            "field_level_encryption" => {
                self.plan_field_level_encryption(current_state, desired_input)
                    .await
            }
            "origin_access_control" => {
                self.plan_origin_access_control(current_state, desired_input)
                    .await
            }
            "managed_certificate_details" => {
                self.plan_managed_certificate_details(current_state, desired_input)
                    .await
            }
            "distribution_tenant_by_domain" => {
                self.plan_distribution_tenant_by_domain(current_state, desired_input)
                    .await
            }
            "distribution" => self.plan_distribution(current_state, desired_input).await,
            "streaming_distribution_config" => {
                self.plan_streaming_distribution_config(current_state, desired_input)
                    .await
            }
            "distribution_config" => {
                self.plan_distribution_config(current_state, desired_input)
                    .await
            }
            "key_group" => self.plan_key_group(current_state, desired_input).await,
            "domain_association" => {
                self.plan_domain_association(current_state, desired_input)
                    .await
            }
            "cloud_front_origin_access_identity" => {
                self.plan_cloud_front_origin_access_identity(current_state, desired_input)
                    .await
            }
            "distribution_tenant" => {
                self.plan_distribution_tenant(current_state, desired_input)
                    .await
            }
            "connection_group" => {
                self.plan_connection_group(current_state, desired_input)
                    .await
            }
            "streaming_distribution_with_tags" => {
                self.plan_streaming_distribution_with_tags(current_state, desired_input)
                    .await
            }
            "vpc_origin" => self.plan_vpc_origin(current_state, desired_input).await,
            "cache_policy" => self.plan_cache_policy(current_state, desired_input).await,
            "public_key_config" => {
                self.plan_public_key_config(current_state, desired_input)
                    .await
            }
            "monitoring_subscription" => {
                self.plan_monitoring_subscription(current_state, desired_input)
                    .await
            }
            "key_value_store" => {
            ...
            "streaming_distribution" => {
                self.plan_streaming_distribution(current_state, desired_input)
                    .await
            }
            "field_level_encryption_profile" => {
                self.plan_field_level_encryption_profile(current_state, desired_input)
                    .await
            }
            "invalidation" => self.plan_invalidation(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudfront", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "connection_group_by_routing_endpoint" => {
                self.create_connection_group_by_routing_endpoint(input)
                    .await
            }
            "cache_policy_config" => self.create_cache_policy_config(input).await,
            "response_headers_policy_config" => {
                self.create_response_headers_policy_config(input).await
            }
            "distribution_with_tags" => self.create_distribution_with_tags(input).await,
            "field_level_encryption_profile_config" => {
                self.create_field_level_encryption_profile_config(input)
                    .await
            }
            "origin_request_policy_config" => self.create_origin_request_policy_config(input).await,
            "distribution_with_staging_config" => {
                self.create_distribution_with_staging_config(input).await
            }
            "origin_access_control_config" => self.create_origin_access_control_config(input).await,
            "key_group_config" => self.create_key_group_config(input).await,
            "field_level_encryption_config" => {
                self.create_field_level_encryption_config(input).await
            }
            "anycast_ip_list" => self.create_anycast_ip_list(input).await,
            "invalidation_for_distribution_tenant" => {
                self.create_invalidation_for_distribution_tenant(input)
                    .await
            }
            "realtime_log_config" => self.create_realtime_log_config(input).await,
            "response_headers_policy" => self.create_response_headers_policy(input).await,
            "continuous_deployment_policy_config" => {
                self.create_continuous_deployment_policy_config(input).await
            }
            "continuous_deployment_policy" => self.create_continuous_deployment_policy(input).await,
            "cloud_front_origin_access_identity_config" => {
                self.create_cloud_front_origin_access_identity_config(input)
                    .await
            }
            "public_key" => self.create_public_key(input).await,
            "origin_request_policy" => self.create_origin_request_policy(input).await,
            "function" => self.create_function(input).await,
            "field_level_encryption" => self.create_field_level_encryption(input).await,
            "origin_access_control" => self.create_origin_access_control(input).await,
            "managed_certificate_details" => self.create_managed_certificate_details(input).await,
            "distribution_tenant_by_domain" => {
            ...
            "distribution_config" => self.create_distribution_config(input).await,
            "key_group" => self.create_key_group(input).await,
            "domain_association" => self.create_domain_association(input).await,
            "cloud_front_origin_access_identity" => {
                self.create_cloud_front_origin_access_identity(input).await
            }
            "distribution_tenant" => self.create_distribution_tenant(input).await,
            "connection_group" => self.create_connection_group(input).await,
            "streaming_distribution_with_tags" => {
                self.create_streaming_distribution_with_tags(input).await
            }
            "vpc_origin" => self.create_vpc_origin(input).await,
            "cache_policy" => self.create_cache_policy(input).await,
            "public_key_config" => self.create_public_key_config(input).await,
            "monitoring_subscription" => self.create_monitoring_subscription(input).await,
            "key_value_store" => self.create_key_value_store(input).await,
            "streaming_distribution" => self.create_streaming_distribution(input).await,
            "field_level_encryption_profile" => {
                self.create_field_level_encryption_profile(input).await
            }
            "invalidation" => self.create_invalidation(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudfront", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "cache_policy_config" => self.read_cache_policy_config(id).await,
            "response_headers_policy_config" => self.read_response_headers_policy_config(id).await,
            "distribution_with_tags" => self.read_distribution_with_tags(id).await,
            "field_level_encryption_profile_config" => {
                self.read_field_level_encryption_profile_config(id).await
            }
            "origin_request_policy_config" => self.read_origin_request_policy_config(id).await,
            "distribution_with_staging_config" => {
                self.read_distribution_with_staging_config(id).await
            }
            "origin_access_control_config" => self.read_origin_access_control_config(id).await,
            "key_group_config" => self.read_key_group_config(id).await,
            "field_level_encryption_config" => self.read_field_level_encryption_config(id).await,
            "anycast_ip_list" => self.read_anycast_ip_list(id).await,
            "invalidation_for_distribution_tenant" => {
                self.read_invalidation_for_distribution_tenant(id).await
            }
            "realtime_log_config" => self.read_realtime_log_config(id).await,
            "response_headers_policy" => self.read_response_headers_policy(id).await,
            "continuous_deployment_policy_config" => {
                self.read_continuous_deployment_policy_config(id).await
            }
            "continuous_deployment_policy" => self.read_continuous_deployment_policy(id).await,
            "cloud_front_origin_access_identity_config" => {
                self.read_cloud_front_origin_access_identity_config(id)
                    .await
            }
            "public_key" => self.read_public_key(id).await,
            "origin_request_policy" => self.read_origin_request_policy(id).await,
            "function" => self.read_function(id).await,
            "field_level_encryption" => self.read_field_level_encryption(id).await,
            "origin_access_control" => self.read_origin_access_control(id).await,
            "managed_certificate_details" => self.read_managed_certificate_details(id).await,
            "distribution_tenant_by_domain" => self.read_distribution_tenant_by_domain(id).await,
            "distribution" => self.read_distribution(id).await,
            "streaming_distribution_config" => self.read_streaming_distribution_config(id).await,
            "distribution_config" => self.read_distribution_config(id).await,
            "key_group" => self.read_key_group(id).await,
            "domain_association" => self.read_domain_association(id).await,
            "cloud_front_origin_access_identity" => {
                self.read_cloud_front_origin_access_identity(id).await
            }
            "distribution_tenant" => self.read_distribution_tenant(id).await,
            "connection_group" => self.read_connection_group(id).await,
            "streaming_distribution_with_tags" => {
                self.read_streaming_distribution_with_tags(id).await
            }
            "vpc_origin" => self.read_vpc_origin(id).await,
            "cache_policy" => self.read_cache_policy(id).await,
            "public_key_config" => self.read_public_key_config(id).await,
            "monitoring_subscription" => self.read_monitoring_subscription(id).await,
            "key_value_store" => self.read_key_value_store(id).await,
            "streaming_distribution" => self.read_streaming_distribution(id).await,
            "field_level_encryption_profile" => self.read_field_level_encryption_profile(id).await,
            "invalidation" => self.read_invalidation(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudfront", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "connection_group_by_routing_endpoint" => {
                self.update_connection_group_by_routing_endpoint(id, input)
                    .await
            }
            "cache_policy_config" => self.update_cache_policy_config(id, input).await,
            "response_headers_policy_config" => {
                self.update_response_headers_policy_config(id, input).await
            }
            "distribution_with_tags" => self.update_distribution_with_tags(id, input).await,
            "field_level_encryption_profile_config" => {
                self.update_field_level_encryption_profile_config(id, input)
                    .await
            }
            "origin_request_policy_config" => {
            ...
            "distribution_with_staging_config" => {
                self.update_distribution_with_staging_config(id, input)
                    .await
            }
            "origin_access_control_config" => {
                self.update_origin_access_control_config(id, input).await
            }
            "key_group_config" => self.update_key_group_config(id, input).await,
            "field_level_encryption_config" => {
                self.update_field_level_encryption_config(id, input).await
            }
            "anycast_ip_list" => self.update_anycast_ip_list(id, input).await,
            "invalidation_for_distribution_tenant" => {
                self.update_invalidation_for_distribution_tenant(id, input)
                    .await
            }
            "realtime_log_config" => self.update_realtime_log_config(id, input).await,
            "response_headers_policy" => self.update_response_headers_policy(id, input).await,
            "continuous_deployment_policy_config" => {
                self.update_continuous_deployment_policy_config(id, input)
                    .await
            }
            "continuous_deployment_policy" => {
            ...
            "cloud_front_origin_access_identity_config" => {
                self.update_cloud_front_origin_access_identity_config(id, input)
                    .await
            }
            "public_key" => self.update_public_key(id, input).await,
            "origin_request_policy" => self.update_origin_request_policy(id, input).await,
            "function" => self.update_function(id, input).await,
            "field_level_encryption" => self.update_field_level_encryption(id, input).await,
            "origin_access_control" => self.update_origin_access_control(id, input).await,
            "managed_certificate_details" => {
            ...
            "distribution_config" => self.update_distribution_config(id, input).await,
            "key_group" => self.update_key_group(id, input).await,
            "domain_association" => self.update_domain_association(id, input).await,
            "cloud_front_origin_access_identity" => {
                self.update_cloud_front_origin_access_identity(id, input)
                    .await
            }
            "distribution_tenant" => self.update_distribution_tenant(id, input).await,
            "connection_group" => self.update_connection_group(id, input).await,
            "streaming_distribution_with_tags" => {
                self.update_streaming_distribution_with_tags(id, input)
                    .await
            }
            "vpc_origin" => self.update_vpc_origin(id, input).await,
            "cache_policy" => self.update_cache_policy(id, input).await,
            "public_key_config" => self.update_public_key_config(id, input).await,
            "monitoring_subscription" => self.update_monitoring_subscription(id, input).await,
            "key_value_store" => self.update_key_value_store(id, input).await,
            "streaming_distribution" => self.update_streaming_distribution(id, input).await,
            "field_level_encryption_profile" => {
                self.update_field_level_encryption_profile(id, input).await
            }
            "invalidation" => self.update_invalidation(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudfront", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "cache_policy_config" => self.delete_cache_policy_config(id).await,
            "response_headers_policy_config" => {
                self.delete_response_headers_policy_config(id).await
            }
            "distribution_with_tags" => self.delete_distribution_with_tags(id).await,
            "field_level_encryption_profile_config" => {
                self.delete_field_level_encryption_profile_config(id).await
            }
            "origin_request_policy_config" => self.delete_origin_request_policy_config(id).await,
            "distribution_with_staging_config" => {
                self.delete_distribution_with_staging_config(id).await
            }
            "origin_access_control_config" => self.delete_origin_access_control_config(id).await,
            "key_group_config" => self.delete_key_group_config(id).await,
            "field_level_encryption_config" => self.delete_field_level_encryption_config(id).await,
            "anycast_ip_list" => self.delete_anycast_ip_list(id).await,
            "invalidation_for_distribution_tenant" => {
                self.delete_invalidation_for_distribution_tenant(id).await
            }
            "realtime_log_config" => self.delete_realtime_log_config(id).await,
            "response_headers_policy" => self.delete_response_headers_policy(id).await,
            "continuous_deployment_policy_config" => {
                self.delete_continuous_deployment_policy_config(id).await
            }
            "continuous_deployment_policy" => self.delete_continuous_deployment_policy(id).await,
            "cloud_front_origin_access_identity_config" => {
                self.delete_cloud_front_origin_access_identity_config(id)
                    .await
            }
            "public_key" => self.delete_public_key(id).await,
            "origin_request_policy" => self.delete_origin_request_policy(id).await,
            "function" => self.delete_function(id).await,
            "field_level_encryption" => self.delete_field_level_encryption(id).await,
            "origin_access_control" => self.delete_origin_access_control(id).await,
            "managed_certificate_details" => self.delete_managed_certificate_details(id).await,
            "distribution_tenant_by_domain" => self.delete_distribution_tenant_by_domain(id).await,
            "distribution" => self.delete_distribution(id).await,
            "streaming_distribution_config" => self.delete_streaming_distribution_config(id).await,
            "distribution_config" => self.delete_distribution_config(id).await,
            "key_group" => self.delete_key_group(id).await,
            "domain_association" => self.delete_domain_association(id).await,
            "cloud_front_origin_access_identity" => {
                self.delete_cloud_front_origin_access_identity(id).await
            }
            "distribution_tenant" => self.delete_distribution_tenant(id).await,
            "connection_group" => self.delete_connection_group(id).await,
            "streaming_distribution_with_tags" => {
                self.delete_streaming_distribution_with_tags(id).await
            }
            "vpc_origin" => self.delete_vpc_origin(id).await,
            "cache_policy" => self.delete_cache_policy(id).await,
            "public_key_config" => self.delete_public_key_config(id).await,
            "monitoring_subscription" => self.delete_monitoring_subscription(id).await,
            "key_value_store" => self.delete_key_value_store(id).await,
            "streaming_distribution" => self.delete_streaming_distribution(id).await,
            "field_level_encryption_profile" => {
                self.delete_field_level_encryption_profile(id).await
            }
            "invalidation" => self.delete_invalidation(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudfront", resource_name
            ))),
    ...
    async fn read_connection_group_by_routing_endpoint(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_connection_group_by_routing_endpoint(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_cache_policy_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cache_policy_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_cache_policy_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn read_response_headers_policy_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_response_headers_policy_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_distribution_with_tags(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let distribution_config_with_tags =
                input.get_string("distribution_config_with_tags")?;
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                ...
                distribution_config_with_tags.unwrap_or_default(),
            ))
        })
    }

    /// Read a distribution_with_tags resource
    async fn read_distribution_with_tags(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_distribution_with_tags(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn read_field_level_encryption_profile_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_field_level_encryption_profile_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn read_origin_request_policy_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_origin_request_policy_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    staging_distribution_id.unwrap_or_default(),
                ))
        })
    }

    /// Read a distribution_with_staging_config resource
    async fn read_distribution_with_staging_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_distribution_with_staging_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn read_origin_access_control_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_origin_access_control_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_key_group_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_key_group_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_key_group_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_field_level_encryption_config(
        ...
        self.provider.runtime().block_on(async {
            ...
            let field_level_encryption_config =
                input.get_string("field_level_encryption_config")?;
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "field_level_encryption_config",
                field_level_encryption_config.unwrap_or_default(),
            ))
        })
    }

    /// Read a field_level_encryption_config resource
    async fn read_field_level_encryption_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_field_level_encryption_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_anycast_ip_list(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_anycast_ip_list(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_anycast_ip_list(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn read_invalidation_for_distribution_tenant(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_invalidation_for_distribution_tenant(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_realtime_log_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_realtime_log_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_realtime_log_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_response_headers_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let response_headers_policy_config =
                input.get_string("response_headers_policy_config")?;
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "response_headers_policy_config",
                response_headers_policy_config.unwrap_or_default(),
            ))
        })
    }

    /// Read a response_headers_policy resource
    async fn read_response_headers_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_response_headers_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn read_continuous_deployment_policy_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_continuous_deployment_policy_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_continuous_deployment_policy(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let continuous_deployment_policy_config =
                input.get_string("continuous_deployment_policy_config")?;
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "continuous_deployment_policy_config",
                continuous_deployment_policy_config.unwrap_or_default(),
            ))
        })
    }

    /// Read a continuous_deployment_policy resource
    async fn read_continuous_deployment_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_continuous_deployment_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn delete_cloud_front_origin_access_identity_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_origin_request_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "origin_request_policy_config",
                origin_request_policy_config.unwrap_or_default(),
            ))
        })
    }

    /// Read a origin_request_policy resource
    async fn read_origin_request_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_origin_request_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_function(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_function(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn update_function(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let function_code = input.get_string("function_code")?;
            let function_config = input.get_string("function_config")?;
    ...
    async fn create_field_level_encryption(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_field_level_encryption(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_field_level_encryption(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_origin_access_control(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "origin_access_control_config",
                origin_access_control_config.unwrap_or_default(),
            ))
        })
    }

    /// Read a origin_access_control resource
    async fn read_origin_access_control(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_origin_access_control(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn read_managed_certificate_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_managed_certificate_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn read_distribution_tenant_by_domain(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_distribution_tenant_by_domain(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_distribution(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "distribution_config",
                distribution_config.unwrap_or_default(),
            ))
        })
    }
    ...
    async fn read_streaming_distribution_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_streaming_distribution_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_distribution_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_distribution_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_distribution_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_key_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_key_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn update_key_group(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let key_group_config = input.get_string("key_group_config")?;
    ...
    async fn delete_key_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_cloud_front_origin_access_identity(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let cloud_front_origin_access_identity_config =
                input.get_string("cloud_front_origin_access_identity_config")?;
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "cloud_front_origin_access_identity_config",
                cloud_front_origin_access_identity_config.unwrap_or_default(),
            ))
        })
    }

    /// Read a cloud_front_origin_access_identity resource
    async fn read_cloud_front_origin_access_identity(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_cloud_front_origin_access_identity(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_distribution_tenant(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let enabled = input.get_optional_string("enabled")?;
            let name = input.get_string("name")?;
            let managed_certificate_request =
                input.get_optional_string("managed_certificate_request")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    managed_certificate_request.unwrap_or_default(),
                )
                ...
                .with_field(
                    "connection_group_id",
                    connection_group_id.unwrap_or_default(),
                ))
        })
    }

    /// Read a distribution_tenant resource
    async fn read_distribution_tenant(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_distribution_tenant(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_connection_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_connection_group(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_connection_group(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_streaming_distribution_with_tags(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let streaming_distribution_config_with_tags =
                input.get_string("streaming_distribution_config_with_tags")?;
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                ...
                streaming_distribution_config_with_tags.unwrap_or_default(),
            ))
        })
    }

    /// Read a streaming_distribution_with_tags resource
    async fn read_streaming_distribution_with_tags(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_streaming_distribution_with_tags(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_vpc_origin(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    vpc_origin_endpoint_config.unwrap_or_default(),
                ))
        })
    }

    /// Read a vpc_origin resource
    async fn read_vpc_origin(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn update_vpc_origin(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let vpc_origin_endpoint_config = input.get_string("vpc_origin_endpoint_config")?;
    ...
    async fn delete_vpc_origin(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_cache_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "cache_policy_config",
                cache_policy_config.unwrap_or_default(),
            ))
        })
    }

    /// Read a cache_policy resource
    async fn read_cache_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn update_cache_policy(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let cache_policy_config = input.get_string("cache_policy_config")?;
    ...
    async fn delete_cache_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_public_key_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_public_key_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_public_key_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_monitoring_subscription(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let distribution_id = input.get_string("distribution_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "monitoring_subscription",
                    monitoring_subscription.unwrap_or_default(),
                ))
        })
    }

    /// Read a monitoring_subscription resource
    async fn read_monitoring_subscription(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_monitoring_subscription(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_streaming_distribution(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let streaming_distribution_config =
                input.get_string("streaming_distribution_config")?;
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "streaming_distribution_config",
                streaming_distribution_config.unwrap_or_default(),
            ))
        })
    }

    /// Read a streaming_distribution resource
    async fn read_streaming_distribution(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_streaming_distribution(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_field_level_encryption_profile(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let field_level_encryption_profile_config =
                input.get_string("field_level_encryption_profile_config")?;
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                "field_level_encryption_profile_config",
                field_level_encryption_profile_config.unwrap_or_default(),
            ))
        })
    }

    /// Read a field_level_encryption_profile resource
    async fn read_field_level_encryption_profile(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn delete_field_level_encryption_profile(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
    ...
    async fn create_invalidation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let distribution_id = input.get_string("distribution_id")?;
    ...
    async fn read_invalidation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudfront_client
    ...
    async fn update_invalidation(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let distribution_id = input.get_string("distribution_id")?;
            let invalidation_batch = input.get_string("invalidation_batch")?;
    ...
    async fn delete_invalidation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudfront_client
