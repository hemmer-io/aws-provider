...
impl<'a> WorkmailService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "email_monitoring_configuration" => {
                self.plan_email_monitoring_configuration(current_state, desired_input).await
            }
            "availability_configuration" => {
                self.plan_availability_configuration(current_state, desired_input).await
            }
            "default_mail_domain" => {
                self.plan_default_mail_domain(current_state, desired_input).await
            }
            "inbound_dmarc_settings" => {
                self.plan_inbound_dmarc_settings(current_state, desired_input).await
            }
            "personal_access_token" => {
                self.plan_personal_access_token(current_state, desired_input).await
            }
            "identity_center_application" => {
                self.plan_identity_center_application(current_state, desired_input).await
            }
            "retention_policy" => {
                self.plan_retention_policy(current_state, desired_input).await
            }
            "mailbox_export_job" => {
                self.plan_mailbox_export_job(current_state, desired_input).await
            }
            "default_retention_policy" => {
                self.plan_default_retention_policy(current_state, desired_input).await
            }
            "mobile_device_access_effect" => {
                self.plan_mobile_device_access_effect(current_state, desired_input).await
            }
            "alias" => {
            ...
            "mailbox_details" => {
                self.plan_mailbox_details(current_state, desired_input).await
            }
            "mobile_device_access_rule" => {
                self.plan_mobile_device_access_rule(current_state, desired_input).await
            }
            "personal_access_token_metadata" => {
                self.plan_personal_access_token_metadata(current_state, desired_input).await
            }
            "access_control_rule" => {
                self.plan_access_control_rule(current_state, desired_input).await
            }
            "mailbox_quota" => {
                self.plan_mailbox_quota(current_state, desired_input).await
            }
            "user" => {
                self.plan_user(current_state, desired_input).await
            }
            "mobile_device_access_override" => {
                self.plan_mobile_device_access_override(current_state, desired_input).await
            }
            "access_control_effect" => {
                self.plan_access_control_effect(current_state, desired_input).await
            }
            "group" => {
            ...
            "mail_domain" => {
                self.plan_mail_domain(current_state, desired_input).await
            }
            "impersonation_role" => {
                self.plan_impersonation_role(current_state, desired_input).await
            }
            "primary_email_address" => {
                self.plan_primary_email_address(current_state, desired_input).await
            }
            "impersonation_role_effect" => {
                self.plan_impersonation_role_effect(current_state, desired_input).await
            }
            "identity_provider_configuration" => {
                self.plan_identity_provider_configuration(current_state, desired_input).await
            }
            "mailbox_permissions" => {
                self.plan_mailbox_permissions(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "availability_configuration" => {
                self.create_availability_configuration(input).await
            }
            "default_mail_domain" => {
                self.create_default_mail_domain(input).await
            }
            "inbound_dmarc_settings" => {
                self.create_inbound_dmarc_settings(input).await
            }
            "personal_access_token" => {
                self.create_personal_access_token(input).await
            }
            "identity_center_application" => {
                self.create_identity_center_application(input).await
            }
            "retention_policy" => {
                self.create_retention_policy(input).await
            }
            "mailbox_export_job" => {
                self.create_mailbox_export_job(input).await
            }
            "default_retention_policy" => {
                self.create_default_retention_policy(input).await
            }
            "mobile_device_access_effect" => {
                self.create_mobile_device_access_effect(input).await
            }
            "alias" => {
            ...
            "mailbox_details" => {
                self.create_mailbox_details(input).await
            }
            "mobile_device_access_rule" => {
                self.create_mobile_device_access_rule(input).await
            }
            "personal_access_token_metadata" => {
                self.create_personal_access_token_metadata(input).await
            }
            "access_control_rule" => {
                self.create_access_control_rule(input).await
            }
            "mailbox_quota" => {
                self.create_mailbox_quota(input).await
            }
            "user" => {
            ...
            "access_control_effect" => {
                self.create_access_control_effect(input).await
            }
            "group" => {
            ...
            "mail_domain" => {
                self.create_mail_domain(input).await
            }
            "impersonation_role" => {
                self.create_impersonation_role(input).await
            }
            "primary_email_address" => {
                self.create_primary_email_address(input).await
            }
            "impersonation_role_effect" => {
                self.create_impersonation_role_effect(input).await
            }
            "identity_provider_configuration" => {
                self.create_identity_provider_configuration(input).await
            }
            "mailbox_permissions" => {
                self.create_mailbox_permissions(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workmail",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "email_monitoring_configuration" => {
                self.read_email_monitoring_configuration(id).await
            }
            "availability_configuration" => {
                self.read_availability_configuration(id).await
            }
            "default_mail_domain" => {
                self.read_default_mail_domain(id).await
            }
            "inbound_dmarc_settings" => {
                self.read_inbound_dmarc_settings(id).await
            }
            "personal_access_token" => {
                self.read_personal_access_token(id).await
            }
            "identity_center_application" => {
                self.read_identity_center_application(id).await
            }
            "retention_policy" => {
                self.read_retention_policy(id).await
            }
            "mailbox_export_job" => {
                self.read_mailbox_export_job(id).await
            }
            "default_retention_policy" => {
                self.read_default_retention_policy(id).await
            }
            "mobile_device_access_effect" => {
                self.read_mobile_device_access_effect(id).await
            }
            "alias" => {
            ...
            "mailbox_details" => {
                self.read_mailbox_details(id).await
            }
            "mobile_device_access_rule" => {
                self.read_mobile_device_access_rule(id).await
            }
            "personal_access_token_metadata" => {
                self.read_personal_access_token_metadata(id).await
            }
            "access_control_rule" => {
                self.read_access_control_rule(id).await
            }
            "mailbox_quota" => {
                self.read_mailbox_quota(id).await
            }
            "user" => {
                self.read_user(id).await
            }
            "mobile_device_access_override" => {
                self.read_mobile_device_access_override(id).await
            }
            "access_control_effect" => {
                self.read_access_control_effect(id).await
            }
            "group" => {
            ...
            "mail_domain" => {
                self.read_mail_domain(id).await
            }
            "impersonation_role" => {
                self.read_impersonation_role(id).await
            }
            "primary_email_address" => {
                self.read_primary_email_address(id).await
            }
            "impersonation_role_effect" => {
                self.read_impersonation_role_effect(id).await
            }
            "identity_provider_configuration" => {
                self.read_identity_provider_configuration(id).await
            }
            "mailbox_permissions" => {
                self.read_mailbox_permissions(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workmail",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "availability_configuration" => {
                self.update_availability_configuration(id, input).await
            }
            "default_mail_domain" => {
                self.update_default_mail_domain(id, input).await
            }
            "inbound_dmarc_settings" => {
                self.update_inbound_dmarc_settings(id, input).await
            }
            "personal_access_token" => {
                self.update_personal_access_token(id, input).await
            }
            "identity_center_application" => {
            ...
            "mailbox_export_job" => {
                self.update_mailbox_export_job(id, input).await
            }
            "default_retention_policy" => {
                self.update_default_retention_policy(id, input).await
            }
            "mobile_device_access_effect" => {
            ...
            "mailbox_details" => {
                self.update_mailbox_details(id, input).await
            }
            "mobile_device_access_rule" => {
                self.update_mobile_device_access_rule(id, input).await
            }
            "personal_access_token_metadata" => {
                self.update_personal_access_token_metadata(id, input).await
            }
            "access_control_rule" => {
                self.update_access_control_rule(id, input).await
            }
            "mailbox_quota" => {
                self.update_mailbox_quota(id, input).await
            }
            "user" => {
            ...
            "access_control_effect" => {
                self.update_access_control_effect(id, input).await
            }
            "group" => {
            ...
            "mail_domain" => {
                self.update_mail_domain(id, input).await
            }
            "impersonation_role" => {
                self.update_impersonation_role(id, input).await
            }
            "primary_email_address" => {
                self.update_primary_email_address(id, input).await
            }
            "impersonation_role_effect" => {
                self.update_impersonation_role_effect(id, input).await
            }
            "identity_provider_configuration" => {
                self.update_identity_provider_configuration(id, input).await
            }
            "mailbox_permissions" => {
                self.update_mailbox_permissions(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workmail",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "availability_configuration" => {
                self.delete_availability_configuration(id).await
            }
            "default_mail_domain" => {
                self.delete_default_mail_domain(id).await
            }
            "inbound_dmarc_settings" => {
                self.delete_inbound_dmarc_settings(id).await
            }
            "personal_access_token" => {
                self.delete_personal_access_token(id).await
            }
            "identity_center_application" => {
                self.delete_identity_center_application(id).await
            }
            "retention_policy" => {
                self.delete_retention_policy(id).await
            }
            "mailbox_export_job" => {
                self.delete_mailbox_export_job(id).await
            }
            "default_retention_policy" => {
                self.delete_default_retention_policy(id).await
            }
            "mobile_device_access_effect" => {
                self.delete_mobile_device_access_effect(id).await
            }
            "alias" => {
            ...
            "mailbox_details" => {
                self.delete_mailbox_details(id).await
            }
            "mobile_device_access_rule" => {
                self.delete_mobile_device_access_rule(id).await
            }
            "personal_access_token_metadata" => {
                self.delete_personal_access_token_metadata(id).await
            }
            "access_control_rule" => {
                self.delete_access_control_rule(id).await
            }
            "mailbox_quota" => {
                self.delete_mailbox_quota(id).await
            }
            "user" => {
                self.delete_user(id).await
            }
            "mobile_device_access_override" => {
                self.delete_mobile_device_access_override(id).await
            }
            "access_control_effect" => {
                self.delete_access_control_effect(id).await
            }
            "group" => {
            ...
            "mail_domain" => {
                self.delete_mail_domain(id).await
            }
            "impersonation_role" => {
                self.delete_impersonation_role(id).await
            }
            "primary_email_address" => {
                self.delete_primary_email_address(id).await
            }
            "impersonation_role_effect" => {
                self.delete_impersonation_role_effect(id).await
            }
            "identity_provider_configuration" => {
                self.delete_identity_provider_configuration(id).await
            }
            "mailbox_permissions" => {
                self.delete_mailbox_permissions(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workmail",
    ...
    async fn create_organization(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("enable_interoperability", enable_interoperability.unwrap_or_default())
    ...
    async fn read_email_monitoring_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_email_monitoring_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_availability_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_availability_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_default_mail_domain(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_default_mail_domain(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_default_mail_domain(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_inbound_dmarc_settings(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_inbound_dmarc_settings(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_inbound_dmarc_settings(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_personal_access_token(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_identity_center_application(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_identity_center_application(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_retention_policy(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("folder_configurations", folder_configurations.unwrap_or_default())
    ...
    async fn create_mailbox_export_job(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_mailbox_export_job(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_mailbox_export_job(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_default_retention_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_default_retention_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_mobile_device_access_effect(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_mobile_device_access_effect(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_mailbox_details(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_mailbox_details(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_mobile_device_access_rule(
        ...
        self.provider.runtime().block_on(async {
            ...
            let not_device_operating_systems = input.get_optional_string("not_device_operating_systems")?;
            let organization_id = input.get_string("organization_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("device_operating_systems", device_operating_systems.unwrap_or_default())
                .with_field("description", description.unwrap_or_default())
                .with_field("device_user_agents", device_user_agents.unwrap_or_default())
                .with_field("not_device_user_agents", not_device_user_agents.unwrap_or_default())
                .with_field("client_token", client_token.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                ...
                .with_field("not_device_operating_systems", not_device_operating_systems.unwrap_or_default())
                .with_field("organization_id", organization_id.unwrap_or_default())
            )
        })
    }
    ...
    async fn read_mobile_device_access_rule(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_personal_access_token_metadata(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_personal_access_token_metadata(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_access_control_rule(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            let not_impersonation_role_ids = input.get_optional_string("not_impersonation_role_ids")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("description", description.unwrap_or_default())
                .with_field("impersonation_role_ids", impersonation_role_ids.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                .with_field("effect", effect.unwrap_or_default())
                ...
                .with_field("not_impersonation_role_ids", not_impersonation_role_ids.unwrap_or_default())
            )
        })
    }

    /// Read a access_control_rule resource
    async fn read_access_control_rule(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_user(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let identity_provider_user_id = input.get_optional_string("identity_provider_user_id")?;
            ...
            let hidden_from_global_address_list = input.get_optional_string("hidden_from_global_address_list")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("identity_provider_user_id", identity_provider_user_id.unwrap_or_default())
                ...
                .with_field("hidden_from_global_address_list", hidden_from_global_address_list.unwrap_or_default())
    ...
    async fn read_mobile_device_access_override(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_mobile_device_access_override(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_access_control_effect(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_access_control_effect(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_access_control_effect(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_impersonation_role(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_impersonation_role(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_impersonation_role(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_primary_email_address(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_primary_email_address(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_primary_email_address(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_impersonation_role_effect(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_impersonation_role_effect(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_identity_provider_configuration(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let personal_access_token_configuration = input.get_string("personal_access_token_configuration")?;
            let authentication_mode = input.get_string("authentication_mode")?;
            let organization_id = input.get_string("organization_id")?;
            let identity_center_configuration = input.get_string("identity_center_configuration")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("personal_access_token_configuration", personal_access_token_configuration.unwrap_or_default())
                .with_field("authentication_mode", authentication_mode.unwrap_or_default())
                .with_field("organization_id", organization_id.unwrap_or_default())
                .with_field("identity_center_configuration", identity_center_configuration.unwrap_or_default())
            )
        })
    }

    /// Read a identity_provider_configuration resource
    async fn read_identity_provider_configuration(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_identity_provider_configuration(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_mailbox_permissions(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_mailbox_permissions(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
