...
impl<'a> Availability_configuration<'a> {
    ...
    pub async fn create(&self, ews_provider: Option<String>, domain_name: String, organization_id: String, lambda_provider: Option<String>, client_token: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, ews_provider: Option<String>, domain_name: Option<String>, organization_id: Option<String>, lambda_provider: Option<String>, client_token: Option<String>) -> Result<()> {
