...
impl<'a> Identity_provider_configuration<'a> {
    ...
    pub async fn create(&self, personal_access_token_configuration: String, organization_id: String, authentication_mode: String, identity_center_configuration: String) -> Result<String> {
