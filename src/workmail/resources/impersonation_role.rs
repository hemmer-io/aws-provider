...
impl<'a> Impersonation_role<'a> {
    ...
    pub async fn create(&self, description: Option<String>, name: String, organization_id: String, type: String, client_token: Option<String>, rules: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, name: Option<String>, organization_id: Option<String>, type: Option<String>, client_token: Option<String>, rules: Option<Vec<String>>) -> Result<()> {
