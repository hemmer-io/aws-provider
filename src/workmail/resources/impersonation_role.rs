...
impl<'a> Impersonation_role<'a> {
    ...
    pub async fn create(&self, name: String, type: String, client_token: Option<String>, description: Option<String>, organization_id: String, rules: Vec<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, type: Option<String>, client_token: Option<String>, description: Option<String>, organization_id: Option<String>, rules: Option<Vec<String>>) -> Result<()> {
