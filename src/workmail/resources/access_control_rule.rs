...
impl<'a> Access_control_rule<'a> {
    ...
    pub async fn create(&self, not_impersonation_role_ids: Option<Vec<String>>, effect: String, not_ip_ranges: Option<Vec<String>>, description: String, not_user_ids: Option<Vec<String>>, impersonation_role_ids: Option<Vec<String>>, ip_ranges: Option<Vec<String>>, not_actions: Option<Vec<String>>, name: String, actions: Option<Vec<String>>, organization_id: String, user_ids: Option<Vec<String>>) -> Result<String> {
