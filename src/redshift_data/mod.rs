//! Redshift_data service for Aws provider
//!
//! This module handles all redshift_data resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Redshift_data service handler
pub struct Redshift_dataService<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Redshift_dataService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "statement_result" => {
                self.plan_statement_result(current_state, desired_input)
                    .await
            }
            "statement_result_v2" => {
                self.plan_statement_result_v2(current_state, desired_input)
                    .await
            }
            "table" => self.plan_table(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "redshift_data", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "statement_result" => self.create_statement_result(input).await,
            "statement_result_v2" => self.create_statement_result_v2(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "statement_result" => self.read_statement_result(id).await,
            "statement_result_v2" => self.read_statement_result_v2(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "statement_result" => self.update_statement_result(id, input).await,
            "statement_result_v2" => self.update_statement_result_v2(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "statement_result" => self.delete_statement_result(id).await,
            "statement_result_v2" => self.delete_statement_result_v2(id).await,
    ...
    async fn create_statement_result(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_statement_result(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.redshift_data_client
    ...
    async fn delete_statement_result(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.redshift_data_client
    ...
    async fn create_statement_result_v2(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_statement_result_v2(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.redshift_data_client
    ...
    async fn delete_statement_result_v2(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.redshift_data_client
