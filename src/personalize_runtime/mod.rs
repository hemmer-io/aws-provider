//! Personalize_runtime service for Aws provider
//!
//! This module handles all personalize_runtime resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Personalize_runtime service handler
pub struct Personalize_runtimeService<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Personalize_runtimeService<'a> {
    ...
    /// Plan changes to a personalized_ranking resource
    async fn plan_personalized_ranking(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Update a personalized_ranking resource
    async fn update_personalized_ranking(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn delete_personalized_ranking(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            ...
            // Example:
            // self.provider.personalize_runtime_client
            //     .delete_personalized_ranking()
            //     .set_id(id.to_string())
            //     .send()
            //     .await
    ...
    /// Plan changes to a action_recommendations resource
    async fn plan_action_recommendations(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    async fn read_action_recommendations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            ...
            // Example:
            // let result = self.provider.personalize_runtime_client
            //     .describe_action_recommendations()
            //     .set_id(id.to_string())
            //     .send()
            //     .await
            //     .map_err(|e| hemmer_core::HemmerError::Provider(format!("Failed to read resource: {}", e)))?;
    ...
    /// Update a action_recommendations resource
    async fn update_action_recommendations(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
