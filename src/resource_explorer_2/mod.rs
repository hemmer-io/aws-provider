...
impl<'a> Resource_explorer_2Service<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "managed_view" => self.plan_managed_view(current_state, desired_input).await,
            "account_level_service_configuration" => {
                self.plan_account_level_service_configuration(current_state, desired_input)
                    .await
            }
            "resource_explorer_setup" => {
                self.plan_resource_explorer_setup(current_state, desired_input)
                    .await
            }
            "service_index" => self.plan_service_index(current_state, desired_input).await,
            "default_view" => self.plan_default_view(current_state, desired_input).await,
            "service_view" => self.plan_service_view(current_state, desired_input).await,
            "index" => self.plan_index(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "resource_explorer_2", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "managed_view" => self.create_managed_view(input).await,
            "account_level_service_configuration" => {
                self.create_account_level_service_configuration(input).await
            }
            "resource_explorer_setup" => self.create_resource_explorer_setup(input).await,
            "service_index" => self.create_service_index(input).await,
            "default_view" => self.create_default_view(input).await,
            "service_view" => self.create_service_view(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "managed_view" => self.read_managed_view(id).await,
            "account_level_service_configuration" => {
                self.read_account_level_service_configuration(id).await
            }
            "resource_explorer_setup" => self.read_resource_explorer_setup(id).await,
            "service_index" => self.read_service_index(id).await,
            "default_view" => self.read_default_view(id).await,
            "service_view" => self.read_service_view(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "managed_view" => self.update_managed_view(id, input).await,
            "account_level_service_configuration" => {
                self.update_account_level_service_configuration(id, input)
                    .await
            }
            "resource_explorer_setup" => self.update_resource_explorer_setup(id, input).await,
            "service_index" => self.update_service_index(id, input).await,
            "default_view" => self.update_default_view(id, input).await,
            "service_view" => self.update_service_view(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "managed_view" => self.delete_managed_view(id).await,
            "account_level_service_configuration" => {
                self.delete_account_level_service_configuration(id).await
            }
            "resource_explorer_setup" => self.delete_resource_explorer_setup(id).await,
            "service_index" => self.delete_service_index(id).await,
            "default_view" => self.delete_default_view(id).await,
            "service_view" => self.delete_service_view(id).await,
    ...
    async fn create_managed_view(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_managed_view(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_managed_view(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_managed_view(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_account_level_service_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.resource_explorer_2_client
    ...
    async fn delete_account_level_service_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.resource_explorer_2_client
    ...
    async fn create_resource_explorer_setup(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_resource_explorer_setup(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.resource_explorer_2_client
    ...
    async fn delete_resource_explorer_setup(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.resource_explorer_2_client
    ...
    async fn create_service_index(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_service_index(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.resource_explorer_2_client
    ...
    async fn update_service_index(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_service_index(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.resource_explorer_2_client
    ...
    async fn create_default_view(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_default_view(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.resource_explorer_2_client
    ...
    async fn update_default_view(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_default_view(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.resource_explorer_2_client
    ...
    async fn create_service_view(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_service_view(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.resource_explorer_2_client
    ...
    async fn update_service_view(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_service_view(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.resource_explorer_2_client
