...
impl<'a> Test_grid_project<'a> {
    ...
    pub async fn create(&self, description: Option<String>, name: String, vpc_config: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, name: Option<String>, vpc_config: Option<String>) -> Result<()> {
