...
impl<'a> Instance_profile<'a> {
    ...
    pub async fn create(&self, name: String, package_cleanup: Option<bool>, reboot_after_use: Option<bool>, description: Option<String>, exclude_app_packages_from_cleanup: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, package_cleanup: Option<bool>, reboot_after_use: Option<bool>, description: Option<String>, exclude_app_packages_from_cleanup: Option<Vec<String>>) -> Result<()> {
