...
impl<'a> Persistent_app_ui<'a> {
    ...
    pub async fn create(&self, profiler_type: Option<String>, target_resource_arn: String, emr_containers_config: Option<String>, tags: Option<Vec<String>>, x_referer: Option<String>) -> Result<String> {
