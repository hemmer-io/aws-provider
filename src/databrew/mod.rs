...
impl<'a> DatabrewService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "recipe_version" => self.plan_recipe_version(current_state, desired_input).await,
            "job_run" => self.plan_job_run(current_state, desired_input).await,
            "profile_job" => self.plan_profile_job(current_state, desired_input).await,
            "ruleset" => self.plan_ruleset(current_state, desired_input).await,
            "recipe_job" => self.plan_recipe_job(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "recipe_version" => self.create_recipe_version(input).await,
            "job_run" => self.create_job_run(input).await,
            "profile_job" => self.create_profile_job(input).await,
            "ruleset" => self.create_ruleset(input).await,
            "recipe_job" => self.create_recipe_job(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "recipe_version" => self.read_recipe_version(id).await,
            "job_run" => self.read_job_run(id).await,
            "profile_job" => self.read_profile_job(id).await,
            "ruleset" => self.read_ruleset(id).await,
            "recipe_job" => self.read_recipe_job(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "recipe_version" => self.update_recipe_version(id, input).await,
            "job_run" => self.update_job_run(id, input).await,
            "profile_job" => self.update_profile_job(id, input).await,
            "ruleset" => self.update_ruleset(id, input).await,
            "recipe_job" => self.update_recipe_job(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "recipe_version" => self.delete_recipe_version(id).await,
            "job_run" => self.delete_job_run(id).await,
            "profile_job" => self.delete_profile_job(id).await,
            "ruleset" => self.delete_ruleset(id).await,
            "recipe_job" => self.delete_recipe_job(id).await,
    ...
    async fn create_recipe_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_recipe_version(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_recipe_version(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_profile_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let validation_configurations =
                input.get_optional_string("validation_configurations")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    validation_configurations.unwrap_or_default(),
                )
    ...
    async fn read_profile_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.databrew_client
    ...
    async fn update_profile_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let log_subscription = input.get_optional_string("log_subscription")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn delete_profile_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.databrew_client
    ...
    async fn create_recipe_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    data_catalog_outputs.unwrap_or_default(),
                )
                .with_field("log_subscription", log_subscription.unwrap_or_default()))
        })
    }
    ...
    async fn read_recipe_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.databrew_client
    ...
    async fn update_recipe_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let dataset_name = input.get_optional_string("dataset_name")?;
            let encryption_mode = input.get_optional_string("encryption_mode")?;
    ...
    async fn delete_recipe_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.databrew_client
