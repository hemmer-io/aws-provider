...
impl<'a> Service_quotasService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "auto_management" => {
                self.plan_auto_management(current_state, desired_input)
                    .await
            }
            "service_quota" => self.plan_service_quota(current_state, desired_input).await,
            "service_quota_increase_request_from_template" => {
                self.plan_service_quota_increase_request_from_template(current_state, desired_input)
                    .await
            }
            "auto_management_configuration" => {
                self.plan_auto_management_configuration(current_state, desired_input)
                    .await
            }
            "support_case" => self.plan_support_case(current_state, desired_input).await,
            "requested_service_quota_change" => {
                self.plan_requested_service_quota_change(current_state, desired_input)
                    .await
            }
            "service_quota_increase_request_into_template" => {
                self.plan_service_quota_increase_request_into_template(current_state, desired_input)
                    .await
            }
            "aws_default_service_quota" => {
                self.plan_aws_default_service_quota(current_state, desired_input)
                    .await
            }
            "association_for_service_quota_template" => {
                self.plan_association_for_service_quota_template(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "service_quotas", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "auto_management" => self.create_auto_management(input).await,
            "service_quota" => self.create_service_quota(input).await,
            "service_quota_increase_request_from_template" => {
                self.create_service_quota_increase_request_from_template(input)
                    .await
            }
            "auto_management_configuration" => {
                self.create_auto_management_configuration(input).await
            }
            "support_case" => self.create_support_case(input).await,
            "requested_service_quota_change" => {
                self.create_requested_service_quota_change(input).await
            }
            "service_quota_increase_request_into_template" => {
                self.create_service_quota_increase_request_into_template(input)
                    .await
            }
            "aws_default_service_quota" => self.create_aws_default_service_quota(input).await,
            "association_for_service_quota_template" => {
                self.create_association_for_service_quota_template(input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "auto_management" => self.read_auto_management(id).await,
            "service_quota" => self.read_service_quota(id).await,
            "service_quota_increase_request_from_template" => {
                self.read_service_quota_increase_request_from_template(id)
                    .await
            }
            "auto_management_configuration" => self.read_auto_management_configuration(id).await,
            "support_case" => self.read_support_case(id).await,
            "requested_service_quota_change" => self.read_requested_service_quota_change(id).await,
            "service_quota_increase_request_into_template" => {
                self.read_service_quota_increase_request_into_template(id)
                    .await
            }
            "aws_default_service_quota" => self.read_aws_default_service_quota(id).await,
            "association_for_service_quota_template" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "auto_management" => self.update_auto_management(id, input).await,
            "service_quota" => self.update_service_quota(id, input).await,
            "service_quota_increase_request_from_template" => {
                self.update_service_quota_increase_request_from_template(id, input)
                    .await
            }
            "auto_management_configuration" => {
                self.update_auto_management_configuration(id, input).await
            }
            "support_case" => self.update_support_case(id, input).await,
            "requested_service_quota_change" => {
                self.update_requested_service_quota_change(id, input).await
            }
            "service_quota_increase_request_into_template" => {
                self.update_service_quota_increase_request_into_template(id, input)
                    .await
            }
            "aws_default_service_quota" => self.update_aws_default_service_quota(id, input).await,
            "association_for_service_quota_template" => {
                self.update_association_for_service_quota_template(id, input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "auto_management" => self.delete_auto_management(id).await,
            "service_quota" => self.delete_service_quota(id).await,
            "service_quota_increase_request_from_template" => {
                self.delete_service_quota_increase_request_from_template(id)
                    .await
            }
            "auto_management_configuration" => self.delete_auto_management_configuration(id).await,
            "support_case" => self.delete_support_case(id).await,
            "requested_service_quota_change" => {
                self.delete_requested_service_quota_change(id).await
            }
            "service_quota_increase_request_into_template" => {
                self.delete_service_quota_increase_request_into_template(id)
                    .await
            }
            "aws_default_service_quota" => self.delete_aws_default_service_quota(id).await,
            "association_for_service_quota_template" => {
    ...
    async fn create_auto_management(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_auto_management(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_auto_management(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_service_quota(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_service_quota(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_quotas_client
    ...
    async fn update_service_quota(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_service_quota(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_quotas_client
    ...
    async fn delete_service_quota_increase_request_from_template(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_quotas_client
    ...
    async fn read_auto_management_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_quotas_client
    ...
    async fn delete_auto_management_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_quotas_client
    ...
    async fn create_support_case(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_support_case(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_quotas_client
    ...
    async fn update_support_case(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let request_id = input.get_string("request_id")?;
    ...
    async fn delete_support_case(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_quotas_client
    ...
    async fn read_requested_service_quota_change(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_quotas_client
    ...
    async fn delete_requested_service_quota_change(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_quotas_client
    ...
    async fn delete_service_quota_increase_request_into_template(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_quotas_client
    ...
    async fn read_aws_default_service_quota(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.service_quotas_client
    ...
    async fn delete_aws_default_service_quota(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_quotas_client
    ...
    async fn delete_association_for_service_quota_template(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.service_quotas_client
