...
impl<'a> Auto_management<'a> {
    ...
    pub async fn update(&self, id: &str, opt_in_type: Option<String>, notification_arn: Option<String>, exclusion_list: Option<HashMap<String, Vec<String>>>) -> Result<()> {

        // Note: This is a generated skeleton.
        // TODO: Map resource ID and update fields to SDK parameters
        let _client = &self.provider.service_quotas_client;
