//! Iot_events_data service for Aws provider
//!
//! This module handles all iot_events_data resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Iot_events_data service handler
pub struct Iot_events_dataService<'a> {
    provider: &'a crate::AwsProvider,
}

impl<'a> Iot_events_dataService<'a> {
    ...
    async fn create_alarm(
        ...
        self.provider.runtime().block_on(async {
            ...
            // Example:
            // let result = self.provider.iot_events_data_client
            //     .create_alarm()
            //     .set_name(name)
            //     .send()
            //     .await
    ...
    async fn delete_alarm(
        ...
        self.provider.runtime().block_on(async {
            ...
            // Example:
            // self.provider.iot_events_data_client
            //     .delete_alarm()
            //     .set_id(id.to_string())
            //     .send()
            //     .await
