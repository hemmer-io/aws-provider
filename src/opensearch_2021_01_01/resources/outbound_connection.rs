...
impl<'a> Outbound_connection<'a> {
    ...
    pub async fn create(&self, remote_domain_info: String, connection_mode: Option<String>, connection_properties: Option<String>, local_domain_info: String, connection_alias: String) -> Result<String> {
