...
impl<'a> Data_source<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, domain_name: Option<String>, description: Option<String>, status: Option<String>, name: Option<String>, data_source_type: Option<String>) -> Result<()> {
