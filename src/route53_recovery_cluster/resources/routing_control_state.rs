...
impl<'a> Routing_control_state<'a> {
    ...
    pub async fn read(&self, id: &str) -> Result<()> {
        ...
        let _client = &self.provider.route53_recovery_cluster_client;
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, routing_control_state: Option<String>, safety_rules_to_override: Option<Vec<String>>, routing_control_arn: Option<String>) -> Result<()> {
