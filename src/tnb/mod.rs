...
impl<'a> TnbService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "sol_function_package" => {
                self.plan_sol_function_package(current_state, desired_input)
                    .await
            }
            "sol_network_instance" => {
                self.plan_sol_network_instance(current_state, desired_input)
                    .await
            }
            "sol_function_instance" => {
                self.plan_sol_function_instance(current_state, desired_input)
                    .await
            }
            "sol_function_package_descriptor" => {
                self.plan_sol_function_package_descriptor(current_state, desired_input)
                    .await
            }
            "sol_network_package_descriptor" => {
                self.plan_sol_network_package_descriptor(current_state, desired_input)
                    .await
            }
            "sol_network_package_content" => {
                self.plan_sol_network_package_content(current_state, desired_input)
                    .await
            }
            "sol_network_operation" => {
                self.plan_sol_network_operation(current_state, desired_input)
                    .await
            }
            "sol_function_package_content" => {
                self.plan_sol_function_package_content(current_state, desired_input)
                    .await
            }
            "sol_network_package" => {
                self.plan_sol_network_package(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "sol_function_package" => self.create_sol_function_package(input).await,
            "sol_network_instance" => self.create_sol_network_instance(input).await,
            "sol_function_instance" => self.create_sol_function_instance(input).await,
            "sol_function_package_descriptor" => {
            ...
            "sol_network_package_content" => self.create_sol_network_package_content(input).await,
            "sol_network_operation" => self.create_sol_network_operation(input).await,
            "sol_function_package_content" => self.create_sol_function_package_content(input).await,
            "sol_network_package" => self.create_sol_network_package(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "tnb", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "sol_function_package" => self.read_sol_function_package(id).await,
            "sol_network_instance" => self.read_sol_network_instance(id).await,
            "sol_function_instance" => self.read_sol_function_instance(id).await,
            "sol_function_package_descriptor" => {
                self.read_sol_function_package_descriptor(id).await
            }
            "sol_network_package_descriptor" => self.read_sol_network_package_descriptor(id).await,
            "sol_network_package_content" => self.read_sol_network_package_content(id).await,
            "sol_network_operation" => self.read_sol_network_operation(id).await,
            "sol_function_package_content" => self.read_sol_function_package_content(id).await,
            "sol_network_package" => self.read_sol_network_package(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "tnb", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "sol_function_package" => self.update_sol_function_package(id, input).await,
            "sol_network_instance" => self.update_sol_network_instance(id, input).await,
            "sol_function_instance" => self.update_sol_function_instance(id, input).await,
            "sol_function_package_descriptor" => {
            ...
            "sol_network_operation" => self.update_sol_network_operation(id, input).await,
            "sol_function_package_content" => {
                self.update_sol_function_package_content(id, input).await
            }
            "sol_network_package" => self.update_sol_network_package(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "tnb", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "sol_function_package" => self.delete_sol_function_package(id).await,
            "sol_network_instance" => self.delete_sol_network_instance(id).await,
            "sol_function_instance" => self.delete_sol_function_instance(id).await,
            "sol_function_package_descriptor" => {
            ...
            "sol_network_package_content" => self.delete_sol_network_package_content(id).await,
            "sol_network_operation" => self.delete_sol_network_operation(id).await,
            "sol_function_package_content" => self.delete_sol_function_package_content(id).await,
            "sol_network_package" => self.delete_sol_network_package(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "tnb", resource_name
            ))),
    ...
    async fn create_sol_function_package(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_sol_function_package(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_sol_function_package(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_sol_network_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_sol_network_instance(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.tnb_client
    ...
    async fn delete_sol_network_instance(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.tnb_client
    ...
    async fn create_sol_function_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_sol_function_instance(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.tnb_client
    ...
    async fn delete_sol_function_instance(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.tnb_client
    ...
    async fn read_sol_function_package_descriptor(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.tnb_client
    ...
    async fn delete_sol_function_package_descriptor(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.tnb_client
    ...
    async fn read_sol_network_package_descriptor(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.tnb_client
    ...
    async fn delete_sol_network_package_descriptor(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.tnb_client
    ...
    async fn read_sol_network_package_content(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.tnb_client
    ...
    async fn delete_sol_network_package_content(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.tnb_client
    ...
    async fn create_sol_network_operation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_sol_network_operation(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.tnb_client
    ...
    async fn delete_sol_network_operation(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.tnb_client
    ...
    async fn read_sol_function_package_content(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.tnb_client
    ...
    async fn delete_sol_function_package_content(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.tnb_client
    ...
    async fn create_sol_network_package(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_sol_network_package(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.tnb_client
    ...
    async fn delete_sol_network_package(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.tnb_client
