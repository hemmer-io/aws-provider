...
impl<'a> CloudhsmService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "hapg" => self.plan_hapg(current_state, desired_input).await,
            "config" => self.plan_config(current_state, desired_input).await,
            "hsm" => self.plan_hsm(current_state, desired_input).await,
            "luna_client" => self.plan_luna_client(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "hapg" => self.create_hapg(input).await,
            "config" => self.create_config(input).await,
            "hsm" => self.create_hsm(input).await,
            "luna_client" => self.create_luna_client(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "hapg" => self.read_hapg(id).await,
            "config" => self.read_config(id).await,
            "hsm" => self.read_hsm(id).await,
            "luna_client" => self.read_luna_client(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "hapg" => self.update_hapg(id, input).await,
            "config" => self.update_config(id, input).await,
            "hsm" => self.update_hsm(id, input).await,
            "luna_client" => self.update_luna_client(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "hapg" => self.delete_hapg(id).await,
            "config" => self.delete_config(id).await,
            "hsm" => self.delete_hsm(id).await,
            "luna_client" => self.delete_luna_client(id).await,
    ...
    async fn create_hapg(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_hapg(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_hapg(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let label = input.get_string("label")?;
    ...
    async fn delete_hapg(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudhsm_client
    ...
    async fn update_config(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn create_hsm(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    /// Read a hsm resource
    async fn read_hsm(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudhsm_client
    ...
    async fn update_hsm(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let iam_role_arn = input.get_string("iam_role_arn")?;
            let subscription_type = input.get_string("subscription_type")?;
    ...
    async fn delete_hsm(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudhsm_client
    ...
    async fn create_luna_client(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_luna_client(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.cloudhsm_client
    ...
    async fn update_luna_client(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let label = input.get_optional_string("label")?;
            let certificate = input.get_string("certificate")?;
    ...
    async fn delete_luna_client(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.cloudhsm_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    backup_retention_policy.unwrap_or_default(),
                )
