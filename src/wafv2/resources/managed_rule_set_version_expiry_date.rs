...
impl<'a> Managed_rule_set_version_expiry_date<'a> {
    ...
    pub async fn update(&self, id: &str, name: Option<String>, scope: Option<String>, id: Option<String>, version_to_expire: Option<String>, lock_token: Option<String>, expiry_timestamp: Option<String>) -> Result<()> {
