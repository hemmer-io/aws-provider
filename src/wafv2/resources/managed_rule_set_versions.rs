...
impl<'a> Managed_rule_set_versions<'a> {
    ...
    pub async fn create(&self, recommended_version: Option<String>, id: String, name: String, versions_to_publish: Option<HashMap<String, String>>, scope: String, lock_token: String) -> Result<String> {
