...
impl<'a> ConnectparticipantService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "transcript" => self.plan_transcript(current_state, desired_input).await,
            "attachment" => self.plan_attachment(current_state, desired_input).await,
            "participant_connection" => {
                self.plan_participant_connection(current_state, desired_input)
                    .await
            }
            "view" => self.plan_view(current_state, desired_input).await,
            "authentication_url" => {
                self.plan_authentication_url(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "connectparticipant", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "transcript" => self.create_transcript(input).await,
            "attachment" => self.create_attachment(input).await,
            "participant_connection" => self.create_participant_connection(input).await,
            "view" => self.create_view(input).await,
            "authentication_url" => self.create_authentication_url(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "connectparticipant", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "transcript" => self.read_transcript(id).await,
            "attachment" => self.read_attachment(id).await,
            "participant_connection" => self.read_participant_connection(id).await,
            "view" => self.read_view(id).await,
            "authentication_url" => self.read_authentication_url(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "connectparticipant", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "transcript" => self.update_transcript(id, input).await,
            "attachment" => self.update_attachment(id, input).await,
            "participant_connection" => self.update_participant_connection(id, input).await,
            "view" => self.update_view(id, input).await,
            "authentication_url" => self.update_authentication_url(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "connectparticipant", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "transcript" => self.delete_transcript(id).await,
            "attachment" => self.delete_attachment(id).await,
            "participant_connection" => self.delete_participant_connection(id).await,
            "view" => self.delete_view(id).await,
            "authentication_url" => self.delete_authentication_url(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "connectparticipant", resource_name
            ))),
    ...
    async fn create_transcript(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_transcript(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_transcript(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn create_participant_connection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "connect_participant",
                    connect_participant.unwrap_or_default(),
                )
    ...
    async fn read_participant_connection(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connectparticipant_client
    ...
    async fn delete_participant_connection(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connectparticipant_client
    ...
    async fn create_authentication_url(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_authentication_url(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.connectparticipant_client
    ...
    async fn delete_authentication_url(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.connectparticipant_client
