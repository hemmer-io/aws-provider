...
impl<'a> Chime_webhook_configuration<'a> {
    ...
    pub async fn create(&self, configuration_name: String, logging_level: Option<String>, tags: Option<Vec<String>>, webhook_description: String, webhook_url: String, sns_topic_arns: Vec<String>, iam_role_arn: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, configuration_name: Option<String>, logging_level: Option<String>, tags: Option<Vec<String>>, webhook_description: Option<String>, webhook_url: Option<String>, sns_topic_arns: Option<Vec<String>>, iam_role_arn: Option<String>) -> Result<()> {
