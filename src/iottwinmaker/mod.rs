...
impl<'a> IottwinmakerService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "property_value" => self.plan_property_value(current_state, desired_input).await,
            "property_value_history" => {
                self.plan_property_value_history(current_state, desired_input)
                    .await
            }
            "metadata_transfer_job" => {
                self.plan_metadata_transfer_job(current_state, desired_input)
                    .await
            }
            "workspace" => self.plan_workspace(current_state, desired_input).await,
            "pricing_plan" => self.plan_pricing_plan(current_state, desired_input).await,
            "scene" => self.plan_scene(current_state, desired_input).await,
            "sync_job" => self.plan_sync_job(current_state, desired_input).await,
            "component_type" => self.plan_component_type(current_state, desired_input).await,
            "entity" => self.plan_entity(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "iottwinmaker", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "property_value" => self.create_property_value(input).await,
            "property_value_history" => self.create_property_value_history(input).await,
            "metadata_transfer_job" => self.create_metadata_transfer_job(input).await,
            "workspace" => self.create_workspace(input).await,
            "pricing_plan" => self.create_pricing_plan(input).await,
            "scene" => self.create_scene(input).await,
            "sync_job" => self.create_sync_job(input).await,
            "component_type" => self.create_component_type(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "property_value" => self.read_property_value(id).await,
            "property_value_history" => self.read_property_value_history(id).await,
            "metadata_transfer_job" => self.read_metadata_transfer_job(id).await,
            "workspace" => self.read_workspace(id).await,
            "pricing_plan" => self.read_pricing_plan(id).await,
            "scene" => self.read_scene(id).await,
            "sync_job" => self.read_sync_job(id).await,
            "component_type" => self.read_component_type(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "property_value" => self.update_property_value(id, input).await,
            "property_value_history" => self.update_property_value_history(id, input).await,
            "metadata_transfer_job" => self.update_metadata_transfer_job(id, input).await,
            "workspace" => self.update_workspace(id, input).await,
            "pricing_plan" => self.update_pricing_plan(id, input).await,
            "scene" => self.update_scene(id, input).await,
            "sync_job" => self.update_sync_job(id, input).await,
            "component_type" => self.update_component_type(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "property_value" => self.delete_property_value(id).await,
            "property_value_history" => self.delete_property_value_history(id).await,
            "metadata_transfer_job" => self.delete_metadata_transfer_job(id).await,
            "workspace" => self.delete_workspace(id).await,
            "pricing_plan" => self.delete_pricing_plan(id).await,
            "scene" => self.delete_scene(id).await,
            "sync_job" => self.delete_sync_job(id).await,
            "component_type" => self.delete_component_type(id).await,
    ...
    async fn create_property_value(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_property_value(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_property_value(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_property_value_history(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_property_value_history(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iottwinmaker_client
    ...
    async fn delete_property_value_history(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iottwinmaker_client
    ...
    async fn create_metadata_transfer_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    metadata_transfer_job_id.unwrap_or_default(),
                )
    ...
    async fn read_metadata_transfer_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iottwinmaker_client
    ...
    async fn delete_metadata_transfer_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iottwinmaker_client
    ...
    async fn create_pricing_plan(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_pricing_plan(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iottwinmaker_client
    ...
    async fn update_pricing_plan(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let pricing_mode = input.get_string("pricing_mode")?;
            let bundle_names = input.get_optional_string("bundle_names")?;
    ...
    async fn delete_pricing_plan(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iottwinmaker_client
    ...
    async fn create_scene(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_scene(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iottwinmaker_client
    ...
    async fn update_scene(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let scene_metadata = input.get_optional_string("scene_metadata")?;
            let workspace_id = input.get_string("workspace_id")?;
    ...
    async fn create_sync_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_sync_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iottwinmaker_client
    ...
    async fn update_sync_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let sync_source = input.get_string("sync_source")?;
            let workspace_id = input.get_string("workspace_id")?;
    ...
    async fn delete_sync_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iottwinmaker_client
    ...
    async fn create_component_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            let description = input.get_optional_string("description")?;
            let composite_component_types =
                input.get_optional_string("composite_component_types")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    property_definitions.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    composite_component_types.unwrap_or_default(),
                )
                ...
                .with_field(
                    "component_type_name",
                    component_type_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a component_type resource
    async fn read_component_type(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iottwinmaker_client
    ...
    async fn delete_component_type(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iottwinmaker_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    composite_components.unwrap_or_default(),
                )
                .with_field("workspace_id", workspace_id.unwrap_or_default()))
        })
    }
