...
impl<'a> Resource_config<'a> {
    ...
    pub async fn create(&self, resource_type: String, schema_version_id: String, tags: Option<HashMap<String, String>>, resource_name: Option<String>, configuration: String, resource_id: String) -> Result<String> {
