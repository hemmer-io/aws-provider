...
impl<'a> App_version_app_component<'a> {
    ...
    pub async fn create(&self, name: String, type: String, additional_info: Option<HashMap<String, Vec<String>>>, client_token: Option<String>, app_arn: String, id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, type: Option<String>, additional_info: Option<HashMap<String, Vec<String>>>, client_token: Option<String>, app_arn: Option<String>, id: Option<String>) -> Result<()> {
