...
impl<'a> App_version_app_component<'a> {
    ...
    pub async fn create(&self, type: String, name: String, additional_info: Option<HashMap<String, Vec<String>>>, client_token: Option<String>, app_arn: String, id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, type: Option<String>, name: Option<String>, additional_info: Option<HashMap<String, Vec<String>>>, client_token: Option<String>, app_arn: Option<String>, id: Option<String>) -> Result<()> {
