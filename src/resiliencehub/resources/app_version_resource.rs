...
impl<'a> App_version_resource<'a> {
    ...
    pub async fn create(&self, aws_account_id: Option<String>, logical_resource_id: String, resource_name: Option<String>, app_arn: String, resource_type: String, app_components: Vec<String>, additional_info: Option<HashMap<String, Vec<String>>>, physical_resource_id: String, client_token: Option<String>, aws_region: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, aws_account_id: Option<String>, logical_resource_id: Option<String>, resource_name: Option<String>, app_arn: Option<String>, resource_type: Option<String>, app_components: Option<Vec<String>>, additional_info: Option<HashMap<String, Vec<String>>>, physical_resource_id: Option<String>, client_token: Option<String>, aws_region: Option<String>) -> Result<()> {
