...
impl<'a> Configuration_manager<'a> {
    ...
    pub async fn create(&self, tags: Option<HashMap<String, String>>, description: Option<String>, configuration_definitions: Vec<String>, name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<HashMap<String, String>>, description: Option<String>, configuration_definitions: Option<Vec<String>>, name: Option<String>) -> Result<()> {
