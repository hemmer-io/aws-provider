...
impl<'a> ComprehendService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "document_classifier" => {
                self.plan_document_classifier(current_state, desired_input)
                    .await
            }
            "pii_entities_detection_job" => {
                self.plan_pii_entities_detection_job(current_state, desired_input)
                    .await
            }
            "document_classification_job" => {
                self.plan_document_classification_job(current_state, desired_input)
                    .await
            }
            "flywheel" => self.plan_flywheel(current_state, desired_input).await,
            "entity_recognizer" => {
                self.plan_entity_recognizer(current_state, desired_input)
                    .await
            }
            "dataset" => self.plan_dataset(current_state, desired_input).await,
            "dominant_language_detection_job" => {
                self.plan_dominant_language_detection_job(current_state, desired_input)
                    .await
            }
            "targeted_sentiment_detection_job" => {
                self.plan_targeted_sentiment_detection_job(current_state, desired_input)
                    .await
            }
            "resource_policy" => {
            ...
            "events_detection_job" => {
                self.plan_events_detection_job(current_state, desired_input)
                    .await
            }
            "endpoint" => self.plan_endpoint(current_state, desired_input).await,
            "key_phrases_detection_job" => {
                self.plan_key_phrases_detection_job(current_state, desired_input)
                    .await
            }
            "flywheel_iteration" => {
                self.plan_flywheel_iteration(current_state, desired_input)
                    .await
            }
            "entities_detection_job" => {
                self.plan_entities_detection_job(current_state, desired_input)
                    .await
            }
            "topics_detection_job" => {
                self.plan_topics_detection_job(current_state, desired_input)
                    .await
            }
            "sentiment_detection_job" => {
                self.plan_sentiment_detection_job(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "comprehend", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "document_classifier" => self.create_document_classifier(input).await,
            "pii_entities_detection_job" => self.create_pii_entities_detection_job(input).await,
            "document_classification_job" => self.create_document_classification_job(input).await,
            "flywheel" => self.create_flywheel(input).await,
            "entity_recognizer" => self.create_entity_recognizer(input).await,
            ...
            "events_detection_job" => self.create_events_detection_job(input).await,
            "endpoint" => self.create_endpoint(input).await,
            "key_phrases_detection_job" => self.create_key_phrases_detection_job(input).await,
            "flywheel_iteration" => self.create_flywheel_iteration(input).await,
            "entities_detection_job" => self.create_entities_detection_job(input).await,
            "topics_detection_job" => self.create_topics_detection_job(input).await,
            "sentiment_detection_job" => self.create_sentiment_detection_job(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "comprehend", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "document_classifier" => self.read_document_classifier(id).await,
            "pii_entities_detection_job" => self.read_pii_entities_detection_job(id).await,
            "document_classification_job" => self.read_document_classification_job(id).await,
            "flywheel" => self.read_flywheel(id).await,
            "entity_recognizer" => self.read_entity_recognizer(id).await,
            ...
            "events_detection_job" => self.read_events_detection_job(id).await,
            "endpoint" => self.read_endpoint(id).await,
            "key_phrases_detection_job" => self.read_key_phrases_detection_job(id).await,
            "flywheel_iteration" => self.read_flywheel_iteration(id).await,
            "entities_detection_job" => self.read_entities_detection_job(id).await,
            "topics_detection_job" => self.read_topics_detection_job(id).await,
            "sentiment_detection_job" => self.read_sentiment_detection_job(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "comprehend", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "document_classifier" => self.update_document_classifier(id, input).await,
            "pii_entities_detection_job" => self.update_pii_entities_detection_job(id, input).await,
            "document_classification_job" => {
                self.update_document_classification_job(id, input).await
            }
            "flywheel" => self.update_flywheel(id, input).await,
            "entity_recognizer" => self.update_entity_recognizer(id, input).await,
            "dataset" => self.update_dataset(id, input).await,
            "dominant_language_detection_job" => {
                self.update_dominant_language_detection_job(id, input).await
            }
            "targeted_sentiment_detection_job" => {
                self.update_targeted_sentiment_detection_job(id, input)
                    .await
            }
            "resource_policy" => self.update_resource_policy(id, input).await,
            "events_detection_job" => self.update_events_detection_job(id, input).await,
            "endpoint" => self.update_endpoint(id, input).await,
            "key_phrases_detection_job" => self.update_key_phrases_detection_job(id, input).await,
            "flywheel_iteration" => self.update_flywheel_iteration(id, input).await,
            "entities_detection_job" => self.update_entities_detection_job(id, input).await,
            "topics_detection_job" => self.update_topics_detection_job(id, input).await,
            "sentiment_detection_job" => self.update_sentiment_detection_job(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "comprehend", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "document_classifier" => self.delete_document_classifier(id).await,
            "pii_entities_detection_job" => self.delete_pii_entities_detection_job(id).await,
            "document_classification_job" => self.delete_document_classification_job(id).await,
            "flywheel" => self.delete_flywheel(id).await,
            "entity_recognizer" => self.delete_entity_recognizer(id).await,
            ...
            "events_detection_job" => self.delete_events_detection_job(id).await,
            "endpoint" => self.delete_endpoint(id).await,
            "key_phrases_detection_job" => self.delete_key_phrases_detection_job(id).await,
            "flywheel_iteration" => self.delete_flywheel_iteration(id).await,
            "entities_detection_job" => self.delete_entities_detection_job(id).await,
            "topics_detection_job" => self.delete_topics_detection_job(id).await,
            "sentiment_detection_job" => self.delete_sentiment_detection_job(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "comprehend", resource_name
            ))),
    ...
    async fn create_document_classifier(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    document_classifier_name.unwrap_or_default(),
                )
    ...
    async fn read_document_classifier(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_document_classifier(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_pii_entities_detection_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehend_client
    ...
    async fn delete_pii_entities_detection_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehend_client
    ...
    async fn read_document_classification_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehend_client
    ...
    async fn delete_document_classification_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehend_client
    ...
    async fn create_flywheel(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    data_security_config.unwrap_or_default(),
                )
                .with_field(
                    "data_access_role_arn",
                    data_access_role_arn.unwrap_or_default(),
    ...
    async fn read_flywheel(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehend_client
    ...
    async fn update_flywheel(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let flywheel_name = input.get_string("flywheel_name")?;
            let data_security_config = input.get_optional_string("data_security_config")?;
    ...
    async fn delete_flywheel(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehend_client
    ...
    async fn create_entity_recognizer(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_entity_recognizer(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehend_client
    ...
    async fn delete_entity_recognizer(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehend_client
    ...
    async fn read_dominant_language_detection_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehend_client
    ...
    async fn delete_dominant_language_detection_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehend_client
    ...
    async fn read_targeted_sentiment_detection_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehend_client
    ...
    async fn delete_targeted_sentiment_detection_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehend_client
    ...
    async fn create_events_detection_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_events_detection_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehend_client
    ...
    async fn delete_events_detection_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehend_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    desired_inference_units.unwrap_or_default(),
                )
                .with_field(
                    "client_request_token",
                    client_request_token.unwrap_or_default(),
    ...
    async fn read_key_phrases_detection_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehend_client
    ...
    async fn delete_key_phrases_detection_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehend_client
    ...
    async fn create_flywheel_iteration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_flywheel_iteration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehend_client
    ...
    async fn delete_flywheel_iteration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehend_client
    ...
    async fn create_entities_detection_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_entities_detection_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehend_client
    ...
    async fn delete_entities_detection_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehend_client
    ...
    async fn create_topics_detection_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_topics_detection_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehend_client
    ...
    async fn delete_topics_detection_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehend_client
    ...
    async fn create_sentiment_detection_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_sentiment_detection_job(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.comprehend_client
    ...
    async fn delete_sentiment_detection_job(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.comprehend_client
