...
impl<'a> Document_classifier<'a> {
    ...
    pub async fn create(&self, language_code: String, document_classifier_name: String, vpc_config: Option<String>, mode: Option<String>, output_data_config: Option<String>, input_data_config: String, tags: Option<Vec<String>>, version_name: Option<String>, data_access_role_arn: String, client_request_token: Option<String>, volume_kms_key_id: Option<String>, model_kms_key_id: Option<String>, model_policy: Option<String>) -> Result<String> {
