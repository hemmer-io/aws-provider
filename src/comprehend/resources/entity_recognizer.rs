...
impl<'a> Entity_recognizer<'a> {
    ...
    pub async fn create(&self, data_access_role_arn: String, recognizer_name: String, model_kms_key_id: Option<String>, client_request_token: Option<String>, vpc_config: Option<String>, volume_kms_key_id: Option<String>, input_data_config: String, model_policy: Option<String>, version_name: Option<String>, tags: Option<Vec<String>>, language_code: String) -> Result<String> {
