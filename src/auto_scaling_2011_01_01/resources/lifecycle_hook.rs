...
impl<'a> Lifecycle_hook<'a> {
    ...
    pub async fn create(&self, notification_target_arn: Option<String>, role_arn: Option<String>, default_result: Option<String>, lifecycle_hook_name: String, lifecycle_transition: Option<String>, auto_scaling_group_name: String, notification_metadata: Option<String>, heartbeat_timeout: Option<i64>) -> Result<String> {
