...
impl<'a> Resource_policy<'a> {
    ...
    pub async fn create(&self, policy_document: String, policy_name: String, bypass_policy_lockout_check: Option<bool>, policy_revision_id: Option<String>) -> Result<String> {
