...
impl<'a> Resource_policy<'a> {
    ...
    pub async fn create(&self, policy_revision_id: Option<String>, bypass_policy_lockout_check: Option<bool>, policy_name: String, policy_document: String) -> Result<String> {
