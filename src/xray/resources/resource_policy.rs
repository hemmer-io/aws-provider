...
impl<'a> Resource_policy<'a> {
    ...
    pub async fn create(&self, bypass_policy_lockout_check: Option<bool>, policy_revision_id: Option<String>, policy_document: String, policy_name: String) -> Result<String> {
