...
impl<'a> XrayService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "trace_graph" => self.plan_trace_graph(current_state, desired_input).await,
            "indexing_rules" => self.plan_indexing_rules(current_state, desired_input).await,
            "retrieved_traces_graph" => {
                self.plan_retrieved_traces_graph(current_state, desired_input)
                    .await
            }
            "time_series_service_statistics" => {
                self.plan_time_series_service_statistics(current_state, desired_input)
                    .await
            }
            "group" => self.plan_group(current_state, desired_input).await,
            "insight_impact_graph" => {
                self.plan_insight_impact_graph(current_state, desired_input)
                    .await
            }
            "encryption_config" => {
                self.plan_encryption_config(current_state, desired_input)
                    .await
            }
            "trace_segment_destination" => {
                self.plan_trace_segment_destination(current_state, desired_input)
                    .await
            }
            "trace_summaries" => {
                self.plan_trace_summaries(current_state, desired_input)
                    .await
            }
            "telemetry_records" => {
                self.plan_telemetry_records(current_state, desired_input)
                    .await
            }
            "trace_segments" => self.plan_trace_segments(current_state, desired_input).await,
            "sampling_targets" => {
                self.plan_sampling_targets(current_state, desired_input)
                    .await
            }
            "resource_policy" => {
            ...
            "sampling_rule" => self.plan_sampling_rule(current_state, desired_input).await,
            "sampling_statistic_summaries" => {
                self.plan_sampling_statistic_summaries(current_state, desired_input)
                    .await
            }
            "indexing_rule" => self.plan_indexing_rule(current_state, desired_input).await,
            "groups" => self.plan_groups(current_state, desired_input).await,
            "sampling_rules" => self.plan_sampling_rules(current_state, desired_input).await,
            "service_graph" => self.plan_service_graph(current_state, desired_input).await,
            "insight" => self.plan_insight(current_state, desired_input).await,
            "insight_events" => self.plan_insight_events(current_state, desired_input).await,
            "insight_summaries" => {
                self.plan_insight_summaries(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "trace_graph" => self.create_trace_graph(input).await,
            "indexing_rules" => self.create_indexing_rules(input).await,
            "retrieved_traces_graph" => self.create_retrieved_traces_graph(input).await,
            "time_series_service_statistics" => {
                self.create_time_series_service_statistics(input).await
            }
            "group" => self.create_group(input).await,
            "insight_impact_graph" => self.create_insight_impact_graph(input).await,
            "encryption_config" => self.create_encryption_config(input).await,
            "trace_segment_destination" => self.create_trace_segment_destination(input).await,
            "trace_summaries" => self.create_trace_summaries(input).await,
            "telemetry_records" => self.create_telemetry_records(input).await,
            "trace_segments" => self.create_trace_segments(input).await,
            "sampling_targets" => self.create_sampling_targets(input).await,
            "resource_policy" => self.create_resource_policy(input).await,
            "sampling_rule" => self.create_sampling_rule(input).await,
            "sampling_statistic_summaries" => self.create_sampling_statistic_summaries(input).await,
            "indexing_rule" => self.create_indexing_rule(input).await,
            "groups" => self.create_groups(input).await,
            "sampling_rules" => self.create_sampling_rules(input).await,
            "service_graph" => self.create_service_graph(input).await,
            "insight" => self.create_insight(input).await,
            "insight_events" => self.create_insight_events(input).await,
            "insight_summaries" => self.create_insight_summaries(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "xray", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "trace_graph" => self.read_trace_graph(id).await,
            "indexing_rules" => self.read_indexing_rules(id).await,
            "retrieved_traces_graph" => self.read_retrieved_traces_graph(id).await,
            "time_series_service_statistics" => self.read_time_series_service_statistics(id).await,
            "group" => self.read_group(id).await,
            "insight_impact_graph" => self.read_insight_impact_graph(id).await,
            "encryption_config" => self.read_encryption_config(id).await,
            "trace_segment_destination" => self.read_trace_segment_destination(id).await,
            "trace_summaries" => self.read_trace_summaries(id).await,
            "telemetry_records" => self.read_telemetry_records(id).await,
            "trace_segments" => self.read_trace_segments(id).await,
            "sampling_targets" => self.read_sampling_targets(id).await,
            "resource_policy" => self.read_resource_policy(id).await,
            "sampling_rule" => self.read_sampling_rule(id).await,
            "sampling_statistic_summaries" => self.read_sampling_statistic_summaries(id).await,
            "indexing_rule" => self.read_indexing_rule(id).await,
            "groups" => self.read_groups(id).await,
            "sampling_rules" => self.read_sampling_rules(id).await,
            "service_graph" => self.read_service_graph(id).await,
            "insight" => self.read_insight(id).await,
            "insight_events" => self.read_insight_events(id).await,
            "insight_summaries" => self.read_insight_summaries(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "xray", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "trace_graph" => self.update_trace_graph(id, input).await,
            "indexing_rules" => self.update_indexing_rules(id, input).await,
            "retrieved_traces_graph" => self.update_retrieved_traces_graph(id, input).await,
            "time_series_service_statistics" => {
                self.update_time_series_service_statistics(id, input).await
            }
            "group" => self.update_group(id, input).await,
            "insight_impact_graph" => self.update_insight_impact_graph(id, input).await,
            "encryption_config" => self.update_encryption_config(id, input).await,
            "trace_segment_destination" => self.update_trace_segment_destination(id, input).await,
            "trace_summaries" => self.update_trace_summaries(id, input).await,
            "telemetry_records" => self.update_telemetry_records(id, input).await,
            "trace_segments" => self.update_trace_segments(id, input).await,
            "sampling_targets" => self.update_sampling_targets(id, input).await,
            "resource_policy" => self.update_resource_policy(id, input).await,
            "sampling_rule" => self.update_sampling_rule(id, input).await,
            "sampling_statistic_summaries" => {
                self.update_sampling_statistic_summaries(id, input).await
            }
            "indexing_rule" => self.update_indexing_rule(id, input).await,
            "groups" => self.update_groups(id, input).await,
            "sampling_rules" => self.update_sampling_rules(id, input).await,
            "service_graph" => self.update_service_graph(id, input).await,
            "insight" => self.update_insight(id, input).await,
            "insight_events" => self.update_insight_events(id, input).await,
            "insight_summaries" => self.update_insight_summaries(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "xray", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "trace_graph" => self.delete_trace_graph(id).await,
            "indexing_rules" => self.delete_indexing_rules(id).await,
            "retrieved_traces_graph" => self.delete_retrieved_traces_graph(id).await,
            "time_series_service_statistics" => {
                self.delete_time_series_service_statistics(id).await
            }
            "group" => self.delete_group(id).await,
            "insight_impact_graph" => self.delete_insight_impact_graph(id).await,
            "encryption_config" => self.delete_encryption_config(id).await,
            "trace_segment_destination" => self.delete_trace_segment_destination(id).await,
            "trace_summaries" => self.delete_trace_summaries(id).await,
            "telemetry_records" => self.delete_telemetry_records(id).await,
            "trace_segments" => self.delete_trace_segments(id).await,
            "sampling_targets" => self.delete_sampling_targets(id).await,
            "resource_policy" => self.delete_resource_policy(id).await,
            "sampling_rule" => self.delete_sampling_rule(id).await,
            "sampling_statistic_summaries" => self.delete_sampling_statistic_summaries(id).await,
            "indexing_rule" => self.delete_indexing_rule(id).await,
            "groups" => self.delete_groups(id).await,
            "sampling_rules" => self.delete_sampling_rules(id).await,
            "service_graph" => self.delete_service_graph(id).await,
            "insight" => self.delete_insight(id).await,
            "insight_events" => self.delete_insight_events(id).await,
            "insight_summaries" => self.delete_insight_summaries(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "xray", resource_name
            ))),
    ...
    async fn create_trace_graph(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_trace_graph(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_trace_graph(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_trace_graph(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_indexing_rules(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_indexing_rules(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_indexing_rules(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_retrieved_traces_graph(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_retrieved_traces_graph(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_retrieved_traces_graph(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn read_time_series_service_statistics(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_time_series_service_statistics(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    insights_configuration.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_insight_impact_graph(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_insight_impact_graph(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_insight_impact_graph(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_encryption_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_encryption_config(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_encryption_config(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn read_trace_segment_destination(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_trace_segment_destination(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_trace_summaries(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_trace_summaries(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_trace_summaries(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_telemetry_records(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_telemetry_records(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_telemetry_records(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_trace_segments(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new().with_id("placeholder-id").with_field(
                ...
                trace_segment_documents.unwrap_or_default(),
            ))
        })
    }

    /// Read a trace_segments resource
    async fn read_trace_segments(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_trace_segments(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_sampling_targets(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_sampling_targets(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_sampling_targets(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_resource_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let bypass_policy_lockout_check =
                input.get_optional_string("bypass_policy_lockout_check")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    bypass_policy_lockout_check.unwrap_or_default(),
                )
    ...
    async fn create_sampling_rule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
    ...
    async fn read_sampling_rule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn update_sampling_rule(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let sampling_rule = input.get_string("sampling_rule")?;
    ...
    async fn delete_sampling_rule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn read_sampling_statistic_summaries(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_sampling_statistic_summaries(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_indexing_rule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_indexing_rule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn update_indexing_rule(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let rule = input.get_string("rule")?;
            let name = input.get_string("name")?;
    ...
    async fn delete_indexing_rule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_groups(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_groups(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn update_groups(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_groups(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_sampling_rules(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_sampling_rules(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_sampling_rules(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_service_graph(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_service_graph(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn update_service_graph(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_service_graph(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_insight_events(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_insight_events(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_insight_events(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
    ...
    async fn create_insight_summaries(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_insight_summaries(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.xray_client
    ...
    async fn delete_insight_summaries(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.xray_client
