...
impl<'a> Recommendation_preferences<'a> {
    ...
    pub async fn create(&self, inferred_workload_types: Option<String>, scope: Option<String>, enhanced_infrastructure_metrics: Option<String>, look_back_period: Option<String>, utilization_preferences: Option<Vec<String>>, external_metrics_preference: Option<String>, preferred_resources: Option<Vec<String>>, savings_estimation_mode: Option<String>, resource_type: String) -> Result<String> {
