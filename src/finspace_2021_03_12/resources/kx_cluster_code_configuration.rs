...
impl<'a> Kx_cluster_code_configuration<'a> {
    ...
    pub async fn update(&self, id: &str, deployment_configuration: Option<String>, code: Option<String>, initialization_script: Option<String>, command_line_arguments: Option<Vec<String>>, environment_id: Option<String>, cluster_name: Option<String>, client_token: Option<String>) -> Result<()> {
