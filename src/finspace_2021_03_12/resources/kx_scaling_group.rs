...
impl<'a> Kx_scaling_group<'a> {
    ...
    pub async fn create(&self, availability_zone_id: String, tags: Option<HashMap<String, String>>, client_token: String, environment_id: String, scaling_group_name: String, host_type: String) -> Result<String> {
