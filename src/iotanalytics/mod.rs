...
impl<'a> IotanalyticsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "dataset_content" => {
                self.plan_dataset_content(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "dataset_content" => self.create_dataset_content(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "dataset_content" => self.read_dataset_content(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "dataset_content" => self.update_dataset_content(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "dataset_content" => self.delete_dataset_content(id).await,
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    content_delivery_rules.unwrap_or_default(),
                )
    ...
    async fn create_pipeline(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "pipeline_activities",
                    pipeline_activities.unwrap_or_default(),
                )
    ...
    async fn create_dataset_content(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_dataset_content(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.iotanalytics_client
    ...
    async fn delete_dataset_content(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.iotanalytics_client
    ...
    async fn create_datastore(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let retention_period = input.get_optional_string("retention_period")?;
            let tags = input.get_optional_string("tags")?;
            let file_format_configuration =
                input.get_optional_string("file_format_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    file_format_configuration.unwrap_or_default(),
                )
                .with_field("datastore_name", datastore_name.unwrap_or_default())
                .with_field(
                    "datastore_partitions",
                    datastore_partitions.unwrap_or_default(),
                ))
        })
    }
