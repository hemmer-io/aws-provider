...
impl<'a> Relational_database_from_snapshot<'a> {
    ...
    pub async fn create(&self, publicly_accessible: Option<bool>, relational_database_snapshot_name: Option<String>, relational_database_name: String, availability_zone: Option<String>, source_relational_database_name: Option<String>, use_latest_restorable_time: Option<bool>, restore_time: Option<String>, tags: Option<Vec<String>>, relational_database_bundle_id: Option<String>) -> Result<String> {
