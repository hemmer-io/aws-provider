...
impl<'a> Relational_database_from_snapshot<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, relational_database_name: String, source_relational_database_name: Option<String>, use_latest_restorable_time: Option<bool>, availability_zone: Option<String>, relational_database_bundle_id: Option<String>, relational_database_snapshot_name: Option<String>, restore_time: Option<String>, publicly_accessible: Option<bool>) -> Result<String> {
