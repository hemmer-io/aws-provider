...
impl<'a> Relational_database_from_snapshot<'a> {
    ...
    pub async fn create(&self, availability_zone: Option<String>, relational_database_snapshot_name: Option<String>, use_latest_restorable_time: Option<bool>, publicly_accessible: Option<bool>, restore_time: Option<String>, relational_database_bundle_id: Option<String>, tags: Option<Vec<String>>, source_relational_database_name: Option<String>, relational_database_name: String) -> Result<String> {
