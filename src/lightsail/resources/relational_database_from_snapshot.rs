...
impl<'a> Relational_database_from_snapshot<'a> {
    ...
    pub async fn create(&self, publicly_accessible: Option<bool>, relational_database_bundle_id: Option<String>, restore_time: Option<String>, tags: Option<Vec<String>>, relational_database_name: String, use_latest_restorable_time: Option<bool>, availability_zone: Option<String>, relational_database_snapshot_name: Option<String>, source_relational_database_name: Option<String>) -> Result<String> {
