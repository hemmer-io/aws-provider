...
impl<'a> Disk_from_snapshot<'a> {
    ...
    pub async fn create(&self, tags: Option<Vec<String>>, disk_name: String, disk_snapshot_name: Option<String>, availability_zone: String, add_ons: Option<Vec<String>>, size_in_gb: i64, source_disk_name: Option<String>, restore_date: Option<String>, use_latest_restorable_auto_snapshot: Option<bool>) -> Result<String> {
