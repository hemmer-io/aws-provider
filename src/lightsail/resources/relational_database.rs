...
impl<'a> Relational_database<'a> {
    ...
    pub async fn create(&self, relational_database_name: String, availability_zone: Option<String>, master_database_name: String, tags: Option<Vec<String>>, preferred_maintenance_window: Option<String>, relational_database_blueprint_id: String, relational_database_bundle_id: String, master_user_password: Option<String>, master_username: String, preferred_backup_window: Option<String>, publicly_accessible: Option<bool>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, relational_database_name: Option<String>, availability_zone: Option<String>, master_database_name: Option<String>, tags: Option<Vec<String>>, preferred_maintenance_window: Option<String>, relational_database_blueprint_id: Option<String>, relational_database_bundle_id: Option<String>, master_user_password: Option<String>, master_username: Option<String>, preferred_backup_window: Option<String>, publicly_accessible: Option<bool>) -> Result<()> {
