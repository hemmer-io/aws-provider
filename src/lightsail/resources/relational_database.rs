...
impl<'a> Relational_database<'a> {
    ...
    pub async fn create(&self, master_username: String, preferred_maintenance_window: Option<String>, relational_database_blueprint_id: String, relational_database_name: String, publicly_accessible: Option<bool>, relational_database_bundle_id: String, tags: Option<Vec<String>>, availability_zone: Option<String>, master_database_name: String, master_user_password: Option<String>, preferred_backup_window: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, master_username: Option<String>, preferred_maintenance_window: Option<String>, relational_database_blueprint_id: Option<String>, relational_database_name: Option<String>, publicly_accessible: Option<bool>, relational_database_bundle_id: Option<String>, tags: Option<Vec<String>>, availability_zone: Option<String>, master_database_name: Option<String>, master_user_password: Option<String>, preferred_backup_window: Option<String>) -> Result<()> {
