...
impl<'a> Load_balancer<'a> {
    ...
    pub async fn create(&self, tls_policy_name: Option<String>, instance_port: i64, health_check_path: Option<String>, certificate_name: Option<String>, certificate_domain_name: Option<String>, certificate_alternative_names: Option<Vec<String>>, ip_address_type: Option<String>, load_balancer_name: String, tags: Option<Vec<String>>) -> Result<String> {
