...
impl<'a> Load_balancer<'a> {
    ...
    pub async fn create(&self, certificate_domain_name: Option<String>, ip_address_type: Option<String>, instance_port: i64, certificate_name: Option<String>, health_check_path: Option<String>, tags: Option<Vec<String>>, certificate_alternative_names: Option<Vec<String>>, tls_policy_name: Option<String>, load_balancer_name: String) -> Result<String> {
