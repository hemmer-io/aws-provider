...
impl<'a> Domain_entry<'a> {
    ...
    pub async fn create(&self, domain_name: String, domain_entry: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, domain_name: Option<String>, domain_entry: Option<String>) -> Result<()> {
