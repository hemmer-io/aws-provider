...
impl<'a> LightsailService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "instance_state" => self.plan_instance_state(current_state, desired_input).await,
            "operations_for_resource" => {
                self.plan_operations_for_resource(current_state, desired_input)
                    .await
            }
            "relational_database_events" => {
                self.plan_relational_database_events(current_state, desired_input)
                    .await
            }
            "relational_database_log_streams" => {
                self.plan_relational_database_log_streams(current_state, desired_input)
                    .await
            }
            "instance_public_ports" => {
                self.plan_instance_public_ports(current_state, desired_input)
                    .await
            }
            "distributions" => self.plan_distributions(current_state, desired_input).await,
            "instance_port_states" => {
                self.plan_instance_port_states(current_state, desired_input)
                    .await
            }
            "container_service_deployments" => {
                self.plan_container_service_deployments(current_state, desired_input)
                    .await
            }
            "container_service_registry_login" => {
                self.plan_container_service_registry_login(current_state, desired_input)
                    .await
            }
            "contact_methods" => {
                self.plan_contact_methods(current_state, desired_input)
                    .await
            }
            "alarm" => self.plan_alarm(current_state, desired_input).await,
            "bucket_access_key" => {
                self.plan_bucket_access_key(current_state, desired_input)
                    .await
            }
            "key_pair" => self.plan_key_pair(current_state, desired_input).await,
            "load_balancer" => self.plan_load_balancer(current_state, desired_input).await,
            "load_balancer_tls_certificate" => {
                self.plan_load_balancer_tls_certificate(current_state, desired_input)
                    .await
            }
            "disk_snapshots" => self.plan_disk_snapshots(current_state, desired_input).await,
            "cloud_formation_stack_records" => {
                self.plan_cloud_formation_stack_records(current_state, desired_input)
                    .await
            }
            "relational_database_snapshots" => {
                self.plan_relational_database_snapshots(current_state, desired_input)
                    .await
            }
            "static_ips" => self.plan_static_ips(current_state, desired_input).await,
            "relational_databases" => {
                self.plan_relational_databases(current_state, desired_input)
                    .await
            }
            "distribution" => self.plan_distribution(current_state, desired_input).await,
            "relational_database_snapshot" => {
                self.plan_relational_database_snapshot(current_state, desired_input)
                    .await
            }
            "container_api_metadata" => {
                self.plan_container_api_metadata(current_state, desired_input)
                    .await
            }
            "container_service_metric_data" => {
                self.plan_container_service_metric_data(current_state, desired_input)
                    .await
            }
            "container_images" => {
                self.plan_container_images(current_state, desired_input)
                    .await
            }
            "domains" => self.plan_domains(current_state, desired_input).await,
            "active_names" => self.plan_active_names(current_state, desired_input).await,
            "relational_database_from_snapshot" => {
                self.plan_relational_database_from_snapshot(current_state, desired_input)
                    .await
            }
            "bucket_bundle" => self.plan_bucket_bundle(current_state, desired_input).await,
            "relational_database_bundles" => {
                self.plan_relational_database_bundles(current_state, desired_input)
                    .await
            }
            "load_balancer_attribute" => {
                self.plan_load_balancer_attribute(current_state, desired_input)
                    .await
            }
            "container_service" => {
                self.plan_container_service(current_state, desired_input)
                    .await
            }
            "auto_snapshot" => self.plan_auto_snapshot(current_state, desired_input).await,
            "instance_snapshot" => {
                self.plan_instance_snapshot(current_state, desired_input)
                    .await
            }
            "alarms" => self.plan_alarms(current_state, desired_input).await,
            "bucket_metric_data" => {
                self.plan_bucket_metric_data(current_state, desired_input)
                    .await
            }
            "key_pairs" => self.plan_key_pairs(current_state, desired_input).await,
            ...
            "contact_method" => self.plan_contact_method(current_state, desired_input).await,
            "auto_snapshots" => self.plan_auto_snapshots(current_state, desired_input).await,
            "container_services" => {
                self.plan_container_services(current_state, desired_input)
                    .await
            }
            "bucket" => self.plan_bucket(current_state, desired_input).await,
            "load_balancer_tls_policies" => {
                self.plan_load_balancer_tls_policies(current_state, desired_input)
                    .await
            }
            "instance_access_details" => {
                self.plan_instance_access_details(current_state, desired_input)
                    .await
            }
            "disk_from_snapshot" => {
                self.plan_disk_from_snapshot(current_state, desired_input)
                    .await
            }
            "domain" => self.plan_domain(current_state, desired_input).await,
            "container_log" => self.plan_container_log(current_state, desired_input).await,
            "operations" => self.plan_operations(current_state, desired_input).await,
            "distribution_metric_data" => {
                self.plan_distribution_metric_data(current_state, desired_input)
                    .await
            }
            "disks" => self.plan_disks(current_state, desired_input).await,
            "load_balancer_tls_certificates" => {
                self.plan_load_balancer_tls_certificates(current_state, desired_input)
                    .await
            }
            "relational_database_log_events" => {
                self.plan_relational_database_log_events(current_state, desired_input)
                    .await
            }
            "static_ip" => self.plan_static_ip(current_state, desired_input).await,
            "distribution_bundle" => {
                self.plan_distribution_bundle(current_state, desired_input)
                    .await
            }
            "known_host_keys" => {
                self.plan_known_host_keys(current_state, desired_input)
                    .await
            }
            "container_image" => {
                self.plan_container_image(current_state, desired_input)
                    .await
            }
            "certificates" => self.plan_certificates(current_state, desired_input).await,
            "cost_estimate" => self.plan_cost_estimate(current_state, desired_input).await,
            "relational_database_blueprints" => {
                self.plan_relational_database_blueprints(current_state, desired_input)
                    .await
            }
            "setup_history" => self.plan_setup_history(current_state, desired_input).await,
            "instance_metadata_options" => {
                self.plan_instance_metadata_options(current_state, desired_input)
                    .await
            }
            "instances_from_snapshot" => {
                self.plan_instances_from_snapshot(current_state, desired_input)
                    .await
            }
            "instances" => self.plan_instances(current_state, desired_input).await,
            "domain_entry" => self.plan_domain_entry(current_state, desired_input).await,
            "operation" => self.plan_operation(current_state, desired_input).await,
            "relational_database_master_user_password" => {
                self.plan_relational_database_master_user_password(current_state, desired_input)
                    .await
            }
            "gui_session_access_details" => {
                self.plan_gui_session_access_details(current_state, desired_input)
                    .await
            }
            "disk" => self.plan_disk(current_state, desired_input).await,
            "bundles" => self.plan_bundles(current_state, desired_input).await,
            "container_service_powers" => {
                self.plan_container_service_powers(current_state, desired_input)
                    .await
            }
            "regions" => self.plan_regions(current_state, desired_input).await,
            "disk_snapshot" => self.plan_disk_snapshot(current_state, desired_input).await,
            "relational_database_metric_data" => {
                self.plan_relational_database_metric_data(current_state, desired_input)
                    .await
            }
            "bucket_access_keys" => {
                self.plan_bucket_access_keys(current_state, desired_input)
                    .await
            }
            "load_balancer_metric_data" => {
                self.plan_load_balancer_metric_data(current_state, desired_input)
                    .await
            }
            "instance_metric_data" => {
                self.plan_instance_metric_data(current_state, desired_input)
                    .await
            }
            "cloud_formation_stack" => {
                self.plan_cloud_formation_stack(current_state, desired_input)
                    .await
            }
            "distribution_bundles" => {
                self.plan_distribution_bundles(current_state, desired_input)
                    .await
            }
            "buckets" => self.plan_buckets(current_state, desired_input).await,
            "relational_database" => {
                self.plan_relational_database(current_state, desired_input)
                    .await
            }
            "container_service_deployment" => {
                self.plan_container_service_deployment(current_state, desired_input)
                    .await
            }
            "bucket_bundles" => self.plan_bucket_bundles(current_state, desired_input).await,
            "distribution_latest_cache_reset" => {
                self.plan_distribution_latest_cache_reset(current_state, desired_input)
                    .await
            }
            "blueprints" => self.plan_blueprints(current_state, desired_input).await,
            "relational_database_parameters" => {
                self.plan_relational_database_parameters(current_state, desired_input)
                    .await
            }
            "instance_snapshots" => {
                self.plan_instance_snapshots(current_state, desired_input)
                    .await
            }
            "export_snapshot_records" => {
                self.plan_export_snapshot_records(current_state, desired_input)
                    .await
            }
            "certificate" => self.plan_certificate(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "lightsail", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "instance_state" => self.create_instance_state(input).await,
            "operations_for_resource" => self.create_operations_for_resource(input).await,
            "relational_database_events" => self.create_relational_database_events(input).await,
            "relational_database_log_streams" => {
                self.create_relational_database_log_streams(input).await
            }
            "instance_public_ports" => self.create_instance_public_ports(input).await,
            "distributions" => self.create_distributions(input).await,
            "instance_port_states" => self.create_instance_port_states(input).await,
            "container_service_deployments" => {
            ...
            "contact_methods" => self.create_contact_methods(input).await,
            "alarm" => self.create_alarm(input).await,
            "bucket_access_key" => self.create_bucket_access_key(input).await,
            "key_pair" => self.create_key_pair(input).await,
            "load_balancer" => self.create_load_balancer(input).await,
            "load_balancer_tls_certificate" => {
                self.create_load_balancer_tls_certificate(input).await
            }
            "disk_snapshots" => self.create_disk_snapshots(input).await,
            "cloud_formation_stack_records" => {
            ...
            "static_ips" => self.create_static_ips(input).await,
            "relational_databases" => self.create_relational_databases(input).await,
            "distribution" => self.create_distribution(input).await,
            "relational_database_snapshot" => self.create_relational_database_snapshot(input).await,
            "container_api_metadata" => self.create_container_api_metadata(input).await,
            "container_service_metric_data" => {
                self.create_container_service_metric_data(input).await
            }
            "container_images" => self.create_container_images(input).await,
            "domains" => self.create_domains(input).await,
            "active_names" => self.create_active_names(input).await,
            "relational_database_from_snapshot" => {
                self.create_relational_database_from_snapshot(input).await
            }
            "bucket_bundle" => self.create_bucket_bundle(input).await,
            "relational_database_bundles" => self.create_relational_database_bundles(input).await,
            "load_balancer_attribute" => self.create_load_balancer_attribute(input).await,
            "container_service" => self.create_container_service(input).await,
            "auto_snapshot" => self.create_auto_snapshot(input).await,
            "instance_snapshot" => self.create_instance_snapshot(input).await,
            "alarms" => self.create_alarms(input).await,
            "bucket_metric_data" => self.create_bucket_metric_data(input).await,
            "key_pairs" => self.create_key_pairs(input).await,
            "load_balancers" => self.create_load_balancers(input).await,
            "instance" => self.create_instance(input).await,
            "contact_method" => self.create_contact_method(input).await,
            "auto_snapshots" => self.create_auto_snapshots(input).await,
            "container_services" => self.create_container_services(input).await,
            "bucket" => self.create_bucket(input).await,
            "load_balancer_tls_policies" => self.create_load_balancer_tls_policies(input).await,
            "instance_access_details" => self.create_instance_access_details(input).await,
            "disk_from_snapshot" => self.create_disk_from_snapshot(input).await,
            "domain" => self.create_domain(input).await,
            "container_log" => self.create_container_log(input).await,
            "operations" => self.create_operations(input).await,
            "distribution_metric_data" => self.create_distribution_metric_data(input).await,
            "disks" => self.create_disks(input).await,
            "load_balancer_tls_certificates" => {
            ...
            "static_ip" => self.create_static_ip(input).await,
            "distribution_bundle" => self.create_distribution_bundle(input).await,
            "known_host_keys" => self.create_known_host_keys(input).await,
            "container_image" => self.create_container_image(input).await,
            "certificates" => self.create_certificates(input).await,
            "cost_estimate" => self.create_cost_estimate(input).await,
            "relational_database_blueprints" => {
                self.create_relational_database_blueprints(input).await
            }
            "setup_history" => self.create_setup_history(input).await,
            "instance_metadata_options" => self.create_instance_metadata_options(input).await,
            "instances_from_snapshot" => self.create_instances_from_snapshot(input).await,
            "instances" => self.create_instances(input).await,
            "domain_entry" => self.create_domain_entry(input).await,
            "operation" => self.create_operation(input).await,
            "relational_database_master_user_password" => {
                self.create_relational_database_master_user_password(input)
                    .await
            }
            "gui_session_access_details" => self.create_gui_session_access_details(input).await,
            "disk" => self.create_disk(input).await,
            "bundles" => self.create_bundles(input).await,
            "container_service_powers" => self.create_container_service_powers(input).await,
            "regions" => self.create_regions(input).await,
            "disk_snapshot" => self.create_disk_snapshot(input).await,
            "relational_database_metric_data" => {
                self.create_relational_database_metric_data(input).await
            }
            "bucket_access_keys" => self.create_bucket_access_keys(input).await,
            "load_balancer_metric_data" => self.create_load_balancer_metric_data(input).await,
            "instance_metric_data" => self.create_instance_metric_data(input).await,
            "cloud_formation_stack" => self.create_cloud_formation_stack(input).await,
            "distribution_bundles" => self.create_distribution_bundles(input).await,
            "buckets" => self.create_buckets(input).await,
            "relational_database" => self.create_relational_database(input).await,
            "container_service_deployment" => self.create_container_service_deployment(input).await,
            "bucket_bundles" => self.create_bucket_bundles(input).await,
            "distribution_latest_cache_reset" => {
                self.create_distribution_latest_cache_reset(input).await
            }
            "blueprints" => self.create_blueprints(input).await,
            "relational_database_parameters" => {
                self.create_relational_database_parameters(input).await
            }
            "instance_snapshots" => self.create_instance_snapshots(input).await,
            "export_snapshot_records" => self.create_export_snapshot_records(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "instance_state" => self.read_instance_state(id).await,
            "operations_for_resource" => self.read_operations_for_resource(id).await,
            "relational_database_events" => self.read_relational_database_events(id).await,
            "relational_database_log_streams" => {
                self.read_relational_database_log_streams(id).await
            }
            "instance_public_ports" => self.read_instance_public_ports(id).await,
            "distributions" => self.read_distributions(id).await,
            "instance_port_states" => self.read_instance_port_states(id).await,
            "container_service_deployments" => self.read_container_service_deployments(id).await,
            "container_service_registry_login" => {
                self.read_container_service_registry_login(id).await
            }
            "contact_methods" => self.read_contact_methods(id).await,
            "alarm" => self.read_alarm(id).await,
            "bucket_access_key" => self.read_bucket_access_key(id).await,
            "key_pair" => self.read_key_pair(id).await,
            "load_balancer" => self.read_load_balancer(id).await,
            "load_balancer_tls_certificate" => self.read_load_balancer_tls_certificate(id).await,
            "disk_snapshots" => self.read_disk_snapshots(id).await,
            "cloud_formation_stack_records" => self.read_cloud_formation_stack_records(id).await,
            "relational_database_snapshots" => self.read_relational_database_snapshots(id).await,
            "static_ips" => self.read_static_ips(id).await,
            "relational_databases" => self.read_relational_databases(id).await,
            "distribution" => self.read_distribution(id).await,
            "relational_database_snapshot" => self.read_relational_database_snapshot(id).await,
            "container_api_metadata" => self.read_container_api_metadata(id).await,
            "container_service_metric_data" => self.read_container_service_metric_data(id).await,
            "container_images" => self.read_container_images(id).await,
            "domains" => self.read_domains(id).await,
            "active_names" => self.read_active_names(id).await,
            "relational_database_from_snapshot" => {
                self.read_relational_database_from_snapshot(id).await
            }
            "bucket_bundle" => self.read_bucket_bundle(id).await,
            "relational_database_bundles" => self.read_relational_database_bundles(id).await,
            "load_balancer_attribute" => self.read_load_balancer_attribute(id).await,
            "container_service" => self.read_container_service(id).await,
            "auto_snapshot" => self.read_auto_snapshot(id).await,
            "instance_snapshot" => self.read_instance_snapshot(id).await,
            "alarms" => self.read_alarms(id).await,
            "bucket_metric_data" => self.read_bucket_metric_data(id).await,
            "key_pairs" => self.read_key_pairs(id).await,
            "load_balancers" => self.read_load_balancers(id).await,
            "instance" => self.read_instance(id).await,
            "contact_method" => self.read_contact_method(id).await,
            "auto_snapshots" => self.read_auto_snapshots(id).await,
            "container_services" => self.read_container_services(id).await,
            "bucket" => self.read_bucket(id).await,
            "load_balancer_tls_policies" => self.read_load_balancer_tls_policies(id).await,
            "instance_access_details" => self.read_instance_access_details(id).await,
            "disk_from_snapshot" => self.read_disk_from_snapshot(id).await,
            "domain" => self.read_domain(id).await,
            "container_log" => self.read_container_log(id).await,
            "operations" => self.read_operations(id).await,
            "distribution_metric_data" => self.read_distribution_metric_data(id).await,
            "disks" => self.read_disks(id).await,
            "load_balancer_tls_certificates" => self.read_load_balancer_tls_certificates(id).await,
            "relational_database_log_events" => self.read_relational_database_log_events(id).await,
            "static_ip" => self.read_static_ip(id).await,
            "distribution_bundle" => self.read_distribution_bundle(id).await,
            "known_host_keys" => self.read_known_host_keys(id).await,
            "container_image" => self.read_container_image(id).await,
            "certificates" => self.read_certificates(id).await,
            "cost_estimate" => self.read_cost_estimate(id).await,
            "relational_database_blueprints" => self.read_relational_database_blueprints(id).await,
            "setup_history" => self.read_setup_history(id).await,
            "instance_metadata_options" => self.read_instance_metadata_options(id).await,
            "instances_from_snapshot" => self.read_instances_from_snapshot(id).await,
            "instances" => self.read_instances(id).await,
            "domain_entry" => self.read_domain_entry(id).await,
            "operation" => self.read_operation(id).await,
            "relational_database_master_user_password" => {
                self.read_relational_database_master_user_password(id).await
            }
            "gui_session_access_details" => self.read_gui_session_access_details(id).await,
            "disk" => self.read_disk(id).await,
            "bundles" => self.read_bundles(id).await,
            "container_service_powers" => self.read_container_service_powers(id).await,
            "regions" => self.read_regions(id).await,
            "disk_snapshot" => self.read_disk_snapshot(id).await,
            "relational_database_metric_data" => {
                self.read_relational_database_metric_data(id).await
            }
            "bucket_access_keys" => self.read_bucket_access_keys(id).await,
            "load_balancer_metric_data" => self.read_load_balancer_metric_data(id).await,
            "instance_metric_data" => self.read_instance_metric_data(id).await,
            "cloud_formation_stack" => self.read_cloud_formation_stack(id).await,
            "distribution_bundles" => self.read_distribution_bundles(id).await,
            "buckets" => self.read_buckets(id).await,
            "relational_database" => self.read_relational_database(id).await,
            "container_service_deployment" => self.read_container_service_deployment(id).await,
            "bucket_bundles" => self.read_bucket_bundles(id).await,
            "distribution_latest_cache_reset" => {
                self.read_distribution_latest_cache_reset(id).await
            }
            "blueprints" => self.read_blueprints(id).await,
            "relational_database_parameters" => self.read_relational_database_parameters(id).await,
            "instance_snapshots" => self.read_instance_snapshots(id).await,
            "export_snapshot_records" => self.read_export_snapshot_records(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "instance_state" => self.update_instance_state(id, input).await,
            "operations_for_resource" => self.update_operations_for_resource(id, input).await,
            "relational_database_events" => self.update_relational_database_events(id, input).await,
            "relational_database_log_streams" => {
                self.update_relational_database_log_streams(id, input).await
            }
            "instance_public_ports" => self.update_instance_public_ports(id, input).await,
            "distributions" => self.update_distributions(id, input).await,
            "instance_port_states" => self.update_instance_port_states(id, input).await,
            "container_service_deployments" => {
                self.update_container_service_deployments(id, input).await
            }
            "container_service_registry_login" => {
                self.update_container_service_registry_login(id, input)
                    .await
            }
            "contact_methods" => self.update_contact_methods(id, input).await,
            "alarm" => self.update_alarm(id, input).await,
            "bucket_access_key" => self.update_bucket_access_key(id, input).await,
            "key_pair" => self.update_key_pair(id, input).await,
            "load_balancer" => self.update_load_balancer(id, input).await,
            "load_balancer_tls_certificate" => {
                self.update_load_balancer_tls_certificate(id, input).await
            }
            "disk_snapshots" => self.update_disk_snapshots(id, input).await,
            "cloud_formation_stack_records" => {
            ...
            "static_ips" => self.update_static_ips(id, input).await,
            "relational_databases" => self.update_relational_databases(id, input).await,
            "distribution" => self.update_distribution(id, input).await,
            "relational_database_snapshot" => {
                self.update_relational_database_snapshot(id, input).await
            }
            "container_api_metadata" => self.update_container_api_metadata(id, input).await,
            "container_service_metric_data" => {
                self.update_container_service_metric_data(id, input).await
            }
            "container_images" => self.update_container_images(id, input).await,
            "domains" => self.update_domains(id, input).await,
            "active_names" => self.update_active_names(id, input).await,
            "relational_database_from_snapshot" => {
                self.update_relational_database_from_snapshot(id, input)
                    .await
            }
            "bucket_bundle" => self.update_bucket_bundle(id, input).await,
            "relational_database_bundles" => {
                self.update_relational_database_bundles(id, input).await
            }
            "load_balancer_attribute" => self.update_load_balancer_attribute(id, input).await,
            "container_service" => self.update_container_service(id, input).await,
            "auto_snapshot" => self.update_auto_snapshot(id, input).await,
            "instance_snapshot" => self.update_instance_snapshot(id, input).await,
            "alarms" => self.update_alarms(id, input).await,
            "bucket_metric_data" => self.update_bucket_metric_data(id, input).await,
            "key_pairs" => self.update_key_pairs(id, input).await,
            "load_balancers" => self.update_load_balancers(id, input).await,
            "instance" => self.update_instance(id, input).await,
            "contact_method" => self.update_contact_method(id, input).await,
            "auto_snapshots" => self.update_auto_snapshots(id, input).await,
            "container_services" => self.update_container_services(id, input).await,
            "bucket" => self.update_bucket(id, input).await,
            "load_balancer_tls_policies" => self.update_load_balancer_tls_policies(id, input).await,
            "instance_access_details" => self.update_instance_access_details(id, input).await,
            "disk_from_snapshot" => self.update_disk_from_snapshot(id, input).await,
            "domain" => self.update_domain(id, input).await,
            "container_log" => self.update_container_log(id, input).await,
            "operations" => self.update_operations(id, input).await,
            "distribution_metric_data" => self.update_distribution_metric_data(id, input).await,
            "disks" => self.update_disks(id, input).await,
            "load_balancer_tls_certificates" => {
            ...
            "static_ip" => self.update_static_ip(id, input).await,
            "distribution_bundle" => self.update_distribution_bundle(id, input).await,
            "known_host_keys" => self.update_known_host_keys(id, input).await,
            "container_image" => self.update_container_image(id, input).await,
            "certificates" => self.update_certificates(id, input).await,
            "cost_estimate" => self.update_cost_estimate(id, input).await,
            "relational_database_blueprints" => {
                self.update_relational_database_blueprints(id, input).await
            }
            "setup_history" => self.update_setup_history(id, input).await,
            "instance_metadata_options" => self.update_instance_metadata_options(id, input).await,
            "instances_from_snapshot" => self.update_instances_from_snapshot(id, input).await,
            "instances" => self.update_instances(id, input).await,
            "domain_entry" => self.update_domain_entry(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "relational_database_master_user_password" => {
                self.update_relational_database_master_user_password(id, input)
                    .await
            }
            "gui_session_access_details" => self.update_gui_session_access_details(id, input).await,
            "disk" => self.update_disk(id, input).await,
            "bundles" => self.update_bundles(id, input).await,
            "container_service_powers" => self.update_container_service_powers(id, input).await,
            "regions" => self.update_regions(id, input).await,
            "disk_snapshot" => self.update_disk_snapshot(id, input).await,
            "relational_database_metric_data" => {
                self.update_relational_database_metric_data(id, input).await
            }
            "bucket_access_keys" => self.update_bucket_access_keys(id, input).await,
            "load_balancer_metric_data" => self.update_load_balancer_metric_data(id, input).await,
            "instance_metric_data" => self.update_instance_metric_data(id, input).await,
            "cloud_formation_stack" => self.update_cloud_formation_stack(id, input).await,
            "distribution_bundles" => self.update_distribution_bundles(id, input).await,
            "buckets" => self.update_buckets(id, input).await,
            "relational_database" => self.update_relational_database(id, input).await,
            "container_service_deployment" => {
                self.update_container_service_deployment(id, input).await
            }
            "bucket_bundles" => self.update_bucket_bundles(id, input).await,
            "distribution_latest_cache_reset" => {
                self.update_distribution_latest_cache_reset(id, input).await
            }
            "blueprints" => self.update_blueprints(id, input).await,
            "relational_database_parameters" => {
                self.update_relational_database_parameters(id, input).await
            }
            "instance_snapshots" => self.update_instance_snapshots(id, input).await,
            "export_snapshot_records" => self.update_export_snapshot_records(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "instance_state" => self.delete_instance_state(id).await,
            "operations_for_resource" => self.delete_operations_for_resource(id).await,
            "relational_database_events" => self.delete_relational_database_events(id).await,
            "relational_database_log_streams" => {
                self.delete_relational_database_log_streams(id).await
            }
            "instance_public_ports" => self.delete_instance_public_ports(id).await,
            "distributions" => self.delete_distributions(id).await,
            "instance_port_states" => self.delete_instance_port_states(id).await,
            "container_service_deployments" => self.delete_container_service_deployments(id).await,
            "container_service_registry_login" => {
                self.delete_container_service_registry_login(id).await
            }
            "contact_methods" => self.delete_contact_methods(id).await,
            "alarm" => self.delete_alarm(id).await,
            "bucket_access_key" => self.delete_bucket_access_key(id).await,
            "key_pair" => self.delete_key_pair(id).await,
            "load_balancer" => self.delete_load_balancer(id).await,
            "load_balancer_tls_certificate" => self.delete_load_balancer_tls_certificate(id).await,
            "disk_snapshots" => self.delete_disk_snapshots(id).await,
            "cloud_formation_stack_records" => self.delete_cloud_formation_stack_records(id).await,
            "relational_database_snapshots" => self.delete_relational_database_snapshots(id).await,
            "static_ips" => self.delete_static_ips(id).await,
            "relational_databases" => self.delete_relational_databases(id).await,
            "distribution" => self.delete_distribution(id).await,
            "relational_database_snapshot" => self.delete_relational_database_snapshot(id).await,
            "container_api_metadata" => self.delete_container_api_metadata(id).await,
            "container_service_metric_data" => self.delete_container_service_metric_data(id).await,
            "container_images" => self.delete_container_images(id).await,
            "domains" => self.delete_domains(id).await,
            "active_names" => self.delete_active_names(id).await,
            "relational_database_from_snapshot" => {
                self.delete_relational_database_from_snapshot(id).await
            }
            "bucket_bundle" => self.delete_bucket_bundle(id).await,
            "relational_database_bundles" => self.delete_relational_database_bundles(id).await,
            "load_balancer_attribute" => self.delete_load_balancer_attribute(id).await,
            "container_service" => self.delete_container_service(id).await,
            "auto_snapshot" => self.delete_auto_snapshot(id).await,
            "instance_snapshot" => self.delete_instance_snapshot(id).await,
            "alarms" => self.delete_alarms(id).await,
            "bucket_metric_data" => self.delete_bucket_metric_data(id).await,
            "key_pairs" => self.delete_key_pairs(id).await,
            "load_balancers" => self.delete_load_balancers(id).await,
            "instance" => self.delete_instance(id).await,
            "contact_method" => self.delete_contact_method(id).await,
            "auto_snapshots" => self.delete_auto_snapshots(id).await,
            "container_services" => self.delete_container_services(id).await,
            "bucket" => self.delete_bucket(id).await,
            "load_balancer_tls_policies" => self.delete_load_balancer_tls_policies(id).await,
            "instance_access_details" => self.delete_instance_access_details(id).await,
            "disk_from_snapshot" => self.delete_disk_from_snapshot(id).await,
            "domain" => self.delete_domain(id).await,
            "container_log" => self.delete_container_log(id).await,
            "operations" => self.delete_operations(id).await,
            "distribution_metric_data" => self.delete_distribution_metric_data(id).await,
            "disks" => self.delete_disks(id).await,
            "load_balancer_tls_certificates" => {
            ...
            "static_ip" => self.delete_static_ip(id).await,
            "distribution_bundle" => self.delete_distribution_bundle(id).await,
            "known_host_keys" => self.delete_known_host_keys(id).await,
            "container_image" => self.delete_container_image(id).await,
            "certificates" => self.delete_certificates(id).await,
            "cost_estimate" => self.delete_cost_estimate(id).await,
            "relational_database_blueprints" => {
                self.delete_relational_database_blueprints(id).await
            }
            "setup_history" => self.delete_setup_history(id).await,
            "instance_metadata_options" => self.delete_instance_metadata_options(id).await,
            "instances_from_snapshot" => self.delete_instances_from_snapshot(id).await,
            "instances" => self.delete_instances(id).await,
            "domain_entry" => self.delete_domain_entry(id).await,
            "operation" => self.delete_operation(id).await,
            "relational_database_master_user_password" => {
                self.delete_relational_database_master_user_password(id)
                    .await
            }
            "gui_session_access_details" => self.delete_gui_session_access_details(id).await,
            "disk" => self.delete_disk(id).await,
            "bundles" => self.delete_bundles(id).await,
            "container_service_powers" => self.delete_container_service_powers(id).await,
            "regions" => self.delete_regions(id).await,
            "disk_snapshot" => self.delete_disk_snapshot(id).await,
            "relational_database_metric_data" => {
                self.delete_relational_database_metric_data(id).await
            }
            "bucket_access_keys" => self.delete_bucket_access_keys(id).await,
            "load_balancer_metric_data" => self.delete_load_balancer_metric_data(id).await,
            "instance_metric_data" => self.delete_instance_metric_data(id).await,
            "cloud_formation_stack" => self.delete_cloud_formation_stack(id).await,
            "distribution_bundles" => self.delete_distribution_bundles(id).await,
            "buckets" => self.delete_buckets(id).await,
            "relational_database" => self.delete_relational_database(id).await,
            "container_service_deployment" => self.delete_container_service_deployment(id).await,
            "bucket_bundles" => self.delete_bucket_bundles(id).await,
            "distribution_latest_cache_reset" => {
                self.delete_distribution_latest_cache_reset(id).await
            }
            "blueprints" => self.delete_blueprints(id).await,
            "relational_database_parameters" => {
                self.delete_relational_database_parameters(id).await
            }
            "instance_snapshots" => self.delete_instance_snapshots(id).await,
            "export_snapshot_records" => self.delete_export_snapshot_records(id).await,
    ...
    async fn create_instance_state(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_instance_state(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_instance_state(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_operations_for_resource(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_operations_for_resource(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_operations_for_resource(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_relational_database_events(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_relational_database_events(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_relational_database_log_streams(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_relational_database_log_streams(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_instance_public_ports(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_public_ports(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_instance_public_ports(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_distributions(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_distributions(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_distributions(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_distributions(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_instance_port_states(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_port_states(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_instance_port_states(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_container_service_deployments(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_container_service_deployments(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_container_service_registry_login(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_container_service_registry_login(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_contact_methods(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_contact_methods(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_contact_methods(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_alarm(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "datapoints_to_alarm",
                    datapoints_to_alarm.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    notification_triggers.unwrap_or_default(),
                )
                .with_field(
                    "notification_enabled",
                    notification_enabled.unwrap_or_default(),
                )
                .with_field(
                    "comparison_operator",
                    comparison_operator.unwrap_or_default(),
                )
                .with_field("contact_protocols", contact_protocols.unwrap_or_default())
                .with_field(
                    "monitored_resource_name",
                    monitored_resource_name.unwrap_or_default(),
                )
    ...
    async fn create_bucket_access_key(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_bucket_access_key(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_bucket_access_key(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_key_pair(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_key_pair(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_key_pair(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            let key_pair_name = input.get_string("key_pair_name")?;
    ...
    async fn create_load_balancer(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let certificate_alternative_names =
                input.get_optional_string("certificate_alternative_names")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    certificate_alternative_names.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    certificate_domain_name.unwrap_or_default(),
                )
    ...
    async fn read_load_balancer_tls_certificate(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_load_balancer_tls_certificate(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_disk_snapshots(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_disk_snapshots(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_disk_snapshots(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_cloud_formation_stack_records(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_cloud_formation_stack_records(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_relational_database_snapshots(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_relational_database_snapshots(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_static_ips(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_static_ips(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_static_ips(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_static_ips(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_relational_databases(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_relational_databases(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_relational_databases(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_distribution(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let viewer_minimum_tls_protocol_version =
                input.get_optional_string("viewer_minimum_tls_protocol_version")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    default_cache_behavior.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("certificate_name", certificate_name.unwrap_or_default())
                .with_field("ip_address_type", ip_address_type.unwrap_or_default())
                ...
                .with_field(
                    ...
                    cache_behavior_settings.unwrap_or_default(),
                )
                .with_field(
                    "viewer_minimum_tls_protocol_version",
                    viewer_minimum_tls_protocol_version.unwrap_or_default(),
                )
    ...
    async fn read_distribution(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_distribution(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let default_cache_behavior = input.get_string("default_cache_behavior")?;
            let tags = input.get_optional_string("tags")?;
    ...
    async fn create_relational_database_snapshot(
        ...
        self.provider.runtime().block_on(async {
            ...
            let tags = input.get_optional_string("tags")?;
            let relational_database_snapshot_name =
                input.get_string("relational_database_snapshot_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    relational_database_name.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "relational_database_snapshot_name",
                    relational_database_snapshot_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a relational_database_snapshot resource
    async fn read_relational_database_snapshot(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_relational_database_snapshot(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_container_api_metadata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_container_api_metadata(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_container_api_metadata(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_container_service_metric_data(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_container_service_metric_data(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_container_images(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_container_images(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_container_images(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_active_names(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_active_names(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_active_names(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_active_names(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_relational_database_from_snapshot(
        ...
        self.provider.runtime().block_on(async {
            ...
            let relational_database_snapshot_name =
                input.get_optional_string("relational_database_snapshot_name")?;
            let use_latest_restorable_time =
                input.get_optional_string("use_latest_restorable_time")?;
            ...
            let relational_database_bundle_id =
                input.get_optional_string("relational_database_bundle_id")?;
            let tags = input.get_optional_string("tags")?;
            let source_relational_database_name =
                input.get_optional_string("source_relational_database_name")?;
            let relational_database_name = input.get_string("relational_database_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    use_latest_restorable_time.unwrap_or_default(),
                )
                .with_field(
                    "publicly_accessible",
                ...
                .with_field(
                    ...
                    relational_database_bundle_id.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field(
                    "source_relational_database_name",
                    source_relational_database_name.unwrap_or_default(),
                )
                .with_field(
                    "relational_database_name",
                    relational_database_name.unwrap_or_default(),
    ...
    async fn read_relational_database_from_snapshot(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_relational_database_from_snapshot(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_bucket_bundle(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let bundle_id = input.get_string("bundle_id")?;
    ...
    async fn read_bucket_bundle(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_bucket_bundle(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let bundle_id = input.get_string("bundle_id")?;
            let bucket_name = input.get_string("bucket_name")?;
    ...
    async fn delete_bucket_bundle(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_relational_database_bundles(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_relational_database_bundles(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_load_balancer_attribute(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let load_balancer_name = input.get_string("load_balancer_name")?;
    ...
    async fn read_load_balancer_attribute(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_load_balancer_attribute(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_container_service(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    private_registry_access.unwrap_or_default(),
                )
                .with_field("power", power.unwrap_or_default())
                .with_field(
                    "public_domain_names",
                    public_domain_names.unwrap_or_default(),
                ))
        })
    }

    /// Read a container_service resource
    async fn read_container_service(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_container_service(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_auto_snapshot(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_auto_snapshot(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_auto_snapshot(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_auto_snapshot(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_instance_snapshot(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let instance_name = input.get_string("instance_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    instance_snapshot_name.unwrap_or_default(),
                ))
        })
    }

    /// Read a instance_snapshot resource
    async fn read_instance_snapshot(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_instance_snapshot(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_alarms(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_alarms(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_alarms(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_alarms(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_bucket_metric_data(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_bucket_metric_data(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_bucket_metric_data(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_key_pairs(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_key_pairs(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_key_pairs(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_key_pairs(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_contact_method(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_contact_method(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_contact_method(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_auto_snapshots(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_auto_snapshots(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_auto_snapshots(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_container_services(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_container_services(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_container_services(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    enable_object_versioning.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn read_load_balancer_tls_policies(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_load_balancer_tls_policies(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_instance_access_details(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_access_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_instance_access_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_disk_from_snapshot(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let tags = input.get_optional_string("tags")?;
            ...
            let use_latest_restorable_auto_snapshot =
                input.get_optional_string("use_latest_restorable_auto_snapshot")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    use_latest_restorable_auto_snapshot.unwrap_or_default(),
                ))
        })
    }

    /// Read a disk_from_snapshot resource
    async fn read_disk_from_snapshot(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_disk_from_snapshot(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_container_log(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_container_log(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_container_log(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_container_log(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_operations(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_operations(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_operations(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_operations(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_distribution_metric_data(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_distribution_metric_data(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_disks(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_disks(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_disks(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_disks(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_load_balancer_tls_certificates(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_load_balancer_tls_certificates(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_relational_database_log_events(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_relational_database_log_events(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_static_ip(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_static_ip(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_static_ip(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_static_ip(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_distribution_bundle(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_distribution_bundle(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_distribution_bundle(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_known_host_keys(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_known_host_keys(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_known_host_keys(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_container_image(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_container_image(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_container_image(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_certificates(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_certificates(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_certificates(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_certificates(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_cost_estimate(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cost_estimate(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_cost_estimate(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_cost_estimate(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_relational_database_blueprints(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_relational_database_blueprints(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_setup_history(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_setup_history(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_setup_history(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_setup_history(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_instance_metadata_options(
        ...
        self.provider.runtime().block_on(async {
            ...
            let http_put_response_hop_limit =
                input.get_optional_string("http_put_response_hop_limit")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    http_put_response_hop_limit.unwrap_or_default(),
                ))
        })
    }

    /// Read a instance_metadata_options resource
    async fn read_instance_metadata_options(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_instance_metadata_options(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_instances_from_snapshot(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let add_ons = input.get_optional_string("add_ons")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    attached_disk_mapping.unwrap_or_default(),
                )
                .with_field("ip_address_type", ip_address_type.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("availability_zone", availability_zone.unwrap_or_default())
                ...
                .with_field(
                    ...
                    source_instance_name.unwrap_or_default(),
                )
                .with_field("key_pair_name", key_pair_name.unwrap_or_default())
                .with_field(
                    "use_latest_restorable_auto_snapshot",
    ...
    async fn read_instances_from_snapshot(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_instances_from_snapshot(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_instances(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let ip_address_type = input.get_optional_string("ip_address_type")?;
    ...
    async fn read_instances(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_instances(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let ip_address_type = input.get_optional_string("ip_address_type")?;
            let custom_image_name = input.get_optional_string("custom_image_name")?;
    ...
    async fn delete_instances(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_domain_entry(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let domain_name = input.get_string("domain_name")?;
    ...
    async fn read_domain_entry(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_domain_entry(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let domain_name = input.get_string("domain_name")?;
            let domain_entry = input.get_string("domain_entry")?;
    ...
    async fn delete_domain_entry(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn delete_relational_database_master_user_password(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_gui_session_access_details(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_gui_session_access_details(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_disk(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let availability_zone = input.get_string("availability_zone")?;
    ...
    async fn read_disk(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_disk(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let availability_zone = input.get_string("availability_zone")?;
            let add_ons = input.get_optional_string("add_ons")?;
    ...
    async fn create_bundles(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_bundles(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_bundles(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_bundles(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_container_service_powers(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_container_service_powers(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_disk_snapshot(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_disk_snapshot(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_disk_snapshot(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let instance_name = input.get_optional_string("instance_name")?;
            let disk_name = input.get_optional_string("disk_name")?;
    ...
    async fn delete_disk_snapshot(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_relational_database_metric_data(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_relational_database_metric_data(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_bucket_access_keys(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_bucket_access_keys(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_bucket_access_keys(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_load_balancer_metric_data(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_load_balancer_metric_data(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_instance_metric_data(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_metric_data(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_instance_metric_data(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_cloud_formation_stack(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_cloud_formation_stack(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_cloud_formation_stack(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_distribution_bundles(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_distribution_bundles(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_distribution_bundles(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_buckets(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_buckets(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_buckets(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_buckets(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_relational_database(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            let tags = input.get_optional_string("tags")?;
            let relational_database_bundle_id =
                input.get_string("relational_database_bundle_id")?;
            let preferred_maintenance_window =
                input.get_optional_string("preferred_maintenance_window")?;
            let availability_zone = input.get_optional_string("availability_zone")?;
            let relational_database_blueprint_id =
                input.get_string("relational_database_blueprint_id")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    master_database_name.unwrap_or_default(),
                )
                .with_field(
                    "publicly_accessible",
                    publicly_accessible.unwrap_or_default(),
                ...
                .with_field(
                    ...
                    relational_database_blueprint_id.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    preferred_backup_window.unwrap_or_default(),
                ))
        })
    }

    /// Read a relational_database resource
    async fn read_relational_database(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_relational_database(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_container_service_deployment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_container_service_deployment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_bucket_bundles(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_bucket_bundles(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_bucket_bundles(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_distribution_latest_cache_reset(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_distribution_latest_cache_reset(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_blueprints(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_blueprints(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn update_blueprints(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_blueprints(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn read_relational_database_parameters(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_relational_database_parameters(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_instance_snapshots(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_instance_snapshots(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_instance_snapshots(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_export_snapshot_records(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_export_snapshot_records(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.lightsail_client
    ...
    async fn delete_export_snapshot_records(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.lightsail_client
    ...
    async fn create_certificate(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let subject_alternative_names =
                input.get_optional_string("subject_alternative_names")?;
            let tags = input.get_optional_string("tags")?;
            let domain_name = input.get_string("domain_name")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    subject_alternative_names.unwrap_or_default(),
                )
                .with_field("tags", tags.unwrap_or_default())
                .with_field("domain_name", domain_name.unwrap_or_default()))
        })
