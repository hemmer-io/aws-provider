...
impl<'a> External_model<'a> {
    ...
    pub async fn create(&self, invoke_model_endpoint_role_arn: String, tags: Option<Vec<String>>, output_configuration: String, model_endpoint_status: String, model_endpoint: String, model_source: String, input_configuration: String) -> Result<String> {
