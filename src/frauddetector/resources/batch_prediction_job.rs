...
impl<'a> Batch_prediction_job<'a> {
    ...
    pub async fn create(&self, detector_name: String, iam_role_arn: String, event_type_name: String, job_id: String, output_path: String, tags: Option<Vec<String>>, input_path: String, detector_version: Option<String>) -> Result<String> {
