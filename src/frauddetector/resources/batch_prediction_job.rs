...
impl<'a> Batch_prediction_job<'a> {
    ...
    pub async fn create(&self, output_path: String, job_id: String, detector_name: String, iam_role_arn: String, detector_version: Option<String>, input_path: String, tags: Option<Vec<String>>, event_type_name: String) -> Result<String> {
