...
impl<'a> Batch_import_job<'a> {
    ...
    pub async fn create(&self, job_id: String, tags: Option<Vec<String>>, iam_role_arn: String, event_type_name: String, output_path: String, input_path: String) -> Result<String> {
