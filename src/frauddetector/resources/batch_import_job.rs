...
impl<'a> Batch_import_job<'a> {
    ...
    pub async fn create(&self, job_id: String, tags: Option<Vec<String>>, event_type_name: String, output_path: String, iam_role_arn: String, input_path: String) -> Result<String> {
