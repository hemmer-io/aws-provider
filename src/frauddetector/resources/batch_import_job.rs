...
impl<'a> Batch_import_job<'a> {
    ...
    pub async fn create(&self, job_id: String, output_path: String, input_path: String, event_type_name: String, iam_role_arn: String, tags: Option<Vec<String>>) -> Result<String> {
