...
impl<'a> Event_label<'a> {
    ...
    pub async fn update(&self, id: &str, label_timestamp: Option<String>, assigned_label: Option<String>, event_type_name: Option<String>, event_id: Option<String>) -> Result<()> {
