...
impl<'a> Event_label<'a> {
    ...
    pub async fn update(&self, id: &str, event_id: Option<String>, event_type_name: Option<String>, assigned_label: Option<String>, label_timestamp: Option<String>) -> Result<()> {
