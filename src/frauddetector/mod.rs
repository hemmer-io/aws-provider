...
//!
//! Auto-generated service module for frauddetector

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for frauddetector
...
impl<'a> FrauddetectorService<'a> {
    ...
    /// Get kmsencryption_key resource handler
    pub fn kmsencryption_key(&self) -> resources::Kmsencryption_key<'_> {
        resources::Kmsencryption_key::new(self.provider)
    }
