...
impl<'a> FrauddetectorService<'a> {
    ...
    async fn create_kms_encryption_key(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("kms_encryption_key_arn", kms_encryption_key_arn.unwrap_or_default())
            )
        })
    }

    /// Read a kms_encryption_key resource
    async fn read_kms_encryption_key(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_kms_encryption_key(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
