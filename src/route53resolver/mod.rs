...
impl<'a> Route53resolverService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "firewall_rule_group" => {
                self.plan_firewall_rule_group(current_state, desired_input).await
            }
            "resolver_rule_association" => {
                self.plan_resolver_rule_association(current_state, desired_input).await
            }
            "resolver_dnssec_config" => {
                self.plan_resolver_dnssec_config(current_state, desired_input).await
            }
            "firewall_rule_group_policy" => {
                self.plan_firewall_rule_group_policy(current_state, desired_input).await
            }
            "resolver_query_log_config" => {
                self.plan_resolver_query_log_config(current_state, desired_input).await
            }
            "firewall_config" => {
                self.plan_firewall_config(current_state, desired_input).await
            }
            "firewall_rule_group_association" => {
                self.plan_firewall_rule_group_association(current_state, desired_input).await
            }
            "firewall_domains" => {
                self.plan_firewall_domains(current_state, desired_input).await
            }
            "firewall_rule" => {
                self.plan_firewall_rule(current_state, desired_input).await
            }
            "resolver_config" => {
                self.plan_resolver_config(current_state, desired_input).await
            }
            "resolver_rule" => {
                self.plan_resolver_rule(current_state, desired_input).await
            }
            "resolver_endpoint" => {
                self.plan_resolver_endpoint(current_state, desired_input).await
            }
            "firewall_domain_list" => {
                self.plan_firewall_domain_list(current_state, desired_input).await
            }
            "resolver_rule_policy" => {
                self.plan_resolver_rule_policy(current_state, desired_input).await
            }
            "outpost_resolver" => {
                self.plan_outpost_resolver(current_state, desired_input).await
            }
            "resolver_query_log_config_policy" => {
                self.plan_resolver_query_log_config_policy(current_state, desired_input).await
            }
            "resolver_query_log_config_association" => {
                self.plan_resolver_query_log_config_association(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "firewall_rule_group" => {
                self.create_firewall_rule_group(input).await
            }
            "resolver_rule_association" => {
                self.create_resolver_rule_association(input).await
            }
            "resolver_dnssec_config" => {
                self.create_resolver_dnssec_config(input).await
            }
            "firewall_rule_group_policy" => {
                self.create_firewall_rule_group_policy(input).await
            }
            "resolver_query_log_config" => {
                self.create_resolver_query_log_config(input).await
            }
            "firewall_config" => {
                self.create_firewall_config(input).await
            }
            "firewall_rule_group_association" => {
                self.create_firewall_rule_group_association(input).await
            }
            "firewall_domains" => {
                self.create_firewall_domains(input).await
            }
            "firewall_rule" => {
                self.create_firewall_rule(input).await
            }
            "resolver_config" => {
                self.create_resolver_config(input).await
            }
            "resolver_rule" => {
                self.create_resolver_rule(input).await
            }
            "resolver_endpoint" => {
                self.create_resolver_endpoint(input).await
            }
            "firewall_domain_list" => {
                self.create_firewall_domain_list(input).await
            }
            "resolver_rule_policy" => {
                self.create_resolver_rule_policy(input).await
            }
            "outpost_resolver" => {
                self.create_outpost_resolver(input).await
            }
            "resolver_query_log_config_policy" => {
                self.create_resolver_query_log_config_policy(input).await
            }
            "resolver_query_log_config_association" => {
                self.create_resolver_query_log_config_association(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route53resolver",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "firewall_rule_group" => {
                self.read_firewall_rule_group(id).await
            }
            "resolver_rule_association" => {
                self.read_resolver_rule_association(id).await
            }
            "resolver_dnssec_config" => {
                self.read_resolver_dnssec_config(id).await
            }
            "firewall_rule_group_policy" => {
                self.read_firewall_rule_group_policy(id).await
            }
            "resolver_query_log_config" => {
                self.read_resolver_query_log_config(id).await
            }
            "firewall_config" => {
                self.read_firewall_config(id).await
            }
            "firewall_rule_group_association" => {
                self.read_firewall_rule_group_association(id).await
            }
            "firewall_domains" => {
                self.read_firewall_domains(id).await
            }
            "firewall_rule" => {
                self.read_firewall_rule(id).await
            }
            "resolver_config" => {
                self.read_resolver_config(id).await
            }
            "resolver_rule" => {
                self.read_resolver_rule(id).await
            }
            "resolver_endpoint" => {
                self.read_resolver_endpoint(id).await
            }
            "firewall_domain_list" => {
                self.read_firewall_domain_list(id).await
            }
            "resolver_rule_policy" => {
                self.read_resolver_rule_policy(id).await
            }
            "outpost_resolver" => {
                self.read_outpost_resolver(id).await
            }
            "resolver_query_log_config_policy" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "firewall_rule_group" => {
                self.update_firewall_rule_group(id, input).await
            }
            "resolver_rule_association" => {
                self.update_resolver_rule_association(id, input).await
            }
            "resolver_dnssec_config" => {
                self.update_resolver_dnssec_config(id, input).await
            }
            "firewall_rule_group_policy" => {
                self.update_firewall_rule_group_policy(id, input).await
            }
            "resolver_query_log_config" => {
                self.update_resolver_query_log_config(id, input).await
            }
            "firewall_config" => {
                self.update_firewall_config(id, input).await
            }
            "firewall_rule_group_association" => {
                self.update_firewall_rule_group_association(id, input).await
            }
            "firewall_domains" => {
                self.update_firewall_domains(id, input).await
            }
            "firewall_rule" => {
                self.update_firewall_rule(id, input).await
            }
            "resolver_config" => {
                self.update_resolver_config(id, input).await
            }
            "resolver_rule" => {
                self.update_resolver_rule(id, input).await
            }
            "resolver_endpoint" => {
                self.update_resolver_endpoint(id, input).await
            }
            "firewall_domain_list" => {
                self.update_firewall_domain_list(id, input).await
            }
            "resolver_rule_policy" => {
                self.update_resolver_rule_policy(id, input).await
            }
            "outpost_resolver" => {
                self.update_outpost_resolver(id, input).await
            }
            "resolver_query_log_config_policy" => {
                self.update_resolver_query_log_config_policy(id, input).await
            }
            "resolver_query_log_config_association" => {
                self.update_resolver_query_log_config_association(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "route53resolver",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "firewall_rule_group" => {
                self.delete_firewall_rule_group(id).await
            }
            "resolver_rule_association" => {
                self.delete_resolver_rule_association(id).await
            }
            "resolver_dnssec_config" => {
                self.delete_resolver_dnssec_config(id).await
            }
            "firewall_rule_group_policy" => {
                self.delete_firewall_rule_group_policy(id).await
            }
            "resolver_query_log_config" => {
                self.delete_resolver_query_log_config(id).await
            }
            "firewall_config" => {
                self.delete_firewall_config(id).await
            }
            "firewall_rule_group_association" => {
                self.delete_firewall_rule_group_association(id).await
            }
            "firewall_domains" => {
                self.delete_firewall_domains(id).await
            }
            "firewall_rule" => {
                self.delete_firewall_rule(id).await
            }
            "resolver_config" => {
                self.delete_resolver_config(id).await
            }
            "resolver_rule" => {
                self.delete_resolver_rule(id).await
            }
            "resolver_endpoint" => {
                self.delete_resolver_endpoint(id).await
            }
            "firewall_domain_list" => {
                self.delete_firewall_domain_list(id).await
            }
            "resolver_rule_policy" => {
                self.delete_resolver_rule_policy(id).await
            }
            "outpost_resolver" => {
                self.delete_outpost_resolver(id).await
            }
            "resolver_query_log_config_policy" => {
    ...
    async fn read_firewall_rule_group(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_resolver_rule_association(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resolver_rule_association(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_resolver_dnssec_config(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn read_resolver_dnssec_config(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resolver_dnssec_config(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_firewall_rule_group_policy(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("firewall_rule_group_policy", firewall_rule_group_policy.unwrap_or_default())
            )
        })
    }

    /// Read a firewall_rule_group_policy resource
    async fn read_firewall_rule_group_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_firewall_rule_group_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_resolver_query_log_config(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_firewall_config(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
    ...
    async fn delete_firewall_config(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_firewall_rule_group_association(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let firewall_rule_group_association_id = input.get_string("firewall_rule_group_association_id")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("firewall_rule_group_association_id", firewall_rule_group_association_id.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                .with_field("priority", priority.unwrap_or_default())
                .with_field("mutation_protection", mutation_protection.unwrap_or_default())
            )
        })
    }

    /// Read a firewall_rule_group_association resource
    async fn read_firewall_rule_group_association(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_firewall_rule_group_association(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_firewall_domains(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("firewall_domain_list_id", firewall_domain_list_id.unwrap_or_default())
            )
        })
    }

    /// Read a firewall_domains resource
    async fn read_firewall_domains(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_firewall_domains(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_firewall_rule(
        ...
        self.provider.runtime().block_on(async {
            ...
            let firewall_domain_redirection_action = input.get_optional_string("firewall_domain_redirection_action")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("dns_threat_protection", dns_threat_protection.unwrap_or_default())
                .with_field("confidence_threshold", confidence_threshold.unwrap_or_default())
                .with_field("creator_request_id", creator_request_id.unwrap_or_default())
                .with_field("firewall_rule_group_id", firewall_rule_group_id.unwrap_or_default())
                .with_field("firewall_domain_list_id", firewall_domain_list_id.unwrap_or_default())
                .with_field("action", action.unwrap_or_default())
                .with_field("block_response", block_response.unwrap_or_default())
                .with_field("block_override_domain", block_override_domain.unwrap_or_default())
                .with_field("block_override_ttl", block_override_ttl.unwrap_or_default())
                .with_field("name", name.unwrap_or_default())
                .with_field("block_override_dns_type", block_override_dns_type.unwrap_or_default())
                .with_field("firewall_domain_redirection_action", firewall_domain_redirection_action.unwrap_or_default())
                .with_field("priority", priority.unwrap_or_default())
            )
        })
    }
    ...
    async fn create_resolver_config(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("autodefined_reverse_flag", autodefined_reverse_flag.unwrap_or_default())
                .with_field("resource_id", resource_id.unwrap_or_default())
            )
        })
    }
    ...
    async fn delete_resolver_config(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_resolver_rule(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("name", name.unwrap_or_default())
                .with_field("resolver_endpoint_id", resolver_endpoint_id.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
            )
        })
    }
    ...
    async fn create_resolver_endpoint(
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field("preferred_instance_type", preferred_instance_type.unwrap_or_default())
                .with_field("direction", direction.unwrap_or_default())
                .with_field("tags", tags.unwrap_or_default())
                .with_field("resolver_endpoint_type", resolver_endpoint_type.unwrap_or_default())
    ...
    async fn read_resolver_endpoint(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_firewall_domain_list(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_resolver_rule_policy(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("resolver_rule_policy", resolver_rule_policy.unwrap_or_default())
                .with_field("arn", arn.unwrap_or_default())
            )
        })
    }
    ...
    async fn read_resolver_rule_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resolver_rule_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_outpost_resolver(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_resolver_query_log_config_policy(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let arn = input.get_string("arn")?;
            let resolver_query_log_config_policy = input.get_string("resolver_query_log_config_policy")?;
            ...
            Ok(ResourceOutput::new()
                .with_id("placeholder-id")
                .with_field("arn", arn.unwrap_or_default())
                .with_field("resolver_query_log_config_policy", resolver_query_log_config_policy.unwrap_or_default())
            )
        })
    }

    /// Read a resolver_query_log_config_policy resource
    async fn read_resolver_query_log_config_policy(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resolver_query_log_config_policy(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn read_resolver_query_log_config_association(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_resolver_query_log_config_association(
        &self,
        id: &str,
    ) -> Result<()> {
        self.provider.runtime().block_on(async {
