...
impl<'a> Outpost_resolver<'a> {
    ...
    pub async fn create(&self, name: String, instance_count: Option<i64>, preferred_instance_type: String, outpost_arn: String, creator_request_id: String, tags: Option<Vec<String>>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, instance_count: Option<i64>, preferred_instance_type: Option<String>, outpost_arn: Option<String>, creator_request_id: Option<String>, tags: Option<Vec<String>>) -> Result<()> {
