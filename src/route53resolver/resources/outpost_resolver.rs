...
impl<'a> Outpost_resolver<'a> {
    ...
    pub async fn create(&self, preferred_instance_type: String, outpost_arn: String, name: String, tags: Option<Vec<String>>, instance_count: Option<i64>, creator_request_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, preferred_instance_type: Option<String>, outpost_arn: Option<String>, name: Option<String>, tags: Option<Vec<String>>, instance_count: Option<i64>, creator_request_id: Option<String>) -> Result<()> {
