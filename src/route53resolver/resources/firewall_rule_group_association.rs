...
impl<'a> Firewall_rule_group_association<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, firewall_rule_group_association_id: Option<String>, name: Option<String>, priority: Option<i64>, mutation_protection: Option<String>) -> Result<()> {
