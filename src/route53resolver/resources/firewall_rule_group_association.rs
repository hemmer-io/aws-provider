...
impl<'a> Firewall_rule_group_association<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, priority: Option<i64>, firewall_rule_group_association_id: Option<String>, mutation_protection: Option<String>, name: Option<String>) -> Result<()> {
