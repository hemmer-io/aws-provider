...
impl<'a> Snapshot_schedule<'a> {
    ...
    /// Read/describe a snapshot_schedule
    ///
    ...
    /// Update a snapshot_schedule
    ///
    /// TODO: Map `id` and update fields to appropriate SDK parameters
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, tags: Option<Vec<String>>, volume_arn: Option<String>, start_at: Option<i64>, recurrence_in_hours: Option<i64>, description: Option<String>) -> Result<()> {
