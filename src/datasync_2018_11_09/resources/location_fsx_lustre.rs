...
impl<'a> Location_fsx_lustre<'a> {
    ...
    pub async fn create(&self, security_group_arns: Vec<String>, fsx_filesystem_arn: String, tags: Option<Vec<String>>, subdirectory: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, security_group_arns: Option<Vec<String>>, fsx_filesystem_arn: Option<String>, tags: Option<Vec<String>>, subdirectory: Option<String>) -> Result<()> {
