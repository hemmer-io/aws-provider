...
impl<'a> Location_fsx_windows<'a> {
    ...
    pub async fn create(&self, domain: Option<String>, security_group_arns: Vec<String>, password: String, subdirectory: Option<String>, tags: Option<Vec<String>>, fsx_filesystem_arn: String, user: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, domain: Option<String>, security_group_arns: Option<Vec<String>>, password: Option<String>, subdirectory: Option<String>, tags: Option<Vec<String>>, fsx_filesystem_arn: Option<String>, user: Option<String>) -> Result<()> {
