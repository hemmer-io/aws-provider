...
impl<'a> S3Service<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "object_acl" => self.plan_object_acl(current_state, desired_input).await,
            "bucket_policy" => self.plan_bucket_policy(current_state, desired_input).await,
            "object_legal_hold" => {
                self.plan_object_legal_hold(current_state, desired_input)
                    .await
            }
            "bucket_website" => self.plan_bucket_website(current_state, desired_input).await,
            "bucket_location" => {
                self.plan_bucket_location(current_state, desired_input)
                    .await
            }
            "bucket_inventory_configuration" => {
                self.plan_bucket_inventory_configuration(current_state, desired_input)
                    .await
            }
            ...
            "bucket_metadata_configuration" => {
                self.plan_bucket_metadata_configuration(current_state, desired_input)
                    .await
            }
            "bucket_ownership_controls" => {
                self.plan_bucket_ownership_controls(current_state, desired_input)
                    .await
            }
            "object_tagging" => self.plan_object_tagging(current_state, desired_input).await,
            "bucket_lifecycle" => {
                self.plan_bucket_lifecycle(current_state, desired_input)
                    .await
            }
            ...
            "bucket_metadata_inventory_table_configuration" => {
                self.plan_bucket_metadata_inventory_table_configuration(
                    current_state,
                    desired_input,
                )
                .await
            ...
            "bucket_metadata_table_configuration" => {
                self.plan_bucket_metadata_table_configuration(current_state, desired_input)
                    .await
            }
            "bucket_analytics_configuration" => {
                self.plan_bucket_analytics_configuration(current_state, desired_input)
                    .await
            }
            "bucket_request_payment" => {
                self.plan_bucket_request_payment(current_state, desired_input)
                    .await
            }
            "bucket_encryption" => {
                self.plan_bucket_encryption(current_state, desired_input)
                    .await
            }
            "object_lock_configuration" => {
                self.plan_object_lock_configuration(current_state, desired_input)
                    .await
            }
            "bucket_policy_status" => {
                self.plan_bucket_policy_status(current_state, desired_input)
                    .await
            }
            "bucket_accelerate_configuration" => {
                self.plan_bucket_accelerate_configuration(current_state, desired_input)
                    .await
            }
            "multipart_upload" => {
                self.plan_multipart_upload(current_state, desired_input)
                    .await
            }
            "bucket_cors" => self.plan_bucket_cors(current_state, desired_input).await,
            "bucket_acl" => self.plan_bucket_acl(current_state, desired_input).await,
            "object_retention" => {
                self.plan_object_retention(current_state, desired_input)
                    .await
            }
            "bucket" => self.plan_bucket(current_state, desired_input).await,
            "bucket_intelligent_tiering_configuration" => {
                self.plan_bucket_intelligent_tiering_configuration(current_state, desired_input)
                    .await
            }
            "object" => self.plan_object(current_state, desired_input).await,
            "bucket_metrics_configuration" => {
                self.plan_bucket_metrics_configuration(current_state, desired_input)
                    .await
            }
            "bucket_notification_configuration" => {
                self.plan_bucket_notification_configuration(current_state, desired_input)
                    .await
            }
            "bucket_replication" => {
            ...
            "bucket_logging" => self.plan_bucket_logging(current_state, desired_input).await,
            "bucket_metadata_journal_table_configuration" => {
                self.plan_bucket_metadata_journal_table_configuration(current_state, desired_input)
                    .await
            }
            "public_access_block" => {
            ...
            "object_torrent" => self.plan_object_torrent(current_state, desired_input).await,
            "object_attributes" => {
                self.plan_object_attributes(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "object_acl" => self.create_object_acl(input).await,
            "bucket_policy" => self.create_bucket_policy(input).await,
            "object_legal_hold" => self.create_object_legal_hold(input).await,
            "bucket_website" => self.create_bucket_website(input).await,
            "bucket_location" => self.create_bucket_location(input).await,
            "bucket_inventory_configuration" => {
            ...
            "bucket_ownership_controls" => self.create_bucket_ownership_controls(input).await,
            "object_tagging" => self.create_object_tagging(input).await,
            "bucket_lifecycle" => self.create_bucket_lifecycle(input).await,
            ...
            "bucket_metadata_inventory_table_configuration" => {
                self.create_bucket_metadata_inventory_table_configuration(input)
                    .await
            }
            "bucket_metadata_table_configuration" => {
            ...
            "bucket_request_payment" => self.create_bucket_request_payment(input).await,
            "bucket_encryption" => self.create_bucket_encryption(input).await,
            "object_lock_configuration" => self.create_object_lock_configuration(input).await,
            "bucket_policy_status" => self.create_bucket_policy_status(input).await,
            "bucket_accelerate_configuration" => {
                self.create_bucket_accelerate_configuration(input).await
            }
            "multipart_upload" => self.create_multipart_upload(input).await,
            "bucket_cors" => self.create_bucket_cors(input).await,
            "bucket_acl" => self.create_bucket_acl(input).await,
            "object_retention" => self.create_object_retention(input).await,
            "bucket" => self.create_bucket(input).await,
            "bucket_intelligent_tiering_configuration" => {
                self.create_bucket_intelligent_tiering_configuration(input)
                    .await
            }
            "object" => self.create_object(input).await,
            "bucket_metrics_configuration" => self.create_bucket_metrics_configuration(input).await,
            "bucket_notification_configuration" => {
                self.create_bucket_notification_configuration(input).await
            }
            "bucket_replication" => self.create_bucket_replication(input).await,
            "bucket_logging" => self.create_bucket_logging(input).await,
            "bucket_metadata_journal_table_configuration" => {
                self.create_bucket_metadata_journal_table_configuration(input)
                    .await
            }
            ...
            "object_torrent" => self.create_object_torrent(input).await,
            "object_attributes" => self.create_object_attributes(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "s3", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "object_acl" => self.read_object_acl(id).await,
            "bucket_policy" => self.read_bucket_policy(id).await,
            "object_legal_hold" => self.read_object_legal_hold(id).await,
            "bucket_website" => self.read_bucket_website(id).await,
            "bucket_location" => self.read_bucket_location(id).await,
            "bucket_inventory_configuration" => self.read_bucket_inventory_configuration(id).await,
            "bucket_lifecycle_configuration" => self.read_bucket_lifecycle_configuration(id).await,
            "bucket_metadata_configuration" => self.read_bucket_metadata_configuration(id).await,
            "bucket_ownership_controls" => self.read_bucket_ownership_controls(id).await,
            "object_tagging" => self.read_object_tagging(id).await,
            "bucket_lifecycle" => self.read_bucket_lifecycle(id).await,
            "session" => self.read_session(id).await,
            "bucket_tagging" => self.read_bucket_tagging(id).await,
            "objects" => self.read_objects(id).await,
            "bucket_metadata_inventory_table_configuration" => {
                self.read_bucket_metadata_inventory_table_configuration(id)
                    .await
            }
            "bucket_metadata_table_configuration" => {
                self.read_bucket_metadata_table_configuration(id).await
            }
            "bucket_analytics_configuration" => self.read_bucket_analytics_configuration(id).await,
            "bucket_request_payment" => self.read_bucket_request_payment(id).await,
            "bucket_encryption" => self.read_bucket_encryption(id).await,
            "object_lock_configuration" => self.read_object_lock_configuration(id).await,
            "bucket_policy_status" => self.read_bucket_policy_status(id).await,
            "bucket_accelerate_configuration" => {
                self.read_bucket_accelerate_configuration(id).await
            }
            "multipart_upload" => self.read_multipart_upload(id).await,
            "bucket_cors" => self.read_bucket_cors(id).await,
            "bucket_acl" => self.read_bucket_acl(id).await,
            "object_retention" => self.read_object_retention(id).await,
            "bucket" => self.read_bucket(id).await,
            "bucket_intelligent_tiering_configuration" => {
                self.read_bucket_intelligent_tiering_configuration(id).await
            }
            "object" => self.read_object(id).await,
            "bucket_metrics_configuration" => self.read_bucket_metrics_configuration(id).await,
            "bucket_notification_configuration" => {
                self.read_bucket_notification_configuration(id).await
            }
            "bucket_replication" => self.read_bucket_replication(id).await,
            "bucket_logging" => self.read_bucket_logging(id).await,
            "bucket_metadata_journal_table_configuration" => {
                self.read_bucket_metadata_journal_table_configuration(id)
                    .await
            }
            "public_access_block" => self.read_public_access_block(id).await,
            "bucket_versioning" => self.read_bucket_versioning(id).await,
            "object_torrent" => self.read_object_torrent(id).await,
            "object_attributes" => self.read_object_attributes(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "s3", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "object_acl" => self.update_object_acl(id, input).await,
            "bucket_policy" => self.update_bucket_policy(id, input).await,
            "object_legal_hold" => self.update_object_legal_hold(id, input).await,
            "bucket_website" => self.update_bucket_website(id, input).await,
            "bucket_location" => self.update_bucket_location(id, input).await,
            "bucket_inventory_configuration" => {
            ...
            "bucket_ownership_controls" => self.update_bucket_ownership_controls(id, input).await,
            "object_tagging" => self.update_object_tagging(id, input).await,
            "bucket_lifecycle" => self.update_bucket_lifecycle(id, input).await,
            ...
            "bucket_metadata_inventory_table_configuration" => {
                self.update_bucket_metadata_inventory_table_configuration(id, input)
                    .await
            }
            "bucket_metadata_table_configuration" => {
                self.update_bucket_metadata_table_configuration(id, input)
                    .await
            }
            "bucket_analytics_configuration" => {
                self.update_bucket_analytics_configuration(id, input).await
            }
            "bucket_request_payment" => self.update_bucket_request_payment(id, input).await,
            "bucket_encryption" => self.update_bucket_encryption(id, input).await,
            "object_lock_configuration" => self.update_object_lock_configuration(id, input).await,
            "bucket_policy_status" => self.update_bucket_policy_status(id, input).await,
            "bucket_accelerate_configuration" => {
                self.update_bucket_accelerate_configuration(id, input).await
            }
            "multipart_upload" => self.update_multipart_upload(id, input).await,
            "bucket_cors" => self.update_bucket_cors(id, input).await,
            "bucket_acl" => self.update_bucket_acl(id, input).await,
            "object_retention" => self.update_object_retention(id, input).await,
            "bucket" => self.update_bucket(id, input).await,
            "bucket_intelligent_tiering_configuration" => {
                self.update_bucket_intelligent_tiering_configuration(id, input)
                    .await
            }
            "object" => self.update_object(id, input).await,
            "bucket_metrics_configuration" => {
                self.update_bucket_metrics_configuration(id, input).await
            }
            "bucket_notification_configuration" => {
                self.update_bucket_notification_configuration(id, input)
                    .await
            }
            "bucket_replication" => self.update_bucket_replication(id, input).await,
            "bucket_logging" => self.update_bucket_logging(id, input).await,
            "bucket_metadata_journal_table_configuration" => {
                self.update_bucket_metadata_journal_table_configuration(id, input)
                    .await
            }
            ...
            "object_torrent" => self.update_object_torrent(id, input).await,
            "object_attributes" => self.update_object_attributes(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "s3", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "object_acl" => self.delete_object_acl(id).await,
            "bucket_policy" => self.delete_bucket_policy(id).await,
            "object_legal_hold" => self.delete_object_legal_hold(id).await,
            "bucket_website" => self.delete_bucket_website(id).await,
            "bucket_location" => self.delete_bucket_location(id).await,
            "bucket_inventory_configuration" => {
            ...
            "bucket_metadata_configuration" => self.delete_bucket_metadata_configuration(id).await,
            "bucket_ownership_controls" => self.delete_bucket_ownership_controls(id).await,
            "object_tagging" => self.delete_object_tagging(id).await,
            "bucket_lifecycle" => self.delete_bucket_lifecycle(id).await,
            ...
            "bucket_metadata_inventory_table_configuration" => {
                self.delete_bucket_metadata_inventory_table_configuration(id)
                    .await
            }
            "bucket_metadata_table_configuration" => {
            ...
            "bucket_request_payment" => self.delete_bucket_request_payment(id).await,
            "bucket_encryption" => self.delete_bucket_encryption(id).await,
            "object_lock_configuration" => self.delete_object_lock_configuration(id).await,
            "bucket_policy_status" => self.delete_bucket_policy_status(id).await,
            "bucket_accelerate_configuration" => {
                self.delete_bucket_accelerate_configuration(id).await
            }
            "multipart_upload" => self.delete_multipart_upload(id).await,
            "bucket_cors" => self.delete_bucket_cors(id).await,
            "bucket_acl" => self.delete_bucket_acl(id).await,
            "object_retention" => self.delete_object_retention(id).await,
            "bucket" => self.delete_bucket(id).await,
            "bucket_intelligent_tiering_configuration" => {
                self.delete_bucket_intelligent_tiering_configuration(id)
                    .await
            }
            "object" => self.delete_object(id).await,
            "bucket_metrics_configuration" => self.delete_bucket_metrics_configuration(id).await,
            "bucket_notification_configuration" => {
                self.delete_bucket_notification_configuration(id).await
            }
            "bucket_replication" => self.delete_bucket_replication(id).await,
            "bucket_logging" => self.delete_bucket_logging(id).await,
            "bucket_metadata_journal_table_configuration" => {
                self.delete_bucket_metadata_journal_table_configuration(id)
                    .await
            }
            "public_access_block" => self.delete_public_access_block(id).await,
            "bucket_versioning" => self.delete_bucket_versioning(id).await,
            "object_torrent" => self.delete_object_torrent(id).await,
            "object_attributes" => self.delete_object_attributes(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "s3", resource_name
            ))),
    ...
    async fn create_object_acl(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    access_control_policy.unwrap_or_default(),
                )
    ...
    async fn read_object_acl(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn update_object_acl(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let grant_full_control = input.get_optional_string("grant_full_control")?;
            let grant_write = input.get_optional_string("grant_write")?;
    ...
    async fn delete_object_acl(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_object_legal_hold(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let checksum_algorithm = input.get_optional_string("checksum_algorithm")?;
    ...
    async fn read_object_legal_hold(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_object_legal_hold(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_bucket_website(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let expected_bucket_owner = input.get_optional_string("expected_bucket_owner")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    website_configuration.unwrap_or_default(),
                )
                .with_field("bucket", bucket.unwrap_or_default()))
        })
    }
    ...
    async fn read_bucket_website(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_website(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_bucket_location(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_bucket_location(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_location(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    inventory_configuration.unwrap_or_default(),
                ))
        })
    }

    /// Read a bucket_inventory_configuration resource
    async fn read_bucket_inventory_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_inventory_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_bucket_lifecycle_configuration(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let checksum_algorithm = input.get_optional_string("checksum_algorithm")?;
            let transition_default_minimum_object_size =
                input.get_optional_string("transition_default_minimum_object_size")?;
            let expected_bucket_owner = input.get_optional_string("expected_bucket_owner")?;
            let bucket = input.get_string("bucket")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    transition_default_minimum_object_size.unwrap_or_default(),
                )
                .with_field(
                    "expected_bucket_owner",
                    expected_bucket_owner.unwrap_or_default(),
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    metadata_configuration.unwrap_or_default(),
                )
                .with_field("checksum_algorithm", checksum_algorithm.unwrap_or_default()))
        })
    }
    ...
    async fn read_bucket_metadata_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_metadata_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn read_bucket_ownership_controls(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_ownership_controls(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_object_tagging(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let expected_bucket_owner = input.get_optional_string("expected_bucket_owner")?;
    ...
    async fn read_object_tagging(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_object_tagging(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_bucket_lifecycle(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_bucket_lifecycle(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_lifecycle(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_session(&self, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        self.provider.runtime().block_on(async {
            ...
            let ssekms_encryption_context =
                input.get_optional_string("ssekms_encryption_context")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    ssekms_encryption_context.unwrap_or_default(),
                ))
        })
    }
    ...
    async fn create_bucket_metadata_inventory_table_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            let inventory_table_configuration =
                input.get_string("inventory_table_configuration")?;
            let content_md5 = input.get_optional_string("content_md5")?;
            let expected_bucket_owner = input.get_optional_string("expected_bucket_owner")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    inventory_table_configuration.unwrap_or_default(),
                )
                .with_field("content_md5", content_md5.unwrap_or_default())
                .with_field(
                    "expected_bucket_owner",
    ...
    async fn delete_bucket_metadata_inventory_table_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    metadata_table_configuration.unwrap_or_default(),
                )
                .with_field(
                    "expected_bucket_owner",
                    expected_bucket_owner.unwrap_or_default(),
    ...
    async fn read_bucket_metadata_table_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_metadata_table_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    analytics_configuration.unwrap_or_default(),
                )
                .with_field("bucket", bucket.unwrap_or_default())
                .with_field("id", id.unwrap_or_default()))
        })
    ...
    async fn read_bucket_analytics_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_analytics_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_bucket_request_payment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let bucket = input.get_string("bucket")?;
            ...
            let content_md5 = input.get_optional_string("content_md5")?;
            let expected_bucket_owner = input.get_optional_string("expected_bucket_owner")?;
            let request_payment_configuration =
                input.get_string("request_payment_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    request_payment_configuration.unwrap_or_default(),
                ))
        })
    }

    /// Read a bucket_request_payment resource
    async fn read_bucket_request_payment(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_request_payment(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_bucket_encryption(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let expected_bucket_owner = input.get_optional_string("expected_bucket_owner")?;
            ...
            let server_side_encryption_configuration =
                input.get_string("server_side_encryption_configuration")?;
            let bucket = input.get_string("bucket")?;
            let checksum_algorithm = input.get_optional_string("checksum_algorithm")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    server_side_encryption_configuration.unwrap_or_default(),
                )
                .with_field("bucket", bucket.unwrap_or_default())
                .with_field("checksum_algorithm", checksum_algorithm.unwrap_or_default()))
        })
    ...
    async fn read_bucket_encryption(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_encryption(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_object_lock_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            let checksum_algorithm = input.get_optional_string("checksum_algorithm")?;
            let expected_bucket_owner = input.get_optional_string("expected_bucket_owner")?;
            let object_lock_configuration =
                input.get_optional_string("object_lock_configuration")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "object_lock_configuration",
                    object_lock_configuration.unwrap_or_default(),
                ))
        })
    }

    /// Read a object_lock_configuration resource
    async fn read_object_lock_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_object_lock_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_bucket_policy_status(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_bucket_policy_status(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_policy_status(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    accelerate_configuration.unwrap_or_default(),
                )
                .with_field(
                    "expected_bucket_owner",
                    expected_bucket_owner.unwrap_or_default(),
    ...
    async fn read_bucket_accelerate_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_accelerate_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_multipart_upload(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let bucket = input.get_string("bucket")?;
            ...
            let website_redirect_location =
                input.get_optional_string("website_redirect_location")?;
            ...
            let grant_read = input.get_optional_string("grant_read")?;
            let server_side_encryption = input.get_optional_string("server_side_encryption")?;
            let object_lock_legal_hold_status =
                input.get_optional_string("object_lock_legal_hold_status")?;
            ...
            let object_lock_retain_until_date =
                input.get_optional_string("object_lock_retain_until_date")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    sse_customer_key_md5.unwrap_or_default(),
                )
                .with_field(
                    "website_redirect_location",
                    website_redirect_location.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    object_lock_legal_hold_status.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    object_lock_retain_until_date.unwrap_or_default(),
                )
                ...
                .with_field(
                    ...
                    sse_customer_algorithm.unwrap_or_default(),
                ))
        })
    }

    /// Read a multipart_upload resource
    async fn read_multipart_upload(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_multipart_upload(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_bucket_cors(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let expected_bucket_owner = input.get_optional_string("expected_bucket_owner")?;
    ...
    async fn read_bucket_cors(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn update_bucket_cors(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let expected_bucket_owner = input.get_optional_string("expected_bucket_owner")?;
            let content_md5 = input.get_optional_string("content_md5")?;
    ...
    async fn delete_bucket_cors(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_bucket_acl(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let access_control_policy = input.get_optional_string("access_control_policy")?;
    ...
    async fn read_bucket_acl(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn update_bucket_acl(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let access_control_policy = input.get_optional_string("access_control_policy")?;
            let content_md5 = input.get_optional_string("content_md5")?;
    ...
    async fn delete_bucket_acl(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_object_retention(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let expected_bucket_owner = input.get_optional_string("expected_bucket_owner")?;
            let bypass_governance_retention =
                input.get_optional_string("bypass_governance_retention")?;
            let bucket = input.get_string("bucket")?;
            let version_id = input.get_optional_string("version_id")?;
            let checksum_algorithm = input.get_optional_string("checksum_algorithm")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    bypass_governance_retention.unwrap_or_default(),
                )
                .with_field("bucket", bucket.unwrap_or_default())
                .with_field("version_id", version_id.unwrap_or_default())
                .with_field("checksum_algorithm", checksum_algorithm.unwrap_or_default())
    ...
    async fn read_object_retention(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_object_retention(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_bucket_intelligent_tiering_configuration(
        ...
        self.provider.runtime().block_on(async {
            // Extract input fields
            let intelligent_tiering_configuration =
                input.get_string("intelligent_tiering_configuration")?;
            let bucket = input.get_string("bucket")?;
            let id = input.get_string("id")?;
            let expected_bucket_owner = input.get_optional_string("expected_bucket_owner")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    intelligent_tiering_configuration.unwrap_or_default(),
                )
                .with_field("bucket", bucket.unwrap_or_default())
                .with_field("id", id.unwrap_or_default())
                .with_field(
    ...
    async fn delete_bucket_intelligent_tiering_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_object(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            let metadata = input.get_optional_string("metadata")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    "checksum_crc64_nvme",
                    checksum_crc64_nvme.unwrap_or_default(),
                )
                .with_field("grant_read", grant_read.unwrap_or_default())
                .with_field(
                    "object_lock_legal_hold_status",
    ...
    async fn read_object(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn update_object(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let metadata = input.get_optional_string("metadata")?;
            let key = input.get_string("key")?;
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    metrics_configuration.unwrap_or_default(),
                )
                .with_field("id", id.unwrap_or_default())
                .with_field(
                    "expected_bucket_owner",
    ...
    async fn read_bucket_metrics_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_metrics_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_bucket_notification_configuration(
        ...
        self.provider.runtime().block_on(async {
            ...
            let expected_bucket_owner = input.get_optional_string("expected_bucket_owner")?;
            let skip_destination_validation =
                input.get_optional_string("skip_destination_validation")?;
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    skip_destination_validation.unwrap_or_default(),
                ))
        })
    }

    /// Read a bucket_notification_configuration resource
    async fn read_bucket_notification_configuration(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_notification_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_bucket_logging(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    bucket_logging_status.unwrap_or_default(),
                )
                .with_field("content_md5", content_md5.unwrap_or_default())
                .with_field("checksum_algorithm", checksum_algorithm.unwrap_or_default())
                .with_field("bucket", bucket.unwrap_or_default())
    ...
    async fn read_bucket_logging(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_bucket_logging(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
        ...
        self.provider.runtime().block_on(async {
            ...
            Ok(ResourceOutput::new()
                ...
                .with_field(
                    ...
                    journal_table_configuration.unwrap_or_default(),
                )
                .with_field("bucket", bucket.unwrap_or_default())
                .with_field("content_md5", content_md5.unwrap_or_default())
                .with_field(
    ...
    async fn delete_bucket_metadata_journal_table_configuration(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_object_torrent(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_object_torrent(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_object_torrent(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
    ...
    async fn create_object_attributes(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_object_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.s3_client
    ...
    async fn delete_object_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.s3_client
