...
impl<'a> Bucket_ownership_controls<'a> {
    ...
    pub async fn create(&self, expected_bucket_owner: Option<String>, content_md5: Option<String>, checksum_algorithm: Option<String>, bucket: String, ownership_controls: String) -> Result<String> {
