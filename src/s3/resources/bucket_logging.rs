...
impl<'a> Bucket_logging<'a> {
    ...
    pub async fn create(&self, bucket_logging_status: String, content_md5: Option<String>, checksum_algorithm: Option<String>, bucket: String, expected_bucket_owner: Option<String>) -> Result<String> {
