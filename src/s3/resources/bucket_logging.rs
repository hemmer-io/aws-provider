...
impl<'a> Bucket_logging<'a> {
    ...
    pub async fn create(&self, bucket_logging_status: String, bucket: String, checksum_algorithm: Option<String>, expected_bucket_owner: Option<String>, content_md5: Option<String>) -> Result<String> {
