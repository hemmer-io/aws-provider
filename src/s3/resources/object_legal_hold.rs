...
impl<'a> Object_legal_hold<'a> {
    ...
    pub async fn create(&self, checksum_algorithm: Option<String>, content_md5: Option<String>, key: String, version_id: Option<String>, legal_hold: Option<String>, request_payer: Option<String>, expected_bucket_owner: Option<String>, bucket: String) -> Result<String> {
