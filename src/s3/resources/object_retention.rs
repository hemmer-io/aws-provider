...
impl<'a> Object_retention<'a> {
    ...
    pub async fn create(&self, expected_bucket_owner: Option<String>, bypass_governance_retention: Option<bool>, bucket: String, version_id: Option<String>, checksum_algorithm: Option<String>, retention: Option<String>, content_md5: Option<String>, request_payer: Option<String>, key: String) -> Result<String> {
