...
impl<'a> Bucket_cors<'a> {
    ...
    pub async fn create(&self, expected_bucket_owner: Option<String>, content_md5: Option<String>, cors_configuration: String, checksum_algorithm: Option<String>, bucket: String) -> Result<String> {
