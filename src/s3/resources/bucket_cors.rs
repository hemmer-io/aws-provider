...
impl<'a> Bucket_cors<'a> {
    ...
    pub async fn create(&self, checksum_algorithm: Option<String>, expected_bucket_owner: Option<String>, bucket: String, content_md5: Option<String>, cors_configuration: String) -> Result<String> {
