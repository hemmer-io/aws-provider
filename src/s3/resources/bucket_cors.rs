...
impl<'a> Bucket_cors<'a> {
    ...
    pub async fn create(&self, bucket: String, cors_configuration: String, content_md5: Option<String>, expected_bucket_owner: Option<String>, checksum_algorithm: Option<String>) -> Result<String> {
