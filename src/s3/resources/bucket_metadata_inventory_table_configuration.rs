...
impl<'a> Bucket_metadata_inventory_table_configuration<'a> {
    ...
    pub async fn update(&self, id: &str, checksum_algorithm: Option<String>, expected_bucket_owner: Option<String>, inventory_table_configuration: Option<String>, bucket: Option<String>, content_md5: Option<String>) -> Result<()> {
