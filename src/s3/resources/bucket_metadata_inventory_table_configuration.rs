...
impl<'a> Bucket_metadata_inventory_table_configuration<'a> {
    ...
    pub async fn update(&self, id: &str, inventory_table_configuration: Option<String>, expected_bucket_owner: Option<String>, bucket: Option<String>, checksum_algorithm: Option<String>, content_md5: Option<String>) -> Result<()> {
