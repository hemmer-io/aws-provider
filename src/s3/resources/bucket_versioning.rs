...
impl<'a> Bucket_versioning<'a> {
    ...
    pub async fn create(&self, mfa: Option<String>, versioning_configuration: String, content_md5: Option<String>, checksum_algorithm: Option<String>, bucket: String, expected_bucket_owner: Option<String>) -> Result<String> {
