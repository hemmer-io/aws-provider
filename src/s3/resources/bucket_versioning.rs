...
impl<'a> Bucket_versioning<'a> {
    ...
    pub async fn create(&self, mfa: Option<String>, checksum_algorithm: Option<String>, content_md5: Option<String>, expected_bucket_owner: Option<String>, bucket: String, versioning_configuration: String) -> Result<String> {
