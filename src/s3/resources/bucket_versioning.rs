...
impl<'a> Bucket_versioning<'a> {
    ...
    pub async fn create(&self, expected_bucket_owner: Option<String>, checksum_algorithm: Option<String>, bucket: String, content_md5: Option<String>, versioning_configuration: String, mfa: Option<String>) -> Result<String> {
