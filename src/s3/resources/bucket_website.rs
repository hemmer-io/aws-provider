...
impl<'a> Bucket_website<'a> {
    ...
    pub async fn create(&self, expected_bucket_owner: Option<String>, content_md5: Option<String>, checksum_algorithm: Option<String>, website_configuration: String, bucket: String) -> Result<String> {
