...
impl<'a> Bucket_website<'a> {
    ...
    pub async fn create(&self, content_md5: Option<String>, checksum_algorithm: Option<String>, expected_bucket_owner: Option<String>, bucket: String, website_configuration: String) -> Result<String> {
