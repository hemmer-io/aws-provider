...
impl<'a> Public_access_block<'a> {
    ...
    pub async fn create(&self, public_access_block_configuration: String, expected_bucket_owner: Option<String>, content_md5: Option<String>, bucket: String, checksum_algorithm: Option<String>) -> Result<String> {
