...
impl<'a> Access_grant<'a> {
    ...
    pub async fn create(&self, s3_prefix_type: Option<String>, grantee: String, account_id: String, tags: Option<Vec<String>>, application_arn: Option<String>, access_grants_location_configuration: Option<String>, permission: String, access_grants_location_id: String) -> Result<String> {
