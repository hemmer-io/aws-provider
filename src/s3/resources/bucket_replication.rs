...
impl<'a> Bucket_replication<'a> {
    ...
    pub async fn create(&self, content_md5: Option<String>, token: Option<String>, bucket: String, checksum_algorithm: Option<String>, replication_configuration: String, expected_bucket_owner: Option<String>) -> Result<String> {
