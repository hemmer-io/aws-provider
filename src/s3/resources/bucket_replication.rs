...
impl<'a> Bucket_replication<'a> {
    ...
    pub async fn create(&self, expected_bucket_owner: Option<String>, checksum_algorithm: Option<String>, content_md5: Option<String>, bucket: String, replication_configuration: String, token: Option<String>) -> Result<String> {
