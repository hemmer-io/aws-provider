...
impl<'a> Bucket_replication<'a> {
    ...
    pub async fn create(&self, replication_configuration: String, checksum_algorithm: Option<String>, content_md5: Option<String>, token: Option<String>, bucket: String, expected_bucket_owner: Option<String>) -> Result<String> {
