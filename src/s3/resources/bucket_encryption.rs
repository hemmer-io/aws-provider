...
impl<'a> Bucket_encryption<'a> {
    ...
    pub async fn create(&self, expected_bucket_owner: Option<String>, content_md5: Option<String>, server_side_encryption_configuration: String, bucket: String, checksum_algorithm: Option<String>) -> Result<String> {
