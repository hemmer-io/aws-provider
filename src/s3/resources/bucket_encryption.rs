...
impl<'a> Bucket_encryption<'a> {
    ...
    pub async fn create(&self, checksum_algorithm: Option<String>, server_side_encryption_configuration: String, bucket: String, expected_bucket_owner: Option<String>, content_md5: Option<String>) -> Result<String> {
