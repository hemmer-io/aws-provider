...
impl<'a> Bucket_request_payment<'a> {
    ...
    pub async fn create(&self, request_payment_configuration: String, content_md5: Option<String>, checksum_algorithm: Option<String>, expected_bucket_owner: Option<String>, bucket: String) -> Result<String> {
