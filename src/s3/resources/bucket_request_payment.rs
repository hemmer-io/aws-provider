...
impl<'a> Bucket_request_payment<'a> {
    ...
    pub async fn create(&self, checksum_algorithm: Option<String>, bucket: String, content_md5: Option<String>, request_payment_configuration: String, expected_bucket_owner: Option<String>) -> Result<String> {
