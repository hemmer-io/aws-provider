...
impl<'a> Bucket_notification_configuration<'a> {
    ...
    pub async fn create(&self, skip_destination_validation: Option<bool>, notification_configuration: String, bucket: String, expected_bucket_owner: Option<String>) -> Result<String> {
