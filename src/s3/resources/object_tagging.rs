...
impl<'a> Object_tagging<'a> {
    ...
    pub async fn create(&self, version_id: Option<String>, expected_bucket_owner: Option<String>, request_payer: Option<String>, content_md5: Option<String>, key: String, bucket: String, checksum_algorithm: Option<String>, tagging: String) -> Result<String> {
