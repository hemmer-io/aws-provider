...
impl<'a> Object_tagging<'a> {
    ...
    pub async fn create(&self, expected_bucket_owner: Option<String>, key: String, checksum_algorithm: Option<String>, content_md5: Option<String>, bucket: String, tagging: String, request_payer: Option<String>, version_id: Option<String>) -> Result<String> {
