...
impl<'a> Access_point<'a> {
    ...
    pub async fn create(&self, scope: Option<String>, name: String, vpc_configuration: Option<String>, bucket_account_id: Option<String>, account_id: String, bucket: String, tags: Option<Vec<String>>, public_access_block_configuration: Option<String>) -> Result<String> {
