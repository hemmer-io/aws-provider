...
impl<'a> Configuration_set_tracking_options<'a> {
    ...
    pub async fn create(&self, configuration_set_name: String, tracking_options: String) -> Result<String> {
    ...
    /// Update a configuration_set_tracking_options
    ///
    /// TODO: Map `id` and update fields to appropriate SDK parameters
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, configuration_set_name: Option<String>, tracking_options: Option<String>) -> Result<()> {
    ...
    /// Delete a configuration_set_tracking_options
    ///
