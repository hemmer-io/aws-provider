...
impl<'a> Custom_verification_email_template<'a> {
    ...
    pub async fn create(&self, template_content: String, template_name: String, success_redirection_url: String, from_email_address: String, template_subject: String, failure_redirection_url: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, template_content: Option<String>, template_name: Option<String>, success_redirection_url: Option<String>, from_email_address: Option<String>, template_subject: Option<String>, failure_redirection_url: Option<String>) -> Result<()> {
