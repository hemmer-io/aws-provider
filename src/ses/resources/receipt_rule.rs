...
impl<'a> Receipt_rule<'a> {
    ...
    pub async fn create(&self, rule_set_name: String, rule: String, after: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, rule_set_name: Option<String>, rule: Option<String>, after: Option<String>) -> Result<()> {
