...
impl<'a> Receipt_rule<'a> {
    ...
    pub async fn create(&self, after: Option<String>, rule_set_name: String, rule: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, after: Option<String>, rule_set_name: Option<String>, rule: Option<String>) -> Result<()> {
