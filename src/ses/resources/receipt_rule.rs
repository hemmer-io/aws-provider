...
impl<'a> Receipt_rule<'a> {
    ...
    pub async fn create(&self, rule: String, after: Option<String>, rule_set_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, rule: Option<String>, after: Option<String>, rule_set_name: Option<String>) -> Result<()> {
