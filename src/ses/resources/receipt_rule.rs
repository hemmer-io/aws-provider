...
impl<'a> Receipt_rule<'a> {
    ...
    pub async fn create(&self, after: Option<String>, rule: String, rule_set_name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, after: Option<String>, rule: Option<String>, rule_set_name: Option<String>) -> Result<()> {
