...
impl<'a> SesService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "identity_policy" => {
                self.plan_identity_policy(current_state, desired_input)
                    .await
            }
            "receipt_rule_set" => {
                self.plan_receipt_rule_set(current_state, desired_input)
                    .await
            }
            "send_quota" => self.plan_send_quota(current_state, desired_input).await,
            "receipt_filter" => self.plan_receipt_filter(current_state, desired_input).await,
            "receipt_rule" => self.plan_receipt_rule(current_state, desired_input).await,
            ...
            "account_sending_enabled" => {
                self.plan_account_sending_enabled(current_state, desired_input)
                    .await
            }
            "template" => self.plan_template(current_state, desired_input).await,
            "identity" => self.plan_identity(current_state, desired_input).await,
            "active_receipt_rule_set" => {
                self.plan_active_receipt_rule_set(current_state, desired_input)
                    .await
            }
            "identity_dkim_attributes" => {
                self.plan_identity_dkim_attributes(current_state, desired_input)
                    .await
            }
            "identity_mail_from_domain_attributes" => {
                self.plan_identity_mail_from_domain_attributes(current_state, desired_input)
                    .await
            }
            "send_statistics" => {
                self.plan_send_statistics(current_state, desired_input)
                    .await
            }
            ...
            "configuration_set_sending_enabled" => {
                self.plan_configuration_set_sending_enabled(current_state, desired_input)
                    .await
            }
            ...
            "configuration_set_reputation_metrics_enabled" => {
                self.plan_configuration_set_reputation_metrics_enabled(current_state, desired_input)
                    .await
            }
            "identity_notification_attributes" => {
                self.plan_identity_notification_attributes(current_state, desired_input)
                    .await
            }
            "identity_verification_attributes" => {
                self.plan_identity_verification_attributes(current_state, desired_input)
                    .await
            }
            "identity_policies" => {
                self.plan_identity_policies(current_state, desired_input)
                    .await
            }
            "verified_email_address" => {
                self.plan_verified_email_address(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "identity_policy" => self.create_identity_policy(input).await,
            "receipt_rule_set" => self.create_receipt_rule_set(input).await,
            "send_quota" => self.create_send_quota(input).await,
            "receipt_filter" => self.create_receipt_filter(input).await,
            "receipt_rule" => self.create_receipt_rule(input).await,
            "custom_verification_email_template" => {
                self.create_custom_verification_email_template(input).await
            }
            "account_sending_enabled" => self.create_account_sending_enabled(input).await,
            "template" => self.create_template(input).await,
            "identity" => self.create_identity(input).await,
            "active_receipt_rule_set" => self.create_active_receipt_rule_set(input).await,
            "identity_dkim_attributes" => self.create_identity_dkim_attributes(input).await,
            "identity_mail_from_domain_attributes" => {
                self.create_identity_mail_from_domain_attributes(input)
                    .await
            }
            "send_statistics" => self.create_send_statistics(input).await,
            "configuration_set_delivery_options" => {
            ...
            "configuration_set_reputation_metrics_enabled" => {
                self.create_configuration_set_reputation_metrics_enabled(input)
                    .await
            }
            "identity_notification_attributes" => {
            ...
            "identity_policies" => self.create_identity_policies(input).await,
            "verified_email_address" => self.create_verified_email_address(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ses", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "identity_policy" => self.read_identity_policy(id).await,
            "receipt_rule_set" => self.read_receipt_rule_set(id).await,
            "send_quota" => self.read_send_quota(id).await,
            "receipt_filter" => self.read_receipt_filter(id).await,
            "receipt_rule" => self.read_receipt_rule(id).await,
            "custom_verification_email_template" => {
                self.read_custom_verification_email_template(id).await
            }
            "account_sending_enabled" => self.read_account_sending_enabled(id).await,
            "template" => self.read_template(id).await,
            "identity" => self.read_identity(id).await,
            "active_receipt_rule_set" => self.read_active_receipt_rule_set(id).await,
            "identity_dkim_attributes" => self.read_identity_dkim_attributes(id).await,
            "identity_mail_from_domain_attributes" => {
                self.read_identity_mail_from_domain_attributes(id).await
            }
            "send_statistics" => self.read_send_statistics(id).await,
            "configuration_set_delivery_options" => {
            ...
            "configuration_set_reputation_metrics_enabled" => {
                self.read_configuration_set_reputation_metrics_enabled(id)
                    .await
            }
            "identity_notification_attributes" => {
            ...
            "identity_policies" => self.read_identity_policies(id).await,
            "verified_email_address" => self.read_verified_email_address(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ses", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "identity_policy" => self.update_identity_policy(id, input).await,
            "receipt_rule_set" => self.update_receipt_rule_set(id, input).await,
            "send_quota" => self.update_send_quota(id, input).await,
            "receipt_filter" => self.update_receipt_filter(id, input).await,
            "receipt_rule" => self.update_receipt_rule(id, input).await,
            "custom_verification_email_template" => {
                self.update_custom_verification_email_template(id, input)
                    .await
            }
            "account_sending_enabled" => self.update_account_sending_enabled(id, input).await,
            "template" => self.update_template(id, input).await,
            "identity" => self.update_identity(id, input).await,
            "active_receipt_rule_set" => self.update_active_receipt_rule_set(id, input).await,
            "identity_dkim_attributes" => self.update_identity_dkim_attributes(id, input).await,
            "identity_mail_from_domain_attributes" => {
                self.update_identity_mail_from_domain_attributes(id, input)
                    .await
            }
            "send_statistics" => self.update_send_statistics(id, input).await,
            "configuration_set_delivery_options" => {
                self.update_configuration_set_delivery_options(id, input)
                    .await
            }
            "configuration_set_sending_enabled" => {
                self.update_configuration_set_sending_enabled(id, input)
                    .await
            }
            "configuration_set_tracking_options" => {
            ...
            "configuration_set_reputation_metrics_enabled" => {
                self.update_configuration_set_reputation_metrics_enabled(id, input)
                    .await
            }
            "identity_notification_attributes" => {
                self.update_identity_notification_attributes(id, input)
                    .await
            }
            "identity_verification_attributes" => {
                self.update_identity_verification_attributes(id, input)
                    .await
            }
            "identity_policies" => self.update_identity_policies(id, input).await,
            "verified_email_address" => self.update_verified_email_address(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ses", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "identity_policy" => self.delete_identity_policy(id).await,
            "receipt_rule_set" => self.delete_receipt_rule_set(id).await,
            "send_quota" => self.delete_send_quota(id).await,
            "receipt_filter" => self.delete_receipt_filter(id).await,
            "receipt_rule" => self.delete_receipt_rule(id).await,
            "custom_verification_email_template" => {
                self.delete_custom_verification_email_template(id).await
            }
            "account_sending_enabled" => self.delete_account_sending_enabled(id).await,
            "template" => self.delete_template(id).await,
            "identity" => self.delete_identity(id).await,
            "active_receipt_rule_set" => self.delete_active_receipt_rule_set(id).await,
            "identity_dkim_attributes" => self.delete_identity_dkim_attributes(id).await,
            "identity_mail_from_domain_attributes" => {
                self.delete_identity_mail_from_domain_attributes(id).await
            }
            "send_statistics" => self.delete_send_statistics(id).await,
            "configuration_set_delivery_options" => {
            ...
            "configuration_set_reputation_metrics_enabled" => {
                self.delete_configuration_set_reputation_metrics_enabled(id)
                    .await
            }
            "identity_notification_attributes" => {
            ...
            "identity_policies" => self.delete_identity_policies(id).await,
            "verified_email_address" => self.delete_verified_email_address(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "ses", resource_name
            ))),
    ...
    async fn create_identity_policy(&self, input: ResourceInput) -> Result<ResourceOutput> {
    ...
    async fn read_identity_policy(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
    ...
    async fn delete_identity_policy(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
    ...
    async fn create_receipt_rule_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_receipt_rule_set(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn delete_receipt_rule_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn create_send_quota(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_send_quota(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn update_send_quota(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn delete_send_quota(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn create_receipt_filter(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_receipt_filter(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn delete_receipt_filter(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn create_receipt_rule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_receipt_rule(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn update_receipt_rule(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
            let after = input.get_optional_string("after")?;
            let rule_set_name = input.get_string("rule_set_name")?;
    ...
    async fn delete_receipt_rule(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn create_account_sending_enabled(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_account_sending_enabled(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn delete_account_sending_enabled(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn create_identity(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_identity(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn update_identity(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn create_active_receipt_rule_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_active_receipt_rule_set(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn delete_active_receipt_rule_set(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn read_identity_dkim_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn delete_identity_dkim_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn read_identity_mail_from_domain_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn delete_identity_mail_from_domain_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn create_send_statistics(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_send_statistics(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn delete_send_statistics(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn read_configuration_set_sending_enabled(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn delete_configuration_set_sending_enabled(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn delete_configuration_set_reputation_metrics_enabled(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn read_identity_notification_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn delete_identity_notification_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn read_identity_verification_attributes(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn delete_identity_verification_attributes(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn create_identity_policies(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_identity_policies(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn delete_identity_policies(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
    ...
    async fn create_verified_email_address(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // Use the runtime to execute async SDK calls
        self.provider.runtime().block_on(async {
            // Extract input fields
    ...
    async fn read_verified_email_address(&self, id: &str) -> Result<ResourceOutput> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to read the resource
            // Example:
            // let result = self.provider.ses_client
    ...
    async fn delete_verified_email_address(&self, id: &str) -> Result<()> {
        self.provider.runtime().block_on(async {
            // TODO: Call AWS SDK to delete the resource
            // Example:
            // self.provider.ses_client
