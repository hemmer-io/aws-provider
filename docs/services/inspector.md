...
# Create multiple assessment_runs resources
assessment_runs_0 = provider.inspector.Assessment_runs {
}
assessment_runs_1 = provider.inspector.Assessment_runs {
}
assessment_runs_2 = provider.inspector.Assessment_runs {
}
```
...
if environment == "production":
    assessment_runs = provider.inspector.Assessment_runs {
    }
```
