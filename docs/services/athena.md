...
# Create multiple data_catalog resources
data_catalog_0 = provider.athena.Data_catalog {
    type = "value-0"
    name = "value-0"
}
data_catalog_1 = provider.athena.Data_catalog {
    type = "value-1"
    name = "value-1"
}
data_catalog_2 = provider.athena.Data_catalog {
    type = "value-2"
    name = "value-2"
}
```
