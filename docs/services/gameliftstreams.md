...
# Create multiple stream_session_connection resources
stream_session_connection_0 = provider.gameliftstreams.Stream_session_connection {
    identifier = "value-0"
    stream_session_identifier = "value-0"
    signal_request = "value-0"
}
stream_session_connection_1 = provider.gameliftstreams.Stream_session_connection {
    identifier = "value-1"
    stream_session_identifier = "value-1"
    signal_request = "value-1"
}
stream_session_connection_2 = provider.gameliftstreams.Stream_session_connection {
    identifier = "value-2"
    stream_session_identifier = "value-2"
    signal_request = "value-2"
}
```
...
if environment == "production":
    stream_session_connection = provider.gameliftstreams.Stream_session_connection {
        ...
        stream_session_identifier = "production-value"
        signal_request = "production-value"
    }
```
