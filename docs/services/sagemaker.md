...
# Create multiple hub_content_reference resources
hub_content_reference_0 = provider.sagemaker.Hub_content_reference {
    hub_name = "value-0"
    sage_maker_public_hub_content_arn = "value-0"
}
hub_content_reference_1 = provider.sagemaker.Hub_content_reference {
    hub_name = "value-1"
    sage_maker_public_hub_content_arn = "value-1"
}
hub_content_reference_2 = provider.sagemaker.Hub_content_reference {
    hub_name = "value-2"
    sage_maker_public_hub_content_arn = "value-2"
}
```
...
if environment == "production":
    hub_content_reference = provider.sagemaker.Hub_content_reference {
        hub_name = "production-value"
        sage_maker_public_hub_content_arn = "production-value"
    }
```
