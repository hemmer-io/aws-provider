...
# Create multiple cluster_settings resources
cluster_settings_0 = provider.ecs.Cluster_settings {
    settings = "value-0"
    cluster = "value-0"
}
cluster_settings_1 = provider.ecs.Cluster_settings {
    settings = "value-1"
    cluster = "value-1"
}
cluster_settings_2 = provider.ecs.Cluster_settings {
    settings = "value-2"
    cluster = "value-2"
}
```
...
if environment == "production":
    cluster_settings = provider.ecs.Cluster_settings {
        settings = "production-value"
        cluster = "production-value"
    }
```
