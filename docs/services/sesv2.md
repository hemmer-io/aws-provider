...
# Create multiple dedicated_ip_pool_scaling_attributes resources
dedicated_ip_pool_scaling_attributes_0 = provider.sesv2.Dedicated_ip_pool_scaling_attributes {
    pool_name = "value-0"
    scaling_mode = "value-0"
}
dedicated_ip_pool_scaling_attributes_1 = provider.sesv2.Dedicated_ip_pool_scaling_attributes {
    pool_name = "value-1"
    scaling_mode = "value-1"
}
dedicated_ip_pool_scaling_attributes_2 = provider.sesv2.Dedicated_ip_pool_scaling_attributes {
    pool_name = "value-2"
    scaling_mode = "value-2"
}
```
...
if environment == "production":
    dedicated_ip_pool_scaling_attributes = provider.sesv2.Dedicated_ip_pool_scaling_attributes {
        pool_name = "production-value"
        scaling_mode = "production-value"
    }
```
