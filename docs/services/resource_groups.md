...
# Create multiple tag_sync_task resources
tag_sync_task_0 = provider.resource_groups.Tag_sync_task {
}
tag_sync_task_1 = provider.resource_groups.Tag_sync_task {
}
tag_sync_task_2 = provider.resource_groups.Tag_sync_task {
}
```
...
if environment == "production":
    tag_sync_task = provider.resource_groups.Tag_sync_task {
    }
```
