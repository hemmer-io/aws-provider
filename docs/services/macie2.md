...
# Create multiple custom_data_identifier resources
custom_data_identifier_0 = provider.macie2.Custom_data_identifier {
    name = "value-0"
    regex = "value-0"
}
custom_data_identifier_1 = provider.macie2.Custom_data_identifier {
    name = "value-1"
    regex = "value-1"
}
custom_data_identifier_2 = provider.macie2.Custom_data_identifier {
    name = "value-2"
    regex = "value-2"
}
```
