...
data_source_0 = provider.machine_learning.Data_source {
    data_source_name = "value-0"
    data_source_id = "value-0"
}
data_source_1 = provider.machine_learning.Data_source {
    data_source_name = "value-1"
    data_source_id = "value-1"
}
data_source_2 = provider.machine_learning.Data_source {
    data_source_name = "value-2"
...
if environment == "production":
    data_source = provider.machine_learning.Data_source {
        data_source_name = "production-value"
