...
# Create multiple data_repository_associations resources
data_repository_associations_0 = provider.fsx.Data_repository_associations {
}
data_repository_associations_1 = provider.fsx.Data_repository_associations {
}
data_repository_associations_2 = provider.fsx.Data_repository_associations {
}
```
...
if environment == "production":
    data_repository_associations = provider.fsx.Data_repository_associations {
    }
```
