...
# Create multiple availability_zone_change_protection resources
availability_zone_change_protection_0 = provider.network_firewall.Availability_zone_change_protection {
    availability_zone_change_protection = "value-0"
}
availability_zone_change_protection_1 = provider.network_firewall.Availability_zone_change_protection {
    availability_zone_change_protection = "value-1"
}
availability_zone_change_protection_2 = provider.network_firewall.Availability_zone_change_protection {
    availability_zone_change_protection = "value-2"
}
```
...
if environment == "production":
    availability_zone_change_protection = provider.network_firewall.Availability_zone_change_protection {
        availability_zone_change_protection = "production-value"
    }
```
