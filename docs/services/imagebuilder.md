...
# Create multiple component resources
component_0 = provider.imagebuilder.Component {
    client_token = "value-0"
    name = "value-0"
    platform = "value-0"
    semantic_version = "value-0"
}
component_1 = provider.imagebuilder.Component {
    client_token = "value-1"
    name = "value-1"
    platform = "value-1"
    semantic_version = "value-1"
}
component_2 = provider.imagebuilder.Component {
