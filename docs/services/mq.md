...
# Create multiple broker_engine_types resources
broker_engine_types_0 = provider.mq.Broker_engine_types {
}
broker_engine_types_1 = provider.mq.Broker_engine_types {
}
broker_engine_types_2 = provider.mq.Broker_engine_types {
}
```
...
if environment == "production":
    broker_engine_types = provider.mq.Broker_engine_types {
    }
```
