...
# Create multiple chime_webhook_configurations resources
chime_webhook_configurations_0 = provider.chatbot.Chime_webhook_configurations {
}
chime_webhook_configurations_1 = provider.chatbot.Chime_webhook_configurations {
}
chime_webhook_configurations_2 = provider.chatbot.Chime_webhook_configurations {
}
```
...
if environment == "production":
    chime_webhook_configurations = provider.chatbot.Chime_webhook_configurations {
    }
```
