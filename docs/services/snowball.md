...
# Create multiple return_shipping_label resources
return_shipping_label_0 = provider.snowball.Return_shipping_label {
    job_id = "value-0"
}
return_shipping_label_1 = provider.snowball.Return_shipping_label {
    job_id = "value-1"
}
return_shipping_label_2 = provider.snowball.Return_shipping_label {
    job_id = "value-2"
}
```
