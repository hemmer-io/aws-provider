...
# Create multiple load_balancer_target_groups resources
load_balancer_target_groups_0 = provider.auto_scaling.Load_balancer_target_groups {
}
load_balancer_target_groups_1 = provider.auto_scaling.Load_balancer_target_groups {
}
load_balancer_target_groups_2 = provider.auto_scaling.Load_balancer_target_groups {
}
```
...
if environment == "production":
    load_balancer_target_groups = provider.auto_scaling.Load_balancer_target_groups {
    }
```
