...
# Create multiple resolver resources
resolver_0 = provider.appsync.Resolver {
    field_name = "value-0"
    api_id = "value-0"
    type_name = "value-0"
}
resolver_1 = provider.appsync.Resolver {
    field_name = "value-1"
    api_id = "value-1"
    type_name = "value-1"
}
resolver_2 = provider.appsync.Resolver {
    field_name = "value-2"
    api_id = "value-2"
    type_name = "value-2"
}
...
if environment == "production":
    resolver = provider.appsync.Resolver {
        field_name = "production-value"
        api_id = "production-value"
        type_name = "production-value"
    }
```
