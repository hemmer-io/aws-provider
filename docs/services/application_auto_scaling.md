...
# Create multiple scalable_targets resources
scalable_targets_0 = provider.application_auto_scaling.Scalable_targets {
}
scalable_targets_1 = provider.application_auto_scaling.Scalable_targets {
}
scalable_targets_2 = provider.application_auto_scaling.Scalable_targets {
}
```
...
if environment == "production":
    scalable_targets = provider.application_auto_scaling.Scalable_targets {
    }
```
