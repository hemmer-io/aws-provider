...
# Create multiple firewall_rule_group resources
firewall_rule_group_0 = provider.route53resolver.Firewall_rule_group {
    name = "value-0"
    creator_request_id = "value-0"
}
firewall_rule_group_1 = provider.route53resolver.Firewall_rule_group {
    name = "value-1"
    creator_request_id = "value-1"
}
firewall_rule_group_2 = provider.route53resolver.Firewall_rule_group {
    name = "value-2"
