...
# Create multiple ticket_v2 resources
ticket_v2_0 = provider.securityhub.Ticket_v2 {
    finding_metadata_uid = "value-0"
    connector_id = "value-0"
}
ticket_v2_1 = provider.securityhub.Ticket_v2 {
    finding_metadata_uid = "value-1"
    connector_id = "value-1"
}
ticket_v2_2 = provider.securityhub.Ticket_v2 {
    finding_metadata_uid = "value-2"
    connector_id = "value-2"
}
```
...
if environment == "production":
    ticket_v2 = provider.securityhub.Ticket_v2 {
        finding_metadata_uid = "production-value"
        connector_id = "production-value"
    }
```
