...
# Create multiple managed_view resources
managed_view_0 = provider.resource_explorer_2.Managed_view {
}
managed_view_1 = provider.resource_explorer_2.Managed_view {
}
managed_view_2 = provider.resource_explorer_2.Managed_view {
}
```
...
if environment == "production":
    managed_view = provider.resource_explorer_2.Managed_view {
    }
```
