...
# Create multiple secret_version_stage resources
secret_version_stage_0 = provider.secrets_manager.Secret_version_stage {
    secret_id = "value-0"
    version_stage = "value-0"
}
secret_version_stage_1 = provider.secrets_manager.Secret_version_stage {
    secret_id = "value-1"
    version_stage = "value-1"
}
secret_version_stage_2 = provider.secrets_manager.Secret_version_stage {
    secret_id = "value-2"
    version_stage = "value-2"
}
```
...
if environment == "production":
    secret_version_stage = provider.secrets_manager.Secret_version_stage {
        secret_id = "production-value"
        version_stage = "production-value"
    }
```
