...
# Create multiple ml_model_training_job resources
ml_model_training_job_0 = provider.neptunedata.Ml_model_training_job {
}
ml_model_training_job_1 = provider.neptunedata.Ml_model_training_job {
}
ml_model_training_job_2 = provider.neptunedata.Ml_model_training_job {
}
```
...
if environment == "production":
    ml_model_training_job = provider.neptunedata.Ml_model_training_job {
    }
```
