...
# Create multiple license_conversion_task resources
license_conversion_task_0 = provider.license_manager.License_conversion_task {
}
license_conversion_task_1 = provider.license_manager.License_conversion_task {
}
license_conversion_task_2 = provider.license_manager.License_conversion_task {
}
```
...
if environment == "production":
    license_conversion_task = provider.license_manager.License_conversion_task {
    }
```
