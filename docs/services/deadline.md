...
# Create multiple queue_limit_association resources
queue_limit_association_0 = provider.deadline.Queue_limit_association {
    farm_id = "value-0"
    queue_id = "value-0"
    limit_id = "value-0"
}
queue_limit_association_1 = provider.deadline.Queue_limit_association {
    farm_id = "value-1"
    queue_id = "value-1"
    limit_id = "value-1"
}
queue_limit_association_2 = provider.deadline.Queue_limit_association {
    farm_id = "value-2"
    queue_id = "value-2"
    limit_id = "value-2"
}
