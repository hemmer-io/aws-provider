...
# Create multiple nfs_file_share resources
nfs_file_share_0 = provider.storage_gateway.Nfs_file_share {
    client_token = "value-0"
    location_arn = "value-0"
    gateway_arn = "value-0"
    role = "value-0"
}
nfs_file_share_1 = provider.storage_gateway.Nfs_file_share {
    client_token = "value-1"
    location_arn = "value-1"
    gateway_arn = "value-1"
    role = "value-1"
}
nfs_file_share_2 = provider.storage_gateway.Nfs_file_share {
    client_token = "value-2"
    location_arn = "value-2"
    gateway_arn = "value-2"
    role = "value-2"
}
```
...
if environment == "production":
    nfs_file_share = provider.storage_gateway.Nfs_file_share {
        ...
        location_arn = "production-value"
        gateway_arn = "production-value"
