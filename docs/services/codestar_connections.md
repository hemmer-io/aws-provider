...
# Create multiple sync_blocker resources
sync_blocker_0 = provider.codestar_connections.Sync_blocker {
    sync_type = "value-0"
    id = "value-0"
    resource_name = "value-0"
    resolved_reason = "value-0"
}
sync_blocker_1 = provider.codestar_connections.Sync_blocker {
    sync_type = "value-1"
    id = "value-1"
    resource_name = "value-1"
    resolved_reason = "value-1"
}
sync_blocker_2 = provider.codestar_connections.Sync_blocker {
    sync_type = "value-2"
    id = "value-2"
    resource_name = "value-2"
    resolved_reason = "value-2"
}
```
...
if environment == "production":
    sync_blocker = provider.codestar_connections.Sync_blocker {
        sync_type = "production-value"
        id = "production-value"
        resource_name = "production-value"
        resolved_reason = "production-value"
    }
```
