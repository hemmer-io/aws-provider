...
# Create multiple migration_task resources
migration_task_0 = provider.migration_hub.Migration_task {
}
migration_task_1 = provider.migration_hub.Migration_task {
}
migration_task_2 = provider.migration_hub.Migration_task {
}
```
...
if environment == "production":
    migration_task = provider.migration_hub.Migration_task {
    }
```
