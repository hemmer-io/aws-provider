...
# Create multiple sip_media_application_logging_configuration resources
sip_media_application_logging_configuration_0 = provider.chime_sdk.Sip_media_application_logging_configuration {
    sip_media_application_id = "value-0"
}
sip_media_application_logging_configuration_1 = provider.chime_sdk.Sip_media_application_logging_configuration {
    sip_media_application_id = "value-1"
}
sip_media_application_logging_configuration_2 = provider.chime_sdk.Sip_media_application_logging_configuration {
    sip_media_application_id = "value-2"
}
```
...
if environment == "production":
    sip_media_application_logging_configuration = provider.chime_sdk.Sip_media_application_logging_configuration {
        sip_media_application_id = "production-value"
    }
```
