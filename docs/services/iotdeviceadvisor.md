...
# Create multiple suite_run_report resources
suite_run_report_0 = provider.iotdeviceadvisor.Suite_run_report {
}
suite_run_report_1 = provider.iotdeviceadvisor.Suite_run_report {
}
suite_run_report_2 = provider.iotdeviceadvisor.Suite_run_report {
}
```
...
if environment == "production":
    suite_run_report = provider.iotdeviceadvisor.Suite_run_report {
    }
```
