...
# Create multiple text_translation_job resources
text_translation_job_0 = provider.translate.Text_translation_job {
}
text_translation_job_1 = provider.translate.Text_translation_job {
}
text_translation_job_2 = provider.translate.Text_translation_job {
}
```
...
if environment == "production":
    text_translation_job = provider.translate.Text_translation_job {
    }
```
