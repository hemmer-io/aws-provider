...
# Create multiple vocabulary_filter resources
vocabulary_filter_0 = provider.transcribe.Vocabulary_filter {
    language_code = "value-0"
    vocabulary_filter_name = "value-0"
}
vocabulary_filter_1 = provider.transcribe.Vocabulary_filter {
    language_code = "value-1"
    vocabulary_filter_name = "value-1"
}
vocabulary_filter_2 = provider.transcribe.Vocabulary_filter {
    language_code = "value-2"
    vocabulary_filter_name = "value-2"
}
```
...
if environment == "production":
    vocabulary_filter = provider.transcribe.Vocabulary_filter {
        language_code = "production-value"
        vocabulary_filter_name = "production-value"
    }
```
