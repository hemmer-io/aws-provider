...
# Create multiple site_to_site_vpn_attachment resources
site_to_site_vpn_attachment_0 = provider.networkmanager.Site_to_site_vpn_attachment {
    vpn_connection_arn = "value-0"
    core_network_id = "value-0"
}
site_to_site_vpn_attachment_1 = provider.networkmanager.Site_to_site_vpn_attachment {
    vpn_connection_arn = "value-1"
    core_network_id = "value-1"
}
site_to_site_vpn_attachment_2 = provider.networkmanager.Site_to_site_vpn_attachment {
    vpn_connection_arn = "value-2"
    core_network_id = "value-2"
}
```
...
if environment == "production":
    site_to_site_vpn_attachment = provider.networkmanager.Site_to_site_vpn_attachment {
        vpn_connection_arn = "production-value"
        core_network_id = "production-value"
    }
```
