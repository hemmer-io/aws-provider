...
# Create multiple db_cluster resources
db_cluster_0 = provider.docdb.Db_cluster {
    engine = "value-0"
    db_cluster_identifier = "value-0"
}
db_cluster_1 = provider.docdb.Db_cluster {
    engine = "value-1"
    db_cluster_identifier = "value-1"
}
db_cluster_2 = provider.docdb.Db_cluster {
    engine = "value-2"
