...
# Create multiple instance_type_limits resources
instance_type_limits_0 = provider.opensearch.Instance_type_limits {
}
instance_type_limits_1 = provider.opensearch.Instance_type_limits {
}
instance_type_limits_2 = provider.opensearch.Instance_type_limits {
}
```
...
if environment == "production":
    instance_type_limits = provider.opensearch.Instance_type_limits {
    }
```
