...
# Create multiple external_data_view_access_details resources
external_data_view_access_details_0 = provider.finspace_data.External_data_view_access_details {
}
external_data_view_access_details_1 = provider.finspace_data.External_data_view_access_details {
}
external_data_view_access_details_2 = provider.finspace_data.External_data_view_access_details {
}
```
...
if environment == "production":
    external_data_view_access_details = provider.finspace_data.External_data_view_access_details {
    }
```
