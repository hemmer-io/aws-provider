...
# Create multiple configuration_settings resources
configuration_settings_0 = provider.elastic_beanstalk.Configuration_settings {
}
configuration_settings_1 = provider.elastic_beanstalk.Configuration_settings {
}
configuration_settings_2 = provider.elastic_beanstalk.Configuration_settings {
}
```
...
if environment == "production":
    configuration_settings = provider.elastic_beanstalk.Configuration_settings {
    }
```
