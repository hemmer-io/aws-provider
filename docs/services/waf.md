...
regex_match_set = provider.waf.Regex_match_set {
...
size_constraint_set = provider.waf.Size_constraint_set {
    change_token = "value"  # <p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>
...
sql_injection_match_set = provider.waf.Sql_injection_match_set {
    change_token = "value"  # <p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>
