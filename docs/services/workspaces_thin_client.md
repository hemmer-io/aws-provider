...
environment_0 = provider.workspaces_thin_client.Environment {
    desktop_arn = "value-0"
}
environment_1 = provider.workspaces_thin_client.Environment {
    desktop_arn = "value-1"
}
environment_2 = provider.workspaces_thin_client.Environment {
    desktop_arn = "value-2"
}
```
