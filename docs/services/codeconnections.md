...
# Create multiple sync_blocker_summary resources
sync_blocker_summary_0 = provider.codeconnections.Sync_blocker_summary {
}
sync_blocker_summary_1 = provider.codeconnections.Sync_blocker_summary {
}
sync_blocker_summary_2 = provider.codeconnections.Sync_blocker_summary {
}
```
...
if environment == "production":
    sync_blocker_summary = provider.codeconnections.Sync_blocker_summary {
    }
```
