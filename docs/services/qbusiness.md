...
# Create multiple conversation resources
conversation_0 = provider.qbusiness.Conversation {
}
conversation_1 = provider.qbusiness.Conversation {
}
conversation_2 = provider.qbusiness.Conversation {
}
```
...
if environment == "production":
    conversation = provider.qbusiness.Conversation {
    }
```
