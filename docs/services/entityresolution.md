...
# Create multiple matching_workflow resources
matching_workflow_0 = provider.entityresolution.Matching_workflow {
    output_source_config = "value-0"
    role_arn = "value-0"
    input_source_config = "value-0"
    resolution_techniques = "value-0"
    workflow_name = "value-0"
}
matching_workflow_1 = provider.entityresolution.Matching_workflow {
    output_source_config = "value-1"
    role_arn = "value-1"
    input_source_config = "value-1"
    resolution_techniques = "value-1"
    workflow_name = "value-1"
}
matching_workflow_2 = provider.entityresolution.Matching_workflow {
    output_source_config = "value-2"
    role_arn = "value-2"
    input_source_config = "value-2"
    resolution_techniques = "value-2"
    workflow_name = "value-2"
}
```
...
if environment == "production":
    matching_workflow = provider.entityresolution.Matching_workflow {
        output_source_config = "production-value"
        role_arn = "production-value"
        input_source_config = "production-value"
        resolution_techniques = "production-value"
        workflow_name = "production-value"
    }
```
