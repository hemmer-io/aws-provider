...
# Create multiple home_region_controls resources
home_region_controls_0 = provider.migrationhub_config.Home_region_controls {
}
home_region_controls_1 = provider.migrationhub_config.Home_region_controls {
}
home_region_controls_2 = provider.migrationhub_config.Home_region_controls {
}
```
...
if environment == "production":
    home_region_controls = provider.migrationhub_config.Home_region_controls {
    }
```
