...
# Create multiple system_template resources
system_template_0 = provider.iotthingsgraph.System_template {
    definition = "value-0"
}
system_template_1 = provider.iotthingsgraph.System_template {
    definition = "value-1"
}
system_template_2 = provider.iotthingsgraph.System_template {
    definition = "value-2"
}
```
