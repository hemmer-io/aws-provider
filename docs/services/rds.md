...
# Create multiple db_shard_group resources
db_shard_group_0 = provider.rds.Db_shard_group {
    db_cluster_identifier = "value-0"
    max_acu = "value-0"
    db_shard_group_identifier = "value-0"
}
db_shard_group_1 = provider.rds.Db_shard_group {
    db_cluster_identifier = "value-1"
    max_acu = "value-1"
    db_shard_group_identifier = "value-1"
}
db_shard_group_2 = provider.rds.Db_shard_group {
    db_cluster_identifier = "value-2"
    max_acu = "value-2"
    db_shard_group_identifier = "value-2"
}
```
...
if environment == "production":
    db_shard_group = provider.rds.Db_shard_group {
        ...
        max_acu = "production-value"
        db_shard_group_identifier = "production-value"
    }
```
