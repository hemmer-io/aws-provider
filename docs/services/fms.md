...
# Create multiple protocols_list resources
protocols_list_0 = provider.fms.Protocols_list {
    protocols_list = "value-0"
}
protocols_list_1 = provider.fms.Protocols_list {
    protocols_list = "value-1"
}
protocols_list_2 = provider.fms.Protocols_list {
    protocols_list = "value-2"
}
```
...
if environment == "production":
    protocols_list = provider.fms.Protocols_list {
        protocols_list = "production-value"
    }
```
