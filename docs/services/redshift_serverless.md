...
# Create multiple custom_domain_association resources
custom_domain_association_0 = provider.redshift_serverless.Custom_domain_association {
    custom_domain_name = "value-0"
    workgroup_name = "value-0"
    custom_domain_certificate_arn = "value-0"
}
custom_domain_association_1 = provider.redshift_serverless.Custom_domain_association {
    custom_domain_name = "value-1"
    workgroup_name = "value-1"
    custom_domain_certificate_arn = "value-1"
}
custom_domain_association_2 = provider.redshift_serverless.Custom_domain_association {
    custom_domain_name = "value-2"
    workgroup_name = "value-2"
    custom_domain_certificate_arn = "value-2"
}
```
...
if environment == "production":
    custom_domain_association = provider.redshift_serverless.Custom_domain_association {
        custom_domain_name = "production-value"
        workgroup_name = "production-value"
        custom_domain_certificate_arn = "production-value"
    }
```
