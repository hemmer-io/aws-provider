...
# Create multiple reusable_delegation_set resources
reusable_delegation_set_0 = provider.route_53.Reusable_delegation_set {
    caller_reference = "value-0"
}
reusable_delegation_set_1 = provider.route_53.Reusable_delegation_set {
    caller_reference = "value-1"
}
reusable_delegation_set_2 = provider.route_53.Reusable_delegation_set {
    caller_reference = "value-2"
}
```
...
if environment == "production":
    reusable_delegation_set = provider.route_53.Reusable_delegation_set {
        caller_reference = "production-value"
    }
```
