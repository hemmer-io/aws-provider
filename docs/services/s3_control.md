...
# Create multiple access_grants_location resources
access_grants_location_0 = provider.s3_control.Access_grants_location {
    iam_role_arn = "value-0"
    location_scope = "value-0"
    account_id = "value-0"
}
access_grants_location_1 = provider.s3_control.Access_grants_location {
    iam_role_arn = "value-1"
    location_scope = "value-1"
    account_id = "value-1"
}
access_grants_location_2 = provider.s3_control.Access_grants_location {
    iam_role_arn = "value-2"
    location_scope = "value-2"
    account_id = "value-2"
}
```
...
if environment == "production":
    access_grants_location = provider.s3_control.Access_grants_location {
        ...
        location_scope = "production-value"
