...
# Create multiple game_session_details resources
game_session_details_0 = provider.gamelift.Game_session_details {
}
game_session_details_1 = provider.gamelift.Game_session_details {
}
game_session_details_2 = provider.gamelift.Game_session_details {
}
```
...
if environment == "production":
    game_session_details = provider.gamelift.Game_session_details {
    }
```
