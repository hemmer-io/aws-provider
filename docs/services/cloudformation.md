...
change_set_0 = provider.cloudformation.Change_set {
    change_set_name = "value-0"
    stack_name = "value-0"
}
change_set_1 = provider.cloudformation.Change_set {
    change_set_name = "value-1"
    stack_name = "value-1"
}
change_set_2 = provider.cloudformation.Change_set {
    change_set_name = "value-2"
    stack_name = "value-2"
}
```
...
if environment == "production":
    change_set = provider.cloudformation.Change_set {
        change_set_name = "production-value"
        stack_name = "production-value"
    }
```
