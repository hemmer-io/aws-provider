...
# Create multiple event_aggregates resources
event_aggregates_0 = provider.health.Event_aggregates {
}
event_aggregates_1 = provider.health.Event_aggregates {
}
event_aggregates_2 = provider.health.Event_aggregates {
}
```
...
if environment == "production":
    event_aggregates = provider.health.Event_aggregates {
    }
```
