...
# Create multiple storage_configuration resources
storage_configuration_0 = provider.iotsitewise.Storage_configuration {
    storage_type = "value-0"
}
storage_configuration_1 = provider.iotsitewise.Storage_configuration {
    storage_type = "value-1"
}
storage_configuration_2 = provider.iotsitewise.Storage_configuration {
    storage_type = "value-2"
}
```
