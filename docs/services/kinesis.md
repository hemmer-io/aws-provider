...
# Create multiple media_for_fragment_list resources
media_for_fragment_list_0 = provider.kinesis.Media_for_fragment_list {
}
media_for_fragment_list_1 = provider.kinesis.Media_for_fragment_list {
}
media_for_fragment_list_2 = provider.kinesis.Media_for_fragment_list {
}
```
...
if environment == "production":
    media_for_fragment_list = provider.kinesis.Media_for_fragment_list {
    }
```
