...
endpoints_0 = provider.dynamodb.Endpoints {
}
endpoints_1 = provider.dynamodb.Endpoints {
}
endpoints_2 = provider.dynamodb.Endpoints {
}
```
...
if environment == "production":
    endpoints = provider.dynamodb.Endpoints {
    }
```
