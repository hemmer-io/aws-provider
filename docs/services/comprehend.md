...
# Create multiple entities_detection_job resources
entities_detection_job_0 = provider.comprehend.Entities_detection_job {
}
entities_detection_job_1 = provider.comprehend.Entities_detection_job {
}
entities_detection_job_2 = provider.comprehend.Entities_detection_job {
}
```
...
if environment == "production":
    entities_detection_job = provider.comprehend.Entities_detection_job {
    }
```
