...
|--------|------|-------------|
| `queue_url` | String | <p>The URL of the queue.</p> |
...
| Output | Type | Description |
|--------|------|-------------|
| `attributes` | HashMap<String, String> | <p>A map of attributes to their respective values.</p> |
...
# Access queue_attributes outputs
queue_attributes_id = queue_attributes.id
queue_attributes_attributes = queue_attributes.attributes
```
...
# Create queue
queue = provider.sqs.Queue {
    queue_name = "value"  # <p>The name of the new queue. The following limits apply to this name:</p>
         <ul>
            <li>
               <p>A queue name can have up to 80 characters.</p>
            </li>
