...
# Create multiple data_lake_settings resources
data_lake_settings_0 = provider.lakeformation.Data_lake_settings {
    data_lake_settings = "value-0"
}
data_lake_settings_1 = provider.lakeformation.Data_lake_settings {
    data_lake_settings = "value-1"
}
data_lake_settings_2 = provider.lakeformation.Data_lake_settings {
    data_lake_settings = "value-2"
}
```
...
if environment == "production":
    data_lake_settings = provider.lakeformation.Data_lake_settings {
        data_lake_settings = "production-value"
    }
```
