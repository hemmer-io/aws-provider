...
# Create multiple connector resources
connector_0 = provider.kafkaconnect.Connector {
    plugins = "value-0"
    connector_name = "value-0"
    kafka_cluster = "value-0"
    connector_configuration = "value-0"
    kafka_cluster_client_authentication = "value-0"
    kafka_connect_version = "value-0"
    kafka_cluster_encryption_in_transit = "value-0"
    service_execution_role_arn = "value-0"
    capacity = "value-0"
}
connector_1 = provider.kafkaconnect.Connector {
    plugins = "value-1"
    connector_name = "value-1"
    kafka_cluster = "value-1"
    connector_configuration = "value-1"
    kafka_cluster_client_authentication = "value-1"
    kafka_connect_version = "value-1"
    kafka_cluster_encryption_in_transit = "value-1"
    service_execution_role_arn = "value-1"
    capacity = "value-1"
}
connector_2 = provider.kafkaconnect.Connector {
    plugins = "value-2"
    connector_name = "value-2"
    kafka_cluster = "value-2"
    connector_configuration = "value-2"
    kafka_cluster_client_authentication = "value-2"
    kafka_connect_version = "value-2"
    kafka_cluster_encryption_in_transit = "value-2"
    service_execution_role_arn = "value-2"
    capacity = "value-2"
}
```
...
if environment == "production":
    connector = provider.kafkaconnect.Connector {
        ...
        connector_name = "production-value"
        kafka_cluster = "production-value"
        connector_configuration = "production-value"
        kafka_cluster_client_authentication = "production-value"
        kafka_connect_version = "production-value"
        kafka_cluster_encryption_in_transit = "production-value"
        service_execution_role_arn = "production-value"
