...
db_cluster_parameter_groups_0 = provider.neptune.Db_cluster_parameter_groups {
}
db_cluster_parameter_groups_1 = provider.neptune.Db_cluster_parameter_groups {
}
db_cluster_parameter_groups_2 = provider.neptune.Db_cluster_parameter_groups {
}
```
...
if environment == "production":
    db_cluster_parameter_groups = provider.neptune.Db_cluster_parameter_groups {
    }
```
