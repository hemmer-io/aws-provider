...
# Create multiple vpc_connector resources
vpc_connector_0 = provider.apprunner.Vpc_connector {
    vpc_connector_name = "value-0"
    subnets = "value-0"
}
vpc_connector_1 = provider.apprunner.Vpc_connector {
    vpc_connector_name = "value-1"
    subnets = "value-1"
}
vpc_connector_2 = provider.apprunner.Vpc_connector {
    vpc_connector_name = "value-2"
    subnets = "value-2"
}
```
...
if environment == "production":
    vpc_connector = provider.apprunner.Vpc_connector {
        vpc_connector_name = "production-value"
        subnets = "production-value"
    }
```
