...
# Create multiple subscriber resources
subscriber_0 = provider.budgets.Subscriber {
    notification = "value-0"
    subscriber = "value-0"
    account_id = "value-0"
    budget_name = "value-0"
}
subscriber_1 = provider.budgets.Subscriber {
    notification = "value-1"
    subscriber = "value-1"
    account_id = "value-1"
    budget_name = "value-1"
}
subscriber_2 = provider.budgets.Subscriber {
