...
# Create multiple detector_model resources
detector_model_0 = provider.iot_events.Detector_model {
    role_arn = "value-0"
    detector_model_name = "value-0"
    detector_model_definition = "value-0"
}
detector_model_1 = provider.iot_events.Detector_model {
    role_arn = "value-1"
    detector_model_name = "value-1"
    detector_model_definition = "value-1"
}
detector_model_2 = provider.iot_events.Detector_model {
    role_arn = "value-2"
    detector_model_name = "value-2"
    detector_model_definition = "value-2"
}
```
...
if environment == "production":
    detector_model = provider.iot_events.Detector_model {
        ...
        detector_model_name = "production-value"
        detector_model_definition = "production-value"
    }
```
