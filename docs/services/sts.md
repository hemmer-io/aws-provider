...
# Create multiple caller_identity resources
caller_identity_0 = provider.sts.Caller_identity {
}
caller_identity_1 = provider.sts.Caller_identity {
}
caller_identity_2 = provider.sts.Caller_identity {
}
```
...
if environment == "production":
    caller_identity = provider.sts.Caller_identity {
    }
```
