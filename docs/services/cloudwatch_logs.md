...
# Create multiple metric_filter resources
metric_filter_0 = provider.cloudwatch_logs.Metric_filter {
    metric_transformations = "value-0"
    log_group_name = "value-0"
    filter_name = "value-0"
    filter_pattern = "value-0"
}
metric_filter_1 = provider.cloudwatch_logs.Metric_filter {
    metric_transformations = "value-1"
    log_group_name = "value-1"
    filter_name = "value-1"
    filter_pattern = "value-1"
}
metric_filter_2 = provider.cloudwatch_logs.Metric_filter {
    metric_transformations = "value-2"
    log_group_name = "value-2"
    filter_name = "value-2"
    filter_pattern = "value-2"
}
```
...
if environment == "production":
    metric_filter = provider.cloudwatch_logs.Metric_filter {
        metric_transformations = "production-value"
        log_group_name = "production-value"
        filter_name = "production-value"
        filter_pattern = "production-value"
    }
```
