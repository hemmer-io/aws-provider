...
# Create multiple effective_recommendation_preferences resources
effective_recommendation_preferences_0 = provider.compute_optimizer.Effective_recommendation_preferences {
}
effective_recommendation_preferences_1 = provider.compute_optimizer.Effective_recommendation_preferences {
}
effective_recommendation_preferences_2 = provider.compute_optimizer.Effective_recommendation_preferences {
}
```
...
if environment == "production":
    effective_recommendation_preferences = provider.compute_optimizer.Effective_recommendation_preferences {
    }
```
