...
# Create multiple app_version_app_component resources
app_version_app_component_0 = provider.resiliencehub.App_version_app_component {
    type = "value-0"
    app_arn = "value-0"
    name = "value-0"
}
app_version_app_component_1 = provider.resiliencehub.App_version_app_component {
    type = "value-1"
    app_arn = "value-1"
    name = "value-1"
}
app_version_app_component_2 = provider.resiliencehub.App_version_app_component {
    type = "value-2"
    app_arn = "value-2"
    name = "value-2"
}
