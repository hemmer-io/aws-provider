...
# Create multiple multi_region_parameters resources
multi_region_parameters_0 = provider.memorydb.Multi_region_parameters {
}
multi_region_parameters_1 = provider.memorydb.Multi_region_parameters {
}
multi_region_parameters_2 = provider.memorydb.Multi_region_parameters {
}
```
...
if environment == "production":
    multi_region_parameters = provider.memorydb.Multi_region_parameters {
    }
```
