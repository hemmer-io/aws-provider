...
# Create multiple identity_usage resources
identity_usage_0 = provider.cognito_sync.Identity_usage {
}
identity_usage_1 = provider.cognito_sync.Identity_usage {
}
identity_usage_2 = provider.cognito_sync.Identity_usage {
}
```
...
if environment == "production":
    identity_usage = provider.cognito_sync.Identity_usage {
    }
```
