...
# Create multiple rules_of_ip_group resources
rules_of_ip_group_0 = provider.workspaces.Rules_of_ip_group {
    group_id = "value-0"
    user_rules = "value-0"
}
rules_of_ip_group_1 = provider.workspaces.Rules_of_ip_group {
    group_id = "value-1"
    user_rules = "value-1"
}
rules_of_ip_group_2 = provider.workspaces.Rules_of_ip_group {
    group_id = "value-2"
    user_rules = "value-2"
}
```
...
if environment == "production":
    rules_of_ip_group = provider.workspaces.Rules_of_ip_group {
        group_id = "production-value"
        user_rules = "production-value"
    }
```
