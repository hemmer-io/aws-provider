...
# Create multiple capacity_block_status resources
capacity_block_status_0 = provider.ec2.Capacity_block_status {
}
capacity_block_status_1 = provider.ec2.Capacity_block_status {
}
capacity_block_status_2 = provider.ec2.Capacity_block_status {
}
```
...
if environment == "production":
    capacity_block_status = provider.ec2.Capacity_block_status {
    }
```
