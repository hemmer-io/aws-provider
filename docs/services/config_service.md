...
# Create multiple organization_custom_rule_policy resources
organization_custom_rule_policy_0 = provider.config_service.Organization_custom_rule_policy {
}
organization_custom_rule_policy_1 = provider.config_service.Organization_custom_rule_policy {
}
organization_custom_rule_policy_2 = provider.config_service.Organization_custom_rule_policy {
}
```
...
if environment == "production":
    organization_custom_rule_policy = provider.config_service.Organization_custom_rule_policy {
    }
```
