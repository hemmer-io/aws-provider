...
# Create multiple import resources
import_0 = provider.lex_model_building_service.Import {
}
import_1 = provider.lex_model_building_service.Import {
}
import_2 = provider.lex_model_building_service.Import {
}
```
...
if environment == "production":
    import = provider.lex_model_building_service.Import {
    }
```
