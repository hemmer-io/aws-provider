...
# Create multiple managed_rule_set_versions resources
managed_rule_set_versions_0 = provider.wafv2.Managed_rule_set_versions {
    id = "value-0"
    name = "value-0"
    scope = "value-0"
    lock_token = "value-0"
}
managed_rule_set_versions_1 = provider.wafv2.Managed_rule_set_versions {
    id = "value-1"
    name = "value-1"
    scope = "value-1"
    lock_token = "value-1"
}
managed_rule_set_versions_2 = provider.wafv2.Managed_rule_set_versions {
    id = "value-2"
    name = "value-2"
    scope = "value-2"
    lock_token = "value-2"
