...
# Create multiple reserved_node_offerings resources
reserved_node_offerings_0 = provider.redshift.Reserved_node_offerings {
}
reserved_node_offerings_1 = provider.redshift.Reserved_node_offerings {
}
reserved_node_offerings_2 = provider.redshift.Reserved_node_offerings {
}
```
...
if environment == "production":
    reserved_node_offerings = provider.redshift.Reserved_node_offerings {
    }
```
