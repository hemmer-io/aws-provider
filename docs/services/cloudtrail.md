...
# Create multiple trail_status resources
trail_status_0 = provider.cloudtrail.Trail_status {
}
trail_status_1 = provider.cloudtrail.Trail_status {
}
trail_status_2 = provider.cloudtrail.Trail_status {
}
```
...
if environment == "production":
    trail_status = provider.cloudtrail.Trail_status {
    }
```
