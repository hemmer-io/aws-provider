...
# Create multiple method_response resources
method_response_0 = provider.api_gateway.Method_response {
    rest_api_id = "value-0"
    resource_id = "value-0"
    http_method = "value-0"
    status_code = "value-0"
}
method_response_1 = provider.api_gateway.Method_response {
    rest_api_id = "value-1"
    resource_id = "value-1"
    http_method = "value-1"
    status_code = "value-1"
}
method_response_2 = provider.api_gateway.Method_response {
    rest_api_id = "value-2"
    resource_id = "value-2"
    http_method = "value-2"
    status_code = "value-2"
