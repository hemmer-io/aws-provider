...
# Create multiple location_hdfs resources
location_hdfs_0 = provider.datasync.Location_hdfs {
    authentication_type = "value-0"
    agent_arns = "value-0"
    name_nodes = "value-0"
}
location_hdfs_1 = provider.datasync.Location_hdfs {
    authentication_type = "value-1"
    agent_arns = "value-1"
    name_nodes = "value-1"
}
location_hdfs_2 = provider.datasync.Location_hdfs {
...
if environment == "production":
    location_hdfs = provider.datasync.Location_hdfs {
        authentication_type = "production-value"
        agent_arns = "production-value"
        name_nodes = "production-value"
    }
```
