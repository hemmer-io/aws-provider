...
# Create multiple deletion_protection resources
deletion_protection_0 = provider.ssm_incidents.Deletion_protection {
    arn = "value-0"
    deletion_protected = "value-0"
}
deletion_protection_1 = provider.ssm_incidents.Deletion_protection {
    arn = "value-1"
    deletion_protected = "value-1"
}
deletion_protection_2 = provider.ssm_incidents.Deletion_protection {
    arn = "value-2"
    deletion_protected = "value-2"
}
```
...
if environment == "production":
    deletion_protection = provider.ssm_incidents.Deletion_protection {
        arn = "production-value"
        deletion_protected = "production-value"
    }
```
