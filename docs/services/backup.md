...
# Create multiple backup_plan_from_json resources
backup_plan_from_json_0 = provider.backup.Backup_plan_from_json {
}
backup_plan_from_json_1 = provider.backup.Backup_plan_from_json {
}
backup_plan_from_json_2 = provider.backup.Backup_plan_from_json {
}
```
...
if environment == "production":
    backup_plan_from_json = provider.backup.Backup_plan_from_json {
    }
```
