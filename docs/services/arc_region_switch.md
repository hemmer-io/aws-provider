...
# Create multiple plan_in_region resources
plan_in_region_0 = provider.arc_region_switch.Plan_in_region {
}
plan_in_region_1 = provider.arc_region_switch.Plan_in_region {
}
plan_in_region_2 = provider.arc_region_switch.Plan_in_region {
}
```
...
if environment == "production":
    plan_in_region = provider.arc_region_switch.Plan_in_region {
    }
```
