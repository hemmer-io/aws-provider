...
# Create multiple ui_customization resources
ui_customization_0 = provider.cognito_identity_provider.Ui_customization {
}
ui_customization_1 = provider.cognito_identity_provider.Ui_customization {
}
ui_customization_2 = provider.cognito_identity_provider.Ui_customization {
}
```
...
if environment == "production":
    ui_customization = provider.cognito_identity_provider.Ui_customization {
    }
```
