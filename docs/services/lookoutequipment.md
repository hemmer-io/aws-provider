...
# Create multiple active_model_version resources
active_model_version_0 = provider.lookoutequipment.Active_model_version {
    model_name = "value-0"
    model_version = "value-0"
}
active_model_version_1 = provider.lookoutequipment.Active_model_version {
    model_name = "value-1"
    model_version = "value-1"
}
active_model_version_2 = provider.lookoutequipment.Active_model_version {
    model_name = "value-2"
...
if environment == "production":
    active_model_version = provider.lookoutequipment.Active_model_version {
