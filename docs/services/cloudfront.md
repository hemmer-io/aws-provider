...
# Create multiple connection_group resources
connection_group_0 = provider.cloudfront.Connection_group {
    name = "value-0"
}
connection_group_1 = provider.cloudfront.Connection_group {
    name = "value-1"
}
connection_group_2 = provider.cloudfront.Connection_group {
    name = "value-2"
}
```
