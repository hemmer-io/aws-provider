...
# Create multiple job_flows resources
job_flows_0 = provider.emr.Job_flows {
}
job_flows_1 = provider.emr.Job_flows {
}
job_flows_2 = provider.emr.Job_flows {
}
```
...
if environment == "production":
    job_flows = provider.emr.Job_flows {
    }
```
