...
# Create multiple trace_summaries resources
trace_summaries_0 = provider.xray.Trace_summaries {
}
trace_summaries_1 = provider.xray.Trace_summaries {
}
trace_summaries_2 = provider.xray.Trace_summaries {
}
```
...
if environment == "production":
    trace_summaries = provider.xray.Trace_summaries {
    }
```
