...
# Create multiple elasticsearch_domains resources
elasticsearch_domains_0 = provider.elasticsearch_service.Elasticsearch_domains {
}
elasticsearch_domains_1 = provider.elasticsearch_service.Elasticsearch_domains {
}
elasticsearch_domains_2 = provider.elasticsearch_service.Elasticsearch_domains {
}
```
...
if environment == "production":
    elasticsearch_domains = provider.elasticsearch_service.Elasticsearch_domains {
    }
```
