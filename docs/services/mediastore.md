...
# Create multiple cors_policy resources
cors_policy_0 = provider.mediastore.Cors_policy {
    container_name = "value-0"
    cors_policy = "value-0"
}
cors_policy_1 = provider.mediastore.Cors_policy {
    container_name = "value-1"
    cors_policy = "value-1"
}
cors_policy_2 = provider.mediastore.Cors_policy {
