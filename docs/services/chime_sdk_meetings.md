...
# Create multiple meeting_with_attendees resources
meeting_with_attendees_0 = provider.chime_sdk_meetings.Meeting_with_attendees {
    attendees = "value-0"
    client_request_token = "value-0"
    external_meeting_id = "value-0"
    media_region = "value-0"
}
meeting_with_attendees_1 = provider.chime_sdk_meetings.Meeting_with_attendees {
    attendees = "value-1"
    client_request_token = "value-1"
    external_meeting_id = "value-1"
    media_region = "value-1"
}
meeting_with_attendees_2 = provider.chime_sdk_meetings.Meeting_with_attendees {
    attendees = "value-2"
