...
# Create multiple dataset_group resources
dataset_group_0 = provider.forecast.Dataset_group {
    dataset_group_name = "value-0"
    domain = "value-0"
}
dataset_group_1 = provider.forecast.Dataset_group {
    dataset_group_name = "value-1"
    domain = "value-1"
}
dataset_group_2 = provider.forecast.Dataset_group {
    dataset_group_name = "value-2"
    domain = "value-2"
}
```
...
if environment == "production":
    dataset_group = provider.forecast.Dataset_group {
        dataset_group_name = "production-value"
