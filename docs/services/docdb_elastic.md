...
cluster_0 = provider.docdb_elastic.Cluster {
    auth_type = "value-0"
    shard_count = "value-0"
    cluster_name = "value-0"
    shard_capacity = "value-0"
    admin_user_password = "value-0"
    admin_user_name = "value-0"
}
cluster_1 = provider.docdb_elastic.Cluster {
    auth_type = "value-1"
    shard_count = "value-1"
    cluster_name = "value-1"
    shard_capacity = "value-1"
    admin_user_password = "value-1"
    admin_user_name = "value-1"
}
cluster_2 = provider.docdb_elastic.Cluster {
    auth_type = "value-2"
    shard_count = "value-2"
    cluster_name = "value-2"
    shard_capacity = "value-2"
    admin_user_password = "value-2"
    admin_user_name = "value-2"
}
```
...
if environment == "production":
    cluster = provider.docdb_elastic.Cluster {
        ...
        shard_count = "production-value"
        cluster_name = "production-value"
        shard_capacity = "production-value"
        admin_user_password = "production-value"
        admin_user_name = "production-value"
    }
```
