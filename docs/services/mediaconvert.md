...
# Create multiple jobs_query_results resources
jobs_query_results_0 = provider.mediaconvert.Jobs_query_results {
}
jobs_query_results_1 = provider.mediaconvert.Jobs_query_results {
}
jobs_query_results_2 = provider.mediaconvert.Jobs_query_results {
}
```
...
if environment == "production":
    jobs_query_results = provider.mediaconvert.Jobs_query_results {
    }
```
