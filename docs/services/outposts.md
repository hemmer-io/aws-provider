...
# Create multiple outpost resources
outpost_0 = provider.outposts.Outpost {
    name = "value-0"
    site_id = "value-0"
}
outpost_1 = provider.outposts.Outpost {
    name = "value-1"
    site_id = "value-1"
}
outpost_2 = provider.outposts.Outpost {
    name = "value-2"
    site_id = "value-2"
}
```
