...
# Create multiple authorization_token resources
authorization_token_0 = provider.ecr.Authorization_token {
}
authorization_token_1 = provider.ecr.Authorization_token {
}
authorization_token_2 = provider.ecr.Authorization_token {
}
```
...
if environment == "production":
    authorization_token = provider.ecr.Authorization_token {
    }
```
