...
# Create multiple insight_rule resources
insight_rule_0 = provider.cloudwatch.Insight_rule {
    rule_name = "value-0"
    rule_definition = "value-0"
}
insight_rule_1 = provider.cloudwatch.Insight_rule {
    rule_name = "value-1"
    rule_definition = "value-1"
}
insight_rule_2 = provider.cloudwatch.Insight_rule {
    rule_name = "value-2"
    rule_definition = "value-2"
}
```
...
if environment == "production":
    insight_rule = provider.cloudwatch.Insight_rule {
        ...
        rule_definition = "production-value"
    }
```
