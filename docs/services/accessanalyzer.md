...
# Create multiple finding_recommendation resources
finding_recommendation_0 = provider.accessanalyzer.Finding_recommendation {
}
finding_recommendation_1 = provider.accessanalyzer.Finding_recommendation {
}
finding_recommendation_2 = provider.accessanalyzer.Finding_recommendation {
}
```
...
if environment == "production":
    finding_recommendation = provider.accessanalyzer.Finding_recommendation {
    }
```
