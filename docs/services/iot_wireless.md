...
# Create multiple wireless_device_import_task resources
wireless_device_import_task_0 = provider.iot_wireless.Wireless_device_import_task {
    sidewalk = "value-0"
    id = "value-0"
}
wireless_device_import_task_1 = provider.iot_wireless.Wireless_device_import_task {
    sidewalk = "value-1"
    id = "value-1"
}
wireless_device_import_task_2 = provider.iot_wireless.Wireless_device_import_task {
    sidewalk = "value-2"
    id = "value-2"
}
```
...
if environment == "production":
    wireless_device_import_task = provider.iot_wireless.Wireless_device_import_task {
        sidewalk = "production-value"
        id = "production-value"
    }
```
