...
# Create multiple telemetry_enrichment_status resources
telemetry_enrichment_status_0 = provider.observabilityadmin.Telemetry_enrichment_status {
}
telemetry_enrichment_status_1 = provider.observabilityadmin.Telemetry_enrichment_status {
}
telemetry_enrichment_status_2 = provider.observabilityadmin.Telemetry_enrichment_status {
}
```
...
if environment == "production":
    telemetry_enrichment_status = provider.observabilityadmin.Telemetry_enrichment_status {
    }
```
