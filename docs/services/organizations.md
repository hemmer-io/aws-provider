...
resource_policy_0 = provider.organizations.Resource_policy {
    content = "value-0"
}
resource_policy_1 = provider.organizations.Resource_policy {
    content = "value-1"
}
resource_policy_2 = provider.organizations.Resource_policy {
    content = "value-2"
}
```
