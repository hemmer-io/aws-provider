...
# Create multiple hosted_configuration_version resources
hosted_configuration_version_0 = provider.appconfig.Hosted_configuration_version {
    content_type = "value-0"
    configuration_profile_id = "value-0"
    application_id = "value-0"
    content = "value-0"
}
hosted_configuration_version_1 = provider.appconfig.Hosted_configuration_version {
    content_type = "value-1"
    configuration_profile_id = "value-1"
    application_id = "value-1"
    content = "value-1"
}
hosted_configuration_version_2 = provider.appconfig.Hosted_configuration_version {
    content_type = "value-2"
    configuration_profile_id = "value-2"
...
if environment == "production":
    hosted_configuration_version = provider.appconfig.Hosted_configuration_version {
        ...
        configuration_profile_id = "production-value"
