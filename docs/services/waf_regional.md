...
# Create multiple size_constraint_set resources
size_constraint_set_0 = provider.waf_regional.Size_constraint_set {
    change_token = "value-0"
    name = "value-0"
}
size_constraint_set_1 = provider.waf_regional.Size_constraint_set {
    change_token = "value-1"
    name = "value-1"
}
size_constraint_set_2 = provider.waf_regional.Size_constraint_set {
