...
# Create multiple kx_connection_string resources
kx_connection_string_0 = provider.finspace.Kx_connection_string {
}
kx_connection_string_1 = provider.finspace.Kx_connection_string {
}
kx_connection_string_2 = provider.finspace.Kx_connection_string {
}
```
...
if environment == "production":
    kx_connection_string = provider.finspace.Kx_connection_string {
    }
```
