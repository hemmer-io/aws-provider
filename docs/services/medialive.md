...
schedule_0 = provider.medialive.Schedule {
}
schedule_1 = provider.medialive.Schedule {
}
schedule_2 = provider.medialive.Schedule {
}
```
...
if environment == "production":
    schedule = provider.medialive.Schedule {
    }
```
