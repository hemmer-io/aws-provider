...
# Create multiple service_role_for_account resources
service_role_for_account_0 = provider.greengrass.Service_role_for_account {
}
service_role_for_account_1 = provider.greengrass.Service_role_for_account {
}
service_role_for_account_2 = provider.greengrass.Service_role_for_account {
}
```
...
if environment == "production":
    service_role_for_account = provider.greengrass.Service_role_for_account {
    }
```
