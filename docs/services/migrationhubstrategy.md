...
# Create multiple application_component_config resources
application_component_config_0 = provider.migrationhubstrategy.Application_component_config {
    application_component_id = "value-0"
}
application_component_config_1 = provider.migrationhubstrategy.Application_component_config {
    application_component_id = "value-1"
}
application_component_config_2 = provider.migrationhubstrategy.Application_component_config {
    application_component_id = "value-2"
}
```
...
if environment == "production":
    application_component_config = provider.migrationhubstrategy.Application_component_config {
        application_component_id = "production-value"
    }
```
