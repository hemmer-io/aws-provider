...
# Create multiple serverless_cache_snapshot resources
serverless_cache_snapshot_0 = provider.elasticache.Serverless_cache_snapshot {
    serverless_cache_snapshot_name = "value-0"
    serverless_cache_name = "value-0"
}
serverless_cache_snapshot_1 = provider.elasticache.Serverless_cache_snapshot {
    serverless_cache_snapshot_name = "value-1"
    serverless_cache_name = "value-1"
}
serverless_cache_snapshot_2 = provider.elasticache.Serverless_cache_snapshot {
    serverless_cache_snapshot_name = "value-2"
    serverless_cache_name = "value-2"
}
```
...
if environment == "production":
    serverless_cache_snapshot = provider.elasticache.Serverless_cache_snapshot {
        serverless_cache_snapshot_name = "production-value"
        serverless_cache_name = "production-value"
    }
```
