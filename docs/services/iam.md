...
# Create multiple account_password_policy resources
account_password_policy_0 = provider.iam.Account_password_policy {
}
account_password_policy_1 = provider.iam.Account_password_policy {
}
account_password_policy_2 = provider.iam.Account_password_policy {
}
```
...
if environment == "production":
    account_password_policy = provider.iam.Account_password_policy {
    }
```
