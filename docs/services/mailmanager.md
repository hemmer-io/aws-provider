...
# Create multiple archive_search_results resources
archive_search_results_0 = provider.mailmanager.Archive_search_results {
}
archive_search_results_1 = provider.mailmanager.Archive_search_results {
}
archive_search_results_2 = provider.mailmanager.Archive_search_results {
}
```
...
if environment == "production":
    archive_search_results = provider.mailmanager.Archive_search_results {
    }
```
