...
# Create multiple ops_items resources
ops_items_0 = provider.ssm.Ops_items {
}
ops_items_1 = provider.ssm.Ops_items {
}
ops_items_2 = provider.ssm.Ops_items {
}
```
...
if environment == "production":
    ops_items = provider.ssm.Ops_items {
    }
```
