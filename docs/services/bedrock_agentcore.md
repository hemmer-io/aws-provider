...
# Create multiple workload_access_token_for_user_id resources
workload_access_token_for_user_id_0 = provider.bedrock_agentcore.Workload_access_token_for_user_id {
}
workload_access_token_for_user_id_1 = provider.bedrock_agentcore.Workload_access_token_for_user_id {
}
workload_access_token_for_user_id_2 = provider.bedrock_agentcore.Workload_access_token_for_user_id {
}
```
...
if environment == "production":
    workload_access_token_for_user_id = provider.bedrock_agentcore.Workload_access_token_for_user_id {
    }
```
