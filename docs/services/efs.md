...
# Create multiple replication_configurations resources
replication_configurations_0 = provider.efs.Replication_configurations {
}
replication_configurations_1 = provider.efs.Replication_configurations {
}
replication_configurations_2 = provider.efs.Replication_configurations {
}
```
...
if environment == "production":
    replication_configurations = provider.efs.Replication_configurations {
    }
```
