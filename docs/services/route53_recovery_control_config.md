...
cluster_0 = provider.route53_recovery_control_config.Cluster {
    cluster_name = "value-0"
}
cluster_1 = provider.route53_recovery_control_config.Cluster {
    cluster_name = "value-1"
}
cluster_2 = provider.route53_recovery_control_config.Cluster {
