...
environment_0 = provider.datazone.Environment {
    domain_identifier = "value-0"
    project_identifier = "value-0"
    name = "value-0"
}
environment_1 = provider.datazone.Environment {
    domain_identifier = "value-1"
    project_identifier = "value-1"
    name = "value-1"
}
environment_2 = provider.datazone.Environment {
    domain_identifier = "value-2"
    project_identifier = "value-2"
    name = "value-2"
}
```
...
if environment == "production":
    environment = provider.datazone.Environment {
        ...
        project_identifier = "production-value"
