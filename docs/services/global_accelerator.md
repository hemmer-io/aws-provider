...
# Create multiple custom_routing_accelerator_attributes resources
custom_routing_accelerator_attributes_0 = provider.global_accelerator.Custom_routing_accelerator_attributes {
    accelerator_arn = "value-0"
}
custom_routing_accelerator_attributes_1 = provider.global_accelerator.Custom_routing_accelerator_attributes {
    accelerator_arn = "value-1"
}
custom_routing_accelerator_attributes_2 = provider.global_accelerator.Custom_routing_accelerator_attributes {
...
if environment == "production":
    custom_routing_accelerator_attributes = provider.global_accelerator.Custom_routing_accelerator_attributes {
