...
# Create multiple resource_policies resources
resource_policies_0 = provider.ram.Resource_policies {
}
resource_policies_1 = provider.ram.Resource_policies {
}
resource_policies_2 = provider.ram.Resource_policies {
}
```
...
if environment == "production":
    resource_policies = provider.ram.Resource_policies {
    }
```
