...
# Create multiple receipt_rule resources
receipt_rule_0 = provider.ses.Receipt_rule {
    rule = "value-0"
    rule_set_name = "value-0"
}
receipt_rule_1 = provider.ses.Receipt_rule {
    rule = "value-1"
    rule_set_name = "value-1"
}
receipt_rule_2 = provider.ses.Receipt_rule {
    rule = "value-2"
    rule_set_name = "value-2"
}
```
...
if environment == "production":
    receipt_rule = provider.ses.Receipt_rule {
        ...
        rule_set_name = "production-value"
    }
```
