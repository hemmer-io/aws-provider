...
# Create multiple certificate_authority_audit_report resources
certificate_authority_audit_report_0 = provider.acm_pca.Certificate_authority_audit_report {
    certificate_authority_arn = "value-0"
    s3_bucket_name = "value-0"
    audit_report_response_format = "value-0"
}
certificate_authority_audit_report_1 = provider.acm_pca.Certificate_authority_audit_report {
    certificate_authority_arn = "value-1"
    s3_bucket_name = "value-1"
    audit_report_response_format = "value-1"
}
certificate_authority_audit_report_2 = provider.acm_pca.Certificate_authority_audit_report {
    certificate_authority_arn = "value-2"
    s3_bucket_name = "value-2"
    audit_report_response_format = "value-2"
}
```
...
if environment == "production":
    certificate_authority_audit_report = provider.acm_pca.Certificate_authority_audit_report {
        certificate_authority_arn = "production-value"
        s3_bucket_name = "production-value"
        audit_report_response_format = "production-value"
    }
```
