...
# Create multiple organization_configuration resources
organization_configuration_0 = provider.guardduty.Organization_configuration {
    detector_id = "value-0"
}
organization_configuration_1 = provider.guardduty.Organization_configuration {
    detector_id = "value-1"
}
organization_configuration_2 = provider.guardduty.Organization_configuration {
    detector_id = "value-2"
}
```
...
if environment == "production":
    organization_configuration = provider.guardduty.Organization_configuration {
        detector_id = "production-value"
    }
```
