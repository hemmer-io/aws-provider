...
# Create multiple domain_contact resources
domain_contact_0 = provider.route_53_domains.Domain_contact {
    domain_name = "value-0"
}
domain_contact_1 = provider.route_53_domains.Domain_contact {
    domain_name = "value-1"
}
domain_contact_2 = provider.route_53_domains.Domain_contact {
    domain_name = "value-2"
}
```
...
if environment == "production":
    domain_contact = provider.route_53_domains.Domain_contact {
