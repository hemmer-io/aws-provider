...
# Create multiple face_liveness_session resources
face_liveness_session_0 = provider.rekognition.Face_liveness_session {
}
face_liveness_session_1 = provider.rekognition.Face_liveness_session {
}
face_liveness_session_2 = provider.rekognition.Face_liveness_session {
}
```
