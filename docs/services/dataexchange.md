...
# Create multiple data_set resources
data_set_0 = provider.dataexchange.Data_set {
    asset_type = "value-0"
    description = "value-0"
    name = "value-0"
}
data_set_1 = provider.dataexchange.Data_set {
    asset_type = "value-1"
    description = "value-1"
    name = "value-1"
}
data_set_2 = provider.dataexchange.Data_set {
    asset_type = "value-2"
    description = "value-2"
    name = "value-2"
}
