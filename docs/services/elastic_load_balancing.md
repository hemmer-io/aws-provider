...
# Create multiple listener_certificates resources
listener_certificates_0 = provider.elastic_load_balancing.Listener_certificates {
}
listener_certificates_1 = provider.elastic_load_balancing.Listener_certificates {
}
listener_certificates_2 = provider.elastic_load_balancing.Listener_certificates {
}
```
...
if environment == "production":
    listener_certificates = provider.elastic_load_balancing.Listener_certificates {
    }
```
