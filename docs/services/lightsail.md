...
# Create multiple instances_from_snapshot resources
instances_from_snapshot_0 = provider.lightsail.Instances_from_snapshot {
    bundle_id = "value-0"
    availability_zone = "value-0"
    instance_names = "value-0"
}
instances_from_snapshot_1 = provider.lightsail.Instances_from_snapshot {
    bundle_id = "value-1"
    availability_zone = "value-1"
    instance_names = "value-1"
}
instances_from_snapshot_2 = provider.lightsail.Instances_from_snapshot {
    bundle_id = "value-2"
    availability_zone = "value-2"
    instance_names = "value-2"
}
```
...
if environment == "production":
    instances_from_snapshot = provider.lightsail.Instances_from_snapshot {
        bundle_id = "production-value"
        availability_zone = "production-value"
        instance_names = "production-value"
    }
```
